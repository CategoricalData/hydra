...
Types:
  ...
  hydra.core.Type = union{annotated:hydra.core.AnnotatedType, application:hydra.core.ApplicationType, either:hydra.core.EitherType, forall:hydra.core.ForallType, function:hydra.core.FunctionType, list:hydra.core.Type, literal:hydra.core.LiteralType, map:hydra.core.MapType, maybe:hydra.core.Type, pair:hydra.core.PairType, product:list<hydra.core.Type>, record:list<hydra.core.FieldType>, set:hydra.core.Type, sum:list<hydra.core.Type>, union:list<hydra.core.FieldType>, unit:unit, variable:hydra.core.Name, wrap:hydra.core.Type}
  ...
