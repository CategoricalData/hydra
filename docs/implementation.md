...
dist/haskell/hydra-ext/src/main/haskell/Hydra/          # Extension modules (long-tail; frozen, shipped as-is)
...
| `sync-packages.sh` | Phase 1 only: DSL sources → JSON + Haskell kernel + `stack test`. |
