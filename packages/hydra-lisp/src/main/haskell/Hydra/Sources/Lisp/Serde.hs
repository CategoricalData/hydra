...
programToExpr = define "programToExpr" $
  lambda "prog" $ lets [
    ...
    -- Generated-file header. Lisp dialects all share a leading-`;` line comment.
    "warning">: list [Serialization.cst @@ (Strings.cat2 (string "; ") (asTerm Constants.warningAutoGeneratedFile))],
