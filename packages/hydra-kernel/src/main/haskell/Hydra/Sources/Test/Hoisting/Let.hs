...
hoistLetBindingsGroup = subgroup "hoistLetBindings" [
    ...
    hoistAllCase "nested let inside lambda: binding hoisted with lambda capture"
      ...
      (mkLetUntyped [(nm "f",
        lambda "a" (Core.termLet $ mkLetUntyped [(nm "g", apply (apply (primitive (Prims.primName DefMath.add)) (var "a")) (int32 1))]
          (apply (apply (primitive (Prims.primName DefMath.mul)) (var "g")) (int32 2))))]
      ...
      (mkLetUntyped [
        (nm "f",
          lambda "a" (apply (apply (primitive (Prims.primName DefMath.mul)) (apply (var "f_g") (var "a"))) (int32 2))),
        (nm "f_g", lambda "a" (apply (apply (primitive (Prims.primName DefMath.add)) (var "a")) (int32 1)))]
        (apply (var "f") (int32 10))),
    ...
    hoistAllCase "type application: nested let outside lambda CAN be hoisted"
      ...
      (mkLetUntyped [(nm "f",
        tyapp (Core.termLet $ mkLetUntyped [(nm "y", int32 1)]
          (lambda "x" (apply (apply (primitive (Prims.primName DefMath.add)) (var "x")) (var "y")))) T.int32)]
        (apply (var "f") (int32 10)))
      -- Output: f comes first (original binding), then f_y is hoisted
      (mkLetUntyped [
        (nm "f",
          tyapp (lambda "x" (apply (apply (primitive (Prims.primName DefMath.add)) (var "x")) (var "f_y"))) T.int32),
        (nm "f_y", int32 1)]
        (apply (var "f") (int32 10)))]
...
hoistPolymorphicLetBindingsGroup = subgroup "hoistPolymorphicLetBindings" [
    ...
    hoistPolyCase "polymorphic binding captures both lambda-bound and let-bound variables"
      ...
      (mkLet [(nm "f",
        lambdaTyped "a" T.int32 (Core.termLet $ mkLet [
          (nm "x", int32 1, monoType T.int32),
          (nm "g", lambda "y" (apply (apply (primitive (Prims.primName DefMath.add))
                    (apply (apply (primitive (Prims.primName DefMath.add)) (var "a")) (var "x"))) (var "y")),
      ...
      (mkLet [
        ...
        (nm "f_g", tylam "b" (lambdaTyped "a" T.int32 (lambdaTyped "x" T.int32
          (lambda "y" (apply (apply (primitive (Prims.primName DefMath.add))
            (apply (apply (primitive (Prims.primName DefMath.add)) (var "a")) (var "x"))) (var "y"))))),
    ...
    hoistPolyCase "sibling polymorphic bindings inside lambda: one calls the other"
      ...
      (mkLet [(nm "wrapper",
        lambdaTyped "outer" T.int32 (Core.termLet $ mkLet [
          (nm "g", lambda "y" (apply (apply (primitive (Prims.primName DefMath.add)) (var "outer")) (var "y")),
      ...
      (mkLet [
        (nm "wrapper",
          ...
          monoType (T.function T.int32 T.int32)),
        (nm "wrapper_g", tylam "a" (lambdaTyped "outer" T.int32 (lambda "y" (apply (apply (primitive (Prims.primName DefMath.add)) (var "outer")) (var "y")))),
    ...
    hoistPolyCase "sibling polymorphic bindings inside lambda: h passes its own args to g"
      ...
      (mkLet [(nm "wrapper",
        lambdaTyped "outer" T.int32 (Core.termLet $ mkLet [
          (nm "g", lambda "v" (lambda "t" (apply (apply (primitive (Prims.primName DefMath.add)) (var "outer"))
            (apply (apply (primitive (Prims.primName DefMath.add)) (var "v")) (var "t")))),
      ...
      (mkLet [
        ...
        (nm "wrapper_g", tylam "a" (lambdaTyped "outer" T.int32
          (lambda "v" (lambda "t" (apply (apply (primitive (Prims.primName DefMath.add)) (var "outer"))
            (apply (apply (primitive (Prims.primName DefMath.add)) (var "v")) (var "t")))))),
    ...
    hoistPolyCase "untyped binding: not hoisted"
      ...
      (mkLetUntyped [(nm "x", int32 1)]
        (Core.termLet $ mkLetUntyped [(nm "y", int32 2)]
          (apply (apply (primitive (Prims.primName DefMath.add)) (var "x")) (var "y"))))
        ...
        lambdaTyped "left" T.int32
          (lambdaTyped "right" T.int32
            (Core.termLet $ mkLet [
              ...
              (nm "cannotUnify",
                lambda "x" (apply (apply (primitive (Prims.primName DefMath.add)) (var "sleft"))
                  (apply (apply (primitive (Prims.primName DefMath.add)) (var "sright")) (var "x"))),
                polyType ["a"] (T.function (T.var "a") (T.var "a")))]
      ...
      (mkLet [(nm "wrapper",
        lambdaTyped "left" T.int32
          ...
          (Core.termLet $ mkLet [
            ...
            (Core.termLet $ mkLet [
              (nm "cannotUnify",
                lambda "x" (apply (apply (primitive (Prims.primName DefMath.add)) (var "sleft")) (var "x")),
                polyType ["a"] (T.function (T.var "a") (T.var "a")))]
