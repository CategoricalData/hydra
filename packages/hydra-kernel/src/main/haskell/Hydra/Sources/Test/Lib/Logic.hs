...
ns :: ModuleName
ns = ModuleName "hydra.core.test.lib.logic"
...
module_ = Module {
            ...
            moduleMetadata = descriptionMetadata (Just "Test cases for hydra.core.lib.logic primitives")}
  where
    definitions = [Phantoms.toDefinition allTests]

-- Test groups for hydra.core.lib.logic primitives

allTests :: TypedTermDefinition TestGroup
allTests = definitionInModule module_ "allTests" $
    Phantoms.doc "Test cases for hydra.core.lib.logic primitives" $
    supergroup "hydra.core.lib.logic primitives" [
      logicAnd,
      logicIfElse,
      logicNot,
      logicOr]
