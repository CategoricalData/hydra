...
literalsBigintToInt32 = subgroup "bigintToInt32" [
  ...
  test "zero" 0 0]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToInt32) [bigint x] (int32 result)
...
literalsInt32ToBigint = subgroup "int32ToBigint" [
  ...
  test "zero" 0 0]
  where
    test name x result = primCase name (Prims.primName DefLiterals.int32ToBigint) [int32 x] (bigint result)
...
literalsInt16ToBigint = subgroup "int16ToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.int16ToBigint) [int16 x] (bigint result)
...
literalsInt64ToBigint = subgroup "int64ToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.int64ToBigint) [int64 x] (bigint result)
...
literalsInt8ToBigint = subgroup "int8ToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.int8ToBigint) [int8 x] (bigint result)
...
literalsUint16ToBigint = subgroup "uint16ToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.uint16ToBigint) [uint16 x] (bigint result)
...
literalsUint32ToBigint = subgroup "uint32ToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.uint32ToBigint) [uint32 x] (bigint result)
...
literalsUint64ToBigint = subgroup "uint64ToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.uint64ToBigint) [uint64 x] (bigint result)
...
literalsUint8ToBigint = subgroup "uint8ToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.uint8ToBigint) [uint8 x] (bigint result)
...
literalsBigintToInt16 = subgroup "bigintToInt16" [
  ...
  test "negative" (-1000) (-1000)]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToInt16) [bigint x] (int16 result)
...
literalsBigintToInt64 = subgroup "bigintToInt64" [
  ...
  test "negative" (-1000000) (-1000000)]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToInt64) [bigint x] (int64 result)
...
literalsBigintToInt8 = subgroup "bigintToInt8" [
  ...
  test "negative" (-42) (-42)]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToInt8) [bigint x] (int8 result)
...
literalsBigintToUint16 = subgroup "bigintToUint16" [
  ...
  test "typical value" 1000 1000]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToUint16) [bigint x] (uint16 result)
...
literalsBigintToUint32 = subgroup "bigintToUint32" [
  ...
  test "typical value" 100000 100000]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToUint32) [bigint x] (uint32 result)
...
literalsBigintToUint64 = subgroup "bigintToUint64" [
  ...
  test "typical value" 1000000 1000000]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToUint64) [bigint x] (uint64 result)
...
literalsBigintToUint8 = subgroup "bigintToUint8" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToUint8) [bigint x] (uint8 result)
...
literalsFloat32ToFloat64 = subgroup "float32ToFloat64" [
  ...
  test "zero" 0.0 0.0]
  where
    test name x result = primCase name (Prims.primName DefLiterals.float32ToFloat64) [float32 x] (float64 result)
...
literalsFloat64ToFloat32 = subgroup "float64ToFloat32" [
  ...
  test "zero" 0.0 0.0]
  where
    test name x result = primCase name (Prims.primName DefLiterals.float64ToFloat32) [float64 x] (float32 result)
...
literalsBigintToDecimal = subgroup "bigintToDecimal" [
  ...
  test "zero" 0 0]
  where
    test name x result = primCase name (Prims.primName DefLiterals.bigintToDecimal) [bigint x] (decimal result)
...
literalsDecimalToBigint = subgroup "decimalToBigint" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.decimalToBigint) [decimal x] (bigint result)
...
literalsDecimalToFloat32 = subgroup "decimalToFloat32" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.decimalToFloat32) [decimal x] (float32 result)
...
literalsDecimalToFloat64 = subgroup "decimalToFloat64" [
  ...
  test "negative whole" (-2) (-2.0)]
  where
    test name x result = primCase name (Prims.primName DefLiterals.decimalToFloat64) [decimal x] (float64 result)
...
literalsFloat32ToDecimal = subgroup "float32ToDecimal" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.float32ToDecimal) [float32 x] (decimal result)
...
literalsFloat64ToDecimal = subgroup "float64ToDecimal" [
  ...
  test "negative whole" (-2.0) (-2)]
  where
    test name x result = primCase name (Prims.primName DefLiterals.float64ToDecimal) [float64 x] (decimal result)
...
literalsReadDecimal = subgroup "readDecimal" [
  ...
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readDecimal) [string x] (Core.termOptional $ just (decimal result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readDecimal) [string x] (Core.termOptional nothing)
...
literalsShowDecimal = subgroup "showDecimal" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.showDecimal) [decimal x] (string result)
...
literalsShowBigint = subgroup "showBigint" [
  ...
  test "zero" 0 "0"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showBigint) [bigint x] (string result)
...
literalsShowBoolean = subgroup "showBoolean" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.showBoolean) [x] (string result)
...
literalsShowFloat32 = subgroup "showFloat32" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.showFloat32) [float32 x] (string result)
...
literalsShowFloat64 = subgroup "showFloat64" [
  ...
  test "normal decimal" 0.1 "0.1"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showFloat64) [float64 x] (string result)
...
literalsShowInt16 = subgroup "showInt16" [
  ...
  test "negative" (-1000) "-1000"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showInt16) [int16 x] (string result)
...
literalsShowInt32 = subgroup "showInt32" [
  ...
  test "zero" 0 "0"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showInt32) [int32 x] (string result)
...
literalsShowInt64 = subgroup "showInt64" [
  ...
  test "negative" (-1000000) "-1000000"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showInt64) [int64 x] (string result)
...
literalsShowInt8 = subgroup "showInt8" [
  ...
  test "negative" (-42) "-42"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showInt8) [int8 x] (string result)
...
literalsShowString = subgroup "showString" [
  ...
  test "delete" "\127" "\"\\DEL\""]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showString) [string x] (string result)
...
literalsShowUint16 = subgroup "showUint16" [
  ...
  test "typical value" 1000 "1000"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showUint16) [uint16 x] (string result)
...
literalsShowUint32 = subgroup "showUint32" [
  ...
  test "typical value" 100000 "100000"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showUint32) [uint32 x] (string result)
...
literalsShowUint64 = subgroup "showUint64" [
  ...
  test "typical value" 1000000 "1000000"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showUint64) [uint64 x] (string result)
...
literalsShowUint8 = subgroup "showUint8" [
  ...
  test "max value" 255 "255"]
  where
    test name x result = primCase name (Prims.primName DefLiterals.showUint8) [uint8 x] (string result)
...
literalsBinaryToString = subgroup "binaryToString" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.binaryToString) [binary x] (string result)
...
literalsReadBigint = subgroup "readBigint" [
  ...
  testJust "negative" "-42" (-42),
  testJust "zero" "0" 0,
  primCaseWithTags "large" [tag_disabled] (Prims.primName DefLiterals.readBigint) [string "123456789012345678901234567890"] (Core.termOptional $ just (bigint 123456789012345678901234567890)),
  testNothing "invalid" "abc"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readBigint) [string x] (Core.termOptional $ just (bigint result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readBigint) [string x] (Core.termOptional nothing)
...
literalsReadBoolean = subgroup "readBoolean" [
  ...
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readBoolean) [string x] (Core.termOptional $ just result)
    testNothing name x = primCase name (Prims.primName DefLiterals.readBoolean) [string x] (Core.termOptional nothing)
...
literalsReadFloat32 = subgroup "readFloat32" [
  ...
  testNothing "invalid" "abc"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readFloat32) [string x] (Core.termOptional $ just (float32 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readFloat32) [string x] (Core.termOptional nothing)
...
literalsReadFloat64 = subgroup "readFloat64" [
  ...
  testNothing "invalid" "abc"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readFloat64) [string x] (Core.termOptional $ just (float64 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readFloat64) [string x] (Core.termOptional nothing)
...
literalsReadInt16 = subgroup "readInt16" [
  ...
  testNothing "invalid" "abc"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readInt16) [string x] (Core.termOptional $ just (int16 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readInt16) [string x] (Core.termOptional nothing)
...
literalsReadInt32 = subgroup "readInt32" [
  ...
  testNothing "invalid" "abc"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readInt32) [string x] (Core.termOptional $ just (int32 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readInt32) [string x] (Core.termOptional nothing)
...
literalsReadInt64 = subgroup "readInt64" [
  ...
  testNothing "invalid" "abc"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readInt64) [string x] (Core.termOptional $ just (int64 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readInt64) [string x] (Core.termOptional nothing)
...
literalsReadInt8 = subgroup "readInt8" [
  ...
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readInt8) [string x] (Core.termOptional $ just (int8 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readInt8) [string x] (Core.termOptional nothing)
...
literalsReadString = subgroup "readString" [
  ...
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readString) [string x] (Core.termOptional $ just (string result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readString) [string x] (Core.termOptional nothing)
...
literalsReadUint16 = subgroup "readUint16" [
  ...
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readUint16) [string x] (Core.termOptional $ just (uint16 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readUint16) [string x] (Core.termOptional nothing)
...
literalsReadUint32 = subgroup "readUint32" [
  ...
  testNothing "negative" "-1"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readUint32) [string x] (Core.termOptional $ just (uint32 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readUint32) [string x] (Core.termOptional nothing)
...
literalsReadUint64 = subgroup "readUint64" [
  ...
  testNothing "negative" "-1"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readUint64) [string x] (Core.termOptional $ just (uint64 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readUint64) [string x] (Core.termOptional nothing)
...
literalsReadUint8 = subgroup "readUint8" [
  ...
  testNothing "negative" "-1"]
  where
    testJust name x result = primCase name (Prims.primName DefLiterals.readUint8) [string x] (Core.termOptional $ just (uint8 result))
    testNothing name x = primCase name (Prims.primName DefLiterals.readUint8) [string x] (Core.termOptional nothing)
...
literalsStringToBinary = subgroup "stringToBinary" [
  ...
  where
    test name x result = primCase name (Prims.primName DefLiterals.stringToBinary) [string x] (binary result)
