...
ns :: ModuleName
ns = ModuleName "hydra.core.test.inference.nominalTypes"

module_ :: Module
module_ = Module {
            moduleName = ns,
            moduleDefinitions = definitions,
            moduleDependencies = unqualifiedDep <$> ([TestGraph.ns, ModuleName "hydra.core.inference", ModuleName "hydra.core.print.model", ModuleName "hydra.core.test.testTerms", ModuleName "hydra.core.test.testTypes"] ++ kernelTypesModuleNames),
...
testGroupForCaseStatements :: TypedTermDefinition TestGroup
...
testGroupForProjections :: TypedTermDefinition TestGroup
...
testGroupForVariants :: TypedTermDefinition TestGroup
...
testGroupForWrappers :: TypedTermDefinition TestGroup
