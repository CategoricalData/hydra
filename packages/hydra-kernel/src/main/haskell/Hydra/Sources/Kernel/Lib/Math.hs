...
module_ = Module {
  ...
  where
    definitions = [
      primNoDef "abs"       "The absolute value of an integer." int32To [
      ...
      primNoDef "acos"      "The arc cosine of a floating-point number." f64To [
      ...
      primNoDef "acosh"     "The hyperbolic arc cosine of a floating-point number." f64To [
      ...
      primNoDef "add"       "Integer addition." int32To2 [
      ...
      primNoDef "addFloat64" "Floating-point addition." f64To2 [
      ...
      primNoDef "asin"      "The arc sine of a floating-point number." f64To [
      ...
      primNoDef "asinh"     "The hyperbolic arc sine of a floating-point number." f64To [
      ...
      primNoDef "atan"      "The arc tangent of a floating-point number." f64To [
      ...
      primNoDef "atan2"     "The two-argument arc tangent (atan2)." f64To2 [
      ...
      primNoDef "atanh"     "The hyperbolic arc tangent of a floating-point number." f64To [
      ...
      primNoDef "ceiling"   "The smallest integer greater than or equal to the argument, as a float." f64To [
      ...
      primNoDef "cos"       "The cosine of a floating-point number." f64To [
      ...
      primNoDef "cosh"      "The hyperbolic cosine of a floating-point number." f64To [
      ...
      primNoDef "e"         "Euler's constant (the base of the natural logarithm)." f64Const [
      ...
      toPrimitive "Test whether an integer is even." int32ToBool [
        ...
        \ even :: Int32 -> Bool."] even_,
      primNoDef "exp"       "The exponential function." f64To [
      ...
      primNoDef "floor"     "The largest integer less than or equal to the argument, as a float." f64To [
      ...
      primNoDef "log"       "The natural logarithm." f64To [
      ...
      primNoDef "logBase"   "Logarithm of the second argument in the base of the first." f64To2 [
      ...
      primNoDef "max"       "The maximum of two integers." int32To2 [
      ...
      primNoDef "maybeDiv"  "Integer division, or Nothing if dividing by zero." int32To2Maybe [
        ...
        \ case total."],
      primNoDef "maybeMod"  "Integer modulus, or Nothing if dividing by zero." int32To2Maybe [
        ...
        \ case total."],
      primNoDef "maybePred" "The predecessor of an integer, or Nothing on underflow." int32ToMaybe [
      ...
      primNoDef "maybeRem"  "Integer remainder, or Nothing if dividing by zero." int32To2Maybe [
        ...
        \ case total."],
      primNoDef "maybeSucc" "The successor of an integer, or Nothing on overflow." int32ToMaybe [
      ...
      primNoDef "min"       "The minimum of two integers." int32To2 [
      ...
      primNoDef "mul"       "Integer multiplication." int32To2 [
        "Two's-complement 32-bit signed integer multiplication. The result is x * y reduced modulo 2^32 and\
        \ reinterpreted as a signed int32 (i.e. arithmetic wraps silently on overflow, with no exception\
        \ raised).",
        "The operation is total. Corresponds to Haskell's (*) :: Int32 -> Int32 -> Int32."],
      primNoDef "mulFloat64" "Floating-point multiplication." f64To2 [
      ...
      primNoDef "negate"    "Negate an integer." int32To [
      ...
      primNoDef "negateFloat64" "Negate a floating-point number." f64To [
      ...
      toPrimitive "Test whether an integer is odd." int32ToBool [
        "True if the argument is not divisible by 2 (i.e. x mod 2 \x2260 0), false otherwise.",
        "Total on all int32 inputs including negative numbers and minBound. Corresponds to Haskell's\
        \ odd :: Int32 -> Bool."] odd_,
      primNoDef "pi"        "The mathematical constant pi." f64Const [
      ...
      primNoDef "pow"       "Raise the first argument to the power of the second." f64To2 [
        "pow(x, y) = x^y.",
      ...
      primNoDef "range"     "Construct the inclusive integer range from the first to the second argument." int32To2List [
      ...
      primNoDef "round"     "Round a floating-point number to the nearest integer-valued float." f64To [
      ...
      primNoDef "roundFloat32" "Round a float32 to the given number of decimal places." int32F32ToF32 [
      ...
      primNoDef "roundFloat64" "Round a float64 to the given number of decimal places." int32F64ToF64 [
        ...
        "Negative n is supported in principle (rounding to powers of ten above 1); host implementations may\
        \ differ on out-of-range n."],
      primNoDef "signum"    "Return the sign of an integer as -1, 0, or 1." int32To [
      ...
      primNoDef "sin"       "The sine of a floating-point number." f64To [
      ...
      primNoDef "sinh"      "The hyperbolic sine of a floating-point number." f64To [
      ...
      primNoDef "sqrt"      "The non-negative square root of a floating-point number." f64To [
        ...
        \ Double."],
      primNoDef "sub"       "Integer subtraction." int32To2 [
        "Two's-complement 32-bit signed integer subtraction. The result is x - y reduced modulo 2^32 and\
        \ reinterpreted as a signed int32 (i.e. arithmetic wraps silently on overflow, with no exception\
        \ raised).",
        "The operation is total. Corresponds to Haskell's (-) :: Int32 -> Int32 -> Int32."],
      primNoDef "subFloat64" "Floating-point subtraction." f64To2 [
      ...
      primNoDef "tan"       "The tangent of a floating-point number." f64To [
