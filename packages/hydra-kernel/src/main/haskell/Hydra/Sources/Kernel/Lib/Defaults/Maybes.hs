...
cat_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Either Error Term)
cat_ = define "cat" $
...
cases_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Term -> Term -> Either Error Term)
cases_ = define "cases" $
...
fromJust_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Either Error Term)
...
fromMaybe_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Term -> Either Error Term)
...
isJust_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Either Error Term)
...
isNothing_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Either Error Term)
...
compose_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Term -> Term -> Either Error Term)
...
-- or applies funTerm to the value if Just.
maybe_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Term -> Term -> Either Error Term)
maybe_ = define "maybe" $
...
-- Just x -> [x], Nothing -> []
toList_ :: TTermDefinition (InferenceContext -> Graph -> Term -> Either Error Term)
