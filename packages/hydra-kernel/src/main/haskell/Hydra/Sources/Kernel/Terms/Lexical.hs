...
import qualified Hydra.Core.Overlay.Haskell.Dsl.Meta.Literals     as MetaLiterals
...
ns :: ModuleName
ns = ModuleName "hydra.core.lexical"
...
-- `:: TypedTerm (M.Map ... b)` annotation, needed now that the generated `Hydra.Core.Dsl.Lib.Maps`
