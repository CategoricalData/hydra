...
sha256 = define "sha256" "Compute the SHA-256 digest of a sequence of bytes."
  (sigWithParams [("bytes", "the sequence of bytes to hash")] $ TypeScheme [] (Types.binary Types.~> Types.binary) Nothing)
...
sha256Hex = define "sha256Hex" "Compute the SHA-256 digest of a sequence of bytes as a lowercase hex string."
  (sigWithParams [("bytes", "the sequence of bytes to hash")] $ TypeScheme [] (Types.binary Types.~> Types.string) Nothing)
