...
ns :: ModuleName
ns = ModuleName "hydra.core.analysis"
...
module_ = Module {
            ...
            moduleDependencies = Bootstrap.unqualifiedDep <$> ([Annotations.ns, Arity.ns, Checking.ns, Constants.ns, Dependencies.ns, ModuleName "hydra.core.decode.model", Lexical.ns, Names.ns, Predicates.ns, Rewriting.ns, Scoping.ns, Strip.ns, Variables.ns] L.++ kernelTypesModuleNames),
