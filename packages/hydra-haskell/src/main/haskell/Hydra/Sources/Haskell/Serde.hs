...
constructorToExpr = haskellSerdeDefinition "constructorToExpr" $
  ...
  lambda "cons" $ lets [
    ...
    Maybes.cases (var "mc") (var "body") (lambda "c" $ Serialization.newlineSep @@ (Lists.cons (Serialization.cst @@ (toHaskellComments @@ var "c")) (list [var "body"])))
...
moduleHeadToExpr = haskellSerdeDefinition "moduleHeadToExpr" $
  ...
  lambda "moduleHead" $ lets [
    ...
    Maybes.cases (var "mc") (var "head") (lambda "c" $ Serialization.newlineSep @@ (Lists.cons
...
moduleToExpr = haskellSerdeDefinition "moduleToExpr" $
  ...
  lambda "module" $ lets [
    ...
    "headerLine">: Maybes.cases (var "mh") (list ([] :: [TypedTerm Expr])) (lambda "h" $ list [moduleHeadToExpr @@ var "h"]),
  ...
  lambda "vb" $
    cases H._ValueBinding (var "vb") Nothing [
      H._ValueBinding_simple>>: lambda "simpleVB" $ lets [
        ...
        Maybes.cases (var "local") (var "body") (lambda "localBindings" $ lets [
