...
- **Generated coder output** — per-package directories under `dist/haskell/`
  ...
  - [`dist/haskell/hydra-ext/`](https://github.com/CategoricalData/hydra/tree/main/dist/haskell/hydra-ext/src/main/haskell) — long-tail coders (Avro, Protobuf, GraphQL, Cpp, Csharp, Go, Rust, Yaml, ...)
  - [`dist/haskell/hydra-coq/`](https://github.com/CategoricalData/hydra/tree/main/dist/haskell/hydra-coq/src/main/haskell), [`hydra-typescript/`](https://github.com/CategoricalData/hydra/tree/main/dist/haskell/hydra-typescript/src/main/haskell), [`hydra-wasm/`](https://github.com/CategoricalData/hydra/tree/main/dist/haskell/hydra-wasm/src/main/haskell) — additional targets
