...
def latlonRecord(lat: Float)(lon: Float): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record(hydra.test.testTypes.testTypeLatLonName, Seq(hydra.core.Field("lat", hydra.core.Term.literal(hydra.core.Literal.float(hydra.core.FloatValue.float32(lat)))), hydra.core.Field("lon", hydra.core.Term.literal(hydra.core.Literal.float(hydra.core.FloatValue.float32(lon)))))))

lazy val testDataArthur: hydra.core.Term = hydra.core.Term.record(hydra.core.Record(hydra.test.testTypes.testTypePersonName, Seq(hydra.core.Field("firstName", hydra.core.Term.literal(hydra.core.Literal.string("Arthur"))), hydra.core.Field("lastName", hydra.core.Term.literal(hydra.core.Literal.string("Dent"))), hydra.core.Field("age", hydra.core.Term.literal(hydra.core.Literal.integer(hydra.core.IntegerValue.int32(42)))))))
