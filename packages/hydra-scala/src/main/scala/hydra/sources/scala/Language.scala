    ...
    val body =
      Phantoms.let(Seq(
        ...
        Phantoms.field("floatTypes", Sets.fromList(Phantoms.list(
          KernelDsl.model.floatTypeFloat32,
          KernelDsl.model.floatTypeFloat64))),
        Phantoms.field("integerTypes", Sets.fromList(Phantoms.list(
          KernelDsl.model.integerTypeBigint,
          KernelDsl.model.integerTypeInt8,
          KernelDsl.model.integerTypeInt16,
          KernelDsl.model.integerTypeInt32,
          KernelDsl.model.integerTypeInt64,
          KernelDsl.model.integerTypeUint8,
          KernelDsl.model.integerTypeUint16,
          KernelDsl.model.integerTypeUint32,
          KernelDsl.model.integerTypeUint64))),
