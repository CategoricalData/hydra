...
checkRecordName :: TTermDefinition (InferenceContext -> Name -> Name -> Either Error ())
...
constructEdgeCoder :: TTermDefinition (InferenceContext -> Graph -> PG.VertexLabel -> PGM.Schema Graph t v -> Type -> t -> t -> PG.Direction -> Name -> [FieldType]
...
constructVertexCoder :: TTermDefinition (InferenceContext -> Graph -> PGM.Schema Graph t v -> Type -> t -> t -> Name -> [FieldType]
  -> [Adapter FieldType (PG.PropertyType t) Field (PG.Property v)]
  -> Either Error (Adapter Type (PG.ElementTypeTree t) Term (PG.ElementTree v)))
...
edgeIdAdapter :: TTermDefinition (InferenceContext -> Graph -> PGM.Schema Graph t v -> t -> Name -> Name -> [FieldType]
...
elementCoder :: TTermDefinition (Y.Maybe (PG.Direction, PG.VertexLabel) -> PGM.Schema Graph t v -> Type -> t -> t -> InferenceContext -> Graph
  -> Either Error (Adapter Type (PG.ElementTypeTree t) Term (PG.ElementTree v)))
...
encodeProperties :: TTermDefinition (InferenceContext -> M.Map Name Term -> [Adapter FieldType (PG.PropertyType t) Field (PG.Property v)]
...
encodeProperty :: TTermDefinition (InferenceContext -> M.Map Name Term -> Adapter FieldType (PG.PropertyType t) Field (PG.Property v)
...
findAdjacenEdgeAdapters :: TTermDefinition (InferenceContext -> Graph -> PGM.Schema Graph t v -> t -> t -> PG.VertexLabel -> PG.Direction -> [FieldType]
...
findIdProjectionSpec :: TTermDefinition (InferenceContext -> Bool -> Name -> Name -> [FieldType]
...
findIncidentVertexAdapter :: TTermDefinition (InferenceContext -> Graph -> PGM.Schema Graph t v -> t -> t -> (FieldType, PGM.ValueSpec, Y.Maybe String)
...
findLabelString :: TTermDefinition (InferenceContext -> Graph -> Type -> Name -> Name -> Either Error String)
...
findProjectionSpec :: TTermDefinition (InferenceContext -> Graph -> Name -> Name -> Name -> [FieldType]
  -> Either Error (Y.Maybe (FieldType, PGM.ValueSpec, Y.Maybe String)))
...
findPropertySpecs :: TTermDefinition (InferenceContext -> Graph -> PGM.Schema Graph t v -> PG.ElementKind -> [FieldType]
...
findSingleFieldWithAnnotationKey :: TTermDefinition (InferenceContext -> Name -> Name -> [FieldType]
...
projectionAdapter :: TTermDefinition (InferenceContext -> Graph -> t -> Coder Term v -> (FieldType, PGM.ValueSpec, Y.Maybe String) -> String
...
propertyAdapter :: TTermDefinition (InferenceContext -> Graph -> PGM.Schema Graph t v -> (FieldType, PGM.ValueSpec, Y.Maybe String)
...
selectEdgeId :: TTermDefinition (InferenceContext -> M.Map Name Term -> (Name, Adapter Type t Term v) -> Either Error v)
...
selectVertexId :: TTermDefinition (InferenceContext -> M.Map Name Term -> (Name, Adapter Type t Term v) -> Either Error v)
...
traverseToSingleTerm :: TTermDefinition (InferenceContext -> String -> (Term -> Either Error [Term]) -> Term -> Either Error Term)
...
vertexIdAdapter :: TTermDefinition (InferenceContext -> Graph -> PGM.Schema Graph t v -> t -> Name -> Name -> [FieldType]
  -> Either Error (Name, Adapter Type t Term v))
