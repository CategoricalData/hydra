...
func TypeClass (cx graph.Graph, raw core.Term) any {
      ...
      switch v := x.(type) {
        ...
        return func (inj core.Injection) any {
          return func () any {
            ...
            var variantMap any = libmaps.FromList([]any{[2]any{core.Name("equality"), func (input core.Term) any {
              return libeithers.Map(func (t struct{}) any {
                return classes.TypeClassEquality{Value: t}
              }).(func(any) any)(extracthelpers.DecodeUnit(cx, input))
            }}, [2]any{core.Name("ordering"), func (input core.Term) any {
              return libeithers.Map(func (t struct{}) any {
                return classes.TypeClassOrdering{Value: t}
              }).(func(any) any)(extracthelpers.DecodeUnit(cx, input))
            }}})
