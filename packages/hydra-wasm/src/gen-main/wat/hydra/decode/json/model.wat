(module
  ...
  (export "hydra.decode.json.model.value" (func $hydra.decode.json.model.value) )
  (func $hydra.decode.json.model.value (param $cx i32) (param $raw i32) (result i32)
  (local $b i32)
  (local $cx2 i32)
  (local $err i32)
  (local $f i32)
  ...
  local.get $t
  call $hydra.decode.json.model.value
  local.get $cx
  local.get $input
