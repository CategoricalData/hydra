...
module Hydra.Ext.Sources.Coq.Serde where
...
import qualified Hydra.Ext.Sources.Other.Coq               as CoqSyntax
...
import Hydra.Ast
import qualified Hydra.Ext.Fr.Inria.Coq.Syntax as C
...
ns :: Namespace
ns = Namespace "hydra.ext.coq.serde"
