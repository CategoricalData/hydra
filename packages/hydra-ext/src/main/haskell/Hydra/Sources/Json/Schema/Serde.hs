...
ns :: ModuleName
ns = ModuleName "hydra.ext.json.schema.serde"
...
jsonSchemaSyntaxNs = ModuleName "hydra.ext.json.schema.model"
...
jsonSchemaDocumentToString = define "jsonSchemaDocumentToString" $
  ...
  lambda "doc" $
    var "hydra.core.json.writer.printJson" @@ (jsonSchemaDocumentToJsonValue @@ var "doc")
