...
module_ :: Module
module_ = Module {
            moduleName = (ModuleName "hydra.ext.pegasus.language"),
            ...
            moduleMetadata = Bootstrap.descriptionMetadata (Just "Language constraints for LinkedIn Pegasus (PDL)")}
...
pdlLanguage = define "pdlLanguage" $
  ...
  Coders.language
    (Coders.languageName2 $ string "hydra.ext.pegasus.pdl")
    (Coders.languageConstraints2
      ...
      (wrap _FileExtension (string "pdl"))
