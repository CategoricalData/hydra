...
def encode_field(rname: hydra.core.Name, subject: hydra.ext.org.w3.rdf.syntax.Resource, field: hydra.core.Field, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.errors.Error, tuple[frozenlist[hydra.ext.org.w3.rdf.syntax.Triple], hydra.context.Context]]:
...
def encode_list(subj: hydra.ext.org.w3.rdf.syntax.Resource, terms: frozenlist[hydra.core.Term], cx0: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.errors.Error, tuple[frozenlist[hydra.ext.org.w3.rdf.syntax.Description], hydra.context.Context]]:
...
def encode_term(subject: hydra.ext.org.w3.rdf.syntax.Resource, term: hydra.core.Term, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.errors.Error, tuple[frozenlist[hydra.ext.org.w3.rdf.syntax.Description], hydra.context.Context]]:
...
def encode_field_type(rname: hydra.core.Name, order: Maybe[int], ft: hydra.core.FieldType, cx: T0) -> Either[hydra.errors.Error, hydra.ext.org.w3.shacl.model.Definition[hydra.ext.org.w3.shacl.model.PropertyShape]]:
    ...
    def for_type(mn: Maybe[int], mx: Maybe[int], t: hydra.core.Type) -> Either[hydra.errors.Error, hydra.ext.org.w3.shacl.model.Definition[hydra.ext.org.w3.shacl.model.PropertyShape]]:
        while True:
    ...
    def for_type_default(mn: Maybe[int], mx: Maybe[int], t: hydra.core.Type) -> Either[hydra.errors.Error, hydra.ext.org.w3.shacl.model.Definition[hydra.ext.org.w3.shacl.model.PropertyShape]]:
...
def encode_type(tname: hydra.core.Name, typ: hydra.core.Type, cx: T0) -> Either[hydra.errors.Error, hydra.ext.org.w3.shacl.model.CommonProperties]:
    r"""Encode a Hydra type as SHACL CommonProperties."""

    @lru_cache(1)
    def any() -> Either[T1, hydra.ext.org.w3.shacl.model.CommonProperties]:
        return Right(common(()))
...
def shacl_coder(mod: hydra.packaging.Module, cx: T0, g: hydra.graph.Graph) -> Either[hydra.errors.Error, tuple[hydra.ext.org.w3.shacl.model.ShapesGraph, T0]]:
    ...
    def to_shape(el: hydra.core.Binding) -> Either[hydra.errors.Error, hydra.ext.org.w3.shacl.model.Definition[hydra.ext.org.w3.shacl.model.Shape]]:
