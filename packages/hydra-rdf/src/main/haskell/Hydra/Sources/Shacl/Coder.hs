...
ns :: ModuleName
ns = ModuleName "hydra.rdf.shacl.coder"

module_ :: Module
module_ = Module {
            moduleName = ns,
            moduleDefinitions = definitions,
            moduleDependencies = Bootstrap.unqualifiedDep <$> ([Names.ns, Strip.ns, Annotations.ns, Constants.ns, ModuleName "hydra.core.decode.model", ExtractCore.ns, Formatting.ns, Lexical.ns, RdfUtils.ns, Rewriting.ns] L.++ (ShaclModel.ns:RdfSyntax.ns:KernelTypes.kernelTypesModuleNames)),
