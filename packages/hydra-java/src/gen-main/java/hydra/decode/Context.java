...
public interface Context {
  static hydra.util.Either<hydra.errors.DecodingError, hydra.context.Context> context(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<hydra.errors.DecodingError, hydra.util.Either<hydra.errors.DecodingError, hydra.context.Context>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.context.Context>left(err)),
  ...
  static <T0> hydra.util.Either<hydra.errors.DecodingError, hydra.context.InContext<T0>> inContext(java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, T0>>> e, hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<hydra.errors.DecodingError, hydra.util.Either<hydra.errors.DecodingError, hydra.context.InContext<T0>>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.context.InContext<T0>>left(err)),
