...
public class Pat_Bind implements Serializable, Comparable<Pat_Bind> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Pat_Bind");
  ...
  public Pat_Bind (hydra.ext.scala.syntax.Pat lhs, hydra.ext.scala.syntax.Pat rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public Pat_Bind withRhs(hydra.ext.scala.syntax.Pat rhs) {
    return new Pat_Bind(lhs, rhs);
  }
}
