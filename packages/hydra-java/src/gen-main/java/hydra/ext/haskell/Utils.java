...
public interface Utils {
  static hydra.ext.haskell.syntax.Pattern applicationPattern(hydra.ext.haskell.syntax.Name name, java.util.List<hydra.ext.haskell.syntax.Pattern> args) {
    return new hydra.ext.haskell.syntax.Pattern.Application(new hydra.ext.haskell.syntax.ApplicationPattern(name, args));
  }

  static hydra.ext.haskell.syntax.Name elementReference(hydra.packaging.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Name name) {
    ...
    hydra.util.Lazy<hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>> namespacePair = new hydra.util.Lazy<>(() -> ((java.util.function.Function<hydra.packaging.Namespaces<hydra.ext.haskell.syntax.ModuleName>, hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>>) (projected -> projected.focus)).apply(namespaces));
    ...
    hydra.util.Lazy<java.util.Map<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>> namespacesMap = new hydra.util.Lazy<>(() -> ((java.util.function.Function<hydra.packaging.Namespaces<hydra.ext.haskell.syntax.ModuleName>, java.util.Map<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>>) (projected -> projected.mapping)).apply(namespaces));
    return hydra.lib.maybes.Cases.applyLazy(
      (qname).namespace,
      () -> hydra.ext.haskell.Utils.simpleName(local),
      (java.util.function.Function<hydra.packaging.Namespace, hydra.ext.haskell.syntax.Name>) (ns -> hydra.lib.maybes.Cases.applyLazy(
        ...
        (java.util.function.Function<hydra.ext.haskell.syntax.ModuleName, hydra.ext.haskell.syntax.Name>) (mn -> {
          ...
          return hydra.lib.logic.IfElse.lazy(
            ...
            () -> hydra.ext.haskell.Utils.rawName(hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
              aliasStr,
              ".",
  ...
  static hydra.ext.haskell.syntax.Expression hslambda(hydra.ext.haskell.syntax.Name name, hydra.ext.haskell.syntax.Expression rhs) {
    return new hydra.ext.haskell.syntax.Expression.Lambda(new hydra.ext.haskell.syntax.LambdaExpression(java.util.Arrays.asList(new hydra.ext.haskell.syntax.Pattern.Name(name)), rhs));
  }
  ...
  static <T0> hydra.util.Either<hydra.errors.Error_, hydra.packaging.Namespaces<hydra.ext.haskell.syntax.ModuleName>> namespacesForModule(hydra.packaging.Module mod, T0 cx, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<java.util.Set<hydra.packaging.Namespace>, hydra.util.Either<hydra.errors.Error_, hydra.packaging.Namespaces<hydra.ext.haskell.syntax.ModuleName>>>) (nss -> {
        ...
        java.util.function.Function<hydra.packaging.Namespace, hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>> toPair = (java.util.function.Function<hydra.packaging.Namespace, hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>>) (name -> (hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>) ((hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>) (new hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>(name, (toModuleName).apply(name)))));
        hydra.util.Lazy<java.util.List<hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>>> nssPairs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
          toPair,
          nssAsList.get()));
        hydra.util.Lazy<hydra.util.Pair<java.util.Map<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName>, java.util.Set<hydra.ext.haskell.syntax.ModuleName>>> finalState = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
          p0 -> p1 -> hydra.ext.haskell.Utils.<hydra.packaging.Namespace>namespacesForModule_addPair(
            p0,
            p1),
          hydra.ext.haskell.Utils.<hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName, hydra.ext.haskell.syntax.ModuleName>namespacesForModule_emptyState(),
          nssPairs.get()));
  ...
  static hydra.ext.haskell.syntax.Name rawName(String n) {
    return new hydra.ext.haskell.syntax.Name.Normal(new hydra.ext.haskell.syntax.QualifiedName((java.util.List<hydra.ext.haskell.syntax.NamePart>) (java.util.Collections.<hydra.ext.haskell.syntax.NamePart>emptyList()), new hydra.ext.haskell.syntax.NamePart(n)));
  }

  static hydra.ext.haskell.syntax.Name recordFieldReference(hydra.packaging.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Name sname, hydra.core.Name fname) {
  ...
  static hydra.ext.haskell.syntax.ValueBinding simpleValueBinding(hydra.ext.haskell.syntax.Name hname, hydra.ext.haskell.syntax.Expression rhs, hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings> bindings) {
    hydra.util.Lazy<hydra.ext.haskell.syntax.Pattern> pat = new hydra.util.Lazy<>(() -> new hydra.ext.haskell.syntax.Pattern.Application(new hydra.ext.haskell.syntax.ApplicationPattern(hname, (java.util.List<hydra.ext.haskell.syntax.Pattern>) (java.util.Collections.<hydra.ext.haskell.syntax.Pattern>emptyList()))));
  ...
  static hydra.ext.haskell.syntax.Type toTypeApplication(java.util.List<hydra.ext.haskell.syntax.Type> types) {
    java.util.concurrent.atomic.AtomicReference<java.util.function.Function<java.util.List<hydra.ext.haskell.syntax.Type>, hydra.ext.haskell.syntax.Type>> app = new java.util.concurrent.atomic.AtomicReference<>();
    app.set((java.util.function.Function<java.util.List<hydra.ext.haskell.syntax.Type>, hydra.ext.haskell.syntax.Type>) (l -> hydra.lib.logic.IfElse.lazy(
  ...
  static hydra.ext.haskell.syntax.Name unionFieldReference(java.util.Set<hydra.core.Name> boundNames, hydra.packaging.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Name sname, hydra.core.Name fname) {
    String fnameStr = (fname).value;
  ...
  static hydra.util.Pair<java.util.List<hydra.core.Name>, hydra.core.Type> unpackForallType(hydra.core.Type t) {
    return hydra.Strip.deannotateType(t).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public hydra.util.Pair<java.util.List<hydra.core.Name>, hydra.core.Type> visit(hydra.core.Type.Forall fat) {
        ...
        hydra.util.Pair<java.util.List<hydra.core.Name>, hydra.core.Type> recursiveResult = hydra.ext.haskell.Utils.unpackForallType(tbody);
