...
module_ = Module {
            ...
            moduleDependencies = Bootstrap.unqualifiedDep <$> ([PyNames.ns, PySerde.ns, Serialization.ns, Analysis.ns] L.++ (PyEnvironmentSource.ns:PySyntax.ns:KernelTypes.kernelTypesNamespaces)),
