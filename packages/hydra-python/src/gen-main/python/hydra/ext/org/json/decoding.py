...
def decode_optional_field(decode_value: Callable[[T0], Either[T1, T2]], name: T3, m: FrozenDict[T3, T0]) -> Either[T1, Maybe[T2]]:
...
def decode_field(decode_value: Callable[[T0], Either[str, T1]], name: str, m: FrozenDict[str, T0]):
