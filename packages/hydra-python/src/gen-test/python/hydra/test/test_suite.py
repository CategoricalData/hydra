...
import hydra.test.dependencies
import hydra.test.differentiation
import hydra.test.eta_expansion
import hydra.test.formatting
import hydra.test.hoisting.all
...
import hydra.test.strip
import hydra.test.substitution
import hydra.test.unification
import hydra.test.validate.all
import hydra.test.variables
...
def all_tests():
    ...
    return hydra.testing.TestGroup("common", Nothing(), (hydra.test.lib.chars.all_tests(), hydra.test.lib.eithers.all_tests(), hydra.test.lib.equality.all_tests(), hydra.test.lib.lists.all_tests(), hydra.test.lib.literals.all_tests(), hydra.test.lib.logic.all_tests(), hydra.test.lib.maps.all_tests(), hydra.test.lib.math.all_tests(), hydra.test.lib.maybes.all_tests(), hydra.test.lib.pairs.all_tests(), hydra.test.lib.regex.all_tests(), hydra.test.lib.sets.all_tests(), hydra.test.lib.strings.all_tests(), hydra.test.annotations.all_tests(), hydra.test.checking.all.all_tests(), hydra.test.dependencies.all_tests(), hydra.test.differentiation.all_tests(), hydra.test.eta_expansion.all_tests(), hydra.test.formatting.all_tests(), hydra.test.hoisting.all.all_tests(), hydra.test.inference.all.all_tests(), hydra.test.json.roundtrip.all_tests(), hydra.test.json.writer.all_tests(), hydra.test.reduction.all_tests(), hydra.test.rewriting.all_tests(), hydra.test.serialization.all_tests(), hydra.test.sorting.all_tests(), hydra.test.strip.all_tests(), hydra.test.substitution.all_tests(), hydra.test.unification.all_tests(), hydra.test.validate.all.all_tests(), hydra.test.variables.all_tests()), ())
