...
(defvar hydra_annotations_debug_if (lambda (cx) (lambda (debug_id) (lambda (message) ((hydra_lib_eithers_bind (hydra_annotations_get_debug_id cx)) (lambda (mid) (if ((hydra_lib_equality_equal mid) debug_id) (list :left (make-hydra_context_in_context (list :other message) cx)) (list :right nil))))))))
