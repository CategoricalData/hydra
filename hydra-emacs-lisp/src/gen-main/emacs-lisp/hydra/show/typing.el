...
(defvar hydra_show_typing_type_constraint (lambda (tc) (let* ((ltyp ((lambda (v) (hydra_typing_type_constraint-left v)) tc)) (rtyp ((lambda (v) (hydra_typing_type_constraint-right v)) tc))) (hydra_lib_strings_cat (list (hydra_show_core_type ltyp) "≡" (hydra_show_core_type rtyp))))))
