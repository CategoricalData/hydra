...
(defvar hydra_test_test_terms_test_element_arthur (make-hydra_core_binding "firstName" hydra_test_test_terms_test_data_arthur (make-hydra_core_type_scheme (list) (list :variable hydra_test_test_types_test_type_person_name) nil)))

(defvar hydra_test_test_terms_test_element_first_name (make-hydra_core_binding "firstName" (list :function (list :elimination (list :record (make-hydra_core_projection hydra_test_test_types_test_type_person_name "firstName")))) (make-hydra_core_type_scheme (list) (list :function (make-hydra_core_function_type (list :variable hydra_test_test_types_test_type_person_name) (list :literal (list :string nil)))) nil)))
