...
popStackUntil :: Topology.Vertex -> Topology.TarjanState -> ([Topology.Vertex], Topology.TarjanState)
popStackUntil v st0 =
...
strongConnect :: M.Map Topology.Vertex [Topology.Vertex] -> Topology.Vertex -> Topology.TarjanState -> Topology.TarjanState
