...
stronglyConnectedComponents :: (M.Map Int [Int] -> [[Topology.Vertex]])
...
strongConnect graph v = (Flows.bind Errors.getState (\st ->  
  let i = (Topology.tarjanStateCounter st) 
      newSt = Topology.TarjanState {
              ...
              Topology.tarjanStateIndices = (Topology.tarjanStateIndices (Topology.TarjanState {
                Topology.tarjanStateCounter = (Topology.tarjanStateCounter (Topology.TarjanState {
                  Topology.tarjanStateCounter = (Topology.tarjanStateCounter (Topology.TarjanState {
                    Topology.tarjanStateCounter = (Topology.tarjanStateCounter (Topology.TarjanState {
                      Topology.tarjanStateCounter = (Topology.tarjanStateCounter st),
                      Topology.tarjanStateIndices = (Topology.tarjanStateIndices st),
                      Topology.tarjanStateLowLinks = (Topology.tarjanStateLowLinks st),
                      Topology.tarjanStateStack = (Topology.tarjanStateStack st),
                    ...
                    Topology.tarjanStateIndices = (Topology.tarjanStateIndices (Topology.TarjanState {
                      ...
                      Topology.tarjanStateOnStack = (Sets.insert v (Topology.tarjanStateOnStack st)),
                      Topology.tarjanStateSccs = (Topology.tarjanStateSccs st)})),
                    Topology.tarjanStateLowLinks = (Topology.tarjanStateLowLinks (Topology.TarjanState {
                      Topology.tarjanStateCounter = (Topology.tarjanStateCounter st),
                      Topology.tarjanStateIndices = (Topology.tarjanStateIndices st),
                      Topology.tarjanStateLowLinks = (Topology.tarjanStateLowLinks st),
                      Topology.tarjanStateStack = (Topology.tarjanStateStack st),
                    ...
                    Topology.tarjanStateOnStack = (Topology.tarjanStateOnStack (Topology.TarjanState {
                      Topology.tarjanStateCounter = (Topology.tarjanStateCounter st),
                      Topology.tarjanStateIndices = (Topology.tarjanStateIndices st),
                      Topology.tarjanStateLowLinks = (Topology.tarjanStateLowLinks st),
                      Topology.tarjanStateStack = (Topology.tarjanStateStack st),
                      Topology.tarjanStateOnStack = (Sets.insert v (Topology.tarjanStateOnStack st)),
                      Topology.tarjanStateSccs = (Topology.tarjanStateSccs st)})),
                    Topology.tarjanStateSccs = (Topology.tarjanStateSccs (Topology.TarjanState {
                      Topology.tarjanStateCounter = (Topology.tarjanStateCounter st),
                      Topology.tarjanStateIndices = (Topology.tarjanStateIndices st),
                      Topology.tarjanStateLowLinks = (Topology.tarjanStateLowLinks st),
                      Topology.tarjanStateStack = (Topology.tarjanStateStack st),
                  ...
                  Topology.tarjanStateStack = (Topology.tarjanStateStack (Topology.TarjanState {
                    Topology.tarjanStateCounter = (Topology.tarjanStateCounter (Topology.TarjanState {
                      Topology.tarjanStateCounter = (Topology.tarjanStateCounter st),
                      Topology.tarjanStateIndices = (Topology.tarjanStateIndices st),
                      Topology.tarjanStateLowLinks = (Topology.tarjanStateLowLinks st),
