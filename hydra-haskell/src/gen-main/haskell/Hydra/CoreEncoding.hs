-- | Implementation of LambdaGraph's epsilon encoding, which maps hydra/core constructs  embedded in a language like Haskell or Java to their language-agnostic representation as terms
