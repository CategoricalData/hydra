...
module Hydra.Ext.Parquet.Format where
...
_Type = (Core.Name "hydra/ext/parquet/format.Type")
...
_FieldRepetitionType = (Core.Name "hydra/ext/parquet/format.FieldRepetitionType")
...
_Statistics = (Core.Name "hydra/ext/parquet/format.Statistics")
...
_DecimalType = (Core.Name "hydra/ext/parquet/format.DecimalType")
...
_TimeUnit = (Core.Name "hydra/ext/parquet/format.TimeUnit")
...
_TimestampType = (Core.Name "hydra/ext/parquet/format.TimestampType")
...
_TimeType = (Core.Name "hydra/ext/parquet/format.TimeType")
...
_IntType = (Core.Name "hydra/ext/parquet/format.IntType")
...
_LogicalType = (Core.Name "hydra/ext/parquet/format.LogicalType")
...
_SchemaElement = (Core.Name "hydra/ext/parquet/format.SchemaElement")
...
_Encoding = (Core.Name "hydra/ext/parquet/format.Encoding")
...
_CompressionCodec = (Core.Name "hydra/ext/parquet/format.CompressionCodec")
...
_PageType = (Core.Name "hydra/ext/parquet/format.PageType")
...
_BoundaryOrder = (Core.Name "hydra/ext/parquet/format.BoundaryOrder")
...
_DataPageHeader = (Core.Name "hydra/ext/parquet/format.DataPageHeader")
...
_IndexPageHeader = (Core.Name "hydra/ext/parquet/format.IndexPageHeader")
...
_DictionaryPageHeader = (Core.Name "hydra/ext/parquet/format.DictionaryPageHeader")
...
_DataPageHeaderV2 = (Core.Name "hydra/ext/parquet/format.DataPageHeaderV2")
...
_BloomFilterAlgorithm = (Core.Name "hydra/ext/parquet/format.BloomFilterAlgorithm")
...
_BloomFilterHash = (Core.Name "hydra/ext/parquet/format.BloomFilterHash")
...
_BloomFilterCompression = (Core.Name "hydra/ext/parquet/format.BloomFilterCompression")
...
_BloomFilterHeader = (Core.Name "hydra/ext/parquet/format.BloomFilterHeader")
...
_PageHeader = (Core.Name "hydra/ext/parquet/format.PageHeader")
...
_KeyValue = (Core.Name "hydra/ext/parquet/format.KeyValue")
...
_SortingColumn = (Core.Name "hydra/ext/parquet/format.SortingColumn")
...
_PageEncodingStats = (Core.Name "hydra/ext/parquet/format.PageEncodingStats")
...
data ColumnMetaData = 
  ColumnMetaData {
    ...
    columnMetaDataNumValues :: Integer,
    -- | total byte size of all uncompressed pages in this column chunk (including the headers)
    columnMetaDataTotalUncompressedSize :: Integer,
    -- | total byte size of all compressed, and potentially encrypted, pages in this column chunk (including the headers)
    columnMetaDataTotalCompressedSize :: Integer,
    -- | Optional key/value metadata
    columnMetaDataKeyValueMetadata :: (Maybe [KeyValue]),
    -- | Byte offset from beginning of file to first data page
    columnMetaDataDataPageOffset :: Integer,
    -- | Byte offset from beginning of file to root index page
    columnMetaDataIndexPageOffset :: (Maybe Integer),
    -- | Byte offset from the beginning of file to first (only) dictionary page
    columnMetaDataDictionaryPageOffset :: (Maybe Integer),
    ...
    columnMetaDataBloomFilterOffset :: (Maybe Integer)}
  deriving (Eq, Ord, Read, Show)

_ColumnMetaData = (Core.Name "hydra/ext/parquet/format.ColumnMetaData")
...
_EncryptionWithFooterKey = (Core.Name "hydra/ext/parquet/format.EncryptionWithFooterKey")
...
_EncryptionWithColumnKey = (Core.Name "hydra/ext/parquet/format.EncryptionWithColumnKey")
...
_ColumnCryptoMetaData = (Core.Name "hydra/ext/parquet/format.ColumnCryptoMetaData")
...
data ColumnChunk = 
  ColumnChunk {
    ...
    columnChunkOffsetIndexOffset :: (Maybe Integer),
    -- | Size of ColumnChunk's OffsetIndex, in bytes
    columnChunkOffsetIndexLength :: (Maybe Int),
    -- | File offset of ColumnChunk's ColumnIndex
    columnChunkColumnIndexOffset :: (Maybe Integer),
...
_ColumnChunk = (Core.Name "hydra/ext/parquet/format.ColumnChunk")
...
data RowGroup = 
  RowGroup {
    ...
    rowGroupTotalByteSize :: Integer,
    -- | Number of rows in this row group
    rowGroupNumRows :: Integer,
    ...
    rowGroupFileOffset :: (Maybe Integer),
    -- | Total byte size of all compressed (and potentially encrypted) column data in this row group
    rowGroupTotalCompressedSize :: (Maybe Integer),
    -- | Row group ordinal in the file
    rowGroupOrdinal :: (Maybe Int)}
  deriving (Eq, Ord, Read, Show)

_RowGroup = (Core.Name "hydra/ext/parquet/format.RowGroup")
...
_ColumnOrder = (Core.Name "hydra/ext/parquet/format.ColumnOrder")
...
data PageLocation = 
  PageLocation {
    ...
    pageLocationFirstRowIndex :: Integer}
  deriving (Eq, Ord, Read, Show)

_PageLocation = (Core.Name "hydra/ext/parquet/format.PageLocation")
...
_OffsetIndex = (Core.Name "hydra/ext/parquet/format.OffsetIndex")
...
data ColumnIndex = 
  ColumnIndex {
    ...
    columnIndexNullCounts :: (Maybe [Integer])}
  deriving (Eq, Ord, Read, Show)

_ColumnIndex = (Core.Name "hydra/ext/parquet/format.ColumnIndex")
...
_AesGcmV1 = (Core.Name "hydra/ext/parquet/format.AesGcmV1")
...
_AesGcmCtrV1 = (Core.Name "hydra/ext/parquet/format.AesGcmCtrV1")
...
_EncryptionAlgorithm = (Core.Name "hydra/ext/parquet/format.EncryptionAlgorithm")
...
_FileMetaData = (Core.Name "hydra/ext/parquet/format.FileMetaData")
...
_FileCryptoMetaData = (Core.Name "hydra/ext/parquet/format.FileCryptoMetaData")
