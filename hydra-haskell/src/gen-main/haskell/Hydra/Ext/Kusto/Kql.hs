...
module Hydra.Ext.Kusto.Kql where
...
_BetweenExpression = (Core.Name "hydra/ext/kusto/kql.BetweenExpression")
...
_BinaryExpression = (Core.Name "hydra/ext/kusto/kql.BinaryExpression")
...
_BinaryOperator = (Core.Name "hydra/ext/kusto/kql.BinaryOperator")
...
_BuiltInFunction = (Core.Name "hydra/ext/kusto/kql.BuiltInFunction")
...
_ColumnAlias = (Core.Name "hydra/ext/kusto/kql.ColumnAlias")
...
_ColumnAssignment = (Core.Name "hydra/ext/kusto/kql.ColumnAssignment")
...
_ColumnName = (Core.Name "hydra/ext/kusto/kql.ColumnName")
...
_Columns = (Core.Name "hydra/ext/kusto/kql.Columns")
...
_Command = (Core.Name "hydra/ext/kusto/kql.Command")
...
_Datetime = (Core.Name "hydra/ext/kusto/kql.Datetime")
...
_Duration = (Core.Name "hydra/ext/kusto/kql.Duration")
...
_DurationUnit = (Core.Name "hydra/ext/kusto/kql.DurationUnit")
...
_Expression = (Core.Name "hydra/ext/kusto/kql.Expression")
...
_Function = (Core.Name "hydra/ext/kusto/kql.Function")
...
_FunctionExpression = (Core.Name "hydra/ext/kusto/kql.FunctionExpression")
...
_FunctionName = (Core.Name "hydra/ext/kusto/kql.FunctionName")
...
_IndexExpression = (Core.Name "hydra/ext/kusto/kql.IndexExpression")
...
_JoinCommand = (Core.Name "hydra/ext/kusto/kql.JoinCommand")
...
_JoinKind = (Core.Name "hydra/ext/kusto/kql.JoinKind")
...
_KeyValuePair = (Core.Name "hydra/ext/kusto/kql.KeyValuePair")
...
_LetBinding = (Core.Name "hydra/ext/kusto/kql.LetBinding")
...
_LetExpression = (Core.Name "hydra/ext/kusto/kql.LetExpression")
...
_Literal = (Core.Name "hydra/ext/kusto/kql.Literal")
...
_Order = (Core.Name "hydra/ext/kusto/kql.Order")
...
_Parameter = (Core.Name "hydra/ext/kusto/kql.Parameter")
...
_ParseCommand = (Core.Name "hydra/ext/kusto/kql.ParseCommand")
...
_PipelineExpression = (Core.Name "hydra/ext/kusto/kql.PipelineExpression")
...
_PrintCommand = (Core.Name "hydra/ext/kusto/kql.PrintCommand")
...
_Projection = (Core.Name "hydra/ext/kusto/kql.Projection")
...
_PropertyExpression = (Core.Name "hydra/ext/kusto/kql.PropertyExpression")
...
_Query = (Core.Name "hydra/ext/kusto/kql.Query")
...
_SearchCommand = (Core.Name "hydra/ext/kusto/kql.SearchCommand")
...
_SummarizeCommand = (Core.Name "hydra/ext/kusto/kql.SummarizeCommand")
...
_TableName = (Core.Name "hydra/ext/kusto/kql.TableName")
...
_TopCommand = (Core.Name "hydra/ext/kusto/kql.TopCommand")
...
_SortBy = (Core.Name "hydra/ext/kusto/kql.SortBy")
...
_TabularExpression = (Core.Name "hydra/ext/kusto/kql.TabularExpression")
...
_UnaryExpression = (Core.Name "hydra/ext/kusto/kql.UnaryExpression")
...
_UnaryOperator = (Core.Name "hydra/ext/kusto/kql.UnaryOperator")
...
_UnionCommand = (Core.Name "hydra/ext/kusto/kql.UnionCommand")
...
_UnionKind = (Core.Name "hydra/ext/kusto/kql.UnionKind")
