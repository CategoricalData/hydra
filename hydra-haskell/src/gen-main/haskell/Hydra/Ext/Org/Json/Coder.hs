...
jsonCoder :: (Core.Type -> Context.Context -> Graph.Graph -> Either (Context.InContext Error.Error) (Compute.Coder Core.Term Model.Value))
jsonCoder typ cx g =  
...
recordCoder :: (Core.RowType -> Context.Context -> Graph.Graph -> Either (Context.InContext Error.Error) (Compute.Coder Core.Term Model.Value))
recordCoder rt cx g =  
...
encodeRecord :: ([(Core.FieldType, (Compute.Coder Core.Term Model.Value))] -> Context.Context -> Graph.Graph -> Core.Term -> Either (Context.InContext Error.Error) Model.Value)
...
decodeRecord :: (Core.RowType -> [(Core.FieldType, (Compute.Coder Core.Term Model.Value))] -> Context.Context -> Model.Value -> Either (Context.InContext Error.Error) Core.Term)
...
termCoder :: (Core.Type -> Context.Context -> Graph.Graph -> Either (Context.InContext Error.Error) (Compute.Coder Core.Term Model.Value))
termCoder typ cx g =  
