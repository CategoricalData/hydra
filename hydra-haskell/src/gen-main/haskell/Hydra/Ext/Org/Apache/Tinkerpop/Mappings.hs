...
module Hydra.Ext.Org.Apache.Tinkerpop.Mappings where
...
_AnnotationSchema = (Core.Name "hydra/ext/org/apache/tinkerpop/mappings.AnnotationSchema")
...
_EdgeSpec = (Core.Name "hydra/ext/org/apache/tinkerpop/mappings.EdgeSpec")
...
_ElementSpec = (Core.Name "hydra/ext/org/apache/tinkerpop/mappings.ElementSpec")
...
_PropertySpec = (Core.Name "hydra/ext/org/apache/tinkerpop/mappings.PropertySpec")
...
_Schema = (Core.Name "hydra/ext/org/apache/tinkerpop/mappings.Schema")
...
_ValueSpec = (Core.Name "hydra/ext/org/apache/tinkerpop/mappings.ValueSpec")
...
_VertexSpec = (Core.Name "hydra/ext/org/apache/tinkerpop/mappings.VertexSpec")
