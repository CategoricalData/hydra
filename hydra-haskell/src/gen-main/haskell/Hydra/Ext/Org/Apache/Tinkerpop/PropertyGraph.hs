...
module Hydra.Ext.Org.Apache.Tinkerpop.PropertyGraph where
...
_Direction = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.Direction")
...
_Edge = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.Edge")
...
_EdgeLabel = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.EdgeLabel")
...
_EdgeType = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.EdgeType")
...
_Element = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.Element")
...
_ElementKind = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.ElementKind")
...
_ElementTree = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.ElementTree")
...
_ElementType = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.ElementType")
...
_ElementTypeTree = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.ElementTypeTree")
...
_Graph = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.Graph")
...
_GraphSchema = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.GraphSchema")
...
_Label = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.Label")
...
_Property = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.Property")
...
_PropertyKey = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.PropertyKey")
...
_PropertyType = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.PropertyType")
...
_Vertex = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.Vertex")
...
_VertexLabel = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.VertexLabel")
...
_VertexType = (Core.Name "hydra/ext/org/apache/tinkerpop/propertyGraph.VertexType")
