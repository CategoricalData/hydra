...
_Ontology = (Core.Name "hydra/ext/owl/syntax.Ontology")
...
_Declaration = (Core.Name "hydra/ext/owl/syntax.Declaration")
...
_Entity = (Core.Name "hydra/ext/owl/syntax.Entity")
...
_AnnotationSubject = (Core.Name "hydra/ext/owl/syntax.AnnotationSubject")
...
_AnnotationValue = (Core.Name "hydra/ext/owl/syntax.AnnotationValue")
...
_Annotation = (Core.Name "hydra/ext/owl/syntax.Annotation")
...
_AnnotationAxiom = (Core.Name "hydra/ext/owl/syntax.AnnotationAxiom")
...
_AnnotationAssertion = (Core.Name "hydra/ext/owl/syntax.AnnotationAssertion")
...
_SubAnnotationPropertyOf = (Core.Name "hydra/ext/owl/syntax.SubAnnotationPropertyOf")
...
_AnnotationPropertyDomain = (Core.Name "hydra/ext/owl/syntax.AnnotationPropertyDomain")
...
_AnnotationPropertyRange = (Core.Name "hydra/ext/owl/syntax.AnnotationPropertyRange")
...
_Datatype = (Core.Name "hydra/ext/owl/syntax.Datatype")
...
_ObjectProperty = (Core.Name "hydra/ext/owl/syntax.ObjectProperty")

data DataProperty 
  = DataProperty {}
  deriving (Eq, Ord, Read, Show)

_DataProperty = (Core.Name "hydra/ext/owl/syntax.DataProperty")

data AnnotationProperty 
  = AnnotationProperty {}
  deriving (Eq, Ord, Read, Show)

_AnnotationProperty = (Core.Name "hydra/ext/owl/syntax.AnnotationProperty")
...
_Individual = (Core.Name "hydra/ext/owl/syntax.Individual")
...
_NamedIndividual = (Core.Name "hydra/ext/owl/syntax.NamedIndividual")

data AnonymousIndividual 
  = AnonymousIndividual {}
  deriving (Eq, Ord, Read, Show)

_AnonymousIndividual = (Core.Name "hydra/ext/owl/syntax.AnonymousIndividual")
...
_ObjectPropertyExpression = (Core.Name "hydra/ext/owl/syntax.ObjectPropertyExpression")
...
_InverseObjectProperty = (Core.Name "hydra/ext/owl/syntax.InverseObjectProperty")
...
_DataRange = (Core.Name "hydra/ext/owl/syntax.DataRange")
...
_DatatypeRestriction = (Core.Name "hydra/ext/owl/syntax.DatatypeRestriction")
...
_DatatypeRestriction_Constraint = (Core.Name "hydra/ext/owl/syntax.DatatypeRestriction.Constraint")
...
_DatatypeRestriction_ConstrainingFacet = (Core.Name "hydra/ext/owl/syntax.DatatypeRestriction.ConstrainingFacet")
...
_ClassExpression = (Core.Name "hydra/ext/owl/syntax.ClassExpression")
...
_ObjectIntersectionOf = (Core.Name "hydra/ext/owl/syntax.ObjectIntersectionOf")
...
_ObjectUnionOf = (Core.Name "hydra/ext/owl/syntax.ObjectUnionOf")
...
_ObjectComplementOf = (Core.Name "hydra/ext/owl/syntax.ObjectComplementOf")
...
_ObjectOneOf = (Core.Name "hydra/ext/owl/syntax.ObjectOneOf")
...
_ObjectSomeValuesFrom = (Core.Name "hydra/ext/owl/syntax.ObjectSomeValuesFrom")
...
_ObjectAllValuesFrom = (Core.Name "hydra/ext/owl/syntax.ObjectAllValuesFrom")
...
_ObjectHasValue = (Core.Name "hydra/ext/owl/syntax.ObjectHasValue")
...
_ObjectMinCardinality = (Core.Name "hydra/ext/owl/syntax.ObjectMinCardinality")
...
_ObjectMaxCardinality = (Core.Name "hydra/ext/owl/syntax.ObjectMaxCardinality")
...
_ObjectExactCardinality = (Core.Name "hydra/ext/owl/syntax.ObjectExactCardinality")
...
_DataSomeValuesFrom = (Core.Name "hydra/ext/owl/syntax.DataSomeValuesFrom")
...
_DataAllValuesFrom = (Core.Name "hydra/ext/owl/syntax.DataAllValuesFrom")
...
_DataHasValue = (Core.Name "hydra/ext/owl/syntax.DataHasValue")
...
_DataMinCardinality = (Core.Name "hydra/ext/owl/syntax.DataMinCardinality")
...
_DataMaxCardinality = (Core.Name "hydra/ext/owl/syntax.DataMaxCardinality")
...
_DataExactCardinality = (Core.Name "hydra/ext/owl/syntax.DataExactCardinality")
...
_Axiom = (Core.Name "hydra/ext/owl/syntax.Axiom")
...
_ClassAxiom = (Core.Name "hydra/ext/owl/syntax.ClassAxiom")
...
_SubClassOf = (Core.Name "hydra/ext/owl/syntax.SubClassOf")
...
_EquivalentClasses = (Core.Name "hydra/ext/owl/syntax.EquivalentClasses")
...
_DisjointClasses = (Core.Name "hydra/ext/owl/syntax.DisjointClasses")
...
_DisjointUnion = (Core.Name "hydra/ext/owl/syntax.DisjointUnion")
...
_ObjectPropertyAxiom = (Core.Name "hydra/ext/owl/syntax.ObjectPropertyAxiom")
...
_SubObjectPropertyOf = (Core.Name "hydra/ext/owl/syntax.SubObjectPropertyOf")
...
_EquivalentObjectProperties = (Core.Name "hydra/ext/owl/syntax.EquivalentObjectProperties")
...
_DisjointObjectProperties = (Core.Name "hydra/ext/owl/syntax.DisjointObjectProperties")
...
_ObjectPropertyDomain = (Core.Name "hydra/ext/owl/syntax.ObjectPropertyDomain")
...
_ObjectPropertyRange = (Core.Name "hydra/ext/owl/syntax.ObjectPropertyRange")
...
_InverseObjectProperties = (Core.Name "hydra/ext/owl/syntax.InverseObjectProperties")
...
_FunctionalObjectProperty = (Core.Name "hydra/ext/owl/syntax.FunctionalObjectProperty")
...
_InverseFunctionalObjectProperty = (Core.Name "hydra/ext/owl/syntax.InverseFunctionalObjectProperty")
...
_ReflexiveObjectProperty = (Core.Name "hydra/ext/owl/syntax.ReflexiveObjectProperty")
...
_IrreflexiveObjectProperty = (Core.Name "hydra/ext/owl/syntax.IrreflexiveObjectProperty")
...
_SymmetricObjectProperty = (Core.Name "hydra/ext/owl/syntax.SymmetricObjectProperty")
...
_AsymmetricObjectProperty = (Core.Name "hydra/ext/owl/syntax.AsymmetricObjectProperty")
...
_TransitiveObjectProperty = (Core.Name "hydra/ext/owl/syntax.TransitiveObjectProperty")
...
_DataPropertyAxiom = (Core.Name "hydra/ext/owl/syntax.DataPropertyAxiom")
...
_SubDataPropertyOf = (Core.Name "hydra/ext/owl/syntax.SubDataPropertyOf")
...
_EquivalentDataProperties = (Core.Name "hydra/ext/owl/syntax.EquivalentDataProperties")
...
_DisjointDataProperties = (Core.Name "hydra/ext/owl/syntax.DisjointDataProperties")
...
_DataPropertyDomain = (Core.Name "hydra/ext/owl/syntax.DataPropertyDomain")
...
_DataPropertyRange = (Core.Name "hydra/ext/owl/syntax.DataPropertyRange")
...
_FunctionalDataProperty = (Core.Name "hydra/ext/owl/syntax.FunctionalDataProperty")
...
_DatatypeDefinition = (Core.Name "hydra/ext/owl/syntax.DatatypeDefinition")
...
_HasKey = (Core.Name "hydra/ext/owl/syntax.HasKey")
...
_Assertion = (Core.Name "hydra/ext/owl/syntax.Assertion")
...
_SameIndividual = (Core.Name "hydra/ext/owl/syntax.SameIndividual")
...
_DifferentIndividuals = (Core.Name "hydra/ext/owl/syntax.DifferentIndividuals")
...
_ClassAssertion = (Core.Name "hydra/ext/owl/syntax.ClassAssertion")
...
_ObjectPropertyAssertion = (Core.Name "hydra/ext/owl/syntax.ObjectPropertyAssertion")
...
_NegativeObjectPropertyAssertion = (Core.Name "hydra/ext/owl/syntax.NegativeObjectPropertyAssertion")
...
_DataPropertyAssertion = (Core.Name "hydra/ext/owl/syntax.DataPropertyAssertion")
...
_NegativeDataPropertyAssertion = (Core.Name "hydra/ext/owl/syntax.NegativeDataPropertyAssertion")
