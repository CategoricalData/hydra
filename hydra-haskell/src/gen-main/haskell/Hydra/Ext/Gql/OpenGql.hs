...
data GqlProgram = 
  GqlProgramActivity GqlProgramActivity |
  GqlProgramClose SessionCloseCommand
...
data GqlProgramActivity = 
  GqlProgramActivity {
    gqlProgramActivityProgramActivity :: ProgramActivity,
    gqlProgramActivitySessionCloseCommand :: (Maybe SessionCloseCommand)}
  deriving (Eq, Ord, Read, Show)

_GqlProgramActivity = (Core.Name "hydra/ext/gql/openGql.GqlProgramActivity")

_GqlProgramActivity_programActivity = (Core.Name "programActivity")

_GqlProgramActivity_sessionCloseCommand = (Core.Name "sessionCloseCommand")
...
data SessionSetBindingTableParameterClause = 
  SessionSetBindingTableParameterClause {
    ...
    sessionSetBindingTableParameterClauseTable :: SessionSetParameterName,
    sessionSetBindingTableParameterClauseBinding :: OptTypedBindingTableInitializer}
  deriving (Eq, Ord, Read, Show)
...
_SessionSetBindingTableParameterClause_table = (Core.Name "table")
...
data FocusedLinearDataModifyingStatement = 
  FocusedLinearDataModifyingStatementBody FocusedLinearDataModifyingStatementBody |
...
_FocusedLinearDataModifyingStatement_body = (Core.Name "body")
...
data AmbientLinearDataModifyingStatement = 
  AmbientLinearDataModifyingStatementBody AmbientLinearDataModifyingStatementBody |
...
_AmbientLinearDataModifyingStatement_body = (Core.Name "body")
...
data CompositeQueryExpression = 
  CompositeQueryExpressionConjunction CompositeQueryExpressionConjunction |
...
_CompositeQueryExpression_conjunction = (Core.Name "conjunction")
...
data FocusedLinearQueryStatement = 
  FocusedLinearQueryStatementPartsAndResult FocusedLinearQueryStatementPartsAndResult |
  FocusedLinearQueryStatementPrimitiveResult FocusedPrimitiveResultStatement |
...
_FocusedLinearQueryStatement_partsAndResult = (Core.Name "partsAndResult")

_FocusedLinearQueryStatement_primitiveResult = (Core.Name "primitiveResult")
...
data AmbientLinearQueryStatement = 
  AmbientLinearQueryStatementSimpleAndPrimitiveResult AmbientLinearQueryStatementSimpleAndPrimitiveResult |
...
_AmbientLinearQueryStatement_simpleAndPrimitiveResult = (Core.Name "simpleAndPrimitiveResult")
...
data NodeTypePhraseFiller = 
  NodeTypePhraseFillerTypeNameWithFiller TypeNameWithFiller |
  NodeTypePhraseFillerFillerOnly NodeTypeFiller
  deriving (Eq, Ord, Read, Show)

_NodeTypePhraseFiller = (Core.Name "hydra/ext/gql/openGql.NodeTypePhraseFiller")

_NodeTypePhraseFiller_typeNameWithFiller = (Core.Name "typeNameWithFiller")

_NodeTypePhraseFiller_fillerOnly = (Core.Name "fillerOnly")

data TypeNameWithFiller = 
  TypeNameWithFiller {
    typeNameWithFillerTypeName :: EdgeTypeName,
    typeNameWithFillerFiller :: (Maybe EdgeTypeFiller)}
  deriving (Eq, Ord, Read, Show)

_TypeNameWithFiller = (Core.Name "hydra/ext/gql/openGql.TypeNameWithFiller")

_TypeNameWithFiller_typeName = (Core.Name "typeName")

_TypeNameWithFiller_filler = (Core.Name "filler")

data NodeTypeFiller = 
  NodeTypeFillerKeyLabelSetWithContent KeyLabelSetWithContent |
  NodeTypeFillerImpliedContent NodeTypeImpliedContent
  deriving (Eq, Ord, Read, Show)

_NodeTypeFiller = (Core.Name "hydra/ext/gql/openGql.NodeTypeFiller")

_NodeTypeFiller_keyLabelSetWithContent = (Core.Name "keyLabelSetWithContent")

_NodeTypeFiller_impliedContent = (Core.Name "impliedContent")

data KeyLabelSetWithContent = 
  KeyLabelSetWithContent {
    keyLabelSetWithContentKeyLabelSet :: EdgeTypeKeyLabelSet,
    keyLabelSetWithContentImpliedContent :: (Maybe EdgeTypeImpliedContent)}
  deriving (Eq, Ord, Read, Show)

_KeyLabelSetWithContent = (Core.Name "hydra/ext/gql/openGql.KeyLabelSetWithContent")

_KeyLabelSetWithContent_keyLabelSet = (Core.Name "keyLabelSet")

_KeyLabelSetWithContent_impliedContent = (Core.Name "impliedContent")
...
data NodeTypeImpliedContent = 
  ...
  NodeTypeImpliedContentLabelSetWithProperties LabelSetWithProperties
  deriving (Eq, Ord, Read, Show)
...
data LabelSetWithProperties = 
  LabelSetWithProperties {
    labelSetWithPropertiesLabelSet :: EdgeTypeLabelSet,
    labelSetWithPropertiesPropertyTypes :: EdgeTypePropertyTypes}
  deriving (Eq, Ord, Read, Show)

_LabelSetWithProperties = (Core.Name "hydra/ext/gql/openGql.LabelSetWithProperties")

_LabelSetWithProperties_labelSet = (Core.Name "labelSet")

_LabelSetWithProperties_propertyTypes = (Core.Name "propertyTypes")
...
data EdgeTypePhraseFiller = 
  EdgeTypePhraseFillerTypeNameWithFiller TypeNameWithFiller |
...
data EdgeTypeFiller = 
  EdgeTypeFillerKeyLabelSetWithContent KeyLabelSetWithContent |
...
data EdgeTypeImpliedContent = 
  ...
  EdgeTypeImpliedContentLabelSetWithProperties LabelSetWithProperties
  deriving (Eq, Ord, Read, Show)
...
data EndpointPair = 
  EndpointPairDirected EndpointPairDirected |
  EndpointPairUndirected EndpointPairUndirected
  deriving (Eq, Ord, Read, Show)
...
data NonParenthesizedValueExpressionPrimary = 
  NonParenthesizedValueExpressionPrimarySpecialCase NonParenthesizedValueExpressionPrimarySpecialCase |
