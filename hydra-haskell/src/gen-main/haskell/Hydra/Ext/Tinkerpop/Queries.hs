...
module Hydra.Ext.Tinkerpop.Queries where
...
_AggregationQuery = (Core.Name "hydra/ext/tinkerpop/queries.AggregationQuery")
...
_ApplicationQuery = (Core.Name "hydra/ext/tinkerpop/queries.ApplicationQuery")
...
_AssociativeExpression = (Core.Name "hydra/ext/tinkerpop/queries.AssociativeExpression")
...
_BinaryExpression = (Core.Name "hydra/ext/tinkerpop/queries.BinaryExpression")
...
_BinaryBooleanOperator = (Core.Name "hydra/ext/tinkerpop/queries.BinaryBooleanOperator")
...
_BinaryOperator = (Core.Name "hydra/ext/tinkerpop/queries.BinaryOperator")
...
_Binding = (Core.Name "hydra/ext/tinkerpop/queries.Binding")
...
_ComparisonOperator = (Core.Name "hydra/ext/tinkerpop/queries.ComparisonOperator")
...
_EdgeProjectionPattern = (Core.Name "hydra/ext/tinkerpop/queries.EdgeProjectionPattern")
...
_Expression = (Core.Name "hydra/ext/tinkerpop/queries.Expression")
...
_LetQuery = (Core.Name "hydra/ext/tinkerpop/queries.LetQuery")
...
_MatchQuery = (Core.Name "hydra/ext/tinkerpop/queries.MatchQuery")
...
_Projection = (Core.Name "hydra/ext/tinkerpop/queries.Projection")
...
_Projections = (Core.Name "hydra/ext/tinkerpop/queries.Projections")
...
_PropertyPattern = (Core.Name "hydra/ext/tinkerpop/queries.PropertyPattern")
...
_PropertyProjection = (Core.Name "hydra/ext/tinkerpop/queries.PropertyProjection")
...
_PropertyValue = (Core.Name "hydra/ext/tinkerpop/queries.PropertyValue")
...
_PropertyValuePattern = (Core.Name "hydra/ext/tinkerpop/queries.PropertyValuePattern")
...
_Query = (Core.Name "hydra/ext/tinkerpop/queries.Query")
...
_SelectQuery = (Core.Name "hydra/ext/tinkerpop/queries.SelectQuery")
...
_UnaryExpression = (Core.Name "hydra/ext/tinkerpop/queries.UnaryExpression")
...
_UnaryOperator = (Core.Name "hydra/ext/tinkerpop/queries.UnaryOperator")
...
_Variable = (Core.Name "hydra/ext/tinkerpop/queries.Variable")
...
_VertexPattern = (Core.Name "hydra/ext/tinkerpop/queries.VertexPattern")
