...
bigfloatValue v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "bigfloat" (Core_.showFloat v))) v)
...
bigintValue v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "bigint" (Core_.showInteger v))) v)
...
binaryLiteral v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "binary" (Core_.showLiteral v))) v)
...
booleanLiteral v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "boolean" (Core_.showLiteral v))) v)
  ...
  Core.TermFunction v1 -> ((\x -> case x of
    Core.FunctionElimination v2 -> ((\x -> case x of
      Core.EliminationUnion v3 -> (Logic.ifElse (Equality.equalString (Core.unName (Core.caseStatementTypeName v3)) (Core.unName name)) (Flows.pure v3) (Errors.unexpected (Strings.cat [
        ...
        (Core.unName name)]) (Core_.showTerm term)))
      _ -> (Errors.unexpected "case statement" (Core_.showTerm term))) v2)
    _ -> (Errors.unexpected "case statement" (Core_.showTerm term))) v1)
  _ -> (Errors.unexpected "case statement" (Core_.showTerm term))) term))
...
float32Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "float32" (Core_.showFloat v))) v)
...
functionType typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "function type" (Core_.showType typ))) stripped)
...
injection expected term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  ...
  _ -> (Errors.unexpected "injection" (Core_.showTerm term))) term))
...
int16Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "int16" (Core_.showInteger v))) v)
...
int32Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "int32" (Core_.showInteger v))) v)
...
int64Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "int64" (Core_.showInteger v))) v)
...
int8Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "int8" (Core_.showInteger v))) v)
...
integerLiteral lit = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "integer value" (Core_.showLiteral lit))) lit)
...
lambda term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  Core.TermFunction v1 -> ((\x -> case x of
    ...
    _ -> (Errors.unexpected "lambda" (Core_.showTerm term))) v1)
  _ -> (Errors.unexpected "lambda" (Core_.showTerm term))) term))
...
letTerm term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  ...
  _ -> (Errors.unexpected "let term" (Core_.showTerm term))) term))
...
list f term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  ...
  _ -> (Errors.unexpected "list" (Core_.showTerm term))) term))
...
listType typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "list type" (Core_.showType typ))) stripped)
...
literal term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  ...
  _ -> (Errors.unexpected "literal" (Core_.showTerm term))) term))
...
map fk fv term0 =  
  ...
  in (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
    ...
    _ -> (Errors.unexpected "map" (Core_.showTerm term))) term))
...
mapType typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "map type" (Core_.showType typ))) stripped)
...
optional f term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  ...
  _ -> (Errors.unexpected "optional value" (Core_.showTerm term))) term))
...
optionalType typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "optional type" (Core_.showType typ))) stripped)
...
pair kf vf term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  Core.TermProduct v1 -> (Logic.ifElse (Equality.equalInt32 (Lists.length v1) 2) (Flows.bind (kf (Lists.head v1)) (\kVal -> Flows.bind (vf (Lists.head (Lists.tail v1))) (\vVal -> Flows.pure (kVal, vVal)))) (Errors.unexpected "pair" (Core_.showTerm term)))
  _ -> (Errors.unexpected "product" (Core_.showTerm term))) term))
...
productType typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "product type" (Core_.showType typ))) stripped)
...
record expected term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  ...
  _ -> (Errors.unexpected "record" (Core_.showTerm term))) term))
...
recordType ename typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "record type" (Core_.showType typ))) stripped)
...
set f term0 = (Flows.bind (Lexical.stripAndDereferenceTerm term0) (\term -> (\x -> case x of
  ...
  _ -> (Errors.unexpected "set" (Core_.showTerm term))) term))
...
setType typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "set type" (Core_.showType typ))) stripped)
...
stringLiteral v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "string" (Core_.showLiteral v))) v)
...
sumType typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "sum type" (Core_.showType typ))) stripped)
...
uint16Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "uint16" (Core_.showInteger v))) v)
...
uint32Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "uint32" (Core_.showInteger v))) v)
...
uint64Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "uint64" (Core_.showInteger v))) v)
...
uint8Value v = ((\x -> case x of
  ...
  _ -> (Errors.unexpected "uint8" (Core_.showInteger v))) v)
...
unionType ename typ =  
  ...
  in ((\x -> case x of
    Core.TypeUnion v1 -> (Logic.ifElse (Equality.equalString (Core.unName (Core.rowTypeTypeName v1)) (Core.unName ename)) (Flows.pure (Core.rowTypeFields v1)) (Errors.unexpected (Strings.cat [
      ...
      "union of type ",
      (Core.unName (Core.rowTypeTypeName v1))])))
    _ -> (Errors.unexpected "union type" (Core_.showType typ))) stripped)

-- | Extract a unit value (empty record) from a term
unit :: (Core.Term -> Compute.Flow Graph.Graph ())
unit term0 = (Flows.bind (record (Core.Name "hydra.core.Unit") term0) (\fields -> Logic.ifElse (Lists.null fields) (Flows.pure ()) (Errors.unexpected "unit" (Core_.showTerm term0))))
...
wrappedType ename typ =  
  ...
  in ((\x -> case x of
    ...
    _ -> (Errors.unexpected "wrapped type" (Core_.showType typ))) stripped)
