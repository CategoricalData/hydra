...
parseError message remainder = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
parseErrorMessage x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
parseErrorRemainder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.parsing.ParseError"),
...
parseErrorWithMessage original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.parsing.ParseError"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "message"),
...
parseErrorWithRemainder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.parsing.ParseError"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "message"),
...
parseResultSuccess x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
parseResultFailure x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.parsing.ParseResult"),
  Core.injectionField = Core.Field {
...
parseSuccess value remainder = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
parseSuccessValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
parseSuccessRemainder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.parsing.ParseSuccess"),
    Core.projectionField = (Core.Name "remainder")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
parseSuccessWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.parsing.ParseSuccess"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
parseSuccessWithRemainder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.parsing.ParseSuccess"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
parser x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unParser x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
