...
fileExtension cx raw =
    Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped -> case stripped of
      Core.TermWrap v0 -> Eithers.map (\b -> Packaging.FileExtension b) ((\raw2 -> Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped2 -> case stripped2 of
      ...
      Core.TermRecord v0 ->
        ...
        in (Eithers.bind (Core__.requireField "namespace" namespace fieldMap cx) (\field_namespace -> Eithers.bind (Core__.requireField "definitions" (Core__.decodeList definition) fieldMap cx) (\field_definitions -> Eithers.bind (Core__.requireField "termDependencies" (Core__.decodeList namespace) fieldMap cx) (\field_termDependencies -> Eithers.bind (Core__.requireField "typeDependencies" (Core__.decodeList namespace) fieldMap cx) (\field_typeDependencies -> Eithers.bind (Core__.requireField "description" (Core__.decodeMaybe (\cx2 -> \raw2 -> Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped2 -> case stripped2 of
          Core.TermLiteral v1 -> case v1 of
            Core.LiteralString v2 -> Right v2
            _ -> Left (Errors.DecodingError "expected string literal")
          _ -> Left (Errors.DecodingError "expected literal")) (Lexical.stripAndDereferenceTermEither cx2 raw2))) fieldMap cx) (\field_description -> Right (Packaging.Module {
...
namespace cx raw =
    Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped -> case stripped of
      Core.TermWrap v0 -> Eithers.map (\b -> Packaging.Namespace b) ((\raw2 -> Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped2 -> case stripped2 of
        Core.TermLiteral v1 -> case v1 of
          Core.LiteralString v2 -> Right v2
          _ -> Left (Errors.DecodingError "expected string literal")
        _ -> Left (Errors.DecodingError "expected literal")) (Lexical.stripAndDereferenceTermEither cx raw2)) (Core.wrappedTermBody v0))
      ...
      Core.TermRecord v0 ->
        ...
        in (Eithers.bind (Core__.requireField "name" packageName fieldMap cx) (\field_name -> Eithers.bind (Core__.requireField "modules" (Core__.decodeList module_) fieldMap cx) (\field_modules -> Eithers.bind (Core__.requireField "dependencies" (Core__.decodeList packageName) fieldMap cx) (\field_dependencies -> Eithers.bind (Core__.requireField "description" (Core__.decodeMaybe (\cx2 -> \raw2 -> Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped2 -> case stripped2 of
          Core.TermLiteral v1 -> case v1 of
            Core.LiteralString v2 -> Right v2
            _ -> Left (Errors.DecodingError "expected string literal")
          _ -> Left (Errors.DecodingError "expected literal")) (Lexical.stripAndDereferenceTermEither cx2 raw2))) fieldMap cx) (\field_description -> Right (Packaging.Package {
...
packageName cx raw =
    Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped -> case stripped of
      Core.TermWrap v0 -> Eithers.map (\b -> Packaging.PackageName b) ((\raw2 -> Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped2 -> case stripped2 of
        Core.TermLiteral v1 -> case v1 of
          Core.LiteralString v2 -> Right v2
          _ -> Left (Errors.DecodingError "expected string literal")
        _ -> Left (Errors.DecodingError "expected literal")) (Lexical.stripAndDereferenceTermEither cx raw2)) (Core.wrappedTermBody v0))
      ...
      Core.TermRecord v0 ->
        ...
        in (Eithers.bind (Core__.requireField "namespace" (Core__.decodeMaybe namespace) fieldMap cx) (\field_namespace -> Eithers.bind (Core__.requireField "local" (\cx2 -> \raw2 -> Eithers.either (\err -> Left (Errors.DecodingError err)) (\stripped2 -> case stripped2 of
          Core.TermLiteral v1 -> case v1 of
            Core.LiteralString v2 -> Right v2
            _ -> Left (Errors.DecodingError "expected string literal")
          _ -> Left (Errors.DecodingError "expected literal")) (Lexical.stripAndDereferenceTermEither cx2 raw2)) fieldMap cx) (\field_local -> Right (Packaging.QualifiedName {
