module Hydra.Langs.Tinkerpop.Typed where
...
_CollectionType = (Core.Name "hydra/langs/tinkerpop/typed.CollectionType")
...
_CollectionValue = (Core.Name "hydra/langs/tinkerpop/typed.CollectionValue")
...
_Edge = (Core.Name "hydra/langs/tinkerpop/typed.Edge")
...
_EdgeId = (Core.Name "hydra/langs/tinkerpop/typed.EdgeId")
...
_EdgeIdType = (Core.Name "hydra/langs/tinkerpop/typed.EdgeIdType")
...
_EdgeType = (Core.Name "hydra/langs/tinkerpop/typed.EdgeType")
...
_Id = (Core.Name "hydra/langs/tinkerpop/typed.Id")
...
_IdType = (Core.Name "hydra/langs/tinkerpop/typed.IdType")
...
_Key = (Core.Name "hydra/langs/tinkerpop/typed.Key")
...
_Label = (Core.Name "hydra/langs/tinkerpop/typed.Label")
...
_Type = (Core.Name "hydra/langs/tinkerpop/typed.Type")
...
_Value = (Core.Name "hydra/langs/tinkerpop/typed.Value")
...
_Vertex = (Core.Name "hydra/langs/tinkerpop/typed.Vertex")
...
_VertexId = (Core.Name "hydra/langs/tinkerpop/typed.VertexId")
...
_VertexIdType = (Core.Name "hydra/langs/tinkerpop/typed.VertexIdType")
...
_VertexType = (Core.Name "hydra/langs/tinkerpop/typed.VertexType")
