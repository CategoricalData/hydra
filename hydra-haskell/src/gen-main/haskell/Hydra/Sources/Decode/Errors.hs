...
module_ =
    Module.Module {
      ...
      Module.moduleElements = [
        Core.Binding {
          Core.bindingName = (Core.Name "hydra.decode.errors.decodingError"),
        ...
        Core.Binding {
          Core.bindingName = (Core.Name "hydra.decode.errors.error"),
          Core.bindingTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
            Core.lambdaParameter = (Core.Name "cx"),
            Core.lambdaDomain = Nothing,
            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
          ...
          Core.bindingType = (Just (Core.TypeScheme {
            ...
            Core.typeSchemeConstraints = Nothing}))},
        Core.Binding {
          Core.bindingName = (Core.Name "hydra.decode.errors.otherError"),
          Core.bindingTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
            Core.lambdaParameter = (Core.Name "cx"),
            Core.lambdaDomain = Nothing,
            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
          ...
          Core.bindingType = (Just (Core.TypeScheme {
            ...
            Core.typeSchemeConstraints = Nothing}))},
        Core.Binding {
          Core.bindingName = (Core.Name "hydra.decode.errors.unificationError"),
          Core.bindingTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
            Core.lambdaParameter = (Core.Name "cx"),
            Core.lambdaDomain = Nothing,
            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
