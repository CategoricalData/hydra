      ...
      Module.moduleDefinitions = [
        ...
        (Module.DefinitionTerm (Module.TermDefinition {
          ...
          Module.termDefinitionType = (Just (Core.TypeScheme {
            ...
            Core.typeSchemeConstraints = Nothing}))})),
        (Module.DefinitionTerm (Module.TermDefinition {
          Module.termDefinitionName = (Core.Name "hydra.decode.error.packaging.duplicateDefinitionNameError"),
          Module.termDefinitionTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
            Core.lambdaParameter = (Core.Name "cx"),
            Core.lambdaDomain = Nothing,
            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
          ...
          Module.termDefinitionType = (Just (Core.TypeScheme {
            ...
            Core.typeSchemeConstraints = Nothing}))})),
        (Module.DefinitionTerm (Module.TermDefinition {
          Module.termDefinitionName = (Core.Name "hydra.decode.error.packaging.duplicateModuleNamespaceError"),
          Module.termDefinitionTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
            Core.lambdaParameter = (Core.Name "cx"),
            Core.lambdaDomain = Nothing,
            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
          ...
          Module.termDefinitionType = (Just (Core.TypeScheme {
            ...
            Core.typeSchemeConstraints = Nothing}))})),
        (Module.DefinitionTerm (Module.TermDefinition {
          Module.termDefinitionName = (Core.Name "hydra.decode.error.packaging.invalidModuleError"),
          Module.termDefinitionTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
            Core.lambdaParameter = (Core.Name "cx"),
            Core.lambdaDomain = Nothing,
            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                                    ...
                                    Core.bindingTerm = (Core.TermApplication (Core.Application {
                                      ...
                                      Core.applicationArgument = (Core.TermList [
                                        Core.TermPair (Core.TermWrap (Core.WrappedTerm {
                                          ...
                                          Core.wrappedTermBody = (Core.TermLiteral (Core.LiteralString "conflictingVariantName"))}), (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                                        ...
                                        (Core.TermPair (Core.TermWrap (Core.WrappedTerm {
                                          Core.wrappedTermTypeName = (Core.Name "hydra.core.Name"),
                                          Core.wrappedTermBody = (Core.TermLiteral (Core.LiteralString "definitionNotInModuleNamespace"))}), (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                                          Core.lambdaParameter = (Core.Name "input"),
                                          Core.lambdaDomain = Nothing,
                                          Core.lambdaBody = (Core.TermApplication (Core.Application {
                                            Core.applicationFunction = (Core.TermApplication (Core.Application {
                                        ...
                                        (Core.TermPair (Core.TermWrap (Core.WrappedTerm {
                                          Core.wrappedTermTypeName = (Core.Name "hydra.core.Name"),
                                          Core.wrappedTermBody = (Core.TermLiteral (Core.LiteralString "duplicateDefinitionName"))}), (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                                          Core.lambdaParameter = (Core.Name "input"),
                                          Core.lambdaDomain = Nothing,
                                          Core.lambdaBody = (Core.TermApplication (Core.Application {
                                            Core.applicationFunction = (Core.TermApplication (Core.Application {
          ...
          Module.termDefinitionType = (Just (Core.TypeScheme {
            ...
            Core.typeSchemeConstraints = Nothing}))})),
        (Module.DefinitionTerm (Module.TermDefinition {
          Module.termDefinitionName = (Core.Name "hydra.decode.error.packaging.invalidPackageError"),
          Module.termDefinitionTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
            Core.lambdaParameter = (Core.Name "cx"),
            Core.lambdaDomain = Nothing,
            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
