...
data LastMile a = 
  LastMile {
    ...
    lastMileEncoder :: (Core.Type Compute.Kv -> Compute.Flow (Graph.Graph Compute.Kv) (Core.Term Compute.Kv -> Graph.Graph Compute.Kv -> Compute.Flow (Graph.Graph Compute.Kv) [a])),
