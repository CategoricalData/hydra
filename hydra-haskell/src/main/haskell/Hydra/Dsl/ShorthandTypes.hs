...
elementT = TypeVariable _Binding :: Type
...
forallTypeT = TypeVariable _ForallType :: Type
languageT = TypeVariable _Language :: Type
letT = TypeVariable _Let :: Type
letBindingT = TypeVariable _Binding :: Type
...
typeLambdaT = TypeVariable _TypeLambda :: Type
typeSchemeT = TypeVariable _TypeScheme :: Type
typeApplicationTermT = TypeVariable _TypeApplicationTerm :: Type
