...
bytesToHsYaml :: BS.ByteString -> GraphFlow a (DY.Node DY.Pos)
...
bytesToHydraYaml :: BS.ByteString -> GraphFlow a YM.Node
...
hsYamlToHydraYaml :: DY.Node x -> GraphFlow a YM.Node
