-- | An Azure Digital Twin Definition Language (DTLD) model
--   Based on: https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v2/dtdlv2.md#digital-twins-definition-language
-- 
...
module Hydra.Impl.Haskell.Sources.Ext.Azure.Dtld where
...
dtldModule = Module azureDtld []

dtldName :: GraphName
dtldName = GraphName "hydra/ext/azure/dtld"

azureDtld :: Graph Meta
azureDtld = Graph dtldName elements hydraCoreName
  where
    def = datatype coreContext dtldName
