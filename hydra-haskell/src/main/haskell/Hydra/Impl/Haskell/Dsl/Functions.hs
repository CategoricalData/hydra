...
cases cx dom cod cs = typed cx (Types.function dom cod) $
    program $ DataTermFunction $ FunctionElimination $ EliminationUnion $ toField <$> cs
  where
...
deref = program $ DataTermFunction $ FunctionElimination EliminationElement
...
optionalCases (Program nothing) (Program just)
  = program $ DataTermFunction $ FunctionElimination $ EliminationOptional $ OptionalCases nothing just
...
project fname = program $ DataTermFunction $ FunctionElimination $ EliminationRecord fname
