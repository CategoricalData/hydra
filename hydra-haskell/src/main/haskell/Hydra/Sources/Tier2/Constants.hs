module Hydra.Sources.Tier2.Constants where
...
hydraConstantsModule = Module (Namespace "hydra.constants") elements [] [Tier1.hydraCoreModule] $
...
warningAutoGeneratedFileDef = constantsDefinition "warningAutoGeneratedFile" $
