...
hydraSortingModule = Module (Namespace "hydra.sorting") elements
    [tarjanModule] [hydraComputeModule, hydraMantleModule, hydraTopologyModule] $
...
createOrderingIsomorphismDef :: TElement ([a] -> [a] -> OrderingIsomorphism b)
