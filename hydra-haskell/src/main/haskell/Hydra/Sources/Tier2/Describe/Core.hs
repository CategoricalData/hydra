...
describeFloatTypeDef = printingDefinition "describeFloatType" $
  ...
  lambda "t" $ (ref describePrecisionDef <.> ref Variants.floatTypePrecisionDef @@ var "t") ++ string " floating-point numbers"
...
describeIntegerTypeDef = printingDefinition "describeIntegerType" $
  ...
  lambda "t" $ (ref describePrecisionDef <.> ref Variants.integerTypePrecisionDef @@ var "t")
    ++ string " integers"
