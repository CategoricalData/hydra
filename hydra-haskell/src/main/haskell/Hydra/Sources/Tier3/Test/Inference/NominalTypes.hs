...
testGroupForCaseStatements = subgroup "Case statements" [
    expectMono 1 [tag_disabledForDefaultInference, tag_disabledForAlgorithmWInference, tag_disabledForAltInference]
...
testGroupForRecords = supergroup "Records" [
    ...
    subgroup "Simple records" [
      ...
      expectMono 5 [tag_disabledForDefaultInference, tag_disabledForAlgorithmWInference, tag_disabledForAltInference]
    ...
    subgroup "Record instances of simply recursive record types" [
      ...
      expectMono 4 [tag_disabledForDefaultInference, tag_disabledForAlgorithmWInference, tag_disabledForAltInference]
        ((lambda "x" $ record (ref testTypeListNameDef) [
          ...
          "tail">: optional $ just (record (ref testTypeListNameDef) [
            ...
            "tail">: optional nothing])]) @@ int32 42)
        (T.apply (Core.typeVariable (ref testTypeListNameDef)) T.int32),
      expectPoly 5 [tag_disabledForDefaultInference, tag_disabledForAlgorithmWInference, tag_disabledForAltInference]
        (lambda "x" $ record (ref testTypeListNameDef) [
          "head">: var "x",
          "tail">: optional $ just (record (ref testTypeListNameDef) [
            "head">: var "x",
    ...
    subgroup "Record instances of mutually recursive record types" [
      ...
      expectPoly 2 [tag_disabledForDefaultInference, tag_disabledForAlgorithmWInference, tag_disabledForAltInference]
        (lambda "x" $ record (ref testTypeBuddyListANameDef) [
          "head">: var "x",
          "tail">: optional $ just $ record (ref testTypeBuddyListBNameDef) [
            "head">: var "x",
...
--          (inject testTypeUnionMonomorphicName $ Field (Name "string") $ int32 42)
    ...
    subgroup "Polymorphic and recursive variants" [
      expectPoly 1 [tag_disabledForDefaultInference, tag_disabledForAlgorithmWInference, tag_disabledForAltInference]
