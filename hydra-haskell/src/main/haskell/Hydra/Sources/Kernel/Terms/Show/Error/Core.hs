...
module_ = Module ns elements
  ...
  where
   elements = [
     toBinding constantConditionError,
     toBinding duplicateBindingError,
     toBinding duplicateFieldError,
     toBinding duplicateRecordTypeFieldNamesError,
     toBinding duplicateUnionTypeFieldNamesError,
     toBinding emptyCaseStatementError,
     toBinding emptyLetBindingsError,
     toBinding emptyRecordTypeError,
     toBinding emptyTermAnnotationError,
     toBinding emptyTypeAnnotationError,
     toBinding emptyTypeNameInTermError,
     toBinding emptyUnionTypeError,
     toBinding invalidForallParameterNameError,
     toBinding invalidLambdaParameterNameError,
     toBinding invalidLetBindingNameError,
     toBinding invalidTermError,
     toBinding invalidTypeError,
     toBinding invalidTypeLambdaParameterNameError,
     toBinding invalidTypeSchemeVariableNameError,
     toBinding nestedTermAnnotationError,
     toBinding nestedTypeAnnotationError,
     toBinding nonComparableMapKeyTypeError,
     toBinding nonComparableSetElementTypeError,
     toBinding redundantWrapUnwrapError,
     toBinding selfApplicationError,
     toBinding singleVariantUnionError,
     toBinding termVariableShadowingError,
     toBinding typeVariableShadowingInForallError,
     toBinding typeVariableShadowingInTypeLambdaError,
     toBinding undefinedFieldError,
     toBinding undefinedTermVariableError,
     toBinding undefinedTypeVariableError,
     toBinding undefinedTypeVariableInBindingTypeError,
     toBinding undefinedTypeVariableInLambdaDomainError,
     toBinding undefinedTypeVariableInTypeApplicationError,
     toBinding unexpectedTermVariantError,
     toBinding unexpectedTypeVariantError,
     toBinding unknownPrimitiveNameError,
     toBinding unnecessaryIdentityApplicationError,
     toBinding untypedTermVariableError,
     toBinding voidInNonBottomPositionError]
