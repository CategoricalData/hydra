...
import Hydra.Kernel hiding (emptyContext, maybeToList)
...
module_ = Module ns elements
    ...
    Just ("Miscellaneous helper functions.")
  where
    elements = [
...
emptyContext = define "emptyContext" $
  doc "An empty context with no trace, messages, or other data" $
  Ctx.context (list ([] :: [TTerm String])) (list ([] :: [TTerm String])) Maps.empty
