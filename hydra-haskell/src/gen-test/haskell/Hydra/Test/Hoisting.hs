    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseHoistPolymorphicLetBindings (Testing.HoistPolymorphicLetBindingsTestCase {
                          ...
                          Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                            ...
                            Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                              ...
                              Core.lambdaBody = (Core.TermApplication (Core.Application {
                                Core.applicationFunction = (Core.TermApplication (Core.Application {
                                  Core.applicationFunction = (Core.TermApplication (Core.Application {
                                    Core.applicationFunction = (Core.TermVariable (Core.Name "either")),
                              ...
                              Core.functionTypeCodomain = (Core.TypeFunction (Core.FunctionType {
                                Core.functionTypeDomain = (Core.TypeApplication (Core.ApplicationType {
                                  Core.applicationTypeFunction = (Core.TypeApplication (Core.ApplicationType {
                                    Core.applicationTypeFunction = (Core.TypeVariable (Core.Name "Either")),
            ...
            Testing.hoistPolymorphicLetBindingsTestCaseOutput = Core.Let {
              Core.letBindings = [
                ...
                Core.Binding {
                  Core.bindingName = (Core.Name "f"),
                  Core.bindingTerm = (Core.TermVariable (Core.Name "choose")),
                  Core.bindingType = (Just (Core.TypeScheme {
                    Core.typeSchemeVariables = [],
                    Core.typeSchemeType = (Core.TypeFunction (Core.FunctionType {
                      Core.functionTypeDomain = (Core.TypeFunction (Core.FunctionType {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseHoistPolymorphicLetBindings (Testing.HoistPolymorphicLetBindingsTestCase {
            ...
            Testing.hoistPolymorphicLetBindingsTestCaseOutput = Core.Let {
              Core.letBindings = [
                ...
                Core.Binding {
                  Core.bindingName = (Core.Name "f"),
                  Core.bindingTerm = (Core.TermVariable (Core.Name "returnT")),
                  Core.bindingType = (Just (Core.TypeScheme {
                    Core.typeSchemeVariables = [],
                    Core.typeSchemeType = (Core.TypeFunction (Core.FunctionType {
                      Core.functionTypeDomain = Core.TypeUnit,
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseHoistPolymorphicLetBindings (Testing.HoistPolymorphicLetBindingsTestCase {
                    ...
                    Core.letBindings = [
                      Core.Binding {
                        ...
                        Core.bindingType = (Just (Core.TypeScheme {
                          ...
                          Core.typeSchemeType = (Core.TypeFunction (Core.FunctionType {
                            Core.functionTypeDomain = (Core.TypeApplication (Core.ApplicationType {
                              Core.applicationTypeFunction = (Core.TypeVariable (Core.Name "List")),
                              Core.applicationTypeArgument = (Core.TypeApplication (Core.ApplicationType {
                                Core.applicationTypeFunction = (Core.TypeApplication (Core.ApplicationType {
                                  Core.applicationTypeFunction = (Core.TypeVariable (Core.Name "Map")),
                                  Core.applicationTypeArgument = (Core.TypeVariable (Core.Name "t0"))})),
                                Core.applicationTypeArgument = (Core.TypeApplication (Core.ApplicationType {
                                  Core.applicationTypeFunction = (Core.TypeApplication (Core.ApplicationType {
                                    Core.applicationTypeFunction = (Core.TypeVariable (Core.Name "Pair")),
            ...
            Testing.hoistPolymorphicLetBindingsTestCaseOutput = Core.Let {
              Core.letBindings = [
                ...
                Core.Binding {
                  Core.bindingName = (Core.Name "f"),
                  Core.bindingTerm = (Core.TermVariable (Core.Name "nested")),
                  Core.bindingType = (Just (Core.TypeScheme {
                    Core.typeSchemeVariables = [],
                    Core.typeSchemeType = (Core.TypeFunction (Core.FunctionType {
                      Core.functionTypeDomain = (Core.TypeApplication (Core.ApplicationType {
        ...
        Testing.TestCaseWithMetadata {
              ...
              Core.letBindings = [
                Core.Binding {
                  ...
                  Core.bindingType = (Just (Core.TypeScheme {
                    Core.typeSchemeVariables = [],
                    Core.typeSchemeType = (Core.TypeFunction (Core.FunctionType {
                      Core.functionTypeDomain = (Core.TypeVariable (Core.Name "MutateType")),
                      Core.functionTypeCodomain = (Core.TypeFunction (Core.FunctionType {
                        Core.functionTypeDomain = (Core.TypeVariable (Core.Name "RestoreType")),
                        Core.functionTypeCodomain = (Core.TypeFunction (Core.FunctionType {
                          Core.functionTypeDomain = (Core.TypeVariable (Core.Name "FlowType")),
                          Core.functionTypeCodomain = (Core.TypeVariable (Core.Name "FlowType"))}))}))})),
                    Core.typeSchemeConstraints = Nothing}))}],
          ...
          Testing.testCaseWithMetadataTags = []},
        Testing.TestCaseWithMetadata {
          Testing.testCaseWithMetadataName = "inner binding uses type variable from outer polymorphic context",
          Testing.testCaseWithMetadataCase = (Testing.TestCaseHoistPolymorphicLetBindings (Testing.HoistPolymorphicLetBindingsTestCase {
            Testing.hoistPolymorphicLetBindingsTestCaseInput = Core.Let {
              Core.letBindings = [
                Core.Binding {
                  Core.bindingName = (Core.Name "etaExpand"),
                  Core.bindingTerm = (Core.TermTypeLambda (Core.TypeLambda {
                    Core.typeLambdaParameter = (Core.Name "s"),
                    Core.typeLambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                      Core.lambdaParameter = (Core.Name "tx"),
                      Core.lambdaDomain = Nothing,
                      Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                        ...
                        Core.lambdaBody = (Core.TermLet (Core.Let {
                          Core.letBindings = [
                            Core.Binding {
                              Core.bindingName = (Core.Name "forCaseStatement"),
                              Core.bindingTerm = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                                Core.lambdaParameter = (Core.Name "cs"),
                                Core.lambdaDomain = Nothing,
                                Core.lambdaBody = (Core.TermApplication (Core.Application {
                                  Core.applicationFunction = (Core.TermVariable (Core.Name "processCaseStatement")),
                                  Core.applicationArgument = (Core.TermVariable (Core.Name "cs"))}))}))),
                              Core.bindingType = (Just (Core.TypeScheme {
                                Core.typeSchemeVariables = [],
                                Core.typeSchemeType = (Core.TypeFunction (Core.FunctionType {
                                  Core.functionTypeDomain = (Core.TypeVariable (Core.Name "CaseStatement")),
                                  Core.functionTypeCodomain = (Core.TypeApplication (Core.ApplicationType {
                                    Core.applicationTypeFunction = (Core.TypeApplication (Core.ApplicationType {
                                      Core.applicationTypeFunction = (Core.TypeVariable (Core.Name "Flow")),
                                      Core.applicationTypeArgument = (Core.TypeVariable (Core.Name "s"))})),
                                    Core.applicationTypeArgument = (Core.TypeVariable (Core.Name "CaseStatement"))}))})),
                                Core.typeSchemeConstraints = Nothing}))}],
                          Core.letBody = (Core.TermApplication (Core.Application {
                            Core.applicationFunction = (Core.TermVariable (Core.Name "forCaseStatement")),
                            Core.applicationArgument = (Core.TermApplication (Core.Application {
                              Core.applicationFunction = (Core.TermVariable (Core.Name "getCaseStatement")),
                              Core.applicationArgument = (Core.TermVariable (Core.Name "term"))}))}))}))})))})))})),
                  Core.bindingType = (Just (Core.TypeScheme {
                    Core.typeSchemeVariables = [
                      Core.Name "s"],
                    Core.typeSchemeType = (Core.TypeFunction (Core.FunctionType {
                      Core.functionTypeDomain = (Core.TypeVariable (Core.Name "TypeContext")),
                      Core.functionTypeCodomain = (Core.TypeFunction (Core.FunctionType {
                        Core.functionTypeDomain = (Core.TypeVariable (Core.Name "Term")),
                        Core.functionTypeCodomain = (Core.TypeApplication (Core.ApplicationType {
                          Core.applicationTypeFunction = (Core.TypeApplication (Core.ApplicationType {
                            Core.applicationTypeFunction = (Core.TypeVariable (Core.Name "Flow")),
                            Core.applicationTypeArgument = (Core.TypeVariable (Core.Name "s"))})),
                          Core.applicationTypeArgument = (Core.TypeVariable (Core.Name "Term"))}))}))})),
                    Core.typeSchemeConstraints = Nothing}))}],
              Core.letBody = (Core.TermVariable (Core.Name "etaExpand"))},
            Testing.hoistPolymorphicLetBindingsTestCaseOutput = Core.Let {
              Core.letBindings = [
                Core.Binding {
                  Core.bindingName = (Core.Name "forCaseStatement"),
                  ...
                  Core.bindingTerm = (Core.TermTypeLambda (Core.TypeLambda {
                    ...
                    Core.typeLambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                      ...
                      Core.lambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                        ...
                        Core.lambdaBody = (Core.TermApplication (Core.Application {
                          Core.applicationFunction = (Core.TermTypeApplication (Core.TypeApplicationTerm {
                            Core.typeApplicationTermBody = (Core.TermVariable (Core.Name "forCaseStatement")),
                            Core.typeApplicationTermType = (Core.TypeVariable (Core.Name "s"))})),
                          Core.applicationArgument = (Core.TermApplication (Core.Application {
                            Core.applicationFunction = (Core.TermVariable (Core.Name "getCaseStatement")),
                            Core.applicationArgument = (Core.TermVariable (Core.Name "term"))}))}))})))})))})),
                  Core.bindingType = (Just (Core.TypeScheme {
          ...
          Testing.testCaseWithMetadataTags = []},
        Testing.TestCaseWithMetadata {
          Testing.testCaseWithMetadataName = "monomorphic binding with type referencing outer type variable",
          Testing.testCaseWithMetadataCase = (Testing.TestCaseHoistPolymorphicLetBindings (Testing.HoistPolymorphicLetBindingsTestCase {
            Testing.hoistPolymorphicLetBindingsTestCaseInput = Core.Let {
              Core.letBindings = [
                Core.Binding {
                      ...
                      Core.lambdaBody = (Core.TermLet (Core.Let {
                        Core.letBindings = [
                          Core.Binding {
                            Core.bindingName = (Core.Name "g"),
                            Core.bindingTerm = (Core.TermApplication (Core.Application {
                              Core.applicationFunction = (Core.TermVariable (Core.Name "pure")),
                              Core.applicationArgument = (Core.TermLiteral (Core.LiteralInteger (Core.IntegerValueInt32 42)))})),
                            Core.bindingType = (Just (Core.TypeScheme {
                              Core.typeSchemeVariables = [],
                  ...
                  Core.bindingTerm = (Core.TermTypeLambda (Core.TypeLambda {
                    ...
                    Core.typeLambdaBody = (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
                      ...
                      Core.lambdaBody = (Core.TermTypeApplication (Core.TypeApplicationTerm {
                        Core.typeApplicationTermBody = (Core.TermVariable (Core.Name "g")),
                        Core.typeApplicationTermType = (Core.TypeVariable (Core.Name "s"))}))})))})),
                  Core.bindingType = (Just (Core.TypeScheme {
                    Core.typeSchemeVariables = [
                      Core.Name "s"],
