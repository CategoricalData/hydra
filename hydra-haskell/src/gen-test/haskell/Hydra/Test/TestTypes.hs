...
testTypeComparison = (Core.TypeUnion [
  Core.FieldType {
...
testTypeHydraLiteralType = (Core.TypeUnion [
  Core.FieldType {
...
testTypeHydraType = (Core.TypeUnion [
  Core.FieldType {
...
testTypeIntList = (Core.TypeRecord [
  Core.FieldType {
    Core.fieldTypeName = (Core.Name "head"),
...
testTypeLatLon = (Core.TypeRecord [
  Core.FieldType {
...
testTypePerson = (Core.TypeRecord [
  Core.FieldType {
...
testTypeSimpleNumber = (Core.TypeUnion [
  Core.FieldType {
    Core.fieldTypeName = (Core.Name "int"),
    Core.fieldTypeType = (Core.TypeLiteral (Core.LiteralTypeInteger Core.IntegerTypeInt32))},
  Core.FieldType {
...
testTypeTimestamp = (Core.TypeUnion [
  Core.FieldType {
...
testTypeUnionMonomorphic = (Core.TypeUnion [
  Core.FieldType {
...
eitherStringOrInt8Type = (Core.TypeUnion [
  Core.FieldType {
    Core.fieldTypeName = (Core.Name "left"),
    Core.fieldTypeType = (Core.TypeLiteral Core.LiteralTypeString)},
  Core.FieldType {
...
stringOrIntType = (Core.TypeUnion [
  Core.FieldType {
    Core.fieldTypeName = (Core.Name "left"),
    Core.fieldTypeType = (Core.TypeLiteral Core.LiteralTypeString)},
  Core.FieldType {
