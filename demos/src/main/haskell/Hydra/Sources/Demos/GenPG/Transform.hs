...
import qualified Hydra.Core.Tabular as Tab            -- Generated tabular types
import qualified Hydra.Core.Relational as Rel         -- Generated relational types


ns :: ModuleName
ns = ModuleName "hydra.pg.demos.genpg.transform"
