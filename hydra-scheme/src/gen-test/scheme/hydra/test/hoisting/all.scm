...
(begin
(define hydra_test_hoisting_all_all_tests (make-hydra_testing_test_group "hoisting" '() (list hydra_test_hoisting_cases_all_tests hydra_test_hoisting_let_all_tests) (list)))))
