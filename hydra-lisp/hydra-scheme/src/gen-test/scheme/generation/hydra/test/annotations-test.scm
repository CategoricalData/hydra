...
(define (test-annotations-negarbitrary-annotations-negset-multiple-annotations--num1)
  ...
  (assert (equal? (list 'annotated (make-hydra_core_annotated_term (list 'literal (list 'boolean #t)) (list (cons "k1" (list 'literal (list 'string "first"))) (cons "k2" (list 'literal (list 'integer (list 'int32 200))))))) (((hydra_annotations_set_term_annotation "k2") (list 'just (list 'literal (list 'integer (list 'int32 200))))) (((hydra_annotations_set_term_annotation "k1") (list 'just (list 'literal (list 'string "first")))) (list 'literal (list 'boolean #t)))))))
...
(define (test-annotations-negarbitrary-annotations-negouter-annotation-overrides-inner--num3)
  ...
  (assert (equal? (list 'annotated (make-hydra_core_annotated_term (list 'literal (list 'boolean #f)) (list (cons "key" (list 'literal (list 'integer (list 'int32 999))))))) (((hydra_annotations_set_term_annotation "key") (list 'just (list 'literal (list 'integer (list 'int32 999))))) (((hydra_annotations_set_term_annotation "key") (list 'just (list 'literal (list 'integer (list 'int32 1))))) (list 'literal (list 'boolean #f)))))))
...
(define (test-annotations-negdescriptions-negset-description--num3)
  ...
  (assert (equal? (list 'annotated (make-hydra_core_annotated_term (list 'literal (list 'boolean #t)) (list (cons "description" (list 'literal (list 'string "A longer description with spaces")))))) ((hydra_annotations_set_term_description (list 'just "A longer description with spaces")) (list 'literal (list 'boolean #t))))))
