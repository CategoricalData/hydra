...
(define (test-formatting-negcase-conversion-neg-num1-lower-snake-case--neg-upper-snake-case)
...
(define (test-formatting-negcase-conversion-neg-num2-lower-snake-case--neg-camelcase)

  (assert (equal? "aHelloWorld42A4242aB" (((hydra_formatting_convert_case (list 'lower_snake '())) (list 'camel '())) "a_hello_world_42_a42_42a_b"))))

(define (test-formatting-negcase-conversion-neg-num3-lower-snake-case--neg-pascalcase)

  (assert (equal? "AHelloWorld42A4242aB" (((hydra_formatting_convert_case (list 'lower_snake '())) (list 'pascal '())) "a_hello_world_42_a42_42a_b"))))

(define (test-formatting-negcase-conversion-neg-num4-lower-snake-case--neg-lower-snake-case)
...
(define (test-formatting-negcase-conversion-neg-num5-upper-snake-case--neg-lower-snake-case)
...
(define (test-formatting-negcase-conversion-neg-num6-upper-snake-case--neg-camelcase)

  (assert (equal? "aHelloWorld42A4242aB" (((hydra_formatting_convert_case (list 'upper_snake '())) (list 'camel '())) "A_HELLO_WORLD_42_A42_42A_B"))))

(define (test-formatting-negcase-conversion-neg-num7-upper-snake-case--neg-pascalcase)

  (assert (equal? "AHelloWorld42A4242aB" (((hydra_formatting_convert_case (list 'upper_snake '())) (list 'pascal '())) "A_HELLO_WORLD_42_A42_42A_B"))))

(define (test-formatting-negcase-conversion-neg-num8-upper-snake-case--neg-upper-snake-case)
