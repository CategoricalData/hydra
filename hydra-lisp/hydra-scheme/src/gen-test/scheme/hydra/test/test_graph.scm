...
(import (scheme base) (hydra core) (hydra context) (hydra graph) (hydra lexical) (hydra lib libraries) (hydra lib maps) (hydra module) (hydra rewriting) (hydra scoping) (hydra json bootstrap) (hydra test test_terms) (hydra test test_types))
(begin
...
(include "/Users/josh/projects/github/CategoricalData/hydra-branches/feature_221_refactor_terms/hydra-lisp/hydra-scheme/src/test/scheme/hydra/annotation_bindings.scm")
