...
(define hydra_show_util_comparison (lambda (c) ((lambda (match_target) ((lambda (match_value) (cond ((equal? (car match_target) 'less_than) ((lambda (_) "lessThan") match_value)) ((equal? (car match_target) 'equal_to) ((lambda (_) "equalTo") match_value)) ((equal? (car match_target) 'greater_than) ((lambda (_) "greaterThan") match_value)))) (cadr match_target))) c)))))
