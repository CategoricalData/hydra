...
(define hydra_variants_function_variant-variants (list 'elimination 'lambda 'primitive))
...
(define hydra_variants_type_variant-variants (list 'annotated 'application 'either 'forall 'function 'list 'literal 'map 'maybe 'pair 'record 'set 'union 'unit 'variable 'wrap))))
