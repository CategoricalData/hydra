      ...
      (let ((ns "hydra.lib.math")
        ...
        (append
          ...
          (list
            ...
            (cons (qname ns "ceiling")  (prim1 (qname ns "ceiling")  hydra_lib_math_ceiling  #f f64 bi))
            ...
            (cons (qname ns "floor")    (prim1 (qname ns "floor")    hydra_lib_math_floor    #f f64 bi))
            ...
            (cons (qname ns "round")    (prim1 (qname ns "round")    hydra_lib_math_round    #f f64 bi))
            ...
            (cons (qname ns "truncate") (prim1 (qname ns "truncate") hydra_lib_math_truncate #f f64 bi))))))
