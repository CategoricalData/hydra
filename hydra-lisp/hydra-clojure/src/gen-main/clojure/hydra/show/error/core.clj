(ns hydra.show.error.core
  (:require [hydra.core :refer :all] [hydra.error.core :refer :all] [hydra.lib.literals :refer :all] [hydra.lib.strings :refer :all] [hydra.show.core :refer :all] [hydra.show.variants :refer :all]
))
...
(def hydra_show_error_core_unexpected_term_variant_error (fn [e] (let [expected ((fn [v] (:expected_variant v)) e)] (let [actual ((fn [v] (:actual_term v)) e)] (hydra_lib_strings_cat (list "expected " (hydra_show_variants_term_variant expected) " term but found " (hydra_show_core_term actual)))))))

(def hydra_show_error_core_unexpected_type_variant_error (fn [e] (let [expected ((fn [v] (:expected_variant v)) e)] (let [actual ((fn [v] (:actual_type v)) e)] (hydra_lib_strings_cat (list "expected " (hydra_show_variants_type_variant expected) " type but found " (hydra_show_core_type actual)))))))
