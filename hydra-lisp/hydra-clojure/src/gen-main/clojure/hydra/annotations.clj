...
(def hydra_annotations_get_description (fn [cx] (fn [graph] (fn [anns] (((hydra_lib_maybes_maybe (list :right (list :nothing))) (fn [term] ((hydra_lib_eithers_map hydra_lib_maybes_pure) (((hydra_extract_core_string cx) graph) term)))) ((hydra_lib_maps_lookup "description") anns))))))
...
(def hydra_annotations_get_type (fn [graph] (fn [anns] (((hydra_lib_maybes_maybe (list :right (list :nothing))) (fn [dat] ((hydra_lib_eithers_map hydra_lib_maybes_pure) ((hydra_decode_core_type graph) dat)))) ((hydra_lib_maps_lookup hydra_constants_key_type) anns)))))
...
(def hydra_annotations_is_native_type (fn [el] (let [is_flagged_as_first_class_type ((hydra_lib_maybes_from_maybe false) ((hydra_lib_maybes_map (fn [_] true)) ((hydra_annotations_get_term_annotation hydra_constants_key_first_class_type) ((fn [v] (:term v)) el))))] (((hydra_lib_maybes_maybe false) (fn [ts] ((hydra_lib_logic_and ((hydra_lib_equality_equal ts) (->hydra_core_type_scheme (list) (list :variable "hydra.core.Type") (list :nothing)))) (hydra_lib_logic_not is_flagged_as_first_class_type)))) ((fn [v] (:type v)) el)))))
