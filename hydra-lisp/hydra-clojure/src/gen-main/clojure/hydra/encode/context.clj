...
(def hydra_encode_context_context (fn [x] (list :record (->hydra_core_record "hydra.context.Context" (list (->hydra_core_field "trace" ((fn [xs] (list :list ((hydra_lib_lists_map (fn [x] (list :literal (list :string x)))) xs))) ((fn [v] (:trace v)) x))) (->hydra_core_field "messages" ((fn [xs] (list :list ((hydra_lib_lists_map (fn [x] (list :literal (list :string x)))) xs))) ((fn [v] (:messages v)) x))) (->hydra_core_field "other" ((fn [m] (list :map (((hydra_lib_maps_bimap hydra_encode_core_name) hydra_encode_core_term) m))) ((fn [v] (:other v)) x))))))))
