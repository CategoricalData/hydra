...
(def hydra_encode_module_file_extension (fn [x] (list :wrap (->hydra_core_wrapped_term "hydra.module.FileExtension" ((fn [x] (list :literal (list :string x))) ((fn [v] v) x))))))
...
(def hydra_encode_module_qualified_name (fn [x] (list :record (->hydra_core_record "hydra.module.QualifiedName" (list (->hydra_core_field "namespace" ((fn [opt] (list :maybe ((hydra_lib_maybes_map hydra_encode_module_namespace) opt))) ((fn [v] (:namespace v)) x))) (->hydra_core_field "local" ((fn [x] (list :literal (list :string x))) ((fn [v] (:local v)) x))))))))
