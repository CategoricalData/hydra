(ns hydra.names
  (:require [hydra.annotations :refer :all] [hydra.constants :refer :all] [hydra.core :refer :all] [hydra.formatting :refer :all] [hydra.lib.equality :refer :all] [hydra.lib.lists :refer :all] [hydra.lib.literals :refer :all] [hydra.lib.logic :refer :all] [hydra.lib.maps :refer :all] [hydra.lib.math :refer :all] [hydra.lib.maybes :refer :all] [hydra.lib.pairs :refer :all] [hydra.lib.sets :refer :all] [hydra.lib.strings :refer :all] [hydra.module :refer :all] [hydra.util :refer :all]
))

(declare hydra_names_qualify_name hydra_names_compact_name hydra_names_normal_type_variable hydra_names_fresh_name hydra_names_fresh_names hydra_names_local_name_of hydra_names_namespace_of hydra_names_namespace_to_file_path hydra_names_qname hydra_names_unique_label hydra_names_unqualify_name)
