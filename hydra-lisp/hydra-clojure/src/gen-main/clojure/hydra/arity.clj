...
(def hydra_arity_function_arity (fn [match_target] ((fn [match_value] (cond (= (first match_target) :elimination) ((fn [_] 1) match_value) (= (first match_target) :lambda) ((fn [arg_] ((fn [i] ((hydra_lib_math_add 1) i)) ((fn [arg_] (hydra_arity_term_arity ((fn [v] (:body v)) arg_))) arg_))) match_value) (= (first match_target) :primitive) ((fn [_] 42) match_value))) (second match_target))))

(def hydra_arity_term_arity (fn [match_target] ((fn [match_value] (cond (= (first match_target) :application) ((fn [arg_] ((fn [arg_] ((fn [xapp] ((hydra_lib_math_sub xapp) 1)) (hydra_arity_term_arity arg_))) ((fn [v] (:function v)) arg_))) match_value) (= (first match_target) :function) (hydra_arity_function_arity match_value) :else 0)) (second match_target))))
...
(def hydra_arity_primitive_arity (fn [arg_] ((fn [arg_] (hydra_arity_type_arity ((fn [v] (:type v)) arg_))) ((fn [v] (:type v)) arg_))))
