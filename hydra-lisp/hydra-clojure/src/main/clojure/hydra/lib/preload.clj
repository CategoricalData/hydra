...
(def ^:private gen-ns-names
  ...
  ["hydra.core" "hydra.error" "hydra.compute" "hydra.context"
   "hydra.graph" "hydra.module" "hydra.monads" "hydra.phantoms"
   "hydra.coders" "hydra.grammar" "hydra.ast" "hydra.testing"
   "hydra.typing" "hydra.query" "hydra.relational" "hydra.tabular"
   "hydra.workflow" "hydra.classes" "hydra.topology" "hydra.parsing"
   "hydra.variants" "hydra.accessors" "hydra.util" "hydra.constants"
   ...
   "hydra.show.meta" "hydra.show.accessors"
   "hydra.lexical" "hydra.substitution"
   "hydra.extract.helpers" "hydra.extract.core" "hydra.extract.util"
   "hydra.extract.json"
   "hydra.unification"
   "hydra.encode.core" "hydra.encode.accessors" "hydra.encode.compute"
   "hydra.encode.context" "hydra.encode.core_" "hydra.encode.graph"
   ...
   "hydra.decode.core" "hydra.decode.accessors" "hydra.decode.compute"
   "hydra.decode.context" "hydra.decode.core_" "hydra.decode.graph"
   ...
   "hydra.annotations" "hydra.templates" "hydra.grammars"
   ...
   "hydra.json.writer"
   "hydra.ext.org.json.decoding" "hydra.ext.org.json.language"
   ...
   "hydra.test.lib.pairs" "hydra.test.lib.sets" "hydra.test.lib.strings"
...
(def ^:private gen-main-load-order
  ...
  [;; Core types (no cross-module term references)
   ...
   "hydra.formatting" "hydra.reflect" "hydra.names"
   "hydra.tarjan" "hydra.sorting" "hydra.rewriting"
   "hydra.show.core" "hydra.show.meta" "hydra.show.typing"
   "hydra.show.graph" "hydra.show.accessors" "hydra.show.util"
   "hydra.lexical"
   "hydra.extract.core" "hydra.extract.helpers" "hydra.extract.util"
   "hydra.encode.core" "hydra.decode.core"
   "hydra.annotations" "hydra.substitution"
   "hydra.schemas" "hydra.literals"
   "hydra.monads" "hydra.arity"
   "hydra.hoisting"
