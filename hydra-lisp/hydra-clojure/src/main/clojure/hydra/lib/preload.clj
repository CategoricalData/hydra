...
(def ^:private gen-ns-names
  ...
  ["hydra.core" "hydra.error" "hydra.context"
   ...
   "hydra.decode.core" "hydra.decode.accessors"
   "hydra.decode.context" "hydra.decode.ast" "hydra.decode.classes"
   "hydra.decode.coders" "hydra.decode.grammar"
...
(def ^:private gen-main-load-order
  ...
  [;; Core types (no cross-module term references)
   ...
   "hydra.show.core" "hydra.show.error" "hydra.show.meta" "hydra.show.typing"
