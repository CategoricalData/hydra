...
(defvar hydra_ext_java_testing_term_to_java (lambda (term) (lambda (g) (funcall (funcall (hydra_lib_eithers_bimap (lambda (ic) (hydra_show_errors_error (funcall (lambda (v) (hydra_context_in_context-object v)) ic)))) (lambda (arg_) (funcall (lambda (arg_) (hydra_serialization_print_expr (hydra_serialization_parenthesize arg_))) (hydra_ext_java_serde_write_expression arg_)))) (funcall (funcall (funcall (hydra_ext_java_coder_encode_term (make-hydra_ext_java_environment_java_environment (make-hydra_ext_java_environment_aliases "test" hydra_lib_maps_empty hydra_lib_sets_empty hydra_lib_sets_empty hydra_lib_sets_empty hydra_lib_sets_empty hydra_lib_sets_empty hydra_lib_maps_empty hydra_lib_sets_empty hydra_lib_maps_empty hydra_lib_sets_empty (list :nothing) hydra_lib_sets_empty) g)) term) hydra_lexical_empty_context) g)))))

(defvar hydra_ext_java_testing_type_to_java (lambda (_t) (lambda (_g) (list :right "Object"))))

(defvar hydra_ext_java_testing_java_test_codec (make-hydra_testing_test_codec "java" "java" hydra_ext_java_testing_term_to_java hydra_ext_java_testing_type_to_java hydra_ext_java_testing_format_java_test_name hydra_ext_java_testing_namespace_to_java_class_name hydra_ext_java_testing_java_test_case_template hydra_ext_java_testing_java_test_group_template hydra_ext_java_testing_java_module_template hydra_ext_java_testing_java_import_template (lambda (_names) hydra_ext_java_testing_find_java_imports)))

(defvar hydra_ext_java_testing_generate_java_test_file (lambda (test_module) (lambda (test_group) (lambda (g) (funcall (hydra_lib_eithers_bind (funcall (hydra_test_utils_infer_test_group_terms g) test_group)) (lambda (inferred_test_group) (funcall (funcall (funcall (hydra_ext_java_testing_generate_test_file_with_java_codec hydra_ext_java_testing_java_test_codec) test_module) inferred_test_group) g)))))))
