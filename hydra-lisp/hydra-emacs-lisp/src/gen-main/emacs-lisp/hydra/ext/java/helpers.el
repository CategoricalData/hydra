...
(defvar hydra_ext_java_helpers_java_symbol_class-variants (list :constant :nullary_function :hoisted_lambda :unary_function :local_variable))
...
(provide 'hydra.ext.java.helpers)
