...
(defvar hydra_encode_relational_column_name (lambda (x) (list :wrap (make-hydra_core_wrapped_term "hydra.relational.ColumnName" (funcall (lambda (x) (list :literal (list :string x))) (funcall (lambda (v) v) x))))))
...
(defvar hydra_encode_relational_relation_name (lambda (x) (list :wrap (make-hydra_core_wrapped_term "hydra.relational.RelationName" (funcall (lambda (x) (list :literal (list :string x))) (funcall (lambda (v) v) x))))))
