...
(defvar hydra_eval_lib_maybes_bind (lambda (cx) (lambda (g) (lambda (opt_term) (lambda (fun_term) (funcall (lambda (match_target) (funcall (lambda (match_value) (cond ((equal (car match_target) :maybe) (funcall (lambda (m) (list :right (funcall (funcall (hydra_lib_maybes_maybe (list :maybe (list :nothing))) (lambda (val) (list :application (make-hydra_core_application fun_term val)))) m))) match_value)) (t (list :left (make-hydra_context_in_context (list :other (funcall (hydra_lib_strings_cat2 (funcall (hydra_lib_strings_cat2 (funcall (hydra_lib_strings_cat2 "expected ") "optional value")) " but found ")) (hydra_show_core_term opt_term))) cx))))) (cadr match_target))) opt_term))))))

(defvar hydra_eval_lib_maybes_cases (lambda (cx) (lambda (g) (lambda (opt_term) (lambda (default_term) (lambda (fun_term) (funcall (lambda (match_target) (funcall (lambda (match_value) (cond ((equal (car match_target) :maybe) (funcall (lambda (m) (list :right (funcall (funcall (hydra_lib_maybes_maybe default_term) (lambda (val) (list :application (make-hydra_core_application fun_term val)))) m))) match_value)) (t (list :left (make-hydra_context_in_context (list :other (funcall (hydra_lib_strings_cat2 (funcall (hydra_lib_strings_cat2 (funcall (hydra_lib_strings_cat2 "expected ") "optional value")) " but found ")) (hydra_show_core_term opt_term))) cx))))) (cadr match_target))) opt_term)))))))
