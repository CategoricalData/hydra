...
(defvar hydra_json_yaml_encode_to_yaml (lambda (term) (funcall (hydra_lib_eithers_map (lambda (v) (hydra_json_yaml_encode_json_to_yaml v))) (hydra_json_encode_to_json term))))
