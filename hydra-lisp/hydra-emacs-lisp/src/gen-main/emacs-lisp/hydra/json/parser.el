...
(defvar hydra_json_parser_json_string (hydra_json_parser_token (funcall (hydra_parsers_bind (hydra_parsers_char 34)) (lambda (_) (funcall (hydra_parsers_bind (hydra_parsers_many hydra_json_parser_json_string_char)) (lambda (chars) (funcall (hydra_parsers_bind (hydra_parsers_char 34)) (lambda (_) (hydra_parsers_pure (list :string (hydra_lib_strings_from_list chars)))))))))))
...
(defvar hydra_json_parser_json_key_value (funcall (hydra_parsers_bind (hydra_json_parser_token (funcall (hydra_parsers_bind (hydra_parsers_char 34)) (lambda (_) (funcall (hydra_parsers_bind (hydra_parsers_many hydra_json_parser_json_string_char)) (lambda (chars) (funcall (hydra_parsers_bind (hydra_parsers_char 34)) (lambda (_) (hydra_parsers_pure (hydra_lib_strings_from_list chars)))))))))) (lambda (key) (funcall (hydra_parsers_bind (hydra_json_parser_token (hydra_parsers_char 58))) (lambda (_) (funcall (hydra_parsers_map (lambda (v) (list key v))) (hydra_parsers_lazy (lambda (_) hydra_json_parser_json_value))))))))
...
(defvar hydra_json_parser_parse_json (lambda (input) (funcall (funcall (lambda (v) v) (funcall (hydra_parsers_bind hydra_json_parser_whitespace) (lambda (_) (funcall (hydra_parsers_bind hydra_json_parser_json_value) (lambda (v) (funcall (hydra_parsers_bind hydra_json_parser_whitespace) (lambda (_) (funcall (hydra_parsers_bind hydra_parsers_eof) (lambda (_) (hydra_parsers_pure v)))))))))) input)))
