...
(cl:defvar hydra_annotations_get_description (cl:lambda (cx) (cl:lambda (graph) (cl:lambda (anns) (((hydra_lib_maybes_maybe (list :right (list :nothing))) (cl:lambda (term) ((hydra_lib_eithers_map hydra_lib_maybes_pure) (((hydra_extract_core_string cx) graph) term)))) ((hydra_lib_maps_lookup "description") anns))))))
...
(cl:defvar hydra_annotations_get_type (cl:lambda (graph) (cl:lambda (anns) (((hydra_lib_maybes_maybe (list :right (list :nothing))) (cl:lambda (dat) ((hydra_lib_eithers_map hydra_lib_maybes_pure) ((hydra_decode_core_type graph) dat)))) ((hydra_lib_maps_lookup hydra_constants_key_type) anns)))))
...
(cl:defvar hydra_annotations_is_native_type (cl:lambda (el) (let ((is_flagged_as_first_class_type ((hydra_lib_maybes_from_maybe cl:nil) ((hydra_lib_maybes_map (cl:lambda (_) cl:t)) ((hydra_annotations_get_term_annotation hydra_constants_key_first_class_type) ((cl:lambda (v) (hydra_core_binding-term v)) el)))))) (((hydra_lib_maybes_maybe cl:nil) (cl:lambda (ts) ((hydra_lib_logic_and ((hydra_lib_equality_equal ts) (make-hydra_core_type_scheme (cl:list) (list :variable "hydra.core.Type") (list :nothing)))) (hydra_lib_logic_not is_flagged_as_first_class_type)))) ((cl:lambda (v) (hydra_core_binding-type v)) el)))))
