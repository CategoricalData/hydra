...
(:use :cl :hydra.classes :hydra.constants :hydra.context :hydra.core :hydra.decode.core :hydra.encode.core :hydra.errors :hydra.extract.core :hydra.graph :hydra.lib.eithers :hydra.lib.equality :hydra.lib.lists :hydra.lib.logic :hydra.lib.maps :hydra.lib.math :hydra.lib.maybes :hydra.lib.pairs :hydra.lib.sets :hydra.lib.strings :hydra.rewriting :hydra.show.core)
...
(cl:defvar hydra_annotations_debug_if (cl:lambda (cx) (cl:lambda (debug_id) (cl:lambda (message) ((hydra_lib_eithers_bind (hydra_annotations_get_debug_id cx)) (cl:lambda (mid) (if ((hydra_lib_equality_equal mid) (list :just debug_id)) (list :left (make-hydra_context_in_context (list :other message) cx)) (list :right cl:nil))))))))
...
(cl:defvar hydra_annotations_get_description (cl:lambda (cx) (cl:lambda (graph) (cl:lambda (anns) (((hydra_lib_maybes_maybe (cl:lambda () (list :right (list :nothing)))) (cl:lambda (term) ((hydra_lib_eithers_map hydra_lib_maybes_pure) (((hydra_extract_core_string cx) graph) term)))) ((hydra_lib_maps_lookup "description") anns))))))
...
(cl:defvar hydra_annotations_get_type_classes (cl:lambda (cx) (cl:lambda (graph) (cl:lambda (term) (let ((decode_class (cl:lambda (term2) (let ((by_name (hydra_lib_maps_from_list (cl:list (cl:list "equality" (list :equality cl:nil)) (cl:list "ordering" (list :ordering cl:nil)))))) ((hydra_lib_eithers_bind ((((hydra_extract_core_unit_variant cx) "hydra.classes.TypeClass") graph) term2)) (cl:lambda (fn_) (((hydra_lib_maybes_maybe (cl:lambda () (list :left (make-hydra_context_in_context (list :other ((hydra_lib_strings_cat2 "unexpected: expected type class, got ") (hydra_show_core_term term2))) cx)))) (cl:lambda (x) (list :right x))) ((hydra_lib_maps_lookup fn_) by_name)))))))) (((hydra_lib_maybes_maybe (cl:lambda () (list :right hydra_lib_maps_empty))) (cl:lambda (term2) (((((hydra_extract_core_map cx) (cl:lambda (t_) (((hydra_lib_eithers_bimap (cl:lambda (de) (make-hydra_context_in_context (list :other ((cl:lambda (v) v) de)) cx))) (cl:lambda (x) x)) ((hydra_decode_core_name graph) t_)))) (((hydra_extract_core_set_of cx) decode_class) graph)) graph) term2))) ((hydra_annotations_get_term_annotation hydra_constants_key_classes) term)))))))
