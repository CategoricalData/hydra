...
(cl:defvar hydra_annotations_get_type_classes (cl:lambda (cx) (cl:lambda (graph) (cl:lambda (term) (let ((decode_class (cl:lambda (term) (let ((by_name (hydra_lib_maps_from_list (cl:list (cl:list "equality" (list :equality cl:nil)) (cl:list "ordering" (list :ordering cl:nil)))))) ((hydra_lib_eithers_bind ((((hydra_extract_core_unit_variant cx) "hydra.classes.TypeClass") graph) term)) (cl:lambda (fn_) (((hydra_lib_maybes_maybe (cl:lambda () (list :left (make-hydra_context_in_context (list :other ((hydra_lib_strings_cat2 "unexpected: expected type class, got ") (hydra_show_core_term term))) cx)))) (cl:lambda (x) (list :right x))) ((hydra_lib_maps_lookup fn_) by_name)))))))) (((hydra_lib_maybes_maybe (cl:lambda () (list :right hydra_lib_maps_empty))) (cl:lambda (term) (((((hydra_extract_core_map cx) (cl:lambda (t_) (((hydra_lib_eithers_bimap (cl:lambda (de) (make-hydra_context_in_context (list :other ((cl:lambda (v) v) de)) cx))) (cl:lambda (x) x)) ((hydra_decode_core_name graph) t_)))) (((hydra_extract_core_set_of cx) decode_class) graph)) graph) term))) ((hydra_annotations_get_term_annotation hydra_constants_key_classes) term)))))))
