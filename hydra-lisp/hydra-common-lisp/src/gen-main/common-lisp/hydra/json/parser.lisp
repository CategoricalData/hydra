...
(cl:defvar hydra_json_parser_json_integer_part ((hydra_parsers_bind (hydra_parsers_optional (hydra_parsers_char 45))) (cl:lambda (sign) ((hydra_parsers_bind hydra_json_parser_digits) (cl:lambda (digits) (hydra_parsers_pure (((hydra_lib_maybes_maybe digits) (cl:lambda (_) ((hydra_lib_strings_cat2 "-") digits))) sign)))))))
