...
(cl:defvar hydra_json_yaml_encode_to_yaml (cl:lambda (term) ((hydra_lib_eithers_map (cl:lambda (v) (hydra_json_yaml_encode_json_to_yaml v))) (hydra_json_encode_to_json term))))
