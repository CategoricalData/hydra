...
(cl:defvar hydra_lib_names_lists_maybe_at "hydra.lib.lists.maybeAt")

(cl:defvar hydra_lib_names_lists_maybe_head "hydra.lib.lists.maybeHead")

(cl:defvar hydra_lib_names_lists_maybe_init "hydra.lib.lists.maybeInit")

(cl:defvar hydra_lib_names_lists_maybe_last "hydra.lib.lists.maybeLast")

(cl:defvar hydra_lib_names_lists_maybe_tail "hydra.lib.lists.maybeTail")
...
(cl:defvar hydra_lib_names_math_add_float64 "hydra.lib.math.addFloat64")
...
(cl:defvar hydra_lib_names_math_maybe_div "hydra.lib.math.maybeDiv")

(cl:defvar hydra_lib_names_math_maybe_mod "hydra.lib.math.maybeMod")

(cl:defvar hydra_lib_names_math_maybe_pred "hydra.lib.math.maybePred")

(cl:defvar hydra_lib_names_math_maybe_rem "hydra.lib.math.maybeRem")

(cl:defvar hydra_lib_names_math_maybe_succ "hydra.lib.math.maybeSucc")
...
(cl:defvar hydra_lib_names_math_mul_float64 "hydra.lib.math.mulFloat64")

(cl:defvar hydra_lib_names_math_negate "hydra.lib.math.negate")

(cl:defvar hydra_lib_names_math_negate_float64 "hydra.lib.math.negateFloat64")
...
(cl:defvar hydra_lib_names_math_sub_float64 "hydra.lib.math.subFloat64")
...
(cl:defvar hydra_lib_names_regex "hydra.lib.regex")

(cl:defvar hydra_lib_names_regex_find "hydra.lib.regex.find")

(cl:defvar hydra_lib_names_regex_find_all "hydra.lib.regex.findAll")

(cl:defvar hydra_lib_names_regex_matches "hydra.lib.regex.matches")

(cl:defvar hydra_lib_names_regex_replace "hydra.lib.regex.replace")

(cl:defvar hydra_lib_names_regex_replace_all "hydra.lib.regex.replaceAll")

(cl:defvar hydra_lib_names_regex_split "hydra.lib.regex.split")
...
(cl:defvar hydra_lib_names_strings_maybe_char_at "hydra.lib.strings.maybeCharAt")
