...
(cl:defvar hydra_encode_tabular_header_row (cl:lambda (x) (list :wrap (make-hydra_core_wrapped_term "hydra.tabular.HeaderRow" ((cl:lambda (xs) (list :list ((hydra_lib_lists_map (cl:lambda (x) (list :literal (list :string x)))) xs))) ((cl:lambda (v) v) x))))))
