...
(defun test-case-conversion-neg-num1-lower-snake-case--neg-upper-snake-case ()
...
(defun test-case-conversion-neg-num2-lower-snake-case--neg-camelcase ()
...
(defun test-case-conversion-neg-num3-lower-snake-case--neg-pascalcase ()
...
(defun test-case-conversion-neg-num4-lower-snake-case--neg-lower-snake-case ()
...
(defun test-case-conversion-neg-num5-upper-snake-case--neg-lower-snake-case ()
...
(defun test-case-conversion-neg-num6-upper-snake-case--neg-camelcase ()
...
(defun test-case-conversion-neg-num7-upper-snake-case--neg-pascalcase ()
...
(defun test-case-conversion-neg-num8-upper-snake-case--neg-upper-snake-case ()
...
(defun test-case-conversion-neg-num9-camelcase--neg-lower-snake-case ()
...
(defun test-case-conversion-neg-num10-camelcase--neg-upper-snake-case ()
...
(defun test-case-conversion-neg-num11-camelcase--neg-pascalcase ()
...
(defun test-case-conversion-neg-num12-camelcase--neg-camelcase ()

  (assert (equal "aHelloWorld42A4242aB" (((hydra_formatting_convert_case (list :camel cl:nil)) (list :camel cl:nil)) "aHelloWorld42A4242aB"))))

(defun test-case-conversion-neg-num13-pascalcase--neg-lower-snake-case ()
...
(defun test-case-conversion-neg-num14-pascalcase--neg-upper-snake-case ()
...
(defun test-case-conversion-neg-num15-pascalcase--neg-camelcase ()
...
(defun test-case-conversion-neg-num16-pascalcase--neg-pascalcase ()
