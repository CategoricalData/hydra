...
(defun test-topological-sort-negtwo-trees ()
...
(defun test-topological-sort-negdiamond-dag ()
...
(defun test-topological-sort-negtwo-negnode-cycle ()

  (assert (equal (list :left (list (list 1 2))) (hydra_sorting_topological_sort (list (list 1 (list 2)) (list 2 (list 1)))))))

(defun test-topological-sort-negcycle-with-incoming-and-outgoing-edges ()
...
(defun test-topological-sort-scc-negempty-set ()

  (assert (equal (list ) (hydra_sorting_topological_sort_components (list )))))

(defun test-topological-sort-scc-negsingleton-set ()

  (assert (equal (list (list 1)) (hydra_sorting_topological_sort_components (list (list 1 (list )))))))

(defun test-topological-sort-scc-negdiscrete-set-with-multiple-elements ()
...
(defun test-topological-sort-scc-negsccs-with-dependencies-to-divfrom-non-negscc-nodes ()
