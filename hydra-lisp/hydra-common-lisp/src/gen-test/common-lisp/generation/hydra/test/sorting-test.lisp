...
(defun test-sorting-negtopological-sort-negtwo-trees ()
...
(defun test-sorting-negtopological-sort-negdiamond-dag ()
...
(defun test-sorting-negtopological-sort-negtwo-negnode-cycle ()

  (assert (equal (list :left (list (list 1 2))) (hydra_sorting_topological_sort (list (list 1 (list 2)) (list 2 (list 1)))))))

(defun test-sorting-negtopological-sort-negcycle-with-incoming-and-outgoing-edges ()
...
(defun test-sorting-negtopological-sort-scc-negempty-set ()

  (assert (equal (list ) (hydra_sorting_topological_sort_components (list )))))

(defun test-sorting-negtopological-sort-scc-negsingleton-set ()

  (assert (equal (list (list 1)) (hydra_sorting_topological_sort_components (list (list 1 (list )))))))

(defun test-sorting-negtopological-sort-scc-negdiscrete-set-with-multiple-elements ()
...
(defun test-sorting-negtopological-sort-scc-negsingle-two-negelement-component--num1 ()

  (assert (equal (list (list 2) (list 1)) (hydra_sorting_topological_sort_components (list (list 1 (list 2)) (list 2 (list )))))))

(defun test-sorting-negtopological-sort-scc-negsingle-two-negelement-component--num2 ()

  (assert (equal (list (list 1) (list 2)) (hydra_sorting_topological_sort_components (list (list 2 (list 1)) (list 1 (list )))))))

(defun test-sorting-negtopological-sort-scc-negmultiple-negelement-component ()
...
(defun test-sorting-negtopological-sort-scc-negcomplex-cycles ()

  (assert (equal (list (list 1 2 3)) (hydra_sorting_topological_sort_components (list (list 1 (list 2 3)) (list 2 (list 3)) (list 3 (list 1)))))))

(defun test-sorting-negtopological-sort-scc-negchain-of-three-sccs ()
...
(defun test-sorting-negtopological-sort-scc-negsccs-with-dependencies-to-divfrom-non-negscc-nodes ()
