  ...
  (let ((ns_ "hydra.lib.math")
    ...
    (append
      ...
      (list
        ...
        (cons (qname ns_ "ceiling")  (prim1 (qname ns_ "ceiling")  hydra_lib_math_ceiling  nil f64 bi))
        ...
        (cons (qname ns_ "floor")    (prim1 (qname ns_ "floor")    hydra_lib_math_floor    nil f64 bi))
        ...
        (cons (qname ns_ "round")    (prim1 (qname ns_ "round")    hydra_lib_math_round    nil f64 bi))
        ...
        (cons (qname ns_ "truncate") (prim1 (qname ns_ "truncate") hydra_lib_math_truncate nil f64 bi))))))
