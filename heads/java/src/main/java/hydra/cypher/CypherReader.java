...
import hydra.cypher.openCypher.AddOrSubtractExpression;
import hydra.cypher.openCypher.AddOrSubtractOperator;
import hydra.cypher.openCypher.AddOrSubtractRightHandSide;
import hydra.cypher.openCypher.AndExpression;
import hydra.cypher.openCypher.AnonymousPatternPart;
import hydra.cypher.openCypher.Atom;
import hydra.cypher.openCypher.CaseAlternative;
import hydra.cypher.openCypher.CaseExpression;
import hydra.cypher.openCypher.ComparisonExpression;
import hydra.cypher.openCypher.ComparisonOperator;
import hydra.cypher.openCypher.Create;
import hydra.cypher.openCypher.Delete;
import hydra.cypher.openCypher.ExistentialSubquery;
import hydra.cypher.openCypher.ExplicitProcedureInvocation;
import hydra.cypher.openCypher.Expression;
import hydra.cypher.openCypher.FilterExpression;
import hydra.cypher.openCypher.FunctionInvocation;
import hydra.cypher.openCypher.IdInColl;
import hydra.cypher.openCypher.ImplicitProcedureInvocation;
import hydra.cypher.openCypher.InQueryCall;
import hydra.cypher.openCypher.KeyValuePair;
import hydra.cypher.openCypher.Limit;
import hydra.cypher.openCypher.ListComprehension;
import hydra.cypher.openCypher.ListLiteral;
import hydra.cypher.openCypher.ListOperatorExpression;
import hydra.cypher.openCypher.ListOperatorExpressionOrPropertyLookup;
import hydra.cypher.openCypher.ListPredicateExpression;
import hydra.cypher.openCypher.Literal;
import hydra.cypher.openCypher.MapLiteral;
import hydra.cypher.openCypher.Match;
import hydra.cypher.openCypher.MatchOrCreate;
import hydra.cypher.openCypher.Merge;
import hydra.cypher.openCypher.MergeAction;
import hydra.cypher.openCypher.MultiPartQuery;
import hydra.cypher.openCypher.MultiplyDivideModuloExpression;
import hydra.cypher.openCypher.MultiplyDivideModuloOperator;
import hydra.cypher.openCypher.MultiplyDivideModuloRightHandSide;
import hydra.cypher.openCypher.NodeLabel;
import hydra.cypher.openCypher.NodeLabels;
import hydra.cypher.openCypher.NodePattern;
import hydra.cypher.openCypher.NodePatternChain;
import hydra.cypher.openCypher.NonArithmeticOperatorExpression;
import hydra.cypher.openCypher.NotExpression;
import hydra.cypher.openCypher.NullPredicateExpression;
import hydra.cypher.openCypher.NumberLiteral;
import hydra.cypher.openCypher.OrExpression;
import hydra.cypher.openCypher.Order;
import hydra.cypher.openCypher.Parameter;
import hydra.cypher.openCypher.ParenthesizedExpression;
import hydra.cypher.openCypher.PartialComparisonExpression;
import hydra.cypher.openCypher.Pattern;
import hydra.cypher.openCypher.PatternComprehension;
import hydra.cypher.openCypher.PatternElement;
import hydra.cypher.openCypher.PatternElementChain;
import hydra.cypher.openCypher.PatternPart;
import hydra.cypher.openCypher.PatternPredicate;
import hydra.cypher.openCypher.PatternWhere;
import hydra.cypher.openCypher.PowerOfExpression;
import hydra.cypher.openCypher.ProcedureInvocation;
import hydra.cypher.openCypher.ProcedureResultField;
import hydra.cypher.openCypher.ProjectionBody;
import hydra.cypher.openCypher.ProjectionItem;
import hydra.cypher.openCypher.ProjectionItems;
import hydra.cypher.openCypher.Properties;
import hydra.cypher.openCypher.PropertyEquals;
import hydra.cypher.openCypher.PropertyExpression;
import hydra.cypher.openCypher.PropertyKeyName;
import hydra.cypher.openCypher.PropertyLookup;
import hydra.cypher.openCypher.QualifiedName;
import hydra.cypher.openCypher.Quantifier;
import hydra.cypher.openCypher.QuantifierOperator;
import hydra.cypher.openCypher.Query;
import hydra.cypher.openCypher.RangeExpression;
import hydra.cypher.openCypher.RangeLiteral;
import hydra.cypher.openCypher.ReadingClause;
import hydra.cypher.openCypher.RegularQuery;
import hydra.cypher.openCypher.RelTypeName;
import hydra.cypher.openCypher.RelationshipDetail;
import hydra.cypher.openCypher.RelationshipPattern;
import hydra.cypher.openCypher.RelationshipTypes;
import hydra.cypher.openCypher.RelationshipsPattern;
import hydra.cypher.openCypher.Remove;
import hydra.cypher.openCypher.RemoveItem;
import hydra.cypher.openCypher.Return;
import hydra.cypher.openCypher.Set;
import hydra.cypher.openCypher.SetItem;
import hydra.cypher.openCypher.SinglePartQuery;
import hydra.cypher.openCypher.SingleQuery;
import hydra.cypher.openCypher.Skip;
import hydra.cypher.openCypher.SortItem;
import hydra.cypher.openCypher.SortOrder;
import hydra.cypher.openCypher.StandaloneCall;
import hydra.cypher.openCypher.StarOrYieldItems;
import hydra.cypher.openCypher.StringListNullPredicateExpression;
import hydra.cypher.openCypher.StringListNullPredicateRightHandSide;
import hydra.cypher.openCypher.StringLiteral;
import hydra.cypher.openCypher.StringPredicateExpression;
import hydra.cypher.openCypher.StringPredicateOperator;
import hydra.cypher.openCypher.UnaryAddOrSubtractExpression;
import hydra.cypher.openCypher.Union;
import hydra.cypher.openCypher.Unwind;
import hydra.cypher.openCypher.UpdatingClause;
import hydra.cypher.openCypher.Variable;
import hydra.cypher.openCypher.VariableAndNodeLabels;
import hydra.cypher.openCypher.VariableEquals;
import hydra.cypher.openCypher.VariablePlusEquals;
import hydra.cypher.openCypher.Where;
import hydra.cypher.openCypher.With;
import hydra.cypher.openCypher.WithClause;
import hydra.cypher.openCypher.XorExpression;
import hydra.cypher.openCypher.YieldItem;
import hydra.cypher.openCypher.YieldItems;
...
/**
 * A parser which constructs Cypher queries using the hydra.cypher.openCypher model.
 *
 * <p>Notes/limitations:
...
public class CypherReader extends AntlrReaderBase {
    ...
    /**
     * Like {@link #list}, but returns a ConsList.
     */
    private static <C1, C2, T> ConsList<T> consList(
            C1 c1, Function<C1, List<C2>> accessor, Function<C2, T> constructor) {
        return ConsList.fromList(list(c1, accessor, constructor));
    }

    /**
     * Like {@link #nonemptyList}, but returns a ConsList.
     */
    private static <C1, C2, T> ConsList<T> nonemptyConsList(
            C1 c1, Function<C1, List<C2>> accessor, Function<C2, T> constructor) {
        return ConsList.fromList(nonemptyList(c1, accessor, constructor));
    }
    ...
    private static OrExpression read(CypherParser.OC_OrExpressionContext ctx) {
        return new OrExpression(consList(ctx, CypherParser.OC_OrExpressionContext::oC_XorExpression, CypherReader::read));
    }
    ...
    private static XorExpression read(CypherParser.OC_XorExpressionContext ctx) {
        return new XorExpression(consList(ctx, CypherParser.OC_XorExpressionContext::oC_AndExpression, CypherReader::read));
    }
    ...
    private static AndExpression read(CypherParser.OC_AndExpressionContext ctx) {
        return new AndExpression(consList(ctx, CypherParser.OC_AndExpressionContext::oC_NotExpression, CypherReader::read));
    }
    ...
    private static ComparisonExpression read(CypherParser.OC_ComparisonExpressionContext ctx) {
        return new ComparisonExpression(
                required(ctx, CypherParser.OC_ComparisonExpressionContext::oC_StringListNullPredicateExpression,
                        CypherReader::read),
                consList(ctx, CypherParser.OC_ComparisonExpressionContext::oC_PartialComparisonExpression,
                        CypherReader::read));
    }
    ...
    private static StringListNullPredicateExpression read(
        ...
        return new StringListNullPredicateExpression(
                required(ctx,
                        ...
                        CypherReader::read),
                consList(ctx, CypherParser.OC_StringListNullPredicateExpressionContext
    ...
    private static AddOrSubtractExpression read(CypherParser.OC_AddOrSubtractExpressionContext ctx) {
        return new AddOrSubtractExpression(
                required(ctx, CypherParser.OC_AddOrSubtractExpressionContext::oC_MultiplyDivideModuloExpression,
                        CypherReader::read),
                consList(ctx, CypherParser.OC_AddOrSubtractExpressionContext::oC_AddOrSubtractExpression_RHS,
                        CypherReader::read));
    }
    ...
    private static MultiplyDivideModuloExpression read(CypherParser.OC_MultiplyDivideModuloExpressionContext ctx) {
        return new MultiplyDivideModuloExpression(
                required(ctx, CypherParser.OC_MultiplyDivideModuloExpressionContext::oC_PowerOfExpression,
                        CypherReader::read),
                consList(ctx, CypherParser.OC_MultiplyDivideModuloExpressionContext::oC_MultiplyDivideModuloExpression_RHS,
                        CypherReader::read));
    }
    ...
    private static PowerOfExpression read(CypherParser.OC_PowerOfExpressionContext ctx) {
        return new PowerOfExpression(
                consList(ctx, CypherParser.OC_PowerOfExpressionContext::oC_UnaryAddOrSubtractExpression,
                        CypherReader::read));
    }
    ...
    private static NonArithmeticOperatorExpression read(CypherParser.OC_NonArithmeticOperatorExpressionContext ctx) {
        return new NonArithmeticOperatorExpression(
                ...
                consList(ctx, CypherParser.OC_NonArithmeticOperatorExpressionContext
    ...
    private static FunctionInvocation read(CypherParser.OC_FunctionInvocationContext ctx) {
        return new FunctionInvocation(
                ...
                ctx.DISTINCT() != null,
                consList(ctx, CypherParser.OC_FunctionInvocationContext::oC_Expression, CypherReader::read));
    }
    ...
    private static RelationshipsPattern read(CypherParser.OC_RelationshipsPatternContext ctx) {
        return new RelationshipsPattern(
                ...
                nonemptyConsList(ctx, CypherParser.OC_RelationshipsPatternContext::oC_PatternElementChain,
                        CypherReader::read));
    }
    ...
    private static CaseExpression read(CypherParser.OC_CaseExpressionContext ctx) {
        return new CaseExpression(optional(ctx, CypherParser.OC_CaseExpressionContext::oC_Expression,
                CypherReader::read),
                consList(ctx, CypherParser.OC_CaseExpressionContext::oC_CaseAlternative, CypherReader::read),
    ...
    private static ListLiteral read(CypherParser.OC_ListLiteralContext ctx) {
        return new ListLiteral(consList(ctx, CypherParser.OC_ListLiteralContext::oC_Expression, CypherReader::read));
    }
    ...
    private static MultiPartQuery read(CypherParser.OC_MultiPartQueryContext ctx) {
        return new MultiPartQuery(
                consList(ctx, CypherParser.OC_MultiPartQueryContext::oc_WithClause, CypherReader::read),
    ...
    private static WithClause read(CypherParser.Oc_WithClauseContext ctx) {
        return new WithClause(
                consList(ctx, CypherParser.Oc_WithClauseContext::oC_ReadingClause, CypherReader::read),
                consList(ctx, CypherParser.Oc_WithClauseContext::oC_UpdatingClause, CypherReader::read),
    ...
    private static Pattern read(CypherParser.OC_PatternContext ctx) {
        return new Pattern(
                nonemptyConsList(ctx, CypherParser.OC_PatternContext::oC_PatternPart, CypherReader::read));
    }
    ...
    private static PatternElement read(CypherParser.OC_PatternElementContext ctx) {
        ...
        return np.isJust()
                ...
                new NodePatternChain(np.fromJust(),
                        consList(ctx, CypherParser.OC_PatternElementContext::oC_PatternElementChain,
                        CypherReader::read)))
    ...
    private static MapLiteral read(CypherParser.OC_MapLiteralContext ctx) {
        return new MapLiteral(consList(ctx, CypherParser.OC_MapLiteralContext::oc_KeyValuePair, CypherReader::read));
    }
    ...
    private static NodeLabels read(CypherParser.OC_NodeLabelsContext ctx) {
        return new NodeLabels(nonemptyConsList(ctx, CypherParser.OC_NodeLabelsContext::oC_NodeLabel, CypherReader::read));
    }
    ...
    private static RelationshipTypes read(CypherParser.OC_RelationshipTypesContext ctx) {
        return new RelationshipTypes(consList(ctx, CypherParser.OC_RelationshipTypesContext::oC_RelTypeName,
                CypherReader::read));
    }
    ...
    private static YieldItems read(CypherParser.OC_YieldItemsContext ctx) {
        return new YieldItems(
                nonemptyConsList(ctx, CypherParser.OC_YieldItemsContext::oC_YieldItem, CypherReader::read),
    ...
    private static ExplicitProcedureInvocation read(CypherParser.OC_ExplicitProcedureInvocationContext ctx) {
        return new ExplicitProcedureInvocation(
                ...
                consList(ctx, CypherParser.OC_ExplicitProcedureInvocationContext::oC_Expression, CypherReader::read));
    }
    ...
    private static RegularQuery read(CypherParser.OC_RegularQueryContext ctx) {
        ...
        ConsList<Union> rest = consList(ctx,
    ...
    private static SinglePartQuery read(CypherParser.OC_SinglePartQueryContext ctx) {
        ConsList<ReadingClause> rc = consList(ctx,
                CypherParser.OC_SinglePartQueryContext::oC_ReadingClause,
                CypherReader::read);
        ConsList<UpdatingClause> uc = consList(ctx,
    ...
    private static Order read(CypherParser.OC_OrderContext ctx) {
        return new Order(consList(ctx, CypherParser.OC_OrderContext::oC_SortItem, CypherReader::read));
    }
    ...
    private static ProjectionItems read(CypherParser.OC_ProjectionItemsContext ctx) {
        return new ProjectionItems(
                ...
                consList(ctx, CypherParser.OC_ProjectionItemsContext::oC_ProjectionItem, CypherReader::read));
    }
    ...
    private static Remove read(CypherParser.OC_RemoveContext ctx) {
        return new Remove(nonemptyConsList(ctx, CypherParser.OC_RemoveContext::oC_RemoveItem, CypherReader::read));
    }
    ...
    private static Set read(CypherParser.OC_SetContext ctx) {
        return new Set(consList(ctx, CypherParser.OC_SetContext::oC_SetItem, CypherReader::read));
    }
    ...
    private static PropertyExpression read(CypherParser.OC_PropertyExpressionContext ctx) {
        return new PropertyExpression(
                ...
                nonemptyConsList(ctx, CypherParser.OC_PropertyExpressionContext::oC_PropertyLookup, CypherReader::read));
    }
    ...
    private static Delete read(CypherParser.OC_DeleteContext ctx) {
        return new Delete(
                ctx.DETACH() != null,
                consList(ctx, CypherParser.OC_DeleteContext::oC_Expression, CypherReader::read));
    }
    ...
    private static Merge read(CypherParser.OC_MergeContext ctx) {
        return new Merge(
                ...
                consList(ctx, CypherParser.OC_MergeContext::oC_MergeAction, CypherReader::read));
    }
