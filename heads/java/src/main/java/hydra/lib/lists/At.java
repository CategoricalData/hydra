...
public class At extends PrimitiveFunction {
    ...
    protected Function<List<Term>, Function<Context, Function<Graph, Either<Error_, Term>>>> implementation() {
        return args -> cx -> graph -> hydra.lib.eithers.Bind.apply(hydra.extract.Core.int32(graph, args.get(0)), i -> hydra.lib.eithers.Map.apply((Function<List<Term>, Term>) list -> list.get(i), hydra.extract.Core.list(graph, args.get(1))));
    }
