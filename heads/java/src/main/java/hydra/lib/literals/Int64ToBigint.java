...
public class Int64ToBigint extends PrimitiveFunction {
     ...
     * @return the function name "hydra.lib.literals.int64ToBigint"
     */
    public Name name() {
    ...
    protected Function<List<Term>, Function<InferenceContext, Function<Graph, Either<Error_, Term>>>> implementation() {
        return args -> cx -> graph -> hydra.lib.eithers.Map.apply(s -> Terms.bigint(apply(s)), hydra.extract.Core.int64(graph, args.get(0)));
    }
