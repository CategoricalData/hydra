...
toDefinition (TypedTermDefinition name (TypedTerm term)) = DefinitionTerm $ TermDefinition name term Nothing
...
toTermDefinition (TypedBinding name (TypedTerm term)) = DefinitionTerm $ TermDefinition name term Nothing
