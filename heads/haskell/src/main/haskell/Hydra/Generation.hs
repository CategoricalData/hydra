...
-- (#630). The driver-level POST-generation correction pass this section used
-- to also provide ('correctHaskellLibRedirect'/'correctTypeScriptLibRedirect'/
-- 'redirectLibBack') is now dead code, deleted -- superseded by #630.
