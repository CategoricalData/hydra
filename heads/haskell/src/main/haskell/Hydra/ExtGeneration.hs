...
coqLibPrimitiveNames = Set.fromList [
  ...
  "nub","null","odd","or","parseBigint","parseBoolean","parseDecimal",
  "parseFloat32","parseFloat64","parseInt16","parseInt32","parseInt64","parseInt8",
  "parseString","parseUint16","parseUint32","parseUint64","parseUint8",
  "partition","partitionEithers","pi","pow","pred",
  "printBigint","printBoolean","printDecimal","printFloat32",
  "printFloat64","printInt16","printInt32","printInt64","printInt8","printString",
...
writeCommonLisp basePath universeModules modulesToGenerate = do
  ...
  generateSources (moduleToLispDialect LispSyntax.DialectCommonLisp "lisp" knownSubs) commonLispLanguage True basePath universeModules modulesToGenerate
