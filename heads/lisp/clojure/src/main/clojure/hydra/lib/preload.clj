...
(def ^:private gen-ns-names
  "All generated namespaces to pre-create. Manifest order; main + eval-lib + test."
  ["hydra.paths" "hydra.ast" "hydra.classes" "hydra.coders" "hydra.context"
   "hydra.core" "hydra.error.checking" "hydra.error.core" "hydra.error.packaging"
   "hydra.errors" "hydra.graph" "hydra.json.model" "hydra.packaging"
   "hydra.parsing" "hydra.phantoms" "hydra.query" "hydra.relational"
   "hydra.tabular" "hydra.testing" "hydra.topology" "hydra.typing" "hydra.util"
   "hydra.variants" "hydra.adapt" "hydra.analysis" "hydra.annotations"
   "hydra.arity" "hydra.checking" "hydra.codegen" "hydra.constants"
   "hydra.decoding" "hydra.dependencies" "hydra.differentiation" "hydra.encoding"
   "hydra.environment" "hydra.extract.core" "hydra.extract.util" "hydra.formatting"
   "hydra.hoisting" "hydra.inference" "hydra.languages" "hydra.lexical"
   "hydra.lib.names" "hydra.literals" "hydra.names" "hydra.parsers"
   "hydra.predicates" "hydra.reduction" "hydra.reflect" "hydra.resolution"
   "hydra.rewriting" "hydra.scoping" "hydra.serialization" "hydra.strip"
   "hydra.show.paths" "hydra.show.core" "hydra.show.errors" "hydra.show.error.core"
   "hydra.show.graph" "hydra.show.variants" "hydra.show.typing" "hydra.show.util"
   "hydra.sorting" "hydra.substitution" "hydra.templates" "hydra.unification"
   "hydra.validate.core" "hydra.validate.packaging" "hydra.variables"
   "hydra.decode.paths" "hydra.decode.ast" "hydra.decode.classes"
   "hydra.decode.coders" "hydra.decode.context" "hydra.decode.core"
   "hydra.decode.errors" "hydra.decode.error.checking" "hydra.decode.error.core"
   "hydra.decode.json.model" "hydra.decode.packaging" "hydra.decode.parsing"
   "hydra.decode.phantoms" "hydra.decode.query" "hydra.decode.relational"
   "hydra.decode.tabular" "hydra.decode.testing" "hydra.decode.topology"
   "hydra.decode.typing" "hydra.decode.util" "hydra.decode.variants"
   "hydra.encode.paths" "hydra.encode.ast" "hydra.encode.classes"
   "hydra.encode.coders" "hydra.encode.context" "hydra.encode.core"
   "hydra.encode.errors" "hydra.encode.error.checking" "hydra.encode.error.core"
   "hydra.encode.json.model" "hydra.encode.packaging" "hydra.encode.parsing"
   "hydra.encode.phantoms" "hydra.encode.query" "hydra.encode.relational"
   "hydra.encode.tabular" "hydra.encode.testing" "hydra.encode.topology"
   "hydra.encode.typing" "hydra.encode.util" "hydra.encode.variants"
   "hydra.json.bootstrap" "hydra.json.decode" "hydra.json.decoding"
   "hydra.json.encode" "hydra.extract.json" "hydra.json.parser" "hydra.json.writer"
   ...
   "hydra.test.etaExpansion" "hydra.test.formatting" "hydra.test.generation"
   "hydra.test.json.roundtrip" "hydra.test.json.writer" "hydra.test.json.yaml"
   "hydra.test.reduction" "hydra.test.rewriting" "hydra.test.serialization"
   "hydra.test.sorting" "hydra.test.strip" "hydra.test.variables"
   "hydra.test.checking.all" "hydra.test.checking.advanced"
   "hydra.test.checking.algebraicTypes" "hydra.test.checking.collections"
   "hydra.test.checking.failures" "hydra.test.checking.fundamentals"
   "hydra.test.checking.nominalTypes" "hydra.test.inference.all"
...
(def ^:private gen-main-load-order
  ...
  ["hydra.ast" "hydra.classes" "hydra.core" "hydra.json.model" "hydra.parsing"
   ...
   "hydra.variants" "hydra.yaml.model" "hydra.constants" "hydra.context"
   "hydra.differentiation" "hydra.encode.ast" "hydra.encode.classes"
   ...
   "hydra.phantoms" "hydra.query" "hydra.show.core" "hydra.encode.json.model"
   ...
   "hydra.show.variants" "hydra.sorting" "hydra.typing" "hydra.encode.context"
   "hydra.encode.paths" "hydra.error.core" "hydra.encode.phantoms"
   ...
   "hydra.error.packaging" "hydra.lib.names" "hydra.test.transform"
   ...
   "hydra.extract.util" "hydra.annotations" "hydra.decode.context"
   "hydra.decode.packaging" "hydra.decode.paths" "hydra.decode.phantoms"
