...
(def ^:private gen-ns-names
  ...
  ["hydra.paths" "hydra.ast" "hydra.classes" "hydra.coders"   "hydra.core" "hydra.error.checking" "hydra.error.core" "hydra.error.packaging"
   ...
   "hydra.parsing" "hydra.query" "hydra.relational"
   "hydra.tabular" "hydra.testing" "hydra.topology" "hydra.typed" "hydra.typing" "hydra.util"
   ...
   "hydra.decode.query" "hydra.decode.relational"
   "hydra.decode.tabular" "hydra.decode.testing" "hydra.decode.topology"
   "hydra.decode.typed" "hydra.decode.typing" "hydra.decode.util" "hydra.decode.variants"
   ...
   "hydra.encode.query" "hydra.encode.relational"
   "hydra.encode.tabular" "hydra.encode.testing" "hydra.encode.topology"
   "hydra.encode.typed" "hydra.encode.typing" "hydra.encode.util" "hydra.encode.variants"
