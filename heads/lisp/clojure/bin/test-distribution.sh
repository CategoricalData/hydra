...
if test_cache_check clojure "$HYDRA_ROOT_DIR/dist/clojure" "${HYDRA_CLOJURE_HEAD}/src/test" "${BASH_SOURCE[0]}"; then
...
test_cache_record clojure "$HYDRA_ROOT_DIR/dist/clojure" "${HYDRA_CLOJURE_HEAD}/src/test" "${BASH_SOURCE[0]}"
