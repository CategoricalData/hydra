...
if test_cache_check emacs-lisp "$HYDRA_ROOT_DIR/dist/emacs-lisp" "${HYDRA_EL_HEAD}/src/test" "$THIS_SCRIPT"; then
...
test_cache_record emacs-lisp "$HYDRA_ROOT_DIR/dist/emacs-lisp" "${HYDRA_EL_HEAD}/src/test" "$THIS_SCRIPT"
