...
;; e :: Double
(defvar hydra_lisp_lib_math_e (exp 1.0d0))
...
(defvar hydra_lisp_lib_math_logBase
  (lambda (base)
    (lambda (x)
      (/ (funcall hydra_lisp_lib_math_log x) (funcall hydra_lisp_lib_math_log base)))))
...
;; pi :: Double
(defvar hydra_lisp_lib_math_pi (float pi 1.0d0))
