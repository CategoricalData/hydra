...
object Libraries:
  ...
  private def mathPrimitives(): Map[String, Primitive] =
    ...
    Map(
      ...
      // Float64 primitives
      s"$ns.addFloat64" -> mkPrimImpl(s"$ns.addFloat64", tMono(tFun(tFloat64, tFun(tFloat64, tFloat64))),
      ...
      s"$ns.mulFloat64" -> mkPrimImpl(s"$ns.mulFloat64", tMono(tFun(tFloat64, tFun(tFloat64, tFloat64))),
        impl2((a, b) => mkFloat64(math.mulFloat64(exFloat64(a))(exFloat64(b))))),
      s"$ns.negateFloat64" -> mkPrimImpl(s"$ns.negateFloat64", tMono(tFun(tFloat64, tFloat64)),
      ...
      s"$ns.subFloat64" -> mkPrimImpl(s"$ns.subFloat64", tMono(tFun(tFloat64, tFun(tFloat64, tFloat64))),
