...
(:use :cl :hydra.constants :hydra.formatting :hydra.lib.eithers :hydra.lib.equality :hydra.lib.lists :hydra.lib.logic :hydra.lib.strings :hydra.packaging :hydra.testing :hydra.util)
...
(cl:defvar hydra_java_testing_build_java_test_module (cl:lambda (test_module) (cl:lambda (test_group) (cl:lambda (test_body) (let* ((ns_ ((cl:lambda (v) (hydra_packaging_module-namespace v)) test_module)) (parts ((hydra_lib_strings_split_on ".") ((cl:lambda (v) v) ns_))) (class_name_ ((hydra_lib_strings_cat2 (hydra_formatting_capitalize (hydra_lib_lists_last parts))) "Test")) (group_name_ ((cl:lambda (v) (hydra_testing_test_group-name v)) test_group)) (package_name ((hydra_lib_strings_intercalate ".") (hydra_lib_lists_init parts))) (standard_imports (cl:list "import org.junit.jupiter.api.Test;" "import static org.junit.jupiter.api.Assertions.*;" "import java.util.*;" "import hydra.util.*;")) (header (hydra_lib_strings_cat (cl:list ((hydra_lib_strings_cat2 "// ") hydra_constants_warning_auto_generated_file) "
...
(cl:defvar hydra_java_testing_generate_test_file_with_java_codec (cl:lambda (test_module) (cl:lambda (test_group) ((hydra_lib_eithers_map (cl:lambda (test_body) (let* ((ns_ ((cl:lambda (v) (hydra_packaging_module-namespace v)) test_module)) (parts ((hydra_lib_strings_split_on ".") ((cl:lambda (v) v) ns_))) (class_name_ ((hydra_lib_strings_cat2 (hydra_formatting_capitalize (hydra_lib_lists_last parts))) "Test")) (dir_parts ((hydra_lib_lists_drop 1) (hydra_lib_lists_init parts))) (file_name ((hydra_lib_strings_cat2 class_name_) ".java")) (file_path (hydra_lib_strings_cat (cl:list ((hydra_lib_strings_intercalate "/") dir_parts) "/" file_name))) (test_module_content (((hydra_java_testing_build_java_test_module test_module) test_group) test_body))) (cl:list file_path test_module_content)))) ((hydra_java_testing_generate_java_test_group_hierarchy (cl:list)) test_group)))))
