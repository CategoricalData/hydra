...
(cl:defvar hydra_java_utils_add_expressions (cl:lambda (exprs) (let ((dummy_mult (list :unary (list :other (list :postfix (list :primary (list :no_new_array (list :literal (list :integer 0))))))))) (((hydra_lib_lists_foldl (cl:lambda (ae) (cl:lambda (me) (list :plus (make-hydra_java_syntax_additive_expression_binary ae me))))) (list :unary ((hydra_lib_maybes_from_maybe (cl:lambda () dummy_mult)) (hydra_lib_lists_maybe_head exprs)))) ((hydra_lib_lists_drop 1) exprs)))))
...
(cl:defvar hydra_java_utils_is_escaped (cl:lambda (s) ((hydra_lib_equality_equal ((hydra_lib_maybes_from_maybe (cl:lambda () 0)) ((hydra_lib_strings_maybe_char_at 0) s))) 36)))

(cl:defvar hydra_java_utils_unescape (cl:lambda (s) (hydra_lib_strings_from_list ((hydra_lib_lists_drop 1) (hydra_lib_strings_to_list s)))))
