...
(:use :cl :hydra.annotations :hydra.constants :hydra.core :hydra.formatting :hydra.lib.equality :hydra.lib.lists :hydra.lib.literals :hydra.lib.logic :hydra.lib.maps :hydra.lib.math :hydra.lib.maybes :hydra.lib.pairs :hydra.lib.sets :hydra.lib.strings :hydra.packaging :hydra.util)
...
(cl:defvar hydra_names_qualify_name (cl:lambda (name) (let ((parts (hydra_lib_lists_reverse ((hydra_lib_strings_split_on ".") ((cl:lambda (v) v) name))))) (if ((hydra_lib_equality_equal 1) (hydra_lib_lists_length parts)) (make-hydra_packaging_qualified_name (list :nothing) ((cl:lambda (v) v) name)) (make-hydra_packaging_qualified_name (list :just ((hydra_lib_strings_intercalate ".") (hydra_lib_lists_reverse (hydra_lib_lists_tail parts)))) (hydra_lib_lists_head parts))))))
