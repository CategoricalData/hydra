...
(cl:defvar hydra_json_parser_json_key_value ((hydra_parsers_bind (hydra_json_parser_token ((hydra_parsers_bind (hydra_parsers_char 34)) (cl:lambda (_) ((hydra_parsers_bind (hydra_parsers_many hydra_json_parser_json_string_char)) (cl:lambda (chars) ((hydra_parsers_bind (hydra_parsers_char 34)) (cl:lambda (_2) (hydra_parsers_pure (hydra_lib_strings_from_list chars)))))))))) (cl:lambda (key) ((hydra_parsers_bind (hydra_json_parser_token (hydra_parsers_char 58))) (cl:lambda (_) ((hydra_parsers_map (cl:lambda (v) (cl:list key v))) (hydra_parsers_lazy (cl:lambda (_2) hydra_json_parser_json_value))))))))
...
(cl:defvar hydra_json_parser_parse_json (cl:lambda (input) (((cl:lambda (v) v) ((hydra_parsers_bind hydra_json_parser_whitespace) (cl:lambda (_) ((hydra_parsers_bind hydra_json_parser_json_value) (cl:lambda (v) ((hydra_parsers_bind hydra_json_parser_whitespace) (cl:lambda (_2) ((hydra_parsers_bind hydra_parsers_eof) (cl:lambda (_3) (hydra_parsers_pure v)))))))))) input)))
