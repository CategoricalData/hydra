...
(cl:defvar hydra_core_literal-variants (cl:list :binary :boolean :decimal :float :integer :string))

(cl:defvar hydra_core_literal_type-variants (cl:list :binary :boolean :decimal :float :integer :string))
