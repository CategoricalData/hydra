...
(define hydra_variants_term_variant-variants (list 'annotated 'application 'cases 'either 'lambda 'let 'list 'literal 'map 'maybe 'pair 'project 'record 'set 'type_application 'type_lambda 'union 'unit 'unwrap 'variable 'wrap))
