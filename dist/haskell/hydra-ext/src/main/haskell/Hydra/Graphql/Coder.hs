...
moduleToGraphql :: Module.Module -> [Module.Definition] -> Context.Context -> Graph.Graph -> Either Errors.Error (M.Map String String)
...
encodeTypeDefinition :: Context.Context -> Graph.Graph -> M.Map Module.Namespace String -> Module.TypeDefinition -> Either Errors.Error Syntax.TypeDefinition
...
descriptionFromType :: Context.Context -> Graph.Graph -> Core.Type -> Either Errors.Error (Maybe Syntax.Description)
...
encodeEnumFieldType :: Context.Context -> Graph.Graph -> Core.FieldType -> Either Errors.Error Syntax.EnumValueDefinition
...
encodeFieldType :: Context.Context -> Graph.Graph -> M.Map Module.Namespace String -> Core.FieldType -> Either Errors.Error Syntax.FieldDefinition
...
encodeLiteralType :: Context.Context -> Core.LiteralType -> Either Errors.Error Syntax.NamedType
encodeLiteralType cx lt =
    case lt of
      ...
      Core.LiteralTypeFloat v0 -> case v0 of
        ...
        _ -> Left (Errors.ErrorOther (Errors.OtherError (Strings.cat2 "Expected 64-bit float type, found: " (Core_.floatType v0))))
      Core.LiteralTypeInteger v0 -> case v0 of
        Core.IntegerTypeInt32 -> Right (Syntax.NamedType (Syntax.Name "Int"))
        _ -> Left (Errors.ErrorOther (Errors.OtherError (Strings.cat2 "Expected 32-bit signed integer type, found: " (Core_.integerType v0))))
      Core.LiteralTypeString -> Right (Syntax.NamedType (Syntax.Name "String"))
      _ -> Left (Errors.ErrorOther (Errors.OtherError (Strings.cat2 "Expected GraphQL-compatible literal type, found: " (Core_.literalType lt))))

encodeNamedType :: Context.Context -> Graph.Graph -> M.Map Module.Namespace String -> Core.Name -> Core.Type -> Either Errors.Error Syntax.TypeDefinition
encodeNamedType cx g prefixes name typ =
    case (Strip.deannotateType typ) of
      ...
      _ -> Left (Errors.ErrorOther (Errors.OtherError (Strings.cat2 "Expected record or union type, found: " (Core_.type_ typ))))

encodeType :: Context.Context -> t0 -> M.Map Module.Namespace String -> Core.Type -> Either Errors.Error Syntax.Type
encodeType cx g prefixes typ =
    case (Strip.deannotateType typ) of
      Core.TypeMaybe v0 -> case (Strip.deannotateType v0) of
        ...
        _ -> Left (Errors.ErrorOther (Errors.OtherError (Strings.cat2 "Expected GraphQL-compatible type, found: " (Core_.type_ v0))))
      ...
      _ -> Left (Errors.ErrorOther (Errors.OtherError (Strings.cat2 "Expected GraphQL-compatible type, found: " (Core_.type_ typ))))
...
encodeUnionFieldType :: Context.Context -> Graph.Graph -> M.Map Module.Namespace String -> Core.FieldType -> Either Errors.Error Syntax.FieldDefinition
