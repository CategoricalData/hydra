...
_ColumnDefinition_DefaultOrIdentityOrGeneration_Option =
    Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition_DefaultOrIdentityOrGeneration_Option"
...
_ContextuallyTypedRowValueExpressionList =
    Core.Name "hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueExpressionList"
...
_ContextuallyTypedTableValueConstructor =
    Core.Name "hydra.ext.org.ansi.sql.syntax.ContextuallyTypedTableValueConstructor"
...
_NonparenthesizedValueExpressionPrimary =
    Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"
