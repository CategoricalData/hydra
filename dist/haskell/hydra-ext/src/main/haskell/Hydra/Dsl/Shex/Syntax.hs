...
unAtpNameNs x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.AtpNameNs")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unBaseDecl :: Phantoms.TTerm Syntax.BaseDecl -> Phantoms.TTerm Syntax.IriRef
unBaseDecl x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.BaseDecl")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unBlankNode :: Phantoms.TTerm Syntax.BlankNode -> Phantoms.TTerm Syntax.BlankNodeLabel
unBlankNode x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.BlankNode")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unCode :: Phantoms.TTerm Syntax.Code -> Phantoms.TTerm [Syntax.Code_Elmt]
unCode x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Code")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unDatatype :: Phantoms.TTerm Syntax.Datatype -> Phantoms.TTerm Syntax.Iri
unDatatype x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Datatype")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unDecimal :: Phantoms.TTerm Syntax.Decimal -> Phantoms.TTerm String
unDecimal x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Decimal")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unDouble :: Phantoms.TTerm Syntax.Double_ -> Phantoms.TTerm String
unDouble x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Double")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unEchar :: Phantoms.TTerm Syntax.Echar -> Phantoms.TTerm String
unEchar x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Echar")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unExclusion :: Phantoms.TTerm Syntax.Exclusion -> Phantoms.TTerm Syntax.Iri
unExclusion x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Exclusion")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unExtraPropertySet :: Phantoms.TTerm Syntax.ExtraPropertySet -> Phantoms.TTerm [Syntax.Predicate]
unExtraPropertySet x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.ExtraPropertySet")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unHex :: Phantoms.TTerm Syntax.Hex -> Phantoms.TTerm String
unHex x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Hex")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unInclude :: Phantoms.TTerm Syntax.Include -> Phantoms.TTerm Syntax.TripleExprLabel
unInclude x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Include")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unIncludeSet :: Phantoms.TTerm Syntax.IncludeSet -> Phantoms.TTerm [Syntax.ShapeExprLabel]
unIncludeSet x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.IncludeSet")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unInlineShapeExpression x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.InlineShapeExpression")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unInteger :: Phantoms.TTerm Syntax.Integer_ -> Phantoms.TTerm String
unInteger x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.Integer")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unIriRef :: Phantoms.TTerm Syntax.IriRef -> Phantoms.TTerm [Syntax.IriRef_Elmt]
unIriRef x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.IriRef")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unLangTag :: Phantoms.TTerm Syntax.LangTag -> Phantoms.TTerm String
unLangTag x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.LangTag")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unPnLocalEsc :: Phantoms.TTerm Syntax.PnLocalEsc -> Phantoms.TTerm String
unPnLocalEsc x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.PnLocalEsc")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unPnameNs :: Phantoms.TTerm Syntax.PnameNs -> Phantoms.TTerm (Maybe Syntax.PnPrefix)
unPnameNs x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.PnameNs")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unRdfType :: Phantoms.TTerm Syntax.RdfType -> Phantoms.TTerm ()
unRdfType x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.RdfType")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unSemanticActions :: Phantoms.TTerm Syntax.SemanticActions -> Phantoms.TTerm [Syntax.CodeDecl]
unSemanticActions x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.SemanticActions")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unSenseFlags :: Phantoms.TTerm Syntax.SenseFlags -> Phantoms.TTerm ()
unSenseFlags x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.SenseFlags")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unShapeExpression :: Phantoms.TTerm Syntax.ShapeExpression -> Phantoms.TTerm Syntax.ShapeOr
unShapeExpression x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.ShapeExpression")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unStartActions :: Phantoms.TTerm Syntax.StartActions -> Phantoms.TTerm [Syntax.CodeDecl]
unStartActions x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.StartActions")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unStringLiteral1 :: Phantoms.TTerm Syntax.StringLiteral1 -> Phantoms.TTerm [Syntax.StringLiteral1_Elmt]
unStringLiteral1 x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.StringLiteral1")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unStringLiteral2 :: Phantoms.TTerm Syntax.StringLiteral2 -> Phantoms.TTerm [Syntax.StringLiteral2_Elmt]
unStringLiteral2 x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.StringLiteral2")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unStringLiteralLong1 x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.StringLiteralLong1")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unStringLiteralLong2 x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.StringLiteralLong2")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unTripleExpression :: Phantoms.TTerm Syntax.TripleExpression -> Phantoms.TTerm Syntax.OneOfTripleExpr
unTripleExpression x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.TripleExpression")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unValueSet :: Phantoms.TTerm Syntax.ValueSet -> Phantoms.TTerm [Syntax.ValueSetValue]
unValueSet x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.shex.syntax.ValueSet")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
