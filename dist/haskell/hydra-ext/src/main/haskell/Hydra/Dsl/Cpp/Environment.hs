...
cppEnvironment :: Phantoms.TTerm (Util.Namespaces String) -> Phantoms.TTerm ([Core.Name], (M.Map Core.Name String)) -> Phantoms.TTerm Environment.CppEnvironment
...
cppEnvironmentWithNamespaces :: Phantoms.TTerm Environment.CppEnvironment -> Phantoms.TTerm (Util.Namespaces String) -> Phantoms.TTerm Environment.CppEnvironment
