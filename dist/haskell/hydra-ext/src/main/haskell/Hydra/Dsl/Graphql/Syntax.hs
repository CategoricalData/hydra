...
unArguments x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.Arguments")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unArgumentsDefinition x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.ArgumentsDefinition")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unDefaultValue :: Phantoms.TTerm Syntax.DefaultValue -> Phantoms.TTerm Syntax.Value
unDefaultValue x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.DefaultValue")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unDescription :: Phantoms.TTerm Syntax.Description -> Phantoms.TTerm Syntax.StringValue
unDescription x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.Description")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unDirectives :: Phantoms.TTerm Syntax.Directives -> Phantoms.TTerm [Syntax.Directive]
unDirectives x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.Directives")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unDocument :: Phantoms.TTerm Syntax.Document -> Phantoms.TTerm [Syntax.Definition]
unDocument x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.Document")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unEnumValue :: Phantoms.TTerm Syntax.EnumValue -> Phantoms.TTerm Syntax.Name
unEnumValue x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.EnumValue")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unEnumValuesDefinition x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.EnumValuesDefinition")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unExecutableDocument x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.ExecutableDocument")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unFieldsDefinition :: Phantoms.TTerm Syntax.FieldsDefinition -> Phantoms.TTerm [Syntax.FieldDefinition]
unFieldsDefinition x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.FieldsDefinition")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unFloatValue :: Phantoms.TTerm Syntax.FloatValue -> Phantoms.TTerm String
unFloatValue x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.FloatValue")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unFragmentName :: Phantoms.TTerm Syntax.FragmentName -> Phantoms.TTerm Syntax.Name
unFragmentName x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.FragmentName")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unInputFieldsDefinition x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.InputFieldsDefinition")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unIntValue :: Phantoms.TTerm Syntax.IntValue -> Phantoms.TTerm String
unIntValue x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.IntValue")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unListType :: Phantoms.TTerm Syntax.ListType -> Phantoms.TTerm Syntax.Type
unListType x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.ListType")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unName :: Phantoms.TTerm Syntax.Name -> Phantoms.TTerm String
unName x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.Name")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unNamedType :: Phantoms.TTerm Syntax.NamedType -> Phantoms.TTerm Syntax.Name
unNamedType x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.NamedType")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unNullValue :: Phantoms.TTerm Syntax.NullValue -> Phantoms.TTerm ()
unNullValue x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.NullValue")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unSelectionSet :: Phantoms.TTerm Syntax.SelectionSet -> Phantoms.TTerm [Syntax.Selection]
unSelectionSet x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.SelectionSet")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unStringValue :: Phantoms.TTerm Syntax.StringValue -> Phantoms.TTerm String
unStringValue x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.StringValue")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unTypeSystemDocment x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.TypeSystemDocment")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
...
unTypeSystemExtensionDocument x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.TypeSystemExtensionDocument")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unVariable :: Phantoms.TTerm Syntax.Variable -> Phantoms.TTerm Syntax.Name
unVariable x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.graphql.syntax.Variable")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
