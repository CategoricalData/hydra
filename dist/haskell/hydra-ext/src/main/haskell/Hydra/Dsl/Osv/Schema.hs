...
unEcosystem x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.Ecosystem")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unId :: Phantoms.TTerm Schema.Id -> Phantoms.TTerm String
unId x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.Id")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unMarkdown :: Phantoms.TTerm Schema.Markdown -> Phantoms.TTerm String
unMarkdown x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.Markdown")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unOsvVersion :: Phantoms.TTerm Schema.OsvVersion -> Phantoms.TTerm String
unOsvVersion x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.OsvVersion")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unReferenceType :: Phantoms.TTerm Schema.ReferenceType -> Phantoms.TTerm String
unReferenceType x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.ReferenceType")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unSeverityScore :: Phantoms.TTerm Schema.SeverityScore -> Phantoms.TTerm String
unSeverityScore x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.SeverityScore")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unSeverityType :: Phantoms.TTerm Schema.SeverityType -> Phantoms.TTerm String
unSeverityType x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.SeverityType")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unTimestamp :: Phantoms.TTerm Schema.Timestamp -> Phantoms.TTerm String
unTimestamp x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.Timestamp")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unUrl :: Phantoms.TTerm Schema.Url -> Phantoms.TTerm String
unUrl x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.Url")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unVersion :: Phantoms.TTerm Schema.Version -> Phantoms.TTerm String
unVersion x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.Version")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unVersionOrStar :: Phantoms.TTerm Schema.VersionOrStar -> Phantoms.TTerm String
unVersionOrStar x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.VersionOrStar")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unVersionOrZero :: Phantoms.TTerm Schema.VersionOrZero -> Phantoms.TTerm String
unVersionOrZero x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.VersionOrZero")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))

unVersionType :: Phantoms.TTerm Schema.VersionType -> Phantoms.TTerm String
unVersionType x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.osv.schema.VersionType")))),
      Core.applicationArgument = (Phantoms.unTTerm x)}))
