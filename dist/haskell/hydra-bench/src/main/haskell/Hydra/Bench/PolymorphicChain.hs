...
-- | Polymorphic-chain inference benchmark. polyWalker_K :: Maybe a -> Maybe a; chains via Optionals.bind, instantiating forall a at each cross-def call site.
