    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        ...
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (Maybes.maybe "valid" (\e -> ShowErrorCore.invalidTermError e) (ValidateCore.term False TestGraph.testGraph (Core.TermFunction (Core.FunctionLambda (Core.Lambda {
