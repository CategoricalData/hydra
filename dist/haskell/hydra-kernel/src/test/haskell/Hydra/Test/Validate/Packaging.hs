      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkConflictingModuleNames (Packaging.Package {
            ...
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases Nothing "valid" (\e -> ShowErrorPackaging.invalidPackageError e))})),
            ...
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkConflictingModuleNames (Packaging.Package {
              ...
              Packaging.packageModules = [
                ...
                Packaging.Module {
                  ...
                  Packaging.moduleDependencies = [],
                  Packaging.moduleDefinitions = []}]})) "valid" (\e -> ShowErrorPackaging.invalidPackageError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidPackageErrorConflictingModuleName (ErrorPackaging.ConflictingModuleNameError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkConflictingVariantNames (Packaging.Module {
              Packaging.moduleName = (Packaging.ModuleName "hydra.foo"),
              Packaging.moduleMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test module hydra.foo"),
                Packaging.entityMetadataComments = [],
            ...
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases Nothing "valid" (\e -> ShowErrorPackaging.invalidModuleError e))})),
          Testing.testCaseWithMetadataDescription = Nothing,
          Testing.testCaseWithMetadataTags = []}]}
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkDefinitionDocumentation (Packaging.Module {
              Packaging.moduleName = (Packaging.ModuleName "hydra.foo"),
              Packaging.moduleMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test module hydra.foo"),
                Packaging.entityMetadataComments = [],
        ...
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            ...
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidModuleErrorMissingDocumentation (ErrorPackaging.MissingDocumentationError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          Testing.testCaseWithMetadataName = "empty module: no error",
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkDefinitionModuleNames (Packaging.Module {
              Packaging.moduleName = (Packaging.ModuleName "hydra.foo"),
              Packaging.moduleMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test module hydra.foo"),
                Packaging.entityMetadataComments = [],
              ...
              Packaging.moduleDefinitions = [
                Packaging.DefinitionTerm (Packaging.TermDefinition {
                  ...
                  Packaging.termDefinitionBody = (Core.TermAnnotated (Core.AnnotatedTerm {
                    ...
                    Core.annotatedTermAnnotation = (Annotations.wrapAnnotationMap (Maps.fromList [
                      (Core.Name "description", (Core.TermLiteral (Core.LiteralString "test description")))]))}))})]})) "valid" (\e -> ShowErrorPackaging.invalidModuleError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidModuleErrorDefinitionNotInModuleName (ErrorPackaging.DefinitionNotInModuleNameError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          Testing.testCaseWithMetadataName = "empty module: no error",
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkDefinitionNameConvention (Packaging.Module {
              Packaging.moduleName = (Packaging.ModuleName "hydra.foo"),
              Packaging.moduleMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test module hydra.foo"),
                Packaging.entityMetadataComments = [],
              ...
              Packaging.moduleDefinitions = [
                Packaging.DefinitionTerm (Packaging.TermDefinition {
                  ...
                  Packaging.termDefinitionBody = (Core.TermAnnotated (Core.AnnotatedTerm {
                    ...
                    Core.annotatedTermAnnotation = (Annotations.wrapAnnotationMap (Maps.fromList [
                      (Core.Name "description", (Core.TermLiteral (Core.LiteralString "test description")))]))}))})]})) "valid" (\e -> ShowErrorPackaging.invalidModuleError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidModuleErrorInvalidDefinitionName (ErrorPackaging.InvalidDefinitionNameError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          Testing.testCaseWithMetadataName = "empty module: no error",
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkDefinitionOrdering (Packaging.Module {
              Packaging.moduleName = (Packaging.ModuleName "hydra.foo"),
              Packaging.moduleMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test module hydra.foo"),
                Packaging.entityMetadataComments = [],
              ...
              Packaging.moduleDefinitions = [
                ...
                (Packaging.DefinitionTerm (Packaging.TermDefinition {
                  ...
                  Packaging.termDefinitionBody = (Core.TermAnnotated (Core.AnnotatedTerm {
                    ...
                    Core.annotatedTermAnnotation = (Annotations.wrapAnnotationMap (Maps.fromList [
                      (Core.Name "description", (Core.TermLiteral (Core.LiteralString "test description")))]))}))}))]})) "valid" (\e -> ShowErrorPackaging.invalidModuleError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidModuleErrorDefinitionsOutOfOrder (ErrorPackaging.DefinitionsOutOfOrderError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          Testing.testCaseWithMetadataName = "empty module: no error",
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkDuplicateDefinitionNames (Packaging.Module {
              Packaging.moduleName = (Packaging.ModuleName "hydra.foo"),
              Packaging.moduleMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test module hydra.foo"),
                Packaging.entityMetadataComments = [],
              ...
              Packaging.moduleDefinitions = [
                ...
                (Packaging.DefinitionTerm (Packaging.TermDefinition {
                  ...
                  Packaging.termDefinitionBody = (Core.TermAnnotated (Core.AnnotatedTerm {
                    ...
                    Core.annotatedTermAnnotation = (Annotations.wrapAnnotationMap (Maps.fromList [
                      (Core.Name "description", (Core.TermLiteral (Core.LiteralString "test description")))]))}))}))]})) "valid" (\e -> ShowErrorPackaging.invalidModuleError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidModuleErrorDuplicateDefinitionName (ErrorPackaging.DuplicateDefinitionNameError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkDuplicateModuleNames (Packaging.Package {
              Packaging.packageName = (Packaging.PackageName "test-pkg"),
              Packaging.packageMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test package test-pkg"),
                Packaging.entityMetadataComments = [],
            ...
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkDuplicateModuleNames (Packaging.Package {
              ...
              Packaging.packageModules = [
                ...
                Packaging.Module {
                  ...
                  Packaging.moduleDependencies = [],
                  Packaging.moduleDefinitions = []}]})) "valid" (\e -> ShowErrorPackaging.invalidPackageError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidPackageErrorDuplicateModuleName (ErrorPackaging.DuplicateModuleNameError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkModuleNameConvention (Packaging.Module {
        ...
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkModuleNameConvention (Packaging.Module {
              ...
              Packaging.moduleDependencies = [],
              Packaging.moduleDefinitions = []})) "valid" (\e -> ShowErrorPackaging.invalidModuleError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidModuleErrorInvalidModuleNameConvention (ErrorPackaging.InvalidModuleNameConventionError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkPackageNameConvention (Packaging.Package {
        ...
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.checkPackageNameConvention (Packaging.Package {
              ...
              Packaging.packageDependencies = [],
              Packaging.packageModules = []})) "valid" (\e -> ShowErrorPackaging.invalidPackageError e)),
            Testing.universalTestCaseExpected = (\_ -> Maybes.cases (Just (ErrorPackaging.InvalidPackageErrorInvalidPackageName (ErrorPackaging.InvalidPackageNameError {
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.kernelModule (Packaging.Module {
              Packaging.moduleName = (Packaging.ModuleName "hydra.foo"),
              Packaging.moduleMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test module hydra.foo"),
                Packaging.entityMetadataComments = [],
    ...
    Testing.TestGroup {
      ...
      Testing.testGroupCases = [
        Testing.TestCaseWithMetadata {
          ...
          Testing.testCaseWithMetadataCase = (Testing.TestCaseUniversal (Testing.UniversalTestCase {
            Testing.universalTestCaseActual = (\_ -> Maybes.cases (ValidatePackaging.kernelPackage (Packaging.Package {
              Packaging.packageName = (Packaging.PackageName "test-pkg"),
              Packaging.packageMetadata = (Just (Packaging.EntityMetadata {
                Packaging.entityMetadataDescription = (Just "Test package test-pkg"),
                Packaging.entityMetadataComments = [],
            ...
            Testing.universalTestCaseActual = (\_ -> Strings.cat2 (Strings.cat2 "errors=[" (Strings.cat2 (Strings.intercalate ";" (Lists.map (\e -> ShowErrorPackaging.invalidModuleError e) (Validation.validationResultErrors (ValidatePackaging.module_ (Validation.ValidationProfile {
              ...
              Packaging.moduleDefinitions = [
                ...
                (Packaging.DefinitionTerm (Packaging.TermDefinition {
                  ...
                  Packaging.termDefinitionMetadata = Nothing,
                  Packaging.termDefinitionSignature = Nothing,
                  Packaging.termDefinitionBody = (Core.TermLiteral (Core.LiteralString "value"))}))]}))))) "]")) (Strings.cat2 " warnings=[" (Strings.cat2 (Strings.intercalate ";" (Lists.map (\w -> ShowErrorPackaging.invalidModuleError w) (Validation.validationResultWarnings (ValidatePackaging.module_ (Validation.ValidationProfile {
              Validation.validationProfileErrorRules = (Sets.fromList [
                Core.Name "hydra.error.packaging.InvalidModuleError.missingDocumentation",
                (Core.Name "hydra.error.packaging.InvalidModuleError.duplicateDefinitionName")]),
              Validation.validationProfileWarningRules = (Sets.fromList []),
