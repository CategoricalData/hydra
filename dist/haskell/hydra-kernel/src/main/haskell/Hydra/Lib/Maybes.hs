...
apply =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionDescription = "Applicative apply for maybes: combine a maybe function and a maybe argument.",
      Packaging.primitiveDefinitionComments = (Just "apply(mf, mx) returns Just(f x) when mf is Just(f) and mx is Just(x), and Nothing if either is Nothing. The applicative apply for maybe; threads a function-in-context with a value-in-context. Total. Corresponds to Haskell's (<*>) :: Maybe (a -> b) -> Maybe a -> Maybe b."),
    ...
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionSignature = Typing.TermSignature {
        ...
        Typing.termSignatureResult = Typing.Result {
          Typing.resultDescription = Nothing,
          Typing.resultType = (Core.TypeMaybe (Core.TypeVariable (Core.Name "y")))}},
      Packaging.primitiveDefinitionDescription = "Monadic bind for maybes.",
      Packaging.primitiveDefinitionComments = (Just "bind(m, f) returns f(x) when m is Just(x), and Nothing when m is Nothing. The monadic bind for maybe; used to chain computations that may be absent. Total. Corresponds to Haskell's (>>=) :: Maybe a -> (a -> Maybe b) -> Maybe b."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
cases =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionDescription = "Case analysis on a maybe, with cases-style argument order.",
      Packaging.primitiveDefinitionComments = (Just "cases(m, def, f) returns f(x) when m is Just(x), and def when m is Nothing. Identical in behavior to the maybe primitive but with the maybe value as the first argument (matching the convention for case-statement-like elimination). Total. Argument order is (m, def, f) rather than Haskell's (def, f, m)."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
cat =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionDescription = "Concatenate maybes, keeping only the present values.",
      Packaging.primitiveDefinitionComments = (Just "cat(xs) returns the list of contained values from Just elements of xs, in original order; Nothing elements are discarded. Total. Corresponds to Haskell's Data.Maybe.catMaybes :: [Maybe a] -> [a]."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
compose =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionDescription = "Kleisli composition for maybes.",
      Packaging.primitiveDefinitionComments = (Just "compose(f, g, x) returns the Kleisli composition of f and g applied to x: bind(f(x), g). If either f or the second stage produces Nothing, the result is Nothing. Total. Corresponds to Haskell's Kleisli composition for Maybe, (>=>) :: (a -> Maybe b) -> (b -> Maybe c) -> a -> Maybe c."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
fromMaybe =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionDescription = "Return the value contained in a maybe, falling back to a default if absent.",
      Packaging.primitiveDefinitionComments = (Just "fromMaybe(def, m) returns x when m is Just(x), and def when m is Nothing. Total. Corresponds to Haskell's Data.Maybe.fromMaybe :: a -> Maybe a -> a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
isJust =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionDescription = "Test whether a maybe is present (Just).",
      Packaging.primitiveDefinitionComments = (Just "isJust(m) returns true iff m is a Just variant. Total. Corresponds to Haskell's Data.Maybe.isJust :: Maybe a -> Bool."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
    ...
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionSignature = Typing.TermSignature {
        ...
        Typing.termSignatureResult = Typing.Result {
          Typing.resultDescription = Nothing,
          Typing.resultType = (Core.TypeLiteral Core.LiteralTypeBoolean)}},
      Packaging.primitiveDefinitionDescription = "Test whether a maybe is absent (Nothing).",
      Packaging.primitiveDefinitionComments = (Just "isNothing(m) returns true iff m is the Nothing variant. Total. Corresponds to Haskell's Data.Maybe.isNothing :: Maybe a -> Bool."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
    ...
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionSignature = Typing.TermSignature {
        ...
        Typing.termSignatureResult = Typing.Result {
          Typing.resultDescription = Nothing,
          Typing.resultType = (Core.TypeMaybe (Core.TypeVariable (Core.Name "y")))}},
      Packaging.primitiveDefinitionDescription = "Map a function over a maybe.",
      Packaging.primitiveDefinitionComments = (Just "map(f, m) returns Just(f x) when m is Just(x), and Nothing when m is Nothing. The functor instance for maybe. Total. Corresponds to Haskell's fmap :: (a -> b) -> Maybe a -> Maybe b."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
mapMaybe =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "mapMaybe(f, xs) applies f to each element of xs and returns the list of contained values from Just results in original order; Nothing results are discarded. Total. Corresponds to Haskell's Data.Maybe.mapMaybe :: (a -> Maybe b) -> [a] -> [b]."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
    ...
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionSignature = Typing.TermSignature {
        ...
        Typing.termSignatureResult = Typing.Result {
          Typing.resultDescription = Nothing,
          Typing.resultType = (Core.TypeVariable (Core.Name "y"))}},
      Packaging.primitiveDefinitionDescription = "Case analysis on a maybe, applying a function if present or returning a default if absent.",
      Packaging.primitiveDefinitionComments = (Just "maybe(def, f, m) returns f(x) when m is Just(x), and def when m is Nothing. The fundamental eliminator for the maybe type; every other primitive in this namespace can be derived from it. Total. Corresponds to Haskell's maybe :: b -> (a -> b) -> Maybe a -> b."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
pure =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "pure(x) = Just(x). The applicative pure for maybe. Total. Corresponds to Haskell's pure :: a -> Maybe a / Just."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
    ...
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionSignature = Typing.TermSignature {
        ...
        Typing.termSignatureResult = Typing.Result {
          Typing.resultDescription = Nothing,
          Typing.resultType = (Core.TypeList (Core.TypeVariable (Core.Name "x")))}},
      Packaging.primitiveDefinitionDescription = "Convert a maybe to a list: Just x maps to [x], Nothing to [].",
      Packaging.primitiveDefinitionComments = (Just "toList(m) returns [x] when m is Just(x), and the empty list when m is Nothing. Total. Corresponds to Haskell's Data.Maybe.maybeToList :: Maybe a -> [a]."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
