...
bimap =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "bimap(f, g, p) returns a new pair (f(first(p)), g(second(p))). The bifunctor map for pairs. Total. Corresponds to Haskell's Data.Bifunctor.bimap :: (a -> c) -> (b -> d) -> (a, b) -> (c, d)."),
...
first =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "first(p) returns the first component of the pair p. Total. Corresponds to Haskell's fst :: (a, b) -> a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
second =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "second(p) returns the second component of the pair p. Total. Corresponds to Haskell's snd :: (a, b) -> b."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
