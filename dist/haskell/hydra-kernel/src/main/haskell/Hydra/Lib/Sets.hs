...
delete =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "delete(x, s) returns s with x removed; if x is not in s, s is returned unchanged. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.delete :: Ord a => a -> Set a -> Set a."),
...
difference =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "difference(s1, s2) returns the set of elements that are in s1 but not in s2. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.difference :: Ord a => Set a -> Set a -> Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
empty =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "empty is the set with no elements. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.empty :: Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
fromList =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "fromList(xs) returns the set containing exactly the distinct elements of xs; duplicates are discarded. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.fromList :: Ord a => [a] -> Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
insert =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "insert(x, s) returns s with x added; if x is already in s, s is returned unchanged. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.insert :: Ord a => a -> Set a -> Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
intersection =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "intersection(s1, s2) returns the set of elements present in both s1 and s2. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.intersection :: Ord a => Set a -> Set a -> Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
map =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "map(f, s) returns the set of f(x) for each x in s. Elements that f maps to the same image are deduplicated by the result type's ordering. Requires 'ordering' constraints on both the input and output element types. Total. Corresponds to Haskell's Data.Set.map :: (Ord a, Ord b) => (a -> b) -> Set a -> Set b."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
member =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "member(x, s) returns true iff x is an element of s. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.member :: Ord a => a -> Set a -> Bool."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
null =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "null(s) returns true iff s has no elements. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.null :: Set a -> Bool."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
singleton =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "singleton(x) returns the set containing exactly the element x. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.singleton :: a -> Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
size =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "size(s) returns the number of elements in s as an int32. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.size :: Set a -> Int (with narrowing to int32)."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
toList =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionDescription = "Convert a set to a list (in ascending order).",
      Packaging.primitiveDefinitionComments = (Just "toList(s) returns the elements of s as a list, in ascending order under the element type's ordering. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.toAscList :: Set a -> [a]."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
union =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "union(s1, s2) returns the set of elements that are in s1 or in s2 (or both). Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.union :: Ord a => Set a -> Set a -> Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
unions =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "unions(ss) returns the union of every set in ss. Equivalent to folding union over ss starting from empty. Requires an 'ordering' constraint on the element type. Total. Corresponds to Haskell's Data.Set.unions :: Ord a => [Set a] -> Set a."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
