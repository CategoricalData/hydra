...
and =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "and(p, q) returns true iff both p and q are true. Evaluation is strict in both arguments at the primitive level; for short-circuiting behavior, use ifElse. Total. Corresponds to Haskell's (&&) :: Bool -> Bool -> Bool (but without short-circuit evaluation)."),
...
ifElse =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "ifElse(p, t, f) returns t if p is true, or f if p is false. The unselected branch is not necessarily evaluated; ifElse is the standard way to express short-circuiting boolean logic and branching in Hydra. Total. Corresponds to Haskell's if/then/else."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
not =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "not(p) returns false if p is true, or true if p is false. Total. Corresponds to Haskell's not :: Bool -> Bool."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
...
or =
    Packaging.PrimitiveDefinition {
      ...
      Packaging.primitiveDefinitionComments = (Just "or(p, q) returns true iff at least one of p and q is true. Evaluation is strict in both arguments at the primitive level; for short-circuiting behavior, use ifElse. Total. Corresponds to Haskell's (||) :: Bool -> Bool -> Bool (but without short-circuit evaluation)."),
      Packaging.primitiveDefinitionSeeAlso = [],
      Packaging.primitiveDefinitionIsPure = True,
      Packaging.primitiveDefinitionIsTotal = True,
      Packaging.primitiveDefinitionAvailableSince = Nothing,
