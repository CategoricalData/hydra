...
intercalate = primitive2 (Prims.primName DefStrings.intercalate)

-- | Return the length of a string.
length :: TypedTerm String -> TypedTerm Int
length = primitive1 (Prims.primName DefStrings.length)

-- | Split a string into lines.
lines :: TypedTerm String -> TypedTerm [String]
lines = primitive1 (Prims.primName DefStrings.lines)
