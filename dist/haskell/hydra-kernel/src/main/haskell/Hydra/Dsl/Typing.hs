...
-- Bootstrap shims for new types (#156). These will be regenerated by sync.
...
parameter name description type_ isLazy =
    Phantoms.TTerm (Core.TermRecord (Core.Record {
      ...
      Core.recordFields = [
        ...
        Core.Field { Core.fieldName = (Core.Name "type"), Core.fieldTerm = (Phantoms.unTTerm type_)},
        Core.Field { Core.fieldName = (Core.Name "isLazy"), Core.fieldTerm = (Phantoms.unTTerm isLazy)}]}))
...
parameterName x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.Parameter"), Core.projectionField = (Core.Name "name")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
parameterDescription :: Phantoms.TTerm Typing.Parameter -> Phantoms.TTerm (Maybe String)
parameterDescription x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.Parameter"), Core.projectionField = (Core.Name "description")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
...
parameterType x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.Parameter"), Core.projectionField = (Core.Name "type")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
parameterIsLazy :: Phantoms.TTerm Typing.Parameter -> Phantoms.TTerm Bool
parameterIsLazy x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.Parameter"), Core.projectionField = (Core.Name "isLazy")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
...
resultDescription x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.Result"), Core.projectionField = (Core.Name "description")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
resultType :: Phantoms.TTerm Typing.Result -> Phantoms.TTerm Core.Type
resultType x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.Result"), Core.projectionField = (Core.Name "type")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
...
termSignature typeParameters parameters result_ =
    Phantoms.TTerm (Core.TermRecord (Core.Record {
      Core.recordTypeName = (Core.Name "hydra.typing.TermSignature"),
      Core.recordFields = [
        Core.Field { Core.fieldName = (Core.Name "typeParameters"), Core.fieldTerm = (Phantoms.unTTerm typeParameters)},
        Core.Field { Core.fieldName = (Core.Name "parameters"), Core.fieldTerm = (Phantoms.unTTerm parameters)},
        Core.Field { Core.fieldName = (Core.Name "result"), Core.fieldTerm = (Phantoms.unTTerm result_)}]}))
termSignatureTypeParameters :: Phantoms.TTerm Typing.TermSignature -> Phantoms.TTerm [Typing.TypeParameter]
termSignatureTypeParameters x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.TermSignature"), Core.projectionField = (Core.Name "typeParameters")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
termSignatureParameters :: Phantoms.TTerm Typing.TermSignature -> Phantoms.TTerm [Typing.Parameter]
termSignatureParameters x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.TermSignature"), Core.projectionField = (Core.Name "parameters")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
termSignatureResult :: Phantoms.TTerm Typing.TermSignature -> Phantoms.TTerm Typing.Result
termSignatureResult x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.TermSignature"), Core.projectionField = (Core.Name "result")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
...
typeParameter name constraints =
    Phantoms.TTerm (Core.TermRecord (Core.Record {
      ...
      Core.recordFields = [
        Core.Field { Core.fieldName = (Core.Name "name"), Core.fieldTerm = (Phantoms.unTTerm name)},
        Core.Field { Core.fieldName = (Core.Name "constraints"), Core.fieldTerm = (Phantoms.unTTerm constraints)}]}))
...
typeParameterName x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.TypeParameter"), Core.projectionField = (Core.Name "name")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
typeParameterConstraints :: Phantoms.TTerm Typing.TypeParameter -> Phantoms.TTerm [Core.TypeClassConstraint]
typeParameterConstraints x = Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermProject (Core.Projection { Core.projectionTypeName = (Core.Name "hydra.typing.TypeParameter"), Core.projectionField = (Core.Name "constraints")})),
  Core.applicationArgument = (Phantoms.unTTerm x)}))
