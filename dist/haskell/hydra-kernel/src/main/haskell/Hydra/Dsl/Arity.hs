...
primitiveArity :: Typed.TypedTerm Graph.Primitive -> Typed.TypedTerm Int
primitiveArity arg0 =
    Typed.TypedTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermVariable (Core.Name "hydra.arity.primitiveArity")),
      Core.applicationArgument = (Typed.unTypedTerm arg0)}))

-- | DSL reference to hydra.arity.termArity
termArity :: Typed.TypedTerm Core.Term -> Typed.TypedTerm Int
termArity arg0 =
    Typed.TypedTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermVariable (Core.Name "hydra.arity.termArity")),
      Core.applicationArgument = (Typed.unTypedTerm arg0)}))

-- | DSL reference to hydra.arity.typeArity
typeArity :: Typed.TypedTerm Core.Type -> Typed.TypedTerm Int
typeArity arg0 =
    Typed.TypedTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermVariable (Core.Name "hydra.arity.typeArity")),
      Core.applicationArgument = (Typed.unTypedTerm arg0)}))

-- | DSL reference to hydra.arity.typeSchemeArity
typeSchemeArity :: Typed.TypedTerm Core.TypeScheme -> Typed.TypedTerm Int
typeSchemeArity arg0 =
    Typed.TypedTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermVariable (Core.Name "hydra.arity.typeSchemeArity")),
      Core.applicationArgument = (Typed.unTypedTerm arg0)}))

-- | DSL reference to hydra.arity.uncurryType
uncurryType :: Typed.TypedTerm Core.Type -> Typed.TypedTerm [Core.Type]
uncurryType arg0 =
    Typed.TypedTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermVariable (Core.Name "hydra.arity.uncurryType")),
      Core.applicationArgument = (Typed.unTypedTerm arg0)}))
