...
decimalToBigint = primitive1 (Prims.primName DefLiterals.decimalToBigint)
...
decimalToFloat32 = primitive1 (Prims.primName DefLiterals.decimalToFloat32)
