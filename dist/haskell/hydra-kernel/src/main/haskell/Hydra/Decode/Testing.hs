...
-- | Decoder for hydra.testing.TestCase
...
-- | Decoder for hydra.testing.TestCaseWithMetadata
...
-- | Decoder for hydra.testing.TestGroup
...
testGroup cx raw =
    Eithers.either (\err -> Left err) (\stripped -> case stripped of
      ...
      _ -> Left (Errors.DecodingError "expected record")) (ExtractCore.stripWithDecodingError cx raw)
-- | Decoder for hydra.testing.UniversalTestCase
