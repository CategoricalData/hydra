...
module_ =
    Packaging.Module {
      ...
      Packaging.moduleName = (Packaging.ModuleName "hydra.decode.classes"),
        ...
        Packaging.DefinitionTerm (Packaging.TermDefinition {
          ...
          Packaging.termDefinitionTerm = (Core.TermAnnotated (Core.AnnotatedTerm {
            ...
            Core.annotatedTermAnnotation = (M.fromList [
              (Core.Name "description", (Core.TermLiteral (Core.LiteralString "Decoder for hydra.classes.TypeClass")))])})),
