...
module_ =
    Packaging.Module {
      ...
      Packaging.moduleName = (Packaging.ModuleName "hydra.encode.classes"),
      Packaging.moduleDependencies = [
        ...
        Packaging.ModuleDependency {
          Packaging.moduleDependencyModule = (Packaging.ModuleName "hydra.classes"),
          Packaging.moduleDependencyPackage = Nothing}],
        ...
        Packaging.DefinitionTerm (Packaging.TermDefinition {
          ...
          Packaging.termDefinitionTerm = (Core.TermAnnotated (Core.AnnotatedTerm {
            ...
            Core.annotatedTermAnnotation = (M.fromList [
              (Core.Name "description", (Core.TermLiteral (Core.LiteralString "Encoder for hydra.classes.TypeClass")))])})),
          Packaging.termDefinitionSignature = (Just (Typing.TermSignature {
            ...
            Typing.termSignatureParameters = [
              Typing.Parameter {
                ...
                Typing.parameterType = (Core.TypeVariable (Core.Name "hydra.classes.TypeClass")),
