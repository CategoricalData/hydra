...
-- | DSL functions for hydra.ext.haskell.environment

module Hydra.Dsl.Ext.Haskell.Environment where
...
haskellModuleMetadata usesByteString usesInt usesMap usesSet =
    Phantoms.TTerm (Core.TermRecord (Core.Record {
      Core.recordTypeName = (Core.Name "hydra.ext.haskell.environment.HaskellModuleMetadata"),
      Core.recordFields = [
        Core.Field {
...
haskellModuleMetadataUsesByteString x =
    Phantoms.TTerm (Core.TermApplication (Core.Application {
      Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
        Core.projectionTypeName = (Core.Name "hydra.ext.haskell.environment.HaskellModuleMetadata"),
