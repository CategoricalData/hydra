...
public class LabeledStatementNoShortIf implements Serializable, Comparable<LabeledStatementNoShortIf> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.LabeledStatementNoShortIf");
  ...
  public final hydra.java.syntax.StatementNoShortIf statement;

  public LabeledStatementNoShortIf (hydra.java.syntax.Identifier identifier, hydra.java.syntax.StatementNoShortIf statement) {
  ...
  public LabeledStatementNoShortIf withIdentifier(hydra.java.syntax.Identifier identifier) {
    return new LabeledStatementNoShortIf(identifier, statement);
  }

  public LabeledStatementNoShortIf withStatement(hydra.java.syntax.StatementNoShortIf statement) {
    return new LabeledStatementNoShortIf(identifier, statement);
  }
}
