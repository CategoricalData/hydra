...
public class RelationalExpression_GreaterThanEqual implements Serializable, Comparable<RelationalExpression_GreaterThanEqual> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.RelationalExpression_GreaterThanEqual");
  ...
  public RelationalExpression_GreaterThanEqual (hydra.java.syntax.RelationalExpression lhs, hydra.java.syntax.ShiftExpression rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public RelationalExpression_GreaterThanEqual withLhs(hydra.java.syntax.RelationalExpression lhs) {
    return new RelationalExpression_GreaterThanEqual(lhs, rhs);
  }

  public RelationalExpression_GreaterThanEqual withRhs(hydra.java.syntax.ShiftExpression rhs) {
    return new RelationalExpression_GreaterThanEqual(lhs, rhs);
  }
}
