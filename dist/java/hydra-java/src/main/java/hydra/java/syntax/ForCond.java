...
public class ForCond implements Serializable, Comparable<ForCond> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ForCond");
  ...
  public final hydra.util.Maybe<hydra.java.syntax.ForInit> init;

  public final hydra.util.Maybe<hydra.java.syntax.Expression> cond;

  public final hydra.util.Maybe<hydra.java.syntax.ForUpdate> update;

  public ForCond (hydra.util.Maybe<hydra.java.syntax.ForInit> init, hydra.util.Maybe<hydra.java.syntax.Expression> cond, hydra.util.Maybe<hydra.java.syntax.ForUpdate> update) {
    this.init = init;
    this.cond = cond;
    this.update = update;
  }
  ...
  public ForCond withInit(hydra.util.Maybe<hydra.java.syntax.ForInit> init) {
    return new ForCond(init, cond, update);
  }

  public ForCond withCond(hydra.util.Maybe<hydra.java.syntax.Expression> cond) {
    return new ForCond(init, cond, update);
  }

  public ForCond withUpdate(hydra.util.Maybe<hydra.java.syntax.ForUpdate> update) {
    return new ForCond(init, cond, update);
  }
}
