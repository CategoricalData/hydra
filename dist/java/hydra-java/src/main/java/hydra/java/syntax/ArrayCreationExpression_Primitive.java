...
public class ArrayCreationExpression_Primitive implements Serializable, Comparable<ArrayCreationExpression_Primitive> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ArrayCreationExpression_Primitive");
  ...
  public ArrayCreationExpression_Primitive (hydra.java.syntax.PrimitiveTypeWithAnnotations type, java.util.List<hydra.java.syntax.DimExpr> dimExprs, hydra.util.Maybe<hydra.java.syntax.Dims> dims) {
    this.type = type;
  ...
  public ArrayCreationExpression_Primitive withType(hydra.java.syntax.PrimitiveTypeWithAnnotations type) {
    return new ArrayCreationExpression_Primitive(type, dimExprs, dims);
  }

  public ArrayCreationExpression_Primitive withDimExprs(java.util.List<hydra.java.syntax.DimExpr> dimExprs) {
    return new ArrayCreationExpression_Primitive(type, dimExprs, dims);
  }

  public ArrayCreationExpression_Primitive withDims(hydra.util.Maybe<hydra.java.syntax.Dims> dims) {
    return new ArrayCreationExpression_Primitive(type, dimExprs, dims);
  }
}
