...
public class TypeParameterModifier implements Serializable, Comparable<TypeParameterModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.TypeParameterModifier");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.Annotation value;

  public TypeParameterModifier (hydra.java.syntax.Annotation value) {
    this.value = value;
  }
