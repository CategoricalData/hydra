...
public abstract class FieldAccess_Qualifier implements Serializable, Comparable<FieldAccess_Qualifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.FieldAccess_Qualifier");
  ...
  public static final class Primary extends hydra.java.syntax.FieldAccess_Qualifier implements Serializable {
  ...
  public static final class Super extends hydra.java.syntax.FieldAccess_Qualifier implements Serializable {
    public Super () {
  ...
  public static final class Typed extends hydra.java.syntax.FieldAccess_Qualifier implements Serializable {
    public final hydra.java.syntax.TypeName value;

    public Typed (hydra.java.syntax.TypeName value) {
      this.value = value;
    }
