...
public class CastExpression_NotPlusMinus implements Serializable, Comparable<CastExpression_NotPlusMinus> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.CastExpression_NotPlusMinus");
  ...
  public CastExpression_NotPlusMinus (hydra.java.syntax.CastExpression_RefAndBounds refAndBounds, hydra.java.syntax.UnaryExpression expression) {
  ...
  public CastExpression_NotPlusMinus withRefAndBounds(hydra.java.syntax.CastExpression_RefAndBounds refAndBounds) {
    return new CastExpression_NotPlusMinus(refAndBounds, expression);
  }

  public CastExpression_NotPlusMinus withExpression(hydra.java.syntax.UnaryExpression expression) {
    return new CastExpression_NotPlusMinus(refAndBounds, expression);
  }
}
