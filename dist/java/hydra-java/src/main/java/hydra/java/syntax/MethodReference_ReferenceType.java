...
public class MethodReference_ReferenceType implements Serializable, Comparable<MethodReference_ReferenceType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.MethodReference_ReferenceType");
  ...
  public final hydra.java.syntax.ReferenceType referenceType;
  ...
  public MethodReference_ReferenceType (hydra.java.syntax.ReferenceType referenceType, java.util.List<hydra.java.syntax.TypeArgument> typeArguments, hydra.java.syntax.Identifier identifier) {
  ...
  public MethodReference_ReferenceType withReferenceType(hydra.java.syntax.ReferenceType referenceType) {
    return new MethodReference_ReferenceType(referenceType, typeArguments, identifier);
  }

  public MethodReference_ReferenceType withTypeArguments(java.util.List<hydra.java.syntax.TypeArgument> typeArguments) {
    return new MethodReference_ReferenceType(referenceType, typeArguments, identifier);
  }

  public MethodReference_ReferenceType withIdentifier(hydra.java.syntax.Identifier identifier) {
    return new MethodReference_ReferenceType(referenceType, typeArguments, identifier);
  }
}
