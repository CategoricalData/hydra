...
public class ModuleDirective_ExportsOrOpens implements Serializable, Comparable<ModuleDirective_ExportsOrOpens> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ModuleDirective_ExportsOrOpens");
  ...
  public final hydra.java.syntax.PackageName package_;

  /**
   * At least one module
   */
  public final java.util.List<hydra.java.syntax.ModuleName> modules;

  public ModuleDirective_ExportsOrOpens (hydra.java.syntax.PackageName package_, java.util.List<hydra.java.syntax.ModuleName> modules) {
  ...
  public ModuleDirective_ExportsOrOpens withPackage(hydra.java.syntax.PackageName package_) {
    return new ModuleDirective_ExportsOrOpens(package_, modules);
  }

  public ModuleDirective_ExportsOrOpens withModules(java.util.List<hydra.java.syntax.ModuleName> modules) {
    return new ModuleDirective_ExportsOrOpens(package_, modules);
  }
}
