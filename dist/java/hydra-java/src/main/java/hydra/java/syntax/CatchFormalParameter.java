...
public class CatchFormalParameter implements Serializable, Comparable<CatchFormalParameter> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.CatchFormalParameter");
  ...
  public final hydra.java.syntax.CatchType type;

  public final hydra.java.syntax.VariableDeclaratorId id;

  public CatchFormalParameter (java.util.List<hydra.java.syntax.VariableModifier> modifiers, hydra.java.syntax.CatchType type, hydra.java.syntax.VariableDeclaratorId id) {
  ...
  public CatchFormalParameter withModifiers(java.util.List<hydra.java.syntax.VariableModifier> modifiers) {
    return new CatchFormalParameter(modifiers, type, id);
  }

  public CatchFormalParameter withType(hydra.java.syntax.CatchType type) {
    return new CatchFormalParameter(modifiers, type, id);
  }

  public CatchFormalParameter withId(hydra.java.syntax.VariableDeclaratorId id) {
    return new CatchFormalParameter(modifiers, type, id);
  }
}
