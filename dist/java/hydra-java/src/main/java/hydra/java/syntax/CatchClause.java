...
public class CatchClause implements Serializable, Comparable<CatchClause> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.CatchClause");
  ...
  public final hydra.util.Maybe<hydra.java.syntax.CatchFormalParameter> parameter;

  public final hydra.java.syntax.Block block;

  public CatchClause (hydra.util.Maybe<hydra.java.syntax.CatchFormalParameter> parameter, hydra.java.syntax.Block block) {
  ...
  public CatchClause withParameter(hydra.util.Maybe<hydra.java.syntax.CatchFormalParameter> parameter) {
    return new CatchClause(parameter, block);
  }

  public CatchClause withBlock(hydra.java.syntax.Block block) {
    return new CatchClause(parameter, block);
  }
}
