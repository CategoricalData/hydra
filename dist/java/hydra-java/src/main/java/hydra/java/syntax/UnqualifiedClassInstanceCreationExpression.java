...
public class UnqualifiedClassInstanceCreationExpression implements Serializable, Comparable<UnqualifiedClassInstanceCreationExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.UnqualifiedClassInstanceCreationExpression");
  ...
  public final hydra.java.syntax.ClassOrInterfaceTypeToInstantiate classOrInterface;
  ...
  public UnqualifiedClassInstanceCreationExpression (java.util.List<hydra.java.syntax.TypeArgument> typeArguments, hydra.java.syntax.ClassOrInterfaceTypeToInstantiate classOrInterface, java.util.List<hydra.java.syntax.Expression> arguments, hydra.util.Maybe<hydra.java.syntax.ClassBody> body) {
  ...
  public UnqualifiedClassInstanceCreationExpression withTypeArguments(java.util.List<hydra.java.syntax.TypeArgument> typeArguments) {
    return new UnqualifiedClassInstanceCreationExpression(typeArguments, classOrInterface, arguments, body);
  }

  public UnqualifiedClassInstanceCreationExpression withClassOrInterface(hydra.java.syntax.ClassOrInterfaceTypeToInstantiate classOrInterface) {
    return new UnqualifiedClassInstanceCreationExpression(typeArguments, classOrInterface, arguments, body);
  }

  public UnqualifiedClassInstanceCreationExpression withArguments(java.util.List<hydra.java.syntax.Expression> arguments) {
    return new UnqualifiedClassInstanceCreationExpression(typeArguments, classOrInterface, arguments, body);
  }

  public UnqualifiedClassInstanceCreationExpression withBody(hydra.util.Maybe<hydra.java.syntax.ClassBody> body) {
    return new UnqualifiedClassInstanceCreationExpression(typeArguments, classOrInterface, arguments, body);
  }
}
