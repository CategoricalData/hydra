...
public class PackageOrTypeName implements Serializable, Comparable<PackageOrTypeName> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.PackageOrTypeName");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final java.util.List<hydra.java.syntax.Identifier> value;

  public PackageOrTypeName (java.util.List<hydra.java.syntax.Identifier> value) {
    this.value = value;
  }
