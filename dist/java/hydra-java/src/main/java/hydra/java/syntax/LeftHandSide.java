...
public abstract class LeftHandSide implements Serializable, Comparable<LeftHandSide> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.LeftHandSide");
  ...
  public static final class ExpressionName extends hydra.java.syntax.LeftHandSide implements Serializable {
  ...
  public static final class FieldAccess extends hydra.java.syntax.LeftHandSide implements Serializable {
  ...
  public static final class ArrayAccess extends hydra.java.syntax.LeftHandSide implements Serializable {
