...
public abstract class ExplicitConstructorInvocation_Variant implements Serializable, Comparable<ExplicitConstructorInvocation_Variant> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ExplicitConstructorInvocation_Variant");
  ...
  public static final class This extends hydra.java.syntax.ExplicitConstructorInvocation_Variant implements Serializable {
    public This () {
  ...
  public static final class Super extends hydra.java.syntax.ExplicitConstructorInvocation_Variant implements Serializable {
    public final hydra.util.Maybe<hydra.java.syntax.ExpressionName> value;

    public Super (hydra.util.Maybe<hydra.java.syntax.ExpressionName> value) {
      this.value = value;
    }
  ...
  public static final class Primary extends hydra.java.syntax.ExplicitConstructorInvocation_Variant implements Serializable {
