...
public class PreIncrementExpression implements Serializable, Comparable<PreIncrementExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.PreIncrementExpression");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.UnaryExpression value;

  public PreIncrementExpression (hydra.java.syntax.UnaryExpression value) {
    this.value = value;
  }
