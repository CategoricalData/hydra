...
public abstract class IntegralType implements Serializable, Comparable<IntegralType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.IntegralType");
  ...
  public static final class Byte_ extends hydra.java.syntax.IntegralType implements Serializable {
    public Byte_ () {
  ...
  public static final class Short_ extends hydra.java.syntax.IntegralType implements Serializable {
    public Short_ () {
  ...
  public static final class Int extends hydra.java.syntax.IntegralType implements Serializable {
    public Int () {
  ...
  public static final class Long_ extends hydra.java.syntax.IntegralType implements Serializable {
    public Long_ () {
  ...
  public static final class Char extends hydra.java.syntax.IntegralType implements Serializable {
    public Char () {
