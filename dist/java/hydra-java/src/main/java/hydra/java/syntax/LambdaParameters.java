...
public abstract class LambdaParameters implements Serializable, Comparable<LambdaParameters> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.LambdaParameters");
  ...
  public static final class Tuple extends hydra.java.syntax.LambdaParameters implements Serializable {
    public final java.util.List<hydra.java.syntax.LambdaParameters> value;

    public Tuple (java.util.List<hydra.java.syntax.LambdaParameters> value) {
      this.value = value;
    }
  ...
  public static final class Single extends hydra.java.syntax.LambdaParameters implements Serializable {
    public final hydra.java.syntax.Identifier value;

    public Single (hydra.java.syntax.Identifier value) {
      this.value = value;
    }
