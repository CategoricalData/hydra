...
public abstract class ForInit implements Serializable, Comparable<ForInit> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ForInit");
  ...
  public static final class Statements extends hydra.java.syntax.ForInit implements Serializable {
    public final java.util.List<hydra.java.syntax.StatementExpression> value;

    public Statements (java.util.List<hydra.java.syntax.StatementExpression> value) {
      this.value = value;
    }
  ...
  public static final class LocalVariable extends hydra.java.syntax.ForInit implements Serializable {
    public final hydra.java.syntax.LocalVariableDeclaration value;

    public LocalVariable (hydra.java.syntax.LocalVariableDeclaration value) {
      this.value = value;
    }
