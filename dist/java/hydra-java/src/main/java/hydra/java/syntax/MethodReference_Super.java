...
public class MethodReference_Super implements Serializable, Comparable<MethodReference_Super> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.MethodReference_Super");
  ...
  public MethodReference_Super (java.util.List<hydra.java.syntax.TypeArgument> typeArguments, hydra.java.syntax.Identifier identifier, Boolean super_) {
  ...
  public MethodReference_Super withTypeArguments(java.util.List<hydra.java.syntax.TypeArgument> typeArguments) {
    return new MethodReference_Super(typeArguments, identifier, super_);
  }

  public MethodReference_Super withIdentifier(hydra.java.syntax.Identifier identifier) {
    return new MethodReference_Super(typeArguments, identifier, super_);
  }
