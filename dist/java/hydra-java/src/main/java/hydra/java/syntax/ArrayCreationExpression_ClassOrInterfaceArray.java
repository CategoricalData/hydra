...
public class ArrayCreationExpression_ClassOrInterfaceArray implements Serializable, Comparable<ArrayCreationExpression_ClassOrInterfaceArray> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ArrayCreationExpression_ClassOrInterfaceArray");
  ...
  public ArrayCreationExpression_ClassOrInterfaceArray (hydra.java.syntax.ClassOrInterfaceType type, java.util.List<hydra.java.syntax.Dims> dims, hydra.java.syntax.ArrayInitializer array) {
    this.type = type;
    this.dims = dims;
    this.array = array;
  }
  ...
  public ArrayCreationExpression_ClassOrInterfaceArray withType(hydra.java.syntax.ClassOrInterfaceType type) {
    return new ArrayCreationExpression_ClassOrInterfaceArray(type, dims, array);
  }

  public ArrayCreationExpression_ClassOrInterfaceArray withDims(java.util.List<hydra.java.syntax.Dims> dims) {
    return new ArrayCreationExpression_ClassOrInterfaceArray(type, dims, array);
  }

  public ArrayCreationExpression_ClassOrInterfaceArray withArray(hydra.java.syntax.ArrayInitializer array) {
    return new ArrayCreationExpression_ClassOrInterfaceArray(type, dims, array);
  }
}
