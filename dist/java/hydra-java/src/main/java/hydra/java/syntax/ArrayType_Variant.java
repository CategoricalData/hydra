...
public abstract class ArrayType_Variant implements Serializable, Comparable<ArrayType_Variant> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ArrayType_Variant");
  ...
  public static final class Primitive extends hydra.java.syntax.ArrayType_Variant implements Serializable {
    public final hydra.java.syntax.PrimitiveTypeWithAnnotations value;

    public Primitive (hydra.java.syntax.PrimitiveTypeWithAnnotations value) {
      this.value = value;
    }
  ...
  public static final class ClassOrInterface extends hydra.java.syntax.ArrayType_Variant implements Serializable {
    public final hydra.java.syntax.ClassOrInterfaceType value;

    public ClassOrInterface (hydra.java.syntax.ClassOrInterfaceType value) {
      this.value = value;
    }
  ...
  public static final class Variable extends hydra.java.syntax.ArrayType_Variant implements Serializable {
