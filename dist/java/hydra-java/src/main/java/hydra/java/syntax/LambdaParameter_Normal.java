...
public class LambdaParameter_Normal implements Serializable, Comparable<LambdaParameter_Normal> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.LambdaParameter_Normal");
  ...
  public final hydra.java.syntax.LambdaParameterType type;

  public final hydra.java.syntax.VariableDeclaratorId id;

  public LambdaParameter_Normal (java.util.List<hydra.java.syntax.VariableModifier> modifiers, hydra.java.syntax.LambdaParameterType type, hydra.java.syntax.VariableDeclaratorId id) {
  ...
  public LambdaParameter_Normal withModifiers(java.util.List<hydra.java.syntax.VariableModifier> modifiers) {
    return new LambdaParameter_Normal(modifiers, type, id);
  }

  public LambdaParameter_Normal withType(hydra.java.syntax.LambdaParameterType type) {
    return new LambdaParameter_Normal(modifiers, type, id);
  }

  public LambdaParameter_Normal withId(hydra.java.syntax.VariableDeclaratorId id) {
    return new LambdaParameter_Normal(modifiers, type, id);
  }
}
