...
public abstract class MethodModifier implements Serializable, Comparable<MethodModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.MethodModifier");
  ...
  public static final hydra.core.Name NATIVE = new hydra.core.Name("native");

  public static final hydra.core.Name STRICTFB = new hydra.core.Name("strictfb");
  ...
  public static final class Annotation extends hydra.java.syntax.MethodModifier implements Serializable {
  ...
  public static final class Public extends hydra.java.syntax.MethodModifier implements Serializable {
    public Public () {
  ...
  public static final class Protected extends hydra.java.syntax.MethodModifier implements Serializable {
    public Protected () {
  ...
  public static final class Private extends hydra.java.syntax.MethodModifier implements Serializable {
    public Private () {
  ...
  public static final class Abstract extends hydra.java.syntax.MethodModifier implements Serializable {
    public Abstract () {
  ...
  public static final class Static extends hydra.java.syntax.MethodModifier implements Serializable {
    public Static () {
  ...
  public static final class Final extends hydra.java.syntax.MethodModifier implements Serializable {
    public Final () {
  ...
  public static final class Synchronized extends hydra.java.syntax.MethodModifier implements Serializable {
    public Synchronized () {
  ...
  public static final class Native extends hydra.java.syntax.MethodModifier implements Serializable {
    public Native () {
  ...
  public static final class Strictfb extends hydra.java.syntax.MethodModifier implements Serializable {
    public Strictfb () {
