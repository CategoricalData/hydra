...
public class ThrowStatement implements Serializable, Comparable<ThrowStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ThrowStatement");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.Expression value;

  public ThrowStatement (hydra.java.syntax.Expression value) {
    this.value = value;
  }
