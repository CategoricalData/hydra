...
public class AnnotationTypeElementDeclaration implements Serializable, Comparable<AnnotationTypeElementDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.AnnotationTypeElementDeclaration");
  ...
  public final java.util.List<hydra.java.syntax.AnnotationTypeElementModifier> modifiers;
  ...
  public final hydra.util.Maybe<hydra.java.syntax.DefaultValue> default_;

  public AnnotationTypeElementDeclaration (java.util.List<hydra.java.syntax.AnnotationTypeElementModifier> modifiers, hydra.java.syntax.UnannType type, hydra.java.syntax.Identifier identifier, hydra.util.Maybe<hydra.java.syntax.Dims> dims, hydra.util.Maybe<hydra.java.syntax.DefaultValue> default_) {
  ...
  public AnnotationTypeElementDeclaration withModifiers(java.util.List<hydra.java.syntax.AnnotationTypeElementModifier> modifiers) {
    return new AnnotationTypeElementDeclaration(modifiers, type, identifier, dims, default_);
  }

  public AnnotationTypeElementDeclaration withType(hydra.java.syntax.UnannType type) {
    return new AnnotationTypeElementDeclaration(modifiers, type, identifier, dims, default_);
  }

  public AnnotationTypeElementDeclaration withIdentifier(hydra.java.syntax.Identifier identifier) {
    return new AnnotationTypeElementDeclaration(modifiers, type, identifier, dims, default_);
  }

  public AnnotationTypeElementDeclaration withDims(hydra.util.Maybe<hydra.java.syntax.Dims> dims) {
    return new AnnotationTypeElementDeclaration(modifiers, type, identifier, dims, default_);
  }

  public AnnotationTypeElementDeclaration withDefault(hydra.util.Maybe<hydra.java.syntax.DefaultValue> default_) {
    return new AnnotationTypeElementDeclaration(modifiers, type, identifier, dims, default_);
  }
}
