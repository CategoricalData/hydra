...
public class ContinueStatement implements Serializable, Comparable<ContinueStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ContinueStatement");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.util.Maybe<hydra.java.syntax.Identifier> value;

  public ContinueStatement (hydra.util.Maybe<hydra.java.syntax.Identifier> value) {
    this.value = value;
  }
