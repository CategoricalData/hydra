...
public class TypeImportOnDemandDeclaration implements Serializable, Comparable<TypeImportOnDemandDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.TypeImportOnDemandDeclaration");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.PackageOrTypeName value;

  public TypeImportOnDemandDeclaration (hydra.java.syntax.PackageOrTypeName value) {
    this.value = value;
  }
