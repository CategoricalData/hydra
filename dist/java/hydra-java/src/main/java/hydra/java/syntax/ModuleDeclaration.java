...
public class ModuleDeclaration implements Serializable, Comparable<ModuleDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ModuleDeclaration");
  ...
  public final java.util.List<hydra.java.syntax.Identifier> identifiers;

  public final java.util.List<java.util.List<hydra.java.syntax.ModuleDirective>> directives;

  public ModuleDeclaration (java.util.List<hydra.java.syntax.Annotation> annotations, Boolean open, java.util.List<hydra.java.syntax.Identifier> identifiers, java.util.List<java.util.List<hydra.java.syntax.ModuleDirective>> directives) {
  ...
  public ModuleDeclaration withAnnotations(java.util.List<hydra.java.syntax.Annotation> annotations) {
  ...
  public ModuleDeclaration withIdentifiers(java.util.List<hydra.java.syntax.Identifier> identifiers) {
    return new ModuleDeclaration(annotations, open, identifiers, directives);
  }

  public ModuleDeclaration withDirectives(java.util.List<java.util.List<hydra.java.syntax.ModuleDirective>> directives) {
    return new ModuleDeclaration(annotations, open, identifiers, directives);
  }
}
