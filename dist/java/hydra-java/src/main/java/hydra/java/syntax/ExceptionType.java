...
public abstract class ExceptionType implements Serializable, Comparable<ExceptionType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ExceptionType");
  ...
  public static final class Class_ extends hydra.java.syntax.ExceptionType implements Serializable {
  ...
  public static final class Variable extends hydra.java.syntax.ExceptionType implements Serializable {
