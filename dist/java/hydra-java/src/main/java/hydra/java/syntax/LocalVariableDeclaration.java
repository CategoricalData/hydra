...
public class LocalVariableDeclaration implements Serializable, Comparable<LocalVariableDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.LocalVariableDeclaration");
  ...
  public final java.util.List<hydra.java.syntax.VariableDeclarator> declarators;

  public LocalVariableDeclaration (java.util.List<hydra.java.syntax.VariableModifier> modifiers, hydra.java.syntax.LocalVariableType type, java.util.List<hydra.java.syntax.VariableDeclarator> declarators) {
  ...
  public LocalVariableDeclaration withModifiers(java.util.List<hydra.java.syntax.VariableModifier> modifiers) {
    return new LocalVariableDeclaration(modifiers, type, declarators);
  }

  public LocalVariableDeclaration withType(hydra.java.syntax.LocalVariableType type) {
    return new LocalVariableDeclaration(modifiers, type, declarators);
  }

  public LocalVariableDeclaration withDeclarators(java.util.List<hydra.java.syntax.VariableDeclarator> declarators) {
    return new LocalVariableDeclaration(modifiers, type, declarators);
  }
}
