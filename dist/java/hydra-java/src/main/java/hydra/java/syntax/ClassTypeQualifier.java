...
public abstract class ClassTypeQualifier implements Serializable, Comparable<ClassTypeQualifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ClassTypeQualifier");
  ...
  public static final class None extends hydra.java.syntax.ClassTypeQualifier implements Serializable {
    public None () {
  ...
  public static final class Package_ extends hydra.java.syntax.ClassTypeQualifier implements Serializable {
    public final hydra.java.syntax.PackageName value;

    public Package_ (hydra.java.syntax.PackageName value) {
      this.value = value;
    }
  ...
  public static final class Parent extends hydra.java.syntax.ClassTypeQualifier implements Serializable {
    public final hydra.java.syntax.ClassOrInterfaceType value;

    public Parent (hydra.java.syntax.ClassOrInterfaceType value) {
      this.value = value;
    }
