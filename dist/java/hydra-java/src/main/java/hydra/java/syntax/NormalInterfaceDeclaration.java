...
public class NormalInterfaceDeclaration implements Serializable, Comparable<NormalInterfaceDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.NormalInterfaceDeclaration");
  ...
  public final java.util.List<hydra.java.syntax.InterfaceModifier> modifiers;
  ...
  public final java.util.List<hydra.java.syntax.InterfaceType> extends_;

  public final hydra.java.syntax.InterfaceBody body;

  public NormalInterfaceDeclaration (java.util.List<hydra.java.syntax.InterfaceModifier> modifiers, hydra.java.syntax.TypeIdentifier identifier, java.util.List<hydra.java.syntax.TypeParameter> parameters, java.util.List<hydra.java.syntax.InterfaceType> extends_, hydra.java.syntax.InterfaceBody body) {
  ...
  public NormalInterfaceDeclaration withModifiers(java.util.List<hydra.java.syntax.InterfaceModifier> modifiers) {
    return new NormalInterfaceDeclaration(modifiers, identifier, parameters, extends_, body);
  }

  public NormalInterfaceDeclaration withIdentifier(hydra.java.syntax.TypeIdentifier identifier) {
    return new NormalInterfaceDeclaration(modifiers, identifier, parameters, extends_, body);
  }

  public NormalInterfaceDeclaration withParameters(java.util.List<hydra.java.syntax.TypeParameter> parameters) {
    return new NormalInterfaceDeclaration(modifiers, identifier, parameters, extends_, body);
  }

  public NormalInterfaceDeclaration withExtends(java.util.List<hydra.java.syntax.InterfaceType> extends_) {
    return new NormalInterfaceDeclaration(modifiers, identifier, parameters, extends_, body);
  }

  public NormalInterfaceDeclaration withBody(hydra.java.syntax.InterfaceBody body) {
    return new NormalInterfaceDeclaration(modifiers, identifier, parameters, extends_, body);
  }
}
