...
public abstract class PrimitiveType implements Serializable, Comparable<PrimitiveType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.PrimitiveType");
  ...
  public static final class Numeric extends hydra.java.syntax.PrimitiveType implements Serializable {
    public final hydra.java.syntax.NumericType value;

    public Numeric (hydra.java.syntax.NumericType value) {
      this.value = value;
    }
  ...
  public static final class Boolean_ extends hydra.java.syntax.PrimitiveType implements Serializable {
    public Boolean_ () {
