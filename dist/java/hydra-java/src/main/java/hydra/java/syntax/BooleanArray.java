...
public abstract class BooleanArray implements Serializable, Comparable<BooleanArray> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.BooleanArray");
  ...
  public static final class Simple extends hydra.java.syntax.BooleanArray implements Serializable {
    public Simple () {
  ...
  public static final class Array extends hydra.java.syntax.BooleanArray implements Serializable {
    public final hydra.java.syntax.BooleanArray value;

    public Array (hydra.java.syntax.BooleanArray value) {
      this.value = value;
    }
