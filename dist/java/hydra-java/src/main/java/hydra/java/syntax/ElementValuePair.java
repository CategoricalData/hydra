...
public class ElementValuePair implements Serializable, Comparable<ElementValuePair> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ElementValuePair");

  public static final hydra.core.Name KEY = new hydra.core.Name("key");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.Identifier key;

  public final hydra.java.syntax.ElementValue value;

  public ElementValuePair (hydra.java.syntax.Identifier key, hydra.java.syntax.ElementValue value) {
    this.key = key;
    this.value = value;
  }
  ...
  public ElementValuePair withKey(hydra.java.syntax.Identifier key) {
    return new ElementValuePair(key, value);
  }

  public ElementValuePair withValue(hydra.java.syntax.ElementValue value) {
    return new ElementValuePair(key, value);
  }
}
