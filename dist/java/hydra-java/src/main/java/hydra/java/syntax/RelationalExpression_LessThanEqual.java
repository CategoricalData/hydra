...
public class RelationalExpression_LessThanEqual implements Serializable, Comparable<RelationalExpression_LessThanEqual> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.RelationalExpression_LessThanEqual");
  ...
  public RelationalExpression_LessThanEqual (hydra.java.syntax.RelationalExpression lhs, hydra.java.syntax.ShiftExpression rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public RelationalExpression_LessThanEqual withLhs(hydra.java.syntax.RelationalExpression lhs) {
    return new RelationalExpression_LessThanEqual(lhs, rhs);
  }

  public RelationalExpression_LessThanEqual withRhs(hydra.java.syntax.ShiftExpression rhs) {
    return new RelationalExpression_LessThanEqual(lhs, rhs);
  }
}
