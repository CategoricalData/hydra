...
public class BytesType implements Serializable, Comparable<BytesType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("openGql.grammar.BytesType");
  ...
  public BytesType (hydra.util.Maybe<openGql.grammar.UnsignedInteger> minLength, hydra.util.Maybe<openGql.grammar.UnsignedInteger> maxLength, Boolean notNull) {
  ...
  public BytesType withMinLength(hydra.util.Maybe<openGql.grammar.UnsignedInteger> minLength) {
    return new BytesType(minLength, maxLength, notNull);
  }

  public BytesType withMaxLength(hydra.util.Maybe<openGql.grammar.UnsignedInteger> maxLength) {
    return new BytesType(minLength, maxLength, notNull);
  }

  public BytesType withNotNull(Boolean notNull) {
    return new BytesType(minLength, maxLength, notNull);
  }
}
