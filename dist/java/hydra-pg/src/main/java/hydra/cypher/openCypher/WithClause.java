...
public class WithClause implements Serializable, Comparable<WithClause> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.WithClause");
  ...
  public final hydra.cypher.openCypher.With with;

  public WithClause (java.util.List<hydra.cypher.openCypher.ReadingClause> reading, java.util.List<hydra.cypher.openCypher.UpdatingClause> updating, hydra.cypher.openCypher.With with) {
  ...
  public WithClause withReading(java.util.List<hydra.cypher.openCypher.ReadingClause> reading) {
    return new WithClause(reading, updating, with);
  }

  public WithClause withUpdating(java.util.List<hydra.cypher.openCypher.UpdatingClause> updating) {
    return new WithClause(reading, updating, with);
  }

  public WithClause withWith(hydra.cypher.openCypher.With with) {
    return new WithClause(reading, updating, with);
  }
}
