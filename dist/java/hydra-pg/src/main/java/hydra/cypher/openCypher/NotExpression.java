...
public class NotExpression implements Serializable, Comparable<NotExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.NotExpression");
  ...
  public final hydra.cypher.openCypher.ComparisonExpression expression;

  public NotExpression (Boolean not, hydra.cypher.openCypher.ComparisonExpression expression) {
    this.not = not;
  ...
  public NotExpression withExpression(hydra.cypher.openCypher.ComparisonExpression expression) {
    return new NotExpression(not, expression);
  }
}
