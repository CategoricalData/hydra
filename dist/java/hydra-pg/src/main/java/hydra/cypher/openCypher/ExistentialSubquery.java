...
public abstract class ExistentialSubquery implements Serializable, Comparable<ExistentialSubquery> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.ExistentialSubquery");
  ...
  public static final class Regular extends hydra.cypher.openCypher.ExistentialSubquery implements Serializable {
  ...
  public static final class Pattern extends hydra.cypher.openCypher.ExistentialSubquery implements Serializable {
    public final hydra.cypher.openCypher.PatternWhere value;

    public Pattern (hydra.cypher.openCypher.PatternWhere value) {
      this.value = value;
    }
