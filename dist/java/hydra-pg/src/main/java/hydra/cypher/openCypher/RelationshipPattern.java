...
public class RelationshipPattern implements Serializable, Comparable<RelationshipPattern> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.RelationshipPattern");
  ...
  public final hydra.util.Maybe<hydra.cypher.openCypher.RelationshipDetail> detail;

  public final Boolean rightArrow;

  public RelationshipPattern (Boolean leftArrow, hydra.util.Maybe<hydra.cypher.openCypher.RelationshipDetail> detail, Boolean rightArrow) {
  ...
  public RelationshipPattern withDetail(hydra.util.Maybe<hydra.cypher.openCypher.RelationshipDetail> detail) {
    return new RelationshipPattern(leftArrow, detail, rightArrow);
  }
