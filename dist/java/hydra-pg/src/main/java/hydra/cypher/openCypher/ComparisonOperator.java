...
public abstract class ComparisonOperator implements Serializable, Comparable<ComparisonOperator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.ComparisonOperator");
  ...
  public static final class Eq extends hydra.cypher.openCypher.ComparisonOperator implements Serializable {
    public Eq () {
  ...
  public static final class Neq extends hydra.cypher.openCypher.ComparisonOperator implements Serializable {
    public Neq () {
  ...
  public static final class Lt extends hydra.cypher.openCypher.ComparisonOperator implements Serializable {
    public Lt () {
  ...
  public static final class Gt extends hydra.cypher.openCypher.ComparisonOperator implements Serializable {
    public Gt () {
  ...
  public static final class Lte extends hydra.cypher.openCypher.ComparisonOperator implements Serializable {
    public Lte () {
  ...
  public static final class Gte extends hydra.cypher.openCypher.ComparisonOperator implements Serializable {
    public Gte () {
