...
public class Match implements Serializable, Comparable<Match> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.Match");
  ...
  public Match (Boolean optional, hydra.cypher.openCypher.Pattern pattern, hydra.util.Maybe<hydra.cypher.openCypher.Where> where) {
  ...
  public Match withPattern(hydra.cypher.openCypher.Pattern pattern) {
    return new Match(optional, pattern, where);
  }

  public Match withWhere(hydra.util.Maybe<hydra.cypher.openCypher.Where> where) {
    return new Match(optional, pattern, where);
  }
}
