...
public class PatternComprehension implements Serializable, Comparable<PatternComprehension> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.PatternComprehension");
  ...
  public final hydra.cypher.openCypher.RelationshipsPattern pattern;

  public final hydra.util.Maybe<hydra.cypher.openCypher.Where> where;

  public final hydra.cypher.openCypher.Expression right;

  public PatternComprehension (hydra.util.Maybe<hydra.cypher.openCypher.Variable> variable, hydra.cypher.openCypher.RelationshipsPattern pattern, hydra.util.Maybe<hydra.cypher.openCypher.Where> where, hydra.cypher.openCypher.Expression right) {
  ...
  public PatternComprehension withVariable(hydra.util.Maybe<hydra.cypher.openCypher.Variable> variable) {
    return new PatternComprehension(variable, pattern, where, right);
  }

  public PatternComprehension withPattern(hydra.cypher.openCypher.RelationshipsPattern pattern) {
    return new PatternComprehension(variable, pattern, where, right);
  }

  public PatternComprehension withWhere(hydra.util.Maybe<hydra.cypher.openCypher.Where> where) {
    return new PatternComprehension(variable, pattern, where, right);
  }

  public PatternComprehension withRight(hydra.cypher.openCypher.Expression right) {
    return new PatternComprehension(variable, pattern, where, right);
  }
}
