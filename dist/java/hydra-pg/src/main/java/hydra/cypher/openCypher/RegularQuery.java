...
public class RegularQuery implements Serializable, Comparable<RegularQuery> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.RegularQuery");
  ...
  public final hydra.cypher.openCypher.SingleQuery head;

  public final java.util.List<hydra.cypher.openCypher.Union> rest;

  public RegularQuery (hydra.cypher.openCypher.SingleQuery head, java.util.List<hydra.cypher.openCypher.Union> rest) {
    this.head = head;
    this.rest = rest;
  }
  ...
  public RegularQuery withHead(hydra.cypher.openCypher.SingleQuery head) {
    return new RegularQuery(head, rest);
  }

  public RegularQuery withRest(java.util.List<hydra.cypher.openCypher.Union> rest) {
    return new RegularQuery(head, rest);
  }
}
