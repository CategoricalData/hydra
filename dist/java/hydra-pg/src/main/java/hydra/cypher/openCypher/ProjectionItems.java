...
public class ProjectionItems implements Serializable, Comparable<ProjectionItems> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.ProjectionItems");
  ...
  public final java.util.List<hydra.cypher.openCypher.ProjectionItem> explicit;

  public ProjectionItems (Boolean star, java.util.List<hydra.cypher.openCypher.ProjectionItem> explicit) {
    this.star = star;
  ...
  public ProjectionItems withExplicit(java.util.List<hydra.cypher.openCypher.ProjectionItem> explicit) {
    return new ProjectionItems(star, explicit);
  }
}
