...
public class NonArithmeticOperatorExpression implements Serializable, Comparable<NonArithmeticOperatorExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.NonArithmeticOperatorExpression");
  ...
  public final java.util.List<hydra.cypher.openCypher.ListOperatorExpressionOrPropertyLookup> listsAndLookups;

  public final hydra.util.Maybe<hydra.cypher.openCypher.NodeLabels> labels;

  public NonArithmeticOperatorExpression (hydra.cypher.openCypher.Atom atom, java.util.List<hydra.cypher.openCypher.ListOperatorExpressionOrPropertyLookup> listsAndLookups, hydra.util.Maybe<hydra.cypher.openCypher.NodeLabels> labels) {
    this.atom = atom;
  ...
  public NonArithmeticOperatorExpression withAtom(hydra.cypher.openCypher.Atom atom) {
    return new NonArithmeticOperatorExpression(atom, listsAndLookups, labels);
  }

  public NonArithmeticOperatorExpression withListsAndLookups(java.util.List<hydra.cypher.openCypher.ListOperatorExpressionOrPropertyLookup> listsAndLookups) {
    return new NonArithmeticOperatorExpression(atom, listsAndLookups, labels);
  }

  public NonArithmeticOperatorExpression withLabels(hydra.util.Maybe<hydra.cypher.openCypher.NodeLabels> labels) {
    return new NonArithmeticOperatorExpression(atom, listsAndLookups, labels);
  }
}
