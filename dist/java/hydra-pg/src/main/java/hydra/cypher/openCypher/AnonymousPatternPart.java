...
public class AnonymousPatternPart implements Serializable, Comparable<AnonymousPatternPart> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.AnonymousPatternPart");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.cypher.openCypher.PatternElement value;

  public AnonymousPatternPart (hydra.cypher.openCypher.PatternElement value) {
    this.value = value;
  }
