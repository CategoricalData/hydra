...
public interface Construct {
  ...
  static hydra.coders.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value> graphsonVertexToJsonCoder() {
    return (hydra.coders.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value>) ((hydra.coders.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value>) (new hydra.coders.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.errors.Error_, hydra.json.model.Value>>>) (_cx -> (java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.errors.Error_, hydra.json.model.Value>>) (v -> hydra.util.Either.<hydra.errors.Error_, hydra.json.model.Value>right(hydra.pg.graphson.Coder.vertexToJson(v)))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Vertex>>>) (_cx -> (java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Vertex>>) (ignored -> hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Vertex>left(new hydra.errors.Error_.Other(new hydra.errors.OtherError("decoding GraphSON JSON is currently unsupported"))))))));
  }
