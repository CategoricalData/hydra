...
public class PgRdfEnvironment<V> implements Serializable, Comparable<PgRdfEnvironment<V>> {
   ...
   */
  public final java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Iri> encodeVertexId;

  /**
   * A function which encodes a vertex label as an RDF IRI
   */
  public final java.util.function.Function<hydra.pg.model.VertexLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeVertexLabel;

  /**
   * A function which encodes an edge id as an RDF IRI
   */
  public final java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Iri> encodeEdgeId;

  /**
   * A function which encodes an edge label as an RDF IRI
   */
  public final java.util.function.Function<hydra.pg.model.EdgeLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeEdgeLabel;

  /**
   * A function which encodes a property key as an RDF IRI
   */
  public final java.util.function.Function<hydra.pg.model.PropertyKey, hydra.ext.org.w3.rdf.syntax.Iri> encodePropertyKey;

  /**
   * A function which encodes a property value as an RDF literal
   */
  public final java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Literal> encodePropertyValue;

  public PgRdfEnvironment (java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Iri> encodeVertexId, java.util.function.Function<hydra.pg.model.VertexLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeVertexLabel, java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Iri> encodeEdgeId, java.util.function.Function<hydra.pg.model.EdgeLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeEdgeLabel, java.util.function.Function<hydra.pg.model.PropertyKey, hydra.ext.org.w3.rdf.syntax.Iri> encodePropertyKey, java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Literal> encodePropertyValue) {
  ...
  public PgRdfEnvironment withEncodeVertexId(java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Iri> encodeVertexId) {
  ...
  public PgRdfEnvironment withEncodeVertexLabel(java.util.function.Function<hydra.pg.model.VertexLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeVertexLabel) {
    return new PgRdfEnvironment(encodeVertexId, encodeVertexLabel, encodeEdgeId, encodeEdgeLabel, encodePropertyKey, encodePropertyValue);
  }

  public PgRdfEnvironment withEncodeEdgeId(java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Iri> encodeEdgeId) {
    return new PgRdfEnvironment(encodeVertexId, encodeVertexLabel, encodeEdgeId, encodeEdgeLabel, encodePropertyKey, encodePropertyValue);
  }

  public PgRdfEnvironment withEncodeEdgeLabel(java.util.function.Function<hydra.pg.model.EdgeLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeEdgeLabel) {
    return new PgRdfEnvironment(encodeVertexId, encodeVertexLabel, encodeEdgeId, encodeEdgeLabel, encodePropertyKey, encodePropertyValue);
  }

  public PgRdfEnvironment withEncodePropertyKey(java.util.function.Function<hydra.pg.model.PropertyKey, hydra.ext.org.w3.rdf.syntax.Iri> encodePropertyKey) {
    return new PgRdfEnvironment(encodeVertexId, encodeVertexLabel, encodeEdgeId, encodeEdgeLabel, encodePropertyKey, encodePropertyValue);
  }

  public PgRdfEnvironment withEncodePropertyValue(java.util.function.Function<V, hydra.ext.org.w3.rdf.syntax.Literal> encodePropertyValue) {
    return new PgRdfEnvironment(encodeVertexId, encodeVertexLabel, encodeEdgeId, encodeEdgeLabel, encodePropertyKey, encodePropertyValue);
  }
}
