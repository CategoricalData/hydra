...
public interface Utils {
  static <T0> java.util.List<hydra.pg.model.VertexWithAdjacentEdges<T0>> elementsToVerticesWithAdjacentEdges(java.util.List<hydra.pg.model.Element<T0>> els) {
    hydra.util.Lazy<hydra.util.Pair<java.util.List<hydra.pg.model.Vertex<T0>>, java.util.List<hydra.pg.model.Edge<T0>>>> partitioned = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_partitioned(els));
    return hydra.lib.maps.Elems.apply(hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_vertexMap1(
      hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_edges(partitioned.get()),
  ...
  static <T0> hydra.util.Pair<java.util.List<hydra.pg.model.Vertex<T0>>, java.util.List<hydra.pg.model.Edge<T0>>> elementsToVerticesWithAdjacentEdges_partitioned(java.util.List<hydra.pg.model.Element<T0>> els) {
    return hydra.lib.lists.Foldl.apply(
      ...
      (hydra.util.Pair<java.util.List<hydra.pg.model.Vertex<T0>>, java.util.List<hydra.pg.model.Edge<T0>>>) ((hydra.util.Pair<java.util.List<hydra.pg.model.Vertex<T0>>, java.util.List<hydra.pg.model.Edge<T0>>>) (new hydra.util.Pair<java.util.List<hydra.pg.model.Vertex<T0>>, java.util.List<hydra.pg.model.Edge<T0>>>((java.util.List<hydra.pg.model.Vertex<T0>>) (java.util.Collections.<hydra.pg.model.Vertex<T0>>emptyList()), (java.util.List<hydra.pg.model.Edge<T0>>) (java.util.Collections.<hydra.pg.model.Edge<T0>>emptyList())))),
      els);
  }
  ...
  static <T0> java.util.Map<T0, hydra.pg.model.VertexWithAdjacentEdges<T0>> elementsToVerticesWithAdjacentEdges_vertexMap1(java.util.List<hydra.pg.model.Edge<T0>> edges, java.util.Map<T0, hydra.pg.model.VertexWithAdjacentEdges<T0>> vertexMap0) {
    return hydra.lib.lists.Foldl.apply(
      (java.util.function.Function<java.util.Map<T0, hydra.pg.model.VertexWithAdjacentEdges<T0>>, java.util.function.Function<hydra.pg.model.Edge<T0>, java.util.Map<T0, hydra.pg.model.VertexWithAdjacentEdges<T0>>>>) (vmap -> (java.util.function.Function<hydra.pg.model.Edge<T0>, java.util.Map<T0, hydra.pg.model.VertexWithAdjacentEdges<T0>>>) (edge -> {
        hydra.util.Lazy<T0> edgeId = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_edgeId(edge));
        hydra.util.Lazy<T0> inV = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_inV(edge));
        ...
        hydra.util.Lazy<T0> outV = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_outV(edge));
        hydra.util.Lazy<java.util.Map<hydra.pg.model.PropertyKey, T0>> props = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_props(edge));
        hydra.util.Lazy<java.util.Map<T0, hydra.pg.model.VertexWithAdjacentEdges<T0>>> vmap1 = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_vmap1(
          hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_adjEdgeOut(
            edgeId.get(),
            inV.get(),
            label.get(),
            props.get()),
        ...
        return hydra.lib.maybes.Maybe.applyLazy(
          ...
          (java.util.function.Function<hydra.pg.model.VertexWithAdjacentEdges<T0>, java.util.Map<T0, hydra.pg.model.VertexWithAdjacentEdges<T0>>>) (vae -> hydra.lib.maps.Insert.apply(
            ...
            (hydra.pg.model.VertexWithAdjacentEdges<T0>) (new hydra.pg.model.VertexWithAdjacentEdges<T0>(((java.util.function.Function<hydra.pg.model.VertexWithAdjacentEdges<T0>, hydra.pg.model.Vertex<T0>>) (projected -> projected.vertex)).apply(vae), hydra.lib.lists.Cons.apply(
              hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges_adjEdgeIn(
                edgeId.get(),
                label.get(),
                outV.get(),
                props.get()),
  ...
  static hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> encodeTermValue(hydra.core.Term term) {
    return hydra.Strip.deannotateTerm(term).accept(new hydra.core.Term.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> otherwise(hydra.core.Term instance) {
        return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>left(new hydra.errors.Error_.Other(new hydra.errors.OtherError("unsupported term variant for GraphSON encoding")));
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.Term.Literal lit) {
        return (lit).value.accept(new hydra.core.Literal.PartialVisitor<>() {
          @Override
          public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> otherwise(hydra.core.Literal instance) {
            return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>left(new hydra.errors.Error_.Other(new hydra.errors.OtherError("unsupported literal type for GraphSON encoding")));
          }

          @Override
          public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.Literal.Binary b) {
            return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.Binary(hydra.lib.literals.BinaryToString.apply((b).value)));
          }

          @Override
          public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.Literal.Boolean_ b) {
            return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.Boolean_((b).value));
          }

          @Override
          public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.Literal.Float_ fv) {
            return (fv).value.accept(new hydra.core.FloatValue.PartialVisitor<>() {
              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> otherwise(hydra.core.FloatValue instance) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>left(new hydra.errors.Error_.Other(new hydra.errors.OtherError("unsupported float type")));
              }

              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.FloatValue.Bigfloat f) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.BigDecimal(new hydra.pg.graphson.syntax.BigDecimalValue(hydra.lib.literals.ShowBigfloat.apply((f).value))));
              }

              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.FloatValue.Float32 f) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.Float_(new hydra.pg.graphson.syntax.FloatValue.Finite((f).value)));
              }

              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.FloatValue.Float64 f) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.Double_(new hydra.pg.graphson.syntax.DoubleValue.Finite((f).value)));
              }
            });
          }

          @Override
          public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.Literal.Integer_ iv) {
            return (iv).value.accept(new hydra.core.IntegerValue.PartialVisitor<>() {
              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> otherwise(hydra.core.IntegerValue instance) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>left(new hydra.errors.Error_.Other(new hydra.errors.OtherError("unsupported integer type")));
              }

              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.IntegerValue.Bigint i) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.BigInteger((i).value));
              }

              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.IntegerValue.Int32 i) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.Integer_((i).value));
              }

              @Override
              public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.IntegerValue.Int64 i) {
                return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.Long_((i).value));
              }
            });
          }

          @Override
          public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.Literal.String_ s) {
            return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.String_((s).value));
          }
        });
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.pg.graphson.syntax.Value> visit(hydra.core.Term.Unit ignored) {
        return hydra.util.Either.<hydra.errors.Error_, hydra.pg.graphson.syntax.Value>right(new hydra.pg.graphson.syntax.Value.Null());
      }
    });
  }
  ...
  static <T0, T1> hydra.util.Either<T1, java.util.List<hydra.json.model.Value>> pgElementsToGraphson(java.util.function.Function<T0, hydra.util.Either<T1, hydra.pg.graphson.syntax.Value>> encodeValue, java.util.List<hydra.pg.model.Element<T0>> els) {
    return hydra.lib.eithers.MapList.apply(
      (java.util.function.Function<hydra.pg.model.VertexWithAdjacentEdges<T0>, hydra.util.Either<T1, hydra.json.model.Value>>) (v1 -> hydra.pg.graphson.Construct.<T0, T1>pgVertexWithAdjacentEdgesToJson(
        encodeValue,
        v1)),
      hydra.pg.graphson.Utils.<T0>elementsToVerticesWithAdjacentEdges(els));
  }
}
