...
public abstract class TraversalTerminalMethod implements Serializable, Comparable<TraversalTerminalMethod> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalTerminalMethod");
  ...
  public static final class Explain extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public Explain () {
  ...
  public static final class Iterate extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public Iterate () {
  ...
  public static final class HasNext extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public HasNext () {
  ...
  public static final class TryNext extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public TryNext () {
  ...
  public static final class Next extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public final hydra.util.Maybe<hydra.tinkerpop.gremlin.IntegerLiteral> value;

    public Next (hydra.util.Maybe<hydra.tinkerpop.gremlin.IntegerLiteral> value) {
      this.value = value;
    }
  ...
  public static final class ToList extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public ToList () {
  ...
  public static final class ToSet extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public ToSet () {
  ...
  public static final class ToBulkSet extends hydra.tinkerpop.gremlin.TraversalTerminalMethod implements Serializable {
    public ToBulkSet () {
