...
public class WhereWithPredicateArgs implements Serializable, Comparable<WhereWithPredicateArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.WhereWithPredicateArgs");
  ...
  public final hydra.util.Maybe<hydra.tinkerpop.gremlin.StringArgument> leftArg;

  public final hydra.tinkerpop.gremlin.TraversalPredicate predicate;

  public WhereWithPredicateArgs (hydra.util.Maybe<hydra.tinkerpop.gremlin.StringArgument> leftArg, hydra.tinkerpop.gremlin.TraversalPredicate predicate) {
  ...
  public WhereWithPredicateArgs withLeftArg(hydra.util.Maybe<hydra.tinkerpop.gremlin.StringArgument> leftArg) {
    return new WhereWithPredicateArgs(leftArg, predicate);
  }

  public WhereWithPredicateArgs withPredicate(hydra.tinkerpop.gremlin.TraversalPredicate predicate) {
    return new WhereWithPredicateArgs(leftArg, predicate);
  }
}
