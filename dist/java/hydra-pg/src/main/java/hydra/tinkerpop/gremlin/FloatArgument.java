...
public abstract class FloatArgument implements Serializable, Comparable<FloatArgument> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.FloatArgument");
  ...
  public static final class Value extends hydra.tinkerpop.gremlin.FloatArgument implements Serializable {
    public final hydra.tinkerpop.gremlin.FloatLiteral value;

    public Value (hydra.tinkerpop.gremlin.FloatLiteral value) {
      this.value = value;
    }
  ...
  public static final class Variable extends hydra.tinkerpop.gremlin.FloatArgument implements Serializable {
