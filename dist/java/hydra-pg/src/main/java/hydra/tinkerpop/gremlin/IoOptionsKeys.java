...
public abstract class IoOptionsKeys implements Serializable, Comparable<IoOptionsKeys> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.IoOptionsKeys");
  ...
  public static final class Reader extends hydra.tinkerpop.gremlin.IoOptionsKeys implements Serializable {
    public Reader () {
  ...
  public static final class Writer extends hydra.tinkerpop.gremlin.IoOptionsKeys implements Serializable {
    public Writer () {
