...
public abstract class PredicateOrTraversal implements Serializable, Comparable<PredicateOrTraversal> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.PredicateOrTraversal");
  ...
  public static final class Predicate extends hydra.tinkerpop.gremlin.PredicateOrTraversal implements Serializable {
    ...
    public int compareTo(PredicateOrTraversal other) {
  ...
  public static final class Traversal extends hydra.tinkerpop.gremlin.PredicateOrTraversal implements Serializable {
