...
public class IntegerRange implements Serializable, Comparable<IntegerRange> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.IntegerRange");
  ...
  public final hydra.tinkerpop.gremlin.IntegerLiteral left;

  public final hydra.tinkerpop.gremlin.IntegerLiteral right;

  public IntegerRange (hydra.tinkerpop.gremlin.IntegerLiteral left, hydra.tinkerpop.gremlin.IntegerLiteral right) {
    this.left = left;
    this.right = right;
  }
  ...
  public IntegerRange withLeft(hydra.tinkerpop.gremlin.IntegerLiteral left) {
    return new IntegerRange(left, right);
  }

  public IntegerRange withRight(hydra.tinkerpop.gremlin.IntegerLiteral right) {
    return new IntegerRange(left, right);
  }
}
