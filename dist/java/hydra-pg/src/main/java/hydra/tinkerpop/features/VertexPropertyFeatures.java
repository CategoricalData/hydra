...
public class VertexPropertyFeatures implements Serializable, Comparable<VertexPropertyFeatures> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.features.VertexPropertyFeatures");
  ...
  public final hydra.tinkerpop.features.ElementFeatures elementFeatures;
  ...
  public VertexPropertyFeatures (hydra.tinkerpop.features.DataTypeFeatures dataTypeFeatures, hydra.tinkerpop.features.PropertyFeatures propertyFeatures, hydra.tinkerpop.features.ElementFeatures elementFeatures, Boolean supportsRemove) {
  ...
  public VertexPropertyFeatures withDataTypeFeatures(hydra.tinkerpop.features.DataTypeFeatures dataTypeFeatures) {
    return new VertexPropertyFeatures(dataTypeFeatures, propertyFeatures, elementFeatures, supportsRemove);
  }

  public VertexPropertyFeatures withPropertyFeatures(hydra.tinkerpop.features.PropertyFeatures propertyFeatures) {
    return new VertexPropertyFeatures(dataTypeFeatures, propertyFeatures, elementFeatures, supportsRemove);
  }

  public VertexPropertyFeatures withElementFeatures(hydra.tinkerpop.features.ElementFeatures elementFeatures) {
    return new VertexPropertyFeatures(dataTypeFeatures, propertyFeatures, elementFeatures, supportsRemove);
  }
