...
public class VariableFeatures implements Serializable, Comparable<VariableFeatures> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.features.VariableFeatures");
  ...
  public VariableFeatures (hydra.tinkerpop.features.DataTypeFeatures dataTypeFeatures, Boolean supportsVariables) {
  ...
  public VariableFeatures withDataTypeFeatures(hydra.tinkerpop.features.DataTypeFeatures dataTypeFeatures) {
