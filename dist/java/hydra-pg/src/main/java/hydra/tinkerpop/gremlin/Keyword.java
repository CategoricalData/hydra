...
public abstract class Keyword implements Serializable, Comparable<Keyword> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.Keyword");
  ...
  public static final class Edges extends hydra.tinkerpop.gremlin.Keyword implements Serializable {
    public Edges () {
  ...
  public static final class Keys extends hydra.tinkerpop.gremlin.Keyword implements Serializable {
    public Keys () {
  ...
  public static final class New extends hydra.tinkerpop.gremlin.Keyword implements Serializable {
    public New () {
  ...
  public static final class Values extends hydra.tinkerpop.gremlin.Keyword implements Serializable {
    public Values () {
