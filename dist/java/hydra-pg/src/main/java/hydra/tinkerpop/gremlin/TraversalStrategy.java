...
public class TraversalStrategy implements Serializable, Comparable<TraversalStrategy> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalStrategy");
  ...
  public final hydra.tinkerpop.gremlin.Identifier class_;

  public final java.util.List<hydra.tinkerpop.gremlin.Configuration> configurations;

  public TraversalStrategy (Boolean new_, hydra.tinkerpop.gremlin.Identifier class_, java.util.List<hydra.tinkerpop.gremlin.Configuration> configurations) {
    this.new_ = new_;
    this.class_ = class_;
  ...
  public TraversalStrategy withClass(hydra.tinkerpop.gremlin.Identifier class_) {
    return new TraversalStrategy(new_, class_, configurations);
  }

  public TraversalStrategy withConfigurations(java.util.List<hydra.tinkerpop.gremlin.Configuration> configurations) {
    return new TraversalStrategy(new_, class_, configurations);
  }
}
