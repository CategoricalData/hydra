...
public abstract class TraversalPredicateOrStringLiteralVarargs implements Serializable, Comparable<TraversalPredicateOrStringLiteralVarargs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPredicateOrStringLiteralVarargs");
  ...
  public static final class Predicate extends hydra.tinkerpop.gremlin.TraversalPredicateOrStringLiteralVarargs implements Serializable {
  ...
  public static final class String_ extends hydra.tinkerpop.gremlin.TraversalPredicateOrStringLiteralVarargs implements Serializable {
