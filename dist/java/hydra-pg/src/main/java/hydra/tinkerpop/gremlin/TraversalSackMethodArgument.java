...
public abstract class TraversalSackMethodArgument implements Serializable, Comparable<TraversalSackMethodArgument> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSackMethodArgument");
  ...
  public static final class Value extends hydra.tinkerpop.gremlin.TraversalSackMethodArgument implements Serializable {
    public Value () {
  ...
  public static final class Variable extends hydra.tinkerpop.gremlin.TraversalSackMethodArgument implements Serializable {
