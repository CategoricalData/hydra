...
public abstract class ToArgs implements Serializable, Comparable<ToArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.ToArgs");
  ...
  public static final class Direction extends hydra.tinkerpop.gremlin.ToArgs implements Serializable {
    public final hydra.tinkerpop.gremlin.DirectionAndVarargs value;

    public Direction (hydra.tinkerpop.gremlin.DirectionAndVarargs value) {
      this.value = value;
    }
  ...
  public static final class String_ extends hydra.tinkerpop.gremlin.ToArgs implements Serializable {
  ...
  public static final class Vertex extends hydra.tinkerpop.gremlin.ToArgs implements Serializable {
  ...
  public static final class Traversal extends hydra.tinkerpop.gremlin.ToArgs implements Serializable {
