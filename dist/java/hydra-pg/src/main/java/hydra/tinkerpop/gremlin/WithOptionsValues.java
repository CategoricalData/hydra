...
public abstract class WithOptionsValues implements Serializable, Comparable<WithOptionsValues> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.WithOptionsValues");
  ...
  public static final class Tokens extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Tokens () {
  ...
  public static final class None extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public None () {
  ...
  public static final class Ids extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Ids () {
  ...
  public static final class Labels extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Labels () {
  ...
  public static final class Keys extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Keys () {
  ...
  public static final class Values extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Values () {
  ...
  public static final class All extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public All () {
  ...
  public static final class List extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public List () {
  ...
  public static final class Map extends hydra.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Map () {
