...
public abstract class GenericLiteralMapNullableArgumentOrNestedTraversal implements Serializable, Comparable<GenericLiteralMapNullableArgumentOrNestedTraversal> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal");
  ...
  public static final class Map extends hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal implements Serializable {
    public final hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument value;

    public Map (hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument value) {
      this.value = value;
    }
  ...
  public static final class Traversal extends hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal implements Serializable {
