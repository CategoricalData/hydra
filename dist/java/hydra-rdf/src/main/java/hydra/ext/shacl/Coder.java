...
public interface Coder {
  ...
  static hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>> encodeField(hydra.core.Name rname, hydra.ext.org.w3.rdf.syntax.Resource subject, hydra.core.Field field, hydra.context.Context cx, hydra.graph.Graph g) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.ext.shacl.Coder.encodeTerm(
        ...
        cx1.get(),
        g),
      (java.util.function.Function<hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>>>) (_r1 -> {
        ...
        return hydra.util.Either.<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>>right((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>) ((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>) (new hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>(hydra.lib.lists.Concat2.apply(
  ...
  static <T0> hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>> encodeFieldType(hydra.core.Name rname, hydra.util.Maybe<java.math.BigInteger> order, hydra.core.FieldType ft, T0 cx) {
    hydra.core.Name fname = (ft).name;
    hydra.ext.org.w3.rdf.syntax.Iri iri = hydra.ext.rdf.Utils.propertyIri(
      rname,
      fname);
    java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>>> forTypeDefault = (java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>>>) (mn -> (java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>>) (mx -> (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>) (t -> hydra.lib.eithers.Map.apply(
      ...
      hydra.ext.shacl.Coder.<T0>encodeType(
        rname,
        t,
        cx)))));
    ...
    forType.set((java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>>>) (mn -> (java.util.function.Function<hydra.util.Maybe<java.math.BigInteger>, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>>) (mx -> (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>) (t -> hydra.Strip.deannotateType(t).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>> otherwise(hydra.core.Type instance) {
        return (forTypeDefault).apply(mn).apply(mx).apply(t);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>> visit(hydra.core.Type.Maybe ot) {
        return forType.get().apply(hydra.util.Maybe.just(new java.math.BigInteger("0"))).apply(mx).apply((ot).value);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>> visit(hydra.core.Type.Set st) {
  ...
  static hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> encodeList(hydra.ext.org.w3.rdf.syntax.Resource subj, java.util.List<hydra.core.Term> terms, hydra.context.Context cx0, hydra.graph.Graph g) {
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.lists.Null.apply(terms),
      () -> hydra.util.Either.<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>right((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>) ((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>) (new hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>(java.util.Arrays.asList(new hydra.ext.org.w3.rdf.syntax.Description(new hydra.ext.org.w3.rdf.syntax.Node.Iri(new hydra.ext.org.w3.rdf.syntax.Iri("http://www.w3.org/1999/02/22-rdf-syntax-ns#nil")), new hydra.ext.org.w3.rdf.syntax.Graph((java.util.Set<hydra.ext.org.w3.rdf.syntax.Triple>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Triple>apply())))), cx0)))),
      () -> ((java.util.function.Supplier<hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>>) (() -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.ext.shacl.Coder.encodeTerm(
            ...
            cx1.get(),
            g),
          (java.util.function.Function<hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>>) (_r1 -> {
            hydra.util.Lazy<hydra.context.Context> cx2 = new hydra.util.Lazy<>(() -> hydra.lib.pairs.Second.apply(_r1));
  ...
  static hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> encodeTerm(hydra.ext.org.w3.rdf.syntax.Resource subject, hydra.core.Term term, hydra.context.Context cx, hydra.graph.Graph g) {
    return (term).accept(new hydra.core.Term.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> otherwise(hydra.core.Term instance) {
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Annotated at) {
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.List terms) {
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Literal lit) {
        return hydra.util.Either.<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>right((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>) ((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>) (new hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>(java.util.Arrays.asList(new hydra.ext.org.w3.rdf.syntax.Description(new hydra.ext.org.w3.rdf.syntax.Node.Literal(hydra.ext.rdf.Utils.encodeLiteral((lit).value)), new hydra.ext.org.w3.rdf.syntax.Graph((java.util.Set<hydra.ext.org.w3.rdf.syntax.Triple>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Triple>apply())))), cx))));
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Map m) {
        return hydra.lib.eithers.Map.apply(
          ...
          hydra.ext.shacl.Coder.foldAccumResult(
            (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.util.Pair<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>>>>) (_cx0 -> (java.util.function.Function<hydra.util.Pair<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>>>) (kv -> hydra.lib.eithers.Bind.apply(
              hydra.extract.Core.string(
                g,
                hydra.Strip.deannotateTerm(hydra.lib.pairs.First.apply(kv))),
              (java.util.function.Function<String, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>>>) (_ks -> {
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Wrap wt) {
        return hydra.lib.eithers.Map.apply(
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Maybe mterm) {
        return hydra.lib.maybes.Maybe.applyLazy(
          () -> hydra.util.Either.<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>right((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>) ((hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>) (new hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>((java.util.List<hydra.ext.org.w3.rdf.syntax.Description>) (java.util.Collections.<hydra.ext.org.w3.rdf.syntax.Description>emptyList()), cx)))),
          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>>) (_inner -> hydra.ext.shacl.Coder.encodeTerm(
            subject,
            _inner,
            cx,
            g)),
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Record rec) {
        ...
        return hydra.lib.eithers.Map.apply(
          ...
          hydra.ext.shacl.Coder.foldAccumResult(
            (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Field, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>>>>) (_cx0 -> (java.util.function.Function<hydra.core.Field, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Triple>, hydra.context.Context>>>) (field -> hydra.ext.shacl.Coder.encodeField(
              rname,
              subject,
              field,
              _cx0,
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Set terms) {
        return hydra.lib.eithers.Map.apply(
          ...
          hydra.ext.shacl.Coder.foldAccumResult(
            (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>>>) (_cx0 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>>>) (t -> {
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<java.util.List<hydra.ext.org.w3.rdf.syntax.Description>, hydra.context.Context>> visit(hydra.core.Term.Union inj) {
  ...
  static <T0> hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> encodeType(hydra.core.Name tname, hydra.core.Type typ, T0 cx) {
    return hydra.Strip.deannotateType(typ).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> otherwise(hydra.core.Type instance) {
        return hydra.ext.shacl.Coder.unexpectedE(
          cx,
          "type",
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Either ignored) {
        return hydra.ext.shacl.Coder.encodeType_any(hydra.ext.shacl.Coder::common);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.List ignored) {
        return hydra.ext.shacl.Coder.encodeType_any(hydra.ext.shacl.Coder::common);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Literal lt) {
        return hydra.util.Either.<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties>right(hydra.ext.shacl.Coder.encodeLiteralType((lt).value));
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Map ignored) {
        return hydra.ext.shacl.Coder.encodeType_any(hydra.ext.shacl.Coder::common);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Pair ignored) {
        return hydra.ext.shacl.Coder.encodeType_any(hydra.ext.shacl.Coder::common);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Wrap ignored) {
        return hydra.ext.shacl.Coder.encodeType_any(hydra.ext.shacl.Coder::common);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Record fts) {
        return hydra.lib.eithers.Map.apply(
          ...
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.util.Pair<java.math.BigInteger, hydra.core.FieldType>, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>) (_pair -> hydra.ext.shacl.Coder.<T0>encodeFieldType(
              tname,
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Set ignored) {
        return hydra.ext.shacl.Coder.encodeType_any(hydra.ext.shacl.Coder::common);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Union fts) {
        return hydra.lib.eithers.Map.apply(
          (java.util.function.Function<java.util.List<hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>, hydra.ext.org.w3.shacl.model.CommonProperties>) (_props -> hydra.ext.shacl.Coder.common(java.util.Arrays.asList(new hydra.ext.org.w3.shacl.model.CommonConstraint.Xone(hydra.lib.sets.FromList.apply(hydra.lib.lists.Map.apply(
            ...
            _props)))))),
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.core.FieldType, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.PropertyShape>>>) (_ft -> hydra.ext.shacl.Coder.<T0>encodeFieldType(
              tname,
      ...
      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Unit ignored) {
        return hydra.ext.shacl.Coder.encodeType_any(hydra.ext.shacl.Coder::common);
      }

      @Override
      public hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties> visit(hydra.core.Type.Variable vname) {
        return hydra.util.Either.<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.CommonProperties>right(hydra.ext.shacl.Coder.common(java.util.Arrays.asList(new hydra.ext.org.w3.shacl.model.CommonConstraint.Node(hydra.lib.sets.FromList.apply(java.util.Arrays.asList((hydra.ext.org.w3.shacl.model.Reference<hydra.ext.org.w3.shacl.model.NodeShape>) (new hydra.ext.org.w3.shacl.model.Reference.Named(hydra.ext.rdf.Utils.nameToIri((vname).value)))))))));
      }
    });
  }

  static <T1> hydra.util.Either<T1, hydra.ext.org.w3.shacl.model.CommonProperties> encodeType_any(java.util.function.Function<java.util.List<hydra.ext.org.w3.shacl.model.CommonConstraint>, hydra.ext.org.w3.shacl.model.CommonProperties> hydra_ext_shacl_coder_common) {
    return hydra.util.Either.<T1, hydra.ext.org.w3.shacl.model.CommonProperties>right((hydra_ext_shacl_coder_common).apply((java.util.List<hydra.ext.org.w3.shacl.model.CommonConstraint>) (java.util.Collections.<hydra.ext.org.w3.shacl.model.CommonConstraint>emptyList())));
  }
  ...
  static <T0> hydra.util.Either<hydra.errors.Error_, hydra.util.Pair<hydra.ext.org.w3.shacl.model.ShapesGraph, T0>> shaclCoder(hydra.packaging.Module mod, T0 cx, hydra.graph.Graph g) {
    java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.Shape>>> toShape = (java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.Shape>>>) (el -> hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.Bimap.apply(
        ...
        hydra.decode.Core.type(
          g,
          (el).term)),
      (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.Error_, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.Shape>>>) (_typ -> hydra.lib.eithers.Map.apply(
    ...
    hydra.util.Lazy<java.util.List<hydra.core.Binding>> typeEls = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Cat.apply(hydra.lib.lists.Map.apply(
      ...
      (mod).definitions)));
    return hydra.lib.eithers.Map.apply(
      (java.util.function.Function<java.util.List<hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.Shape>>, hydra.util.Pair<hydra.ext.org.w3.shacl.model.ShapesGraph, T0>>) (_shapes -> (hydra.util.Pair<hydra.ext.org.w3.shacl.model.ShapesGraph, T0>) ((hydra.util.Pair<hydra.ext.org.w3.shacl.model.ShapesGraph, T0>) (new hydra.util.Pair<hydra.ext.org.w3.shacl.model.ShapesGraph, T0>(new hydra.ext.org.w3.shacl.model.ShapesGraph(hydra.lib.sets.FromList.apply(_shapes)), cx)))),
      hydra.lib.eithers.MapList.apply(
        toShape,
        typeEls.get()));
  }
  ...
  static <T0, T1> hydra.util.Either<hydra.errors.Error_, T1> unexpectedE(T0 cx, String expected, String found) {
    return hydra.ext.shacl.Coder.<T0, T1>err(
      cx,
