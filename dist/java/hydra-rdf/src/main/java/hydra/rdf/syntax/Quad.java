...
public class Quad implements Serializable, Comparable<Quad> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.rdf.syntax.Quad");
  ...
  public final hydra.util.Maybe<hydra.rdf.syntax.Iri> graph;

  public Quad (hydra.rdf.syntax.Resource subject, hydra.rdf.syntax.Iri predicate, hydra.rdf.syntax.Node object, hydra.util.Maybe<hydra.rdf.syntax.Iri> graph) {
  ...
  public Quad withSubject(hydra.rdf.syntax.Resource subject) {
    return new Quad(subject, predicate, object, graph);
  }

  public Quad withPredicate(hydra.rdf.syntax.Iri predicate) {
    return new Quad(subject, predicate, object, graph);
  }

  public Quad withObject(hydra.rdf.syntax.Node object) {
    return new Quad(subject, predicate, object, graph);
  }

  public Quad withGraph(hydra.util.Maybe<hydra.rdf.syntax.Iri> graph) {
    return new Quad(subject, predicate, object, graph);
  }
}
