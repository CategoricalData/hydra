...
public abstract class Resource implements Serializable, Comparable<Resource> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.rdf.syntax.Resource");
  ...
  public static final class Iri extends hydra.rdf.syntax.Resource implements Serializable {
  ...
  public static final class Bnode extends hydra.rdf.syntax.Resource implements Serializable {
