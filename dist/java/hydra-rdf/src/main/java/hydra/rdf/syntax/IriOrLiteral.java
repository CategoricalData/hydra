 ...
 */
public abstract class IriOrLiteral implements Serializable, Comparable<IriOrLiteral> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.rdf.syntax.IriOrLiteral");
  ...
  public static final class Iri extends hydra.rdf.syntax.IriOrLiteral implements Serializable {
    ...
    public int compareTo(IriOrLiteral other) {
  ...
  public static final class Literal extends hydra.rdf.syntax.IriOrLiteral implements Serializable {
