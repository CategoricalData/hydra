...
public class Definition<A> implements Serializable, Comparable<Definition<A>> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shacl.model.Definition");
  ...
  public Definition (hydra.rdf.syntax.Iri iri, A target) {
    this.iri = iri;
    this.target = target;
  }
  ...
  public Definition withIri(hydra.rdf.syntax.Iri iri) {
