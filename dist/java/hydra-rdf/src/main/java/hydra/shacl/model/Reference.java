...
public abstract class Reference<A> implements Serializable, Comparable<Reference<A>> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shacl.model.Reference");
  ...
  public static final class Named<A> extends hydra.shacl.model.Reference<A> implements Serializable {
    public final hydra.rdf.syntax.Iri value;

    public Named (hydra.rdf.syntax.Iri value) {
      this.value = value;
    }
   ...
   */
  public static final class Anonymous<A> extends hydra.shacl.model.Reference<A> implements Serializable {
   ...
   */
  public static final class Definition<A> extends hydra.shacl.model.Reference<A> implements Serializable {
    public final hydra.shacl.model.Definition<A> value;

    public Definition (hydra.shacl.model.Definition<A> value) {
      this.value = value;
    }
