...
public class ObjectHasValue implements Serializable, Comparable<ObjectHasValue> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ObjectHasValue");
  ...
  public ObjectHasValue (hydra.owl.syntax.ObjectPropertyExpression property, hydra.owl.syntax.Individual individual) {
  ...
  public ObjectHasValue withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new ObjectHasValue(property, individual);
  }

  public ObjectHasValue withIndividual(hydra.owl.syntax.Individual individual) {
    return new ObjectHasValue(property, individual);
  }
}
