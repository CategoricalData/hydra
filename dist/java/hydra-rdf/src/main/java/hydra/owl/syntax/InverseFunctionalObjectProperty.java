...
public class InverseFunctionalObjectProperty implements Serializable, Comparable<InverseFunctionalObjectProperty> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.InverseFunctionalObjectProperty");
  ...
  public InverseFunctionalObjectProperty (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property) {
  ...
  public InverseFunctionalObjectProperty withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new InverseFunctionalObjectProperty(annotations, property);
  }

  public InverseFunctionalObjectProperty withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new InverseFunctionalObjectProperty(annotations, property);
  }
}
