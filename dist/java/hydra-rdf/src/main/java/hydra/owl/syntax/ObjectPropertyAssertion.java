...
public class ObjectPropertyAssertion implements Serializable, Comparable<ObjectPropertyAssertion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ObjectPropertyAssertion");
  ...
  public ObjectPropertyAssertion (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property, hydra.owl.syntax.Individual source, hydra.owl.syntax.Individual target) {
  ...
  public ObjectPropertyAssertion withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new ObjectPropertyAssertion(annotations, property, source, target);
  }

  public ObjectPropertyAssertion withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new ObjectPropertyAssertion(annotations, property, source, target);
  }

  public ObjectPropertyAssertion withSource(hydra.owl.syntax.Individual source) {
    return new ObjectPropertyAssertion(annotations, property, source, target);
  }

  public ObjectPropertyAssertion withTarget(hydra.owl.syntax.Individual target) {
    return new ObjectPropertyAssertion(annotations, property, source, target);
  }
}
