...
public class NegativeDataPropertyAssertion implements Serializable, Comparable<NegativeDataPropertyAssertion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.NegativeDataPropertyAssertion");
  ...
  public NegativeDataPropertyAssertion (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.DataPropertyExpression property, hydra.owl.syntax.Individual source, hydra.owl.syntax.Individual target) {
  ...
  public NegativeDataPropertyAssertion withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new NegativeDataPropertyAssertion(annotations, property, source, target);
  }

  public NegativeDataPropertyAssertion withProperty(hydra.owl.syntax.DataPropertyExpression property) {
    return new NegativeDataPropertyAssertion(annotations, property, source, target);
  }

  public NegativeDataPropertyAssertion withSource(hydra.owl.syntax.Individual source) {
    return new NegativeDataPropertyAssertion(annotations, property, source, target);
  }

  public NegativeDataPropertyAssertion withTarget(hydra.owl.syntax.Individual target) {
    return new NegativeDataPropertyAssertion(annotations, property, source, target);
  }
}
