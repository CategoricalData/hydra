...
public abstract class AnnotationValue implements Serializable, Comparable<AnnotationValue> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.AnnotationValue");
  ...
  public static final class AnonymousIndividual extends hydra.owl.syntax.AnnotationValue implements Serializable {
    public final hydra.owl.syntax.AnonymousIndividual value;

    public AnonymousIndividual (hydra.owl.syntax.AnonymousIndividual value) {
      this.value = value;
    }
  ...
  public static final class Iri extends hydra.owl.syntax.AnnotationValue implements Serializable {
  ...
  public static final class Literal extends hydra.owl.syntax.AnnotationValue implements Serializable {
