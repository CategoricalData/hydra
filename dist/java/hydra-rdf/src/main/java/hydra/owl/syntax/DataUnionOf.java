...
public class DataUnionOf implements Serializable, Comparable<DataUnionOf> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DataUnionOf");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final java.util.List<hydra.owl.syntax.DataRange> value;

  public DataUnionOf (java.util.List<hydra.owl.syntax.DataRange> value) {
    this.value = value;
  }
