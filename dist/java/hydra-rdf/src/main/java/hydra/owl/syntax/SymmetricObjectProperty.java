...
public class SymmetricObjectProperty implements Serializable, Comparable<SymmetricObjectProperty> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.SymmetricObjectProperty");
  ...
  public SymmetricObjectProperty (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property) {
  ...
  public SymmetricObjectProperty withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new SymmetricObjectProperty(annotations, property);
  }

  public SymmetricObjectProperty withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new SymmetricObjectProperty(annotations, property);
  }
}
