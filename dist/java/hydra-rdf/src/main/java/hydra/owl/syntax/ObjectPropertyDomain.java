...
public class ObjectPropertyDomain implements Serializable, Comparable<ObjectPropertyDomain> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ObjectPropertyDomain");
  ...
  public ObjectPropertyDomain (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property, hydra.owl.syntax.ClassExpression domain) {
  ...
  public ObjectPropertyDomain withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new ObjectPropertyDomain(annotations, property, domain);
  }

  public ObjectPropertyDomain withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new ObjectPropertyDomain(annotations, property, domain);
  }

  public ObjectPropertyDomain withDomain(hydra.owl.syntax.ClassExpression domain) {
    return new ObjectPropertyDomain(annotations, property, domain);
  }
}
