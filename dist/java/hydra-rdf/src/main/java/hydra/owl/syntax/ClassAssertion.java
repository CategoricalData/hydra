...
public class ClassAssertion implements Serializable, Comparable<ClassAssertion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ClassAssertion");
  ...
  public final hydra.owl.syntax.Individual individual;

  public ClassAssertion (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ClassExpression class_, hydra.owl.syntax.Individual individual) {
  ...
  public ClassAssertion withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new ClassAssertion(annotations, class_, individual);
  }

  public ClassAssertion withClass(hydra.owl.syntax.ClassExpression class_) {
    return new ClassAssertion(annotations, class_, individual);
  }

  public ClassAssertion withIndividual(hydra.owl.syntax.Individual individual) {
    return new ClassAssertion(annotations, class_, individual);
  }
}
