...
public abstract class Datatype implements Serializable, Comparable<Datatype> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.Datatype");
   ...
   */
  public static final class XmlSchema extends hydra.owl.syntax.Datatype implements Serializable {
    public final hydra.xml.schema.Datatype value;

    public XmlSchema (hydra.xml.schema.Datatype value) {
      this.value = value;
    }
  ...
  public static final class Other extends hydra.owl.syntax.Datatype implements Serializable {
