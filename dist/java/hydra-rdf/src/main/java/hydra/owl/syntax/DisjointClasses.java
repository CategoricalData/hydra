...
public class DisjointClasses implements Serializable, Comparable<DisjointClasses> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DisjointClasses");
  ...
  public DisjointClasses (java.util.List<hydra.owl.syntax.Annotation> annotations, java.util.List<hydra.owl.syntax.ClassExpression> classes) {
  ...
  public DisjointClasses withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new DisjointClasses(annotations, classes);
  }

  public DisjointClasses withClasses(java.util.List<hydra.owl.syntax.ClassExpression> classes) {
    return new DisjointClasses(annotations, classes);
  }
}
