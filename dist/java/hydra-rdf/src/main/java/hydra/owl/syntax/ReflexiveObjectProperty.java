...
public class ReflexiveObjectProperty implements Serializable, Comparable<ReflexiveObjectProperty> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ReflexiveObjectProperty");
  ...
  public ReflexiveObjectProperty (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property) {
  ...
  public ReflexiveObjectProperty withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new ReflexiveObjectProperty(annotations, property);
  }

  public ReflexiveObjectProperty withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new ReflexiveObjectProperty(annotations, property);
  }
}
