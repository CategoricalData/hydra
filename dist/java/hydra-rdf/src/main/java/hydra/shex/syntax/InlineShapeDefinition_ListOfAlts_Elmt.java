...
public abstract class InlineShapeDefinition_ListOfAlts_Elmt implements Serializable, Comparable<InlineShapeDefinition_ListOfAlts_Elmt> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt");
  ...
  public static final class IncludeSet extends hydra.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt implements Serializable {
  ...
  public static final class ExtraPropertySet extends hydra.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt implements Serializable {
  ...
  public static final class CLOSED extends hydra.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt implements Serializable {
    public CLOSED () {
