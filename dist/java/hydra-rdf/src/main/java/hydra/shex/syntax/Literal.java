...
public abstract class Literal implements Serializable, Comparable<Literal> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.Literal");
  ...
  public static final class RdfLiteral extends hydra.shex.syntax.Literal implements Serializable {
    public final hydra.shex.syntax.RdfLiteral value;

    public RdfLiteral (hydra.shex.syntax.RdfLiteral value) {
      this.value = value;
    }
  ...
  public static final class NumericLiteral extends hydra.shex.syntax.Literal implements Serializable {
    public final hydra.shex.syntax.NumericLiteral value;

    public NumericLiteral (hydra.shex.syntax.NumericLiteral value) {
      this.value = value;
    }
  ...
  public static final class BooleanLiteral extends hydra.shex.syntax.Literal implements Serializable {
    public final hydra.shex.syntax.BooleanLiteral value;

    public BooleanLiteral (hydra.shex.syntax.BooleanLiteral value) {
      this.value = value;
    }
