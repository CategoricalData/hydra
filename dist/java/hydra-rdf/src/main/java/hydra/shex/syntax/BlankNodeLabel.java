...
public class BlankNodeLabel implements Serializable, Comparable<BlankNodeLabel> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.BlankNodeLabel");
  ...
  public final hydra.shex.syntax.BlankNodeLabel_Alts alts;

  public final hydra.util.Maybe<java.util.List<hydra.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt>> ListOfAlts;

  public final hydra.shex.syntax.PnChars PnChars;

  public BlankNodeLabel (hydra.shex.syntax.BlankNodeLabel_Alts alts, hydra.util.Maybe<java.util.List<hydra.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt>> ListOfAlts, hydra.shex.syntax.PnChars PnChars) {
    this.alts = alts;
  ...
  public BlankNodeLabel withAlts(hydra.shex.syntax.BlankNodeLabel_Alts alts) {
    return new BlankNodeLabel(alts, ListOfAlts, PnChars);
  }

  public BlankNodeLabel withListOfAlts(hydra.util.Maybe<java.util.List<hydra.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt>> ListOfAlts) {
    return new BlankNodeLabel(alts, ListOfAlts, PnChars);
  }

  public BlankNodeLabel withPnChars(hydra.shex.syntax.PnChars PnChars) {
    return new BlankNodeLabel(alts, ListOfAlts, PnChars);
  }
}
