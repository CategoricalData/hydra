...
public abstract class PnChars implements Serializable, Comparable<PnChars> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.PnChars");
  ...
  public static final class PnCharsU extends hydra.shex.syntax.PnChars implements Serializable {
    ...
    public int compareTo(PnChars other) {
  ...
  public static final class Minus extends hydra.shex.syntax.PnChars implements Serializable {
    public Minus () {
  ...
  public static final class Regex extends hydra.shex.syntax.PnChars implements Serializable {
