...
public class InlineShapeDefinition implements Serializable, Comparable<InlineShapeDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.InlineShapeDefinition");
  ...
  public final java.util.List<hydra.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt> listOfAlts;

  public final hydra.util.Maybe<hydra.shex.syntax.TripleExpression> TripleExpression;

  public InlineShapeDefinition (java.util.List<hydra.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt> listOfAlts, hydra.util.Maybe<hydra.shex.syntax.TripleExpression> TripleExpression) {
  ...
  public InlineShapeDefinition withListOfAlts(java.util.List<hydra.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt> listOfAlts) {
    return new InlineShapeDefinition(listOfAlts, TripleExpression);
  }

  public InlineShapeDefinition withTripleExpression(hydra.util.Maybe<hydra.shex.syntax.TripleExpression> TripleExpression) {
    return new InlineShapeDefinition(listOfAlts, TripleExpression);
  }
}
