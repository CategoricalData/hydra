...
public abstract class ShapeExprLabel implements Serializable, Comparable<ShapeExprLabel> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShapeExprLabel");
  ...
  public static final class Iri extends hydra.shex.syntax.ShapeExprLabel implements Serializable {
    public final hydra.shex.syntax.Iri value;

    public Iri (hydra.shex.syntax.Iri value) {
      this.value = value;
    }
  ...
  public static final class BlankNode extends hydra.shex.syntax.ShapeExprLabel implements Serializable {
    public final hydra.shex.syntax.BlankNode value;

    public BlankNode (hydra.shex.syntax.BlankNode value) {
      this.value = value;
    }
