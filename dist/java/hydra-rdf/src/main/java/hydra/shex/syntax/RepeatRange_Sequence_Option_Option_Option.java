...
public abstract class RepeatRange_Sequence_Option_Option_Option implements Serializable, Comparable<RepeatRange_Sequence_Option_Option_Option> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.RepeatRange_Sequence_Option_Option_Option");
  ...
  public static final class Integer_ extends hydra.shex.syntax.RepeatRange_Sequence_Option_Option_Option implements Serializable {
  ...
  public static final class Ast extends hydra.shex.syntax.RepeatRange_Sequence_Option_Option_Option implements Serializable {
    public Ast () {
