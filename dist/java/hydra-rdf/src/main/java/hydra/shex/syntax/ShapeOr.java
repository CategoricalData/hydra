...
public class ShapeOr implements Serializable, Comparable<ShapeOr> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShapeOr");
  ...
  public final java.util.List<hydra.shex.syntax.ShapeAnd> listOfSequence;

  public ShapeOr (hydra.shex.syntax.ShapeAnd ShapeAnd, java.util.List<hydra.shex.syntax.ShapeAnd> listOfSequence) {
  ...
  public ShapeOr withShapeAnd(hydra.shex.syntax.ShapeAnd ShapeAnd) {
    return new ShapeOr(ShapeAnd, listOfSequence);
  }

  public ShapeOr withListOfSequence(java.util.List<hydra.shex.syntax.ShapeAnd> listOfSequence) {
    return new ShapeOr(ShapeAnd, listOfSequence);
  }
}
