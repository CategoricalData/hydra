...
public class PnPrefix implements Serializable, Comparable<PnPrefix> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.PnPrefix");
  ...
  public final hydra.shex.syntax.PnCharsBase PnCharsBase;

  public final hydra.util.Maybe<hydra.shex.syntax.PnPrefix_Sequence_Option> Sequence;

  public PnPrefix (hydra.shex.syntax.PnCharsBase PnCharsBase, hydra.util.Maybe<hydra.shex.syntax.PnPrefix_Sequence_Option> Sequence) {
  ...
  public PnPrefix withPnCharsBase(hydra.shex.syntax.PnCharsBase PnCharsBase) {
    return new PnPrefix(PnCharsBase, Sequence);
  }

  public PnPrefix withSequence(hydra.util.Maybe<hydra.shex.syntax.PnPrefix_Sequence_Option> Sequence) {
    return new PnPrefix(PnCharsBase, Sequence);
  }
}
