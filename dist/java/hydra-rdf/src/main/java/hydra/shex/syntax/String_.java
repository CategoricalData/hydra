...
public abstract class String_ implements Serializable, Comparable<String_> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.String");
  ...
  public static final class StringLiteral1 extends hydra.shex.syntax.String_ implements Serializable {
    public final hydra.shex.syntax.StringLiteral1 value;

    public StringLiteral1 (hydra.shex.syntax.StringLiteral1 value) {
      this.value = value;
    }
  ...
  public static final class StringLiteralLong1 extends hydra.shex.syntax.String_ implements Serializable {
    public final hydra.shex.syntax.StringLiteralLong1 value;

    public StringLiteralLong1 (hydra.shex.syntax.StringLiteralLong1 value) {
      this.value = value;
    }
  ...
  public static final class StringLiteral2 extends hydra.shex.syntax.String_ implements Serializable {
    public final hydra.shex.syntax.StringLiteral2 value;

    public StringLiteral2 (hydra.shex.syntax.StringLiteral2 value) {
      this.value = value;
    }
  ...
  public static final class StringLiteralLong2 extends hydra.shex.syntax.String_ implements Serializable {
    public final hydra.shex.syntax.StringLiteralLong2 value;

    public StringLiteralLong2 (hydra.shex.syntax.StringLiteralLong2 value) {
      this.value = value;
    }
