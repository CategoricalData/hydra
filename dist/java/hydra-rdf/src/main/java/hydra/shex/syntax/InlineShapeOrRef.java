...
public abstract class InlineShapeOrRef implements Serializable, Comparable<InlineShapeOrRef> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.InlineShapeOrRef");
  ...
  public static final class InlineShapeDefinition extends hydra.shex.syntax.InlineShapeOrRef implements Serializable {
    public final hydra.shex.syntax.InlineShapeDefinition value;

    public InlineShapeDefinition (hydra.shex.syntax.InlineShapeDefinition value) {
      this.value = value;
    }
  ...
  public static final class AtpNameLn extends hydra.shex.syntax.InlineShapeOrRef implements Serializable {
  ...
  public static final class AtpNameNs extends hydra.shex.syntax.InlineShapeOrRef implements Serializable {
  ...
  public static final class Sequence extends hydra.shex.syntax.InlineShapeOrRef implements Serializable {
