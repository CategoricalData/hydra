...
public abstract class NonLiteralKind implements Serializable, Comparable<NonLiteralKind> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NonLiteralKind");
  ...
  public static final class IRI extends hydra.shex.syntax.NonLiteralKind implements Serializable {
    public IRI () {
  ...
  public static final class BNODE extends hydra.shex.syntax.NonLiteralKind implements Serializable {
    public BNODE () {
  ...
  public static final class NONLITERAL extends hydra.shex.syntax.NonLiteralKind implements Serializable {
    public NONLITERAL () {
