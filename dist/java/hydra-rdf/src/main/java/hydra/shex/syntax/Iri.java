...
public abstract class Iri implements Serializable, Comparable<Iri> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.Iri");
  ...
  public static final class IriRef extends hydra.shex.syntax.Iri implements Serializable {
    public final hydra.shex.syntax.IriRef value;

    public IriRef (hydra.shex.syntax.IriRef value) {
      this.value = value;
    }
  ...
  public static final class PrefixedName extends hydra.shex.syntax.Iri implements Serializable {
    public final hydra.shex.syntax.PrefixedName value;

    public PrefixedName (hydra.shex.syntax.PrefixedName value) {
      this.value = value;
    }
