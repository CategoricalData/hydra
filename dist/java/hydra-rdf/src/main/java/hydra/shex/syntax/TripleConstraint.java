...
public class TripleConstraint implements Serializable, Comparable<TripleConstraint> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.TripleConstraint");
  ...
  public final hydra.util.Maybe<hydra.shex.syntax.SenseFlags> SenseFlags;

  public final hydra.shex.syntax.Predicate Predicate;

  public final hydra.shex.syntax.InlineShapeExpression InlineShapeExpression;
  ...
  public TripleConstraint (hydra.util.Maybe<hydra.shex.syntax.SenseFlags> SenseFlags, hydra.shex.syntax.Predicate Predicate, hydra.shex.syntax.InlineShapeExpression InlineShapeExpression, hydra.util.Maybe<hydra.shex.syntax.Cardinality> Cardinality, java.util.List<hydra.shex.syntax.Annotation> listOfAnnotation, hydra.shex.syntax.SemanticActions SemanticActions) {
  ...
  public TripleConstraint withSenseFlags(hydra.util.Maybe<hydra.shex.syntax.SenseFlags> SenseFlags) {
    return new TripleConstraint(SenseFlags, Predicate, InlineShapeExpression, Cardinality, listOfAnnotation, SemanticActions);
  }

  public TripleConstraint withPredicate(hydra.shex.syntax.Predicate Predicate) {
    return new TripleConstraint(SenseFlags, Predicate, InlineShapeExpression, Cardinality, listOfAnnotation, SemanticActions);
  }

  public TripleConstraint withInlineShapeExpression(hydra.shex.syntax.InlineShapeExpression InlineShapeExpression) {
    return new TripleConstraint(SenseFlags, Predicate, InlineShapeExpression, Cardinality, listOfAnnotation, SemanticActions);
  }

  public TripleConstraint withCardinality(hydra.util.Maybe<hydra.shex.syntax.Cardinality> Cardinality) {
    return new TripleConstraint(SenseFlags, Predicate, InlineShapeExpression, Cardinality, listOfAnnotation, SemanticActions);
  }

  public TripleConstraint withListOfAnnotation(java.util.List<hydra.shex.syntax.Annotation> listOfAnnotation) {
    return new TripleConstraint(SenseFlags, Predicate, InlineShapeExpression, Cardinality, listOfAnnotation, SemanticActions);
  }

  public TripleConstraint withSemanticActions(hydra.shex.syntax.SemanticActions SemanticActions) {
    return new TripleConstraint(SenseFlags, Predicate, InlineShapeExpression, Cardinality, listOfAnnotation, SemanticActions);
  }
}
