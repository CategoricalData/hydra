...
public class CodeDecl implements Serializable, Comparable<CodeDecl> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.CodeDecl");
  ...
  public final hydra.shex.syntax.CodeDecl_Alts alts;

  public CodeDecl (hydra.shex.syntax.Iri Iri, hydra.shex.syntax.CodeDecl_Alts alts) {
    this.Iri = Iri;
    this.alts = alts;
  }
  ...
  public CodeDecl withIri(hydra.shex.syntax.Iri Iri) {
    return new CodeDecl(Iri, alts);
  }

  public CodeDecl withAlts(hydra.shex.syntax.CodeDecl_Alts alts) {
    return new CodeDecl(Iri, alts);
  }
}
