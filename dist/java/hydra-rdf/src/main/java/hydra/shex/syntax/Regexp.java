...
public class Regexp implements Serializable, Comparable<Regexp> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.Regexp");
  ...
  public final java.util.List<hydra.shex.syntax.Regexp_ListOfAlts_Elmt> listOfAlts;

  public final java.util.List<String> listOfRegex;

  public Regexp (java.util.List<hydra.shex.syntax.Regexp_ListOfAlts_Elmt> listOfAlts, java.util.List<String> listOfRegex) {
  ...
  public Regexp withListOfAlts(java.util.List<hydra.shex.syntax.Regexp_ListOfAlts_Elmt> listOfAlts) {
