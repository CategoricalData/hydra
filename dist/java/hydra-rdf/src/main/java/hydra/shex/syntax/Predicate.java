...
public abstract class Predicate implements Serializable, Comparable<Predicate> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.Predicate");
  ...
  public static final class Iri extends hydra.shex.syntax.Predicate implements Serializable {
  ...
  public static final class RdfType extends hydra.shex.syntax.Predicate implements Serializable {
    public final hydra.shex.syntax.RdfType value;

    public RdfType (hydra.shex.syntax.RdfType value) {
      this.value = value;
    }
