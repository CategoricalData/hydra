...
public abstract class TypeCastOperator implements Serializable, Comparable<TypeCastOperator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.coq.syntax.TypeCastOperator");

  public static final hydra.core.Name NORMAL = new hydra.core.Name("normal");

  public static final hydra.core.Name VM_COMPUTE = new hydra.core.Name("vmCompute");

  public static final hydra.core.Name NATIVE_COMPUTE = new hydra.core.Name("nativeCompute");
   ...
   */
  public static final class Normal extends hydra.coq.syntax.TypeCastOperator implements Serializable {
    public Normal () {
    ...
    public int compareTo(TypeCastOperator other) {
   ...
   */
  public static final class VmCompute extends hydra.coq.syntax.TypeCastOperator implements Serializable {
    public VmCompute () {
   ...
   */
  public static final class NativeCompute extends hydra.coq.syntax.TypeCastOperator implements Serializable {
