...
public class AmbiguousName implements Serializable, Comparable<AmbiguousName> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.AmbiguousName");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final java.util.List<hydra.java.syntax.Identifier> value;

  public AmbiguousName (java.util.List<hydra.java.syntax.Identifier> value) {
    this.value = value;
  }
