...
public class PostIncrementExpression implements Serializable, Comparable<PostIncrementExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.PostIncrementExpression");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.PostfixExpression value;

  public PostIncrementExpression (hydra.java.syntax.PostfixExpression value) {
    this.value = value;
  }
