...
public abstract class ConstantModifier implements Serializable, Comparable<ConstantModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ConstantModifier");
  ...
  public static final class Annotation extends hydra.java.syntax.ConstantModifier implements Serializable {
    ...
    public int compareTo(ConstantModifier other) {
  ...
  public static final class Public extends hydra.java.syntax.ConstantModifier implements Serializable {
    public Public () {
  ...
  public static final class Static extends hydra.java.syntax.ConstantModifier implements Serializable {
    public Static () {
  ...
  public static final class Final extends hydra.java.syntax.ConstantModifier implements Serializable {
    public Final () {
