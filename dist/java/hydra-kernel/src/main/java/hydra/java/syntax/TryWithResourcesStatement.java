...
public class TryWithResourcesStatement implements Serializable, Comparable<TryWithResourcesStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.TryWithResourcesStatement");
  ...
  public final hydra.java.syntax.ResourceSpecification resourceSpecification;

  public final hydra.java.syntax.Block block;

  public final hydra.util.Maybe<hydra.java.syntax.Catches> catches;

  public final hydra.util.Maybe<hydra.java.syntax.Finally> finally_;

  public TryWithResourcesStatement (hydra.java.syntax.ResourceSpecification resourceSpecification, hydra.java.syntax.Block block, hydra.util.Maybe<hydra.java.syntax.Catches> catches, hydra.util.Maybe<hydra.java.syntax.Finally> finally_) {
  ...
  public TryWithResourcesStatement withResourceSpecification(hydra.java.syntax.ResourceSpecification resourceSpecification) {
    return new TryWithResourcesStatement(resourceSpecification, block, catches, finally_);
  }

  public TryWithResourcesStatement withBlock(hydra.java.syntax.Block block) {
    return new TryWithResourcesStatement(resourceSpecification, block, catches, finally_);
  }

  public TryWithResourcesStatement withCatches(hydra.util.Maybe<hydra.java.syntax.Catches> catches) {
    return new TryWithResourcesStatement(resourceSpecification, block, catches, finally_);
  }

  public TryWithResourcesStatement withFinally(hydra.util.Maybe<hydra.java.syntax.Finally> finally_) {
    return new TryWithResourcesStatement(resourceSpecification, block, catches, finally_);
  }
}
