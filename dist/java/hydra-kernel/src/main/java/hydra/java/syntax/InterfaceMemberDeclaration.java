...
public abstract class InterfaceMemberDeclaration implements Serializable, Comparable<InterfaceMemberDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.InterfaceMemberDeclaration");
  ...
  public static final class Constant extends hydra.java.syntax.InterfaceMemberDeclaration implements Serializable {
  ...
  public static final class InterfaceMethod extends hydra.java.syntax.InterfaceMemberDeclaration implements Serializable {
    public final hydra.java.syntax.InterfaceMethodDeclaration value;

    public InterfaceMethod (hydra.java.syntax.InterfaceMethodDeclaration value) {
      this.value = value;
    }
  ...
  public static final class Class_ extends hydra.java.syntax.InterfaceMemberDeclaration implements Serializable {
  ...
  public static final class Interface extends hydra.java.syntax.InterfaceMemberDeclaration implements Serializable {
