...
public class PackageModifier implements Serializable, Comparable<PackageModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.PackageModifier");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.Annotation value;

  public PackageModifier (hydra.java.syntax.Annotation value) {
    this.value = value;
  }
