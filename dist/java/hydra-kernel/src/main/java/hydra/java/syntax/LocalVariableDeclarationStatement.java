...
public class LocalVariableDeclarationStatement implements Serializable, Comparable<LocalVariableDeclarationStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.LocalVariableDeclarationStatement");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.LocalVariableDeclaration value;

  public LocalVariableDeclarationStatement (hydra.java.syntax.LocalVariableDeclaration value) {
    this.value = value;
  }
