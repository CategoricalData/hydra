...
public abstract class ClassModifier implements Serializable, Comparable<ClassModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ClassModifier");
  ...
  public static final class Annotation extends hydra.java.syntax.ClassModifier implements Serializable {
  ...
  public static final class Public extends hydra.java.syntax.ClassModifier implements Serializable {
    public Public () {
  ...
  public static final class Protected extends hydra.java.syntax.ClassModifier implements Serializable {
    public Protected () {
  ...
  public static final class Private extends hydra.java.syntax.ClassModifier implements Serializable {
    public Private () {
  ...
  public static final class Abstract extends hydra.java.syntax.ClassModifier implements Serializable {
    public Abstract () {
  ...
  public static final class Static extends hydra.java.syntax.ClassModifier implements Serializable {
    public Static () {
  ...
  public static final class Final extends hydra.java.syntax.ClassModifier implements Serializable {
    public Final () {
  ...
  public static final class Strictfp extends hydra.java.syntax.ClassModifier implements Serializable {
    public Strictfp () {
