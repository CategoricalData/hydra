...
public class JavaEnvironment implements Serializable, Comparable<JavaEnvironment> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.environment.JavaEnvironment");
   ...
   */
  public final hydra.java.environment.Aliases aliases;
  ...
  public JavaEnvironment (hydra.java.environment.Aliases aliases, hydra.graph.Graph graph) {
  ...
  public JavaEnvironment withAliases(hydra.java.environment.Aliases aliases) {
