...
public class BasicForStatement implements Serializable, Comparable<BasicForStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.BasicForStatement");
  ...
  public BasicForStatement (hydra.java.syntax.ForCond cond, hydra.java.syntax.Statement body) {
    this.cond = cond;
    this.body = body;
  }
  ...
  public BasicForStatement withCond(hydra.java.syntax.ForCond cond) {
    return new BasicForStatement(cond, body);
  }

  public BasicForStatement withBody(hydra.java.syntax.Statement body) {
    return new BasicForStatement(cond, body);
  }
}
