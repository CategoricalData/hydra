...
public class PreDecrementExpression implements Serializable, Comparable<PreDecrementExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.PreDecrementExpression");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.UnaryExpression value;

  public PreDecrementExpression (hydra.java.syntax.UnaryExpression value) {
    this.value = value;
  }
