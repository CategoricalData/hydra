...
public class AnnotatedIdentifier implements Serializable, Comparable<AnnotatedIdentifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.AnnotatedIdentifier");
  ...
  public AnnotatedIdentifier (java.util.List<hydra.java.syntax.Annotation> annotations, hydra.java.syntax.Identifier identifier) {
  ...
  public AnnotatedIdentifier withAnnotations(java.util.List<hydra.java.syntax.Annotation> annotations) {
    return new AnnotatedIdentifier(annotations, identifier);
  }

  public AnnotatedIdentifier withIdentifier(hydra.java.syntax.Identifier identifier) {
    return new AnnotatedIdentifier(annotations, identifier);
  }
}
