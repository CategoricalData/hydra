...
public class IfThenElseStatementNoShortIf implements Serializable, Comparable<IfThenElseStatementNoShortIf> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.IfThenElseStatementNoShortIf");
  ...
  public final hydra.java.syntax.StatementNoShortIf else_;

  public IfThenElseStatementNoShortIf (hydra.util.Maybe<hydra.java.syntax.Expression> cond, hydra.java.syntax.StatementNoShortIf then, hydra.java.syntax.StatementNoShortIf else_) {
    this.cond = cond;
    this.then = then;
    this.else_ = else_;
  }
  ...
  public IfThenElseStatementNoShortIf withCond(hydra.util.Maybe<hydra.java.syntax.Expression> cond) {
    return new IfThenElseStatementNoShortIf(cond, then, else_);
  }

  public IfThenElseStatementNoShortIf withThen(hydra.java.syntax.StatementNoShortIf then) {
    return new IfThenElseStatementNoShortIf(cond, then, else_);
  }

  public IfThenElseStatementNoShortIf withElse(hydra.java.syntax.StatementNoShortIf else_) {
    return new IfThenElseStatementNoShortIf(cond, then, else_);
  }
}
