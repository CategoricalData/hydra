...
public abstract class Result implements Serializable, Comparable<Result> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.Result");
  ...
  public static final class Type extends hydra.java.syntax.Result implements Serializable {
  ...
  public static final class Void_ extends hydra.java.syntax.Result implements Serializable {
    public Void_ () {
