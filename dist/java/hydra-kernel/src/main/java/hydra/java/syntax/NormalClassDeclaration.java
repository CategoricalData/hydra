...
public class NormalClassDeclaration implements Serializable, Comparable<NormalClassDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.NormalClassDeclaration");
  ...
  public final java.util.List<hydra.java.syntax.ClassModifier> modifiers;
  ...
  public final hydra.util.Maybe<hydra.java.syntax.ClassType> extends_;

  public final java.util.List<hydra.java.syntax.InterfaceType> implements_;

  public final hydra.java.syntax.ClassBody body;

  public NormalClassDeclaration (java.util.List<hydra.java.syntax.ClassModifier> modifiers, hydra.java.syntax.TypeIdentifier identifier, java.util.List<hydra.java.syntax.TypeParameter> parameters, hydra.util.Maybe<hydra.java.syntax.ClassType> extends_, java.util.List<hydra.java.syntax.InterfaceType> implements_, hydra.java.syntax.ClassBody body) {
  ...
  public NormalClassDeclaration withModifiers(java.util.List<hydra.java.syntax.ClassModifier> modifiers) {
    return new NormalClassDeclaration(modifiers, identifier, parameters, extends_, implements_, body);
  }

  public NormalClassDeclaration withIdentifier(hydra.java.syntax.TypeIdentifier identifier) {
    return new NormalClassDeclaration(modifiers, identifier, parameters, extends_, implements_, body);
  }

  public NormalClassDeclaration withParameters(java.util.List<hydra.java.syntax.TypeParameter> parameters) {
    return new NormalClassDeclaration(modifiers, identifier, parameters, extends_, implements_, body);
  }

  public NormalClassDeclaration withExtends(hydra.util.Maybe<hydra.java.syntax.ClassType> extends_) {
    return new NormalClassDeclaration(modifiers, identifier, parameters, extends_, implements_, body);
  }

  public NormalClassDeclaration withImplements(java.util.List<hydra.java.syntax.InterfaceType> implements_) {
    return new NormalClassDeclaration(modifiers, identifier, parameters, extends_, implements_, body);
  }

  public NormalClassDeclaration withBody(hydra.java.syntax.ClassBody body) {
    return new NormalClassDeclaration(modifiers, identifier, parameters, extends_, implements_, body);
  }
}
