...
public abstract class ClassMemberDeclaration implements Serializable, Comparable<ClassMemberDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ClassMemberDeclaration");
  ...
  public static final class Field extends hydra.java.syntax.ClassMemberDeclaration implements Serializable {
    public final hydra.java.syntax.FieldDeclaration value;

    public Field (hydra.java.syntax.FieldDeclaration value) {
      this.value = value;
    }
  ...
  public static final class Method extends hydra.java.syntax.ClassMemberDeclaration implements Serializable {
    public final hydra.java.syntax.MethodDeclaration value;

    public Method (hydra.java.syntax.MethodDeclaration value) {
      this.value = value;
    }
  ...
  public static final class Class_ extends hydra.java.syntax.ClassMemberDeclaration implements Serializable {
  ...
  public static final class Interface extends hydra.java.syntax.ClassMemberDeclaration implements Serializable {
  ...
  public static final class None extends hydra.java.syntax.ClassMemberDeclaration implements Serializable {
    public None () {
