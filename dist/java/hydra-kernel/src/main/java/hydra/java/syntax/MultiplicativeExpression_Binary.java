...
public class MultiplicativeExpression_Binary implements Serializable, Comparable<MultiplicativeExpression_Binary> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.MultiplicativeExpression_Binary");
  ...
  public final hydra.java.syntax.MultiplicativeExpression lhs;

  public final hydra.java.syntax.UnaryExpression rhs;

  public MultiplicativeExpression_Binary (hydra.java.syntax.MultiplicativeExpression lhs, hydra.java.syntax.UnaryExpression rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public MultiplicativeExpression_Binary withLhs(hydra.java.syntax.MultiplicativeExpression lhs) {
    return new MultiplicativeExpression_Binary(lhs, rhs);
  }

  public MultiplicativeExpression_Binary withRhs(hydra.java.syntax.UnaryExpression rhs) {
    return new MultiplicativeExpression_Binary(lhs, rhs);
  }
}
