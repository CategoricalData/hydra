...
public abstract class ConstructorModifier implements Serializable, Comparable<ConstructorModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ConstructorModifier");
  ...
  public static final class Annotation extends hydra.java.syntax.ConstructorModifier implements Serializable {
  ...
  public static final class Public extends hydra.java.syntax.ConstructorModifier implements Serializable {
    public Public () {
  ...
  public static final class Protected extends hydra.java.syntax.ConstructorModifier implements Serializable {
    public Protected () {
  ...
  public static final class Private extends hydra.java.syntax.ConstructorModifier implements Serializable {
    public Private () {
