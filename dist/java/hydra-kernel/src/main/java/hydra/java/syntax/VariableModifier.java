...
public abstract class VariableModifier implements Serializable, Comparable<VariableModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.VariableModifier");
  ...
  public static final class Annotation extends hydra.java.syntax.VariableModifier implements Serializable {
  ...
  public static final class Final extends hydra.java.syntax.VariableModifier implements Serializable {
    public Final () {
