...
public abstract class BlockStatement implements Serializable, Comparable<BlockStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.BlockStatement");
  ...
  public static final class LocalVariableDeclaration extends hydra.java.syntax.BlockStatement implements Serializable {
    public final hydra.java.syntax.LocalVariableDeclarationStatement value;

    public LocalVariableDeclaration (hydra.java.syntax.LocalVariableDeclarationStatement value) {
      this.value = value;
    }
  ...
  public static final class Class_ extends hydra.java.syntax.BlockStatement implements Serializable {
  ...
  public static final class Statement extends hydra.java.syntax.BlockStatement implements Serializable {
    public final hydra.java.syntax.Statement value;

    public Statement (hydra.java.syntax.Statement value) {
      this.value = value;
    }
