...
public interface Language {
  static hydra.coders.Language javaLanguage() {
    ...
    return new hydra.coders.Language(new hydra.coders.LanguageName("hydra.java"), new hydra.coders.LanguageConstraints(eliminationVariants.get(), literalVariants.get(), floatTypes.get(), functionVariants.get(), integerTypes.get(), termVariants.get(), typeVariants.get(), p0 -> hydra.java.Language.<hydra.core.Type>javaLanguage_typePredicate(p0)));
  }
