...
public class ArrayCreationExpression_ClassOrInterface implements Serializable, Comparable<ArrayCreationExpression_ClassOrInterface> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ArrayCreationExpression_ClassOrInterface");
  ...
  public final java.util.List<hydra.java.syntax.DimExpr> dimExprs;

  public final hydra.util.Maybe<hydra.java.syntax.Dims> dims;

  public ArrayCreationExpression_ClassOrInterface (hydra.java.syntax.ClassOrInterfaceType type, java.util.List<hydra.java.syntax.DimExpr> dimExprs, hydra.util.Maybe<hydra.java.syntax.Dims> dims) {
    this.type = type;
  ...
  public ArrayCreationExpression_ClassOrInterface withType(hydra.java.syntax.ClassOrInterfaceType type) {
    return new ArrayCreationExpression_ClassOrInterface(type, dimExprs, dims);
  }

  public ArrayCreationExpression_ClassOrInterface withDimExprs(java.util.List<hydra.java.syntax.DimExpr> dimExprs) {
    return new ArrayCreationExpression_ClassOrInterface(type, dimExprs, dims);
  }

  public ArrayCreationExpression_ClassOrInterface withDims(hydra.util.Maybe<hydra.java.syntax.Dims> dims) {
    return new ArrayCreationExpression_ClassOrInterface(type, dimExprs, dims);
  }
}
