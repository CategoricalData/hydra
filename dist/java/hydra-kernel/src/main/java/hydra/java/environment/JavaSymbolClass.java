...
package hydra.java.environment;
...
public abstract class JavaSymbolClass implements Serializable, Comparable<JavaSymbolClass> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.environment.JavaSymbolClass");
   ...
   * A constant value
   */
  public static final class Constant extends hydra.java.environment.JavaSymbolClass implements Serializable {
    public Constant () {
   ...
   */
  public static final class NullaryFunction extends hydra.java.environment.JavaSymbolClass implements Serializable {
   ...
   */
  public static final class HoistedLambda extends hydra.java.environment.JavaSymbolClass implements Serializable {
   ...
   */
  public static final class UnaryFunction extends hydra.java.environment.JavaSymbolClass implements Serializable {
   ...
   * A local variable
   */
  public static final class LocalVariable extends hydra.java.environment.JavaSymbolClass implements Serializable {
