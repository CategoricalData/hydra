...
public class TryStatement_WithFinally implements Serializable, Comparable<TryStatement_WithFinally> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.TryStatement_WithFinally");
  ...
  public final hydra.java.syntax.Finally finally_;

  public TryStatement_WithFinally (hydra.java.syntax.Block block, hydra.util.Maybe<hydra.java.syntax.Catches> catches, hydra.java.syntax.Finally finally_) {
    this.block = block;
  ...
  public TryStatement_WithFinally withBlock(hydra.java.syntax.Block block) {
    return new TryStatement_WithFinally(block, catches, finally_);
  }

  public TryStatement_WithFinally withCatches(hydra.util.Maybe<hydra.java.syntax.Catches> catches) {
    return new TryStatement_WithFinally(block, catches, finally_);
  }

  public TryStatement_WithFinally withFinally(hydra.java.syntax.Finally finally_) {
    return new TryStatement_WithFinally(block, catches, finally_);
  }
}
