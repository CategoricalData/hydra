...
public abstract class FloatingPointType implements Serializable, Comparable<FloatingPointType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.FloatingPointType");
  ...
  public static final class Float_ extends hydra.java.syntax.FloatingPointType implements Serializable {
    public Float_ () {
  ...
  public static final class Double_ extends hydra.java.syntax.FloatingPointType implements Serializable {
    public Double_ () {
