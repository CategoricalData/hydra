...
public abstract class NumericTypeArray implements Serializable, Comparable<NumericTypeArray> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.NumericTypeArray");
  ...
  public static final class Simple extends hydra.java.syntax.NumericTypeArray implements Serializable {
    public final hydra.java.syntax.NumericType value;

    public Simple (hydra.java.syntax.NumericType value) {
      this.value = value;
    }
  ...
  public static final class Array extends hydra.java.syntax.NumericTypeArray implements Serializable {
    public final hydra.java.syntax.NumericTypeArray value;

    public Array (hydra.java.syntax.NumericTypeArray value) {
      this.value = value;
    }
