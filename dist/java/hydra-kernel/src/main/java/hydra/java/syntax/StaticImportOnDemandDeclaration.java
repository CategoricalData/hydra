...
public class StaticImportOnDemandDeclaration implements Serializable, Comparable<StaticImportOnDemandDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.StaticImportOnDemandDeclaration");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.TypeName value;

  public StaticImportOnDemandDeclaration (hydra.java.syntax.TypeName value) {
    this.value = value;
  }
