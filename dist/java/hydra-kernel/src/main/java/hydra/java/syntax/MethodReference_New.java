...
public class MethodReference_New implements Serializable, Comparable<MethodReference_New> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.MethodReference_New");
  ...
  public final hydra.java.syntax.ClassType classType;

  public final java.util.List<hydra.java.syntax.TypeArgument> typeArguments;

  public MethodReference_New (hydra.java.syntax.ClassType classType, java.util.List<hydra.java.syntax.TypeArgument> typeArguments) {
  ...
  public MethodReference_New withClassType(hydra.java.syntax.ClassType classType) {
    return new MethodReference_New(classType, typeArguments);
  }

  public MethodReference_New withTypeArguments(java.util.List<hydra.java.syntax.TypeArgument> typeArguments) {
    return new MethodReference_New(classType, typeArguments);
  }
}
