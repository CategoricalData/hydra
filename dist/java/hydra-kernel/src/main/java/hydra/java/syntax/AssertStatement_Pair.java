...
public class AssertStatement_Pair implements Serializable, Comparable<AssertStatement_Pair> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.AssertStatement_Pair");
  ...
  public final hydra.java.syntax.Expression first;

  public final hydra.java.syntax.Expression second;

  public AssertStatement_Pair (hydra.java.syntax.Expression first, hydra.java.syntax.Expression second) {
    this.first = first;
    this.second = second;
  }
  ...
  public AssertStatement_Pair withFirst(hydra.java.syntax.Expression first) {
    return new AssertStatement_Pair(first, second);
  }

  public AssertStatement_Pair withSecond(hydra.java.syntax.Expression second) {
    return new AssertStatement_Pair(first, second);
  }
}
