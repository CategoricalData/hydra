...
public class MarkerAnnotation implements Serializable, Comparable<MarkerAnnotation> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.MarkerAnnotation");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.TypeName value;

  public MarkerAnnotation (hydra.java.syntax.TypeName value) {
    this.value = value;
  }
