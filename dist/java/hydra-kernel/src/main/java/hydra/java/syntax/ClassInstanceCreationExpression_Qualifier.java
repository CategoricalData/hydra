...
public abstract class ClassInstanceCreationExpression_Qualifier implements Serializable, Comparable<ClassInstanceCreationExpression_Qualifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ClassInstanceCreationExpression_Qualifier");
  ...
  public static final class Expression extends hydra.java.syntax.ClassInstanceCreationExpression_Qualifier implements Serializable {
  ...
  public static final class Primary extends hydra.java.syntax.ClassInstanceCreationExpression_Qualifier implements Serializable {
