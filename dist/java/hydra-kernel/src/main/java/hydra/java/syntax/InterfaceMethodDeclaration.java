...
public class InterfaceMethodDeclaration implements Serializable, Comparable<InterfaceMethodDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.InterfaceMethodDeclaration");
  ...
  public final java.util.List<hydra.java.syntax.InterfaceMethodModifier> modifiers;

  public final hydra.java.syntax.MethodHeader header;

  public final hydra.java.syntax.MethodBody body;

  public InterfaceMethodDeclaration (java.util.List<hydra.java.syntax.InterfaceMethodModifier> modifiers, hydra.java.syntax.MethodHeader header, hydra.java.syntax.MethodBody body) {
  ...
  public InterfaceMethodDeclaration withModifiers(java.util.List<hydra.java.syntax.InterfaceMethodModifier> modifiers) {
    return new InterfaceMethodDeclaration(modifiers, header, body);
  }

  public InterfaceMethodDeclaration withHeader(hydra.java.syntax.MethodHeader header) {
    return new InterfaceMethodDeclaration(modifiers, header, body);
  }

  public InterfaceMethodDeclaration withBody(hydra.java.syntax.MethodBody body) {
    return new InterfaceMethodDeclaration(modifiers, header, body);
  }
}
