...
public abstract class ArrayAccess_Variant implements Serializable, Comparable<ArrayAccess_Variant> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ArrayAccess_Variant");
  ...
  public static final class Name extends hydra.java.syntax.ArrayAccess_Variant implements Serializable {
  ...
  public static final class Primary extends hydra.java.syntax.ArrayAccess_Variant implements Serializable {
    public final hydra.java.syntax.PrimaryNoNewArrayExpression value;

    public Primary (hydra.java.syntax.PrimaryNoNewArrayExpression value) {
      this.value = value;
    }
