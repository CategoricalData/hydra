...
public class ModularCompilationUnit implements Serializable, Comparable<ModularCompilationUnit> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ModularCompilationUnit");
  ...
  public final hydra.java.syntax.ModuleDeclaration module;

  public ModularCompilationUnit (java.util.List<hydra.java.syntax.ImportDeclaration> imports, hydra.java.syntax.ModuleDeclaration module) {
  ...
  public ModularCompilationUnit withImports(java.util.List<hydra.java.syntax.ImportDeclaration> imports) {
    return new ModularCompilationUnit(imports, module);
  }

  public ModularCompilationUnit withModule(hydra.java.syntax.ModuleDeclaration module) {
    return new ModularCompilationUnit(imports, module);
  }
}
