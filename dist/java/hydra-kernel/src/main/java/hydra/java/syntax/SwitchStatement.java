...
public class SwitchStatement implements Serializable, Comparable<SwitchStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.SwitchStatement");
  ...
  public final hydra.java.syntax.Expression cond;

  public final hydra.java.syntax.SwitchBlock block;

  public SwitchStatement (hydra.java.syntax.Expression cond, hydra.java.syntax.SwitchBlock block) {
    this.cond = cond;
    this.block = block;
  }
  ...
  public SwitchStatement withCond(hydra.java.syntax.Expression cond) {
    return new SwitchStatement(cond, block);
  }

  public SwitchStatement withBlock(hydra.java.syntax.SwitchBlock block) {
    return new SwitchStatement(cond, block);
  }
}
