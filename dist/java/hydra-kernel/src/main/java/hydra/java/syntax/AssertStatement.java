...
public abstract class AssertStatement implements Serializable, Comparable<AssertStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.AssertStatement");
  ...
  public static final class Single extends hydra.java.syntax.AssertStatement implements Serializable {
    public final hydra.java.syntax.Expression value;

    public Single (hydra.java.syntax.Expression value) {
      this.value = value;
    }
  ...
  public static final class Pair extends hydra.java.syntax.AssertStatement implements Serializable {
    public final hydra.java.syntax.AssertStatement_Pair value;

    public Pair (hydra.java.syntax.AssertStatement_Pair value) {
      this.value = value;
    }
