...
public abstract class NumericType implements Serializable, Comparable<NumericType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.NumericType");
  ...
  public static final class Integral extends hydra.java.syntax.NumericType implements Serializable {
    public final hydra.java.syntax.IntegralType value;

    public Integral (hydra.java.syntax.IntegralType value) {
      this.value = value;
    }
  ...
  public static final class FloatingPoint extends hydra.java.syntax.NumericType implements Serializable {
    public final hydra.java.syntax.FloatingPointType value;

    public FloatingPoint (hydra.java.syntax.FloatingPointType value) {
      this.value = value;
    }
