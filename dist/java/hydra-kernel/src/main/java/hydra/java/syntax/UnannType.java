...
public class UnannType implements Serializable, Comparable<UnannType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.UnannType");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.java.syntax.Type value;

  public UnannType (hydra.java.syntax.Type value) {
    this.value = value;
  }
