...
public class MethodDeclarator implements Serializable, Comparable<MethodDeclarator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.MethodDeclarator");
  ...
  public MethodDeclarator (hydra.java.syntax.Identifier identifier, hydra.util.Maybe<hydra.java.syntax.ReceiverParameter> receiverParameter, java.util.List<hydra.java.syntax.FormalParameter> formalParameters) {
  ...
  public MethodDeclarator withIdentifier(hydra.java.syntax.Identifier identifier) {
    return new MethodDeclarator(identifier, receiverParameter, formalParameters);
  }

  public MethodDeclarator withReceiverParameter(hydra.util.Maybe<hydra.java.syntax.ReceiverParameter> receiverParameter) {
    return new MethodDeclarator(identifier, receiverParameter, formalParameters);
  }

  public MethodDeclarator withFormalParameters(java.util.List<hydra.java.syntax.FormalParameter> formalParameters) {
    return new MethodDeclarator(identifier, receiverParameter, formalParameters);
  }
}
