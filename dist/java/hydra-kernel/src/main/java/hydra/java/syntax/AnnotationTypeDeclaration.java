...
public class AnnotationTypeDeclaration implements Serializable, Comparable<AnnotationTypeDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.AnnotationTypeDeclaration");
  ...
  public final hydra.java.syntax.AnnotationTypeBody body;

  public AnnotationTypeDeclaration (java.util.List<hydra.java.syntax.InterfaceModifier> modifiers, hydra.java.syntax.TypeIdentifier identifier, hydra.java.syntax.AnnotationTypeBody body) {
  ...
  public AnnotationTypeDeclaration withModifiers(java.util.List<hydra.java.syntax.InterfaceModifier> modifiers) {
    return new AnnotationTypeDeclaration(modifiers, identifier, body);
  }

  public AnnotationTypeDeclaration withIdentifier(hydra.java.syntax.TypeIdentifier identifier) {
    return new AnnotationTypeDeclaration(modifiers, identifier, body);
  }

  public AnnotationTypeDeclaration withBody(hydra.java.syntax.AnnotationTypeBody body) {
    return new AnnotationTypeDeclaration(modifiers, identifier, body);
  }
}
