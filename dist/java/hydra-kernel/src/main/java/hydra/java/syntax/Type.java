...
public abstract class Type implements Serializable, Comparable<Type> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.Type");
  ...
  public static final class Primitive extends hydra.java.syntax.Type implements Serializable {
  ...
  public static final class Reference extends hydra.java.syntax.Type implements Serializable {
