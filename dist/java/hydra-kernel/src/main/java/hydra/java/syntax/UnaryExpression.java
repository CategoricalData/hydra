...
public abstract class UnaryExpression implements Serializable, Comparable<UnaryExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.UnaryExpression");
  ...
  public static final class PreIncrement extends hydra.java.syntax.UnaryExpression implements Serializable {
  ...
  public static final class PreDecrement extends hydra.java.syntax.UnaryExpression implements Serializable {
  ...
  public static final class Plus extends hydra.java.syntax.UnaryExpression implements Serializable {
    public final hydra.java.syntax.UnaryExpression value;

    public Plus (hydra.java.syntax.UnaryExpression value) {
      this.value = value;
    }
  ...
  public static final class Minus extends hydra.java.syntax.UnaryExpression implements Serializable {
    public final hydra.java.syntax.UnaryExpression value;

    public Minus (hydra.java.syntax.UnaryExpression value) {
      this.value = value;
    }
  ...
  public static final class Other extends hydra.java.syntax.UnaryExpression implements Serializable {
    public final hydra.java.syntax.UnaryExpressionNotPlusMinus value;

    public Other (hydra.java.syntax.UnaryExpressionNotPlusMinus value) {
      this.value = value;
    }
