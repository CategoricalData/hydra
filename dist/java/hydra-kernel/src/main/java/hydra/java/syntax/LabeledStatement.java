...
public class LabeledStatement implements Serializable, Comparable<LabeledStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.LabeledStatement");
  ...
  public LabeledStatement (hydra.java.syntax.Identifier identifier, hydra.java.syntax.Statement statement) {
  ...
  public LabeledStatement withIdentifier(hydra.java.syntax.Identifier identifier) {
    return new LabeledStatement(identifier, statement);
  }

  public LabeledStatement withStatement(hydra.java.syntax.Statement statement) {
    return new LabeledStatement(identifier, statement);
  }
}
