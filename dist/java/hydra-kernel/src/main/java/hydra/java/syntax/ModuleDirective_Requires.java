...
public class ModuleDirective_Requires implements Serializable, Comparable<ModuleDirective_Requires> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.java.syntax.ModuleDirective_Requires");
  ...
  public final java.util.List<hydra.java.syntax.RequiresModifier> modifiers;

  public final hydra.java.syntax.ModuleName module;

  public ModuleDirective_Requires (java.util.List<hydra.java.syntax.RequiresModifier> modifiers, hydra.java.syntax.ModuleName module) {
  ...
  public ModuleDirective_Requires withModifiers(java.util.List<hydra.java.syntax.RequiresModifier> modifiers) {
    return new ModuleDirective_Requires(modifiers, module);
  }

  public ModuleDirective_Requires withModule(hydra.java.syntax.ModuleName module) {
    return new ModuleDirective_Requires(modifiers, module);
  }
}
