  ...
  static hydra.core.Term coderDirection(hydra.coders.CoderDirection v1) {
    return (v1).accept(new hydra.coders.CoderDirection.PartialVisitor<>() {
      ...
      public hydra.core.Term visit(hydra.coders.CoderDirection.Encode y) {
        return new hydra.core.Term.Inject(new hydra.core.Injection(new hydra.core.Name("hydra.coders.CoderDirection"), new hydra.core.Field(new hydra.core.Name("encode"), new hydra.core.Term.Unit())));
      }

      @Override
      public hydra.core.Term visit(hydra.coders.CoderDirection.Decode y) {
        return new hydra.core.Term.Inject(new hydra.core.Injection(new hydra.core.Name("hydra.coders.CoderDirection"), new hydra.core.Field(new hydra.core.Name("decode"), new hydra.core.Term.Unit())));
      }
    });
  }
  ...
  static hydra.core.Term traversalOrder(hydra.coders.TraversalOrder v1) {
    return (v1).accept(new hydra.coders.TraversalOrder.PartialVisitor<>() {
      ...
      public hydra.core.Term visit(hydra.coders.TraversalOrder.Pre y) {
        return new hydra.core.Term.Inject(new hydra.core.Injection(new hydra.core.Name("hydra.coders.TraversalOrder"), new hydra.core.Field(new hydra.core.Name("pre"), new hydra.core.Term.Unit())));
      }

      @Override
      public hydra.core.Term visit(hydra.coders.TraversalOrder.Post y) {
        return new hydra.core.Term.Inject(new hydra.core.Injection(new hydra.core.Name("hydra.coders.TraversalOrder"), new hydra.core.Field(new hydra.core.Name("post"), new hydra.core.Term.Unit())));
      }
    });
  }
}
