...
public interface Parsers {
  ...
  static <T0> hydra.parsing.Parser<java.util.List<T0>> many(hydra.parsing.Parser<T0> p) {
    return hydra.Parsers.<java.util.List<T0>>alt(
      hydra.Parsers.<T0>some(p),
      hydra.Parsers.<java.util.List<T0>>pure((java.util.List<T0>) (java.util.Collections.<T0>emptyList())));
  }
  ...
  static <T0, T1> hydra.parsing.Parser<java.util.List<T0>> sepBy1(hydra.parsing.Parser<T0> p, hydra.parsing.Parser<T1> sep) {
    return hydra.Parsers.<T0, java.util.List<T0>>bind(
      p,
      (java.util.function.Function<T0, hydra.parsing.Parser<java.util.List<T0>>>) (x -> hydra.Parsers.<java.util.List<T0>, java.util.List<T0>>bind(
        hydra.Parsers.<T0>many(hydra.Parsers.<T1, T0>bind(
          sep,
          (java.util.function.Function<T1, hydra.parsing.Parser<T0>>) (ignored -> p))),
        (java.util.function.Function<java.util.List<T0>, hydra.parsing.Parser<java.util.List<T0>>>) (xs -> hydra.Parsers.<java.util.List<T0>>pure(hydra.lib.lists.Cons.apply(
          x,
          xs))))));
  }
