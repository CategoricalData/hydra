...
public class Data_Tuple implements Serializable, Comparable<Data_Tuple> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_Tuple");
  ...
  public Data_Tuple (java.util.List<hydra.scala.syntax.Data> args) {
    this.args = args;
  }
