...
public class Decl_Val implements Serializable, Comparable<Decl_Val> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Decl_Val");
  ...
  public Decl_Val (java.util.List<hydra.scala.syntax.Mod> mods, java.util.List<hydra.scala.syntax.Pat> pats, hydra.scala.syntax.Type decltpe) {
    this.mods = mods;
    this.pats = pats;
  ...
  public Decl_Val withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Decl_Val(mods, pats, decltpe);
  }

  public Decl_Val withPats(java.util.List<hydra.scala.syntax.Pat> pats) {
    return new Decl_Val(mods, pats, decltpe);
  }

  public Decl_Val withDecltpe(hydra.scala.syntax.Type decltpe) {
    return new Decl_Val(mods, pats, decltpe);
  }
}
