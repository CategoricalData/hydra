...
public class Data_Ascribe implements Serializable, Comparable<Data_Ascribe> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_Ascribe");
  ...
  public Data_Ascribe (hydra.scala.syntax.Data expr, hydra.scala.syntax.Type tpe) {
    this.expr = expr;
    this.tpe = tpe;
  }
  ...
  public Data_Ascribe withExpr(hydra.scala.syntax.Data expr) {
    return new Data_Ascribe(expr, tpe);
  }

  public Data_Ascribe withTpe(hydra.scala.syntax.Type tpe) {
    return new Data_Ascribe(expr, tpe);
  }
}
