...
public class Pkg implements Serializable, Comparable<Pkg> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Pkg");
  ...
  public Pkg (hydra.scala.syntax.Data_Name name, hydra.scala.syntax.Data_Ref ref, java.util.List<hydra.scala.syntax.Stat> stats) {
    this.name = name;
    this.ref = ref;
    this.stats = stats;
  }
  ...
  public Pkg withName(hydra.scala.syntax.Data_Name name) {
    return new Pkg(name, ref, stats);
  }

  public Pkg withRef(hydra.scala.syntax.Data_Ref ref) {
    return new Pkg(name, ref, stats);
  }

  public Pkg withStats(java.util.List<hydra.scala.syntax.Stat> stats) {
    return new Pkg(name, ref, stats);
  }
}
