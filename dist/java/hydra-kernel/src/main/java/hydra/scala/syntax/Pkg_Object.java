...
public class Pkg_Object implements Serializable, Comparable<Pkg_Object> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Pkg_Object");
  ...
  public Pkg_Object (java.util.List<hydra.scala.syntax.Mod> mods, hydra.scala.syntax.Data_Name name, hydra.scala.syntax.Template template) {
    this.mods = mods;
    this.name = name;
  ...
  public Pkg_Object withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Pkg_Object(mods, name, template);
  }

  public Pkg_Object withName(hydra.scala.syntax.Data_Name name) {
    return new Pkg_Object(mods, name, template);
  }

  public Pkg_Object withTemplate(hydra.scala.syntax.Template template) {
    return new Pkg_Object(mods, name, template);
  }
}
