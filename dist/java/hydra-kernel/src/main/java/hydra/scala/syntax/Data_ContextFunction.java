...
public class Data_ContextFunction implements Serializable, Comparable<Data_ContextFunction> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_ContextFunction");
  ...
  public Data_ContextFunction (java.util.List<hydra.scala.syntax.Data_Param> params, hydra.scala.syntax.Data body) {
    this.params = params;
    this.body = body;
  }
  ...
  public Data_ContextFunction withParams(java.util.List<hydra.scala.syntax.Data_Param> params) {
    return new Data_ContextFunction(params, body);
  }

  public Data_ContextFunction withBody(hydra.scala.syntax.Data body) {
    return new Data_ContextFunction(params, body);
  }
}
