...
public class Pat_Extract implements Serializable, Comparable<Pat_Extract> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Pat_Extract");
  ...
  public Pat_Extract (hydra.scala.syntax.Data fun, java.util.List<hydra.scala.syntax.Pat> args) {
    this.fun = fun;
    this.args = args;
  }
  ...
  public Pat_Extract withFun(hydra.scala.syntax.Data fun) {
    return new Pat_Extract(fun, args);
  }

  public Pat_Extract withArgs(java.util.List<hydra.scala.syntax.Pat> args) {
    return new Pat_Extract(fun, args);
  }
}
