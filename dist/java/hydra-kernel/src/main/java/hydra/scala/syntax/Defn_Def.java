...
public class Defn_Def implements Serializable, Comparable<Defn_Def> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Defn_Def");
  ...
  public Defn_Def (java.util.List<hydra.scala.syntax.Mod> mods, hydra.scala.syntax.Data_Name name, java.util.List<hydra.scala.syntax.Type_Param> tparams, java.util.List<java.util.List<hydra.scala.syntax.Data_Param>> paramss, hydra.util.Maybe<hydra.scala.syntax.Type> decltpe, hydra.scala.syntax.Data body) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Def withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withName(hydra.scala.syntax.Data_Name name) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withTparams(java.util.List<hydra.scala.syntax.Type_Param> tparams) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withParamss(java.util.List<java.util.List<hydra.scala.syntax.Data_Param>> paramss) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withDecltpe(hydra.util.Maybe<hydra.scala.syntax.Type> decltpe) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withBody(hydra.scala.syntax.Data body) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }
}
