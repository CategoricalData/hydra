...
public class Type_Or implements Serializable, Comparable<Type_Or> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Type_Or");
  ...
  public Type_Or (hydra.scala.syntax.Type lhs, hydra.scala.syntax.Type rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public Type_Or withLhs(hydra.scala.syntax.Type lhs) {
    return new Type_Or(lhs, rhs);
  }

  public Type_Or withRhs(hydra.scala.syntax.Type rhs) {
    return new Type_Or(lhs, rhs);
  }
}
