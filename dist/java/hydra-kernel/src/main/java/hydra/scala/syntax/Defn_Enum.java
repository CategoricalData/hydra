...
public class Defn_Enum implements Serializable, Comparable<Defn_Enum> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Defn_Enum");
  ...
  public Defn_Enum (java.util.List<hydra.scala.syntax.Mod> mods, hydra.scala.syntax.Type_Name name, java.util.List<hydra.scala.syntax.Type_Param> tparams, hydra.scala.syntax.Ctor_Primary ctor, hydra.scala.syntax.Template template) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Enum withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }

  public Defn_Enum withName(hydra.scala.syntax.Type_Name name) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }

  public Defn_Enum withTparams(java.util.List<hydra.scala.syntax.Type_Param> tparams) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }

  public Defn_Enum withCtor(hydra.scala.syntax.Ctor_Primary ctor) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }

  public Defn_Enum withTemplate(hydra.scala.syntax.Template template) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }
}
