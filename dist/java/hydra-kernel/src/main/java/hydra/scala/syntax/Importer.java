...
public class Importer implements Serializable, Comparable<Importer> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Importer");
  ...
  public final java.util.List<hydra.scala.syntax.Importee> importees;

  public Importer (hydra.scala.syntax.Data_Ref ref, java.util.List<hydra.scala.syntax.Importee> importees) {
    this.ref = ref;
  ...
  public Importer withRef(hydra.scala.syntax.Data_Ref ref) {
    return new Importer(ref, importees);
  }

  public Importer withImportees(java.util.List<hydra.scala.syntax.Importee> importees) {
    return new Importer(ref, importees);
  }
}
