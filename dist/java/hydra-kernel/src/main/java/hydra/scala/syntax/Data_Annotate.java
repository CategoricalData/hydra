...
public class Data_Annotate implements Serializable, Comparable<Data_Annotate> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_Annotate");
  ...
  public Data_Annotate (hydra.scala.syntax.Data expr, java.util.List<hydra.scala.syntax.Mod_Annot> annots) {
    this.expr = expr;
    this.annots = annots;
  }
  ...
  public Data_Annotate withExpr(hydra.scala.syntax.Data expr) {
    return new Data_Annotate(expr, annots);
  }

  public Data_Annotate withAnnots(java.util.List<hydra.scala.syntax.Mod_Annot> annots) {
    return new Data_Annotate(expr, annots);
  }
}
