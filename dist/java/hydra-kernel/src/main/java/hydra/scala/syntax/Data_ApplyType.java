...
public class Data_ApplyType implements Serializable, Comparable<Data_ApplyType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_ApplyType");
  ...
  public Data_ApplyType (hydra.scala.syntax.Data lhs, hydra.scala.syntax.Data_Name op, java.util.List<hydra.scala.syntax.Type> targs, java.util.List<hydra.scala.syntax.Data> args) {
    this.lhs = lhs;
    this.op = op;
    this.targs = targs;
    this.args = args;
  ...
  public Data_ApplyType withLhs(hydra.scala.syntax.Data lhs) {
    return new Data_ApplyType(lhs, op, targs, args);
  }

  public Data_ApplyType withOp(hydra.scala.syntax.Data_Name op) {
    return new Data_ApplyType(lhs, op, targs, args);
  }

  public Data_ApplyType withTargs(java.util.List<hydra.scala.syntax.Type> targs) {
    return new Data_ApplyType(lhs, op, targs, args);
  }

  public Data_ApplyType withArgs(java.util.List<hydra.scala.syntax.Data> args) {
    return new Data_ApplyType(lhs, op, targs, args);
  }
}
