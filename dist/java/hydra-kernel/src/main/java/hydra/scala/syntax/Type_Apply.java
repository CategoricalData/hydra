...
public class Type_Apply implements Serializable, Comparable<Type_Apply> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Type_Apply");
  ...
  public final java.util.List<hydra.scala.syntax.Type> args;

  public Type_Apply (hydra.scala.syntax.Type tpe, java.util.List<hydra.scala.syntax.Type> args) {
    this.tpe = tpe;
    this.args = args;
  }
  ...
  public Type_Apply withTpe(hydra.scala.syntax.Type tpe) {
    return new Type_Apply(tpe, args);
  }

  public Type_Apply withArgs(java.util.List<hydra.scala.syntax.Type> args) {
    return new Type_Apply(tpe, args);
  }
}
