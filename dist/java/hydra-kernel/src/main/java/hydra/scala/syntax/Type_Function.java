...
public class Type_Function implements Serializable, Comparable<Type_Function> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Type_Function");
  ...
  public Type_Function (java.util.List<hydra.scala.syntax.Type> params, hydra.scala.syntax.Type res) {
    this.params = params;
    this.res = res;
  }
  ...
  public Type_Function withParams(java.util.List<hydra.scala.syntax.Type> params) {
    return new Type_Function(params, res);
  }

  public Type_Function withRes(hydra.scala.syntax.Type res) {
    return new Type_Function(params, res);
  }
}
