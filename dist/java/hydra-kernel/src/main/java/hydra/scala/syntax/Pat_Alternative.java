...
public class Pat_Alternative implements Serializable, Comparable<Pat_Alternative> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Pat_Alternative");
  ...
  public final hydra.scala.syntax.Pat rhs;

  public Pat_Alternative (hydra.scala.syntax.Pat lhs, hydra.scala.syntax.Pat rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public Pat_Alternative withLhs(hydra.scala.syntax.Pat lhs) {
    return new Pat_Alternative(lhs, rhs);
  }

  public Pat_Alternative withRhs(hydra.scala.syntax.Pat rhs) {
    return new Pat_Alternative(lhs, rhs);
  }
}
