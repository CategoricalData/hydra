...
public class Defn_Var implements Serializable, Comparable<Defn_Var> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Defn_Var");
  ...
  public final hydra.util.Maybe<hydra.scala.syntax.Data> rhs;

  public Defn_Var (java.util.List<hydra.scala.syntax.Mod> mods, java.util.List<hydra.scala.syntax.Pat> pats, hydra.scala.syntax.Type decltpe, hydra.util.Maybe<hydra.scala.syntax.Data> rhs) {
    this.mods = mods;
    this.pats = pats;
  ...
  public Defn_Var withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }

  public Defn_Var withPats(java.util.List<hydra.scala.syntax.Pat> pats) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }

  public Defn_Var withDecltpe(hydra.scala.syntax.Type decltpe) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }

  public Defn_Var withRhs(hydra.util.Maybe<hydra.scala.syntax.Data> rhs) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }
}
