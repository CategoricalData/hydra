...
public class Importee_Rename implements Serializable, Comparable<Importee_Rename> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Importee_Rename");
  ...
  public final hydra.scala.syntax.Name rename;

  public Importee_Rename (hydra.scala.syntax.Name name, hydra.scala.syntax.Name rename) {
    this.name = name;
    this.rename = rename;
  }
  ...
  public Importee_Rename withName(hydra.scala.syntax.Name name) {
    return new Importee_Rename(name, rename);
  }

  public Importee_Rename withRename(hydra.scala.syntax.Name rename) {
    return new Importee_Rename(name, rename);
  }
}
