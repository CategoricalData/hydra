...
public class Data_SplicedMacroExpr implements Serializable, Comparable<Data_SplicedMacroExpr> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_SplicedMacroExpr");

  public static final hydra.core.Name BODY = new hydra.core.Name("body");

  public final hydra.scala.syntax.Data body;

  public Data_SplicedMacroExpr (hydra.scala.syntax.Data body) {
    this.body = body;
  }
