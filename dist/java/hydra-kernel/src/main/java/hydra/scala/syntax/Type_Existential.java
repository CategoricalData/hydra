...
public class Type_Existential implements Serializable, Comparable<Type_Existential> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Type_Existential");
  ...
  public Type_Existential (hydra.scala.syntax.Type tpe, java.util.List<hydra.scala.syntax.Stat> stats) {
    this.tpe = tpe;
    this.stats = stats;
  }
  ...
  public Type_Existential withTpe(hydra.scala.syntax.Type tpe) {
    return new Type_Existential(tpe, stats);
  }

  public Type_Existential withStats(java.util.List<hydra.scala.syntax.Stat> stats) {
    return new Type_Existential(tpe, stats);
  }
}
