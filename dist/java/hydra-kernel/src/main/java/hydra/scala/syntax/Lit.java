...
public abstract class Lit implements Serializable, Comparable<Lit> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Lit");
  ...
  public static final class Null extends hydra.scala.syntax.Lit implements Serializable {
    public Null () {
  ...
  public static final class Int extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Double_ extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Float_ extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Byte_ extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Short_ extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Char extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Long_ extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Boolean_ extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Unit extends hydra.scala.syntax.Lit implements Serializable {
    public Unit () {
  ...
  public static final class String_ extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Bytes extends hydra.scala.syntax.Lit implements Serializable {
  ...
  public static final class Symbol extends hydra.scala.syntax.Lit implements Serializable {
    public final hydra.scala.syntax.ScalaSymbol value;

    public Symbol (hydra.scala.syntax.ScalaSymbol value) {
      this.value = value;
    }
