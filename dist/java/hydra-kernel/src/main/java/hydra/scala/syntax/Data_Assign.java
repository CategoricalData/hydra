...
public class Data_Assign implements Serializable, Comparable<Data_Assign> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_Assign");
  ...
  public Data_Assign (hydra.scala.syntax.Data lhs, hydra.scala.syntax.Data rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public Data_Assign withLhs(hydra.scala.syntax.Data lhs) {
    return new Data_Assign(lhs, rhs);
  }

  public Data_Assign withRhs(hydra.scala.syntax.Data rhs) {
    return new Data_Assign(lhs, rhs);
  }
}
