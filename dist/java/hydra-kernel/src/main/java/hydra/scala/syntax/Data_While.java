...
public class Data_While implements Serializable, Comparable<Data_While> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_While");
  ...
  public Data_While (hydra.scala.syntax.Data expr, hydra.scala.syntax.Data body) {
    this.expr = expr;
    this.body = body;
  }
  ...
  public Data_While withExpr(hydra.scala.syntax.Data expr) {
    return new Data_While(expr, body);
  }

  public Data_While withBody(hydra.scala.syntax.Data body) {
    return new Data_While(expr, body);
  }
}
