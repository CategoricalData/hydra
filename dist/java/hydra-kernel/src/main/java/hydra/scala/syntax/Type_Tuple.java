...
public class Type_Tuple implements Serializable, Comparable<Type_Tuple> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Type_Tuple");
  ...
  public Type_Tuple (java.util.List<hydra.scala.syntax.Type> args) {
    this.args = args;
  }
