...
public class Decl_Def implements Serializable, Comparable<Decl_Def> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Decl_Def");
  ...
  public Decl_Def (java.util.List<hydra.scala.syntax.Mod> mods, hydra.scala.syntax.Data_Name name, java.util.List<hydra.scala.syntax.Type_Param> tparams, java.util.List<java.util.List<hydra.scala.syntax.Data_Param>> paramss, hydra.scala.syntax.Type decltpe) {
    this.mods = mods;
    this.name = name;
  ...
  public Decl_Def withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Decl_Def(mods, name, tparams, paramss, decltpe);
  }

  public Decl_Def withName(hydra.scala.syntax.Data_Name name) {
    return new Decl_Def(mods, name, tparams, paramss, decltpe);
  }

  public Decl_Def withTparams(java.util.List<hydra.scala.syntax.Type_Param> tparams) {
    return new Decl_Def(mods, name, tparams, paramss, decltpe);
  }

  public Decl_Def withParamss(java.util.List<java.util.List<hydra.scala.syntax.Data_Param>> paramss) {
    return new Decl_Def(mods, name, tparams, paramss, decltpe);
  }

  public Decl_Def withDecltpe(hydra.scala.syntax.Type decltpe) {
    return new Decl_Def(mods, name, tparams, paramss, decltpe);
  }
}
