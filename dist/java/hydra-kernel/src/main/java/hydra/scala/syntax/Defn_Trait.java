...
public class Defn_Trait implements Serializable, Comparable<Defn_Trait> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Defn_Trait");
  ...
  public Defn_Trait (java.util.List<hydra.scala.syntax.Mod> mods, hydra.scala.syntax.Type_Name name, java.util.List<hydra.scala.syntax.Type_Param> tparams, hydra.scala.syntax.Ctor_Primary ctor, hydra.scala.syntax.Template template) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Trait withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Defn_Trait(mods, name, tparams, ctor, template);
  }

  public Defn_Trait withName(hydra.scala.syntax.Type_Name name) {
    return new Defn_Trait(mods, name, tparams, ctor, template);
  }

  public Defn_Trait withTparams(java.util.List<hydra.scala.syntax.Type_Param> tparams) {
    return new Defn_Trait(mods, name, tparams, ctor, template);
  }

  public Defn_Trait withCtor(hydra.scala.syntax.Ctor_Primary ctor) {
    return new Defn_Trait(mods, name, tparams, ctor, template);
  }

  public Defn_Trait withTemplate(hydra.scala.syntax.Template template) {
    return new Defn_Trait(mods, name, tparams, ctor, template);
  }
}
