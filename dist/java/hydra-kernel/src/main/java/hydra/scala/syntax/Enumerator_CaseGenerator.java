...
public class Enumerator_CaseGenerator implements Serializable, Comparable<Enumerator_CaseGenerator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Enumerator_CaseGenerator");
  ...
  public Enumerator_CaseGenerator (hydra.scala.syntax.Pat pat, hydra.scala.syntax.Data rhs) {
    this.pat = pat;
    this.rhs = rhs;
  }
  ...
  public Enumerator_CaseGenerator withPat(hydra.scala.syntax.Pat pat) {
    return new Enumerator_CaseGenerator(pat, rhs);
  }

  public Enumerator_CaseGenerator withRhs(hydra.scala.syntax.Data rhs) {
    return new Enumerator_CaseGenerator(pat, rhs);
  }
}
