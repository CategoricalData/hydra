...
public abstract class Name implements Serializable, Comparable<Name> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Name");
  ...
  public static final class Value extends hydra.scala.syntax.Name implements Serializable {
  ...
  public static final class Anonymous extends hydra.scala.syntax.Name implements Serializable {
    public Anonymous () {
  ...
  public static final class Indeterminate extends hydra.scala.syntax.Name implements Serializable {
    public final hydra.scala.syntax.PredefString value;

    public Indeterminate (hydra.scala.syntax.PredefString value) {
      this.value = value;
    }
