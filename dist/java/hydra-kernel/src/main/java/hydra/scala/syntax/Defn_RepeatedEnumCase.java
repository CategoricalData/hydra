...
public class Defn_RepeatedEnumCase implements Serializable, Comparable<Defn_RepeatedEnumCase> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Defn_RepeatedEnumCase");
  ...
  public final java.util.List<hydra.scala.syntax.Data_Name> cases;

  public Defn_RepeatedEnumCase (java.util.List<hydra.scala.syntax.Mod> mods, java.util.List<hydra.scala.syntax.Data_Name> cases) {
    this.mods = mods;
    this.cases = cases;
  }
  ...
  public Defn_RepeatedEnumCase withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Defn_RepeatedEnumCase(mods, cases);
  }

  public Defn_RepeatedEnumCase withCases(java.util.List<hydra.scala.syntax.Data_Name> cases) {
    return new Defn_RepeatedEnumCase(mods, cases);
  }
}
