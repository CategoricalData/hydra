...
public class Enumerator_Val implements Serializable, Comparable<Enumerator_Val> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Enumerator_Val");
  ...
  public Enumerator_Val (hydra.scala.syntax.Pat pat, hydra.scala.syntax.Data rhs) {
    this.pat = pat;
    this.rhs = rhs;
  }
  ...
  public Enumerator_Val withPat(hydra.scala.syntax.Pat pat) {
    return new Enumerator_Val(pat, rhs);
  }

  public Enumerator_Val withRhs(hydra.scala.syntax.Data rhs) {
    return new Enumerator_Val(pat, rhs);
  }
}
