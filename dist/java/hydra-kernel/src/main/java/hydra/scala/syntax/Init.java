...
public class Init implements Serializable, Comparable<Init> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Init");
  ...
  public final java.util.List<java.util.List<hydra.scala.syntax.Data>> argss;

  public Init (hydra.scala.syntax.Type tpe, hydra.scala.syntax.Name name, java.util.List<java.util.List<hydra.scala.syntax.Data>> argss) {
    this.tpe = tpe;
    this.name = name;
    this.argss = argss;
  }
  ...
  public Init withTpe(hydra.scala.syntax.Type tpe) {
    return new Init(tpe, name, argss);
  }

  public Init withName(hydra.scala.syntax.Name name) {
    return new Init(tpe, name, argss);
  }

  public Init withArgss(java.util.List<java.util.List<hydra.scala.syntax.Data>> argss) {
    return new Init(tpe, name, argss);
  }
}
