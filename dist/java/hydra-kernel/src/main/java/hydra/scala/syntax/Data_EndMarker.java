...
public class Data_EndMarker implements Serializable, Comparable<Data_EndMarker> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_EndMarker");

  public static final hydra.core.Name NAME = new hydra.core.Name("name");

  public final hydra.scala.syntax.Data_Name name;

  public Data_EndMarker (hydra.scala.syntax.Data_Name name) {
    this.name = name;
  }
