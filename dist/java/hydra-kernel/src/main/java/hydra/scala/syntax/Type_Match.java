...
public class Type_Match implements Serializable, Comparable<Type_Match> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Type_Match");
  ...
  public final java.util.List<hydra.scala.syntax.TypeCase> cases;

  public Type_Match (hydra.scala.syntax.Type tpe, java.util.List<hydra.scala.syntax.TypeCase> cases) {
    this.tpe = tpe;
    this.cases = cases;
  }
  ...
  public Type_Match withTpe(hydra.scala.syntax.Type tpe) {
    return new Type_Match(tpe, cases);
  }

  public Type_Match withCases(java.util.List<hydra.scala.syntax.TypeCase> cases) {
    return new Type_Match(tpe, cases);
  }
}
