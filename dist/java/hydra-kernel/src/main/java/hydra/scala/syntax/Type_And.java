...
public class Type_And implements Serializable, Comparable<Type_And> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Type_And");
  ...
  public Type_And (hydra.scala.syntax.Type lhs, hydra.scala.syntax.Type rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public Type_And withLhs(hydra.scala.syntax.Type lhs) {
    return new Type_And(lhs, rhs);
  }

  public Type_And withRhs(hydra.scala.syntax.Type rhs) {
    return new Type_And(lhs, rhs);
  }
}
