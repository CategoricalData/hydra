...
public class Data_Try implements Serializable, Comparable<Data_Try> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_Try");
  ...
  public final java.util.List<hydra.scala.syntax.Case> catchp;

  public final hydra.util.Maybe<hydra.scala.syntax.Data> finallyp;

  public Data_Try (hydra.scala.syntax.Data expr, java.util.List<hydra.scala.syntax.Case> catchp, hydra.util.Maybe<hydra.scala.syntax.Data> finallyp) {
    this.expr = expr;
    this.catchp = catchp;
  ...
  public Data_Try withExpr(hydra.scala.syntax.Data expr) {
    return new Data_Try(expr, catchp, finallyp);
  }

  public Data_Try withCatchp(java.util.List<hydra.scala.syntax.Case> catchp) {
    return new Data_Try(expr, catchp, finallyp);
  }

  public Data_Try withFinallyp(hydra.util.Maybe<hydra.scala.syntax.Data> finallyp) {
    return new Data_Try(expr, catchp, finallyp);
  }
}
