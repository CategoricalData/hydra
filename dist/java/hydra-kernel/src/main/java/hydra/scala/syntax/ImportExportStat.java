...
public abstract class ImportExportStat implements Serializable, Comparable<ImportExportStat> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.ImportExportStat");
  ...
  public static final class Import extends hydra.scala.syntax.ImportExportStat implements Serializable {
    public final hydra.scala.syntax.Import value;

    public Import (hydra.scala.syntax.Import value) {
      this.value = value;
    }
  ...
  public static final class Export extends hydra.scala.syntax.ImportExportStat implements Serializable {
    public final hydra.scala.syntax.Export value;

    public Export (hydra.scala.syntax.Export value) {
      this.value = value;
    }
