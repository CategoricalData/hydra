...
public abstract class Member_Data implements Serializable, Comparable<Member_Data> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Member_Data");
  ...
  public static final class Pkg extends hydra.scala.syntax.Member_Data implements Serializable {
    public final hydra.scala.syntax.Pkg value;

    public Pkg (hydra.scala.syntax.Pkg value) {
      this.value = value;
    }
  ...
  public static final class Object_ extends hydra.scala.syntax.Member_Data implements Serializable {
    public final hydra.scala.syntax.Pkg_Object value;

    public Object_ (hydra.scala.syntax.Pkg_Object value) {
      this.value = value;
    }
