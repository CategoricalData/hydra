...
public class Data_TryWithHandler implements Serializable, Comparable<Data_TryWithHandler> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_TryWithHandler");
  ...
  public final hydra.scala.syntax.Data catchp;

  public final hydra.util.Maybe<hydra.scala.syntax.Data> finallyp;

  public Data_TryWithHandler (hydra.scala.syntax.Data expr, hydra.scala.syntax.Data catchp, hydra.util.Maybe<hydra.scala.syntax.Data> finallyp) {
    this.expr = expr;
    this.catchp = catchp;
  ...
  public Data_TryWithHandler withExpr(hydra.scala.syntax.Data expr) {
    return new Data_TryWithHandler(expr, catchp, finallyp);
  }

  public Data_TryWithHandler withCatchp(hydra.scala.syntax.Data catchp) {
    return new Data_TryWithHandler(expr, catchp, finallyp);
  }

  public Data_TryWithHandler withFinallyp(hydra.util.Maybe<hydra.scala.syntax.Data> finallyp) {
    return new Data_TryWithHandler(expr, catchp, finallyp);
  }
}
