...
public class Data_ApplyUsing implements Serializable, Comparable<Data_ApplyUsing> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_ApplyUsing");
  ...
  public final java.util.List<hydra.scala.syntax.Data> targs;

  public Data_ApplyUsing (hydra.scala.syntax.Data fun, java.util.List<hydra.scala.syntax.Data> targs) {
    this.fun = fun;
    this.targs = targs;
  }
  ...
  public Data_ApplyUsing withFun(hydra.scala.syntax.Data fun) {
    return new Data_ApplyUsing(fun, targs);
  }

  public Data_ApplyUsing withTargs(java.util.List<hydra.scala.syntax.Data> targs) {
    return new Data_ApplyUsing(fun, targs);
  }
}
