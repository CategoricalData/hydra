...
public class Decl_Type implements Serializable, Comparable<Decl_Type> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Decl_Type");
  ...
  public final hydra.scala.syntax.TypeBounds bounds;

  public Decl_Type (java.util.List<hydra.scala.syntax.Mod> mods, hydra.scala.syntax.Type_Name name, java.util.List<hydra.scala.syntax.Type_Param> tparams, hydra.scala.syntax.TypeBounds bounds) {
    this.mods = mods;
    this.name = name;
  ...
  public Decl_Type withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Decl_Type(mods, name, tparams, bounds);
  }

  public Decl_Type withName(hydra.scala.syntax.Type_Name name) {
    return new Decl_Type(mods, name, tparams, bounds);
  }

  public Decl_Type withTparams(java.util.List<hydra.scala.syntax.Type_Param> tparams) {
    return new Decl_Type(mods, name, tparams, bounds);
  }

  public Decl_Type withBounds(hydra.scala.syntax.TypeBounds bounds) {
    return new Decl_Type(mods, name, tparams, bounds);
  }
}
