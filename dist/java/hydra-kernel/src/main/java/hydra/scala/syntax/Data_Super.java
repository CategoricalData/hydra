...
public class Data_Super implements Serializable, Comparable<Data_Super> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_Super");
  ...
  public final hydra.scala.syntax.Name thisp;

  public final hydra.scala.syntax.Name superp;

  public Data_Super (hydra.scala.syntax.Name thisp, hydra.scala.syntax.Name superp) {
    this.thisp = thisp;
    this.superp = superp;
  }
  ...
  public Data_Super withThisp(hydra.scala.syntax.Name thisp) {
    return new Data_Super(thisp, superp);
  }

  public Data_Super withSuperp(hydra.scala.syntax.Name superp) {
    return new Data_Super(thisp, superp);
  }
}
