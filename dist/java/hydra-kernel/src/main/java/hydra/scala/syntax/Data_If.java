...
public class Data_If implements Serializable, Comparable<Data_If> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Data_If");
  ...
  public final hydra.scala.syntax.Data thenp;

  public final hydra.scala.syntax.Data elsep;

  public Data_If (hydra.scala.syntax.Data cond, hydra.scala.syntax.Data thenp, hydra.scala.syntax.Data elsep) {
    this.cond = cond;
    this.thenp = thenp;
    this.elsep = elsep;
  }
  ...
  public Data_If withCond(hydra.scala.syntax.Data cond) {
    return new Data_If(cond, thenp, elsep);
  }

  public Data_If withThenp(hydra.scala.syntax.Data thenp) {
    return new Data_If(cond, thenp, elsep);
  }

  public Data_If withElsep(hydra.scala.syntax.Data elsep) {
    return new Data_If(cond, thenp, elsep);
  }
}
