...
public class Ctor_Primary implements Serializable, Comparable<Ctor_Primary> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.scala.syntax.Ctor_Primary");
  ...
  public Ctor_Primary (java.util.List<hydra.scala.syntax.Mod> mods, hydra.scala.syntax.Name name, java.util.List<java.util.List<hydra.scala.syntax.Data_Param>> paramss) {
    this.mods = mods;
    this.name = name;
  ...
  public Ctor_Primary withMods(java.util.List<hydra.scala.syntax.Mod> mods) {
    return new Ctor_Primary(mods, name, paramss);
  }

  public Ctor_Primary withName(hydra.scala.syntax.Name name) {
    return new Ctor_Primary(mods, name, paramss);
  }

  public Ctor_Primary withParamss(java.util.List<java.util.List<hydra.scala.syntax.Data_Param>> paramss) {
    return new Ctor_Primary(mods, name, paramss);
  }
}
