...
public interface Encoding {
  ...
  static hydra.core.Term encodeForallType(hydra.core.ForallType ft) {
    return new hydra.core.Term.Lambda(new hydra.core.Lambda(hydra.Encoding.encodeBindingName((ft).parameter), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), hydra.Encoding.encodeType((ft).body)));
  }
  ...
  static hydra.core.Term encodeLiteralType(hydra.core.LiteralType v1) {
    return (v1).accept(new hydra.core.LiteralType.PartialVisitor<>() {
      ...
      public hydra.core.Term otherwise(hydra.core.LiteralType instance) {
        return new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("x"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Variable(new hydra.core.Name("x"))));
      }
      ...
      public hydra.core.Term visit(hydra.core.LiteralType.Decimal ignored) {
        return new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("x"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Inject(new hydra.core.Injection(new hydra.core.Name("hydra.core.Term"), new hydra.core.Field(new hydra.core.Name("literal"), new hydra.core.Term.Inject(new hydra.core.Injection(new hydra.core.Name("hydra.core.Literal"), new hydra.core.Field(new hydra.core.Name("decimal"), new hydra.core.Term.Variable(new hydra.core.Name("x"))))))))));
      }
      ...
      (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.errors.Error_, hydra.util.Maybe<hydra.packaging.Module>>>) (typeBindings -> hydra.lib.logic.IfElse.lazy(
        ...
        () -> hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.errors.Error_, hydra.util.Maybe<hydra.packaging.Module>>>) (encodedBindings -> hydra.util.Either.<hydra.errors.Error_, hydra.util.Maybe<hydra.packaging.Module>>right(hydra.util.Maybe.just(new hydra.packaging.Module(hydra.Encoding.encodeNamespace((mod).namespace), hydra.lib.lists.Map.apply(
            ...
            hydra.lib.lists.Map.apply(
              hydra.Encoding::encodeNamespace,
              (mod).termDependencies))), java.util.Arrays.asList((mod).namespace), hydra.util.Maybe.just(hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
            "Term encoders for ",
            (mod).namespace.value)))))))))));
  }
    ...
    return new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("x"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Inject(new hydra.core.Injection(new hydra.core.Name("hydra.core.Term"), new hydra.core.Field(new hydra.core.Name("record"), new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.core.Record"), java.util.Arrays.asList(
      ...
      new hydra.core.Field(new hydra.core.Name("fields"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.core.FieldType, hydra.core.Term>) (ft -> new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.core.Field"), java.util.Arrays.asList(
          ...
          new hydra.core.Field(new hydra.core.Name("term"), new hydra.core.Term.Application(new hydra.core.Application(hydra.Encoding.encodeType((ft).type), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Project(new hydra.core.Projection(ename, (ft).name)), new hydra.core.Term.Variable(new hydra.core.Name("x"))))))))))),
        rt)))))))))));
  }
  ...
  static hydra.core.Term encodeTypeNamed(hydra.core.Name ename, hydra.core.Type typ) {
    return (typ).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      @Override
      public hydra.core.Term visit(hydra.core.Type.Forall ft) {
        return new hydra.core.Term.Lambda(new hydra.core.Lambda(hydra.Encoding.encodeBindingName((ft).value.parameter), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), hydra.Encoding.encodeTypeNamed(
          ename,
          (ft).value.body)));
      }
  ...
  static hydra.core.Term encodeUnionType(java.util.List<hydra.core.FieldType> rt) {
    return hydra.Encoding.encodeUnionTypeNamed(
      new hydra.core.Name("unknown"),
      rt);
  }

  static hydra.core.Term encodeUnionTypeNamed(hydra.core.Name ename, java.util.List<hydra.core.FieldType> rt) {
    return new hydra.core.Term.Cases(new hydra.core.CaseStatement(ename, (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), hydra.lib.lists.Map.apply(
    ...
    return (typ).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public java.util.List<hydra.core.Name> visit(hydra.core.Type.Record rt) {
        return hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.core.FieldType, java.util.List<hydra.core.Name>>) (ft -> hydra.Encoding.encoderCollectOrdVars((ft).type)),
          (rt).value));
      }
  ...
  static java.util.List<hydra.core.Name> encoderCollectTypeVarsFromType(hydra.core.Type typ) {
    return (typ).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public java.util.List<hydra.core.Name> visit(hydra.core.Type.Record rt) {
        return hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.core.FieldType, java.util.List<hydra.core.Name>>) (ft -> hydra.Encoding.encoderCollectTypeVarsFromType((ft).type)),
          (rt).value));
      }
  ...
  static hydra.core.TypeScheme encoderTypeScheme(hydra.core.Type typ) {
    java.util.List<hydra.core.Name> allOrdVars = hydra.Encoding.encoderCollectOrdVars(typ);
    java.util.List<hydra.core.Name> typeVars = hydra.Encoding.encoderCollectForallVariables(typ);
