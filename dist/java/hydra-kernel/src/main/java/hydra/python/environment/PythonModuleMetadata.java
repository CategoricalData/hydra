...
public class PythonModuleMetadata implements Serializable, Comparable<PythonModuleMetadata> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.environment.PythonModuleMetadata");
  ...
  public PythonModuleMetadata withNamespaces(hydra.packaging.Namespaces<hydra.python.syntax.DottedName> namespaces) {
