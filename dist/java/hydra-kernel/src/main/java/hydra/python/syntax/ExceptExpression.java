...
public class ExceptExpression implements Serializable, Comparable<ExceptExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.ExceptExpression");
  ...
  public ExceptExpression (hydra.python.syntax.Expression expression, hydra.util.Maybe<hydra.python.syntax.Name> as) {
  ...
  public ExceptExpression withExpression(hydra.python.syntax.Expression expression) {
    return new ExceptExpression(expression, as);
  }

  public ExceptExpression withAs(hydra.util.Maybe<hydra.python.syntax.Name> as) {
    return new ExceptExpression(expression, as);
  }
}
