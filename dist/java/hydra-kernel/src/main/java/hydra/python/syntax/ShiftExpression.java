...
public class ShiftExpression implements Serializable, Comparable<ShiftExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.ShiftExpression");
  ...
  public final hydra.util.Maybe<hydra.python.syntax.ShiftLhs> lhs;

  public final hydra.python.syntax.Sum rhs;

  public ShiftExpression (hydra.util.Maybe<hydra.python.syntax.ShiftLhs> lhs, hydra.python.syntax.Sum rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public ShiftExpression withLhs(hydra.util.Maybe<hydra.python.syntax.ShiftLhs> lhs) {
    return new ShiftExpression(lhs, rhs);
  }

  public ShiftExpression withRhs(hydra.python.syntax.Sum rhs) {
    return new ShiftExpression(lhs, rhs);
  }
}
