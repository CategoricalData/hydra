...
public abstract class Number_ implements Serializable, Comparable<Number_> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.Number");
  ...
  public static final class Integer_ extends hydra.python.syntax.Number_ implements Serializable {
  ...
  public static final class Float_ extends hydra.python.syntax.Number_ implements Serializable {
