...
public abstract class LiteralExpression implements Serializable, Comparable<LiteralExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.LiteralExpression");
  ...
  public static final class Number_ extends hydra.python.syntax.LiteralExpression implements Serializable {
    public final hydra.python.syntax.SignedNumber value;

    public Number_ (hydra.python.syntax.SignedNumber value) {
      this.value = value;
    }
  ...
  public static final class Complex extends hydra.python.syntax.LiteralExpression implements Serializable {
    public final hydra.python.syntax.ComplexNumber value;

    public Complex (hydra.python.syntax.ComplexNumber value) {
      this.value = value;
    }
  ...
  public static final class String_ extends hydra.python.syntax.LiteralExpression implements Serializable {
  ...
  public static final class None extends hydra.python.syntax.LiteralExpression implements Serializable {
    public None () {
  ...
  public static final class True extends hydra.python.syntax.LiteralExpression implements Serializable {
    public True () {
  ...
  public static final class False extends hydra.python.syntax.LiteralExpression implements Serializable {
    public False () {
