...
public class String_ implements Serializable, Comparable<String_> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.String");
  ...
  public final hydra.python.syntax.QuoteStyle quoteStyle;

  public String_ (String value, hydra.python.syntax.QuoteStyle quoteStyle) {
    this.value = value;
  ...
  public String_ withQuoteStyle(hydra.python.syntax.QuoteStyle quoteStyle) {
    return new String_(value, quoteStyle);
  }
}
