...
public class PythonEnvironment implements Serializable, Comparable<PythonEnvironment> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.environment.PythonEnvironment");
   ...
   */
  public final hydra.packaging.Namespaces<hydra.python.syntax.DottedName> namespaces;

  /**
   * Type variables in scope, with their Python names
   */
  public final hydra.util.Pair<java.util.List<hydra.core.Name>, java.util.Map<hydra.core.Name, hydra.python.syntax.Name>> boundTypeVariables;
   ...
   */
  public final hydra.python.environment.PythonVersion version;
  ...
  public PythonEnvironment withNamespaces(hydra.packaging.Namespaces<hydra.python.syntax.DottedName> namespaces) {
    return new PythonEnvironment(namespaces, boundTypeVariables, graph, nullaryBindings, version, skipCasts, inlineVariables);
  }

  public PythonEnvironment withBoundTypeVariables(hydra.util.Pair<java.util.List<hydra.core.Name>, java.util.Map<hydra.core.Name, hydra.python.syntax.Name>> boundTypeVariables) {
    return new PythonEnvironment(namespaces, boundTypeVariables, graph, nullaryBindings, version, skipCasts, inlineVariables);
  }
  ...
  public PythonEnvironment withVersion(hydra.python.environment.PythonVersion version) {
    return new PythonEnvironment(namespaces, boundTypeVariables, graph, nullaryBindings, version, skipCasts, inlineVariables);
  }
