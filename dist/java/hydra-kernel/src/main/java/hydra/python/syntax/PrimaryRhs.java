...
public abstract class PrimaryRhs implements Serializable, Comparable<PrimaryRhs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.PrimaryRhs");
  ...
  public static final class Project extends hydra.python.syntax.PrimaryRhs implements Serializable {
    public final hydra.python.syntax.Name value;

    public Project (hydra.python.syntax.Name value) {
      this.value = value;
    }
  ...
  public static final class Genexp extends hydra.python.syntax.PrimaryRhs implements Serializable {
  ...
  public static final class Call extends hydra.python.syntax.PrimaryRhs implements Serializable {
    public final hydra.python.syntax.Args value;

    public Call (hydra.python.syntax.Args value) {
      this.value = value;
    }
  ...
  public static final class Slices extends hydra.python.syntax.PrimaryRhs implements Serializable {
    public final hydra.python.syntax.Slices value;

    public Slices (hydra.python.syntax.Slices value) {
      this.value = value;
    }
