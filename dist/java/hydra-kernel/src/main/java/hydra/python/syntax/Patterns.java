...
public abstract class Patterns implements Serializable, Comparable<Patterns> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.Patterns");
  ...
  public static final class Sequence extends hydra.python.syntax.Patterns implements Serializable {
    public final hydra.python.syntax.OpenSequencePattern value;

    public Sequence (hydra.python.syntax.OpenSequencePattern value) {
      this.value = value;
    }
  ...
  public static final class Pattern extends hydra.python.syntax.Patterns implements Serializable {
