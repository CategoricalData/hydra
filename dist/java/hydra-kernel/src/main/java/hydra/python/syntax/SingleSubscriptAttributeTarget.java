...
public abstract class SingleSubscriptAttributeTarget implements Serializable, Comparable<SingleSubscriptAttributeTarget> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.SingleSubscriptAttributeTarget");
  ...
  public static final class PrimaryAndName extends hydra.python.syntax.SingleSubscriptAttributeTarget implements Serializable {
  ...
  public static final class PrimaryAndSlices extends hydra.python.syntax.SingleSubscriptAttributeTarget implements Serializable {
