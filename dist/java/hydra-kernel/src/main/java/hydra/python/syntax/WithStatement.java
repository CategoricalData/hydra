...
public class WithStatement implements Serializable, Comparable<WithStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.WithStatement");
  ...
  public final java.util.List<hydra.python.syntax.WithItem> items;

  public final hydra.util.Maybe<hydra.python.syntax.TypeComment> typeComment;

  public final hydra.python.syntax.Block body;

  public WithStatement (Boolean async, java.util.List<hydra.python.syntax.WithItem> items, hydra.util.Maybe<hydra.python.syntax.TypeComment> typeComment, hydra.python.syntax.Block body) {
    this.async = async;
    this.items = items;
  ...
  public WithStatement withItems(java.util.List<hydra.python.syntax.WithItem> items) {
    return new WithStatement(async, items, typeComment, body);
  }

  public WithStatement withTypeComment(hydra.util.Maybe<hydra.python.syntax.TypeComment> typeComment) {
    return new WithStatement(async, items, typeComment, body);
  }

  public WithStatement withBody(hydra.python.syntax.Block body) {
    return new WithStatement(async, items, typeComment, body);
  }
}
