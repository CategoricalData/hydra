...
public class ForIfClause implements Serializable, Comparable<ForIfClause> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.ForIfClause");
  ...
  public final hydra.python.syntax.Disjunction in;

  public final java.util.List<hydra.python.syntax.Disjunction> ifs;

  public ForIfClause (Boolean async, java.util.List<hydra.python.syntax.StarTarget> targets, hydra.python.syntax.Disjunction in, java.util.List<hydra.python.syntax.Disjunction> ifs) {
    this.async = async;
  ...
  public ForIfClause withTargets(java.util.List<hydra.python.syntax.StarTarget> targets) {
    return new ForIfClause(async, targets, in, ifs);
  }

  public ForIfClause withIn(hydra.python.syntax.Disjunction in) {
    return new ForIfClause(async, targets, in, ifs);
  }

  public ForIfClause withIfs(java.util.List<hydra.python.syntax.Disjunction> ifs) {
    return new ForIfClause(async, targets, in, ifs);
  }
}
