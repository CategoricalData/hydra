...
public abstract class PlusOrMinus implements Serializable, Comparable<PlusOrMinus> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.PlusOrMinus");
  ...
  public static final class Plus extends hydra.python.syntax.PlusOrMinus implements Serializable {
    public Plus () {
  ...
  public static final class Minus extends hydra.python.syntax.PlusOrMinus implements Serializable {
    public Minus () {
