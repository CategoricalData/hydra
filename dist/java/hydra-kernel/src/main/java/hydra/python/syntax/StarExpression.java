...
public abstract class StarExpression implements Serializable, Comparable<StarExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.StarExpression");
  ...
  public static final class Star extends hydra.python.syntax.StarExpression implements Serializable {
    public final hydra.python.syntax.BitwiseOr value;

    public Star (hydra.python.syntax.BitwiseOr value) {
      this.value = value;
    }
  ...
  public static final class Simple extends hydra.python.syntax.StarExpression implements Serializable {
