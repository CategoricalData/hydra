...
public class ParamWithDefaultParameters implements Serializable, Comparable<ParamWithDefaultParameters> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.ParamWithDefaultParameters");
  ...
  public ParamWithDefaultParameters (java.util.List<hydra.python.syntax.ParamWithDefault> paramWithDefault, hydra.util.Maybe<hydra.python.syntax.StarEtc> starEtc) {
  ...
  public ParamWithDefaultParameters withParamWithDefault(java.util.List<hydra.python.syntax.ParamWithDefault> paramWithDefault) {
    return new ParamWithDefaultParameters(paramWithDefault, starEtc);
  }

  public ParamWithDefaultParameters withStarEtc(hydra.util.Maybe<hydra.python.syntax.StarEtc> starEtc) {
    return new ParamWithDefaultParameters(paramWithDefault, starEtc);
  }
}
