...
public class ParamWithDefault implements Serializable, Comparable<ParamWithDefault> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.ParamWithDefault");
  ...
  public final hydra.python.syntax.Param param;

  public final hydra.python.syntax.Default default_;

  public final hydra.util.Maybe<hydra.python.syntax.TypeComment> typeComment;

  public ParamWithDefault (hydra.python.syntax.Param param, hydra.python.syntax.Default default_, hydra.util.Maybe<hydra.python.syntax.TypeComment> typeComment) {
    this.param = param;
  ...
  public ParamWithDefault withParam(hydra.python.syntax.Param param) {
    return new ParamWithDefault(param, default_, typeComment);
  }

  public ParamWithDefault withDefault(hydra.python.syntax.Default default_) {
    return new ParamWithDefault(param, default_, typeComment);
  }

  public ParamWithDefault withTypeComment(hydra.util.Maybe<hydra.python.syntax.TypeComment> typeComment) {
    return new ParamWithDefault(param, default_, typeComment);
  }
}
