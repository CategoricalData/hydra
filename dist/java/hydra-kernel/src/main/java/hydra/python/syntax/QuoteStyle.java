...
public abstract class QuoteStyle implements Serializable, Comparable<QuoteStyle> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.QuoteStyle");
  ...
  public static final class Single extends hydra.python.syntax.QuoteStyle implements Serializable {
    public Single () {
  ...
  public static final class Double_ extends hydra.python.syntax.QuoteStyle implements Serializable {
    public Double_ () {
  ...
  public static final class Triple extends hydra.python.syntax.QuoteStyle implements Serializable {
    public Triple () {
