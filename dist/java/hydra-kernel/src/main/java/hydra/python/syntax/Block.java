...
public abstract class Block implements Serializable, Comparable<Block> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.Block");
  ...
  public static final class Indented extends hydra.python.syntax.Block implements Serializable {
    public final java.util.List<java.util.List<hydra.python.syntax.Statement>> value;

    public Indented (java.util.List<java.util.List<hydra.python.syntax.Statement>> value) {
      this.value = value;
    }
  ...
  public static final class Simple extends hydra.python.syntax.Block implements Serializable {
