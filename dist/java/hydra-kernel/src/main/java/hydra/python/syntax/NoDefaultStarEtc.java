...
public class NoDefaultStarEtc implements Serializable, Comparable<NoDefaultStarEtc> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.NoDefaultStarEtc");
  ...
  public final hydra.python.syntax.ParamNoDefault paramNoDefault;
  ...
  public NoDefaultStarEtc (hydra.python.syntax.ParamNoDefault paramNoDefault, java.util.List<hydra.python.syntax.ParamMaybeDefault> paramMaybeDefault, hydra.util.Maybe<hydra.python.syntax.Keywords> keywords) {
  ...
  public NoDefaultStarEtc withParamNoDefault(hydra.python.syntax.ParamNoDefault paramNoDefault) {
    return new NoDefaultStarEtc(paramNoDefault, paramMaybeDefault, keywords);
  }

  public NoDefaultStarEtc withParamMaybeDefault(java.util.List<hydra.python.syntax.ParamMaybeDefault> paramMaybeDefault) {
    return new NoDefaultStarEtc(paramNoDefault, paramMaybeDefault, keywords);
  }

  public NoDefaultStarEtc withKeywords(hydra.util.Maybe<hydra.python.syntax.Keywords> keywords) {
    return new NoDefaultStarEtc(paramNoDefault, paramMaybeDefault, keywords);
  }
}
