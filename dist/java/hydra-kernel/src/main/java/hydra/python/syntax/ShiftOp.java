...
public abstract class ShiftOp implements Serializable, Comparable<ShiftOp> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.ShiftOp");
  ...
  public static final class Left extends hydra.python.syntax.ShiftOp implements Serializable {
    public Left () {
  ...
  public static final class Right extends hydra.python.syntax.ShiftOp implements Serializable {
    public Right () {
