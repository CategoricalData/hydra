...
public class CompareOpBitwiseOrPair implements Serializable, Comparable<CompareOpBitwiseOrPair> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.CompareOpBitwiseOrPair");
  ...
  public final hydra.python.syntax.CompareOp operator;

  public final hydra.python.syntax.BitwiseOr rhs;

  public CompareOpBitwiseOrPair (hydra.python.syntax.CompareOp operator, hydra.python.syntax.BitwiseOr rhs) {
  ...
  public CompareOpBitwiseOrPair withOperator(hydra.python.syntax.CompareOp operator) {
    return new CompareOpBitwiseOrPair(operator, rhs);
  }

  public CompareOpBitwiseOrPair withRhs(hydra.python.syntax.BitwiseOr rhs) {
    return new CompareOpBitwiseOrPair(operator, rhs);
  }
}
