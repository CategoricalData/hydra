...
public class LambdaParamWithDefault implements Serializable, Comparable<LambdaParamWithDefault> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.LambdaParamWithDefault");
  ...
  public LambdaParamWithDefault (hydra.python.syntax.Name param, hydra.util.Maybe<hydra.python.syntax.Default> default_) {
    this.param = param;
  ...
  public LambdaParamWithDefault withParam(hydra.python.syntax.Name param) {
    return new LambdaParamWithDefault(param, default_);
  }

  public LambdaParamWithDefault withDefault(hydra.util.Maybe<hydra.python.syntax.Default> default_) {
    return new LambdaParamWithDefault(param, default_);
  }
}
