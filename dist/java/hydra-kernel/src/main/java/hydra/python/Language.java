...
public interface Language {
  static hydra.coders.Language pythonLanguage() {
    ...
    return new hydra.coders.Language(new hydra.coders.LanguageName("hydra.python"), new hydra.coders.LanguageConstraints(eliminationVariants.get(), literalVariants.get(), floatTypes.get(), functionVariants.get(), integerTypes.get(), termVariants.get(), typeVariants.get(), p0 -> hydra.python.Language.<hydra.core.Type>pythonLanguage_typePredicate(p0)));
  }
  ...
  static java.util.Set<String> pythonReservedWords() {
    java.util.List<String> hydraPythonKeywords = java.util.Arrays.asList(
      "Node",
      "FrozenDict");
    java.util.List<String> pythonBuiltInFunctions = java.util.Arrays.asList("range");
    java.util.List<String> pythonKeywords = java.util.Arrays.asList(
      "False",
      "None",
      "True",
      "and",
