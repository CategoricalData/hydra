...
public class SlashNoDefaultParameters implements Serializable, Comparable<SlashNoDefaultParameters> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.SlashNoDefaultParameters");
  ...
  public final hydra.python.syntax.SlashNoDefault slash;
  ...
  public final hydra.util.Maybe<hydra.python.syntax.StarEtc> starEtc;

  public SlashNoDefaultParameters (hydra.python.syntax.SlashNoDefault slash, java.util.List<hydra.python.syntax.ParamNoDefault> paramNoDefault, java.util.List<hydra.python.syntax.ParamWithDefault> paramWithDefault, hydra.util.Maybe<hydra.python.syntax.StarEtc> starEtc) {
    this.slash = slash;
  ...
  public SlashNoDefaultParameters withSlash(hydra.python.syntax.SlashNoDefault slash) {
    return new SlashNoDefaultParameters(slash, paramNoDefault, paramWithDefault, starEtc);
  }

  public SlashNoDefaultParameters withParamNoDefault(java.util.List<hydra.python.syntax.ParamNoDefault> paramNoDefault) {
    return new SlashNoDefaultParameters(slash, paramNoDefault, paramWithDefault, starEtc);
  }

  public SlashNoDefaultParameters withParamWithDefault(java.util.List<hydra.python.syntax.ParamWithDefault> paramWithDefault) {
    return new SlashNoDefaultParameters(slash, paramNoDefault, paramWithDefault, starEtc);
  }

  public SlashNoDefaultParameters withStarEtc(hydra.util.Maybe<hydra.python.syntax.StarEtc> starEtc) {
    return new SlashNoDefaultParameters(slash, paramNoDefault, paramWithDefault, starEtc);
  }
}
