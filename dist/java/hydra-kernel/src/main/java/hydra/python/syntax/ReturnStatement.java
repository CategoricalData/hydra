...
public class ReturnStatement implements Serializable, Comparable<ReturnStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.ReturnStatement");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final java.util.List<hydra.python.syntax.StarExpression> value;

  public ReturnStatement (java.util.List<hydra.python.syntax.StarExpression> value) {
    this.value = value;
  }
