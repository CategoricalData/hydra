...
public class StarredExpression implements Serializable, Comparable<StarredExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.StarredExpression");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.python.syntax.Expression value;

  public StarredExpression (hydra.python.syntax.Expression value) {
    this.value = value;
  }
