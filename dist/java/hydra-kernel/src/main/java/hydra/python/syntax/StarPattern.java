...
public abstract class StarPattern implements Serializable, Comparable<StarPattern> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.StarPattern");
  ...
  public static final class Capture extends hydra.python.syntax.StarPattern implements Serializable {
    public final hydra.python.syntax.PatternCaptureTarget value;

    public Capture (hydra.python.syntax.PatternCaptureTarget value) {
      this.value = value;
    }
  ...
  public static final class Wildcard extends hydra.python.syntax.StarPattern implements Serializable {
    public Wildcard () {
