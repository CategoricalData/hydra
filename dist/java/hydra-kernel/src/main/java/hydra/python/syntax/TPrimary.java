...
public abstract class TPrimary implements Serializable, Comparable<TPrimary> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.TPrimary");
  ...
  public static final class PrimaryAndName extends hydra.python.syntax.TPrimary implements Serializable {
  ...
  public static final class PrimaryAndSlices extends hydra.python.syntax.TPrimary implements Serializable {
  ...
  public static final class PrimaryAndGenexp extends hydra.python.syntax.TPrimary implements Serializable {
    public final hydra.python.syntax.TPrimaryAndGenexp value;

    public PrimaryAndGenexp (hydra.python.syntax.TPrimaryAndGenexp value) {
      this.value = value;
    }
  ...
  public static final class PrimaryAndArguments extends hydra.python.syntax.TPrimary implements Serializable {
    public final hydra.python.syntax.TPrimaryAndArguments value;

    public PrimaryAndArguments (hydra.python.syntax.TPrimaryAndArguments value) {
      this.value = value;
    }
  ...
  public static final class Atom extends hydra.python.syntax.TPrimary implements Serializable {
    public final hydra.python.syntax.Atom value;

    public Atom (hydra.python.syntax.Atom value) {
      this.value = value;
    }
