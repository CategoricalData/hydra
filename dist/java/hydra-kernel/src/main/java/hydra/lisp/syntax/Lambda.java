...
public class Lambda implements Serializable, Comparable<Lambda> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.Lambda");
   ...
   */
  public final hydra.util.Maybe<hydra.lisp.syntax.Symbol> name;
  ...
  public Lambda (hydra.util.Maybe<hydra.lisp.syntax.Symbol> name, java.util.List<hydra.lisp.syntax.Symbol> params, hydra.util.Maybe<hydra.lisp.syntax.Symbol> restParam, java.util.List<hydra.lisp.syntax.Expression> body) {
    this.name = name;
    this.params = params;
  ...
  public Lambda withName(hydra.util.Maybe<hydra.lisp.syntax.Symbol> name) {
    return new Lambda(name, params, restParam, body);
  }

  public Lambda withParams(java.util.List<hydra.lisp.syntax.Symbol> params) {
    return new Lambda(name, params, restParam, body);
  }

  public Lambda withRestParam(hydra.util.Maybe<hydra.lisp.syntax.Symbol> restParam) {
    return new Lambda(name, params, restParam, body);
  }

  public Lambda withBody(java.util.List<hydra.lisp.syntax.Expression> body) {
    return new Lambda(name, params, restParam, body);
  }
}
