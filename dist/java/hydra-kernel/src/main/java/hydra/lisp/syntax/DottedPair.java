...
public class DottedPair implements Serializable, Comparable<DottedPair> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.DottedPair");
   ...
   * The first element
   */
  public final hydra.lisp.syntax.Expression car;

  /**
   * The second element
   */
  public final hydra.lisp.syntax.Expression cdr;

  public DottedPair (hydra.lisp.syntax.Expression car, hydra.lisp.syntax.Expression cdr) {
    this.car = car;
    this.cdr = cdr;
  }
  ...
  public DottedPair withCar(hydra.lisp.syntax.Expression car) {
    return new DottedPair(car, cdr);
  }

  public DottedPair withCdr(hydra.lisp.syntax.Expression cdr) {
    return new DottedPair(car, cdr);
  }
}
