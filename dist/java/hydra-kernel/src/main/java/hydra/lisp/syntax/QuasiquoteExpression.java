...
public class QuasiquoteExpression implements Serializable, Comparable<QuasiquoteExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.QuasiquoteExpression");
  ...
  public QuasiquoteExpression (hydra.lisp.syntax.Expression body) {
    this.body = body;
  }
