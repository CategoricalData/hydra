...
public class MapLiteral implements Serializable, Comparable<MapLiteral> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.MapLiteral");
   ...
   * The key-value pairs
   */
  public final java.util.List<hydra.lisp.syntax.MapEntry> entries;

  public MapLiteral (java.util.List<hydra.lisp.syntax.MapEntry> entries) {
