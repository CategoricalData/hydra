...
public class SetLiteral implements Serializable, Comparable<SetLiteral> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.SetLiteral");
   ...
   * The set elements
   */
  public final java.util.List<hydra.lisp.syntax.Expression> elements;

  public SetLiteral (java.util.List<hydra.lisp.syntax.Expression> elements) {
