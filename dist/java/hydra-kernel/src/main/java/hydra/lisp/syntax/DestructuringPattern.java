...
public abstract class DestructuringPattern implements Serializable, Comparable<DestructuringPattern> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.DestructuringPattern");
   ...
   */
  public static final class Sequential extends hydra.lisp.syntax.DestructuringPattern implements Serializable {
    public final java.util.List<hydra.lisp.syntax.Symbol> value;

    public Sequential (java.util.List<hydra.lisp.syntax.Symbol> value) {
      this.value = value;
    }
   ...
   */
  public static final class Associative extends hydra.lisp.syntax.DestructuringPattern implements Serializable {
    public final java.util.List<hydra.lisp.syntax.Symbol> value;

    public Associative (java.util.List<hydra.lisp.syntax.Symbol> value) {
      this.value = value;
    }
   ...
   */
  public static final class Rest extends hydra.lisp.syntax.DestructuringPattern implements Serializable {
    public final java.util.List<hydra.lisp.syntax.Symbol> value;

    public Rest (java.util.List<hydra.lisp.syntax.Symbol> value) {
      this.value = value;
    }
