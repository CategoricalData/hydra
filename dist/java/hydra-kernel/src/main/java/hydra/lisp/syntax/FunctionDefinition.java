...
public class FunctionDefinition implements Serializable, Comparable<FunctionDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.FunctionDefinition");
   ...
   */
  public final java.util.List<hydra.lisp.syntax.TypeHint> typeHints;
  ...
  public FunctionDefinition (hydra.lisp.syntax.Symbol name, java.util.List<hydra.lisp.syntax.Symbol> params, hydra.util.Maybe<hydra.lisp.syntax.Symbol> restParam, hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc, java.util.List<hydra.lisp.syntax.TypeHint> typeHints, java.util.List<hydra.lisp.syntax.Expression> body) {
    this.name = name;
    this.params = params;
  ...
  public FunctionDefinition withName(hydra.lisp.syntax.Symbol name) {
    return new FunctionDefinition(name, params, restParam, doc, typeHints, body);
  }

  public FunctionDefinition withParams(java.util.List<hydra.lisp.syntax.Symbol> params) {
    return new FunctionDefinition(name, params, restParam, doc, typeHints, body);
  }

  public FunctionDefinition withRestParam(hydra.util.Maybe<hydra.lisp.syntax.Symbol> restParam) {
    return new FunctionDefinition(name, params, restParam, doc, typeHints, body);
  }

  public FunctionDefinition withDoc(hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc) {
    return new FunctionDefinition(name, params, restParam, doc, typeHints, body);
  }

  public FunctionDefinition withTypeHints(java.util.List<hydra.lisp.syntax.TypeHint> typeHints) {
    return new FunctionDefinition(name, params, restParam, doc, typeHints, body);
  }

  public FunctionDefinition withBody(java.util.List<hydra.lisp.syntax.Expression> body) {
    return new FunctionDefinition(name, params, restParam, doc, typeHints, body);
  }
}
