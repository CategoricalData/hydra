...
public class VariableReference implements Serializable, Comparable<VariableReference> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.VariableReference");
  ...
  public VariableReference (hydra.lisp.syntax.Symbol name, Boolean functionNamespace) {
    this.name = name;
  ...
  public VariableReference withName(hydra.lisp.syntax.Symbol name) {
