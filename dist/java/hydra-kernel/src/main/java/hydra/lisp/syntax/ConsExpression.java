...
public class ConsExpression implements Serializable, Comparable<ConsExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.ConsExpression");
   ...
   * The head element
   */
  public final hydra.lisp.syntax.Expression head;

  /**
   * The tail (typically a list or another cons)
   */
  public final hydra.lisp.syntax.Expression tail;

  public ConsExpression (hydra.lisp.syntax.Expression head, hydra.lisp.syntax.Expression tail) {
    this.head = head;
    this.tail = tail;
  }
  ...
  public ConsExpression withHead(hydra.lisp.syntax.Expression head) {
    return new ConsExpression(head, tail);
  }

  public ConsExpression withTail(hydra.lisp.syntax.Expression tail) {
    return new ConsExpression(head, tail);
  }
}
