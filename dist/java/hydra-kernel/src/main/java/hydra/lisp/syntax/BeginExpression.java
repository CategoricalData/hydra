...
public class BeginExpression implements Serializable, Comparable<BeginExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.BeginExpression");
  ...
  public BeginExpression (java.util.List<hydra.lisp.syntax.Expression> expressions) {
