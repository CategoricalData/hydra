...
public class ListLiteral implements Serializable, Comparable<ListLiteral> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.ListLiteral");
  ...
  public ListLiteral (java.util.List<hydra.lisp.syntax.Expression> elements, Boolean quoted) {
  ...
  public ListLiteral withElements(java.util.List<hydra.lisp.syntax.Expression> elements) {
