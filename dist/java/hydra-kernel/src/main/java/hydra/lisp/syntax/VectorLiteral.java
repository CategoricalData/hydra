...
public class VectorLiteral implements Serializable, Comparable<VectorLiteral> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.VectorLiteral");
  ...
  public VectorLiteral (java.util.List<hydra.lisp.syntax.Expression> elements) {
