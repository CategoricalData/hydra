...
public class FieldDefinition implements Serializable, Comparable<FieldDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.FieldDefinition");
   ...
   */
  public final hydra.util.Maybe<hydra.lisp.syntax.Expression> defaultValue;

  public FieldDefinition (hydra.lisp.syntax.Symbol name, hydra.util.Maybe<hydra.lisp.syntax.Expression> defaultValue) {
    this.name = name;
  ...
  public FieldDefinition withName(hydra.lisp.syntax.Symbol name) {
    return new FieldDefinition(name, defaultValue);
  }

  public FieldDefinition withDefaultValue(hydra.util.Maybe<hydra.lisp.syntax.Expression> defaultValue) {
    return new FieldDefinition(name, defaultValue);
  }
}
