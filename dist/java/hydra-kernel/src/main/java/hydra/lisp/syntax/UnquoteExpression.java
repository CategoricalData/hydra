...
public class UnquoteExpression implements Serializable, Comparable<UnquoteExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.UnquoteExpression");
  ...
  public UnquoteExpression (hydra.lisp.syntax.Expression body) {
    this.body = body;
  }
