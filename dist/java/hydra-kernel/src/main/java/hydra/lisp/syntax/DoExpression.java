...
public class DoExpression implements Serializable, Comparable<DoExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.DoExpression");
  ...
  public DoExpression (java.util.List<hydra.lisp.syntax.Expression> expressions) {
