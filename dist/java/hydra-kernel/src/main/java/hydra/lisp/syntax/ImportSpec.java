...
public abstract class ImportSpec implements Serializable, Comparable<ImportSpec> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.ImportSpec");
   ...
   * Import everything
   */
  public static final class All extends hydra.lisp.syntax.ImportSpec implements Serializable {
    public All () {
   ...
   */
  public static final class Alias extends hydra.lisp.syntax.ImportSpec implements Serializable {
    public final hydra.lisp.syntax.Symbol value;

    public Alias (hydra.lisp.syntax.Symbol value) {
      this.value = value;
    }
   ...
   */
  public static final class Only extends hydra.lisp.syntax.ImportSpec implements Serializable {
    public final java.util.List<hydra.lisp.syntax.Symbol> value;

    public Only (java.util.List<hydra.lisp.syntax.Symbol> value) {
      this.value = value;
    }
   ...
   */
  public static final class Rename extends hydra.lisp.syntax.ImportSpec implements Serializable {
    public final java.util.List<java.util.List<hydra.lisp.syntax.Symbol>> value;

    public Rename (java.util.List<java.util.List<hydra.lisp.syntax.Symbol>> value) {
      this.value = value;
    }
