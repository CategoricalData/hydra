...
public class TypeHint implements Serializable, Comparable<TypeHint> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.TypeHint");
  ...
  public TypeHint (hydra.lisp.syntax.Symbol name, hydra.lisp.syntax.TypeSpecifier type) {
    this.name = name;
    this.type = type;
  }
  ...
  public TypeHint withName(hydra.lisp.syntax.Symbol name) {
    return new TypeHint(name, type);
  }

  public TypeHint withType(hydra.lisp.syntax.TypeSpecifier type) {
    return new TypeHint(name, type);
  }
}
