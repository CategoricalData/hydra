...
public abstract class NilStyle implements Serializable, Comparable<NilStyle> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.NilStyle");
  ...
  public static final class Nil extends hydra.lisp.syntax.NilStyle implements Serializable {
    public Nil () {
  ...
  public static final class EmptyList extends hydra.lisp.syntax.NilStyle implements Serializable {
    public EmptyList () {
