...
public class TypeBounds implements Serializable, Comparable<TypeBounds> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.TypeBounds");
  ...
  public final hydra.util.Maybe<hydra.ext.scala.syntax.Type> lo;

  public final hydra.util.Maybe<hydra.ext.scala.syntax.Type> hi;

  public TypeBounds (hydra.util.Maybe<hydra.ext.scala.syntax.Type> lo, hydra.util.Maybe<hydra.ext.scala.syntax.Type> hi) {
    this.lo = lo;
    this.hi = hi;
  }
  ...
  public TypeBounds withHi(hydra.util.Maybe<hydra.ext.scala.syntax.Type> hi) {
    return new TypeBounds(lo, hi);
  }
}
