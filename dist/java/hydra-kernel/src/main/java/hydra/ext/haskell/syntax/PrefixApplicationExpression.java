...
public class PrefixApplicationExpression implements Serializable, Comparable<PrefixApplicationExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.PrefixApplicationExpression");
  ...
  public PrefixApplicationExpression (hydra.ext.haskell.syntax.Operator operator, hydra.ext.haskell.syntax.Expression rhs) {
  ...
  public PrefixApplicationExpression withOperator(hydra.ext.haskell.syntax.Operator operator) {
    return new PrefixApplicationExpression(operator, rhs);
  }

  public PrefixApplicationExpression withRhs(hydra.ext.haskell.syntax.Expression rhs) {
    return new PrefixApplicationExpression(operator, rhs);
  }
}
