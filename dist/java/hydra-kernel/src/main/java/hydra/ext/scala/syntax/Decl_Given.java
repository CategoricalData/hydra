...
public class Decl_Given implements Serializable, Comparable<Decl_Given> {
  ...
  public Decl_Given (java.util.List<hydra.ext.scala.syntax.Mod> mods, hydra.ext.scala.syntax.Data_Name name, java.util.List<hydra.ext.scala.syntax.Type_Param> tparams, java.util.List<java.util.List<hydra.ext.scala.syntax.Data_Param>> sparams, hydra.ext.scala.syntax.Type decltpe) {
    this.mods = mods;
    this.name = name;
  ...
  public Decl_Given withMods(java.util.List<hydra.ext.scala.syntax.Mod> mods) {
  ...
  public Decl_Given withTparams(java.util.List<hydra.ext.scala.syntax.Type_Param> tparams) {
    return new Decl_Given(mods, name, tparams, sparams, decltpe);
  }

  public Decl_Given withSparams(java.util.List<java.util.List<hydra.ext.scala.syntax.Data_Param>> sparams) {
    return new Decl_Given(mods, name, tparams, sparams, decltpe);
  }
