...
public class Case implements Serializable, Comparable<Case> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Case");
  ...
  public final hydra.util.Maybe<hydra.ext.scala.syntax.Data> cond;

  public final hydra.ext.scala.syntax.Data body;

  public Case (hydra.ext.scala.syntax.Pat pat, hydra.util.Maybe<hydra.ext.scala.syntax.Data> cond, hydra.ext.scala.syntax.Data body) {
    this.pat = pat;
    this.cond = cond;
    this.body = body;
  }
  ...
  public Case withCond(hydra.util.Maybe<hydra.ext.scala.syntax.Data> cond) {
    return new Case(pat, cond, body);
  }

  public Case withBody(hydra.ext.scala.syntax.Data body) {
    return new Case(pat, cond, body);
  }
}
