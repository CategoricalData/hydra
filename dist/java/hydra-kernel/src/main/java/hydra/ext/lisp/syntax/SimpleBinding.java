...
public class SimpleBinding implements Serializable, Comparable<SimpleBinding> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.SimpleBinding");
  ...
  public SimpleBinding (hydra.ext.lisp.syntax.Symbol name, hydra.ext.lisp.syntax.Expression value) {
    this.name = name;
    this.value = value;
  }
  ...
  public SimpleBinding withName(hydra.ext.lisp.syntax.Symbol name) {
    return new SimpleBinding(name, value);
  }

  public SimpleBinding withValue(hydra.ext.lisp.syntax.Expression value) {
    return new SimpleBinding(name, value);
  }
}
