...
public class Defn_Def implements Serializable, Comparable<Defn_Def> {
  ...
  public Defn_Def withMods(java.util.List<hydra.ext.scala.syntax.Mod> mods) {
  ...
  public Defn_Def withTparams(java.util.List<hydra.ext.scala.syntax.Type_Param> tparams) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withParamss(java.util.List<java.util.List<hydra.ext.scala.syntax.Data_Param>> paramss) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }
