...
public class RecordConstructor implements Serializable, Comparable<RecordConstructor> {
   ...
   */
  public final java.util.List<hydra.ext.haskell.syntax.FieldWithComments> fields;

  public RecordConstructor (hydra.ext.haskell.syntax.Name name, java.util.List<hydra.ext.haskell.syntax.FieldWithComments> fields) {
    this.name = name;
    this.fields = fields;
  }
  ...
  public RecordConstructor withFields(java.util.List<hydra.ext.haskell.syntax.FieldWithComments> fields) {
    return new RecordConstructor(name, fields);
  }
}
