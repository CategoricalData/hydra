...
public abstract class LambdaParameterType implements Serializable, Comparable<LambdaParameterType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.java.syntax.LambdaParameterType");
  ...
  public static final class Type extends hydra.ext.java.syntax.LambdaParameterType implements Serializable {
    ...
    public int compareTo(LambdaParameterType other) {
