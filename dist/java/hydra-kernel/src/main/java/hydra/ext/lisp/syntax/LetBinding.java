...
public abstract class LetBinding implements Serializable, Comparable<LetBinding> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.LetBinding");
   ...
   */
  public static final class Simple extends hydra.ext.lisp.syntax.LetBinding implements Serializable {
    public final hydra.ext.lisp.syntax.SimpleBinding value;

    public Simple (hydra.ext.lisp.syntax.SimpleBinding value) {
      this.value = value;
    }
   ...
   */
  public static final class Destructuring extends hydra.ext.lisp.syntax.LetBinding implements Serializable {
    public final hydra.ext.lisp.syntax.DestructuringBinding value;

    public Destructuring (hydra.ext.lisp.syntax.DestructuringBinding value) {
      this.value = value;
    }
