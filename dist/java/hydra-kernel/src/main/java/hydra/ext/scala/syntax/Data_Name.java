...
public class Data_Name implements Serializable, Comparable<Data_Name> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Data_Name");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.ext.scala.syntax.PredefString value;

  public Data_Name (hydra.ext.scala.syntax.PredefString value) {
    this.value = value;
  }
