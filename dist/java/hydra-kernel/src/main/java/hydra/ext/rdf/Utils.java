...
public interface Utils {
  ...
  static hydra.ext.org.w3.rdf.syntax.Literal encodeLiteral(hydra.core.Literal lit) {
    return (lit).accept(new hydra.core.Literal.PartialVisitor<>() {
      ...
      public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.Literal.Binary s) {
        return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.BinaryToString.apply((s).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("base64Binary"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
      }
      ...
      public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.Literal.Boolean_ b) {
        return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.logic.IfElse.lazy(
          (b).value,
          () -> "true",
          () -> "false"), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("boolean"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
      }
      ...
      public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.Literal.Float_ f) {
        return (f).value.accept(new hydra.core.FloatValue.PartialVisitor<>() {
          ...
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.FloatValue.Bigfloat v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowBigfloat.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("decimal"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.FloatValue.Float32 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowFloat32.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("float"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.FloatValue.Float64 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowFloat64.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("double"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }
        });
      }
      ...
      public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.Literal.Integer_ i) {
        return (i).value.accept(new hydra.core.IntegerValue.PartialVisitor<>() {
          ...
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Bigint v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowBigint.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("integer"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Int8 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowInt8.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("byte"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Int16 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowInt16.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("short"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Int32 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowInt32.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("int"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Int64 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowInt64.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("long"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Uint8 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowUint8.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("unsignedByte"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Uint16 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowUint16.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("unsignedShort"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Uint32 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowUint32.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("unsignedInt"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }

          @Override
          public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.IntegerValue.Uint64 v) {
            return new hydra.ext.org.w3.rdf.syntax.Literal(hydra.lib.literals.ShowUint64.apply((v).value), hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("unsignedLong"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
          }
        });
      }
      ...
      public hydra.ext.org.w3.rdf.syntax.Literal visit(hydra.core.Literal.String_ s) {
        return new hydra.ext.org.w3.rdf.syntax.Literal((s).value, hydra.ext.rdf.Utils.xmlSchemaDatatypeIri("string"), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.LanguageTag>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.LanguageTag>nothing()));
      }
    });
  }
  ...
  static hydra.util.Pair<hydra.ext.org.w3.rdf.syntax.Resource, hydra.context.Context> nextBlankNode(hydra.context.Context cx) {
    hydra.util.Pair<Integer, hydra.context.Context> result = hydra.Annotations.nextCount(
      hydra.ext.rdf.Utils.key_rdfBlankNodeCounter(),
      cx);
