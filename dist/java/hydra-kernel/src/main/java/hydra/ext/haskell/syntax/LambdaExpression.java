...
public class LambdaExpression implements Serializable, Comparable<LambdaExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.LambdaExpression");
  ...
  public LambdaExpression withInner(hydra.ext.haskell.syntax.Expression inner) {
    return new LambdaExpression(bindings, inner);
  }
}
