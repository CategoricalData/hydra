...
public class Data_PolyFunction implements Serializable, Comparable<Data_PolyFunction> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Data_PolyFunction");
  ...
  public Data_PolyFunction withBody(hydra.ext.scala.syntax.Data body) {
    return new Data_PolyFunction(tparams, body);
  }
}
