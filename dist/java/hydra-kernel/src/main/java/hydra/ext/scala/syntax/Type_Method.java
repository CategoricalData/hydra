...
public class Type_Method implements Serializable, Comparable<Type_Method> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Type_Method");
  ...
  public Type_Method withTpe(hydra.ext.scala.syntax.Type tpe) {
    return new Type_Method(paramss, tpe);
  }
}
