...
public class Import implements Serializable, Comparable<Import> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.Import");
   ...
   */
  public final hydra.haskell.syntax.ModuleName module;

  /**
   * Optional alias for the module
   */
  public final hydra.util.Maybe<hydra.haskell.syntax.ModuleName> as;

  /**
   * Optional import specification
   */
  public final hydra.util.Maybe<hydra.haskell.syntax.SpecImport> spec;

  public Import (Boolean qualified, hydra.haskell.syntax.ModuleName module, hydra.util.Maybe<hydra.haskell.syntax.ModuleName> as, hydra.util.Maybe<hydra.haskell.syntax.SpecImport> spec) {
  ...
  public Import withModule(hydra.haskell.syntax.ModuleName module) {
    return new Import(qualified, module, as, spec);
  }

  public Import withAs(hydra.util.Maybe<hydra.haskell.syntax.ModuleName> as) {
    return new Import(qualified, module, as, spec);
  }

  public Import withSpec(hydra.util.Maybe<hydra.haskell.syntax.SpecImport> spec) {
    return new Import(qualified, module, as, spec);
  }
}
