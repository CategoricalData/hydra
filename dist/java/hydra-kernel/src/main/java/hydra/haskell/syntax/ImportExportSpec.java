...
public class ImportExportSpec implements Serializable, Comparable<ImportExportSpec> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.ImportExportSpec");
   ...
   */
  public final hydra.util.Maybe<hydra.haskell.syntax.ImportModifier> modifier;
   ...
   */
  public final hydra.util.Maybe<hydra.haskell.syntax.SubspecImportExportSpec> subspec;

  public ImportExportSpec (hydra.util.Maybe<hydra.haskell.syntax.ImportModifier> modifier, hydra.haskell.syntax.Name name, hydra.util.Maybe<hydra.haskell.syntax.SubspecImportExportSpec> subspec) {
  ...
  public ImportExportSpec withModifier(hydra.util.Maybe<hydra.haskell.syntax.ImportModifier> modifier) {
    return new ImportExportSpec(modifier, name, subspec);
  }

  public ImportExportSpec withName(hydra.haskell.syntax.Name name) {
    return new ImportExportSpec(modifier, name, subspec);
  }

  public ImportExportSpec withSubspec(hydra.util.Maybe<hydra.haskell.syntax.SubspecImportExportSpec> subspec) {
    return new ImportExportSpec(modifier, name, subspec);
  }
}
