...
public class ConstructRecordExpression implements Serializable, Comparable<ConstructRecordExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.ConstructRecordExpression");
  ...
  public ConstructRecordExpression (hydra.haskell.syntax.Name name, java.util.List<hydra.haskell.syntax.FieldUpdate> fields) {
    this.name = name;
    this.fields = fields;
  }
  ...
  public ConstructRecordExpression withName(hydra.haskell.syntax.Name name) {
    return new ConstructRecordExpression(name, fields);
  }

  public ConstructRecordExpression withFields(java.util.List<hydra.haskell.syntax.FieldUpdate> fields) {
    return new ConstructRecordExpression(name, fields);
  }
}
