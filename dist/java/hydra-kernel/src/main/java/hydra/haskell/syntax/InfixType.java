...
public class InfixType implements Serializable, Comparable<InfixType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.InfixType");
   ...
   * The left-hand type
   */
  public final hydra.haskell.syntax.Type lhs;
   ...
   */
  public final hydra.haskell.syntax.Operator rhs;

  public InfixType (hydra.haskell.syntax.Type lhs, hydra.haskell.syntax.Operator operator, hydra.haskell.syntax.Operator rhs) {
    this.lhs = lhs;
  ...
  public InfixType withLhs(hydra.haskell.syntax.Type lhs) {
    return new InfixType(lhs, operator, rhs);
  }

  public InfixType withOperator(hydra.haskell.syntax.Operator operator) {
    return new InfixType(lhs, operator, rhs);
  }

  public InfixType withRhs(hydra.haskell.syntax.Operator rhs) {
    return new InfixType(lhs, operator, rhs);
  }
}
