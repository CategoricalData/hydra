...
public abstract class Export implements Serializable, Comparable<Export> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.Export");
   ...
   */
  public static final class Declaration extends hydra.haskell.syntax.Export implements Serializable {
    public final hydra.haskell.syntax.ImportExportSpec value;

    public Declaration (hydra.haskell.syntax.ImportExportSpec value) {
      this.value = value;
    }
   ...
   * An exported module
   */
  public static final class Module extends hydra.haskell.syntax.Export implements Serializable {
    public final hydra.haskell.syntax.ModuleName value;

    public Module (hydra.haskell.syntax.ModuleName value) {
      this.value = value;
    }
