...
public class Field implements Serializable, Comparable<Field> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.Field");
  ...
  public Field (hydra.haskell.syntax.Name name, hydra.haskell.syntax.Type type) {
    this.name = name;
    this.type = type;
  }
  ...
  public Field withName(hydra.haskell.syntax.Name name) {
    return new Field(name, type);
  }

  public Field withType(hydra.haskell.syntax.Type type) {
    return new Field(name, type);
  }
}
