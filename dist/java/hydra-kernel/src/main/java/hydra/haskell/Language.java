...
public interface Language {
  static hydra.coders.Language haskellLanguage() {
    ...
    return new hydra.coders.Language(new hydra.coders.LanguageName("hydra.haskell"), new hydra.coders.LanguageConstraints(eliminationVariants.get(), literalVariants.get(), floatTypes.get(), functionVariants.get(), integerTypes.get(), termVariants.get(), typeVariants.get(), p0 -> hydra.haskell.Language.<hydra.core.Type>haskellLanguage_typePredicate(p0)));
  }
