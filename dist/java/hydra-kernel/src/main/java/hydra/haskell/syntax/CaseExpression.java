...
public class CaseExpression implements Serializable, Comparable<CaseExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.CaseExpression");
   ...
   */
  public final hydra.haskell.syntax.Expression case_;

  /**
   * The pattern-matching alternatives
   */
  public final java.util.List<hydra.haskell.syntax.Alternative> alternatives;

  public CaseExpression (hydra.haskell.syntax.Expression case_, java.util.List<hydra.haskell.syntax.Alternative> alternatives) {
    this.case_ = case_;
  ...
  public CaseExpression withCase(hydra.haskell.syntax.Expression case_) {
    return new CaseExpression(case_, alternatives);
  }

  public CaseExpression withAlternatives(java.util.List<hydra.haskell.syntax.Alternative> alternatives) {
    return new CaseExpression(case_, alternatives);
  }
}
