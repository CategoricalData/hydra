...
public class ConstructorWithComments implements Serializable, Comparable<ConstructorWithComments> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.ConstructorWithComments");
   ...
   * The constructor
   */
  public final hydra.haskell.syntax.Constructor body;
  ...
  public ConstructorWithComments (hydra.haskell.syntax.Constructor body, hydra.util.Maybe<String> comments) {
    this.body = body;
  ...
  public ConstructorWithComments withBody(hydra.haskell.syntax.Constructor body) {
