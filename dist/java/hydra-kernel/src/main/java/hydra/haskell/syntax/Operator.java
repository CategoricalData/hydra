...
public abstract class Operator implements Serializable, Comparable<Operator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.Operator");
   ...
   */
  public static final class Backtick extends hydra.haskell.syntax.Operator implements Serializable {
    public final hydra.haskell.syntax.QualifiedName value;

    public Backtick (hydra.haskell.syntax.QualifiedName value) {
      this.value = value;
    }
   ...
   */
  public static final class Normal extends hydra.haskell.syntax.Operator implements Serializable {
    public final hydra.haskell.syntax.QualifiedName value;
