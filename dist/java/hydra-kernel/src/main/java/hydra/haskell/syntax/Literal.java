...
public abstract class Literal implements Serializable, Comparable<Literal> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.Literal");
   ...
   * A character literal
   */
  public static final class Char extends hydra.haskell.syntax.Literal implements Serializable {
   ...
   */
  public static final class Double_ extends hydra.haskell.syntax.Literal implements Serializable {
   ...
   */
  public static final class Float_ extends hydra.haskell.syntax.Literal implements Serializable {
   ...
   */
  public static final class Int extends hydra.haskell.syntax.Literal implements Serializable {
   ...
   */
  public static final class Integer_ extends hydra.haskell.syntax.Literal implements Serializable {
   ...
   * A string literal
   */
  public static final class String_ extends hydra.haskell.syntax.Literal implements Serializable {
