...
public abstract class ImportModifier implements Serializable, Comparable<ImportModifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.ImportModifier");
  ...
  public static final class Pattern extends hydra.haskell.syntax.ImportModifier implements Serializable {
    public Pattern () {
  ...
  public static final class Type extends hydra.haskell.syntax.ImportModifier implements Serializable {
    public Type () {
