...
public abstract class SubspecImportExportSpec implements Serializable, Comparable<SubspecImportExportSpec> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.SubspecImportExportSpec");
   ...
   * Import/export all
   */
  public static final class All extends hydra.haskell.syntax.SubspecImportExportSpec implements Serializable {
    public All () {
   ...
   */
  public static final class List extends hydra.haskell.syntax.SubspecImportExportSpec implements Serializable {
    public final java.util.List<hydra.haskell.syntax.Name> value;

    public List (java.util.List<hydra.haskell.syntax.Name> value) {
      this.value = value;
    }
