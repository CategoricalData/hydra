...
public class ClassAssertion implements Serializable, Comparable<ClassAssertion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.ClassAssertion");
   ...
   */
  public final java.util.List<hydra.haskell.syntax.Type> types;

  public ClassAssertion (hydra.haskell.syntax.Name name, java.util.List<hydra.haskell.syntax.Type> types) {
    this.name = name;
    this.types = types;
  }
  ...
  public ClassAssertion withName(hydra.haskell.syntax.Name name) {
    return new ClassAssertion(name, types);
  }

  public ClassAssertion withTypes(java.util.List<hydra.haskell.syntax.Type> types) {
    return new ClassAssertion(name, types);
  }
}
