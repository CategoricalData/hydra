...
public class ModuleHead implements Serializable, Comparable<ModuleHead> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.ModuleHead");
   ...
   * The module name
   */
  public final hydra.haskell.syntax.ModuleName name;

  /**
   * Export list
   */
  public final java.util.List<hydra.haskell.syntax.Export> exports;

  public ModuleHead (hydra.util.Maybe<String> comments, hydra.haskell.syntax.ModuleName name, java.util.List<hydra.haskell.syntax.Export> exports) {
  ...
  public ModuleHead withName(hydra.haskell.syntax.ModuleName name) {
    return new ModuleHead(comments, name, exports);
  }

  public ModuleHead withExports(java.util.List<hydra.haskell.syntax.Export> exports) {
    return new ModuleHead(comments, name, exports);
  }
}
