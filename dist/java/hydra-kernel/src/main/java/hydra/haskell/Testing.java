...
public interface Testing {
  static hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName> addNamespacesToNamespaces(hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName> ns0, java.util.Set<hydra.core.Name> names) {
    ...
    return (hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>) (new hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>(((java.util.function.Function<hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>, hydra.util.Pair<hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName>>) (projected -> projected.focus)).apply(ns0), hydra.lib.maps.Union.apply(
      ((java.util.function.Function<hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>, java.util.Map<hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName>>) (projected -> projected.mapping)).apply(ns0),
      newMappings.get())));
  }

  static hydra.util.Either<String, hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>> buildNamespacesForTestGroup(hydra.packaging.Module mod, hydra.testing.TestGroup tgroup, hydra.graph.Graph graph_) {
    java.util.List<hydra.testing.TestCaseWithMetadata> testCases_ = hydra.haskell.Testing.collectTestCases(tgroup);
    hydra.util.Lazy<java.util.List<hydra.core.Binding>> testBindings = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      ...
      hydra.haskell.Testing.buildNamespacesForTestGroup_testTerms(testCases_)));
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.Bimap.apply(
        ...
        (java.util.function.Function<hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>, hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>>) (a -> a),
        hydra.haskell.Utils.namespacesForModule(
          tempModule.get(),
          hydra.Lexical.emptyContext(),
          graph_)),
      (java.util.function.Function<hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>, hydra.util.Either<String, hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>>>) (baseNamespaces -> {
        hydra.util.Lazy<java.util.Set<hydra.core.Name>> encodedNames = new hydra.util.Lazy<>(() -> hydra.lib.sets.Unions.apply(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.core.Term, java.util.Set<hydra.core.Name>>) (t -> hydra.haskell.Testing.extractEncodedTermVariableNames(
            graph_,
            t)),
          hydra.haskell.Testing.buildNamespacesForTestGroup_testTerms(testCases_))));
        return hydra.util.Either.<String, hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>>right(hydra.haskell.Testing.addNamespacesToNamespaces(
          baseNamespaces,
          encodedNames.get()));
      }));
  }
  ...
  static <T0> java.util.List<T0> buildNamespacesForTestGroup_testTerms(java.util.List<hydra.testing.TestCaseWithMetadata> testCases_) {
    return hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
      p0 -> hydra.haskell.Testing.<hydra.testing.TestCaseWithMetadata, T0>extractTestTerms(p0),
      testCases_));
  }
  ...
  static <T0> String buildTestModule(hydra.packaging.Module testModule, hydra.testing.TestGroup testGroup, String testBody, hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName> namespaces) {
    ...
    hydra.packaging.Namespace specNs = new hydra.packaging.Namespace(hydra.lib.strings.Cat2.apply(
      (ns_).value,
      "Spec"));
    String moduleNameString = hydra.haskell.Testing.namespaceToModuleName(specNs);
  ...
  static java.util.List<hydra.testing.TestCaseWithMetadata> collectTestCases(hydra.testing.TestGroup tg) {
    return hydra.lib.lists.Concat2.apply(
      ...
      hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
        hydra.haskell.Testing::collectTestCases,
        (tg).subgroups)));
  }
  ...
  static java.util.Set<hydra.core.Name> extractEncodedTermVariableNames(hydra.graph.Graph graf, hydra.core.Term term) {
    return hydra.Rewriting.foldOverTerm(
      ...
      (java.util.function.Function<java.util.Set<hydra.core.Name>, java.util.function.Function<hydra.core.Term, java.util.Set<hydra.core.Name>>>) (v1 -> (java.util.function.Function<hydra.core.Term, java.util.Set<hydra.core.Name>>) (v2 -> hydra.haskell.Testing.collectNames(
        graf,
        v1,
        v2))),
  ...
  static <T0> java.util.List<String> findHaskellImports(hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName> namespaces, T0 names_) {
    ...
    return hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.util.Pair<hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName>, String>) (entry -> hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
        "import qualified ",
  ...
  static hydra.util.Either<String, hydra.util.Pair<String, String>> generateHaskellTestFile(hydra.packaging.Module testModule, hydra.testing.TestGroup testGroup, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bind.apply(
      hydra.haskell.Testing.buildNamespacesForTestGroup(
        testModule,
        testGroup,
        g),
      (java.util.function.Function<hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName>, hydra.util.Either<String, hydra.util.Pair<String, String>>>) (namespaces -> hydra.haskell.Testing.generateTestFile(
        testModule,
        testGroup,
        namespaces)));
  }
  ...
  static <T0> hydra.util.Either<T0, hydra.util.Pair<String, String>> generateTestFile(hydra.packaging.Module testModule, hydra.testing.TestGroup testGroup, hydra.packaging.Namespaces<hydra.haskell.syntax.ModuleName> namespaces) {
    return hydra.lib.eithers.Map.apply(
      (java.util.function.Function<String, hydra.util.Pair<String, String>>) (testBody -> {
        ...
        String filePath = hydra.Names.namespaceToFilePath(
          ...
          specNs);
        String testModuleContent = hydra.haskell.Testing.buildTestModule(
          testModule,
          testGroup,
          testBody,
          namespaces);
      ...
      hydra.haskell.Testing.<T0>generateTestGroupHierarchy(
        1,
        testGroup));
  }
  ...
  static <T0> hydra.util.Either<T0, String> generateTestGroupHierarchy(Integer depth, hydra.testing.TestGroup testGroup) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.MapList.apply(
        (java.util.function.Function<hydra.testing.TestCaseWithMetadata, hydra.util.Either<T0, java.util.List<String>>>) (tc -> hydra.haskell.Testing.<Integer, T0>generateTestCase(
          depth,
          tc)),
        cases_),
