...
public class ApplicationDeclarationHead implements Serializable, Comparable<ApplicationDeclarationHead> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.haskell.syntax.ApplicationDeclarationHead");
   ...
   */
  public final hydra.haskell.syntax.DeclarationHead function;

  /**
   * The type variable operand
   */
  public final hydra.haskell.syntax.Variable operand;

  public ApplicationDeclarationHead (hydra.haskell.syntax.DeclarationHead function, hydra.haskell.syntax.Variable operand) {
  ...
  public ApplicationDeclarationHead withFunction(hydra.haskell.syntax.DeclarationHead function) {
    return new ApplicationDeclarationHead(function, operand);
  }

  public ApplicationDeclarationHead withOperand(hydra.haskell.syntax.Variable operand) {
    return new ApplicationDeclarationHead(function, operand);
  }
}
