    ...
    return new hydra.testing.TestGroup("Case statements", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (java.util.List<hydra.testing.TestGroup>) (java.util.Collections.<hydra.testing.TestGroup>emptyList()), java.util.Arrays.asList(
      new hydra.testing.TestCaseWithMetadata("#1", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.eithers.Either.apply(
        ...
        hydra.Inference.inferTypeOf(
          ...
          new hydra.core.Term.Cases(new hydra.core.CaseStatement(hydra.test.TestTypes.testTypeSimpleNumberName(), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), java.util.Arrays.asList(
            new hydra.core.Field(new hydra.core.Name("int"), new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("x"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Variable(new hydra.core.Name("x"))))),
      ...
      new hydra.testing.TestCaseWithMetadata("#2", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.eithers.Either.apply(
        ...
        hydra.Inference.inferTypeOf(
          hydra.test.TestGraph.testContext(),
          hydra.test.TestGraph.testGraph(),
          new hydra.core.Term.Cases(new hydra.core.CaseStatement(hydra.test.TestTypes.testTypeUnionMonomorphicName(), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), java.util.Arrays.asList(
            new hydra.core.Field(new hydra.core.Name("bool"), new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("_"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Literal(new hydra.core.Literal.Boolean_(true))))),
            new hydra.core.Field(new hydra.core.Name("string"), new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("_"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Literal(new hydra.core.Literal.Boolean_(false))))),
            new hydra.core.Field(new hydra.core.Name("unit"), new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("_"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Literal(new hydra.core.Literal.Boolean_(false)))))))))), hydra.show.Core.typeScheme(new hydra.core.TypeScheme((java.util.List<hydra.core.Name>) (java.util.Collections.<hydra.core.Name>emptyList()), new hydra.core.Type.Function(new hydra.core.FunctionType(new hydra.core.Type.Variable(hydra.test.TestTypes.testTypeUnionMonomorphicName()), new hydra.core.Type.Literal(new hydra.core.LiteralType.Boolean_()))), (hydra.util.Maybe<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) (hydra.util.Maybe.<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>nothing()))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), java.util.Arrays.asList(new hydra.testing.Tag("disabledForMinimalInference")))));
  }
      ...
      new hydra.testing.TestGroup("Simple records", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (java.util.List<hydra.testing.TestGroup>) (java.util.Collections.<hydra.testing.TestGroup>emptyList()), java.util.Arrays.asList(
        ...
        new hydra.testing.TestCaseWithMetadata("#3", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.eithers.Either.apply(
          ...
          hydra.Inference.inferTypeOf(
            hydra.test.TestGraph.testContext(),
            hydra.test.TestGraph.testGraph(),
            new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("lon"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Record(new hydra.core.Record(hydra.test.TestTypes.testTypeLatLonPolyName(), java.util.Arrays.asList(
              new hydra.core.Field(new hydra.core.Name("lat"), new hydra.core.Term.Literal(new hydra.core.Literal.Float_(new hydra.core.FloatValue.Float32((float) (37.774898529052734))))),
        ...
        new hydra.testing.TestCaseWithMetadata("#4", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.eithers.Either.apply(
          ...
          hydra.Inference.inferTypeOf(
            hydra.test.TestGraph.testContext(),
            hydra.test.TestGraph.testGraph(),
            new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("latlon"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Record(new hydra.core.Record(hydra.test.TestTypes.testTypeLatLonPolyName(), java.util.Arrays.asList(
      ...
      new hydra.testing.TestGroup("Record instances of simply recursive record types", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (java.util.List<hydra.testing.TestGroup>) (java.util.Collections.<hydra.testing.TestGroup>emptyList()), java.util.Arrays.asList(
        ...
        new hydra.testing.TestCaseWithMetadata("#5", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.eithers.Either.apply(
          ...
          hydra.Inference.inferTypeOf(
            hydra.test.TestGraph.testContext(),
            hydra.test.TestGraph.testGraph(),
            new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("x"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Record(new hydra.core.Record(hydra.test.TestTypes.testTypeListName(), java.util.Arrays.asList(
              new hydra.core.Field(new hydra.core.Name("head"), new hydra.core.Term.Variable(new hydra.core.Name("x"))),
              new hydra.core.Field(new hydra.core.Name("tail"), new hydra.core.Term.Maybe(hydra.util.Maybe.just(new hydra.core.Term.Record(new hydra.core.Record(hydra.test.TestTypes.testTypeListName(), java.util.Arrays.asList(
                new hydra.core.Field(new hydra.core.Name("head"), new hydra.core.Term.Variable(new hydra.core.Name("x"))),
      ...
      new hydra.testing.TestGroup("Record instances of mutually recursive record types", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (java.util.List<hydra.testing.TestGroup>) (java.util.Collections.<hydra.testing.TestGroup>emptyList()), java.util.Arrays.asList(
        ...
        new hydra.testing.TestCaseWithMetadata("#2", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.eithers.Either.apply(
          ...
          hydra.Inference.inferTypeOf(
            hydra.test.TestGraph.testContext(),
            hydra.test.TestGraph.testGraph(),
            new hydra.core.Term.Lambda(new hydra.core.Lambda(new hydra.core.Name("x"), (hydra.util.Maybe<hydra.core.Type>) (hydra.util.Maybe.<hydra.core.Type>nothing()), new hydra.core.Term.Record(new hydra.core.Record(hydra.test.TestTypes.testTypeBuddyListAName(), java.util.Arrays.asList(
              new hydra.core.Field(new hydra.core.Name("head"), new hydra.core.Term.Variable(new hydra.core.Name("x"))),
              new hydra.core.Field(new hydra.core.Name("tail"), new hydra.core.Term.Maybe(hydra.util.Maybe.just(new hydra.core.Term.Record(new hydra.core.Record(hydra.test.TestTypes.testTypeBuddyListBName(), java.util.Arrays.asList(
                new hydra.core.Field(new hydra.core.Name("head"), new hydra.core.Term.Variable(new hydra.core.Name("x"))),
