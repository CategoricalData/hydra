 ...
 */
public abstract class ProjectionSpec implements Serializable, Comparable<ProjectionSpec> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("com.gdblab.pathAlgebra.expressions.ProjectionSpec");
  ...
  public static final class All extends com.gdblab.pathAlgebra.expressions.ProjectionSpec implements Serializable {
    public All () {
  ...
  public static final class Limited extends com.gdblab.pathAlgebra.expressions.ProjectionSpec implements Serializable {
    public final Integer value;

    public Limited (Integer value) {
      this.value = value;
    }
