...
public abstract class ComparisonOperator implements Serializable, Comparable<ComparisonOperator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("com.gdblab.pathAlgebra.expressions.ComparisonOperator");
  ...
  public static final class Equal extends com.gdblab.pathAlgebra.expressions.ComparisonOperator implements Serializable {
    public Equal () {
  ...
  public static final class NotEqual extends com.gdblab.pathAlgebra.expressions.ComparisonOperator implements Serializable {
    public NotEqual () {
  ...
  public static final class LessThan extends com.gdblab.pathAlgebra.expressions.ComparisonOperator implements Serializable {
    public LessThan () {
  ...
  public static final class LessThanOrEqual extends com.gdblab.pathAlgebra.expressions.ComparisonOperator implements Serializable {
  ...
  public static final class GreaterThan extends com.gdblab.pathAlgebra.expressions.ComparisonOperator implements Serializable {
    public GreaterThan () {
  ...
  public static final class GreaterThanOrEqual extends com.gdblab.pathAlgebra.expressions.ComparisonOperator implements Serializable {
