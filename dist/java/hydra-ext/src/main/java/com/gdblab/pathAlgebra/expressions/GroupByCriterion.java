 ...
 */
public abstract class GroupByCriterion implements Serializable, Comparable<GroupByCriterion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("com.gdblab.pathAlgebra.expressions.GroupByCriterion");
  ...
  public static final class None extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
    public None () {
    ...
    public int compareTo(GroupByCriterion other) {
  ...
  public static final class Source extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
    public Source () {
  ...
  public static final class Target extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
    public Target () {
  ...
  public static final class Length extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
    public Length () {
  ...
  public static final class SourceTarget extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
    public SourceTarget () {
  ...
  public static final class SourceLength extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
    public SourceLength () {
  ...
  public static final class TargetLength extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
    public TargetLength () {
  ...
  public static final class SourceTargetLength extends com.gdblab.pathAlgebra.expressions.GroupByCriterion implements Serializable {
