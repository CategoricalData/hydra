...
public abstract class PrimaryValueExpression implements Serializable, Comparable<PrimaryValueExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("openGql.grammar.PrimaryValueExpression");
  ...
  public static final hydra.core.Name BINDING_VARIABLE_REFERENCE = new hydra.core.Name("bindingVariableReference");

  private PrimaryValueExpression () {
  ...
  public interface Visitor<R> {
    ...
    R visit(BindingVariableReference instance) ;
  }

  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(PrimaryValueExpression instance) {
    ...
    default R visit(BindingVariableReference instance) {
      return otherwise(instance);
    }
  }

  public static final class Parenthesized extends openGql.grammar.PrimaryValueExpression implements Serializable {
    ...
    public int compareTo(PrimaryValueExpression other) {
  ...
  public static final class AggregateFunction extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class UnsignedValueSpecification extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class PathValueConstructor extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class PropertyReference extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class ValueQueryExpression extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class CaseExpression extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class CastSpecification extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class ElementIdFunction extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class LetValueExpression extends openGql.grammar.PrimaryValueExpression implements Serializable {
  ...
  public static final class BindingVariableReference extends openGql.grammar.PrimaryValueExpression implements Serializable {
    public final String value;

    public BindingVariableReference (String value) {
      this.value = value;
    }

    @Override
    public boolean equals(Object other) {
      if (!(other instanceof BindingVariableReference)) {
        return false;
      }
      BindingVariableReference o = (BindingVariableReference) other;
      return java.util.Objects.equals(
        this.value,
        o.value);
    }
