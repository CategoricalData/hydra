...
public abstract class NumericType implements Serializable, Comparable<NumericType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("openGql.grammar.NumericType");
  ...
  public static final class Exact extends openGql.grammar.NumericType implements Serializable {
    public final openGql.grammar.ExactNumericType value;

    public Exact (openGql.grammar.ExactNumericType value) {
      this.value = value;
    }
  ...
  public static final class Approximate extends openGql.grammar.NumericType implements Serializable {
    public final openGql.grammar.ApproximateNumericType value;

    public Approximate (openGql.grammar.ApproximateNumericType value) {
      this.value = value;
    }
