...
public abstract class EdgeTypeImpliedContent implements Serializable, Comparable<EdgeTypeImpliedContent> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("openGql.grammar.EdgeTypeImpliedContent");
  ...
  private EdgeTypeImpliedContent () {
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(EdgeTypeImpliedContent instance) {
  ...
  public static final class LabelSet extends openGql.grammar.EdgeTypeImpliedContent implements Serializable {
    ...
    public int compareTo(EdgeTypeImpliedContent other) {
  ...
  public static final class PropertyTypes extends openGql.grammar.EdgeTypeImpliedContent implements Serializable {
  ...
  public static final class LabelSetWithProperties extends openGql.grammar.EdgeTypeImpliedContent implements Serializable {
    public final openGql.grammar.EdgeLabelSetWithProperties value;

    public LabelSetWithProperties (openGql.grammar.EdgeLabelSetWithProperties value) {
      this.value = value;
    }
