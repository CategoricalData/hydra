...
public abstract class LocaltimeType implements Serializable, Comparable<LocaltimeType> {
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(LocaltimeType instance) {
  ...
  public static final class LocalTime extends openGql.grammar.LocaltimeType implements Serializable {
  ...
  public static final class TimeWithoutTimeZone extends openGql.grammar.LocaltimeType implements Serializable {
