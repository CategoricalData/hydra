...
public interface Printing {
  static <T0> String printEdge(java.util.function.Function<T0, String> printValue, hydra.pg.model.Edge<T0> edge) {
    ...
    hydra.util.Lazy<String> props = new hydra.util.Lazy<>(() -> hydra.lib.strings.Intercalate.apply(
      ...
      hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.util.Pair<hydra.pg.model.PropertyKey, T0>, String>) (p -> hydra.pg.Printing.<T0>printProperty(
          printValue,
          hydra.lib.pairs.First.apply(p),
          hydra.lib.pairs.Second.apply(p))),
        hydra.lib.maps.ToList.apply(((java.util.function.Function<hydra.pg.model.Edge<T0>, java.util.Map<hydra.pg.model.PropertyKey, T0>>) (projected -> projected.properties)).apply(edge)))));
  ...
  static <T0> String printGraph(java.util.function.Function<T0, String> printValue, hydra.pg.model.Graph<T0> graph) {
    return hydra.pg.Printing.<T0>printLazyGraph(
      printValue,
      (hydra.pg.model.LazyGraph<T0>) (new hydra.pg.model.LazyGraph<T0>(hydra.lib.maps.Elems.apply(((java.util.function.Function<hydra.pg.model.Graph<T0>, java.util.Map<T0, hydra.pg.model.Vertex<T0>>>) (projected -> projected.vertices)).apply(graph)), hydra.lib.maps.Elems.apply(((java.util.function.Function<hydra.pg.model.Graph<T0>, java.util.Map<T0, hydra.pg.model.Edge<T0>>>) (projected -> projected.edges)).apply(graph)))));
  }
  ...
  static <T0> String printLazyGraph(java.util.function.Function<T0, String> printValue, hydra.pg.model.LazyGraph<T0> lg) {
    return hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
      ...
      hydra.lib.strings.Cat.apply(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.pg.model.Vertex<T0>, String>) (v -> hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
          "\n\t",
          hydra.pg.Printing.<T0>printVertex(
            printValue,
            v)))),
        hydra.pg.Printing.<T0>printLazyGraph_vertices(lg))),
      "\nedges:",
      hydra.lib.strings.Cat.apply(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.pg.model.Edge<T0>, String>) (e -> hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
          "\n\t",
          hydra.pg.Printing.<T0>printEdge(
            printValue,
            e)))),
        hydra.pg.Printing.<T0>printLazyGraph_edges(lg)))));
  }

  static <T0> java.util.List<hydra.pg.model.Edge<T0>> printLazyGraph_edges(hydra.pg.model.LazyGraph<T0> lg) {
    return ((java.util.function.Function<hydra.pg.model.LazyGraph<T0>, java.util.List<hydra.pg.model.Edge<T0>>>) (projected -> projected.edges)).apply(lg);
  }

  static <T0> java.util.List<hydra.pg.model.Vertex<T0>> printLazyGraph_vertices(hydra.pg.model.LazyGraph<T0> lg) {
    return ((java.util.function.Function<hydra.pg.model.LazyGraph<T0>, java.util.List<hydra.pg.model.Vertex<T0>>>) (projected -> projected.vertices)).apply(lg);
  }
    ...
    hydra.util.Lazy<String> props = new hydra.util.Lazy<>(() -> hydra.lib.strings.Intercalate.apply(
      ...
      hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.util.Pair<hydra.pg.model.PropertyKey, T0>, String>) (p -> hydra.pg.Printing.<T0>printProperty(
          ...
          hydra.lib.pairs.First.apply(p),
          hydra.lib.pairs.Second.apply(p))),
        hydra.lib.maps.ToList.apply(((java.util.function.Function<hydra.pg.model.Vertex<T0>, java.util.Map<hydra.pg.model.PropertyKey, T0>>) (projected -> projected.properties)).apply(vertex)))));
    return hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
      id.get(),
      ": (",
      label.get(),
