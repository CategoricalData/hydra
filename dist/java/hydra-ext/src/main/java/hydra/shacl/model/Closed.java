...
public class Closed implements Serializable, Comparable<Closed> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shacl.model.Closed");
  ...
  public final hydra.util.Maybe<java.util.Set<hydra.rdf.syntax.Property>> ignoredProperties;

  public Closed (Boolean isClosed, hydra.util.Maybe<java.util.Set<hydra.rdf.syntax.Property>> ignoredProperties) {
  ...
  public Closed withIgnoredProperties(hydra.util.Maybe<java.util.Set<hydra.rdf.syntax.Property>> ignoredProperties) {
    return new Closed(isClosed, ignoredProperties);
  }
}
