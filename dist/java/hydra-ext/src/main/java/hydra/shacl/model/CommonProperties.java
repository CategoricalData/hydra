...
public class CommonProperties implements Serializable, Comparable<CommonProperties> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shacl.model.CommonProperties");
   ...
   */
  public final java.util.Set<hydra.shacl.model.CommonConstraint> constraints;
   ...
   */
  public final hydra.rdf.syntax.LangStrings message;

  /**
   * See https://www.w3.org/TR/shacl/#severity
   */
  public final hydra.shacl.model.Severity severity;

  /**
   * See https://www.w3.org/TR/shacl/#targetClass
   */
  public final java.util.Set<hydra.rdf.syntax.RdfsClass> targetClass;

  /**
   * See https://www.w3.org/TR/shacl/#targetNode
   */
  public final java.util.Set<hydra.rdf.syntax.IriOrLiteral> targetNode;

  /**
   * See https://www.w3.org/TR/shacl/#targetObjectsOf
   */
  public final java.util.Set<hydra.rdf.syntax.Property> targetObjectsOf;

  /**
   * See https://www.w3.org/TR/shacl/#targetSubjectsOf
   */
  public final java.util.Set<hydra.rdf.syntax.Property> targetSubjectsOf;

  public CommonProperties (java.util.Set<hydra.shacl.model.CommonConstraint> constraints, hydra.util.Maybe<Boolean> deactivated, hydra.rdf.syntax.LangStrings message, hydra.shacl.model.Severity severity, java.util.Set<hydra.rdf.syntax.RdfsClass> targetClass, java.util.Set<hydra.rdf.syntax.IriOrLiteral> targetNode, java.util.Set<hydra.rdf.syntax.Property> targetObjectsOf, java.util.Set<hydra.rdf.syntax.Property> targetSubjectsOf) {
  ...
  public int compareTo(CommonProperties other) {
    ...
    cmp = hydra.util.Comparing.compare(
      targetObjectsOf,
      other.targetObjectsOf);
    if (cmp != 0) {
      return cmp;
    }
    return hydra.util.Comparing.compare(
      targetSubjectsOf,
      other.targetSubjectsOf);
  }

  public CommonProperties withConstraints(java.util.Set<hydra.shacl.model.CommonConstraint> constraints) {
  ...
  public CommonProperties withMessage(hydra.rdf.syntax.LangStrings message) {
    return new CommonProperties(constraints, deactivated, message, severity, targetClass, targetNode, targetObjectsOf, targetSubjectsOf);
  }

  public CommonProperties withSeverity(hydra.shacl.model.Severity severity) {
    return new CommonProperties(constraints, deactivated, message, severity, targetClass, targetNode, targetObjectsOf, targetSubjectsOf);
  }

  public CommonProperties withTargetClass(java.util.Set<hydra.rdf.syntax.RdfsClass> targetClass) {
    return new CommonProperties(constraints, deactivated, message, severity, targetClass, targetNode, targetObjectsOf, targetSubjectsOf);
  }

  public CommonProperties withTargetNode(java.util.Set<hydra.rdf.syntax.IriOrLiteral> targetNode) {
    return new CommonProperties(constraints, deactivated, message, severity, targetClass, targetNode, targetObjectsOf, targetSubjectsOf);
  }

  public CommonProperties withTargetObjectsOf(java.util.Set<hydra.rdf.syntax.Property> targetObjectsOf) {
    return new CommonProperties(constraints, deactivated, message, severity, targetClass, targetNode, targetObjectsOf, targetSubjectsOf);
  }

  public CommonProperties withTargetSubjectsOf(java.util.Set<hydra.rdf.syntax.Property> targetSubjectsOf) {
    return new CommonProperties(constraints, deactivated, message, severity, targetClass, targetNode, targetObjectsOf, targetSubjectsOf);
  }
}
