...
public abstract class PropertyShapeConstraint implements Serializable, Comparable<PropertyShapeConstraint> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shacl.model.PropertyShapeConstraint");
   ...
   */
  public static final class LessThan extends hydra.shacl.model.PropertyShapeConstraint implements Serializable {
    public final java.util.Set<hydra.rdf.syntax.Property> value;

    public LessThan (java.util.Set<hydra.rdf.syntax.Property> value) {
      this.value = value;
    }
   ...
   */
  public static final class LessThanOrEquals extends hydra.shacl.model.PropertyShapeConstraint implements Serializable {
    public final java.util.Set<hydra.rdf.syntax.Property> value;

    public LessThanOrEquals (java.util.Set<hydra.rdf.syntax.Property> value) {
      this.value = value;
    }
   ...
   */
  public static final class MaxCount extends hydra.shacl.model.PropertyShapeConstraint implements Serializable {
   ...
   */
  public static final class MinCount extends hydra.shacl.model.PropertyShapeConstraint implements Serializable {
    public final java.math.BigInteger value;
   ...
   */
  public static final class UniqueLang extends hydra.shacl.model.PropertyShapeConstraint implements Serializable {
   ...
   */
  public static final class QualifiedValueShape extends hydra.shacl.model.PropertyShapeConstraint implements Serializable {
    public final hydra.shacl.model.QualifiedValueShape value;

    public QualifiedValueShape (hydra.shacl.model.QualifiedValueShape value) {
      this.value = value;
    }
