...
public class MultiElementGroup implements Serializable, Comparable<MultiElementGroup> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.MultiElementGroup");
  ...
  public final java.util.List<hydra.shex.syntax.UnaryTripleExpr> listOfSequence;

  public final hydra.util.Maybe<java.lang.Void> Semi;

  public MultiElementGroup (hydra.shex.syntax.UnaryTripleExpr UnaryTripleExpr, java.util.List<hydra.shex.syntax.UnaryTripleExpr> listOfSequence, hydra.util.Maybe<java.lang.Void> Semi) {
  ...
  public MultiElementGroup withUnaryTripleExpr(hydra.shex.syntax.UnaryTripleExpr UnaryTripleExpr) {
    return new MultiElementGroup(UnaryTripleExpr, listOfSequence, Semi);
  }

  public MultiElementGroup withListOfSequence(java.util.List<hydra.shex.syntax.UnaryTripleExpr> listOfSequence) {
    return new MultiElementGroup(UnaryTripleExpr, listOfSequence, Semi);
  }
