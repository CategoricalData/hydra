...
public abstract class PnPrefix_Sequence_Option_Alts implements Serializable, Comparable<PnPrefix_Sequence_Option_Alts> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.PnPrefix_Sequence_Option_Alts");
  ...
  public static final class PnChars extends hydra.shex.syntax.PnPrefix_Sequence_Option_Alts implements Serializable {
  ...
  public static final class Period extends hydra.shex.syntax.PnPrefix_Sequence_Option_Alts implements Serializable {
    public Period () {
