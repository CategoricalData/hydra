...
public abstract class NotStartAction_ShapeExprDecl_Alts implements Serializable, Comparable<NotStartAction_ShapeExprDecl_Alts> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NotStartAction_ShapeExprDecl_Alts");
  ...
  public static final class ShapeExpression extends hydra.shex.syntax.NotStartAction_ShapeExprDecl_Alts implements Serializable {
    public final hydra.shex.syntax.ShapeExpression value;

    public ShapeExpression (hydra.shex.syntax.ShapeExpression value) {
      this.value = value;
    }
  ...
  public static final class EXTERNAL extends hydra.shex.syntax.NotStartAction_ShapeExprDecl_Alts implements Serializable {
    public EXTERNAL () {
