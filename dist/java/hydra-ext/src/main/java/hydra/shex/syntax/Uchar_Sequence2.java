...
public class Uchar_Sequence2 implements Serializable, Comparable<Uchar_Sequence2> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.Uchar_Sequence2");
  ...
  public final hydra.shex.syntax.Hex Hex3;

  public final hydra.shex.syntax.Hex Hex4;

  public final hydra.shex.syntax.Hex Hex5;

  public final hydra.shex.syntax.Hex Hex6;

  public final hydra.shex.syntax.Hex Hex7;

  public final hydra.shex.syntax.Hex Hex8;

  public Uchar_Sequence2 (hydra.shex.syntax.Hex Hex, hydra.shex.syntax.Hex Hex2, hydra.shex.syntax.Hex Hex3, hydra.shex.syntax.Hex Hex4, hydra.shex.syntax.Hex Hex5, hydra.shex.syntax.Hex Hex6, hydra.shex.syntax.Hex Hex7, hydra.shex.syntax.Hex Hex8) {
    this.Hex = Hex;
    this.Hex2 = Hex2;
    this.Hex3 = Hex3;
    this.Hex4 = Hex4;
  ...
  public Uchar_Sequence2 withHex(hydra.shex.syntax.Hex Hex) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }

  public Uchar_Sequence2 withHex2(hydra.shex.syntax.Hex Hex2) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }

  public Uchar_Sequence2 withHex3(hydra.shex.syntax.Hex Hex3) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }

  public Uchar_Sequence2 withHex4(hydra.shex.syntax.Hex Hex4) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }

  public Uchar_Sequence2 withHex5(hydra.shex.syntax.Hex Hex5) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }

  public Uchar_Sequence2 withHex6(hydra.shex.syntax.Hex Hex6) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }

  public Uchar_Sequence2 withHex7(hydra.shex.syntax.Hex Hex7) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }

  public Uchar_Sequence2 withHex8(hydra.shex.syntax.Hex Hex8) {
    return new Uchar_Sequence2(Hex, Hex2, Hex3, Hex4, Hex5, Hex6, Hex7, Hex8);
  }
}
