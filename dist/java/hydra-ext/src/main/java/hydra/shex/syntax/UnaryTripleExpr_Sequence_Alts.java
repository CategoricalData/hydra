...
public abstract class UnaryTripleExpr_Sequence_Alts implements Serializable, Comparable<UnaryTripleExpr_Sequence_Alts> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.UnaryTripleExpr_Sequence_Alts");
  ...
  public static final class TripleConstraint extends hydra.shex.syntax.UnaryTripleExpr_Sequence_Alts implements Serializable {
    public final hydra.shex.syntax.TripleConstraint value;

    public TripleConstraint (hydra.shex.syntax.TripleConstraint value) {
      this.value = value;
    }
  ...
  public static final class BracketedTripleExpr extends hydra.shex.syntax.UnaryTripleExpr_Sequence_Alts implements Serializable {
    public final hydra.shex.syntax.BracketedTripleExpr value;

    public BracketedTripleExpr (hydra.shex.syntax.BracketedTripleExpr value) {
      this.value = value;
    }
