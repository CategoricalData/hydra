...
public class NumericFacet_Sequence implements Serializable, Comparable<NumericFacet_Sequence> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NumericFacet_Sequence");
  ...
  public final hydra.shex.syntax.NumericRange NumericRange;

  public final hydra.shex.syntax.NumericLiteral NumericLiteral;

  public NumericFacet_Sequence (hydra.shex.syntax.NumericRange NumericRange, hydra.shex.syntax.NumericLiteral NumericLiteral) {
  ...
  public NumericFacet_Sequence withNumericRange(hydra.shex.syntax.NumericRange NumericRange) {
    return new NumericFacet_Sequence(NumericRange, NumericLiteral);
  }

  public NumericFacet_Sequence withNumericLiteral(hydra.shex.syntax.NumericLiteral NumericLiteral) {
    return new NumericFacet_Sequence(NumericRange, NumericLiteral);
  }
}
