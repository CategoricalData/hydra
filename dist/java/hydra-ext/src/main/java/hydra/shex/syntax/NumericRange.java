...
public abstract class NumericRange implements Serializable, Comparable<NumericRange> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NumericRange");
  ...
  public static final class MININCLUSIVE extends hydra.shex.syntax.NumericRange implements Serializable {
    public MININCLUSIVE () {
  ...
  public static final class MINEXCLUSIVE extends hydra.shex.syntax.NumericRange implements Serializable {
    public MINEXCLUSIVE () {
  ...
  public static final class MAXINCLUSIVE extends hydra.shex.syntax.NumericRange implements Serializable {
    public MAXINCLUSIVE () {
  ...
  public static final class MAXEXCLUSIVE extends hydra.shex.syntax.NumericRange implements Serializable {
    public MAXEXCLUSIVE () {
