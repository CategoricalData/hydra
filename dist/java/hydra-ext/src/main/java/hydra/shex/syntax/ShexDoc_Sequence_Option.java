...
public class ShexDoc_Sequence_Option implements Serializable, Comparable<ShexDoc_Sequence_Option> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShexDoc_Sequence_Option");
  ...
  public final hydra.shex.syntax.ShexDoc_Sequence_Option_Alts alts;

  public final java.util.List<hydra.shex.syntax.Statement> listOfStatement;

  public ShexDoc_Sequence_Option (hydra.shex.syntax.ShexDoc_Sequence_Option_Alts alts, java.util.List<hydra.shex.syntax.Statement> listOfStatement) {
    this.alts = alts;
  ...
  public ShexDoc_Sequence_Option withAlts(hydra.shex.syntax.ShexDoc_Sequence_Option_Alts alts) {
    return new ShexDoc_Sequence_Option(alts, listOfStatement);
  }

  public ShexDoc_Sequence_Option withListOfStatement(java.util.List<hydra.shex.syntax.Statement> listOfStatement) {
    return new ShexDoc_Sequence_Option(alts, listOfStatement);
  }
}
