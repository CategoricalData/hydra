...
public class InlineShapeAtom_Sequence2 implements Serializable, Comparable<InlineShapeAtom_Sequence2> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.InlineShapeAtom_Sequence2");
  ...
  public final hydra.shex.syntax.InlineShapeOrRef InlineShapeOrRef;

  public final hydra.util.Maybe<hydra.shex.syntax.NodeConstraint> NodeConstraint;

  public InlineShapeAtom_Sequence2 (hydra.shex.syntax.InlineShapeOrRef InlineShapeOrRef, hydra.util.Maybe<hydra.shex.syntax.NodeConstraint> NodeConstraint) {
  ...
  public InlineShapeAtom_Sequence2 withInlineShapeOrRef(hydra.shex.syntax.InlineShapeOrRef InlineShapeOrRef) {
    return new InlineShapeAtom_Sequence2(InlineShapeOrRef, NodeConstraint);
  }

  public InlineShapeAtom_Sequence2 withNodeConstraint(hydra.util.Maybe<hydra.shex.syntax.NodeConstraint> NodeConstraint) {
    return new InlineShapeAtom_Sequence2(InlineShapeOrRef, NodeConstraint);
  }
}
