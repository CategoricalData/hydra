...
public abstract class ShapeDefinition_ListOfAlts_Elmt implements Serializable, Comparable<ShapeDefinition_ListOfAlts_Elmt> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShapeDefinition_ListOfAlts_Elmt");
  ...
  public static final class IncludeSet extends hydra.shex.syntax.ShapeDefinition_ListOfAlts_Elmt implements Serializable {
    public final hydra.shex.syntax.IncludeSet value;

    public IncludeSet (hydra.shex.syntax.IncludeSet value) {
      this.value = value;
    }
  ...
  public static final class ExtraPropertySet extends hydra.shex.syntax.ShapeDefinition_ListOfAlts_Elmt implements Serializable {
    public final hydra.shex.syntax.ExtraPropertySet value;

    public ExtraPropertySet (hydra.shex.syntax.ExtraPropertySet value) {
      this.value = value;
    }
  ...
  public static final class CLOSED extends hydra.shex.syntax.ShapeDefinition_ListOfAlts_Elmt implements Serializable {
    public CLOSED () {
