...
public class NodeConstraint_Sequence3 implements Serializable, Comparable<NodeConstraint_Sequence3> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NodeConstraint_Sequence3");
  ...
  public final hydra.shex.syntax.Datatype Datatype;

  public final java.util.List<hydra.shex.syntax.XsFacet> listOfXsFacet;

  public NodeConstraint_Sequence3 (hydra.shex.syntax.Datatype Datatype, java.util.List<hydra.shex.syntax.XsFacet> listOfXsFacet) {
  ...
  public NodeConstraint_Sequence3 withDatatype(hydra.shex.syntax.Datatype Datatype) {
    return new NodeConstraint_Sequence3(Datatype, listOfXsFacet);
  }

  public NodeConstraint_Sequence3 withListOfXsFacet(java.util.List<hydra.shex.syntax.XsFacet> listOfXsFacet) {
    return new NodeConstraint_Sequence3(Datatype, listOfXsFacet);
  }
}
