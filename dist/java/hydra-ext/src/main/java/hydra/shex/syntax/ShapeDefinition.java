...
public class ShapeDefinition implements Serializable, Comparable<ShapeDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShapeDefinition");
  ...
  public final java.util.List<hydra.shex.syntax.ShapeDefinition_ListOfAlts_Elmt> listOfAlts;

  public final hydra.util.Maybe<hydra.shex.syntax.TripleExpression> TripleExpression;
  ...
  public ShapeDefinition (java.util.List<hydra.shex.syntax.ShapeDefinition_ListOfAlts_Elmt> listOfAlts, hydra.util.Maybe<hydra.shex.syntax.TripleExpression> TripleExpression, java.util.List<hydra.shex.syntax.Annotation> listOfAnnotation, hydra.shex.syntax.SemanticActions SemanticActions) {
  ...
  public ShapeDefinition withListOfAlts(java.util.List<hydra.shex.syntax.ShapeDefinition_ListOfAlts_Elmt> listOfAlts) {
    return new ShapeDefinition(listOfAlts, TripleExpression, listOfAnnotation, SemanticActions);
  }

  public ShapeDefinition withTripleExpression(hydra.util.Maybe<hydra.shex.syntax.TripleExpression> TripleExpression) {
    return new ShapeDefinition(listOfAlts, TripleExpression, listOfAnnotation, SemanticActions);
  }

  public ShapeDefinition withListOfAnnotation(java.util.List<hydra.shex.syntax.Annotation> listOfAnnotation) {
    return new ShapeDefinition(listOfAlts, TripleExpression, listOfAnnotation, SemanticActions);
  }

  public ShapeDefinition withSemanticActions(hydra.shex.syntax.SemanticActions SemanticActions) {
    return new ShapeDefinition(listOfAlts, TripleExpression, listOfAnnotation, SemanticActions);
  }
}
