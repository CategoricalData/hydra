...
public abstract class NumericLength implements Serializable, Comparable<NumericLength> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NumericLength");
  ...
  public static final class TOTALDIGITS extends hydra.shex.syntax.NumericLength implements Serializable {
    public TOTALDIGITS () {
  ...
  public static final class FRACTIONDIGITS extends hydra.shex.syntax.NumericLength implements Serializable {
