...
public class ShapeNot implements Serializable, Comparable<ShapeNot> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShapeNot");
  ...
  public final hydra.shex.syntax.ShapeAtom ShapeAtom;

  public ShapeNot (hydra.util.Maybe<java.lang.Void> NOT, hydra.shex.syntax.ShapeAtom ShapeAtom) {
    this.NOT = NOT;
  ...
  public ShapeNot withShapeAtom(hydra.shex.syntax.ShapeAtom ShapeAtom) {
    return new ShapeNot(NOT, ShapeAtom);
  }
}
