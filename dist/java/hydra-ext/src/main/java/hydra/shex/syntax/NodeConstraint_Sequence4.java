...
public class NodeConstraint_Sequence4 implements Serializable, Comparable<NodeConstraint_Sequence4> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NodeConstraint_Sequence4");
  ...
  public NodeConstraint_Sequence4 (hydra.shex.syntax.ValueSet ValueSet, java.util.List<hydra.shex.syntax.XsFacet> listOfXsFacet) {
  ...
  public NodeConstraint_Sequence4 withValueSet(hydra.shex.syntax.ValueSet ValueSet) {
    return new NodeConstraint_Sequence4(ValueSet, listOfXsFacet);
  }

  public NodeConstraint_Sequence4 withListOfXsFacet(java.util.List<hydra.shex.syntax.XsFacet> listOfXsFacet) {
    return new NodeConstraint_Sequence4(ValueSet, listOfXsFacet);
  }
}
