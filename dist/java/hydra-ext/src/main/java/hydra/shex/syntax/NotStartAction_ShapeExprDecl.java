...
public class NotStartAction_ShapeExprDecl implements Serializable, Comparable<NotStartAction_ShapeExprDecl> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NotStartAction_ShapeExprDecl");
  ...
  public final hydra.shex.syntax.ShapeExprLabel ShapeExprLabel;

  public final hydra.shex.syntax.NotStartAction_ShapeExprDecl_Alts alts;

  public NotStartAction_ShapeExprDecl (hydra.shex.syntax.ShapeExprLabel ShapeExprLabel, hydra.shex.syntax.NotStartAction_ShapeExprDecl_Alts alts) {
  ...
  public NotStartAction_ShapeExprDecl withShapeExprLabel(hydra.shex.syntax.ShapeExprLabel ShapeExprLabel) {
    return new NotStartAction_ShapeExprDecl(ShapeExprLabel, alts);
  }

  public NotStartAction_ShapeExprDecl withAlts(hydra.shex.syntax.NotStartAction_ShapeExprDecl_Alts alts) {
    return new NotStartAction_ShapeExprDecl(ShapeExprLabel, alts);
  }
}
