...
public class SingleElementGroup implements Serializable, Comparable<SingleElementGroup> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.SingleElementGroup");
  ...
  public final hydra.shex.syntax.UnaryTripleExpr UnaryTripleExpr;

  public final hydra.util.Maybe<java.lang.Void> Semi;

  public SingleElementGroup (hydra.shex.syntax.UnaryTripleExpr UnaryTripleExpr, hydra.util.Maybe<java.lang.Void> Semi) {
  ...
  public SingleElementGroup withUnaryTripleExpr(hydra.shex.syntax.UnaryTripleExpr UnaryTripleExpr) {
