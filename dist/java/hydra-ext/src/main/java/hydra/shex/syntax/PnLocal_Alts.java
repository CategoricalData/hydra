...
public abstract class PnLocal_Alts implements Serializable, Comparable<PnLocal_Alts> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.PnLocal_Alts");
  ...
  public static final class PnCharsU extends hydra.shex.syntax.PnLocal_Alts implements Serializable {
    public final hydra.shex.syntax.PnCharsU value;

    public PnCharsU (hydra.shex.syntax.PnCharsU value) {
      this.value = value;
    }
  ...
  public static final class Colon extends hydra.shex.syntax.PnLocal_Alts implements Serializable {
    public Colon () {
  ...
  public static final class Regex extends hydra.shex.syntax.PnLocal_Alts implements Serializable {
  ...
  public static final class Plx extends hydra.shex.syntax.PnLocal_Alts implements Serializable {
