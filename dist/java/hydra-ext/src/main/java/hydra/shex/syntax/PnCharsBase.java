...
public abstract class PnCharsBase implements Serializable, Comparable<PnCharsBase> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.PnCharsBase");
  ...
  public static final class Regex extends hydra.shex.syntax.PnCharsBase implements Serializable {
  ...
  public static final class Regex2 extends hydra.shex.syntax.PnCharsBase implements Serializable {
    public final String value;
