...
public abstract class Plx implements Serializable, Comparable<Plx> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.Plx");
  ...
  public static final class Percent extends hydra.shex.syntax.Plx implements Serializable {
    public final hydra.shex.syntax.Percent value;

    public Percent (hydra.shex.syntax.Percent value) {
      this.value = value;
    }
  ...
  public static final class PnLocalEsc extends hydra.shex.syntax.Plx implements Serializable {
    public final hydra.shex.syntax.PnLocalEsc value;

    public PnLocalEsc (hydra.shex.syntax.PnLocalEsc value) {
      this.value = value;
    }
