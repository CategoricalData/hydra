...
public abstract class PnLocal_Sequence_Option_ListOfAlts_Elmt implements Serializable, Comparable<PnLocal_Sequence_Option_ListOfAlts_Elmt> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt");
  ...
  public static final class PnChars extends hydra.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt implements Serializable {
  ...
  public static final class Period extends hydra.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt implements Serializable {
    public Period () {
  ...
  public static final class Colon extends hydra.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt implements Serializable {
    public Colon () {
  ...
  public static final class Plx extends hydra.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt implements Serializable {
