...
public class Uchar_Sequence implements Serializable, Comparable<Uchar_Sequence> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.Uchar_Sequence");
  ...
  public Uchar_Sequence (hydra.shex.syntax.Hex Hex, hydra.shex.syntax.Hex Hex2, hydra.shex.syntax.Hex Hex3, hydra.shex.syntax.Hex Hex4) {
    this.Hex = Hex;
    this.Hex2 = Hex2;
    this.Hex3 = Hex3;
    this.Hex4 = Hex4;
  ...
  public Uchar_Sequence withHex(hydra.shex.syntax.Hex Hex) {
    return new Uchar_Sequence(Hex, Hex2, Hex3, Hex4);
  }

  public Uchar_Sequence withHex2(hydra.shex.syntax.Hex Hex2) {
    return new Uchar_Sequence(Hex, Hex2, Hex3, Hex4);
  }

  public Uchar_Sequence withHex3(hydra.shex.syntax.Hex Hex3) {
    return new Uchar_Sequence(Hex, Hex2, Hex3, Hex4);
  }

  public Uchar_Sequence withHex4(hydra.shex.syntax.Hex Hex4) {
    return new Uchar_Sequence(Hex, Hex2, Hex3, Hex4);
  }
}
