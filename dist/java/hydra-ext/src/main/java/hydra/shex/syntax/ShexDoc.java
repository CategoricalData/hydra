...
public class ShexDoc implements Serializable, Comparable<ShexDoc> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShexDoc");
  ...
  public final java.util.List<hydra.shex.syntax.Directive> listOfDirective;

  public final hydra.util.Maybe<hydra.shex.syntax.ShexDoc_Sequence_Option> Sequence;

  public final hydra.shex.syntax.PrefixDecl PrefixDecl;

  public ShexDoc (java.util.List<hydra.shex.syntax.Directive> listOfDirective, hydra.util.Maybe<hydra.shex.syntax.ShexDoc_Sequence_Option> Sequence, hydra.shex.syntax.PrefixDecl PrefixDecl) {
  ...
  public ShexDoc withListOfDirective(java.util.List<hydra.shex.syntax.Directive> listOfDirective) {
    return new ShexDoc(listOfDirective, Sequence, PrefixDecl);
  }

  public ShexDoc withSequence(hydra.util.Maybe<hydra.shex.syntax.ShexDoc_Sequence_Option> Sequence) {
    return new ShexDoc(listOfDirective, Sequence, PrefixDecl);
  }

  public ShexDoc withPrefixDecl(hydra.shex.syntax.PrefixDecl PrefixDecl) {
    return new ShexDoc(listOfDirective, Sequence, PrefixDecl);
  }
}
