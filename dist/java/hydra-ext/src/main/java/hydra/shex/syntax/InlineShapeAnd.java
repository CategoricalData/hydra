...
public class InlineShapeAnd implements Serializable, Comparable<InlineShapeAnd> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.InlineShapeAnd");
  ...
  public final hydra.shex.syntax.InlineShapeNot InlineShapeNot;

  public final java.util.List<hydra.shex.syntax.InlineShapeNot> listOfSequence;

  public InlineShapeAnd (hydra.shex.syntax.InlineShapeNot InlineShapeNot, java.util.List<hydra.shex.syntax.InlineShapeNot> listOfSequence) {
  ...
  public InlineShapeAnd withInlineShapeNot(hydra.shex.syntax.InlineShapeNot InlineShapeNot) {
    return new InlineShapeAnd(InlineShapeNot, listOfSequence);
  }

  public InlineShapeAnd withListOfSequence(java.util.List<hydra.shex.syntax.InlineShapeNot> listOfSequence) {
    return new InlineShapeAnd(InlineShapeNot, listOfSequence);
  }
}
