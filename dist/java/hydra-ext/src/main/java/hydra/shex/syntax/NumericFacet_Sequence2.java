...
public class NumericFacet_Sequence2 implements Serializable, Comparable<NumericFacet_Sequence2> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.NumericFacet_Sequence2");
  ...
  public final hydra.shex.syntax.NumericLength NumericLength;

  public final hydra.shex.syntax.Integer_ Integer_;

  public NumericFacet_Sequence2 (hydra.shex.syntax.NumericLength NumericLength, hydra.shex.syntax.Integer_ Integer_) {
  ...
  public NumericFacet_Sequence2 withNumericLength(hydra.shex.syntax.NumericLength NumericLength) {
    return new NumericFacet_Sequence2(NumericLength, Integer_);
  }

  public NumericFacet_Sequence2 withInteger(hydra.shex.syntax.Integer_ Integer_) {
    return new NumericFacet_Sequence2(NumericLength, Integer_);
  }
}
