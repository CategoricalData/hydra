...
public class ShapeAtom_Sequence implements Serializable, Comparable<ShapeAtom_Sequence> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.ShapeAtom_Sequence");
  ...
  public final hydra.util.Maybe<hydra.shex.syntax.ShapeOrRef> ShapeOrRef;

  public ShapeAtom_Sequence (hydra.shex.syntax.NodeConstraint NodeConstraint, hydra.util.Maybe<hydra.shex.syntax.ShapeOrRef> ShapeOrRef) {
  ...
  public ShapeAtom_Sequence withNodeConstraint(hydra.shex.syntax.NodeConstraint NodeConstraint) {
    return new ShapeAtom_Sequence(NodeConstraint, ShapeOrRef);
  }

  public ShapeAtom_Sequence withShapeOrRef(hydra.util.Maybe<hydra.shex.syntax.ShapeOrRef> ShapeOrRef) {
    return new ShapeAtom_Sequence(NodeConstraint, ShapeOrRef);
  }
}
