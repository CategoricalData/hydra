...
public class StringLiteralLong1_Elmt_Sequence implements Serializable, Comparable<StringLiteralLong1_Elmt_Sequence> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.shex.syntax.StringLiteralLong1_Elmt_Sequence");
  ...
  public final hydra.util.Maybe<hydra.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option> Alts;

  public final String regex;

  public StringLiteralLong1_Elmt_Sequence (hydra.util.Maybe<hydra.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option> Alts, String regex) {
    this.Alts = Alts;
    this.regex = regex;
  }
  ...
  public StringLiteralLong1_Elmt_Sequence withAlts(hydra.util.Maybe<hydra.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option> Alts) {
