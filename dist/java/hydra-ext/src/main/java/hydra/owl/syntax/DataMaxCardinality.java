...
public class DataMaxCardinality implements Serializable, Comparable<DataMaxCardinality> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DataMaxCardinality");
  ...
  public DataMaxCardinality (java.math.BigInteger bound, hydra.owl.syntax.DataPropertyExpression property, java.util.List<hydra.owl.syntax.DataRange> range) {
    this.bound = bound;
  ...
  public DataMaxCardinality withProperty(hydra.owl.syntax.DataPropertyExpression property) {
    return new DataMaxCardinality(bound, property, range);
  }

  public DataMaxCardinality withRange(java.util.List<hydra.owl.syntax.DataRange> range) {
    return new DataMaxCardinality(bound, property, range);
  }
}
