...
public class DatatypeDefinition implements Serializable, Comparable<DatatypeDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DatatypeDefinition");
  ...
  public DatatypeDefinition (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.Datatype datatype, hydra.owl.syntax.DataRange range) {
  ...
  public DatatypeDefinition withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new DatatypeDefinition(annotations, datatype, range);
  }

  public DatatypeDefinition withDatatype(hydra.owl.syntax.Datatype datatype) {
    return new DatatypeDefinition(annotations, datatype, range);
  }

  public DatatypeDefinition withRange(hydra.owl.syntax.DataRange range) {
    return new DatatypeDefinition(annotations, datatype, range);
  }
}
