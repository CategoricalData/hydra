...
public abstract class AnnotationAxiom implements Serializable, Comparable<AnnotationAxiom> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.AnnotationAxiom");
  ...
  public static final class AnnotationAssertion extends hydra.owl.syntax.AnnotationAxiom implements Serializable {
    public final hydra.owl.syntax.AnnotationAssertion value;

    public AnnotationAssertion (hydra.owl.syntax.AnnotationAssertion value) {
      this.value = value;
    }
  ...
  public static final class AnnotationPropertyDomain extends hydra.owl.syntax.AnnotationAxiom implements Serializable {
    public final hydra.owl.syntax.AnnotationPropertyDomain value;

    public AnnotationPropertyDomain (hydra.owl.syntax.AnnotationPropertyDomain value) {
      this.value = value;
    }
  ...
  public static final class AnnotationPropertyRange extends hydra.owl.syntax.AnnotationAxiom implements Serializable {
    public final hydra.owl.syntax.AnnotationPropertyRange value;

    public AnnotationPropertyRange (hydra.owl.syntax.AnnotationPropertyRange value) {
      this.value = value;
    }
  ...
  public static final class SubAnnotationPropertyOf extends hydra.owl.syntax.AnnotationAxiom implements Serializable {
    public final hydra.owl.syntax.SubAnnotationPropertyOf value;

    public SubAnnotationPropertyOf (hydra.owl.syntax.SubAnnotationPropertyOf value) {
      this.value = value;
    }
