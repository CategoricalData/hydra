...
public class IrreflexiveObjectProperty implements Serializable, Comparable<IrreflexiveObjectProperty> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.IrreflexiveObjectProperty");
  ...
  public IrreflexiveObjectProperty (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property) {
  ...
  public IrreflexiveObjectProperty withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new IrreflexiveObjectProperty(annotations, property);
  }

  public IrreflexiveObjectProperty withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new IrreflexiveObjectProperty(annotations, property);
  }
}
