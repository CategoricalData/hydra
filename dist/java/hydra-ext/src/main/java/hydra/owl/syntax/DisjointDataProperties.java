...
public class DisjointDataProperties implements Serializable, Comparable<DisjointDataProperties> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DisjointDataProperties");
  ...
  public DisjointDataProperties (java.util.List<hydra.owl.syntax.Annotation> annotations, java.util.List<hydra.owl.syntax.DataPropertyExpression> properties) {
  ...
  public DisjointDataProperties withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new DisjointDataProperties(annotations, properties);
  }

  public DisjointDataProperties withProperties(java.util.List<hydra.owl.syntax.DataPropertyExpression> properties) {
    return new DisjointDataProperties(annotations, properties);
  }
}
