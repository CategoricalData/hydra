...
public class FunctionalDataProperty implements Serializable, Comparable<FunctionalDataProperty> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.FunctionalDataProperty");
  ...
  public FunctionalDataProperty (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.DataPropertyExpression property) {
  ...
  public FunctionalDataProperty withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new FunctionalDataProperty(annotations, property);
  }

  public FunctionalDataProperty withProperty(hydra.owl.syntax.DataPropertyExpression property) {
    return new FunctionalDataProperty(annotations, property);
  }
}
