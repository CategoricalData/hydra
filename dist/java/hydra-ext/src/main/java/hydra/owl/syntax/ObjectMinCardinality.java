...
public class ObjectMinCardinality implements Serializable, Comparable<ObjectMinCardinality> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ObjectMinCardinality");
  ...
  public final java.util.List<hydra.owl.syntax.ClassExpression> class_;

  public ObjectMinCardinality (java.math.BigInteger bound, hydra.owl.syntax.ObjectPropertyExpression property, java.util.List<hydra.owl.syntax.ClassExpression> class_) {
    this.bound = bound;
  ...
  public ObjectMinCardinality withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new ObjectMinCardinality(bound, property, class_);
  }

  public ObjectMinCardinality withClass(java.util.List<hydra.owl.syntax.ClassExpression> class_) {
    return new ObjectMinCardinality(bound, property, class_);
  }
}
