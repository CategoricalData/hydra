...
public class EquivalentObjectProperties implements Serializable, Comparable<EquivalentObjectProperties> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.EquivalentObjectProperties");
  ...
  public final java.util.List<hydra.owl.syntax.ObjectPropertyExpression> properties;

  public EquivalentObjectProperties (java.util.List<hydra.owl.syntax.Annotation> annotations, java.util.List<hydra.owl.syntax.ObjectPropertyExpression> properties) {
  ...
  public EquivalentObjectProperties withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new EquivalentObjectProperties(annotations, properties);
  }

  public EquivalentObjectProperties withProperties(java.util.List<hydra.owl.syntax.ObjectPropertyExpression> properties) {
    return new EquivalentObjectProperties(annotations, properties);
  }
}
