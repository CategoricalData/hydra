...
public class DifferentIndividuals implements Serializable, Comparable<DifferentIndividuals> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DifferentIndividuals");
  ...
  public DifferentIndividuals (java.util.List<hydra.owl.syntax.Annotation> annotations, java.util.List<hydra.owl.syntax.Individual> individuals) {
  ...
  public DifferentIndividuals withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new DifferentIndividuals(annotations, individuals);
  }

  public DifferentIndividuals withIndividuals(java.util.List<hydra.owl.syntax.Individual> individuals) {
    return new DifferentIndividuals(annotations, individuals);
  }
}
