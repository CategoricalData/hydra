...
public class DisjointObjectProperties implements Serializable, Comparable<DisjointObjectProperties> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DisjointObjectProperties");
  ...
  public DisjointObjectProperties (java.util.List<hydra.owl.syntax.Annotation> annotations, java.util.List<hydra.owl.syntax.ObjectPropertyExpression> properties) {
  ...
  public DisjointObjectProperties withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new DisjointObjectProperties(annotations, properties);
  }

  public DisjointObjectProperties withProperties(java.util.List<hydra.owl.syntax.ObjectPropertyExpression> properties) {
    return new DisjointObjectProperties(annotations, properties);
  }
}
