...
public class Declaration implements Serializable, Comparable<Declaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.Declaration");
  ...
  public final hydra.owl.syntax.Entity entity;

  public Declaration (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.Entity entity) {
  ...
  public Declaration withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new Declaration(annotations, entity);
  }

  public Declaration withEntity(hydra.owl.syntax.Entity entity) {
    return new Declaration(annotations, entity);
  }
}
