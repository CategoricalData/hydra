...
public abstract class ClassAxiom implements Serializable, Comparable<ClassAxiom> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ClassAxiom");
  ...
  public static final class DisjointClasses extends hydra.owl.syntax.ClassAxiom implements Serializable {
    public final hydra.owl.syntax.DisjointClasses value;

    public DisjointClasses (hydra.owl.syntax.DisjointClasses value) {
      this.value = value;
    }
  ...
  public static final class DisjointUnion extends hydra.owl.syntax.ClassAxiom implements Serializable {
    public final hydra.owl.syntax.DisjointUnion value;

    public DisjointUnion (hydra.owl.syntax.DisjointUnion value) {
      this.value = value;
    }
  ...
  public static final class EquivalentClasses extends hydra.owl.syntax.ClassAxiom implements Serializable {
    public final hydra.owl.syntax.EquivalentClasses value;

    public EquivalentClasses (hydra.owl.syntax.EquivalentClasses value) {
      this.value = value;
    }
  ...
  public static final class SubClassOf extends hydra.owl.syntax.ClassAxiom implements Serializable {
    public final hydra.owl.syntax.SubClassOf value;

    public SubClassOf (hydra.owl.syntax.SubClassOf value) {
      this.value = value;
    }
