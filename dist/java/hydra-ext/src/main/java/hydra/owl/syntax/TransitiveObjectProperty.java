...
public class TransitiveObjectProperty implements Serializable, Comparable<TransitiveObjectProperty> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.TransitiveObjectProperty");
  ...
  public TransitiveObjectProperty (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property) {
  ...
  public TransitiveObjectProperty withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new TransitiveObjectProperty(annotations, property);
  }

  public TransitiveObjectProperty withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new TransitiveObjectProperty(annotations, property);
  }
}
