...
public class DataHasValue implements Serializable, Comparable<DataHasValue> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DataHasValue");
  ...
  public DataHasValue (hydra.owl.syntax.DataPropertyExpression property, hydra.rdf.syntax.Literal value) {
  ...
  public DataHasValue withProperty(hydra.owl.syntax.DataPropertyExpression property) {
    return new DataHasValue(property, value);
  }

  public DataHasValue withValue(hydra.rdf.syntax.Literal value) {
    return new DataHasValue(property, value);
  }
}
