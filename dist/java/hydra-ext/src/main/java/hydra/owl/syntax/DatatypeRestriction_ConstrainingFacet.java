...
public abstract class DatatypeRestriction_ConstrainingFacet implements Serializable, Comparable<DatatypeRestriction_ConstrainingFacet> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DatatypeRestriction_ConstrainingFacet");
   ...
   */
  public static final class XmlSchema extends hydra.owl.syntax.DatatypeRestriction_ConstrainingFacet implements Serializable {
    public final hydra.xml.schema.ConstrainingFacet value;

    public XmlSchema (hydra.xml.schema.ConstrainingFacet value) {
      this.value = value;
    }
  ...
  public static final class Other extends hydra.owl.syntax.DatatypeRestriction_ConstrainingFacet implements Serializable {
    public final hydra.rdf.syntax.Iri value;

    public Other (hydra.rdf.syntax.Iri value) {
      this.value = value;
    }
