...
public class NegativeObjectPropertyAssertion implements Serializable, Comparable<NegativeObjectPropertyAssertion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.NegativeObjectPropertyAssertion");
  ...
  public final hydra.owl.syntax.Individual source;

  public final hydra.owl.syntax.Individual target;

  public NegativeObjectPropertyAssertion (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.ObjectPropertyExpression property, hydra.owl.syntax.Individual source, hydra.owl.syntax.Individual target) {
  ...
  public NegativeObjectPropertyAssertion withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new NegativeObjectPropertyAssertion(annotations, property, source, target);
  }

  public NegativeObjectPropertyAssertion withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new NegativeObjectPropertyAssertion(annotations, property, source, target);
  }

  public NegativeObjectPropertyAssertion withSource(hydra.owl.syntax.Individual source) {
    return new NegativeObjectPropertyAssertion(annotations, property, source, target);
  }

  public NegativeObjectPropertyAssertion withTarget(hydra.owl.syntax.Individual target) {
    return new NegativeObjectPropertyAssertion(annotations, property, source, target);
  }
}
