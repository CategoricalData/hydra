...
public class ObjectMaxCardinality implements Serializable, Comparable<ObjectMaxCardinality> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ObjectMaxCardinality");
  ...
  public ObjectMaxCardinality (java.math.BigInteger bound, hydra.owl.syntax.ObjectPropertyExpression property, java.util.List<hydra.owl.syntax.ClassExpression> class_) {
    this.bound = bound;
  ...
  public ObjectMaxCardinality withProperty(hydra.owl.syntax.ObjectPropertyExpression property) {
    return new ObjectMaxCardinality(bound, property, class_);
  }

  public ObjectMaxCardinality withClass(java.util.List<hydra.owl.syntax.ClassExpression> class_) {
    return new ObjectMaxCardinality(bound, property, class_);
  }
}
