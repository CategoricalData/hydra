...
public class DataPropertyRange implements Serializable, Comparable<DataPropertyRange> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DataPropertyRange");
  ...
  public DataPropertyRange (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.DataPropertyExpression property, hydra.owl.syntax.ClassExpression range) {
  ...
  public DataPropertyRange withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new DataPropertyRange(annotations, property, range);
  }

  public DataPropertyRange withProperty(hydra.owl.syntax.DataPropertyExpression property) {
    return new DataPropertyRange(annotations, property, range);
  }

  public DataPropertyRange withRange(hydra.owl.syntax.ClassExpression range) {
    return new DataPropertyRange(annotations, property, range);
  }
}
