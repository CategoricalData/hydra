...
public class ObjectIntersectionOf implements Serializable, Comparable<ObjectIntersectionOf> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.ObjectIntersectionOf");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final java.util.List<hydra.owl.syntax.ClassExpression> value;

  public ObjectIntersectionOf (java.util.List<hydra.owl.syntax.ClassExpression> value) {
    this.value = value;
  }
