...
public abstract class Individual implements Serializable, Comparable<Individual> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.Individual");
  ...
  public static final class Named extends hydra.owl.syntax.Individual implements Serializable {
    public final hydra.owl.syntax.NamedIndividual value;

    public Named (hydra.owl.syntax.NamedIndividual value) {
      this.value = value;
    }
  ...
  public static final class Anonymous extends hydra.owl.syntax.Individual implements Serializable {
    public final hydra.owl.syntax.AnonymousIndividual value;

    public Anonymous (hydra.owl.syntax.AnonymousIndividual value) {
      this.value = value;
    }
