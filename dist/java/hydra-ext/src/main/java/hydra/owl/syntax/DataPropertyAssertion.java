...
public class DataPropertyAssertion implements Serializable, Comparable<DataPropertyAssertion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.owl.syntax.DataPropertyAssertion");
  ...
  public DataPropertyAssertion (java.util.List<hydra.owl.syntax.Annotation> annotations, hydra.owl.syntax.DataPropertyExpression property, hydra.owl.syntax.Individual source, hydra.owl.syntax.Individual target) {
  ...
  public DataPropertyAssertion withAnnotations(java.util.List<hydra.owl.syntax.Annotation> annotations) {
    return new DataPropertyAssertion(annotations, property, source, target);
  }

  public DataPropertyAssertion withProperty(hydra.owl.syntax.DataPropertyExpression property) {
    return new DataPropertyAssertion(annotations, property, source, target);
  }

  public DataPropertyAssertion withSource(hydra.owl.syntax.Individual source) {
    return new DataPropertyAssertion(annotations, property, source, target);
  }

  public DataPropertyAssertion withTarget(hydra.owl.syntax.Individual target) {
    return new DataPropertyAssertion(annotations, property, source, target);
  }
}
