 ...
 */
public class LanguageTag implements Serializable, Comparable<LanguageTag> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.org.w3.rdf.syntax.LanguageTag");
