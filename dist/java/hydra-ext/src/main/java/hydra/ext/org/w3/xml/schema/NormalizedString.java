...
public class NormalizedString implements Serializable, Comparable<NormalizedString> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.org.w3.xml.schema.NormalizedString");
