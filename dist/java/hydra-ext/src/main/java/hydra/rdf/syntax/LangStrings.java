...
public class LangStrings implements Serializable, Comparable<LangStrings> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.rdf.syntax.LangStrings");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final java.util.Map<hydra.util.Maybe<hydra.rdf.syntax.LanguageTag>, String> value;

  public LangStrings (java.util.Map<hydra.util.Maybe<hydra.rdf.syntax.LanguageTag>, String> value) {
    this.value = value;
  }
