...
public class Literal implements Serializable, Comparable<Literal> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.rdf.syntax.Literal");
   ...
   */
  public final hydra.rdf.syntax.Iri datatypeIri;

  /**
   * An optional language tag, present if and only if the datatype IRI is http://www.w3.org/1999/02/22-rdf-syntax-ns#langString
   */
  public final hydra.util.Maybe<hydra.rdf.syntax.LanguageTag> languageTag;

  public Literal (String lexicalForm, hydra.rdf.syntax.Iri datatypeIri, hydra.util.Maybe<hydra.rdf.syntax.LanguageTag> languageTag) {
  ...
  public Literal withDatatypeIri(hydra.rdf.syntax.Iri datatypeIri) {
    return new Literal(lexicalForm, datatypeIri, languageTag);
  }

  public Literal withLanguageTag(hydra.util.Maybe<hydra.rdf.syntax.LanguageTag> languageTag) {
    return new Literal(lexicalForm, datatypeIri, languageTag);
  }
}
