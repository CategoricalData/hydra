...
public class ReplaceArgs implements Serializable, Comparable<ReplaceArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.ReplaceArgs");
  ...
  public final hydra.tinkerpop.gremlin.StringNullableArgument from;

  public final hydra.tinkerpop.gremlin.StringNullableArgument to;

  public ReplaceArgs (hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.tinkerpop.gremlin.StringNullableArgument from, hydra.tinkerpop.gremlin.StringNullableArgument to) {
    this.scope = scope;
    this.from = from;
    this.to = to;
  }
  ...
  public ReplaceArgs withScope(hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    return new ReplaceArgs(scope, from, to);
  }

  public ReplaceArgs withFrom(hydra.tinkerpop.gremlin.StringNullableArgument from) {
    return new ReplaceArgs(scope, from, to);
  }

  public ReplaceArgs withTo(hydra.tinkerpop.gremlin.StringNullableArgument to) {
    return new ReplaceArgs(scope, from, to);
  }
}
