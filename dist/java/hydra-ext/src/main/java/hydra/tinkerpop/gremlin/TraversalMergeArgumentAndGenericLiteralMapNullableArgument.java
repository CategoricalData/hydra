...
public class TraversalMergeArgumentAndGenericLiteralMapNullableArgument implements Serializable, Comparable<TraversalMergeArgumentAndGenericLiteralMapNullableArgument> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument");
  ...
  public final hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument map;

  public final hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalCardinality> cardinality;

  public TraversalMergeArgumentAndGenericLiteralMapNullableArgument (hydra.tinkerpop.gremlin.TraversalMergeArgument merge, hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument map, hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalCardinality> cardinality) {
    this.merge = merge;
    this.map = map;
  ...
  public TraversalMergeArgumentAndGenericLiteralMapNullableArgument withMerge(hydra.tinkerpop.gremlin.TraversalMergeArgument merge) {
    return new TraversalMergeArgumentAndGenericLiteralMapNullableArgument(merge, map, cardinality);
  }

  public TraversalMergeArgumentAndGenericLiteralMapNullableArgument withMap(hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument map) {
    return new TraversalMergeArgumentAndGenericLiteralMapNullableArgument(merge, map, cardinality);
  }

  public TraversalMergeArgumentAndGenericLiteralMapNullableArgument withCardinality(hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalCardinality> cardinality) {
    return new TraversalMergeArgumentAndGenericLiteralMapNullableArgument(merge, map, cardinality);
  }
}
