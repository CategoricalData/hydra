...
public abstract class Query implements Serializable, Comparable<Query> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.Query");
  ...
  public static final class TraversalSource extends hydra.tinkerpop.gremlin.Query implements Serializable {
    public final hydra.tinkerpop.gremlin.TraversalSourceQuery value;

    public TraversalSource (hydra.tinkerpop.gremlin.TraversalSourceQuery value) {
      this.value = value;
    }
  ...
  public static final class RootTraversal extends hydra.tinkerpop.gremlin.Query implements Serializable {
    public final hydra.tinkerpop.gremlin.RootTraversalQuery value;

    public RootTraversal (hydra.tinkerpop.gremlin.RootTraversalQuery value) {
      this.value = value;
    }
  ...
  public static final class ToString extends hydra.tinkerpop.gremlin.Query implements Serializable {
    public ToString () {
  ...
  public static final class Empty extends hydra.tinkerpop.gremlin.Query implements Serializable {
    public Empty () {
