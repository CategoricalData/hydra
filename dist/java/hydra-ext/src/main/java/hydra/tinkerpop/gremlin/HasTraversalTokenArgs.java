...
public class HasTraversalTokenArgs implements Serializable, Comparable<HasTraversalTokenArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.HasTraversalTokenArgs");
  ...
  public final hydra.tinkerpop.gremlin.TraversalTokenArgument traversalToken;

  public final hydra.tinkerpop.gremlin.HasTraversalTokenArgsRest rest;

  public HasTraversalTokenArgs (hydra.tinkerpop.gremlin.TraversalTokenArgument traversalToken, hydra.tinkerpop.gremlin.HasTraversalTokenArgsRest rest) {
  ...
  public HasTraversalTokenArgs withTraversalToken(hydra.tinkerpop.gremlin.TraversalTokenArgument traversalToken) {
    return new HasTraversalTokenArgs(traversalToken, rest);
  }

  public HasTraversalTokenArgs withRest(hydra.tinkerpop.gremlin.HasTraversalTokenArgsRest rest) {
    return new HasTraversalTokenArgs(traversalToken, rest);
  }
}
