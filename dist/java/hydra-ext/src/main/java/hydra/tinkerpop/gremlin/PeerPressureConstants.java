...
public abstract class PeerPressureConstants implements Serializable, Comparable<PeerPressureConstants> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.PeerPressureConstants");
  ...
  public static final class Edges extends hydra.tinkerpop.gremlin.PeerPressureConstants implements Serializable {
    public Edges () {
    ...
    public int compareTo(PeerPressureConstants other) {
  ...
  public static final class Times extends hydra.tinkerpop.gremlin.PeerPressureConstants implements Serializable {
    public Times () {
  ...
  public static final class PropertyName extends hydra.tinkerpop.gremlin.PeerPressureConstants implements Serializable {
    public PropertyName () {
