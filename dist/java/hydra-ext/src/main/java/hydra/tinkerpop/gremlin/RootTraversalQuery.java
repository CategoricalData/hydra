...
public class RootTraversalQuery implements Serializable, Comparable<RootTraversalQuery> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.RootTraversalQuery");
  ...
  public final hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalTerminalMethod> terminalMethod;

  public RootTraversalQuery (hydra.tinkerpop.gremlin.RootTraversal root, hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalTerminalMethod> terminalMethod) {
    this.root = root;
  ...
  public RootTraversalQuery withRoot(hydra.tinkerpop.gremlin.RootTraversal root) {
    return new RootTraversalQuery(root, terminalMethod);
  }

  public RootTraversalQuery withTerminalMethod(hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalTerminalMethod> terminalMethod) {
    return new RootTraversalQuery(root, terminalMethod);
  }
}
