...
public abstract class KeywordOrIdentifier implements Serializable, Comparable<KeywordOrIdentifier> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.KeywordOrIdentifier");
  ...
  public static final class Keyword extends hydra.tinkerpop.gremlin.KeywordOrIdentifier implements Serializable {
    public final hydra.tinkerpop.gremlin.Keyword value;

    public Keyword (hydra.tinkerpop.gremlin.Keyword value) {
      this.value = value;
    }
  ...
  public static final class Identifier extends hydra.tinkerpop.gremlin.KeywordOrIdentifier implements Serializable {
    public final hydra.tinkerpop.gremlin.Identifier value;

    public Identifier (hydra.tinkerpop.gremlin.Identifier value) {
      this.value = value;
    }
