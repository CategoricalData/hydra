...
public abstract class WithArgsKeys implements Serializable, Comparable<WithArgsKeys> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.WithArgsKeys");
  ...
  public static final class WithOption extends hydra.tinkerpop.gremlin.WithArgsKeys implements Serializable {
    public final hydra.tinkerpop.gremlin.WithOptionKeys value;

    public WithOption (hydra.tinkerpop.gremlin.WithOptionKeys value) {
      this.value = value;
    }
  ...
  public static final class String_ extends hydra.tinkerpop.gremlin.WithArgsKeys implements Serializable {
