...
public abstract class PageRankConstants implements Serializable, Comparable<PageRankConstants> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.PageRankConstants");
  ...
  public static final class Edges extends hydra.tinkerpop.gremlin.PageRankConstants implements Serializable {
    public Edges () {
    ...
    public int compareTo(PageRankConstants other) {
  ...
  public static final class Times extends hydra.tinkerpop.gremlin.PageRankConstants implements Serializable {
    public Times () {
  ...
  public static final class PropertyName extends hydra.tinkerpop.gremlin.PageRankConstants implements Serializable {
    public PropertyName () {
