...
public class VertexFeatures implements Serializable, Comparable<VertexFeatures> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.features.VertexFeatures");
  ...
  public final hydra.tinkerpop.features.VertexPropertyFeatures properties;
  ...
  public VertexFeatures withElementFeatures(hydra.tinkerpop.features.ElementFeatures elementFeatures) {
  ...
  public VertexFeatures withProperties(hydra.tinkerpop.features.VertexPropertyFeatures properties) {
    return new VertexFeatures(elementFeatures, properties, supportsAddVertices, supportsDuplicateMultiProperties, supportsMetaProperties, supportsMultiProperties, supportsRemoveVertices, supportsUpsert);
  }
