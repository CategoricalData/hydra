...
public abstract class WithOptionKeys implements Serializable, Comparable<WithOptionKeys> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.WithOptionKeys");
  ...
  public static final class ShortestPath extends hydra.tinkerpop.gremlin.WithOptionKeys implements Serializable {
    public final hydra.tinkerpop.gremlin.ShortestPathConstants value;

    public ShortestPath (hydra.tinkerpop.gremlin.ShortestPathConstants value) {
      this.value = value;
    }
  ...
  public static final class ConnectedComponent extends hydra.tinkerpop.gremlin.WithOptionKeys implements Serializable {
    public final hydra.tinkerpop.gremlin.ConnectedComponentConstants value;

    public ConnectedComponent (hydra.tinkerpop.gremlin.ConnectedComponentConstants value) {
      this.value = value;
    }
  ...
  public static final class PageRank extends hydra.tinkerpop.gremlin.WithOptionKeys implements Serializable {
    public final hydra.tinkerpop.gremlin.PageRankConstants value;

    public PageRank (hydra.tinkerpop.gremlin.PageRankConstants value) {
      this.value = value;
    }
  ...
  public static final class PeerPressure extends hydra.tinkerpop.gremlin.WithOptionKeys implements Serializable {
    public final hydra.tinkerpop.gremlin.PeerPressureConstants value;

    public PeerPressure (hydra.tinkerpop.gremlin.PeerPressureConstants value) {
      this.value = value;
    }
  ...
  public static final class Io extends hydra.tinkerpop.gremlin.WithOptionKeys implements Serializable {
    public final hydra.tinkerpop.gremlin.IoOptionsKeys value;

    public Io (hydra.tinkerpop.gremlin.IoOptionsKeys value) {
      this.value = value;
    }
  ...
  public static final class WithOptionsTokens extends hydra.tinkerpop.gremlin.WithOptionKeys implements Serializable {
  ...
  public static final class WithOptionsIndexer extends hydra.tinkerpop.gremlin.WithOptionKeys implements Serializable {
