...
public abstract class FromArgs implements Serializable, Comparable<FromArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.FromArgs");
  ...
  public static final class String_ extends hydra.tinkerpop.gremlin.FromArgs implements Serializable {
  ...
  public static final class Vertex extends hydra.tinkerpop.gremlin.FromArgs implements Serializable {
    public final hydra.tinkerpop.gremlin.StructureVertexArgument value;

    public Vertex (hydra.tinkerpop.gremlin.StructureVertexArgument value) {
      this.value = value;
    }
  ...
  public static final class Traversal extends hydra.tinkerpop.gremlin.FromArgs implements Serializable {
