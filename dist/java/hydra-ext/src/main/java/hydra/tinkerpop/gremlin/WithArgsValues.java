...
public abstract class WithArgsValues implements Serializable, Comparable<WithArgsValues> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.WithArgsValues");
  ...
  public static final class WithOptions extends hydra.tinkerpop.gremlin.WithArgsValues implements Serializable {
    public final hydra.tinkerpop.gremlin.WithOptionsValues value;

    public WithOptions (hydra.tinkerpop.gremlin.WithOptionsValues value) {
      this.value = value;
    }
  ...
  public static final class Io extends hydra.tinkerpop.gremlin.WithArgsValues implements Serializable {
    public final hydra.tinkerpop.gremlin.IoOptionsValues value;

    public Io (hydra.tinkerpop.gremlin.IoOptionsValues value) {
      this.value = value;
    }
  ...
  public static final class Object_ extends hydra.tinkerpop.gremlin.WithArgsValues implements Serializable {
