...
public class EdgeFeatures implements Serializable, Comparable<EdgeFeatures> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.features.EdgeFeatures");
  ...
  public final hydra.tinkerpop.features.EdgePropertyFeatures properties;
  ...
  public EdgeFeatures (hydra.tinkerpop.features.ElementFeatures elementFeatures, hydra.tinkerpop.features.EdgePropertyFeatures properties, Boolean supportsAddEdges, Boolean supportsRemoveEdges, Boolean supportsUpsert) {
  ...
  public EdgeFeatures withElementFeatures(hydra.tinkerpop.features.ElementFeatures elementFeatures) {
    return new EdgeFeatures(elementFeatures, properties, supportsAddEdges, supportsRemoveEdges, supportsUpsert);
  }

  public EdgeFeatures withProperties(hydra.tinkerpop.features.EdgePropertyFeatures properties) {
    return new EdgeFeatures(elementFeatures, properties, supportsAddEdges, supportsRemoveEdges, supportsUpsert);
  }
