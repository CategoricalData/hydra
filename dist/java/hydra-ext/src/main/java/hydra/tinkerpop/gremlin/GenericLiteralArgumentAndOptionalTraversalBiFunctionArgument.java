...
public class GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument implements Serializable, Comparable<GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument");
  ...
  public final hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalBiFunctionArgument> biFunction;

  public GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument (hydra.tinkerpop.gremlin.GenericLiteralArgument literal, hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalBiFunctionArgument> biFunction) {
  ...
  public GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument withLiteral(hydra.tinkerpop.gremlin.GenericLiteralArgument literal) {
    return new GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument(literal, biFunction);
  }

  public GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument withBiFunction(hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalBiFunctionArgument> biFunction) {
    return new GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument(literal, biFunction);
  }
}
