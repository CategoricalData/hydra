...
public class GenericLiteralList implements Serializable, Comparable<GenericLiteralList> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralList");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final java.util.List<hydra.tinkerpop.gremlin.GenericLiteral> value;

  public GenericLiteralList (java.util.List<hydra.tinkerpop.gremlin.GenericLiteral> value) {
    this.value = value;
  }
