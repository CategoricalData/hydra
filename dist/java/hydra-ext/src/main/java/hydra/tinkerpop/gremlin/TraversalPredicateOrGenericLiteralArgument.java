...
public abstract class TraversalPredicateOrGenericLiteralArgument implements Serializable, Comparable<TraversalPredicateOrGenericLiteralArgument> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument");
  ...
  public static final class Predicate extends hydra.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument implements Serializable {
  ...
  public static final class Literal extends hydra.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument implements Serializable {
    public final java.util.List<hydra.tinkerpop.gremlin.GenericLiteralArgument> value;

    public Literal (java.util.List<hydra.tinkerpop.gremlin.GenericLiteralArgument> value) {
      this.value = value;
    }
