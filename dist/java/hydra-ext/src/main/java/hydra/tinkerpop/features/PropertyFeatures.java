...
public class PropertyFeatures implements Serializable, Comparable<PropertyFeatures> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.features.PropertyFeatures");
  ...
  public final hydra.tinkerpop.features.DataTypeFeatures dataTypeFeatures;
  ...
  public PropertyFeatures (hydra.tinkerpop.features.DataTypeFeatures dataTypeFeatures, Boolean supportsProperties) {
  ...
  public PropertyFeatures withDataTypeFeatures(hydra.tinkerpop.features.DataTypeFeatures dataTypeFeatures) {
