...
public class SubstringArgs implements Serializable, Comparable<SubstringArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.SubstringArgs");
  ...
  public final hydra.tinkerpop.gremlin.IntegerArgument start;

  public final hydra.util.Maybe<hydra.tinkerpop.gremlin.IntegerArgument> end;

  public SubstringArgs (hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.tinkerpop.gremlin.IntegerArgument start, hydra.util.Maybe<hydra.tinkerpop.gremlin.IntegerArgument> end) {
    this.scope = scope;
    this.start = start;
    this.end = end;
  }
  ...
  public SubstringArgs withScope(hydra.util.Maybe<hydra.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    return new SubstringArgs(scope, start, end);
  }

  public SubstringArgs withStart(hydra.tinkerpop.gremlin.IntegerArgument start) {
    return new SubstringArgs(scope, start, end);
  }

  public SubstringArgs withEnd(hydra.util.Maybe<hydra.tinkerpop.gremlin.IntegerArgument> end) {
    return new SubstringArgs(scope, start, end);
  }
}
