...
public abstract class TraversalOrder implements Serializable, Comparable<TraversalOrder> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalOrder");
  ...
  public static final class Incr extends hydra.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Incr () {
  ...
  public static final class Decr extends hydra.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Decr () {
  ...
  public static final class Asc extends hydra.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Asc () {
  ...
  public static final class Desc extends hydra.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Desc () {
  ...
  public static final class Shuffle extends hydra.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Shuffle () {
