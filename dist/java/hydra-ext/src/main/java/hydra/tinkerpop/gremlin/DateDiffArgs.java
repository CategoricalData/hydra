...
public abstract class DateDiffArgs implements Serializable, Comparable<DateDiffArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.DateDiffArgs");
  ...
  public static final class Traversal extends hydra.tinkerpop.gremlin.DateDiffArgs implements Serializable {
  ...
  public static final class Date extends hydra.tinkerpop.gremlin.DateDiffArgs implements Serializable {
    public final hydra.tinkerpop.gremlin.DateArgument value;

    public Date (hydra.tinkerpop.gremlin.DateArgument value) {
      this.value = value;
    }
