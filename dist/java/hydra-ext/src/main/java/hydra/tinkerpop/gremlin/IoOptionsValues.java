...
public abstract class IoOptionsValues implements Serializable, Comparable<IoOptionsValues> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.IoOptionsValues");
  ...
  public static final class Gryo extends hydra.tinkerpop.gremlin.IoOptionsValues implements Serializable {
    public Gryo () {
  ...
  public static final class Graphson extends hydra.tinkerpop.gremlin.IoOptionsValues implements Serializable {
    public Graphson () {
  ...
  public static final class Graphml extends hydra.tinkerpop.gremlin.IoOptionsValues implements Serializable {
    public Graphml () {
