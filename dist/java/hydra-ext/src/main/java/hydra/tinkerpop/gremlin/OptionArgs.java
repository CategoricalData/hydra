...
public abstract class OptionArgs implements Serializable, Comparable<OptionArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.OptionArgs");
  ...
  public static final class PredicateTraversal extends hydra.tinkerpop.gremlin.OptionArgs implements Serializable {
    public final hydra.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal value;

    public PredicateTraversal (hydra.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal value) {
      this.value = value;
    }
  ...
  public static final class MergeMap extends hydra.tinkerpop.gremlin.OptionArgs implements Serializable {
    public final hydra.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument value;

    public MergeMap (hydra.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument value) {
      this.value = value;
    }
  ...
  public static final class MergeTraversal extends hydra.tinkerpop.gremlin.OptionArgs implements Serializable {
    public final hydra.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal value;

    public MergeTraversal (hydra.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal value) {
      this.value = value;
    }
  ...
  public static final class ObjectTraversal extends hydra.tinkerpop.gremlin.OptionArgs implements Serializable {
    public final hydra.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal value;

    public ObjectTraversal (hydra.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal value) {
      this.value = value;
    }
  ...
  public static final class Traversal extends hydra.tinkerpop.gremlin.OptionArgs implements Serializable {
