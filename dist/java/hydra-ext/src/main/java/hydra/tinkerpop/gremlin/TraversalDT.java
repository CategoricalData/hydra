...
public abstract class TraversalDT implements Serializable, Comparable<TraversalDT> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalDT");
  ...
  public static final class Second extends hydra.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Second () {
  ...
  public static final class Minute extends hydra.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Minute () {
  ...
  public static final class Hour extends hydra.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Hour () {
  ...
  public static final class Day extends hydra.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Day () {
