...
public abstract class TransactionPart implements Serializable, Comparable<TransactionPart> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TransactionPart");
  ...
  public static final class Begin extends hydra.tinkerpop.gremlin.TransactionPart implements Serializable {
    public Begin () {
  ...
  public static final class Commit extends hydra.tinkerpop.gremlin.TransactionPart implements Serializable {
    public Commit () {
  ...
  public static final class Rollback extends hydra.tinkerpop.gremlin.TransactionPart implements Serializable {
    public Rollback () {
