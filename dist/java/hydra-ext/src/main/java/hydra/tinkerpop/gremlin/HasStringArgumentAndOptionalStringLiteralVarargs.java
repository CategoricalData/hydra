...
public class HasStringArgumentAndOptionalStringLiteralVarargs implements Serializable, Comparable<HasStringArgumentAndOptionalStringLiteralVarargs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargs");
  ...
  public final hydra.util.Maybe<hydra.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest> rest;

  public HasStringArgumentAndOptionalStringLiteralVarargs (hydra.tinkerpop.gremlin.StringNullableArgument string, hydra.util.Maybe<hydra.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest> rest) {
    this.string = string;
    this.rest = rest;
  }
  ...
  public HasStringArgumentAndOptionalStringLiteralVarargs withString(hydra.tinkerpop.gremlin.StringNullableArgument string) {
    return new HasStringArgumentAndOptionalStringLiteralVarargs(string, rest);
  }

  public HasStringArgumentAndOptionalStringLiteralVarargs withRest(hydra.util.Maybe<hydra.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest> rest) {
    return new HasStringArgumentAndOptionalStringLiteralVarargs(string, rest);
  }
}
