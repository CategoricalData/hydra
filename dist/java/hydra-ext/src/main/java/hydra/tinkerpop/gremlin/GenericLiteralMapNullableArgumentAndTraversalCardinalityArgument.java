...
public class GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument implements Serializable, Comparable<GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument");
  ...
  public final hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument object;

  public GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument (hydra.tinkerpop.gremlin.TraversalCardinalityArgument cardinality, hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument object) {
  ...
  public GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument withCardinality(hydra.tinkerpop.gremlin.TraversalCardinalityArgument cardinality) {
    return new GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument(cardinality, object);
  }

  public GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument withObject(hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument object) {
    return new GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument(cardinality, object);
  }
}
