...
public abstract class TraversalToken implements Serializable, Comparable<TraversalToken> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalToken");
  ...
  public static final class Id extends hydra.tinkerpop.gremlin.TraversalToken implements Serializable {
    public Id () {
  ...
  public static final class Label extends hydra.tinkerpop.gremlin.TraversalToken implements Serializable {
    public Label () {
  ...
  public static final class Key extends hydra.tinkerpop.gremlin.TraversalToken implements Serializable {
    public Key () {
  ...
  public static final class Value extends hydra.tinkerpop.gremlin.TraversalToken implements Serializable {
    public Value () {
