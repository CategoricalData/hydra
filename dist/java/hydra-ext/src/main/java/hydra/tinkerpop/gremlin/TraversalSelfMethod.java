...
public abstract class TraversalSelfMethod implements Serializable, Comparable<TraversalSelfMethod> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSelfMethod");
  ...
  public static final class Discard extends hydra.tinkerpop.gremlin.TraversalSelfMethod implements Serializable {
    public Discard () {
