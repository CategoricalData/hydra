...
public class MergeAction implements Serializable, Comparable<MergeAction> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.MergeAction");
  ...
  public final hydra.cypher.openCypher.MatchOrCreate action;

  public final hydra.cypher.openCypher.Set set;

  public MergeAction (hydra.cypher.openCypher.MatchOrCreate action, hydra.cypher.openCypher.Set set) {
    this.action = action;
    this.set = set;
  }
  ...
  public MergeAction withAction(hydra.cypher.openCypher.MatchOrCreate action) {
    return new MergeAction(action, set);
  }

  public MergeAction withSet(hydra.cypher.openCypher.Set set) {
    return new MergeAction(action, set);
  }
}
