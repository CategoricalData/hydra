...
public abstract class PatternElement implements Serializable, Comparable<PatternElement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.PatternElement");
  ...
  public static final class Chained extends hydra.cypher.openCypher.PatternElement implements Serializable {
    public final hydra.cypher.openCypher.NodePatternChain value;

    public Chained (hydra.cypher.openCypher.NodePatternChain value) {
      this.value = value;
    }
  ...
  public static final class Parenthesized extends hydra.cypher.openCypher.PatternElement implements Serializable {
    public final hydra.cypher.openCypher.PatternElement value;

    public Parenthesized (hydra.cypher.openCypher.PatternElement value) {
      this.value = value;
    }
