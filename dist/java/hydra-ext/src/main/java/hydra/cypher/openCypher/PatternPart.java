...
public class PatternPart implements Serializable, Comparable<PatternPart> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.PatternPart");
  ...
  public final hydra.cypher.openCypher.AnonymousPatternPart pattern;

  public PatternPart (hydra.util.Maybe<hydra.cypher.openCypher.Variable> variable, hydra.cypher.openCypher.AnonymousPatternPart pattern) {
  ...
  public PatternPart withVariable(hydra.util.Maybe<hydra.cypher.openCypher.Variable> variable) {
    return new PatternPart(variable, pattern);
  }

  public PatternPart withPattern(hydra.cypher.openCypher.AnonymousPatternPart pattern) {
    return new PatternPart(variable, pattern);
  }
}
