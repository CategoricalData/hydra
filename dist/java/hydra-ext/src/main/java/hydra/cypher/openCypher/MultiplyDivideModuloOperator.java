...
public abstract class MultiplyDivideModuloOperator implements Serializable, Comparable<MultiplyDivideModuloOperator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.MultiplyDivideModuloOperator");
  ...
  public static final class Multiply extends hydra.cypher.openCypher.MultiplyDivideModuloOperator implements Serializable {
    public Multiply () {
  ...
  public static final class Divide extends hydra.cypher.openCypher.MultiplyDivideModuloOperator implements Serializable {
    public Divide () {
  ...
  public static final class Modulo extends hydra.cypher.openCypher.MultiplyDivideModuloOperator implements Serializable {
    public Modulo () {
