...
public class Delete implements Serializable, Comparable<Delete> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.Delete");
  ...
  public final java.util.List<hydra.cypher.openCypher.Expression> expressions;

  public Delete (Boolean detach, java.util.List<hydra.cypher.openCypher.Expression> expressions) {
    this.detach = detach;
  ...
  public Delete withExpressions(java.util.List<hydra.cypher.openCypher.Expression> expressions) {
    return new Delete(detach, expressions);
  }
}
