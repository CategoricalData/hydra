...
public class PatternWhere implements Serializable, Comparable<PatternWhere> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.PatternWhere");
  ...
  public final hydra.cypher.openCypher.Pattern pattern;

  public final hydra.util.Maybe<hydra.cypher.openCypher.Where> where;

  public PatternWhere (hydra.cypher.openCypher.Pattern pattern, hydra.util.Maybe<hydra.cypher.openCypher.Where> where) {
  ...
  public PatternWhere withPattern(hydra.cypher.openCypher.Pattern pattern) {
    return new PatternWhere(pattern, where);
  }

  public PatternWhere withWhere(hydra.util.Maybe<hydra.cypher.openCypher.Where> where) {
    return new PatternWhere(pattern, where);
  }
}
