...
public class YieldItems implements Serializable, Comparable<YieldItems> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.YieldItems");
  ...
  public final java.util.List<hydra.cypher.openCypher.YieldItem> items;

  public final hydra.util.Maybe<hydra.cypher.openCypher.Where> where;

  public YieldItems (java.util.List<hydra.cypher.openCypher.YieldItem> items, hydra.util.Maybe<hydra.cypher.openCypher.Where> where) {
    this.items = items;
    this.where = where;
  }
  ...
  public YieldItems withItems(java.util.List<hydra.cypher.openCypher.YieldItem> items) {
    return new YieldItems(items, where);
  }

  public YieldItems withWhere(hydra.util.Maybe<hydra.cypher.openCypher.Where> where) {
    return new YieldItems(items, where);
  }
}
