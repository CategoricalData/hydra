...
public class ProjectionBody implements Serializable, Comparable<ProjectionBody> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.ProjectionBody");
  ...
  public final hydra.cypher.openCypher.ProjectionItems projectionItems;

  public final hydra.util.Maybe<hydra.cypher.openCypher.Order> order;

  public final hydra.util.Maybe<hydra.cypher.openCypher.Skip> skip;

  public final hydra.util.Maybe<hydra.cypher.openCypher.Limit> limit;

  public ProjectionBody (Boolean distinct, hydra.cypher.openCypher.ProjectionItems projectionItems, hydra.util.Maybe<hydra.cypher.openCypher.Order> order, hydra.util.Maybe<hydra.cypher.openCypher.Skip> skip, hydra.util.Maybe<hydra.cypher.openCypher.Limit> limit) {
  ...
  public ProjectionBody withProjectionItems(hydra.cypher.openCypher.ProjectionItems projectionItems) {
    return new ProjectionBody(distinct, projectionItems, order, skip, limit);
  }

  public ProjectionBody withOrder(hydra.util.Maybe<hydra.cypher.openCypher.Order> order) {
    return new ProjectionBody(distinct, projectionItems, order, skip, limit);
  }

  public ProjectionBody withSkip(hydra.util.Maybe<hydra.cypher.openCypher.Skip> skip) {
    return new ProjectionBody(distinct, projectionItems, order, skip, limit);
  }

  public ProjectionBody withLimit(hydra.util.Maybe<hydra.cypher.openCypher.Limit> limit) {
    return new ProjectionBody(distinct, projectionItems, order, skip, limit);
  }
}
