...
public abstract class SortOrder implements Serializable, Comparable<SortOrder> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.SortOrder");
  ...
  public static final class Ascending extends hydra.cypher.openCypher.SortOrder implements Serializable {
    public Ascending () {
  ...
  public static final class Descending extends hydra.cypher.openCypher.SortOrder implements Serializable {
    public Descending () {
