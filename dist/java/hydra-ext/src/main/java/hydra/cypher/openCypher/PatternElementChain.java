...
public class PatternElementChain implements Serializable, Comparable<PatternElementChain> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.PatternElementChain");
  ...
  public final hydra.cypher.openCypher.RelationshipPattern relationship;

  public final hydra.cypher.openCypher.NodePattern node;

  public PatternElementChain (hydra.cypher.openCypher.RelationshipPattern relationship, hydra.cypher.openCypher.NodePattern node) {
  ...
  public PatternElementChain withRelationship(hydra.cypher.openCypher.RelationshipPattern relationship) {
    return new PatternElementChain(relationship, node);
  }

  public PatternElementChain withNode(hydra.cypher.openCypher.NodePattern node) {
    return new PatternElementChain(relationship, node);
  }
}
