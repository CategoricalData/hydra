...
public abstract class SingleQuery implements Serializable, Comparable<SingleQuery> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.SingleQuery");
  ...
  public static final class SinglePart extends hydra.cypher.openCypher.SingleQuery implements Serializable {
    public final hydra.cypher.openCypher.SinglePartQuery value;

    public SinglePart (hydra.cypher.openCypher.SinglePartQuery value) {
      this.value = value;
    }
  ...
  public static final class MultiPart extends hydra.cypher.openCypher.SingleQuery implements Serializable {
    public final hydra.cypher.openCypher.MultiPartQuery value;

    public MultiPart (hydra.cypher.openCypher.MultiPartQuery value) {
      this.value = value;
    }
