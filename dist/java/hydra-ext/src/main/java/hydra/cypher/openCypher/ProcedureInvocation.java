...
public abstract class ProcedureInvocation implements Serializable, Comparable<ProcedureInvocation> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.ProcedureInvocation");
  ...
  public static final class Explicit extends hydra.cypher.openCypher.ProcedureInvocation implements Serializable {
    public final hydra.cypher.openCypher.ExplicitProcedureInvocation value;

    public Explicit (hydra.cypher.openCypher.ExplicitProcedureInvocation value) {
      this.value = value;
    }
  ...
  public static final class Implicit extends hydra.cypher.openCypher.ProcedureInvocation implements Serializable {
    public final hydra.cypher.openCypher.ImplicitProcedureInvocation value;

    public Implicit (hydra.cypher.openCypher.ImplicitProcedureInvocation value) {
      this.value = value;
    }
