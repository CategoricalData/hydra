...
public class IdInColl implements Serializable, Comparable<IdInColl> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.IdInColl");
  ...
  public IdInColl (hydra.cypher.openCypher.Variable variable, hydra.cypher.openCypher.Expression expression) {
  ...
  public IdInColl withVariable(hydra.cypher.openCypher.Variable variable) {
    return new IdInColl(variable, expression);
  }

  public IdInColl withExpression(hydra.cypher.openCypher.Expression expression) {
    return new IdInColl(variable, expression);
  }
}
