...
public abstract class ListOperatorExpression implements Serializable, Comparable<ListOperatorExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.cypher.openCypher.ListOperatorExpression");
  ...
  public static final class Single extends hydra.cypher.openCypher.ListOperatorExpression implements Serializable {
    public final hydra.cypher.openCypher.Expression value;

    public Single (hydra.cypher.openCypher.Expression value) {
      this.value = value;
    }
  ...
  public static final class Range extends hydra.cypher.openCypher.ListOperatorExpression implements Serializable {
    public final hydra.cypher.openCypher.RangeExpression value;

    public Range (hydra.cypher.openCypher.RangeExpression value) {
      this.value = value;
    }
