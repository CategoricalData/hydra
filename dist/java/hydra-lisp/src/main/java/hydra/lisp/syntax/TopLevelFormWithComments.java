...
public class TopLevelFormWithComments implements Serializable, Comparable<TopLevelFormWithComments> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.TopLevelFormWithComments");
   ...
   * Optional comment
   */
  public final hydra.util.Maybe<hydra.lisp.syntax.Comment> comment;

  /**
   * The form itself
   */
  public final hydra.lisp.syntax.TopLevelForm form;

  public TopLevelFormWithComments (hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc, hydra.util.Maybe<hydra.lisp.syntax.Comment> comment, hydra.lisp.syntax.TopLevelForm form) {
    this.doc = doc;
  ...
  public TopLevelFormWithComments withDoc(hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc) {
    return new TopLevelFormWithComments(doc, comment, form);
  }

  public TopLevelFormWithComments withComment(hydra.util.Maybe<hydra.lisp.syntax.Comment> comment) {
    return new TopLevelFormWithComments(doc, comment, form);
  }

  public TopLevelFormWithComments withForm(hydra.lisp.syntax.TopLevelForm form) {
    return new TopLevelFormWithComments(doc, comment, form);
  }
}
