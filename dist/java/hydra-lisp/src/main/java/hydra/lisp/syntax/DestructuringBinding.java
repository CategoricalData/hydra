...
public class DestructuringBinding implements Serializable, Comparable<DestructuringBinding> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.DestructuringBinding");
   ...
   */
  public final hydra.lisp.syntax.DestructuringPattern pattern;
  ...
  public DestructuringBinding (hydra.lisp.syntax.DestructuringPattern pattern, hydra.lisp.syntax.Expression value) {
  ...
  public DestructuringBinding withPattern(hydra.lisp.syntax.DestructuringPattern pattern) {
    return new DestructuringBinding(pattern, value);
  }

  public DestructuringBinding withValue(hydra.lisp.syntax.Expression value) {
    return new DestructuringBinding(pattern, value);
  }
}
