...
public class OrExpression implements Serializable, Comparable<OrExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.OrExpression");
  ...
  public OrExpression (java.util.List<hydra.lisp.syntax.Expression> expressions) {
