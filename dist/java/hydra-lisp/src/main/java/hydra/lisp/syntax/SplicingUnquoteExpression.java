...
public class SplicingUnquoteExpression implements Serializable, Comparable<SplicingUnquoteExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.SplicingUnquoteExpression");
  ...
  public SplicingUnquoteExpression (hydra.lisp.syntax.Expression body) {
    this.body = body;
  }
