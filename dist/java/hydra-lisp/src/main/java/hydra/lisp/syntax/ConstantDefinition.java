...
public class ConstantDefinition implements Serializable, Comparable<ConstantDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.ConstantDefinition");
  ...
  public ConstantDefinition (hydra.lisp.syntax.Symbol name, hydra.lisp.syntax.Expression value, hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc) {
    this.name = name;
    this.value = value;
    this.doc = doc;
  }
  ...
  public ConstantDefinition withName(hydra.lisp.syntax.Symbol name) {
    return new ConstantDefinition(name, value, doc);
  }

  public ConstantDefinition withValue(hydra.lisp.syntax.Expression value) {
    return new ConstantDefinition(name, value, doc);
  }

  public ConstantDefinition withDoc(hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc) {
    return new ConstantDefinition(name, value, doc);
  }
}
