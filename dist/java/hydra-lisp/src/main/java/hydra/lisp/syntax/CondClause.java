...
public class CondClause implements Serializable, Comparable<CondClause> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.CondClause");
  ...
  public CondClause (hydra.lisp.syntax.Expression condition, hydra.lisp.syntax.Expression body) {
  ...
  public CondClause withCondition(hydra.lisp.syntax.Expression condition) {
    return new CondClause(condition, body);
  }

  public CondClause withBody(hydra.lisp.syntax.Expression body) {
    return new CondClause(condition, body);
  }
}
