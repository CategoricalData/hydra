...
public class VariableDefinition implements Serializable, Comparable<VariableDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.lisp.syntax.VariableDefinition");
  ...
  public VariableDefinition (hydra.lisp.syntax.Symbol name, hydra.lisp.syntax.Expression value, hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc) {
    this.name = name;
    this.value = value;
    this.doc = doc;
  }
  ...
  public VariableDefinition withName(hydra.lisp.syntax.Symbol name) {
    return new VariableDefinition(name, value, doc);
  }

  public VariableDefinition withValue(hydra.lisp.syntax.Expression value) {
    return new VariableDefinition(name, value, doc);
  }

  public VariableDefinition withDoc(hydra.util.Maybe<hydra.lisp.syntax.Docstring> doc) {
    return new VariableDefinition(name, value, doc);
  }
}
