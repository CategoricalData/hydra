...
public abstract class SumOp implements Serializable, Comparable<SumOp> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.SumOp");
  ...
  public static final class Add extends hydra.python.syntax.SumOp implements Serializable {
    public Add () {
  ...
  public static final class Sub extends hydra.python.syntax.SumOp implements Serializable {
    public Sub () {
