...
public abstract class StarAtom implements Serializable, Comparable<StarAtom> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.StarAtom");
  ...
  public static final class Name extends hydra.python.syntax.StarAtom implements Serializable {
  ...
  public static final class TargetWithStarAtom extends hydra.python.syntax.StarAtom implements Serializable {
    public final hydra.python.syntax.TargetWithStarAtom value;

    public TargetWithStarAtom (hydra.python.syntax.TargetWithStarAtom value) {
      this.value = value;
    }
  ...
  public static final class StarTargetsTupleSeq extends hydra.python.syntax.StarAtom implements Serializable {
    public final hydra.util.Maybe<hydra.python.syntax.StarTargetsTupleSeq> value;

    public StarTargetsTupleSeq (hydra.util.Maybe<hydra.python.syntax.StarTargetsTupleSeq> value) {
      this.value = value;
    }
  ...
  public static final class StarTargetsListSeq extends hydra.python.syntax.StarAtom implements Serializable {
    public final hydra.util.Maybe<hydra.python.syntax.StarTargetsListSeq> value;

    public StarTargetsListSeq (hydra.util.Maybe<hydra.python.syntax.StarTargetsListSeq> value) {
      this.value = value;
    }
