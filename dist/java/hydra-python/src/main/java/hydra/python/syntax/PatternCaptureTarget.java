...
public class PatternCaptureTarget implements Serializable, Comparable<PatternCaptureTarget> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.PatternCaptureTarget");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.python.syntax.Name value;

  public PatternCaptureTarget (hydra.python.syntax.Name value) {
    this.value = value;
  }
