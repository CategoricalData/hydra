...
public class FunctionDefRaw implements Serializable, Comparable<FunctionDefRaw> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.FunctionDefRaw");
  ...
  public final hydra.util.Maybe<hydra.python.syntax.Parameters> params;

  public final hydra.util.Maybe<hydra.python.syntax.Expression> returnType;

  public final hydra.util.Maybe<hydra.python.syntax.FuncTypeComment> funcTypeComment;

  public final hydra.python.syntax.Block block;

  public FunctionDefRaw (Boolean async, hydra.python.syntax.Name name, java.util.List<hydra.python.syntax.TypeParameter> typeParams, hydra.util.Maybe<hydra.python.syntax.Parameters> params, hydra.util.Maybe<hydra.python.syntax.Expression> returnType, hydra.util.Maybe<hydra.python.syntax.FuncTypeComment> funcTypeComment, hydra.python.syntax.Block block) {
    this.async = async;
    this.name = name;
  ...
  public FunctionDefRaw withName(hydra.python.syntax.Name name) {
    return new FunctionDefRaw(async, name, typeParams, params, returnType, funcTypeComment, block);
  }

  public FunctionDefRaw withTypeParams(java.util.List<hydra.python.syntax.TypeParameter> typeParams) {
    return new FunctionDefRaw(async, name, typeParams, params, returnType, funcTypeComment, block);
  }

  public FunctionDefRaw withParams(hydra.util.Maybe<hydra.python.syntax.Parameters> params) {
    return new FunctionDefRaw(async, name, typeParams, params, returnType, funcTypeComment, block);
  }

  public FunctionDefRaw withReturnType(hydra.util.Maybe<hydra.python.syntax.Expression> returnType) {
    return new FunctionDefRaw(async, name, typeParams, params, returnType, funcTypeComment, block);
  }

  public FunctionDefRaw withFuncTypeComment(hydra.util.Maybe<hydra.python.syntax.FuncTypeComment> funcTypeComment) {
    return new FunctionDefRaw(async, name, typeParams, params, returnType, funcTypeComment, block);
  }

  public FunctionDefRaw withBlock(hydra.python.syntax.Block block) {
    return new FunctionDefRaw(async, name, typeParams, params, returnType, funcTypeComment, block);
  }
}
