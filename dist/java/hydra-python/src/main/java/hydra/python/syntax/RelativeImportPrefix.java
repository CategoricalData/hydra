...
public abstract class RelativeImportPrefix implements Serializable, Comparable<RelativeImportPrefix> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.RelativeImportPrefix");
  ...
  public static final class Dot extends hydra.python.syntax.RelativeImportPrefix implements Serializable {
    public Dot () {
  ...
  public static final class Ellipsis extends hydra.python.syntax.RelativeImportPrefix implements Serializable {
    public Ellipsis () {
