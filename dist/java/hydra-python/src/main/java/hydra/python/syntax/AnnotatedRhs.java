...
public abstract class AnnotatedRhs implements Serializable, Comparable<AnnotatedRhs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.AnnotatedRhs");
  ...
  public static final class Yield extends hydra.python.syntax.AnnotatedRhs implements Serializable {
  ...
  public static final class Star extends hydra.python.syntax.AnnotatedRhs implements Serializable {
    public final java.util.List<hydra.python.syntax.StarExpression> value;

    public Star (java.util.List<hydra.python.syntax.StarExpression> value) {
      this.value = value;
    }
