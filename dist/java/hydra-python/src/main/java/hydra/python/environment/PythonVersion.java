...
public abstract class PythonVersion implements Serializable, Comparable<PythonVersion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.environment.PythonVersion");
  ...
  public static final class Python310 extends hydra.python.environment.PythonVersion implements Serializable {
    public Python310 () {
  ...
  public static final class Python312 extends hydra.python.environment.PythonVersion implements Serializable {
    public Python312 () {
