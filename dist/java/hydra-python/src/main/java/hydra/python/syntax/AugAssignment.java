...
public class AugAssignment implements Serializable, Comparable<AugAssignment> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.AugAssignment");
  ...
  public final hydra.python.syntax.AugAssign augassign;

  public final hydra.python.syntax.AnnotatedRhs rhs;

  public AugAssignment (hydra.python.syntax.SingleTarget lhs, hydra.python.syntax.AugAssign augassign, hydra.python.syntax.AnnotatedRhs rhs) {
    this.lhs = lhs;
  ...
  public AugAssignment withLhs(hydra.python.syntax.SingleTarget lhs) {
    return new AugAssignment(lhs, augassign, rhs);
  }

  public AugAssignment withAugassign(hydra.python.syntax.AugAssign augassign) {
    return new AugAssignment(lhs, augassign, rhs);
  }

  public AugAssignment withRhs(hydra.python.syntax.AnnotatedRhs rhs) {
    return new AugAssignment(lhs, augassign, rhs);
  }
}
