...
public class LambdaSlashWithDefault implements Serializable, Comparable<LambdaSlashWithDefault> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.LambdaSlashWithDefault");
  ...
  public LambdaSlashWithDefault (java.util.List<hydra.python.syntax.LambdaParamNoDefault> paramNoDefault, java.util.List<hydra.python.syntax.LambdaParamWithDefault> paramWithDefault) {
  ...
  public LambdaSlashWithDefault withParamNoDefault(java.util.List<hydra.python.syntax.LambdaParamNoDefault> paramNoDefault) {
    return new LambdaSlashWithDefault(paramNoDefault, paramWithDefault);
  }

  public LambdaSlashWithDefault withParamWithDefault(java.util.List<hydra.python.syntax.LambdaParamWithDefault> paramWithDefault) {
    return new LambdaSlashWithDefault(paramNoDefault, paramWithDefault);
  }
}
