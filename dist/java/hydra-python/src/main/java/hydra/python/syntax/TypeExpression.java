...
public abstract class TypeExpression implements Serializable, Comparable<TypeExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.TypeExpression");
  ...
  public static final class Expression extends hydra.python.syntax.TypeExpression implements Serializable {
  ...
  public static final class StarredExpression extends hydra.python.syntax.TypeExpression implements Serializable {
    public final hydra.python.syntax.Expression value;
  ...
  public static final class DoubleStarredExpression extends hydra.python.syntax.TypeExpression implements Serializable {
    public final hydra.python.syntax.Expression value;

    public DoubleStarredExpression (hydra.python.syntax.Expression value) {
      this.value = value;
    }
