...
public abstract class TermOp implements Serializable, Comparable<TermOp> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.TermOp");
  ...
  public static final class Mul extends hydra.python.syntax.TermOp implements Serializable {
    public Mul () {
  ...
  public static final class Div extends hydra.python.syntax.TermOp implements Serializable {
    public Div () {
  ...
  public static final class Floordiv extends hydra.python.syntax.TermOp implements Serializable {
    public Floordiv () {
  ...
  public static final class Mod extends hydra.python.syntax.TermOp implements Serializable {
    public Mod () {
  ...
  public static final class Matmul extends hydra.python.syntax.TermOp implements Serializable {
    public Matmul () {
