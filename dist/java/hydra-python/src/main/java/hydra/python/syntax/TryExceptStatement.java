...
public class TryExceptStatement implements Serializable, Comparable<TryExceptStatement> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.TryExceptStatement");
  ...
  public final java.util.List<hydra.python.syntax.ExceptBlock> excepts;
  ...
  public TryExceptStatement (hydra.python.syntax.Block body, java.util.List<hydra.python.syntax.ExceptBlock> excepts, hydra.util.Maybe<hydra.python.syntax.Block> else_, hydra.util.Maybe<hydra.python.syntax.Block> finally_) {
    this.body = body;
  ...
  public TryExceptStatement withBody(hydra.python.syntax.Block body) {
    return new TryExceptStatement(body, excepts, else_, finally_);
  }

  public TryExceptStatement withExcepts(java.util.List<hydra.python.syntax.ExceptBlock> excepts) {
    return new TryExceptStatement(body, excepts, else_, finally_);
  }

  public TryExceptStatement withElse(hydra.util.Maybe<hydra.python.syntax.Block> else_) {
    return new TryExceptStatement(body, excepts, else_, finally_);
  }

  public TryExceptStatement withFinally(hydra.util.Maybe<hydra.python.syntax.Block> finally_) {
    return new TryExceptStatement(body, excepts, else_, finally_);
  }
}
