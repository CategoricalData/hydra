...
public class SumLhs implements Serializable, Comparable<SumLhs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.SumLhs");
  ...
  public final hydra.python.syntax.Sum operand;

  public final hydra.python.syntax.SumOp operator;

  public SumLhs (hydra.python.syntax.Sum operand, hydra.python.syntax.SumOp operator) {
  ...
  public SumLhs withOperand(hydra.python.syntax.Sum operand) {
    return new SumLhs(operand, operator);
  }

  public SumLhs withOperator(hydra.python.syntax.SumOp operator) {
    return new SumLhs(operand, operator);
  }
}
