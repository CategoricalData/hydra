...
public class Listcomp implements Serializable, Comparable<Listcomp> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.Listcomp");
  ...
  public Listcomp (hydra.python.syntax.NamedExpression expression, hydra.python.syntax.ForIfClauses forIfClauses) {
  ...
  public Listcomp withExpression(hydra.python.syntax.NamedExpression expression) {
    return new Listcomp(expression, forIfClauses);
  }

  public Listcomp withForIfClauses(hydra.python.syntax.ForIfClauses forIfClauses) {
    return new Listcomp(expression, forIfClauses);
  }
}
