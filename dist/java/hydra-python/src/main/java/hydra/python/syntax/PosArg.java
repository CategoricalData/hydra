...
public abstract class PosArg implements Serializable, Comparable<PosArg> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.PosArg");
  ...
  public static final class Starred extends hydra.python.syntax.PosArg implements Serializable {
    public final hydra.python.syntax.StarredExpression value;

    public Starred (hydra.python.syntax.StarredExpression value) {
      this.value = value;
    }
  ...
  public static final class Assignment extends hydra.python.syntax.PosArg implements Serializable {
  ...
  public static final class Expression extends hydra.python.syntax.PosArg implements Serializable {
    public final hydra.python.syntax.Expression value;

    public Expression (hydra.python.syntax.Expression value) {
      this.value = value;
    }
