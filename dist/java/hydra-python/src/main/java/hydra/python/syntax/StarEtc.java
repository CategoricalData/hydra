...
public abstract class StarEtc implements Serializable, Comparable<StarEtc> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.StarEtc");
  ...
  public static final class StarNoDefault extends hydra.python.syntax.StarEtc implements Serializable {
    public final hydra.python.syntax.NoDefaultStarEtc value;

    public StarNoDefault (hydra.python.syntax.NoDefaultStarEtc value) {
      this.value = value;
    }
  ...
  public static final class StarNoDefaultStarAnnotation extends hydra.python.syntax.StarEtc implements Serializable {
    public final hydra.python.syntax.NoDefaultStarAnnotationStarEtc value;

    public StarNoDefaultStarAnnotation (hydra.python.syntax.NoDefaultStarAnnotationStarEtc value) {
      this.value = value;
    }
  ...
  public static final class StarComma extends hydra.python.syntax.StarEtc implements Serializable {
    public final hydra.python.syntax.CommaStarEtc value;

    public StarComma (hydra.python.syntax.CommaStarEtc value) {
      this.value = value;
    }
  ...
  public static final class Keywords extends hydra.python.syntax.StarEtc implements Serializable {
    public final hydra.python.syntax.Keywords value;

    public Keywords (hydra.python.syntax.Keywords value) {
      this.value = value;
    }
