...
public class SlashWithDefaultParameters implements Serializable, Comparable<SlashWithDefaultParameters> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.python.syntax.SlashWithDefaultParameters");
  ...
  public SlashWithDefaultParameters (java.util.List<hydra.python.syntax.ParamNoDefault> paramNoDefault, java.util.List<hydra.python.syntax.ParamWithDefault> paramWithDefault, hydra.util.Maybe<hydra.python.syntax.StarEtc> starEtc) {
  ...
  public SlashWithDefaultParameters withParamNoDefault(java.util.List<hydra.python.syntax.ParamNoDefault> paramNoDefault) {
    return new SlashWithDefaultParameters(paramNoDefault, paramWithDefault, starEtc);
  }

  public SlashWithDefaultParameters withParamWithDefault(java.util.List<hydra.python.syntax.ParamWithDefault> paramWithDefault) {
    return new SlashWithDefaultParameters(paramNoDefault, paramWithDefault, starEtc);
  }

  public SlashWithDefaultParameters withStarEtc(hydra.util.Maybe<hydra.python.syntax.StarEtc> starEtc) {
    return new SlashWithDefaultParameters(paramNoDefault, paramWithDefault, starEtc);
  }
}
