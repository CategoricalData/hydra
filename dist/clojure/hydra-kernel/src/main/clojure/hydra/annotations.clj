...
(def hydra_annotations_aggregate_annotations (fn [get_value] (fn [get_x] (fn [get_anns] (fn [t_] (let [to_pairs (fn to_pairs [rest] (fn [t2] (((hydra_lib_maybes_maybe (fn [] rest)) (fn [yy] ((to_pairs ((hydra_lib_lists_cons (hydra_lib_maps_to_list (get_anns yy))) rest)) (get_x yy)))) (get_value t2))))] (hydra_lib_maps_from_list (hydra_lib_lists_concat ((to_pairs (list)) t_)))))))))
