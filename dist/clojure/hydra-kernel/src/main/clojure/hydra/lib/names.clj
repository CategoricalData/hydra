...
(def hydra_lib_names_lists_at "hydra.lib.lists.at")
...
(def hydra_lib_names_lists_head "hydra.lib.lists.head")

(def hydra_lib_names_lists_init "hydra.lib.lists.init")
...
(def hydra_lib_names_lists_last "hydra.lib.lists.last")
...
(def hydra_lib_names_lists_safe_head "hydra.lib.lists.safeHead")
...
(def hydra_lib_names_lists_tail "hydra.lib.lists.tail")
...
(def hydra_lib_names_math_div "hydra.lib.math.div")
...
(def hydra_lib_names_math_mod "hydra.lib.math.mod")
...
(def hydra_lib_names_math_pred "hydra.lib.math.pred")

(def hydra_lib_names_math_range "hydra.lib.math.range")

(def hydra_lib_names_math_rem "hydra.lib.math.rem")
...
(def hydra_lib_names_math_succ "hydra.lib.math.succ")
...
(def hydra_lib_names_maybes_from_just "hydra.lib.maybes.fromJust")
...
(def hydra_lib_names_strings_char_at "hydra.lib.strings.charAt")
