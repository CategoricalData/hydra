...
def eval_step(cx: T0, step: str, term: hydra.core.Term):
    def _hoist_hydra_pg_terms_to_elements_eval_step_1(cx, step, v1):
        match v1:
            ...
            case _:
                return Left(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2("Can't traverse through term for step ", step)))))
...
def apply_pattern(cx: T0, first_lit: str, pairs: frozenlist[tuple[frozenlist[str], str]], term: hydra.core.Term) -> Either[hydra.errors.Error, frozenlist[hydra.core.Term]]:
...
def decode_edge_label(cx: T0, g: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.errors.Error, hydra.pg.model.EdgeLabel]:
    r"""Decode an edge label from a term."""

    return hydra.lib.eithers.map((lambda _x: hydra.pg.model.EdgeLabel(_x)), hydra.extract.core.string(g, t))

def decode_property_key(cx: T0, g: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.errors.Error, hydra.pg.model.PropertyKey]:
    r"""Decode a property key from a term."""

    return hydra.lib.eithers.map((lambda _x: hydra.pg.model.PropertyKey(_x)), hydra.extract.core.string(g, t))
...
def decode_value_spec(cx: T0, g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_pg_terms_to_elements_decode_value_spec_1(cx, g, term, v1):
        match v1:
            ...
            case _:
                return read_injection(cx, g, ((hydra.core.Name("value"), (lambda _: Right(cast(hydra.pg.mapping.ValueSpec, hydra.pg.mapping.ValueSpecValue())))), (hydra.core.Name("pattern"), (lambda t: hydra.lib.eithers.map((lambda _x: cast(hydra.pg.mapping.ValueSpec, hydra.pg.mapping.ValueSpecPattern(_x))), hydra.extract.core.string(g, t))))), term)
    match hydra.strip.deannotate_term(term):
        case hydra.core.TermLiteral(value=lit):
...
def read_field(cx: T0, fields: FrozenDict[hydra.core.Name, T1], fname: hydra.core.Name, fun: Callable[[T1], Either[hydra.errors.Error, T2]]) -> Either[hydra.errors.Error, T2]:
    r"""Read a field from a map of fields by name."""

    return hydra.lib.maybes.maybe((lambda : Left(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2("no such field: ", fname.value)))))), fun, hydra.lib.maps.lookup(fname, fields))

def read_record(cx: T0, g: hydra.graph.Graph, cons: Callable[[FrozenDict[hydra.core.Name, hydra.core.Term]], Either[hydra.errors.Error, T1]], term: hydra.core.Term) -> Either[hydra.errors.Error, T1]:
    r"""Read a record from a term as a map of field names to values."""

    return hydra.lib.eithers.bind(hydra.extract.core.map((lambda k: hydra.lib.eithers.map((lambda _n: hydra.core.Name(_n)), hydra.extract.core.string(g, k))), (lambda _v: Right(_v)), g, term), cons)

def decode_property_spec(cx: T0, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.errors.Error, hydra.pg.mapping.PropertySpec]:
...
def expect_list(cx: T0, g: hydra.graph.Graph, f: Callable[[T0, hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.Error, T1]], term: hydra.core.Term) -> Either[hydra.errors.Error, frozenlist[T1]]:
    r"""Extract a list from a term and apply a decoder to each element."""

    return hydra.lib.eithers.bind(hydra.extract.core.list(g, term), (lambda elems: hydra.lib.eithers.map_list((lambda v1: f(cx, g, v1)), elems)))

def decode_edge_spec(cx: T0, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.errors.Error, hydra.pg.mapping.EdgeSpec]:
...
def decode_vertex_label(cx: T0, g: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.errors.Error, hydra.pg.model.VertexLabel]:
    r"""Decode a vertex label from a term."""

    return hydra.lib.eithers.map((lambda _x: hydra.pg.model.VertexLabel(_x)), hydra.extract.core.string(g, t))

def decode_vertex_spec(cx: T0, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.errors.Error, hydra.pg.mapping.VertexSpec]:
...
def decode_element_spec(cx: T0, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.errors.Error, hydra.pg.mapping.ElementSpec]:
...
def parse_pattern(cx: T0, _g: T1, pat: str) -> Either[T2, Callable[[T3, hydra.core.Term], Either[hydra.errors.Error, frozenlist[hydra.core.Term]]]]:
...
def parse_edge_id_pattern(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.ValueSpec) -> Either[T5, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.errors.Error, frozenlist[T4]]]]:
...
def parse_property_spec(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.PropertySpec) -> Either[T5, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.errors.Error, frozenlist[tuple[hydra.pg.model.PropertyKey, T4]]]]]:
...
def parse_vertex_id_pattern(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.ValueSpec) -> Either[T5, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.errors.Error, frozenlist[T4]]]]:
...
def parse_vertex_spec(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.VertexSpec) -> Either[T5, tuple[hydra.pg.model.Label, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.errors.Error, frozenlist[hydra.pg.model.Element[T4]]]]]]:
...
def parse_element_spec(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.ElementSpec) -> Either[T5, tuple[hydra.pg.model.Label, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.errors.Error, frozenlist[hydra.pg.model.Element[T4]]]]]]:
...
def term_to_elements_adapter(cx: T0, g: hydra.graph.Graph, schema: hydra.pg.mapping.Schema[T1, T2, T3], typ: hydra.core.Type) -> Either[hydra.errors.Error, hydra.coders.Adapter[hydra.core.Type, frozenlist[hydra.pg.model.Label], hydra.core.Term, frozenlist[hydra.pg.model.Element[T3]]]]:
