...
r"""Language constraints for Apache Avro."""
...
@lru_cache(1)
def avro_language() -> hydra.coders.Language:
    r"""Language constraints for Apache Avro."""
    ...
    def type_variants() -> frozenset[hydra.variants.TypeVariant]:
        return hydra.lib.sets.from_list((hydra.variants.TypeVariant.ANNOTATED, hydra.variants.TypeVariant.LIST, hydra.variants.TypeVariant.LITERAL, hydra.variants.TypeVariant.MAP, hydra.variants.TypeVariant.WRAP, hydra.variants.TypeVariant.MAYBE, hydra.variants.TypeVariant.RECORD))
    def type_predicate(typ: hydra.core.Type):
        ...
        match hydra.strip.deannotate_type(typ):
            ...
            case _:
                return True
    return hydra.coders.Language(hydra.coders.LanguageName("hydra.avro"), hydra.coders.LanguageConstraints(elimination_variants(), literal_variants(), float_types(), function_variants(), integer_types(), term_variants(), type_variants(), (lambda x1: type_predicate(x1))))
