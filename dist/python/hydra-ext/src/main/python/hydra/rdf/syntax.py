...
BlankNode.TYPE_ = hydra.core.Name("hydra.rdf.syntax.BlankNode")

class RdfsClass(Node[None]):
    r"""Stand-in for rdfs:Class."""

RdfsClass.TYPE_ = hydra.core.Name("hydra.rdf.syntax.RdfsClass")

class Dataset(Node["frozenset[Quad]"]):
    ...

Dataset.TYPE_ = hydra.core.Name("hydra.rdf.syntax.Dataset")
...
class Description:
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.Description")
...
Graph.TYPE_ = hydra.core.Name("hydra.rdf.syntax.Graph")

class Iri(Node[str]):
    r"""An Internationalized Resource Identifier."""

Iri.TYPE_ = hydra.core.Name("hydra.rdf.syntax.Iri")
...
class IriOrLiteral(metaclass=_IriOrLiteralMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.IriOrLiteral")
...
LangStrings.TYPE_ = hydra.core.Name("hydra.rdf.syntax.LangStrings")

class LanguageTag(Node[str]):
    r"""A BCP47 language tag."""

LanguageTag.TYPE_ = hydra.core.Name("hydra.rdf.syntax.LanguageTag")
...
class Literal:
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.Literal")
...
class Node_(metaclass=_Node_Meta):
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.Node")
    IRI = hydra.core.Name("iri")
...
class Property:
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.Property")
...
class Quad:
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.Quad")
    SUBJECT = hydra.core.Name("subject")
...
class Resource(metaclass=_ResourceMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.Resource")
    IRI = hydra.core.Name("iri")
    BNODE = hydra.core.Name("bnode")
...
class Triple:
    ...
    TYPE_ = hydra.core.Name("hydra.rdf.syntax.Triple")
    SUBJECT = hydra.core.Name("subject")
    PREDICATE = hydra.core.Name("predicate")
    OBJECT = hydra.core.Name("object")
