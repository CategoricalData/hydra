...
class Ontology:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Ontology")
...
class Declaration:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Declaration")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class Entity(metaclass=_EntityMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Entity")
...
class AnnotationSubjectIri(Node["hydra.rdf.syntax.Iri"]):
    ...
...
class AnnotationSubject(metaclass=_AnnotationSubjectMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.AnnotationSubject")
...
class AnnotationValueIri(Node["hydra.rdf.syntax.Iri"]):
    ...

class AnnotationValueLiteral(Node["hydra.rdf.syntax.Literal"]):
    ...
...
class AnnotationValue(metaclass=_AnnotationValueMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.AnnotationValue")
    ANONYMOUS_INDIVIDUAL = hydra.core.Name("anonymousIndividual")
    IRI = hydra.core.Name("iri")
...
class Annotation:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Annotation")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class AnnotationAxiom(metaclass=_AnnotationAxiomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.AnnotationAxiom")
...
class AnnotationAssertion:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.AnnotationAssertion")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class SubAnnotationPropertyOf:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.SubAnnotationPropertyOf")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class AnnotationPropertyDomain:
    annotations: frozenlist[Annotation]
    property: AnnotationProperty
    iri: hydra.rdf.syntax.Iri

    TYPE_ = hydra.core.Name("hydra.owl.syntax.AnnotationPropertyDomain")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    IRI = hydra.core.Name("iri")
...
class AnnotationPropertyRange:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.AnnotationPropertyRange")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    IRI = hydra.core.Name("iri")
...
Class.TYPE_ = hydra.core.Name("hydra.owl.syntax.Class")

class DatatypeXmlSchema(Node["hydra.xml.schema.Datatype"]):
...
class DatatypeOther(Node["hydra.rdf.syntax.Iri"]):
    ...
...
class Datatype(metaclass=_DatatypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Datatype")
...
ObjectProperty.TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectProperty")

class DataProperty(Node[None]):
    ...

DataProperty.TYPE_ = hydra.core.Name("hydra.owl.syntax.DataProperty")

class AnnotationProperty(Node[None]):
    ...

AnnotationProperty.TYPE_ = hydra.core.Name("hydra.owl.syntax.AnnotationProperty")
...
class Individual(metaclass=_IndividualMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Individual")
...
NamedIndividual.TYPE_ = hydra.core.Name("hydra.owl.syntax.NamedIndividual")

class AnonymousIndividual(Node[None]):
    ...

AnonymousIndividual.TYPE_ = hydra.core.Name("hydra.owl.syntax.AnonymousIndividual")
...
class ObjectPropertyExpression(metaclass=_ObjectPropertyExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectPropertyExpression")
...
InverseObjectProperty.TYPE_ = hydra.core.Name("hydra.owl.syntax.InverseObjectProperty")

class DataPropertyExpression(Node["DataProperty"]):
    ...

DataPropertyExpression.TYPE_ = hydra.core.Name("hydra.owl.syntax.DataPropertyExpression")
...
class DataRange(metaclass=_DataRangeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataRange")
...
DataIntersectionOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.DataIntersectionOf")

class DataUnionOf(Node["frozenlist[DataRange]"]):
    r"""See https://www.w3.org/TR/owl2-syntax/#Union_of_Data_Ranges."""

DataUnionOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.DataUnionOf")

class DataComplementOf(Node["DataRange"]):
    r"""See https://www.w3.org/TR/owl2-syntax/#Complement_of_Data_Ranges."""

DataComplementOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.DataComplementOf")

class DataOneOf(Node["frozenlist[hydra.rdf.syntax.Literal]"]):
    r"""See https://www.w3.org/TR/owl2-syntax/#Enumeration_of_Literals."""

DataOneOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.DataOneOf")
...
class DatatypeRestriction:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DatatypeRestriction")
    DATATYPE = hydra.core.Name("datatype")
...
class DatatypeRestriction_Constraint:
    ...
    restriction_value: hydra.rdf.syntax.Literal

    TYPE_ = hydra.core.Name("hydra.owl.syntax.DatatypeRestriction_Constraint")
    CONSTRAINING_FACET = hydra.core.Name("constrainingFacet")
    RESTRICTION_VALUE = hydra.core.Name("restrictionValue")

class DatatypeRestriction_ConstrainingFacetXmlSchema(Node["hydra.xml.schema.ConstrainingFacet"]):
...
class DatatypeRestriction_ConstrainingFacetOther(Node["hydra.rdf.syntax.Iri"]):
    ...
...
class DatatypeRestriction_ConstrainingFacet(metaclass=_DatatypeRestriction_ConstrainingFacetMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DatatypeRestriction_ConstrainingFacet")
    XML_SCHEMA = hydra.core.Name("xmlSchema")
    OTHER = hydra.core.Name("other")
...
class ClassExpression(metaclass=_ClassExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ClassExpression")
    CLASS = hydra.core.Name("class")
...
ObjectIntersectionOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectIntersectionOf")

class ObjectUnionOf(Node["frozenlist[ClassExpression]"]):
    ...

ObjectUnionOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectUnionOf")

class ObjectComplementOf(Node["ClassExpression"]):
    ...

ObjectComplementOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectComplementOf")

class ObjectOneOf(Node["frozenlist[Individual]"]):
    ...

ObjectOneOf.TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectOneOf")
...
class ObjectSomeValuesFrom:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectSomeValuesFrom")
    PROPERTY = hydra.core.Name("property")
    CLASS = hydra.core.Name("class")
...
class ObjectAllValuesFrom:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectAllValuesFrom")
    PROPERTY = hydra.core.Name("property")
    CLASS = hydra.core.Name("class")
...
class ObjectHasValue:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectHasValue")
    PROPERTY = hydra.core.Name("property")
...
ObjectHasSelf.TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectHasSelf")
...
class ObjectMinCardinality:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectMinCardinality")
...
class ObjectMaxCardinality:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectMaxCardinality")
    BOUND = hydra.core.Name("bound")
    PROPERTY = hydra.core.Name("property")
    CLASS = hydra.core.Name("class")
...
class ObjectExactCardinality:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectExactCardinality")
    BOUND = hydra.core.Name("bound")
    PROPERTY = hydra.core.Name("property")
    CLASS = hydra.core.Name("class")
...
class DataSomeValuesFrom:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataSomeValuesFrom")
    PROPERTY = hydra.core.Name("property")
...
class DataAllValuesFrom:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataAllValuesFrom")
    PROPERTY = hydra.core.Name("property")
    RANGE = hydra.core.Name("range")
...
class DataHasValue:
    ...
    value: hydra.rdf.syntax.Literal

    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataHasValue")
    PROPERTY = hydra.core.Name("property")
    VALUE = hydra.core.Name("value")
...
class DataMinCardinality:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataMinCardinality")
    BOUND = hydra.core.Name("bound")
    PROPERTY = hydra.core.Name("property")
    RANGE = hydra.core.Name("range")
...
class DataMaxCardinality:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataMaxCardinality")
    BOUND = hydra.core.Name("bound")
    PROPERTY = hydra.core.Name("property")
    RANGE = hydra.core.Name("range")
...
class DataExactCardinality:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataExactCardinality")
    BOUND = hydra.core.Name("bound")
    PROPERTY = hydra.core.Name("property")
    RANGE = hydra.core.Name("range")
...
class Axiom(metaclass=_AxiomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Axiom")
...
class ClassAxiom(metaclass=_ClassAxiomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ClassAxiom")
...
class SubClassOf:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.SubClassOf")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class EquivalentClasses:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.EquivalentClasses")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class DisjointClasses:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DisjointClasses")
    ANNOTATIONS = hydra.core.Name("annotations")
    CLASSES = hydra.core.Name("classes")
...
class DisjointUnion:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DisjointUnion")
    ANNOTATIONS = hydra.core.Name("annotations")
    CLASS = hydra.core.Name("class")
    CLASSES = hydra.core.Name("classes")
...
class ObjectPropertyAxiom(metaclass=_ObjectPropertyAxiomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectPropertyAxiom")
...
class SubObjectPropertyOf:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.SubObjectPropertyOf")
    ANNOTATIONS = hydra.core.Name("annotations")
    SUB_PROPERTY = hydra.core.Name("subProperty")
    SUPER_PROPERTY = hydra.core.Name("superProperty")
...
class EquivalentObjectProperties:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.EquivalentObjectProperties")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class DisjointObjectProperties:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DisjointObjectProperties")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTIES = hydra.core.Name("properties")
...
class ObjectPropertyDomain:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectPropertyDomain")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class ObjectPropertyRange:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectPropertyRange")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    RANGE = hydra.core.Name("range")
...
class InverseObjectProperties:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.InverseObjectProperties")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class FunctionalObjectProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.FunctionalObjectProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class InverseFunctionalObjectProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.InverseFunctionalObjectProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class ReflexiveObjectProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ReflexiveObjectProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class IrreflexiveObjectProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.IrreflexiveObjectProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class SymmetricObjectProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.SymmetricObjectProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class AsymmetricObjectProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.AsymmetricObjectProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class TransitiveObjectProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.TransitiveObjectProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class DataPropertyAxiom(metaclass=_DataPropertyAxiomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataPropertyAxiom")
    DATA_PROPERTY_AXIOM = hydra.core.Name("dataPropertyAxiom")
...
class SubDataPropertyOf:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.SubDataPropertyOf")
    ANNOTATIONS = hydra.core.Name("annotations")
    SUB_PROPERTY = hydra.core.Name("subProperty")
    SUPER_PROPERTY = hydra.core.Name("superProperty")
...
class EquivalentDataProperties:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.EquivalentDataProperties")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTIES = hydra.core.Name("properties")
...
class DisjointDataProperties:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DisjointDataProperties")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTIES = hydra.core.Name("properties")
...
class DataPropertyDomain:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataPropertyDomain")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    DOMAIN = hydra.core.Name("domain")
...
class DataPropertyRange:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataPropertyRange")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    RANGE = hydra.core.Name("range")
...
class FunctionalDataProperty:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.FunctionalDataProperty")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class DatatypeDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DatatypeDefinition")
    ANNOTATIONS = hydra.core.Name("annotations")
    DATATYPE = hydra.core.Name("datatype")
    RANGE = hydra.core.Name("range")
...
class HasKey:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.HasKey")
    ANNOTATIONS = hydra.core.Name("annotations")
    CLASS = hydra.core.Name("class")
...
class Assertion(metaclass=_AssertionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.Assertion")
...
class SameIndividual:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.SameIndividual")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class DifferentIndividuals:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DifferentIndividuals")
    ANNOTATIONS = hydra.core.Name("annotations")
    INDIVIDUALS = hydra.core.Name("individuals")
...
class ClassAssertion:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ClassAssertion")
    ANNOTATIONS = hydra.core.Name("annotations")
    CLASS = hydra.core.Name("class")
    INDIVIDUAL = hydra.core.Name("individual")
...
class ObjectPropertyAssertion:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.ObjectPropertyAssertion")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
...
class NegativeObjectPropertyAssertion:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.NegativeObjectPropertyAssertion")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    SOURCE = hydra.core.Name("source")
    TARGET = hydra.core.Name("target")
...
class DataPropertyAssertion:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.DataPropertyAssertion")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    SOURCE = hydra.core.Name("source")
    TARGET = hydra.core.Name("target")
...
class NegativeDataPropertyAssertion:
    ...
    TYPE_ = hydra.core.Name("hydra.owl.syntax.NegativeDataPropertyAssertion")
    ANNOTATIONS = hydra.core.Name("annotations")
    PROPERTY = hydra.core.Name("property")
    SOURCE = hydra.core.Name("source")
    TARGET = hydra.core.Name("target")
