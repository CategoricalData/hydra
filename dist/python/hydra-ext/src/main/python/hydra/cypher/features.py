...
class CypherFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.CypherFeatures")
...
class ArithmeticFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ArithmeticFeatures")
...
class AtomFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.AtomFeatures")
...
class ComparisonFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ComparisonFeatures")
...
class DeleteFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.DeleteFeatures")
    DELETE = hydra.core.Name("delete")
...
class FunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.FunctionFeatures")
...
class AggregateFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.AggregateFunctionFeatures")
...
class DatabaseFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.DatabaseFunctionFeatures")
...
class GenAIFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.GenAIFunctionFeatures")
...
class GraphFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.GraphFunctionFeatures")
...
class ListFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ListFunctionFeatures")
...
class LoadCSVFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.LoadCSVFunctionFeatures")
...
class LogarithmicFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.LogarithmicFunctionFeatures")
    E = hydra.core.Name("e")
...
class NumericFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.NumericFunctionFeatures")
...
class PredicateFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.PredicateFunctionFeatures")
...
class ScalarFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ScalarFunctionFeatures")
...
class SpatialFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.SpatialFunctionFeatures")
...
class StringFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.StringFunctionFeatures")
...
class TemporalDurationFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.TemporalDurationFunctionFeatures")
...
class TemporalInstantFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.TemporalInstantFunctionFeatures")
...
class TrigonometricFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.TrigonometricFunctionFeatures")
...
class VectorFunctionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.VectorFunctionFeatures")
...
class ListFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ListFeatures")
...
class LiteralFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.LiteralFeatures")
...
class LogicalFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.LogicalFeatures")
...
class MatchFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.MatchFeatures")
    MATCH = hydra.core.Name("match")
...
class MergeFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.MergeFeatures")
    MERGE = hydra.core.Name("merge")
...
class NodePatternFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.NodePatternFeatures")
...
class NullFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.NullFeatures")
...
class PathFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.PathFeatures")
...
class ProcedureCallFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ProcedureCallFeatures")
...
class ProjectionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ProjectionFeatures")
...
class QuantifierFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.QuantifierFeatures")
    ALL = hydra.core.Name("all")
    ANY = hydra.core.Name("any")
    NONE = hydra.core.Name("none")
    SINGLE = hydra.core.Name("single")
...
class RangeLiteralFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.RangeLiteralFeatures")
...
class ReadingFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.ReadingFeatures")
...
class RelationshipDirectionFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.RelationshipDirectionFeatures")
...
class RelationshipPatternFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.RelationshipPatternFeatures")
...
class RemoveFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.RemoveFeatures")
...
class SetFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.SetFeatures")
...
class StringFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.StringFeatures")
...
class UpdatingFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.cypher.features.UpdatingFeatures")
