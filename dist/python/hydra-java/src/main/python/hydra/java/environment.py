...
class JavaSymbolClass(metaclass=_JavaSymbolClassMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.environment.JavaSymbolClass")
...
class JavaFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.java.environment.JavaFeatures")
...
class Aliases:
    ...
    packages: Annotated[FrozenDict[hydra.packaging.Namespace, hydra.java.syntax.PackageName], "Maps namespaces to Java package names"]
    ...
    TYPE_ = hydra.core.Name("hydra.java.environment.Aliases")
...
class JavaEnvironment:
    ...
    TYPE_ = hydra.core.Name("hydra.java.environment.JavaEnvironment")
