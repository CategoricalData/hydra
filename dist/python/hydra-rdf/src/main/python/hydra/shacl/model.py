...
class Closed:
    ...
    is_closed: bool
    ignored_properties: Maybe[frozenset[hydra.rdf.syntax.Property]]

    TYPE_ = hydra.core.Name("hydra.shacl.model.Closed")
...
class CommonConstraintClass(Node["frozenset[hydra.rdf.syntax.RdfsClass]"]):
    r"""See https://www.w3.org/TR/shacl/#ClassConstraintComponent"""

class CommonConstraintDatatype(Node["hydra.rdf.syntax.Iri"]):
    r"""See https://www.w3.org/TR/shacl/#DatatypeConstraintComponent"""

class CommonConstraintDisjoint(Node["frozenset[hydra.rdf.syntax.Property]"]):
    r"""See https://www.w3.org/TR/shacl/#DisjointConstraintComponent"""

class CommonConstraintEquals(Node["frozenset[hydra.rdf.syntax.Property]"]):
    r"""See https://www.w3.org/TR/shacl/#EqualsConstraintComponent"""

class CommonConstraintHasValue(Node["frozenset[hydra.rdf.syntax.Node_]"]):
...
class CommonConstraintIn(Node["frozenlist[hydra.rdf.syntax.Node_]"]):
...
class CommonConstraintLanguageIn(Node["frozenset[hydra.rdf.syntax.LanguageTag]"]):
...
class CommonConstraintMaxExclusive(Node["hydra.rdf.syntax.Literal"]):
    r"""See https://www.w3.org/TR/shacl/#MaxExclusiveConstraintComponent"""

class CommonConstraintMaxInclusive(Node["hydra.rdf.syntax.Literal"]):
...
class CommonConstraintMinExclusive(Node["hydra.rdf.syntax.Literal"]):
    r"""See https://www.w3.org/TR/shacl/#MinExclusiveConstraintComponent"""

class CommonConstraintMinInclusive(Node["hydra.rdf.syntax.Literal"]):
...
class CommonConstraint(metaclass=_CommonConstraintMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.CommonConstraint")
...
class CommonProperties:
    ...
    message: Annotated[hydra.rdf.syntax.LangStrings, "See https://www.w3.org/TR/shacl/#message"]
    severity: Annotated[Severity, "See https://www.w3.org/TR/shacl/#severity"]
    target_class: Annotated[frozenset[hydra.rdf.syntax.RdfsClass], "See https://www.w3.org/TR/shacl/#targetClass"]
    target_node: Annotated[frozenset[hydra.rdf.syntax.IriOrLiteral], "See https://www.w3.org/TR/shacl/#targetNode"]
    target_objects_of: Annotated[frozenset[hydra.rdf.syntax.Property], "See https://www.w3.org/TR/shacl/#targetObjectsOf"]
    target_subjects_of: Annotated[frozenset[hydra.rdf.syntax.Property], "See https://www.w3.org/TR/shacl/#targetSubjectsOf"]

    TYPE_ = hydra.core.Name("hydra.shacl.model.CommonProperties")
...
class Definition(Generic[A]):
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.Definition")
...
NodeKind.TYPE_ = hydra.core.Name("hydra.shacl.model.NodeKind")
...
class NodeShape:
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.NodeShape")
...
class Pattern:
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.Pattern")
...
class PropertyShape:
    ...
    default_value: Annotated[Maybe[hydra.rdf.syntax.Node_], "See https://www.w3.org/TR/shacl/#defaultValue"]
    description: Annotated[hydra.rdf.syntax.LangStrings, "See https://www.w3.org/TR/shacl/#name"]
    name: Annotated[hydra.rdf.syntax.LangStrings, "See https://www.w3.org/TR/shacl/#name"]
    order: Annotated[Maybe[int], "See https://www.w3.org/TR/shacl/#order"]
    path: hydra.rdf.syntax.Iri

    TYPE_ = hydra.core.Name("hydra.shacl.model.PropertyShape")
    COMMON = hydra.core.Name("common")
    CONSTRAINTS = hydra.core.Name("constraints")
...
class PropertyShapeConstraintLessThan(Node["frozenset[hydra.rdf.syntax.Property]"]):
    r"""See https://www.w3.org/TR/shacl/#LessThanConstraintComponent"""

class PropertyShapeConstraintLessThanOrEquals(Node["frozenset[hydra.rdf.syntax.Property]"]):
...
class PropertyShapeConstraint(metaclass=_PropertyShapeConstraintMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.PropertyShapeConstraint")
...
class QualifiedValueShape:
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.QualifiedValueShape")
    QUALIFIED_VALUE_SHAPE = hydra.core.Name("qualifiedValueShape")
...
class ReferenceNamed(Node["hydra.rdf.syntax.Iri"]):
    ...
...
class Reference(metaclass=_ReferenceMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.Reference")
...
Severity.TYPE_ = hydra.core.Name("hydra.shacl.model.Severity")
...
class Shape(metaclass=_ShapeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.shacl.model.Shape")
    NODE = hydra.core.Name("node")
    PROPERTY = hydra.core.Name("property")
...
ShapesGraph.TYPE_ = hydra.core.Name("hydra.shacl.model.ShapesGraph")
