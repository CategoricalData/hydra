...
Identifier.TYPE_ = hydra.core.Name("hydra.java.syntax.Identifier")

class TypeIdentifier(Node["Identifier"]):
    ...

TypeIdentifier.TYPE_ = hydra.core.Name("hydra.java.syntax.TypeIdentifier")
...
class Literal(metaclass=_LiteralMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Literal")
...
IntegerLiteral.TYPE_ = hydra.core.Name("hydra.java.syntax.IntegerLiteral")

class FloatingPointLiteral(Node[Decimal]):
    r"""Note: this is an approximation which ignores encoding."""

FloatingPointLiteral.TYPE_ = hydra.core.Name("hydra.java.syntax.FloatingPointLiteral")

class StringLiteral(Node[str]):
    r"""Note: this is an approximation which ignores encoding."""

StringLiteral.TYPE_ = hydra.core.Name("hydra.java.syntax.StringLiteral")
...
class Type(metaclass=_TypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Type")
...
class PrimitiveTypeWithAnnotations:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.PrimitiveTypeWithAnnotations")
...
class PrimitiveType(metaclass=_PrimitiveTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.PrimitiveType")
...
class NumericType(metaclass=_NumericTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.NumericType")
...
IntegralType.TYPE_ = hydra.core.Name("hydra.java.syntax.IntegralType")
...
FloatingPointType.TYPE_ = hydra.core.Name("hydra.java.syntax.FloatingPointType")
...
class ReferenceType(metaclass=_ReferenceTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ReferenceType")
...
class ClassOrInterfaceType(metaclass=_ClassOrInterfaceTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassOrInterfaceType")
...
class ClassType:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassType")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class ClassTypeQualifier(metaclass=_ClassTypeQualifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassTypeQualifier")
...
InterfaceType.TYPE_ = hydra.core.Name("hydra.java.syntax.InterfaceType")
...
class TypeVariable:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeVariable")
    ANNOTATIONS = hydra.core.Name("annotations")
    IDENTIFIER = hydra.core.Name("identifier")
...
class ArrayType:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayType")
...
class ArrayType_Variant(metaclass=_ArrayType_VariantMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayType_Variant")
    PRIMITIVE = hydra.core.Name("primitive")
    CLASS_OR_INTERFACE = hydra.core.Name("classOrInterface")
    VARIABLE = hydra.core.Name("variable")
...
Dims.TYPE_ = hydra.core.Name("hydra.java.syntax.Dims")
...
class TypeParameter:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeParameter")
...
TypeParameterModifier.TYPE_ = hydra.core.Name("hydra.java.syntax.TypeParameterModifier")
...
class TypeBound(metaclass=_TypeBoundMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeBound")
    VARIABLE = hydra.core.Name("variable")
    CLASS_OR_INTERFACE = hydra.core.Name("classOrInterface")
...
class TypeBound_ClassOrInterface:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeBound_ClassOrInterface")
    TYPE = hydra.core.Name("type")
...
AdditionalBound.TYPE_ = hydra.core.Name("hydra.java.syntax.AdditionalBound")
...
class TypeArgument(metaclass=_TypeArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeArgument")
    REFERENCE = hydra.core.Name("reference")
...
class Wildcard:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Wildcard")
    ANNOTATIONS = hydra.core.Name("annotations")
    WILDCARD = hydra.core.Name("wildcard")
...
class WildcardBounds(metaclass=_WildcardBoundsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.WildcardBounds")
...
class ModuleName:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ModuleName")
    IDENTIFIER = hydra.core.Name("identifier")
...
PackageName.TYPE_ = hydra.core.Name("hydra.java.syntax.PackageName")
...
class TypeName:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeName")
    IDENTIFIER = hydra.core.Name("identifier")
    QUALIFIER = hydra.core.Name("qualifier")
...
class ExpressionName:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ExpressionName")
    QUALIFIER = hydra.core.Name("qualifier")
    IDENTIFIER = hydra.core.Name("identifier")
...
MethodName.TYPE_ = hydra.core.Name("hydra.java.syntax.MethodName")

class PackageOrTypeName(Node["frozenlist[Identifier]"]):
    ...

PackageOrTypeName.TYPE_ = hydra.core.Name("hydra.java.syntax.PackageOrTypeName")

class AmbiguousName(Node["frozenlist[Identifier]"]):
    ...

AmbiguousName.TYPE_ = hydra.core.Name("hydra.java.syntax.AmbiguousName")
...
class CompilationUnit(metaclass=_CompilationUnitMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CompilationUnit")
...
class OrdinaryCompilationUnit:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.OrdinaryCompilationUnit")
    PACKAGE = hydra.core.Name("package")
...
class ModularCompilationUnit:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ModularCompilationUnit")
    IMPORTS = hydra.core.Name("imports")
...
class PackageDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.PackageDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
...
PackageModifier.TYPE_ = hydra.core.Name("hydra.java.syntax.PackageModifier")
...
class ImportDeclaration(metaclass=_ImportDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ImportDeclaration")
...
SingleTypeImportDeclaration.TYPE_ = hydra.core.Name("hydra.java.syntax.SingleTypeImportDeclaration")

class TypeImportOnDemandDeclaration(Node["PackageOrTypeName"]):
    ...

TypeImportOnDemandDeclaration.TYPE_ = hydra.core.Name("hydra.java.syntax.TypeImportOnDemandDeclaration")
...
class SingleStaticImportDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.SingleStaticImportDeclaration")
...
StaticImportOnDemandDeclaration.TYPE_ = hydra.core.Name("hydra.java.syntax.StaticImportOnDemandDeclaration")
...
class TypeDeclaration(metaclass=_TypeDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeDeclaration")
    CLASS = hydra.core.Name("class")
    INTERFACE = hydra.core.Name("interface")
    NONE = hydra.core.Name("none")
...
class TypeDeclarationWithComments:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeDeclarationWithComments")
...
class ModuleDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ModuleDeclaration")
    ANNOTATIONS = hydra.core.Name("annotations")
...
class ModuleDirective(metaclass=_ModuleDirectiveMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ModuleDirective")
...
class ModuleDirective_Requires:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ModuleDirective_Requires")
    MODIFIERS = hydra.core.Name("modifiers")
    MODULE = hydra.core.Name("module")
...
class ModuleDirective_ExportsOrOpens:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ModuleDirective_ExportsOrOpens")
    PACKAGE = hydra.core.Name("package")
...
class ModuleDirective_Provides:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ModuleDirective_Provides")
...
RequiresModifier.TYPE_ = hydra.core.Name("hydra.java.syntax.RequiresModifier")
...
class ClassDeclaration(metaclass=_ClassDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassDeclaration")
...
class NormalClassDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.NormalClassDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    IDENTIFIER = hydra.core.Name("identifier")
...
class ClassModifier(metaclass=_ClassModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassModifier")
...
ClassBody.TYPE_ = hydra.core.Name("hydra.java.syntax.ClassBody")
...
class ClassBodyDeclaration(metaclass=_ClassBodyDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassBodyDeclaration")
...
class ClassBodyDeclarationWithComments:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassBodyDeclarationWithComments")
    VALUE = hydra.core.Name("value")
    COMMENTS = hydra.core.Name("comments")
...
class ClassMemberDeclaration(metaclass=_ClassMemberDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassMemberDeclaration")
...
class FieldDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.FieldDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
...
class FieldModifier(metaclass=_FieldModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.FieldModifier")
    ANNOTATION = hydra.core.Name("annotation")
    PUBLIC = hydra.core.Name("public")
    PROTECTED = hydra.core.Name("protected")
    PRIVATE = hydra.core.Name("private")
...
class VariableDeclarator:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.VariableDeclarator")
...
class VariableDeclaratorId:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.VariableDeclaratorId")
    IDENTIFIER = hydra.core.Name("identifier")
    DIMS = hydra.core.Name("dims")
...
class VariableInitializer(metaclass=_VariableInitializerMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.VariableInitializer")
...
UnannType.TYPE_ = hydra.core.Name("hydra.java.syntax.UnannType")

class UnannClassType(Node["ClassType"]):
    r"""A ClassType which does not allow annotations."""

UnannClassType.TYPE_ = hydra.core.Name("hydra.java.syntax.UnannClassType")
...
class MethodDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodDeclaration")
    ANNOTATIONS = hydra.core.Name("annotations")
    MODIFIERS = hydra.core.Name("modifiers")
...
class MethodModifier(metaclass=_MethodModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodModifier")
    ANNOTATION = hydra.core.Name("annotation")
    PUBLIC = hydra.core.Name("public")
    PROTECTED = hydra.core.Name("protected")
    PRIVATE = hydra.core.Name("private")
...
class MethodHeader:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodHeader")
    PARAMETERS = hydra.core.Name("parameters")
...
class Result(metaclass=_ResultMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Result")
    TYPE = hydra.core.Name("type")
...
class MethodDeclarator:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodDeclarator")
    IDENTIFIER = hydra.core.Name("identifier")
...
class ReceiverParameter:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ReceiverParameter")
    ANNOTATIONS = hydra.core.Name("annotations")
    UNANN_TYPE = hydra.core.Name("unannType")
    IDENTIFIER = hydra.core.Name("identifier")
...
class FormalParameter(metaclass=_FormalParameterMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.FormalParameter")
...
class FormalParameter_Simple:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.FormalParameter_Simple")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
    ID = hydra.core.Name("id")
...
class VariableArityParameter:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.VariableArityParameter")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
    ANNOTATIONS = hydra.core.Name("annotations")
    IDENTIFIER = hydra.core.Name("identifier")
...
class VariableModifier(metaclass=_VariableModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.VariableModifier")
    ANNOTATION = hydra.core.Name("annotation")
    FINAL = hydra.core.Name("final")
...
Throws.TYPE_ = hydra.core.Name("hydra.java.syntax.Throws")
...
class ExceptionType(metaclass=_ExceptionTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ExceptionType")
    CLASS = hydra.core.Name("class")
    VARIABLE = hydra.core.Name("variable")
...
class MethodBody(metaclass=_MethodBodyMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodBody")
...
InstanceInitializer.TYPE_ = hydra.core.Name("hydra.java.syntax.InstanceInitializer")

class StaticInitializer(Node["Block"]):
    ...

StaticInitializer.TYPE_ = hydra.core.Name("hydra.java.syntax.StaticInitializer")
...
class ConstructorDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConstructorDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
...
class ConstructorModifier(metaclass=_ConstructorModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConstructorModifier")
    ANNOTATION = hydra.core.Name("annotation")
    PUBLIC = hydra.core.Name("public")
    PROTECTED = hydra.core.Name("protected")
    PRIVATE = hydra.core.Name("private")
...
class ConstructorDeclarator:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConstructorDeclarator")
    PARAMETERS = hydra.core.Name("parameters")
    NAME = hydra.core.Name("name")
    RECEIVER_PARAMETER = hydra.core.Name("receiverParameter")
    FORMAL_PARAMETERS = hydra.core.Name("formalParameters")
...
SimpleTypeName.TYPE_ = hydra.core.Name("hydra.java.syntax.SimpleTypeName")
...
class ConstructorBody:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConstructorBody")
...
class ExplicitConstructorInvocation:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ExplicitConstructorInvocation")
...
class ExplicitConstructorInvocation_Variant(metaclass=_ExplicitConstructorInvocation_VariantMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ExplicitConstructorInvocation_Variant")
...
class EnumDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EnumDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    IDENTIFIER = hydra.core.Name("identifier")
    IMPLEMENTS = hydra.core.Name("implements")
    BODY = hydra.core.Name("body")
...
EnumBody.TYPE_ = hydra.core.Name("hydra.java.syntax.EnumBody")
...
class EnumBody_Element:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EnumBody_Element")
...
class EnumConstant:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EnumConstant")
    MODIFIERS = hydra.core.Name("modifiers")
    IDENTIFIER = hydra.core.Name("identifier")
    ARGUMENTS = hydra.core.Name("arguments")
    BODY = hydra.core.Name("body")
...
EnumConstantModifier.TYPE_ = hydra.core.Name("hydra.java.syntax.EnumConstantModifier")
...
class InterfaceDeclaration(metaclass=_InterfaceDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.InterfaceDeclaration")
...
class NormalInterfaceDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.NormalInterfaceDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    IDENTIFIER = hydra.core.Name("identifier")
    PARAMETERS = hydra.core.Name("parameters")
    EXTENDS = hydra.core.Name("extends")
...
class InterfaceModifier(metaclass=_InterfaceModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.InterfaceModifier")
    ANNOTATION = hydra.core.Name("annotation")
    PUBLIC = hydra.core.Name("public")
    PROTECTED = hydra.core.Name("protected")
    PRIVATE = hydra.core.Name("private")
...
InterfaceBody.TYPE_ = hydra.core.Name("hydra.java.syntax.InterfaceBody")
...
class InterfaceMemberDeclaration(metaclass=_InterfaceMemberDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.InterfaceMemberDeclaration")
...
class ConstantDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConstantDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
...
class ConstantModifier(metaclass=_ConstantModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConstantModifier")
    ANNOTATION = hydra.core.Name("annotation")
    PUBLIC = hydra.core.Name("public")
    STATIC = hydra.core.Name("static")
    FINAL = hydra.core.Name("final")
...
class InterfaceMethodDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.InterfaceMethodDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    HEADER = hydra.core.Name("header")
    BODY = hydra.core.Name("body")
...
class InterfaceMethodModifier(metaclass=_InterfaceMethodModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.InterfaceMethodModifier")
    ANNOTATION = hydra.core.Name("annotation")
    PUBLIC = hydra.core.Name("public")
    PRIVATE = hydra.core.Name("private")
    ABSTRACT = hydra.core.Name("abstract")
...
class AnnotationTypeDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AnnotationTypeDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    IDENTIFIER = hydra.core.Name("identifier")
    BODY = hydra.core.Name("body")
...
AnnotationTypeBody.TYPE_ = hydra.core.Name("hydra.java.syntax.AnnotationTypeBody")
...
class AnnotationTypeMemberDeclaration(metaclass=_AnnotationTypeMemberDeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AnnotationTypeMemberDeclaration")
    ANNOTATION_TYPE = hydra.core.Name("annotationType")
    CONSTANT = hydra.core.Name("constant")
    CLASS = hydra.core.Name("class")
    INTERFACE = hydra.core.Name("interface")
...
class AnnotationTypeElementDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AnnotationTypeElementDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
    IDENTIFIER = hydra.core.Name("identifier")
    DIMS = hydra.core.Name("dims")
...
class AnnotationTypeElementModifier(metaclass=_AnnotationTypeElementModifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AnnotationTypeElementModifier")
    PUBLIC = hydra.core.Name("public")
    ABSTRACT = hydra.core.Name("abstract")
...
DefaultValue.TYPE_ = hydra.core.Name("hydra.java.syntax.DefaultValue")
...
class Annotation(metaclass=_AnnotationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Annotation")
    NORMAL = hydra.core.Name("normal")
...
class NormalAnnotation:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.NormalAnnotation")
    TYPE_NAME = hydra.core.Name("typeName")
...
class ElementValuePair:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ElementValuePair")
...
class ElementValue(metaclass=_ElementValueMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ElementValue")
...
ElementValueArrayInitializer.TYPE_ = hydra.core.Name("hydra.java.syntax.ElementValueArrayInitializer")

class MarkerAnnotation(Node["TypeName"]):
    ...

MarkerAnnotation.TYPE_ = hydra.core.Name("hydra.java.syntax.MarkerAnnotation")
...
class SingleElementAnnotation:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.SingleElementAnnotation")
    NAME = hydra.core.Name("name")
    VALUE = hydra.core.Name("value")
...
ArrayInitializer.TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayInitializer")

class Block(Node["frozenlist[BlockStatement]"]):
    ...

Block.TYPE_ = hydra.core.Name("hydra.java.syntax.Block")
...
class BlockStatement(metaclass=_BlockStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.BlockStatement")
...
LocalVariableDeclarationStatement.TYPE_ = hydra.core.Name("hydra.java.syntax.LocalVariableDeclarationStatement")
...
class LocalVariableDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LocalVariableDeclaration")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
...
class LocalVariableType(metaclass=_LocalVariableTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LocalVariableType")
    TYPE = hydra.core.Name("type")
...
class Statement(metaclass=_StatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Statement")
...
class StatementNoShortIf(metaclass=_StatementNoShortIfMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.StatementNoShortIf")
    WITHOUT_TRAILING = hydra.core.Name("withoutTrailing")
    LABELED = hydra.core.Name("labeled")
    IF_THEN_ELSE = hydra.core.Name("ifThenElse")
    WHILE = hydra.core.Name("while")
...
class StatementWithoutTrailingSubstatement(metaclass=_StatementWithoutTrailingSubstatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.StatementWithoutTrailingSubstatement")
    BLOCK = hydra.core.Name("block")
...
class LabeledStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LabeledStatement")
    IDENTIFIER = hydra.core.Name("identifier")
    STATEMENT = hydra.core.Name("statement")
...
class LabeledStatementNoShortIf:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LabeledStatementNoShortIf")
    IDENTIFIER = hydra.core.Name("identifier")
    STATEMENT = hydra.core.Name("statement")
...
ExpressionStatement.TYPE_ = hydra.core.Name("hydra.java.syntax.ExpressionStatement")
...
class StatementExpression(metaclass=_StatementExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.StatementExpression")
...
class IfThenStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.IfThenStatement")
    EXPRESSION = hydra.core.Name("expression")
    STATEMENT = hydra.core.Name("statement")
...
class IfThenElseStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.IfThenElseStatement")
...
class IfThenElseStatementNoShortIf:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.IfThenElseStatementNoShortIf")
    COND = hydra.core.Name("cond")
    THEN = hydra.core.Name("then")
    ELSE = hydra.core.Name("else")
...
class AssertStatement(metaclass=_AssertStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AssertStatement")
...
class AssertStatement_Pair:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AssertStatement_Pair")
...
class SwitchStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.SwitchStatement")
    COND = hydra.core.Name("cond")
    BLOCK = hydra.core.Name("block")
...
SwitchBlock.TYPE_ = hydra.core.Name("hydra.java.syntax.SwitchBlock")
...
class SwitchBlock_Pair:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.SwitchBlock_Pair")
    STATEMENTS = hydra.core.Name("statements")
...
class SwitchBlockStatementGroup:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.SwitchBlockStatementGroup")
    LABELS = hydra.core.Name("labels")
    STATEMENTS = hydra.core.Name("statements")
...
class SwitchLabel(metaclass=_SwitchLabelMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.SwitchLabel")
    CONSTANT = hydra.core.Name("constant")
...
EnumConstantName.TYPE_ = hydra.core.Name("hydra.java.syntax.EnumConstantName")
...
class WhileStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.WhileStatement")
    COND = hydra.core.Name("cond")
    BODY = hydra.core.Name("body")
...
class WhileStatementNoShortIf:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.WhileStatementNoShortIf")
    COND = hydra.core.Name("cond")
    BODY = hydra.core.Name("body")
...
class DoStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.DoStatement")
    BODY = hydra.core.Name("body")
...
class ForStatement(metaclass=_ForStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ForStatement")
...
class ForStatementNoShortIf(metaclass=_ForStatementNoShortIfMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ForStatementNoShortIf")
    BASIC = hydra.core.Name("basic")
    ENHANCED = hydra.core.Name("enhanced")
...
class BasicForStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.BasicForStatement")
    COND = hydra.core.Name("cond")
    BODY = hydra.core.Name("body")
...
class ForCond:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ForCond")
...
class BasicForStatementNoShortIf:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.BasicForStatementNoShortIf")
    COND = hydra.core.Name("cond")
    BODY = hydra.core.Name("body")
...
class ForInit(metaclass=_ForInitMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ForInit")
    STATEMENTS = hydra.core.Name("statements")
...
ForUpdate.TYPE_ = hydra.core.Name("hydra.java.syntax.ForUpdate")
...
class EnhancedForStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EnhancedForStatement")
    COND = hydra.core.Name("cond")
    BODY = hydra.core.Name("body")
...
class EnhancedForCond:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EnhancedForCond")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
    ID = hydra.core.Name("id")
    EXPRESSION = hydra.core.Name("expression")
...
class EnhancedForStatementNoShortIf:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EnhancedForStatementNoShortIf")
    COND = hydra.core.Name("cond")
    BODY = hydra.core.Name("body")
...
BreakStatement.TYPE_ = hydra.core.Name("hydra.java.syntax.BreakStatement")

class ContinueStatement(Node["Maybe[Identifier]"]):
    ...

ContinueStatement.TYPE_ = hydra.core.Name("hydra.java.syntax.ContinueStatement")

class ReturnStatement(Node["Maybe[Expression]"]):
    ...

ReturnStatement.TYPE_ = hydra.core.Name("hydra.java.syntax.ReturnStatement")

class ThrowStatement(Node["Expression"]):
    ...

ThrowStatement.TYPE_ = hydra.core.Name("hydra.java.syntax.ThrowStatement")
...
class SynchronizedStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.SynchronizedStatement")
    EXPRESSION = hydra.core.Name("expression")
    BLOCK = hydra.core.Name("block")
...
class TryStatement(metaclass=_TryStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TryStatement")
    SIMPLE = hydra.core.Name("simple")
...
class TryStatement_Simple:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TryStatement_Simple")
    BLOCK = hydra.core.Name("block")
...
class TryStatement_WithFinally:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TryStatement_WithFinally")
    BLOCK = hydra.core.Name("block")
    CATCHES = hydra.core.Name("catches")
...
Catches.TYPE_ = hydra.core.Name("hydra.java.syntax.Catches")
...
class CatchClause:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CatchClause")
...
class CatchFormalParameter:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CatchFormalParameter")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
    ID = hydra.core.Name("id")
...
class CatchType:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CatchType")
    TYPE = hydra.core.Name("type")
    TYPES = hydra.core.Name("types")
...
Finally.TYPE_ = hydra.core.Name("hydra.java.syntax.Finally")
...
class TryWithResourcesStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TryWithResourcesStatement")
...
ResourceSpecification.TYPE_ = hydra.core.Name("hydra.java.syntax.ResourceSpecification")
...
class Resource(metaclass=_ResourceMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Resource")
...
class Resource_Local:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Resource_Local")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
    IDENTIFIER = hydra.core.Name("identifier")
    EXPRESSION = hydra.core.Name("expression")
...
class VariableAccess(metaclass=_VariableAccessMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.VariableAccess")
...
class Primary(metaclass=_PrimaryMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Primary")
...
class PrimaryNoNewArrayExpression(metaclass=_PrimaryNoNewArrayExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.PrimaryNoNewArrayExpression")
...
class ClassLiteral(metaclass=_ClassLiteralMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassLiteral")
    TYPE = hydra.core.Name("type")
...
class TypeNameArray(metaclass=_TypeNameArrayMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeNameArray")
    SIMPLE = hydra.core.Name("simple")
    ARRAY = hydra.core.Name("array")
...
class NumericTypeArray(metaclass=_NumericTypeArrayMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.NumericTypeArray")
    SIMPLE = hydra.core.Name("simple")
    ARRAY = hydra.core.Name("array")
...
class BooleanArray(metaclass=_BooleanArrayMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.BooleanArray")
    SIMPLE = hydra.core.Name("simple")
    ARRAY = hydra.core.Name("array")
...
class ClassInstanceCreationExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassInstanceCreationExpression")
    QUALIFIER = hydra.core.Name("qualifier")
    EXPRESSION = hydra.core.Name("expression")
...
class ClassInstanceCreationExpression_Qualifier(metaclass=_ClassInstanceCreationExpression_QualifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassInstanceCreationExpression_Qualifier")
    EXPRESSION = hydra.core.Name("expression")
    PRIMARY = hydra.core.Name("primary")
...
class UnqualifiedClassInstanceCreationExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.UnqualifiedClassInstanceCreationExpression")
    TYPE_ARGUMENTS = hydra.core.Name("typeArguments")
    CLASS_OR_INTERFACE = hydra.core.Name("classOrInterface")
    ARGUMENTS = hydra.core.Name("arguments")
    BODY = hydra.core.Name("body")
...
class ClassOrInterfaceTypeToInstantiate:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ClassOrInterfaceTypeToInstantiate")
    IDENTIFIERS = hydra.core.Name("identifiers")
    TYPE_ARGUMENTS = hydra.core.Name("typeArguments")
...
class AnnotatedIdentifier:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AnnotatedIdentifier")
    ANNOTATIONS = hydra.core.Name("annotations")
    IDENTIFIER = hydra.core.Name("identifier")
...
class TypeArgumentsOrDiamond(metaclass=_TypeArgumentsOrDiamondMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.TypeArgumentsOrDiamond")
    ARGUMENTS = hydra.core.Name("arguments")
...
class FieldAccess:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.FieldAccess")
    QUALIFIER = hydra.core.Name("qualifier")
    IDENTIFIER = hydra.core.Name("identifier")
...
class FieldAccess_Qualifier(metaclass=_FieldAccess_QualifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.FieldAccess_Qualifier")
    PRIMARY = hydra.core.Name("primary")
    SUPER = hydra.core.Name("super")
...
class ArrayAccess:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayAccess")
    EXPRESSION = hydra.core.Name("expression")
    VARIANT = hydra.core.Name("variant")
...
class ArrayAccess_Variant(metaclass=_ArrayAccess_VariantMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayAccess_Variant")
    NAME = hydra.core.Name("name")
    PRIMARY = hydra.core.Name("primary")
...
class MethodInvocation:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodInvocation")
    HEADER = hydra.core.Name("header")
    ARGUMENTS = hydra.core.Name("arguments")
...
class MethodInvocation_Header(metaclass=_MethodInvocation_HeaderMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodInvocation_Header")
    SIMPLE = hydra.core.Name("simple")
...
class MethodInvocation_Complex:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodInvocation_Complex")
    VARIANT = hydra.core.Name("variant")
    TYPE_ARGUMENTS = hydra.core.Name("typeArguments")
    IDENTIFIER = hydra.core.Name("identifier")
...
class MethodInvocation_Variant(metaclass=_MethodInvocation_VariantMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodInvocation_Variant")
    TYPE = hydra.core.Name("type")
    EXPRESSION = hydra.core.Name("expression")
    PRIMARY = hydra.core.Name("primary")
    SUPER = hydra.core.Name("super")
...
class MethodReference(metaclass=_MethodReferenceMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodReference")
    EXPRESSION = hydra.core.Name("expression")
    PRIMARY = hydra.core.Name("primary")
...
class MethodReference_Expression:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodReference_Expression")
    NAME = hydra.core.Name("name")
    TYPE_ARGUMENTS = hydra.core.Name("typeArguments")
    IDENTIFIER = hydra.core.Name("identifier")
...
class MethodReference_Primary:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodReference_Primary")
    PRIMARY = hydra.core.Name("primary")
    TYPE_ARGUMENTS = hydra.core.Name("typeArguments")
    IDENTIFIER = hydra.core.Name("identifier")
...
class MethodReference_ReferenceType:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodReference_ReferenceType")
    REFERENCE_TYPE = hydra.core.Name("referenceType")
    TYPE_ARGUMENTS = hydra.core.Name("typeArguments")
    IDENTIFIER = hydra.core.Name("identifier")
...
class MethodReference_Super:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodReference_Super")
    TYPE_ARGUMENTS = hydra.core.Name("typeArguments")
    IDENTIFIER = hydra.core.Name("identifier")
    SUPER = hydra.core.Name("super")
...
class MethodReference_New:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MethodReference_New")
...
MethodReference_Array.TYPE_ = hydra.core.Name("hydra.java.syntax.MethodReference_Array")
...
class ArrayCreationExpression(metaclass=_ArrayCreationExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayCreationExpression")
    PRIMITIVE = hydra.core.Name("primitive")
    CLASS_OR_INTERFACE = hydra.core.Name("classOrInterface")
...
class ArrayCreationExpression_Primitive:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayCreationExpression_Primitive")
    TYPE = hydra.core.Name("type")
...
class ArrayCreationExpression_ClassOrInterface:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayCreationExpression_ClassOrInterface")
    TYPE = hydra.core.Name("type")
    DIM_EXPRS = hydra.core.Name("dimExprs")
    DIMS = hydra.core.Name("dims")
...
class ArrayCreationExpression_PrimitiveArray:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayCreationExpression_PrimitiveArray")
    TYPE = hydra.core.Name("type")
    DIMS = hydra.core.Name("dims")
    ARRAY = hydra.core.Name("array")
...
class ArrayCreationExpression_ClassOrInterfaceArray:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ArrayCreationExpression_ClassOrInterfaceArray")
    TYPE = hydra.core.Name("type")
    DIMS = hydra.core.Name("dims")
    ARRAY = hydra.core.Name("array")
...
class DimExpr:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.DimExpr")
    ANNOTATIONS = hydra.core.Name("annotations")
    EXPRESSION = hydra.core.Name("expression")
...
class Expression(metaclass=_ExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Expression")
...
class LambdaExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LambdaExpression")
    PARAMETERS = hydra.core.Name("parameters")
    BODY = hydra.core.Name("body")
...
class LambdaParameters(metaclass=_LambdaParametersMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LambdaParameters")
...
class LambdaParameter(metaclass=_LambdaParameterMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LambdaParameter")
    NORMAL = hydra.core.Name("normal")
    VARIABLE_ARITY = hydra.core.Name("variableArity")
...
class LambdaParameter_Normal:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LambdaParameter_Normal")
    MODIFIERS = hydra.core.Name("modifiers")
    TYPE = hydra.core.Name("type")
    ID = hydra.core.Name("id")
...
class LambdaParameterType(metaclass=_LambdaParameterTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LambdaParameterType")
    TYPE = hydra.core.Name("type")
    VAR = hydra.core.Name("var")
...
class LambdaBody(metaclass=_LambdaBodyMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LambdaBody")
    EXPRESSION = hydra.core.Name("expression")
    BLOCK = hydra.core.Name("block")
...
class AssignmentExpression(metaclass=_AssignmentExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AssignmentExpression")
...
class Assignment:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.Assignment")
...
class LeftHandSide(metaclass=_LeftHandSideMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.LeftHandSide")
    EXPRESSION_NAME = hydra.core.Name("expressionName")
    FIELD_ACCESS = hydra.core.Name("fieldAccess")
    ARRAY_ACCESS = hydra.core.Name("arrayAccess")
...
AssignmentOperator.TYPE_ = hydra.core.Name("hydra.java.syntax.AssignmentOperator")
...
class ConditionalExpression(metaclass=_ConditionalExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConditionalExpression")
    SIMPLE = hydra.core.Name("simple")
...
class ConditionalExpression_TernaryCond:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConditionalExpression_TernaryCond")
    COND = hydra.core.Name("cond")
...
class ConditionalExpression_TernaryLambda:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ConditionalExpression_TernaryLambda")
    COND = hydra.core.Name("cond")
    IF_TRUE = hydra.core.Name("ifTrue")
    IF_FALSE = hydra.core.Name("ifFalse")
...
ConditionalOrExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.ConditionalOrExpression")

class ConditionalAndExpression(Node["frozenlist[InclusiveOrExpression]"]):
    ...

ConditionalAndExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.ConditionalAndExpression")

class InclusiveOrExpression(Node["frozenlist[ExclusiveOrExpression]"]):
    ...

InclusiveOrExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.InclusiveOrExpression")

class ExclusiveOrExpression(Node["frozenlist[AndExpression]"]):
    ...

ExclusiveOrExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.ExclusiveOrExpression")

class AndExpression(Node["frozenlist[EqualityExpression]"]):
    ...

AndExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.AndExpression")
...
class EqualityExpression(metaclass=_EqualityExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EqualityExpression")
...
class EqualityExpression_Binary:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.EqualityExpression_Binary")
    LHS = hydra.core.Name("lhs")
...
class RelationalExpression(metaclass=_RelationalExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.RelationalExpression")
    SIMPLE = hydra.core.Name("simple")
...
class RelationalExpression_LessThan:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.RelationalExpression_LessThan")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class RelationalExpression_GreaterThan:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.RelationalExpression_GreaterThan")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class RelationalExpression_LessThanEqual:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.RelationalExpression_LessThanEqual")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class RelationalExpression_GreaterThanEqual:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.RelationalExpression_GreaterThanEqual")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class RelationalExpression_InstanceOf:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.RelationalExpression_InstanceOf")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class ShiftExpression(metaclass=_ShiftExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ShiftExpression")
    UNARY = hydra.core.Name("unary")
    SHIFT_LEFT = hydra.core.Name("shiftLeft")
    SHIFT_RIGHT = hydra.core.Name("shiftRight")
    SHIFT_RIGHT_ZERO_FILL = hydra.core.Name("shiftRightZeroFill")
...
class ShiftExpression_Binary:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.ShiftExpression_Binary")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class AdditiveExpression(metaclass=_AdditiveExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AdditiveExpression")
    UNARY = hydra.core.Name("unary")
    PLUS = hydra.core.Name("plus")
    MINUS = hydra.core.Name("minus")
...
class AdditiveExpression_Binary:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.AdditiveExpression_Binary")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class MultiplicativeExpression(metaclass=_MultiplicativeExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MultiplicativeExpression")
    UNARY = hydra.core.Name("unary")
    TIMES = hydra.core.Name("times")
...
class MultiplicativeExpression_Binary:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.MultiplicativeExpression_Binary")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class UnaryExpression(metaclass=_UnaryExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.UnaryExpression")
    PRE_INCREMENT = hydra.core.Name("preIncrement")
    PRE_DECREMENT = hydra.core.Name("preDecrement")
    PLUS = hydra.core.Name("plus")
    MINUS = hydra.core.Name("minus")
...
PreIncrementExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.PreIncrementExpression")

class PreDecrementExpression(Node["UnaryExpression"]):
    ...

PreDecrementExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.PreDecrementExpression")
...
class UnaryExpressionNotPlusMinus(metaclass=_UnaryExpressionNotPlusMinusMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.UnaryExpressionNotPlusMinus")
...
class PostfixExpression(metaclass=_PostfixExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.PostfixExpression")
    PRIMARY = hydra.core.Name("primary")
    NAME = hydra.core.Name("name")
    POST_INCREMENT = hydra.core.Name("postIncrement")
    POST_DECREMENT = hydra.core.Name("postDecrement")
...
PostIncrementExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.PostIncrementExpression")

class PostDecrementExpression(Node["PostfixExpression"]):
    ...

PostDecrementExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.PostDecrementExpression")
...
class CastExpression(metaclass=_CastExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CastExpression")
    PRIMITIVE = hydra.core.Name("primitive")
...
class CastExpression_Primitive:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CastExpression_Primitive")
    TYPE = hydra.core.Name("type")
    EXPRESSION = hydra.core.Name("expression")
...
class CastExpression_NotPlusMinus:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CastExpression_NotPlusMinus")
...
class CastExpression_Lambda:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CastExpression_Lambda")
    REF_AND_BOUNDS = hydra.core.Name("refAndBounds")
    EXPRESSION = hydra.core.Name("expression")
...
class CastExpression_RefAndBounds:
    ...
    TYPE_ = hydra.core.Name("hydra.java.syntax.CastExpression_RefAndBounds")
    TYPE = hydra.core.Name("type")
...
ConstantExpression.TYPE_ = hydra.core.Name("hydra.java.syntax.ConstantExpression")
