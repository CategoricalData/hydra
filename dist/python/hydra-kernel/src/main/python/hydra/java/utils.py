...
def is_escaped(s: str) -> bool:
    return hydra.lib.equality.equal(hydra.lib.maybes.from_maybe((lambda : 0), hydra.lib.strings.maybe_char_at(0, s)), 36)

def unescape(s: str) -> str:
    return hydra.lib.strings.from_list(hydra.lib.lists.drop(1, hydra.lib.strings.to_list(s)))
