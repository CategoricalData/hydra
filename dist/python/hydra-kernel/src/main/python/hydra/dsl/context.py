...
def context_messages(x: hydra.phantoms.TTerm[hydra.context.Context]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.context.Context"), hydra.core.Name("messages")))), x.value))))

def context_other(x: hydra.phantoms.TTerm[hydra.context.Context]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.context.Context"), hydra.core.Name("other")))), x.value))))

def context_trace(x: hydra.phantoms.TTerm[hydra.context.Context]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.context.Context"), hydra.core.Name("trace")))), x.value))))
...
def context_with_other(original: hydra.phantoms.TTerm[hydra.context.Context], new_val: hydra.phantoms.TTerm[FrozenDict[hydra.core.Name, hydra.core.Term]]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermRecord(hydra.core.Record(hydra.core.Name("hydra.context.Context"), (hydra.core.Field(hydra.core.Name("trace"), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.context.Context"), hydra.core.Name("trace")))), original.value)))), hydra.core.Field(hydra.core.Name("messages"), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.context.Context"), hydra.core.Name("messages")))), original.value)))), hydra.core.Field(hydra.core.Name("other"), new_val.value))))))
...
def in_context_context(x: hydra.phantoms.TTerm[hydra.context.InContext[E]]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.context.InContext"), hydra.core.Name("context")))), x.value))))

def in_context_object(x: hydra.phantoms.TTerm[hydra.context.InContext[E]]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.context.InContext"), hydra.core.Name("object")))), x.value))))
