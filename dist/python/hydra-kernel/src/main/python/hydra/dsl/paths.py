...
subterm_step_annotated_body = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("annotatedBody"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subterm_step_application_argument = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("applicationArgument"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subterm_step_application_function = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("applicationFunction"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subterm_step_injection_term = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("injectionTerm"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subterm_step_lambda_body = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("lambdaBody"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

def subterm_step_let_binding(x: hydra.phantoms.TTerm[hydra.core.Name]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("letBinding"), x.value)))))

subterm_step_let_body = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("letBody"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

def subterm_step_list_element(x: hydra.phantoms.TTerm[int]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("listElement"), x.value)))))

def subterm_step_map_key(x: hydra.phantoms.TTerm[int]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("mapKey"), x.value)))))

def subterm_step_map_value(x: hydra.phantoms.TTerm[int]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("mapValue"), x.value)))))

subterm_step_maybe_term = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("maybeTerm"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

def subterm_step_product_term(x: hydra.phantoms.TTerm[int]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("productTerm"), x.value)))))

def subterm_step_record_field(x: hydra.phantoms.TTerm[hydra.core.Name]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("recordField"), x.value)))))

def subterm_step_set_element(x: hydra.phantoms.TTerm[int]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("setElement"), x.value)))))

subterm_step_sum_term = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("sumTerm"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subterm_step_type_application_term = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("typeApplicationTerm"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subterm_step_type_lambda_body = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("typeLambdaBody"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

def subterm_step_union_cases_branch(x: hydra.phantoms.TTerm[hydra.core.Name]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("unionCasesBranch"), x.value)))))

subterm_step_union_cases_default = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("unionCasesDefault"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subterm_step_wrapped_term = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtermStep"), hydra.core.Field(hydra.core.Name("wrappedTerm"), cast(hydra.core.Term, hydra.core.TermUnit()))))))
...
subtype_step_annotated_body = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("annotatedBody"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_application_argument = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("applicationArgument"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_application_function = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("applicationFunction"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_either_left = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("eitherLeft"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_either_right = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("eitherRight"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_forall_body = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("forallBody"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_function_codomain = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("functionCodomain"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_function_domain = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("functionDomain"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_list_element = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("listElement"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_map_keys = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("mapKeys"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_map_values = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("mapValues"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_maybe_element = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("maybeElement"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_pair_first = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("pairFirst"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

subtype_step_pair_second = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("pairSecond"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

def subtype_step_record_field(x: hydra.phantoms.TTerm[hydra.core.Name]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("recordField"), x.value)))))

subtype_step_set_element = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("setElement"), cast(hydra.core.Term, hydra.core.TermUnit()))))))

def subtype_step_union_field(x: hydra.phantoms.TTerm[hydra.core.Name]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("unionField"), x.value)))))

subtype_step_wrapped_type = hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermInject(hydra.core.Injection(hydra.core.Name("hydra.paths.SubtypeStep"), hydra.core.Field(hydra.core.Name("wrappedType"), cast(hydra.core.Term, hydra.core.TermUnit()))))))
