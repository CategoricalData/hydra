...
def multiple_bindings_error_name(x: hydra.phantoms.TTerm[hydra.errors.MultipleBindingsError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.MultipleBindingsError"), hydra.core.Name("name")))), x.value))))
...
def multiple_fields_error_field_name(x: hydra.phantoms.TTerm[hydra.errors.MultipleFieldsError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.MultipleFieldsError"), hydra.core.Name("fieldName")))), x.value))))
...
def no_matching_field_error_field_name(x: hydra.phantoms.TTerm[hydra.errors.NoMatchingFieldError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.NoMatchingFieldError"), hydra.core.Name("fieldName")))), x.value))))
...
def no_such_binding_error_name(x: hydra.phantoms.TTerm[hydra.errors.NoSuchBindingError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.NoSuchBindingError"), hydra.core.Name("name")))), x.value))))
...
def no_such_primitive_error_name(x: hydra.phantoms.TTerm[hydra.errors.NoSuchPrimitiveError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.NoSuchPrimitiveError"), hydra.core.Name("name")))), x.value))))
...
def other_inference_error_message(x: hydra.phantoms.TTerm[hydra.errors.OtherInferenceError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.OtherInferenceError"), hydra.core.Name("message")))), x.value))))

def other_inference_error_path(x: hydra.phantoms.TTerm[hydra.errors.OtherInferenceError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.OtherInferenceError"), hydra.core.Name("path")))), x.value))))
...
def un_other_error(x: hydra.phantoms.TTerm[hydra.errors.OtherError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermUnwrap(hydra.core.Name("hydra.errors.OtherError"))), x.value))))

def un_other_resolution_error(x: hydra.phantoms.TTerm[hydra.errors.OtherResolutionError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermUnwrap(hydra.core.Name("hydra.errors.OtherResolutionError"))), x.value))))
...
def unexpected_shape_error_actual(x: hydra.phantoms.TTerm[hydra.errors.UnexpectedShapeError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnexpectedShapeError"), hydra.core.Name("actual")))), x.value))))

def unexpected_shape_error_expected(x: hydra.phantoms.TTerm[hydra.errors.UnexpectedShapeError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnexpectedShapeError"), hydra.core.Name("expected")))), x.value))))
...
def unification_error_left_type(x: hydra.phantoms.TTerm[hydra.errors.UnificationError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationError"), hydra.core.Name("leftType")))), x.value))))

def unification_error_message(x: hydra.phantoms.TTerm[hydra.errors.UnificationError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationError"), hydra.core.Name("message")))), x.value))))

def unification_error_right_type(x: hydra.phantoms.TTerm[hydra.errors.UnificationError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationError"), hydra.core.Name("rightType")))), x.value))))
...
def unification_error_with_left_type(original: hydra.phantoms.TTerm[hydra.errors.UnificationError], new_val: hydra.phantoms.TTerm[hydra.core.Type]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermRecord(hydra.core.Record(hydra.core.Name("hydra.errors.UnificationError"), (hydra.core.Field(hydra.core.Name("leftType"), new_val.value), hydra.core.Field(hydra.core.Name("rightType"), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationError"), hydra.core.Name("rightType")))), original.value)))), hydra.core.Field(hydra.core.Name("message"), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationError"), hydra.core.Name("message")))), original.value)))))))))
...
def unification_error_with_message(original: hydra.phantoms.TTerm[hydra.errors.UnificationError], new_val: hydra.phantoms.TTerm[str]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermRecord(hydra.core.Record(hydra.core.Name("hydra.errors.UnificationError"), (hydra.core.Field(hydra.core.Name("leftType"), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationError"), hydra.core.Name("leftType")))), original.value)))), hydra.core.Field(hydra.core.Name("rightType"), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationError"), hydra.core.Name("rightType")))), original.value)))), hydra.core.Field(hydra.core.Name("message"), new_val.value))))))
...
def unification_inference_error_cause(x: hydra.phantoms.TTerm[hydra.errors.UnificationInferenceError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationInferenceError"), hydra.core.Name("cause")))), x.value))))

def unification_inference_error_path(x: hydra.phantoms.TTerm[hydra.errors.UnificationInferenceError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.errors.UnificationInferenceError"), hydra.core.Name("path")))), x.value))))
