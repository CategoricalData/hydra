...
def parse_error_message(x: hydra.phantoms.TTerm[hydra.parsing.ParseError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.parsing.ParseError"), hydra.core.Name("message")))), x.value))))

def parse_error_remainder(x: hydra.phantoms.TTerm[hydra.parsing.ParseError]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.parsing.ParseError"), hydra.core.Name("remainder")))), x.value))))
...
def parse_success_remainder(x: hydra.phantoms.TTerm[hydra.parsing.ParseSuccess[A]]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.parsing.ParseSuccess"), hydra.core.Name("remainder")))), x.value))))

def parse_success_value(x: hydra.phantoms.TTerm[hydra.parsing.ParseSuccess[A]]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.core.Name("hydra.parsing.ParseSuccess"), hydra.core.Name("value")))), x.value))))
...
def un_parser(x: hydra.phantoms.TTerm[hydra.parsing.Parser[A]]) -> hydra.phantoms.TTerm:
    return hydra.phantoms.TTerm(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(cast(hydra.core.Term, hydra.core.TermUnwrap(hydra.core.Name("hydra.parsing.Parser"))), x.value))))
