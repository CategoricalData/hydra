...
class AnnotatedStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.AnnotatedStatement")
...
Module.TYPE_ = hydra.core.Name("hydra.python.syntax.Module")
...
QuoteStyle.TYPE_ = hydra.core.Name("hydra.python.syntax.QuoteStyle")

class Name(Node[str]):
    ...

Name.TYPE_ = hydra.core.Name("hydra.python.syntax.Name")
...
class Number(metaclass=_NumberMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Number")
...
class String:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.String")
...
TypeComment.TYPE_ = hydra.core.Name("hydra.python.syntax.TypeComment")

class File(Node["frozenlist[Statement]"]):
    ...

File.TYPE_ = hydra.core.Name("hydra.python.syntax.File")

class Interactive(Node["Statement"]):
    ...

Interactive.TYPE_ = hydra.core.Name("hydra.python.syntax.Interactive")

class Eval(Node["frozenlist[Expression]"]):
    ...

Eval.TYPE_ = hydra.core.Name("hydra.python.syntax.Eval")
...
class FuncType:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.FuncType")
...
class Statement(metaclass=_StatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Statement")
...
class SimpleStatement(metaclass=_SimpleStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SimpleStatement")
...
class CompoundStatement(metaclass=_CompoundStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.CompoundStatement")
...
class Assignment(metaclass=_AssignmentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Assignment")
...
class TypedAssignment:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TypedAssignment")
...
class UntypedAssignment:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.UntypedAssignment")
...
class AugAssignment:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.AugAssignment")
    LHS = hydra.core.Name("lhs")
...
class AnnotatedRhs(metaclass=_AnnotatedRhsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.AnnotatedRhs")
    YIELD = hydra.core.Name("yield")
...
AugAssign.TYPE_ = hydra.core.Name("hydra.python.syntax.AugAssign")

class ReturnStatement(Node["frozenlist[StarExpression]"]):
    ...

ReturnStatement.TYPE_ = hydra.core.Name("hydra.python.syntax.ReturnStatement")

class RaiseStatement(Node["Maybe[RaiseExpression]"]):
    ...

RaiseStatement.TYPE_ = hydra.core.Name("hydra.python.syntax.RaiseStatement")
...
class RaiseExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.RaiseExpression")
...
DelStatement.TYPE_ = hydra.core.Name("hydra.python.syntax.DelStatement")

class YieldStatement(Node["YieldExpression"]):
    ...

YieldStatement.TYPE_ = hydra.core.Name("hydra.python.syntax.YieldStatement")
...
class AssertStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.AssertStatement")
...
class ImportStatement(metaclass=_ImportStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ImportStatement")
...
ImportName.TYPE_ = hydra.core.Name("hydra.python.syntax.ImportName")
...
class ImportFrom:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ImportFrom")
...
RelativeImportPrefix.TYPE_ = hydra.core.Name("hydra.python.syntax.RelativeImportPrefix")
...
class ImportFromTargets(metaclass=_ImportFromTargetsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ImportFromTargets")
    SIMPLE = hydra.core.Name("simple")
...
class ImportFromAsName:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ImportFromAsName")
    NAME = hydra.core.Name("name")
...
class DottedAsName:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.DottedAsName")
    NAME = hydra.core.Name("name")
    AS = hydra.core.Name("as")
...
DottedName.TYPE_ = hydra.core.Name("hydra.python.syntax.DottedName")
...
class Block(metaclass=_BlockMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Block")
...
Decorators.TYPE_ = hydra.core.Name("hydra.python.syntax.Decorators")
...
class ClassDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ClassDefinition")
...
class FunctionDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.FunctionDefinition")
    DECORATORS = hydra.core.Name("decorators")
...
class FunctionDefRaw:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.FunctionDefRaw")
...
class Parameters(metaclass=_ParametersMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Parameters")
...
class SlashNoDefaultParameters:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SlashNoDefaultParameters")
...
class SlashWithDefaultParameters:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SlashWithDefaultParameters")
    PARAM_NO_DEFAULT = hydra.core.Name("paramNoDefault")
    PARAM_WITH_DEFAULT = hydra.core.Name("paramWithDefault")
    STAR_ETC = hydra.core.Name("starEtc")
...
class ParamNoDefaultParameters:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ParamNoDefaultParameters")
    PARAM_NO_DEFAULT = hydra.core.Name("paramNoDefault")
    PARAM_WITH_DEFAULT = hydra.core.Name("paramWithDefault")
    STAR_ETC = hydra.core.Name("starEtc")
...
class ParamWithDefaultParameters:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ParamWithDefaultParameters")
    PARAM_WITH_DEFAULT = hydra.core.Name("paramWithDefault")
    STAR_ETC = hydra.core.Name("starEtc")
...
SlashNoDefault.TYPE_ = hydra.core.Name("hydra.python.syntax.SlashNoDefault")
...
class SlashWithDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SlashWithDefault")
    PARAM_NO_DEFAULT = hydra.core.Name("paramNoDefault")
    PARAM_WITH_DEFAULT = hydra.core.Name("paramWithDefault")
...
class StarEtc(metaclass=_StarEtcMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.StarEtc")
...
class NoDefaultStarEtc:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.NoDefaultStarEtc")
    PARAM_NO_DEFAULT = hydra.core.Name("paramNoDefault")
...
class NoDefaultStarAnnotationStarEtc:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.NoDefaultStarAnnotationStarEtc")
...
class CommaStarEtc:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.CommaStarEtc")
    PARAM_MAYBE_DEFAULT = hydra.core.Name("paramMaybeDefault")
    KEYWORDS = hydra.core.Name("keywords")
...
Keywords.TYPE_ = hydra.core.Name("hydra.python.syntax.Keywords")
...
class ParamNoDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ParamNoDefault")
...
class ParamNoDefaultStarAnnotation:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ParamNoDefaultStarAnnotation")
...
class ParamWithDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ParamWithDefault")
    PARAM = hydra.core.Name("param")
...
class ParamMaybeDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ParamMaybeDefault")
    PARAM = hydra.core.Name("param")
    DEFAULT = hydra.core.Name("default")
    TYPE_COMMENT = hydra.core.Name("typeComment")
...
class Param:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Param")
    NAME = hydra.core.Name("name")
...
class ParamStarAnnotation:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ParamStarAnnotation")
    NAME = hydra.core.Name("name")
    ANNOTATION = hydra.core.Name("annotation")
...
Annotation.TYPE_ = hydra.core.Name("hydra.python.syntax.Annotation")

class StarAnnotation(Node["StarExpression"]):
    ...

StarAnnotation.TYPE_ = hydra.core.Name("hydra.python.syntax.StarAnnotation")

class Default(Node["Expression"]):
    ...

Default.TYPE_ = hydra.core.Name("hydra.python.syntax.Default")
...
class IfStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.IfStatement")
...
class IfTail(metaclass=_IfTailMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.IfTail")
...
class WhileStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.WhileStatement")
    CONDITION = hydra.core.Name("condition")
    BODY = hydra.core.Name("body")
    ELSE = hydra.core.Name("else")
...
class ForStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ForStatement")
    ASYNC = hydra.core.Name("async")
    TARGETS = hydra.core.Name("targets")
...
class WithStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.WithStatement")
    ASYNC = hydra.core.Name("async")
...
class WithItem:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.WithItem")
    EXPRESSION = hydra.core.Name("expression")
    AS = hydra.core.Name("as")
...
class TryStatement(metaclass=_TryStatementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TryStatement")
...
class TryFinallyStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TryFinallyStatement")
    BODY = hydra.core.Name("body")
    FINALLY = hydra.core.Name("finally")
...
class TryExceptStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TryExceptStatement")
    BODY = hydra.core.Name("body")
...
class TryExceptStarStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TryExceptStarStatement")
    BODY = hydra.core.Name("body")
    EXCEPTS = hydra.core.Name("excepts")
    ELSE = hydra.core.Name("else")
    FINALLY = hydra.core.Name("finally")
...
class ExceptBlock:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ExceptBlock")
    EXPRESSION = hydra.core.Name("expression")
    BODY = hydra.core.Name("body")
...
class ExceptExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ExceptExpression")
    EXPRESSION = hydra.core.Name("expression")
    AS = hydra.core.Name("as")
...
class ExceptStarBlock:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ExceptStarBlock")
    EXPRESSION = hydra.core.Name("expression")
    AS = hydra.core.Name("as")
    BODY = hydra.core.Name("body")
...
class MatchStatement:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.MatchStatement")
...
class SubjectExpression(metaclass=_SubjectExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SubjectExpression")
...
class CaseBlock:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.CaseBlock")
...
Guard.TYPE_ = hydra.core.Name("hydra.python.syntax.Guard")
...
class Patterns(metaclass=_PatternsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Patterns")
...
class Pattern(metaclass=_PatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Pattern")
    AS = hydra.core.Name("as")
...
class AsPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.AsPattern")
    PATTERN = hydra.core.Name("pattern")
    AS = hydra.core.Name("as")
...
OrPattern.TYPE_ = hydra.core.Name("hydra.python.syntax.OrPattern")
...
class ClosedPattern(metaclass=_ClosedPatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ClosedPattern")
...
class LiteralExpression(metaclass=_LiteralExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LiteralExpression")
...
class ComplexNumber:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ComplexNumber")
...
PlusOrMinus.TYPE_ = hydra.core.Name("hydra.python.syntax.PlusOrMinus")
...
class SignedNumber(metaclass=_SignedNumberMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SignedNumber")
...
class SignedRealNumber(metaclass=_SignedRealNumberMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SignedRealNumber")
    SIGN = hydra.core.Name("sign")
    NUMBER = hydra.core.Name("number")
...
RealNumber.TYPE_ = hydra.core.Name("hydra.python.syntax.RealNumber")

class ImaginaryNumber(Node["Number"]):
    ...

ImaginaryNumber.TYPE_ = hydra.core.Name("hydra.python.syntax.ImaginaryNumber")

class CapturePattern(Node["PatternCaptureTarget"]):
    ...

CapturePattern.TYPE_ = hydra.core.Name("hydra.python.syntax.CapturePattern")

class PatternCaptureTarget(Node["Name"]):
    ...

PatternCaptureTarget.TYPE_ = hydra.core.Name("hydra.python.syntax.PatternCaptureTarget")

class ValuePattern(Node["Attribute"]):
    ...

ValuePattern.TYPE_ = hydra.core.Name("hydra.python.syntax.ValuePattern")

class Attribute(Node["frozenlist[Name]"]):
    ...

Attribute.TYPE_ = hydra.core.Name("hydra.python.syntax.Attribute")

class NameOrAttribute(Node["frozenlist[Name]"]):
    ...

NameOrAttribute.TYPE_ = hydra.core.Name("hydra.python.syntax.NameOrAttribute")

class GroupPattern(Node["Pattern"]):
    ...

GroupPattern.TYPE_ = hydra.core.Name("hydra.python.syntax.GroupPattern")
...
class SequencePattern(metaclass=_SequencePatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SequencePattern")
...
class OpenSequencePattern:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.OpenSequencePattern")
...
MaybeSequencePattern.TYPE_ = hydra.core.Name("hydra.python.syntax.MaybeSequencePattern")
...
class MaybeStarPattern(metaclass=_MaybeStarPatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.MaybeStarPattern")
    STAR = hydra.core.Name("star")
    PATTERN = hydra.core.Name("pattern")
...
class StarPattern(metaclass=_StarPatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.StarPattern")
    CAPTURE = hydra.core.Name("capture")
    WILDCARD = hydra.core.Name("wildcard")
...
class MappingPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.MappingPattern")
    ITEMS = hydra.core.Name("items")
...
ItemsPattern.TYPE_ = hydra.core.Name("hydra.python.syntax.ItemsPattern")
...
class KeyValuePattern:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.KeyValuePattern")
...
class LiteralExpressionOrAttribute(metaclass=_LiteralExpressionOrAttributeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LiteralExpressionOrAttribute")
    LITERAL = hydra.core.Name("literal")
...
DoubleStarPattern.TYPE_ = hydra.core.Name("hydra.python.syntax.DoubleStarPattern")
...
class ClassPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ClassPattern")
...
PositionalPatterns.TYPE_ = hydra.core.Name("hydra.python.syntax.PositionalPatterns")

class KeywordPatterns(Node["frozenlist[KeywordPattern]"]):
    ...

KeywordPatterns.TYPE_ = hydra.core.Name("hydra.python.syntax.KeywordPatterns")
...
class KeywordPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.KeywordPattern")
    NAME = hydra.core.Name("name")
    PATTERN = hydra.core.Name("pattern")
...
class TypeAlias:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TypeAlias")
    NAME = hydra.core.Name("name")
    TYPE_PARAMS = hydra.core.Name("typeParams")
    EXPRESSION = hydra.core.Name("expression")
...
class TypeParameter(metaclass=_TypeParameterMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TypeParameter")
    SIMPLE = hydra.core.Name("simple")
    STAR = hydra.core.Name("star")
    DOUBLE_STAR = hydra.core.Name("doubleStar")
...
class SimpleTypeParameter:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SimpleTypeParameter")
    NAME = hydra.core.Name("name")
...
class StarTypeParameter:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.StarTypeParameter")
    NAME = hydra.core.Name("name")
    DEFAULT = hydra.core.Name("default")
...
class DoubleStarTypeParameter:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.DoubleStarTypeParameter")
    NAME = hydra.core.Name("name")
    DEFAULT = hydra.core.Name("default")
...
class Expression(metaclass=_ExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Expression")
...
class Conditional:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Conditional")
    BODY = hydra.core.Name("body")
    IF = hydra.core.Name("if")
    ELSE = hydra.core.Name("else")
...
class YieldExpression(metaclass=_YieldExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.YieldExpression")
    FROM = hydra.core.Name("from")
    SIMPLE = hydra.core.Name("simple")
...
class StarExpression(metaclass=_StarExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.StarExpression")
    STAR = hydra.core.Name("star")
    SIMPLE = hydra.core.Name("simple")
...
StarNamedExpressions.TYPE_ = hydra.core.Name("hydra.python.syntax.StarNamedExpressions")
...
class StarNamedExpression(metaclass=_StarNamedExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.StarNamedExpression")
    STAR = hydra.core.Name("star")
    SIMPLE = hydra.core.Name("simple")
...
class AssignmentExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.AssignmentExpression")
    NAME = hydra.core.Name("name")
    EXPRESSION = hydra.core.Name("expression")
...
class NamedExpression(metaclass=_NamedExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.NamedExpression")
    ASSIGNMENT = hydra.core.Name("assignment")
    SIMPLE = hydra.core.Name("simple")
...
Disjunction.TYPE_ = hydra.core.Name("hydra.python.syntax.Disjunction")

class Conjunction(Node["frozenlist[Inversion]"]):
    ...

Conjunction.TYPE_ = hydra.core.Name("hydra.python.syntax.Conjunction")
...
class Inversion(metaclass=_InversionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Inversion")
...
class Comparison:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Comparison")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class CompareOpBitwiseOrPair:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.CompareOpBitwiseOrPair")
...
CompareOp.TYPE_ = hydra.core.Name("hydra.python.syntax.CompareOp")
...
class BitwiseOr:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.BitwiseOr")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class BitwiseXor:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.BitwiseXor")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class BitwiseAnd:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.BitwiseAnd")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class ShiftExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ShiftExpression")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class ShiftLhs:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ShiftLhs")
...
ShiftOp.TYPE_ = hydra.core.Name("hydra.python.syntax.ShiftOp")
...
class Sum:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Sum")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class SumLhs:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SumLhs")
    OPERAND = hydra.core.Name("operand")
    OPERATOR = hydra.core.Name("operator")
...
SumOp.TYPE_ = hydra.core.Name("hydra.python.syntax.SumOp")
...
class Term:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Term")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class TermLhs:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TermLhs")
    OPERAND = hydra.core.Name("operand")
    OPERATOR = hydra.core.Name("operator")
...
TermOp.TYPE_ = hydra.core.Name("hydra.python.syntax.TermOp")
...
class Factor(metaclass=_FactorMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Factor")
...
class Power:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Power")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class AwaitPrimary:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.AwaitPrimary")
...
class Primary(metaclass=_PrimaryMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Primary")
    SIMPLE = hydra.core.Name("simple")
    COMPOUND = hydra.core.Name("compound")
...
class PrimaryWithRhs:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.PrimaryWithRhs")
    PRIMARY = hydra.core.Name("primary")
    RHS = hydra.core.Name("rhs")
...
class PrimaryRhs(metaclass=_PrimaryRhsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.PrimaryRhs")
...
class Slices:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Slices")
    HEAD = hydra.core.Name("head")
    TAIL = hydra.core.Name("tail")
...
class SliceOrStarredExpression(metaclass=_SliceOrStarredExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SliceOrStarredExpression")
...
class Slice(metaclass=_SliceMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Slice")
...
class SliceExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SliceExpression")
...
class Atom(metaclass=_AtomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Atom")
    NAME = hydra.core.Name("name")
    TRUE = hydra.core.Name("true")
    FALSE = hydra.core.Name("false")
    NONE = hydra.core.Name("none")
...
class Group(metaclass=_GroupMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Group")
    YIELD = hydra.core.Name("yield")
    EXPRESSION = hydra.core.Name("expression")
...
class Lambda:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Lambda")
    PARAMS = hydra.core.Name("params")
    BODY = hydra.core.Name("body")
...
class LambdaParameters:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaParameters")
    SLASH_NO_DEFAULT = hydra.core.Name("slashNoDefault")
    PARAM_NO_DEFAULT = hydra.core.Name("paramNoDefault")
    PARAM_WITH_DEFAULT = hydra.core.Name("paramWithDefault")
    STAR_ETC = hydra.core.Name("starEtc")
...
class LambdaSlashNoDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaSlashNoDefault")
...
class LambdaSlashWithDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaSlashWithDefault")
    PARAM_NO_DEFAULT = hydra.core.Name("paramNoDefault")
    PARAM_WITH_DEFAULT = hydra.core.Name("paramWithDefault")
...
class LambdaStarEtc(metaclass=_LambdaStarEtcMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaStarEtc")
    STAR = hydra.core.Name("star")
    PARAM_NO_DEFAULT = hydra.core.Name("paramNoDefault")
    PARAM_MAYBE_DEFAULT = hydra.core.Name("paramMaybeDefault")
...
LambdaKwds.TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaKwds")

class LambdaParamNoDefault(Node["Name"]):
    ...

LambdaParamNoDefault.TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaParamNoDefault")
...
class LambdaParamWithDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaParamWithDefault")
    PARAM = hydra.core.Name("param")
    DEFAULT = hydra.core.Name("default")
...
class LambdaParamMaybeDefault:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.LambdaParamMaybeDefault")
    PARAM = hydra.core.Name("param")
    DEFAULT = hydra.core.Name("default")
...
List.TYPE_ = hydra.core.Name("hydra.python.syntax.List")

class Tuple(Node["frozenlist[StarNamedExpression]"]):
    ...

Tuple.TYPE_ = hydra.core.Name("hydra.python.syntax.Tuple")

class Set(Node["frozenlist[StarNamedExpression]"]):
    ...

Set.TYPE_ = hydra.core.Name("hydra.python.syntax.Set")

class Dict(Node["frozenlist[DoubleStarredKvpair]"]):
    ...

Dict.TYPE_ = hydra.core.Name("hydra.python.syntax.Dict")
...
class DoubleStarredKvpair(metaclass=_DoubleStarredKvpairMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.DoubleStarredKvpair")
    STARRED = hydra.core.Name("starred")
...
class Kvpair:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Kvpair")
    KEY = hydra.core.Name("key")
    VALUE = hydra.core.Name("value")
...
ForIfClauses.TYPE_ = hydra.core.Name("hydra.python.syntax.ForIfClauses")
...
class ForIfClause:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.ForIfClause")
    ASYNC = hydra.core.Name("async")
    TARGETS = hydra.core.Name("targets")
    IN = hydra.core.Name("in")
...
class Listcomp:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Listcomp")
    EXPRESSION = hydra.core.Name("expression")
...
class Setcomp:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Setcomp")
    EXPRESSION = hydra.core.Name("expression")
    FOR_IF_CLAUSES = hydra.core.Name("forIfClauses")
...
class Genexp:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Genexp")
    HEAD = hydra.core.Name("head")
    TAIL = hydra.core.Name("tail")
...
class GenexpHead(metaclass=_GenexpHeadMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.GenexpHead")
    ASSIGNMENT = hydra.core.Name("assignment")
    EXPRESSION = hydra.core.Name("expression")
...
class Dictcomp:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Dictcomp")
...
class Args:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Args")
...
class PosArg(metaclass=_PosArgMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.PosArg")
    STARRED = hydra.core.Name("starred")
    ASSIGNMENT = hydra.core.Name("assignment")
    EXPRESSION = hydra.core.Name("expression")
...
StarredExpression.TYPE_ = hydra.core.Name("hydra.python.syntax.StarredExpression")
...
class KwargOrStarred(metaclass=_KwargOrStarredMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.KwargOrStarred")
...
class Kwarg:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.Kwarg")
    NAME = hydra.core.Name("name")
    VALUE = hydra.core.Name("value")
...
class KwargOrDoubleStarred(metaclass=_KwargOrDoubleStarredMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.KwargOrDoubleStarred")
    KWARG = hydra.core.Name("kwarg")
...
StarTargetsListSeq.TYPE_ = hydra.core.Name("hydra.python.syntax.StarTargetsListSeq")

class StarTargetsTupleSeq(Node["frozenlist[StarTarget]"]):
    ...

StarTargetsTupleSeq.TYPE_ = hydra.core.Name("hydra.python.syntax.StarTargetsTupleSeq")
...
class StarTarget(metaclass=_StarTargetMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.StarTarget")
    STARRED = hydra.core.Name("starred")
...
class TargetWithStarAtom(metaclass=_TargetWithStarAtomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TargetWithStarAtom")
    PROJECT = hydra.core.Name("project")
    SLICES = hydra.core.Name("slices")
...
class TPrimaryAndName:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TPrimaryAndName")
    PRIMARY = hydra.core.Name("primary")
    NAME = hydra.core.Name("name")
...
class TPrimaryAndSlices:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TPrimaryAndSlices")
    PRIMARY = hydra.core.Name("primary")
    SLICES = hydra.core.Name("slices")
...
class StarAtom(metaclass=_StarAtomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.StarAtom")
    NAME = hydra.core.Name("name")
...
class SingleTarget(metaclass=_SingleTargetMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SingleTarget")
...
class SingleSubscriptAttributeTarget(metaclass=_SingleSubscriptAttributeTargetMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.SingleSubscriptAttributeTarget")
...
class TPrimary(metaclass=_TPrimaryMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TPrimary")
    PRIMARY_AND_NAME = hydra.core.Name("primaryAndName")
    PRIMARY_AND_SLICES = hydra.core.Name("primaryAndSlices")
...
class TPrimaryAndGenexp:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TPrimaryAndGenexp")
    PRIMARY = hydra.core.Name("primary")
    GENEXP = hydra.core.Name("genexp")
...
class TPrimaryAndArguments:
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TPrimaryAndArguments")
    PRIMARY = hydra.core.Name("primary")
    ARGUMENTS = hydra.core.Name("arguments")
...
DelTargets.TYPE_ = hydra.core.Name("hydra.python.syntax.DelTargets")
...
class DelTarget(metaclass=_DelTargetMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.DelTarget")
    PRIMARY_AND_NAME = hydra.core.Name("primaryAndName")
    PRIMARY_AND_SLICES = hydra.core.Name("primaryAndSlices")
...
class DelTAtom(metaclass=_DelTAtomMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.DelTAtom")
    NAME = hydra.core.Name("name")
...
class TypeExpression(metaclass=_TypeExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.python.syntax.TypeExpression")
    EXPRESSION = hydra.core.Name("expression")
...
FuncTypeComment.TYPE_ = hydra.core.Name("hydra.python.syntax.FuncTypeComment")
