...
class Alternative:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Alternative")
...
class Assertion(metaclass=_AssertionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Assertion")
...
class ClassAssertion:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ClassAssertion")
...
CaseRhs.TYPE_ = hydra.core.Name("hydra.haskell.syntax.CaseRhs")
...
class Constructor(metaclass=_ConstructorMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Constructor")
...
class OrdinaryConstructor:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.OrdinaryConstructor")
    NAME = hydra.core.Name("name")
...
class RecordConstructor:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.RecordConstructor")
    NAME = hydra.core.Name("name")
    FIELDS = hydra.core.Name("fields")
...
class ConstructorWithComments:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ConstructorWithComments")
...
class DataDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.DataDeclaration")
...
DataOrNewtype.TYPE_ = hydra.core.Name("hydra.haskell.syntax.DataOrNewtype")
...
class DeclarationWithComments:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.DeclarationWithComments")
    BODY = hydra.core.Name("body")
    COMMENTS = hydra.core.Name("comments")
...
class Declaration(metaclass=_DeclarationMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Declaration")
    DATA = hydra.core.Name("data")
...
class DeclarationHead(metaclass=_DeclarationHeadMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.DeclarationHead")
...
class ApplicationDeclarationHead:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ApplicationDeclarationHead")
...
Deriving.TYPE_ = hydra.core.Name("hydra.haskell.syntax.Deriving")
...
class Export(metaclass=_ExportMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Export")
...
class Expression(metaclass=_ExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Expression")
    APPLICATION = hydra.core.Name("application")
...
class ApplicationExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ApplicationExpression")
    FUNCTION = hydra.core.Name("function")
...
class CaseExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.CaseExpression")
    CASE = hydra.core.Name("case")
...
class ConstructRecordExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ConstructRecordExpression")
    NAME = hydra.core.Name("name")
    FIELDS = hydra.core.Name("fields")
...
class IfExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.IfExpression")
...
class InfixApplicationExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.InfixApplicationExpression")
...
class LambdaExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.LambdaExpression")
...
class LetExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.LetExpression")
    BINDINGS = hydra.core.Name("bindings")
    INNER = hydra.core.Name("inner")
...
class PrefixApplicationExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.PrefixApplicationExpression")
    OPERATOR = hydra.core.Name("operator")
    RHS = hydra.core.Name("rhs")
...
class SectionExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.SectionExpression")
    OPERATOR = hydra.core.Name("operator")
...
class TypeSignatureExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.TypeSignatureExpression")
    INNER = hydra.core.Name("inner")
    TYPE = hydra.core.Name("type")
...
class UpdateRecordExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.UpdateRecordExpression")
    INNER = hydra.core.Name("inner")
    FIELDS = hydra.core.Name("fields")
...
class Field:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Field")
    NAME = hydra.core.Name("name")
    TYPE = hydra.core.Name("type")
...
class FieldWithComments:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.FieldWithComments")
...
class FieldUpdate:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.FieldUpdate")
    NAME = hydra.core.Name("name")
...
class Import:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Import")
...
class SpecImport(metaclass=_SpecImportMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.SpecImport")
    LIST = hydra.core.Name("list")
...
ImportModifier.TYPE_ = hydra.core.Name("hydra.haskell.syntax.ImportModifier")
...
class ImportExportSpec:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ImportExportSpec")
...
class SubspecImportExportSpec(metaclass=_SubspecImportExportSpecMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.SubspecImportExportSpec")
...
class Literal(metaclass=_LiteralMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Literal")
...
class LocalBinding(metaclass=_LocalBindingMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.LocalBinding")
...
LocalBindings.TYPE_ = hydra.core.Name("hydra.haskell.syntax.LocalBindings")
...
class Module:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Module")
    HEAD = hydra.core.Name("head")
...
class ModuleHead:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ModuleHead")
    COMMENTS = hydra.core.Name("comments")
    NAME = hydra.core.Name("name")
...
ModuleName.TYPE_ = hydra.core.Name("hydra.haskell.syntax.ModuleName")
...
class Name(metaclass=_NameMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Name")
...
NamePart.TYPE_ = hydra.core.Name("hydra.haskell.syntax.NamePart")
...
class Operator(metaclass=_OperatorMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Operator")
...
class Pattern(metaclass=_PatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Pattern")
    APPLICATION = hydra.core.Name("application")
    AS = hydra.core.Name("as")
    LIST = hydra.core.Name("list")
    LITERAL = hydra.core.Name("literal")
...
class ApplicationPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ApplicationPattern")
    NAME = hydra.core.Name("name")
...
class AsPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.AsPattern")
    NAME = hydra.core.Name("name")
    INNER = hydra.core.Name("inner")
...
class RecordPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.RecordPattern")
    NAME = hydra.core.Name("name")
    FIELDS = hydra.core.Name("fields")
...
class TypedPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.TypedPattern")
    INNER = hydra.core.Name("inner")
    TYPE = hydra.core.Name("type")
...
class PatternField:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.PatternField")
    NAME = hydra.core.Name("name")
    PATTERN = hydra.core.Name("pattern")
...
class QualifiedName:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.QualifiedName")
...
RightHandSide.TYPE_ = hydra.core.Name("hydra.haskell.syntax.RightHandSide")

class Statement(Node["Expression"]):
    r"""A do-notation statement."""

Statement.TYPE_ = hydra.core.Name("hydra.haskell.syntax.Statement")
...
class Type(metaclass=_TypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.Type")
    APPLICATION = hydra.core.Name("application")
...
class ApplicationType:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ApplicationType")
    CONTEXT = hydra.core.Name("context")
    ARGUMENT = hydra.core.Name("argument")
...
class ContextType:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ContextType")
    CTX = hydra.core.Name("ctx")
    TYPE = hydra.core.Name("type")
...
class FunctionType:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.FunctionType")
...
class InfixType:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.InfixType")
    LHS = hydra.core.Name("lhs")
    OPERATOR = hydra.core.Name("operator")
    RHS = hydra.core.Name("rhs")
...
class TypeDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.TypeDeclaration")
    NAME = hydra.core.Name("name")
    TYPE = hydra.core.Name("type")
...
class TypeSignature:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.TypeSignature")
    NAME = hydra.core.Name("name")
    TYPE = hydra.core.Name("type")
...
class TypedBinding:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.TypedBinding")
    TYPE_SIGNATURE = hydra.core.Name("typeSignature")
    VALUE_BINDING = hydra.core.Name("valueBinding")
...
class ValueBinding(metaclass=_ValueBindingMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.ValueBinding")
    SIMPLE = hydra.core.Name("simple")
...
class SimpleValueBinding:
    ...
    TYPE_ = hydra.core.Name("hydra.haskell.syntax.SimpleValueBinding")
    PATTERN = hydra.core.Name("pattern")
    RHS = hydra.core.Name("rhs")
...
Variable.TYPE_ = hydra.core.Name("hydra.haskell.syntax.Variable")
