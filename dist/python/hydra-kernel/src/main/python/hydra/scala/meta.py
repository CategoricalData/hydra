...
PredefString.TYPE_ = hydra.core.Name("hydra.scala.meta.PredefString")

@dataclass(frozen=True)
class ScalaSymbol:
    name: str

    TYPE_ = hydra.core.Name("hydra.scala.meta.ScalaSymbol")
...
class Tree(metaclass=_TreeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Tree")
...
class Ref(metaclass=_RefMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Ref")
    NAME = hydra.core.Name("name")
...
class Stat(metaclass=_StatMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Stat")
...
class Name(metaclass=_NameMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Name")
...
class Lit(metaclass=_LitMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Lit")
...
class Data(metaclass=_DataMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data")
...
class Data_Ref(metaclass=_Data_RefMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Ref")
...
Data_This.TYPE_ = hydra.core.Name("hydra.scala.meta.Data_This")
...
class Data_Super:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Super")
...
class Data_Name:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Name")
    VALUE = hydra.core.Name("value")

class Data_Anonymous(Node[None]):
    ...

Data_Anonymous.TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Anonymous")
...
class Data_Select:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Select")
...
class Data_Interpolate:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Interpolate")
...
class Data_Xml:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Xml")
    PARTS = hydra.core.Name("parts")
    ARGS = hydra.core.Name("args")
...
class Data_Apply:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Apply")
...
class Data_ApplyUsing:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_ApplyUsing")
    FUN = hydra.core.Name("fun")
...
class Data_ApplyType:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_ApplyType")
...
class Data_ApplyInfix:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_ApplyInfix")
    LHS = hydra.core.Name("lhs")
    OP = hydra.core.Name("op")
    TARGS = hydra.core.Name("targs")
    ARGS = hydra.core.Name("args")
...
class Data_ApplyUnary:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_ApplyUnary")
    OP = hydra.core.Name("op")
...
class Data_Assign:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Assign")
    LHS = hydra.core.Name("lhs")
...
class Data_Return:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Return")
...
class Data_Throw:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Throw")
    EXPR = hydra.core.Name("expr")
...
class Data_Ascribe:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Ascribe")
    EXPR = hydra.core.Name("expr")
...
class Data_Annotate:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Annotate")
    EXPR = hydra.core.Name("expr")
...
class Data_Tuple:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Tuple")
    ARGS = hydra.core.Name("args")
...
class Data_Block:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Block")
...
class Data_EndMarker:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_EndMarker")
    NAME = hydra.core.Name("name")
...
class Data_If:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_If")
...
class Data_QuotedMacroExpr:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_QuotedMacroExpr")
...
class Data_QuotedMacroType:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_QuotedMacroType")
    TPE = hydra.core.Name("tpe")
...
class Data_SplicedMacroExpr:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_SplicedMacroExpr")
    BODY = hydra.core.Name("body")
...
class Data_Match:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Match")
    EXPR = hydra.core.Name("expr")
...
class Data_Try:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Try")
    EXPR = hydra.core.Name("expr")
...
class Data_TryWithHandler:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_TryWithHandler")
    EXPR = hydra.core.Name("expr")
    CATCHP = hydra.core.Name("catchp")
    FINALLYP = hydra.core.Name("finallyp")
...
class Data_FunctionData(metaclass=_Data_FunctionDataMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_FunctionData")
...
class Data_ContextFunction:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_ContextFunction")
...
class Data_Function:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Function")
    PARAMS = hydra.core.Name("params")
    BODY = hydra.core.Name("body")
...
class Data_PolyFunction:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_PolyFunction")
...
class Data_PartialFunction:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_PartialFunction")
    CASES = hydra.core.Name("cases")
...
class Data_While:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_While")
    EXPR = hydra.core.Name("expr")
    BODY = hydra.core.Name("body")
...
class Data_Do:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Do")
    BODY = hydra.core.Name("body")
    EXPR = hydra.core.Name("expr")
...
class Data_For:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_For")
...
class Data_ForYield:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_ForYield")
    ENUMS = hydra.core.Name("enums")
...
class Data_New:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_New")
    INIT = hydra.core.Name("init")
...
class Data_NewAnonymous:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_NewAnonymous")
...
class Data_Eta:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Eta")
    EXPR = hydra.core.Name("expr")
...
class Data_Repeated:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Repeated")
    EXPR = hydra.core.Name("expr")
...
class Data_Param:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Data_Param")
...
class Type(metaclass=_TypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type")
    REF = hydra.core.Name("ref")
...
class Type_Ref(metaclass=_Type_RefMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Ref")
    NAME = hydra.core.Name("name")
    SELECT = hydra.core.Name("select")
...
class Type_Name:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Name")
    VALUE = hydra.core.Name("value")

class Type_AnonymousName(Node[None]):
    ...

Type_AnonymousName.TYPE_ = hydra.core.Name("hydra.scala.meta.Type_AnonymousName")
...
class Type_Select:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Select")
    QUAL = hydra.core.Name("qual")
    NAME = hydra.core.Name("name")
...
class Type_Project:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Project")
    QUAL = hydra.core.Name("qual")
    NAME = hydra.core.Name("name")
...
class Type_Singleton:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Singleton")
    REF = hydra.core.Name("ref")
...
class Type_Apply:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Apply")
    TPE = hydra.core.Name("tpe")
    ARGS = hydra.core.Name("args")
...
class Type_ApplyInfix:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_ApplyInfix")
    LHS = hydra.core.Name("lhs")
    OP = hydra.core.Name("op")
    RHS = hydra.core.Name("rhs")
...
class Type_FunctionType(metaclass=_Type_FunctionTypeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_FunctionType")
    FUNCTION = hydra.core.Name("function")
    CONTEXT_FUNCTION = hydra.core.Name("contextFunction")
...
class Type_Function:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Function")
    PARAMS = hydra.core.Name("params")
...
class Type_PolyFunction:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_PolyFunction")
    TPARAMS = hydra.core.Name("tparams")
    TPE = hydra.core.Name("tpe")
...
class Type_ContextFunction:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_ContextFunction")
    PARAMS = hydra.core.Name("params")
    RES = hydra.core.Name("res")
...
class Type_ImplicitFunction:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_ImplicitFunction")
    PARAMS = hydra.core.Name("params")
    RES = hydra.core.Name("res")
...
class Type_Tuple:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Tuple")
    ARGS = hydra.core.Name("args")
...
class Type_With:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_With")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class Type_And:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_And")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class Type_Or:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Or")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class Type_Refine:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Refine")
    TPE = hydra.core.Name("tpe")
    STATS = hydra.core.Name("stats")
...
class Type_Existential:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Existential")
    TPE = hydra.core.Name("tpe")
    STATS = hydra.core.Name("stats")
...
class Type_Annotate:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Annotate")
    TPE = hydra.core.Name("tpe")
    ANNOTS = hydra.core.Name("annots")
...
class Type_Lambda:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Lambda")
    TPARAMS = hydra.core.Name("tparams")
    TPE = hydra.core.Name("tpe")
...
class Type_Macro:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Macro")
    BODY = hydra.core.Name("body")
...
class Type_Method:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Method")
...
class Type_Placeholder:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Placeholder")
    BOUNDS = hydra.core.Name("bounds")
...
class TypeBounds:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.TypeBounds")
...
class Type_ByName:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_ByName")
    TPE = hydra.core.Name("tpe")
...
class Type_Repeated:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Repeated")
    TPE = hydra.core.Name("tpe")
...
class Type_Var:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Var")
    NAME = hydra.core.Name("name")
...
class Type_TypedParam:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_TypedParam")
    NAME = hydra.core.Name("name")
...
class Type_Param:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Param")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
...
class Type_Match:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Type_Match")
    TPE = hydra.core.Name("tpe")
    CASES = hydra.core.Name("cases")
...
class Pat(metaclass=_PatMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat")
    VAR = hydra.core.Name("var")
...
class Pat_Var:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Var")
    NAME = hydra.core.Name("name")
...
class Pat_Bind:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Bind")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class Pat_Alternative:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Alternative")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class Pat_Tuple:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Tuple")
    ARGS = hydra.core.Name("args")
...
class Pat_Repeated:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Repeated")
    NAME = hydra.core.Name("name")
...
class Pat_Extract:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Extract")
    FUN = hydra.core.Name("fun")
    ARGS = hydra.core.Name("args")
...
class Pat_ExtractInfix:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_ExtractInfix")
    LHS = hydra.core.Name("lhs")
    OP = hydra.core.Name("op")
    RHS = hydra.core.Name("rhs")
...
class Pat_Interpolate:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Interpolate")
    PREFIX = hydra.core.Name("prefix")
    PARTS = hydra.core.Name("parts")
...
class Pat_Xml:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Xml")
    PARTS = hydra.core.Name("parts")
    ARGS = hydra.core.Name("args")
...
class Pat_Typed:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Typed")
    LHS = hydra.core.Name("lhs")
    RHS = hydra.core.Name("rhs")
...
class Pat_Macro:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Macro")
    BODY = hydra.core.Name("body")
...
class Pat_Given:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pat_Given")
    TPE = hydra.core.Name("tpe")
...
class Member(metaclass=_MemberMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Member")
    TERM = hydra.core.Name("term")
    TYPE = hydra.core.Name("type")
...
class Member_Data(metaclass=_Member_DataMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Member_Data")
...
class Member_Type:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Member_Type")
    NAME = hydra.core.Name("name")
...
class Decl(metaclass=_DeclMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Decl")
...
class Decl_Val:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Decl_Val")
    MODS = hydra.core.Name("mods")
...
class Decl_Var:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Decl_Var")
    MODS = hydra.core.Name("mods")
    PATS = hydra.core.Name("pats")
    DECLTPE = hydra.core.Name("decltpe")
...
class Decl_Def:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Decl_Def")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    PARAMSS = hydra.core.Name("paramss")
...
class Decl_Type:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Decl_Type")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    BOUNDS = hydra.core.Name("bounds")
...
class Decl_Given:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Decl_Given")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
...
class Defn(metaclass=_DefnMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn")
    VAL = hydra.core.Name("val")
    VAR = hydra.core.Name("var")
    GIVEN = hydra.core.Name("given")
...
class Defn_Val:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Val")
    MODS = hydra.core.Name("mods")
    PATS = hydra.core.Name("pats")
    DECLTPE = hydra.core.Name("decltpe")
    RHS = hydra.core.Name("rhs")
...
class Defn_Var:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Var")
    MODS = hydra.core.Name("mods")
    PATS = hydra.core.Name("pats")
    DECLTPE = hydra.core.Name("decltpe")
    RHS = hydra.core.Name("rhs")
...
class Defn_Given:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Given")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    SPARAMS = hydra.core.Name("sparams")
...
class Defn_Enum:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Enum")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    CTOR = hydra.core.Name("ctor")
...
class Defn_EnumCase:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_EnumCase")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    CTOR = hydra.core.Name("ctor")
...
class Defn_RepeatedEnumCase:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_RepeatedEnumCase")
    MODS = hydra.core.Name("mods")
    CASES = hydra.core.Name("cases")
...
class Defn_GivenAlias:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_GivenAlias")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    SPARAMS = hydra.core.Name("sparams")
...
class Defn_ExtensionGroup:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_ExtensionGroup")
    TPARAMS = hydra.core.Name("tparams")
...
class Defn_Def:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Def")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    PARAMSS = hydra.core.Name("paramss")
...
class Defn_Macro:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Macro")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    PARAMSS = hydra.core.Name("paramss")
...
class Defn_Type:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Type")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    BODY = hydra.core.Name("body")
...
class Defn_Class:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Class")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    CTOR = hydra.core.Name("ctor")
...
class Defn_Trait:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Trait")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TPARAMS = hydra.core.Name("tparams")
    CTOR = hydra.core.Name("ctor")
...
class Defn_Object:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Defn_Object")
    NAME = hydra.core.Name("name")
...
class Pkg:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pkg")
    NAME = hydra.core.Name("name")
    REF = hydra.core.Name("ref")
    STATS = hydra.core.Name("stats")
...
class Pkg_Object:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Pkg_Object")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    TEMPLATE = hydra.core.Name("template")
...
class Ctor(metaclass=_CtorMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Ctor")
...
class Ctor_Primary:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Ctor_Primary")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    PARAMSS = hydra.core.Name("paramss")
...
class Ctor_Secondary:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Ctor_Secondary")
    MODS = hydra.core.Name("mods")
    NAME = hydra.core.Name("name")
    PARAMSS = hydra.core.Name("paramss")
    INIT = hydra.core.Name("init")
...
class Init:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Init")
    TPE = hydra.core.Name("tpe")
    NAME = hydra.core.Name("name")
...
Self.TYPE_ = hydra.core.Name("hydra.scala.meta.Self")
...
class Template:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Template")
...
class Mod(metaclass=_ModMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Mod")
...
class Mod_Annot:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Mod_Annot")
    INIT = hydra.core.Name("init")
...
class Mod_Private:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Mod_Private")
...
class Mod_Protected:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Mod_Protected")
    WITHIN = hydra.core.Name("within")
...
class Enumerator(metaclass=_EnumeratorMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Enumerator")
...
class Enumerator_Generator:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Enumerator_Generator")
    PAT = hydra.core.Name("pat")
    RHS = hydra.core.Name("rhs")
...
class Enumerator_CaseGenerator:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Enumerator_CaseGenerator")
    PAT = hydra.core.Name("pat")
    RHS = hydra.core.Name("rhs")
...
class Enumerator_Val:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Enumerator_Val")
    PAT = hydra.core.Name("pat")
    RHS = hydra.core.Name("rhs")
...
class Enumerator_Guard:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Enumerator_Guard")
    COND = hydra.core.Name("cond")
...
class ImportExportStat(metaclass=_ImportExportStatMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.ImportExportStat")
...
class Import:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Import")
...
class Export:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Export")
    IMPORTERS = hydra.core.Name("importers")
...
class Importer:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Importer")
    REF = hydra.core.Name("ref")
...
class Importee(metaclass=_ImporteeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Importee")
    WILDCARD = hydra.core.Name("wildcard")
    GIVEN = hydra.core.Name("given")
...
class Importee_Given:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Importee_Given")
    TPE = hydra.core.Name("tpe")
...
class Importee_Name:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Importee_Name")
    NAME = hydra.core.Name("name")
...
class Importee_Rename:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Importee_Rename")
    NAME = hydra.core.Name("name")
    RENAME = hydra.core.Name("rename")
...
class Importee_Unimport:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Importee_Unimport")
    NAME = hydra.core.Name("name")
...
class CaseTree(metaclass=_CaseTreeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.CaseTree")
    CASE = hydra.core.Name("case")
...
class Case:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Case")
    PAT = hydra.core.Name("pat")
    COND = hydra.core.Name("cond")
    BODY = hydra.core.Name("body")
...
class TypeCase:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.TypeCase")
    PAT = hydra.core.Name("pat")
    BODY = hydra.core.Name("body")
...
class Source:
    ...
    TYPE_ = hydra.core.Name("hydra.scala.meta.Source")
    STATS = hydra.core.Name("stats")

class Quasi(Node[None]):
    ...

Quasi.TYPE_ = hydra.core.Name("hydra.scala.meta.Quasi")
