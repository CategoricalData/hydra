...
def test_element_arthur() -> hydra.core.Binding:
    return hydra.core.Binding(hydra.core.Name("firstName"), test_data_arthur, Just(hydra.core.TypeScheme((), cast(hydra.core.Type, hydra.core.TypeVariable(hydra.test.test_types.test_type_person_name)), Nothing())))

@lru_cache(1)
def test_element_first_name() -> hydra.core.Binding:
    return hydra.core.Binding(hydra.core.Name("firstName"), cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(hydra.test.test_types.test_type_person_name, hydra.core.Name("firstName")))), Just(hydra.core.TypeScheme((), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(cast(hydra.core.Type, hydra.core.TypeVariable(hydra.test.test_types.test_type_person_name)), cast(hydra.core.Type, hydra.core.TypeLiteral(cast(hydra.core.LiteralType, hydra.core.LiteralTypeString())))))), Nothing())))
