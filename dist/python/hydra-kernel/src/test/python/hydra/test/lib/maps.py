...
def all_tests() -> hydra.testing.TestGroup:
    ...
    return hydra.testing.TestGroup("hydra.lib.maps primitives", Nothing(), (hydra.testing.TestGroup("alter", Nothing(), (), (hydra.testing.TestCaseWithMetadata("insert new key", cast(hydra.testing.TestCase, hydra.testing.TestCaseUniversal(hydra.testing.UniversalTestCase(hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), hydra.lib.maps.alter((lambda _: Just("new")), 3, FrozenDict({
      ...
      1: "a",
      2: "b",
      3: "c"}))), hydra.show.core.list((lambda s: hydra.lib.literals.show_string(s)), ("a", "b", "c"))))), Nothing(), ()), hydra.testing.TestCaseWithMetadata("empty map", cast(hydra.testing.TestCase, hydra.testing.TestCaseUniversal(hydra.testing.UniversalTestCase(hydra.show.core.list((lambda s: hydra.lib.literals.show_string(s)), hydra.lib.maps.elems(FrozenDict({}))), hydra.show.core.list((lambda s: hydra.lib.literals.show_string(s)), ())))), Nothing(), ()))), hydra.testing.TestGroup("empty", Nothing(), (), (hydra.testing.TestCaseWithMetadata("empty map", cast(hydra.testing.TestCase, hydra.testing.TestCaseUniversal(hydra.testing.UniversalTestCase(hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), hydra.lib.maps.empty()), hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), FrozenDict({}))))), Nothing(), ()),)), hydra.testing.TestGroup("filter", Nothing(), (), (hydra.testing.TestCaseWithMetadata("filter values starting with a", cast(hydra.testing.TestCase, hydra.testing.TestCaseUniversal(hydra.testing.UniversalTestCase(hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), hydra.lib.maps.filter((lambda v: hydra.lib.equality.equal(hydra.lib.maybes.from_maybe((lambda : 0), hydra.lib.maybes.map((lambda c: hydra.lib.chars.to_lower(c)), hydra.lib.strings.maybe_char_at(0, v))), 97)), FrozenDict({
      1: "a",
      2: "b",
      3: "ab"}))), hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), FrozenDict({
      1: "a",
      3: "ab"}))))), Nothing(), ()), hydra.testing.TestCaseWithMetadata("filter all", cast(hydra.testing.TestCase, hydra.testing.TestCaseUniversal(hydra.testing.UniversalTestCase(hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), hydra.lib.maps.filter((lambda v: hydra.lib.equality.equal(hydra.lib.maybes.from_maybe((lambda : 0), hydra.lib.maybes.map((lambda c: hydra.lib.chars.to_lower(c)), hydra.lib.strings.maybe_char_at(0, v))), 97)), FrozenDict({
      1: "b",
      2: "c"}))), hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), FrozenDict({}))))), Nothing(), ()), hydra.testing.TestCaseWithMetadata("empty map", cast(hydra.testing.TestCase, hydra.testing.TestCaseUniversal(hydra.testing.UniversalTestCase(hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), hydra.lib.maps.filter((lambda v: hydra.lib.equality.equal(hydra.lib.maybes.from_maybe((lambda : 0), hydra.lib.maybes.map((lambda c: hydra.lib.chars.to_lower(c)), hydra.lib.strings.maybe_char_at(0, v))), 97)), FrozenDict({}))), hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), FrozenDict({}))))), Nothing(), ()))), hydra.testing.TestGroup("filterWithKey", Nothing(), (), (hydra.testing.TestCaseWithMetadata("filter by key > 1", cast(hydra.testing.TestCase, hydra.testing.TestCaseUniversal(hydra.testing.UniversalTestCase(hydra.show.core.map((lambda n: hydra.lib.literals.show_int32(n)), (lambda s: hydra.lib.literals.show_string(s)), hydra.lib.maps.filter_with_key((lambda k, v: hydra.lib.equality.gt(k, 1)), FrozenDict({
      1: "a",
      2: "b",
