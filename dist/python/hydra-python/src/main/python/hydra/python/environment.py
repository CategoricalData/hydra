...
PythonVersion.TYPE_ = hydra.core.Name("hydra.python.environment.PythonVersion")

@dataclass(frozen=True)
class PythonEnvironment:
    r"""Environment for Python code generation."""

    namespaces: Annotated[hydra.packaging.Namespaces[hydra.python.syntax.DottedName], "Namespace mapping for imports"]
    bound_type_variables: Annotated[tuple[frozenlist[hydra.core.Name], FrozenDict[hydra.core.Name, hydra.python.syntax.Name]], "Type variables in scope, with their Python names"]
...
class PythonModuleMetadata:
    ...
    TYPE_ = hydra.core.Name("hydra.python.environment.PythonModuleMetadata")
    NAMESPACES = hydra.core.Name("namespaces")
...
class PyGraph:
    ...
    TYPE_ = hydra.core.Name("hydra.python.environment.PyGraph")
    GRAPH = hydra.core.Name("graph")
