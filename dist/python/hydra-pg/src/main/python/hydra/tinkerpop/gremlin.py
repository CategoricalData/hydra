...
QueryList.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.QueryList")
...
class Query(metaclass=_QueryMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.Query")
...
class TraversalSourceQuery:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSourceQuery")
...
class RootTraversalQuery:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.RootTraversalQuery")
...
TraversalSource.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSource")
...
TransactionPart.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TransactionPart")
...
class RootTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.RootTraversal")
    SOURCE = hydra.core.Name("source")
...
class TraversalSourceSelfMethod(metaclass=_TraversalSourceSelfMethodMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSourceSelfMethod")
...
class GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument")
...
class StringArgumentAndGenericLiteralArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringArgumentAndGenericLiteralArgument")
...
class StringArgumentAndOptionalGenericLiteralArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringArgumentAndOptionalGenericLiteralArgument")
    STRING = hydra.core.Name("string")
    LITERAL = hydra.core.Name("literal")
...
class TraversalSourceSpawnMethod(metaclass=_TraversalSourceSpawnMethodMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSourceSpawnMethod")
...
class GenericLiteralMapNullableArgumentOrNestedTraversal(metaclass=_GenericLiteralMapNullableArgumentOrNestedTraversalMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal")
...
class ServiceCall:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ServiceCall")
...
class ServiceArguments(metaclass=_ServiceArgumentsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ServiceArguments")
    MAP = hydra.core.Name("map")
    TRAVERSAL = hydra.core.Name("traversal")
...
class ChainedTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ChainedTraversal")
...
class ChainedTraversalElement(metaclass=_ChainedTraversalElementMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ChainedTraversalElement")
...
class NestedTraversal(metaclass=_NestedTraversalMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.NestedTraversal")
    ROOT = hydra.core.Name("root")
    CHAINED = hydra.core.Name("chained")
...
class TerminatedTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TerminatedTraversal")
    ROOT = hydra.core.Name("root")
...
class TraversalMethod(metaclass=_TraversalMethodMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalMethod")
    V = hydra.core.Name("v")
    E = hydra.core.Name("e")
    ADD_E = hydra.core.Name("addE")
    ADD_V = hydra.core.Name("addV")
...
class StringArgumentOrNestedTraversal(metaclass=_StringArgumentOrNestedTraversalMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringArgumentOrNestedTraversal")
    STRING = hydra.core.Name("string")
    TRAVERSAL = hydra.core.Name("traversal")
...
class OptionalTraversalScopeArgumentAndStringArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndStringArgument")
...
class StringArgumentAndOptionalStringLiteralVarargs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringArgumentAndOptionalStringLiteralVarargs")
    FIRST = hydra.core.Name("first")
    REST = hydra.core.Name("rest")
...
class TraversalSackMethodArgumentOrIntegerArgument(metaclass=_TraversalSackMethodArgumentOrIntegerArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSackMethodArgumentOrIntegerArgument")
...
class ByArgs(metaclass=_ByArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ByArgs")
    ORDER = hydra.core.Name("order")
...
class ByOtherArgs(metaclass=_ByOtherArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ByOtherArgs")
...
class TraversalFunctionArgumentOrStringArgumentOrNestedTraversal(metaclass=_TraversalFunctionArgumentOrStringArgumentOrNestedTraversalMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalFunctionArgumentOrStringArgumentOrNestedTraversal")
...
class ChooseArgs(metaclass=_ChooseArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ChooseArgs")
    FUNCTION = hydra.core.Name("function")
...
class PredicateTraversalArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.PredicateTraversalArgument")
...
class NestedTraversalArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.NestedTraversalArgument")
    TRAVERSAL1 = hydra.core.Name("traversal1")
    TRAVERSAL2 = hydra.core.Name("traversal2")
...
class DedupArgs(metaclass=_DedupArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.DedupArgs")
...
class ScopeStringArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ScopeStringArgument")
    SCOPE = hydra.core.Name("scope")
...
class PredicateOrTraversal(metaclass=_PredicateOrTraversalMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.PredicateOrTraversal")
    PREDICATE = hydra.core.Name("predicate")
    TRAVERSAL = hydra.core.Name("traversal")
...
class GenericLiteralArgumentAndTraversalBiFunctionArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalBiFunctionArgument")
    LITERAL = hydra.core.Name("literal")
    BI_FUNCTION = hydra.core.Name("biFunction")
...
class FromArgs(metaclass=_FromArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.FromArgs")
    STRING = hydra.core.Name("string")
...
class HasArgs(metaclass=_HasArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.HasArgs")
    STRING = hydra.core.Name("string")
...
class HasStringArgumentAndOptionalStringLiteralVarargs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargs")
    STRING = hydra.core.Name("string")
    REST = hydra.core.Name("rest")
...
class HasStringArgumentAndOptionalStringLiteralVarargsRest(metaclass=_HasStringArgumentAndOptionalStringLiteralVarargsRestMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest")
...
class StringNullableArgumentAndGenericLiteralArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument")
    STRING = hydra.core.Name("string")
    LITERAL = hydra.core.Name("literal")
...
class StringNullableArgumentAndTraversalPredicate:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate")
    STRING = hydra.core.Name("string")
    PREDICATE = hydra.core.Name("predicate")
...
class HasTraversalTokenArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.HasTraversalTokenArgs")
    TRAVERSAL_TOKEN = hydra.core.Name("traversalToken")
    REST = hydra.core.Name("rest")
...
class HasTraversalTokenArgsRest(metaclass=_HasTraversalTokenArgsRestMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.HasTraversalTokenArgsRest")
    LITERAL = hydra.core.Name("literal")
    PREDICATE = hydra.core.Name("predicate")
    TRAVERSAL = hydra.core.Name("traversal")
...
class GenericLiteralArgumentAndTraversalPredicate(metaclass=_GenericLiteralArgumentAndTraversalPredicateMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalPredicate")
    LITERAL = hydra.core.Name("literal")
    PREDICATE = hydra.core.Name("predicate")
...
class TraversalPredicateOrStringLiteralVarargs(metaclass=_TraversalPredicateOrStringLiteralVarargsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPredicateOrStringLiteralVarargs")
    PREDICATE = hydra.core.Name("predicate")
    STRING = hydra.core.Name("string")
...
class TraversalPredicateOrGenericLiteralArgument(metaclass=_TraversalPredicateOrGenericLiteralArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument")
    PREDICATE = hydra.core.Name("predicate")
    LITERAL = hydra.core.Name("literal")
...
class OptionArgs(metaclass=_OptionArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.OptionArgs")
    PREDICATE_TRAVERSAL = hydra.core.Name("predicateTraversal")
...
class TraversalPredicateAndNestedTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal")
    PREDICATE = hydra.core.Name("predicate")
    TRAVERSAL = hydra.core.Name("traversal")
...
class TraversalMergeArgumentAndGenericLiteralMapNullableArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument")
    MERGE = hydra.core.Name("merge")
    MAP = hydra.core.Name("map")
...
class TraversalMergeArgumentAndNestedTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal")
    MERGE = hydra.core.Name("merge")
    TRAVERSAL = hydra.core.Name("traversal")
...
class GenericLiteralArgumentAndNestedTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal")
    OBJECT = hydra.core.Name("object")
    TRAVERSAL = hydra.core.Name("traversal")
...
class PropertyArgs(metaclass=_PropertyArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.PropertyArgs")
...
class TraversalCardinalityArgumentAndObjects:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalCardinalityArgumentAndObjects")
    CARDINALITY = hydra.core.Name("cardinality")
    OBJECTS = hydra.core.Name("objects")
...
class GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument")
    CARDINALITY = hydra.core.Name("cardinality")
    OBJECT = hydra.core.Name("object")
...
class RangeArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.RangeArgs")
    SCOPE = hydra.core.Name("scope")
    MIN = hydra.core.Name("min")
    MAX = hydra.core.Name("max")
...
class OptionalStringArgumentAndNestedTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.OptionalStringArgumentAndNestedTraversal")
    STRING = hydra.core.Name("string")
    TRAVERSAL = hydra.core.Name("traversal")
...
class OptionalTraversalScopeArgumentAndIntegerArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndIntegerArgument")
    SCOPE = hydra.core.Name("scope")
...
class SelectArgs(metaclass=_SelectArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.SelectArgs")
...
class PopStringsArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.PopStringsArgument")
...
class TraversalPopArgumentAndNestedTraversal:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPopArgumentAndNestedTraversal")
    POP = hydra.core.Name("pop")
    TRAVERSAL = hydra.core.Name("traversal")
...
class TailArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TailArgs")
    SCOPE = hydra.core.Name("scope")
...
class ToArgs(metaclass=_ToArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ToArgs")
...
class DirectionAndVarargs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.DirectionAndVarargs")
    DIRECTION = hydra.core.Name("direction")
...
class ValueMapArgs(metaclass=_ValueMapArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ValueMapArgs")
    STRING = hydra.core.Name("string")
...
class ValueMapBooleanArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ValueMapBooleanArgs")
    VALUE = hydra.core.Name("value")
...
class WhereArgs(metaclass=_WhereArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.WhereArgs")
    PREDICATE = hydra.core.Name("predicate")
    STRING = hydra.core.Name("string")
    TRAVERSAL = hydra.core.Name("traversal")
...
class WhereWithPredicateArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.WhereWithPredicateArgs")
...
class WithArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.WithArgs")
    KEYS = hydra.core.Name("keys")
    VALUES = hydra.core.Name("values")
...
class WithArgsKeys(metaclass=_WithArgsKeysMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.WithArgsKeys")
...
class WithArgsValues(metaclass=_WithArgsValuesMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.WithArgsValues")
...
class ConcatArgs(metaclass=_ConcatArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ConcatArgs")
    TRAVERSAL = hydra.core.Name("traversal")
    STRING = hydra.core.Name("string")
...
class ReplaceArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ReplaceArgs")
    SCOPE = hydra.core.Name("scope")
    FROM = hydra.core.Name("from")
    TO = hydra.core.Name("to")
...
class SplitArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.SplitArgs")
    SCOPE = hydra.core.Name("scope")
...
class SubstringArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.SubstringArgs")
    SCOPE = hydra.core.Name("scope")
...
class DateAddArgs:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.DateAddArgs")
...
class DateDiffArgs(metaclass=_DateDiffArgsMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.DateDiffArgs")
    TRAVERSAL = hydra.core.Name("traversal")
...
class StructureVertex:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StructureVertex")
...
class TraversalStrategy:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalStrategy")
    NEW = hydra.core.Name("new")
...
class Configuration:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.Configuration")
    KEY = hydra.core.Name("key")
    VALUE = hydra.core.Name("value")
...
class KeywordOrIdentifier(metaclass=_KeywordOrIdentifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.KeywordOrIdentifier")
...
TraversalScope.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalScope")
...
TraversalToken.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalToken")
...
TraversalMerge.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalMerge")
...
TraversalOrder.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalOrder")
...
TraversalDirection.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalDirection")
...
class TraversalCardinality(metaclass=_TraversalCardinalityMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalCardinality")
...
TraversalColumn.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalColumn")
...
TraversalPop.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPop")
...
TraversalOperator.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalOperator")
...
TraversalPick.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPick")
...
TraversalDT.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalDT")
...
class TraversalPredicate(metaclass=_TraversalPredicateMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPredicate")
...
class TwoTraversalPredicates:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TwoTraversalPredicates")
...
class TraversalTerminalMethod(metaclass=_TraversalTerminalMethodMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalTerminalMethod")
...
TraversalSelfMethod.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSelfMethod")
...
class TraversalFunction(metaclass=_TraversalFunctionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalFunction")
    TOKEN = hydra.core.Name("token")
    COLUMN = hydra.core.Name("column")
...
class RangeArgument:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.RangeArgument")
    MIN = hydra.core.Name("min")
    MAX = hydra.core.Name("max")
...
class WithOptionKeys(metaclass=_WithOptionKeysMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.WithOptionKeys")
    SHORTEST_PATH = hydra.core.Name("shortestPath")
    CONNECTED_COMPONENT = hydra.core.Name("connectedComponent")
    PAGE_RANK = hydra.core.Name("pageRank")
    PEER_PRESSURE = hydra.core.Name("peerPressure")
...
ConnectedComponentConstants.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ConnectedComponentConstants")
...
PageRankConstants.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.PageRankConstants")
...
PeerPressureConstants.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.PeerPressureConstants")
...
ShortestPathConstants.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.ShortestPathConstants")
...
WithOptionsValues.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.WithOptionsValues")
...
IoOptionsKeys.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.IoOptionsKeys")
...
IoOptionsValues.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.IoOptionsValues")
...
class BooleanArgument(metaclass=_BooleanArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.BooleanArgument")
    VALUE = hydra.core.Name("value")
...
class IntegerArgument(metaclass=_IntegerArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.IntegerArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class FloatArgument(metaclass=_FloatArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.FloatArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class StringArgument(metaclass=_StringArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class StringNullableArgument(metaclass=_StringNullableArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringNullableArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class DateArgument(metaclass=_DateArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.DateArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class GenericLiteralArgument(metaclass=_GenericLiteralArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class GenericLiteralListArgument(metaclass=_GenericLiteralListArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralListArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class GenericLiteralMapArgument(metaclass=_GenericLiteralMapArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralMapArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class GenericLiteralMapNullableArgument(metaclass=_GenericLiteralMapNullableArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralMapNullableArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class StructureVertexArgument(metaclass=_StructureVertexArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StructureVertexArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalCardinalityArgument(metaclass=_TraversalCardinalityArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalCardinalityArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalColumnArgument(metaclass=_TraversalColumnArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalColumnArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalDirectionArgument(metaclass=_TraversalDirectionArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalDirectionArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalMergeArgument(metaclass=_TraversalMergeArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalMergeArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalOrderArgument(metaclass=_TraversalOrderArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalOrderArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalPopArgument(metaclass=_TraversalPopArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalPopArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalSackMethodArgument(metaclass=_TraversalSackMethodArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalSackMethodArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalScopeArgument(metaclass=_TraversalScopeArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalScopeArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalTokenArgument(metaclass=_TraversalTokenArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalTokenArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalComparatorArgument(metaclass=_TraversalComparatorArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalComparatorArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalFunctionArgument(metaclass=_TraversalFunctionArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalFunctionArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalBiFunctionArgument(metaclass=_TraversalBiFunctionArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalBiFunctionArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
class TraversalDTArgument(metaclass=_TraversalDTArgumentMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.TraversalDTArgument")
    VALUE = hydra.core.Name("value")
    VARIABLE = hydra.core.Name("variable")
...
GenericLiteralList.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralList")
...
class GenericLiteralRange(metaclass=_GenericLiteralRangeMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralRange")
    INTEGER = hydra.core.Name("integer")
    STRING = hydra.core.Name("string")
...
class IntegerRange:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.IntegerRange")
    LEFT = hydra.core.Name("left")
    RIGHT = hydra.core.Name("right")
...
class StringRange:
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.StringRange")
    LEFT = hydra.core.Name("left")
    RIGHT = hydra.core.Name("right")
...
GenericLiteralSet.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralSet")

class GenericLiteralCollection(Node["frozenlist[GenericLiteral]"]):
    ...

GenericLiteralCollection.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralCollection")
...
class GenericLiteral(metaclass=_GenericLiteralMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteral")
...
GenericLiteralMap.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.GenericLiteralMap")
...
class MapEntry(metaclass=_MapEntryMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.MapEntry")
    KEY = hydra.core.Name("key")
    VALUE = hydra.core.Name("value")
...
class MapKey(metaclass=_MapKeyMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.MapKey")
    STRING = hydra.core.Name("string")
    NUMERIC = hydra.core.Name("numeric")
    TRAVERSAL_TOKEN = hydra.core.Name("traversalToken")
    TRAVERSAL_DIRECTION = hydra.core.Name("traversalDirection")
...
IntegerLiteral.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.IntegerLiteral")

class FloatLiteral(Node[Decimal]):
    ...

FloatLiteral.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.FloatLiteral")
...
class NumericLiteral(metaclass=_NumericLiteralMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.NumericLiteral")
    INTEGER = hydra.core.Name("integer")
...
DateLiteral.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.DateLiteral")
...
Keyword.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.Keyword")

class Identifier(Node[str]):
    ...

Identifier.TYPE_ = hydra.core.Name("hydra.tinkerpop.gremlin.Identifier")
