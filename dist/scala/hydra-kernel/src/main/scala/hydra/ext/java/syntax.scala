...
enum Primary :
   case noNewArray(value: hydra.ext.java.syntax.PrimaryNoNewArrayExpression) extends Primary
   case arrayCreation(value: hydra.ext.java.syntax.ArrayCreationExpression) extends Primary

enum PrimaryNoNewArrayExpression :
   case literal(value: hydra.ext.java.syntax.Literal) extends PrimaryNoNewArrayExpression
   case classLiteral(value: hydra.ext.java.syntax.ClassLiteral) extends PrimaryNoNewArrayExpression
   case `this` extends PrimaryNoNewArrayExpression
   case dotThis(value: hydra.ext.java.syntax.TypeName) extends PrimaryNoNewArrayExpression
   case parens(value: hydra.ext.java.syntax.Expression) extends PrimaryNoNewArrayExpression
   case classInstance(value: hydra.ext.java.syntax.ClassInstanceCreationExpression) extends PrimaryNoNewArrayExpression
   case fieldAccess(value: hydra.ext.java.syntax.FieldAccess) extends PrimaryNoNewArrayExpression
   case arrayAccess(value: hydra.ext.java.syntax.ArrayAccess) extends PrimaryNoNewArrayExpression
   case methodInvocation(value: hydra.ext.java.syntax.MethodInvocation) extends PrimaryNoNewArrayExpression
   case methodReference(value: hydra.ext.java.syntax.MethodReference) extends PrimaryNoNewArrayExpression
...
enum ArrayAccess_Variant :
   ...
   case primary(value: hydra.ext.java.syntax.PrimaryNoNewArrayExpression) extends ArrayAccess_Variant
