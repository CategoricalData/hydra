...
def generatePythonTestGroupHierarchy[T0](groupPath: Seq[scala.Predef.String])(testGroup: hydra.testing.TestGroup): Either[T0,
  ...
  hydra.lib.eithers.bind[T0, Seq[Seq[scala.Predef.String]], scala.Predef.String](hydra.lib.eithers.mapList[hydra.testing.TestCaseWithMetadata,
     Seq[scala.Predef.String], T0]((tc: hydra.testing.TestCaseWithMetadata) => hydra.python.testing.generatePythonTestCase(groupPath)(tc))(`cases_`))((testCaseLines: Seq[Seq[scala.Predef.String]]) =>
    ...
    hydra.lib.eithers.map[scala.Predef.String, scala.Predef.String, T0]((content: scala.Predef.String) => hydra.lib.strings.cat(Seq(header,
       "\n\n", content)))(hydra.python.testing.generatePythonTestGroupHierarchy(hydra.lib.lists.concat2[scala.Predef.String](groupPath)(Seq(groupName)))(subgroup))
