...
def eliminationVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.inject(v_Term_inject_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.EliminationVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.variants.EliminationVariant],
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.EliminationVariant]](Left(hydra.lib.strings.cat(Seq("no such field ",
       ...
       hydra.variants.EliminationVariant])) => f(fterm))(hydra.lib.maps.lookup[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.EliminationVariant]](fname)(variantMap))
  }
  case _ => Left("expected union"))(hydra.extract.core.stripWithDecodingError(cx)(raw))

def functionVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.inject(v_Term_inject_inj) => {
    ...
    lazy val fterm: hydra.core.Term = (field.term)
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.FunctionVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.variants.FunctionVariant],
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.FunctionVariant]](Left(hydra.lib.strings.cat(Seq("no such field ",
       ...
       fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.FunctionVariant])) => f(fterm))(hydra.lib.maps.lookup[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.FunctionVariant]](fname)(variantMap))
  }
  case _ => Left("expected union"))(hydra.extract.core.stripWithDecodingError(cx)(raw))

def literalVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.inject(v_Term_inject_inj) => {
    ...
    lazy val fterm: hydra.core.Term = (field.term)
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.LiteralVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.variants.LiteralVariant],
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.LiteralVariant]](Left(hydra.lib.strings.cat(Seq("no such field ",
       ...
       fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.LiteralVariant])) => f(fterm))(hydra.lib.maps.lookup[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.LiteralVariant]](fname)(variantMap))
  }
  case _ => Left("expected union"))(hydra.extract.core.stripWithDecodingError(cx)(raw))

def termVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.inject(v_Term_inject_inj) => {
    ...
    lazy val fterm: hydra.core.Term = (field.term)
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.TermVariant])] = hydra.lib.maps.fromList[hydra.core.Name, (hydra.core.Term) => Either[hydra.errors.DecodingError,
       ...
       hydra.variants.TermVariant]](Seq(Tuple2("annotated", (input: hydra.core.Term) =>
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.variants.TermVariant],
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.TermVariant]](Left(hydra.lib.strings.cat(Seq("no such field ",
       ...
       fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.TermVariant])) => f(fterm))(hydra.lib.maps.lookup[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.TermVariant]](fname)(variantMap))
  }
  case _ => Left("expected union"))(hydra.extract.core.stripWithDecodingError(cx)(raw))

def typeVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.inject(v_Term_inject_inj) => {
    ...
    lazy val fterm: hydra.core.Term = (field.term)
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.TypeVariant])] = hydra.lib.maps.fromList[hydra.core.Name, (hydra.core.Term) => Either[hydra.errors.DecodingError,
       ...
       hydra.variants.TypeVariant]](Seq(Tuple2("annotated", (input: hydra.core.Term) =>
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.variants.TypeVariant],
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.variants.TypeVariant]](Left(hydra.lib.strings.cat(Seq("no such field ",
       ...
       fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError,
       hydra.variants.TypeVariant])) => f(fterm))(hydra.lib.maps.lookup[hydra.core.Name,
