...
def columnType(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
   hydra.tabular.ColumnType] =
...
def dataRow[T0](v: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError,
  ...
  stripped match
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[Seq[Option[T0]],
     hydra.tabular.DataRow[T0], hydra.errors.DecodingError]((b: Seq[Option[T0]]) => b)(hydra.extract.core.decodeList((v1: hydra.graph.Graph) =>
...
def headerRow(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
   hydra.tabular.HeaderRow] =
  hydra.lib.eithers.either[hydra.errors.DecodingError, hydra.core.Term, Either[hydra.errors.DecodingError,
...
def table[T0](v: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError,
   T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    lazy val fieldMap: Map[hydra.core.Name, hydra.core.Term] = hydra.extract.core.toFieldMap(v_Term_record_record)
    hydra.lib.eithers.bind[hydra.errors.DecodingError, Option[hydra.tabular.HeaderRow],
       hydra.tabular.Table[T0]](hydra.extract.core.requireField("header")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
      ...
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.tabular.DataRow[T0]],
         hydra.tabular.Table[T0]](hydra.extract.core.requireField("data")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
...
def tableType(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
   hydra.tabular.TableType] =
  hydra.lib.eithers.either[hydra.errors.DecodingError, hydra.core.Term, Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.relational.RelationName,
       hydra.tabular.TableType](hydra.extract.core.requireField("name")(hydra.decode.relational.relationName)(fieldMap)(cx))((field_name: hydra.relational.RelationName) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.tabular.ColumnType],
