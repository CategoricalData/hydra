...
def testCase(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.testing.TestCase] =
  ...
  case hydra.core.Term.inject(v_Term_inject_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.testing.TestCase])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.testing.TestCase]](Seq(Tuple2("universal",
...
def testCaseWithMetadata(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.testing.TestCaseWithMetadata] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, scala.Predef.String, hydra.testing.TestCaseWithMetadata](hydra.extract.core.requireField("name")((cx2: hydra.graph.Graph) =>
      ...
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Option[scala.Predef.String], hydra.testing.TestCaseWithMetadata](hydra.extract.core.requireField("description")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, scala.Predef.String, hydra.testing.TestGroup](hydra.extract.core.requireField("name")((cx2: hydra.graph.Graph) =>
      ...
      case hydra.core.Term.literal(v_Term_literal_v) => v_Term_literal_v match
        ...
        case _ => Left("expected string literal")
      case _ => Left("expected literal"))(hydra.extract.core.stripWithDecodingError(cx2)(raw2)))(fieldMap)(cx))((field_name: scala.Predef.String) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Option[scala.Predef.String], hydra.testing.TestGroup](hydra.extract.core.requireField("description")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
      hydra.extract.core.decodeMaybe((cx2: hydra.graph.Graph) =>
      (raw2: hydra.core.Term) =>
      hydra.lib.eithers.either[hydra.errors.DecodingError, hydra.core.Term, Either[hydra.errors.DecodingError,
      ...
      case hydra.core.Term.literal(v_Term_literal_v) => v_Term_literal_v match
        ...
        case _ => Left("expected string literal")
      case _ => Left("expected literal"))(hydra.extract.core.stripWithDecodingError(cx2)(raw2)))(v1)(v2))(fieldMap)(cx))((field_description: Option[scala.Predef.String]) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.testing.TestGroup], hydra.testing.TestGroup](hydra.extract.core.requireField("subgroups")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
      ...
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.testing.TestCaseWithMetadata], hydra.testing.TestGroup](hydra.extract.core.requireField("cases")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
