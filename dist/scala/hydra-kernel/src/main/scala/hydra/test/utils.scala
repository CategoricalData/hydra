...
def inferTerm(g: hydra.graph.Graph)(term: hydra.core.Term): Either[scala.Predef.String, hydra.core.Term] =
  hydra.lib.eithers.bimap[hydra.errors.Error, hydra.typing.InferenceResult, scala.Predef.String,
     hydra.core.Term]((e: hydra.errors.Error) => hydra.show.errors.error(e))((x: hydra.typing.InferenceResult) => (x.term))(hydra.inference.inferInGraphContext(hydra.lexical.emptyContext)(g)(term))

def inferTestCase[T0, T1](g: T0)(tcm: hydra.testing.TestCaseWithMetadata): Either[T1,
  ...
  hydra.lib.eithers.map[hydra.testing.TestCase, hydra.testing.TestCaseWithMetadata,
     T1]((inferredCase: hydra.testing.TestCase) =>
