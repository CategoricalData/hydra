...
def module(x: hydra.packaging.Module): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.packaging.Module", Seq(hydra.core.Field("namespace",
     hydra.encode.packaging.namespace(x.namespace)), hydra.core.Field("definitions",
     hydra.core.Term.list(hydra.lib.lists.map[hydra.packaging.Definition, hydra.core.Term](hydra.encode.packaging.definition)(x.definitions))),
     hydra.core.Field("termDependencies", hydra.core.Term.list(hydra.lib.lists.map[hydra.packaging.Namespace,
     hydra.core.Term](hydra.encode.packaging.namespace)(x.termDependencies))), hydra.core.Field("typeDependencies",
     hydra.core.Term.list(hydra.lib.lists.map[hydra.packaging.Namespace, hydra.core.Term](hydra.encode.packaging.namespace)(x.typeDependencies))),
     hydra.core.Field("description", hydra.core.Term.maybe(hydra.lib.maybes.map[scala.Predef.String,
...
def namespaces[T0](n: (T0 => hydra.core.Term))(x: hydra.packaging.Namespaces[T0]): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.packaging.Namespaces", Seq(hydra.core.Field("focus",
     hydra.core.Term.pair(hydra.lib.pairs.bimap[hydra.packaging.Namespace, T0, hydra.core.Term,
     hydra.core.Term](hydra.encode.packaging.namespace)(n)(x.focus))), hydra.core.Field("mapping",
     hydra.core.Term.map(hydra.lib.maps.bimap[hydra.packaging.Namespace, hydra.core.Term,
     T0, hydra.core.Term](hydra.encode.packaging.namespace)(n)(x.mapping))))))

def `package`(x: hydra.packaging.Package): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.packaging.Package", Seq(hydra.core.Field("name",
     hydra.encode.packaging.packageName(x.name)), hydra.core.Field("modules", hydra.core.Term.list(hydra.lib.lists.map[hydra.packaging.Module,
     hydra.core.Term](hydra.encode.packaging.module)(x.modules))), hydra.core.Field("dependencies",
     hydra.core.Term.list(hydra.lib.lists.map[hydra.packaging.PackageName, hydra.core.Term](hydra.encode.packaging.packageName)(x.dependencies))),
     hydra.core.Field("description", hydra.core.Term.maybe(hydra.lib.maybes.map[scala.Predef.String,
     hydra.core.Term]((x2: scala.Predef.String) => hydra.core.Term.literal(hydra.core.Literal.string(x2)))(x.description))))))
