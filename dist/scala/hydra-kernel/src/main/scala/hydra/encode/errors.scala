...
def error(v1: hydra.errors.Error): hydra.core.Term =
  ...
  case hydra.errors.Error.extraction(v_Error_extraction_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.Error",
     hydra.core.Field("extraction", hydra.encode.errors.extractionError(v_Error_extraction_y))))
  case hydra.errors.Error.inference(v_Error_inference_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.Error",
  ...
  case hydra.errors.Error.resolution(v_Error_resolution_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.Error",
  ...
  case hydra.errors.Error.undefinedTermVariable(v_Error_undefinedTermVariable_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.Error",
  ...
  case hydra.errors.Error.untypedTermVariable(v_Error_untypedTermVariable_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.Error",
...
def extractionError(v1: hydra.errors.ExtractionError): hydra.core.Term =
  v1 match
  case hydra.errors.ExtractionError.emptyList(v_ExtractionError_emptyList_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ExtractionError",
     hydra.core.Field("emptyList", hydra.encode.errors.emptyListError(v_ExtractionError_emptyList_y))))
  case hydra.errors.ExtractionError.multipleBindings(v_ExtractionError_multipleBindings_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ExtractionError",
     hydra.core.Field("multipleBindings", hydra.encode.errors.multipleBindingsError(v_ExtractionError_multipleBindings_y))))
  case hydra.errors.ExtractionError.multipleFields(v_ExtractionError_multipleFields_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ExtractionError",
     hydra.core.Field("multipleFields", hydra.encode.errors.multipleFieldsError(v_ExtractionError_multipleFields_y))))
  case hydra.errors.ExtractionError.noMatchingField(v_ExtractionError_noMatchingField_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ExtractionError",
     hydra.core.Field("noMatchingField", hydra.encode.errors.noMatchingFieldError(v_ExtractionError_noMatchingField_y))))
  case hydra.errors.ExtractionError.noSuchBinding(v_ExtractionError_noSuchBinding_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ExtractionError",
     hydra.core.Field("noSuchBinding", hydra.encode.errors.noSuchBindingError(v_ExtractionError_noSuchBinding_y))))
  case hydra.errors.ExtractionError.notEnoughCases(v_ExtractionError_notEnoughCases_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ExtractionError",
     hydra.core.Field("notEnoughCases", hydra.encode.errors.notEnoughCasesError(v_ExtractionError_notEnoughCases_y))))
  case hydra.errors.ExtractionError.unexpectedShape(v_ExtractionError_unexpectedShape_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ExtractionError",
...
def inferenceError(v1: hydra.errors.InferenceError): hydra.core.Term =
  v1 match
  case hydra.errors.InferenceError.checking(v_InferenceError_checking_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.InferenceError",
     hydra.core.Field("checking", hydra.encode.error.checking.checkingError(v_InferenceError_checking_y))))
  case hydra.errors.InferenceError.other(v_InferenceError_other_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.InferenceError",
     hydra.core.Field("other", hydra.encode.errors.otherInferenceError(v_InferenceError_other_y))))
  case hydra.errors.InferenceError.unification(v_InferenceError_unification_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.InferenceError",
...
def resolutionError(v1: hydra.errors.ResolutionError): hydra.core.Term =
  v1 match
  case hydra.errors.ResolutionError.noSuchBinding(v_ResolutionError_noSuchBinding_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ResolutionError",
     hydra.core.Field("noSuchBinding", hydra.encode.errors.noSuchBindingError(v_ResolutionError_noSuchBinding_y))))
  case hydra.errors.ResolutionError.noSuchPrimitive(v_ResolutionError_noSuchPrimitive_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ResolutionError",
     hydra.core.Field("noSuchPrimitive", hydra.encode.errors.noSuchPrimitiveError(v_ResolutionError_noSuchPrimitive_y))))
  case hydra.errors.ResolutionError.noMatchingField(v_ResolutionError_noMatchingField_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ResolutionError",
     hydra.core.Field("noMatchingField", hydra.encode.errors.noMatchingFieldError(v_ResolutionError_noMatchingField_y))))
  case hydra.errors.ResolutionError.other(v_ResolutionError_other_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ResolutionError",
     hydra.core.Field("other", hydra.encode.errors.otherResolutionError(v_ResolutionError_other_y))))
  case hydra.errors.ResolutionError.unexpectedShape(v_ResolutionError_unexpectedShape_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.ResolutionError",
