...
def columnType(x: hydra.tabular.ColumnType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.tabular.ColumnType", Seq(hydra.core.Field("name",
     hydra.encode.relational.columnName(x.name)), hydra.core.Field("type", hydra.encode.core.`type`(x.`type`)))))
...
def table[T0](v: (T0 => hydra.core.Term))(x: hydra.tabular.Table[T0]): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.tabular.Table", Seq(hydra.core.Field("header",
     hydra.core.Term.maybe(hydra.lib.maybes.map[hydra.tabular.HeaderRow, hydra.core.Term](hydra.encode.tabular.headerRow)(x.header))),
     hydra.core.Field("data", hydra.core.Term.list(hydra.lib.lists.map[hydra.tabular.DataRow[T0],
...
def tableType(x: hydra.tabular.TableType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.tabular.TableType", Seq(hydra.core.Field("name",
     hydra.encode.relational.relationName(x.name)), hydra.core.Field("columns", hydra.core.Term.list(hydra.lib.lists.map[hydra.tabular.ColumnType,
     hydra.core.Term](hydra.encode.tabular.columnType)(x.columns))))))
