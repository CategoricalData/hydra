...
def node(v1: hydra.query.Node): hydra.core.Term =
  v1 match
  case hydra.query.Node.term(v_Node_term_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Node",
     hydra.core.Field("term", hydra.encode.core.term(v_Node_term_y))))
  case hydra.query.Node.variable(v_Node_variable_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Node",
     hydra.core.Field("variable", hydra.encode.query.variable(v_Node_variable_y))))
  case hydra.query.Node.wildcard => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Node",
     hydra.core.Field("wildcard", hydra.core.Term.unit)))

def path(v1: hydra.query.Path): hydra.core.Term =
  v1 match
  case hydra.query.Path.step(v_Path_step_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Path",
     hydra.core.Field("step", hydra.encode.query.step(v_Path_step_y))))
  case hydra.query.Path.regex(v_Path_regex_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Path",
     hydra.core.Field("regex", hydra.encode.query.regexSequence(v_Path_regex_y))))
  case hydra.query.Path.inverse(v_Path_inverse_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Path",
...
def pathEquation(x: hydra.query.PathEquation): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.query.PathEquation", Seq(hydra.core.Field("left",
     hydra.encode.query.path(x.left)), hydra.core.Field("right", hydra.encode.query.path(x.right)))))
...
def range(x: hydra.query.Range): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.query.Range", Seq(hydra.core.Field("min",
     hydra.core.Term.literal(hydra.core.Literal.integer(hydra.core.IntegerValue.int32(x.min)))),
...
def regexSequence(x: hydra.query.RegexSequence): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.query.RegexSequence", Seq(hydra.core.Field("path",
     hydra.encode.query.path(x.path)), hydra.core.Field("quantifier", hydra.encode.query.regexQuantifier(x.quantifier)))))

def step(v1: hydra.query.Step): hydra.core.Term =
  v1 match
  case hydra.query.Step.edge(v_Step_edge_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Step",
     hydra.core.Field("edge", hydra.encode.query.edge(v_Step_edge_y))))
  case hydra.query.Step.project(v_Step_project_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Step",
     hydra.core.Field("project", hydra.encode.core.projection(v_Step_project_y))))
  case hydra.query.Step.compare(v_Step_compare_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.query.Step",
