...
def functionStructure[T0](env: (T0 => hydra.core.Term))(x: hydra.typing.FunctionStructure[T0]): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.typing.FunctionStructure", Seq(hydra.core.Field("typeParams",
     ...
     hydra.core.Term](hydra.encode.core.`type`)(x.codomain))), hydra.core.Field("environment",
     env(x.environment)))))
...
def inferenceResult(x: hydra.typing.InferenceResult): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.typing.InferenceResult", Seq(hydra.core.Field("term",
     hydra.encode.core.term(x.term)), hydra.core.Field("type", hydra.encode.core.`type`(x.`type`)),
     hydra.core.Field("subst", hydra.encode.typing.typeSubst(x.subst)), hydra.core.Field("classConstraints",
     hydra.core.Term.map(hydra.lib.maps.bimap[hydra.core.Name, hydra.core.Term, hydra.core.TypeVariableMetadata,
     hydra.core.Term](hydra.encode.core.name)(hydra.encode.core.typeVariableMetadata)(x.classConstraints))),
