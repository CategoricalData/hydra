...
def associativity(v1: hydra.ast.Associativity): hydra.core.Term =
  v1 match
  case hydra.ast.Associativity.none => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Associativity",
     hydra.core.Field("none", hydra.core.Term.unit)))
  case hydra.ast.Associativity.left => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Associativity",
     hydra.core.Field("left", hydra.core.Term.unit)))
  case hydra.ast.Associativity.right => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Associativity",
     hydra.core.Field("right", hydra.core.Term.unit)))
  case hydra.ast.Associativity.both => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Associativity",
     hydra.core.Field("both", hydra.core.Term.unit)))
...
def bracketExpr(x: hydra.ast.BracketExpr): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.ast.BracketExpr", Seq(hydra.core.Field("brackets",
     hydra.encode.ast.brackets(x.brackets)), hydra.core.Field("enclosed", hydra.encode.ast.expr(x.enclosed)),
     hydra.core.Field("style", hydra.encode.ast.blockStyle(x.style)))))

def brackets(x: hydra.ast.Brackets): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.ast.Brackets", Seq(hydra.core.Field("open",
     hydra.encode.ast.symbol(x.open)), hydra.core.Field("close", hydra.encode.ast.symbol(x.close)))))
...
def op(x: hydra.ast.Op): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.ast.Op", Seq(hydra.core.Field("symbol",
     hydra.encode.ast.symbol(x.symbol)), hydra.core.Field("padding", hydra.encode.ast.padding(x.padding)),
     hydra.core.Field("precedence", hydra.encode.ast.precedence(x.precedence)), hydra.core.Field("associativity",
     hydra.encode.ast.associativity(x.associativity)))))

def opExpr(x: hydra.ast.OpExpr): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.ast.OpExpr", Seq(hydra.core.Field("op",
     hydra.encode.ast.op(x.op)), hydra.core.Field("lhs", hydra.encode.ast.expr(x.lhs)),
     hydra.core.Field("rhs", hydra.encode.ast.expr(x.rhs)))))

def padding(x: hydra.ast.Padding): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.ast.Padding", Seq(hydra.core.Field("left",
     hydra.encode.ast.ws(x.left)), hydra.core.Field("right", hydra.encode.ast.ws(x.right)))))
...
def seqExpr(x: hydra.ast.SeqExpr): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.ast.SeqExpr", Seq(hydra.core.Field("op",
     hydra.encode.ast.op(x.op)), hydra.core.Field("elements", hydra.core.Term.list(hydra.lib.lists.map[hydra.ast.Expr,
     hydra.core.Term](hydra.encode.ast.expr)(x.elements))))))
...
def ws(v1: hydra.ast.Ws): hydra.core.Term =
  v1 match
  case hydra.ast.Ws.none => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Ws",
     hydra.core.Field("none", hydra.core.Term.unit)))
  case hydra.ast.Ws.space => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Ws",
     hydra.core.Field("space", hydra.core.Term.unit)))
  case hydra.ast.Ws.break => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Ws",
     hydra.core.Field("break", hydra.core.Term.unit)))
  ...
  case hydra.ast.Ws.doubleBreak => hydra.core.Term.inject(hydra.core.Injection("hydra.ast.Ws",
     hydra.core.Field("doubleBreak", hydra.core.Term.unit)))
