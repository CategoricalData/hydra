...
def annotatedTerm(x: hydra.core.AnnotatedTerm): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.AnnotatedTerm", Seq(hydra.core.Field("body",
     hydra.encode.core.term(x.body)), hydra.core.Field("annotation", hydra.core.Term.map(hydra.lib.maps.bimap[hydra.core.Name,
     ...
     hydra.core.Term, hydra.core.Term, hydra.core.Term](hydra.encode.core.name)(hydra.encode.core.term)(x.annotation))))))

def annotatedType(x: hydra.core.AnnotatedType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.AnnotatedType", Seq(hydra.core.Field("body",
     hydra.encode.core.`type`(x.body)), hydra.core.Field("annotation", hydra.core.Term.map(hydra.lib.maps.bimap[hydra.core.Name,
...
def binding(x: hydra.core.Binding): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.Binding", Seq(hydra.core.Field("name",
     hydra.encode.core.name(x.name)), hydra.core.Field("term", hydra.encode.core.term(x.term)),
     hydra.core.Field("type", hydra.core.Term.maybe(hydra.lib.maybes.map[hydra.core.TypeScheme,
...
def caseStatement(x: hydra.core.CaseStatement): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.CaseStatement", Seq(hydra.core.Field("typeName",
     ...
     hydra.core.Term](hydra.encode.core.term)(x.default))), hydra.core.Field("cases",
     hydra.core.Term.list(hydra.lib.lists.map[hydra.core.Field, hydra.core.Term](hydra.encode.core.field)(x.cases))))))

def eitherType(x: hydra.core.EitherType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.EitherType", Seq(hydra.core.Field("left",
...
def fieldType(x: hydra.core.FieldType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.FieldType", Seq(hydra.core.Field("name",
...
def floatType(v1: hydra.core.FloatType): hydra.core.Term =
  v1 match
  case hydra.core.FloatType.bigfloat => hydra.core.Term.inject(hydra.core.Injection("hydra.core.FloatType",
     hydra.core.Field("bigfloat", hydra.core.Term.unit)))
  case hydra.core.FloatType.float32 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.FloatType",
     hydra.core.Field("float32", hydra.core.Term.unit)))
  case hydra.core.FloatType.float64 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.FloatType",
     hydra.core.Field("float64", hydra.core.Term.unit)))
...
def functionType(x: hydra.core.FunctionType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.FunctionType", Seq(hydra.core.Field("domain",
     hydra.encode.core.`type`(x.domain)), hydra.core.Field("codomain", hydra.encode.core.`type`(x.codomain)))))
...
def injection(x: hydra.core.Injection): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.Injection", Seq(hydra.core.Field("typeName",
     hydra.encode.core.name(x.typeName)), hydra.core.Field("field", hydra.encode.core.field(x.field)))))

def integerType(v1: hydra.core.IntegerType): hydra.core.Term =
  v1 match
  case hydra.core.IntegerType.bigint => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("bigint", hydra.core.Term.unit)))
  case hydra.core.IntegerType.int8 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("int8", hydra.core.Term.unit)))
  case hydra.core.IntegerType.int16 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("int16", hydra.core.Term.unit)))
  case hydra.core.IntegerType.int32 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("int32", hydra.core.Term.unit)))
  case hydra.core.IntegerType.int64 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("int64", hydra.core.Term.unit)))
  case hydra.core.IntegerType.uint8 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("uint8", hydra.core.Term.unit)))
  case hydra.core.IntegerType.uint16 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("uint16", hydra.core.Term.unit)))
  case hydra.core.IntegerType.uint32 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("uint32", hydra.core.Term.unit)))
  case hydra.core.IntegerType.uint64 => hydra.core.Term.inject(hydra.core.Injection("hydra.core.IntegerType",
     hydra.core.Field("uint64", hydra.core.Term.unit)))
...
def lambda(x: hydra.core.Lambda): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.Lambda", Seq(hydra.core.Field("parameter",
     hydra.encode.core.name(x.parameter)), hydra.core.Field("domain", hydra.core.Term.maybe(hydra.lib.maybes.map[hydra.core.Type,
     ...
     hydra.core.Term](hydra.encode.core.`type`)(x.domain))), hydra.core.Field("body",
     hydra.encode.core.term(x.body)))))

def let(x: hydra.core.Let): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.Let", Seq(hydra.core.Field("bindings",
...
def literalType(v1: hydra.core.LiteralType): hydra.core.Term =
  v1 match
  case hydra.core.LiteralType.binary => hydra.core.Term.inject(hydra.core.Injection("hydra.core.LiteralType",
  ...
  case hydra.core.LiteralType.string => hydra.core.Term.inject(hydra.core.Injection("hydra.core.LiteralType",
     hydra.core.Field("string", hydra.core.Term.unit)))

def mapType(x: hydra.core.MapType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.MapType", Seq(hydra.core.Field("keys",
     hydra.encode.core.`type`(x.keys)), hydra.core.Field("values", hydra.encode.core.`type`(x.values)))))
...
def pairType(x: hydra.core.PairType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.PairType", Seq(hydra.core.Field("first",
     hydra.encode.core.`type`(x.first)), hydra.core.Field("second", hydra.encode.core.`type`(x.second)))))

def projection(x: hydra.core.Projection): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.Projection", Seq(hydra.core.Field("typeName",
     hydra.encode.core.name(x.typeName)), hydra.core.Field("field", hydra.encode.core.name(x.field)))))
...
def record(x: hydra.core.Record): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.Record", Seq(hydra.core.Field("typeName",
     hydra.encode.core.name(x.typeName)), hydra.core.Field("fields", hydra.core.Term.list(hydra.lib.lists.map[hydra.core.Field,
     ...
     hydra.core.Term](hydra.encode.core.field)(x.fields))))))
...
def term(v1: hydra.core.Term): hydra.core.Term =
  ...
  case hydra.core.Term.either(v_Term_either_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Term",
     hydra.core.Field("either", hydra.core.Term.either(hydra.lib.eithers.bimap[hydra.core.Term,
     hydra.core.Term, hydra.core.Term, hydra.core.Term](hydra.encode.core.term)(hydra.encode.core.term)(v_Term_either_y)))))
  ...
  case hydra.core.Term.list(v_Term_list_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Term",
     hydra.core.Field("list", hydra.core.Term.list(hydra.lib.lists.map[hydra.core.Term,
     hydra.core.Term](hydra.encode.core.term)(v_Term_list_y)))))
  ...
  case hydra.core.Term.map(v_Term_map_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Term",
     hydra.core.Field("map", hydra.core.Term.map(hydra.lib.maps.bimap[hydra.core.Term,
     hydra.core.Term, hydra.core.Term, hydra.core.Term](hydra.encode.core.term)(hydra.encode.core.term)(v_Term_map_y)))))
  case hydra.core.Term.maybe(v_Term_maybe_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Term",
     hydra.core.Field("maybe", hydra.core.Term.maybe(hydra.lib.maybes.map[hydra.core.Term,
     hydra.core.Term](hydra.encode.core.term)(v_Term_maybe_y)))))
  case hydra.core.Term.pair(v_Term_pair_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Term",
     hydra.core.Field("pair", hydra.core.Term.pair(hydra.lib.pairs.bimap[hydra.core.Term,
     hydra.core.Term, hydra.core.Term, hydra.core.Term](hydra.encode.core.term)(hydra.encode.core.term)(v_Term_pair_y)))))
  ...
  case hydra.core.Term.set(v_Term_set_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Term",
     hydra.core.Field("set", hydra.core.Term.set(hydra.lib.sets.map[hydra.core.Term,
     hydra.core.Term](hydra.encode.core.term)(v_Term_set_y)))))
  ...
  case hydra.core.Term.unit => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Term",
...
def `type`(v1: hydra.core.Type): hydra.core.Term =
  ...
  case hydra.core.Type.record(v_Type_record_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Type",
     hydra.core.Field("record", hydra.core.Term.list(hydra.lib.lists.map[hydra.core.FieldType,
     hydra.core.Term](hydra.encode.core.fieldType)(v_Type_record_y)))))
  ...
  case hydra.core.Type.union(v_Type_union_y) => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Type",
     hydra.core.Field("union", hydra.core.Term.list(hydra.lib.lists.map[hydra.core.FieldType,
     hydra.core.Term](hydra.encode.core.fieldType)(v_Type_union_y)))))
  case hydra.core.Type.unit => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Type",
     hydra.core.Field("unit", hydra.core.Term.unit)))
  ...
  case hydra.core.Type.void => hydra.core.Term.inject(hydra.core.Injection("hydra.core.Type",
...
def typeScheme(x: hydra.core.TypeScheme): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.TypeScheme", Seq(hydra.core.Field("variables",
     ...
     hydra.core.Field("type", hydra.encode.core.`type`(x.`type`)), hydra.core.Field("constraints",
     hydra.core.Term.maybe(hydra.lib.maybes.map[Map[hydra.core.Name, hydra.core.TypeVariableMetadata],
     hydra.core.Term]((m: Map[hydra.core.Name, hydra.core.TypeVariableMetadata]) =>
