...
def expectArray(value: hydra.json.model.Value): Either[scala.Predef.String, Seq[hydra.json.model.Value]] =
  ...
  case _ => Left(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("JSON array"))(hydra.lib.strings.cat2(" but found ")(hydra.extract.json.showValue(value))))
...
def expectString(value: hydra.json.model.Value): Either[scala.Predef.String, scala.Predef.String] =
  ...
  case _ => Left(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("JSON string"))(hydra.lib.strings.cat2(" but found ")(hydra.extract.json.showValue(value))))
...
def requireNumber[T0](fname: T0)(m: Map[T0, hydra.json.model.Value]): Either[scala.Predef.String, BigDecimal] =
  hydra.lib.eithers.bind[scala.Predef.String, hydra.json.model.Value, BigDecimal](hydra.extract.json.require(fname)(m))(hydra.extract.json.expectNumber)

def requireString[T0](fname: T0)(m: Map[T0, hydra.json.model.Value]): Either[scala.Predef.String, scala.Predef.String] =
  hydra.lib.eithers.bind[scala.Predef.String, hydra.json.model.Value, scala.Predef.String](hydra.extract.json.require(fname)(m))(hydra.extract.json.expectString)
