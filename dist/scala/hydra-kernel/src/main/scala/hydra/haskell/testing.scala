...
def addNamespacesToNamespaces(ns0: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName])(names: scala.collection.immutable.Set[hydra.core.Name]): hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName] =
  {
  ...
  lazy val newMappings: Map[hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName] = hydra.lib.maps.fromList[hydra.packaging.Namespace,
     ...
     toModuleName(`ns_`)))(hydra.lib.sets.toList[hydra.packaging.Namespace](newNamespaces)))
  hydra.packaging.Namespaces(ns0.focus, hydra.lib.maps.union[hydra.packaging.Namespace,
     hydra.haskell.syntax.ModuleName](ns0.mapping)(newMappings))
}
...
def buildNamespacesForTestGroup(mod: hydra.packaging.Module)(tgroup: hydra.testing.TestGroup)(`graph_`: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  {
  lazy val `testCases_`: Seq[hydra.testing.TestCaseWithMetadata] = hydra.haskell.testing.collectTestCases(tgroup)
  def testTerms[T0]: Seq[T0] =
    hydra.lib.lists.concat[T0](hydra.lib.lists.map[hydra.testing.TestCaseWithMetadata,
       Seq[T0]](hydra.haskell.testing.extractTestTerms)(`testCases_`))
  lazy val testBindings: Seq[hydra.core.Binding] = hydra.lib.lists.map[hydra.core.Term,
     hydra.core.Binding]((term: hydra.core.Term) => hydra.core.Binding("_test_", term,
     None))(testTerms)
  lazy val tempModule: hydra.packaging.Module = hydra.packaging.Module(mod.namespace,
    ...
    hydra.packaging.Definition.term(hydra.packaging.TermDefinition(b.name, (b.term),
       (b.`type`))))(testBindings), (mod.termDependencies), (mod.typeDependencies),
       (mod.description))
  hydra.lib.eithers.bind[scala.Predef.String, hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName],
     hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName]](hydra.lib.eithers.bimap[hydra.errors.Error,
     hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName], scala.Predef.String,
     hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName]]((e: hydra.errors.Error) => hydra.show.errors.error(e))((a: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName]) => a)(hydra.haskell.utils.namespacesForModule(tempModule)(hydra.lexical.emptyContext)(`graph_`)))((baseNamespaces: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName]) =>
    {
    lazy val encodedNames: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.sets.unions[hydra.core.Name](hydra.lib.lists.map[hydra.core.Term,
      ...
      hydra.haskell.testing.extractEncodedTermVariableNames(`graph_`)(t))(testTerms))
    Right(hydra.haskell.testing.addNamespacesToNamespaces(baseNamespaces)(encodedNames))
  })
}

def buildTestModule(testModule: hydra.packaging.Module)(testGroup: hydra.testing.TestGroup)(testBody: scala.Predef.String)(namespaces: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName]): scala.Predef.String =
  {
  ...
  lazy val header: scala.Predef.String = hydra.lib.strings.intercalate("\n")(hydra.lib.lists.concat[scala.Predef.String](Seq(Seq(hydra.lib.strings.cat2("-- ")(hydra.constants.warningAutoGeneratedFile),
     ""), Seq("", hydra.lib.strings.cat(Seq("module ", moduleNameString, " where")),
     ""), allImports, Seq("", "spec :: H.Spec", hydra.lib.strings.cat(Seq("spec = H.describe ",
     hydra.lib.literals.showString(`groupName_`), " $ do"))))))
...
def collectTestCases(tg: hydra.testing.TestGroup): Seq[hydra.testing.TestCaseWithMetadata] =
  hydra.lib.lists.concat2[hydra.testing.TestCaseWithMetadata](tg.cases)(hydra.lib.lists.concat[hydra.testing.TestCaseWithMetadata](hydra.lib.lists.map[hydra.testing.TestGroup,
     Seq[hydra.testing.TestCaseWithMetadata]](hydra.haskell.testing.collectTestCases)(tg.subgroups)))
...
def extractEncodedTermVariableNames(graf: hydra.graph.Graph)(term: hydra.core.Term): scala.collection.immutable.Set[hydra.core.Name] =
  ...
  (v2: hydra.core.Term) => hydra.haskell.testing.collectNames(graf)(v1)(v2))(hydra.lib.sets.empty[hydra.core.Name])(term)

def extractTestTerms[T0, T1](tcm: T0): Seq[T1] = Seq()

def findHaskellImports[T0](namespaces: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName])(`names_`: T0): Seq[scala.Predef.String] =
  {
  lazy val `mapping_`: Map[hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName] = (namespaces.mapping)
  ...
  hydra.lib.lists.map[Tuple2[hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName],
    ...
    hydra.lib.strings.cat(Seq("import qualified ", hydra.lib.strings.intercalate(".")(hydra.lib.lists.map[scala.Predef.String,
       ...
       hydra.haskell.syntax.ModuleName](entry)))), " as ", hydra.lib.pairs.second[hydra.packaging.Namespace,
       hydra.haskell.syntax.ModuleName](entry))))(hydra.lib.maps.toList[hydra.packaging.Namespace,
       hydra.haskell.syntax.ModuleName](filtered))
}
...
def generateHaskellTestFile(testModule: hydra.packaging.Module)(testGroup: hydra.testing.TestGroup)(g: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  hydra.lib.eithers.bind[scala.Predef.String, hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName],
     Tuple2[scala.Predef.String, scala.Predef.String]](hydra.haskell.testing.buildNamespacesForTestGroup(testModule)(testGroup)(g))((namespaces: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName]) =>
  hydra.haskell.testing.generateTestFile(testModule)(testGroup)(namespaces))
...
def generateTestCase[T0, T1](depth: T0)(tcm: hydra.testing.TestCaseWithMetadata): Either[T1, Seq[scala.Predef.String]] =
  ...
  Right(Seq(hydra.lib.strings.cat(Seq("H.it ", hydra.lib.literals.showString(`name_`),
     " $ H.shouldBe")), hydra.lib.strings.cat(Seq("  (", `actual_`, ")")), hydra.lib.strings.cat(Seq("  (",
     `expected_`, ")"))))
}

def generateTestFile[T0](testModule: hydra.packaging.Module)(testGroup: hydra.testing.TestGroup)(namespaces: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName]): Either[T0,
   Tuple2[scala.Predef.String, scala.Predef.String]] =
  hydra.lib.eithers.map[scala.Predef.String, Tuple2[scala.Predef.String, scala.Predef.String],
     T0]((testBody: scala.Predef.String) =>
  {
  lazy val testModuleContent: scala.Predef.String = hydra.haskell.testing.buildTestModule(testModule)(testGroup)(testBody)(namespaces)
  lazy val `ns_`: hydra.packaging.Namespace = (testModule.namespace)
  lazy val specNs: hydra.packaging.Namespace = hydra.lib.strings.cat2(`ns_`)("Spec")
...
})(hydra.haskell.testing.generateTestGroupHierarchy(1)(testGroup))
...
def generateTestGroupHierarchy[T0](depth: Int)(testGroup: hydra.testing.TestGroup): Either[T0, scala.Predef.String] =
  ...
  hydra.lib.eithers.bind[T0, Seq[Seq[scala.Predef.String]], scala.Predef.String](hydra.lib.eithers.mapList[hydra.testing.TestCaseWithMetadata,
     Seq[scala.Predef.String], T0]((tc: hydra.testing.TestCaseWithMetadata) => hydra.haskell.testing.generateTestCase(depth)(tc))(`cases_`))((testCaseLinesRaw: Seq[Seq[scala.Predef.String]]) =>
    {
    ...
    hydra.lib.eithers.map[scala.Predef.String, scala.Predef.String, T0]((subgroupsStr: scala.Predef.String) =>
      ...
      hydra.lib.eithers.map[scala.Predef.String, scala.Predef.String, T0]((content: scala.Predef.String) =>
        hydra.lib.strings.cat(Seq(indent, "H.describe ", hydra.lib.literals.showString(`groupName_`),
           " $ do\n", content)))(hydra.haskell.testing.generateTestGroupHierarchy(hydra.lib.math.add(depth)(1))(subgroup))
    })(subgroups)))
  })
}
