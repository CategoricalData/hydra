...
def addNamespacesToNamespaces(ns0: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName])(names: scala.collection.immutable.Set[hydra.core.Name]): hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName] =
  ...
  lazy val newMappings: Map[hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName] = hydra.lib.maps.fromList[hydra.packaging.Namespace,
     hydra.haskell.syntax.ModuleName](hydra.lib.lists.map[hydra.packaging.Namespace, Tuple2[hydra.packaging.Namespace,
     hydra.haskell.syntax.ModuleName]]((`ns_`: hydra.packaging.Namespace) => Tuple2(`ns_`, toModuleName(`ns_`)))(hydra.lib.sets.toList[hydra.packaging.Namespace](newNamespaces)))
  hydra.packaging.Namespaces(ns0.focus, hydra.lib.maps.union[hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName](ns0.mapping)(newMappings))
}
...
def buildNamespacesForTestGroup(mod: hydra.packaging.Module)(tgroup: hydra.testing.TestGroup)(`graph_`: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  def testTerms[T0]: Seq[T0] =
    hydra.lib.lists.concat[T0](hydra.lib.lists.map[hydra.testing.TestCaseWithMetadata, Seq[T0]](hydra.haskell.testing.extractTestTerms)(`testCases_`))
...
def findHaskellImports[T0](namespaces: hydra.packaging.Namespaces[hydra.haskell.syntax.ModuleName])(`names_`: T0): Seq[scala.Predef.String] =
  ...
  hydra.lib.lists.map[Tuple2[hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName], scala.Predef.String]((entry: Tuple2[hydra.packaging.Namespace,
     hydra.haskell.syntax.ModuleName]) =>
    hydra.lib.strings.cat(Seq("import qualified ", hydra.lib.strings.intercalate(".")(hydra.lib.lists.map[scala.Predef.String,
       ...
       hydra.haskell.syntax.ModuleName](entry))))(hydra.lib.maps.toList[hydra.packaging.Namespace, hydra.haskell.syntax.ModuleName](filtered))
}
