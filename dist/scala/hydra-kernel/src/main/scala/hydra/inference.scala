            ...
            lazy val unboundInType: scala.collection.immutable.Set[hydra.core.Name] = hydra.variables.freeVariablesInType(ts.`type`)
            {
              lazy val unboundInTerm: scala.collection.immutable.Set[hydra.core.Name] = hydra.variables.freeTypeVariablesInTerm(bterm)
              {
                lazy val unbound: Seq[hydra.core.Name] = hydra.lib.sets.toList[hydra.core.Name](hydra.lib.sets.difference[hydra.core.Name](hydra.lib.sets.union[hydra.core.Name](unboundInType)(unboundInTerm))(hydra.lib.sets.union[hydra.core.Name](svars)(bvars)))
                {
                  ...
                  {
                    lazy val bterm2: hydra.core.Term = hydra.lib.lists.foldl[hydra.core.Term, hydra.core.Name]((t: hydra.core.Term) =>
...
def inferMany(fcx: hydra.context.Context)(cx: hydra.graph.Graph)(pairs: Seq[Tuple2[hydra.core.Term, scala.Predef.String]]): Either[hydra.errors.Error,
  ...
  lazy val dflt: Either[hydra.errors.Error, Tuple2[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
    ...
    {
      lazy val desc: scala.Predef.String = hydra.lib.pairs.second[hydra.core.Term, scala.Predef.String](hydra.lib.lists.head[Tuple2[hydra.core.Term,
         scala.Predef.String]](pairs))
      {
              ...
              lazy val t1: hydra.core.Type = (result1.`type`)
              {
                lazy val s1: hydra.typing.TypeSubst = (result1.subst)
                {
                  ...
                  hydra.lib.eithers.bind[hydra.errors.Error, Tuple2[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
                     ...
                     hydra.core.TypeVariableMetadata]]]], hydra.context.Context]) =>
                    {
                    lazy val result2: Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
                             ...
                             hydra.core.TypeVariableMetadata]]]](result2))
                          {
                               ...
                               hydra.core.TypeVariableMetadata]]]](result2)))
                            {
                                 ...
                                 hydra.core.TypeVariableMetadata]]]](result2)))
                              {
                                ...
                                {
                                  lazy val mergedConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.inference.mergeClassConstraints(c1Subst)(c2)
                          ...
                          lazy val v: hydra.core.Name = hydra.lib.pairs.first[hydra.core.Name, hydra.context.Context](vResult)
                          {
                            ...
                            hydra.lib.eithers.bind[hydra.errors.Error, hydra.typing.TypeSubst, hydra.typing.InferenceResult](hydra.lib.eithers.bimap[hydra.errors.UnificationError,
                                 ...
                                 hydra.substitution.substTypesInTerm(s2)(b)))
                              {
                                ...
                                {
                                  lazy val rSubst: hydra.typing.TypeSubst = hydra.substitution.composeTypeSubstList(Seq(s0, s1, s2))
                                  {
                                    lazy val c0Subst: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.substitution.substInClassConstraints(s2)(hydra.substitution.substInClassConstraints(s1)(c0))
                                    {
                                      lazy val c1Subst: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.substitution.substInClassConstraints(s2)(c1)
                                      {
                                        lazy val rConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.inference.mergeClassConstraints(c0Subst)(c1Subst)
            ...
            lazy val dfltResult: Option[hydra.typing.InferenceResult] = dfltRp
            {
              ...
              hydra.lib.eithers.bind[hydra.errors.Error, Tuple2[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
                ...
                Tuple2(f.term, hydra.lib.strings.cat(Seq("case ", tname, ".", (f.name)))))(cases)))((caseRp: Tuple2[Tuple2[Seq[hydra.core.Term],
                   ...
                   hydra.context.Context]) =>
                {
                lazy val caseResults: Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
                   Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]] = hydra.lib.pairs.first[Tuple2[Seq[hydra.core.Term],
                   Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]],
                         ...
                         hydra.core.TypeVariableMetadata]]]](caseResults))
                      {
                           ...
                           hydra.core.TypeVariableMetadata]]]](caseResults)))
                        {
                             ...
                             hydra.core.TypeVariableMetadata]]]](caseResults)))
                          {
                            ...
                            {
                              lazy val codv: hydra.core.Name = hydra.lib.pairs.first[hydra.core.Name, hydra.context.Context](codvResult)
                              {
                                lazy val fcx5: hydra.context.Context = hydra.lib.pairs.second[hydra.core.Name, hydra.context.Context](codvResult)
                                {
                                  lazy val cod: hydra.core.Type = hydra.core.Type.variable(codv)
                                  {
                                       ...
                                       (ft.`type`)))(sfields))
                                    {
                                        ...
                                        hydra.typing.TypeConstraint(cod, hydra.substitution.substInType(isubst)(r.`type`), "match default"))(dfltResult))
                                      {
                                        ...
                                        {
                                          lazy val dfltClassConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.lib.maybes.fromMaybe[Map[hydra.core.Name,
...
def inferTypeOfCollection(fcx: hydra.context.Context)(cx: hydra.graph.Graph)(typCons: (hydra.core.Type => hydra.core.Type))(trmCons: (Seq[hydra.core.Term] => hydra.core.Term))(desc: scala.Predef.String)(classNames: scala.collection.immutable.Set[hydra.core.Name])(els: Seq[hydra.core.Term]): Either[hydra.errors.Error,
  ...
  hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.typing.InferenceResult]](hydra.lib.lists.`null`[hydra.core.Term](els))(Right(hydra.inference.yieldWithConstraints(fcx2)(hydra.inference.buildTypeApplicationTerm(Seq(`var`))(trmCons(Seq())))(typCons(hydra.core.Type.variable(`var`)))(hydra.substitution.idTypeSubst)(classConstraints)))(hydra.lib.eithers.bind[hydra.errors.Error,
    ...
    {
      lazy val fcx3: hydra.context.Context = hydra.lib.pairs.second[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
         Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]], hydra.context.Context](resultsRp)
      {
        lazy val terms: Seq[hydra.core.Term] = hydra.lib.pairs.first[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
           Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](results)
        {
          lazy val types: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
          ...
          {
            lazy val subst1: hydra.typing.TypeSubst = hydra.lib.pairs.first[hydra.typing.TypeSubst, Map[hydra.core.Name,
    ...
    lazy val iterm: hydra.core.Term = (r1.term)
    {
      lazy val leftType: hydra.core.Type = (r1.`type`)
      {
        lazy val subst: hydra.typing.TypeSubst = (r1.subst)
        {
          ...
          {
            lazy val rightType: hydra.core.Type = hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context](fvResult)
            {
              lazy val fcx3: hydra.context.Context = hydra.lib.pairs.second[hydra.core.Type, hydra.context.Context](fvResult)
              {
                lazy val eitherTerm: hydra.core.Term = hydra.core.Term.either(Left(iterm))
                {
                  lazy val termWithLeftType: hydra.core.Term = hydra.core.Term.typeApplication(hydra.core.TypeApplicationTerm(eitherTerm, leftType))
                  {
                    lazy val termWithBothTypes: hydra.core.Term = hydra.core.Term.typeApplication(hydra.core.TypeApplicationTerm(termWithLeftType, rightType))
                    {
                      lazy val eitherType: hydra.core.Type = hydra.core.Type.either(hydra.core.EitherType(leftType, rightType))
...
def inferTypeOfInjection(fcx: hydra.context.Context)(cx: hydra.graph.Graph)(injection: hydra.core.Injection): Either[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.typing.InferenceResult, hydra.typing.InferenceResult](hydra.inference.inferTypeOfTerm(fcx)(cx)(term)("injected term"))((result: hydra.typing.InferenceResult) =>
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, Tuple2[hydra.core.TypeScheme, hydra.context.Context], hydra.typing.InferenceResult](hydra.resolution.requireSchemaType(fcx2)(cx.schemaTypes)(tname))((stRp: Tuple2[hydra.core.TypeScheme,
      ...
      lazy val schemaType: hydra.core.TypeScheme = hydra.lib.pairs.first[hydra.core.TypeScheme, hydra.context.Context](stRp)
      {
        lazy val fcx3: hydra.context.Context = hydra.lib.pairs.second[hydra.core.TypeScheme, hydra.context.Context](stRp)
        {
          lazy val svars: Seq[hydra.core.Name] = (schemaType.variables)
          {
            lazy val stype: hydra.core.Type = (schemaType.`type`)
...
def inferTypeOfLet(fcx0: hydra.context.Context)(cx: hydra.graph.Graph)(let0: hydra.core.Let): Either[hydra.errors.Error, hydra.typing.InferenceResult] =
  ...
  lazy val rewrittenLet: hydra.core.Term = hydra.lib.lists.foldl[hydra.core.Term, Seq[hydra.core.Name]](createLet)(body0)(hydra.lib.lists.reverse[Seq[hydra.core.Name]](groups))
  def restoreLet(iterm: hydra.core.Term): hydra.core.Term =
    ...
    lazy val bindingList: Seq[hydra.core.Binding] = hydra.lib.pairs.first[Seq[hydra.core.Binding], hydra.core.Term](result)
...
def inferTypeOfLetNormalized(fcx0: hydra.context.Context)(cx0: hydra.graph.Graph)(letTerm: hydra.core.Let): Either[hydra.errors.Error,
  ...
  lazy val bnames: Seq[hydra.core.Name] = hydra.lib.lists.map[hydra.core.Binding, hydra.core.Name]((x: hydra.core.Binding) => (x.name))(bins0)
  ...
  lazy val fcx2: hydra.context.Context = hydra.lib.pairs.second[Seq[hydra.core.Name], hydra.context.Context](bvarsResult)
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, Tuple2[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
     ...
     hydra.context.Context]) =>
    {
    lazy val inferredResult: Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
       Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]] = hydra.lib.pairs.first[Tuple2[Seq[hydra.core.Term],
       Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]],
       hydra.context.Context](irRp)
    {
      ...
      {
        lazy val bterms1: Seq[hydra.core.Term] = hydra.lib.pairs.first[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
           Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](inferredResult)
        {
          lazy val tbins1: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
             Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]](hydra.lib.pairs.second[Seq[hydra.core.Term],
          ...
          {
            lazy val substAndConstraints: Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]] = hydra.lib.pairs.second[Seq[hydra.core.Type],
               Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]](hydra.lib.pairs.second[Seq[hydra.core.Term],
               Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](inferredResult))
            {
              lazy val s1: hydra.typing.TypeSubst = hydra.lib.pairs.first[hydra.typing.TypeSubst, Map[hydra.core.Name,
                ...
                hydra.lib.eithers.bind[hydra.errors.Error, hydra.typing.TypeSubst, hydra.typing.InferenceResult](hydra.lib.eithers.bimap[hydra.errors.UnificationError,
                  ...
                  lazy val g2base: hydra.graph.Graph = hydra.substitution.substInContext(hydra.substitution.composeTypeSubst(s1)(s2))(cx0)
                  {
                    lazy val constraintsWithS2: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.substitution.substInClassConstraints(s2)(inferredConstraints)
                    {
                      ...
                      {
                        lazy val originalBindingConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.lib.lists.foldl[Map[hydra.core.Name,
                        ...
                        {
                          lazy val originalConstraintsSubst: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.substitution.substInClassConstraints(composedSubst)(originalBindingConstraints)
                          {
                            lazy val allInferredConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.inference.mergeClassConstraints(constraintsWithS2)(originalConstraintsSubst)
                            {
                              lazy val mergedConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.inference.mergeClassConstraints(g2base.classConstraints)(allInferredConstraints)
                              {
                                lazy val g2: hydra.graph.Graph = hydra.graph.Graph(g2base.boundTerms,
                                   (g2base.boundTypes), mergedConstraints, (g2base.lambdaVariables), (g2base.metadata),
                                   (g2base.primitives), (g2base.schemaTypes), (g2base.typeVariables))
                                {
                                  ...
                                  {
                                    lazy val tsbins1: Seq[Tuple2[hydra.core.Name, hydra.core.TypeScheme]] = hydra.lib.lists.zip[hydra.core.Name,
                                          ...
                                          lazy val tbody: hydra.core.Type = (bodyResult.`type`)
                                          {
                                            lazy val sbody: hydra.typing.TypeSubst = (bodyResult.subst)
                                            {
                                              lazy val st1: hydra.typing.TermSubst = hydra.lib.maps.fromList[hydra.core.Name,
                                                ...
                                                {
                                                lazy val name: hydra.core.Name = hydra.lib.pairs.first[hydra.core.Name, hydra.core.TypeScheme](pair)
                                                {
                                                  lazy val ts: hydra.core.TypeScheme = hydra.lib.pairs.second[hydra.core.Name, hydra.core.TypeScheme](pair)
                                              ...
                                              })(tsbins1))
                                              {
                                                def createBinding(bindingPair: Tuple2[Tuple2[hydra.core.Name,
                                                  ...
                                                  {
                                                  lazy val nameTsPair: Tuple2[hydra.core.Name, hydra.core.TypeScheme] = hydra.lib.pairs.first[Tuple2[hydra.core.Name,
                                                  ...
                                                  lazy val term: hydra.core.Term = hydra.lib.pairs.second[Tuple2[hydra.core.Name,
                                                     hydra.core.TypeScheme], hydra.core.Term](bindingPair)
                                                  lazy val name: hydra.core.Name = hydra.lib.pairs.first[hydra.core.Name, hydra.core.TypeScheme](nameTsPair)
                                                ...
                                                }
                                                {
                                                  ...
                                                  {
                                                    lazy val bodyConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.substitution.substInClassConstraints(sbody)(bodyResult.classConstraints)
                                                    {
...
def inferTypeOfMap(fcx: hydra.context.Context)(cx: hydra.graph.Graph)(m: Map[hydra.core.Term, hydra.core.Term]): Either[hydra.errors.Error,
  ...
  hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.typing.InferenceResult]](hydra.lib.maps.`null`[hydra.core.Term,
    ...
    {
      lazy val fcx4: hydra.context.Context = hydra.lib.pairs.second[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
         Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]], hydra.context.Context](kRp)
      {
        lazy val kterms: Seq[hydra.core.Term] = hydra.lib.pairs.first[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
           Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](kResults)
        {
          lazy val ktypes: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
             Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]](hydra.lib.pairs.second[Seq[hydra.core.Term],
             Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](kResults))
          {
            lazy val ksubst: hydra.typing.TypeSubst = hydra.lib.pairs.first[hydra.typing.TypeSubst, Map[hydra.core.Name,
               hydra.core.TypeVariableMetadata]](hydra.lib.pairs.second[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
               Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]](hydra.lib.pairs.second[Seq[hydra.core.Term],
               Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](kResults)))
            {
              ...
              hydra.lib.eithers.bind[hydra.errors.Error, Tuple2[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
                 ...
                 hydra.context.Context]) =>
                {
                lazy val vResults: Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
                   Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]] = hydra.lib.pairs.first[Tuple2[Seq[hydra.core.Term],
                   Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]],
...
def inferTypeOfPair(fcx: hydra.context.Context)(cx: hydra.graph.Graph)(p: Tuple2[hydra.core.Term, hydra.core.Term]): Either[hydra.errors.Error,
  ...
  {
    lazy val fcx2: hydra.context.Context = hydra.lib.pairs.second[Tuple2[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
       Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]], hydra.context.Context](rp)
    {
      lazy val iterms: Seq[hydra.core.Term] = hydra.lib.pairs.first[Seq[hydra.core.Term], Tuple2[Seq[hydra.core.Type],
         Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](results)
      {
        lazy val itypes: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
           Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]](hydra.lib.pairs.second[Seq[hydra.core.Term],
           Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](results))
        {
          lazy val isubst: hydra.typing.TypeSubst = hydra.lib.pairs.first[hydra.typing.TypeSubst, Map[hydra.core.Name,
             hydra.core.TypeVariableMetadata]](hydra.lib.pairs.second[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst,
             Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]](hydra.lib.pairs.second[Seq[hydra.core.Term],
             Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](results)))
          {
            lazy val pairElemConstraints: Map[hydra.core.Name, hydra.core.TypeVariableMetadata] = hydra.lib.pairs.second[hydra.typing.TypeSubst,
               ...
               Tuple2[Seq[hydra.core.Type], Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]]](results)))
            {
              lazy val ifst: hydra.core.Term = hydra.lib.lists.head[hydra.core.Term](iterms)
              {
                lazy val isnd: hydra.core.Term = hydra.lib.lists.head[hydra.core.Term](hydra.lib.lists.tail[hydra.core.Term](iterms))
                {
                  lazy val tyFst: hydra.core.Type = hydra.lib.lists.head[hydra.core.Type](itypes)
                  {
                    lazy val tySnd: hydra.core.Type = hydra.lib.lists.head[hydra.core.Type](hydra.lib.lists.tail[hydra.core.Type](itypes))
                    {
                ...
                lazy val u_prime: hydra.core.Type = (result1.`type`)
                {
                  lazy val u: hydra.typing.TypeSubst = (result1.subst)
                  {
                    ...
                    hydra.lib.eithers.bind[hydra.errors.Error, Map[hydra.core.Name, hydra.core.TypeVariableMetadata],
                      ...
                      {
                        lazy val instantiatedTs: hydra.core.TypeScheme = hydra.lib.pairs.first[hydra.core.TypeScheme, hydra.context.Context](tsResult)
                        {
                             ...
                             hydra.core.TypeVariableMetadata]]]], hydra.context.Context](rp2)
                          {
                               ...
                               hydra.core.TypeVariableMetadata]]]](result2)
                            {
                              lazy val r_prime: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type],
                                 ...
                                 hydra.core.TypeVariableMetadata]]]](result2))
                              {
                                lazy val restPair: Tuple2[hydra.typing.TypeSubst, Map[hydra.core.Name,
