...
def termToSubtermGraph(namespaces: Map[hydra.packaging.Namespace, scala.Predef.String])(term: hydra.core.Term): hydra.paths.SubtermGraph =
  ...
  def helper(ids: Map[hydra.core.Name, hydra.paths.SubtermNode])(mroot: Option[hydra.paths.SubtermNode])(path: Seq[hydra.paths.SubtermStep])(state: Tuple2[Tuple2[Seq[hydra.paths.SubtermNode],
    ...
    lazy val edges: Seq[hydra.paths.SubtermEdge] = hydra.lib.pairs.second[Seq[hydra.paths.SubtermNode],
       Seq[hydra.paths.SubtermEdge]](nodesEdges)
    ...
    currentTerm match
      case hydra.core.Term.let(v_Term_let_letExpr) => {
        ...
        def addBindingName(nodesVisitedIds: Tuple2[Tuple2[Seq[hydra.paths.SubtermNode],
           scala.collection.immutable.Set[scala.Predef.String]], Map[hydra.core.Name,
           hydra.paths.SubtermNode]])(name: hydra.core.Name): Tuple2[Tuple2[Seq[hydra.paths.SubtermNode],
           scala.collection.immutable.Set[scala.Predef.String]], Map[hydra.core.Name,
        ...
        def addBindingTerm(currentState: Tuple2[Tuple2[Seq[hydra.paths.SubtermNode],
           ...
           scala.collection.immutable.Set[scala.Predef.String]] =
          {
          lazy val root: hydra.paths.SubtermNode = hydra.lib.pairs.first[hydra.paths.SubtermNode,
             hydra.core.Binding](nodeBinding)
          lazy val binding: hydra.core.Binding = hydra.lib.pairs.second[hydra.paths.SubtermNode,
             hydra.core.Binding](nodeBinding)
      ...
      case _ => hydra.lib.lists.foldl[Tuple2[Tuple2[Seq[hydra.paths.SubtermNode],
         Seq[hydra.paths.SubtermEdge]], scala.collection.immutable.Set[scala.Predef.String]],
         Tuple2[hydra.paths.SubtermStep, hydra.core.Term]]((v1: Tuple2[Tuple2[Seq[hydra.paths.SubtermNode],
         Seq[hydra.paths.SubtermEdge]], scala.collection.immutable.Set[scala.Predef.String]]) =>
  ...
  lazy val finalEdges: Seq[hydra.paths.SubtermEdge] = hydra.lib.pairs.second[Seq[hydra.paths.SubtermNode],
     Seq[hydra.paths.SubtermEdge]](finalNodesEdges)
