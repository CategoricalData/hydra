...
def yamlToJson(node: hydra.yaml.model.Node): Either[scala.Predef.String, hydra.json.model.Value] =
  ...
  case hydra.yaml.model.Node.mapping(v_Node_mapping_m) => {
    ...
    {
      lazy val entries: Either[scala.Predef.String, Seq[Tuple2[scala.Predef.String, hydra.json.model.Value]]] = hydra.lib.eithers.mapList[Tuple2[hydra.yaml.model.Node,
         hydra.yaml.model.Node], Tuple2[scala.Predef.String, hydra.json.model.Value], scala.Predef.String](convertEntry)(hydra.lib.maps.toList[hydra.yaml.model.Node,
