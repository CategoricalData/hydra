...
case class FunctionStructure[Env](typeParams: Seq[hydra.core.Name], params: Seq[hydra.core.Name],
   bindings: Seq[hydra.core.Binding], body: hydra.core.Term, domains: Seq[hydra.core.Type],
   codomain: Option[hydra.core.Type], environment: Env)
