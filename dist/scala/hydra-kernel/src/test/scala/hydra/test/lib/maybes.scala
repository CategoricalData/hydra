...
lazy val allTests: hydra.testing.TestGroup = hydra.testing.TestGroup("hydra.lib.maybes primitives",
  ...
  hydra.lib.logic.ifElse[Option[Int]](hydra.lib.equality.gte[Int](y)(5))(Some(hydra.lib.math.mul(y)(2)))(None))(3)),
     ...
     hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.literals.showBoolean(hydra.lib.maybes.isJust[Any](None)),
     ...
     hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.literals.showBoolean(hydra.lib.maybes.isNothing[Any](None)),
