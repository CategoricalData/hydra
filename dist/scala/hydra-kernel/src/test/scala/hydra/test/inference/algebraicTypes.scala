package hydra.test.inference.algebraicTypes

import hydra.core.*

import hydra.testing.*

lazy val allTests: hydra.testing.TestGroup = hydra.testing.TestGroup("Algebraic terms",
   None, Seq(hydra.test.inference.algebraicTypes.testGroupForCollectionPrimitives,
   hydra.test.inference.algebraicTypes.testGroupForEithers, hydra.test.inference.algebraicTypes.testGroupForFolds,
   hydra.test.inference.algebraicTypes.testGroupForLists, hydra.test.inference.algebraicTypes.testGroupForMaps,
   hydra.test.inference.algebraicTypes.testGroupForOptionals, hydra.test.inference.algebraicTypes.testGroupForPairs,
   hydra.test.inference.algebraicTypes.testGroupForSets), Seq())
...
lazy val testGroupForEithers: hydra.testing.TestGroup = hydra.testing.TestGroup("Either terms",
   None, Seq(hydra.testing.TestGroup("Left values", None, Seq(), Seq(hydra.testing.TestCaseWithMetadata("#1",
   hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.eithers.either[hydra.errors.Error,
   Tuple2[Tuple2[hydra.core.Term, hydra.core.TypeScheme], hydra.context.Context],
   scala.Predef.String]((e: hydra.errors.Error) => hydra.lib.strings.cat2("INFERENCE ERROR: ")("failed"))((result: Tuple2[Tuple2[hydra.core.Term,
...
lazy val testGroupForLists: hydra.testing.TestGroup = hydra.testing.TestGroup("List terms",
   None, Seq(hydra.testing.TestGroup("List of strings", None, Seq(), Seq(hydra.testing.TestCaseWithMetadata("#1",
   hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.eithers.either[hydra.errors.Error,
   Tuple2[Tuple2[hydra.core.Term, hydra.core.TypeScheme], hydra.context.Context],
   scala.Predef.String]((e: hydra.errors.Error) => hydra.lib.strings.cat2("INFERENCE ERROR: ")("failed"))((result: Tuple2[Tuple2[hydra.core.Term,
...
lazy val testGroupForPairs: hydra.testing.TestGroup = hydra.testing.TestGroup("Pair terms",
   None, Seq(hydra.testing.TestGroup("Monotyped pairs", None, Seq(), Seq(hydra.testing.TestCaseWithMetadata("#1",
   hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.eithers.either[hydra.errors.Error,
   Tuple2[Tuple2[hydra.core.Term, hydra.core.TypeScheme], hydra.context.Context],
   scala.Predef.String]((e: hydra.errors.Error) => hydra.lib.strings.cat2("INFERENCE ERROR: ")("failed"))((result: Tuple2[Tuple2[hydra.core.Term,
  ...
  hydra.show.core.typeScheme(hydra.lib.pairs.second[hydra.core.Term, hydra.core.TypeScheme](hydra.lib.pairs.first[Tuple2[hydra.core.Term,
     ...
     hydra.testing.TestGroup("Nested pairs", None, Seq(), Seq(hydra.testing.TestCaseWithMetadata("#1",
     hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.eithers.either[hydra.errors.Error,
     Tuple2[Tuple2[hydra.core.Term, hydra.core.TypeScheme], hydra.context.Context],
     scala.Predef.String]((e: hydra.errors.Error) => hydra.lib.strings.cat2("INFERENCE ERROR: ")("failed"))((result: Tuple2[Tuple2[hydra.core.Term,
