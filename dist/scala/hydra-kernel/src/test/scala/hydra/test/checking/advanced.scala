package hydra.test.checking.advanced

import hydra.core.*

import hydra.testing.*

lazy val allTests: hydra.testing.TestGroup = hydra.testing.TestGroup("Advanced", None,
   Seq(hydra.test.checking.advanced.annotatedTermsTests), Seq())

lazy val annotatedTermsTests: hydra.testing.TestGroup = hydra.testing.TestGroup("Annotated terms",
   None, Seq(hydra.test.checking.advanced.topLevelAnnotationsTests, hydra.test.checking.advanced.nestedAnnotationsTests,
...
lazy val nestedAnnotationsTests: hydra.testing.TestGroup = hydra.testing.TestGroup("Nested annotations",
   None, Seq(), Seq(hydra.testing.TestCaseWithMetadata("annotation within annotation",
   hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.eithers.either[hydra.errors.Error,
   Tuple2[Tuple2[hydra.core.Term, hydra.core.TypeScheme], hydra.context.Context],
   scala.Predef.String]((e: hydra.errors.Error) => "<<inference error>>")((result: Tuple2[Tuple2[hydra.core.Term,
   hydra.core.TypeScheme], hydra.context.Context]) =>
