...
lazy val allTests: hydra.testing.TestGroup = hydra.testing.TestGroup("JSON<->YAML bridge",
   ...
   None, Seq()), hydra.testing.TestCaseWithMetadata("large integer", hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.eithers.either[scala.Predef.String,
   hydra.json.model.Value, scala.Predef.String]((e: scala.Predef.String) => e)((back: hydra.json.model.Value) => hydra.json.writer.printJson(back))(hydra.json.yaml.decode.yamlToJson(hydra.json.yaml.encode.jsonToYaml(hydra.json.model.Value.number(BigDecimal("1.00000000000000000001e20"))))),
   hydra.json.writer.printJson(hydra.json.model.Value.number(BigDecimal("1.00000000000000000001e20"))))),
   ...
   None, Seq()), hydra.testing.TestCaseWithMetadata("many significant digits", hydra.testing.TestCase.universal(hydra.testing.UniversalTestCase(hydra.lib.eithers.either[scala.Predef.String,
   hydra.json.model.Value, scala.Predef.String]((e: scala.Predef.String) => e)((back: hydra.json.model.Value) => hydra.json.writer.printJson(back))(hydra.json.yaml.decode.yamlToJson(hydra.json.yaml.encode.jsonToYaml(hydra.json.model.Value.number(BigDecimal("3.14159265358979323846"))))),
   hydra.json.writer.printJson(hydra.json.model.Value.number(BigDecimal("3.14159265358979323846"))))),
