(module
  ...
  (import "hydra.checking" "hydra.checking.type_of_term" (func $hydra.checking.type_of_term (param i32) (param i32) (param i32) (result i32) ) )
  ...
  (import "hydra.predicates" "hydra.predicates.is_complex_binding" (func $hydra.predicates.is_complex_binding (param i32) (param i32) (result i32) ) )
  ...
  (data (offset i32.const 1024 ) "\01\00\00\00\5f\0f\00\00\00\68\79\64\72\61\2e\63\6f\72\65\2e\54\79\70\65")
  ...
  (export "hydra.analysis.module_contains_decimal_literals" (func $hydra.analysis.module_contains_decimal_literals) )
  ...
  local.get $__rec_ptr
  i32.load
  br_table $annotated $lambda $let $type_lambda $type_application $type_application
)
  local.get $v
  drop
  local.get $at
  ...
  (func $hydra.analysis.module_contains_decimal_literals (param $mod i32) (result i32)
  (local $__rec_ptr i32)
  (local $__rec_scratch i32)
  (local $acc i32)
  (local $check_term i32)
  ...
  (local $td i32)
  (local $term i32)
  (local $term_contains_decimal i32)
  (local $v i32)
  local.get $found
  (block $end_term (result i32)
  (block $literal
  ...
  local.get $term
  call $hydra.rewriting.fold_over_term
  local.set $term_contains_decimal
  (block $end_definition (result i32)
  (block $term
  local.get $d
  local.set $__rec_ptr
  ...
  local.get $t
  drop
  local.get $term_contains_decimal
  drop
  i32.const 0
  call $hydra.lib.logic.or
  i32.const 0
