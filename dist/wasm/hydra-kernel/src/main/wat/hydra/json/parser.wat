(module
  ...
  (import "hydra.lib.literals" "hydra.lib.literals.read_decimal" (func $hydra.lib.literals.read_decimal (param i32) (result i32) ) )
  ...
  (import "hydra.parsers" "hydra.parsers.alt" (func $hydra.parsers.alt (param i32) (param i32) (result i32) ) )
  (import "hydra.parsers" "hydra.parsers.between" (func $hydra.parsers.between (param i32) (param i32) (param i32) (result i32) ) )
  (import "hydra.parsers" "hydra.parsers.bind" (func $hydra.parsers.bind (param i32) (param i32) (result i32) ) )
  ...
  (import "hydra.parsers" "hydra.parsers.map" (func $hydra.parsers.map (param i32) (param i32) (result i32) ) )
  ...
  (import "hydra.parsers" "hydra.parsers.sep_by" (func $hydra.parsers.sep_by (param i32) (param i32) (result i32) ) )
  ...
  (data (offset i32.const 1024 ) "\00\00\00\00\01\00\00\00\2d\01\00\00\00\2e\01\00\00\00\65\05\00\00\00\66\61\6c\73\65\04\00\00\00\6e\75\6c\6c\04\00\00\00\74\72\75\65")
  ...
  i32.const 0
  local.get $num_str
  call $hydra.lib.literals.read_decimal
  call $hydra.lib.maybes.maybe
  i32.const 8
  call $__alloc
  local.set $__rec_ptr
