...
Definition moduleContainsBinaryLiterals : forall (_ : Module_) , bool := fun (mod_ : Module_) => let defTerms := (maybes.cat) (((lists.map) (fun (d : Definition_) => (fun x_ => match x_ with
...
Definition namespacesForDefinitions (t0 : Type) : forall (_ : forall (_ : Namespace) , t0) , forall (_ : Namespace) , forall (_ : (list) (Definition_)) , (Namespaces) (t0) := fun (encodeNamespace : forall (_ : Namespace) , t0) => fun (focusNs : Namespace) => fun (defs : (list) (Definition_)) => let toPair := fun (ns : Namespace) => (pair) (ns) ((encodeNamespace) (ns)) in let nss := ((sets.delete) (focusNs)) ((definitionDependencyNamespaces) (defs)) in (Build_Namespaces) ((toPair) (focusNs)) ((maps.fromList) (((lists.map) (toPair)) ((sets.toList) (nss)))).
...
Definition addNamesToNamespaces (t0 : Type) : forall (_ : forall (_ : Namespace) , t0) , forall (_ : (list) (Name)) , forall (_ : (Namespaces) (t0)) , (Namespaces) (t0) := fun (encodeNamespace : forall (_ : Namespace) , t0) => fun (names : (list) (Name)) => fun (ns0 : (Namespaces) (t0)) => let toPair := fun (ns : Namespace) => (pair) (ns) ((encodeNamespace) (ns)) in let nss := (sets.fromList) ((maybes.cat) (((lists.map) (namespaceOf)) ((sets.toList) (names)))) in (Build_Namespaces) ((fun r_ => (namespaces_focus) (r_)) (ns0)) (((maps.union) ((fun r_ => (namespaces_mapping) (r_)) (ns0))) ((maps.fromList) (((lists.map) (toPair)) ((sets.toList) (nss))))).
