...
| Literal_Decimal v_ => (fun (d : Q) => (inr) (d)) (v_)
| _ => (inl) ((Error_Extraction) ((ExtractionError_UnexpectedShape) ((Build_UnexpectedShapeError) ("decimal"%string) ((hydra.show.core.literal) (v)))))
end) (v).
