...
Arguments field {t0}.
Definition unitVariant : forall (_ : Name) , forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (Error) (Name) := fun (tname : Name) => fun (graph_ : hydra.graph.Graph) => fun (term_ : Term) => ((eithers.bind) ((((injection) (tname)) (graph_)) (term_))) (fun (field : Field) => ((eithers.bind) ((unit_) ((fun r_ => (field_term) (r_)) (field)))) (fun (ignored : unit) => (inr) ((fun r_ => (field_name) (r_)) (field)))).
