...
Definition context : forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) (Context_) := fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
