...
Definition tTerm (t0 : Type) (t1 : Type) : t0 -> hydra.graph.Graph -> Term -> (sum) (DecodingError) ((TTerm) (t1)) :=
  fun (a : t0) => fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition tTermDefinition (t0 : Type) (t1 : Type) : t0 -> hydra.graph.Graph -> Term -> (sum) (DecodingError) ((TTermDefinition) (t1)) :=
  fun (a : t0) => fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition tBinding (t0 : Type) (t1 : Type) : t0 -> hydra.graph.Graph -> Term -> (sum) (DecodingError) ((TBinding) (t1)) :=
  fun (a : t0) => fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
