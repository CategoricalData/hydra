...
Definition typeSubst : forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) (TypeSubst) := fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition inferenceResult : forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) (InferenceResult) := fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition termSubst : forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) (TermSubst) := fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition typeConstraint : forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) (TypeConstraint) := fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
