...
| _ => (inl) ("expected literal"%string)
end) (stripped2))) (((stripWithDecodingError) (cx2)) (raw2))) (cx)) (input)))) ((cons) ((pair) ("decimal"%string) (fun (input : Term) => ((eithers.map) (fun (t : Q) => (Literal_Decimal) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (v : Literal) => (fun x_ => match x_ with
| Literal_Decimal v_ => (fun (d : Q) => (inr) (d)) (v_)
| _ => (inl) ("expected decimal literal"%string)
end) (v)) (v_)
| _ => (inl) ("expected literal"%string)
