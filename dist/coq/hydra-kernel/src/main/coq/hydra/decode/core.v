...
(* Module dependencies *)
Require Import hydra.graph hydra.core hydra.errors hydra.lib.eithers hydra.extract.core hydra.lib.maps hydra.lib.maybes hydra.lib.strings.

Definition annotatedTerm_name_bundle :=
  hydra_fix (fun (bundle_ : prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (AnnotatedTerm)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Name)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (WrappedTerm)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Record_)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Field)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Term)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Application)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (CaseStatement)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Injection)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Lambda)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Type_)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (AnnotatedType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (ApplicationType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (EitherType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (FieldType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (ForallType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (FunctionType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (LiteralType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (FloatType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (IntegerType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (MapType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (PairType)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Let)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Binding)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeScheme)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeVariableMetadata)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Literal)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (FloatValue)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (IntegerValue)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Projection)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeApplicationTerm)) (hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeLambda))))))))))))))))))))))))))))))))) =>
    let annotatedTerm := (fst bundle_) in
    let name := (fst (snd bundle_)) in
    let wrappedTerm := (fst (snd (snd bundle_))) in
    let record := (fst (snd (snd (snd bundle_)))) in
    let field := (fst (snd (snd (snd (snd bundle_))))) in
    let term := (fst (snd (snd (snd (snd (snd bundle_)))))) in
    let application := (fst (snd (snd (snd (snd (snd (snd bundle_))))))) in
    let caseStatement := (fst (snd (snd (snd (snd (snd (snd (snd bundle_)))))))) in
    let injection := (fst (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))) in
    let lambda := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))) in
    let type := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))) in
    let annotatedType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))) in
    let applicationType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))) in
    let eitherType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))) in
    let fieldType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))) in
    let forallType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))) in
    let functionType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))) in
    let literalType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))) in
    let floatType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))) in
    let integerType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))) in
    let mapType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))) in
    let pairType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))))) in
    let let_ := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))))) in
    let binding := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))))))) in
    let typeScheme := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))))))) in
    let typeVariableMetadata := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))))))))) in
    let literal := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))))))))) in
    let floatValue := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))))))))))) in
    let integerValue := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))))))))))) in
    let projection := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))))))))))))) in
    let typeApplicationTerm := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))))))))))))) in
    let typeLambda := (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))))))))))))) in
...
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("annotated"%string) (fun (input : Term) => ((eithers.map) (fun (t : AnnotatedType) => (Type__Annotated) (t))) (((annotatedType) (cx)) (input)))) ((cons) ((pair) ("application"%string) (fun (input : Term) => ((eithers.map) (fun (t : ApplicationType) => (Type__Application) (t))) (((applicationType) (cx)) (input)))) ((cons) ((pair) ("either"%string) (fun (input : Term) => ((eithers.map) (fun (t : EitherType) => (Type__Either) (t))) (((eitherType) (cx)) (input)))) ((cons) ((pair) ("forall"%string) (fun (input : Term) => ((eithers.map) (fun (t : ForallType) => (Type__Forall) (t))) (((forallType) (cx)) (input)))) ((cons) ((pair) ("function"%string) (fun (input : Term) => ((eithers.map) (fun (t : FunctionType) => (Type__Function) (t))) (((functionType) (cx)) (input)))) ((cons) ((pair) ("list"%string) (fun (input : Term) => ((eithers.map) (fun (t : Type_) => (Type__List) (t))) (((type) (cx)) (input)))) ((cons) ((pair) ("literal"%string) (fun (input : Term) => ((eithers.map) (fun (t : LiteralType) => (Type__Literal) (t))) (((literalType) (cx)) (input)))) ((cons) ((pair) ("map"%string) (fun (input : Term) => ((eithers.map) (fun (t : MapType) => (Type__Map) (t))) (((mapType) (cx)) (input)))) ((cons) ((pair) ("maybe"%string) (fun (input : Term) => ((eithers.map) (fun (t : Type_) => (Type__Maybe) (t))) (((type) (cx)) (input)))) ((cons) ((pair) ("pair"%string) (fun (input : Term) => ((eithers.map) (fun (t : PairType) => (Type__Pair) (t))) (((pairType) (cx)) (input)))) ((cons) ((pair) ("record"%string) (fun (input : Term) => ((eithers.map) (fun (t : (list) (FieldType)) => (Type__Record) (t))) ((((decodeList) (fieldType)) (cx)) (input)))) ((cons) ((pair) ("set"%string) (fun (input : Term) => ((eithers.map) (fun (t : Type_) => (Type__Set) (t))) (((type) (cx)) (input)))) ((cons) ((pair) ("union"%string) (fun (input : Term) => ((eithers.map) (fun (t : (list) (FieldType)) => (Type__Union) (t))) ((((decodeList) (fieldType)) (cx)) (input)))) ((cons) ((pair) ("unit"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Type__Unit) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("variable"%string) (fun (input : Term) => ((eithers.map) (fun (t : Name) => (Type__Variable) (t))) (((name) (cx)) (input)))) ((cons) ((pair) ("void"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Type__Void) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("wrap"%string) (fun (input : Term) => ((eithers.map) (fun (t : Type_) => (Type__Wrap) (t))) (((type) (cx)) (input)))) (nil)))))))))))))))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (Type_)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("binary"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (LiteralType_Binary) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("boolean"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (LiteralType_Boolean) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("float"%string) (fun (input : Term) => ((eithers.map) (fun (t : FloatType) => (LiteralType_Float) (t))) (((floatType) (cx)) (input)))) ((cons) ((pair) ("integer"%string) (fun (input : Term) => ((eithers.map) (fun (t : IntegerType) => (LiteralType_Integer) (t))) (((integerType) (cx)) (input)))) ((cons) ((pair) ("string"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (LiteralType_String) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) (nil)))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (LiteralType)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("bigfloat"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (FloatType_Bigfloat) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("float32"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (FloatType_Float32) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("float64"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (FloatType_Float64) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) (nil)))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (FloatType)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("bigint"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Bigint) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("int8"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Int8) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("int16"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Int16) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("int32"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Int32) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("int64"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Int64) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("uint8"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Uint8) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("uint16"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Uint16) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("uint32"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Uint32) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("uint64"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (IntegerType_Uint64) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) (nil)))))))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (IntegerType)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("binary"%string) (fun (input : Term) => ((eithers.map) (fun (t : string) => (Literal_Binary) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (v : Literal) => (fun x_ => match x_ with
...
| _ => (inl) ("expected literal"%string)
end) (stripped2))) (((stripWithDecodingError) (cx2)) (raw2))) (cx)) (input)))) (nil)))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (Literal)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("bigfloat"%string) (fun (input : Term) => ((eithers.map) (fun (t : Q) => (FloatValue_Bigfloat) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (v : Literal) => (fun x_ => match x_ with
...
| _ => (inl) ("expected literal"%string)
end) (stripped2))) (((stripWithDecodingError) (cx2)) (raw2))) (cx)) (input)))) (nil)))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (FloatValue)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("bigint"%string) (fun (input : Term) => ((eithers.map) (fun (t : Z) => (IntegerValue_Bigint) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (v : Literal) => (fun x_ => match x_ with
...
| _ => (inl) ("expected literal"%string)
end) (stripped2))) (((stripWithDecodingError) (cx2)) (raw2))) (cx)) (input)))) (nil)))))))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (IntegerValue)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition annotatedTerm : hydra.graph.Graph -> Term -> (sum) (DecodingError) (AnnotatedTerm) :=
  (fst annotatedTerm_name_bundle).
Definition name : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Name) :=
  (fst (snd annotatedTerm_name_bundle)).
Definition wrappedTerm : hydra.graph.Graph -> Term -> (sum) (DecodingError) (WrappedTerm) :=
  (fst (snd (snd annotatedTerm_name_bundle))).
Definition record : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Record_) :=
  (fst (snd (snd (snd annotatedTerm_name_bundle)))).
Definition field : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Field) :=
  (fst (snd (snd (snd (snd annotatedTerm_name_bundle))))).
Definition term : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Term) :=
  (fst (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))).
Definition application : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Application) :=
  (fst (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))).
Definition caseStatement : hydra.graph.Graph -> Term -> (sum) (DecodingError) (CaseStatement) :=
  (fst (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))).
Definition injection : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Injection) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))).
Definition lambda : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Lambda) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))).
Definition type : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Type_) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))).
Definition annotatedType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (AnnotatedType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))).
Definition applicationType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (ApplicationType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))).
Definition eitherType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (EitherType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))).
Definition fieldType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (FieldType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))).
Definition forallType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (ForallType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))).
Definition functionType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (FunctionType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))).
Definition literalType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (LiteralType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))))).
Definition floatType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (FloatType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))).
Definition integerType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (IntegerType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))))))).
Definition mapType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (MapType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))))).
Definition pairType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (PairType) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))))))))).
Definition let_ : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Let) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))))))).
Definition binding : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Binding) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))))))))))).
Definition typeScheme : hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeScheme) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))))))))).
Definition typeVariableMetadata : hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeVariableMetadata) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))))))))))))).
Definition literal : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Literal) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))))))))))).
Definition floatValue : hydra.graph.Graph -> Term -> (sum) (DecodingError) (FloatValue) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))))))))))))))).
Definition integerValue : hydra.graph.Graph -> Term -> (sum) (DecodingError) (IntegerValue) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))))))))))))).
Definition projection : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Projection) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle)))))))))))))))))))))))))))))).
Definition typeApplicationTerm : hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeApplicationTerm) :=
  (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))))))))))))))).
Definition typeLambda : hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeLambda) :=
  (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd annotatedTerm_name_bundle))))))))))))))))))))))))))))))).
