...
(* Module dependencies *)
Require Import hydra.graph hydra.core hydra.errors hydra.lib.eithers hydra.extract.core hydra.decode.core hydra.decode.paths hydra.paths hydra.lib.maps hydra.lib.maybes hydra.lib.strings hydra.error.checking hydra.decode.error.checking hydra.error.core hydra.decode.error.core.

Definition unificationError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UnificationError) :=
...
Definition unificationInferenceError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UnificationInferenceError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition unexpectedShapeError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UnexpectedShapeError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition otherResolutionError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (OtherResolutionError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition otherInferenceError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (OtherInferenceError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition otherError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (OtherError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Wrap v_ => (fun (wrappedTerm : WrappedTerm) => ((eithers.map) (fun (b : string) => b)) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (v : Literal) => (fun x_ => match x_ with
| Literal_String v_ => (fun (s : string) => (inr) (s)) (v_)
...
Definition notEnoughCasesError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (unit) :=
  fun (cx : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx)) (t).
Definition noSuchPrimitiveError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (NoSuchPrimitiveError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition noSuchBindingError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (NoSuchBindingError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition noMatchingFieldError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (NoMatchingFieldError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition resolutionError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (ResolutionError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("noSuchBinding"%string) (fun (input : Term) => ((eithers.map) (fun (t : NoSuchBindingError) => (ResolutionError_NoSuchBinding) (t))) (((noSuchBindingError) (cx)) (input)))) ((cons) ((pair) ("noSuchPrimitive"%string) (fun (input : Term) => ((eithers.map) (fun (t : NoSuchPrimitiveError) => (ResolutionError_NoSuchPrimitive) (t))) (((noSuchPrimitiveError) (cx)) (input)))) ((cons) ((pair) ("noMatchingField"%string) (fun (input : Term) => ((eithers.map) (fun (t : NoMatchingFieldError) => (ResolutionError_NoMatchingField) (t))) (((noMatchingFieldError) (cx)) (input)))) ((cons) ((pair) ("other"%string) (fun (input : Term) => ((eithers.map) (fun (t : OtherResolutionError) => (ResolutionError_Other) (t))) (((otherResolutionError) (cx)) (input)))) ((cons) ((pair) ("unexpectedShape"%string) (fun (input : Term) => ((eithers.map) (fun (t : UnexpectedShapeError) => (ResolutionError_UnexpectedShape) (t))) (((unexpectedShapeError) (cx)) (input)))) (nil)))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (ResolutionError)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw)).
Definition multipleFieldsError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (MultipleFieldsError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition multipleBindingsError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (MultipleBindingsError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition inferenceError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (InferenceError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("checking"%string) (fun (input : Term) => ((eithers.map) (fun (t : CheckingError) => (InferenceError_Checking) (t))) (((hydra.decode.error.checking.checkingError) (cx)) (input)))) ((cons) ((pair) ("other"%string) (fun (input : Term) => ((eithers.map) (fun (t : OtherInferenceError) => (InferenceError_Other) (t))) (((otherInferenceError) (cx)) (input)))) ((cons) ((pair) ("unification"%string) (fun (input : Term) => ((eithers.map) (fun (t : UnificationInferenceError) => (InferenceError_Unification) (t))) (((unificationInferenceError) (cx)) (input)))) (nil)))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (InferenceError)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw)).
Definition emptyListError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (unit) :=
  fun (cx : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx)) (t).
Definition extractionError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (ExtractionError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("emptyList"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (ExtractionError_EmptyList) (t))) (((emptyListError) (cx)) (input)))) ((cons) ((pair) ("multipleBindings"%string) (fun (input : Term) => ((eithers.map) (fun (t : MultipleBindingsError) => (ExtractionError_MultipleBindings) (t))) (((multipleBindingsError) (cx)) (input)))) ((cons) ((pair) ("multipleFields"%string) (fun (input : Term) => ((eithers.map) (fun (t : MultipleFieldsError) => (ExtractionError_MultipleFields) (t))) (((multipleFieldsError) (cx)) (input)))) ((cons) ((pair) ("noMatchingField"%string) (fun (input : Term) => ((eithers.map) (fun (t : NoMatchingFieldError) => (ExtractionError_NoMatchingField) (t))) (((noMatchingFieldError) (cx)) (input)))) ((cons) ((pair) ("noSuchBinding"%string) (fun (input : Term) => ((eithers.map) (fun (t : NoSuchBindingError) => (ExtractionError_NoSuchBinding) (t))) (((noSuchBindingError) (cx)) (input)))) ((cons) ((pair) ("notEnoughCases"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (ExtractionError_NotEnoughCases) (t))) (((notEnoughCasesError) (cx)) (input)))) ((cons) ((pair) ("unexpectedShape"%string) (fun (input : Term) => ((eithers.map) (fun (t : UnexpectedShapeError) => (ExtractionError_UnexpectedShape) (t))) (((unexpectedShapeError) (cx)) (input)))) (nil)))))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (ExtractionError)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw)).
Definition decodingError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (DecodingError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Wrap v_ => (fun (wrappedTerm : WrappedTerm) => ((eithers.map) (fun (b : string) => b)) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (v : Literal) => (fun x_ => match x_ with
| Literal_String v_ => (fun (s : string) => (inr) (s)) (v_)
