...
(* Module dependencies *)
Require Import hydra.graph hydra.core hydra.errors hydra.ast hydra.lib.eithers hydra.lib.maps hydra.extract.core hydra.lib.maybes hydra.lib.strings.

Definition ws : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Ws) :=
...
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("none"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Ws_None) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("space"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Ws_Space) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("break"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Ws_Break) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("breakAndIndent"%string) (fun (input : Term) => ((eithers.map) (fun (t : string) => (Ws_BreakAndIndent) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
...
end) (stripped2))) (((stripWithDecodingError) (cx2)) (raw2))) (cx)) (input)))) ((cons) ((pair) ("doubleBreak"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Ws_DoubleBreak) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) (nil)))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (Ws)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw)).
Definition symbol : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Symbol) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition precedence : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Precedence) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition padding : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Padding) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition indentStyle : hydra.graph.Graph -> Term -> (sum) (DecodingError) (IndentStyle) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("allLines"%string) (fun (input : Term) => ((eithers.map) (fun (t : string) => (IndentStyle_AllLines) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (raw2 : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped2 : Term) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (v : Literal) => (fun x_ => match x_ with
| Literal_String v_ => (fun (s : string) => (inr) (s)) (v_)
| _ => (inl) ("expected string literal"%string)
end) (v)) (v_)
...
Definition blockStyle : hydra.graph.Graph -> Term -> (sum) (DecodingError) (BlockStyle) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition associativity : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Associativity) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("none"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Associativity_None) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("left"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Associativity_Left) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("right"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Associativity_Right) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) ((cons) ((pair) ("both"%string) (fun (input : Term) => ((eithers.map) (fun (t : unit) => (Associativity_Both) (t))) (((fun (cx2 : hydra.graph.Graph) => fun (t : Term) => ((decodeUnit) (cx2)) (t)) (cx)) (input)))) (nil))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (Associativity)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw)).
Definition op : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Op) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition seqExpr_expr_bundle :=
  hydra_fix (fun (bundle_ : prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (SeqExpr)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (Expr)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (BracketExpr)) (prod (hydra.graph.Graph -> Term -> (sum) (DecodingError) (IndentedExpression)) (hydra.graph.Graph -> Term -> (sum) (DecodingError) (OpExpr)))))) =>
...
| Term_Inject v_ => (fun (inj : Injection) => let variantMap := (maps.fromList) ((cons) ((pair) ("const"%string) (fun (input : Term) => ((eithers.map) (fun (t : Symbol) => (Expr_Const) (t))) (((symbol) (cx)) (input)))) ((cons) ((pair) ("indent"%string) (fun (input : Term) => ((eithers.map) (fun (t : IndentedExpression) => (Expr_Indent) (t))) (((indentedExpression) (cx)) (input)))) ((cons) ((pair) ("op"%string) (fun (input : Term) => ((eithers.map) (fun (t : OpExpr) => (Expr_Op) (t))) (((opExpr) (cx)) (input)))) ((cons) ((pair) ("brackets"%string) (fun (input : Term) => ((eithers.map) (fun (t : BracketExpr) => (Expr_Brackets) (t))) (((bracketExpr) (cx)) (input)))) ((cons) ((pair) ("seq"%string) (fun (input : Term) => ((eithers.map) (fun (t : SeqExpr) => (Expr_Seq) (t))) (((seqExpr) (cx)) (input)))) (nil)))))) in let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : Term -> (sum) (DecodingError) (Expr)) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
| _ => (inl) ("expected union"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw))) ((pair (fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition seqExpr : hydra.graph.Graph -> Term -> (sum) (DecodingError) (SeqExpr) :=
  (fst seqExpr_expr_bundle).
Definition expr : hydra.graph.Graph -> Term -> (sum) (DecodingError) (Expr) :=
  (fst (snd seqExpr_expr_bundle)).
Definition bracketExpr : hydra.graph.Graph -> Term -> (sum) (DecodingError) (BracketExpr) :=
  (fst (snd (snd seqExpr_expr_bundle))).
Definition indentedExpression : hydra.graph.Graph -> Term -> (sum) (DecodingError) (IndentedExpression) :=
  (fst (snd (snd (snd seqExpr_expr_bundle)))).
Definition opExpr : hydra.graph.Graph -> Term -> (sum) (DecodingError) (OpExpr) :=
