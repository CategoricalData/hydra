...
Definition parseResult (t0 : Type) : forall (_ : forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) (t0)) , forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) ((ParseResult) (t0)) := fun (a : forall (_ : hydra.graph.Graph) , forall (_ : Term) , (sum) (DecodingError) (t0)) => fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun r_ => (field_name) (r_)) (field) in let fterm := (fun r_ => (field_term) (r_)) (field) in let variantMap := (maps.fromList) ((cons) ((pair) ("success"%string) (fun (input : Term) => ((eithers.map) (fun (t : (ParseSuccess) (t0)) => (ParseResult_Success) (t))) ((((parseSuccess) (a)) (cx)) (input)))) ((cons) ((pair) ("failure"%string) (fun (input : Term) => ((eithers.map) (fun (t : ParseError) => (ParseResult_Failure) (t))) (((parseError) (cx)) (input)))) (nil))) in (((maybes.maybe) ((inl) ((strings.cat) ((cons) ("no such field "%string) ((cons) ((fun w_ => w_) (fname)) ((cons) (" in union"%string) (nil))))))) (fun (f : forall (_ : Term) , (sum) (DecodingError) ((ParseResult) (t0))) => (f) (fterm))) (((maps.lookup) (fname)) (variantMap))) (v_)
