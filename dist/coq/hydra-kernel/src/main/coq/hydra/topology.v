...
orderingIsomorphism_encode : forall (_ : (list) (a)) , (list) (a) ;
orderingIsomorphism_decode : forall (_ : (list) (a)) , (list) (a) ;
}.

Definition Graph : Type := (list) ((prod) (Vertex) ((list) (Vertex))).
