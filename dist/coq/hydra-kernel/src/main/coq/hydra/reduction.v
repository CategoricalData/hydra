...
| _ => dflt
end) (term2)) in let extraVariables := fun (n : Z) => ((lists.map) (fun (i : Z) => ((strings.cat2) ("v"%string)) ((literals.showInt32) (i)))) (((math.range) ((1)%Z)) (n)) in let forCase := fun (f : Field) => ((eithers.bind) (((((((rewrite) (false)) (true)) (nil)) (recurse)) (tx)) ((fun r_ => (field_term) (r_)) (f)))) (fun (r : Term) => (inr) ((Build_Field) ((fun r_ => (field_name) (r_)) (f)) (r))) in let forCaseStatement := fun (cs : CaseStatement) => let csCases := (fun r_ => (caseStatement_cases) (r_)) (cs) in let dflt := (fun r_ => (caseStatement_default) (r_)) (cs) in let tname := (fun r_ => (caseStatement_typeName) (r_)) (cs) in ((eithers.bind) (((eithers.mapMaybe) ((((((rewrite) (false)) (false)) (nil)) (recurse)) (tx))) (dflt))) (fun (rdflt : (option) (Term)) => ((eithers.bind) (((eithers.mapList) (forCase)) (csCases))) (fun (rcases : (list) (Field)) => (inr) ((Term_Cases) ((Build_CaseStatement) (tname) (rdflt) (rcases))))) in let pad := (hydra_fix) (fun pad => fun (vars : (list) (Name)) => fun (body : Term) => (((logic.ifElse) ((lists.null) (vars))) (body)) ((Term_Lambda) ((Build_Lambda) ((lists.head) (vars)) ((None) : (option) (Type_)) (((pad) ((lists.tail) (vars))) ((Term_Application) ((Build_Application) (body) ((Term_Variable) ((lists.head) (vars))))))))) in let padn := fun (n : Z) => fun (body : Term) => ((pad) ((extraVariables) (n))) (body) in let unwind := fun (term2 : Term) => (((lists.foldl) (fun (e : Term) => fun (t : Type_) => (Term_TypeApplication) ((Build_TypeApplicationTerm) (e) (t)))) (term2)) (typeArgs) in let forCases := fun (cs : CaseStatement) => ((eithers.bind) (((eithers.map) (unwind)) ((forCaseStatement) (cs)))) (fun (base : Term) => (inr) ((((logic.ifElse) (((logic.or) (topLevel)) (forced))) (((padn) ((1)%Z)) (base))) (base))) in let forNullaryElim := fun (elimTerm : Term) => let base := (unwind) (elimTerm) in (((logic.ifElse) (((logic.or) (topLevel)) (forced))) (((padn) ((1)%Z)) (base))) (base) in let forceExpansion := fun (t : Term) => ((eithers.bind) (((((typeOf) (cx)) (tx)) (nil)) (t))) (fun (typCx : (prod) (Type_) (Context_)) => let arity := (typeArity) ((pairs.first) (typCx)) in (inr) (((padn) (arity)) ((unwind) (t)))) in let recurseOrForce := fun (term2 : Term) => (((logic.ifElse) (forced)) ((forceExpansion) (term2))) (((recurse) (tx)) ((unwind) (term2))) in let rewriteSpine := (hydra_fix) (fun rewriteSpine => fun (term2 : Term) => (fun x_ => match x_ with
...
| _ => true
end) (term2) in ((logic.and) (eager2)) (isNonLambdaTerm) in let mapping := fun (recurse : forall (_ : Term) , (sum) (Error) (Term)) => fun (mid : Term) => ((eithers.bind) ((((logic.ifElse) (((doRecurse) (eager)) (mid))) ((recurse) (mid))) ((inr) (mid)))) (fun (inner : Term) => (((applyIfNullary) (eager)) (inner)) (nil)) in ((rewriteTermM) (mapping)) (term_)).
