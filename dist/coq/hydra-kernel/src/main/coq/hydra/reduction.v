...
end) (typ))) (mt))) in let peelFunctionDomains := (hydra_fix) (fun peelFunctionDomains => fun (mtyp : (option) (Type_)) => fun (n : Z) => (((logic.ifElse) (((equality.lte) (n)) ((0)%Z))) (mtyp)) ((((maybes.maybe) (None)) (fun (typ : Type_) => (fun x_ => match x_ with
