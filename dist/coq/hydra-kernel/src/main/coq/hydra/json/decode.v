...
| _ => ((inl) ("expected string"%string)) : (sum) (string) (string)
end) (value).
...
| Value_Number v_ => (fun (n : Q) => ((inr) ((Term_Literal) ((Literal_Float) ((FloatValue_Bigfloat) (n))))) : (sum) (string) (Term)) (v_)
| _ => ((inl) ("expected number for bigfloat"%string)) : (sum) (string) (Term)
end) (value)
| FloatType_Float32 _ => let strResult := (expectString) (value) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (s : string) => let parsed := (literals.readFloat32) (s) in (((maybes.maybe) (((inl) ((strings.cat) ((cons) ("invalid float32: "%string) ((cons) (s) (nil))))) : (sum) (string) (Term))) (fun (v : Q) => ((inr) ((Term_Literal) ((Literal_Float) ((FloatValue_Float32) (v))))) : (sum) (string) (Term))) (parsed))) (strResult)
| FloatType_Float64 _ => (fun x_ => match x_ with
| Value_Number v_ => (fun (n : Q) => ((inr) ((Term_Literal) ((Literal_Float) ((FloatValue_Float64) ((literals.bigfloatToFloat64) (n)))))) : (sum) (string) (Term)) (v_)
| Value_String v_ => (fun (s : string) => (((maybes.maybe) (((inl) ((strings.cat) ((cons) ("invalid float64 sentinel: "%string) ((cons) (s) (nil))))) : (sum) (string) (Term))) (fun (v : Q) => ((inr) ((Term_Literal) ((Literal_Float) ((FloatValue_Float64) (v))))) : (sum) (string) (Term))) ((parseSpecialFloat) (s))) (v_)
| _ => ((inl) ("expected number or special float string for float64"%string)) : (sum) (string) (Term)
end) (value)
end) (ft).
Definition expectNumber : forall (_ : Value) , (sum) (string) (Q) := fun (value : Value) => (fun x_ => match x_ with
| Value_Number v_ => (fun (n : Q) => ((inr) (n)) : (sum) (string) (Q)) (v_)
| _ => ((inl) ("expected number"%string)) : (sum) (string) (Q)
end) (value).
...
| IntegerType_Bigint _ => let strResult := (expectString) (value) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (s : string) => let parsed := (literals.readBigint) (s) in (((maybes.maybe) (((inl) ((strings.cat) ((cons) ("invalid bigint: "%string) ((cons) (s) (nil))))) : (sum) (string) (Term))) (fun (v : Z) => ((inr) ((Term_Literal) ((Literal_Integer) ((IntegerValue_Bigint) (v))))) : (sum) (string) (Term))) (parsed))) (strResult)
| IntegerType_Int64 _ => let strResult := (expectString) (value) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (s : string) => let parsed := (literals.readInt64) (s) in (((maybes.maybe) (((inl) ((strings.cat) ((cons) ("invalid int64: "%string) ((cons) (s) (nil))))) : (sum) (string) (Term))) (fun (v : Z) => ((inr) ((Term_Literal) ((Literal_Integer) ((IntegerValue_Int64) (v))))) : (sum) (string) (Term))) (parsed))) (strResult)
| IntegerType_Uint32 _ => let strResult := (expectString) (value) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (s : string) => let parsed := (literals.readUint32) (s) in (((maybes.maybe) (((inl) ((strings.cat) ((cons) ("invalid uint32: "%string) ((cons) (s) (nil))))) : (sum) (string) (Term))) (fun (v : Z) => ((inr) ((Term_Literal) ((Literal_Integer) ((IntegerValue_Uint32) (v))))) : (sum) (string) (Term))) (parsed))) (strResult)
| IntegerType_Uint64 _ => let strResult := (expectString) (value) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (s : string) => let parsed := (literals.readUint64) (s) in (((maybes.maybe) (((inl) ((strings.cat) ((cons) ("invalid uint64: "%string) ((cons) (s) (nil))))) : (sum) (string) (Term))) (fun (v : Z) => ((inr) ((Term_Literal) ((Literal_Integer) ((IntegerValue_Uint64) (v))))) : (sum) (string) (Term))) (parsed))) (strResult)
...
| Value_Boolean v_ => (fun (b : bool) => ((inr) ((Term_Literal) ((Literal_Boolean) (b)))) : (sum) (string) (Term)) (v_)
| _ => ((inl) ("expected boolean"%string)) : (sum) (string) (Term)
end) (value)
| LiteralType_Decimal _ => (fun x_ => match x_ with
| Value_Number v_ => (fun (n : Q) => ((inr) ((Term_Literal) ((Literal_Decimal) ((literals.float64ToDecimal) ((literals.bigfloatToFloat64) (n)))))) : (sum) (string) (Term)) (v_)
| _ => ((inl) ("expected number for decimal"%string)) : (sum) (string) (Term)
end) (value)
...
| Value_Array v_ => (fun (arr : (list) (Value)) => ((inr) (arr)) : (sum) (string) ((list) (Value))) (v_)
| _ => ((inl) ("expected array"%string)) : (sum) (string) ((list) (Value))
end) (value).
Definition expectObject : forall (_ : Value) , (sum) (string) ((list) ((prod) (string) (Value))) := fun (value : Value) => (fun x_ => match x_ with
| Value_Object v_ => (fun (obj : (list) ((prod) (string) (Value))) => ((inr) (obj)) : (sum) (string) ((list) ((prod) (string) (Value)))) (v_)
| _ => ((inl) ("expected object"%string)) : (sum) (string) ((list) ((prod) (string) (Value)))
end) (value).
...
| Type__List v_ => (fun (elemType : Type_) => let arrResult := (expectArray) (value) in let decodeElem := fun (v : Value) => ((((fromJson) (types)) (tname)) (elemType)) (v) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (arr : (list) (Value)) => let decoded := ((eithers.mapList) (decodeElem)) (arr) in ((eithers.map) (fun (ts : (list) (Term)) => (Term_List) (ts))) (decoded))) (arrResult)) (v_)
| Type__Set v_ => (fun (elemType : Type_) => let arrResult := (expectArray) (value) in let decodeElem := fun (v : Value) => ((((fromJson) (types)) (tname)) (elemType)) (v) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (arr : (list) (Value)) => let decoded := ((eithers.mapList) (decodeElem)) (arr) in ((eithers.map) (fun (elems : (list) (Term)) => (Term_Set) ((sets.fromList) (elems)))) (decoded))) (arrResult)) (v_)
...
| Type__Map v_ => (fun (mt : MapType) => let arrResult := (expectArray) (value) in let keyType := (fun r_ => (mapType_keys) (r_)) (mt) in let valType := (fun r_ => (mapType_values) (r_)) (mt) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (arr : (list) (Value)) => let decodeEntry := fun (entryJson : Value) => let objResult := (expectObject) (entryJson) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) ((prod) (Term) (Term)))) (fun (entryObj : (list) ((prod) (string) (Value))) => let keyJson := ((maps.lookup) ("@key"%string)) (entryObj) in let valJson := ((maps.lookup) ("@value"%string)) (entryObj) in (((maybes.maybe) (((inl) ("missing @key in map entry"%string)) : (sum) (string) ((prod) (Term) (Term)))) (fun (kj : Value) => (((maybes.maybe) (((inl) ("missing @value in map entry"%string)) : (sum) (string) ((prod) (Term) (Term)))) (fun (vj : Value) => let decodedKey := ((((fromJson) (types)) (tname)) (keyType)) (kj) in let decodedVal := ((((fromJson) (types)) (tname)) (valType)) (vj) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) ((prod) (Term) (Term)))) (fun (k : Term) => ((eithers.map) (fun (v : Term) => (pair) (k) (v))) (decodedVal))) (decodedKey))) (valJson))) (keyJson))) (objResult) in let entries := ((eithers.mapList) (decodeEntry)) (arr) in ((eithers.map) (fun (es : (list) ((prod) (Term) (Term))) => (Term_Map) ((maps.fromList) (es)))) (entries))) (arrResult)) (v_)
| Type__Pair v_ => (fun (pt : PairType) => let firstType := (fun r_ => (pairType_first) (r_)) (pt) in let objResult := (expectObject) (value) in let secondType := (fun r_ => (pairType_second) (r_)) (pt) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (obj : (list) ((prod) (string) (Value))) => let firstJson := ((maps.lookup) ("@first"%string)) (obj) in let secondJson := ((maps.lookup) ("@second"%string)) (obj) in (((maybes.maybe) (((inl) ("missing @first in pair"%string)) : (sum) (string) (Term))) (fun (fj : Value) => (((maybes.maybe) (((inl) ("missing @second in pair"%string)) : (sum) (string) (Term))) (fun (sj : Value) => let decodedFirst := ((((fromJson) (types)) (tname)) (firstType)) (fj) in let decodedSecond := ((((fromJson) (types)) (tname)) (secondType)) (sj) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (f : Term) => ((eithers.map) (fun (s : Term) => (Term_Pair) ((pair) (f) (s)))) (decodedSecond))) (decodedFirst))) (secondJson))) (firstJson))) (objResult)) (v_)
| Type__Either v_ => (fun (et : EitherType) => let leftType := (fun r_ => (eitherType_left) (r_)) (et) in let objResult := (expectObject) (value) in let rightType := (fun r_ => (eitherType_right) (r_)) (et) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Term))) (fun (obj : (list) ((prod) (string) (Value))) => let leftJson := ((maps.lookup) ("@left"%string)) (obj) in let rightJson := ((maps.lookup) ("@right"%string)) (obj) in (((maybes.maybe) ((((maybes.maybe) (((inl) ("expected @left or @right in Either"%string)) : (sum) (string) (Term))) (fun (rj : Value) => let decoded := ((((fromJson) (types)) (tname)) (rightType)) (rj) in ((eithers.map) (fun (v : Term) => (Term_Either) (((inr) (v)) : (sum) (Term) (Term)))) (decoded))) (rightJson))) (fun (lj : Value) => let decoded := ((((fromJson) (types)) (tname)) (leftType)) (lj) in ((eithers.map) (fun (v : Term) => (Term_Either) (((inl) (v)) : (sum) (Term) (Term)))) (decoded))) (leftJson))) (objResult)) (v_)
| Type__Variable v_ => (fun (name : Name) => let lookedUp := ((maps.lookup) (name)) (types) in (((maybes.maybe) (((inl) ((strings.cat) ((cons) ("unknown type variable: "%string) ((cons) ((fun w_ => w_) (name)) (nil))))) : (sum) (string) (Term))) (fun (resolvedType : Type_) => ((((fromJson) (types)) (name)) (resolvedType)) (value))) (lookedUp)) (v_)
| _ => ((inl) ((strings.cat) ((cons) ("unsupported type for JSON decoding: "%string) ((cons) ((hydra.show.core.type) (typ)) (nil))))) : (sum) (string) (Term)
end) (stripped)).
