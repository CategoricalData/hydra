...
(* Module dependencies *)
Require Import hydra.core hydra.json.model hydra.lib.eithers hydra.lib.equality hydra.lib.lists hydra.lib.literals hydra.lib.logic hydra.lib.maps hydra.lib.maybes hydra.lib.pairs hydra.lib.sets hydra.lib.strings hydra.show.core hydra.strip.
...
| Term_Maybe v_ => (fun (opt : (option) (Term)) => (((maybes.maybe) (((inr) ((Value_Null) (tt))) : (sum) (string) (Value))) (fun (v : Term) => let encodedMaybe := (toJsonUntyped) (v) in ((eithers.map) (fun (encoded : Value) => (Value_Array) ((cons) (encoded) (nil)))) (encodedMaybe))) (opt)) (v_)
| Term_Record v_ => (fun (r : Record_) => let encodeField := fun (f : Field) => let fterm := (fun r_ => (field_term) (r_)) (f) in let encodedField := (toJsonUntyped) (fterm) in let fname := (fun w_ => w_) ((fun r_ => (field_name) (r_)) (f)) in ((eithers.map) (fun (v : Value) => (pair) (fname) (v))) (encodedField) in let fields := (fun r_ => (record__fields) (r_)) (r) in let encodedFields := ((eithers.mapList) (encodeField)) (fields) in ((eithers.map) (fun (fs : (list) ((prod) (string) (Value))) => (Value_Object) ((maps.fromList) (fs)))) (encodedFields)) (v_)
| Term_Inject v_ => (fun (inj : Injection) => let field := (fun r_ => (injection_field) (r_)) (inj) in let fterm := (fun r_ => (field_term) (r_)) (field) in let encodedUnion := (toJsonUntyped) (fterm) in let fname := (fun w_ => w_) ((fun r_ => (field_name) (r_)) (field)) in ((eithers.map) (fun (v : Value) => (Value_Object) ((maps.fromList) ((cons) ((pair) (fname) (v)) (nil))))) (encodedUnion)) (v_)
| Term_Unit _ => ((inr) ((Value_Object) (maps.empty))) : (sum) (string) (Value)
| Term_Wrap v_ => (fun (wt : WrappedTerm) => (toJsonUntyped) ((fun r_ => (wrappedTerm_body) (r_)) (wt))) (v_)
| Term_Map v_ => (fun (m : (list) ((prod) (Term) (Term))) => let encodeEntry := fun (kv : (prod) (Term) (Term)) => let k := (pairs.first) (kv) in let encodedK := (toJsonUntyped) (k) in let v := (pairs.second) (kv) in let encodedV := (toJsonUntyped) (v) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Value))) (fun (ek : Value) => ((eithers.map) (fun (ev : Value) => (Value_Object) ((maps.fromList) ((cons) ((pair) ("@key"%string) (ek)) ((cons) ((pair) ("@value"%string) (ev)) (nil)))))) (encodedV))) (encodedK) in let entries := ((eithers.mapList) (encodeEntry)) ((maps.toList) (m)) in ((eithers.map) (fun (es : (list) (Value)) => (Value_Array) (es))) (entries)) (v_)
| Term_Pair v_ => (fun (p : (prod) (Term) (Term)) => let first := (pairs.first) (p) in let encodedFirst := (toJsonUntyped) (first) in let second := (pairs.second) (p) in let encodedSecond := (toJsonUntyped) (second) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Value))) (fun (ef : Value) => ((eithers.map) (fun (es : Value) => (Value_Object) ((maps.fromList) ((cons) ((pair) ("@first"%string) (ef)) ((cons) ((pair) ("@second"%string) (es)) (nil)))))) (encodedSecond))) (encodedFirst)) (v_)
...
| _ => ((inl) ((strings.cat) ((cons) ("unsupported term variant for JSON encoding: "%string) ((cons) ((hydra.show.core.term) (term_)) (nil))))) : (sum) (string) (Value)
end) (stripped)).
...
Definition toJson_bundle :=
  hydra_fix (fun (bundle_ : forall (_ : (list) ((prod) (Name) (Type_))) , forall (_ : Name) , forall (_ : Type_) , forall (_ : Term) , (sum) (string) (Value)) =>
    ...
    fun (types : (list) ((prod) (Name) (Type_))) => fun (tname : Name) => fun (typ : Type_) => fun (term_ : Term) => let stripped := (deannotateType) (typ) in let strippedTerm := (deannotateTerm) (term_) in (fun x_ => match x_ with
| Type__Literal v_ => (fun (_ : LiteralType) => (fun x_ => match x_ with
| Term_Literal v_ => (fun (lit : Literal) => (encodeLiteral) (lit)) (v_)
| _ => ((inl) ("expected literal term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
...
| _ => ((inl) ("expected list term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
...
| _ => ((inl) ("expected set term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
...
| Term_Maybe v_ => (fun (opt : (option) (Term)) => (((maybes.maybe) (((inr) ((Value_Null) (tt))) : (sum) (string) (Value))) (fun (v : Term) => let encoded := ((((toJson) (types)) (tname)) (innerType)) (v) in (((logic.ifElse) (isNestedMaybe)) (((eithers.map) (fun (ev : Value) => (Value_Array) ((cons) (ev) (nil)))) (encoded))) (encoded))) (opt)) (v_)
| _ => ((inl) ("expected maybe term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
...
| Term_Maybe v_ => (fun (opt : (option) (Term)) => (((maybes.maybe) (((inr) ((None) : (option) ((prod) (string) (Value)))) : (sum) (string) ((option) ((prod) (string) (Value))))) (fun (v : Term) => let innerType := (fun x_ => match x_ with
...
| _ => ((inl) ("expected maybe term for optional field"%string)) : (sum) (string) ((option) ((prod) (string) (Value)))
end) ((deannotateTerm) (fterm)))) (let encoded := ((((toJson) (types)) (tname)) (ftype)) (fterm) in ((eithers.map) (fun (ev : Value) => (Some) ((pair) (fname) (ev)))) (encoded)) in let fieldTypes := rt in let fields := (fun r_ => (record__fields) (r_)) (r) in let encodedPairs := ((eithers.mapList) (fun (ftf : (prod) (FieldType) (Field)) => ((encodeFieldWithType) ((pairs.first) (ftf))) ((pairs.second) (ftf)))) (((lists.zip) (fieldTypes)) (fields)) in ((eithers.map) (fun (pairs : (list) ((option) ((prod) (string) (Value)))) => (Value_Object) ((maps.fromList) ((maybes.cat) (pairs))))) (encodedPairs)) (v_)
| _ => ((inl) ("expected record term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
| Type__Union v_ => (fun (rt : (list) (FieldType)) => (fun x_ => match x_ with
| Term_Inject v_ => (fun (inj : Injection) => let field := (fun r_ => (injection_field) (r_)) (inj) in let fname := (fun w_ => w_) ((fun r_ => (field_name) (r_)) (field)) in let findFieldType := (hydra_fix) (fun findFieldType => fun (fts : (list) (FieldType)) => (((logic.ifElse) ((lists.null) (fts))) (((inl) ((strings.cat) ((cons) ("unknown variant: "%string) ((cons) (fname) (nil))))) : (sum) (string) (Type_))) ((((logic.ifElse) (((equality.equal) ((fun w_ => w_) ((fun r_ => (fieldType_name) (r_)) ((lists.head) (fts))))) (fname))) (((inr) ((fun r_ => (fieldType_type) (r_)) ((lists.head) (fts)))) : (sum) (string) (Type_))) ((findFieldType) ((lists.tail) (fts))))) in let fterm := (fun r_ => (field_term) (r_)) (field) in let ftypeResult := (findFieldType) (rt) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Value))) (fun (ftype : Type_) => let encodedUnion := ((((toJson) (types)) (tname)) (ftype)) (fterm) in ((eithers.map) (fun (v : Value) => (Value_Object) ((maps.fromList) ((cons) ((pair) (fname) (v)) (nil))))) (encodedUnion))) (ftypeResult)) (v_)
| _ => ((inl) ("expected union term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
| Type__Unit _ => ((inr) ((Value_Object) (maps.empty))) : (sum) (string) (Value)
...
| _ => ((inl) ("expected wrapped term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
| Type__Map v_ => (fun (mt : MapType) => let keyType := (fun r_ => (mapType_keys) (r_)) (mt) in let valType := (fun r_ => (mapType_values) (r_)) (mt) in (fun x_ => match x_ with
| Term_Map v_ => (fun (m : (list) ((prod) (Term) (Term))) => let encodeEntry := fun (kv : (prod) (Term) (Term)) => let k := (pairs.first) (kv) in let encodedK := ((((toJson) (types)) (tname)) (keyType)) (k) in let v := (pairs.second) (kv) in let encodedV := ((((toJson) (types)) (tname)) (valType)) (v) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Value))) (fun (ek : Value) => ((eithers.map) (fun (ev : Value) => (Value_Object) ((maps.fromList) ((cons) ((pair) ("@key"%string) (ek)) ((cons) ((pair) ("@value"%string) (ev)) (nil)))))) (encodedV))) (encodedK) in let entries := ((eithers.mapList) (encodeEntry)) ((maps.toList) (m)) in ((eithers.map) (fun (es : (list) (Value)) => (Value_Array) (es))) (entries)) (v_)
| _ => ((inl) ("expected map term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
| Type__Pair v_ => (fun (pt : PairType) => let firstType := (fun r_ => (pairType_first) (r_)) (pt) in let secondType := (fun r_ => (pairType_second) (r_)) (pt) in (fun x_ => match x_ with
| Term_Pair v_ => (fun (p : (prod) (Term) (Term)) => let first := (pairs.first) (p) in let encodedFirst := ((((toJson) (types)) (tname)) (firstType)) (first) in let second := (pairs.second) (p) in let encodedSecond := ((((toJson) (types)) (tname)) (secondType)) (second) in (((eithers.either) (fun (err : string) => ((inl) (err)) : (sum) (string) (Value))) (fun (ef : Value) => ((eithers.map) (fun (es : Value) => (Value_Object) ((maps.fromList) ((cons) ((pair) ("@first"%string) (ef)) ((cons) ((pair) ("@second"%string) (es)) (nil)))))) (encodedSecond))) (encodedFirst)) (v_)
| _ => ((inl) ("expected pair term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
| Type__Either v_ => (fun (et : EitherType) => let leftType := (fun r_ => (eitherType_left) (r_)) (et) in let rightType := (fun r_ => (eitherType_right) (r_)) (et) in (fun x_ => match x_ with
...
| _ => ((inl) ("expected either term"%string)) : (sum) (string) (Value)
end) (strippedTerm)) (v_)
...
| _ => ((inl) ((strings.cat) ((cons) ("unsupported type for JSON encoding: "%string) ((cons) ((hydra.show.core.type) (typ)) (nil))))) : (sum) (string) (Value)
end) (stripped)).
