...
| Value_Boolean v_ => (fun (b : bool) => ((inr) (b)) : (sum) (string) (bool)) (v_)
| _ => ((inl) ("expected a boolean"%string)) : (sum) (string) (bool)
end.
...
| Value_Object v_ => (fun (o : (list) ((prod) (string) (Value))) => ((inr) (o)) : (sum) (string) ((list) ((prod) (string) (Value)))) (v_)
| _ => ((inl) ("expected an object"%string)) : (sum) (string) ((list) ((prod) (string) (Value)))
end.
...
| _ => ((inl) ("expected a string"%string)) : (sum) (string) (string)
end.
