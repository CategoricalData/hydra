...
Definition unificationError : forall (_ : UnificationError) , string := fun (e : UnificationError) => let rt := (fun r_ => (unificationError_rightType) (r_)) (e) in let msg := (fun r_ => (unificationError_message) (r_)) (e) in let lt := (fun r_ => (unificationError_leftType) (r_)) (e) in (strings.cat) ((cons) ("unification error: cannot unify "%string) ((cons) ((hydra.show.core.type) (lt)) ((cons) (" with "%string) ((cons) ((hydra.show.core.type) (rt)) ((cons) (": "%string) ((cons) (msg) (nil))))))).
Definition unequalTypesError : forall (_ : UnequalTypesError) , string := fun (e : UnequalTypesError) => let types := (fun r_ => (unequalTypesError_types) (r_)) (e) in let desc := (fun r_ => (unequalTypesError_description) (r_)) (e) in (strings.cat) ((cons) ("unequal types "%string) ((cons) (((showList) (hydra.show.core.type)) (types)) ((cons) (" in "%string) ((cons) (desc) (nil))))).
...
Definition typeMismatchError : forall (_ : TypeMismatchError) , string := fun (e : TypeMismatchError) => let expected := (fun r_ => (typeMismatchError_expectedType) (r_)) (e) in let actual := (fun r_ => (typeMismatchError_actualType) (r_)) (e) in (strings.cat) ((cons) ("type mismatch: expected "%string) ((cons) ((hydra.show.core.type) (expected)) ((cons) (" but found "%string) ((cons) ((hydra.show.core.type) (actual)) (nil))))).
...
Definition notAForallTypeError : forall (_ : NotAForallTypeError) , string := fun (e : NotAForallTypeError) => let typ := (fun r_ => (notAForallTypeError_type) (r_)) (e) in let args := (fun r_ => (notAForallTypeError_typeArguments) (r_)) (e) in (strings.cat) ((cons) ("not a forall type: "%string) ((cons) ((hydra.show.core.type) (typ)) ((cons) (". Trying to apply "%string) ((cons) ((literals.showInt32) ((lists.length) (args))) ((cons) (" type argument(s): "%string) ((cons) (((showList) (hydra.show.core.type)) (args)) (nil))))))).
