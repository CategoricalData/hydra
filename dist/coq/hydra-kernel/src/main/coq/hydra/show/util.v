...
Definition caseConvention : forall (_ : CaseConvention) , string := fun (c : CaseConvention) => (fun x_ => match x_ with
...
Definition comparison : forall (_ : Comparison) , string := fun (c : Comparison) => (fun x_ => match x_ with
