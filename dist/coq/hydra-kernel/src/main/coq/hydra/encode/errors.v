...
Definition otherResolutionError : forall (_ : OtherResolutionError) , Term := fun (x : OtherResolutionError) => (Term_Wrap) ((Build_WrappedTerm) ("OtherResolutionError"%string) ((fun (x2 : string) => (Term_Literal) ((Literal_String) (x2))) ((fun w_ => w_) (x)))).
Definition otherInferenceError : forall (_ : OtherInferenceError) , Term := fun (x : OtherInferenceError) => (Term_Record) ((Build_Record_) ("OtherInferenceError"%string) ((cons) ((Build_Field) ("path"%string) ((hydra.encode.paths.subtermPath) ((fun r_ => (otherInferenceError_path) (r_)) (x)))) ((cons) ((Build_Field) ("message"%string) ((fun (x2 : string) => (Term_Literal) ((Literal_String) (x2))) ((fun r_ => (otherInferenceError_message) (r_)) (x)))) (nil)))).
Definition otherError : forall (_ : OtherError) , Term := fun (x : OtherError) => (Term_Wrap) ((Build_WrappedTerm) ("OtherError"%string) ((fun (x2 : string) => (Term_Literal) ((Literal_String) (x2))) ((fun w_ => w_) (x)))).
Definition notEnoughCasesError (t0 : Type) : forall (_ : t0) , Term := fun (_ : t0) => (Term_Unit) (tt).
Arguments notEnoughCasesError {t0}.
Definition noSuchPrimitiveError : forall (_ : NoSuchPrimitiveError) , Term := fun (x : NoSuchPrimitiveError) => (Term_Record) ((Build_Record_) ("NoSuchPrimitiveError"%string) ((cons) ((Build_Field) ("name"%string) ((hydra.encode.core.name) ((fun r_ => (noSuchPrimitiveError_name) (r_)) (x)))) (nil))).
Definition noSuchBindingError : forall (_ : NoSuchBindingError) , Term := fun (x : NoSuchBindingError) => (Term_Record) ((Build_Record_) ("NoSuchBindingError"%string) ((cons) ((Build_Field) ("name"%string) ((hydra.encode.core.name) ((fun r_ => (noSuchBindingError_name) (r_)) (x)))) (nil))).
Definition noMatchingFieldError : forall (_ : NoMatchingFieldError) , Term := fun (x : NoMatchingFieldError) => (Term_Record) ((Build_Record_) ("NoMatchingFieldError"%string) ((cons) ((Build_Field) ("fieldName"%string) ((hydra.encode.core.name) ((fun r_ => (noMatchingFieldError_fieldName) (r_)) (x)))) (nil))).
...
Definition multipleFieldsError : forall (_ : MultipleFieldsError) , Term := fun (x : MultipleFieldsError) => (Term_Record) ((Build_Record_) ("MultipleFieldsError"%string) ((cons) ((Build_Field) ("fieldName"%string) ((hydra.encode.core.name) ((fun r_ => (multipleFieldsError_fieldName) (r_)) (x)))) (nil))).
Definition multipleBindingsError : forall (_ : MultipleBindingsError) , Term := fun (x : MultipleBindingsError) => (Term_Record) ((Build_Record_) ("MultipleBindingsError"%string) ((cons) ((Build_Field) ("name"%string) ((hydra.encode.core.name) ((fun r_ => (multipleBindingsError_name) (r_)) (x)))) (nil))).
...
Definition decodingError : forall (_ : DecodingError) , Term := fun (x : DecodingError) => (Term_Wrap) ((Build_WrappedTerm) ("DecodingError"%string) ((fun (x2 : string) => (Term_Literal) ((Literal_String) (x2))) ((fun w_ => w_) (x)))).
