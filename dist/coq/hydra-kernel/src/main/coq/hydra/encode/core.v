...
| IntegerValue_Int32 v_ => (fun (y : Z) => (Term_Inject) ((Build_Injection) ("IntegerValue"%string) ((Build_Field) ("int32"%string) ((fun (x : Z) => (Term_Literal) ((Literal_Integer) ((IntegerValue_Int32) (x)))) (y))))) (v_)
| IntegerValue_Int64 v_ => (fun (y : Z) => (Term_Inject) ((Build_Injection) ("IntegerValue"%string) ((Build_Field) ("int64"%string) ((fun (x : Z) => (Term_Literal) ((Literal_Integer) ((IntegerValue_Int64) (x)))) (y))))) (v_)
| IntegerValue_Uint8 v_ => (fun (y : Z) => (Term_Inject) ((Build_Injection) ("IntegerValue"%string) ((Build_Field) ("uint8"%string) ((fun (x : Z) => (Term_Literal) ((Literal_Integer) ((IntegerValue_Uint8) (x)))) (y))))) (v_)
| IntegerValue_Uint16 v_ => (fun (y : Z) => (Term_Inject) ((Build_Injection) ("IntegerValue"%string) ((Build_Field) ("uint16"%string) ((fun (x : Z) => (Term_Literal) ((Literal_Integer) ((IntegerValue_Uint16) (x)))) (y))))) (v_)
...
| IntegerType_Int32 v_ => (fun (y : unit) => (Term_Inject) ((Build_Injection) ("IntegerType"%string) ((Build_Field) ("int32"%string) ((fun (_ : unit) => (Term_Unit) (tt)) (y))))) (v_)
| IntegerType_Int64 v_ => (fun (y : unit) => (Term_Inject) ((Build_Injection) ("IntegerType"%string) ((Build_Field) ("int64"%string) ((fun (_ : unit) => (Term_Unit) (tt)) (y))))) (v_)
| IntegerType_Uint8 v_ => (fun (y : unit) => (Term_Inject) ((Build_Injection) ("IntegerType"%string) ((Build_Field) ("uint8"%string) ((fun (_ : unit) => (Term_Unit) (tt)) (y))))) (v_)
| IntegerType_Uint16 v_ => (fun (y : unit) => (Term_Inject) ((Build_Injection) ("IntegerType"%string) ((Build_Field) ("uint16"%string) ((fun (_ : unit) => (Term_Unit) (tt)) (y))))) (v_)
...
| LiteralType_Integer v_ => (fun (y : IntegerType) => (Term_Inject) ((Build_Injection) ("LiteralType"%string) ((Build_Field) ("integer"%string) ((integerType) (y))))) (v_)
...
Definition annotatedTerm_term_bundle :=
  hydra_fix (fun (bundle_ : prod (forall (_ : AnnotatedTerm) , Term) (prod (forall (_ : Term) , Term) (prod (forall (_ : Application) , Term) (prod (forall (_ : CaseStatement) , Term) (prod (forall (_ : Field) , Term) (prod (forall (_ : Injection) , Term) (prod (forall (_ : Lambda) , Term) (prod (forall (_ : Type_) , Term) (prod (forall (_ : AnnotatedType) , Term) (prod (forall (_ : ApplicationType) , Term) (prod (forall (_ : EitherType) , Term) (prod (forall (_ : FieldType) , Term) (prod (forall (_ : ForallType) , Term) (prod (forall (_ : FunctionType) , Term) (prod (forall (_ : MapType) , Term) (prod (forall (_ : PairType) , Term) (prod (forall (_ : Let) , Term) (prod (forall (_ : Binding) , Term) (prod (forall (_ : TypeScheme) , Term) (prod (forall (_ : Record_) , Term) (prod (forall (_ : TypeApplicationTerm) , Term) (prod (forall (_ : TypeLambda) , Term) (forall (_ : WrappedTerm) , Term))))))))))))))))))))))) =>
    ...
    let caseStatement := (fst (snd (snd (snd bundle_)))) in
    ...
    let type := (fst (snd (snd (snd (snd (snd (snd (snd bundle_)))))))) in
    let annotatedType := (fst (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))) in
    let applicationType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))) in
    let eitherType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))) in
    let fieldType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))) in
    let forallType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))) in
    let functionType := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))) in
    ...
    let let_ := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))) in
    let binding := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))) in
    let typeScheme := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))) in
    let record := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))) in
    let typeApplicationTerm := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_))))))))))))))))))))) in
    let typeLambda := (fst (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd (snd bundle_)))))))))))))))))))))) in
...
| Term_Annotated v_ => (fun (y : AnnotatedTerm) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("annotated"%string) ((annotatedTerm) (y))))) (v_)
| Term_Application v_ => (fun (y : Application) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("application"%string) ((application) (y))))) (v_)
| Term_Cases v_ => (fun (y : CaseStatement) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("cases"%string) ((caseStatement) (y))))) (v_)
| Term_Either v_ => (fun (y : (sum) (Term) (Term)) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("either"%string) ((fun (e : (sum) (Term) (Term)) => (Term_Either) ((((eithers.bimap) (term)) (term)) (e))) (y))))) (v_)
| Term_Inject v_ => (fun (y : Injection) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("inject"%string) ((injection) (y))))) (v_)
| Term_Lambda v_ => (fun (y : Lambda) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("lambda"%string) ((lambda) (y))))) (v_)
| Term_Let v_ => (fun (y : Let) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("let"%string) ((let_) (y))))) (v_)
| Term_List v_ => (fun (y : (list) (Term)) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("list"%string) ((fun (xs : (list) (Term)) => (Term_List) (((lists.map) (term)) (xs))) (y))))) (v_)
| Term_Literal v_ => (fun (y : Literal) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("literal"%string) ((literal) (y))))) (v_)
| Term_Map v_ => (fun (y : (list) ((prod) (Term) (Term))) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("map"%string) ((fun (m : (list) ((prod) (Term) (Term))) => (Term_Map) ((((maps.bimap) (term)) (term)) (m))) (y))))) (v_)
| Term_Maybe v_ => (fun (y : (option) (Term)) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("maybe"%string) ((fun (opt : (option) (Term)) => (Term_Maybe) (((maybes.map) (term)) (opt))) (y))))) (v_)
| Term_Pair v_ => (fun (y : (prod) (Term) (Term)) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("pair"%string) ((fun (p : (prod) (Term) (Term)) => (Term_Pair) ((((pairs.bimap) (term)) (term)) (p))) (y))))) (v_)
| Term_Project v_ => (fun (y : Projection) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("project"%string) ((projection) (y))))) (v_)
| Term_Record v_ => (fun (y : Record_) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("record"%string) ((record) (y))))) (v_)
| Term_Set v_ => (fun (y : (list) (Term)) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("set"%string) ((fun (s : (list) (Term)) => (Term_Set) (((sets.map) (term)) (s))) (y))))) (v_)
| Term_TypeApplication v_ => (fun (y : TypeApplicationTerm) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("typeApplication"%string) ((typeApplicationTerm) (y))))) (v_)
| Term_TypeLambda v_ => (fun (y : TypeLambda) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("typeLambda"%string) ((typeLambda) (y))))) (v_)
| Term_Unit v_ => (fun (y : unit) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("unit"%string) ((fun (_ : unit) => (Term_Unit) (tt)) (y))))) (v_)
| Term_Unwrap v_ => (fun (y : Name) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("unwrap"%string) ((name) (y))))) (v_)
| Term_Variable v_ => (fun (y : Name) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("variable"%string) ((name) (y))))) (v_)
| Term_Wrap v_ => (fun (y : WrappedTerm) => (Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("wrap"%string) ((wrappedTerm) (y))))) (v_)
end) ((pair (fun (x : Application) => (Term_Record) ((Build_Record_) ("Application"%string) ((cons) ((Build_Field) ("function"%string) ((term) ((fun r_ => (application_function) (r_)) (x)))) ((cons) ((Build_Field) ("argument"%string) ((term) ((fun r_ => (application_argument) (r_)) (x)))) (nil))))) ((pair (fun (x : CaseStatement) => (Term_Record) ((Build_Record_) ("CaseStatement"%string) ((cons) ((Build_Field) ("typeName"%string) ((name) ((fun r_ => (caseStatement_typeName) (r_)) (x)))) ((cons) ((Build_Field) ("default"%string) ((fun (opt : (option) (Term)) => (Term_Maybe) (((maybes.map) (term)) (opt))) ((fun r_ => (caseStatement_default) (r_)) (x)))) ((cons) ((Build_Field) ("cases"%string) ((fun (xs : (list) (Field)) => (Term_List) (((lists.map) (field)) (xs))) ((fun r_ => (caseStatement_cases) (r_)) (x)))) (nil)))))) ((pair (fun (x : Field) => (Term_Record) ((Build_Record_) ("Field"%string) ((cons) ((Build_Field) ("name"%string) ((name) ((fun r_ => (field_name) (r_)) (x)))) ((cons) ((Build_Field) ("term"%string) ((term) ((fun r_ => (field_term) (r_)) (x)))) (nil))))) ((pair (fun (x : Injection) => (Term_Record) ((Build_Record_) ("Injection"%string) ((cons) ((Build_Field) ("typeName"%string) ((name) ((fun r_ => (injection_typeName) (r_)) (x)))) ((cons) ((Build_Field) ("field"%string) ((field) ((fun r_ => (injection_field) (r_)) (x)))) (nil))))) ((pair (fun (x : Lambda) => (Term_Record) ((Build_Record_) ("Lambda"%string) ((cons) ((Build_Field) ("parameter"%string) ((name) ((fun r_ => (lambda_parameter) (r_)) (x)))) ((cons) ((Build_Field) ("domain"%string) ((fun (opt : (option) (Type_)) => (Term_Maybe) (((maybes.map) (type)) (opt))) ((fun r_ => (lambda_domain) (r_)) (x)))) ((cons) ((Build_Field) ("body"%string) ((term) ((fun r_ => (lambda_body) (r_)) (x)))) (nil)))))) ((pair (fun x_ => match x_ with
| Type__Annotated v_ => (fun (y : AnnotatedType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("annotated"%string) ((annotatedType) (y))))) (v_)
| Type__Application v_ => (fun (y : ApplicationType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("application"%string) ((applicationType) (y))))) (v_)
| Type__Either v_ => (fun (y : EitherType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("either"%string) ((eitherType) (y))))) (v_)
| Type__Forall v_ => (fun (y : ForallType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("forall"%string) ((forallType) (y))))) (v_)
| Type__Function v_ => (fun (y : FunctionType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("function"%string) ((functionType) (y))))) (v_)
| Type__List v_ => (fun (y : Type_) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("list"%string) ((type) (y))))) (v_)
| Type__Literal v_ => (fun (y : LiteralType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("literal"%string) ((literalType) (y))))) (v_)
| Type__Map v_ => (fun (y : MapType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("map"%string) ((mapType) (y))))) (v_)
| Type__Maybe v_ => (fun (y : Type_) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("maybe"%string) ((type) (y))))) (v_)
| Type__Pair v_ => (fun (y : PairType) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("pair"%string) ((pairType) (y))))) (v_)
| Type__Record v_ => (fun (y : (list) (FieldType)) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("record"%string) ((fun (xs : (list) (FieldType)) => (Term_List) (((lists.map) (fieldType)) (xs))) (y))))) (v_)
| Type__Set v_ => (fun (y : Type_) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("set"%string) ((type) (y))))) (v_)
| Type__Union v_ => (fun (y : (list) (FieldType)) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("union"%string) ((fun (xs : (list) (FieldType)) => (Term_List) (((lists.map) (fieldType)) (xs))) (y))))) (v_)
| Type__Unit v_ => (fun (y : unit) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("unit"%string) ((fun (_ : unit) => (Term_Unit) (tt)) (y))))) (v_)
| Type__Variable v_ => (fun (y : Name) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("variable"%string) ((name) (y))))) (v_)
| Type__Void v_ => (fun (y : unit) => (Term_Inject) ((Build_Injection) ("Type_"%string) ((Build_Field) ("void"%string) ((fun (_ : unit) => (Term_Unit) (tt)) (y))))) (v_)
