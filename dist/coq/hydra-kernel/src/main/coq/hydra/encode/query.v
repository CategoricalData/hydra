...
Definition variable : forall (_ : Variable_) , Term := fun (x : Variable_) => (Term_Wrap) ((Build_WrappedTerm) ("Variable_"%string) ((fun (x2 : string) => (Term_Literal) ((Literal_String) (x2))) ((fun w_ => w_) (x)))).
Definition range : forall (_ : Range) , Term := fun (x : Range) => (Term_Record) ((Build_Record_) ("Range"%string) ((cons) ((Build_Field) ("min"%string) ((fun (x2 : Z) => (Term_Literal) ((Literal_Integer) ((IntegerValue_Int32) (x2)))) ((fun r_ => (range_min) (r_)) (x)))) ((cons) ((Build_Field) ("max"%string) ((fun (x2 : Z) => (Term_Literal) ((Literal_Integer) ((IntegerValue_Int32) (x2)))) ((fun r_ => (range_max) (r_)) (x)))) (nil)))).
...
Definition pathEquation : forall (_ : PathEquation) , Term := fun (x : PathEquation) => (Term_Record) ((Build_Record_) ("PathEquation"%string) ((cons) ((Build_Field) ("left"%string) ((path) ((fun r_ => (pathEquation_left) (r_)) (x)))) ((cons) ((Build_Field) ("right"%string) ((path) ((fun r_ => (pathEquation_right) (r_)) (x)))) (nil)))).
Definition triplePattern : forall (_ : TriplePattern) , Term := fun (x : TriplePattern) => (Term_Record) ((Build_Record_) ("TriplePattern"%string) ((cons) ((Build_Field) ("subject"%string) ((node) ((fun r_ => (triplePattern_subject) (r_)) (x)))) ((cons) ((Build_Field) ("predicate"%string) ((path) ((fun r_ => (triplePattern_predicate) (r_)) (x)))) ((cons) ((Build_Field) ("object"%string) ((node) ((fun r_ => (triplePattern_object) (r_)) (x)))) (nil))))).
Definition pattern_graphPattern_bundle :=
  hydra_fix (fun (bundle_ : prod (forall (_ : Pattern) , Term) (forall (_ : GraphPattern) , Term)) =>
