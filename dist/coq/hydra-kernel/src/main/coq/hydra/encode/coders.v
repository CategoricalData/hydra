...
Definition languageName : forall (_ : LanguageName) , Term := fun (x : LanguageName) => (Term_Wrap) ((Build_WrappedTerm) ("LanguageName"%string) ((fun (x2 : string) => (Term_Literal) ((Literal_String) (x2))) ((fun w_ => w_) (x)))).
