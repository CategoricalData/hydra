...
Definition pruneLet : forall (_ : Let) , Let := fun (l : Let) => let rootName := "[[[root]]]"%string in let bindingMap := (maps.fromList) (((lists.map) (fun (b : Binding) => (pair) ((fun r_ => (binding_name) (r_)) (b)) ((fun r_ => (binding_term) (r_)) (b)))) ((fun r_ => (let_bindings) (r_)) (l))) in let adj := fun (n : Name) => ((sets.intersection) ((sets.fromList) ((maps.keys) (bindingMap)))) ((freeVariablesInTerm) ((((logic.ifElse) (((equality.equal) (n)) (rootName))) ((fun r_ => (let_body) (r_)) (l))) ((maybes.fromJust) (((maps.lookup) (n)) (bindingMap))))) in let reachable := ((findReachableNodes) (adj)) (rootName) in let prunedBindings := ((lists.filter) (fun (b : Binding) => ((sets.member) ((fun r_ => (binding_name) (r_)) (b))) (reachable))) ((fun r_ => (let_bindings) (r_)) (l)) in (Build_Let) (prunedBindings) ((fun r_ => (let_body) (r_)) (l)).
...
Definition inlineType : forall (_ : (list) ((prod) (Name) (Type_))) , forall (_ : Type_) , (sum) (Error) (Type_) :=
  inlineType_bundle.
Definition flattenLetTerms : forall (_ : Term) , Term := fun (term_ : Term) => let rewriteBinding := (hydra_fix) (fun rewriteBinding => fun (binding : Binding) => let val0 := (fun r_ => (binding_term) (r_)) (binding) in let t := (fun r_ => (binding_type) (r_)) (binding) in let key0 := (fun r_ => (binding_name) (r_)) (binding) in (fun x_ => match x_ with
