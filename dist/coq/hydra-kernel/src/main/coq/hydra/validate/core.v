...
| Term_Lambda v_ => (fun (lam : Lambda) => let param := (fun r_ => (lambda_parameter) (r_)) (lam) in let body := (fun r_ => (lambda_body) (r_)) (lam) in (fun x_ => match x_ with
...
| Term_Cases v_ => (fun (cs : CaseStatement) => let tname := (fun r_ => (caseStatement_typeName) (r_)) (cs) in let csDefault := (fun r_ => (caseStatement_default) (r_)) (cs) in let csCases := (fun r_ => (caseStatement_cases) (r_)) (cs) in (firstError) ((cons) ((((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) (None)) ((cons) ((((logic.ifElse) (((logic.and) ((lists.null) (csCases))) ((maybes.isNothing) (csDefault)))) ((Some) ((InvalidTermError_EmptyCaseStatement) ((Build_EmptyCaseStatementError) (path) (tname))))) (None)) ((cons) (((checkDuplicateFields) (path)) (((lists.map) (fun r_ => (field_name) (r_))) (csCases))) (nil))))) (v_)
