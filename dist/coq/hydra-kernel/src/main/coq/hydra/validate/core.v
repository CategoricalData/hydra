...
(* Module dependencies *)
Require Import hydra.core hydra.error.core hydra.graph hydra.lib.equality hydra.lib.lists hydra.lib.logic hydra.lib.maps hydra.lib.maybes hydra.lib.pairs hydra.lib.sets hydra.paths hydra.rewriting hydra.variables.

Definition findDuplicate (t0 : Type) : forall (_ : (list) (t0)) , (option) (t0) := fun (names : (list) (t0)) => let result := (((lists.foldl) (fun (acc : (prod) ((list) (t0)) ((option) (t0))) => fun (name : t0) => let dup := (pairs.second) (acc) in let seen := (pairs.first) (acc) in (((maybes.cases) (dup)) ((((logic.ifElse) (((sets.member) (name)) (seen))) ((pair) (seen) ((Some) (name)))) ((pair) (((sets.insert) (name)) (seen)) (None)))) (fun (_ : t0) => acc))) ((pair) (sets.empty) (None))) (names) in (pairs.second) (result).
...
Definition findDuplicateFieldType (t0 : Type) : forall (_ : (list) (t0)) , (option) (t0) := fun (names : (list) (t0)) => let result := (((lists.foldl) (fun (acc : (prod) ((list) (t0)) ((option) (t0))) => fun (name : t0) => let dup := (pairs.second) (acc) in let seen := (pairs.first) (acc) in (((maybes.cases) (dup)) ((((logic.ifElse) (((sets.member) (name)) (seen))) ((pair) (seen) ((Some) (name)))) ((pair) (((sets.insert) (name)) (seen)) (None)))) (fun (_ : t0) => acc))) ((pair) (sets.empty) (None))) (names) in (pairs.second) (result).
...
| Term_Annotated v_ => (fun (ann : AnnotatedTerm) => let annMap := (fun r_ => (annotatedTerm_annotation) (r_)) (ann) in let body := (fun r_ => (annotatedTerm_body) (r_)) (ann) in (firstError) ((cons) ((((logic.ifElse) ((maps.null) (annMap))) ((Some) ((InvalidTermError_EmptyTermAnnotation) ((Build_EmptyTermAnnotationError) (path))))) ((None) : (option) (InvalidTermError))) ((cons) ((fun x_ => match x_ with
| Term_Annotated v_ => (fun (_ : AnnotatedTerm) => (Some) ((InvalidTermError_NestedTermAnnotation) ((Build_NestedTermAnnotationError) (path)))) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (body)) (nil)))) (v_)
| Term_Application v_ => (fun (app : Application) => let arg := (fun r_ => (application_argument) (r_)) (app) in let fun_ := (fun r_ => (application_function) (r_)) (app) in (firstError) ((cons) ((fun x_ => match x_ with
| Term_Variable v_ => (fun (primName : Name) => (((logic.ifElse) (((equality.equal) ((fun w_ => w_) (primName))) ("hydra.lib.logic.ifElse"%string))) ((fun x_ => match x_ with
...
| _ => (None) : (option) (InvalidTermError)
end) (arg))) ((None) : (option) (InvalidTermError))) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (fun_)) ((cons) ((fun x_ => match x_ with
| Term_Variable v_ => (fun (funName : Name) => (fun x_ => match x_ with
| Term_Variable v_ => (fun (argName : Name) => (((logic.ifElse) (((equality.equal) (funName)) (argName))) ((Some) ((InvalidTermError_SelfApplication) ((Build_SelfApplicationError) (path) (funName))))) ((None) : (option) (InvalidTermError))) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (arg)) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (fun_)) ((cons) ((fun x_ => match x_ with
| Term_Lambda v_ => (fun (lam : Lambda) => let body := (fun r_ => (lambda_body) (r_)) (lam) in let param := (fun r_ => (lambda_parameter) (r_)) (lam) in (fun x_ => match x_ with
| Term_Variable v_ => (fun (bodyVar : Name) => (((logic.ifElse) (((equality.equal) (param)) (bodyVar))) ((Some) ((InvalidTermError_UnnecessaryIdentityApplication) ((Build_UnnecessaryIdentityApplicationError) (path))))) ((None) : (option) (InvalidTermError))) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (body)) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (fun_)) ((cons) ((fun x_ => match x_ with
| Term_Unwrap v_ => (fun (unwrapName : Name) => (fun x_ => match x_ with
| Term_Wrap v_ => (fun (wt : WrappedTerm) => let wrapName := (fun r_ => (wrappedTerm_typeName) (r_)) (wt) in (((logic.ifElse) (((equality.equal) (unwrapName)) (wrapName))) ((Some) ((InvalidTermError_RedundantWrapUnwrap) ((Build_RedundantWrapUnwrapError) (path) (unwrapName))))) ((None) : (option) (InvalidTermError))) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (arg)) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (fun_)) (nil)))))) (v_)
| Term_Record v_ => (fun (rec : Record_) => let flds := (fun r_ => (record__fields) (r_)) (rec) in let tname := (fun r_ => (record__typeName) (r_)) (rec) in (firstError) ((cons) ((((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) ((None) : (option) (InvalidTermError))) ((cons) (((checkDuplicateFields) (path)) (((lists.map) (fun r_ => (field_name) (r_))) (flds))) (nil)))) (v_)
| Term_Let v_ => (fun (lt : Let) => let bindings := (fun r_ => (let_bindings) (r_)) (lt) in let names := ((lists.map) (fun r_ => (binding_name) (r_))) (bindings) in (firstError) ((cons) ((((logic.ifElse) ((lists.null) (bindings))) ((Some) ((InvalidTermError_EmptyLetBindings) ((Build_EmptyLetBindingsError) (path))))) ((None) : (option) (InvalidTermError))) ((cons) (((checkDuplicateBindings) (path)) (bindings)) ((cons) ((None) : (option) (InvalidTermError)) ((cons) ((firstError) (((lists.map) (fun (bname : Name) => (((logic.ifElse) ((isValidName) (bname))) ((None) : (option) (InvalidTermError))) ((Some) ((InvalidTermError_InvalidLetBindingName) ((Build_InvalidLetBindingNameError) (path) (bname)))))) (names))) ((cons) ((((logic.ifElse) (typed)) ((firstError) (((lists.map) (fun (b : Binding) => (((maybes.cases) ((fun r_ => (binding_type) (r_)) (b))) ((None) : (option) (InvalidTermError))) (fun (ts : TypeScheme) => ((((checkUndefinedTypeVariablesInTypeScheme) (path)) (cx)) (ts)) (fun (uvName : Name) => (Some) ((InvalidTermError_UndefinedTypeVariableInBindingType) ((Build_UndefinedTypeVariableInBindingTypeError) (path) (uvName))))))) (bindings)))) ((None) : (option) (InvalidTermError))) (nil))))))) (v_)
| Term_Inject v_ => (fun (inj : Injection) => let tname := (fun r_ => (injection_typeName) (r_)) (inj) in (((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) ((None) : (option) (InvalidTermError))) (v_)
| Term_Lambda v_ => (fun (lam : Lambda) => let paramName := (fun r_ => (lambda_parameter) (r_)) (lam) in (firstError) ((cons) ((((logic.ifElse) ((maybes.isJust) (((maps.lookup) (paramName)) ((fun r_ => (graph_boundTerms) (r_)) (cx))))) ((Some) ((InvalidTermError_TermVariableShadowing) ((Build_TermVariableShadowingError) (path) (paramName))))) ((None) : (option) (InvalidTermError))) ((cons) ((((logic.ifElse) ((isValidName) (paramName))) ((None) : (option) (InvalidTermError))) ((Some) ((InvalidTermError_InvalidLambdaParameterName) ((Build_InvalidLambdaParameterNameError) (path) (paramName))))) ((cons) ((((logic.ifElse) (typed)) ((((maybes.cases) ((fun r_ => (lambda_domain) (r_)) (lam))) ((None) : (option) (InvalidTermError))) (fun (dom : Type_) => ((((checkUndefinedTypeVariablesInType) (path)) (cx)) (dom)) (fun (uvName : Name) => (Some) ((InvalidTermError_UndefinedTypeVariableInLambdaDomain) ((Build_UndefinedTypeVariableInLambdaDomainError) (path) (uvName))))))) ((None) : (option) (InvalidTermError))) (nil))))) (v_)
| Term_Project v_ => (fun (proj : Projection) => let tname := (fun r_ => (projection_typeName) (r_)) (proj) in (((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) ((None) : (option) (InvalidTermError))) (v_)
| Term_Cases v_ => (fun (cs : CaseStatement) => let csCases := (fun r_ => (caseStatement_cases) (r_)) (cs) in let csDefault := (fun r_ => (caseStatement_default) (r_)) (cs) in let tname := (fun r_ => (caseStatement_typeName) (r_)) (cs) in (firstError) ((cons) ((((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) ((None) : (option) (InvalidTermError))) ((cons) ((((logic.ifElse) (((logic.and) ((lists.null) (csCases))) ((maybes.isNothing) (csDefault)))) ((Some) ((InvalidTermError_EmptyCaseStatement) ((Build_EmptyCaseStatementError) (path) (tname))))) ((None) : (option) (InvalidTermError))) ((cons) (((checkDuplicateFields) (path)) (((lists.map) (fun r_ => (field_name) (r_))) (csCases))) (nil))))) (v_)
| Term_TypeApplication v_ => (fun (ta : TypeApplicationTerm) => (((logic.ifElse) (typed)) (((((checkUndefinedTypeVariablesInType) (path)) (cx)) ((fun r_ => (typeApplicationTerm_type) (r_)) (ta))) (fun (uvName : Name) => (Some) ((InvalidTermError_UndefinedTypeVariableInTypeApplication) ((Build_UndefinedTypeVariableInTypeApplicationError) (path) (uvName)))))) ((None) : (option) (InvalidTermError))) (v_)
| Term_TypeLambda v_ => (fun (tl : TypeLambda) => let tvName := (fun r_ => (typeLambda_parameter) (r_)) (tl) in (firstError) ((cons) ((((logic.ifElse) (((sets.member) (tvName)) (((sets.delete) (tvName)) ((fun r_ => (graph_typeVariables) (r_)) (cx))))) ((Some) ((InvalidTermError_TypeVariableShadowingInTypeLambda) ((Build_TypeVariableShadowingInTypeLambdaError) (path) (tvName))))) ((None) : (option) (InvalidTermError))) ((cons) ((((logic.ifElse) ((isValidName) (tvName))) ((None) : (option) (InvalidTermError))) ((Some) ((InvalidTermError_InvalidTypeLambdaParameterName) ((Build_InvalidTypeLambdaParameterNameError) (path) (tvName))))) (nil)))) (v_)
| Term_Variable v_ => (fun (varName : Name) => (((logic.ifElse) (((logic.or) ((maybes.isJust) (((maps.lookup) (varName)) ((fun r_ => (graph_boundTerms) (r_)) (cx))))) (((logic.or) (((sets.member) (varName)) ((fun r_ => (graph_lambdaVariables) (r_)) (cx)))) ((maybes.isJust) (((maps.lookup) (varName)) ((fun r_ => (graph_primitives) (r_)) (cx))))))) ((None) : (option) (InvalidTermError))) ((Some) ((InvalidTermError_UndefinedTermVariable) ((Build_UndefinedTermVariableError) (path) (varName))))) (v_)
| Term_Wrap v_ => (fun (wt : WrappedTerm) => let tname := (fun r_ => (wrappedTerm_typeName) (r_)) (wt) in (((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) ((None) : (option) (InvalidTermError))) (v_)
| _ => (None) : (option) (InvalidTermError)
end) (term_)) (fun (typed : bool) => fun (g : hydra.graph.Graph) => fun (t : Term) => ((((foldTermWithGraphAndPath) (fun (recurse : forall (_ : (option) (InvalidTermError)) , forall (_ : Term) , (option) (InvalidTermError)) => fun (path : (list) (SubtermStep)) => fun (cx : hydra.graph.Graph) => fun (acc : (option) (InvalidTermError)) => fun (trm : Term) => (((maybes.cases) (acc)) (let checkResult := ((((checkTerm) (typed)) (path)) (cx)) (trm) in (((maybes.cases) (checkResult)) (((recurse) ((None) : (option) (InvalidTermError))) (trm))) (fun (err : InvalidTermError) => (Some) (err)))) (fun (_ : InvalidTermError) => acc))) (g)) ((None) : (option) (InvalidTermError))) (t)))).
...
| _ => (None) : (option) (InvalidTypeError)
end) (typ).
...
| Type__Annotated v_ => (fun (ann : AnnotatedType) => let annMap := (fun r_ => (annotatedType_annotation) (r_)) (ann) in let body := (fun r_ => (annotatedType_body) (r_)) (ann) in (firstTypeError) ((cons) ((((logic.ifElse) ((maps.null) (annMap))) ((Some) ((InvalidTypeError_EmptyTypeAnnotation) ((Build_EmptyTypeAnnotationError) (nil))))) ((None) : (option) (InvalidTypeError))) ((cons) ((fun x_ => match x_ with
...
| Type__Record v_ => (fun (fields : (list) (FieldType)) => (firstTypeError) ((cons) ((((logic.ifElse) ((lists.null) (fields))) ((Some) ((InvalidTypeError_EmptyRecordType) ((Build_EmptyRecordTypeError) (nil))))) ((None) : (option) (InvalidTypeError))) ((cons) (((checkDuplicateFieldTypes) (fields)) (fun (dupName : Name) => (Some) ((InvalidTypeError_DuplicateRecordTypeFieldNames) ((Build_DuplicateRecordTypeFieldNamesError) (nil) (dupName))))) ((cons) ((firstTypeError) (((lists.map) (fun (f : FieldType) => (checkVoid) ((fun r_ => (fieldType_type) (r_)) (f)))) (fields))) (nil))))) (v_)
...
| Type__Union v_ => (fun (fields : (list) (FieldType)) => (firstTypeError) ((cons) ((((logic.ifElse) ((lists.null) (fields))) ((Some) ((InvalidTypeError_EmptyUnionType) ((Build_EmptyUnionTypeError) (nil))))) ((None) : (option) (InvalidTypeError))) ((cons) ((((logic.ifElse) (((equality.equal) ((lists.length) (fields))) ((1)%Z))) (let singleField := (lists.head) (fields) in (Some) ((InvalidTypeError_SingleVariantUnion) ((Build_SingleVariantUnionError) (nil) ((fun r_ => (fieldType_name) (r_)) (singleField)))))) ((None) : (option) (InvalidTypeError))) ((cons) (((checkDuplicateFieldTypes) (fields)) (fun (dupName : Name) => (Some) ((InvalidTypeError_DuplicateUnionTypeFieldNames) ((Build_DuplicateUnionTypeFieldNamesError) (nil) (dupName))))) ((cons) ((firstTypeError) (((lists.map) (fun (f : FieldType) => (checkVoid) ((fun r_ => (fieldType_type) (r_)) (f)))) (fields))) (nil)))))) (v_)
| Type__Variable v_ => (fun (varName : Name) => (((logic.ifElse) (((sets.member) (varName)) (boundVars))) ((None) : (option) (InvalidTypeError))) ((Some) ((InvalidTypeError_UndefinedTypeVariable) ((Build_UndefinedTypeVariableError) (nil) (varName))))) (v_)
| _ => (None) : (option) (InvalidTypeError)
end) (typ).
