...
| Term_Annotated v_ => (fun (ann : AnnotatedTerm) => let annMap := (fun r_ => (annotatedTerm_annotation) (r_)) (ann) in let body := (fun r_ => (annotatedTerm_body) (r_)) (ann) in (firstError) ((cons) ((((logic.ifElse) ((maps.null) (annMap))) ((Some) ((InvalidTermError_EmptyTermAnnotation) ((Build_EmptyTermAnnotationError) (path))))) (None)) ((cons) ((fun x_ => match x_ with
...
| Term_Inject v_ => (fun (inj : Injection) => let tname := (fun r_ => (injection_typeName) (r_)) (inj) in (((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) (None)) (v_)
...
| Term_Project v_ => (fun (proj : Projection) => let tname := (fun r_ => (projection_typeName) (r_)) (proj) in (((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) (None)) (v_)
| Term_Cases v_ => (fun (cs : CaseStatement) => let csCases := (fun r_ => (caseStatement_cases) (r_)) (cs) in let csDefault := (fun r_ => (caseStatement_default) (r_)) (cs) in let tname := (fun r_ => (caseStatement_typeName) (r_)) (cs) in (firstError) ((cons) ((((logic.ifElse) (((equality.equal) ((fun w_ => w_) (tname))) (""%string))) ((Some) ((InvalidTermError_EmptyTypeNameInTerm) ((Build_EmptyTypeNameInTermError) (path))))) (None)) ((cons) ((((logic.ifElse) (((logic.and) ((lists.null) (csCases))) ((maybes.isNothing) (csDefault)))) ((Some) ((InvalidTermError_EmptyCaseStatement) ((Build_EmptyCaseStatementError) (path) (tname))))) (None)) ((cons) (((checkDuplicateFields) (path)) (((lists.map) (fun r_ => (field_name) (r_))) (csCases))) (nil))))) (v_)
...
| Type__Annotated v_ => (fun (ann : AnnotatedType) => let annMap := (fun r_ => (annotatedType_annotation) (r_)) (ann) in let body := (fun r_ => (annotatedType_body) (r_)) (ann) in (firstTypeError) ((cons) ((((logic.ifElse) ((maps.null) (annMap))) ((Some) ((InvalidTypeError_EmptyTypeAnnotation) ((Build_EmptyTypeAnnotationError) (nil))))) (None)) ((cons) ((fun x_ => match x_ with
