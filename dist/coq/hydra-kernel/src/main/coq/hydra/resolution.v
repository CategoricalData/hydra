...
Definition typeToTypeScheme : Type_ -> TypeScheme :=
  fun (t0 : Type_) => let helper := (hydra_fix) (fun helper => fun (vars : (list) (Name)) => fun (t : Type_) => (fun x_ => match x_ with
...
Definition resolveType : hydra.graph.Graph -> Type_ -> (option) (Type_) :=
  fun (graph_ : hydra.graph.Graph) => fun (typ : Type_) => (fun x_ => match x_ with
...
Definition requireType (t0 : Type) : t0 -> hydra.graph.Graph -> Name -> (sum) (Error) (Type_) :=
  fun (cx : t0) => fun (graph_ : hydra.graph.Graph) => fun (name : Name) => (((maybes.maybe) ((((maybes.maybe) ((inl) ((Error_Resolution) ((ResolutionError_NoSuchBinding) ((Build_NoSuchBindingError) (name)))))) (fun (ts : TypeScheme) => (inr) ((typeSchemeToFType) (ts)))) (((maps.lookup) (name)) ((fun r_ => (graph_boundTypes) (r_)) (graph_))))) (fun (ts : TypeScheme) => (inr) ((typeSchemeToFType) (ts)))) (((maps.lookup) (name)) ((fun r_ => (graph_schemaTypes) (r_)) (graph_))).
Arguments requireType {t0}.
Definition requireRowType (t0 : Type) (t1 : Type) : t0 -> string -> (Type_ -> (option) (t1)) -> hydra.graph.Graph -> Name -> (sum) (Error) (t1) :=
  fun (cx : t0) => fun (label : string) => fun (getter : Type_ -> (option) (t1)) => fun (graph_ : hydra.graph.Graph) => fun (name : Name) => let rawType := (hydra_fix) (fun rawType => fun (t : Type_) => (fun x_ => match x_ with
...
Definition requireUnionType (t0 : Type) : t0 -> hydra.graph.Graph -> Name -> (sum) (Error) ((list) (FieldType)) :=
  fun (cx : t0) => fun (graph_ : hydra.graph.Graph) => fun (name : Name) => let toUnion := fun (t : Type_) => (fun x_ => match x_ with
...
Definition nominalApplication : Name -> (list) (Type_) -> Type_ :=
  fun (tname : Name) => fun (args : (list) (Type_)) => (((lists.foldl) (fun (t : Type_) => fun (a : Type_) => (Type__Application) ((Build_ApplicationType) (t) (a)))) ((Type__Variable) (tname))) (args).
Definition instantiateTypeScheme : Context_ -> TypeScheme -> (prod) (TypeScheme) (Context_) :=
  fun (cx : Context_) => fun (scheme : TypeScheme) => let oldVars := (fun r_ => (typeScheme_variables) (r_)) (scheme) in let result := ((freshNames) ((lists.length) (oldVars))) (cx) in let newVars := (pairs.first) (result) in let subst := (maps.fromList) (((lists.zip) (oldVars)) (((lists.map) (fun (x : Name) => (Type__Variable) (x))) (newVars))) in let nameSubst := (maps.fromList) (((lists.zip) (oldVars)) (newVars)) in let renamedConstraints := ((maybes.map) (fun (oldConstraints : (list) ((prod) (Name) (TypeVariableMetadata))) => (maps.fromList) (((lists.map) (fun (kv : (prod) (Name) (TypeVariableMetadata)) => (pair) (((maybes.fromMaybe) ((pairs.first) (kv))) (((maps.lookup) ((pairs.first) (kv))) (nameSubst))) ((pairs.second) (kv)))) ((maps.toList) (oldConstraints))))) ((fun r_ => (typeScheme_constraints) (r_)) (scheme)) in let cx2 := (pairs.second) (result) in (pair) ((Build_TypeScheme) (newVars) (((substInType) (subst)) ((fun r_ => (typeScheme_type) (r_)) (scheme))) (renamedConstraints)) (cx2).
Definition requireSchemaType : Context_ -> (list) ((prod) (Name) (TypeScheme)) -> Name -> (sum) (Error) ((prod) (TypeScheme) (Context_)) :=
  fun (cx : Context_) => fun (types : (list) ((prod) (Name) (TypeScheme))) => fun (tname : Name) => (((maybes.maybe) ((inl) ((Error_Resolution) ((ResolutionError_NoSuchBinding) ((Build_NoSuchBindingError) (tname)))))) (fun (ts : TypeScheme) => (inr) (((instantiateTypeScheme) (cx)) ((deannotateTypeSchemeRecursive) (ts))))) (((maps.lookup) (tname)) (types)).
Definition instantiateType : Context_ -> Type_ -> (prod) (Type_) (Context_) :=
  fun (cx : Context_) => fun (typ : Type_) => let result := ((instantiateTypeScheme) (cx)) ((typeToTypeScheme) (typ)) in (pair) ((typeSchemeToFType) ((pairs.first) (result))) ((pairs.second) (result)).
...
Definition fullyStripType : Type_ -> Type_ :=
  fullyStripType_bundle.
Definition fullyStripAndNormalizeType : Type_ -> Type_ :=
  fun (typ : Type_) => let go := (hydra_fix) (fun go => fun (depth : Z) => fun (subst : (list) ((prod) (Name) (Name))) => fun (t : Type_) => (fun x_ => match x_ with
...
Definition fieldTypes (t0 : Type) : t0 -> hydra.graph.Graph -> Type_ -> (sum) (Error) ((list) ((prod) (Name) (Type_))) :=
  fieldTypes_bundle.
Arguments fieldTypes {t0}.
Definition fieldTypeMap : (list) (FieldType) -> (list) ((prod) (Name) (Type_)) :=
  fun (fields : (list) (FieldType)) => let toPair := fun (f : FieldType) => (pair) ((fun r_ => (fieldType_name) (r_)) (f)) ((fun r_ => (fieldType_type) (r_)) (f)) in (maps.fromList) (((lists.map) (toPair)) (fields)).
Definition fieldMap : (list) (Field) -> (list) ((prod) (Name) (Term)) :=
  fun (fields : (list) (Field)) => let toPair := fun (f : Field) => (pair) ((fun r_ => (field_name) (r_)) (f)) ((fun r_ => (field_term) (r_)) (f)) in (maps.fromList) (((lists.map) (toPair)) (fields)).
...
Definition fTypeIsPolymorphic : Type_ -> bool :=
  fTypeIsPolymorphic_bundle.
Definition dereferenceType (t0 : Type) : t0 -> hydra.graph.Graph -> Name -> (sum) (Error) ((option) (Type_)) :=
  fun (cx : t0) => fun (graph_ : hydra.graph.Graph) => fun (name : Name) => let mel := ((lookupBinding) (graph_)) (name) in (((maybes.maybe) ((inr) (None))) (fun (el : Binding) => ((eithers.map) (maybes.pure)) ((((eithers.bimap) (fun (_e : DecodingError) => (Error_Resolution) ((ResolutionError_UnexpectedShape) ((Build_UnexpectedShapeError) ("type"%string) ((fun w_ => w_) (_e)))))) (fun (_a : Type_) => _a)) (((hydra.decode.core.type) (graph_)) ((fun r_ => (binding_term) (r_)) (el)))))) (mel).
