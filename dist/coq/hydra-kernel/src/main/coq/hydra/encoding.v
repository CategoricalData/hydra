...
| Type__Unit _ => (Term_Lambda) ((Build_Lambda) ("_"%string) (None) ((Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("unit"%string) ((Term_Unit) (tt))))))
| Type__Void _ => (Term_Lambda) ((Build_Lambda) ("_"%string) (None) ((Term_Inject) ((Build_Injection) ("Term"%string) ((Build_Field) ("unit"%string) ((Term_Unit) (tt))))))
