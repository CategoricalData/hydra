...
| LiteralType_Binary _ => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("literal"%string) ((Term_Inject) ((Build_Injection) ("hydra.core.Literal"%string) ((Build_Field) ("binary"%string) ((Term_Variable) ("x"%string)))))))))
| LiteralType_Boolean _ => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("literal"%string) ((Term_Inject) ((Build_Injection) ("hydra.core.Literal"%string) ((Build_Field) ("boolean"%string) ((Term_Variable) ("x"%string)))))))))
| LiteralType_Decimal _ => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("literal"%string) ((Term_Inject) ((Build_Injection) ("hydra.core.Literal"%string) ((Build_Field) ("decimal"%string) ((Term_Variable) ("x"%string)))))))))
| LiteralType_String _ => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("literal"%string) ((Term_Inject) ((Build_Injection) ("hydra.core.Literal"%string) ((Build_Field) ("string"%string) ((Term_Variable) ("x"%string)))))))))
| LiteralType_Integer v_ => (fun (intType : IntegerType) => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("literal"%string) ((Term_Inject) ((Build_Injection) ("hydra.core.Literal"%string) ((Build_Field) ("integer"%string) (((encodeIntegerValue) (intType)) ((Term_Variable) ("x"%string))))))))))) (v_)
| LiteralType_Float v_ => (fun (floatType : FloatType) => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("literal"%string) ((Term_Inject) ((Build_Injection) ("hydra.core.Literal"%string) ((Build_Field) ("float"%string) (((encodeFloatValue) (floatType)) ((Term_Variable) ("x"%string))))))))))) (v_)
end.
...
Definition encodeEitherType_encodeFieldValue_bundle :=
  hydra_fix (fun (bundle_ : prod (forall (_ : EitherType) , Term) (prod (forall (_ : Name) , forall (_ : Name) , forall (_ : Type_) , Term) (prod (forall (_ : ForallType) , Term) (prod (forall (_ : Type_) , Term) (prod (forall (_ : MapType) , Term) (prod (forall (_ : Type_) , Term) (prod (forall (_ : PairType) , Term) (prod (forall (_ : (list) (FieldType)) , Term) (prod (forall (_ : Name) , forall (_ : (list) (FieldType)) , Term) (prod (forall (_ : Type_) , Term) (prod (forall (_ : Type_) , Term) (prod (forall (_ : (list) (FieldType)) , Term) (prod (forall (_ : Name) , forall (_ : (list) (FieldType)) , Term) (prod (forall (_ : Type_) , Term) (forall (_ : Name) , forall (_ : Type_) , Term))))))))))))))) =>
    ...
    (pair (fun (et : EitherType) => (Term_Lambda) ((Build_Lambda) ("e"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("either"%string) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Variable) ("hydra.lib.eithers.bimap"%string)) ((encodeType) ((fun r_ => (eitherType_left) (r_)) (et))))) ((encodeType) ((fun r_ => (eitherType_right) (r_)) (et))))) ((Term_Variable) ("e"%string))))))))) ((pair (fun (typeName : Name) => fun (fieldName : Name) => fun (fieldType : Type_) => (Term_Lambda) ((Build_Lambda) ("y"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("inject"%string) ((((encodeInjection) (typeName)) (fieldName)) ((Term_Application) ((Build_Application) ((encodeType) (fieldType)) ((Term_Variable) ("y"%string)))))))))) ((pair (fun (ft : ForallType) => (Term_Lambda) ((Build_Lambda) ((encodeBindingName) ((fun r_ => (forallType_parameter) (r_)) (ft))) (None) ((encodeType) ((fun r_ => (forallType_body) (r_)) (ft))))) ((pair (fun (elemType : Type_) => (Term_Lambda) ((Build_Lambda) ("xs"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("list"%string) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Variable) ("hydra.lib.lists.map"%string)) ((encodeType) (elemType)))) ((Term_Variable) ("xs"%string))))))))) ((pair (fun (mt : MapType) => (Term_Lambda) ((Build_Lambda) ("m"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("map"%string) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Variable) ("hydra.lib.maps.bimap"%string)) ((encodeType) ((fun r_ => (mapType_keys) (r_)) (mt))))) ((encodeType) ((fun r_ => (mapType_values) (r_)) (mt))))) ((Term_Variable) ("m"%string))))))))) ((pair (fun (elemType : Type_) => (Term_Lambda) ((Build_Lambda) ("opt"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("maybe"%string) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Variable) ("hydra.lib.maybes.map"%string)) ((encodeType) (elemType)))) ((Term_Variable) ("opt"%string))))))))) ((pair (fun (pt : PairType) => (Term_Lambda) ((Build_Lambda) ("p"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("pair"%string) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Variable) ("hydra.lib.pairs.bimap"%string)) ((encodeType) ((fun r_ => (pairType_first) (r_)) (pt))))) ((encodeType) ((fun r_ => (pairType_second) (r_)) (pt))))) ((Term_Variable) ("p"%string))))))))) ((pair (fun (rt : (list) (FieldType)) => ((encodeRecordTypeNamed) ("unknown"%string)) (rt)) ((pair (fun (ename : Name) => fun (rt : (list) (FieldType)) => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("record"%string) ((Term_Record) ((Build_Record_) ("hydra.core.Record"%string) ((cons) ((Build_Field) ("typeName"%string) ((encodeName) (ename))) ((cons) ((Build_Field) ("fields"%string) ((Term_List) (((lists.map) (((fun (tname : Name) => fun (recType : (list) (FieldType)) => fun (ft : FieldType) => (Term_Record) ((Build_Record_) ("hydra.core.Field"%string) ((cons) ((Build_Field) ("name"%string) ((encodeName) ((fun r_ => (fieldType_name) (r_)) (ft)))) ((cons) ((Build_Field) ("term"%string) ((Term_Application) ((Build_Application) ((encodeType) ((fun r_ => (fieldType_type) (r_)) (ft))) ((Term_Application) ((Build_Application) ((Term_Project) ((Build_Projection) (tname) ((fun r_ => (fieldType_name) (r_)) (ft)))) ((Term_Variable) ("x"%string))))))) (nil))))) (ename)) (rt))) (rt)))) (nil)))))))))) ((pair (fun (elemType : Type_) => (Term_Lambda) ((Build_Lambda) ("s"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("set"%string) ((Term_Application) ((Build_Application) ((Term_Application) ((Build_Application) ((Term_Variable) ("hydra.lib.sets.map"%string)) ((encodeType) (elemType)))) ((Term_Variable) ("s"%string))))))))) ((pair (fun x_ => match x_ with
...
| Type__Function v_ => (fun (_ : FunctionType) => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Variable) ("x"%string)))) (v_)
...
| Type__Unit _ => (Term_Lambda) ((Build_Lambda) ("_"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("unit"%string) ((Term_Unit) (tt))))))
| Type__Void _ => (Term_Lambda) ((Build_Lambda) ("_"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("unit"%string) ((Term_Unit) (tt))))))
| Type__Variable v_ => (fun (typeName : Name) => (Term_Variable) ((encodeBindingName) (typeName))) (v_)
end) ((pair (fun (rt : (list) (FieldType)) => ((encodeUnionTypeNamed) ("unknown"%string)) (rt)) ((pair (fun (ename : Name) => fun (rt : (list) (FieldType)) => (Term_Cases) ((Build_CaseStatement) (ename) (None) (((lists.map) (fun (ft : FieldType) => (Build_Field) ((fun r_ => (fieldType_name) (r_)) (ft)) ((((encodeFieldValue) (ename)) ((fun r_ => (fieldType_name) (r_)) (ft))) ((fun r_ => (fieldType_type) (r_)) (ft))))) (rt)))) ((pair (fun (wt : Type_) => ((encodeWrappedTypeNamed) ("unknown"%string)) (wt)) (fun (ename : Name) => fun (wt : Type_) => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Inject) ((Build_Injection) ("hydra.core.Term"%string) ((Build_Field) ("wrap"%string) ((Term_Record) ((Build_Record_) ("hydra.core.WrappedTerm"%string) ((cons) ((Build_Field) ("typeName"%string) ((encodeName) (ename))) ((cons) ((Build_Field) ("body"%string) ((Term_Application) ((Build_Application) ((encodeType) (wt)) ((Term_Application) ((Build_Application) ((Term_Unwrap) (ename)) ((Term_Variable) ("x"%string))))))) (nil)))))))))))))))))))))))))))))))))))))).
...
| Type__Application v_ => (fun (appType : ApplicationType) => (Term_Application) ((Build_Application) ((encodeType) ((fun r_ => (applicationType_function) (r_)) (appType))) ((encodeType) ((fun r_ => (applicationType_argument) (r_)) (appType))))) (v_)
| Type__Either v_ => (fun (et : EitherType) => (encodeEitherType) (et)) (v_)
| Type__Forall v_ => (fun (ft : ForallType) => (Term_Lambda) ((Build_Lambda) ((encodeBindingName) ((fun r_ => (forallType_parameter) (r_)) (ft))) (None) (((encodeTypeNamed) (ename)) ((fun r_ => (forallType_body) (r_)) (ft))))) (v_)
| Type__Function v_ => (fun (_ : FunctionType) => (Term_Lambda) ((Build_Lambda) ("x"%string) (None) ((Term_Variable) ("x"%string)))) (v_)
| Type__List v_ => (fun (elemType : Type_) => (encodeListType) (elemType)) (v_)
| Type__Literal v_ => (fun (lt : LiteralType) => (encodeLiteralType) (lt)) (v_)
| Type__Map v_ => (fun (mt : MapType) => (encodeMapType) (mt)) (v_)
...
Definition encoderTypeScheme : forall (_ : Type_) , TypeScheme := fun (typ : Type_) => let allOrdVars := (encoderCollectOrdVars) (typ) in let typeVars := (encoderCollectForallVariables) (typ) in let ordVars := ((lists.filter) (fun (v : Name) => ((lists.elem) (v)) (typeVars))) (allOrdVars) in let constraints := (((logic.ifElse) ((lists.null) (ordVars))) (None)) ((Some) ((maps.fromList) (((lists.map) (fun (v : Name) => (pair) (v) ((Build_TypeVariableMetadata) ((sets.singleton) ("ordering"%string))))) (ordVars)))) in let encoderFunType := (encoderType) (typ) in (Build_TypeScheme) (typeVars) (encoderFunType) (constraints).
