...
| Term_Inject v_ => (fun (i : Injection) => (((logic.ifElse) (((equality.equal) ((fun r_ => (injection_typeName) (r_)) (i))) ("Type_"%string))) (((eithers.map) (fun (decoded : Type_) => (Some) (((toTypeScheme) (nil)) (decoded)))) ((decodeType) ((fun r_ => (binding_term) (r_)) (el))))) ((inr) (None))) (v_)
| _ => (inr) (None)
