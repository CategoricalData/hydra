...
Definition string_ : forall (_ : string) , (Parser) (string) := fun (str : string) => fun (input : string) => let strCodes := (strings.toList) (str) in let inputCodes := (strings.toList) (input) in let strLen := (lists.length) (strCodes) in let inputPrefix := ((lists.take) (strLen)) (inputCodes) in (((logic.ifElse) (((equality.equal) (strCodes)) (inputPrefix))) ((ParseResult_Success) ((Build_ParseSuccess) (str) ((strings.fromList) (((lists.drop) (strLen)) (inputCodes)))))) ((ParseResult_Failure) ((Build_ParseError) (((strings.cat2) ("expected: "%string)) (str)) (input))).
