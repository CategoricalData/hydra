...
Definition isComplexTerm : forall (_ : hydra.graph.Graph) , forall (_ : Term) , bool :=
  isComplexTerm_bundle.
Definition isComplexBinding : forall (_ : hydra.graph.Graph) , forall (_ : Binding) , bool := fun (tc : hydra.graph.Graph) => fun (b : Binding) => let mts := (fun r_ => (binding_type) (r_)) (b) in let term_ := (fun r_ => (binding_term) (r_)) (b) in (((maybes.cases) (mts)) (((isComplexTerm) (tc)) (term_))) (fun (ts : TypeScheme) => let isComplex := ((isComplexTerm) (tc)) (term_) in let isNonNullary := ((equality.gt) ((typeArity) ((fun r_ => (typeScheme_type) (r_)) (ts)))) ((0)%Z) in let isPolymorphic := (logic.not) ((lists.null) ((fun r_ => (typeScheme_variables) (r_)) (ts))) in ((logic.or) (((logic.or) (isPolymorphic)) (isNonNullary))) (isComplex)).
...
| Term_Inject v_ => (fun (i : Injection) => ((equality.equal) ("hydra.core.Term"%string)) ((fun w_ => w_) ((fun r_ => (injection_typeName) (r_)) (i)))) (v_)
| _ => false
end) ((deannotateTerm) (t))).

Definition isEncodedTerm : forall (_ : Term) , bool :=
...
| Term_Inject v_ => (fun (i : Injection) => ((equality.equal) ("hydra.core.Type"%string)) ((fun w_ => w_) ((fun r_ => (injection_typeName) (r_)) (i)))) (v_)
| _ => false
end) ((deannotateTerm) (t))).

Definition isEncodedType : forall (_ : Term) , bool :=
  isEncodedType_bundle.
Definition isUnitType : forall (_ : Type_) , bool := fun x_ => match x_ with
| Type__Unit _ => true
| _ => false
end.
Definition isEnumRowType : forall (_ : (list) (FieldType)) , bool := fun (rt : (list) (FieldType)) => (((lists.foldl) (logic.and)) (true)) (((lists.map) (fun (f : FieldType) => (isUnitType) ((deannotateType) ((fun r_ => (fieldType_type) (r_)) (f))))) (rt)).
Definition isEnumType : forall (_ : Type_) , bool := fun (typ : Type_) => (fun x_ => match x_ with
...
Definition isNominalType : forall (_ : Type_) , bool :=
  isNominalType_bundle.
Definition typeDependencies : forall (_ : Context_) , forall (_ : hydra.graph.Graph) , forall (_ : bool) , forall (_ : forall (_ : Type_) , Type_) , forall (_ : Name) , (sum) (Error) ((list) ((prod) (Name) (Type_))) := fun (cx : Context_) => fun (graph_ : hydra.graph.Graph) => fun (withSchema : bool) => fun (transform : forall (_ : Type_) , Type_) => fun (name : Name) => let requireType := fun (name2 : Name) => let cx1 := (Build_Context_) (((lists.cons) (((strings.cat2) ("type dependencies of "%string)) ((fun w_ => w_) (name2)))) ((fun r_ => (context__trace) (r_)) (cx))) ((fun r_ => (context__messages) (r_)) (cx)) ((fun r_ => (context__other) (r_)) (cx)) in ((eithers.bind) (((requireBinding) (graph_)) (name2))) (fun (el : Binding) => (((eithers.bimap) (fun (_e : DecodingError) => (Error_Decoding) (_e))) (fun (_a : Type_) => _a)) (((hydra.decode.core.type) (graph_)) ((fun r_ => (binding_term) (r_)) (el)))) in let toPair := fun (name2 : Name) => ((eithers.map) (fun (typ : Type_) => (pair) (name2) ((transform) (typ)))) ((requireType) (name2)) in let deps := (hydra_fix) (fun deps => fun (seeds : (list) (Name)) => fun (names : (list) ((prod) (Name) (Type_))) => (((logic.ifElse) ((sets.null) (seeds))) (((inr) (names)) : (sum) (Error) ((list) ((prod) (Name) (Type_))))) (((eithers.bind) (((eithers.mapList) (toPair)) ((sets.toList) (seeds)))) (fun (pairs : (list) ((prod) (Name) (Type_))) => let newNames := ((maps.union) (names)) ((maps.fromList) (pairs)) in let refs := (((lists.foldl) (sets.union)) (sets.empty)) (((lists.map) (fun (pair_ : (prod) (Name) (Type_)) => ((typeDependencyNames) (withSchema)) ((pairs.second) (pair_)))) (pairs)) in let visited := (sets.fromList) ((maps.keys) (names)) in let newSeeds := ((sets.difference) (refs)) (visited) in ((deps) (newSeeds)) (newNames)))) in ((deps) ((sets.singleton) (name))) (maps.empty).
Definition isSerializable : forall (_ : Context_) , forall (_ : hydra.graph.Graph) , forall (_ : Binding) , (sum) (Error) (bool) := fun (cx : Context_) => fun (graph_ : hydra.graph.Graph) => fun (el : Binding) => let variants := fun (typ : Type_) => ((lists.map) (hydra.reflect.typeVariant)) (((((foldOverType) ((TraversalOrder_Pre) (tt))) (fun (m : (list) (Type_)) => fun (t : Type_) => ((lists.cons) (t)) (m))) (nil)) (typ)) in ((eithers.map) (fun (deps : (list) ((prod) (Name) (Type_))) => let allVariants := (sets.fromList) ((lists.concat) (((lists.map) (variants)) ((maps.elems) (deps)))) in (logic.not) (((sets.member) ((TypeVariant_Function) (tt))) (allVariants)))) ((((((typeDependencies) (cx)) (graph_)) (false)) (equality.identity)) ((fun r_ => (binding_name) (r_)) (el))).
Definition isSerializableByName : forall (_ : Context_) , forall (_ : hydra.graph.Graph) , forall (_ : Name) , (sum) (Error) (bool) := fun (cx : Context_) => fun (graph_ : hydra.graph.Graph) => fun (name : Name) => let variants := fun (typ : Type_) => ((lists.map) (hydra.reflect.typeVariant)) (((((foldOverType) ((TraversalOrder_Pre) (tt))) (fun (m : (list) (Type_)) => fun (t : Type_) => ((lists.cons) (t)) (m))) (nil)) (typ)) in ((eithers.map) (fun (deps : (list) ((prod) (Name) (Type_))) => let allVariants := (sets.fromList) ((lists.concat) (((lists.map) (variants)) ((maps.elems) (deps)))) in (logic.not) (((sets.member) ((TypeVariant_Function) (tt))) (allVariants)))) ((((((typeDependencies) (cx)) (graph_)) (false)) (equality.identity)) (name)).
Definition isSerializableType : forall (_ : Type_) , bool := fun (typ : Type_) => let allVariants := (sets.fromList) (((lists.map) (hydra.reflect.typeVariant)) (((((foldOverType) ((TraversalOrder_Pre) (tt))) (fun (m : (list) (Type_)) => fun (t : Type_) => ((lists.cons) (t)) (m))) (nil)) (typ))) in (logic.not) (((sets.member) ((TypeVariant_Function) (tt))) (allVariants)).
...
| Term_Unit _ => true
| Term_Application v_ => (fun (app : Application) => let arg := (fun r_ => (application_argument) (r_)) (app) in let fun_ := (fun r_ => (application_function) (r_)) (app) in (fun x_ => match x_ with
...
Definition isTrivialTerm : forall (_ : Term) , bool :=
...
| Type__Variable v_ => (fun (v : Name) => ((equality.equal) (v)) ("hydra.core.Type"%string)) (v_)
| _ => false
end) ((deannotateType) (t))).

Definition isType : forall (_ : Type_) , bool :=
  isType_bundle.
Definition isUnitTerm : forall (_ : Term) , bool := fun x_ => match x_ with
| Term_Unit _ => true
| _ => false
end.
