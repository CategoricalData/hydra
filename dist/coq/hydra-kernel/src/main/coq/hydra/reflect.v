...
(* Module dependencies *)
Require Import hydra.core hydra.lib.lists hydra.util hydra.variants.

Definition eliminationVariants : (list) (EliminationVariant) := (cons) ((EliminationVariant_Record) (tt)) ((cons) ((EliminationVariant_Union) (tt)) ((cons) ((EliminationVariant_Wrap) (tt)) (nil))).
Definition floatTypePrecision : forall (_ : FloatType) , Precision := fun x_ => match x_ with
...
Definition floatTypes : (list) (FloatType) := (cons) ((FloatType_Bigfloat) (tt)) ((cons) ((FloatType_Float32) (tt)) ((cons) ((FloatType_Float64) (tt)) (nil))).
Definition floatValueType : forall (_ : FloatValue) , FloatType := fun x_ => match x_ with
...
Definition functionVariants : (list) (FunctionVariant) := (cons) ((FunctionVariant_Elimination) (tt)) ((cons) ((FunctionVariant_Lambda) (tt)) (nil)).
Definition integerTypeIsSigned : forall (_ : IntegerType) , bool := fun x_ => match x_ with
...
Definition integerTypePrecision : forall (_ : IntegerType) , Precision := fun x_ => match x_ with
...
Definition integerTypes : (list) (IntegerType) := (cons) ((IntegerType_Bigint) (tt)) ((cons) ((IntegerType_Int8) (tt)) ((cons) ((IntegerType_Int16) (tt)) ((cons) ((IntegerType_Int32) (tt)) ((cons) ((IntegerType_Int64) (tt)) ((cons) ((IntegerType_Uint8) (tt)) ((cons) ((IntegerType_Uint16) (tt)) ((cons) ((IntegerType_Uint32) (tt)) ((cons) ((IntegerType_Uint64) (tt)) (nil))))))))).
Definition integerValueType : forall (_ : IntegerValue) , IntegerType := fun x_ => match x_ with
