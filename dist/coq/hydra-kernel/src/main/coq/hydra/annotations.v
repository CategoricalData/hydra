...
Definition getDebugId : forall (_ : Context_) , (sum) (Error) ((option) (string)) := fun (cx : Context_) => (((maybes.maybe) ((inr) (None))) (fun (term_ : Term) => ((eithers.map) (maybes.pure)) (((string_) ((Build_Graph) (maps.empty) (maps.empty) (maps.empty) (sets.empty) (maps.empty) (maps.empty) (maps.empty) (sets.empty))) (term_)))) (((getAttr) (key_debugId)) (cx)).
