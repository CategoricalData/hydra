...
Definition getType : forall (_ : hydra.graph.Graph) , forall (_ : (list) ((prod) (Name) (Term))) , (sum) (DecodingError) ((option) (Type_)) := fun (graph_ : hydra.graph.Graph) => fun (anns : (list) ((prod) (Name) (Term))) => (((maybes.maybe) ((inr) (None))) (fun (dat : Term) => ((eithers.map) (maybes.pure)) (((hydra.decode.core.type) (graph_)) (dat)))) (((maps.lookup) (key_type)) (anns)).
Definition getDescription (t0 : Type) : forall (_ : t0) , forall (_ : hydra.graph.Graph) , forall (_ : (list) ((prod) (Name) (Term))) , (sum) (Error) ((option) (string)) := fun (cx : t0) => fun (graph_ : hydra.graph.Graph) => fun (anns : (list) ((prod) (Name) (Term))) => (((maybes.maybe) ((inr) (None))) (fun (term_ : Term) => ((eithers.map) (maybes.pure)) (((hydra.extract.core.string_) (graph_)) (term_)))) (((maps.lookup) ("description"%string)) (anns)).
...
Definition getDebugId : forall (_ : Context_) , (sum) (Error) ((option) (string)) := fun (cx : Context_) => (((maybes.maybe) ((inr) (None))) (fun (term_ : Term) => ((eithers.map) (maybes.pure)) (((hydra.extract.core.string_) ((Build_Graph) (maps.empty) (maps.empty) (maps.empty) (sets.empty) (maps.empty) (maps.empty) (maps.empty) (sets.empty))) (term_)))) (((getAttr) (key_debugId)) (cx)).
Definition failOnFlag : forall (_ : Context_) , forall (_ : Name) , forall (_ : string) , (sum) (Error) (unit) := fun (cx : Context_) => fun (flag : Name) => fun (msg : string) => ((eithers.bind) (((hasFlag) (cx)) (flag))) (fun (val : bool) => (((logic.ifElse) (val)) ((inl) ((Error_Other) (msg)))) ((inr) (tt))).
Definition debugIf : forall (_ : Context_) , forall (_ : string) , forall (_ : string) , (sum) (Error) (unit) := fun (cx : Context_) => fun (debugId : string) => fun (message : string) => ((eithers.bind) ((getDebugId) (cx))) (fun (mid : (option) (string)) => (((logic.ifElse) (((equality.equal) (mid)) ((Some) (debugId)))) ((inl) ((Error_Other) (message)))) ((inr) (tt))).
...
Definition normalizeTermAnnotations : forall (_ : Term) , Term := fun (term_ : Term) => let stripped := (deannotateTerm) (term_) in let anns := (termAnnotationInternal) (term_) in (((logic.ifElse) ((maps.null) (anns))) (stripped)) ((Term_Annotated) ((Build_AnnotatedTerm) (stripped) (anns))).
Definition setTermAnnotation : forall (_ : Name) , forall (_ : (option) (Term)) , forall (_ : Term) , Term := fun (key : Name) => fun (val : (option) (Term)) => fun (term_ : Term) => let term' := (deannotateTerm) (term_) in let anns := (((setAnnotation) (key)) (val)) ((termAnnotationInternal) (term_)) in (((logic.ifElse) ((maps.null) (anns))) (term')) ((Term_Annotated) ((Build_AnnotatedTerm) (term') (anns))).
...
Definition normalizeTypeAnnotations : forall (_ : Type_) , Type_ := fun (typ : Type_) => let stripped := (deannotateType) (typ) in let anns := (typeAnnotationInternal) (typ) in (((logic.ifElse) ((maps.null) (anns))) (stripped)) ((Type__Annotated) ((Build_AnnotatedType) (stripped) (anns))).
Definition setTypeAnnotation : forall (_ : Name) , forall (_ : (option) (Term)) , forall (_ : Type_) , Type_ := fun (key : Name) => fun (val : (option) (Term)) => fun (typ : Type_) => let typ' := (deannotateType) (typ) in let anns := (((setAnnotation) (key)) (val)) ((typeAnnotationInternal) (typ)) in (((logic.ifElse) ((maps.null) (anns))) (typ')) ((Type__Annotated) ((Build_AnnotatedType) (typ') (anns))).
