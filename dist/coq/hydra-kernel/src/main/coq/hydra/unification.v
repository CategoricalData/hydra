...
(* Module dependencies *)
Require Import hydra.coders hydra.core hydra.errors hydra.lib.eithers hydra.lib.equality hydra.lib.lists hydra.lib.logic hydra.lib.maps hydra.lib.maybes hydra.lib.strings hydra.rewriting hydra.show.core hydra.strip hydra.substitution hydra.typing.

Definition joinTypes (t0 : Type) : forall (_ : t0) , forall (_ : Type_) , forall (_ : Type_) , forall (_ : string) , (sum) (UnificationError) ((list) (TypeConstraint)) := fun (cx : t0) => fun (left : Type_) => fun (right : Type_) => fun (comment : string) => let sleft := (deannotateType) (left) in let sright := (deannotateType) (right) in let cannotUnify := fun (t1 : Type) => (inl) ((Build_UnificationError) (sleft) (sright) (((strings.cat2) (((strings.cat2) (((strings.cat2) ("cannot unify "%string)) ((hydra.show.core.type) (sleft)))) (" with "%string))) ((hydra.show.core.type) (sright)))) in let assertEqual := fun (t1 : Type) => (((logic.ifElse) (((equality.equal) (sleft)) (sright))) ((inr) (nil))) ((cannotUnify) ((list) (t1))) in let joinOne := fun (l : Type_) => fun (r : Type_) => (Build_TypeConstraint) (l) (r) (((strings.cat2) ("join types; "%string)) (comment)) in let joinList := fun (lefts : (list) (Type_)) => fun (rights : (list) (Type_)) => (((logic.ifElse) (((equality.equal) ((lists.length) (lefts))) ((lists.length) (rights)))) ((inr) ((((lists.zipWith) (joinOne)) (lefts)) (rights)))) ((cannotUnify) ((list) (TypeConstraint))) in let joinRowTypes := fun (left2 : (list) (FieldType)) => fun (right2 : (list) (FieldType)) => (((logic.ifElse) (((logic.and) (((equality.equal) ((lists.length) (((lists.map) (fun r_ => (fieldType_name) (r_))) (left2)))) ((lists.length) (((lists.map) (fun r_ => (fieldType_name) (r_))) (right2))))) ((((lists.foldl) (logic.and)) (true)) ((((lists.zipWith) (fun (left3 : Name) => fun (right3 : Name) => ((equality.equal) ((fun w_ => w_) (left3))) ((fun w_ => w_) (right3)))) (((lists.map) (fun r_ => (fieldType_name) (r_))) (left2))) (((lists.map) (fun r_ => (fieldType_name) (r_))) (right2)))))) (((joinList) (((lists.map) (fun r_ => (fieldType_type) (r_))) (left2))) (((lists.map) (fun r_ => (fieldType_type) (r_))) (right2)))) ((cannotUnify) ((list) (TypeConstraint))) in (fun x_ => match x_ with
...
Definition variableOccursInType : forall (_ : Name) , forall (_ : Type_) , bool := fun (var : Name) => fun (typ0 : Type_) => let tryType := fun (b : bool) => fun (typ : Type_) => (fun x_ => match x_ with
...
Definition unifyTypeConstraints (t0 : Type) (t1 : Type) : forall (_ : t0) , forall (_ : (list) ((prod) (Name) (t1))) , forall (_ : (list) (TypeConstraint)) , (sum) (UnificationError) (TypeSubst) :=
  unifyTypeConstraints_bundle.
Arguments unifyTypeConstraints {t0} {t1}.
Definition unifyTypeLists (t0 : Type) (t1 : Type) : forall (_ : t0) , forall (_ : (list) ((prod) (Name) (t1))) , forall (_ : (list) (Type_)) , forall (_ : (list) (Type_)) , forall (_ : string) , (sum) (UnificationError) (TypeSubst) := fun (cx : t0) => fun (schemaTypes : (list) ((prod) (Name) (t1))) => fun (l : (list) (Type_)) => fun (r : (list) (Type_)) => fun (comment : string) => let toConstraint := fun (l2 : Type_) => fun (r2 : Type_) => (Build_TypeConstraint) (l2) (r2) (comment) in (((unifyTypeConstraints) (cx)) (schemaTypes)) ((((lists.zipWith) (toConstraint)) (l)) (r)).
Arguments unifyTypeLists {t0} {t1}.
Definition unifyTypes (t0 : Type) (t1 : Type) : forall (_ : t0) , forall (_ : (list) ((prod) (Name) (t1))) , forall (_ : Type_) , forall (_ : Type_) , forall (_ : string) , (sum) (UnificationError) (TypeSubst) := fun (cx : t0) => fun (schemaTypes : (list) ((prod) (Name) (t1))) => fun (l : Type_) => fun (r : Type_) => fun (comment : string) => (((unifyTypeConstraints) (cx)) (schemaTypes)) ((cons) ((Build_TypeConstraint) (l) (r) (comment)) (nil)).
