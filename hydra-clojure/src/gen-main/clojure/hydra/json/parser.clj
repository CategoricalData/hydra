...
(def hydra_json_parser_json_integer_part ((hydra_parsers_bind (hydra_parsers_optional (hydra_parsers_char 45))) (fn [sign] ((hydra_parsers_bind hydra_json_parser_digits) (fn [digits] (hydra_parsers_pure (((hydra_lib_maybes_maybe digits) (fn [_] ((hydra_lib_strings_cat2 "-") digits))) sign)))))))
...
(def hydra_json_parser_json_string (hydra_json_parser_token ((hydra_parsers_bind (hydra_parsers_char 34)) (fn [_] ((hydra_parsers_bind (hydra_parsers_many hydra_json_parser_json_string_char)) (fn [chars] ((hydra_parsers_bind (hydra_parsers_char 34)) (fn [_] (hydra_parsers_pure (list :string (hydra_lib_strings_from_list chars)))))))))))
...
(def hydra_json_parser_json_key_value ((hydra_parsers_bind (hydra_json_parser_token ((hydra_parsers_bind (hydra_parsers_char 34)) (fn [_] ((hydra_parsers_bind (hydra_parsers_many hydra_json_parser_json_string_char)) (fn [chars] ((hydra_parsers_bind (hydra_parsers_char 34)) (fn [_] (hydra_parsers_pure (hydra_lib_strings_from_list chars)))))))))) (fn [key] ((hydra_parsers_bind (hydra_json_parser_token (hydra_parsers_char 58))) (fn [_] ((hydra_parsers_map (fn [v] (list key v))) (hydra_parsers_lazy (fn [_] hydra_json_parser_json_value))))))))
...
(def hydra_json_parser_parse_json (fn [input] (((fn [v] v) ((hydra_parsers_bind hydra_json_parser_whitespace) (fn [_] ((hydra_parsers_bind hydra_json_parser_json_value) (fn [v] ((hydra_parsers_bind hydra_json_parser_whitespace) (fn [_] ((hydra_parsers_bind hydra_parsers_eof) (fn [_] (hydra_parsers_pure v)))))))))) input)))
