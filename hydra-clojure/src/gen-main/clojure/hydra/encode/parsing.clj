...
(def hydra_encode_parsing_parse_error (fn [x] (list :record (->hydra_core_record "hydra.parsing.ParseError" (list (->hydra_core_field "message" ((fn [x] (list :literal (list :string x))) ((fn [v] (:message v)) x))) (->hydra_core_field "remainder" ((fn [x] (list :literal (list :string x))) ((fn [v] (:remainder v)) x))))))))

(def hydra_encode_parsing_parse_success (fn [a] (fn [x] (list :record (->hydra_core_record "hydra.parsing.ParseSuccess" (list (->hydra_core_field "value" (a ((fn [v] (:value v)) x))) (->hydra_core_field "remainder" ((fn [x] (list :literal (list :string x))) ((fn [v] (:remainder v)) x)))))))))
