...
public class Modules {
    ...
    //     Name name = Tier1.unqualifyName(
    //             new QualifiedName(Opt.of(module.namespace), localName));
    ...
    /**
     * Create a module builder for the given namespace.
     *
     * @param namespace the namespace for the module
     * @return a new ModuleBuilder instance
     */
    ...
    /**
     * Create a module builder for the given namespace with a description.
     *
     * @param namespace the namespace for the module
