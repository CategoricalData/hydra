...
import hydra.ext.tinkerpop.propertyGraph.Direction;
import hydra.ext.tinkerpop.propertyGraph.EdgeLabel;
import hydra.ext.tinkerpop.propertyGraph.PropertyKey;
import hydra.ext.tinkerpop.propertyGraph.VertexLabel;
import hydra.ext.tinkerpop.queries.AssociativeExpression;
import hydra.ext.tinkerpop.queries.BinaryBooleanOperator;
import hydra.ext.tinkerpop.queries.BinaryExpression;
import hydra.ext.tinkerpop.queries.BinaryOperator;
import hydra.ext.tinkerpop.queries.ComparisonOperator;
import hydra.ext.tinkerpop.queries.EdgeProjectionPattern;
import hydra.ext.tinkerpop.queries.Expression;
import hydra.ext.tinkerpop.queries.MatchQuery;
import hydra.ext.tinkerpop.queries.Projection;
import hydra.ext.tinkerpop.queries.Projections;
import hydra.ext.tinkerpop.queries.PropertyPattern;
import hydra.ext.tinkerpop.queries.PropertyProjection;
import hydra.ext.tinkerpop.queries.Query;
import hydra.ext.tinkerpop.queries.SelectQuery;
import hydra.ext.tinkerpop.queries.UnaryExpression;
import hydra.ext.tinkerpop.queries.UnaryOperator;
import hydra.ext.tinkerpop.queries.Variable;
import hydra.ext.tinkerpop.queries.VertexPattern;
...
import static hydra.ext.tinkerpop.dsl.Queries.apply;
import static hydra.ext.tinkerpop.dsl.Queries.query;
