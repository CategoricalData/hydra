 ...
 */
public class IsLower extends PrimitiveFunction {
    /**
    ...
    protected Function<List<Term>, Function<Context, Function<Graph, Either<InContext<Error_>, Term>>>> implementation() {
        return args -> cx -> graph -> hydra.lib.eithers.Map.apply(c -> Terms.boolean_(apply(c)), hydra.extract.Core.int32(cx, graph, args.get(0)));
    }

    /**
     * Checks whether the given code point is lowercase.
     * @param codePoint the Unicode code point to test
     * @return true if the code point is lowercase, false otherwise
     */
