...
public class IsNothing extends PrimitiveFunction {
    ...
    protected Function<List<Term>, Function<Context, Function<Graph, Either<InContext<Error_>, Term>>>> implementation() {
        return args -> cx -> graph -> hydra.lib.eithers.Map.apply(x -> Terms.boolean_(IsNothing.apply(x)), hydra.extract.core.Core.maybeTerm(cx, t -> Either.right(t), graph, args.get(0)));
    }
