...
public class AdapterContext implements Serializable, Comparable<AdapterContext> {
   ...
   */
  public final java.util.Map<hydra.core.Name, hydra.util.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> adapters;
  
  public AdapterContext (hydra.graph.Graph graph, hydra.coders.Language language, java.util.Map<hydra.core.Name, hydra.util.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> adapters) {
    this.graph = graph;
  ...
  public AdapterContext withAdapters(java.util.Map<hydra.core.Name, hydra.util.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> adapters) {
    return new AdapterContext(graph, language, adapters);
  }
}
