...
public interface Transform {
  ...
  static hydra.util.Either<String, hydra.util.ConsList<hydra.util.Maybe<String>>> parseCsvLine(String line) {
    ...
    hydra.util.Lazy<hydra.util.Pair<hydra.util.Pair<hydra.util.ConsList<hydra.util.Maybe<String>>, String>, Boolean>> finalState = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
      (java.util.function.Function<hydra.util.Pair<hydra.util.Pair<hydra.util.ConsList<hydra.util.Maybe<String>>, String>, Boolean>, java.util.function.Function<Integer, hydra.util.Pair<hydra.util.Pair<hydra.util.ConsList<hydra.util.Maybe<String>>, String>, Boolean>>>) (p0 -> p1 -> hydra.demos.genpg.Transform.parseCsvChar(
        p0,
        p1)),
  ...
  static hydra.util.Either<String, hydra.tabular.Table<String>> parseTableLines(Boolean hasHeader, hydra.util.ConsList<String> rawLines) {
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.MapList.apply(
        (java.util.function.Function<String, hydra.util.Either<String, hydra.util.Maybe<hydra.util.ConsList<hydra.util.Maybe<String>>>>>) (ln -> hydra.demos.genpg.Transform.parseSingleLine(ln)),
        rawLines),
  ...
  static hydra.util.Either<String, String> tableForEdge(hydra.pg.model.Edge<hydra.core.Term> edge) {
    ...
    hydra.util.Lazy<hydra.util.PersistentSet<String>> tables = new hydra.util.Lazy<>(() -> hydra.demos.genpg.Transform.findTablesInTerms(hydra.lib.lists.Concat2.apply(
  ...
  static hydra.util.Either<String, String> tableForVertex(hydra.pg.model.Vertex<hydra.core.Term> vertex) {
    ...
    hydra.util.Lazy<hydra.util.PersistentSet<String>> tables = new hydra.util.Lazy<>(() -> hydra.demos.genpg.Transform.findTablesInTerms(hydra.lib.lists.Cons.apply(
      id.get(),
      hydra.lib.maps.Elems.apply(props.get()))));
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.equality.Equal.apply(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.pg.model.Vertex<hydra.core.Term>>, hydra.util.ConsList<hydra.pg.model.Edge<hydra.core.Term>>>> transformTableRows(hydra.context.Context cx, hydra.graph.Graph g, hydra.util.ConsList<hydra.pg.model.Vertex<hydra.core.Term>> vspecs, hydra.util.ConsList<hydra.pg.model.Edge<hydra.core.Term>> especs, hydra.tabular.TableType tableType, hydra.util.ConsList<hydra.tabular.DataRow<hydra.core.Term>> rows) {
    return hydra.lib.eithers.Map.apply(
      (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.util.ConsList<hydra.pg.model.Vertex<hydra.core.Term>>, hydra.util.ConsList<hydra.pg.model.Edge<hydra.core.Term>>>>, hydra.util.Pair<hydra.util.ConsList<hydra.pg.model.Vertex<hydra.core.Term>>, hydra.util.ConsList<hydra.pg.model.Edge<hydra.core.Term>>>>) (pairs -> hydra.lib.lists.Foldl.apply(
        ...
        pairs)),
      hydra.lib.eithers.MapList.apply(
        (java.util.function.Function<hydra.tabular.DataRow<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.pg.model.Vertex<hydra.core.Term>>, hydra.util.ConsList<hydra.pg.model.Edge<hydra.core.Term>>>>>) (row -> hydra.demos.genpg.Transform.transformRecord(
          cx,
          g,
          vspecs,
          especs,
