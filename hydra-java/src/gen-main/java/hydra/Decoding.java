...
public interface Decoding {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.Decoding.filterTypeBindings(
        ...
        hydra.lib.maybes.Cat.apply(hydra.lib.lists.Map.apply(
          ...
          (mod).definitions))),
      (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Maybe<hydra.module.Module>>>) (typeBindings -> hydra.lib.logic.IfElse.lazy(
          ...
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Binding>>) (b -> hydra.lib.eithers.Bimap.apply(
              ...
              hydra.Decoding.decodeBinding(
                ...
                b))),
            typeBindings),
          (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Maybe<hydra.module.Module>>>) (decodedBindings -> {
            ...
            return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Maybe<hydra.module.Module>>right(hydra.util.Maybe.just(new hydra.module.Module(hydra.Decoding.decodeNamespace((mod).namespace), hydra.lib.lists.Map.apply(
              ...
              (mod).namespace,
              new hydra.module.Namespace("hydra.util")), hydra.util.Maybe.just(hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
              "Term decoders for ",
              (mod).namespace.value))))));
          })))));
  }
  ...
  static hydra.module.Namespace decodeNamespace(hydra.module.Namespace ns) {
    return new hydra.module.Namespace(hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
      "hydra.decode.",
  ...
  static hydra.core.Term decodeUnitType() {
    return new hydra.core.Term.Variable(new hydra.core.Name("hydra.extract.core.decodeUnit"));
  }
