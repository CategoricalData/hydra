...
public class Module implements Serializable, Comparable<Module> {
   ...
   */
  public final java.util.List<hydra.module.Definition> definitions;
  ...
  public Module (hydra.module.Namespace namespace, java.util.List<hydra.module.Definition> definitions, java.util.List<hydra.module.Namespace> termDependencies, java.util.List<hydra.module.Namespace> typeDependencies, hydra.util.Maybe<String> description) {
  ...
  public Module withDefinitions(java.util.List<hydra.module.Definition> definitions) {
    return new Module(namespace, definitions, termDependencies, typeDependencies, description);
  }
