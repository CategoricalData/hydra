...
public class AnnotationClass<M> {
  ...
  public boolean equals(Object other) {
    ...
    return default_.equals(o.default_) && equal.equals(o.equal) && compare.equals(o.compare) && show.equals(o.show) && read.equals(o.read) && termDescription.equals(o.termDescription) && typeDescription.equals(o.typeDescription) && termType.equals(o.termType) && setTermDescription.equals(o.setTermDescription) && setTermType.equals(o.setTermType) && typeOf.equals(o.typeOf) && setTypeOf.equals(o.setTypeOf);
  }
  
  @Override
  public int hashCode() {
    return 2 * default_.hashCode() + 3 * equal.hashCode() + 5 * compare.hashCode() + 7 * show.hashCode() + 11 * read.hashCode() + 13 * termDescription.hashCode() + 17 * typeDescription.hashCode() + 19 * termType.hashCode() + 23 * setTermDescription.hashCode() + 29 * setTermType.hashCode() + 31 * typeOf.hashCode() + 37 * setTypeOf.hashCode();
  }
  
  public AnnotationClass withDefault(M default_) {
    return new AnnotationClass(default_, equal, compare, show, read, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
