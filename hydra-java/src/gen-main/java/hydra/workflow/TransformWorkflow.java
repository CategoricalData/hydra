...
public class TransformWorkflow implements Serializable, Comparable<TransformWorkflow> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.workflow.TransformWorkflow");
  
  public static final hydra.core.Name NAME = new hydra.core.Name("name");
  
  public static final hydra.core.Name SCHEMA_SPEC = new hydra.core.Name("schemaSpec");
  
  public static final hydra.core.Name SRC_DIR = new hydra.core.Name("srcDir");
  
  public static final hydra.core.Name DEST_DIR = new hydra.core.Name("destDir");
