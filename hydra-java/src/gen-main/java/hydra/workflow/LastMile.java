...
public class LastMile<A> {
   ...
   */
  public final java.util.function.Function<hydra.core.Term<hydra.compute.Kv>, java.util.function.Function<hydra.graph.Graph<hydra.compute.Kv>, hydra.compute.Flow<hydra.graph.Graph<hydra.compute.Kv>, java.util.List<A>>>> encoder;
  ...
  public LastMile (java.util.function.Function<hydra.core.Term<hydra.compute.Kv>, java.util.function.Function<hydra.graph.Graph<hydra.compute.Kv>, hydra.compute.Flow<hydra.graph.Graph<hydra.compute.Kv>, java.util.List<A>>>> encoder, java.util.function.Function<java.util.List<A>, String> serializer, String fileExtension) {
  ...
  public LastMile withEncoder(java.util.function.Function<hydra.core.Term<hydra.compute.Kv>, java.util.function.Function<hydra.graph.Graph<hydra.compute.Kv>, hydra.compute.Flow<hydra.graph.Graph<hydra.compute.Kv>, java.util.List<A>>>> encoder) {
