...
public class LastMile<A> {
   ...
   */
  public final java.util.function.Function<hydra.core.Term<hydra.compute.Meta>, java.util.function.Function<hydra.mantle.Graph<hydra.compute.Meta>, hydra.compute.Flow<hydra.compute.Context<hydra.compute.Meta>, java.util.List<A>>>> encoder;
  ...
  public LastMile (java.util.function.Function<hydra.core.Term<hydra.compute.Meta>, java.util.function.Function<hydra.mantle.Graph<hydra.compute.Meta>, hydra.compute.Flow<hydra.compute.Context<hydra.compute.Meta>, java.util.List<A>>>> encoder, java.util.function.Function<java.util.List<A>, String> serializer, String fileExtension) {
  ...
  public LastMile withEncoder(java.util.function.Function<hydra.core.Term<hydra.compute.Meta>, java.util.function.Function<hydra.mantle.Graph<hydra.compute.Meta>, hydra.compute.Flow<hydra.compute.Context<hydra.compute.Meta>, java.util.List<A>>>> encoder) {
