...
public abstract class Reference<A> {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/shacl/model.Reference");
  ...
  public static final class Named<A> extends hydra.ext.shacl.model.Reference<A> {
   ...
   */
  public static final class Anonymous<A> extends hydra.ext.shacl.model.Reference<A> {
    /**
     * An anonymous instance
     */
   ...
   */
  public static final class Definition<A> extends hydra.ext.shacl.model.Reference<A> {
    /**
     * An inline definition
     */
