...
public class QualifiedValueShape implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shacl/model.QualifiedValueShape");
  ...
  public QualifiedValueShape (hydra.ext.shacl.model.Reference<hydra.ext.shacl.model.Shape> qualifiedValueShape, java.math.BigInteger qualifiedMaxCount, java.math.BigInteger qualifiedMinCount, hydra.util.Opt<Boolean> qualifiedValueShapesDisjoint) {
