...
public class Closed implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shacl/model.Closed");
  ...
  public final hydra.util.Opt<java.util.Set<hydra.ext.rdf.syntax.Property>> ignoredProperties;
  
  public Closed (Boolean isClosed, hydra.util.Opt<java.util.Set<hydra.ext.rdf.syntax.Property>> ignoredProperties) {
  ...
  public Closed withIgnoredProperties(hydra.util.Opt<java.util.Set<hydra.ext.rdf.syntax.Property>> ignoredProperties) {
    java.util.Objects.requireNonNull((ignoredProperties));
    return new Closed(isClosed, ignoredProperties);
  }
}
