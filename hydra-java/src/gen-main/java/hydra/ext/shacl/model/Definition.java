...
public class Definition<A> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shacl/model.Definition");
  ...
  public Definition (hydra.ext.rdf.syntax.Iri iri, A target) {
  ...
  public Definition withIri(hydra.ext.rdf.syntax.Iri iri) {
    java.util.Objects.requireNonNull((iri));
