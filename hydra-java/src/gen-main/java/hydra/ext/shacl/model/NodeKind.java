...
public abstract class NodeKind implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shacl/model.NodeKind");
   ...
   * A blank node
   */
  public static final class BlankNode extends hydra.ext.shacl.model.NodeKind implements Serializable {
    public BlankNode () {
   ...
   * An IRI
   */
  public static final class Iri extends hydra.ext.shacl.model.NodeKind implements Serializable {
    public Iri () {
   ...
   * A literal
   */
  public static final class Literal extends hydra.ext.shacl.model.NodeKind implements Serializable {
    public Literal () {
   ...
   */
  public static final class BlankNodeOrIri extends hydra.ext.shacl.model.NodeKind implements Serializable {
   ...
   */
  public static final class BlankNodeOrLiteral extends hydra.ext.shacl.model.NodeKind implements Serializable {
   ...
   * An IRI or a literal
   */
  public static final class IriOrLiteral extends hydra.ext.shacl.model.NodeKind implements Serializable {
    public IriOrLiteral () {
