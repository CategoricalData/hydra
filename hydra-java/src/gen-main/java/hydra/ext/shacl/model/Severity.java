...
public abstract class Severity implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shacl/model.Severity");
   ...
   */
  public static final class Info extends hydra.ext.shacl.model.Severity implements Serializable {
    public Info () {
   ...
   */
  public static final class Warning extends hydra.ext.shacl.model.Severity implements Serializable {
    public Warning () {
   ...
   */
  public static final class Violation extends hydra.ext.shacl.model.Severity implements Serializable {
    public Violation () {
