...
public abstract class Properties implements Serializable, Comparable<Properties> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.cypher.openCypher.Properties");
