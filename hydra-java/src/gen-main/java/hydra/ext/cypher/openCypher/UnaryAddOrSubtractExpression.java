...
public class UnaryAddOrSubtractExpression implements Serializable {
  ...
  public final hydra.util.Opt<hydra.ext.cypher.openCypher.AddOrSubtractOperator> operator;
  
  public final hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression expression;
  
  public UnaryAddOrSubtractExpression (hydra.util.Opt<hydra.ext.cypher.openCypher.AddOrSubtractOperator> operator, hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression expression) {
  ...
  public UnaryAddOrSubtractExpression withOperator(hydra.util.Opt<hydra.ext.cypher.openCypher.AddOrSubtractOperator> operator) {
    java.util.Objects.requireNonNull((operator));
