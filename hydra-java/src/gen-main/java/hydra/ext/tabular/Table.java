...
public class Table<V> implements Serializable {
   ...
   */
  public final hydra.util.Opt<hydra.ext.tabular.HeaderRow> header;
  
  /**
   * The data rows of the table. Each row must have the same number of cells.
   */
  public final java.util.List<hydra.ext.tabular.DataRow<V>> data;
  
  public Table (hydra.util.Opt<hydra.ext.tabular.HeaderRow> header, java.util.List<hydra.ext.tabular.DataRow<V>> data) {
  ...
  public Table withHeader(hydra.util.Opt<hydra.ext.tabular.HeaderRow> header) {
    java.util.Objects.requireNonNull((header));
    return new Table(header, data);
  }
  
  public Table withData(java.util.List<hydra.ext.tabular.DataRow<V>> data) {
    java.util.Objects.requireNonNull((data));
    return new Table(header, data);
  }
}
