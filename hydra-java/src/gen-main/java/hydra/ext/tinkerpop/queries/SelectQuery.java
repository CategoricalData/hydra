...
public class SelectQuery implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.SelectQuery");
  ...
  public final hydra.ext.tinkerpop.queries.Projections projection;
  
  public SelectQuery (Boolean distinct, hydra.ext.tinkerpop.queries.Projections projection) {
  ...
  public SelectQuery withProjection(hydra.ext.tinkerpop.queries.Projections projection) {
    java.util.Objects.requireNonNull((projection));
    return new SelectQuery(distinct, projection);
  }
}
