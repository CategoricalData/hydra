...
public abstract class BinaryBooleanOperator implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.BinaryBooleanOperator");
  ...
  public static final class And extends hydra.ext.tinkerpop.queries.BinaryBooleanOperator implements Serializable {
    public And () {
  ...
  public static final class Or extends hydra.ext.tinkerpop.queries.BinaryBooleanOperator implements Serializable {
    public Or () {
  ...
  public static final class Xor extends hydra.ext.tinkerpop.queries.BinaryBooleanOperator implements Serializable {
    public Xor () {
