...
public class MatchQuery implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.MatchQuery");
  ...
  public final java.util.List<hydra.ext.tinkerpop.queries.Projection> pattern;
  
  public final hydra.util.Opt<hydra.ext.tinkerpop.queries.Expression> where;
  
  public MatchQuery (Boolean optional, java.util.List<hydra.ext.tinkerpop.queries.Projection> pattern, hydra.util.Opt<hydra.ext.tinkerpop.queries.Expression> where) {
  ...
  public MatchQuery withPattern(java.util.List<hydra.ext.tinkerpop.queries.Projection> pattern) {
    java.util.Objects.requireNonNull((pattern));
    return new MatchQuery(optional, pattern, where);
  }
  
  public MatchQuery withWhere(hydra.util.Opt<hydra.ext.tinkerpop.queries.Expression> where) {
    java.util.Objects.requireNonNull((where));
    return new MatchQuery(optional, pattern, where);
  }
}
