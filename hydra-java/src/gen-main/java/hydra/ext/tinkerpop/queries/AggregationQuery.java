...
public abstract class AggregationQuery implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.AggregationQuery");
  ...
  public static final class Count extends hydra.ext.tinkerpop.queries.AggregationQuery implements Serializable {
    public Count () {
