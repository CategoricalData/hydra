...
public abstract class UnaryOperator implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.UnaryOperator");
  ...
  public static final class Negate extends hydra.ext.tinkerpop.queries.UnaryOperator implements Serializable {
    public Negate () {
