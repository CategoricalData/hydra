...
public class LetQuery implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.LetQuery");
  ...
  public final java.util.List<hydra.ext.tinkerpop.queries.Binding> bindings;
  
  public final hydra.ext.tinkerpop.queries.Query environment;
  
  public LetQuery (java.util.List<hydra.ext.tinkerpop.queries.Binding> bindings, hydra.ext.tinkerpop.queries.Query environment) {
  ...
  public LetQuery withBindings(java.util.List<hydra.ext.tinkerpop.queries.Binding> bindings) {
    java.util.Objects.requireNonNull((bindings));
    return new LetQuery(bindings, environment);
  }
  
  public LetQuery withEnvironment(hydra.ext.tinkerpop.queries.Query environment) {
    java.util.Objects.requireNonNull((environment));
    return new LetQuery(bindings, environment);
  }
}
