...
public class Projections implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.Projections");
  ...
  public final java.util.List<hydra.ext.tinkerpop.queries.Projection> explicit;
  
  public Projections (Boolean all, java.util.List<hydra.ext.tinkerpop.queries.Projection> explicit) {
  ...
  public Projections withExplicit(java.util.List<hydra.ext.tinkerpop.queries.Projection> explicit) {
    java.util.Objects.requireNonNull((explicit));
    return new Projections(all, explicit);
  }
}
