...
public class PropertyProjection implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/queries.PropertyProjection");
  ...
  public final hydra.ext.tinkerpop.queries.Expression base;
  
  public final hydra.ext.tinkerpop.propertyGraph.PropertyKey key;
  
  public PropertyProjection (hydra.ext.tinkerpop.queries.Expression base, hydra.ext.tinkerpop.propertyGraph.PropertyKey key) {
  ...
  public PropertyProjection withBase(hydra.ext.tinkerpop.queries.Expression base) {
    java.util.Objects.requireNonNull((base));
    return new PropertyProjection(base, key);
  }
  
  public PropertyProjection withKey(hydra.ext.tinkerpop.propertyGraph.PropertyKey key) {
    java.util.Objects.requireNonNull((key));
    return new PropertyProjection(base, key);
  }
}
