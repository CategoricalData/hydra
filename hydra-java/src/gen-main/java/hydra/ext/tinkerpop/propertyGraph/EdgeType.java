...
public class EdgeType<T> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/propertyGraph.EdgeType");
   ...
   */
  public final hydra.ext.tinkerpop.propertyGraph.EdgeLabel label;
   ...
   */
  public final hydra.ext.tinkerpop.propertyGraph.VertexLabel out;
  
  /**
   * The label of the in-vertex (head) of any edge of this edge type
   */
  public final hydra.ext.tinkerpop.propertyGraph.VertexLabel in;
  ...
  public EdgeType (hydra.ext.tinkerpop.propertyGraph.EdgeLabel label, T id, hydra.ext.tinkerpop.propertyGraph.VertexLabel out, hydra.ext.tinkerpop.propertyGraph.VertexLabel in, java.util.List<hydra.ext.tinkerpop.propertyGraph.PropertyType<T>> properties) {
  ...
  public EdgeType withLabel(hydra.ext.tinkerpop.propertyGraph.EdgeLabel label) {
    java.util.Objects.requireNonNull((label));
  ...
  public EdgeType withOut(hydra.ext.tinkerpop.propertyGraph.VertexLabel out) {
    java.util.Objects.requireNonNull((out));
    return new EdgeType(label, id, out, in, properties);
  }
  
  public EdgeType withIn(hydra.ext.tinkerpop.propertyGraph.VertexLabel in) {
    java.util.Objects.requireNonNull((in));
    return new EdgeType(label, id, out, in, properties);
  }
  
  public EdgeType withProperties(java.util.List<hydra.ext.tinkerpop.propertyGraph.PropertyType<T>> properties) {
    java.util.Objects.requireNonNull((properties));
    return new EdgeType(label, id, out, in, properties);
  }
}
