...
public abstract class Direction implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/propertyGraph.Direction");
  ...
  public static final class Out extends hydra.ext.tinkerpop.propertyGraph.Direction implements Serializable {
    public Out () {
  ...
  public static final class In extends hydra.ext.tinkerpop.propertyGraph.Direction implements Serializable {
    public In () {
  ...
  public static final class Both extends hydra.ext.tinkerpop.propertyGraph.Direction implements Serializable {
    public Both () {
  ...
  public static final class Undirected extends hydra.ext.tinkerpop.propertyGraph.Direction implements Serializable {
    public Undirected () {
