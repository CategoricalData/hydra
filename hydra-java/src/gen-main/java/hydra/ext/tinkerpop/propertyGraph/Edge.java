...
public class Edge<V> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/propertyGraph.Edge");
   ...
   */
  public final java.util.Map<hydra.ext.tinkerpop.propertyGraph.PropertyKey, V> properties;
  
  public Edge (hydra.ext.tinkerpop.propertyGraph.EdgeLabel label, V id, V out, V in, java.util.Map<hydra.ext.tinkerpop.propertyGraph.PropertyKey, V> properties) {
  ...
  public Edge withLabel(hydra.ext.tinkerpop.propertyGraph.EdgeLabel label) {
    java.util.Objects.requireNonNull((label));
  ...
  public Edge withProperties(java.util.Map<hydra.ext.tinkerpop.propertyGraph.PropertyKey, V> properties) {
    java.util.Objects.requireNonNull((properties));
    return new Edge(label, id, out, in, properties);
  }
}
