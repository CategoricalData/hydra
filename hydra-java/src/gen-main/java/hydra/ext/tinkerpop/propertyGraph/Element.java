...
public abstract class Element<V> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/propertyGraph.Element");
  ...
  public static final class Vertex<V> extends hydra.ext.tinkerpop.propertyGraph.Element<V> implements Serializable {
    public final hydra.ext.tinkerpop.propertyGraph.Vertex<V> value;
    
    public Vertex (hydra.ext.tinkerpop.propertyGraph.Vertex<V> value) {
  ...
  public static final class Edge<V> extends hydra.ext.tinkerpop.propertyGraph.Element<V> implements Serializable {
    public final hydra.ext.tinkerpop.propertyGraph.Edge<V> value;
    
    public Edge (hydra.ext.tinkerpop.propertyGraph.Edge<V> value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
