...
public class Vertex<V> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/propertyGraph.Vertex");
  ...
  public Vertex (hydra.ext.tinkerpop.propertyGraph.VertexLabel label, V id, java.util.Map<hydra.ext.tinkerpop.propertyGraph.PropertyKey, V> properties) {
  ...
  public Vertex withLabel(hydra.ext.tinkerpop.propertyGraph.VertexLabel label) {
    java.util.Objects.requireNonNull((label));
  ...
  public Vertex withProperties(java.util.Map<hydra.ext.tinkerpop.propertyGraph.PropertyKey, V> properties) {
    java.util.Objects.requireNonNull((properties));
    return new Vertex(label, id, properties);
  }
}
