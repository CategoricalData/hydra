...
public class ElementTypeTree<T> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/propertyGraph.ElementTypeTree");
  ...
  public final hydra.ext.tinkerpop.propertyGraph.ElementType<T> self;
  
  public final java.util.List<hydra.ext.tinkerpop.propertyGraph.ElementTypeTree<T>> dependencies;
  
  public ElementTypeTree (hydra.ext.tinkerpop.propertyGraph.ElementType<T> self, java.util.List<hydra.ext.tinkerpop.propertyGraph.ElementTypeTree<T>> dependencies) {
  ...
  public ElementTypeTree withSelf(hydra.ext.tinkerpop.propertyGraph.ElementType<T> self) {
    java.util.Objects.requireNonNull((self));
    return new ElementTypeTree(self, dependencies);
  }
  
  public ElementTypeTree withDependencies(java.util.List<hydra.ext.tinkerpop.propertyGraph.ElementTypeTree<T>> dependencies) {
    java.util.Objects.requireNonNull((dependencies));
    return new ElementTypeTree(self, dependencies);
  }
}
