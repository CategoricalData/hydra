...
public class StringArgumentAndGenericLiteralArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.StringArgumentAndGenericLiteralArgument");
  ...
  public StringArgumentAndGenericLiteralArgument (hydra.ext.tinkerpop.gremlin.StringArgument string, hydra.ext.tinkerpop.gremlin.GenericLiteralArgument literal) {
  ...
  public StringArgumentAndGenericLiteralArgument withString(hydra.ext.tinkerpop.gremlin.StringArgument string) {
    java.util.Objects.requireNonNull((string));
    return new StringArgumentAndGenericLiteralArgument(string, literal);
  }
  
  public StringArgumentAndGenericLiteralArgument withLiteral(hydra.ext.tinkerpop.gremlin.GenericLiteralArgument literal) {
    java.util.Objects.requireNonNull((literal));
    return new StringArgumentAndGenericLiteralArgument(string, literal);
  }
}
