...
public abstract class PredicateOrTraversal implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.PredicateOrTraversal");
  ...
  public static final class Predicate extends hydra.ext.tinkerpop.gremlin.PredicateOrTraversal implements Serializable {
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.PredicateOrTraversal implements Serializable {
