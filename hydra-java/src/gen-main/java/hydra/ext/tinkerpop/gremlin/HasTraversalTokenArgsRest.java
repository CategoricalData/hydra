...
public abstract class HasTraversalTokenArgsRest implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.HasTraversalTokenArgsRest");
  ...
  public static final class Literal extends hydra.ext.tinkerpop.gremlin.HasTraversalTokenArgsRest implements Serializable {
  ...
  public static final class Predicate extends hydra.ext.tinkerpop.gremlin.HasTraversalTokenArgsRest implements Serializable {
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.HasTraversalTokenArgsRest implements Serializable {
