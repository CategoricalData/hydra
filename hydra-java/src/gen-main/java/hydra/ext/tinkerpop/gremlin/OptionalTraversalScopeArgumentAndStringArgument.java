...
public class OptionalTraversalScopeArgumentAndStringArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.OptionalTraversalScopeArgumentAndStringArgument");
  ...
  public OptionalTraversalScopeArgumentAndStringArgument (hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.ext.tinkerpop.gremlin.StringArgument string) {
  ...
  public OptionalTraversalScopeArgumentAndStringArgument withScope(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    java.util.Objects.requireNonNull((scope));
    return new OptionalTraversalScopeArgumentAndStringArgument(scope, string);
  }
  
  public OptionalTraversalScopeArgumentAndStringArgument withString(hydra.ext.tinkerpop.gremlin.StringArgument string) {
    java.util.Objects.requireNonNull((string));
    return new OptionalTraversalScopeArgumentAndStringArgument(scope, string);
  }
}
