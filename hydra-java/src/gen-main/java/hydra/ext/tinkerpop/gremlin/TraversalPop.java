...
public abstract class TraversalPop implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalPop");
  ...
  public static final class First extends hydra.ext.tinkerpop.gremlin.TraversalPop implements Serializable {
    public First () {
  ...
  public static final class Last extends hydra.ext.tinkerpop.gremlin.TraversalPop implements Serializable {
    public Last () {
  ...
  public static final class All extends hydra.ext.tinkerpop.gremlin.TraversalPop implements Serializable {
    public All () {
  ...
  public static final class Mixed extends hydra.ext.tinkerpop.gremlin.TraversalPop implements Serializable {
    public Mixed () {
