...
public abstract class ShortestPathConstants implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.ShortestPathConstants");
  ...
  public static final class Target extends hydra.ext.tinkerpop.gremlin.ShortestPathConstants implements Serializable {
    public Target () {
  ...
  public static final class Edges extends hydra.ext.tinkerpop.gremlin.ShortestPathConstants implements Serializable {
    public Edges () {
  ...
  public static final class Distance extends hydra.ext.tinkerpop.gremlin.ShortestPathConstants implements Serializable {
    public Distance () {
  ...
  public static final class MaxDistance extends hydra.ext.tinkerpop.gremlin.ShortestPathConstants implements Serializable {
    public MaxDistance () {
  ...
  public static final class IncludeEdges extends hydra.ext.tinkerpop.gremlin.ShortestPathConstants implements Serializable {
    public IncludeEdges () {
