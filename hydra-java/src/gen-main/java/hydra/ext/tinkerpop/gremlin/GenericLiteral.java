...
public abstract class GenericLiteral implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.GenericLiteral");
  ...
  public static final class Numeric extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
  ...
  public static final class Boolean_ extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
  ...
  public static final class String_ extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
  ...
  public static final class Date extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.DateLiteral value;
    
    public Date (hydra.ext.tinkerpop.gremlin.DateLiteral value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Null extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public Null () {
  ...
  public static final class Nan extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public Nan () {
  ...
  public static final class Inf extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public Inf () {
  ...
  public static final class TraversalToken extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
  ...
  public static final class TraversalCardinality extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.TraversalCardinality value;
    
    public TraversalCardinality (hydra.ext.tinkerpop.gremlin.TraversalCardinality value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class TraversalDirection extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
  ...
  public static final class TraversalMerge extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.TraversalMerge value;
    
    public TraversalMerge (hydra.ext.tinkerpop.gremlin.TraversalMerge value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class TraversalPick extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.TraversalPick value;
    
    public TraversalPick (hydra.ext.tinkerpop.gremlin.TraversalPick value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class TraversalDT extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.TraversalDT value;
    
    public TraversalDT (hydra.ext.tinkerpop.gremlin.TraversalDT value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class StructureVertex extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.StructureVertex value;
    
    public StructureVertex (hydra.ext.tinkerpop.gremlin.StructureVertex value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class GenericLiteralSet extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.GenericLiteralSet value;
    
    public GenericLiteralSet (hydra.ext.tinkerpop.gremlin.GenericLiteralSet value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class GenericLiteralCollection extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.GenericLiteralCollection value;
    
    public GenericLiteralCollection (hydra.ext.tinkerpop.gremlin.GenericLiteralCollection value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class GenericLiteralRange extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.GenericLiteralRange value;
    
    public GenericLiteralRange (hydra.ext.tinkerpop.gremlin.GenericLiteralRange value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class NestedTraversal extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.NestedTraversal value;
    
    public NestedTraversal (hydra.ext.tinkerpop.gremlin.NestedTraversal value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class TerminatedTraversal extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.TerminatedTraversal value;
    
    public TerminatedTraversal (hydra.ext.tinkerpop.gremlin.TerminatedTraversal value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class GenericLiteralMap extends hydra.ext.tinkerpop.gremlin.GenericLiteral implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.GenericLiteralMap value;
    
    public GenericLiteralMap (hydra.ext.tinkerpop.gremlin.GenericLiteralMap value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
