...
public abstract class HasStringArgumentAndOptionalStringLiteralVarargsRest implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest");
  ...
  public static final class Object_ extends hydra.ext.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest implements Serializable {
  ...
  public static final class Predicate extends hydra.ext.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest implements Serializable {
  ...
  public static final class StringObject extends hydra.ext.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument value;
    
    public StringObject (hydra.ext.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class StringPredicate extends hydra.ext.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate value;
    
    public StringPredicate (hydra.ext.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest implements Serializable {
