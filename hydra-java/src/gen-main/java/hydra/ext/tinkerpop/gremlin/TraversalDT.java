...
public abstract class TraversalDT implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalDT");
  ...
  public static final class Second extends hydra.ext.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Second () {
  ...
  public static final class Minute extends hydra.ext.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Minute () {
  ...
  public static final class Hour extends hydra.ext.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Hour () {
  ...
  public static final class Day extends hydra.ext.tinkerpop.gremlin.TraversalDT implements Serializable {
    public Day () {
