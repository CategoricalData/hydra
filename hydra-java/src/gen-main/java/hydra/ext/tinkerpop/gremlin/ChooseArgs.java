...
public abstract class ChooseArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.ChooseArgs");
  ...
  public static final class Function extends hydra.ext.tinkerpop.gremlin.ChooseArgs implements Serializable {
  ...
  public static final class PredicateTraversal extends hydra.ext.tinkerpop.gremlin.ChooseArgs implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.PredicateTraversalArgument value;
    
    public PredicateTraversal (hydra.ext.tinkerpop.gremlin.PredicateTraversalArgument value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.ChooseArgs implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.NestedTraversalArgument value;
    
    public Traversal (hydra.ext.tinkerpop.gremlin.NestedTraversalArgument value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
