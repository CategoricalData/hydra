...
public class TraversalSourceQuery implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalSourceQuery");
  ...
  public final hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TransactionPart> transactionPart;
  
  public TraversalSourceQuery (hydra.ext.tinkerpop.gremlin.TraversalSource source, hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TransactionPart> transactionPart) {
  ...
  public TraversalSourceQuery withSource(hydra.ext.tinkerpop.gremlin.TraversalSource source) {
    java.util.Objects.requireNonNull((source));
    return new TraversalSourceQuery(source, transactionPart);
  }
  
  public TraversalSourceQuery withTransactionPart(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TransactionPart> transactionPart) {
    java.util.Objects.requireNonNull((transactionPart));
    return new TraversalSourceQuery(source, transactionPart);
  }
}
