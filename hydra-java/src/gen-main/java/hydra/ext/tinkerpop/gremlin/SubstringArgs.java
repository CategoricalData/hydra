...
public class SubstringArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.SubstringArgs");
  ...
  public final hydra.ext.tinkerpop.gremlin.IntegerArgument start;
  
  public final hydra.util.Opt<hydra.ext.tinkerpop.gremlin.IntegerArgument> end;
  
  public SubstringArgs (hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.ext.tinkerpop.gremlin.IntegerArgument start, hydra.util.Opt<hydra.ext.tinkerpop.gremlin.IntegerArgument> end) {
  ...
  public SubstringArgs withScope(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    java.util.Objects.requireNonNull((scope));
    return new SubstringArgs(scope, start, end);
  }
  
  public SubstringArgs withStart(hydra.ext.tinkerpop.gremlin.IntegerArgument start) {
    java.util.Objects.requireNonNull((start));
    return new SubstringArgs(scope, start, end);
  }
  
  public SubstringArgs withEnd(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.IntegerArgument> end) {
    java.util.Objects.requireNonNull((end));
    return new SubstringArgs(scope, start, end);
  }
}
