...
public class PredicateTraversalArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.PredicateTraversalArgument");
  ...
  public PredicateTraversalArgument (hydra.ext.tinkerpop.gremlin.TraversalPredicate predicate, hydra.ext.tinkerpop.gremlin.NestedTraversal traversal1, hydra.util.Opt<hydra.ext.tinkerpop.gremlin.NestedTraversal> traversal2) {
  ...
  public PredicateTraversalArgument withPredicate(hydra.ext.tinkerpop.gremlin.TraversalPredicate predicate) {
    java.util.Objects.requireNonNull((predicate));
    return new PredicateTraversalArgument(predicate, traversal1, traversal2);
  }
  
  public PredicateTraversalArgument withTraversal1(hydra.ext.tinkerpop.gremlin.NestedTraversal traversal1) {
    java.util.Objects.requireNonNull((traversal1));
    return new PredicateTraversalArgument(predicate, traversal1, traversal2);
  }
  
  public PredicateTraversalArgument withTraversal2(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.NestedTraversal> traversal2) {
    java.util.Objects.requireNonNull((traversal2));
    return new PredicateTraversalArgument(predicate, traversal1, traversal2);
  }
}
