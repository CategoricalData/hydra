...
public abstract class Query implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.Query");
  ...
  public static final class TraversalSource extends hydra.ext.tinkerpop.gremlin.Query implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.TraversalSourceQuery value;
    
    public TraversalSource (hydra.ext.tinkerpop.gremlin.TraversalSourceQuery value) {
  ...
  public static final class RootTraversal extends hydra.ext.tinkerpop.gremlin.Query implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.RootTraversalQuery value;
    
    public RootTraversal (hydra.ext.tinkerpop.gremlin.RootTraversalQuery value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class ToString extends hydra.ext.tinkerpop.gremlin.Query implements Serializable {
    public ToString () {
  ...
  public static final class Empty extends hydra.ext.tinkerpop.gremlin.Query implements Serializable {
    public Empty () {
