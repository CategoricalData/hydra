...
public class TailArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TailArgs");
  ...
  public final hydra.util.Opt<hydra.ext.tinkerpop.gremlin.IntegerArgument> integer;
  
  public TailArgs (hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.util.Opt<hydra.ext.tinkerpop.gremlin.IntegerArgument> integer) {
  ...
  public TailArgs withScope(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    java.util.Objects.requireNonNull((scope));
    return new TailArgs(scope, integer);
  }
  
  public TailArgs withInteger(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.IntegerArgument> integer) {
    java.util.Objects.requireNonNull((integer));
    return new TailArgs(scope, integer);
  }
}
