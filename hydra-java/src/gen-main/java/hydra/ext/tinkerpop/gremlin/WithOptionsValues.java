...
public abstract class WithOptionsValues implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.WithOptionsValues");
  ...
  public static final class Tokens extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Tokens () {
  ...
  public static final class None extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public None () {
  ...
  public static final class Ids extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Ids () {
  ...
  public static final class Labels extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Labels () {
  ...
  public static final class Keys extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Keys () {
  ...
  public static final class Values extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Values () {
  ...
  public static final class All extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public All () {
  ...
  public static final class List extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public List () {
  ...
  public static final class Map extends hydra.ext.tinkerpop.gremlin.WithOptionsValues implements Serializable {
    public Map () {
