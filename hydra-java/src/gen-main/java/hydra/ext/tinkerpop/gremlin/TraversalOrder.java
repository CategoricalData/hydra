...
public abstract class TraversalOrder implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalOrder");
  ...
  public static final class Incr extends hydra.ext.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Incr () {
  ...
  public static final class Decr extends hydra.ext.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Decr () {
  ...
  public static final class Asc extends hydra.ext.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Asc () {
  ...
  public static final class Desc extends hydra.ext.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Desc () {
  ...
  public static final class Shuffle extends hydra.ext.tinkerpop.gremlin.TraversalOrder implements Serializable {
    public Shuffle () {
