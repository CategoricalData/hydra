...
public abstract class TraversalSelfMethod implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalSelfMethod");
  ...
  public static final class Discard extends hydra.ext.tinkerpop.gremlin.TraversalSelfMethod implements Serializable {
    public Discard () {
