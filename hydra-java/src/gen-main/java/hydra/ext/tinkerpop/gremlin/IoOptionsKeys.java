...
public abstract class IoOptionsKeys implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.IoOptionsKeys");
  ...
  public static final class Reader extends hydra.ext.tinkerpop.gremlin.IoOptionsKeys implements Serializable {
    public Reader () {
  ...
  public static final class Writer extends hydra.ext.tinkerpop.gremlin.IoOptionsKeys implements Serializable {
    public Writer () {
