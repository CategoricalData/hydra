...
public class StringNullableArgumentAndTraversalPredicate implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.StringNullableArgumentAndTraversalPredicate");
  ...
  public StringNullableArgumentAndTraversalPredicate (hydra.ext.tinkerpop.gremlin.StringNullableArgument string, hydra.ext.tinkerpop.gremlin.TraversalPredicate predicate) {
  ...
  public StringNullableArgumentAndTraversalPredicate withString(hydra.ext.tinkerpop.gremlin.StringNullableArgument string) {
    java.util.Objects.requireNonNull((string));
    return new StringNullableArgumentAndTraversalPredicate(string, predicate);
  }
  
  public StringNullableArgumentAndTraversalPredicate withPredicate(hydra.ext.tinkerpop.gremlin.TraversalPredicate predicate) {
    java.util.Objects.requireNonNull((predicate));
    return new StringNullableArgumentAndTraversalPredicate(string, predicate);
  }
}
