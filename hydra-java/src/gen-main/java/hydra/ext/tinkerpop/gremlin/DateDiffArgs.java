...
public abstract class DateDiffArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.DateDiffArgs");
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.DateDiffArgs implements Serializable {
  ...
  public static final class Date extends hydra.ext.tinkerpop.gremlin.DateDiffArgs implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.DateArgument value;
    
    public Date (hydra.ext.tinkerpop.gremlin.DateArgument value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
