...
public class GenericLiteralArgumentAndTraversalBiFunctionArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.GenericLiteralArgumentAndTraversalBiFunctionArgument");
  ...
  public final hydra.ext.tinkerpop.gremlin.TraversalBiFunctionArgument biFunction;
  
  public GenericLiteralArgumentAndTraversalBiFunctionArgument (hydra.ext.tinkerpop.gremlin.GenericLiteralArgument literal, hydra.ext.tinkerpop.gremlin.TraversalBiFunctionArgument biFunction) {
  ...
  public GenericLiteralArgumentAndTraversalBiFunctionArgument withLiteral(hydra.ext.tinkerpop.gremlin.GenericLiteralArgument literal) {
    java.util.Objects.requireNonNull((literal));
    return new GenericLiteralArgumentAndTraversalBiFunctionArgument(literal, biFunction);
  }
  
  public GenericLiteralArgumentAndTraversalBiFunctionArgument withBiFunction(hydra.ext.tinkerpop.gremlin.TraversalBiFunctionArgument biFunction) {
    java.util.Objects.requireNonNull((biFunction));
    return new GenericLiteralArgumentAndTraversalBiFunctionArgument(literal, biFunction);
  }
}
