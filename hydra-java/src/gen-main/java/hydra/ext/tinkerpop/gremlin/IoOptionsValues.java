...
public abstract class IoOptionsValues implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.IoOptionsValues");
  ...
  public static final class Gryo extends hydra.ext.tinkerpop.gremlin.IoOptionsValues implements Serializable {
    public Gryo () {
  ...
  public static final class Graphson extends hydra.ext.tinkerpop.gremlin.IoOptionsValues implements Serializable {
    public Graphson () {
  ...
  public static final class Graphml extends hydra.ext.tinkerpop.gremlin.IoOptionsValues implements Serializable {
    public Graphml () {
