...
public abstract class TransactionPart implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TransactionPart");
  ...
  public static final class Begin extends hydra.ext.tinkerpop.gremlin.TransactionPart implements Serializable {
    public Begin () {
  ...
  public static final class Commit extends hydra.ext.tinkerpop.gremlin.TransactionPart implements Serializable {
    public Commit () {
  ...
  public static final class Rollback extends hydra.ext.tinkerpop.gremlin.TransactionPart implements Serializable {
    public Rollback () {
