...
public abstract class TraversalDirection implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalDirection");
  ...
  public static final class In extends hydra.ext.tinkerpop.gremlin.TraversalDirection implements Serializable {
    public In () {
  ...
  public static final class Out extends hydra.ext.tinkerpop.gremlin.TraversalDirection implements Serializable {
    public Out () {
  ...
  public static final class Both extends hydra.ext.tinkerpop.gremlin.TraversalDirection implements Serializable {
    public Both () {
