...
public abstract class WithArgsKeys implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.WithArgsKeys");
  ...
  public static final class WithOption extends hydra.ext.tinkerpop.gremlin.WithArgsKeys implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.WithOptionKeys value;
    
    public WithOption (hydra.ext.tinkerpop.gremlin.WithOptionKeys value) {
  ...
  public static final class String_ extends hydra.ext.tinkerpop.gremlin.WithArgsKeys implements Serializable {
