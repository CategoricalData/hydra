...
public abstract class StringArgumentOrNestedTraversal implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.StringArgumentOrNestedTraversal");
  ...
  public static final class String_ extends hydra.ext.tinkerpop.gremlin.StringArgumentOrNestedTraversal implements Serializable {
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.StringArgumentOrNestedTraversal implements Serializable {
