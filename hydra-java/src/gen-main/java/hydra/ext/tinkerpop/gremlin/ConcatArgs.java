...
public abstract class ConcatArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.ConcatArgs");
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.ConcatArgs implements Serializable {
    public final java.util.List<hydra.ext.tinkerpop.gremlin.NestedTraversal> value;
    
    public Traversal (java.util.List<hydra.ext.tinkerpop.gremlin.NestedTraversal> value) {
  ...
  public static final class String_ extends hydra.ext.tinkerpop.gremlin.ConcatArgs implements Serializable {
