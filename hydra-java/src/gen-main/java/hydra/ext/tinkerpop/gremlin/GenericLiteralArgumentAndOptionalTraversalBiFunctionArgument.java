...
public class GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument");
  ...
  public final hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalBiFunctionArgument> biFunction;
  
  public GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument (hydra.ext.tinkerpop.gremlin.GenericLiteralArgument literal, hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalBiFunctionArgument> biFunction) {
  ...
  public GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument withLiteral(hydra.ext.tinkerpop.gremlin.GenericLiteralArgument literal) {
    java.util.Objects.requireNonNull((literal));
    return new GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument(literal, biFunction);
  }
  
  public GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument withBiFunction(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalBiFunctionArgument> biFunction) {
    java.util.Objects.requireNonNull((biFunction));
    return new GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument(literal, biFunction);
  }
}
