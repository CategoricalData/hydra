...
public abstract class PeerPressureConstants implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.PeerPressureConstants");
  ...
  public static final class Edges extends hydra.ext.tinkerpop.gremlin.PeerPressureConstants implements Serializable {
    public Edges () {
  ...
  public static final class Times extends hydra.ext.tinkerpop.gremlin.PeerPressureConstants implements Serializable {
    public Times () {
  ...
  public static final class PropertyName extends hydra.ext.tinkerpop.gremlin.PeerPressureConstants implements Serializable {
    public PropertyName () {
