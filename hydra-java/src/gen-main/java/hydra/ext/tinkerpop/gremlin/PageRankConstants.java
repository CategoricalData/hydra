...
public abstract class PageRankConstants implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.PageRankConstants");
  ...
  public static final class Edges extends hydra.ext.tinkerpop.gremlin.PageRankConstants implements Serializable {
    public Edges () {
  ...
  public static final class Times extends hydra.ext.tinkerpop.gremlin.PageRankConstants implements Serializable {
    public Times () {
  ...
  public static final class PropertyName extends hydra.ext.tinkerpop.gremlin.PageRankConstants implements Serializable {
    public PropertyName () {
