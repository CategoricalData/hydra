...
public class HasTraversalTokenArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.HasTraversalTokenArgs");
  ...
  public final hydra.ext.tinkerpop.gremlin.TraversalTokenArgument traversalToken;
  
  public final hydra.ext.tinkerpop.gremlin.HasTraversalTokenArgsRest rest;
  
  public HasTraversalTokenArgs (hydra.ext.tinkerpop.gremlin.TraversalTokenArgument traversalToken, hydra.ext.tinkerpop.gremlin.HasTraversalTokenArgsRest rest) {
  ...
  public HasTraversalTokenArgs withTraversalToken(hydra.ext.tinkerpop.gremlin.TraversalTokenArgument traversalToken) {
    java.util.Objects.requireNonNull((traversalToken));
    return new HasTraversalTokenArgs(traversalToken, rest);
  }
  
  public HasTraversalTokenArgs withRest(hydra.ext.tinkerpop.gremlin.HasTraversalTokenArgsRest rest) {
    java.util.Objects.requireNonNull((rest));
    return new HasTraversalTokenArgs(traversalToken, rest);
  }
}
