...
public abstract class WhereArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.WhereArgs");
  ...
  public static final class Predicate extends hydra.ext.tinkerpop.gremlin.WhereArgs implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.WhereWithPredicateArgs value;
    
    public Predicate (hydra.ext.tinkerpop.gremlin.WhereWithPredicateArgs value) {
  ...
  public static final class String_ extends hydra.ext.tinkerpop.gremlin.WhereArgs implements Serializable {
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.WhereArgs implements Serializable {
