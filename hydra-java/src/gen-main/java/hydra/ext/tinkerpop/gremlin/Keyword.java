...
public abstract class Keyword implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.Keyword");
  ...
  public static final class Edges extends hydra.ext.tinkerpop.gremlin.Keyword implements Serializable {
    public Edges () {
  ...
  public static final class Keys extends hydra.ext.tinkerpop.gremlin.Keyword implements Serializable {
    public Keys () {
  ...
  public static final class New extends hydra.ext.tinkerpop.gremlin.Keyword implements Serializable {
    public New () {
  ...
  public static final class Values extends hydra.ext.tinkerpop.gremlin.Keyword implements Serializable {
    public Values () {
