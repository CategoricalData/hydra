...
public class GenericLiteralList implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.GenericLiteralList");
  
  public static final hydra.core.Name FIELD_NAME_VALUE = new hydra.core.Name("value");
  
  public final java.util.List<hydra.ext.tinkerpop.gremlin.GenericLiteral> value;
  
  public GenericLiteralList (java.util.List<hydra.ext.tinkerpop.gremlin.GenericLiteral> value) {
