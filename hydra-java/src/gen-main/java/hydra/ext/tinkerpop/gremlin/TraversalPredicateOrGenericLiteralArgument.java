...
public abstract class TraversalPredicateOrGenericLiteralArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalPredicateOrGenericLiteralArgument");
  ...
  public static final class Predicate extends hydra.ext.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument implements Serializable {
  ...
  public static final class Literal extends hydra.ext.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument implements Serializable {
    public final java.util.List<hydra.ext.tinkerpop.gremlin.GenericLiteralArgument> value;
    
    public Literal (java.util.List<hydra.ext.tinkerpop.gremlin.GenericLiteralArgument> value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
