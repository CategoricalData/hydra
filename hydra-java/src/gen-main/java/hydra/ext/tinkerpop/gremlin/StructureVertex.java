...
public class StructureVertex implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.StructureVertex");
  ...
  public final hydra.ext.tinkerpop.gremlin.GenericLiteralArgument id;
  
  public final hydra.ext.tinkerpop.gremlin.StringArgument label;
  
  public StructureVertex (Boolean new_, hydra.ext.tinkerpop.gremlin.GenericLiteralArgument id, hydra.ext.tinkerpop.gremlin.StringArgument label) {
  ...
  public StructureVertex withId(hydra.ext.tinkerpop.gremlin.GenericLiteralArgument id) {
    java.util.Objects.requireNonNull((id));
    return new StructureVertex(new_, id, label);
  }
  
  public StructureVertex withLabel(hydra.ext.tinkerpop.gremlin.StringArgument label) {
    java.util.Objects.requireNonNull((label));
    return new StructureVertex(new_, id, label);
  }
}
