...
public abstract class TraversalColumn implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalColumn");
  ...
  public static final class Keys extends hydra.ext.tinkerpop.gremlin.TraversalColumn implements Serializable {
    public Keys () {
  ...
  public static final class Values extends hydra.ext.tinkerpop.gremlin.TraversalColumn implements Serializable {
    public Values () {
