...
public class OptionalTraversalScopeArgumentAndIntegerArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.OptionalTraversalScopeArgumentAndIntegerArgument");
  ...
  public final hydra.ext.tinkerpop.gremlin.IntegerArgument long_;
  
  public OptionalTraversalScopeArgumentAndIntegerArgument (hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.ext.tinkerpop.gremlin.IntegerArgument long_) {
  ...
  public OptionalTraversalScopeArgumentAndIntegerArgument withScope(hydra.util.Opt<hydra.ext.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    java.util.Objects.requireNonNull((scope));
    return new OptionalTraversalScopeArgumentAndIntegerArgument(scope, long_);
  }
  
  public OptionalTraversalScopeArgumentAndIntegerArgument withLong(hydra.ext.tinkerpop.gremlin.IntegerArgument long_) {
    java.util.Objects.requireNonNull((long_));
    return new OptionalTraversalScopeArgumentAndIntegerArgument(scope, long_);
  }
}
