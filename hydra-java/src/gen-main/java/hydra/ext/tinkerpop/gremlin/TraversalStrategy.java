...
public class TraversalStrategy implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.TraversalStrategy");
  ...
  public final hydra.ext.tinkerpop.gremlin.Identifier class_;
  
  public final java.util.List<hydra.ext.tinkerpop.gremlin.Configuration> configurations;
  
  public TraversalStrategy (Boolean new_, hydra.ext.tinkerpop.gremlin.Identifier class_, java.util.List<hydra.ext.tinkerpop.gremlin.Configuration> configurations) {
  ...
  public TraversalStrategy withClass(hydra.ext.tinkerpop.gremlin.Identifier class_) {
    java.util.Objects.requireNonNull((class_));
    return new TraversalStrategy(new_, class_, configurations);
  }
  
  public TraversalStrategy withConfigurations(java.util.List<hydra.ext.tinkerpop.gremlin.Configuration> configurations) {
    java.util.Objects.requireNonNull((configurations));
    return new TraversalStrategy(new_, class_, configurations);
  }
}
