...
public abstract class GenericLiteralMapNullableArgumentOrNestedTraversal implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal");
  ...
  public static final class Map extends hydra.ext.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal implements Serializable {
    public final hydra.ext.tinkerpop.gremlin.GenericLiteralMapNullableArgument value;
    
    public Map (hydra.ext.tinkerpop.gremlin.GenericLiteralMapNullableArgument value) {
  ...
  public static final class Traversal extends hydra.ext.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal implements Serializable {
