...
public class PropertySpec implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/mappings.PropertySpec");
   ...
   */
  public final hydra.ext.tinkerpop.mappings.ValueSpec value;
  
  public PropertySpec (hydra.ext.tinkerpop.propertyGraph.PropertyKey key, hydra.ext.tinkerpop.mappings.ValueSpec value) {
  ...
  public PropertySpec withKey(hydra.ext.tinkerpop.propertyGraph.PropertyKey key) {
    java.util.Objects.requireNonNull((key));
    return new PropertySpec(key, value);
  }
  
  public PropertySpec withValue(hydra.ext.tinkerpop.mappings.ValueSpec value) {
    java.util.Objects.requireNonNull((value));
    return new PropertySpec(key, value);
  }
}
