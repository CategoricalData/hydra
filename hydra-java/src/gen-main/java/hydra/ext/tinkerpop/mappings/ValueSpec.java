...
public abstract class ValueSpec implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/mappings.ValueSpec");
   ...
   */
  public static final class Value extends hydra.ext.tinkerpop.mappings.ValueSpec implements Serializable {
    public Value () {
   ...
   */
  public static final class Pattern extends hydra.ext.tinkerpop.mappings.ValueSpec implements Serializable {
