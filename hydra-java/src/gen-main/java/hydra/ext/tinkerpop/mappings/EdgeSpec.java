...
public class EdgeSpec implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/mappings.EdgeSpec");
   ...
   */
  public final hydra.ext.tinkerpop.mappings.ValueSpec out;
  
  /**
   * A specification of the in-vertex reference of each target edge
   */
  public final hydra.ext.tinkerpop.mappings.ValueSpec in;
  ...
  public EdgeSpec (hydra.ext.tinkerpop.propertyGraph.EdgeLabel label, hydra.ext.tinkerpop.mappings.ValueSpec id, hydra.ext.tinkerpop.mappings.ValueSpec out, hydra.ext.tinkerpop.mappings.ValueSpec in, java.util.List<hydra.ext.tinkerpop.mappings.PropertySpec> properties) {
  ...
  public EdgeSpec withLabel(hydra.ext.tinkerpop.propertyGraph.EdgeLabel label) {
    java.util.Objects.requireNonNull((label));
    return new EdgeSpec(label, id, out, in, properties);
  }
  
  public EdgeSpec withId(hydra.ext.tinkerpop.mappings.ValueSpec id) {
    java.util.Objects.requireNonNull((id));
    return new EdgeSpec(label, id, out, in, properties);
  }
  
  public EdgeSpec withOut(hydra.ext.tinkerpop.mappings.ValueSpec out) {
    java.util.Objects.requireNonNull((out));
    return new EdgeSpec(label, id, out, in, properties);
  }
  
  public EdgeSpec withIn(hydra.ext.tinkerpop.mappings.ValueSpec in) {
    java.util.Objects.requireNonNull((in));
    return new EdgeSpec(label, id, out, in, properties);
  }
  
  public EdgeSpec withProperties(java.util.List<hydra.ext.tinkerpop.mappings.PropertySpec> properties) {
    java.util.Objects.requireNonNull((properties));
    return new EdgeSpec(label, id, out, in, properties);
  }
}
