...
public class Schema<S, T, V> {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/tinkerpop/mappings.Schema");
  ...
  public final hydra.ext.tinkerpop.mappings.AnnotationSchema annotations;
  
  public final V defaultVertexId;
  
  public final V defaultEdgeId;
  
  public Schema (hydra.compute.Coder<S, S, hydra.core.Type, T> vertexIdTypes, hydra.compute.Coder<S, S, hydra.core.Term, V> vertexIds, hydra.compute.Coder<S, S, hydra.core.Type, T> edgeIdTypes, hydra.compute.Coder<S, S, hydra.core.Term, V> edgeIds, hydra.compute.Coder<S, S, hydra.core.Type, T> propertyTypes, hydra.compute.Coder<S, S, hydra.core.Term, V> propertyValues, hydra.ext.tinkerpop.mappings.AnnotationSchema annotations, V defaultVertexId, V defaultEdgeId) {
  ...
  public Schema withAnnotations(hydra.ext.tinkerpop.mappings.AnnotationSchema annotations) {
    java.util.Objects.requireNonNull((annotations));
    return new Schema(vertexIdTypes, vertexIds, edgeIdTypes, edgeIds, propertyTypes, propertyValues, annotations, defaultVertexId, defaultEdgeId);
  }
