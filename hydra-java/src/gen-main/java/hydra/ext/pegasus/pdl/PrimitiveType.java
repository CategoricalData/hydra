...
public abstract class PrimitiveType implements Serializable {
  ...
  public static final class Boolean_ extends hydra.ext.pegasus.pdl.PrimitiveType implements Serializable {
    public Boolean_ () {
  ...
  public static final class Bytes extends hydra.ext.pegasus.pdl.PrimitiveType implements Serializable {
    public Bytes () {
  ...
  public static final class Double_ extends hydra.ext.pegasus.pdl.PrimitiveType implements Serializable {
    public Double_ () {
  ...
  public static final class Float_ extends hydra.ext.pegasus.pdl.PrimitiveType implements Serializable {
    public Float_ () {
  ...
  public static final class Int extends hydra.ext.pegasus.pdl.PrimitiveType implements Serializable {
    public Int () {
  ...
  public static final class Long_ extends hydra.ext.pegasus.pdl.PrimitiveType implements Serializable {
    public Long_ () {
  ...
  public static final class String_ extends hydra.ext.pegasus.pdl.PrimitiveType implements Serializable {
    public String_ () {
