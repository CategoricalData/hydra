...
public abstract class NamedSchemaType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.pegasus.pdl.NamedSchemaType");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(NamedSchemaType instance) {
  ...
  public static final class Record extends hydra.ext.pegasus.pdl.NamedSchemaType implements Serializable {
  ...
  public static final class Enum_ extends hydra.ext.pegasus.pdl.NamedSchemaType implements Serializable {
  ...
  public static final class Typeref extends hydra.ext.pegasus.pdl.NamedSchemaType implements Serializable {
