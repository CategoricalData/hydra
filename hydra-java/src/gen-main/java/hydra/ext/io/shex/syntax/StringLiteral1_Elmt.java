...
public abstract class StringLiteral1_Elmt implements Serializable, Comparable<StringLiteral1_Elmt> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.io.shex.syntax.StringLiteral1_Elmt");
  ...
  public static final class Regex extends hydra.ext.io.shex.syntax.StringLiteral1_Elmt implements Serializable {
    ...
    public int compareTo(StringLiteral1_Elmt other) {
  ...
  public static final class Echar extends hydra.ext.io.shex.syntax.StringLiteral1_Elmt implements Serializable {
  ...
  public static final class Uchar extends hydra.ext.io.shex.syntax.StringLiteral1_Elmt implements Serializable {
