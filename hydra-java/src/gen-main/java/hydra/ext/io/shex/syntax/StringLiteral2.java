...
public class StringLiteral2 implements Serializable, Comparable<StringLiteral2> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.io.shex.syntax.StringLiteral2");
  ...
  public int compareTo(StringLiteral2 other) {
