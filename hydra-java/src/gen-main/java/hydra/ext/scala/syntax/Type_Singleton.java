...
public class Type_Singleton implements Serializable, Comparable<Type_Singleton> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Type_Singleton");

  public static final hydra.core.Name REF = new hydra.core.Name("ref");

  public final hydra.ext.scala.syntax.Data_Ref ref;

  public Type_Singleton (hydra.ext.scala.syntax.Data_Ref ref) {
    this.ref = ref;
  }
