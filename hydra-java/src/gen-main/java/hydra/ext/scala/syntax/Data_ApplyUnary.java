...
public class Data_ApplyUnary implements Serializable, Comparable<Data_ApplyUnary> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Data_ApplyUnary");
  ...
  public final hydra.ext.scala.syntax.Data arg;

  public Data_ApplyUnary (hydra.ext.scala.syntax.Data_Name op, hydra.ext.scala.syntax.Data arg) {
    this.op = op;
    this.arg = arg;
  }
  ...
  public Data_ApplyUnary withArg(hydra.ext.scala.syntax.Data arg) {
    return new Data_ApplyUnary(op, arg);
  }
}
