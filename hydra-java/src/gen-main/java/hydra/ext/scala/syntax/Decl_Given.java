...
public class Decl_Given implements Serializable, Comparable<Decl_Given> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Decl_Given");
  ...
  public Decl_Given (hydra.util.ConsList<hydra.ext.scala.syntax.Mod> mods, hydra.ext.scala.syntax.Data_Name name, hydra.util.ConsList<hydra.ext.scala.syntax.Type_Param> tparams, hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.syntax.Data_Param>> sparams, hydra.ext.scala.syntax.Type decltpe) {
    this.mods = mods;
    this.name = name;
  ...
  public Decl_Given withMods(hydra.util.ConsList<hydra.ext.scala.syntax.Mod> mods) {
    return new Decl_Given(mods, name, tparams, sparams, decltpe);
  }

  public Decl_Given withName(hydra.ext.scala.syntax.Data_Name name) {
    return new Decl_Given(mods, name, tparams, sparams, decltpe);
  }

  public Decl_Given withTparams(hydra.util.ConsList<hydra.ext.scala.syntax.Type_Param> tparams) {
    return new Decl_Given(mods, name, tparams, sparams, decltpe);
  }

  public Decl_Given withSparams(hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.syntax.Data_Param>> sparams) {
    return new Decl_Given(mods, name, tparams, sparams, decltpe);
  }

  public Decl_Given withDecltpe(hydra.ext.scala.syntax.Type decltpe) {
    return new Decl_Given(mods, name, tparams, sparams, decltpe);
  }
}
