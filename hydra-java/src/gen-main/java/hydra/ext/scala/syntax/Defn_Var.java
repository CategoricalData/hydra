...
public class Defn_Var implements Serializable, Comparable<Defn_Var> {
  ...
  public Defn_Var (java.util.List<hydra.ext.scala.syntax.Mod> mods, java.util.List<hydra.ext.scala.syntax.Pat> pats, hydra.ext.scala.syntax.Type decltpe, hydra.util.Maybe<hydra.ext.scala.syntax.Data> rhs) {
    this.mods = mods;
    this.pats = pats;
  ...
  public Defn_Var withMods(java.util.List<hydra.ext.scala.syntax.Mod> mods) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }

  public Defn_Var withPats(java.util.List<hydra.ext.scala.syntax.Pat> pats) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }
