...
public class Pat_ExtractInfix implements Serializable, Comparable<Pat_ExtractInfix> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Pat_ExtractInfix");
  ...
  public Pat_ExtractInfix withOp(hydra.ext.scala.syntax.Data_Name op) {
    return new Pat_ExtractInfix(lhs, op, rhs);
  }
