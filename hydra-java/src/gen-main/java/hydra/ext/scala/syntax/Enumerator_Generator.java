...
public class Enumerator_Generator implements Serializable, Comparable<Enumerator_Generator> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Enumerator_Generator");
  ...
  public Enumerator_Generator (hydra.ext.scala.syntax.Pat pat, hydra.ext.scala.syntax.Data rhs) {
    this.pat = pat;
    this.rhs = rhs;
  }
  ...
  public Enumerator_Generator withRhs(hydra.ext.scala.syntax.Data rhs) {
    return new Enumerator_Generator(pat, rhs);
  }
}
