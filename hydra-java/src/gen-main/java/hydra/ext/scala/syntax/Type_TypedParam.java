...
public class Type_TypedParam implements Serializable, Comparable<Type_TypedParam> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Type_TypedParam");
  ...
  public final hydra.ext.scala.syntax.Type typ;

  public Type_TypedParam (hydra.ext.scala.syntax.Name name, hydra.ext.scala.syntax.Type typ) {
    this.name = name;
    this.typ = typ;
  }
  ...
  public Type_TypedParam withTyp(hydra.ext.scala.syntax.Type typ) {
    return new Type_TypedParam(name, typ);
  }
}
