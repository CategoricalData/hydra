...
public class Defn_Enum implements Serializable, Comparable<Defn_Enum> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Defn_Enum");
  ...
  public Defn_Enum withName(hydra.ext.scala.syntax.Type_Name name) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }
  ...
  public Defn_Enum withCtor(hydra.ext.scala.syntax.Ctor_Primary ctor) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }

  public Defn_Enum withTemplate(hydra.ext.scala.syntax.Template template) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }
}
