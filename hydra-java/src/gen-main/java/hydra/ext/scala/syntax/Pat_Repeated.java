...
public class Pat_Repeated implements Serializable, Comparable<Pat_Repeated> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Pat_Repeated");

  public static final hydra.core.Name NAME = new hydra.core.Name("name");

  public final hydra.ext.scala.syntax.Data_Name name;

  public Pat_Repeated (hydra.ext.scala.syntax.Data_Name name) {
    this.name = name;
  }
