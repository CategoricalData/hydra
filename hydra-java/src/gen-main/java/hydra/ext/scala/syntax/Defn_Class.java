...
public class Defn_Class implements Serializable, Comparable<Defn_Class> {
  ...
  public Defn_Class (java.util.List<hydra.ext.scala.syntax.Mod> mods, hydra.ext.scala.syntax.Type_Name name, java.util.List<hydra.ext.scala.syntax.Type_Param> tparams, hydra.ext.scala.syntax.Ctor_Primary ctor, hydra.ext.scala.syntax.Template template) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Class withMods(java.util.List<hydra.ext.scala.syntax.Mod> mods) {
  ...
  public Defn_Class withTparams(java.util.List<hydra.ext.scala.syntax.Type_Param> tparams) {
    return new Defn_Class(mods, name, tparams, ctor, template);
  }
