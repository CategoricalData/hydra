...
public class Defn_Given implements Serializable, Comparable<Defn_Given> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Defn_Given");
  ...
  public Defn_Given withName(hydra.ext.scala.syntax.Name name) {
    return new Defn_Given(mods, name, tparams, sparams, templ);
  }
  ...
  public Defn_Given withTempl(hydra.ext.scala.syntax.Template templ) {
    return new Defn_Given(mods, name, tparams, sparams, templ);
  }
}
