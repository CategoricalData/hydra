...
public class Type_With implements Serializable, Comparable<Type_With> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Type_With");
  ...
  public Type_With (hydra.ext.scala.syntax.Type lhs, hydra.ext.scala.syntax.Type rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public Type_With withRhs(hydra.ext.scala.syntax.Type rhs) {
    return new Type_With(lhs, rhs);
  }
}
