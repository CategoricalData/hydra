...
public class Type_Function implements Serializable, Comparable<Type_Function> {
  ...
  public Type_Function (hydra.util.ConsList<hydra.ext.scala.syntax.Type> params, hydra.ext.scala.syntax.Type res) {
    this.params = params;
    this.res = res;
  }
  ...
  public Type_Function withParams(hydra.util.ConsList<hydra.ext.scala.syntax.Type> params) {
