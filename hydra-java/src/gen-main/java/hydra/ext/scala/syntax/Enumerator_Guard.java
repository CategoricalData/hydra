...
public class Enumerator_Guard implements Serializable, Comparable<Enumerator_Guard> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Enumerator_Guard");

  public static final hydra.core.Name COND = new hydra.core.Name("cond");

  public final hydra.ext.scala.syntax.Data cond;

  public Enumerator_Guard (hydra.ext.scala.syntax.Data cond) {
    this.cond = cond;
  }
