...
public class Data_Function implements Serializable, Comparable<Data_Function> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Data_Function");
  ...
  public Data_Function withBody(hydra.ext.scala.syntax.Data body) {
    return new Data_Function(params, body);
  }
}
