...
public class Data_ContextFunction implements Serializable, Comparable<Data_ContextFunction> {
  ...
  public Data_ContextFunction (java.util.List<hydra.ext.scala.syntax.Data_Param> params, hydra.ext.scala.syntax.Data body) {
    this.params = params;
    this.body = body;
  }
  ...
  public Data_ContextFunction withParams(java.util.List<hydra.ext.scala.syntax.Data_Param> params) {
