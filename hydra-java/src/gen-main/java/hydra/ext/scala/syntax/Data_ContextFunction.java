...
public class Data_ContextFunction implements Serializable, Comparable<Data_ContextFunction> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Data_ContextFunction");
  ...
  public Data_ContextFunction (hydra.util.ConsList<hydra.ext.scala.syntax.Data_Param> params, hydra.ext.scala.syntax.Data body) {
    this.params = params;
    this.body = body;
  }
  ...
  public Data_ContextFunction withParams(hydra.util.ConsList<hydra.ext.scala.syntax.Data_Param> params) {
    return new Data_ContextFunction(params, body);
  }

  public Data_ContextFunction withBody(hydra.ext.scala.syntax.Data body) {
    return new Data_ContextFunction(params, body);
  }
}
