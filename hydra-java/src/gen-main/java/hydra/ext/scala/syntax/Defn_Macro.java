...
public class Defn_Macro implements Serializable, Comparable<Defn_Macro> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Defn_Macro");
  ...
  public Defn_Macro withName(hydra.ext.scala.syntax.Data_Name name) {
    return new Defn_Macro(mods, name, tparams, paramss, decltpe, body);
  }
  ...
  public Defn_Macro withDecltpe(hydra.util.Maybe<hydra.ext.scala.syntax.Type> decltpe) {
    return new Defn_Macro(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Macro withBody(hydra.ext.scala.syntax.Data body) {
    return new Defn_Macro(mods, name, tparams, paramss, decltpe, body);
  }
}
