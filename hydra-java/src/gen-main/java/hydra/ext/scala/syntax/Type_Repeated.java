...
public class Type_Repeated implements Serializable, Comparable<Type_Repeated> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Type_Repeated");

  public static final hydra.core.Name TPE = new hydra.core.Name("tpe");

  public final hydra.ext.scala.syntax.Type tpe;

  public Type_Repeated (hydra.ext.scala.syntax.Type tpe) {
    this.tpe = tpe;
  }
