...
public class Defn_GivenAlias implements Serializable, Comparable<Defn_GivenAlias> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Defn_GivenAlias");
  ...
  public Defn_GivenAlias withName(hydra.ext.scala.syntax.Name name) {
    return new Defn_GivenAlias(mods, name, tparams, sparams, decltpe, body);
  }
  ...
  public Defn_GivenAlias withDecltpe(hydra.ext.scala.syntax.Type decltpe) {
    return new Defn_GivenAlias(mods, name, tparams, sparams, decltpe, body);
  }

  public Defn_GivenAlias withBody(hydra.ext.scala.syntax.Data body) {
    return new Defn_GivenAlias(mods, name, tparams, sparams, decltpe, body);
  }
}
