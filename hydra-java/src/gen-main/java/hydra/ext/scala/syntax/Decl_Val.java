...
public class Decl_Val implements Serializable, Comparable<Decl_Val> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.syntax.Decl_Val");
  ...
  public Decl_Val withDecltpe(hydra.ext.scala.syntax.Type decltpe) {
    return new Decl_Val(mods, pats, decltpe);
  }
}
