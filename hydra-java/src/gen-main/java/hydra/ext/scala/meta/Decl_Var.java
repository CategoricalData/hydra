...
public class Decl_Var implements Serializable, Comparable<Decl_Var> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Decl_Var");
  ...
  public Decl_Var (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.util.ConsList<hydra.ext.scala.meta.Pat> pats, hydra.ext.scala.meta.Type decltpe) {
    this.mods = mods;
    this.pats = pats;
  ...
  public Decl_Var withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
    return new Decl_Var(mods, pats, decltpe);
  }

  public Decl_Var withPats(hydra.util.ConsList<hydra.ext.scala.meta.Pat> pats) {
    return new Decl_Var(mods, pats, decltpe);
  }
