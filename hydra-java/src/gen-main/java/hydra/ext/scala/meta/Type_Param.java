...
public class Type_Param implements Serializable, Comparable<Type_Param> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Type_Param");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.TypeBounds> tbounds;

  public final hydra.util.ConsList<hydra.ext.scala.meta.Type> vbounds;

  public final hydra.util.ConsList<hydra.ext.scala.meta.Type> cbounds;

  public Type_Param (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.util.ConsList<hydra.ext.scala.meta.TypeBounds> tbounds, hydra.util.ConsList<hydra.ext.scala.meta.Type> vbounds, hydra.util.ConsList<hydra.ext.scala.meta.Type> cbounds) {
    this.mods = mods;
    this.name = name;
  ...
  public Type_Param withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Type_Param withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Type_Param(mods, name, tparams, tbounds, vbounds, cbounds);
  }

  public Type_Param withTbounds(hydra.util.ConsList<hydra.ext.scala.meta.TypeBounds> tbounds) {
    return new Type_Param(mods, name, tparams, tbounds, vbounds, cbounds);
  }

  public Type_Param withVbounds(hydra.util.ConsList<hydra.ext.scala.meta.Type> vbounds) {
    return new Type_Param(mods, name, tparams, tbounds, vbounds, cbounds);
  }

  public Type_Param withCbounds(hydra.util.ConsList<hydra.ext.scala.meta.Type> cbounds) {
    return new Type_Param(mods, name, tparams, tbounds, vbounds, cbounds);
  }
}
