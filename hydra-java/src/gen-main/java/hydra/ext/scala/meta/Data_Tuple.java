...
public class Data_Tuple implements Serializable, Comparable<Data_Tuple> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Tuple");
  ...
  public Data_Tuple (hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    this.args = args;
  }
