...
public class Pat_ExtractInfix implements Serializable, Comparable<Pat_ExtractInfix> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Pat_ExtractInfix");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.Pat> rhs;

  public Pat_ExtractInfix (hydra.ext.scala.meta.Pat lhs, hydra.ext.scala.meta.Data_Name op, hydra.util.ConsList<hydra.ext.scala.meta.Pat> rhs) {
    this.lhs = lhs;
    this.op = op;
    this.rhs = rhs;
  }
  ...
  public Pat_ExtractInfix withRhs(hydra.util.ConsList<hydra.ext.scala.meta.Pat> rhs) {
    return new Pat_ExtractInfix(lhs, op, rhs);
  }
}
