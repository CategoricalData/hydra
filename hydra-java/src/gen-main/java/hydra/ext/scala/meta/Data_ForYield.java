...
public class Data_ForYield implements Serializable, Comparable<Data_ForYield> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_ForYield");
  ...
  public Data_ForYield (hydra.util.ConsList<hydra.ext.scala.meta.Enumerator> enums) {
    this.enums = enums;
  }
