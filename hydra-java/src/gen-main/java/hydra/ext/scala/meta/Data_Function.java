...
public class Data_Function implements Serializable, Comparable<Data_Function> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Function");
  ...
  public Data_Function (hydra.util.ConsList<hydra.ext.scala.meta.Data_Param> params, hydra.ext.scala.meta.Data body) {
    this.params = params;
    this.body = body;
  }
  ...
  public Data_Function withParams(hydra.util.ConsList<hydra.ext.scala.meta.Data_Param> params) {
