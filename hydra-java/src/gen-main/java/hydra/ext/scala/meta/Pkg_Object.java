...
public class Pkg_Object implements Serializable, Comparable<Pkg_Object> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Pkg_Object");
  ...
  public Pkg_Object (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Data_Name name, hydra.ext.scala.meta.Template template) {
    this.mods = mods;
    this.name = name;
  ...
  public Pkg_Object withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
