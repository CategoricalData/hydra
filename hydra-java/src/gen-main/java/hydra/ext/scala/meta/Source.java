...
public class Source implements Serializable, Comparable<Source> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Source");
  ...
  public Source (hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats) {
    this.stats = stats;
  }
