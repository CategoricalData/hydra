...
public class Type_ContextFunction implements Serializable, Comparable<Type_ContextFunction> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Type_ContextFunction");
  ...
  public Type_ContextFunction (hydra.util.ConsList<hydra.ext.scala.meta.Type> params, hydra.ext.scala.meta.Type res) {
    this.params = params;
    this.res = res;
  }
  ...
  public Type_ContextFunction withParams(hydra.util.ConsList<hydra.ext.scala.meta.Type> params) {
