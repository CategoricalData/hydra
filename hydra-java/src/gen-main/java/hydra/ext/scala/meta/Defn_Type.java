...
public class Defn_Type implements Serializable, Comparable<Defn_Type> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_Type");
  ...
  public Defn_Type (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Type_Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.ext.scala.meta.Type body) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Type withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Defn_Type withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Defn_Type(mods, name, tparams, body);
  }
