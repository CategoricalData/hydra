...
public class Data_Try implements Serializable, Comparable<Data_Try> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Try");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.Case> catchp;

  public final hydra.util.Maybe<hydra.ext.scala.meta.Data> finallyp;

  public Data_Try (hydra.ext.scala.meta.Data expr, hydra.util.ConsList<hydra.ext.scala.meta.Case> catchp, hydra.util.Maybe<hydra.ext.scala.meta.Data> finallyp) {
    this.expr = expr;
    this.catchp = catchp;
  ...
  public Data_Try withCatchp(hydra.util.ConsList<hydra.ext.scala.meta.Case> catchp) {
    return new Data_Try(expr, catchp, finallyp);
  }

  public Data_Try withFinallyp(hydra.util.Maybe<hydra.ext.scala.meta.Data> finallyp) {
    return new Data_Try(expr, catchp, finallyp);
  }
}
