...
public class Data_Xml implements Serializable, Comparable<Data_Xml> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Xml");
  ...
  public Data_Xml (hydra.util.ConsList<hydra.ext.scala.meta.Lit> parts, hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    this.parts = parts;
    this.args = args;
  }
  ...
  public Data_Xml withParts(hydra.util.ConsList<hydra.ext.scala.meta.Lit> parts) {
    return new Data_Xml(parts, args);
  }

  public Data_Xml withArgs(hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    return new Data_Xml(parts, args);
  }
}
