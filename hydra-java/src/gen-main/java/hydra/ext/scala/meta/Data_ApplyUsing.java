...
public class Data_ApplyUsing implements Serializable, Comparable<Data_ApplyUsing> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_ApplyUsing");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.Data> targs;

  public Data_ApplyUsing (hydra.ext.scala.meta.Data fun, hydra.util.ConsList<hydra.ext.scala.meta.Data> targs) {
    this.fun = fun;
    this.targs = targs;
  }
  ...
  public Data_ApplyUsing withTargs(hydra.util.ConsList<hydra.ext.scala.meta.Data> targs) {
    return new Data_ApplyUsing(fun, targs);
  }
}
