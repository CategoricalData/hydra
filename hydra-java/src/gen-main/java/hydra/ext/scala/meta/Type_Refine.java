...
public class Type_Refine implements Serializable, Comparable<Type_Refine> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Type_Refine");
  ...
  public final hydra.util.Maybe<hydra.ext.scala.meta.Type> tpe;

  public final hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats;

  public Type_Refine (hydra.util.Maybe<hydra.ext.scala.meta.Type> tpe, hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats) {
    this.tpe = tpe;
    this.stats = stats;
  }
  ...
  public Type_Refine withTpe(hydra.util.Maybe<hydra.ext.scala.meta.Type> tpe) {
    return new Type_Refine(tpe, stats);
  }

  public Type_Refine withStats(hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats) {
    return new Type_Refine(tpe, stats);
  }
}
