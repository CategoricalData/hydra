...
public class Ctor_Secondary implements Serializable, Comparable<Ctor_Secondary> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Ctor_Secondary");
  ...
  public Ctor_Secondary (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Name name, hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.meta.Data_Param>> paramss, hydra.ext.scala.meta.Init init, hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats) {
    this.mods = mods;
    this.name = name;
  ...
  public Ctor_Secondary withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Ctor_Secondary withParamss(hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.meta.Data_Param>> paramss) {
    return new Ctor_Secondary(mods, name, paramss, init, stats);
  }
  ...
  public Ctor_Secondary withStats(hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats) {
    return new Ctor_Secondary(mods, name, paramss, init, stats);
  }
}
