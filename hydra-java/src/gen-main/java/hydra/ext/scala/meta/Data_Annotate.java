...
public class Data_Annotate implements Serializable, Comparable<Data_Annotate> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Annotate");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.Mod_Annot> annots;

  public Data_Annotate (hydra.ext.scala.meta.Data expr, hydra.util.ConsList<hydra.ext.scala.meta.Mod_Annot> annots) {
    this.expr = expr;
    this.annots = annots;
  }
  ...
  public Data_Annotate withAnnots(hydra.util.ConsList<hydra.ext.scala.meta.Mod_Annot> annots) {
    return new Data_Annotate(expr, annots);
  }
}
