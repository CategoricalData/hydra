...
public class Data_ApplyInfix implements Serializable, Comparable<Data_ApplyInfix> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_ApplyInfix");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.Type> targs;

  public final hydra.util.ConsList<hydra.ext.scala.meta.Data> args;

  public Data_ApplyInfix (hydra.ext.scala.meta.Data lhs, hydra.ext.scala.meta.Data_Name op, hydra.util.ConsList<hydra.ext.scala.meta.Type> targs, hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    this.lhs = lhs;
    this.op = op;
    this.targs = targs;
    this.args = args;
  ...
  public Data_ApplyInfix withTargs(hydra.util.ConsList<hydra.ext.scala.meta.Type> targs) {
    return new Data_ApplyInfix(lhs, op, targs, args);
  }

  public Data_ApplyInfix withArgs(hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    return new Data_ApplyInfix(lhs, op, targs, args);
  }
}
