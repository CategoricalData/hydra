...
public class Pkg implements Serializable, Comparable<Pkg> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Pkg");
  ...
  public Pkg (hydra.ext.scala.meta.Data_Name name, hydra.ext.scala.meta.Data_Ref ref, hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats) {
    this.name = name;
    this.ref = ref;
    this.stats = stats;
  }
  ...
  public Pkg withStats(hydra.util.ConsList<hydra.ext.scala.meta.Stat> stats) {
    return new Pkg(name, ref, stats);
  }
}
