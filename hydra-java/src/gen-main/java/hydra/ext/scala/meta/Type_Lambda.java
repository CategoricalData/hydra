...
public class Type_Lambda implements Serializable, Comparable<Type_Lambda> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Type_Lambda");
  ...
  public Type_Lambda (hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.ext.scala.meta.Type tpe) {
  ...
  public Type_Lambda withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
