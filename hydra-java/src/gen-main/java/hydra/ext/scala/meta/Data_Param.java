...
public class Data_Param implements Serializable, Comparable<Data_Param> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Param");
  ...
  public final hydra.util.Maybe<hydra.ext.scala.meta.Data> default_;

  public Data_Param (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Name name, hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe, hydra.util.Maybe<hydra.ext.scala.meta.Data> default_) {
    this.mods = mods;
    this.name = name;
  ...
  public Data_Param withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Data_Param withDecltpe(hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe) {
    return new Data_Param(mods, name, decltpe, default_);
  }

  public Data_Param withDefault(hydra.util.Maybe<hydra.ext.scala.meta.Data> default_) {
    return new Data_Param(mods, name, decltpe, default_);
  }
}
