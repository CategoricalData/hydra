...
public class Type_ImplicitFunction implements Serializable, Comparable<Type_ImplicitFunction> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Type_ImplicitFunction");
  ...
  public Type_ImplicitFunction (hydra.util.ConsList<hydra.ext.scala.meta.Type> params, hydra.ext.scala.meta.Type res) {
    this.params = params;
    this.res = res;
  }
  ...
  public Type_ImplicitFunction withParams(hydra.util.ConsList<hydra.ext.scala.meta.Type> params) {
