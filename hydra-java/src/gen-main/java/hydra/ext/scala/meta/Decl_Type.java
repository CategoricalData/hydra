...
public class Decl_Type implements Serializable, Comparable<Decl_Type> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Decl_Type");
  ...
  public Decl_Type (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Type_Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.ext.scala.meta.TypeBounds bounds) {
    this.mods = mods;
    this.name = name;
  ...
  public Decl_Type withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Decl_Type withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Decl_Type(mods, name, tparams, bounds);
  }
