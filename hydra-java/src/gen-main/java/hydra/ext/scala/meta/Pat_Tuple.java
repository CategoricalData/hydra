...
public class Pat_Tuple implements Serializable, Comparable<Pat_Tuple> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Pat_Tuple");
  ...
  public Pat_Tuple (hydra.util.ConsList<hydra.ext.scala.meta.Pat> args) {
    this.args = args;
  }
