...
public class Defn_Var implements Serializable, Comparable<Defn_Var> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_Var");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.Pat> pats;

  public final hydra.ext.scala.meta.Type decltpe;

  public final hydra.util.Maybe<hydra.ext.scala.meta.Data> rhs;

  public Defn_Var (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.util.ConsList<hydra.ext.scala.meta.Pat> pats, hydra.ext.scala.meta.Type decltpe, hydra.util.Maybe<hydra.ext.scala.meta.Data> rhs) {
    this.mods = mods;
    this.pats = pats;
  ...
  public Defn_Var withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }

  public Defn_Var withPats(hydra.util.ConsList<hydra.ext.scala.meta.Pat> pats) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }
  ...
  public Defn_Var withRhs(hydra.util.Maybe<hydra.ext.scala.meta.Data> rhs) {
    return new Defn_Var(mods, pats, decltpe, rhs);
  }
}
