...
public class Decl_Def implements Serializable, Comparable<Decl_Def> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Decl_Def");
  ...
  public Decl_Def (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Data_Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.meta.Data_Param>> paramss, hydra.ext.scala.meta.Type decltpe) {
    this.mods = mods;
    this.name = name;
  ...
  public Decl_Def withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Decl_Def withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Decl_Def(mods, name, tparams, paramss, decltpe);
  }

  public Decl_Def withParamss(hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.meta.Data_Param>> paramss) {
    return new Decl_Def(mods, name, tparams, paramss, decltpe);
  }
