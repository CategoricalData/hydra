...
public class Defn_Class implements Serializable, Comparable<Defn_Class> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_Class");
  ...
  public Defn_Class (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Type_Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.ext.scala.meta.Ctor_Primary ctor, hydra.ext.scala.meta.Template template) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Class withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Defn_Class withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Defn_Class(mods, name, tparams, ctor, template);
  }
