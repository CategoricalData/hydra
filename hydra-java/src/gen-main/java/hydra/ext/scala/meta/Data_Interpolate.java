...
public class Data_Interpolate implements Serializable, Comparable<Data_Interpolate> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Interpolate");
  ...
  public final hydra.util.ConsList<hydra.ext.scala.meta.Data> args;

  public Data_Interpolate (hydra.ext.scala.meta.Data_Name prefix, hydra.util.ConsList<hydra.ext.scala.meta.Lit> parts, hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    this.prefix = prefix;
    this.parts = parts;
    this.args = args;
  }
  ...
  public Data_Interpolate withParts(hydra.util.ConsList<hydra.ext.scala.meta.Lit> parts) {
    return new Data_Interpolate(prefix, parts, args);
  }

  public Data_Interpolate withArgs(hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    return new Data_Interpolate(prefix, parts, args);
  }
}
