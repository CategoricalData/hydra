...
public class Data_ApplyType implements Serializable, Comparable<Data_ApplyType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_ApplyType");
  ...
  public Data_ApplyType (hydra.ext.scala.meta.Data lhs, hydra.ext.scala.meta.Data_Name op, hydra.util.ConsList<hydra.ext.scala.meta.Type> targs, hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    this.lhs = lhs;
    this.op = op;
    this.targs = targs;
    this.args = args;
  ...
  public Data_ApplyType withTargs(hydra.util.ConsList<hydra.ext.scala.meta.Type> targs) {
    return new Data_ApplyType(lhs, op, targs, args);
  }

  public Data_ApplyType withArgs(hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    return new Data_ApplyType(lhs, op, targs, args);
  }
}
