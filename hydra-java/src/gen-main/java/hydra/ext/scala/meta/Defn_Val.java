...
public class Defn_Val implements Serializable, Comparable<Defn_Val> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_Val");
  ...
  public Defn_Val (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.util.ConsList<hydra.ext.scala.meta.Pat> pats, hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe, hydra.ext.scala.meta.Data rhs) {
    this.mods = mods;
    this.pats = pats;
  ...
  public Defn_Val withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
    return new Defn_Val(mods, pats, decltpe, rhs);
  }

  public Defn_Val withPats(hydra.util.ConsList<hydra.ext.scala.meta.Pat> pats) {
    return new Defn_Val(mods, pats, decltpe, rhs);
  }

  public Defn_Val withDecltpe(hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe) {
    return new Defn_Val(mods, pats, decltpe, rhs);
  }
