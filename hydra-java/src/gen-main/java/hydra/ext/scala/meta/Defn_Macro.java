...
public class Defn_Macro implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/scala/meta.Defn.Macro");
  ...
  public Defn_Macro (java.util.List<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Data_Name name, java.util.List<hydra.ext.scala.meta.Type_Param> tparams, java.util.List<java.util.List<hydra.ext.scala.meta.Data_Param>> paramss, hydra.util.Opt<hydra.ext.scala.meta.Type> decltpe, hydra.ext.scala.meta.Data body) {
  ...
  public Defn_Macro withDecltpe(hydra.util.Opt<hydra.ext.scala.meta.Type> decltpe) {
    java.util.Objects.requireNonNull((decltpe));
    return new Defn_Macro(mods, name, tparams, paramss, decltpe, body);
  }
