...
public class Defn_Macro implements Serializable, Comparable<Defn_Macro> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_Macro");
  ...
  public final hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe;

  public final hydra.ext.scala.meta.Data body;

  public Defn_Macro (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Data_Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.meta.Data_Param>> paramss, hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe, hydra.ext.scala.meta.Data body) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Macro withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Defn_Macro withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Defn_Macro(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Macro withParamss(hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.meta.Data_Param>> paramss) {
    return new Defn_Macro(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Macro withDecltpe(hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe) {
    return new Defn_Macro(mods, name, tparams, paramss, decltpe, body);
  }
