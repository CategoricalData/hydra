...
public class Defn_Enum implements Serializable, Comparable<Defn_Enum> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_Enum");
  ...
  public Defn_Enum (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Type_Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.ext.scala.meta.Ctor_Primary ctor, hydra.ext.scala.meta.Template template) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_Enum withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Defn_Enum withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Defn_Enum(mods, name, tparams, ctor, template);
  }
