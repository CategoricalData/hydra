...
public class Type_Tuple implements Serializable, Comparable<Type_Tuple> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Type_Tuple");
  ...
  public Type_Tuple (hydra.util.ConsList<hydra.ext.scala.meta.Type> args) {
    this.args = args;
  }
