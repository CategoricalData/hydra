...
public class Defn_Def implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/scala/meta.Defn.Def");
  ...
  public Defn_Def withDecltpe(hydra.util.Opt<hydra.ext.scala.meta.Type> decltpe) {
    java.util.Objects.requireNonNull((decltpe));
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }
