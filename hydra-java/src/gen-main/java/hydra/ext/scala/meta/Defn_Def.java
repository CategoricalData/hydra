...
public class Defn_Def implements Serializable, Comparable<Defn_Def> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_Def");
  ...
  public Defn_Def withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Defn_Def withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withParamss(hydra.util.ConsList<hydra.util.ConsList<hydra.ext.scala.meta.Data_Param>> paramss) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }

  public Defn_Def withDecltpe(hydra.util.Maybe<hydra.ext.scala.meta.Type> decltpe) {
    return new Defn_Def(mods, name, tparams, paramss, decltpe, body);
  }
