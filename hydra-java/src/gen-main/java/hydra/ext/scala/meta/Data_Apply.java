...
public class Data_Apply implements Serializable, Comparable<Data_Apply> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Data_Apply");
  ...
  public Data_Apply (hydra.ext.scala.meta.Data fun, hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    this.fun = fun;
    this.args = args;
  }
  ...
  public Data_Apply withArgs(hydra.util.ConsList<hydra.ext.scala.meta.Data> args) {
    return new Data_Apply(fun, args);
  }
}
