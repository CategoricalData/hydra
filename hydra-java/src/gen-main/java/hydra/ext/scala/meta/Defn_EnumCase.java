...
public class Defn_EnumCase implements Serializable, Comparable<Defn_EnumCase> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.scala.meta.Defn_EnumCase");
  ...
  public Defn_EnumCase (hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods, hydra.ext.scala.meta.Data_Name name, hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams, hydra.ext.scala.meta.Ctor_Primary ctor, hydra.util.ConsList<hydra.ext.scala.meta.Init> inits) {
    this.mods = mods;
    this.name = name;
  ...
  public Defn_EnumCase withMods(hydra.util.ConsList<hydra.ext.scala.meta.Mod> mods) {
  ...
  public Defn_EnumCase withTparams(hydra.util.ConsList<hydra.ext.scala.meta.Type_Param> tparams) {
    return new Defn_EnumCase(mods, name, tparams, ctor, inits);
  }
  ...
  public Defn_EnumCase withInits(hydra.util.ConsList<hydra.ext.scala.meta.Init> inits) {
    return new Defn_EnumCase(mods, name, tparams, ctor, inits);
  }
}
