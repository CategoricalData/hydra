...
public interface Coder {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.scala.syntax.Pkg> constructModule(hydra.context.Context cx, hydra.graph.Graph g, hydra.module.Module mod, java.util.List<hydra.module.Definition> defs) {
    String nsName = (mod).namespace.value;
    hydra.util.Pair<java.util.List<hydra.module.TypeDefinition>, java.util.List<hydra.module.TermDefinition>> partitioned = hydra.Environment.partitionDefinitions(defs);
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.util.List<hydra.ext.scala.syntax.Stat>> findImports(hydra.context.Context cx, hydra.graph.Graph g, hydra.module.Module mod) {
    return hydra.lib.eithers.Bind.apply(
      hydra.Analysis.moduleDependencyNamespaces(
        ...
        false,
        mod),
      (java.util.function.Function<java.util.Set<hydra.module.Namespace>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.util.List<hydra.ext.scala.syntax.Stat>>>) (elImps -> hydra.lib.eithers.Bind.apply(
        hydra.Analysis.moduleDependencyNamespaces(
          cx,
          g,
          false,
          ...
          false,
          mod),
        (java.util.function.Function<java.util.Set<hydra.module.Namespace>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.util.List<hydra.ext.scala.syntax.Stat>>>) (primImps -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, java.util.List<hydra.ext.scala.syntax.Stat>>right(hydra.lib.lists.Concat.apply(java.util.Arrays.asList(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.util.Map<String, String>> moduleToScala(hydra.module.Module mod, java.util.List<hydra.module.Definition> defs, hydra.context.Context cx, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bind.apply(
