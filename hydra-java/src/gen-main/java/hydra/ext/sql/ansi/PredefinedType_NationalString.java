...
public class PredefinedType_NationalString implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.PredefinedType.NationalString");
  ...
  public PredefinedType_NationalString (hydra.ext.sql.ansi.NationalCharacterStringType type, hydra.util.Opt<hydra.ext.sql.ansi.CollateClause> collate) {
  ...
  public PredefinedType_NationalString withCollate(hydra.util.Opt<hydra.ext.sql.ansi.CollateClause> collate) {
    java.util.Objects.requireNonNull((collate));
    return new PredefinedType_NationalString(type, collate);
  }
}
