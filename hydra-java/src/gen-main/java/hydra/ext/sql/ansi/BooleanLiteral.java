...
public abstract class BooleanLiteral {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/sql/ansi.BooleanLiteral");
  ...
  public static final class TRUE extends hydra.ext.sql.ansi.BooleanLiteral {
    public TRUE () {
  ...
  public static final class FALSE extends hydra.ext.sql.ansi.BooleanLiteral {
    public FALSE () {
  ...
  public static final class UNKNOWN extends hydra.ext.sql.ansi.BooleanLiteral {
    public UNKNOWN () {
