...
public abstract class TableCommitAction {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/sql/ansi.TableCommitAction");
  ...
  public static final class Preserve extends hydra.ext.sql.ansi.TableCommitAction {
    public Preserve () {
  ...
  public static final class Delete extends hydra.ext.sql.ansi.TableCommitAction {
    public Delete () {
