...
public abstract class TableCommitAction implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.TableCommitAction");
  ...
  public static final class Preserve extends hydra.ext.sql.ansi.TableCommitAction implements Serializable {
    public Preserve () {
  ...
  public static final class Delete extends hydra.ext.sql.ansi.TableCommitAction implements Serializable {
    public Delete () {
