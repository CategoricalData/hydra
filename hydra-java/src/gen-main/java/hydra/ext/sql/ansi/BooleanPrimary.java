...
public abstract class BooleanPrimary implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.BooleanPrimary");
  ...
  public static final class Predicate extends hydra.ext.sql.ansi.BooleanPrimary implements Serializable {
  ...
  public static final class Predicand extends hydra.ext.sql.ansi.BooleanPrimary implements Serializable {
