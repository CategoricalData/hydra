...
public abstract class GlobalOrLocal {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/sql/ansi.GlobalOrLocal");
  ...
  public static final class Global extends hydra.ext.sql.ansi.GlobalOrLocal {
    public Global () {
  ...
  public static final class Local extends hydra.ext.sql.ansi.GlobalOrLocal {
    public Local () {
