...
public class BooleanTest_Sequence_Option {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/sql/ansi.BooleanTest.Sequence.Option");
  
  public final java.util.Optional<java.lang.Void> nOT;
  
  public final hydra.ext.sql.ansi.TruthValue truthValue;
  
  public BooleanTest_Sequence_Option (java.util.Optional<java.lang.Void> nOT, hydra.ext.sql.ansi.TruthValue truthValue) {
    this.nOT = nOT;
  ...
  public BooleanTest_Sequence_Option withTruthValue(hydra.ext.sql.ansi.TruthValue truthValue) {
    return new BooleanTest_Sequence_Option(nOT, truthValue);
  }
}