...
public abstract class Cardinality {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/protobuf/type.Cardinality");
   ...
   */
  public static final class Unknown extends hydra.ext.protobuf.type.Cardinality {
    public Unknown () {
   ...
   * For optional fields.
   */
  public static final class Optional extends hydra.ext.protobuf.type.Cardinality {
    public Optional () {
   ...
   */
  public static final class Required extends hydra.ext.protobuf.type.Cardinality {
    public Required () {
   ...
   * For repeated fields.
   */
  public static final class Repeated extends hydra.ext.protobuf.type.Cardinality {
    public Repeated () {
