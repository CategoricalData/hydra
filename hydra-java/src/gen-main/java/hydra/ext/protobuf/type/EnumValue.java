...
public class EnumValue {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/protobuf/type.EnumValue");
  ...
  public EnumValue (String name, Integer number, java.util.List<hydra.ext.protobuf.type.Option> options) {
    this.name = name;
    this.number = number;
  ...
  public EnumValue withOptions(java.util.List<hydra.ext.protobuf.type.Option> options) {
    return new EnumValue(name, number, options);
  }
}