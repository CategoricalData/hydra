...
public interface Serde {
  ...
  static hydra.ast.Expr trueExpr(hydra.ext.lisp.syntax.Dialect d) {
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.serialization.Serialization.cst("t");
      }

      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.CommonLisp ignored) {
        return hydra.serialization.Serialization.cst("cl:t");
      }
  ...
  static hydra.ast.Expr falseExpr(hydra.ext.lisp.syntax.Dialect d) {
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.serialization.Serialization.cst("nil");
      }

      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.CommonLisp ignored) {
        return hydra.serialization.Serialization.cst("cl:nil");
      }

      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        return hydra.serialization.Serialization.cst("#f");
      }
    });
  }
  ...
  static hydra.ast.Expr programToExpr(hydra.ext.lisp.syntax.Program prog) {
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> exportSyms = new hydra.util.Lazy<>(() -> hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.ExportDeclaration, hydra.util.ConsList<hydra.ast.Expr>>) (edecl -> hydra.lib.lists.Map.apply(
        hydra.ext.lisp.serde.Serde::symbolToExpr,
        (edecl).symbols)),
      exports)));
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> formPart = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.TopLevelFormWithComments, hydra.ast.Expr>) (v1 -> hydra.ext.lisp.serde.Serde.topLevelFormWithCommentsToExpr(
        d,
        v1)),
      forms));
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return hydra.lib.maybes.Maybe.applyLazy(
          () -> hydra.serialization.Serialization.doubleNewlineSep(formPart.get()),
          (java.util.function.Function<hydra.ext.lisp.syntax.ModuleDeclaration, hydra.ast.Expr>) (m -> {
              ...
              (java.util.function.Function<hydra.ext.lisp.syntax.TopLevelFormWithComments, hydra.util.ConsList<hydra.ast.Expr>>) (fwc -> {
                ...
                return (form).accept(new hydra.ext.lisp.syntax.TopLevelForm.PartialVisitor<>() {
                  ...
                  public hydra.util.ConsList<hydra.ast.Expr> visit(hydra.ext.lisp.syntax.TopLevelForm.Variable vd) {
                    return hydra.util.ConsList.of(hydra.ext.lisp.serde.Serde.symbolToExpr((vd).value.name));
                  }

                  @Override
                  public hydra.util.ConsList<hydra.ast.Expr> visit(hydra.ext.lisp.syntax.TopLevelForm.Function fd) {
                    return hydra.util.ConsList.of(hydra.ext.lisp.serde.Serde.symbolToExpr((fd).value.name));
                  }
                });
              }),
              forms)));
            hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> declareForm = new hydra.util.Lazy<>(() -> hydra.lib.logic.IfElse.lazy(
              ...
              () -> hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
                hydra.util.ConsList.of(hydra.serialization.Serialization.cst("declare")),
                varNames.get()))))));
            ...
            hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> requireClauses = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
              (java.util.function.Function<String, hydra.ast.Expr>) (imp -> hydra.serialization.Serialization.brackets(
                ...
                hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
                  hydra.serialization.Serialization.cst(imp),
                  hydra.serialization.Serialization.cst(":refer"),
                  hydra.serialization.Serialization.cst(":all"))))),
              importNames.get()));
            hydra.util.Lazy<hydra.ast.Expr> nsForm = new hydra.util.Lazy<>(() -> hydra.lib.logic.IfElse.lazy(
              ...
              () -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
                hydra.serialization.Serialization.cst("ns"),
                hydra.serialization.Serialization.cst(nameStr)))),
              () -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.newlineSep(hydra.util.ConsList.of(
                hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
                  hydra.serialization.Serialization.cst("ns"),
                  hydra.serialization.Serialization.cst(nameStr))),
                hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
                  hydra.util.ConsList.of(hydra.serialization.Serialization.cst("  (:require")),
                  requireClauses.get())),
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.lib.maybes.Maybe.applyLazy(
          ...
          (java.util.function.Function<hydra.ext.lisp.syntax.ModuleDeclaration, hydra.ast.Expr>) (m -> {
            String nameStr = (m).name.value;
            hydra.ast.Expr provideForm = hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
              hydra.serialization.Serialization.cst("provide"),
              hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
                hydra.serialization.Serialization.cst("'"),
                hydra.serialization.Serialization.cst(nameStr))))));
            hydra.ast.Expr requireClLib = hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
              hydra.serialization.Serialization.cst("require"),
              hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
                hydra.serialization.Serialization.cst("'"),
                hydra.serialization.Serialization.cst("cl-lib"))))));
            hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> requireImports = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
              (java.util.function.Function<String, hydra.ast.Expr>) (imp -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
                hydra.serialization.Serialization.cst("require"),
                hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
                  hydra.serialization.Serialization.cst("'"),
                  hydra.serialization.Serialization.cst(imp))))))),
        ...
        return hydra.lib.maybes.Maybe.applyLazy(
          ...
          (java.util.function.Function<hydra.ext.lisp.syntax.ModuleDeclaration, hydra.ast.Expr>) (m -> {
            ...
            hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> exportClause = new hydra.util.Lazy<>(() -> hydra.lib.logic.IfElse.lazy(
              ...
              () -> (hydra.util.ConsList<hydra.ast.Expr>) (hydra.util.ConsList.<hydra.ast.Expr>empty()),
              () -> hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
                hydra.util.ConsList.of(hydra.serialization.Serialization.cst(":export")),
                hydra.lib.lists.Map.apply(
                  (java.util.function.Function<hydra.ast.Expr, hydra.ast.Expr>) (s -> hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
                    hydra.serialization.Serialization.cst(":"),
                    s))),
                  exportSyms.get())))))));
            hydra.util.Lazy<hydra.ast.Expr> useClause = new hydra.util.Lazy<>(() -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
              hydra.util.ConsList.of(
                hydra.serialization.Serialization.cst(":use"),
                hydra.serialization.Serialization.cst(":cl")),
              hydra.lib.lists.Map.apply(
                (java.util.function.Function<String, hydra.ast.Expr>) (imp -> hydra.serialization.Serialization.cst(hydra.lib.strings.Cat2.apply(
                  ":",
                  imp))),
                importNames.get())))));
            hydra.util.Lazy<hydra.ast.Expr> defpkgForm = new hydra.util.Lazy<>(() -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.newlineSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
              hydra.util.ConsList.of(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
                hydra.serialization.Serialization.cst("defpackage"),
                hydra.serialization.Serialization.cst(colonName)))),
              hydra.util.ConsList.of(useClause.get()),
              exportClause.get())))));
            hydra.ast.Expr inpkgForm = hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
              hydra.serialization.Serialization.cst("in-package"),
              hydra.serialization.Serialization.cst(colonName))));
            return hydra.serialization.Serialization.doubleNewlineSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
              hydra.util.ConsList.of(
                defpkgForm.get(),
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        return hydra.lib.maybes.Maybe.applyLazy(
          ...
          (java.util.function.Function<hydra.ext.lisp.syntax.ModuleDeclaration, hydra.ast.Expr>) (m -> {
              ...
              (java.util.function.Function<hydra.ext.lisp.syntax.ImportDeclaration, hydra.ast.Expr>) (idecl -> {
                ...
                hydra.util.Lazy<hydra.util.ConsList<String>> nsParts = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
                  ...
                  hydra.lib.strings.SplitOn.apply(
                    ".",
                    nsName)));
                return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Map.apply(
                  (java.util.function.Function<String, hydra.ast.Expr>) (p -> hydra.serialization.Serialization.cst(p)),
                  nsParts.get())));
              }),
              imports));
            hydra.ast.Expr schemeBaseExpr = hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
              hydra.serialization.Serialization.cst("scheme"),
              hydra.serialization.Serialization.cst("base"))));
            ...
            hydra.util.Lazy<hydra.ast.Expr> beginClause = new hydra.util.Lazy<>(() -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.newlineSep(hydra.lib.lists.Concat2.apply(
              hydra.util.ConsList.of(hydra.serialization.Serialization.cst("begin")),
              formPart.get()))));
            hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> exportClauses = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
              (java.util.function.Function<hydra.ext.lisp.syntax.ExportDeclaration, hydra.ast.Expr>) (edecl -> hydra.ext.lisp.serde.Serde.exportDeclarationToExpr(
                d,
                edecl)),
              exports));
            hydra.util.Lazy<hydra.ast.Expr> importClause = new hydra.util.Lazy<>(() -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
              hydra.util.ConsList.of(hydra.serialization.Serialization.cst("import")),
              allImportExprs.get()))));
            String nameStr = (m).name.value;
            hydra.util.Lazy<hydra.util.ConsList<String>> nameParts = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
              ...
              hydra.lib.strings.SplitOn.apply(
                ".",
                nameStr)));
            hydra.util.Lazy<hydra.ast.Expr> nameExpr = new hydra.util.Lazy<>(() -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Map.apply(
              (java.util.function.Function<String, hydra.ast.Expr>) (p -> hydra.serialization.Serialization.cst(p)),
              nameParts.get()))));
            return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.newlineSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
              hydra.util.ConsList.of(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
                hydra.serialization.Serialization.cst("define-library"),
                nameExpr.get()))),
              exportClauses.get(),
  ...
  static hydra.ast.Expr topLevelFormWithCommentsToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.TopLevelFormWithComments fwc) {
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> commentPart = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
      () -> (hydra.util.ConsList<hydra.ast.Expr>) (hydra.util.ConsList.<hydra.ast.Expr>empty()),
      (java.util.function.Function<hydra.ext.lisp.syntax.Comment, hydra.util.ConsList<hydra.ast.Expr>>) (c -> hydra.util.ConsList.of(hydra.ext.lisp.serde.Serde.commentToExpr(c))),
      mcomment));
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> docPart = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
      () -> (hydra.util.ConsList<hydra.ast.Expr>) (hydra.util.ConsList.<hydra.ast.Expr>empty()),
      (java.util.function.Function<hydra.ext.lisp.syntax.Docstring, hydra.util.ConsList<hydra.ast.Expr>>) (ds -> hydra.util.ConsList.of(hydra.ext.lisp.serde.Serde.docstringToExpr(ds))),
      mdoc));
    hydra.ext.lisp.syntax.TopLevelForm form = (fwc).form;
    hydra.ast.Expr formExpr = hydra.ext.lisp.serde.Serde.topLevelFormToExpr(
      d,
      form);
    return hydra.serialization.Serialization.newlineSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
      commentPart.get(),
      docPart.get(),
  ...
  static hydra.ast.Expr topLevelFormToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.TopLevelForm form) {
    return (form).accept(new hydra.ext.lisp.syntax.TopLevelForm.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.TopLevelForm.Function f) {
        return hydra.ext.lisp.serde.Serde.functionDefinitionToExpr(
          d,
          (f).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.TopLevelForm.Variable v) {
        return hydra.ext.lisp.serde.Serde.variableDefinitionToExpr(
          d,
          (v).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.TopLevelForm.Constant c) {
        return hydra.ext.lisp.serde.Serde.constantDefinitionToExpr(
          d,
          (c).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.TopLevelForm.RecordType r) {
        return hydra.ext.lisp.serde.Serde.recordTypeDefinitionToExpr(
          d,
          (r).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.TopLevelForm.Macro m) {
        return hydra.ext.lisp.serde.Serde.macroDefinitionToExpr(
          d,
          (m).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.TopLevelForm.Expression e) {
        return hydra.ext.lisp.serde.Serde.expressionToExpr(
          d,
          (e).value);
      }
    });
  ...
  static hydra.ast.Expr functionDefinitionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.FunctionDefinition fdef) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> body = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.ast.Expr>) (v1 -> hydra.ext.lisp.serde.Serde.expressionToExpr(
        d,
        v1)),
      (fdef).body));
    hydra.ast.Expr name = hydra.ext.lisp.serde.Serde.symbolToExpr((fdef).name);
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("defn"),
            name),
          hydra.util.ConsList.of(hydra.serialization.Serialization.brackets(
            hydra.serialization.Serialization.squareBrackets(),
            hydra.serialization.Serialization.inlineStyle(),
            hydra.serialization.Serialization.spaceSep(params.get()))),
          body.get()))));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("defun"),
            name),
          hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(params.get()))),
          body.get()))));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(hydra.serialization.Serialization.cst("define")),
          hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
  ...
  static hydra.ast.Expr variableDefinitionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.VariableDefinition vdef) {
    hydra.ast.Expr name = hydra.ext.lisp.serde.Serde.symbolToExpr((vdef).name);
    hydra.ast.Expr value = hydra.ext.lisp.serde.Serde.expressionToExpr(
      d,
      (vdef).value);
    return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
      hydra.serialization.Serialization.cst(hydra.ext.lisp.serde.Serde.defKeyword(d)),
      name,
      value)));
  }
  ...
  static hydra.ast.Expr constantDefinitionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.ConstantDefinition cdef) {
    hydra.ast.Expr name = hydra.ext.lisp.serde.Serde.symbolToExpr((cdef).name);
    hydra.ast.Expr value = hydra.ext.lisp.serde.Serde.expressionToExpr(
      d,
      (cdef).value);
    return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
      hydra.serialization.Serialization.cst(hydra.ext.lisp.serde.Serde.defconstKeyword(d)),
      name,
      value)));
  }
  ...
  static hydra.ast.Expr recordTypeDefinitionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.RecordTypeDefinition rdef) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> fields = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.FieldDefinition, hydra.ast.Expr>) (f -> hydra.ext.lisp.serde.Serde.symbolToExpr((f).name)),
      (rdef).fields));
    hydra.ast.Expr name = hydra.ext.lisp.serde.Serde.symbolToExpr((rdef).name);
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        hydra.ast.Expr defrecordForm = hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
          hydra.serialization.Serialization.cst("defrecord"),
          name,
          hydra.serialization.Serialization.brackets(
            hydra.serialization.Serialization.squareBrackets(),
            hydra.serialization.Serialization.inlineStyle(),
            hydra.serialization.Serialization.spaceSep(fields.get())))));
        ...
        hydra.util.Lazy<hydra.ast.Expr> makeAlias = new hydra.util.Lazy<>(() -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("defn"),
          ...
          hydra.util.ConsList.of(hydra.serialization.Serialization.brackets(
            ...
            hydra.serialization.Serialization.spaceSep(fields.get()))),
          hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
            hydra.util.ConsList.of(hydra.serialization.Serialization.cst(hydra.lib.strings.Cat2.apply(
              "->",
              nameStr))),
            hydra.lib.lists.Map.apply(
              (java.util.function.Function<String, hydra.ast.Expr>) (fn -> hydra.serialization.Serialization.cst(fn)),
              fieldNames.get()))))))))));
        return hydra.serialization.Serialization.newlineSep(hydra.util.ConsList.of(
          defrecordForm,
          makeAlias.get()));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("cl-defstruct"),
            name),
          fields.get()))));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        ...
        hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> accessors = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
          (java.util.function.Function<String, hydra.ast.Expr>) (fn -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst(fn),
            hydra.serialization.Serialization.cst(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              nameStr,
              "-",
              fn))))))),
          fieldNames.get()));
        hydra.util.Lazy<hydra.ast.Expr> constructor = new hydra.util.Lazy<>(() -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
          hydra.util.ConsList.of(hydra.serialization.Serialization.cst(hydra.lib.strings.Cat2.apply(
            "make-",
            nameStr))),
          hydra.lib.lists.Map.apply(
            (java.util.function.Function<String, hydra.ast.Expr>) (fn -> hydra.serialization.Serialization.cst(fn)),
            fieldNames.get())))));
        hydra.ast.Expr predicate = hydra.serialization.Serialization.cst(hydra.lib.strings.Cat2.apply(
          nameStr,
          "?"));
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("define-record-type"),
            name,
            constructor.get(),
            predicate),
          accessors.get()))));
  ...
  static hydra.ast.Expr macroDefinitionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.MacroDefinition mdef) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> body = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.ast.Expr>) (v1 -> hydra.ext.lisp.serde.Serde.expressionToExpr(
        ...
        v1)),
      (mdef).body));
    hydra.ast.Expr name = hydra.ext.lisp.serde.Serde.symbolToExpr((mdef).name);
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> params = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      hydra.ext.lisp.serde.Serde::symbolToExpr,
      (mdef).params));
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("defmacro"),
            name),
          hydra.util.ConsList.of(hydra.serialization.Serialization.brackets(
            hydra.serialization.Serialization.squareBrackets(),
            hydra.serialization.Serialization.inlineStyle(),
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("define-syntax"),
            name),
          body.get()))));
      }
    });
  ...
  static hydra.ast.Expr expressionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.Expression expr) {
    return (expr).accept(new hydra.ext.lisp.syntax.Expression.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Application a) {
        return hydra.ext.lisp.serde.Serde.applicationToExpr(
          d,
          (a).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Lambda l) {
        return hydra.ext.lisp.serde.Serde.lambdaToExpr(
          d,
          (l).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Let l) {
        return hydra.ext.lisp.serde.Serde.letExpressionToExpr(
          d,
          (l).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.If i) {
        return hydra.ext.lisp.serde.Serde.ifExpressionToExpr(
          d,
          (i).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Cond c) {
        return hydra.ext.lisp.serde.Serde.condExpressionToExpr(
          d,
          (c).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Case c) {
        return hydra.ext.lisp.serde.Serde.caseExpressionToExpr(
          d,
          (c).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.And a) {
        return hydra.ext.lisp.serde.Serde.andExpressionToExpr(
          d,
          (a).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Or o) {
        return hydra.ext.lisp.serde.Serde.orExpressionToExpr(
          d,
          (o).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Not n) {
        return hydra.ext.lisp.serde.Serde.notExpressionToExpr(
          d,
          (n).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Do e) {
        return hydra.ext.lisp.serde.Serde.doExpressionToExpr(
          d,
          (e).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Variable v) {
        return hydra.ext.lisp.serde.Serde.variableReferenceToExpr(
          d,
          (v).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Literal l) {
        return hydra.ext.lisp.serde.Serde.literalToExpr(
          d,
          (l).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.List l) {
        return hydra.ext.lisp.serde.Serde.listLiteralToExpr(
          d,
          (l).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Vector v) {
        return hydra.ext.lisp.serde.Serde.vectorLiteralToExpr(
          d,
          (v).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Map m) {
        return hydra.ext.lisp.serde.Serde.mapLiteralToExpr(
          d,
          (m).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Set s) {
        return hydra.ext.lisp.serde.Serde.setLiteralToExpr(
          d,
          (s).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.Cons c) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
          hydra.serialization.Serialization.cst("cons"),
          hydra.ext.lisp.serde.Serde.expressionToExpr(
            d,
            (c).value.head),
          hydra.ext.lisp.serde.Serde.expressionToExpr(
            d,
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.FieldAccess fa) {
        return hydra.ext.lisp.serde.Serde.fieldAccessToExpr(
          d,
          (fa).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Expression.SExpression s) {
        return hydra.ext.lisp.serde.Serde.sExpressionToExpr((s).value);
      }
    });
  }
  ...
  static hydra.ast.Expr lambdaToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.Lambda lam) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> body = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.ast.Expr>) (v1 -> hydra.ext.lisp.serde.Serde.expressionToExpr(
        ...
        v1)),
      (lam).body));
    String kw = hydra.ext.lisp.serde.Serde.lambdaKeyword(d);
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return hydra.lib.maybes.Maybe.applyLazy(
          () -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
            hydra.util.ConsList.of(hydra.serialization.Serialization.cst(kw)),
            hydra.util.ConsList.of(hydra.serialization.Serialization.brackets(
              hydra.serialization.Serialization.squareBrackets(),
              hydra.serialization.Serialization.inlineStyle(),
              hydra.serialization.Serialization.spaceSep(params.get()))),
            body.get())))),
          (java.util.function.Function<hydra.ext.lisp.syntax.Symbol, hydra.ast.Expr>) (sym -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
            hydra.util.ConsList.of(
              hydra.serialization.Serialization.cst(kw),
              hydra.ext.lisp.serde.Serde.symbolToExpr(sym)),
            hydra.util.ConsList.of(hydra.serialization.Serialization.brackets(
              hydra.serialization.Serialization.squareBrackets(),
              hydra.serialization.Serialization.inlineStyle(),
              hydra.serialization.Serialization.spaceSep(params.get()))),
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>>> bindingPairs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.LetBinding, hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>>) (b -> (b).accept(new hydra.ext.lisp.syntax.LetBinding.PartialVisitor<>() {
        ...
        public hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr> visit(hydra.ext.lisp.syntax.LetBinding.Simple sb) {
          return (hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>) ((hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>) (new hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>(hydra.ext.lisp.serde.Serde.symbolToExpr((sb).value.name), hydra.ext.lisp.serde.Serde.expressionToExpr(
            d,
            (sb).value.value))));
        }
        ...
        public hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr> visit(hydra.ext.lisp.syntax.LetBinding.Destructuring ignored) {
          return (hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>) ((hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>) (new hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>(hydra.serialization.Serialization.cst("<destructuring>"), hydra.serialization.Serialization.cst("<destructuring>"))));
        }
      })),
      bindings));
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> body = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return (kind).accept(new hydra.ext.lisp.syntax.LetKind.PartialVisitor<>() {
          ...
          public hydra.ast.Expr visit(hydra.ext.lisp.syntax.LetKind.Recursive _2) {
            return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
              hydra.util.ConsList.of(hydra.serialization.Serialization.cst("let")),
              hydra.util.ConsList.of(hydra.serialization.Serialization.brackets(
                hydra.serialization.Serialization.squareBrackets(),
                hydra.serialization.Serialization.inlineStyle(),
                hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> bindingExprs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.util.Pair<hydra.ast.Expr, hydra.ast.Expr>, hydra.ast.Expr>) (p -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
            hydra.lib.pairs.First.apply(p),
            hydra.lib.pairs.Second.apply(p))))),
          bindingPairs.get()));
        ...
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(hydra.serialization.Serialization.cst(kw)),
          hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(bindingExprs.get()))),
          body.get()))));
      }
  ...
  static hydra.ast.Expr ifExpressionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.IfExpression ifExpr) {
    hydra.ast.Expr cond = hydra.ext.lisp.serde.Serde.expressionToExpr(
      d,
      (ifExpr).condition);
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> elsePart = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
      () -> (hydra.util.ConsList<hydra.ast.Expr>) (hydra.util.ConsList.<hydra.ast.Expr>empty()),
      (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.util.ConsList<hydra.ast.Expr>>) (e -> hydra.util.ConsList.of(hydra.ext.lisp.serde.Serde.expressionToExpr(
        d,
        e))),
      else_));
    hydra.ast.Expr then = hydra.ext.lisp.serde.Serde.expressionToExpr(
      d,
      (ifExpr).then);
    return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
      hydra.util.ConsList.of(
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        ...
        hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> defaultPart = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
          ...
          dflt));
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
          hydra.util.ConsList.of(hydra.serialization.Serialization.cst("cond")),
          clauseExprs.get(),
          defaultPart.get()))));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> clauseExprs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.ext.lisp.syntax.CondClause, hydra.ast.Expr>) (c -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
            hydra.ext.lisp.serde.Serde.expressionToExpr(
              d,
              (c).condition),
            hydra.ext.lisp.serde.Serde.expressionToExpr(
        ...
        hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> defaultPart = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
          () -> (hydra.util.ConsList<hydra.ast.Expr>) (hydra.util.ConsList.<hydra.ast.Expr>empty()),
          (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.util.ConsList<hydra.ast.Expr>>) (e -> hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("t"),
            hydra.ext.lisp.serde.Serde.expressionToExpr(
              d,
              e)))))),
          dflt));
  ...
  static hydra.ast.Expr caseExpressionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.CaseExpression caseExpr) {
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> clauseExprs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.ext.lisp.syntax.CaseClause, hydra.ast.Expr>) (c -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
        hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.ast.Expr>) (v1 -> hydra.ext.lisp.serde.Serde.expressionToExpr(
            d,
            v1)),
          (c).keys))),
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ast.Expr>> defaultPart = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
      ...
      (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.util.ConsList<hydra.ast.Expr>>) (e -> hydra.util.ConsList.of(hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
        ...
        hydra.ext.lisp.serde.Serde.expressionToExpr(
          ...
          e)))))),
      dflt));
    hydra.ast.Expr scrutinee = hydra.ext.lisp.serde.Serde.expressionToExpr(
      d,
      (caseExpr).scrutinee);
    return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
      hydra.util.ConsList.of(
  ...
  static hydra.ast.Expr andExpressionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.AndExpression andExpr) {
    return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
      hydra.util.ConsList.of(hydra.serialization.Serialization.cst("and")),
      hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.ast.Expr>) (v1 -> hydra.ext.lisp.serde.Serde.expressionToExpr(
          d,
          v1)),
  ...
  static hydra.ast.Expr orExpressionToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.OrExpression orExpr) {
    return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
      hydra.util.ConsList.of(hydra.serialization.Serialization.cst("or")),
      hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.ext.lisp.syntax.Expression, hydra.ast.Expr>) (v1 -> hydra.ext.lisp.serde.Serde.expressionToExpr(
          d,
          v1)),
  ...
  static hydra.ast.Expr variableReferenceToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.VariableReference vref) {
    ...
    hydra.ast.Expr name = hydra.ext.lisp.serde.Serde.symbolToExpr((vref).name);
  ...
  static hydra.ast.Expr fieldAccessToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.FieldAccess fa) {
    hydra.ast.Expr field = hydra.ext.lisp.serde.Serde.symbolToExpr((fa).field);
    hydra.ast.Expr rtype = hydra.ext.lisp.serde.Serde.symbolToExpr((fa).recordType);
    hydra.ast.Expr target = hydra.ext.lisp.serde.Serde.expressionToExpr(
      d,
      (fa).target);
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      @Override
  ...
  static hydra.ast.Expr literalToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.Literal lit) {
    return (lit).accept(new hydra.ext.lisp.syntax.Literal.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Literal.Integer_ i) {
        return hydra.serialization.Serialization.cst(hydra.lib.literals.ShowBigint.apply((i).value.value));
      }

      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Literal.Float_ f) {
        return hydra.serialization.Serialization.cst(hydra.lib.literals.ShowBigfloat.apply((f).value.value));
      }
          ...
          public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.CommonLisp ignored) {
            String escaped = hydra.lib.strings.Intercalate.apply(
              ...
              hydra.lib.strings.SplitOn.apply(
                "\"",
                e1));
            return hydra.serialization.Serialization.cst(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "\"",
              escaped,
              "\"")));
          }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Literal.Boolean_ b) {
        return hydra.lib.logic.IfElse.lazy(
          (b).value,
          () -> hydra.ext.lisp.serde.Serde.trueExpr(d),
          () -> hydra.ext.lisp.serde.Serde.falseExpr(d));
      }

      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Literal.Nil ignored) {
        return hydra.ext.lisp.serde.Serde.nilExpr(d);
      }

      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Literal.Keyword k) {
        return hydra.ext.lisp.serde.Serde.keywordToExpr(
          d,
          (k).value);
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Literal.Symbol s) {
        return hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
          hydra.serialization.Serialization.cst("'"),
          hydra.ext.lisp.serde.Serde.symbolToExpr((s).value)));
      }
    });
  }
  ...
  static hydra.ast.Expr listLiteralToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.ListLiteral ll) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
        hydra.serialization.Serialization.cst("'"),
        hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(elems.get())))),
      () -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
        hydra.util.ConsList.of(hydra.serialization.Serialization.cst(hydra.ext.lisp.serde.Serde.listKeyword(d))),
        elems.get()))));
  }
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return hydra.serialization.Serialization.brackets(
          hydra.serialization.Serialization.squareBrackets(),
          hydra.serialization.Serialization.inlineStyle(),
          hydra.serialization.Serialization.spaceSep(elems.get()));
      }
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
          hydra.serialization.Serialization.cst("'"),
          hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Map.apply(
            (java.util.function.Function<hydra.ext.lisp.syntax.MapEntry, hydra.ast.Expr>) (e -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
              hydra.ext.lisp.serde.Serde.expressionToExpr(
                d,
                (e).key),
              hydra.serialization.Serialization.cst("."),
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
          hydra.util.ConsList.of(hydra.serialization.Serialization.cst("list")),
          hydra.lib.lists.Map.apply(
            (java.util.function.Function<hydra.ext.lisp.syntax.MapEntry, hydra.ast.Expr>) (e -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
              hydra.serialization.Serialization.cst("cons"),
              hydra.ext.lisp.serde.Serde.expressionToExpr(
  ...
  static hydra.ast.Expr setLiteralToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.SetLiteral sl) {
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.CommonLisp ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Concat2.apply(
          hydra.util.ConsList.of(hydra.serialization.Serialization.cst("cl:list")),
          elems.get())));
      }
  ...
  static hydra.ast.Expr moduleDeclarationToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.ModuleDeclaration mdecl) {
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
          hydra.serialization.Serialization.cst("ns"),
          hydra.serialization.Serialization.cst(name))));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
          hydra.serialization.Serialization.cst("define-library"),
          hydra.serialization.Serialization.parens(hydra.serialization.Serialization.cst(name)))));
      }
    });
  }
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Clojure ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
          ...
          hydra.serialization.Serialization.brackets(
            hydra.serialization.Serialization.squareBrackets(),
            hydra.serialization.Serialization.inlineStyle(),
            hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(hydra.serialization.Serialization.cst(modName)))))));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
          ...
          hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("'"),
            hydra.serialization.Serialization.cst(modName))))));
      }
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.Scheme ignored) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
          ...
          hydra.serialization.Serialization.parens(hydra.serialization.Serialization.cst(modName)))));
      }
    });
  }
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.Dialect.EmacsLisp ignored) {
        return hydra.serialization.Serialization.newlineSep(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.ast.Expr, hydra.ast.Expr>) (s -> hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.util.ConsList.of(
            hydra.serialization.Serialization.cst("provide"),
            hydra.serialization.Serialization.noSep(hydra.util.ConsList.of(
              hydra.serialization.Serialization.cst("'"),
              s)))))),
  ...
  static hydra.ast.Expr sExpressionToExpr(hydra.ext.lisp.syntax.SExpression sexpr) {
    return (sexpr).accept(new hydra.ext.lisp.syntax.SExpression.PartialVisitor<>() {
      ...
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.SExpression.Atom a) {
        return hydra.serialization.Serialization.cst((a).value);
      }

      @Override
      public hydra.ast.Expr visit(hydra.ext.lisp.syntax.SExpression.List elems) {
        return hydra.serialization.Serialization.parens(hydra.serialization.Serialization.spaceSep(hydra.lib.lists.Map.apply(
          hydra.ext.lisp.serde.Serde::sExpressionToExpr,
          (elems).value)));
      }
    });
  }
  ...
  static hydra.ast.Expr symbolToExpr(hydra.ext.lisp.syntax.Symbol s) {
    return hydra.serialization.Serialization.cst((s).value);
  }
  ...
  static hydra.ast.Expr keywordToExpr(hydra.ext.lisp.syntax.Dialect d, hydra.ext.lisp.syntax.Keyword k) {
    ...
    return (d).accept(new hydra.ext.lisp.syntax.Dialect.PartialVisitor<>() {
      ...
      public hydra.ast.Expr otherwise(hydra.ext.lisp.syntax.Dialect instance) {
        return hydra.serialization.Serialization.cst(hydra.lib.maybes.Maybe.applyLazy(
