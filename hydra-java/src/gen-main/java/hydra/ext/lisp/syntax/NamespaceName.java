 ...
 */
public class NamespaceName implements Serializable, Comparable<NamespaceName> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.NamespaceName");
