...
public class NotExpression implements Serializable, Comparable<NotExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.NotExpression");
  ...
  public NotExpression (hydra.ext.lisp.syntax.Expression expression) {
