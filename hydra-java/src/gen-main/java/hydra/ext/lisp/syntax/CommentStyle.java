...
public abstract class CommentStyle implements Serializable, Comparable<CommentStyle> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.CommentStyle");
  ...
  public static final class Line extends hydra.ext.lisp.syntax.CommentStyle implements Serializable {
    public Line () {
  ...
  public static final class Block extends hydra.ext.lisp.syntax.CommentStyle implements Serializable {
    public Block () {
  ...
  public static final class Datum extends hydra.ext.lisp.syntax.CommentStyle implements Serializable {
    public Datum () {
