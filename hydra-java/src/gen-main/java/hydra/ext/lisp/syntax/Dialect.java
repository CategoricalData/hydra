...
public abstract class Dialect implements Serializable, Comparable<Dialect> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.Dialect");
  ...
  public static final class Clojure extends hydra.ext.lisp.syntax.Dialect implements Serializable {
    public Clojure () {
  ...
  public static final class EmacsLisp extends hydra.ext.lisp.syntax.Dialect implements Serializable {
    public EmacsLisp () {
  ...
  public static final class CommonLisp extends hydra.ext.lisp.syntax.Dialect implements Serializable {
    public CommonLisp () {
  ...
  public static final class Scheme extends hydra.ext.lisp.syntax.Dialect implements Serializable {
    public Scheme () {
