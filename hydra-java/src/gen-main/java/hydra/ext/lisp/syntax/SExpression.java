...
public abstract class SExpression implements Serializable, Comparable<SExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.SExpression");
   ...
   * An atomic value
   */
  public static final class Atom extends hydra.ext.lisp.syntax.SExpression implements Serializable {
