...
public class ModuleDeclaration implements Serializable, Comparable<ModuleDeclaration> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.ModuleDeclaration");
   ...
   */
  public final hydra.ext.lisp.syntax.NamespaceName name;
  ...
  public ModuleDeclaration (hydra.ext.lisp.syntax.NamespaceName name, hydra.util.Maybe<hydra.ext.lisp.syntax.Docstring> doc) {
    this.name = name;
    this.doc = doc;
  }
  ...
  public ModuleDeclaration withDoc(hydra.util.Maybe<hydra.ext.lisp.syntax.Docstring> doc) {
    return new ModuleDeclaration(name, doc);
  }
}
