...
public abstract class BooleanStyle implements Serializable, Comparable<BooleanStyle> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.BooleanStyle");
  ...
  public static final class TrueFalse extends hydra.ext.lisp.syntax.BooleanStyle implements Serializable {
    public TrueFalse () {
  ...
  public static final class TNil extends hydra.ext.lisp.syntax.BooleanStyle implements Serializable {
    public TNil () {
  ...
  public static final class HashTF extends hydra.ext.lisp.syntax.BooleanStyle implements Serializable {
    public HashTF () {
