...
public abstract class LetKind implements Serializable, Comparable<LetKind> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.LetKind");
  ...
  public static final class Parallel extends hydra.ext.lisp.syntax.LetKind implements Serializable {
    public Parallel () {
  ...
  public static final class Sequential extends hydra.ext.lisp.syntax.LetKind implements Serializable {
    public Sequential () {
  ...
  public static final class Recursive extends hydra.ext.lisp.syntax.LetKind implements Serializable {
    public Recursive () {
