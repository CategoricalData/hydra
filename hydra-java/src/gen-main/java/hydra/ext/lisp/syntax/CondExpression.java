...
public class CondExpression implements Serializable, Comparable<CondExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.lisp.syntax.CondExpression");
  ...
  public CondExpression withDefault(hydra.util.Maybe<hydra.ext.lisp.syntax.Expression> default_) {
    return new CondExpression(clauses, default_);
  }
}
