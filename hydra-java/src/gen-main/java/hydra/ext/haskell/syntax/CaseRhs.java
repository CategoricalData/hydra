...
public class CaseRhs implements Serializable, Comparable<CaseRhs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.CaseRhs");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.ext.haskell.syntax.Expression value;

  public CaseRhs (hydra.ext.haskell.syntax.Expression value) {
    this.value = value;
  }
