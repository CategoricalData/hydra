...
public class PatternField implements Serializable, Comparable<PatternField> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.PatternField");
  ...
  public PatternField (hydra.ext.haskell.syntax.Name name, hydra.ext.haskell.syntax.Pattern pattern) {
    this.name = name;
  ...
  public PatternField withPattern(hydra.ext.haskell.syntax.Pattern pattern) {
    return new PatternField(name, pattern);
  }
}
