...
public class FieldWithComments implements Serializable, Comparable<FieldWithComments> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.FieldWithComments");
   ...
   * The field
   */
  public final hydra.ext.haskell.syntax.Field field;
  ...
  public FieldWithComments (hydra.ext.haskell.syntax.Field field, hydra.util.Maybe<String> comments) {
    this.field = field;
