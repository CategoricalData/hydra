...
public class RecordConstructor implements Serializable, Comparable<RecordConstructor> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.RecordConstructor");
   ...
   */
  public final hydra.util.ConsList<hydra.ext.haskell.syntax.FieldWithComments> fields;

  public RecordConstructor (hydra.ext.haskell.syntax.Name name, hydra.util.ConsList<hydra.ext.haskell.syntax.FieldWithComments> fields) {
    this.name = name;
    this.fields = fields;
  }
  ...
  public RecordConstructor withName(hydra.ext.haskell.syntax.Name name) {
    return new RecordConstructor(name, fields);
  }

  public RecordConstructor withFields(hydra.util.ConsList<hydra.ext.haskell.syntax.FieldWithComments> fields) {
    return new RecordConstructor(name, fields);
  }
}
