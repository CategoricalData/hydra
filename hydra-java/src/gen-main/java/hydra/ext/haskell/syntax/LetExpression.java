...
public class LetExpression implements Serializable, Comparable<LetExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.LetExpression");
  ...
  public LetExpression withInner(hydra.ext.haskell.syntax.Expression inner) {
    return new LetExpression(bindings, inner);
  }
}
