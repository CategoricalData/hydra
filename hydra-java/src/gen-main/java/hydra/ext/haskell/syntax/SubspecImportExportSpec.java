...
public abstract class SubspecImportExportSpec implements Serializable, Comparable<SubspecImportExportSpec> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.SubspecImportExportSpec");
   ...
   * Import/export all
   */
  public static final class All extends hydra.ext.haskell.syntax.SubspecImportExportSpec implements Serializable {
    public All () {
   ...
   */
  public static final class List extends hydra.ext.haskell.syntax.SubspecImportExportSpec implements Serializable {
    public final hydra.util.ConsList<hydra.ext.haskell.syntax.Name> value;

    public List (hydra.util.ConsList<hydra.ext.haskell.syntax.Name> value) {
      this.value = value;
    }
