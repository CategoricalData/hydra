...
public abstract class Assertion implements Serializable, Comparable<Assertion> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.Assertion");
   ...
   * A class assertion
   */
  public static final class Class_ extends hydra.ext.haskell.syntax.Assertion implements Serializable {
    public final hydra.ext.haskell.syntax.ClassAssertion value;

    public Class_ (hydra.ext.haskell.syntax.ClassAssertion value) {
      this.value = value;
    }
