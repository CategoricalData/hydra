...
public class RightHandSide implements Serializable, Comparable<RightHandSide> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.RightHandSide");

  public static final hydra.core.Name VALUE = new hydra.core.Name("value");

  public final hydra.ext.haskell.syntax.Expression value;

  public RightHandSide (hydra.ext.haskell.syntax.Expression value) {
    this.value = value;
  }
