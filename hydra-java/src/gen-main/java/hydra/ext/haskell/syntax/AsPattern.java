...
public class AsPattern implements Serializable, Comparable<AsPattern> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.AsPattern");
  ...
  public AsPattern (hydra.ext.haskell.syntax.Name name, hydra.ext.haskell.syntax.Pattern inner) {
    this.name = name;
    this.inner = inner;
  }
  ...
  public AsPattern withInner(hydra.ext.haskell.syntax.Pattern inner) {
    return new AsPattern(name, inner);
  }
}
