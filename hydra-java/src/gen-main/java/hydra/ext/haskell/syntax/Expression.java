...
public abstract class Expression implements Serializable, Comparable<Expression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.Expression");
   ...
   */
  public static final class Application extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.ApplicationExpression value;

    public Application (hydra.ext.haskell.syntax.ApplicationExpression value) {
      this.value = value;
    }
   ...
   * A case expression
   */
  public static final class Case extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.CaseExpression value;

    public Case (hydra.ext.haskell.syntax.CaseExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class ConstructRecord extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.ConstructRecordExpression value;

    public ConstructRecord (hydra.ext.haskell.syntax.ConstructRecordExpression value) {
      this.value = value;
    }
   ...
   * An 'if' expression
   */
  public static final class If extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.IfExpression value;

    public If (hydra.ext.haskell.syntax.IfExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class InfixApplication extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.InfixApplicationExpression value;

    public InfixApplication (hydra.ext.haskell.syntax.InfixApplicationExpression value) {
      this.value = value;
    }
   ...
   * A literal value
   */
  public static final class Literal extends hydra.ext.haskell.syntax.Expression implements Serializable {
   ...
   * A lambda expression
   */
  public static final class Lambda extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.LambdaExpression value;

    public Lambda (hydra.ext.haskell.syntax.LambdaExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class LeftSection extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.SectionExpression value;

    public LeftSection (hydra.ext.haskell.syntax.SectionExpression value) {
      this.value = value;
    }
   ...
   * A 'let' expression
   */
  public static final class Let extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.LetExpression value;

    public Let (hydra.ext.haskell.syntax.LetExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class Parens extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.Expression value;

    public Parens (hydra.ext.haskell.syntax.Expression value) {
      this.value = value;
    }
   ...
   */
  public static final class PrefixApplication extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.PrefixApplicationExpression value;

    public PrefixApplication (hydra.ext.haskell.syntax.PrefixApplicationExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class RightSection extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.SectionExpression value;

    public RightSection (hydra.ext.haskell.syntax.SectionExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class TypeSignature extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.TypeSignatureExpression value;

    public TypeSignature (hydra.ext.haskell.syntax.TypeSignatureExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class UpdateRecord extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.UpdateRecordExpression value;

    public UpdateRecord (hydra.ext.haskell.syntax.UpdateRecordExpression value) {
      this.value = value;
    }
   ...
   */
  public static final class Variable extends hydra.ext.haskell.syntax.Expression implements Serializable {
    public final hydra.ext.haskell.syntax.Name value;

    public Variable (hydra.ext.haskell.syntax.Name value) {
      this.value = value;
    }
