...
public class QualifiedName implements Serializable, Comparable<QualifiedName> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.QualifiedName");
  ...
  public QualifiedName withUnqualified(hydra.ext.haskell.syntax.NamePart unqualified) {
    return new QualifiedName(qualifiers, unqualified);
  }
}
