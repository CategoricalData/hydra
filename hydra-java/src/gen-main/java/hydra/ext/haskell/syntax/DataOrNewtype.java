...
public abstract class DataOrNewtype implements Serializable, Comparable<DataOrNewtype> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.DataOrNewtype");
  ...
  public static final class Data extends hydra.ext.haskell.syntax.DataOrNewtype implements Serializable {
    public Data () {
  ...
  public static final class Newtype extends hydra.ext.haskell.syntax.DataOrNewtype implements Serializable {
    public Newtype () {
