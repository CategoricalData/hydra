...
public class ConstructorWithComments implements Serializable, Comparable<ConstructorWithComments> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.ConstructorWithComments");
   ...
   * The constructor
   */
  public final hydra.ext.haskell.syntax.Constructor body;
  ...
  public ConstructorWithComments (hydra.ext.haskell.syntax.Constructor body, hydra.util.Maybe<String> comments) {
    this.body = body;
