...
public class ContextType implements Serializable, Comparable<ContextType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.ContextType");
   ...
   */
  public final hydra.ext.haskell.syntax.Assertion ctx;
  ...
  public ContextType (hydra.ext.haskell.syntax.Assertion ctx, hydra.ext.haskell.syntax.Type type) {
    this.ctx = ctx;
    this.type = type;
  }
  ...
  public ContextType withType(hydra.ext.haskell.syntax.Type type) {
    return new ContextType(ctx, type);
  }
}
