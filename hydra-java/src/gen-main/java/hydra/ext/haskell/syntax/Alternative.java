...
public class Alternative implements Serializable, Comparable<Alternative> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.Alternative");
   ...
   */
  public final hydra.ext.haskell.syntax.CaseRhs rhs;

  /**
   * Optional local bindings
   */
  public final hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings> binds;

  public Alternative (hydra.ext.haskell.syntax.Pattern pattern, hydra.ext.haskell.syntax.CaseRhs rhs, hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings> binds) {
  ...
  public Alternative withRhs(hydra.ext.haskell.syntax.CaseRhs rhs) {
    return new Alternative(pattern, rhs, binds);
  }

  public Alternative withBinds(hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings> binds) {
    return new Alternative(pattern, rhs, binds);
  }
}
