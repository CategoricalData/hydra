...
public class TypeSignatureExpression implements Serializable, Comparable<TypeSignatureExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.TypeSignatureExpression");
  ...
  public TypeSignatureExpression (hydra.ext.haskell.syntax.Expression inner, hydra.ext.haskell.syntax.Type type) {
    this.inner = inner;
    this.type = type;
  }
  ...
  public TypeSignatureExpression withInner(hydra.ext.haskell.syntax.Expression inner) {
    return new TypeSignatureExpression(inner, type);
  }

  public TypeSignatureExpression withType(hydra.ext.haskell.syntax.Type type) {
    return new TypeSignatureExpression(inner, type);
  }
}
