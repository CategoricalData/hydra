...
public class IfExpression implements Serializable, Comparable<IfExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.IfExpression");
   ...
   */
  public final hydra.ext.haskell.syntax.Expression condition;

  /**
   * The 'then' branch
   */
  public final hydra.ext.haskell.syntax.Expression then;

  /**
   * The 'else' branch
   */
  public final hydra.ext.haskell.syntax.Expression else_;

  public IfExpression (hydra.ext.haskell.syntax.Expression condition, hydra.ext.haskell.syntax.Expression then, hydra.ext.haskell.syntax.Expression else_) {
  ...
  public IfExpression withThen(hydra.ext.haskell.syntax.Expression then) {
    return new IfExpression(condition, then, else_);
  }

  public IfExpression withElse(hydra.ext.haskell.syntax.Expression else_) {
    return new IfExpression(condition, then, else_);
  }
}
