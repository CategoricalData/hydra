...
public class ApplicationType implements Serializable, Comparable<ApplicationType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.ApplicationType");
   ...
   */
  public final hydra.ext.haskell.syntax.Type context;

  /**
   * The type argument
   */
  public final hydra.ext.haskell.syntax.Type argument;

  public ApplicationType (hydra.ext.haskell.syntax.Type context, hydra.ext.haskell.syntax.Type argument) {
  ...
  public ApplicationType withArgument(hydra.ext.haskell.syntax.Type argument) {
    return new ApplicationType(context, argument);
  }
}
