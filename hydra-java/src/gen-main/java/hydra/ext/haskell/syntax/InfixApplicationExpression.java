...
public class InfixApplicationExpression implements Serializable, Comparable<InfixApplicationExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.InfixApplicationExpression");
   ...
   */
  public final hydra.ext.haskell.syntax.Expression lhs;
   ...
   */
  public final hydra.ext.haskell.syntax.Expression rhs;

  public InfixApplicationExpression (hydra.ext.haskell.syntax.Expression lhs, hydra.ext.haskell.syntax.Operator operator, hydra.ext.haskell.syntax.Expression rhs) {
    this.lhs = lhs;
  ...
  public InfixApplicationExpression withOperator(hydra.ext.haskell.syntax.Operator operator) {
    return new InfixApplicationExpression(lhs, operator, rhs);
  }

  public InfixApplicationExpression withRhs(hydra.ext.haskell.syntax.Expression rhs) {
    return new InfixApplicationExpression(lhs, operator, rhs);
  }
}
