...
public class TypeSignature implements Serializable, Comparable<TypeSignature> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.TypeSignature");
  ...
  public TypeSignature (hydra.ext.haskell.syntax.Name name, hydra.ext.haskell.syntax.Type type) {
    this.name = name;
    this.type = type;
  }
  ...
  public TypeSignature withName(hydra.ext.haskell.syntax.Name name) {
    return new TypeSignature(name, type);
  }

  public TypeSignature withType(hydra.ext.haskell.syntax.Type type) {
    return new TypeSignature(name, type);
  }
}
