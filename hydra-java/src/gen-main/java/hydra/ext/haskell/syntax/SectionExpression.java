...
public class SectionExpression implements Serializable, Comparable<SectionExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.haskell.syntax.SectionExpression");
   ...
   * The operand
   */
  public final hydra.ext.haskell.syntax.Expression expression;

  public SectionExpression (hydra.ext.haskell.syntax.Operator operator, hydra.ext.haskell.syntax.Expression expression) {
  ...
  public SectionExpression withExpression(hydra.ext.haskell.syntax.Expression expression) {
    return new SectionExpression(operator, expression);
  }
}
