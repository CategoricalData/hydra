...
public interface TestCodec {
  static hydra.util.Either<String, String> termToHaskell(hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces, hydra.core.Term term, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bimap.apply(
      ...
      (java.util.function.Function<hydra.ext.haskell.ast.Expression, String>) (arg_ -> hydra.Serialization.printExpr(hydra.Serialization.parenthesize(hydra.ext.haskell.Serde.expressionToExpr(arg_)))),
  ...
  static <T0> hydra.util.Either<String, String> typeToHaskell(hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces, hydra.core.Type typ, T0 g) {
    return hydra.lib.eithers.Bimap.apply(
      (java.util.function.Function<hydra.context.InContext<hydra.errors.Error_>, String>) (ic -> hydra.show.Errors.error(((java.util.function.Function<hydra.context.InContext<hydra.errors.Error_>, hydra.errors.Error_>) (projected -> projected.object)).apply(ic))),
      (java.util.function.Function<hydra.ext.haskell.ast.Type, String>) (arg_ -> hydra.Serialization.printExpr(hydra.Serialization.parenthesize(hydra.ext.haskell.Serde.typeToExpr(arg_)))),
  ...
  static hydra.testing.TestCodec haskellTestCodec(hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces) {
    return new hydra.testing.TestCodec(new hydra.coders.LanguageName("haskell"), new hydra.module.FileExtension("hs"), (java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>>) (v1 -> (java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>) (v2 -> hydra.ext.haskell.TestCodec.termToHaskell(
      namespaces,
      v1,
      v2))), (java.util.function.Function<hydra.core.Type, java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>>) (v1 -> (java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>) (v2 -> hydra.ext.haskell.TestCodec.typeToHaskell(
      namespaces,
      v1,
      v2))), (java.util.function.Function<String, String>) (n -> n), hydra.ext.haskell.TestCodec::namespaceToModuleName, hydra.ext.haskell.TestCodec.haskellTestCaseTemplate(), hydra.ext.haskell.TestCodec.haskellTestGroupTemplate(), hydra.ext.haskell.TestCodec.haskellModuleTemplate(), hydra.ext.haskell.TestCodec.haskellImportTemplate(), (java.util.function.Function<hydra.util.PersistentSet<hydra.core.Name>, hydra.util.ConsList<String>>) (v1 -> hydra.ext.haskell.TestCodec.findHaskellImports(
      namespaces,
      v1)));
  }
  ...
  static hydra.util.Either<String, String> generateTestGroupHierarchy(hydra.graph.Graph g, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces, hydra.testing.TestCodec codec, Integer depth, hydra.testing.TestGroup testGroup) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.MapList.apply(
        (java.util.function.Function<hydra.testing.TestCaseWithMetadata, hydra.util.Either<String, hydra.util.ConsList<String>>>) (tc -> hydra.ext.haskell.TestCodec.generateTestCaseWithCodec(
          g,
          namespaces,
          codec,
          depth,
              ...
              (java.util.function.Function<hydra.testing.TestGroup, hydra.util.Either<String, String>>) (subgroup -> {
                ...
                return hydra.lib.eithers.Map.apply(
                  (java.util.function.Function<String, String>) (content -> hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
                    ...
                    " $ do\n",
                    content))),
                  hydra.ext.haskell.TestCodec.generateTestGroupHierarchy(
                    g,
                    namespaces,
                    codec,
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<String, hydra.util.Either<String, hydra.util.ConsList<String>>>) (inputCode -> hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<String, hydra.util.Either<String, hydra.util.ConsList<String>>>) (outputCode -> hydra.lib.eithers.Bind.apply(
              hydra.ext.haskell.TestCodec.generateTypeAnnotationFor(
                g,
                namespaces,
                input_,
                output_),
              (java.util.function.Function<hydra.util.Maybe<String>, hydra.util.Either<String, hydra.util.ConsList<String>>>) (typeAnnotation -> {
                String indentedOutputCode = hydra.ext.haskell.TestCodec.indentContinuationLines(
                  continuationIndent,
                  outputCode);
                hydra.util.Lazy<String> finalOutputCode = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
                  ...
                  (java.util.function.Function<String, String>) (anno -> hydra.lib.strings.Cat2.apply(
                    ...
                    anno)),
                  typeAnnotation));
                String indentedInputCode = hydra.ext.haskell.TestCodec.indentContinuationLines(
                  continuationIndent,
                  inputCode);
  ...
  static hydra.util.Either<String, hydra.util.Maybe<String>> generateTypeAnnotationFor(hydra.graph.Graph g, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces, hydra.core.Term inputTerm, hydra.core.Term outputTerm) {
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.logic.Not.apply(hydra.ext.haskell.TestCodec.containsTriviallyPolymorphic(outputTerm)),
      ...
      () -> hydra.lib.maybes.Maybe.applyLazy(
            ...
            () -> ((java.util.function.Supplier<hydra.util.Either<String, hydra.util.Maybe<String>>>) (() -> {
              ...
              return hydra.lib.eithers.Map.apply(
                (java.util.function.Function<String, hydra.util.Maybe<String>>) (typeStr -> hydra.util.Maybe.just(hydra.lib.strings.Cat2.apply(
                  " :: ",
                  typeStr))),
                hydra.ext.haskell.TestCodec.typeToHaskell(
                  namespaces,
                  groundedType,
                  g));
            })).get(),
        ...
        hydra.ext.haskell.TestCodec.tryInferTypeOf(
          g,
          inputTerm)));
  }
  ...
  static Boolean containsTriviallyPolymorphic(hydra.core.Term term) {
    return (term).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      public Boolean visit(hydra.core.Term.List xs) {
        return hydra.lib.logic.Or.apply(
          ...
          hydra.lib.lists.Foldl.apply(
            ...
            false,
            hydra.lib.lists.Map.apply(
              hydra.ext.haskell.TestCodec::containsTriviallyPolymorphic,
              (xs).value)));
      }
      ...
      public Boolean visit(hydra.core.Term.Union inj) {
        return hydra.ext.haskell.TestCodec.containsTriviallyPolymorphic((inj).value.field.term);
      }

      @Override
      public Boolean visit(hydra.core.Term.Pair p) {
        return hydra.lib.logic.Or.apply(
          hydra.ext.haskell.TestCodec.containsTriviallyPolymorphic(hydra.lib.pairs.First.apply((p).value)),
          hydra.ext.haskell.TestCodec.containsTriviallyPolymorphic(hydra.lib.pairs.Second.apply((p).value)));
      }
      ...
      public Boolean visit(hydra.core.Term.Record rec) {
        return hydra.lib.lists.Foldl.apply(
          ...
          false,
          hydra.lib.lists.Map.apply(
            (java.util.function.Function<hydra.core.Field, Boolean>) (f -> hydra.ext.haskell.TestCodec.containsTriviallyPolymorphic((f).term)),
            (rec).value.fields));
      }
      ...
      public Boolean visit(hydra.core.Term.Application app) {
        return hydra.lib.logic.Or.apply(
          hydra.ext.haskell.TestCodec.containsTriviallyPolymorphic((app).value.function),
          hydra.ext.haskell.TestCodec.containsTriviallyPolymorphic((app).value.argument));
      }
    });
  }
    ...
    return hydra.lib.eithers.Map.apply(
      (java.util.function.Function<String, hydra.util.Pair<String, String>>) (testBody -> {
        ...
        String filePath = hydra.Names.namespaceToFilePath(
          ...
          specNs);
        hydra.util.Lazy<String> testModuleContent = new hydra.util.Lazy<>(() -> hydra.ext.haskell.TestCodec.buildTestModuleWithCodec(
          codec,
          testModule,
          testGroup,
          testBody,
  ...
  static hydra.util.PersistentSet<hydra.core.Name> extractEncodedTermVariableNames(hydra.graph.Graph graf, hydra.core.Term term) {
    return hydra.Rewriting.foldOverTerm(
      ...
      (java.util.function.Function<hydra.util.PersistentSet<hydra.core.Name>, java.util.function.Function<hydra.core.Term, hydra.util.PersistentSet<hydra.core.Name>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.PersistentSet<hydra.core.Name>>) (v2 -> hydra.ext.haskell.TestCodec.collectNames(
        graf,
        v1,
        v2))),
  ...
  static hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> addNamespacesToNamespaces(hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> ns0, hydra.util.PersistentSet<hydra.core.Name> names) {
    ...
    java.util.function.Function<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName> toModuleName = (java.util.function.Function<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>) (namespace -> new hydra.ext.haskell.ast.ModuleName(hydra.Formatting.capitalize(hydra.lib.lists.Last.apply(hydra.lib.strings.SplitOn.apply(
      ".",
      (namespace).value)))));
  ...
  static hydra.util.Either<String, hydra.util.Pair<String, String>> generateHaskellTestFile(hydra.module.Module testModule, hydra.testing.TestGroup testGroup, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bind.apply(
      hydra.ext.haskell.TestCodec.buildNamespacesForTestGroup(
        testModule,
        testGroup,
        g),
      (java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>, hydra.util.Either<String, hydra.util.Pair<String, String>>>) (namespaces -> hydra.ext.haskell.TestCodec.generateTestFileWithCodec(
        hydra.ext.haskell.TestCodec.haskellTestCodec(namespaces),
        testModule,
        testGroup,
        namespaces,
        g)));
  ...
  static hydra.util.Either<String, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>> buildNamespacesForTestGroup(hydra.module.Module mod, hydra.testing.TestGroup tgroup, hydra.graph.Graph graph_) {
    hydra.util.ConsList<hydra.testing.TestCaseWithMetadata> testCases_ = hydra.ext.haskell.TestCodec.collectTestCases(tgroup);
    hydra.util.Lazy<hydra.util.ConsList<hydra.core.Term>> testTerms = new hydra.util.Lazy<>(() -> hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
      hydra.ext.haskell.TestCodec::extractTestTerms,
      testCases_)));
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>, hydra.util.Either<String, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>>>) (baseNamespaces -> {
        hydra.util.Lazy<hydra.util.PersistentSet<hydra.core.Name>> encodedNames = new hydra.util.Lazy<>(() -> hydra.lib.sets.Unions.apply(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.core.Term, hydra.util.PersistentSet<hydra.core.Name>>) (t -> hydra.ext.haskell.TestCodec.extractEncodedTermVariableNames(
            graph_,
            t)),
          testTerms.get())));
        return hydra.util.Either.<String, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>>right(hydra.ext.haskell.TestCodec.addNamespacesToNamespaces(
          baseNamespaces,
          encodedNames.get()));
      }));
  }
  ...
  static hydra.util.ConsList<hydra.testing.TestCaseWithMetadata> collectTestCases(hydra.testing.TestGroup tg) {
    return hydra.lib.lists.Concat2.apply(
      ...
      hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
        hydra.ext.haskell.TestCodec::collectTestCases,
        (tg).subgroups)));
  }
