...
public interface Testing {
  static hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> addNamespacesToNamespaces(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> ns0, java.util.Set<hydra.core.Name> names) {
    hydra.util.Lazy<java.util.Set<hydra.module.Namespace>> newNamespaces = new hydra.util.Lazy<>(() -> hydra.lib.sets.FromList.apply(hydra.lib.maybes.Cat.apply(hydra.lib.lists.Map.apply(
    ...
    java.util.function.Function<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName> toModuleName = (java.util.function.Function<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>) (namespace -> new hydra.ext.haskell.syntax.ModuleName(hydra.Formatting.capitalize(hydra.lib.lists.Last.apply(hydra.lib.strings.SplitOn.apply(
      ".",
      (namespace).value)))));
    hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>> newMappings = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.lib.lists.Map.apply(
    ...
    return (hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>) (new hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>(((java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>, hydra.util.Pair<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>>) (projected -> projected.focus)).apply(ns0), hydra.lib.maps.Union.apply(
      ((java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>, java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>>) (projected -> projected.mapping)).apply(ns0),
      newMappings.get())));
  }
  ...
  static <T0> java.util.List<String> findHaskellImports(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, T0 names_) {
    hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>> mapping_ = new hydra.util.Lazy<>(() -> ((java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>, java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>>) (projected -> projected.mapping)).apply(namespaces));
    hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>> filtered = new hydra.util.Lazy<>(() -> hydra.lib.maps.FilterWithKey.apply(
    ...
    return hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.util.Pair<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>, String>) (entry -> hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
        "import qualified ",
