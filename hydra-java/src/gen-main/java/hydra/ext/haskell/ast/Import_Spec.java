...
public abstract class Import_Spec implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/haskell/ast.Import.Spec");
  ...
  public static final class List extends hydra.ext.haskell.ast.Import_Spec implements Serializable {
  ...
  public static final class Hiding extends hydra.ext.haskell.ast.Import_Spec implements Serializable {
    public final java.util.List<hydra.ext.haskell.ast.ImportExportSpec> value;
