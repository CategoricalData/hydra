...
public interface TestCodec {
  ...
  static hydra.testing.TestCodec haskellTestCodec(hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces) {
    return new hydra.testing.TestCodec(new hydra.coders.LanguageName("haskell"), new hydra.module.FileExtension("hs"), (java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>>) (v1 -> (java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>) (v2 -> hydra.ext.haskell.testCodec.TestCodec.termToHaskell(
      ...
      namespaces,
      v1,
      v2))), (java.util.function.Function<String, String>) (n -> n), hydra.ext.haskell.testCodec.TestCodec::namespaceToModuleName, hydra.ext.haskell.testCodec.TestCodec.haskellTestCaseTemplate(), hydra.ext.haskell.testCodec.TestCodec.haskellTestGroupTemplate(), hydra.ext.haskell.testCodec.TestCodec.haskellModuleTemplate(), hydra.ext.haskell.testCodec.TestCodec.haskellImportTemplate(), (java.util.function.Function<java.util.Set<hydra.core.Name>, java.util.List<String>>) (v1 -> hydra.ext.haskell.testCodec.TestCodec.findHaskellImports(
      namespaces,
      v1)));
  }
  ...
  static <T0> java.util.List<String> findHaskellImports(hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces, T0 names_) {
    hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>> mapping_ = new hydra.util.Lazy<>(() -> ((java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>, java.util.Map<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>>) (projected -> projected.mapping)).apply(namespaces));
    hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>> filtered = new hydra.util.Lazy<>(() -> hydra.lib.maps.FilterWithKey.apply(
    ...
    return hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.util.Pair<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>, String>) (entry -> hydra.lib.strings.Cat.apply(java.util.List.of(
        "import qualified ",
  ...
  static hydra.util.Either<String, String> generateTestGroupHierarchy(hydra.graph.Graph g, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces, hydra.testing.TestCodec codec, Integer depth, hydra.testing.TestGroup testGroup) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.MapList.apply(
        (java.util.function.Function<hydra.testing.TestCaseWithMetadata, hydra.util.Either<String, java.util.List<String>>>) (tc -> hydra.ext.haskell.testCodec.TestCodec.generateTestCaseWithCodec(
          g,
          namespaces,
          codec,
          depth,
          tc)),
        cases_),
      (java.util.function.Function<java.util.List<java.util.List<String>>, hydra.util.Either<String, String>>) (testCaseLinesRaw -> {
  ...
  static hydra.util.Either<String, java.util.List<String>> generateTestCaseWithCodec(hydra.graph.Graph g, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> namespaces, hydra.testing.TestCodec codec, Integer depth, hydra.testing.TestCaseWithMetadata tcm) {
      ...
      public hydra.util.Either<String, java.util.List<String>> visit(hydra.testing.TestCase.DelegatedEvaluation delCase) {
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<String, hydra.util.Either<String, java.util.List<String>>>) (inputCode -> hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<String, hydra.util.Either<String, java.util.List<String>>>) (outputCode -> hydra.lib.eithers.Bind.apply(
              hydra.ext.haskell.testCodec.TestCodec.generateTypeAnnotationFor(
                g,
                namespaces,
                input_,
                output_),
              (java.util.function.Function<hydra.util.Maybe<String>, hydra.util.Either<String, java.util.List<String>>>) (typeAnnotation -> {
                ...
                String indentedInputCode = hydra.ext.haskell.testCodec.TestCodec.indentContinuationLines(
                  continuationIndent,
                  inputCode);
                return hydra.util.Either.<String, java.util.List<String>>right(java.util.List.of(
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.maybes.Maybe.applyLazy(
        ...
        (java.util.function.Function<hydra.util.Pair<hydra.core.Term, hydra.core.TypeScheme>, hydra.util.Either<String, hydra.util.Maybe<String>>>) (result -> {
          hydra.util.Lazy<java.util.Set<hydra.core.Name>> schemaVars = new hydra.util.Lazy<>(() -> hydra.lib.sets.FromList.apply(hydra.lib.maps.Keys.apply((g).schemaTypes)));
          ...
          hydra.util.Lazy<java.util.List<hydra.core.Name>> freeVars = new hydra.util.Lazy<>(() -> hydra.lib.sets.ToList.apply(hydra.lib.sets.Difference.apply(
  ...
  static <T0> String buildTestModuleWithCodec(hydra.testing.TestCodec codec, hydra.module.Module testModule, hydra.testing.TestGroup testGroup, String testBody, T0 namespaces) {
    ...
    hydra.util.Lazy<java.util.List<String>> allImports = new hydra.util.Lazy<>(() -> hydra.lib.lists.Concat2.apply(
      standardImports,
      domainImports.get()));
    java.util.List<String> debugComments = java.util.List.of(
  ...
  static java.util.Set<hydra.core.Name> extractEncodedTermVariableNames(hydra.graph.Graph graf, hydra.core.Term term) {
    return hydra.rewriting.Rewriting.foldOverTerm(
      ...
      (java.util.function.Function<java.util.Set<hydra.core.Name>, java.util.function.Function<hydra.core.Term, java.util.Set<hydra.core.Name>>>) (v1 -> (java.util.function.Function<hydra.core.Term, java.util.Set<hydra.core.Name>>) (v2 -> hydra.ext.haskell.testCodec.TestCodec.collectNames(
        graf,
        v1,
        v2))),
  ...
  static java.util.Set<hydra.core.Name> collectNames(hydra.graph.Graph graf, java.util.Set<hydra.core.Name> names, hydra.core.Term t) {
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.eithers.Either.apply(
        (java.util.function.Function<hydra.error.DecodingError, java.util.Set<hydra.core.Name>>) (ignored -> names),
  ...
  static hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> addNamespacesToNamespaces(hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName> ns0, java.util.Set<hydra.core.Name> names) {
    ...
    java.util.function.Function<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName> toModuleName = (java.util.function.Function<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>) (namespace -> new hydra.ext.haskell.ast.ModuleName(hydra.formatting.Formatting.capitalize(hydra.lib.lists.Last.apply(hydra.lib.strings.SplitOn.apply(
      ".",
      (namespace).value)))));
    hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>> newMappings = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.lib.lists.Map.apply(
    ...
    return (hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>) (new hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>(((java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>, hydra.util.Pair<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>>) (projected -> projected.focus)).apply(ns0), hydra.lib.maps.Union.apply(
      ((java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>, java.util.Map<hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName>>) (projected -> projected.mapping)).apply(ns0),
      newMappings.get())));
  }
  ...
  static hydra.util.Either<String, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>> buildNamespacesForTestGroup(hydra.module.Module mod, hydra.testing.TestGroup tgroup, hydra.graph.Graph graph_) {
    java.util.List<hydra.testing.TestCaseWithMetadata> testCases_ = hydra.ext.haskell.testCodec.TestCodec.collectTestCases(tgroup);
    hydra.util.Lazy<java.util.List<hydra.core.Term>> testTerms = new hydra.util.Lazy<>(() -> hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>, hydra.util.Either<String, hydra.module.Namespaces<hydra.ext.haskell.ast.ModuleName>>>) (baseNamespaces -> {
        hydra.util.Lazy<java.util.Set<hydra.core.Name>> encodedNames = new hydra.util.Lazy<>(() -> hydra.lib.sets.Unions.apply(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.core.Term, java.util.Set<hydra.core.Name>>) (t -> hydra.ext.haskell.testCodec.TestCodec.extractEncodedTermVariableNames(
            graph_,
            t)),
          testTerms.get())));
  ...
  static java.util.List<hydra.core.Term> extractTestTerms(hydra.testing.TestCaseWithMetadata tcm) {
    return ((tcm).case_).accept(new hydra.testing.TestCase.PartialVisitor<>() {
      @Override
      public java.util.List<hydra.core.Term> otherwise(hydra.testing.TestCase instance) {
        return (java.util.List<hydra.core.Term>) (java.util.List.<hydra.core.Term>of());
      }
      
      @Override
      public java.util.List<hydra.core.Term> visit(hydra.testing.TestCase.DelegatedEvaluation delCase) {
