...
public interface Coder {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Module> constructModule(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.module.Module mod, hydra.util.ConsList<hydra.module.Definition> defs, hydra.context.Context cx, hydra.graph.Graph g) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.MapList.apply(
        createDeclarations,
        defs),
      (java.util.function.Function<hydra.util.ConsList<hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Module>>) (declLists -> {
        hydra.util.Lazy<hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>> decls = new hydra.util.Lazy<>(() -> hydra.lib.lists.Concat.apply(declLists));
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression> encodeCaseExpression(Integer depth, hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.CaseStatement stmt, hydra.ext.haskell.syntax.Expression scrutinee, hydra.context.Context cx, hydra.graph.Graph g) {
      ...
      return hydra.lib.eithers.Bind.apply(
        hydra.lib.maybes.Cases.applyLazy(
          hydra.lib.maps.Lookup.apply(
            fn,
            fieldMap),
          () -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>>left((hydra.context.InContext<hydra.errors.Error_>) (new hydra.context.InContext<hydra.errors.Error_>(new hydra.errors.Error_.Other(new hydra.errors.OtherError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
            "field ",
            hydra.lib.literals.ShowString.apply((fn).value),
            " not found in ",
            hydra.lib.literals.ShowString.apply((dn).value))))), cx))),
          (java.util.function.Function<hydra.core.FieldType, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>>>) (fieldType -> {
            hydra.core.Type ft = (fieldType).type;
            hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern> singleArg = hydra.util.ConsList.of(new hydra.ext.haskell.syntax.Pattern.Name(hydra.ext.haskell.Utils.rawName(v1.get())));
            return hydra.Rewriting.deannotateType(ft).accept(new hydra.core.Type.PartialVisitor<>() {
              @Override
              public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>> otherwise(hydra.core.Type instance) {
                return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>>right(singleArg);
              }

              @Override
              public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>> visit(hydra.core.Type.Unit ignored) {
                return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>>right(hydra.ext.haskell.Coder.<hydra.ext.haskell.syntax.Pattern>encodeCaseExpression_noArgs());
              }
            });
          })),
        (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Alternative>>) (args -> {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.Schemas.requireUnionType(
        ...
        g,
        dn),
      (java.util.function.Function<hydra.util.ConsList<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (rt -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            ...
            fields),
          (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.Alternative>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (ecases -> hydra.lib.eithers.Bind.apply(
            hydra.lib.maybes.Cases.applyLazy(
              def,
              () -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Alternative>>right((hydra.util.ConsList<hydra.ext.haskell.syntax.Alternative>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Alternative>empty())),
              (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Alternative>>>) (d -> hydra.lib.eithers.Bind.apply(
                hydra.lib.eithers.Map.apply(
                  (java.util.function.Function<hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.CaseRhs>) (x -> new hydra.ext.haskell.syntax.CaseRhs(x)),
                  hydra.ext.haskell.Coder.encodeTerm(
                    depth,
                    ...
                    cx,
                    g)),
                (java.util.function.Function<hydra.ext.haskell.syntax.CaseRhs, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Alternative>>>) (cs -> {
                  ...
                  return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Alternative>>right(hydra.util.ConsList.of(alt.get()));
                })))),
            (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.Alternative>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (dcases -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>right(new hydra.ext.haskell.syntax.Expression.Case(new hydra.ext.haskell.syntax.CaseExpression(scrutinee, hydra.lib.lists.Concat2.apply(
              ecases,
              dcases))))))));
      }));
  }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression> encodeTerm(Integer depth, hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Term term, hydra.context.Context cx, hydra.graph.Graph g) {
    java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>> encode = (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (t -> hydra.ext.haskell.Coder.encodeTerm(
      ...
      cx,
      g));
    java.util.function.Function<hydra.util.PersistentMap<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>> nonemptyMap = (java.util.function.Function<hydra.util.PersistentMap<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (m -> {
      ...
      return hydra.lib.eithers.Bind.apply(
        hydra.lib.eithers.Map.apply(
          (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.Expression>, hydra.ext.haskell.syntax.Expression>) (x -> new hydra.ext.haskell.syntax.Expression.List(x)),
          hydra.lib.eithers.MapList.apply(
            encodePair,
    ...
    java.util.function.Function<hydra.util.PersistentSet<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>> nonemptySet = (java.util.function.Function<hydra.util.PersistentSet<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (s -> {
    ...
    return hydra.Rewriting.deannotateTerm(term).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression> visit(hydra.core.Term.Let letTerm) {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            encodeBinding,
            allBindings.get()),
          (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.LocalBinding>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (hbindings -> hydra.lib.eithers.Bind.apply(
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression> visit(hydra.core.Term.List els) {
        return hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            encode,
            (els).value),
          (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.Expression>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (helems -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>right(new hydra.ext.haskell.syntax.Expression.List(helems))));
      }
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression> visit(hydra.core.Term.Record record) {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            toFieldUpdate,
            fields),
          (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.FieldUpdate>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (updates -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>right(new hydra.ext.haskell.syntax.Expression.ConstructRecord(new hydra.ext.haskell.syntax.ConstructRecordExpression(typeName, updates)))));
      }
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression> visit(hydra.core.Term.Union injection) {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.Schemas.requireUnionField(
            ...
            sname,
            fn),
          (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>>) (ftyp -> hydra.Rewriting.deannotateType(ftyp).accept(new hydra.core.Type.PartialVisitor<>() {
            @Override
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression> visit(hydra.core.Term.Unit ignored) {
        return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Expression>right(new hydra.ext.haskell.syntax.Expression.Tuple((hydra.util.ConsList<hydra.ext.haskell.syntax.Expression>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Expression>empty())));
      }
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type> encodeType(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Type typ, hydra.context.Context cx, T0 g) {
    java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type>> encode = (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type>>) (t -> hydra.ext.haskell.Coder.<T0>encodeType(
      ...
      cx,
      g));
    hydra.util.Lazy<hydra.ext.haskell.syntax.Type> unitTuple = new hydra.util.Lazy<>(() -> new hydra.ext.haskell.syntax.Type.Tuple((hydra.util.ConsList<hydra.ext.haskell.syntax.Type>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Type>empty())));
    return hydra.Rewriting.deannotateType(typ).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type> otherwise(hydra.core.Type instance) {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type> visit(hydra.core.Type.Pair pt) {
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<hydra.ext.haskell.syntax.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type>>) (f -> hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.ext.haskell.syntax.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type>>) (s -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type>right(new hydra.ext.haskell.syntax.Type.Tuple(hydra.util.ConsList.of(
              f,
              s)))))));
      }
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type> encodeTypeWithClassAssertions(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.util.PersistentMap<hydra.core.Name, hydra.util.PersistentSet<hydra.classes.TypeClass>> explicitClasses, hydra.core.Type typ, hydra.context.Context cx, T0 g) {
    ...
    java.util.function.Function<hydra.util.Pair<hydra.core.Name, hydra.classes.TypeClass>, hydra.ext.haskell.syntax.Assertion> encodeAssertion = (java.util.function.Function<hydra.util.Pair<hydra.core.Name, hydra.classes.TypeClass>, hydra.ext.haskell.syntax.Assertion>) (pair -> {
      ...
      return new hydra.ext.haskell.syntax.Assertion.Class_(new hydra.ext.haskell.syntax.ClassAssertion(hname, hydra.util.ConsList.of(htype)));
    });
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.ext.haskell.syntax.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type>>) (htyp -> hydra.lib.logic.IfElse.lazy(
        ...
        () -> ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Type>>) (() -> {
          hydra.util.Lazy<hydra.util.ConsList<hydra.ext.haskell.syntax.Assertion>> encoded = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
            encodeAssertion,
            assertPairs.get()));
  ...
  static hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments> nameDecls(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Name name, hydra.core.Type typ) {
    ...
    java.util.function.Function<hydra.core.Name, java.util.function.Function<hydra.util.Pair<String, String>, hydra.ext.haskell.syntax.DeclarationWithComments>> toDecl = (java.util.function.Function<hydra.core.Name, java.util.function.Function<hydra.util.Pair<String, String>, hydra.ext.haskell.syntax.DeclarationWithComments>>) (n -> (java.util.function.Function<hydra.util.Pair<String, String>, hydra.ext.haskell.syntax.DeclarationWithComments>) (pair -> {
      ...
      hydra.util.Lazy<hydra.ext.haskell.syntax.Declaration> decl = new hydra.util.Lazy<>(() -> new hydra.ext.haskell.syntax.Declaration.ValueBinding(new hydra.ext.haskell.syntax.ValueBinding.Simple(new hydra.ext.haskell.syntax.SimpleValueBinding(hydra.ext.haskell.Utils.applicationPattern(
        ...
        (hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Pattern>empty())), new hydra.ext.haskell.syntax.RightHandSide(new hydra.ext.haskell.syntax.Expression.Application(new hydra.ext.haskell.syntax.ApplicationExpression(new hydra.ext.haskell.syntax.Expression.Variable(hydra.ext.haskell.Utils.elementReference(
        namespaces,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments> toDataDeclaration(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.module.TermDefinition def, hydra.context.Context cx, hydra.graph.Graph g) {
      ...
      public hydra.ext.haskell.syntax.ValueBinding visit(hydra.ext.haskell.syntax.ValueBinding.Simple simple) {
        ...
        return (pattern_).accept(new hydra.ext.haskell.syntax.Pattern.PartialVisitor<>() {
          ...
          public hydra.ext.haskell.syntax.ValueBinding visit(hydra.ext.haskell.syntax.Pattern.Application appPat) {
            hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern> args = (appPat).value.args;
            ...
            return (rhsExpr).accept(new hydra.ext.haskell.syntax.Expression.PartialVisitor<>() {
              ...
              public hydra.ext.haskell.syntax.ValueBinding visit(hydra.ext.haskell.syntax.Expression.Lambda lambda_) {
                ...
                hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern> vars = (lambda_).value.bindings;
    ...
    toDecl.set((java.util.function.Function<hydra.util.Maybe<String>, java.util.function.Function<hydra.ext.haskell.syntax.Name, java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>>>>) (comments -> (java.util.function.Function<hydra.ext.haskell.syntax.Name, java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>>>) (hname_ -> (java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>>) (term_ -> (java.util.function.Function<hydra.util.Maybe<hydra.ext.haskell.syntax.LocalBindings>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>) (bindings -> hydra.Rewriting.deannotateTerm(term_).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<hydra.ext.haskell.syntax.Expression, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>) (hterm -> {
            ...
            return hydra.lib.eithers.Bind.apply(
              ...
              (java.util.function.Function<hydra.util.PersistentMap<hydra.core.Name, hydra.util.PersistentSet<hydra.classes.TypeClass>>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>) (explicitClasses -> {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments> visit(hydra.core.Term.Let letTerm) {
        ...
        hydra.util.Lazy<hydra.util.ConsList<hydra.ext.haskell.syntax.Name>> hnames = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.Expression>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>) (hterms -> {
            ...
            hydra.util.Lazy<hydra.util.ConsList<hydra.ext.haskell.syntax.LocalBinding>> prevBindings = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
              () -> (hydra.util.ConsList<hydra.ext.haskell.syntax.LocalBinding>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.LocalBinding>empty()),
              (java.util.function.Function<hydra.ext.haskell.syntax.LocalBindings, hydra.util.ConsList<hydra.ext.haskell.syntax.LocalBinding>>) (lb -> (lb).value),
              bindings));
            hydra.util.Lazy<hydra.util.ConsList<hydra.ext.haskell.syntax.LocalBinding>> allBindings = new hydra.util.Lazy<>(() -> hydra.lib.lists.Concat2.apply(
              prevBindings.get(),
              hbindings.get()));
    ...
    java.util.function.Function<hydra.core.Name, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>> newtypeCons = (java.util.function.Function<hydra.core.Name, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>>) (tname -> (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>) (typ_ -> {
      ...
      return hydra.lib.eithers.Bind.apply(
        ...
        (java.util.function.Function<hydra.ext.haskell.syntax.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>) (htype -> {
          ...
          return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>right(new hydra.ext.haskell.syntax.ConstructorWithComments(new hydra.ext.haskell.syntax.Constructor.Record(new hydra.ext.haskell.syntax.RecordConstructor(constructorName, hydra.util.ConsList.of(hfield.get()))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing())));
        }));
    }));
    java.util.function.Function<String, java.util.function.Function<hydra.util.ConsList<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>> recordCons = (java.util.function.Function<String, java.util.function.Function<hydra.util.ConsList<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>>) (lname_ -> (java.util.function.Function<hydra.util.ConsList<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>) (fields -> {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.lib.logic.IfElse.lazy(
              hydra.lib.equality.Equal.apply(
                ...
                new hydra.core.Type.Unit()),
              () -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Type>>right((hydra.util.ConsList<hydra.ext.haskell.syntax.Type>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Type>empty())),
              () -> hydra.lib.eithers.Bind.apply(
                hydra.ext.haskell.Coder.adaptTypeToHaskellAndEncode(
                  ...
                  cx,
                  g),
                (java.util.function.Function<hydra.ext.haskell.syntax.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Type>>>) (htype -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.Type>>right(hydra.util.ConsList.of(htype))))),
            (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.Type>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>>) (typeList -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.ConstructorWithComments>right(new hydra.ext.haskell.syntax.ConstructorWithComments(new hydra.ext.haskell.syntax.Constructor.Ordinary(new hydra.ext.haskell.syntax.OrdinaryConstructor(hydra.ext.haskell.Utils.simpleName(nm), typeList)), comments))));
        }));
    })));
    return hydra.lib.eithers.Bind.apply(
      hydra.Schemas.isSerializableByName(
        ...
        g,
        elementName),
      (java.util.function.Function<Boolean, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>>) (isSer -> {
        hydra.util.Lazy<hydra.ext.haskell.syntax.Deriving> deriv = new hydra.util.Lazy<>(() -> new hydra.ext.haskell.syntax.Deriving(hydra.lib.logic.IfElse.lazy(
          ...
          () -> hydra.lib.lists.Map.apply(
            ...
            hydra.util.ConsList.of(
              ...
              "Read",
              "Show")),
          () -> (hydra.util.ConsList<hydra.ext.haskell.syntax.Name>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Name>empty()))));
          ...
          hydra.Rewriting.deannotateType(t_.get()).accept(new hydra.core.Type.PartialVisitor<>() {
            ...
            public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Declaration> visit(hydra.core.Type.Record rt) {
              return hydra.lib.eithers.Bind.apply(
                ...
                (java.util.function.Function<hydra.ext.haskell.syntax.ConstructorWithComments, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Declaration>>) (cons -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Declaration>right(new hydra.ext.haskell.syntax.Declaration.Data(new hydra.ext.haskell.syntax.DataDeclaration(new hydra.ext.haskell.syntax.DataOrNewtype.Data(), (hydra.util.ConsList<hydra.ext.haskell.syntax.Assertion>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Assertion>empty()), hd.get(), hydra.util.ConsList.of(cons), hydra.util.ConsList.of(deriv.get()))))));
            }
            ...
            public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Declaration> visit(hydra.core.Type.Wrap wrapped) {
              return hydra.lib.eithers.Bind.apply(
                ...
                (java.util.function.Function<hydra.ext.haskell.syntax.ConstructorWithComments, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Declaration>>) (cons -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.Declaration>right(new hydra.ext.haskell.syntax.Declaration.Data(new hydra.ext.haskell.syntax.DataDeclaration(new hydra.ext.haskell.syntax.DataOrNewtype.Newtype(), (hydra.util.ConsList<hydra.ext.haskell.syntax.Assertion>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Assertion>empty()), hd.get(), hydra.util.ConsList.of(cons), hydra.util.ConsList.of(deriv.get()))))));
            }
          }),
          (java.util.function.Function<hydra.ext.haskell.syntax.Declaration, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>>) (decl -> hydra.lib.eithers.Bind.apply(
            hydra.Annotations.getTypeDescription(
              cx,
              g,
              typ),
            (java.util.function.Function<hydra.util.Maybe<String>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>>) (comments -> hydra.lib.eithers.Bind.apply(
              hydra.lib.logic.IfElse.lazy(
                ...
                () -> hydra.lib.eithers.Bind.apply(
                  hydra.ext.haskell.Coder.typeDecl(
                    ...
                    cx,
                    g),
                  (java.util.function.Function<hydra.ext.haskell.syntax.DeclarationWithComments, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>>) (decl_ -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>right(hydra.util.ConsList.of(decl_)))),
                () -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>right((hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.DeclarationWithComments>empty()))),
              (java.util.function.Function<hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>>) (tdecls -> {
                ...
                hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments> nameDecls_ = hydra.ext.haskell.Coder.nameDecls(
                  namespaces,
                  elementName,
                  typ);
                return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.ext.haskell.syntax.DeclarationWithComments>>right(hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.ext.haskell.syntax.Expression, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.ext.haskell.syntax.DeclarationWithComments>>) (expr -> {
        ...
        hydra.util.Lazy<hydra.ext.haskell.syntax.Pattern> pat = new hydra.util.Lazy<>(() -> hydra.ext.haskell.Utils.applicationPattern(
          hname,
          (hydra.util.ConsList<hydra.ext.haskell.syntax.Pattern>) (hydra.util.ConsList.<hydra.ext.haskell.syntax.Pattern>empty())));
