...
public interface Utils {
  ...
  static hydra.ext.haskell.syntax.Name elementReference(hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Name name) {
    ...
    hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>> namespacesMap = new hydra.util.Lazy<>(() -> ((java.util.function.Function<hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>, java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>>) (projected -> projected.mapping)).apply(namespaces));
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>> namespacesForModule(hydra.module.Module mod, hydra.context.Context cx, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bind.apply(
      hydra.Analysis.moduleDependencyNamespaces(
        ...
        true,
        mod),
      (java.util.function.Function<java.util.Set<hydra.module.Namespace>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName>>>) (nss -> {
        ...
        hydra.util.Lazy<java.util.List<hydra.util.Pair<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>>> nssPairs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
          toPair,
          nssAsList.get()));
        hydra.util.Lazy<hydra.util.Pair<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>, java.util.Set<hydra.ext.haskell.syntax.ModuleName>>> finalState = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
        ...
        hydra.util.Lazy<java.util.Map<hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName>> resultMap = new hydra.util.Lazy<>(() -> hydra.lib.pairs.First.apply(finalState.get()));
  ...
  static hydra.ext.haskell.syntax.Name unionFieldReference(java.util.Set<hydra.core.Name> boundNames, hydra.module.Namespaces<hydra.ext.haskell.syntax.ModuleName> namespaces, hydra.core.Name sname, hydra.core.Name fname) {
    String fnameStr = (fname).value;
