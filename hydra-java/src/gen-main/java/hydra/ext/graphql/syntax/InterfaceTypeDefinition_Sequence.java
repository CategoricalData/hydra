...
public class InterfaceTypeDefinition_Sequence {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.InterfaceTypeDefinition.Sequence");
  ...
  public InterfaceTypeDefinition_Sequence (java.util.Optional<hydra.ext.graphql.syntax.Description> description, hydra.ext.graphql.syntax.Name name, java.util.Optional<hydra.ext.graphql.syntax.ImplementsInterfaces> implementsInterfaces, java.util.Optional<hydra.ext.graphql.syntax.Directives> directives, hydra.ext.graphql.syntax.FieldsDefinition fieldsDefinition) {
  ...
  public InterfaceTypeDefinition_Sequence withDescription(java.util.Optional<hydra.ext.graphql.syntax.Description> description) {
  ...
  public InterfaceTypeDefinition_Sequence withImplementsInterfaces(java.util.Optional<hydra.ext.graphql.syntax.ImplementsInterfaces> implementsInterfaces) {
    return new InterfaceTypeDefinition_Sequence(description, name, implementsInterfaces, directives, fieldsDefinition);
  }
  
  public InterfaceTypeDefinition_Sequence withDirectives(java.util.Optional<hydra.ext.graphql.syntax.Directives> directives) {
    return new InterfaceTypeDefinition_Sequence(description, name, implementsInterfaces, directives, fieldsDefinition);
  }
