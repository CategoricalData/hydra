...
public abstract class ExecutableDirectiveLocation {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.ExecutableDirectiveLocation");
  ...
  public static final class QUERY extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
    public QUERY () {
  ...
  public static final class MUTATION extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
    public MUTATION () {
  ...
  public static final class SUBSCRIPTION extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
    public SUBSCRIPTION () {
  ...
  public static final class FIELD extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
    public FIELD () {
  ...
  public static final class FRAGMENTLowbarDEFINITION extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
  ...
  public static final class FRAGMENTLowbarSPREAD extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
  ...
  public static final class INLINELowbarFRAGMENT extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
  ...
  public static final class VARIABLELowbarDEFINITION extends hydra.ext.graphql.syntax.ExecutableDirectiveLocation {
