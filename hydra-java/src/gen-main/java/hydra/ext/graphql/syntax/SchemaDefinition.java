...
public class SchemaDefinition {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.SchemaDefinition");
  ...
  public SchemaDefinition (java.util.Optional<hydra.ext.graphql.syntax.Description> description, java.util.Optional<hydra.ext.graphql.syntax.Directives> directives, hydra.ext.graphql.syntax.RootOperationTypeDefinition rootOperationTypeDefinition) {
  ...
  public SchemaDefinition withDescription(java.util.Optional<hydra.ext.graphql.syntax.Description> description) {
    return new SchemaDefinition(description, directives, rootOperationTypeDefinition);
  }
  
  public SchemaDefinition withDirectives(java.util.Optional<hydra.ext.graphql.syntax.Directives> directives) {
    return new SchemaDefinition(description, directives, rootOperationTypeDefinition);
  }
