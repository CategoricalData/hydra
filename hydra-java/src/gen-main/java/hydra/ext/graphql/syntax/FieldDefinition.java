...
public class FieldDefinition {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.FieldDefinition");
  ...
  public FieldDefinition (java.util.Optional<hydra.ext.graphql.syntax.Description> description, hydra.ext.graphql.syntax.Name name, java.util.Optional<hydra.ext.graphql.syntax.ArgumentsDefinition> argumentsDefinition, hydra.ext.graphql.syntax.Type type, java.util.Optional<hydra.ext.graphql.syntax.Directives> directives) {
  ...
  public FieldDefinition withDescription(java.util.Optional<hydra.ext.graphql.syntax.Description> description) {
  ...
  public FieldDefinition withArgumentsDefinition(java.util.Optional<hydra.ext.graphql.syntax.ArgumentsDefinition> argumentsDefinition) {
    return new FieldDefinition(description, name, argumentsDefinition, type, directives);
  }
  ...
  public FieldDefinition withDirectives(java.util.Optional<hydra.ext.graphql.syntax.Directives> directives) {
    return new FieldDefinition(description, name, argumentsDefinition, type, directives);
  }
}