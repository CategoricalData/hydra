...
public class DirectiveDefinition {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.DirectiveDefinition");
  ...
  public final java.util.Optional<hydra.ext.graphql.syntax.ArgumentsDefinition> argumentsDefinition;
  ...
  public DirectiveDefinition (java.util.Optional<hydra.ext.graphql.syntax.Description> description, hydra.ext.graphql.syntax.Name name, java.util.Optional<hydra.ext.graphql.syntax.ArgumentsDefinition> argumentsDefinition, java.util.Optional<java.lang.Void> repeatable, hydra.ext.graphql.syntax.DirectiveLocations directiveLocations) {
  ...
  public DirectiveDefinition withDescription(java.util.Optional<hydra.ext.graphql.syntax.Description> description) {
  ...
  public DirectiveDefinition withArgumentsDefinition(java.util.Optional<hydra.ext.graphql.syntax.ArgumentsDefinition> argumentsDefinition) {
    return new DirectiveDefinition(description, name, argumentsDefinition, repeatable, directiveLocations);
  }
