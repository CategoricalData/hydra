...
public abstract class TypeSystemDirectiveLocation {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.TypeSystemDirectiveLocation");
  ...
  public static final class SCHEMA extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
    public SCHEMA () {
  ...
  public static final class SCALAR extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
    public SCALAR () {
  ...
  public static final class OBJECT extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
    public OBJECT () {
  ...
  public static final class FIELDLowbarDEFINITION extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
  ...
  public static final class ARGUMENTLowbarDEFINITION extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
  ...
  public static final class INTERFACE extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
    public INTERFACE () {
  ...
  public static final class UNION extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
    public UNION () {
  ...
  public static final class ENUM extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
    public ENUM () {
  ...
  public static final class ENUMLowbarVALUE extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
  ...
  public static final class INPUTLowbarOBJECT extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
  ...
  public static final class INPUTLowbarFIELDLowbarDEFINITION extends hydra.ext.graphql.syntax.TypeSystemDirectiveLocation {
