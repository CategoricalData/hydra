...
public abstract class DirectiveLocation {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.DirectiveLocation");
  ...
  public static final class Executable extends hydra.ext.graphql.syntax.DirectiveLocation {
  ...
  public static final class TypeSystem extends hydra.ext.graphql.syntax.DirectiveLocation {
