...
public abstract class ObjectValue implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/graphql/syntax.ObjectValue");
  ...
  public static final class Sequence extends hydra.ext.graphql.syntax.ObjectValue implements Serializable {
    public final hydra.ext.graphql.syntax.ObjectValue_Sequence value;
    
    public Sequence (hydra.ext.graphql.syntax.ObjectValue_Sequence value) {
  ...
  public static final class Sequence2 extends hydra.ext.graphql.syntax.ObjectValue implements Serializable {
