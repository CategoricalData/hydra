...
public abstract class TypeCondition {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/graphql/syntax.TypeCondition");
  ...
  public static final class On extends hydra.ext.graphql.syntax.TypeCondition {
    public On () {
  ...
  public static final class NamedType extends hydra.ext.graphql.syntax.TypeCondition {
