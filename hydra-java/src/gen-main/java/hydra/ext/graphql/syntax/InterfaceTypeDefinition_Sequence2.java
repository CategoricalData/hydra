...
public class InterfaceTypeDefinition_Sequence2 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/graphql/syntax.InterfaceTypeDefinition.Sequence2");
  ...
  public InterfaceTypeDefinition_Sequence2 (hydra.util.Opt<hydra.ext.graphql.syntax.Description> description, hydra.ext.graphql.syntax.Name name, hydra.ext.graphql.syntax.ImplementsInterfaces implementsInterfaces, hydra.util.Opt<hydra.ext.graphql.syntax.Directives> directives) {
  ...
  public InterfaceTypeDefinition_Sequence2 withDescription(hydra.util.Opt<hydra.ext.graphql.syntax.Description> description) {
    java.util.Objects.requireNonNull((description));
  ...
  public InterfaceTypeDefinition_Sequence2 withDirectives(hydra.util.Opt<hydra.ext.graphql.syntax.Directives> directives) {
    java.util.Objects.requireNonNull((directives));
    return new InterfaceTypeDefinition_Sequence2(description, name, implementsInterfaces, directives);
  }
}
