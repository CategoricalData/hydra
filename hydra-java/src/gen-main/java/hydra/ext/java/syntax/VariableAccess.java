...
public abstract class VariableAccess implements Serializable, Comparable<VariableAccess> {
  ...
  public static final class ExpressionName extends hydra.ext.java.syntax.VariableAccess implements Serializable {
  ...
  public static final class FieldAccess extends hydra.ext.java.syntax.VariableAccess implements Serializable {
