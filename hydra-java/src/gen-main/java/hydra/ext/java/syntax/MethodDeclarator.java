...
public class MethodDeclarator implements Serializable {
  ...
  public MethodDeclarator (hydra.ext.java.syntax.Identifier identifier, hydra.util.Opt<hydra.ext.java.syntax.ReceiverParameter> receiverParameter, java.util.List<hydra.ext.java.syntax.FormalParameter> formalParameters) {
  ...
  public MethodDeclarator withReceiverParameter(hydra.util.Opt<hydra.ext.java.syntax.ReceiverParameter> receiverParameter) {
    java.util.Objects.requireNonNull((receiverParameter));
    return new MethodDeclarator(identifier, receiverParameter, formalParameters);
  }
