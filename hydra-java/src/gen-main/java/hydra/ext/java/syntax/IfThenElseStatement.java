...
public class IfThenElseStatement implements Serializable {
  ...
  public IfThenElseStatement (hydra.util.Opt<hydra.ext.java.syntax.Expression> cond, hydra.ext.java.syntax.StatementNoShortIf then, hydra.ext.java.syntax.Statement else_) {
  ...
  public IfThenElseStatement withCond(hydra.util.Opt<hydra.ext.java.syntax.Expression> cond) {
    java.util.Objects.requireNonNull((cond));
