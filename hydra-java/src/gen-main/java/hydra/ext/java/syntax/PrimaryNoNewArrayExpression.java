...
public abstract class PrimaryNoNewArrayExpression implements Serializable, Comparable<PrimaryNoNewArrayExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.java.syntax.PrimaryNoNewArrayExpression");
  ...
  public static final class Literal extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class ClassLiteral extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class This extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
    public This () {
  ...
  public static final class DotThis extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class Parens extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class ClassInstance extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class FieldAccess extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class ArrayAccess extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class MethodInvocation extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
  ...
  public static final class MethodReference extends hydra.ext.java.syntax.PrimaryNoNewArrayExpression implements Serializable {
