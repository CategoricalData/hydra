...
public abstract class LocalVariableType implements Serializable, Comparable<LocalVariableType> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.java.syntax.LocalVariableType");
  ...
  public static final class Type extends hydra.ext.java.syntax.LocalVariableType implements Serializable {
  ...
  public static final class Var extends hydra.ext.java.syntax.LocalVariableType implements Serializable {
    public Var () {
