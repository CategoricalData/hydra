...
public class DimExpr implements Serializable {
  ...
  public DimExpr (java.util.List<hydra.ext.java.syntax.Annotation> annotations, hydra.util.Opt<hydra.ext.java.syntax.Expression> expression) {
  ...
  public DimExpr withExpression(hydra.util.Opt<hydra.ext.java.syntax.Expression> expression) {
    java.util.Objects.requireNonNull((expression));
    return new DimExpr(annotations, expression);
  }
}