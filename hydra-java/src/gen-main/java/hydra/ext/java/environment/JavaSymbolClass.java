...
public abstract class JavaSymbolClass implements Serializable, Comparable<JavaSymbolClass> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.java.environment.JavaSymbolClass");
   ...
   * A constant value
   */
  public static final class Constant extends hydra.ext.java.environment.JavaSymbolClass implements Serializable {
    public Constant () {
   ...
   */
  public static final class NullaryFunction extends hydra.ext.java.environment.JavaSymbolClass implements Serializable {
   ...
   */
  public static final class HoistedLambda extends hydra.ext.java.environment.JavaSymbolClass implements Serializable {
   ...
   */
  public static final class UnaryFunction extends hydra.ext.java.environment.JavaSymbolClass implements Serializable {
   ...
   * A local variable
   */
  public static final class LocalVariable extends hydra.ext.java.environment.JavaSymbolClass implements Serializable {
