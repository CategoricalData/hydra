...
public interface TestCodec {
  ...
  static hydra.testing.TestCodec javaTestCodec() {
    return new hydra.testing.TestCodec(new hydra.coders.LanguageName("java"), new hydra.module.FileExtension("java"), (java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>>) (p0 -> p1 -> hydra.ext.java.TestCodec.termToJava(
      p0,
      p1)), p0 -> p1 -> hydra.ext.java.TestCodec.<hydra.core.Type, hydra.graph.Graph, String>typeToJava(
      p0,
      p1), hydra.ext.java.TestCodec::formatJavaTestName, hydra.ext.java.TestCodec::namespaceToJavaClassName, hydra.ext.java.TestCodec.javaTestCaseTemplate(), hydra.ext.java.TestCodec.javaTestGroupTemplate(), hydra.ext.java.TestCodec.javaModuleTemplate(), hydra.ext.java.TestCodec.javaImportTemplate(), (java.util.function.Function<hydra.util.PersistentSet<hydra.core.Name>, hydra.util.ConsList<String>>) (_names -> hydra.ext.java.TestCodec.findJavaImports()));
  }
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.Map.apply(
        ...
        hydra.lib.eithers.MapList.apply(
          (java.util.function.Function<hydra.testing.TestCaseWithMetadata, hydra.util.Either<String, hydra.util.ConsList<String>>>) (tc -> hydra.ext.java.TestCodec.generateJavaTestCase(
            g,
            codec,
            groupPath,
            tc)),
            ...
            (java.util.function.Function<hydra.testing.TestGroup, hydra.util.Either<String, String>>) (subgroup -> {
              ...
              return hydra.lib.eithers.Map.apply(
                (java.util.function.Function<String, String>) (content -> hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
                  ...
                  "\n\n",
                  content))),
                hydra.ext.java.TestCodec.generateJavaTestGroupHierarchy(
                  g,
                  codec,
  ...
  static hydra.util.Either<String, hydra.util.ConsList<String>> generateJavaTestCase(hydra.graph.Graph g, hydra.testing.TestCodec codec, hydra.util.ConsList<String> groupPath, hydra.testing.TestCaseWithMetadata tcm) {
    ...
    return (tcase).accept(new hydra.testing.TestCase.PartialVisitor<>() {
      ...
      public hydra.util.Either<String, hydra.util.ConsList<String>> visit(hydra.testing.TestCase.DelegatedEvaluation delCase) {
        ...
        String assertType = hydra.ext.java.TestCodec.getAssertionType(output_);
        ...
        hydra.util.Lazy<hydra.util.ConsList<hydra.core.Name>> typeVars = new hydra.util.Lazy<>(() -> hydra.lib.lists.Sort.apply(hydra.lib.lists.Filter.apply(
          hydra.ext.java.TestCodec::isInferenceVar,
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<String, hydra.util.Either<String, hydra.util.ConsList<String>>>) (inputCode -> hydra.lib.eithers.Map.apply(
            (java.util.function.Function<String, hydra.util.ConsList<String>>) (outputCode -> {
              hydra.util.ConsList<String> assertionLines = hydra.ext.java.TestCodec.generateAssertion(
                assertType,
                outputCode,
                inputCode);
    ...
    return hydra.lib.eithers.Map.apply(
      (java.util.function.Function<String, hydra.util.Pair<String, String>>) (testBody -> {
        ...
        String filePath = hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
          ...
          "/",
          fileName));
        hydra.util.Lazy<String> testModuleContent = new hydra.util.Lazy<>(() -> hydra.ext.java.TestCodec.buildJavaTestModule(
          codec,
          testModule,
          testGroup,
          testBody));
  ...
  static hydra.util.Either<String, hydra.util.Pair<String, String>> generateJavaTestFile(hydra.module.Module testModule, hydra.testing.TestGroup testGroup, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bind.apply(
      hydra.test.Utils.inferTestGroupTerms(
        g,
        testGroup),
      (java.util.function.Function<hydra.testing.TestGroup, hydra.util.Either<String, hydra.util.Pair<String, String>>>) (inferredTestGroup -> hydra.ext.java.TestCodec.generateTestFileWithJavaCodec(
        hydra.ext.java.TestCodec.javaTestCodec(),
        testModule,
        inferredTestGroup,
        g)));
  }
