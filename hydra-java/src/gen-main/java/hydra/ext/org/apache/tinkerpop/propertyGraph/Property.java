...
public class Property<V> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/propertyGraph.Property");
  ...
  public Property (hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyKey key, V value) {
  ...
  public Property withKey(hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyKey key) {
    java.util.Objects.requireNonNull((key));
