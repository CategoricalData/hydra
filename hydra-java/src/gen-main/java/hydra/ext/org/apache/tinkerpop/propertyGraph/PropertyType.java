...
public class PropertyType<T> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/propertyGraph.PropertyType");
  ...
  public PropertyType (hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyKey key, T value, Boolean required) {
  ...
  public PropertyType withKey(hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyKey key) {
    java.util.Objects.requireNonNull((key));
