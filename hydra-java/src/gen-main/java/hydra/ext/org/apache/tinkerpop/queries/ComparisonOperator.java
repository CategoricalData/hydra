...
public abstract class ComparisonOperator implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/queries.ComparisonOperator");
  ...
  public static final class Eq extends hydra.ext.org.apache.tinkerpop.queries.ComparisonOperator implements Serializable {
    public Eq () {
  ...
  public static final class Neq extends hydra.ext.org.apache.tinkerpop.queries.ComparisonOperator implements Serializable {
    public Neq () {
  ...
  public static final class Lt extends hydra.ext.org.apache.tinkerpop.queries.ComparisonOperator implements Serializable {
    public Lt () {
  ...
  public static final class Lte extends hydra.ext.org.apache.tinkerpop.queries.ComparisonOperator implements Serializable {
    public Lte () {
  ...
  public static final class Gt extends hydra.ext.org.apache.tinkerpop.queries.ComparisonOperator implements Serializable {
    public Gt () {
  ...
  public static final class Gte extends hydra.ext.org.apache.tinkerpop.queries.ComparisonOperator implements Serializable {
    public Gte () {
