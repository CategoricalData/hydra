...
public class PropertySpec implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/mappings.PropertySpec");
   ...
   */
  public final hydra.ext.org.apache.tinkerpop.mappings.ValueSpec value;
  
  public PropertySpec (hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyKey key, hydra.ext.org.apache.tinkerpop.mappings.ValueSpec value) {
  ...
  public PropertySpec withKey(hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyKey key) {
    java.util.Objects.requireNonNull((key));
    return new PropertySpec(key, value);
  }
  
  public PropertySpec withValue(hydra.ext.org.apache.tinkerpop.mappings.ValueSpec value) {
    java.util.Objects.requireNonNull((value));
    return new PropertySpec(key, value);
  }
}