...
public abstract class UnaryOperator implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/queries.UnaryOperator");
  ...
  public static final class Negate extends hydra.ext.org.apache.tinkerpop.queries.UnaryOperator implements Serializable {
    public Negate () {
