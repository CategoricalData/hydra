...
public abstract class ElementKind implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/propertyGraph.ElementKind");
  ...
  public static final class Vertex extends hydra.ext.org.apache.tinkerpop.propertyGraph.ElementKind implements Serializable {
    public Vertex () {
  ...
  public static final class Edge extends hydra.ext.org.apache.tinkerpop.propertyGraph.ElementKind implements Serializable {
    public Edge () {
