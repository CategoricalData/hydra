...
public class ReplaceArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/gremlin.ReplaceArgs");
  ...
  public ReplaceArgs (hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument from, hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument to) {
  ...
  public ReplaceArgs withScope(hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    java.util.Objects.requireNonNull((scope));
