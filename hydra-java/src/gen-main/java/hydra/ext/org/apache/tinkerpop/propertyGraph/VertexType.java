...
public class VertexType<T> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/propertyGraph.VertexType");
  ...
  public VertexType (hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel label, T id, java.util.List<hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyType<T>> properties) {
  ...
  public VertexType withLabel(hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel label) {
    java.util.Objects.requireNonNull((label));
  ...
  public VertexType withProperties(java.util.List<hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyType<T>> properties) {
    java.util.Objects.requireNonNull((properties));
    return new VertexType(label, id, properties);
  }
}