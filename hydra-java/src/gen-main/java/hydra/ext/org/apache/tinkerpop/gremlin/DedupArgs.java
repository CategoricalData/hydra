...
public abstract class DedupArgs implements Serializable, Comparable<DedupArgs> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.org.apache.tinkerpop.gremlin.DedupArgs");
  ...
  public static final class ScopeString extends hydra.ext.org.apache.tinkerpop.gremlin.DedupArgs implements Serializable {
    public final hydra.ext.org.apache.tinkerpop.gremlin.ScopeStringArgument value;

    public ScopeString (hydra.ext.org.apache.tinkerpop.gremlin.ScopeStringArgument value) {
      this.value = value;
    }
  ...
  public static final class String_ extends hydra.ext.org.apache.tinkerpop.gremlin.DedupArgs implements Serializable {
