...
public class SelectQuery implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/queries.SelectQuery");
  ...
  public final hydra.ext.org.apache.tinkerpop.queries.Projections projection;
  
  public SelectQuery (Boolean distinct, hydra.ext.org.apache.tinkerpop.queries.Projections projection) {
  ...
  public SelectQuery withProjection(hydra.ext.org.apache.tinkerpop.queries.Projections projection) {
    java.util.Objects.requireNonNull((projection));
    return new SelectQuery(distinct, projection);
  }
}