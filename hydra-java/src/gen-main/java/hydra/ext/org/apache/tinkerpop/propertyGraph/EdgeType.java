...
public class EdgeType<T> implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/propertyGraph.EdgeType");
   ...
   */
  public final hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel out;
  
  /**
   * The label of the in-vertex (head) of any edge of this edge type
   */
  public final hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel in;
  
  /**
   * A list of property types. The types are ordered for the sake of applications in which property order is significant.
   */
  public final java.util.List<hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyType<T>> properties;
  
  public EdgeType (hydra.ext.org.apache.tinkerpop.propertyGraph.EdgeLabel label, T id, hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel out, hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel in, java.util.List<hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyType<T>> properties) {
  ...
  public EdgeType withLabel(hydra.ext.org.apache.tinkerpop.propertyGraph.EdgeLabel label) {
    java.util.Objects.requireNonNull((label));
  ...
  public EdgeType withOut(hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel out) {
    java.util.Objects.requireNonNull((out));
    return new EdgeType(label, id, out, in, properties);
  }
  
  public EdgeType withIn(hydra.ext.org.apache.tinkerpop.propertyGraph.VertexLabel in) {
    java.util.Objects.requireNonNull((in));
    return new EdgeType(label, id, out, in, properties);
  }
  
  public EdgeType withProperties(java.util.List<hydra.ext.org.apache.tinkerpop.propertyGraph.PropertyType<T>> properties) {
    java.util.Objects.requireNonNull((properties));
    return new EdgeType(label, id, out, in, properties);
  }
}