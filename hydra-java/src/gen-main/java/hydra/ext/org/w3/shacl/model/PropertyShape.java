...
public class PropertyShape implements Serializable {
   ...
   */
  public final hydra.util.Opt<hydra.ext.org.w3.rdf.syntax.Node> defaultValue;
  ...
  public PropertyShape (hydra.ext.org.w3.shacl.model.CommonProperties common, java.util.Set<hydra.ext.org.w3.shacl.model.PropertyShapeConstraint> constraints, hydra.util.Opt<hydra.ext.org.w3.rdf.syntax.Node> defaultValue, hydra.ext.org.w3.rdf.syntax.LangStrings description, hydra.ext.org.w3.rdf.syntax.LangStrings name, hydra.util.Opt<java.math.BigInteger> order, hydra.ext.org.w3.rdf.syntax.Iri path) {
  ...
  public PropertyShape withDefaultValue(hydra.util.Opt<hydra.ext.org.w3.rdf.syntax.Node> defaultValue) {
    java.util.Objects.requireNonNull((defaultValue));
    return new PropertyShape(common, constraints, defaultValue, description, name, order, path);
  }
