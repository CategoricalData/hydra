...
public class PositiveInteger implements Serializable, Comparable<PositiveInteger> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.org.w3.xml.schema.PositiveInteger");
