...
public class SchemaExtension_Sequence implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.graphql.syntax.SchemaExtension_Sequence");
  ...
  public SchemaExtension_Sequence (hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives, hydra.ext.org.graphql.syntax.RootOperationTypeDefinition rootOperationTypeDefinition) {
  ...
  public SchemaExtension_Sequence withDirectives(hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives) {
    java.util.Objects.requireNonNull((directives));
    return new SchemaExtension_Sequence(directives, rootOperationTypeDefinition);
  }
  
  public SchemaExtension_Sequence withRootOperationTypeDefinition(hydra.ext.org.graphql.syntax.RootOperationTypeDefinition rootOperationTypeDefinition) {
    java.util.Objects.requireNonNull((rootOperationTypeDefinition));
    return new SchemaExtension_Sequence(directives, rootOperationTypeDefinition);
  }
}