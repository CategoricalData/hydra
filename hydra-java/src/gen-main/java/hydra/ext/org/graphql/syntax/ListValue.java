...
public abstract class ListValue implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/graphql/syntax.ListValue");
  ...
  public static final class Sequence extends hydra.ext.graphql.syntax.ListValue implements Serializable {
    public final hydra.ext.graphql.syntax.ListValue_Sequence value;
    
    public Sequence (hydra.ext.graphql.syntax.ListValue_Sequence value) {
  ...
  public static final class Sequence2 extends hydra.ext.graphql.syntax.ListValue implements Serializable {
