...
public class FragmentDefinition implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.graphql.syntax.FragmentDefinition");
  ...
  public final hydra.ext.org.graphql.syntax.TypeCondition typeCondition;
  ...
  public FragmentDefinition (hydra.ext.org.graphql.syntax.FragmentName fragmentName, hydra.ext.org.graphql.syntax.TypeCondition typeCondition, hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives, hydra.ext.org.graphql.syntax.SelectionSet selectionSet) {
  ...
  public FragmentDefinition withFragmentName(hydra.ext.org.graphql.syntax.FragmentName fragmentName) {
    java.util.Objects.requireNonNull((fragmentName));
    return new FragmentDefinition(fragmentName, typeCondition, directives, selectionSet);
  }
  
  public FragmentDefinition withTypeCondition(hydra.ext.org.graphql.syntax.TypeCondition typeCondition) {
    java.util.Objects.requireNonNull((typeCondition));
    return new FragmentDefinition(fragmentName, typeCondition, directives, selectionSet);
  }
  
  public FragmentDefinition withDirectives(hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives) {
    java.util.Objects.requireNonNull((directives));
    return new FragmentDefinition(fragmentName, typeCondition, directives, selectionSet);
  }
  
  public FragmentDefinition withSelectionSet(hydra.ext.org.graphql.syntax.SelectionSet selectionSet) {
    java.util.Objects.requireNonNull((selectionSet));
    return new FragmentDefinition(fragmentName, typeCondition, directives, selectionSet);
  }
}