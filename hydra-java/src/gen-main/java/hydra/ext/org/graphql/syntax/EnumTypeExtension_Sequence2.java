...
public class EnumTypeExtension_Sequence2 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence2");
  ...
  public EnumTypeExtension_Sequence2 (hydra.ext.org.graphql.syntax.Name name, hydra.ext.org.graphql.syntax.Directives directives) {
  ...
  public EnumTypeExtension_Sequence2 withName(hydra.ext.org.graphql.syntax.Name name) {
    java.util.Objects.requireNonNull((name));
    return new EnumTypeExtension_Sequence2(name, directives);
  }
  
  public EnumTypeExtension_Sequence2 withDirectives(hydra.ext.org.graphql.syntax.Directives directives) {
    java.util.Objects.requireNonNull((directives));
    return new EnumTypeExtension_Sequence2(name, directives);
  }
}