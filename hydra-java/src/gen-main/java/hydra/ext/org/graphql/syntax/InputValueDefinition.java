...
public class InputValueDefinition implements Serializable {
  ...
  public InputValueDefinition (hydra.util.Opt<hydra.ext.graphql.syntax.Description> description, hydra.ext.graphql.syntax.Name name, hydra.ext.graphql.syntax.Type type, hydra.util.Opt<hydra.ext.graphql.syntax.DefaultValue> defaultValue, hydra.util.Opt<hydra.ext.graphql.syntax.Directives> directives) {
  ...
  public InputValueDefinition withDescription(hydra.util.Opt<hydra.ext.graphql.syntax.Description> description) {
    java.util.Objects.requireNonNull((description));
  ...
  public InputValueDefinition withDefaultValue(hydra.util.Opt<hydra.ext.graphql.syntax.DefaultValue> defaultValue) {
    java.util.Objects.requireNonNull((defaultValue));
    return new InputValueDefinition(description, name, type, defaultValue, directives);
  }
  
  public InputValueDefinition withDirectives(hydra.util.Opt<hydra.ext.graphql.syntax.Directives> directives) {
    java.util.Objects.requireNonNull((directives));
    return new InputValueDefinition(description, name, type, defaultValue, directives);
  }
}
