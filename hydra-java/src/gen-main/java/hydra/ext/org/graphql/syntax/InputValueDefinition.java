...
public class InputValueDefinition implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.graphql.syntax.InputValueDefinition");
  ...
  public InputValueDefinition (hydra.util.Opt<hydra.ext.org.graphql.syntax.Description> description, hydra.ext.org.graphql.syntax.Name name, hydra.ext.org.graphql.syntax.Type type, hydra.util.Opt<hydra.ext.org.graphql.syntax.DefaultValue> defaultValue, hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives) {
  ...
  public InputValueDefinition withDescription(hydra.util.Opt<hydra.ext.org.graphql.syntax.Description> description) {
    java.util.Objects.requireNonNull((description));
    return new InputValueDefinition(description, name, type, defaultValue, directives);
  }
  
  public InputValueDefinition withName(hydra.ext.org.graphql.syntax.Name name) {
    java.util.Objects.requireNonNull((name));
    return new InputValueDefinition(description, name, type, defaultValue, directives);
  }
  
  public InputValueDefinition withType(hydra.ext.org.graphql.syntax.Type type) {
    java.util.Objects.requireNonNull((type));
    return new InputValueDefinition(description, name, type, defaultValue, directives);
  }
  
  public InputValueDefinition withDefaultValue(hydra.util.Opt<hydra.ext.org.graphql.syntax.DefaultValue> defaultValue) {
    java.util.Objects.requireNonNull((defaultValue));
    return new InputValueDefinition(description, name, type, defaultValue, directives);
  }
  
  public InputValueDefinition withDirectives(hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives) {
    java.util.Objects.requireNonNull((directives));
    return new InputValueDefinition(description, name, type, defaultValue, directives);
  }
}