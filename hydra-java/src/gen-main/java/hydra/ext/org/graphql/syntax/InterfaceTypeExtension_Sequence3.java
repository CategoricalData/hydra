...
public class InterfaceTypeExtension_Sequence3 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence3");
  ...
  public InterfaceTypeExtension_Sequence3 (hydra.ext.org.graphql.syntax.Name name, hydra.ext.org.graphql.syntax.ImplementsInterfaces implementsInterfaces) {
  ...
  public InterfaceTypeExtension_Sequence3 withName(hydra.ext.org.graphql.syntax.Name name) {
    java.util.Objects.requireNonNull((name));
    return new InterfaceTypeExtension_Sequence3(name, implementsInterfaces);
  }
  
  public InterfaceTypeExtension_Sequence3 withImplementsInterfaces(hydra.ext.org.graphql.syntax.ImplementsInterfaces implementsInterfaces) {
    java.util.Objects.requireNonNull((implementsInterfaces));
    return new InterfaceTypeExtension_Sequence3(name, implementsInterfaces);
  }
}