...
public class ObjectTypeDefinition implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.graphql.syntax.ObjectTypeDefinition");
  ...
  public final hydra.util.Opt<hydra.ext.org.graphql.syntax.FieldsDefinition> fieldsDefinition;
  
  public ObjectTypeDefinition (hydra.util.Opt<hydra.ext.org.graphql.syntax.Description> description, hydra.ext.org.graphql.syntax.Name name, hydra.util.Opt<hydra.ext.org.graphql.syntax.ImplementsInterfaces> implementsInterfaces, hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives, hydra.util.Opt<hydra.ext.org.graphql.syntax.FieldsDefinition> fieldsDefinition) {
  ...
  public ObjectTypeDefinition withDescription(hydra.util.Opt<hydra.ext.org.graphql.syntax.Description> description) {
    java.util.Objects.requireNonNull((description));
    return new ObjectTypeDefinition(description, name, implementsInterfaces, directives, fieldsDefinition);
  }
  
  public ObjectTypeDefinition withName(hydra.ext.org.graphql.syntax.Name name) {
    java.util.Objects.requireNonNull((name));
    return new ObjectTypeDefinition(description, name, implementsInterfaces, directives, fieldsDefinition);
  }
  
  public ObjectTypeDefinition withImplementsInterfaces(hydra.util.Opt<hydra.ext.org.graphql.syntax.ImplementsInterfaces> implementsInterfaces) {
    java.util.Objects.requireNonNull((implementsInterfaces));
    return new ObjectTypeDefinition(description, name, implementsInterfaces, directives, fieldsDefinition);
  }
  
  public ObjectTypeDefinition withDirectives(hydra.util.Opt<hydra.ext.org.graphql.syntax.Directives> directives) {
    java.util.Objects.requireNonNull((directives));
    return new ObjectTypeDefinition(description, name, implementsInterfaces, directives, fieldsDefinition);
  }
  
  public ObjectTypeDefinition withFieldsDefinition(hydra.util.Opt<hydra.ext.org.graphql.syntax.FieldsDefinition> fieldsDefinition) {
    java.util.Objects.requireNonNull((fieldsDefinition));
    return new ObjectTypeDefinition(description, name, implementsInterfaces, directives, fieldsDefinition);
  }
}