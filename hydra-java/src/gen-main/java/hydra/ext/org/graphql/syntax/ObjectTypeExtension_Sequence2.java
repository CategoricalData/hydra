...
public class ObjectTypeExtension_Sequence2 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/graphql/syntax.ObjectTypeExtension.Sequence2");
  ...
  public ObjectTypeExtension_Sequence2 (hydra.ext.graphql.syntax.Name name, hydra.util.Opt<hydra.ext.graphql.syntax.ImplementsInterfaces> implementsInterfaces, hydra.util.Opt<hydra.ext.graphql.syntax.Directives> directives) {
  ...
  public ObjectTypeExtension_Sequence2 withImplementsInterfaces(hydra.util.Opt<hydra.ext.graphql.syntax.ImplementsInterfaces> implementsInterfaces) {
    java.util.Objects.requireNonNull((implementsInterfaces));
    return new ObjectTypeExtension_Sequence2(name, implementsInterfaces, directives);
  }
  
  public ObjectTypeExtension_Sequence2 withDirectives(hydra.util.Opt<hydra.ext.graphql.syntax.Directives> directives) {
    java.util.Objects.requireNonNull((directives));
    return new ObjectTypeExtension_Sequence2(name, implementsInterfaces, directives);
  }
}
