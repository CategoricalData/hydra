...
public class ObjectMinCardinality implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.ObjectMinCardinality");
  ...
  public ObjectMinCardinality (java.math.BigInteger bound, hydra.ext.owl.syntax.ObjectPropertyExpression property, java.util.List<hydra.ext.owl.syntax.ClassExpression> class_) {
  ...
  public ObjectMinCardinality withProperty(hydra.ext.owl.syntax.ObjectPropertyExpression property) {
    java.util.Objects.requireNonNull((property));
    return new ObjectMinCardinality(bound, property, class_);
  }
  
  public ObjectMinCardinality withClass(java.util.List<hydra.ext.owl.syntax.ClassExpression> class_) {
    java.util.Objects.requireNonNull((class_));
    return new ObjectMinCardinality(bound, property, class_);
  }
}
