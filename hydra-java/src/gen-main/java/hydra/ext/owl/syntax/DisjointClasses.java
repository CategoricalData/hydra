...
public class DisjointClasses implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.DisjointClasses");
  ...
  public DisjointClasses (java.util.List<hydra.ext.owl.syntax.Annotation> annotations, java.util.List<hydra.ext.owl.syntax.ClassExpression> classes) {
  ...
  public DisjointClasses withAnnotations(java.util.List<hydra.ext.owl.syntax.Annotation> annotations) {
    java.util.Objects.requireNonNull((annotations));
    return new DisjointClasses(annotations, classes);
  }
  
  public DisjointClasses withClasses(java.util.List<hydra.ext.owl.syntax.ClassExpression> classes) {
    java.util.Objects.requireNonNull((classes));
    return new DisjointClasses(annotations, classes);
  }
}
