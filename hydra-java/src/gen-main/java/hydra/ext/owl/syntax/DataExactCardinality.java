...
public class DataExactCardinality implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.DataExactCardinality");
  ...
  public DataExactCardinality (java.math.BigInteger bound, hydra.ext.owl.syntax.DataPropertyExpression property, java.util.List<hydra.ext.owl.syntax.DataRange> range) {
  ...
  public DataExactCardinality withProperty(hydra.ext.owl.syntax.DataPropertyExpression property) {
    java.util.Objects.requireNonNull((property));
    return new DataExactCardinality(bound, property, range);
  }
  
  public DataExactCardinality withRange(java.util.List<hydra.ext.owl.syntax.DataRange> range) {
    java.util.Objects.requireNonNull((range));
    return new DataExactCardinality(bound, property, range);
  }
}
