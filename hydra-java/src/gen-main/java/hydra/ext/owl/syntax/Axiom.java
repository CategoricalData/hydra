...
public abstract class Axiom implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.Axiom");
  ...
  public static final class AnnotationAxiom extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.AnnotationAxiom value;
    
    public AnnotationAxiom (hydra.ext.owl.syntax.AnnotationAxiom value) {
  ...
  public static final class Assertion extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.Assertion value;
    
    public Assertion (hydra.ext.owl.syntax.Assertion value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class ClassAxiom extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.ClassAxiom value;
    
    public ClassAxiom (hydra.ext.owl.syntax.ClassAxiom value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class DataPropertyAxiom extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.DataPropertyAxiom value;
    
    public DataPropertyAxiom (hydra.ext.owl.syntax.DataPropertyAxiom value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class DatatypeDefinition extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.DatatypeDefinition value;
    
    public DatatypeDefinition (hydra.ext.owl.syntax.DatatypeDefinition value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Declaration extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.Declaration value;
    
    public Declaration (hydra.ext.owl.syntax.Declaration value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class HasKey extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.HasKey value;
    
    public HasKey (hydra.ext.owl.syntax.HasKey value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class ObjectPropertyAxiom extends hydra.ext.owl.syntax.Axiom implements Serializable {
    public final hydra.ext.owl.syntax.ObjectPropertyAxiom value;
    
    public ObjectPropertyAxiom (hydra.ext.owl.syntax.ObjectPropertyAxiom value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
