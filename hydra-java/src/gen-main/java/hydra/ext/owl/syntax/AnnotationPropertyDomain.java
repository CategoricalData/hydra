...
public class AnnotationPropertyDomain implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.AnnotationPropertyDomain");
  ...
  public AnnotationPropertyDomain (java.util.List<hydra.ext.owl.syntax.Annotation> annotations, hydra.ext.owl.syntax.AnnotationProperty property, hydra.ext.rdf.syntax.Iri iri) {
  ...
  public AnnotationPropertyDomain withAnnotations(java.util.List<hydra.ext.owl.syntax.Annotation> annotations) {
    java.util.Objects.requireNonNull((annotations));
    return new AnnotationPropertyDomain(annotations, property, iri);
  }
  
  public AnnotationPropertyDomain withProperty(hydra.ext.owl.syntax.AnnotationProperty property) {
    java.util.Objects.requireNonNull((property));
    return new AnnotationPropertyDomain(annotations, property, iri);
  }
