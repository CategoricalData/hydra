...
public class Quad implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/rdf/syntax.Quad");
  ...
  public final hydra.util.Opt<hydra.ext.rdf.syntax.Iri> graph;
  
  public Quad (hydra.ext.rdf.syntax.Resource subject, hydra.ext.rdf.syntax.Iri predicate, hydra.ext.rdf.syntax.Node object, hydra.util.Opt<hydra.ext.rdf.syntax.Iri> graph) {
  ...
  public Quad withGraph(hydra.util.Opt<hydra.ext.rdf.syntax.Iri> graph) {
    java.util.Objects.requireNonNull((graph));
    return new Quad(subject, predicate, object, graph);
  }
}
