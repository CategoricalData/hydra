...
public class Literal implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/rdf/syntax.Literal");
   ...
   */
  public final hydra.util.Opt<hydra.ext.rdf.syntax.LanguageTag> languageTag;
  
  public Literal (String lexicalForm, hydra.ext.rdf.syntax.Iri datatypeIri, hydra.util.Opt<hydra.ext.rdf.syntax.LanguageTag> languageTag) {
  ...
  public Literal withLanguageTag(hydra.util.Opt<hydra.ext.rdf.syntax.LanguageTag> languageTag) {
    java.util.Objects.requireNonNull((languageTag));
    return new Literal(lexicalForm, datatypeIri, languageTag);
  }
}
