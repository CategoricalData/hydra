...
public abstract class IriOrLiteral implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/rdf/syntax.IriOrLiteral");
  ...
  public static final class Iri extends hydra.ext.rdf.syntax.IriOrLiteral implements Serializable {
  ...
  public static final class Literal extends hydra.ext.rdf.syntax.IriOrLiteral implements Serializable {
