...
public abstract class OperatorBody implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.OperatorBody");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(OperatorBody instance) {
  ...
  public static final class Block extends hydra.ext.csharp.syntax.OperatorBody implements Serializable {
  ...
  public static final class Expression extends hydra.ext.csharp.syntax.OperatorBody implements Serializable {
  ...
  public static final class Empty extends hydra.ext.csharp.syntax.OperatorBody implements Serializable {
    public Empty () {
