...
public abstract class ConstructorBody implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.ConstructorBody");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(ConstructorBody instance) {
  ...
  public static final class Block extends hydra.ext.csharp.syntax.ConstructorBody implements Serializable {
  ...
  public static final class Expression extends hydra.ext.csharp.syntax.ConstructorBody implements Serializable {
  ...
  public static final class Empty extends hydra.ext.csharp.syntax.ConstructorBody implements Serializable {
    public Empty () {
