...
public abstract class OperatorModifier implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.OperatorModifier");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(OperatorModifier instance) {
  ...
  public static final class Public extends hydra.ext.csharp.syntax.OperatorModifier implements Serializable {
    public Public () {
  ...
  public static final class Static extends hydra.ext.csharp.syntax.OperatorModifier implements Serializable {
    public Static () {
  ...
  public static final class Extern extends hydra.ext.csharp.syntax.OperatorModifier implements Serializable {
    public Extern () {
  ...
  public static final class Unsafe extends hydra.ext.csharp.syntax.OperatorModifier implements Serializable {
    public Unsafe () {
