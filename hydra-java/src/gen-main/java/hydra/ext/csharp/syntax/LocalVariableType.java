...
public abstract class LocalVariableType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.LocalVariableType");
  ...
  public static final class Type extends hydra.ext.csharp.syntax.LocalVariableType implements Serializable {
  ...
  public static final class Var extends hydra.ext.csharp.syntax.LocalVariableType implements Serializable {
    public Var () {
