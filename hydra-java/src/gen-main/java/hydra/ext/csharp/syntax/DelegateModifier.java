...
public abstract class DelegateModifier implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.DelegateModifier");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(DelegateModifier instance) {
  ...
  public static final class New extends hydra.ext.csharp.syntax.DelegateModifier implements Serializable {
    public New () {
  ...
  public static final class Public extends hydra.ext.csharp.syntax.DelegateModifier implements Serializable {
    public Public () {
  ...
  public static final class Protected extends hydra.ext.csharp.syntax.DelegateModifier implements Serializable {
    public Protected () {
  ...
  public static final class Internal extends hydra.ext.csharp.syntax.DelegateModifier implements Serializable {
    public Internal () {
  ...
  public static final class Private extends hydra.ext.csharp.syntax.DelegateModifier implements Serializable {
    public Private () {
  ...
  public static final class Unsafe extends hydra.ext.csharp.syntax.DelegateModifier implements Serializable {
    public Unsafe () {
