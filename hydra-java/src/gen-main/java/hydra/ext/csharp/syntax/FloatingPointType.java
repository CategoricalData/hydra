...
public abstract class FloatingPointType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.FloatingPointType");
  ...
  public static final class Float_ extends hydra.ext.csharp.syntax.FloatingPointType implements Serializable {
    public Float_ () {
  ...
  public static final class Double_ extends hydra.ext.csharp.syntax.FloatingPointType implements Serializable {
    public Double_ () {
