...
public abstract class StructMemberDeclaration implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.StructMemberDeclaration");
  ...
  public static final hydra.core.Name FIELD_NAME_FIXED_SIZE_BUFFER = new hydra.core.Name("fixedSizeBuffer");
  
  private StructMemberDeclaration () {
  ...
  public interface Visitor<R> {
    ...
    R visit(FixedSizeBuffer instance) ;
  }
  
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(StructMemberDeclaration instance) {
    ...
    default R visit(FixedSizeBuffer instance) {
      return otherwise((instance));
    }
  }
  
  public static final class Constant extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Field extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Method extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Property extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Event extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Indexer extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Operator extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Constructor extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class StaticConstructor extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class Type extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
  ...
  public static final class FixedSizeBuffer extends hydra.ext.csharp.syntax.StructMemberDeclaration implements Serializable {
    public final hydra.ext.csharp.syntax.FixedSizeBufferDeclaration value;
    
    public FixedSizeBuffer (hydra.ext.csharp.syntax.FixedSizeBufferDeclaration value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
    ...
    @Override
    public boolean equals(Object other) {
      if (!(other instanceof FixedSizeBuffer)) {
        return false;
      }
      FixedSizeBuffer o = (FixedSizeBuffer) (other);
      return value.equals(o.value);
    }
