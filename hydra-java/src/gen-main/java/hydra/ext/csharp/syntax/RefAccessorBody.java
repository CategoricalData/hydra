...
public abstract class RefAccessorBody implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.RefAccessorBody");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(RefAccessorBody instance) {
  ...
  public static final class Block extends hydra.ext.csharp.syntax.RefAccessorBody implements Serializable {
  ...
  public static final class Ref extends hydra.ext.csharp.syntax.RefAccessorBody implements Serializable {
  ...
  public static final class Empty extends hydra.ext.csharp.syntax.RefAccessorBody implements Serializable {
    public Empty () {
