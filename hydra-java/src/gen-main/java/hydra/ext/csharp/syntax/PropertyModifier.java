...
public abstract class PropertyModifier implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.PropertyModifier");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(PropertyModifier instance) {
  ...
  public static final class New extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public New () {
  ...
  public static final class Public extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Public () {
  ...
  public static final class Protected extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Protected () {
  ...
  public static final class Internal extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Internal () {
  ...
  public static final class Private extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Private () {
  ...
  public static final class Static extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Static () {
  ...
  public static final class Virtual extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Virtual () {
  ...
  public static final class Sealed extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Sealed () {
  ...
  public static final class Override_ extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Override_ () {
  ...
  public static final class Abstract extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Abstract () {
  ...
  public static final class Extern extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Extern () {
  ...
  public static final class Unsafe extends hydra.ext.csharp.syntax.PropertyModifier implements Serializable {
    public Unsafe () {
