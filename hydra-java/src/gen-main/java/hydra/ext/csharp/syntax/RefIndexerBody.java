...
public abstract class RefIndexerBody implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.RefIndexerBody");
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(RefIndexerBody instance) {
  ...
  public static final class Block extends hydra.ext.csharp.syntax.RefIndexerBody implements Serializable {
  ...
  public static final class Ref extends hydra.ext.csharp.syntax.RefIndexerBody implements Serializable {
