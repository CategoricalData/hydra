...
public abstract class InitializerTarget implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.InitializerTarget");
  
  public static final hydra.core.Name FIELD_NAME_IDENTIFIER = new hydra.core.Name("identifier");
  
  public static final hydra.core.Name FIELD_NAME_ARGUMENTS = new hydra.core.Name("arguments");
  
  private InitializerTarget () {
  ...
  public interface PartialVisitor<R> extends Visitor<R> {
    default R otherwise(InitializerTarget instance) {
  ...
  public static final class Identifier extends hydra.ext.csharp.syntax.InitializerTarget implements Serializable {
  ...
  public static final class Arguments extends hydra.ext.csharp.syntax.InitializerTarget implements Serializable {
