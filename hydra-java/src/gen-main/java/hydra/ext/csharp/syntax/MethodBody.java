...
public abstract class MethodBody implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.csharp.syntax.MethodBody");
  ...
  public static final class Block extends hydra.ext.csharp.syntax.MethodBody implements Serializable {
  ...
  public static final class NullConditionalInvocation extends hydra.ext.csharp.syntax.MethodBody implements Serializable {
  ...
  public static final class Expression extends hydra.ext.csharp.syntax.MethodBody implements Serializable {
  ...
  public static final class Empty extends hydra.ext.csharp.syntax.MethodBody implements Serializable {
    public Empty () {
