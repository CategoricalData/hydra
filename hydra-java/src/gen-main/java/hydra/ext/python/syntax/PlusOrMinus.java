...
public abstract class PlusOrMinus implements Serializable {
  ...
  public static final class Plus extends hydra.ext.python.syntax.PlusOrMinus implements Serializable {
    public Plus () {
  ...
  public static final class Minus extends hydra.ext.python.syntax.PlusOrMinus implements Serializable {
    public Minus () {
