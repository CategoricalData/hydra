...
public abstract class SliceOrStarredExpression implements Serializable, Comparable<SliceOrStarredExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.python.syntax.SliceOrStarredExpression");
  
  public static final hydra.core.Name SLICE = new hydra.core.Name("slice");
