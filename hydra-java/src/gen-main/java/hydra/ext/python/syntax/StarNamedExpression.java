...
public abstract class StarNamedExpression implements Serializable, Comparable<StarNamedExpression> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.python.syntax.StarNamedExpression");
