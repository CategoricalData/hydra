...
public interface Testing {
  ...
  static hydra.util.Either<String, String> termToPython(hydra.module.Namespaces<hydra.ext.python.syntax.DottedName> namespaces_, hydra.core.Term term, hydra.graph.Graph g) {
    return hydra.ext.python.Testing.termToPythonWithContext(
      namespaces_,
      g,
      false,
      term,
  ...
  static hydra.testing.TestCodec pythonTestCodec(hydra.module.Namespaces<hydra.ext.python.syntax.DottedName> namespaces_) {
    return new hydra.testing.TestCodec(new hydra.coders.LanguageName("python"), new hydra.module.FileExtension("py"), (java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>>) (v1 -> (java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>) (v2 -> hydra.ext.python.Testing.termToPython(
      namespaces_,
      v1,
      v2))), (java.util.function.Function<hydra.core.Type, java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>>) (v1 -> (java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>) (v2 -> hydra.ext.python.Testing.typeToPython(
      namespaces_,
      v1,
      v2))), hydra.ext.python.Testing::formatPythonTestName, hydra.ext.python.Testing::namespaceToPythonModuleName, hydra.ext.python.Testing.pythonTestCaseTemplate(), hydra.ext.python.Testing.pythonTestGroupTemplate(), hydra.ext.python.Testing.pythonModuleTemplate(), hydra.ext.python.Testing.pythonImportTemplate(), (java.util.function.Function<hydra.util.PersistentSet<hydra.core.Name>, hydra.util.ConsList<String>>) (v1 -> hydra.ext.python.Testing.findPythonImports(
      namespaces_,
      v1)));
  }
  ...
  static hydra.testing.TestCodec pythonTestCodecWithContext(hydra.module.Namespaces<hydra.ext.python.syntax.DottedName> namespaces_, hydra.graph.Graph tcontext) {
    return new hydra.testing.TestCodec(new hydra.coders.LanguageName("python"), new hydra.module.FileExtension("py"), (java.util.function.Function<hydra.core.Term, java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>>) (v1 -> (java.util.function.Function<hydra.graph.Graph, hydra.util.Either<String, String>>) (v2 -> hydra.ext.python.Testing.termToPythonWithContext(
      namespaces_,
      tcontext,
      true,
      v1,
  ...
  static <T0, T1> hydra.util.ConsList<String> findPythonImports(hydra.module.Namespaces<T0> namespaces_, T1 names_) {
    return hydra.lib.lists.Map.apply(
      ...
      hydra.lib.maps.ToList.apply(hydra.ext.python.Testing.<T0>findPythonImports_filtered(namespaces_)));
  }
    ...
    return hydra.lib.maps.FilterWithKey.apply(
      (java.util.function.Function<hydra.module.Namespace, java.util.function.Function<T0, Boolean>>) (ns_ -> (java.util.function.Function<T0, Boolean>) (_v -> hydra.lib.logic.Not.apply(hydra.lib.equality.Equal.apply(
        hydra.lib.lists.Head.apply(hydra.lib.strings.SplitOn.apply(
          ...
          (ns_).value)),
        "")))),
      hydra.ext.python.Testing.<T0>findPythonImports_mapping_(namespaces_));
  }
  ...
  static <T0> hydra.util.Either<String, String> generatePythonTestGroupHierarchy(hydra.graph.Graph g, T0 namespaces_, hydra.testing.TestCodec codec, hydra.util.ConsList<String> groupPath, hydra.testing.TestGroup testGroup) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.MapList.apply(
        (java.util.function.Function<hydra.testing.TestCaseWithMetadata, hydra.util.Either<String, hydra.util.ConsList<String>>>) (tc -> hydra.ext.python.Testing.<T0>generatePythonTestCase(
          g,
          namespaces_,
          codec,
          groupPath,
  ...
  static hydra.util.Either<String, hydra.util.Pair<String, String>> generatePythonTestFile(hydra.module.Module testModule, hydra.testing.TestGroup testGroup, hydra.graph.Graph g) {
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.testing.TestGroup, hydra.util.Either<String, hydra.util.Pair<String, String>>>) (inferredTestGroup -> hydra.lib.eithers.Bind.apply(
        hydra.ext.python.Testing.namespacesForPythonModule(
          testModule,
          g),
        (java.util.function.Function<hydra.module.Namespaces<hydra.ext.python.syntax.DottedName>, hydra.util.Either<String, hydra.util.Pair<String, String>>>) (namespaces_ -> hydra.ext.python.Testing.generateTestFileWithPythonCodec(
          hydra.ext.python.Testing.pythonTestCodecWithContext(
            namespaces_,
            g),
          testModule,
          inferredTestGroup,
