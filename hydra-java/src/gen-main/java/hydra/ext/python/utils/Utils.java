...
public interface Utils {
  ...
  static hydra.ext.python.syntax.Conjunction pyBitwiseOrToPyConjunction(hydra.ext.python.syntax.BitwiseOr bor) {
    return new hydra.ext.python.syntax.Conjunction(hydra.util.ConsList.of(new hydra.ext.python.syntax.Inversion.Simple(new hydra.ext.python.syntax.Comparison(bor, (hydra.util.ConsList<hydra.ext.python.syntax.CompareOpBitwiseOrPair>) (hydra.util.ConsList.<hydra.ext.python.syntax.CompareOpBitwiseOrPair>of())))));
  }
  ...
  static hydra.ext.python.syntax.Args pyExpressionsToPyArgs(hydra.util.ConsList<hydra.ext.python.syntax.Expression> exprs) {
    return new hydra.ext.python.syntax.Args(hydra.lib.lists.Map.apply(
      ...
      exprs), (hydra.util.ConsList<hydra.ext.python.syntax.KwargOrStarred>) (hydra.util.ConsList.<hydra.ext.python.syntax.KwargOrStarred>of()), (hydra.util.ConsList<hydra.ext.python.syntax.KwargOrDoubleStarred>) (hydra.util.ConsList.<hydra.ext.python.syntax.KwargOrDoubleStarred>of()));
  }
  ...
  static hydra.util.ConsList<hydra.ext.python.syntax.Statement> unionTypeClassStatements310(hydra.ext.python.syntax.Name name, hydra.util.Maybe<String> mcomment, hydra.ext.python.syntax.Expression tyexpr, hydra.util.ConsList<hydra.ext.python.syntax.Statement> extraStmts) {
    ...
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> getItemMethod = new hydra.util.Lazy<>(() -> new hydra.ext.python.syntax.Statement.Compound(new hydra.ext.python.syntax.CompoundStatement.Function(new hydra.ext.python.syntax.FunctionDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), new hydra.ext.python.syntax.FunctionDefRaw(false, new hydra.ext.python.syntax.Name("__getitem__"), (hydra.util.ConsList<hydra.ext.python.syntax.TypeParameter>) (hydra.util.ConsList.<hydra.ext.python.syntax.TypeParameter>of()), hydra.util.Maybe.just(hydra.ext.python.utils.Utils.getItemParams()), (hydra.util.Maybe<hydra.ext.python.syntax.Expression>) (hydra.util.Maybe.<hydra.ext.python.syntax.Expression>nothing()), (hydra.util.Maybe<hydra.ext.python.syntax.FuncTypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.FuncTypeComment>nothing()), hydra.ext.python.utils.Utils.indentedBlock(
    ...
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> unionClass = new hydra.util.Lazy<>(() -> hydra.ext.python.utils.Utils.annotatedStatement(
      mcomment,
      hydra.ext.python.utils.Utils.pyClassDefinitionToPyStatement(new hydra.ext.python.syntax.ClassDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), name, (hydra.util.ConsList<hydra.ext.python.syntax.TypeParameter>) (hydra.util.ConsList.<hydra.ext.python.syntax.TypeParameter>of()), hydra.util.Maybe.just(new hydra.ext.python.syntax.Args((hydra.util.ConsList<hydra.ext.python.syntax.PosArg>) (hydra.util.ConsList.<hydra.ext.python.syntax.PosArg>of()), hydra.util.ConsList.of(new hydra.ext.python.syntax.KwargOrStarred.Kwarg(metaclassArg.get())), (hydra.util.ConsList<hydra.ext.python.syntax.KwargOrDoubleStarred>) (hydra.util.ConsList.<hydra.ext.python.syntax.KwargOrDoubleStarred>of()))), hydra.ext.python.utils.Utils.indentedBlock(
        (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()),
        bodyGroups.get())))));
    return hydra.util.ConsList.of(
      metaClass.get(),
  ...
  static hydra.util.ConsList<hydra.ext.python.syntax.Statement> unitVariantMethods(hydra.ext.python.syntax.Name className) {
    ...
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> hashMethod = new hydra.util.Lazy<>(() -> new hydra.ext.python.syntax.Statement.Compound(new hydra.ext.python.syntax.CompoundStatement.Function(new hydra.ext.python.syntax.FunctionDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), new hydra.ext.python.syntax.FunctionDefRaw(false, new hydra.ext.python.syntax.Name("__hash__"), (hydra.util.ConsList<hydra.ext.python.syntax.TypeParameter>) (hydra.util.ConsList.<hydra.ext.python.syntax.TypeParameter>of()), hydra.util.Maybe.just(hydra.ext.python.utils.Utils.selfOnlyParams()), (hydra.util.Maybe<hydra.ext.python.syntax.Expression>) (hydra.util.Maybe.<hydra.ext.python.syntax.Expression>nothing()), (hydra.util.Maybe<hydra.ext.python.syntax.FuncTypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.FuncTypeComment>nothing()), hydra.ext.python.utils.Utils.indentedBlock(
      (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()),
    ...
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> slotsStmt = new hydra.util.Lazy<>(() -> hydra.ext.python.utils.Utils.assignmentStatement(
      ...
      hydra.ext.python.utils.Utils.pyPrimaryToPyExpression(new hydra.ext.python.syntax.Primary.Simple(new hydra.ext.python.syntax.Atom.Tuple(new hydra.ext.python.syntax.Tuple((hydra.util.ConsList<hydra.ext.python.syntax.StarNamedExpression>) (hydra.util.ConsList.<hydra.ext.python.syntax.StarNamedExpression>of())))))));
    return hydra.util.ConsList.of(
      slotsStmt.get(),
      eqMethod.get(),
      hashMethod.get());
