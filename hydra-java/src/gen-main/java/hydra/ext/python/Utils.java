...
public interface Utils {
  ...
  static hydra.ext.python.syntax.Statement assignment(hydra.ext.python.syntax.Name name, hydra.ext.python.syntax.AnnotatedRhs rhs) {
    return hydra.ext.python.Utils.pyAssignmentToPyStatement(new hydra.ext.python.syntax.Assignment.Untyped(new hydra.ext.python.syntax.UntypedAssignment(java.util.Arrays.asList(hydra.ext.python.Utils.pyNameToPyStarTarget(name)), rhs, (hydra.util.Maybe<hydra.ext.python.syntax.TypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.TypeComment>nothing()))));
  }
  ...
  static hydra.ext.python.syntax.Statement assignmentStatement(hydra.ext.python.syntax.Name name, hydra.ext.python.syntax.Expression expr) {
    return hydra.ext.python.Utils.assignment(
      name,
                ...
                () -> hydra.lib.logic.IfElse.lazy(
                  ...
                  () -> (termRhs).accept(new hydra.ext.python.syntax.Factor.PartialVisitor<>() {
                    ...
                    public hydra.util.Maybe<hydra.ext.python.syntax.Primary> visit(hydra.ext.python.syntax.Factor.Simple power) {
                      return hydra.ext.python.Utils.decodePyPowerToPyPrimary((power).value);
                    }
                  }))))))));
  }
  ...
  static hydra.util.Maybe<hydra.ext.python.syntax.Primary> decodePyConjunctionToPyPrimary(hydra.ext.python.syntax.Conjunction c) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.equality.Equal.apply(
        ...
        1),
      () -> hydra.ext.python.Utils.decodePyInversionToPyPrimary(hydra.lib.lists.Head.apply(inversions)),
      () -> (hydra.util.Maybe<hydra.ext.python.syntax.Primary>) (hydra.util.Maybe.<hydra.ext.python.syntax.Primary>nothing()));
  }
      ...
      public hydra.util.Maybe<hydra.ext.python.syntax.Primary> visit(hydra.ext.python.syntax.Expression.Simple disj) {
        ...
        return hydra.lib.logic.IfElse.lazy(
          hydra.lib.equality.Equal.apply(
            ...
            1),
          () -> hydra.ext.python.Utils.decodePyConjunctionToPyPrimary(hydra.lib.lists.Head.apply(conjunctions)),
          () -> (hydra.util.Maybe<hydra.ext.python.syntax.Primary>) (hydra.util.Maybe.<hydra.ext.python.syntax.Primary>nothing()));
      }
    });
  }
  ...
  static hydra.ext.python.syntax.Statement dottedAssignmentStatement(hydra.ext.python.syntax.Name obj, hydra.ext.python.syntax.Name attr, hydra.ext.python.syntax.Expression expr) {
    ...
    return hydra.ext.python.Utils.pyAssignmentToPyStatement(new hydra.ext.python.syntax.Assignment.Untyped(new hydra.ext.python.syntax.UntypedAssignment(java.util.Arrays.asList(target), hydra.ext.python.Utils.pyExpressionToPyAnnotatedRhs(expr), (hydra.util.Maybe<hydra.ext.python.syntax.TypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.TypeComment>nothing()))));
  }
  ...
  static hydra.packaging.Namespaces<hydra.ext.python.syntax.DottedName> findNamespaces(hydra.packaging.Namespace focusNs, java.util.List<hydra.packaging.Definition> defs) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> (hydra.packaging.Namespaces<hydra.ext.python.syntax.DottedName>) (new hydra.packaging.Namespaces<hydra.ext.python.syntax.DottedName>(((java.util.function.Function<hydra.packaging.Namespaces<hydra.ext.python.syntax.DottedName>, hydra.util.Pair<hydra.packaging.Namespace, hydra.ext.python.syntax.DottedName>>) (projected -> projected.focus)).apply(namespaces.get()), hydra.lib.maps.Insert.apply(
        ...
        ((java.util.function.Function<hydra.packaging.Namespaces<hydra.ext.python.syntax.DottedName>, java.util.Map<hydra.packaging.Namespace, hydra.ext.python.syntax.DottedName>>) (projected -> projected.mapping)).apply(namespaces.get())))));
  }
  ...
  static hydra.ext.python.syntax.Parameters getItemParams() {
    return new hydra.ext.python.syntax.Parameters.ParamNoDefault(new hydra.ext.python.syntax.ParamNoDefaultParameters(java.util.Arrays.asList(
  ...
  static hydra.ext.python.syntax.Block indentedBlock(hydra.util.Maybe<String> mcomment, java.util.List<java.util.List<hydra.ext.python.syntax.Statement>> stmts) {
    hydra.util.Lazy<java.util.List<hydra.ext.python.syntax.Statement>> commentGroup = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
      ...
      (java.util.function.Function<String, java.util.List<hydra.ext.python.syntax.Statement>>) (s -> java.util.Arrays.asList(hydra.ext.python.Utils.commentStatement(s))),
      mcomment));
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> new hydra.ext.python.syntax.Block.Indented(java.util.Arrays.asList(java.util.Arrays.asList(new hydra.ext.python.syntax.Statement.Simple(java.util.Arrays.asList(hydra.ext.python.Utils.pyExpressionToPySimpleStatement(hydra.ext.python.Utils.pyAtomToPyExpression(new hydra.ext.python.syntax.Atom.Ellipsis()))))))),
  ...
  static hydra.ext.python.syntax.Expression orExpression(java.util.List<hydra.ext.python.syntax.Primary> prims) {
    ...
    build.set((java.util.function.Function<hydra.util.Maybe<hydra.ext.python.syntax.BitwiseOr>, java.util.function.Function<java.util.List<hydra.ext.python.syntax.Primary>, hydra.ext.python.syntax.BitwiseOr>>) (prev -> (java.util.function.Function<java.util.List<hydra.ext.python.syntax.Primary>, hydra.ext.python.syntax.BitwiseOr>) (ps -> hydra.lib.logic.IfElse.lazy(
      ...
      () -> new hydra.ext.python.syntax.BitwiseOr(prev, hydra.ext.python.Utils.pyPrimaryToPyBitwiseXor(hydra.lib.lists.Head.apply(ps))),
      () -> build.get().apply(hydra.util.Maybe.just(new hydra.ext.python.syntax.BitwiseOr(prev, hydra.ext.python.Utils.pyPrimaryToPyBitwiseXor(hydra.lib.lists.Head.apply(ps))))).apply(hydra.lib.lists.Tail.apply(ps))))));
  ...
  static hydra.ext.python.syntax.Conjunction pyBitwiseOrToPyConjunction(hydra.ext.python.syntax.BitwiseOr bor) {
    return new hydra.ext.python.syntax.Conjunction(java.util.Arrays.asList(new hydra.ext.python.syntax.Inversion.Simple(new hydra.ext.python.syntax.Comparison(bor, (java.util.List<hydra.ext.python.syntax.CompareOpBitwiseOrPair>) (java.util.Collections.<hydra.ext.python.syntax.CompareOpBitwiseOrPair>emptyList())))));
  }
  ...
  static hydra.ext.python.syntax.Patterns pyClosedPatternToPyPatterns(hydra.ext.python.syntax.ClosedPattern p) {
    return new hydra.ext.python.syntax.Patterns.Pattern(new hydra.ext.python.syntax.Pattern.Or(new hydra.ext.python.syntax.OrPattern(java.util.Arrays.asList(p))));
  }

  static hydra.ext.python.syntax.Expression pyConjunctionToPyExpression(hydra.ext.python.syntax.Conjunction conj) {
    return new hydra.ext.python.syntax.Expression.Simple(new hydra.ext.python.syntax.Disjunction(java.util.Arrays.asList(conj)));
  }
  ...
  static hydra.ext.python.syntax.Disjunction pyExpressionToDisjunction(hydra.ext.python.syntax.Expression e) {
    return (e).accept(new hydra.ext.python.syntax.Expression.PartialVisitor<>() {
      ...
      public hydra.ext.python.syntax.Disjunction otherwise(hydra.ext.python.syntax.Expression instance) {
        return new hydra.ext.python.syntax.Disjunction(java.util.Arrays.asList(hydra.ext.python.Utils.pyPrimaryToPyConjunction(new hydra.ext.python.syntax.Primary.Simple(new hydra.ext.python.syntax.Atom.Group(new hydra.ext.python.syntax.Group.Expression(new hydra.ext.python.syntax.NamedExpression.Simple(e)))))));
      }
  ...
  static hydra.ext.python.syntax.AnnotatedRhs pyExpressionToPyAnnotatedRhs(hydra.ext.python.syntax.Expression expr) {
    return new hydra.ext.python.syntax.AnnotatedRhs.Star(java.util.Arrays.asList(new hydra.ext.python.syntax.StarExpression.Simple(expr)));
  }
  ...
  static hydra.ext.python.syntax.SimpleStatement pyExpressionToPySimpleStatement(hydra.ext.python.syntax.Expression expr) {
    return new hydra.ext.python.syntax.SimpleStatement.StarExpressions(java.util.Arrays.asList(new hydra.ext.python.syntax.StarExpression.Simple(expr)));
  }
  ...
  static hydra.ext.python.syntax.Args pyExpressionsToPyArgs(java.util.List<hydra.ext.python.syntax.Expression> exprs) {
    return new hydra.ext.python.syntax.Args(hydra.lib.lists.Map.apply(
      ...
      exprs), (java.util.List<hydra.ext.python.syntax.KwargOrStarred>) (java.util.Collections.<hydra.ext.python.syntax.KwargOrStarred>emptyList()), (java.util.List<hydra.ext.python.syntax.KwargOrDoubleStarred>) (java.util.Collections.<hydra.ext.python.syntax.KwargOrDoubleStarred>emptyList()));
  }
  ...
  static hydra.ext.python.syntax.Statement pySimpleStatementToPyStatement(hydra.ext.python.syntax.SimpleStatement s) {
    return new hydra.ext.python.syntax.Statement.Simple(java.util.Arrays.asList(s));
  }
  ...
  static hydra.ext.python.syntax.Statement raiseAssertionError(String msg) {
    return hydra.ext.python.Utils.pySimpleStatementToPyStatement(new hydra.ext.python.syntax.SimpleStatement.Raise(new hydra.ext.python.syntax.RaiseStatement(hydra.util.Maybe.just(new hydra.ext.python.syntax.RaiseExpression(hydra.ext.python.Utils.functionCall(
      ...
      java.util.Arrays.asList(hydra.ext.python.Utils.doubleQuotedString(msg))), (hydra.util.Maybe<hydra.ext.python.syntax.Expression>) (hydra.util.Maybe.<hydra.ext.python.syntax.Expression>nothing()))))));
  }
  ...
  static hydra.ext.python.syntax.Statement returnSingle(hydra.ext.python.syntax.Expression expr) {
    return hydra.ext.python.Utils.pySimpleStatementToPyStatement(new hydra.ext.python.syntax.SimpleStatement.Return(new hydra.ext.python.syntax.ReturnStatement(java.util.Arrays.asList(new hydra.ext.python.syntax.StarExpression.Simple(expr)))));
  }

  static hydra.ext.python.syntax.Parameters selfOnlyParams() {
    return new hydra.ext.python.syntax.Parameters.ParamNoDefault(new hydra.ext.python.syntax.ParamNoDefaultParameters(java.util.Arrays.asList(new hydra.ext.python.syntax.ParamNoDefault(new hydra.ext.python.syntax.Param(new hydra.ext.python.syntax.Name("self"), (hydra.util.Maybe<hydra.ext.python.syntax.Annotation>) (hydra.util.Maybe.<hydra.ext.python.syntax.Annotation>nothing())), (hydra.util.Maybe<hydra.ext.python.syntax.TypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.TypeComment>nothing()))), (java.util.List<hydra.ext.python.syntax.ParamWithDefault>) (java.util.Collections.<hydra.ext.python.syntax.ParamWithDefault>emptyList()), (hydra.util.Maybe<hydra.ext.python.syntax.StarEtc>) (hydra.util.Maybe.<hydra.ext.python.syntax.StarEtc>nothing())));
  }
  ...
  static java.util.List<hydra.ext.python.syntax.Statement> unionTypeClassStatements310(hydra.ext.python.syntax.Name name, hydra.util.Maybe<String> mcomment, hydra.ext.python.syntax.Expression tyexpr, java.util.List<hydra.ext.python.syntax.Statement> extraStmts) {
    String docString = hydra.Serialization.printExpr(hydra.ext.python.Serde.encodeExpression(tyexpr));
    hydra.ext.python.syntax.Statement docStmt = hydra.ext.python.Utils.pyExpressionToPyStatement(hydra.ext.python.Utils.tripleQuotedString(docString));
    hydra.util.Lazy<java.util.List<java.util.List<hydra.ext.python.syntax.Statement>>> bodyGroups = new hydra.util.Lazy<>(() -> hydra.lib.logic.IfElse.lazy(
      ...
      () -> ((java.util.function.Supplier<java.util.List<java.util.List<hydra.ext.python.syntax.Statement>>>) (() -> {
        hydra.ext.python.syntax.Statement passStmt = hydra.ext.python.Utils.pySimpleStatementToPyStatement(new hydra.ext.python.syntax.SimpleStatement.Pass());
      ...
      () -> java.util.Arrays.asList(
        java.util.Arrays.asList(docStmt),
        extraStmts)));
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> returnObject = new hydra.util.Lazy<>(() -> hydra.ext.python.Utils.pySimpleStatementToPyStatement(new hydra.ext.python.syntax.SimpleStatement.Return(new hydra.ext.python.syntax.ReturnStatement(java.util.Arrays.asList(new hydra.ext.python.syntax.StarExpression.Simple(new hydra.ext.python.syntax.Expression.Simple(new hydra.ext.python.syntax.Disjunction(java.util.Arrays.asList(new hydra.ext.python.syntax.Conjunction(java.util.Arrays.asList(new hydra.ext.python.syntax.Inversion.Simple(new hydra.ext.python.syntax.Comparison(new hydra.ext.python.syntax.BitwiseOr((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseOr>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseOr>nothing()), new hydra.ext.python.syntax.BitwiseXor((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseXor>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseXor>nothing()), new hydra.ext.python.syntax.BitwiseAnd((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseAnd>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseAnd>nothing()), new hydra.ext.python.syntax.ShiftExpression((hydra.util.Maybe<hydra.ext.python.syntax.ShiftLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.ShiftLhs>nothing()), new hydra.ext.python.syntax.Sum((hydra.util.Maybe<hydra.ext.python.syntax.SumLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.SumLhs>nothing()), new hydra.ext.python.syntax.Term((hydra.util.Maybe<hydra.ext.python.syntax.TermLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.TermLhs>nothing()), new hydra.ext.python.syntax.Factor.Simple(new hydra.ext.python.syntax.Power(new hydra.ext.python.syntax.AwaitPrimary(false, new hydra.ext.python.syntax.Primary.Simple(new hydra.ext.python.syntax.Atom.Name(new hydra.ext.python.syntax.Name("object")))), (hydra.util.Maybe<hydra.ext.python.syntax.Factor>) (hydra.util.Maybe.<hydra.ext.python.syntax.Factor>nothing()))))))))), (java.util.List<hydra.ext.python.syntax.CompareOpBitwiseOrPair>) (java.util.Collections.<hydra.ext.python.syntax.CompareOpBitwiseOrPair>emptyList()))))))))))))));
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> getItemMethod = new hydra.util.Lazy<>(() -> new hydra.ext.python.syntax.Statement.Compound(new hydra.ext.python.syntax.CompoundStatement.Function(new hydra.ext.python.syntax.FunctionDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), new hydra.ext.python.syntax.FunctionDefRaw(false, new hydra.ext.python.syntax.Name("__getitem__"), (java.util.List<hydra.ext.python.syntax.TypeParameter>) (java.util.Collections.<hydra.ext.python.syntax.TypeParameter>emptyList()), hydra.util.Maybe.just(hydra.ext.python.Utils.getItemParams()), (hydra.util.Maybe<hydra.ext.python.syntax.Expression>) (hydra.util.Maybe.<hydra.ext.python.syntax.Expression>nothing()), (hydra.util.Maybe<hydra.ext.python.syntax.FuncTypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.FuncTypeComment>nothing()), hydra.ext.python.Utils.indentedBlock(
    ...
    hydra.ext.python.syntax.Name metaName = new hydra.ext.python.syntax.Name(hydra.lib.strings.Cat2.apply(
      hydra.lib.strings.Cat2.apply(
        ...
        nameStr),
      "Meta"));
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> metaClass = new hydra.util.Lazy<>(() -> hydra.ext.python.Utils.pyClassDefinitionToPyStatement(new hydra.ext.python.syntax.ClassDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), metaName, (java.util.List<hydra.ext.python.syntax.TypeParameter>) (java.util.Collections.<hydra.ext.python.syntax.TypeParameter>emptyList()), hydra.util.Maybe.just(hydra.ext.python.Utils.pyExpressionsToPyArgs(java.util.Arrays.asList(new hydra.ext.python.syntax.Expression.Simple(new hydra.ext.python.syntax.Disjunction(java.util.Arrays.asList(new hydra.ext.python.syntax.Conjunction(java.util.Arrays.asList(new hydra.ext.python.syntax.Inversion.Simple(new hydra.ext.python.syntax.Comparison(new hydra.ext.python.syntax.BitwiseOr((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseOr>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseOr>nothing()), new hydra.ext.python.syntax.BitwiseXor((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseXor>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseXor>nothing()), new hydra.ext.python.syntax.BitwiseAnd((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseAnd>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseAnd>nothing()), new hydra.ext.python.syntax.ShiftExpression((hydra.util.Maybe<hydra.ext.python.syntax.ShiftLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.ShiftLhs>nothing()), new hydra.ext.python.syntax.Sum((hydra.util.Maybe<hydra.ext.python.syntax.SumLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.SumLhs>nothing()), new hydra.ext.python.syntax.Term((hydra.util.Maybe<hydra.ext.python.syntax.TermLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.TermLhs>nothing()), new hydra.ext.python.syntax.Factor.Simple(new hydra.ext.python.syntax.Power(new hydra.ext.python.syntax.AwaitPrimary(false, new hydra.ext.python.syntax.Primary.Simple(new hydra.ext.python.syntax.Atom.Name(new hydra.ext.python.syntax.Name("type")))), (hydra.util.Maybe<hydra.ext.python.syntax.Factor>) (hydra.util.Maybe.<hydra.ext.python.syntax.Factor>nothing()))))))))), (java.util.List<hydra.ext.python.syntax.CompareOpBitwiseOrPair>) (java.util.Collections.<hydra.ext.python.syntax.CompareOpBitwiseOrPair>emptyList()))))))))))), hydra.ext.python.Utils.indentedBlock(
      (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()),
      java.util.Arrays.asList(java.util.Arrays.asList(getItemMethod.get()))))));
    hydra.util.Lazy<hydra.ext.python.syntax.Kwarg> metaclassArg = new hydra.util.Lazy<>(() -> new hydra.ext.python.syntax.Kwarg(new hydra.ext.python.syntax.Name("metaclass"), new hydra.ext.python.syntax.Expression.Simple(new hydra.ext.python.syntax.Disjunction(java.util.Arrays.asList(new hydra.ext.python.syntax.Conjunction(java.util.Arrays.asList(new hydra.ext.python.syntax.Inversion.Simple(new hydra.ext.python.syntax.Comparison(new hydra.ext.python.syntax.BitwiseOr((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseOr>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseOr>nothing()), new hydra.ext.python.syntax.BitwiseXor((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseXor>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseXor>nothing()), new hydra.ext.python.syntax.BitwiseAnd((hydra.util.Maybe<hydra.ext.python.syntax.BitwiseAnd>) (hydra.util.Maybe.<hydra.ext.python.syntax.BitwiseAnd>nothing()), new hydra.ext.python.syntax.ShiftExpression((hydra.util.Maybe<hydra.ext.python.syntax.ShiftLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.ShiftLhs>nothing()), new hydra.ext.python.syntax.Sum((hydra.util.Maybe<hydra.ext.python.syntax.SumLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.SumLhs>nothing()), new hydra.ext.python.syntax.Term((hydra.util.Maybe<hydra.ext.python.syntax.TermLhs>) (hydra.util.Maybe.<hydra.ext.python.syntax.TermLhs>nothing()), new hydra.ext.python.syntax.Factor.Simple(new hydra.ext.python.syntax.Power(new hydra.ext.python.syntax.AwaitPrimary(false, new hydra.ext.python.syntax.Primary.Simple(new hydra.ext.python.syntax.Atom.Name(metaName))), (hydra.util.Maybe<hydra.ext.python.syntax.Factor>) (hydra.util.Maybe.<hydra.ext.python.syntax.Factor>nothing()))))))))), (java.util.List<hydra.ext.python.syntax.CompareOpBitwiseOrPair>) (java.util.Collections.<hydra.ext.python.syntax.CompareOpBitwiseOrPair>emptyList()))))))))));
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> unionClass = new hydra.util.Lazy<>(() -> hydra.ext.python.Utils.annotatedStatement(
      mcomment,
      hydra.ext.python.Utils.pyClassDefinitionToPyStatement(new hydra.ext.python.syntax.ClassDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), name, (java.util.List<hydra.ext.python.syntax.TypeParameter>) (java.util.Collections.<hydra.ext.python.syntax.TypeParameter>emptyList()), hydra.util.Maybe.just(new hydra.ext.python.syntax.Args((java.util.List<hydra.ext.python.syntax.PosArg>) (java.util.Collections.<hydra.ext.python.syntax.PosArg>emptyList()), java.util.Arrays.asList(new hydra.ext.python.syntax.KwargOrStarred.Kwarg(metaclassArg.get())), (java.util.List<hydra.ext.python.syntax.KwargOrDoubleStarred>) (java.util.Collections.<hydra.ext.python.syntax.KwargOrDoubleStarred>emptyList()))), hydra.ext.python.Utils.indentedBlock(
        (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()),
        bodyGroups.get())))));
    return java.util.Arrays.asList(
      metaClass.get(),
  ...
  static java.util.List<hydra.ext.python.syntax.Statement> unitVariantMethods(hydra.ext.python.syntax.Name className) {
    ...
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> returnIsinstance = new hydra.util.Lazy<>(() -> hydra.ext.python.Utils.pySimpleStatementToPyStatement(new hydra.ext.python.syntax.SimpleStatement.Return(new hydra.ext.python.syntax.ReturnStatement(java.util.Arrays.asList(new hydra.ext.python.syntax.StarExpression.Simple(hydra.ext.python.Utils.functionCall(
    ...
    hydra.ext.python.syntax.Statement returnHash = hydra.ext.python.Utils.pySimpleStatementToPyStatement(new hydra.ext.python.syntax.SimpleStatement.Return(new hydra.ext.python.syntax.ReturnStatement(java.util.Arrays.asList(new hydra.ext.python.syntax.StarExpression.Simple(hydra.ext.python.Utils.functionCall(
      ...
      java.util.Arrays.asList(hydra.ext.python.Utils.doubleQuotedString(classNameStr))))))));
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> hashMethod = new hydra.util.Lazy<>(() -> new hydra.ext.python.syntax.Statement.Compound(new hydra.ext.python.syntax.CompoundStatement.Function(new hydra.ext.python.syntax.FunctionDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), new hydra.ext.python.syntax.FunctionDefRaw(false, new hydra.ext.python.syntax.Name("__hash__"), (java.util.List<hydra.ext.python.syntax.TypeParameter>) (java.util.Collections.<hydra.ext.python.syntax.TypeParameter>emptyList()), hydra.util.Maybe.just(hydra.ext.python.Utils.selfOnlyParams()), (hydra.util.Maybe<hydra.ext.python.syntax.Expression>) (hydra.util.Maybe.<hydra.ext.python.syntax.Expression>nothing()), (hydra.util.Maybe<hydra.ext.python.syntax.FuncTypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.FuncTypeComment>nothing()), hydra.ext.python.Utils.indentedBlock(
      (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()),
      java.util.Arrays.asList(java.util.Arrays.asList(returnHash))))))));
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> slotsStmt = new hydra.util.Lazy<>(() -> hydra.ext.python.Utils.assignmentStatement(
      new hydra.ext.python.syntax.Name("__slots__"),
      hydra.ext.python.Utils.pyPrimaryToPyExpression(new hydra.ext.python.syntax.Primary.Simple(new hydra.ext.python.syntax.Atom.Tuple(new hydra.ext.python.syntax.Tuple((java.util.List<hydra.ext.python.syntax.StarNamedExpression>) (java.util.Collections.<hydra.ext.python.syntax.StarNamedExpression>emptyList())))))));
    return java.util.Arrays.asList(
      slotsStmt.get(),
      eqMethod.get(),
      hashMethod.get());
