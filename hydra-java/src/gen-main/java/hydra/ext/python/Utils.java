...
public interface Utils {
  ...
  static hydra.ext.python.syntax.Statement assignment(hydra.ext.python.syntax.Name name, hydra.ext.python.syntax.AnnotatedRhs rhs) {
    return hydra.ext.python.Utils.pyAssignmentToPyStatement(new hydra.ext.python.syntax.Assignment.Untyped(new hydra.ext.python.syntax.UntypedAssignment(hydra.util.ConsList.of(hydra.ext.python.Utils.pyNameToPyStarTarget(name)), rhs, (hydra.util.Maybe<hydra.ext.python.syntax.TypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.TypeComment>nothing()))));
  }
  ...
  static hydra.ext.python.syntax.Block indentedBlock(hydra.util.Maybe<String> mcomment, hydra.util.ConsList<hydra.util.ConsList<hydra.ext.python.syntax.Statement>> stmts) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.python.syntax.Statement>> commentGroup = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
      ...
      (java.util.function.Function<String, hydra.util.ConsList<hydra.ext.python.syntax.Statement>>) (s -> hydra.util.ConsList.of(hydra.ext.python.Utils.commentStatement(s))),
      mcomment));
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> new hydra.ext.python.syntax.Block.Indented(hydra.util.ConsList.of(hydra.util.ConsList.of(new hydra.ext.python.syntax.Statement.Simple(hydra.util.ConsList.of(hydra.ext.python.Utils.pyExpressionToPySimpleStatement(hydra.ext.python.Utils.pyAtomToPyExpression(new hydra.ext.python.syntax.Atom.Ellipsis()))))))),
  ...
  static hydra.util.ConsList<hydra.ext.python.syntax.Statement> unionTypeClassStatements310(hydra.ext.python.syntax.Name name, hydra.util.Maybe<String> mcomment, hydra.ext.python.syntax.Expression tyexpr, hydra.util.ConsList<hydra.ext.python.syntax.Statement> extraStmts) {
    ...
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> getItemMethod = new hydra.util.Lazy<>(() -> new hydra.ext.python.syntax.Statement.Compound(new hydra.ext.python.syntax.CompoundStatement.Function(new hydra.ext.python.syntax.FunctionDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), new hydra.ext.python.syntax.FunctionDefRaw(false, new hydra.ext.python.syntax.Name("__getitem__"), (hydra.util.ConsList<hydra.ext.python.syntax.TypeParameter>) (hydra.util.ConsList.<hydra.ext.python.syntax.TypeParameter>empty()), hydra.util.Maybe.just(hydra.ext.python.Utils.getItemParams()), (hydra.util.Maybe<hydra.ext.python.syntax.Expression>) (hydra.util.Maybe.<hydra.ext.python.syntax.Expression>nothing()), (hydra.util.Maybe<hydra.ext.python.syntax.FuncTypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.FuncTypeComment>nothing()), hydra.ext.python.Utils.indentedBlock(
  ...
  static hydra.util.ConsList<hydra.ext.python.syntax.Statement> unitVariantMethods(hydra.ext.python.syntax.Name className) {
    ...
    hydra.ext.python.syntax.Statement returnHash = hydra.ext.python.Utils.pySimpleStatementToPyStatement(new hydra.ext.python.syntax.SimpleStatement.Return(new hydra.ext.python.syntax.ReturnStatement(hydra.util.ConsList.of(new hydra.ext.python.syntax.StarExpression.Simple(hydra.ext.python.Utils.functionCall(
      ...
      hydra.util.ConsList.of(hydra.ext.python.Utils.doubleQuotedString(classNameStr))))))));
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> hashMethod = new hydra.util.Lazy<>(() -> new hydra.ext.python.syntax.Statement.Compound(new hydra.ext.python.syntax.CompoundStatement.Function(new hydra.ext.python.syntax.FunctionDefinition((hydra.util.Maybe<hydra.ext.python.syntax.Decorators>) (hydra.util.Maybe.<hydra.ext.python.syntax.Decorators>nothing()), new hydra.ext.python.syntax.FunctionDefRaw(false, new hydra.ext.python.syntax.Name("__hash__"), (hydra.util.ConsList<hydra.ext.python.syntax.TypeParameter>) (hydra.util.ConsList.<hydra.ext.python.syntax.TypeParameter>empty()), hydra.util.Maybe.just(hydra.ext.python.Utils.selfOnlyParams()), (hydra.util.Maybe<hydra.ext.python.syntax.Expression>) (hydra.util.Maybe.<hydra.ext.python.syntax.Expression>nothing()), (hydra.util.Maybe<hydra.ext.python.syntax.FuncTypeComment>) (hydra.util.Maybe.<hydra.ext.python.syntax.FuncTypeComment>nothing()), hydra.ext.python.Utils.indentedBlock(
      (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()),
    ...
    hydra.util.Lazy<hydra.ext.python.syntax.Statement> slotsStmt = new hydra.util.Lazy<>(() -> hydra.ext.python.Utils.assignmentStatement(
      ...
      hydra.ext.python.Utils.pyPrimaryToPyExpression(new hydra.ext.python.syntax.Primary.Simple(new hydra.ext.python.syntax.Atom.Tuple(new hydra.ext.python.syntax.Tuple((hydra.util.ConsList<hydra.ext.python.syntax.StarNamedExpression>) (hydra.util.ConsList.<hydra.ext.python.syntax.StarNamedExpression>empty())))))));
    return hydra.util.ConsList.of(
      slotsStmt.get(),
      eqMethod.get(),
      hashMethod.get());
