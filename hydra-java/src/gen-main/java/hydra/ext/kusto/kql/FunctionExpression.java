...
public class FunctionExpression implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.FunctionExpression");
  ...
  public final hydra.ext.kusto.kql.Function function;
  
  public final java.util.List<hydra.ext.kusto.kql.Expression> arguments;
  
  public FunctionExpression (hydra.ext.kusto.kql.Function function, java.util.List<hydra.ext.kusto.kql.Expression> arguments) {
  ...
  public FunctionExpression withFunction(hydra.ext.kusto.kql.Function function) {
    java.util.Objects.requireNonNull((function));
    return new FunctionExpression(function, arguments);
  }
  
  public FunctionExpression withArguments(java.util.List<hydra.ext.kusto.kql.Expression> arguments) {
    java.util.Objects.requireNonNull((arguments));
    return new FunctionExpression(function, arguments);
  }
}
