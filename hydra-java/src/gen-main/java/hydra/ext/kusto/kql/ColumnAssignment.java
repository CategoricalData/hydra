...
public class ColumnAssignment implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.ColumnAssignment");
  ...
  public ColumnAssignment (hydra.ext.kusto.kql.ColumnName column, hydra.ext.kusto.kql.Expression expression) {
  ...
  public ColumnAssignment withColumn(hydra.ext.kusto.kql.ColumnName column) {
    java.util.Objects.requireNonNull((column));
    return new ColumnAssignment(column, expression);
  }
  
  public ColumnAssignment withExpression(hydra.ext.kusto.kql.Expression expression) {
    java.util.Objects.requireNonNull((expression));
    return new ColumnAssignment(column, expression);
  }
}
