...
public abstract class Columns implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.Columns");
  ...
  public static final class All extends hydra.ext.kusto.kql.Columns implements Serializable {
    public All () {
  ...
  public static final class Single extends hydra.ext.kusto.kql.Columns implements Serializable {
    public final hydra.ext.kusto.kql.ColumnName value;
    
    public Single (hydra.ext.kusto.kql.ColumnName value) {
