...
public abstract class Order implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.Order");
  ...
  public static final class Ascending extends hydra.ext.kusto.kql.Order implements Serializable {
    public Ascending () {
  ...
  public static final class Descending extends hydra.ext.kusto.kql.Order implements Serializable {
    public Descending () {
