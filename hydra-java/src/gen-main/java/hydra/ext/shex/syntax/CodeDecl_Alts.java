...
public abstract class CodeDecl_Alts implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.CodeDecl.Alts");
  ...
  public static final class Code extends hydra.ext.shex.syntax.CodeDecl_Alts implements Serializable {
    public final hydra.ext.shex.syntax.Code value;
    
    public Code (hydra.ext.shex.syntax.Code value) {
  ...
  public static final class Percnt extends hydra.ext.shex.syntax.CodeDecl_Alts implements Serializable {
    public Percnt () {
