...
public class ShapeAtom_Sequence implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.ShapeAtom.Sequence");
  ...
  public final hydra.util.Opt<hydra.ext.shex.syntax.ShapeOrRef> shapeOrRef;
  
  public ShapeAtom_Sequence (hydra.ext.shex.syntax.NodeConstraint nodeConstraint, hydra.util.Opt<hydra.ext.shex.syntax.ShapeOrRef> shapeOrRef) {
  ...
  public ShapeAtom_Sequence withShapeOrRef(hydra.util.Opt<hydra.ext.shex.syntax.ShapeOrRef> shapeOrRef) {
    java.util.Objects.requireNonNull((shapeOrRef));
    return new ShapeAtom_Sequence(nodeConstraint, shapeOrRef);
  }
}
