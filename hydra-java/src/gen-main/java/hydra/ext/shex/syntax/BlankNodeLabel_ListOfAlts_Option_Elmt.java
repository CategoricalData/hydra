...
public abstract class BlankNodeLabel_ListOfAlts_Option_Elmt implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.BlankNodeLabel.ListOfAlts.Option.Elmt");
  ...
  public static final class PnChars extends hydra.ext.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt implements Serializable {
  ...
  public static final class Period extends hydra.ext.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt implements Serializable {
    public Period () {
