...
public class StringLiteralLong2_Elmt_Sequence implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.StringLiteralLong2.Elmt.Sequence");
  ...
  public final hydra.util.Opt<hydra.ext.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option> alts;
  
  public final String regex;
  
  public StringLiteralLong2_Elmt_Sequence (hydra.util.Opt<hydra.ext.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option> alts, String regex) {
  ...
  public StringLiteralLong2_Elmt_Sequence withAlts(hydra.util.Opt<hydra.ext.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option> alts) {
    java.util.Objects.requireNonNull((alts));
