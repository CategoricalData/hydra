...
public abstract class ShapeDefinition_ListOfAlts_Elmt {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/shex/syntax.ShapeDefinition.ListOfAlts.Elmt");
  ...
  public static final class IncludeSet extends hydra.ext.shex.syntax.ShapeDefinition_ListOfAlts_Elmt {
  ...
  public static final class ExtraPropertySet extends hydra.ext.shex.syntax.ShapeDefinition_ListOfAlts_Elmt {
  ...
  public static final class CLOSED extends hydra.ext.shex.syntax.ShapeDefinition_ListOfAlts_Elmt {
    public CLOSED () {
