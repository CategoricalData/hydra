...
public abstract class UnaryTripleExpr implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.UnaryTripleExpr");
  ...
  public static final class Sequence extends hydra.ext.shex.syntax.UnaryTripleExpr implements Serializable {
  ...
  public static final class Include extends hydra.ext.shex.syntax.UnaryTripleExpr implements Serializable {
