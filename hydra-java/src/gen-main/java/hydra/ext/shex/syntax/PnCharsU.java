...
public abstract class PnCharsU implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.PnCharsU");
  ...
  public static final class PnCharsBase extends hydra.ext.shex.syntax.PnCharsU implements Serializable {
    public final hydra.ext.shex.syntax.PnCharsBase value;
    
    public PnCharsBase (hydra.ext.shex.syntax.PnCharsBase value) {
  ...
  public static final class Lowbar extends hydra.ext.shex.syntax.PnCharsU implements Serializable {
    public Lowbar () {
