...
public abstract class TripleExprLabel implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.TripleExprLabel");
  ...
  public static final class Iri extends hydra.ext.shex.syntax.TripleExprLabel implements Serializable {
  ...
  public static final class BlankNode extends hydra.ext.shex.syntax.TripleExprLabel implements Serializable {
