...
public abstract class NumericLength {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/shex/syntax.NumericLength");
  ...
  public static final class TOTALDIGITS extends hydra.ext.shex.syntax.NumericLength {
    public TOTALDIGITS () {
  ...
  public static final class FRACTIONDIGITS extends hydra.ext.shex.syntax.NumericLength {
