...
public abstract class ShapeAtom {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/shex/syntax.ShapeAtom");
  ...
  public static final class Sequence extends hydra.ext.shex.syntax.ShapeAtom {
  ...
  public static final class ShapeOrRef extends hydra.ext.shex.syntax.ShapeAtom {
  ...
  public static final class Period extends hydra.ext.shex.syntax.ShapeAtom {
    public Period () {
