...
public abstract class StringLiteral2_Elmt implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.StringLiteral2.Elmt");
  ...
  public static final class Regex extends hydra.ext.shex.syntax.StringLiteral2_Elmt implements Serializable {
  ...
  public static final class Echar extends hydra.ext.shex.syntax.StringLiteral2_Elmt implements Serializable {
  ...
  public static final class Uchar extends hydra.ext.shex.syntax.StringLiteral2_Elmt implements Serializable {
