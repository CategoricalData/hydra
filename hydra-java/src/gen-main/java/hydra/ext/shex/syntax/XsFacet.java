...
public abstract class XsFacet implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.XsFacet");
  ...
  public static final class StringFacet extends hydra.ext.shex.syntax.XsFacet implements Serializable {
    public final hydra.ext.shex.syntax.StringFacet value;
    
    public StringFacet (hydra.ext.shex.syntax.StringFacet value) {
  ...
  public static final class NumericFacet extends hydra.ext.shex.syntax.XsFacet implements Serializable {
    public final hydra.ext.shex.syntax.NumericFacet value;
    
    public NumericFacet (hydra.ext.shex.syntax.NumericFacet value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
