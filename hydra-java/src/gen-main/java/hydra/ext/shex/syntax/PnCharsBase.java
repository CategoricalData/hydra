...
public abstract class PnCharsBase implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.PnCharsBase");
  ...
  public static final class Regex extends hydra.ext.shex.syntax.PnCharsBase implements Serializable {
  ...
  public static final class Regex2 extends hydra.ext.shex.syntax.PnCharsBase implements Serializable {
    public final String value;
