...
public abstract class InlineShapeOrRef implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.InlineShapeOrRef");
  ...
  public static final class InlineShapeDefinition extends hydra.ext.shex.syntax.InlineShapeOrRef implements Serializable {
  ...
  public static final class AtpNameLn extends hydra.ext.shex.syntax.InlineShapeOrRef implements Serializable {
  ...
  public static final class AtpNameNs extends hydra.ext.shex.syntax.InlineShapeOrRef implements Serializable {
  ...
  public static final class Sequence extends hydra.ext.shex.syntax.InlineShapeOrRef implements Serializable {
