...
public abstract class InlineShapeDefinition_ListOfAlts_Elmt implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.InlineShapeDefinition.ListOfAlts.Elmt");
  ...
  public static final class IncludeSet extends hydra.ext.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt implements Serializable {
  ...
  public static final class ExtraPropertySet extends hydra.ext.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt implements Serializable {
  ...
  public static final class CLOSED extends hydra.ext.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt implements Serializable {
    public CLOSED () {
