...
public class InlineShapeDefinition implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.InlineShapeDefinition");
  ...
  public InlineShapeDefinition (java.util.List<hydra.ext.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt> listOfAlts, hydra.util.Opt<hydra.ext.shex.syntax.TripleExpression> tripleExpression) {
  ...
  public InlineShapeDefinition withTripleExpression(hydra.util.Opt<hydra.ext.shex.syntax.TripleExpression> tripleExpression) {
    java.util.Objects.requireNonNull((tripleExpression));
    return new InlineShapeDefinition(listOfAlts, tripleExpression);
  }
}
