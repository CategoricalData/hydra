...
public abstract class Statement implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.Statement");
  ...
  public static final class Directive extends hydra.ext.shex.syntax.Statement implements Serializable {
    public final hydra.ext.shex.syntax.Directive value;
    
    public Directive (hydra.ext.shex.syntax.Directive value) {
  ...
  public static final class NotStartAction extends hydra.ext.shex.syntax.Statement implements Serializable {
