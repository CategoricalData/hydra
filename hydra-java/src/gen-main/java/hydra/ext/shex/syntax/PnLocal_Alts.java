...
public abstract class PnLocal_Alts {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/shex/syntax.PnLocal.Alts");
  ...
  public static final class PnCharsU extends hydra.ext.shex.syntax.PnLocal_Alts {
  ...
  public static final class Colon extends hydra.ext.shex.syntax.PnLocal_Alts {
    public Colon () {
  ...
  public static final class Regex extends hydra.ext.shex.syntax.PnLocal_Alts {
  ...
  public static final class Plx extends hydra.ext.shex.syntax.PnLocal_Alts {
