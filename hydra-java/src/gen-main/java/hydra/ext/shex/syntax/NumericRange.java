...
public abstract class NumericRange {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/shex/syntax.NumericRange");
  ...
  public static final class MININCLUSIVE extends hydra.ext.shex.syntax.NumericRange {
    public MININCLUSIVE () {
  ...
  public static final class MINEXCLUSIVE extends hydra.ext.shex.syntax.NumericRange {
    public MINEXCLUSIVE () {
  ...
  public static final class MAXINCLUSIVE extends hydra.ext.shex.syntax.NumericRange {
    public MAXINCLUSIVE () {
  ...
  public static final class MAXEXCLUSIVE extends hydra.ext.shex.syntax.NumericRange {
    public MAXEXCLUSIVE () {
