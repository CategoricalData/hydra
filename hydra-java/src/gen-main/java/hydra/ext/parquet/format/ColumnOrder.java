...
public abstract class ColumnOrder {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.ColumnOrder");
   ...
   */
  public static final class TypeOrder extends hydra.ext.parquet.format.ColumnOrder {
    public TypeOrder () {
