...
public class PageHeader {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.PageHeader");
  ...
  public final java.util.Optional<hydra.ext.parquet.format.DataPageHeader> dataPageHeader;
  
  public final java.util.Optional<hydra.ext.parquet.format.IndexPageHeader> indexPageHeader;
  
  public final java.util.Optional<hydra.ext.parquet.format.DictionaryPageHeader> dictionaryPageHeader;
  
  public final java.util.Optional<hydra.ext.parquet.format.DataPageHeaderV2> dataPageHeaderV2;
  
  public PageHeader (hydra.ext.parquet.format.PageType type, Integer uncompressedPageSize, Integer compressedPageSize, java.util.Optional<Integer> crc, java.util.Optional<hydra.ext.parquet.format.DataPageHeader> dataPageHeader, java.util.Optional<hydra.ext.parquet.format.IndexPageHeader> indexPageHeader, java.util.Optional<hydra.ext.parquet.format.DictionaryPageHeader> dictionaryPageHeader, java.util.Optional<hydra.ext.parquet.format.DataPageHeaderV2> dataPageHeaderV2) {
    this.type = type;
  ...
  public PageHeader withDataPageHeader(java.util.Optional<hydra.ext.parquet.format.DataPageHeader> dataPageHeader) {
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
  
  public PageHeader withIndexPageHeader(java.util.Optional<hydra.ext.parquet.format.IndexPageHeader> indexPageHeader) {
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
  
  public PageHeader withDictionaryPageHeader(java.util.Optional<hydra.ext.parquet.format.DictionaryPageHeader> dictionaryPageHeader) {
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
  
  public PageHeader withDataPageHeaderV2(java.util.Optional<hydra.ext.parquet.format.DataPageHeaderV2> dataPageHeaderV2) {
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
}