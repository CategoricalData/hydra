...
public class SchemaElement implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.SchemaElement");
   ...
   */
  public final hydra.util.Opt<hydra.ext.parquet.format.Type> type;
   ...
   */
  public final hydra.util.Opt<hydra.ext.parquet.format.FieldRepetitionType> repetitionType;
   ...
   */
  public final hydra.util.Opt<hydra.ext.parquet.format.LogicalType> logicalType;
  
  public SchemaElement (hydra.util.Opt<hydra.ext.parquet.format.Type> type, hydra.util.Opt<Integer> typeLength, hydra.util.Opt<hydra.ext.parquet.format.FieldRepetitionType> repetitionType, String name, hydra.util.Opt<Integer> numChildren, hydra.util.Opt<Integer> fieldId, hydra.util.Opt<hydra.ext.parquet.format.LogicalType> logicalType) {
  ...
  public SchemaElement withType(hydra.util.Opt<hydra.ext.parquet.format.Type> type) {
    java.util.Objects.requireNonNull((type));
  ...
  public SchemaElement withRepetitionType(hydra.util.Opt<hydra.ext.parquet.format.FieldRepetitionType> repetitionType) {
    java.util.Objects.requireNonNull((repetitionType));
    return new SchemaElement(type, typeLength, repetitionType, name, numChildren, fieldId, logicalType);
  }
  ...
  public SchemaElement withLogicalType(hydra.util.Opt<hydra.ext.parquet.format.LogicalType> logicalType) {
    java.util.Objects.requireNonNull((logicalType));
    return new SchemaElement(type, typeLength, repetitionType, name, numChildren, fieldId, logicalType);
  }
}
