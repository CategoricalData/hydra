...
public class SchemaElement {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.SchemaElement");
  
  /**
   * Data type for this field. Not set if the current element is a non-leaf node
   */
  public final java.util.Optional<hydra.ext.parquet.format.Type> type;
   ...
   */
  public final java.util.Optional<hydra.ext.parquet.format.FieldRepetitionType> repetitionType;
   ...
   */
  public final java.util.Optional<hydra.ext.parquet.format.LogicalType> logicalType;
  
  public SchemaElement (java.util.Optional<hydra.ext.parquet.format.Type> type, java.util.Optional<Integer> typeLength, java.util.Optional<hydra.ext.parquet.format.FieldRepetitionType> repetitionType, String name, java.util.Optional<Integer> numChildren, java.util.Optional<Integer> fieldId, java.util.Optional<hydra.ext.parquet.format.LogicalType> logicalType) {
    this.type = type;
  ...
  public SchemaElement withType(java.util.Optional<hydra.ext.parquet.format.Type> type) {
  ...
  public SchemaElement withRepetitionType(java.util.Optional<hydra.ext.parquet.format.FieldRepetitionType> repetitionType) {
    return new SchemaElement(type, typeLength, repetitionType, name, numChildren, fieldId, logicalType);
  }
  ...
  public SchemaElement withLogicalType(java.util.Optional<hydra.ext.parquet.format.LogicalType> logicalType) {
    return new SchemaElement(type, typeLength, repetitionType, name, numChildren, fieldId, logicalType);
  }
}