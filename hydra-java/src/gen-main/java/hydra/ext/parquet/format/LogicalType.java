...
public abstract class LogicalType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.LogicalType");
   ...
   */
  public static final class String_ extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public String_ () {
   ...
   */
  public static final class Map extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public Map () {
   ...
   */
  public static final class List extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public List () {
   ...
   */
  public static final class Enum_ extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public Enum_ () {
   ...
   */
  public static final class Decimal extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public final hydra.ext.parquet.format.DecimalType value;
    
    public Decimal (hydra.ext.parquet.format.DecimalType value) {
   ...
   */
  public static final class Date extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public Date () {
   ...
   */
  public static final class Time extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public final hydra.ext.parquet.format.TimeType value;
    
    public Time (hydra.ext.parquet.format.TimeType value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
   ...
   */
  public static final class Timestamp extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public final hydra.ext.parquet.format.TimestampType value;
    
    public Timestamp (hydra.ext.parquet.format.TimestampType value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
   ...
   */
  public static final class Integer_ extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public final hydra.ext.parquet.format.IntType value;
    
    public Integer_ (hydra.ext.parquet.format.IntType value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
   ...
   */
  public static final class Unknown extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public Unknown () {
   ...
   */
  public static final class Json extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public Json () {
   ...
   */
  public static final class Bson extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public Bson () {
   ...
   * no compatible ConvertedType
   */
  public static final class Uuid extends hydra.ext.parquet.format.LogicalType implements Serializable {
    public Uuid () {
