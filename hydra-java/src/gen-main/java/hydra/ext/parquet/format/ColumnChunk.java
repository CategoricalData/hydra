...
public class ColumnChunk {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.ColumnChunk");
   ...
   */
  public final java.util.Optional<hydra.ext.parquet.format.ColumnMetaData> metaData;
   ...
   */
  public final java.util.Optional<hydra.ext.parquet.format.ColumnCryptoMetaData> cryptoMetadata;
  
  public final java.util.Optional<String> encryptedColumnMetadata;
  
  public ColumnChunk (java.util.Optional<String> filePath, Long fileOffset, java.util.Optional<hydra.ext.parquet.format.ColumnMetaData> metaData, java.util.Optional<Long> offsetIndexOffset, java.util.Optional<Integer> offsetIndexLength, java.util.Optional<Long> columnIndexOffset, java.util.Optional<Integer> columnIndexLength, java.util.Optional<hydra.ext.parquet.format.ColumnCryptoMetaData> cryptoMetadata, java.util.Optional<String> encryptedColumnMetadata) {
  ...
  public ColumnChunk withMetaData(java.util.Optional<hydra.ext.parquet.format.ColumnMetaData> metaData) {
    return new ColumnChunk(filePath, fileOffset, metaData, offsetIndexOffset, offsetIndexLength, columnIndexOffset, columnIndexLength, cryptoMetadata, encryptedColumnMetadata);
  }
  ...
  public ColumnChunk withCryptoMetadata(java.util.Optional<hydra.ext.parquet.format.ColumnCryptoMetaData> cryptoMetadata) {
    return new ColumnChunk(filePath, fileOffset, metaData, offsetIndexOffset, offsetIndexLength, columnIndexOffset, columnIndexLength, cryptoMetadata, encryptedColumnMetadata);
  }
