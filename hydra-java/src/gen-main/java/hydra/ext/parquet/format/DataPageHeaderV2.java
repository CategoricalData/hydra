...
public class DataPageHeaderV2 {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.DataPageHeaderV2");
  ...
  public DataPageHeaderV2 (Integer numValues, Integer numNulls, Integer numRows, hydra.ext.parquet.format.Encoding encoding, Integer definitionLevelsByteLength, Integer repetitionLevelsByteLength, java.util.Optional<Boolean> isCompressed, java.util.Optional<hydra.ext.parquet.format.Statistics> statistics) {
  ...
  public DataPageHeaderV2 withStatistics(java.util.Optional<hydra.ext.parquet.format.Statistics> statistics) {
    return new DataPageHeaderV2(numValues, numNulls, numRows, encoding, definitionLevelsByteLength, repetitionLevelsByteLength, isCompressed, statistics);
  }
}