...
public abstract class CompressionCodec {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.CompressionCodec");
  ...
  public static final class Uncompressed extends hydra.ext.parquet.format.CompressionCodec {
    public Uncompressed () {
  ...
  public static final class Snappy extends hydra.ext.parquet.format.CompressionCodec {
    public Snappy () {
  ...
  public static final class Gzip extends hydra.ext.parquet.format.CompressionCodec {
    public Gzip () {
  ...
  public static final class Lzo extends hydra.ext.parquet.format.CompressionCodec {
    public Lzo () {
   ...
   * Added in 2.4
   */
  public static final class Brotli extends hydra.ext.parquet.format.CompressionCodec {
    public Brotli () {
   ...
   * Added in 2.4
   */
  public static final class Zstd extends hydra.ext.parquet.format.CompressionCodec {
    public Zstd () {
   ...
   * Added in 2.9
   */
  public static final class Lz4Raw extends hydra.ext.parquet.format.CompressionCodec {
    public Lz4Raw () {
