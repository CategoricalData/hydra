...
public abstract class BloomFilterCompression {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.BloomFilterCompression");
  ...
  public static final class Uncompressed extends hydra.ext.parquet.format.BloomFilterCompression {
    public Uncompressed () {
