...
public class ColumnIndex {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.ColumnIndex");
  ...
  public ColumnIndex (java.util.List<Boolean> nullPages, java.util.List<String> minValues, java.util.List<String> maxValues, hydra.ext.parquet.format.BoundaryOrder boundaryOrder, java.util.Optional<java.util.List<Long>> nullCounts) {
