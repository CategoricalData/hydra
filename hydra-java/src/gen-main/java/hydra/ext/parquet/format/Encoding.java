...
public abstract class Encoding {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.Encoding");
   ...
   */
  public static final class Plain extends hydra.ext.parquet.format.Encoding {
    public Plain () {
   ...
   */
  public static final class Rle extends hydra.ext.parquet.format.Encoding {
    public Rle () {
   ...
   */
  public static final class BitPacked extends hydra.ext.parquet.format.Encoding {
    public BitPacked () {
   ...
   */
  public static final class DeltaBinaryPacked extends hydra.ext.parquet.format.Encoding {
   ...
   */
  public static final class DeltaLengthByteArray extends hydra.ext.parquet.format.Encoding {
   ...
   */
  public static final class DeltaByteArray extends hydra.ext.parquet.format.Encoding {
   ...
   */
  public static final class RleDictionary extends hydra.ext.parquet.format.Encoding {
   ...
   */
  public static final class ByteStreamSplit extends hydra.ext.parquet.format.Encoding {
