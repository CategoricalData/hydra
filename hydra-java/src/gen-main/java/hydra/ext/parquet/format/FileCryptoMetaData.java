...
public class FileCryptoMetaData {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.FileCryptoMetaData");
  ...
  public FileCryptoMetaData (hydra.ext.parquet.format.EncryptionAlgorithm encryptionAlgorithm, java.util.Optional<String> keyMetadata) {
