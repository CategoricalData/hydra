...
public abstract class BoundaryOrder {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.BoundaryOrder");
  ...
  public static final class Unordered extends hydra.ext.parquet.format.BoundaryOrder {
    public Unordered () {
  ...
  public static final class Ascending extends hydra.ext.parquet.format.BoundaryOrder {
    public Ascending () {
  ...
  public static final class Descending extends hydra.ext.parquet.format.BoundaryOrder {
    public Descending () {
