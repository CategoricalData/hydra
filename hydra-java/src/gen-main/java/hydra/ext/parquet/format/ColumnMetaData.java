...
public class ColumnMetaData {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.ColumnMetaData");
  
  /**
   * Type of this column
   */
  public final hydra.ext.parquet.format.Type type;
  
  /**
   * Set of all encodings used for this column. The purpose is to validate whether we can decode those pages.
   */
  public final java.util.List<hydra.ext.parquet.format.Encoding> encodings;
   ...
   * Compression codec
   */
  public final hydra.ext.parquet.format.CompressionCodec codec;
   ...
   */
  public final java.util.Optional<java.util.List<hydra.ext.parquet.format.PageEncodingStats>> encodingStats;
  ...
  public ColumnMetaData (hydra.ext.parquet.format.Type type, java.util.List<hydra.ext.parquet.format.Encoding> encodings, java.util.List<String> pathInSchema, hydra.ext.parquet.format.CompressionCodec codec, Long numValues, Long totalUncompressedSize, Long totalCompressedSize, java.util.Optional<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata, Long dataPageOffset, java.util.Optional<Long> indexPageOffset, java.util.Optional<Long> dictionaryPageOffset, java.util.Optional<hydra.ext.parquet.format.Statistics> statistics, java.util.Optional<java.util.List<hydra.ext.parquet.format.PageEncodingStats>> encodingStats, java.util.Optional<Long> bloomFilterOffset) {
    this.type = type;
  ...
  public ColumnMetaData withType(hydra.ext.parquet.format.Type type) {
  ...
  public ColumnMetaData withEncodings(java.util.List<hydra.ext.parquet.format.Encoding> encodings) {
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
  ...
  public ColumnMetaData withCodec(hydra.ext.parquet.format.CompressionCodec codec) {
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
  ...
  public ColumnMetaData withKeyValueMetadata(java.util.Optional<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata) {
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
  ...
  public ColumnMetaData withStatistics(java.util.Optional<hydra.ext.parquet.format.Statistics> statistics) {
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
  
  public ColumnMetaData withEncodingStats(java.util.Optional<java.util.List<hydra.ext.parquet.format.PageEncodingStats>> encodingStats) {
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
