...
public abstract class TimeUnit {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.TimeUnit");
  ...
  public static final class Millis extends hydra.ext.parquet.format.TimeUnit {
    public Millis () {
  ...
  public static final class Micros extends hydra.ext.parquet.format.TimeUnit {
    public Micros () {
  ...
  public static final class Nanos extends hydra.ext.parquet.format.TimeUnit {
    public Nanos () {
