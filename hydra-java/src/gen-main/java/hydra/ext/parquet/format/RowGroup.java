...
public class RowGroup {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.RowGroup");
   ...
   */
  public final java.util.Optional<java.util.List<hydra.ext.parquet.format.SortingColumn>> sortingColumns;
  ...
  public RowGroup (java.util.List<hydra.ext.parquet.format.ColumnChunk> columns, Long totalByteSize, Long numRows, java.util.Optional<java.util.List<hydra.ext.parquet.format.SortingColumn>> sortingColumns, java.util.Optional<Long> fileOffset, java.util.Optional<Long> totalCompressedSize, java.util.Optional<Short> ordinal) {
  ...
  public RowGroup withSortingColumns(java.util.Optional<java.util.List<hydra.ext.parquet.format.SortingColumn>> sortingColumns) {
    return new RowGroup(columns, totalByteSize, numRows, sortingColumns, fileOffset, totalCompressedSize, ordinal);
  }
