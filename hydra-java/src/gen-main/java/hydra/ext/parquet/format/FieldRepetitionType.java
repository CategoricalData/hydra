...
public abstract class FieldRepetitionType {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.FieldRepetitionType");
   ...
   */
  public static final class Required extends hydra.ext.parquet.format.FieldRepetitionType {
    public Required () {
   ...
   */
  public static final class Optional extends hydra.ext.parquet.format.FieldRepetitionType {
    public Optional () {
   ...
   */
  public static final class Repeated extends hydra.ext.parquet.format.FieldRepetitionType {
    public Repeated () {
