...
public abstract class PageType {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.PageType");
  ...
  public static final class DataPage extends hydra.ext.parquet.format.PageType {
    public DataPage () {
  ...
  public static final class IndexPage extends hydra.ext.parquet.format.PageType {
    public IndexPage () {
  ...
  public static final class DictionaryPage extends hydra.ext.parquet.format.PageType {
  ...
  public static final class DataPageV2 extends hydra.ext.parquet.format.PageType {
    public DataPageV2 () {
