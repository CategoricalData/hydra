...
public class FileMetaData {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.FileMetaData");
   ...
   */
  public final java.util.List<hydra.ext.parquet.format.SchemaElement> schema;
   ...
   */
  public final java.util.List<hydra.ext.parquet.format.RowGroup> rowGroups;
  
  /**
   * Optional key/value metadata
   */
  public final java.util.Optional<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata;
   ...
   */
  public final java.util.Optional<java.util.List<hydra.ext.parquet.format.ColumnOrder>> columnOrders;
   ...
   */
  public final java.util.Optional<hydra.ext.parquet.format.EncryptionAlgorithm> encryptionAlgorithm;
  
  public final java.util.Optional<String> footerSigningKeyMetadata;
  
  public FileMetaData (Integer version, java.util.List<hydra.ext.parquet.format.SchemaElement> schema, Long numRows, java.util.List<hydra.ext.parquet.format.RowGroup> rowGroups, java.util.Optional<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata, java.util.Optional<String> createdBy, java.util.Optional<java.util.List<hydra.ext.parquet.format.ColumnOrder>> columnOrders, java.util.Optional<hydra.ext.parquet.format.EncryptionAlgorithm> encryptionAlgorithm, java.util.Optional<String> footerSigningKeyMetadata) {
  ...
  public FileMetaData withSchema(java.util.List<hydra.ext.parquet.format.SchemaElement> schema) {
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
  ...
  public FileMetaData withRowGroups(java.util.List<hydra.ext.parquet.format.RowGroup> rowGroups) {
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
  
  public FileMetaData withKeyValueMetadata(java.util.Optional<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata) {
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
  ...
  public FileMetaData withColumnOrders(java.util.Optional<java.util.List<hydra.ext.parquet.format.ColumnOrder>> columnOrders) {
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
  
  public FileMetaData withEncryptionAlgorithm(java.util.Optional<hydra.ext.parquet.format.EncryptionAlgorithm> encryptionAlgorithm) {
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
