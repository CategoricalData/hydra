...
public class FileMetaData implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.FileMetaData");
   ...
   */
  public final hydra.util.Opt<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata;
   ...
   */
  public final hydra.util.Opt<java.util.List<hydra.ext.parquet.format.ColumnOrder>> columnOrders;
   ...
   */
  public final hydra.util.Opt<hydra.ext.parquet.format.EncryptionAlgorithm> encryptionAlgorithm;
  ...
  public FileMetaData (Integer version, java.util.List<hydra.ext.parquet.format.SchemaElement> schema, Long numRows, java.util.List<hydra.ext.parquet.format.RowGroup> rowGroups, hydra.util.Opt<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata, hydra.util.Opt<String> createdBy, hydra.util.Opt<java.util.List<hydra.ext.parquet.format.ColumnOrder>> columnOrders, hydra.util.Opt<hydra.ext.parquet.format.EncryptionAlgorithm> encryptionAlgorithm, hydra.util.Opt<String> footerSigningKeyMetadata) {
  ...
  public FileMetaData withKeyValueMetadata(hydra.util.Opt<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata) {
    java.util.Objects.requireNonNull((keyValueMetadata));
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
  ...
  public FileMetaData withColumnOrders(hydra.util.Opt<java.util.List<hydra.ext.parquet.format.ColumnOrder>> columnOrders) {
    java.util.Objects.requireNonNull((columnOrders));
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
  
  public FileMetaData withEncryptionAlgorithm(hydra.util.Opt<hydra.ext.parquet.format.EncryptionAlgorithm> encryptionAlgorithm) {
    java.util.Objects.requireNonNull((encryptionAlgorithm));
    return new FileMetaData(version, schema, numRows, rowGroups, keyValueMetadata, createdBy, columnOrders, encryptionAlgorithm, footerSigningKeyMetadata);
  }
