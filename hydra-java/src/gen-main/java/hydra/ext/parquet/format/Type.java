...
public abstract class Type {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/ext/parquet/format.Type");
  ...
  public static final class Boolean_ extends hydra.ext.parquet.format.Type {
    public Boolean_ () {
  ...
  public static final class Int32 extends hydra.ext.parquet.format.Type {
    public Int32 () {
  ...
  public static final class Int64 extends hydra.ext.parquet.format.Type {
    public Int64 () {
  ...
  public static final class Float_ extends hydra.ext.parquet.format.Type {
    public Float_ () {
  ...
  public static final class Double_ extends hydra.ext.parquet.format.Type {
    public Double_ () {
  ...
  public static final class ByteArray extends hydra.ext.parquet.format.Type {
    public ByteArray () {
  ...
  public static final class FixedLenByteArray extends hydra.ext.parquet.format.Type {
