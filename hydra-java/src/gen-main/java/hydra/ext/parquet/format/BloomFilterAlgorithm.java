...
public abstract class BloomFilterAlgorithm implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.BloomFilterAlgorithm");
   ...
   */
  public static final class Block extends hydra.ext.parquet.format.BloomFilterAlgorithm implements Serializable {
    public Block () {
