...
public interface Schemas {
  static <T0> hydra.module.Namespaces<T0> addNamesToNamespaces(java.util.function.Function<hydra.module.Namespace, T0> encodeNamespace, hydra.util.PersistentSet<hydra.core.Name> names, hydra.module.Namespaces<T0> ns0) {
    ...
    return (hydra.module.Namespaces<T0>) (new hydra.module.Namespaces<T0>(((java.util.function.Function<hydra.module.Namespaces<T0>, hydra.util.Pair<hydra.module.Namespace, T0>>) (projected -> projected.focus)).apply(ns0), hydra.lib.maps.Union.apply(
      ...
      hydra.lib.maps.FromList.apply(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.module.Namespace, hydra.util.Pair<hydra.module.Namespace, T0>>) (v1 -> hydra.Schemas.<T0>addNamesToNamespaces_toPair(
          encodeNamespace,
          v1)),
  ...
  static hydra.util.PersistentSet<hydra.module.Namespace> definitionDependencyNamespaces(hydra.util.ConsList<hydra.module.Definition> defs) {
    java.util.function.Function<hydra.module.Definition, hydra.util.PersistentSet<hydra.core.Name>> defNames = (java.util.function.Function<hydra.module.Definition, hydra.util.PersistentSet<hydra.core.Name>>) (def -> (def).accept(new hydra.module.Definition.PartialVisitor<>() {
      ...
      public hydra.util.PersistentSet<hydra.core.Name> visit(hydra.module.Definition.Type typeDef) {
        return hydra.Rewriting.typeDependencyNames(
          true,
          (typeDef).value.type);
      }
      ...
      public hydra.util.PersistentSet<hydra.core.Name> visit(hydra.module.Definition.Term termDef) {
        return hydra.Rewriting.termDependencyNames(
          true,
          true,
          true,
          (termDef).value.term);
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentSet<hydra.module.Namespace>> dependencyNamespaces(hydra.context.Context cx, hydra.graph.Graph graph, Boolean binds, Boolean withPrims, Boolean withNoms, Boolean withSchema, hydra.util.ConsList<hydra.core.Binding> els) {
    java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentSet<hydra.core.Name>>> depNames = (java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentSet<hydra.core.Name>>>) (el -> {
      ...
      hydra.util.PersistentSet<hydra.core.Name> dataNames = hydra.Rewriting.termDependencyNames(
        binds,
        withPrims,
        withNoms,
        term);
      hydra.core.Term deannotatedTerm = hydra.Rewriting.deannotateTerm(term);
      hydra.util.Lazy<hydra.util.PersistentSet<hydra.core.Name>> schemaNames = new hydra.util.Lazy<>(() -> hydra.lib.logic.IfElse.lazy(
        ...
        () -> hydra.lib.maybes.Maybe.applyLazy(
          ...
          (java.util.function.Function<hydra.core.TypeScheme, hydra.util.PersistentSet<hydra.core.Name>>) (ts -> hydra.Rewriting.typeDependencyNames(
            true,
            (ts).type)),
          (el).type),
        () -> (hydra.util.PersistentSet<hydra.core.Name>) (hydra.lib.sets.Empty.<hydra.core.Name>apply())));
      return hydra.lib.logic.IfElse.lazy(
        ...
        () -> hydra.lib.eithers.Map.apply(
          (java.util.function.Function<hydra.core.Type, hydra.util.PersistentSet<hydra.core.Name>>) (typ -> hydra.lib.sets.Unions.apply(hydra.util.ConsList.of(
            dataNames,
            schemaNames.get(),
            hydra.Rewriting.typeDependencyNames(
              true,
              typ)))),
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.core.Binding>> elementsWithDependencies(hydra.context.Context cx, hydra.graph.Graph graph, hydra.util.ConsList<hydra.core.Binding> original) {
    java.util.function.Function<hydra.core.Binding, hydra.util.ConsList<hydra.core.Name>> depNames = (java.util.function.Function<hydra.core.Binding, hydra.util.ConsList<hydra.core.Name>>) (el -> hydra.lib.sets.ToList.apply(hydra.Rewriting.termDependencyNames(
      true,
      false,
      false,
      (el).term)));
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentMap<hydra.core.Name, hydra.core.Type>> fieldTypes(hydra.context.Context cx, hydra.graph.Graph graph, hydra.core.Type t) {
    ...
    return hydra.Rewriting.deannotateType(t).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentMap<hydra.core.Name, hydra.core.Type>> visit(hydra.core.Type.Forall ft) {
        return hydra.Schemas.fieldTypes(
          cx,
          graph,
          (ft).value.body);
      }
  ...
  static hydra.util.Pair<hydra.core.Name, hydra.context.Context> freshName(hydra.context.Context cx) {
    Integer count = hydra.Annotations.getCount(
      ...
      cx);
    return (hydra.util.Pair<hydra.core.Name, hydra.context.Context>) ((hydra.util.Pair<hydra.core.Name, hydra.context.Context>) (new hydra.util.Pair<hydra.core.Name, hydra.context.Context>(hydra.Schemas.normalTypeVariable(count), hydra.Annotations.putCount(
      hydra.Constants.key_freshTypeVariableCount(),
  ...
  static hydra.core.Type fullyStripType(hydra.core.Type typ) {
    return hydra.Rewriting.deannotateType(typ).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public hydra.core.Type visit(hydra.core.Type.Forall ft) {
        return hydra.Schemas.fullyStripType((ft).value.body);
      }
    });
  }
  ...
  static hydra.core.Term graphAsTerm(hydra.util.ConsList<hydra.core.Binding> bindings, hydra.core.Term body) {
    return new hydra.core.Term.Let(hydra.Schemas.graphAsLet(
      bindings,
      body));
  }
  ...
  static hydra.util.Pair<hydra.core.Type, hydra.context.Context> instantiateType(hydra.context.Context cx, hydra.core.Type typ) {
    hydra.util.Pair<hydra.core.TypeScheme, hydra.context.Context> result = hydra.Schemas.instantiateTypeScheme(
      cx,
      hydra.Schemas.typeToTypeScheme(typ));
    return (hydra.util.Pair<hydra.core.Type, hydra.context.Context>) ((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) (new hydra.util.Pair<hydra.core.Type, hydra.context.Context>(hydra.Rewriting.typeSchemeToFType(hydra.lib.pairs.First.apply(result)), hydra.lib.pairs.Second.apply(result))));
  }
  ...
  static hydra.util.Pair<hydra.core.TypeScheme, hydra.context.Context> instantiateTypeScheme(hydra.context.Context cx, hydra.core.TypeScheme scheme) {
    ...
    hydra.util.Lazy<hydra.util.Pair<hydra.util.ConsList<hydra.core.Name>, hydra.context.Context>> result = new hydra.util.Lazy<>(() -> hydra.Schemas.freshNames(
  ...
  static Boolean isEncodedTerm(hydra.core.Term t) {
    return hydra.Rewriting.deannotateTerm(t).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      public Boolean visit(hydra.core.Term.Application a) {
        return hydra.Schemas.isEncodedTerm((a).value.function);
      }
  ...
  static Boolean isEncodedType(hydra.core.Term t) {
    return hydra.Rewriting.deannotateTerm(t).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      @Override
      public Boolean visit(hydra.core.Term.Application a) {
        return hydra.Schemas.isEncodedType((a).value.function);
      }
  ...
  static Boolean isEnumRowType(hydra.util.ConsList<hydra.core.FieldType> rt) {
    return hydra.lib.lists.Foldl.apply(
      ...
      true,
      hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.core.FieldType, Boolean>) (f -> hydra.Schemas.isUnitType(hydra.Rewriting.deannotateType((f).type))),
        rt));
  }
  ...
  static Boolean isEnumType(hydra.core.Type typ) {
    return hydra.Rewriting.deannotateType(typ).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public Boolean visit(hydra.core.Type.Union rt) {
        return hydra.Schemas.isEnumRowType((rt).value);
      }
    });
  }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, Boolean> isSerializable(hydra.context.Context cx, hydra.graph.Graph graph, hydra.core.Binding el) {
    ...
    return hydra.lib.eithers.Map.apply(
      ...
      hydra.Schemas.typeDependencies(
        cx,
        graph,
        false,
  ...
  static Boolean isType(hydra.core.Type t) {
    return hydra.Rewriting.deannotateType(t).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public Boolean visit(hydra.core.Type.Application a) {
        return hydra.Schemas.isType((a).value.function);
      }

      @Override
      public Boolean visit(hydra.core.Type.Forall l) {
        return hydra.Schemas.isType((l).value.body);
      }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentSet<hydra.module.Namespace>> moduleDependencyNamespaces(hydra.context.Context cx, hydra.graph.Graph graph, Boolean binds, Boolean withPrims, Boolean withNoms, Boolean withSchema, hydra.module.Module mod) {
    ...
    return hydra.lib.eithers.Map.apply(
      (java.util.function.Function<hydra.util.PersistentSet<hydra.module.Namespace>, hydra.util.PersistentSet<hydra.module.Namespace>>) (deps -> hydra.lib.sets.Delete.apply(
        (mod).namespace,
        deps)),
      hydra.Schemas.dependencyNamespaces(
        cx,
        graph,
        binds,
        withPrims,
  ...
  static <T0> hydra.module.Namespaces<T0> namespacesForDefinitions(java.util.function.Function<hydra.module.Namespace, T0> encodeNamespace, hydra.module.Namespace focusNs, hydra.util.ConsList<hydra.module.Definition> defs) {
    ...
    java.util.function.Function<hydra.module.Namespace, hydra.util.Pair<hydra.module.Namespace, T0>> toPair = (java.util.function.Function<hydra.module.Namespace, hydra.util.Pair<hydra.module.Namespace, T0>>) (v1 -> hydra.Schemas.<T0>namespacesForDefinitions_toPair(
      encodeNamespace,
      v1));
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.ConsList<hydra.core.FieldType>> requireRecordType(hydra.context.Context cx, hydra.graph.Graph graph, hydra.core.Name name) {
    ...
    return hydra.Schemas.requireRowType(
      cx,
      "record type",
      toRecord,
      graph,
        ...
        return hydra.lib.maybes.Maybe.applyLazy(
          () -> hydra.lib.maybes.Map.apply(
            ...
            hydra.lib.maps.Lookup.apply(
              (name).value,
              (graph).boundTypes)),
          (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Maybe<hydra.core.Type>>) (ts -> hydra.util.Maybe.just(hydra.Rewriting.typeSchemeToFType(ts))),
          hydra.lib.maps.Lookup.apply(
            (name).value,
            (graph).schemaTypes));
      }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentMap<hydra.core.Name, hydra.core.TypeScheme>> schemaGraphToTypingEnvironment(hydra.context.Context cx, hydra.graph.Graph g) {
    ...
    toTypeScheme.set((java.util.function.Function<hydra.util.ConsList<hydra.core.Name>, java.util.function.Function<hydra.core.Type, hydra.core.TypeScheme>>) (vars -> (java.util.function.Function<hydra.core.Type, hydra.core.TypeScheme>) (typ -> hydra.Rewriting.deannotateType(typ).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
    ...
    java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.core.TypeScheme>>>> toPair = (java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.core.TypeScheme>>>>) (el -> {
      ...
      return hydra.lib.eithers.Bind.apply(
        hydra.lib.maybes.Maybe.applyLazy(
          () -> hydra.lib.eithers.Map.apply(
            (java.util.function.Function<hydra.core.Type, hydra.util.Maybe<hydra.core.TypeScheme>>) (typ -> hydra.util.Maybe.just(hydra.Rewriting.fTypeToTypeScheme(typ))),
            (decodeType).apply((el).term)),
          (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Maybe<hydra.core.TypeScheme>>>) (ts -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> hydra.lib.logic.IfElse.lazy(
              ...
              () -> hydra.lib.eithers.Map.apply(
                (java.util.function.Function<hydra.core.Type, hydra.util.Maybe<hydra.core.TypeScheme>>) (decoded -> hydra.util.Maybe.just(toTypeScheme.get().apply((hydra.util.ConsList<hydra.core.Name>) (hydra.util.ConsList.<hydra.core.Name>empty())).apply(decoded))),
                (decodeType).apply((el).term)),
              () -> (forTerm).apply(hydra.Rewriting.deannotateTerm((el).term))))),
          (el).type),
      ...
      () -> hydra.lib.eithers.Bind.apply(
        ...
        (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.core.Name, hydra.core.Type>>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.PersistentMap<hydra.core.Name, hydra.core.Type>>>) (pairs -> {
          ...
          hydra.util.Lazy<hydra.util.PersistentSet<hydra.core.Name>> refs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
            ...
            (hydra.util.PersistentSet<hydra.core.Name>) (hydra.lib.sets.Empty.<hydra.core.Name>apply()),
            hydra.lib.lists.Map.apply(
              (java.util.function.Function<hydra.util.Pair<hydra.core.Name, hydra.core.Type>, hydra.util.PersistentSet<hydra.core.Name>>) (pair -> hydra.Rewriting.typeDependencyNames(
                withSchema,
  ...
  static hydra.core.TypeScheme typeToTypeScheme(hydra.core.Type t0) {
    ...
    helper.set((java.util.function.Function<hydra.util.ConsList<hydra.core.Name>, java.util.function.Function<hydra.core.Type, hydra.core.TypeScheme>>) (vars -> (java.util.function.Function<hydra.core.Type, hydra.core.TypeScheme>) (t -> hydra.Rewriting.deannotateType(t).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
      public hydra.core.TypeScheme otherwise(hydra.core.Type instance) {
  ...
  static <T0, T1, T2> T2 withLambdaContext(java.util.function.Function<T0, hydra.graph.Graph> getContext, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<T0, T1>> setContext, T0 env, hydra.core.Lambda lam, java.util.function.Function<T1, T2> body) {
    hydra.graph.Graph newContext = hydra.Rewriting.extendGraphForLambda(
  ...
  static <T0, T1, T2> T2 withLetContext(java.util.function.Function<T0, hydra.graph.Graph> getContext, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<T0, T1>> setContext, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Binding, hydra.util.Maybe<hydra.core.Term>>> forBinding, T0 env, hydra.core.Let letrec, java.util.function.Function<T1, T2> body) {
    hydra.graph.Graph newContext = hydra.Rewriting.extendGraphForLet(
      forBinding,
      (getContext).apply(env),
      letrec);
    return (body).apply((setContext).apply(newContext).apply(env));
  ...
  static <T0, T1, T2> T2 withTypeLambdaContext(java.util.function.Function<T0, hydra.graph.Graph> getContext, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<T0, T1>> setContext, T0 env, hydra.core.TypeLambda tlam, java.util.function.Function<T1, T2> body) {
    hydra.graph.Graph newContext = hydra.Rewriting.extendGraphForTypeLambda(
      (getContext).apply(env),
      tlam);
    return (body).apply((setContext).apply(newContext).apply(env));
  }
