...
//  static <M, X> java.util.function.Function<X, X> skipAnnotations(java.util.function.Function<X, java.util.Optional<hydra.core.Annotated<M, X>>> getAnn) {
//    java.util.function.Function<X, X> skip = t1 -> m -> m.map(ann -> ((skip)).apply(((ann)).subject));
//    return t -> ((skip)).apply((t));
//  }
