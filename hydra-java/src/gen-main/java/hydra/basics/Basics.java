...
public interface Basics {
  ...
  static <A> hydra.core.Term<A> stripTerm(hydra.core.Term<A> x) {
    return hydra.basics.Basics.skipAnnotations(
      v1 -> ((v1)).accept(new hydra.core.Term.PartialVisitor<>() {
        @Override
        public java.util.Optional<hydra.core.Annotated<hydra.core.Term<M>, M>> otherwise(hydra.core.Term<A> instance) {
          return java.util.Optional.empty();
        }

        @Override
        public java.util.Optional<hydra.core.Annotated<hydra.core.Term<M>, M>> visit(hydra.core.Term.Annotated<A> instance) {
  ...
  static <A> hydra.core.Term<A> stripTerm2(hydra.core.Term<A> x) {
    java.util.function.Function<hydra.core.Term<A>, java.util.Optional<hydra.core.Annotated<hydra.core.Term<A>, A>>>
        fun = new java.util.function.Function<hydra.core.Term<A>, java.util.Optional<hydra.core.Annotated<hydra.core.Term<A>, A>>>() {
      @Override
      public java.util.Optional<hydra.core.Annotated<hydra.core.Term<A>, A>> apply(final hydra.core.Term<A> aTerm) {
        hydra.core.Term.PartialVisitor<A, java.util.Optional<hydra.core.Annotated<hydra.core.Term<A>, A>>> v =
            new hydra.core.Term.PartialVisitor<A, java.util.Optional<hydra.core.Annotated<hydra.core.Term<A>, A>>>() {
              @Override
              public java.util.Optional<hydra.core.Annotated<hydra.core.Term<A>, A>> otherwise(
                  hydra.core.Term<A> instance) {
                return java.util.Optional.empty();
              }

              @Override
              public java.util.Optional<hydra.core.Annotated<hydra.core.Term<A>, A>> visit(
                  hydra.core.Term.Annotated<A> instance) {
                return java.util.Optional.of(instance.value);
              }
            };
        return aTerm.accept(v);
      }
    };
    return hydra.basics.Basics.skipAnnotations(fun).apply(x);
  }

  java.util.function.Function<hydra.core.Type<A>, hydra.core.Type<A>> stripType = hydra.basics.Basics.skipAnnotations(v1 -> ((v1)).accept(new hydra.core.Type.PartialVisitor<>() {
    @Override
    public java.util.Optional<hydra.core.Annotated<hydra.core.Type<M>, M>> otherwise(hydra.core.Type<A> instance) {
      return java.util.Optional.empty();
    }

    @Override
    public java.util.Optional<hydra.core.Annotated<hydra.core.Type<M>, M>> visit(hydra.core.Type.Annotated<A> instance) {
      return java.util.Optional.of((instance.value));
    }
  }));

  static hydra.core.Name unqualifyName(hydra.module.QualifiedName qname) {
    String prefix = ((((qname)).namespace).map(n -> hydra.lib.strings.Cat.apply(java.util.Arrays.asList(
      ((n)).value,
      ".")))).orElse("");
