...
public interface Meta {
  static String termVariant(hydra.variants.TermVariant v1) {
    return ((v1)).accept(new hydra.variants.TermVariant.Visitor<>() {
      @Override
      ...
      @Override
      public String visit(hydra.variants.TermVariant.Product ignored) {
        return "product";
      }
      ...
      @Override
      public String visit(hydra.variants.TermVariant.Sum ignored) {
        return "sum";
      }
  ...
  static String typeVariant(hydra.variants.TypeVariant v1) {
    return ((v1)).accept(new hydra.variants.TypeVariant.Visitor<>() {
      @Override
      ...
      @Override
      public String visit(hydra.variants.TypeVariant.Product ignored) {
        return "product";
      }
      ...
      @Override
      public String visit(hydra.variants.TypeVariant.Sum ignored) {
        return "sum";
      }
