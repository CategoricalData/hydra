  ...
  static String error(hydra.errors.Error_ e) {
    return (e).accept(new hydra.errors.Error_.PartialVisitor<>() {
      ...
      public String visit(hydra.errors.Error_.Checking v1) {
        return hydra.show.errors.Errors.checkingError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.Decoding v1) {
        return hydra.show.errors.Errors.decodingError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.DuplicateBinding v1) {
        return hydra.show.error.core.Core.duplicateBindingError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.DuplicateField v1) {
        return hydra.show.error.core.Core.duplicateFieldError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.Other v1) {
        return hydra.show.errors.Errors.otherError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.UndefinedField v1) {
        return hydra.show.error.core.Core.undefinedFieldError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.UndefinedTerm v1) {
        return hydra.show.error.core.Core.undefinedTermError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.UndefinedType v1) {
        return hydra.show.error.core.Core.undefinedTypeError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.UnexpectedTermVariant v1) {
        return hydra.show.error.core.Core.unexpectedTermVariantError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.UnexpectedTypeVariant v1) {
        return hydra.show.error.core.Core.unexpectedTypeVariantError((v1).value);
      }

      @Override
      public String visit(hydra.errors.Error_.Unification v1) {
        return hydra.show.errors.Errors.unificationError((v1).value);
      }
    });
  }
