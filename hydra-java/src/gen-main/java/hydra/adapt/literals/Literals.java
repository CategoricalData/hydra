...
public interface Literals {
  ...
  static hydra.util.Either<String, hydra.compute.Adapter<hydra.core.LiteralType, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>> literalAdapter(hydra.coders.AdapterContext cx, hydra.core.LiteralType lt) {
    java.util.function.Function<hydra.core.LiteralType, hydra.util.Either<String, java.util.List<hydra.compute.Adapter<hydra.core.LiteralType, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>> alts = (java.util.function.Function<hydra.core.LiteralType, hydra.util.Either<String, java.util.List<hydra.compute.Adapter<hydra.core.LiteralType, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>>) (t -> (t).accept(new hydra.core.LiteralType.PartialVisitor<>() {
      ...
      public hydra.util.Either<String, java.util.List<hydra.compute.Adapter<hydra.core.LiteralType, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>> visit(hydra.core.LiteralType.String_ ignored) {
        return hydra.util.Either.<String, java.util.List<hydra.compute.Adapter<hydra.core.LiteralType, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>left("no substitute for the literal string type");
      }
    }));
  ...
  static <T0, T1> hydra.util.Either<T1, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>> literalAdapter_forBinary(T0 t) {
    hydra.util.Lazy<hydra.compute.Coder<hydra.core.Literal, hydra.core.Literal>> step = new hydra.util.Lazy<>(() -> (hydra.compute.Coder<hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Coder<hydra.core.Literal, hydra.core.Literal>) (new hydra.compute.Coder<hydra.core.Literal, hydra.core.Literal>(p0 -> p1 -> hydra.adapt.literals.Literals.<hydra.context.Context, hydra.context.InContext<hydra.error.OtherError>>literalAdapter_matchBinary(
      ...
      p0,
      p1)))));
    return hydra.util.Either.<T1, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>right(java.util.List.of((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) (new hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>(false, t, new hydra.core.LiteralType.String_(), step.get())))))));
  }
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal> visit(hydra.core.Literal.Boolean_ bv) {
        return hydra.lib.eithers.Bind.apply(
          ((((java.util.function.Function<hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>>>>) (projected -> projected.encode))).apply(step_)).apply(cx2)).apply(new hydra.core.IntegerValue.Uint8(hydra.lib.logic.IfElse.lazy(
            ...
            () -> (short) (1),
            () -> (short) (0)))),
          (java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (iv -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>right(new hydra.core.Literal.Integer_(iv))));
      }
    }))));
      ...
      return (lit).accept(new hydra.core.Literal.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal> visit(hydra.core.Literal.Integer_ iv) {
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (val -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>right((forValue).apply(val))));
        }
      });
    })));
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.logic.IfElse.lazy(
        hasStrings.get(),
        () -> hydra.util.Either.<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>right(hydra.adapt.literals.Literals.<T0>literalAdapter_withStrings(
          hydra_extract_core_booleanLiteral2,
          hydra_extract_core_stringLiteral2,
          t)),
        () -> hydra.util.Either.<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>left("no alternatives available for boolean encoding")));
  }
  ...
  static <T0> hydra.util.Either<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>> literalAdapter_forFloat(hydra.coders.AdapterContext cx, java.util.function.Function<hydra.coders.AdapterContext, java.util.function.Function<hydra.core.FloatType, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>>>> hydra_adapt_literals_floatAdapter2, java.util.function.Function<hydra.core.Literal, String> hydra_show_core_literal2, T0 t, hydra.core.FloatType ft) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.adapt.literals.Literals.<T0>literalAdapter_withFloats(
        ...
        hydra_show_core_literal2,
        t),
      () -> hydra.util.Either.<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>left("no float types available"));
  }
  ...
  static <T0> hydra.util.Either<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>> literalAdapter_forInteger(hydra.coders.AdapterContext cx, java.util.function.Function<hydra.coders.AdapterContext, java.util.function.Function<hydra.core.IntegerType, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>>>> hydra_adapt_literals_integerAdapter2, java.util.function.Function<hydra.core.Literal, String> hydra_show_core_literal2, T0 t, hydra.core.IntegerType it) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.adapt.literals.Literals.<T0>literalAdapter_withIntegers(
        ...
        it,
        t),
      () -> hydra.util.Either.<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>left("no integer types available"));
  }
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.util.Either<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>>) (adapter -> {
        hydra.util.Lazy<hydra.compute.Coder<hydra.core.Literal, hydra.core.Literal>> step = new hydra.util.Lazy<>(() -> hydra.adapt.utils.Utils.bidirectional((java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>>) (v1 -> (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>) (v2 -> (java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (v3 -> hydra.adapt.literals.Literals.literalAdapter_adapt(
          ...
          v2,
          v3))))));
        return hydra.util.Either.<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>right(java.util.List.of((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) (new hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>(((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, Boolean>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, Boolean>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, Boolean>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, Boolean>) (projected -> projected.isLossy))))).apply(adapter), t, new hydra.core.LiteralType.Integer_(((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) (projected -> projected.target))))).apply(adapter)), step.get())))))));
      }));
  }
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, hydra.util.Either<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>>) (adapter -> {
        hydra.util.Lazy<hydra.compute.Coder<hydra.core.Literal, hydra.core.Literal>> step = new hydra.util.Lazy<>(() -> hydra.adapt.utils.Utils.bidirectional((java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>>) (v1 -> (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>) (v2 -> (java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (v3 -> hydra.adapt.literals.Literals.literalAdapter_adapt2(
          ...
          v2,
          v3))))));
        return hydra.util.Either.<String, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>right(java.util.List.of((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) (new hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>(((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, Boolean>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, Boolean>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, Boolean>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, Boolean>) (projected -> projected.isLossy))))).apply(adapter), t, new hydra.core.LiteralType.Float_(((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, hydra.core.FloatType>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, hydra.core.FloatType>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, hydra.core.FloatType>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>, hydra.core.FloatType>) (projected -> projected.target))))).apply(adapter)), step.get())))))));
      }));
  }
  ...
  static <T0> java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>> literalAdapter_withStrings(java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, Boolean>>> hydra_extract_core_booleanLiteral2, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, String>>> hydra_extract_core_stringLiteral2, T0 t) {
    java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>> decode = (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>) (cx -> (java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (lit -> hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<String, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (s -> hydra.lib.logic.IfElse.lazy(
        hydra.lib.equality.Equal.apply(
          s,
          "true"),
        () -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>right(new hydra.core.Literal.Boolean_(true)),
        () -> hydra.lib.logic.IfElse.lazy(
          hydra.lib.equality.Equal.apply(
            s,
            "false"),
          () -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>right(new hydra.core.Literal.Boolean_(false)),
          () -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>left((hydra.context.InContext<hydra.error.OtherError>) (new hydra.context.InContext<hydra.error.OtherError>(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
    ...
    java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>> encode = (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>) (cx -> (java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (lit -> hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<Boolean, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>) (b -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>right(new hydra.core.Literal.String_(hydra.lib.logic.IfElse.lazy(
        b,
        () -> "true",
        () -> "false")))))));
  ...
  static <T0, T1, T2> hydra.util.Either<T2, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>> literalAdapter_withAdapter(java.util.function.Function<hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>> matchBoolean, java.util.function.Function<hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Literal>>>> matchInteger, T0 t, hydra.compute.Adapter<T1, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue> adapter) {
    ...
    return hydra.util.Either.<T2, java.util.List<hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>>>right(java.util.List.of((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) ((hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>) (new hydra.compute.Adapter<T0, hydra.core.LiteralType, hydra.core.Literal, hydra.core.Literal>(false, t, new hydra.core.LiteralType.Integer_(((java.util.function.Function<hydra.compute.Adapter<T1, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) ((java.util.function.Function<hydra.compute.Adapter<T1, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) ((java.util.function.Function<hydra.compute.Adapter<T1, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) ((java.util.function.Function<hydra.compute.Adapter<T1, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>, hydra.core.IntegerType>) (projected -> projected.target))))).apply(adapter)), step.get())))))));
  }
  ...
  static <T2, T3> hydra.util.Either<T3, hydra.core.Literal> literalAdapter_matchBinary(T2 _cx, hydra.core.Literal lit) {
    return (lit).accept(new hydra.core.Literal.PartialVisitor<>() {
      ...
      public hydra.util.Either<T3, hydra.core.Literal> visit(hydra.core.Literal.Binary b) {
        return hydra.util.Either.<T3, hydra.core.Literal>right(new hydra.core.Literal.String_(hydra.lib.literals.BinaryToString.apply((b).value)));
      }
    });
  }
  ...
  static <T2, T3> hydra.util.Either<T3, hydra.core.Literal> literalAdapter_matchString(T2 _cx, hydra.core.Literal lit) {
    return (lit).accept(new hydra.core.Literal.PartialVisitor<>() {
      ...
      public hydra.util.Either<T3, hydra.core.Literal> visit(hydra.core.Literal.String_ s) {
        return hydra.util.Either.<T3, hydra.core.Literal>right(new hydra.core.Literal.Binary(hydra.lib.literals.StringToBinary.apply((s).value)));
      }
    });
  }
  ...
  static <T0> hydra.util.Either<T0, hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>> floatAdapter_makeAdapter(java.util.function.Function<hydra.util.Precision, java.util.function.Function<hydra.util.Precision, hydra.util.Comparison>> hydra_adapt_literals_comparePrecision2, java.util.function.Function<hydra.core.FloatType, java.util.function.Function<hydra.core.FloatValue, hydra.core.FloatValue>> hydra_adapt_literals_convertFloatValue2, java.util.function.Function<hydra.core.FloatType, hydra.util.Precision> hydra_reflect_floatTypePrecision2, hydra.core.FloatType source, hydra.core.FloatType target) {
    hydra.util.Lazy<Boolean> lossy = new hydra.util.Lazy<>(() -> hydra.lib.equality.Equal.apply(
      ...
      new hydra.util.Comparison.GreaterThan()));
    hydra.util.Lazy<hydra.compute.Coder<hydra.core.FloatValue, hydra.core.FloatValue>> step = new hydra.util.Lazy<>(() -> (hydra.compute.Coder<hydra.core.FloatValue, hydra.core.FloatValue>) ((hydra.compute.Coder<hydra.core.FloatValue, hydra.core.FloatValue>) (new hydra.compute.Coder<hydra.core.FloatValue, hydra.core.FloatValue>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.FloatValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.FloatValue>>>) (_cx -> (java.util.function.Function<hydra.core.FloatValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.FloatValue>>) (fv -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.FloatValue>right(((hydra_adapt_literals_convertFloatValue2).apply(target)).apply(fv)))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.FloatValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.FloatValue>>>) (_cx -> (java.util.function.Function<hydra.core.FloatValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.FloatValue>>) (fv -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.FloatValue>right(((hydra_adapt_literals_convertFloatValue2).apply(source)).apply(fv))))))));
    return hydra.util.Either.<T0, hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>>right((hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>) ((hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>) ((hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>) ((hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>) (new hydra.compute.Adapter<hydra.core.FloatType, hydra.core.FloatType, hydra.core.FloatValue, hydra.core.FloatValue>(lossy.get(), source, target, step.get()))))));
  }
  ...
  static <T0> hydra.util.Either<T0, hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>> integerAdapter_makeAdapter(java.util.function.Function<hydra.util.Precision, java.util.function.Function<hydra.util.Precision, hydra.util.Comparison>> hydra_adapt_literals_comparePrecision2, java.util.function.Function<hydra.core.IntegerType, java.util.function.Function<hydra.core.IntegerValue, hydra.core.IntegerValue>> hydra_adapt_literals_convertIntegerValue2, java.util.function.Function<hydra.core.IntegerType, hydra.util.Precision> hydra_reflect_integerTypePrecision2, hydra.core.IntegerType source, hydra.core.IntegerType target) {
    hydra.util.Lazy<Boolean> lossy = new hydra.util.Lazy<>(() -> hydra.lib.logic.Not.apply(hydra.lib.equality.Equal.apply(
      ...
      new hydra.util.Comparison.LessThan())));
    hydra.util.Lazy<hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>> step = new hydra.util.Lazy<>(() -> (hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>) ((hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>) (new hydra.compute.Coder<hydra.core.IntegerValue, hydra.core.IntegerValue>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>>>) (_cx -> (java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>>) (iv -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>right(((hydra_adapt_literals_convertIntegerValue2).apply(target)).apply(iv)))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>>>) (_cx -> (java.util.function.Function<hydra.core.IntegerValue, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>>) (iv -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.IntegerValue>right(((hydra_adapt_literals_convertIntegerValue2).apply(source)).apply(iv))))))));
    return hydra.util.Either.<T0, hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>>right((hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>) ((hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>) ((hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>) ((hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>) (new hydra.compute.Adapter<hydra.core.IntegerType, hydra.core.IntegerType, hydra.core.IntegerValue, hydra.core.IntegerValue>(lossy.get(), source, target, step.get()))))));
  }
