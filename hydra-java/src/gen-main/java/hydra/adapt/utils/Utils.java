...
public interface Utils {
  ...
  static <T0> hydra.compute.Coder<T0, T0> idCoder() {
    return new hydra.compute.Coder<T0, T0>((java.util.function.Function<hydra.context.Context, java.util.function.Function<T0, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T0>>>) (_cx -> (java.util.function.Function<T0, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T0>>) (x -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, T0>right(x))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<T0, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T0>>>) (_cx -> (java.util.function.Function<T0, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T0>>) (x -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, T0>right(x))));
  }
  ...
  static <T0, T1> hydra.compute.Coder<T0, T1> unidirectionalCoder(java.util.function.Function<hydra.context.Context, java.util.function.Function<T0, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T1>>> m) {
    return (hydra.compute.Coder<T0, T1>) ((hydra.compute.Coder<T0, T1>) (new hydra.compute.Coder<T0, T1>(m, (java.util.function.Function<hydra.context.Context, java.util.function.Function<T1, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T0>>>) (cx -> (java.util.function.Function<T1, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T0>>) (ignored -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, T0>left((hydra.context.InContext<hydra.error.OtherError>) (new hydra.context.InContext<hydra.error.OtherError>(new hydra.error.OtherError("inbound mapping is unsupported"), cx))))))));
  }
}
