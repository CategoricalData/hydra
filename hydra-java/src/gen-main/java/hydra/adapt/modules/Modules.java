...
public interface Modules {
          ...
          (java.util.function.Function<java.util.List<hydra.core.TypeApplicationTerm>, hydra.compute.Flow<hydra.graph.Graph, java.util.List<hydra.module.Definition>>>) (tterms -> {
            ...
            return hydra.lib.flows.Bind.apply(
              ...
              (java.util.function.Function<java.util.Map<hydra.core.Type, hydra.compute.Adapter<hydra.graph.Graph, T0, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>, hydra.compute.Flow<hydra.graph.Graph, java.util.List<hydra.module.Definition>>>) (adapters -> hydra.lib.flows.MapList.apply(
                (java.util.function.Function<hydra.util.Pair<hydra.core.Binding, hydra.core.TypeApplicationTerm>, hydra.compute.Flow<hydra.graph.Graph, hydra.module.Definition>>) (v1 -> hydra.adapt.modules.Modules.adaptedModuleDefinitions_classify(
                  graph,
  ...
  static <T1, T2> hydra.compute.Flow<hydra.graph.Graph, java.util.Map<hydra.core.Type, hydra.compute.Adapter<T1, T2, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>> adaptedModuleDefinitions_adaptersFor(hydra.coders.Language lang, java.util.List<hydra.core.Type> types) {
    return hydra.lib.flows.Bind.apply(
      hydra.lib.flows.MapList.apply(
        (java.util.function.Function<hydra.core.Type, hydra.compute.Flow<hydra.graph.Graph, hydra.compute.Adapter<T1, T2, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (v1 -> hydra.adapt.modules.Modules.<T1, T2>languageAdapter(
          lang,
          v1)),
        types),
      (java.util.function.Function<java.util.List<hydra.compute.Adapter<T1, T2, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>, hydra.compute.Flow<hydra.graph.Graph, java.util.Map<hydra.core.Type, hydra.compute.Adapter<T1, T2, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>>) (adapters -> hydra.lib.flows.Pure.apply(hydra.lib.maps.FromList.apply(hydra.lib.lists.Zip.apply(
        types,
        adapters)))));
  }
  
  static <T1, T2> hydra.compute.Flow<hydra.graph.Graph, hydra.module.Definition> adaptedModuleDefinitions_classify(hydra.graph.Graph graph, java.util.function.Function<hydra.core.Binding, Boolean> hydra_annotations_isNativeType2, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.util.DecodingError, hydra.core.Type>>> hydra_decode_core_type2, java.util.function.Function<hydra.core.Type, hydra.core.TypeScheme> hydra_schemas_typeToTypeScheme2, hydra.coders.Language lang, java.util.Map<hydra.core.Type, hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>> adapters, hydra.util.Pair<hydra.core.Binding, hydra.core.TypeApplicationTerm> pair) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.maybes.Maybe.apply(
        hydra.lib.flows.Fail.apply(hydra.lib.strings.Cat2.apply(
          ...
          (name).value)),
        (java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Flow<hydra.graph.Graph, hydra.module.Definition>>) (adapter -> hydra.lib.flows.Bind.apply(
          (((java.util.function.Function<hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.graph.Graph, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.graph.Graph, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.graph.Graph, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.graph.Graph, hydra.core.Term>>>) (projected -> projected.encode))))).apply(((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.graph.Graph, T1, hydra.core.Term, hydra.core.Term>>) (projected -> projected.coder))))))).apply(adapter))).apply(term),
          (java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.graph.Graph, hydra.module.Definition>>) (adapted -> hydra.lib.flows.Pure.apply(new hydra.module.Definition.Term(new hydra.module.TermDefinition(name, adapted, (hydra_schemas_typeToTypeScheme2).apply(((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.graph.Graph, T1, T2, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) (projected -> projected.target))))))).apply(adapter)))))))),
  ...
  static <T0, T1> hydra.compute.Flow<hydra.graph.Graph, hydra.compute.Adapter<T0, T1, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> languageAdapter(hydra.coders.Language lang, hydra.core.Type typ) {
    java.util.function.Function<hydra.core.Type, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>>> getPair = (java.util.function.Function<hydra.core.Type, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>>>) (typ2 -> hydra.lib.flows.Bind.apply(
      hydra.adapt.terms.Terms.termAdapter(typ2),
      (java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>>>) (ad -> hydra.lib.flows.Bind.apply(
        hydra.monads.Monads.<hydra.coders.AdapterContext>getState(),
        (java.util.function.Function<hydra.coders.AdapterContext, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>>>) (cx -> hydra.lib.flows.Pure.apply((hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>) ((hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>) (new hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>(ad, cx)))))))));
    return hydra.lib.flows.Bind.apply(
      hydra.monads.Monads.<hydra.graph.Graph>getState(),
      (java.util.function.Function<hydra.graph.Graph, hydra.compute.Flow<hydra.graph.Graph, hydra.compute.Adapter<T0, T1, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (g -> {
        ...
        return hydra.lib.flows.Bind.apply(
          hydra.monads.Monads.withState(
            cx0.get(),
            (getPair).apply(typ)),
          (java.util.function.Function<hydra.util.Pair<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.coders.AdapterContext>, hydra.compute.Flow<hydra.graph.Graph, hydra.compute.Adapter<T0, T1, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (result -> {
  ...
  static <T2> hydra.compute.Flow<T2, hydra.core.Term> languageAdapter_encode(hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term> adapter, hydra.coders.AdapterContext cx, hydra.core.Term term) {
    return hydra.monads.Monads.withState(
      cx,
      (((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) (projected -> projected.encode))))).apply(((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) (projected -> projected.coder))))))).apply(adapter))).apply(term));
  }
  
  static <T2> hydra.compute.Flow<T2, hydra.core.Term> languageAdapter_decode(hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term> adapter, hydra.coders.AdapterContext cx, hydra.core.Term term) {
    return hydra.monads.Monads.withState(
      cx,
      (((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<hydra.coders.AdapterContext, hydra.core.Term>>>) (projected -> projected.decode))))).apply(((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) ((java.util.function.Function<hydra.compute.Adapter<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.compute.Coder<hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term>>) (projected -> projected.coder))))))).apply(adapter))).apply(term));
  }
  
  static <T0, T1, T2, T3> hydra.compute.Flow<hydra.graph.Graph, T3> transformModule(hydra.coders.Language lang, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<T0, T1>> encodeTerm, java.util.function.Function<hydra.module.Module, java.util.function.Function<java.util.Map<hydra.core.Type, hydra.compute.Coder<T0, T2, hydra.core.Term, T1>>, java.util.function.Function<java.util.List<hydra.util.Pair<hydra.core.Binding, hydra.core.TypeApplicationTerm>>, hydra.compute.Flow<hydra.graph.Graph, T3>>>> createModule, hydra.module.Module mod) {
    java.util.List<hydra.core.Binding> els = (mod).elements;
    return hydra.monads.Monads.withTrace(
      hydra.lib.strings.Cat2.apply(
        "transform module ",
  ...
  static <T0, T1, T2, T3> hydra.compute.Flow<hydra.graph.Graph, T3> transformModule_transform(java.util.function.Function<hydra.module.Module, java.util.function.Function<java.util.Map<hydra.core.Type, hydra.compute.Coder<T0, T2, hydra.core.Term, T1>>, java.util.function.Function<java.util.List<hydra.util.Pair<hydra.core.Binding, hydra.core.TypeApplicationTerm>>, hydra.compute.Flow<hydra.graph.Graph, T3>>>> createModule, java.util.List<hydra.core.Binding> els, java.util.function.Function<hydra.core.Term, hydra.compute.Flow<T0, T1>> encodeTerm, hydra.coders.Language lang, hydra.module.Module mod) {
    return hydra.lib.flows.Bind.apply(
      hydra.lib.flows.MapList.apply(
        p0 -> hydra.schemas.Schemas.<hydra.graph.Graph>elementAsTypeApplicationTerm(p0),
        els),
      (java.util.function.Function<java.util.List<hydra.core.TypeApplicationTerm>, hydra.compute.Flow<hydra.graph.Graph, T3>>) (tterms -> {
        ...
        return hydra.lib.flows.Bind.apply(
          hydra.lib.flows.MapList.apply(
            (java.util.function.Function<hydra.core.Type, hydra.compute.Flow<hydra.graph.Graph, hydra.compute.Coder<T0, T2, hydra.core.Term, T1>>>) (v1 -> hydra.adapt.modules.Modules.<T0, T1, T2>constructCoder(
              lang,
              encodeTerm,
              v1)),
            types.get()),
  ...
  static <T0, T1, T2> java.util.Map<hydra.core.Type, hydra.compute.Coder<T0, T2, hydra.core.Term, T1>> transformModule_coders(java.util.List<hydra.compute.Coder<T0, T2, hydra.core.Term, T1>> cdrs, java.util.List<hydra.core.Type> types) {
