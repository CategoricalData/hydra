...
public interface Terms {
  ...
  static <T0, T1> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Field> fieldAdapter_encdec(hydra.compute.Adapter<T0, T1, hydra.core.Term, hydra.core.Term> ad, hydra.coders.CoderDirection dir, hydra.context.Context cx, hydra.core.Field field) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.adapt.utils.Utils.encodeDecode(
        ...
        cx,
        term),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Field>>) (newTerm -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Field>right(new hydra.core.Field(name, newTerm))));
  }
  ...
  static hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> forTypeReference(hydra.coders.AdapterContext cx, hydra.core.Name name) {
    ...
    java.util.function.Function<hydra.coders.AdapterContext, java.util.function.Function<Boolean, java.util.function.Function<java.util.Map<hydra.core.Name, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>, java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>>>> forMissingAdapter = (java.util.function.Function<hydra.coders.AdapterContext, java.util.function.Function<Boolean, java.util.function.Function<java.util.Map<hydra.core.Name, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>, java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>>>>) (cx2 -> (java.util.function.Function<Boolean, java.util.function.Function<java.util.Map<hydra.core.Name, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>, java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>>>) (lossy -> (java.util.function.Function<java.util.Map<hydra.core.Name, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>, java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>>) (adapters0 -> (java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (placeholder -> {
      ...
      return hydra.lib.maybes.Maybe.applyLazy(
        () -> hydra.util.Either.<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(lossy, new hydra.core.Type.Variable(name), new hydra.core.Type.Variable(name), hydra.adapt.utils.Utils.bidirectional((java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>) (dir -> (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (_cx -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (term -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(term))))))))))),
  ...
  static <T0, T1, T2> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T2> forTypeReference_encdec(hydra.core.Name name, java.util.Map<hydra.core.Name, hydra.compute.Adapter<T0, T1, T2, T2>> adapters0, hydra.coders.CoderDirection dir, hydra.context.Context cx, T2 term) {
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, T2>left((hydra.context.InContext<hydra.error.OtherError>) (new hydra.context.InContext<hydra.error.OtherError>(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
  ...
  static <T0, T1, T2> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term> functionToUnion_decode(hydra.core.Name hydra_adapt_terms_functionProxyName2, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Name, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Field>>>>> hydra_extract_core_injection2, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, String>>>> hydra_extract_core_string2, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>> readFromString, hydra.graph.Graph graph, hydra.compute.Adapter<T0, T1, hydra.core.Term, T2> ad, hydra.context.Context cx, T2 term) {
    ...
    java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>> forPrimitive = (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (fterm -> hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<String, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (s -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name(s)))))));
    ...
    java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>> forVariable = (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (fterm -> hydra.lib.eithers.Bind.apply(
      (((hydra_extract_core_string2).apply(cx)).apply(graph)).apply(fterm),
      (java.util.function.Function<String, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (s -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Variable(new hydra.core.Name(s))))));
    java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>> forWrapped = (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (fterm -> hydra.lib.eithers.Bind.apply(
      (((hydra_extract_core_string2).apply(cx)).apply(graph)).apply(fterm),
      (java.util.function.Function<String, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (s -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Wrap(new hydra.core.Name(s))))))));
    return hydra.lib.eithers.Bind.apply(
  ...
  static <T3> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, T3> functionToUnion_notFound(hydra.context.Context cx, hydra.core.Name fname) {
    return hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, T3>left((hydra.context.InContext<hydra.error.OtherError>) (new hydra.context.InContext<hydra.error.OtherError>(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
      "unexpected field: ",
      (fname).value)), cx)));
  }
      ...
      public hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> visit(hydra.core.Type.Maybe ot) {
        return hydra.lib.eithers.Bind.apply(
          hydra.adapt.terms.Terms.termAdapter(
            cx,
            (ot).value),
          (java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (ad -> hydra.util.Either.<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(false, t, new hydra.core.Type.List(((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) (projected -> projected.target))))).apply(ad)), (hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) ((hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) (new hydra.compute.Coder<hydra.core.Term, hydra.core.Term>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (v2 -> hydra.adapt.terms.Terms.maybeToList_encode(
            ad,
            v1,
        ...
        return hydra.lib.maybes.Maybe.applyLazy(
          ...
          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (r -> hydra.lib.eithers.Bind.apply(
            hydra.adapt.utils.Utils.encodeDecode(
              ...
              cx,
              r),
            (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (encoded -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.List(java.util.List.of(encoded)))))),
          (m).value);
      }
    });
  }
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term> visit(hydra.core.Term.List l) {
        return hydra.lib.eithers.Map.apply(
          ...
          hydra.lib.logic.IfElse.lazy(
            ...
            () -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Maybe<hydra.core.Term>>right((hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing())),
            () -> hydra.lib.eithers.Bind.apply(
              hydra.adapt.utils.Utils.encodeDecode(
              ...
              (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Maybe<hydra.core.Term>>>) (decoded -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Maybe<hydra.core.Term>>right(hydra.util.Maybe.just(decoded))))));
      }
    });
  }
          ...
          (java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (codAd -> hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<java.util.Map<hydra.core.Name, hydra.compute.Adapter<hydra.core.FieldType, hydra.core.FieldType, hydra.core.Field, hydra.core.Field>>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (caseAds -> hydra.lib.eithers.Bind.apply(
              ...
              (java.util.function.Function<hydra.util.Maybe<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (optionAd -> {
                ...
                return hydra.util.Either.<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(lossy.get(), t, target.get(), hydra.adapt.utils.Utils.bidirectional((java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>) (v1 -> (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (v2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (v3 -> hydra.adapt.terms.Terms.passFunction_encdec(
                  hydra.rewriting.Rewriting::deannotateTerm,
                  codAd,
                  caseAds,
                  v1,
          ...
          (java.util.function.Function<java.util.List<hydra.core.Field>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Elimination>>) (rcases -> hydra.lib.eithers.Bind.apply(
            hydra.lib.eithers.MapMaybe.apply(
              (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (d -> hydra.adapt.utils.Utils.encodeDecode(
                ...
                d)),
              def),
            (java.util.function.Function<hydra.util.Maybe<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Elimination>>) (rdef -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Elimination>right(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(n, rdef, rcases)))))));
      }
    });
  }
  ...
  static <T0, T1, T2, T3> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Function> passFunction_forFunction(hydra.coders.CoderDirection dir, hydra.context.Context cx, hydra.compute.Adapter<T0, T1, hydra.core.Term, hydra.core.Term> codAd, java.util.Map<hydra.core.Name, hydra.compute.Adapter<T2, T3, hydra.core.Field, hydra.core.Field>> caseAds, hydra.core.Function f) {
    return (f).accept(new hydra.core.Function.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Function> visit(hydra.core.Function.Lambda l) {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.adapt.utils.Utils.encodeDecode(
            ...
            cx,
            body),
          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Function>>) (newBody -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Function>right(new hydra.core.Function.Lambda(new hydra.core.Lambda(var, d, newBody)))));
      }
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Function> visit(hydra.core.Function.Primitive name) {
        return hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Function>right(new hydra.core.Function.Primitive((name).value));
      }
    });
  }
  ...
  static <T0, T1, T2, T3> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term> passFunction_encdec(java.util.function.Function<hydra.core.Term, hydra.core.Term> hydra_rewriting_deannotateTerm2, hydra.compute.Adapter<T0, T1, hydra.core.Term, hydra.core.Term> codAd, java.util.Map<hydra.core.Name, hydra.compute.Adapter<T2, T3, hydra.core.Field, hydra.core.Field>> caseAds, hydra.coders.CoderDirection dir, hydra.context.Context cx, hydra.core.Term term) {
    return ((hydra_rewriting_deannotateTerm2).apply(term)).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term> otherwise(hydra.core.Term instance) {
        return hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(term);
      }
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (l -> hydra.lib.eithers.Bind.apply(
        hydra.adapt.utils.Utils.encodeDecode(
          ...
          cx,
          l),
        (java.util.function.Function<hydra.core.Literal, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (l2 -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Literal(l2))))));
  }
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (v1 -> hydra.adapt.utils.Utils.encodeDecode(
              ...
              v1)),
            (terms).value),
          (java.util.function.Function<java.util.List<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (newTerms -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.List(newTerms))));
      }
    });
  }
              ...
              return hydra.lib.eithers.Bind.apply(
                ...
                (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Pair<hydra.core.Term, hydra.core.Term>>>) (newK -> hydra.lib.eithers.Bind.apply(
                  hydra.adapt.utils.Utils.encodeDecode(
                    ...
                    cx,
                    v.get()),
                  (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Pair<hydra.core.Term, hydra.core.Term>>>) (newV -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Pair<hydra.core.Term, hydra.core.Term>>right((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) ((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) (new hydra.util.Pair<hydra.core.Term, hydra.core.Term>(newK, newV))))))));
            }),
            hydra.lib.maps.ToList.apply((m).value)),
          (java.util.function.Function<java.util.List<hydra.util.Pair<hydra.core.Term, hydra.core.Term>>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (newPairs -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Map(hydra.lib.maps.FromList.apply(newPairs)))));
      }
    });
  }
      ...
      (java.util.function.Function<hydra.util.Maybe<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (opt -> hydra.lib.eithers.Bind.apply(
        hydra.lib.eithers.MapMaybe.apply(
          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (v1 -> hydra.adapt.utils.Utils.encodeDecode(
            ...
            v1)),
          opt),
        (java.util.function.Function<hydra.util.Maybe<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (newOpt -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Maybe(newOpt)))))))))));
    return (t).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
      public hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> visit(hydra.core.Type.Maybe ot) {
        return hydra.lib.eithers.Bind.apply(
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            ...
            hydra.lib.lists.Zip.apply(
              adapters,
              dfields)),
          (java.util.function.Function<java.util.List<hydra.core.Field>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (newFields -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Record(new hydra.core.Record((rt).typeName, newFields)))));
      }
    });
  }
    ...
    return (term).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term> visit(hydra.core.Term.Set terms) {
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<java.util.List<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (newTerms -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Set(hydra.lib.sets.FromList.apply(newTerms)))));
      }
    });
  }
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<java.util.List<hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<hydra.core.FieldType, hydra.core.FieldType, hydra.core.Field, hydra.core.Field>>>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (adapters -> {
            ...
            hydra.util.Lazy<java.util.List<hydra.core.FieldType>> sfields_ = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
              ...
              adapters));
            return hydra.util.Either.<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(lossy.get(), t, new hydra.core.Type.Union(new hydra.core.RowType(tname, sfields_.get())), hydra.adapt.utils.Utils.bidirectional((java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>) (dir -> (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (_cx -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (term -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(term)))))))))));
          }));
      }
    });
  }
  ...
  static <T0, T1, T2> hydra.util.Either<T2, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> passUnit(T0 _cx, T1 ignored) {
    return hydra.util.Either.<T2, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(false, new hydra.core.Type.Unit(), new hydra.core.Type.Unit(), (hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) ((hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) (new hydra.compute.Coder<hydra.core.Term, hydra.core.Term>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (_cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (_2 -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Unit()))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (_cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (_2 -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Unit()))))))))))));
  }
        ...
        java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.compute.Coder<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>>> mapTerm = (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.compute.Coder<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>>>) (graph -> (java.util.function.Function<hydra.compute.Coder<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>>) (coder -> (java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>) (dir -> (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (term -> hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (unwrapped -> hydra.lib.eithers.Bind.apply(
            hydra.adapt.utils.Utils.encodeDecode(
              ...
              cx2,
              unwrapped),
            (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (newTerm -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(tname, newTerm))))))))))));
    ...
    java.util.function.Function<hydra.core.ApplicationType, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>> forApplicationType = (java.util.function.Function<hydra.core.ApplicationType, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (at -> {
      ...
      return hydra.lib.eithers.Bind.apply(
        hydra.adapt.terms.Terms.termAdapter(
          cx,
          lhs),
        (java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (ad -> hydra.util.Either.<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(false, t, ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) (projected -> projected.target))))).apply(ad), hydra.adapt.utils.Utils.bidirectional((java.util.function.Function<hydra.coders.CoderDirection, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>) (v1 -> (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (v2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (v3 -> hydra.adapt.terms.Terms.simplifyApplication_encdec(
          ad,
          v1,
          v2,
          v3)))))))))))));
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Field> unionToRecord_fromRecordFields(java.util.function.Function<hydra.core.Field, hydra.util.Maybe<hydra.core.Field>> forField, java.util.function.Function<hydra.core.Term, String> hydra_show_core_term2, java.util.function.Function<hydra.core.Type, String> hydra_show_core_type2, hydra.core.Type t, hydra.context.Context cx, hydra.core.Term term, T0 term_, hydra.core.Type t_, java.util.List<hydra.core.Field> fields) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Field>left((hydra.context.InContext<hydra.error.OtherError>) (new hydra.context.InContext<hydra.error.OtherError>(new hydra.error.OtherError(hydra.lib.strings.Cat.apply(java.util.List.of(
      ...
      () -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Field>right(hydra.lib.lists.Head.apply(matches.get())));
  }
  ...
  static <T0, T1, T2> hydra.util.Either<T2, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> unitToRecord(T0 _cx, T1 ignored) {
    return hydra.util.Either.<T2, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(false, new hydra.core.Type.Unit(), new hydra.core.Type.Record(new hydra.core.RowType(new hydra.core.Name("_Unit"), (java.util.List<hydra.core.FieldType>) (java.util.List.<hydra.core.FieldType>of()))), (hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) ((hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) (new hydra.compute.Coder<hydra.core.Term, hydra.core.Term>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (_cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (_2 -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("_Unit"), (java.util.List<hydra.core.Field>) (java.util.List.<hydra.core.Field>of())))))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (_cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (_2 -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Unit()))))))))))));
  }
      ...
      public hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>> visit(hydra.core.Type.Wrap wt) {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.adapt.terms.Terms.termAdapter(
            cx,
            typ),
          (java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.util.Either<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>>) (ad -> hydra.util.Either.<String, hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>>right((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) ((hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>) (new hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>(false, t, ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) ((java.util.function.Function<hydra.compute.Adapter<hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term>, hydra.core.Type>) (projected -> projected.target))))).apply(ad), (hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) ((hydra.compute.Coder<hydra.core.Term, hydra.core.Term>) (new hydra.compute.Coder<hydra.core.Term, hydra.core.Term>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (v2 -> hydra.adapt.terms.Terms.wrapToUnwrapped_encode(
  ...
  static <T0, T1, T2> hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term> wrapToUnwrapped_decode(hydra.core.Name tname, hydra.compute.Adapter<T0, T1, hydra.core.Term, T2> ad, hydra.context.Context cx, T2 term) {
    return hydra.lib.eithers.Bind.apply(
      ((((java.util.function.Function<hydra.compute.Coder<hydra.core.Term, T2>, java.util.function.Function<hydra.context.Context, java.util.function.Function<T2, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.core.Term, T2>, java.util.function.Function<hydra.context.Context, java.util.function.Function<T2, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>>>) (projected -> projected.decode))).apply(((java.util.function.Function<hydra.compute.Adapter<T0, T1, hydra.core.Term, T2>, hydra.compute.Coder<hydra.core.Term, T2>>) ((java.util.function.Function<hydra.compute.Adapter<T0, T1, hydra.core.Term, T2>, hydra.compute.Coder<hydra.core.Term, T2>>) ((java.util.function.Function<hydra.compute.Adapter<T0, T1, hydra.core.Term, T2>, hydra.compute.Coder<hydra.core.Term, T2>>) ((java.util.function.Function<hydra.compute.Adapter<T0, T1, hydra.core.Term, T2>, hydra.compute.Coder<hydra.core.Term, T2>>) (projected -> projected.coder))))).apply(ad))).apply(cx)).apply(term),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>>) (decoded -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.core.Term>right(new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(tname, decoded)))));
  }
}
