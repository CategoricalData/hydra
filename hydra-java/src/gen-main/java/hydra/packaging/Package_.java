...
public class Package_ implements Serializable, Comparable<Package_> {
   ...
   */
  public final java.util.List<hydra.packaging.Module> modules;
  ...
  public Package_ (hydra.packaging.PackageName name, java.util.List<hydra.packaging.Module> modules, java.util.List<hydra.packaging.PackageName> dependencies, hydra.util.Maybe<String> description) {
    this.name = name;
  ...
  public Package_ withModules(java.util.List<hydra.packaging.Module> modules) {
    return new Package_(name, modules, dependencies, description);
  }
