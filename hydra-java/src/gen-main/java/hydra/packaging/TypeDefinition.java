...
public class TypeDefinition implements Serializable, Comparable<TypeDefinition> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.packaging.TypeDefinition");
  ...
  public TypeDefinition (hydra.core.Name name, hydra.core.TypeScheme type) {
    this.name = name;
    this.type = type;
  }
  ...
  public TypeDefinition withType(hydra.core.TypeScheme type) {
    return new TypeDefinition(name, type);
  }
}
