...
public class QualifiedName implements Serializable, Comparable<QualifiedName> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.packaging.QualifiedName");
   ...
   */
  public final hydra.util.Maybe<hydra.packaging.Namespace> namespace;
  ...
  public QualifiedName (hydra.util.Maybe<hydra.packaging.Namespace> namespace, String local) {
