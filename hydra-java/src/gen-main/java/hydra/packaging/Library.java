...
public class Library implements Serializable, Comparable<Library> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.packaging.Library");
  ...
  public Library (hydra.packaging.Namespace namespace, String prefix, hydra.util.ConsList<hydra.graph.Primitive> primitives) {
  ...
  public Library withNamespace(hydra.packaging.Namespace namespace) {
