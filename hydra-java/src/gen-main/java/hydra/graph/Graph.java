...
public class Graph {
   ...
   */
  public final hydra.graph.AnnotationClass annotations;
  ...
  public boolean equals(Object other) {
    ...
    Graph o = (Graph) (other);
    return elements.equals(o.elements) && environment.equals(o.environment) && types.equals(o.types) && body.equals(o.body) && primitives.equals(o.primitives) && annotations.equals(o.annotations) && schema.equals(o.schema);
  }
  
  @Override
  public int hashCode() {
    return 2 * elements.hashCode() + 3 * environment.hashCode() + 5 * types.hashCode() + 7 * body.hashCode() + 11 * primitives.hashCode() + 13 * annotations.hashCode() + 17 * schema.hashCode();
  }
  
  public Graph withElements(java.util.Map<hydra.core.Name, hydra.graph.Element> elements) {
    java.util.Objects.requireNonNull((elements));
    return new Graph(elements, environment, types, body, primitives, annotations, schema);
  }
  ...
  public Graph withAnnotations(hydra.graph.AnnotationClass annotations) {
    java.util.Objects.requireNonNull((annotations));
    return new Graph(elements, environment, types, body, primitives, annotations, schema);
  }
