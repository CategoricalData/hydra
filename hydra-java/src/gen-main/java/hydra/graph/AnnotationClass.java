...
public class AnnotationClass<M> {
  ...
  public final java.util.function.Function<M, java.util.function.Function<M, hydra.graph.Comparison>> compare;
  ...
  public final java.util.function.Function<hydra.core.Term<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<String>>> termDescription;
  
  public final java.util.function.Function<hydra.core.Type<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<String>>> typeDescription;
  
  public final java.util.function.Function<hydra.core.Term<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<hydra.core.Type<M>>>> termType;
  
  public final java.util.function.Function<hydra.graph.Graph<M>, java.util.function.Function<java.util.Optional<String>, java.util.function.Function<hydra.core.Term<M>, hydra.core.Term<M>>>> setTermDescription;
  
  public final java.util.function.Function<hydra.graph.Graph<M>, java.util.function.Function<java.util.Optional<hydra.core.Type<M>>, java.util.function.Function<hydra.core.Term<M>, hydra.core.Term<M>>>> setTermType;
  
  public final java.util.function.Function<M, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<hydra.core.Type<M>>>> typeOf;
  
  public final java.util.function.Function<java.util.Optional<hydra.core.Type<M>>, java.util.function.Function<M, M>> setTypeOf;
  
  public AnnotationClass (M default_, java.util.function.Function<M, java.util.function.Function<M, Boolean>> equal, java.util.function.Function<M, java.util.function.Function<M, hydra.graph.Comparison>> compare, java.util.function.Function<M, String> show, java.util.function.Function<String, java.util.Optional<M>> read, java.util.function.Function<hydra.core.Term<M>, M> termAnnotation, java.util.function.Function<hydra.core.Type<M>, M> typeAnnotation, java.util.function.Function<hydra.core.Term<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<String>>> termDescription, java.util.function.Function<hydra.core.Type<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<String>>> typeDescription, java.util.function.Function<hydra.core.Term<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<hydra.core.Type<M>>>> termType, java.util.function.Function<hydra.graph.Graph<M>, java.util.function.Function<java.util.Optional<String>, java.util.function.Function<hydra.core.Term<M>, hydra.core.Term<M>>>> setTermDescription, java.util.function.Function<hydra.graph.Graph<M>, java.util.function.Function<java.util.Optional<hydra.core.Type<M>>, java.util.function.Function<hydra.core.Term<M>, hydra.core.Term<M>>>> setTermType, java.util.function.Function<M, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<hydra.core.Type<M>>>> typeOf, java.util.function.Function<java.util.Optional<hydra.core.Type<M>>, java.util.function.Function<M, M>> setTypeOf) {
  ...
  public AnnotationClass withCompare(java.util.function.Function<M, java.util.function.Function<M, hydra.graph.Comparison>> compare) {
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
  ...
  public AnnotationClass withTermDescription(java.util.function.Function<hydra.core.Term<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<String>>> termDescription) {
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
  
  public AnnotationClass withTypeDescription(java.util.function.Function<hydra.core.Type<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<String>>> typeDescription) {
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
  
  public AnnotationClass withTermType(java.util.function.Function<hydra.core.Term<M>, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<hydra.core.Type<M>>>> termType) {
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
  
  public AnnotationClass withSetTermDescription(java.util.function.Function<hydra.graph.Graph<M>, java.util.function.Function<java.util.Optional<String>, java.util.function.Function<hydra.core.Term<M>, hydra.core.Term<M>>>> setTermDescription) {
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
  
  public AnnotationClass withSetTermType(java.util.function.Function<hydra.graph.Graph<M>, java.util.function.Function<java.util.Optional<hydra.core.Type<M>>, java.util.function.Function<hydra.core.Term<M>, hydra.core.Term<M>>>> setTermType) {
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
  
  public AnnotationClass withTypeOf(java.util.function.Function<M, hydra.compute.Flow<hydra.graph.Graph<M>, java.util.Optional<hydra.core.Type<M>>>> typeOf) {
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, termType, setTermDescription, setTermType, typeOf, setTypeOf);
  }
