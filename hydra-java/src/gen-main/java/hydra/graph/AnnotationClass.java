...
public class AnnotationClass<A> {
  ...
  public final java.util.function.Function<String, Opt<A>> read;
  ...
  public final java.util.function.Function<hydra.core.Term<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<String>>> termDescription;
  
  public final java.util.function.Function<hydra.core.Type<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<String>>> typeDescription;
  ...
  public final java.util.function.Function<hydra.core.Term<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<Type<A>>>> termType;
  
  public final java.util.function.Function<Opt<String>, java.util.function.Function<hydra.core.Term<A>, hydra.core.Term<A>>> setTermDescription;
  
  public final java.util.function.Function<Opt<Type<A>>, java.util.function.Function<hydra.core.Term<A>, hydra.core.Term<A>>> setTermType;
  ...
  public final java.util.function.Function<A, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<Type<A>>>> typeOf;
  
  public final java.util.function.Function<Opt<Type<A>>, java.util.function.Function<A, A>> setTypeOf;
  
  public AnnotationClass (A default_, java.util.function.Function<A, java.util.function.Function<A, Boolean>> equal, java.util.function.Function<A, java.util.function.Function<A, hydra.graph.Comparison>> compare, java.util.function.Function<A, String> show, java.util.function.Function<String, Opt<A>> read, java.util.function.Function<hydra.core.Term<A>, A> termAnnotation, java.util.function.Function<hydra.core.Type<A>, A> typeAnnotation, java.util.function.Function<hydra.core.Term<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<String>>> termDescription, java.util.function.Function<hydra.core.Type<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<String>>> typeDescription, java.util.function.Function<hydra.core.Type<A>, hydra.compute.Flow<hydra.graph.Graph<A>, java.util.Map<hydra.core.Name, java.util.Set<hydra.graph.TypeClass>>>> typeClasses, java.util.function.Function<hydra.core.Term<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<Type<A>>>> termType, java.util.function.Function<Opt<String>, java.util.function.Function<hydra.core.Term<A>, hydra.core.Term<A>>> setTermDescription, java.util.function.Function<Opt<Type<A>>, java.util.function.Function<hydra.core.Term<A>, hydra.core.Term<A>>> setTermType, java.util.function.Function<java.util.Map<hydra.core.Name, java.util.Set<hydra.graph.TypeClass>>, java.util.function.Function<hydra.core.Type<A>, hydra.core.Type<A>>> setTypeClasses, java.util.function.Function<A, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<Type<A>>>> typeOf, java.util.function.Function<Opt<Type<A>>, java.util.function.Function<A, A>> setTypeOf) {
    if (default_ == null) {
  ...
  public AnnotationClass withRead(java.util.function.Function<String, Opt<A>> read) {
    if (read == null) {
      throw new IllegalArgumentException("null value for 'read' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
  ...
  public AnnotationClass withTermDescription(java.util.function.Function<hydra.core.Term<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<String>>> termDescription) {
    if (termDescription == null) {
      throw new IllegalArgumentException("null value for 'termDescription' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
  ...
  public AnnotationClass withTypeDescription(java.util.function.Function<hydra.core.Type<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<String>>> typeDescription) {
    if (typeDescription == null) {
      throw new IllegalArgumentException("null value for 'typeDescription' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
  ...
  public AnnotationClass withTermType(java.util.function.Function<hydra.core.Term<A>, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<Type<A>>>> termType) {
    if (termType == null) {
      throw new IllegalArgumentException("null value for 'termType' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
  ...
  public AnnotationClass withSetTermDescription(java.util.function.Function<Opt<String>, java.util.function.Function<hydra.core.Term<A>, hydra.core.Term<A>>> setTermDescription) {
    if (setTermDescription == null) {
      throw new IllegalArgumentException("null value for 'setTermDescription' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
  ...
  public AnnotationClass withSetTermType(java.util.function.Function<Opt<Type<A>>, java.util.function.Function<hydra.core.Term<A>, hydra.core.Term<A>>> setTermType) {
    if (setTermType == null) {
      throw new IllegalArgumentException("null value for 'setTermType' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
  ...
  public AnnotationClass withTypeOf(java.util.function.Function<A, hydra.compute.Flow<hydra.graph.Graph<A>, Opt<Type<A>>>> typeOf) {
    if (typeOf == null) {
      throw new IllegalArgumentException("null value for 'typeOf' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
  ...
  public AnnotationClass withSetTypeOf(java.util.function.Function<Opt<Type<A>>, java.util.function.Function<A, A>> setTypeOf) {
    if (setTypeOf == null) {
      throw new IllegalArgumentException("null value for 'setTypeOf' argument");
    }
    return new AnnotationClass(default_, equal, compare, show, read, termAnnotation, typeAnnotation, termDescription, typeDescription, typeClasses, termType, setTermDescription, setTermType, setTypeClasses, typeOf, setTypeOf);
