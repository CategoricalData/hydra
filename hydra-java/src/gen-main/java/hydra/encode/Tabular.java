...
public interface Tabular {
  static hydra.core.Term columnType(hydra.tabular.ColumnType x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.tabular.ColumnType"), java.util.Arrays.asList(
      new hydra.core.Field(new hydra.core.Name("name"), hydra.encode.Relational.columnName((x).name)),
  ...
  static <T0> hydra.core.Term table(java.util.function.Function<T0, hydra.core.Term> v, hydra.tabular.Table<T0> x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.tabular.Table"), java.util.Arrays.asList(
      new hydra.core.Field(new hydra.core.Name("header"), new hydra.core.Term.Maybe(hydra.lib.maybes.Map.apply(
        hydra.encode.Tabular::headerRow,
      ...
      new hydra.core.Field(new hydra.core.Name("data"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.tabular.DataRow<T0>, hydra.core.Term>) (v1 -> hydra.encode.Tabular.<T0>dataRow(
          v,
          v1)),
  ...
  static hydra.core.Term tableType(hydra.tabular.TableType x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.tabular.TableType"), java.util.Arrays.asList(
      new hydra.core.Field(new hydra.core.Name("name"), hydra.encode.Relational.relationName((x).name)),
      new hydra.core.Field(new hydra.core.Name("columns"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
        hydra.encode.Tabular::columnType,
        (x).columns))))));
  }
}
