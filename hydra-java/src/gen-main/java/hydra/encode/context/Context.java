...
public interface Context {
  static hydra.core.Term context(hydra.context.Context x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.context.Context"), java.util.List.of(
  ...
  static <T0> hydra.core.Term inContext(java.util.function.Function<T0, hydra.core.Term> e, hydra.context.InContext<T0> x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.context.InContext"), java.util.List.of(
      ...
      new hydra.core.Field(new hydra.core.Name("context"), hydra.encode.context.Context.context(((java.util.function.Function<hydra.context.InContext<T0>, hydra.context.Context>) (projected -> projected.context)).apply(x))))));
  }
}
