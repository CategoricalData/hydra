...
public interface Grammar {
  ...
  static hydra.core.Term grammar(hydra.grammar.Grammar x) {
    return new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(new hydra.core.Name("hydra.grammar.Grammar"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
      hydra.encode.Grammar::production,
      (x).value))));
  }
  ...
  static hydra.core.Term labeledPattern(hydra.grammar.LabeledPattern x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.grammar.LabeledPattern"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("label"), hydra.encode.Grammar.label((x).label)),
      new hydra.core.Field(new hydra.core.Name("pattern"), hydra.encode.Grammar.pattern((x).pattern)))));
  }
    ...
    return (v1).accept(new hydra.grammar.Pattern.PartialVisitor<>() {
      ...
      public hydra.core.Term visit(hydra.grammar.Pattern.Alternatives y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("alternatives"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
          hydra.encode.Grammar::pattern,
          (y).value)))));
      }

      @Override
      public hydra.core.Term visit(hydra.grammar.Pattern.Constant y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("constant"), hydra.encode.Grammar.constant((y).value))));
      }

      @Override
      public hydra.core.Term visit(hydra.grammar.Pattern.Ignored y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("ignored"), hydra.encode.Grammar.pattern((y).value))));
      }

      @Override
      public hydra.core.Term visit(hydra.grammar.Pattern.Labeled y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("labeled"), hydra.encode.Grammar.labeledPattern((y).value))));
      }
      ...
      public hydra.core.Term visit(hydra.grammar.Pattern.Nonterminal y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("nonterminal"), hydra.encode.Grammar.symbol((y).value))));
      }

      @Override
      public hydra.core.Term visit(hydra.grammar.Pattern.Option y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("option"), hydra.encode.Grammar.pattern((y).value))));
      }

      @Override
      public hydra.core.Term visit(hydra.grammar.Pattern.Plus y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("plus"), hydra.encode.Grammar.pattern((y).value))));
      }

      @Override
      public hydra.core.Term visit(hydra.grammar.Pattern.Regex y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("regex"), hydra.encode.Grammar.regex((y).value))));
      }
      ...
      public hydra.core.Term visit(hydra.grammar.Pattern.Star y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.grammar.Pattern"), new hydra.core.Field(new hydra.core.Name("star"), hydra.encode.Grammar.pattern((y).value))));
      }
    });
  }
  ...
  static hydra.core.Term production(hydra.grammar.Production x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.grammar.Production"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("symbol"), hydra.encode.Grammar.symbol((x).symbol)),
      new hydra.core.Field(new hydra.core.Name("pattern"), hydra.encode.Grammar.pattern((x).pattern)))));
  }
