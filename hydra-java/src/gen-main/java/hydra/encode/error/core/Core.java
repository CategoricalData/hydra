...
public interface Core {
  static hydra.core.Term duplicateBindingError(hydra.error.core.DuplicateBindingError x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.core.DuplicateBindingError"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("location"), hydra.encode.accessors.Accessors.accessorPath((x).location)),
  ...
  static hydra.core.Term invalidTermError(hydra.error.core.InvalidTermError v1) {
    return (v1).accept(new hydra.error.core.InvalidTermError.PartialVisitor<>() {
      ...
      public hydra.core.Term visit(hydra.error.core.InvalidTermError.DuplicateBinding y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.error.core.InvalidTermError"), new hydra.core.Field(new hydra.core.Name("duplicateBinding"), hydra.encode.error.core.Core.duplicateBindingError((y).value))));
      }

      @Override
      public hydra.core.Term visit(hydra.error.core.InvalidTermError.DuplicateField y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.error.core.InvalidTermError"), new hydra.core.Field(new hydra.core.Name("duplicateField"), hydra.encode.error.core.Core.duplicateFieldError((y).value))));
      }
    });
  }
  ...
  static hydra.core.Term undefinedFieldError(hydra.error.core.UndefinedFieldError x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.core.UndefinedFieldError"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("fieldName"), hydra.encode.core.Core.name((x).fieldName)),
  ...
  static hydra.core.Term undefinedTermError(hydra.error.core.UndefinedTermError x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.core.UndefinedTermError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("name"), hydra.encode.core.Core.name((x).name)))));
  }

  static hydra.core.Term undefinedTypeError(hydra.error.core.UndefinedTypeError x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.core.UndefinedTypeError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("name"), hydra.encode.core.Core.name((x).name)))));
  }
  ...
  static hydra.core.Term unexpectedTermVariantError(hydra.error.core.UnexpectedTermVariantError x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.core.UnexpectedTermVariantError"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("expectedVariant"), hydra.encode.variants.Variants.termVariant((x).expectedVariant)),
      new hydra.core.Field(new hydra.core.Name("actualTerm"), hydra.encode.core.Core.term((x).actualTerm)))));
  }
  ...
  static hydra.core.Term unexpectedTypeVariantError(hydra.error.core.UnexpectedTypeVariantError x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.core.UnexpectedTypeVariantError"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("expectedVariant"), hydra.encode.variants.Variants.typeVariant((x).expectedVariant)),
