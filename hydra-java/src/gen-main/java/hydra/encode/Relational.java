...
public interface Relational {
  ...
  static <T0> hydra.core.Term columnSchema(java.util.function.Function<T0, hydra.core.Term> t, hydra.relational.ColumnSchema<T0> x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.ColumnSchema"), java.util.Arrays.asList(
  ...
  static hydra.core.Term foreignKey(hydra.relational.ForeignKey x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.ForeignKey"), java.util.Arrays.asList(
  ...
  static <T0> hydra.core.Term relationSchema(java.util.function.Function<T0, hydra.core.Term> t, hydra.relational.RelationSchema<T0> x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.RelationSchema"), java.util.Arrays.asList(
