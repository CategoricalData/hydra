...
public interface Relational {
  ...
  static <T0> hydra.core.Term columnSchema(java.util.function.Function<T0, hydra.core.Term> t, hydra.relational.ColumnSchema<T0> x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.ColumnSchema"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("name"), hydra.encode.Relational.columnName(((java.util.function.Function<hydra.relational.ColumnSchema<T0>, hydra.relational.ColumnName>) (projected -> projected.name)).apply(x))),
  ...
  static hydra.core.Term foreignKey(hydra.relational.ForeignKey x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.ForeignKey"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("foreignRelation"), hydra.encode.Relational.relationName((x).foreignRelation)),
      new hydra.core.Field(new hydra.core.Name("keys"), new hydra.core.Term.Map(hydra.lib.maps.Bimap.apply(
        hydra.encode.Relational::columnName,
        hydra.encode.Relational::columnName,
        (x).keys))))));
  }
  ...
  static <T0> hydra.core.Term relation(java.util.function.Function<T0, hydra.core.Term> v, hydra.relational.Relation<T0> x) {
    return new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(new hydra.core.Name("hydra.relational.Relation"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.relational.Row<T0>, hydra.core.Term>) (v1 -> hydra.encode.Relational.<T0>row(
        v,
        v1)),
  ...
  static <T0> hydra.core.Term relationSchema(java.util.function.Function<T0, hydra.core.Term> t, hydra.relational.RelationSchema<T0> x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.RelationSchema"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("name"), hydra.encode.Relational.relationName(((java.util.function.Function<hydra.relational.RelationSchema<T0>, hydra.relational.RelationName>) (projected -> projected.name)).apply(x))),
      new hydra.core.Field(new hydra.core.Name("columns"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.relational.ColumnSchema<T0>, hydra.core.Term>) (v1 -> hydra.encode.Relational.<T0>columnSchema(
          t,
          v1)),
        ((java.util.function.Function<hydra.relational.RelationSchema<T0>, hydra.util.ConsList<hydra.relational.ColumnSchema<T0>>>) (projected -> projected.columns)).apply(x)))),
      new hydra.core.Field(new hydra.core.Name("primaryKeys"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
        hydra.encode.Relational::primaryKey,
        ((java.util.function.Function<hydra.relational.RelationSchema<T0>, hydra.util.ConsList<hydra.relational.PrimaryKey>>) (projected -> projected.primaryKeys)).apply(x)))),
      new hydra.core.Field(new hydra.core.Name("foreignKeys"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
        hydra.encode.Relational::foreignKey,
  ...
  static <T0> hydra.core.Term row(java.util.function.Function<T0, hydra.core.Term> v, hydra.relational.Row<T0> x) {
    return new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(new hydra.core.Name("hydra.relational.Row"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
      v,
      ((java.util.function.Function<hydra.relational.Row<T0>, hydra.util.ConsList<T0>>) (wrapped -> (wrapped).value)).apply(x)))));
  }
}
