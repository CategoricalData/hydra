...
public interface Accessors {
  static hydra.core.Term accessorEdge(hydra.accessors.AccessorEdge x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.accessors.AccessorEdge"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("source"), hydra.encode.Accessors.accessorNode((x).source)),
      new hydra.core.Field(new hydra.core.Name("path"), hydra.encode.Accessors.accessorPath((x).path)),
      new hydra.core.Field(new hydra.core.Name("target"), hydra.encode.Accessors.accessorNode((x).target)))));
  }
  ...
  static hydra.core.Term accessorGraph(hydra.accessors.AccessorGraph x) {
    return new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.accessors.AccessorGraph"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("nodes"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
        hydra.encode.Accessors::accessorNode,
        (x).nodes))),
  ...
  static hydra.core.Term accessorPath(hydra.accessors.AccessorPath x) {
    return new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(new hydra.core.Name("hydra.accessors.AccessorPath"), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
      hydra.encode.Accessors::termAccessor,
      (x).value))));
  }
  ...
  static hydra.core.Term termAccessor(hydra.accessors.TermAccessor v1) {
    return (v1).accept(new hydra.accessors.TermAccessor.PartialVisitor<>() {
      ...
      public hydra.core.Term visit(hydra.accessors.TermAccessor.UnionCasesBranch y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.accessors.TermAccessor"), new hydra.core.Field(new hydra.core.Name("unionCasesBranch"), hydra.encode.Core.name((y).value))));
      }
      ...
      public hydra.core.Term visit(hydra.accessors.TermAccessor.LetBinding y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.accessors.TermAccessor"), new hydra.core.Field(new hydra.core.Name("letBinding"), hydra.encode.Core.name((y).value))));
      }
      ...
      public hydra.core.Term visit(hydra.accessors.TermAccessor.RecordField y) {
        return new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.accessors.TermAccessor"), new hydra.core.Field(new hydra.core.Name("recordField"), hydra.encode.Core.name((y).value))));
      }
