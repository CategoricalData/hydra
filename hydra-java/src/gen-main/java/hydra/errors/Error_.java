...
public abstract class Error_ implements Serializable, Comparable<Error_> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.errors.Error");
   ...
   */
  public static final class Checking extends hydra.errors.Error_ implements Serializable {
   ...
   */
  public static final class Decoding extends hydra.errors.Error_ implements Serializable {
    public final hydra.errors.DecodingError value;

    public Decoding (hydra.errors.DecodingError value) {
      this.value = value;
    }
   ...
   */
  public static final class DuplicateBinding extends hydra.errors.Error_ implements Serializable {
   ...
   */
  public static final class DuplicateField extends hydra.errors.Error_ implements Serializable {
  ...
  public static final class Other extends hydra.errors.Error_ implements Serializable {
    public final hydra.errors.OtherError value;

    public Other (hydra.errors.OtherError value) {
      this.value = value;
    }
   ...
   */
  public static final class UndefinedField extends hydra.errors.Error_ implements Serializable {
    public final hydra.error.core.UndefinedFieldError value;

    public UndefinedField (hydra.error.core.UndefinedFieldError value) {
      this.value = value;
    }
   ...
   */
  public static final class UnexpectedTermVariant extends hydra.errors.Error_ implements Serializable {
    public final hydra.error.core.UnexpectedTermVariantError value;

    public UnexpectedTermVariant (hydra.error.core.UnexpectedTermVariantError value) {
      this.value = value;
    }
   ...
   */
  public static final class UnexpectedTypeVariant extends hydra.errors.Error_ implements Serializable {
    public final hydra.error.core.UnexpectedTypeVariantError value;

    public UnexpectedTypeVariant (hydra.error.core.UnexpectedTypeVariantError value) {
      this.value = value;
    }
   ...
   */
  public static final class Unification extends hydra.errors.Error_ implements Serializable {
    public final hydra.errors.UnificationError value;

    public Unification (hydra.errors.UnificationError value) {
      this.value = value;
    }
