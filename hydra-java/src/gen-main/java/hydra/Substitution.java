...
public interface Substitution {
  static hydra.typing.TypeSubst composeTypeSubst(hydra.typing.TypeSubst s1, hydra.typing.TypeSubst s2) {
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.logic.IfElse.lazy(
        ...
        () -> s1,
        () -> hydra.Substitution.composeTypeSubstNonEmpty(
          s1,
          s2)));
  }
  ...
  static hydra.typing.TypeSubst composeTypeSubstList(java.util.List<hydra.typing.TypeSubst> v1) {
    return hydra.lib.lists.Foldl.apply(
      (java.util.function.Function<hydra.typing.TypeSubst, java.util.function.Function<hydra.typing.TypeSubst, hydra.typing.TypeSubst>>) (p0 -> p1 -> hydra.Substitution.composeTypeSubst(
        p0,
        p1)),
  ...
  static hydra.typing.TypeSubst composeTypeSubstNonEmpty(hydra.typing.TypeSubst s1, hydra.typing.TypeSubst s2) {
    hydra.util.Lazy<java.util.Map<hydra.core.Name, hydra.core.Type>> withExtra = new hydra.util.Lazy<>(() -> hydra.lib.maps.FilterWithKey.apply(
      (java.util.function.Function<hydra.core.Name, java.util.function.Function<hydra.core.Type, Boolean>>) (v1 -> (java.util.function.Function<hydra.core.Type, Boolean>) (v2 -> hydra.Substitution.composeTypeSubstNonEmpty_isExtra(
        s1,
        v1,
        v2))),
      (s2).value));
    ...
    return hydra.lib.lists.Foldl.apply(
      (java.util.function.Function<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>, java.util.function.Function<hydra.util.Pair<hydra.core.Name, hydra.core.TypeVariableMetadata>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>) (acc -> (java.util.function.Function<hydra.util.Pair<hydra.core.Name, hydra.core.TypeVariableMetadata>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) (pair -> {
        ...
        return hydra.lib.maybes.Maybe.applyLazy(
          () -> hydra.Substitution.substInClassConstraints_insertOrMerge(
            varName.get(),
            metadata.get(),
            acc),
          (java.util.function.Function<hydra.core.Type, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) (targetType -> {
            hydra.util.Lazy<java.util.List<hydra.core.Name>> freeVars = new hydra.util.Lazy<>(() -> hydra.lib.sets.ToList.apply(hydra.Variables.freeVariablesInType(targetType)));
            return hydra.lib.lists.Foldl.apply(
  ...
  static hydra.graph.Graph substInContext(hydra.typing.TypeSubst subst, hydra.graph.Graph cx) {
    hydra.util.Lazy<java.util.Map<hydra.core.Name, hydra.core.TypeScheme>> newBoundTypes = new hydra.util.Lazy<>(() -> hydra.lib.maps.Map.apply(
      (java.util.function.Function<hydra.core.TypeScheme, hydra.core.TypeScheme>) (v1 -> hydra.Substitution.substInTypeScheme(
        subst,
        v1)),
      (cx).boundTypes));
    ...
    java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata> newClassConstraints = hydra.Substitution.substInClassConstraints(
      subst,
      (cx).classConstraints);
  ...
  static hydra.core.Type substInTypeNonEmpty(hydra.typing.TypeSubst subst, hydra.core.Type typ0) {
    ...
    java.util.function.Function<java.util.function.Function<hydra.core.Type, hydra.core.Type>, java.util.function.Function<hydra.core.Type, hydra.core.Type>> rewrite = (java.util.function.Function<java.util.function.Function<hydra.core.Type, hydra.core.Type>, java.util.function.Function<hydra.core.Type, hydra.core.Type>>) (recurse -> (java.util.function.Function<hydra.core.Type, hydra.core.Type>) (typ -> (typ).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public hydra.core.Type visit(hydra.core.Type.Forall lt) {
        return hydra.lib.maybes.Maybe.applyLazy(
          () -> (recurse).apply(typ),
          (java.util.function.Function<hydra.core.Type, hydra.core.Type>) (styp -> new hydra.core.Type.Forall(new hydra.core.ForallType((lt).value.parameter, hydra.Substitution.substInType(
  ...
  static hydra.core.TypeScheme substInTypeScheme(hydra.typing.TypeSubst subst, hydra.core.TypeScheme ts) {
    return new hydra.core.TypeScheme((ts).variables, hydra.Substitution.substInType(
      subst,
      (ts).type), hydra.lib.maybes.Map.apply(
      (java.util.function.Function<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) (v1 -> hydra.Substitution.substInClassConstraints(
        subst,
        v1)),
      (ts).constraints));
  }
    ...
    java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>> rewrite = (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> {
      ...
      java.util.function.Function<hydra.core.Let, hydra.core.Term> forLet = (java.util.function.Function<hydra.core.Let, hydra.core.Term>) (l -> {
        ...
        return new hydra.core.Term.Let(new hydra.core.Let(hydra.lib.lists.Map.apply(
          rewriteBinding,
          (l).bindings), hydra.Substitution.substTypesInTerm(
          subst,
          (l).body)));
      });
      java.util.function.Function<hydra.core.TypeApplicationTerm, hydra.core.Term> forTypeApplication = (java.util.function.Function<hydra.core.TypeApplicationTerm, hydra.core.Term>) (tt -> new hydra.core.Term.TypeApplication(new hydra.core.TypeApplicationTerm(hydra.Substitution.substTypesInTerm(
        subst,
        (tt).body), hydra.Substitution.substInType(
        subst,
        (tt).type))));
      java.util.function.Function<hydra.core.TypeLambda, hydra.core.Term> forTypeLambda = (java.util.function.Function<hydra.core.TypeLambda, hydra.core.Term>) (ta -> {
        ...
        hydra.util.Lazy<hydra.typing.TypeSubst> subst2 = new hydra.util.Lazy<>(() -> new hydra.typing.TypeSubst(hydra.lib.maps.Delete.apply(
          param,
          (subst).value)));
        return new hydra.core.Term.TypeLambda(new hydra.core.TypeLambda(param, hydra.Substitution.substTypesInTerm(
          subst2.get(),
          (ta).body)));
      });
  ...
  static hydra.core.Binding substituteInBinding(hydra.typing.TermSubst subst, hydra.core.Binding b) {
    return new hydra.core.Binding((b).name, hydra.Substitution.substituteInTerm(
      subst,
      (b).term), (b).type);
  }

  static hydra.typing.TypeConstraint substituteInConstraint(hydra.typing.TypeSubst subst, hydra.typing.TypeConstraint c) {
    return new hydra.typing.TypeConstraint(hydra.Substitution.substInType(
      subst,
      (c).left), hydra.Substitution.substInType(
      subst,
      (c).right), (c).comment);
  }
  ...
  static java.util.List<hydra.typing.TypeConstraint> substituteInConstraints(hydra.typing.TypeSubst subst, java.util.List<hydra.typing.TypeConstraint> cs) {
    return hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.typing.TypeConstraint, hydra.typing.TypeConstraint>) (v1 -> hydra.Substitution.substituteInConstraint(
        subst,
        v1)),
      cs);
  }
      ...
      java.util.function.Function<hydra.core.Let, hydra.core.Term> withLet = (java.util.function.Function<hydra.core.Let, hydra.core.Term>) (lt -> {
        ...
        hydra.util.Lazy<hydra.typing.TermSubst> subst2 = new hydra.util.Lazy<>(() -> new hydra.typing.TermSubst(hydra.lib.maps.FilterWithKey.apply(
          (java.util.function.Function<hydra.core.Name, java.util.function.Function<hydra.core.Term, Boolean>>) (k -> (java.util.function.Function<hydra.core.Term, Boolean>) (v -> hydra.lib.logic.Not.apply(hydra.lib.sets.Member.apply(
            ...
            names.get())))),
          s)));
        java.util.function.Function<hydra.core.Binding, hydra.core.Binding> rewriteBinding = (java.util.function.Function<hydra.core.Binding, hydra.core.Binding>) (b -> new hydra.core.Binding((b).name, hydra.Substitution.substituteInTerm(
          subst2.get(),
          (b).term), (b).type));
        return new hydra.core.Term.Let(new hydra.core.Let(hydra.lib.lists.Map.apply(
          rewriteBinding,
          bindings), hydra.Substitution.substituteInTerm(
          subst2.get(),
          (lt).body)));
      });
      return (term).accept(new hydra.core.Term.PartialVisitor<>() {
