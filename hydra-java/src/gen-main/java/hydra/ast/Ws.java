...
public abstract class Ws implements Serializable {
  ...
  public static final hydra.core.Name FIELD_NAME_SPACE = new hydra.core.Name("space");
  
  public static final hydra.core.Name FIELD_NAME_BREAK = new hydra.core.Name("break");
  
  public static final hydra.core.Name FIELD_NAME_BREAK_AND_INDENT = new hydra.core.Name("breakAndIndent");
  
  public static final hydra.core.Name FIELD_NAME_DOUBLE_BREAK = new hydra.core.Name("doubleBreak");
  ...
  public static final class None extends hydra.ast.Ws implements Serializable {
    ...
    public None (java.lang.Void value) {
  ...
  public static final class Space extends hydra.ast.Ws implements Serializable {
    ...
    public Space (java.lang.Void value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Break extends hydra.ast.Ws implements Serializable {
    ...
    public Break (java.lang.Void value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class DoubleBreak extends hydra.ast.Ws implements Serializable {
    ...
    public DoubleBreak (java.lang.Void value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
