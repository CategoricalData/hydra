...
public interface Relational {
  ...
  static <T> hydra.phantoms.TTerm<hydra.relational.ColumnSchema<T>> columnSchema(hydra.phantoms.TTerm<hydra.relational.ColumnName> name, hydra.phantoms.TTerm<T> domain) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.ColumnSchema"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.relational.ForeignKey> foreignKey(hydra.phantoms.TTerm<hydra.relational.RelationName> foreignRelation, hydra.phantoms.TTerm<hydra.util.PersistentMap<hydra.relational.ColumnName, hydra.relational.ColumnName>> keys) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.ForeignKey"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.util.PersistentMap<hydra.relational.ColumnName, hydra.relational.ColumnName>> foreignKeyKeys(hydra.phantoms.TTerm<hydra.relational.ForeignKey> x) {
  ...
  static hydra.phantoms.TTerm<hydra.relational.ForeignKey> foreignKeyWithKeys(hydra.phantoms.TTerm<hydra.relational.ForeignKey> original, hydra.phantoms.TTerm<hydra.util.PersistentMap<hydra.relational.ColumnName, hydra.relational.ColumnName>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.ForeignKey"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.relational.PrimaryKey> primaryKey(hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ColumnName>> x) {
  ...
  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ColumnName>> unPrimaryKey(hydra.phantoms.TTerm<hydra.relational.PrimaryKey> x) {
  ...
  static <V> hydra.phantoms.TTerm<hydra.relational.Relation<V>> relation(hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.Row<V>>> x) {
  ...
  static <V> hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.Row<V>>> unRelation(hydra.phantoms.TTerm<hydra.relational.Relation<V>> x) {
  ...
  static <T> hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> relationSchema(hydra.phantoms.TTerm<hydra.relational.RelationName> name, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ColumnSchema<T>>> columns, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.PrimaryKey>> primaryKeys, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ForeignKey>> foreignKeys) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.RelationSchema"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("name"), (name).value),
  ...
  static <T> hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ColumnSchema<T>>> relationSchemaColumns(hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("columns"))))), (x).value)));
  }

  static <T> hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.PrimaryKey>> relationSchemaPrimaryKeys(hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("primaryKeys"))))), (x).value)));
  }

  static <T> hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ForeignKey>> relationSchemaForeignKeys(hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("foreignKeys"))))), (x).value)));
  }
  ...
  static <T> hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> relationSchemaWithColumns(hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ColumnSchema<T>>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.RelationSchema"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("name"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("name"))))), (original).value))),
  ...
  static <T> hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> relationSchemaWithPrimaryKeys(hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.PrimaryKey>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.RelationSchema"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("name"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("name"))))), (original).value))),
      new hydra.core.Field(new hydra.core.Name("columns"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("columns"))))), (original).value))),
  ...
  static <T> hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> relationSchemaWithForeignKeys(hydra.phantoms.TTerm<hydra.relational.RelationSchema<T>> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.relational.ForeignKey>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.relational.RelationSchema"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("name"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("name"))))), (original).value))),
      new hydra.core.Field(new hydra.core.Name("columns"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("columns"))))), (original).value))),
      new hydra.core.Field(new hydra.core.Name("primaryKeys"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.relational.RelationSchema"), new hydra.core.Name("primaryKeys"))))), (original).value))),
  ...
  static <V> hydra.phantoms.TTerm<hydra.relational.Relationship<V>> relationship(hydra.phantoms.TTerm<hydra.util.PersistentSet<hydra.util.PersistentMap<hydra.relational.ColumnName, V>>> x) {
  ...
  static <V> hydra.phantoms.TTerm<hydra.util.PersistentSet<hydra.util.PersistentMap<hydra.relational.ColumnName, V>>> unRelationship(hydra.phantoms.TTerm<hydra.relational.Relationship<V>> x) {
  ...
  static <V> hydra.phantoms.TTerm<hydra.relational.Row<V>> row(hydra.phantoms.TTerm<hydra.util.ConsList<V>> x) {
  ...
  static <V> hydra.phantoms.TTerm<hydra.util.ConsList<V>> unRow(hydra.phantoms.TTerm<hydra.relational.Row<V>> x) {
