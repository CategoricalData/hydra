...
public interface Packaging {
  static hydra.phantoms.TTerm<hydra.packaging.Package_> package_(hydra.phantoms.TTerm<hydra.packaging.PackageName> name, hydra.phantoms.TTerm<java.util.List<hydra.module.Module>> modules, hydra.phantoms.TTerm<java.util.List<hydra.packaging.PackageName>> dependencies, hydra.phantoms.TTerm<hydra.util.Maybe<String>> description) {
  ...
  static hydra.phantoms.TTerm<java.util.List<hydra.module.Module>> packageModules(hydra.phantoms.TTerm<hydra.packaging.Package_> x) {
  ...
  static hydra.phantoms.TTerm<hydra.packaging.Package_> packageWithModules(hydra.phantoms.TTerm<hydra.packaging.Package_> original, hydra.phantoms.TTerm<java.util.List<hydra.module.Module>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.packaging.Package"), java.util.Arrays.asList(
      new hydra.core.Field(new hydra.core.Name("name"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.packaging.Package"), new hydra.core.Name("name"))))), (original).value))),
