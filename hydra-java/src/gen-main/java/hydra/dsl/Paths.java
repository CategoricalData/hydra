...
public interface Paths {
  static hydra.phantoms.TTerm<hydra.paths.SubtermEdge> subtermEdge(hydra.phantoms.TTerm<hydra.paths.SubtermNode> source, hydra.phantoms.TTerm<hydra.paths.SubtermPath> path, hydra.phantoms.TTerm<hydra.paths.SubtermNode> target) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtermEdge"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtermGraph> subtermGraph(hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermNode>> nodes, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermEdge>> edges) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtermGraph"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("nodes"), (nodes).value),
      new hydra.core.Field(new hydra.core.Name("edges"), (edges).value)))));
  }

  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermEdge>> subtermGraphEdges(hydra.phantoms.TTerm<hydra.paths.SubtermGraph> x) {
  ...
  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermNode>> subtermGraphNodes(hydra.phantoms.TTerm<hydra.paths.SubtermGraph> x) {
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtermGraph> subtermGraphWithEdges(hydra.phantoms.TTerm<hydra.paths.SubtermGraph> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermEdge>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtermGraph"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtermGraph> subtermGraphWithNodes(hydra.phantoms.TTerm<hydra.paths.SubtermGraph> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermNode>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtermGraph"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtermNode> subtermNode(hydra.phantoms.TTerm<hydra.core.Name> name, hydra.phantoms.TTerm<String> label, hydra.phantoms.TTerm<String> id) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtermNode"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtermPath> subtermPath(hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermStep>> x) {
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepAnnotatedBody() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("annotatedBody"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepApplicationArgument() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("applicationArgument"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepApplicationFunction() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("applicationFunction"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepInjectionTerm() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("injectionTerm"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepLambdaBody() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("lambdaBody"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepLetBinding(hydra.phantoms.TTerm<hydra.core.Name> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("letBinding"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepLetBody() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("letBody"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepListElement(hydra.phantoms.TTerm<Integer> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("listElement"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepMapKey(hydra.phantoms.TTerm<Integer> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("mapKey"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepMapValue(hydra.phantoms.TTerm<Integer> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("mapValue"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepMaybeTerm() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("maybeTerm"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepProductTerm(hydra.phantoms.TTerm<Integer> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("productTerm"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepRecordField(hydra.phantoms.TTerm<hydra.core.Name> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("recordField"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepSetElement(hydra.phantoms.TTerm<Integer> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("setElement"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepSumTerm() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("sumTerm"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepTypeApplicationTerm() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("typeApplicationTerm"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepTypeLambdaBody() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("typeLambdaBody"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepUnionCasesBranch(hydra.phantoms.TTerm<hydra.core.Name> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("unionCasesBranch"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepUnionCasesDefault() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("unionCasesDefault"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtermStep> subtermStepWrappedTerm() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtermStep"), new hydra.core.Field(new hydra.core.Name("wrappedTerm"), new hydra.core.Term.Unit()))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtypeEdge> subtypeEdge(hydra.phantoms.TTerm<hydra.paths.SubtypeNode> source, hydra.phantoms.TTerm<hydra.paths.SubtypePath> path, hydra.phantoms.TTerm<hydra.paths.SubtypeNode> target) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtypeEdge"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("source"), (source).value),
      new hydra.core.Field(new hydra.core.Name("path"), (path).value),
      new hydra.core.Field(new hydra.core.Name("target"), (target).value)))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtypeGraph> subtypeGraph(hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeNode>> nodes, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeEdge>> edges) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtypeGraph"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("nodes"), (nodes).value),
      new hydra.core.Field(new hydra.core.Name("edges"), (edges).value)))));
  }

  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeEdge>> subtypeGraphEdges(hydra.phantoms.TTerm<hydra.paths.SubtypeGraph> x) {
  ...
  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeNode>> subtypeGraphNodes(hydra.phantoms.TTerm<hydra.paths.SubtypeGraph> x) {
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtypeGraph> subtypeGraphWithEdges(hydra.phantoms.TTerm<hydra.paths.SubtypeGraph> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeEdge>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtypeGraph"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("nodes"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.paths.SubtypeGraph"), new hydra.core.Name("nodes"))))), (original).value))),
      new hydra.core.Field(new hydra.core.Name("edges"), (newVal).value)))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeGraph> subtypeGraphWithNodes(hydra.phantoms.TTerm<hydra.paths.SubtypeGraph> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeNode>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtypeGraph"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("nodes"), (newVal).value),
      new hydra.core.Field(new hydra.core.Name("edges"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.paths.SubtypeGraph"), new hydra.core.Name("edges"))))), (original).value)))))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtypeNode> subtypeNode(hydra.phantoms.TTerm<hydra.core.Name> name, hydra.phantoms.TTerm<String> label, hydra.phantoms.TTerm<String> id) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.paths.SubtypeNode"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("name"), (name).value),
      new hydra.core.Field(new hydra.core.Name("label"), (label).value),
      new hydra.core.Field(new hydra.core.Name("id"), (id).value)))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtypePath> subtypePath(hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeStep>> x) {
  ...
  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepAnnotatedBody() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("annotatedBody"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepApplicationArgument() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("applicationArgument"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepApplicationFunction() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("applicationFunction"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepEitherLeft() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("eitherLeft"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepEitherRight() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("eitherRight"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepForallBody() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("forallBody"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepFunctionCodomain() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("functionCodomain"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepFunctionDomain() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("functionDomain"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepListElement() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("listElement"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepMapKeys() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("mapKeys"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepMapValues() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("mapValues"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepMaybeElement() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("maybeElement"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepPairFirst() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("pairFirst"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepPairSecond() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("pairSecond"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepRecordField(hydra.phantoms.TTerm<hydra.core.Name> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("recordField"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepSetElement() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("setElement"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepUnionField(hydra.phantoms.TTerm<hydra.core.Name> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("unionField"), (x).value))));
  }

  static hydra.phantoms.TTerm<hydra.paths.SubtypeStep> subtypeStepWrappedType() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("hydra.paths.SubtypeStep"), new hydra.core.Field(new hydra.core.Name("wrappedType"), new hydra.core.Term.Unit()))));
  }

  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtermStep>> unSubtermPath(hydra.phantoms.TTerm<hydra.paths.SubtermPath> x) {
  ...
  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.paths.SubtypeStep>> unSubtypePath(hydra.phantoms.TTerm<hydra.paths.SubtypePath> x) {
