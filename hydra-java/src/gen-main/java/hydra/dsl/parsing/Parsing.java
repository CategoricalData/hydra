...
public interface Parsing {
  static hydra.phantoms.TTerm<hydra.parsing.ParseError> parseError(hydra.phantoms.TTerm<String> message, hydra.phantoms.TTerm<String> remainder) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.parsing.ParseError"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<String> parseErrorMessage(hydra.phantoms.TTerm<hydra.parsing.ParseError> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.parsing.ParseError"), new hydra.core.Name("message"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<String> parseErrorRemainder(hydra.phantoms.TTerm<hydra.parsing.ParseError> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.parsing.ParseError"), new hydra.core.Name("remainder"))))), (x).value)));
  }
  ...
  static <A> hydra.phantoms.TTerm<java.util.function.Function<String, hydra.parsing.ParseResult<A>>> unParser(hydra.phantoms.TTerm<hydra.parsing.Parser<A>> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Wrap(new hydra.core.Name("hydra.parsing.Parser")))), (x).value)));
  }
}
