...
public interface Graph {
  ...
  static hydra.phantoms.TTerm<hydra.graph.Primitive> primitive(hydra.phantoms.TTerm<hydra.core.Name> name, hydra.phantoms.TTerm<hydra.core.TypeScheme> type, hydra.phantoms.TTerm<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.util.ConsList<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Term>>>>> implementation) {
