...
package hydra.dsl.error.checking;
...
public interface Checking {
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.IncorrectUnificationError> incorrectUnificationError(hydra.phantoms.TTerm<hydra.typing.TypeSubst> substitution) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.IncorrectUnificationError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("substitution"), (substitution).value)))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.IncorrectUnificationError> incorrectUnificationErrorWithSubstitution(hydra.phantoms.TTerm<hydra.error.checking.IncorrectUnificationError> original, hydra.phantoms.TTerm<hydra.typing.TypeSubst> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.IncorrectUnificationError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("substitution"), (newVal).value)))));
  }

  static hydra.phantoms.TTerm<hydra.error.checking.NotAForallTypeError> notAForallTypeError(hydra.phantoms.TTerm<hydra.core.Type> type, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.core.Type>> typeArguments) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.NotAForallTypeError"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.core.Type> notAForallTypeErrorType(hydra.phantoms.TTerm<hydra.error.checking.NotAForallTypeError> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.error.checking.NotAForallTypeError"), new hydra.core.Name("type"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.util.ConsList<hydra.core.Type>> notAForallTypeErrorTypeArguments(hydra.phantoms.TTerm<hydra.error.checking.NotAForallTypeError> x) {
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.NotAForallTypeError> notAForallTypeErrorWithTypeArguments(hydra.phantoms.TTerm<hydra.error.checking.NotAForallTypeError> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.core.Type>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.NotAForallTypeError"), hydra.util.ConsList.of(
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.NotAFunctionTypeError> notAFunctionTypeError(hydra.phantoms.TTerm<hydra.core.Type> type) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.NotAFunctionTypeError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("type"), (type).value)))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.core.Type> notAFunctionTypeErrorType(hydra.phantoms.TTerm<hydra.error.checking.NotAFunctionTypeError> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.error.checking.NotAFunctionTypeError"), new hydra.core.Name("type"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.NotAFunctionTypeError> notAFunctionTypeErrorWithType(hydra.phantoms.TTerm<hydra.error.checking.NotAFunctionTypeError> original, hydra.phantoms.TTerm<hydra.core.Type> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.NotAFunctionTypeError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("type"), (newVal).value)))));
  }

  static hydra.phantoms.TTerm<hydra.error.checking.TypeArityMismatchError> typeArityMismatchError(hydra.phantoms.TTerm<hydra.core.Type> type, hydra.phantoms.TTerm<Integer> expectedArity, hydra.phantoms.TTerm<Integer> actualArity, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.core.Type>> typeArguments) {
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.TypeArityMismatchError> typeArityMismatchErrorWithTypeArguments(hydra.phantoms.TTerm<hydra.error.checking.TypeArityMismatchError> original, hydra.phantoms.TTerm<hydra.util.ConsList<hydra.core.Type>> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.TypeArityMismatchError"), hydra.util.ConsList.of(
      new hydra.core.Field(new hydra.core.Name("type"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.error.checking.TypeArityMismatchError"), new hydra.core.Name("type"))))), (original).value))),
      new hydra.core.Field(new hydra.core.Name("expectedArity"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.error.checking.TypeArityMismatchError"), new hydra.core.Name("expectedArity"))))), (original).value))),
      new hydra.core.Field(new hydra.core.Name("actualArity"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.error.checking.TypeArityMismatchError"), new hydra.core.Name("actualArity"))))), (original).value))),
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.UnsupportedTermVariantError> unsupportedTermVariantError(hydra.phantoms.TTerm<hydra.variants.TermVariant> termVariant) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.UnsupportedTermVariantError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("termVariant"), (termVariant).value)))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.variants.TermVariant> unsupportedTermVariantErrorTermVariant(hydra.phantoms.TTerm<hydra.error.checking.UnsupportedTermVariantError> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.error.checking.UnsupportedTermVariantError"), new hydra.core.Name("termVariant"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.UnsupportedTermVariantError> unsupportedTermVariantErrorWithTermVariant(hydra.phantoms.TTerm<hydra.error.checking.UnsupportedTermVariantError> original, hydra.phantoms.TTerm<hydra.variants.TermVariant> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.UnsupportedTermVariantError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("termVariant"), (newVal).value)))));
  }

  static hydra.phantoms.TTerm<hydra.error.checking.UntypedLambdaError> untypedLambdaError() {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.UntypedLambdaError"), hydra.util.ConsList.empty())));
  }
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.UntypedLetBindingError> untypedLetBindingError(hydra.phantoms.TTerm<hydra.core.Binding> binding) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.UntypedLetBindingError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("binding"), (binding).value)))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.core.Binding> untypedLetBindingErrorBinding(hydra.phantoms.TTerm<hydra.error.checking.UntypedLetBindingError> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.error.checking.UntypedLetBindingError"), new hydra.core.Name("binding"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.error.checking.UntypedLetBindingError> untypedLetBindingErrorWithBinding(hydra.phantoms.TTerm<hydra.error.checking.UntypedLetBindingError> original, hydra.phantoms.TTerm<hydra.core.Binding> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.error.checking.UntypedLetBindingError"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("binding"), (newVal).value)))));
  }
}
