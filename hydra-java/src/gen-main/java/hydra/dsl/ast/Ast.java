...
public interface Ast {
  ...
  static hydra.phantoms.TTerm<hydra.util.Maybe<String>> blockStyleIndent(hydra.phantoms.TTerm<hydra.ast.BlockStyle> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.BlockStyle"), new hydra.core.Name("indent"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.ast.Brackets> bracketExprBrackets(hydra.phantoms.TTerm<hydra.ast.BracketExpr> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.BracketExpr"), new hydra.core.Name("brackets"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Expr> bracketExprEnclosed(hydra.phantoms.TTerm<hydra.ast.BracketExpr> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.BracketExpr"), new hydra.core.Name("enclosed"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.BlockStyle> bracketExprStyle(hydra.phantoms.TTerm<hydra.ast.BracketExpr> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.BracketExpr"), new hydra.core.Name("style"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.ast.Symbol> bracketsOpen(hydra.phantoms.TTerm<hydra.ast.Brackets> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Brackets"), new hydra.core.Name("open"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Symbol> bracketsClose(hydra.phantoms.TTerm<hydra.ast.Brackets> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Brackets"), new hydra.core.Name("close"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.ast.IndentStyle> indentedExpressionStyle(hydra.phantoms.TTerm<hydra.ast.IndentedExpression> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.IndentedExpression"), new hydra.core.Name("style"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Expr> indentedExpressionExpr(hydra.phantoms.TTerm<hydra.ast.IndentedExpression> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.IndentedExpression"), new hydra.core.Name("expr"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.ast.Symbol> opSymbol(hydra.phantoms.TTerm<hydra.ast.Op> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Op"), new hydra.core.Name("symbol"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Padding> opPadding(hydra.phantoms.TTerm<hydra.ast.Op> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Op"), new hydra.core.Name("padding"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Precedence> opPrecedence(hydra.phantoms.TTerm<hydra.ast.Op> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Op"), new hydra.core.Name("precedence"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Associativity> opAssociativity(hydra.phantoms.TTerm<hydra.ast.Op> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Op"), new hydra.core.Name("associativity"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.ast.Op> opWithSymbol(hydra.phantoms.TTerm<hydra.ast.Op> original, hydra.phantoms.TTerm<hydra.ast.Symbol> newVal) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("hydra.ast.Op"), hydra.util.ConsList.of(
      ...
      new hydra.core.Field(new hydra.core.Name("associativity"), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Op"), new hydra.core.Name("associativity"))))), (original).value)))))));
  }
  ...
  static hydra.phantoms.TTerm<hydra.ast.Op> opExprOp(hydra.phantoms.TTerm<hydra.ast.OpExpr> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.OpExpr"), new hydra.core.Name("op"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Expr> opExprLhs(hydra.phantoms.TTerm<hydra.ast.OpExpr> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.OpExpr"), new hydra.core.Name("lhs"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Expr> opExprRhs(hydra.phantoms.TTerm<hydra.ast.OpExpr> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.OpExpr"), new hydra.core.Name("rhs"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<hydra.ast.Ws> paddingLeft(hydra.phantoms.TTerm<hydra.ast.Padding> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Padding"), new hydra.core.Name("left"))))), (x).value)));
  }

  static hydra.phantoms.TTerm<hydra.ast.Ws> paddingRight(hydra.phantoms.TTerm<hydra.ast.Padding> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Record(new hydra.core.Projection(new hydra.core.Name("hydra.ast.Padding"), new hydra.core.Name("right"))))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<Integer> unPrecedence(hydra.phantoms.TTerm<hydra.ast.Precedence> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Wrap(new hydra.core.Name("hydra.ast.Precedence")))), (x).value)));
  }
  ...
  static hydra.phantoms.TTerm<String> unSymbol(hydra.phantoms.TTerm<hydra.ast.Symbol> x) {
    return new hydra.phantoms.TTerm(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Wrap(new hydra.core.Name("hydra.ast.Symbol")))), (x).value)));
  }
