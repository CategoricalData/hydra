...
public interface Decoding {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.Bimap.apply(
        ...
        hydra.decode.core.Core.type(
          graph,
          (b).term)),
      (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.error.DecodingError>, hydra.core.Binding>>) (typ -> (hydra.util.Either<hydra.context.InContext<hydra.error.DecodingError>, hydra.core.Binding>) ((hydra.util.Either<hydra.context.InContext<hydra.error.DecodingError>, hydra.core.Binding>) (hydra.util.Either.<hydra.context.InContext<hydra.error.DecodingError>, hydra.core.Binding>right(new hydra.core.Binding(hydra.decoding.Decoding.decodeBindingName((b).name), hydra.decoding.Decoding.decodeType(typ), hydra.util.Maybe.just(hydra.decoding.Decoding.decoderTypeScheme(typ))))))));
  }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>> decodeModule(hydra.context.Context cx, hydra.graph.Graph graph, hydra.module.Module mod) {
    return hydra.lib.eithers.Bind.apply(
      hydra.decoding.Decoding.filterTypeBindings(
        ...
        graph,
        (mod).elements),
      (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>>) (typeBindings -> hydra.lib.logic.IfElse.lazy(
        hydra.lib.lists.Null.apply(typeBindings),
        () -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>right((hydra.util.Maybe<hydra.module.Module>) (hydra.util.Maybe.<hydra.module.Module>nothing())))),
          ...
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Binding>>) (b -> hydra.lib.eithers.Bimap.apply(
              ...
              hydra.decoding.Decoding.decodeBinding(
                ...
                b))),
            typeBindings),
          (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>>) (decodedBindings -> {
            ...
            hydra.util.Lazy<java.util.List<hydra.module.Namespace>> allDecodedDeps = new hydra.util.Lazy<>(() -> hydra.lib.lists.Nub.apply(hydra.lib.lists.Concat2.apply(
              decodedTypeDeps.get(),
              decodedTermDeps.get())));
            return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.module.Module>>right(hydra.util.Maybe.just(new hydra.module.Module(hydra.decoding.Decoding.decodeNamespace((mod).namespace), decodedBindings, hydra.lib.lists.Concat2.apply(
              java.util.List.of(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, java.util.List<hydra.core.Binding>> filterTypeBindings(hydra.context.Context cx, hydra.graph.Graph graph, java.util.List<hydra.core.Binding> bindings) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.core.Binding>> isDecodableBinding(hydra.context.Context cx, hydra.graph.Graph graph, hydra.core.Binding b) {
    return hydra.lib.eithers.Bind.apply(
      hydra.schemas.Schemas.isSerializableByName(
        ...
        graph,
        (b).name),
      (java.util.function.Function<Boolean, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.core.Binding>>>) (serializable -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.core.Binding>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.core.Binding>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<hydra.core.Binding>>right(hydra.lib.logic.IfElse.lazy(
        serializable,
