        ...
        () -> hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Maybe<hydra.module.Module>>>) (decodedBindings -> {
            ...
            hydra.util.Lazy<java.util.List<hydra.module.Namespace>> allDecodedDeps = new hydra.util.Lazy<>(() -> hydra.lib.lists.Nub.apply(hydra.lib.lists.Concat2.apply(
              decodedTypeDeps.get(),
              decodedTermDeps.get())));
            return hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.util.Maybe<hydra.module.Module>>right(hydra.util.Maybe.just(new hydra.module.Module(hydra.decoding.Decoding.decodeNamespace((mod).namespace), decodedBindings, hydra.lib.lists.Concat2.apply(
              java.util.List.of(
