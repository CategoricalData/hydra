...
public interface Checking {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type> applyTypeArgumentsToType(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Type t) {
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type>>) (() -> {
        hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type>> nonnull = new hydra.util.Lazy<>(() -> (t).accept(new hydra.core.Type.PartialVisitor<>() {
          ...
          public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type> otherwise(hydra.core.Type instance) {
            return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type>left((hydra.context.InContext<hydra.errors.Error_>) (new hydra.context.InContext<hydra.errors.Error_>(new hydra.errors.Error_.Other(new hydra.errors.OtherError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "not a forall type: ",
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void> checkForUnboundTypeVariables(hydra.context.Context cx, hydra.graph.Graph tx, hydra.core.Term term0) {
    ...
    java.util.concurrent.atomic.AtomicReference<java.util.function.Function<hydra.util.PersistentSet<hydra.core.Name>, java.util.function.Function<hydra.util.ConsList<String>, java.util.function.Function<hydra.util.Maybe<hydra.core.Binding>, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>>>>>> checkRecursive = new java.util.concurrent.atomic.AtomicReference<>();
    checkRecursive.set((java.util.function.Function<hydra.util.PersistentSet<hydra.core.Name>, java.util.function.Function<hydra.util.ConsList<String>, java.util.function.Function<hydra.util.Maybe<hydra.core.Binding>, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>>>>>) (vars -> (java.util.function.Function<hydra.util.ConsList<String>, java.util.function.Function<hydra.util.Maybe<hydra.core.Binding>, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>>>>) (trace -> (java.util.function.Function<hydra.util.Maybe<hydra.core.Binding>, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>>>) (lbinding -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>>) (term -> {
      ...
      hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>> dflt = new hydra.util.Lazy<>(() -> hydra.lib.eithers.Bind.apply(
        ...
        (java.util.function.Function<hydra.util.ConsList<java.lang.Void>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>>) (ignored -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>right(null))));
        ...
        public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void> visit(hydra.core.Term.Let l) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.lib.eithers.MapList.apply(
              forBinding,
              (l).value.bindings),
            (java.util.function.Function<hydra.util.ConsList<java.lang.Void>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, java.lang.Void>>) (ignored -> (recurse).apply((l).value.body)));
        }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<java.lang.Void, hydra.context.Context>> checkNominalApplication(hydra.context.Context cx, hydra.graph.Graph tx, hydra.core.Name tname, hydra.util.ConsList<hydra.core.Type> typeArgs) {
    return hydra.lib.eithers.Bind.apply(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type> checkSameType(hydra.context.Context cx, hydra.graph.Graph tx, String desc, hydra.util.ConsList<hydra.core.Type> types) {
    return hydra.lib.logic.IfElse.lazy(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.typing.TypeSubst> checkTypeSubst(hydra.context.Context cx, hydra.graph.Graph tx, hydra.typing.TypeSubst subst) {
    java.util.function.Function<hydra.core.TypeScheme, Boolean> isNominal = (java.util.function.Function<hydra.core.TypeScheme, Boolean>) (ts -> hydra.Rewriting.deannotateType((ts).type).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
  ...
  static Boolean containsInScopeTypeVars(hydra.graph.Graph tx, hydra.core.Type t) {
    hydra.util.PersistentSet<hydra.core.Name> freeVars = hydra.Rewriting.freeVariablesInTypeSimple(t);
    hydra.util.PersistentSet<hydra.core.Name> vars = (tx).typeVariables;
  ...
  static hydra.core.Type normalizeTypeFreeVars(hydra.core.Type typ) {
    ...
    hydra.util.Lazy<hydra.util.PersistentMap<hydra.core.Name, hydra.core.Name>> subst = new hydra.util.Lazy<>(() -> hydra.Rewriting.foldOverType(
      ...
      typ));
    return hydra.Rewriting.substituteTypeVariables(
      subst.get(),
      typ);
  }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOf(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Term term) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfAnnotatedTerm(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.AnnotatedTerm at) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfApplication(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Application app) {
    ...
    tryType.set((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Type, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>>>) (cx0 -> (java.util.function.Function<hydra.core.Type, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>>) (tfun -> (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (targ -> (tfun).accept(new hydra.core.Type.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> visit(hydra.core.Type.Variable v) {
        hydra.util.Pair<hydra.core.Name, hydra.context.Context> nameResult = hydra.Schemas.freshName(cx0);
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfCaseStatement(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.CaseStatement cs) {
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.util.Maybe<hydra.util.Pair<hydra.core.Type, hydra.context.Context>>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (dfltResult -> {
        hydra.util.Lazy<hydra.context.Context> cx2 = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
          ...
          dfltResult));
        hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>> foldResult = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
          (java.util.function.Function<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>>) (acc -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (term -> hydra.lib.eithers.Bind.apply(
            acc,
            (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (accR -> {
              ...
              return hydra.lib.eithers.Bind.apply(
                hydra.Checking.typeOf(
                  ...
                  (hydra.util.ConsList<hydra.core.Type>) (hydra.util.ConsList.<hydra.core.Type>empty()),
                  term),
                (java.util.function.Function<hydra.util.Pair<hydra.core.Type, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (tResult -> {
                  ...
                  return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>right((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) ((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) (new hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>(hydra.lib.lists.Concat2.apply(
                    types.get(),
                    hydra.lib.lists.Pure.apply(t.get())), cxB.get()))));
                }));
            })))),
          hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>right((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) ((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) (new hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>((hydra.util.ConsList<hydra.core.Type>) (hydra.util.ConsList.<hydra.core.Type>empty()), cx2.get())))),
          cterms.get()));
        ...
        return hydra.lib.eithers.Bind.apply(
          foldResult.get(),
          (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (foldR -> {
            ...
            hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>> fcodsResult = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
              (java.util.function.Function<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>, java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>>) (acc -> (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (t -> hydra.lib.eithers.Bind.apply(
                acc,
                (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (accR -> {
                  ...
                  return hydra.lib.eithers.Bind.apply(
                    hydra.extract.Core.functionType(
                      cx3.get(),
                      t),
                    (java.util.function.Function<hydra.core.FunctionType, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (ft -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>right((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) ((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) (new hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>(hydra.lib.lists.Concat2.apply(
                      cods.get(),
                      hydra.lib.lists.Pure.apply((ft).codomain)), cx3.get()))))));
                })))),
              hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>right((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) ((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) (new hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>((hydra.util.ConsList<hydra.core.Type>) (hydra.util.ConsList.<hydra.core.Type>empty()), cx3.get())))),
              tcterms.get()));
            return hydra.lib.eithers.Bind.apply(
              fcodsResult.get(),
              (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (fcodsR -> {
                ...
                return hydra.lib.eithers.Bind.apply(
                  hydra.Checking.checkSameType(
                    ...
                    "case branches",
                    cods.get()),
                  (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (cod -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>right((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) ((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) (new hydra.util.Pair<hydra.core.Type, hydra.context.Context>(new hydra.core.Type.Function(new hydra.core.FunctionType(hydra.Schemas.nominalApplication(
                    tname,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfEither(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.util.Either<hydra.core.Term, hydra.core.Term> et) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfInjection(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Injection injection) {
      ...
      (java.util.function.Function<hydra.util.Pair<hydra.core.TypeScheme, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (schemaResult -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.extract.Core.unionType(
            ...
            tname,
            sbody),
          (java.util.function.Function<hydra.util.ConsList<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (sfields -> hydra.lib.eithers.Bind.apply(
            hydra.Schemas.findFieldType(
              cx2.get(),
              fname,
              sfields),
            (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (ftyp -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>right((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) ((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) (new hydra.util.Pair<hydra.core.Type, hydra.context.Context>(hydra.Schemas.nominalApplication(
              tname,
              typeArgs), cx2.get()))))))));
      }));
  }

  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfLambda(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Lambda l) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfLet(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Let letTerm) {
    java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type>> bindingType = (java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type>>) (b -> hydra.lib.maybes.Maybe.applyLazy(
      ...
      (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type>>) (ts -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.core.Type>right(hydra.Rewriting.typeSchemeToFType(ts))),
      (b).type));
    ...
    hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>> btypesResult = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
      (java.util.function.Function<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>, java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>>>) (acc -> (java.util.function.Function<hydra.core.Binding, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>>) (b -> hydra.lib.eithers.Bind.apply(
        acc,
        (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>>) (accR -> {
          hydra.util.Lazy<hydra.util.ConsList<hydra.core.Type>> types = new hydra.util.Lazy<>(() -> hydra.lib.pairs.First.apply(accR));
          return hydra.lib.eithers.Bind.apply(
            (bindingType).apply(b),
            (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>>) (btype -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>right((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>) ((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>) (new hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>(hydra.lib.lists.Concat2.apply(
              types.get(),
              hydra.lib.lists.Pure.apply(btype)), null))))));
        })))),
      hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>>right((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>) ((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>) (new hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>((hydra.util.ConsList<hydra.core.Type>) (hydra.util.ConsList.<hydra.core.Type>empty()), null)))),
      bs));
    return hydra.lib.eithers.Bind.apply(
      btypesResult.get(),
      (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, java.lang.Void>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (btypesR -> {
        ...
        hydra.util.Lazy<hydra.graph.Graph> tx2 = new hydra.util.Lazy<>(() -> new hydra.graph.Graph((tx).boundTerms, hydra.lib.maps.Union.apply(
          hydra.lib.maps.FromList.apply(hydra.lib.lists.Zip.apply(
            bnames.get(),
            hydra.lib.lists.Map.apply(
              hydra.Rewriting::fTypeToTypeScheme,
              btypes.get()))),
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfList(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.util.ConsList<hydra.core.Term> els) {
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.lists.Null.apply(els),
      ...
      () -> ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (() -> {
        hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>> foldResult = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
          ...
          hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>right((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) ((hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>) (new hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>((hydra.util.ConsList<hydra.core.Type>) (hydra.util.ConsList.<hydra.core.Type>empty()), cx)))),
          els));
        return hydra.lib.eithers.Bind.apply(
          foldResult.get(),
          (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (foldR -> {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfLiteral(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Literal lit) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfMap(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.util.PersistentMap<hydra.core.Term, hydra.core.Term> m) {
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (() -> {
        ...
        return ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (() -> {
          hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>> keyFoldResult = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
            (java.util.function.Function<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>, java.util.function.Function<hydra.util.Pair<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>>) (acc -> (java.util.function.Function<hydra.util.Pair<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (p -> hydra.lib.eithers.Bind.apply(
              acc,
              (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (accR -> {
                hydra.util.Lazy<hydra.context.Context> cxA = new hydra.util.Lazy<>(() -> hydra.lib.pairs.Second.apply(accR));
                hydra.util.Lazy<hydra.util.ConsList<hydra.core.Type>> types = new hydra.util.Lazy<>(() -> hydra.lib.pairs.First.apply(accR));
          ...
          return hydra.lib.eithers.Bind.apply(
            keyFoldResult.get(),
            (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (keyFoldR -> {
              ...
              return hydra.lib.eithers.Bind.apply(
                ...
                (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (kt -> {
                  hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>> valFoldResult = new hydra.util.Lazy<>(() -> hydra.lib.lists.Foldl.apply(
                    (java.util.function.Function<hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>, java.util.function.Function<hydra.util.Pair<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>>) (acc -> (java.util.function.Function<hydra.util.Pair<hydra.core.Term, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (p -> hydra.lib.eithers.Bind.apply(
                      acc,
                      (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>>>) (accR -> {
                        hydra.util.Lazy<hydra.context.Context> cxA = new hydra.util.Lazy<>(() -> hydra.lib.pairs.Second.apply(accR));
                  ...
                  return hydra.lib.eithers.Bind.apply(
                    valFoldResult.get(),
                    (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (valFoldR -> {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfMaybe(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.util.Maybe<hydra.core.Term> mt) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfPair(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.util.Pair<hydra.core.Term, hydra.core.Term> p) {
    hydra.util.Lazy<Integer> n = new hydra.util.Lazy<>(() -> hydra.lib.lists.Length.apply(typeArgs));
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.equality.Equal.apply(
        n.get(),
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfPrimitive(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Name name) {
    hydra.util.Lazy<hydra.util.Maybe<hydra.core.TypeScheme>> rawTs = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Map.apply(
      ...
      hydra.lib.maps.Lookup.apply(
        ...
        (tx).primitives)));
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>left((hydra.context.InContext<hydra.errors.Error_>) (new hydra.context.InContext<hydra.errors.Error_>(new hydra.errors.Error_.UndefinedTermVariable(new hydra.error.core.UndefinedTermVariableError(new hydra.paths.SubtermPath((hydra.util.ConsList<hydra.paths.SubtermStep>) (hydra.util.ConsList.<hydra.paths.SubtermStep>empty())), name)), cx))),
      (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (tsRaw -> {
        ...
        hydra.core.Type t = hydra.Rewriting.typeSchemeToFType(ts.get());
        return hydra.lib.eithers.Bind.apply(
          hydra.Checking.applyTypeArgumentsToType(
            cx2.get(),
            tx,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfProjection(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Projection p) {
          ...
          (java.util.function.Function<hydra.util.ConsList<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (sfields -> hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (ftyp -> {
              ...
              hydra.core.Type sftyp = hydra.Substitution.substInType(
                subst.get(),
                ftyp);
              return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>right((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) ((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) (new hydra.util.Pair<hydra.core.Type, hydra.context.Context>(new hydra.core.Type.Function(new hydra.core.FunctionType(hydra.Schemas.nominalApplication(
                tname,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfRecord(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Record record) {
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<hydra.core.Type>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (foldR -> {
        hydra.util.Lazy<hydra.context.Context> cx2 = new hydra.util.Lazy<>(() -> hydra.lib.pairs.Second.apply(foldR));
        return hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>right((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) ((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) (new hydra.util.Pair<hydra.core.Type, hydra.context.Context>(hydra.Schemas.nominalApplication(
          tname,
          typeArgs), cx2.get()))));
      }));
  }

  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfSet(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.util.PersistentSet<hydra.core.Term> els) {
    return hydra.lib.logic.IfElse.lazy(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfTypeLambda(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.TypeLambda tl) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfUnit(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs) {
    return hydra.lib.eithers.Bind.apply(
      hydra.Checking.applyTypeArgumentsToType(
        cx,
        tx,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfUnwrap(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Name tname) {
    return hydra.lib.eithers.Bind.apply(
      hydra.Schemas.requireSchemaType(
        cx,
        (tx).schemaTypes,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfVariable(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.Name name) {
    ...
    return hydra.lib.maybes.Maybe.applyLazy(
      ...
      (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>>>) (ts -> {
        hydra.util.Lazy<hydra.util.Pair<hydra.core.Type, hydra.context.Context>> tResult = new hydra.util.Lazy<>(() -> hydra.lib.logic.IfElse.lazy(
          hydra.lib.lists.Null.apply(typeArgs),
          () -> hydra.Schemas.instantiateType(
            cx,
            hydra.Rewriting.typeSchemeToFType(ts)),
          () -> (hydra.util.Pair<hydra.core.Type, hydra.context.Context>) ((hydra.util.Pair<hydra.core.Type, hydra.context.Context>) (new hydra.util.Pair<hydra.core.Type, hydra.context.Context>(hydra.Rewriting.typeSchemeToFType(ts), cx)))));
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.util.Pair<hydra.core.Type, hydra.context.Context>> typeOfWrappedTerm(hydra.context.Context cx, hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> typeArgs, hydra.core.WrappedTerm wt) {
  ...
  static Boolean typesAllEffectivelyEqual(hydra.graph.Graph tx, hydra.util.ConsList<hydra.core.Type> tlist) {
    ...
    java.util.function.Function<hydra.core.Type, Boolean> containsFreeVar = (java.util.function.Function<hydra.core.Type, Boolean>) (t -> {
      hydra.util.PersistentSet<hydra.core.Name> allVars = hydra.Rewriting.freeVariablesInTypeSimple(t);
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.logic.IfElse.lazy(
        ...
        () -> true,
        () -> hydra.Checking.allEqual(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.core.Type, hydra.core.Type>) (t -> hydra.Checking.normalizeTypeFreeVars(hydra.Rewriting.deannotateTypeRecursive(hydra.Rewriting.replaceTypedefs(
            types,
            t)))),
          tlist))));
  }
      ...
      hydra.lib.logic.Or.apply(
        ...
        hydra.Checking.typesAllEffectivelyEqual(
          ...
          hydra.util.ConsList.of(
            hydra.Schemas.fullyStripAndNormalizeType(t1),
