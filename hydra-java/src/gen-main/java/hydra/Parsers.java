...
public interface Parsers {
  static <T0> hydra.parsing.Parser<T0> alt(hydra.parsing.Parser<T0> p1, hydra.parsing.Parser<T0> p2) {
    return (hydra.parsing.Parser<T0>) (new hydra.parsing.Parser((java.util.function.Function<String, hydra.parsing.ParseResult<T0>>) (v1 -> hydra.Parsers.<T0>alt_parse(
      p1,
      p2,
      v1))));
  }
  ...
  static <T0> hydra.parsing.ParseResult<T0> alt_parse(hydra.parsing.Parser<T0> p1, hydra.parsing.Parser<T0> p2, String input) {
    return ((java.util.function.Function<hydra.parsing.ParseResult, hydra.parsing.ParseResult<T0>>) (v1 -> ((java.util.function.Function<hydra.parsing.ParseResult<T0>, hydra.parsing.ParseResult<T0>>) ((java.util.function.Function<hydra.parsing.ParseResult<T0>, hydra.parsing.ParseResult<T0>>) (u -> (u).accept(new hydra.parsing.ParseResult.PartialVisitor<>() {
      @Override
  ...
  static hydra.parsing.Parser<Integer> anyChar() {
    return hydra.Parsers.satisfy((java.util.function.Function<Integer, Boolean>) (ignored -> true));
  }
  ...
  static <T0, T1> hydra.parsing.Parser<T1> apply(hydra.parsing.Parser<java.util.function.Function<T0, T1>> pf, hydra.parsing.Parser<T0> pa) {
    return (hydra.parsing.Parser<T1>) (new hydra.parsing.Parser((java.util.function.Function<String, hydra.parsing.ParseResult<T1>>) (v1 -> hydra.Parsers.<T0, T1>apply_parse(
      pa,
      pf,
      v1))));
  }
  ...
  static <T0, T1> hydra.parsing.ParseResult<T1> apply_parse(hydra.parsing.Parser<T0> pa, hydra.parsing.Parser<java.util.function.Function<T0, T1>> pf, String input) {
    return ((java.util.function.Function<hydra.parsing.ParseResult, hydra.parsing.ParseResult<T1>>) (v1 -> ((java.util.function.Function<hydra.parsing.ParseResult<java.util.function.Function<T0, T1>>, hydra.parsing.ParseResult<T1>>) ((java.util.function.Function<hydra.parsing.ParseResult<java.util.function.Function<T0, T1>>, hydra.parsing.ParseResult<T1>>) (u -> (u).accept(new hydra.parsing.ParseResult.PartialVisitor<>() {
      @Override
  ...
  static <T0, T1, T2> hydra.parsing.Parser<T2> between(hydra.parsing.Parser<T0> open, hydra.parsing.Parser<T1> close, hydra.parsing.Parser<T2> p) {
    return hydra.Parsers.<T0, T2>bind(
      open,
      (java.util.function.Function<T0, hydra.parsing.Parser<T2>>) (ignored -> hydra.Parsers.<T2, T2>bind(
        p,
        (java.util.function.Function<T2, hydra.parsing.Parser<T2>>) (x -> hydra.Parsers.<T1, T2>bind(
          close,
          (java.util.function.Function<T1, hydra.parsing.Parser<T2>>) (_2 -> hydra.Parsers.<T2>pure(x)))))));
  }
  ...
  static <T0, T1> hydra.parsing.Parser<T1> bind(hydra.parsing.Parser<T0> pa, java.util.function.Function<T0, hydra.parsing.Parser<T1>> f) {
    return (hydra.parsing.Parser<T1>) (new hydra.parsing.Parser((java.util.function.Function<String, hydra.parsing.ParseResult<T1>>) (v1 -> hydra.Parsers.<T0, T1>bind_parse(
      f,
      pa,
      v1))));
  }
  ...
  static hydra.parsing.Parser<Integer> char_(Integer c) {
    return hydra.Parsers.satisfy((java.util.function.Function<Integer, Boolean>) (x -> hydra.lib.equality.Equal.apply(
      x,
      c)));
  }
  ...
  static <T0> hydra.parsing.Parser<T0> choice(hydra.util.ConsList<hydra.parsing.Parser<T0>> ps) {
    return hydra.lib.lists.Foldl.apply(
      p0 -> p1 -> hydra.Parsers.<T0>alt(
        p0,
        p1),
      hydra.Parsers.<T0>fail("no choice matched"),
      ps);
  }
  ...
  static <T0> hydra.parsing.Parser<hydra.util.ConsList<T0>> many(hydra.parsing.Parser<T0> p) {
    return hydra.Parsers.<hydra.util.ConsList<T0>>alt(
      hydra.Parsers.<T0>some(p),
      hydra.Parsers.<hydra.util.ConsList<T0>>pure((hydra.util.ConsList<T0>) (hydra.util.ConsList.<T0>empty())));
  }

  static <T0, T1> hydra.parsing.Parser<T1> map(java.util.function.Function<T0, T1> f, hydra.parsing.Parser<T0> pa) {
    return (hydra.parsing.Parser<T1>) (new hydra.parsing.Parser((java.util.function.Function<String, hydra.parsing.ParseResult<T1>>) (v1 -> hydra.Parsers.<T0, T1>map_parse(
      f,
      pa,
      v1))));
  }
  ...
  static <T0> hydra.parsing.Parser<hydra.util.Maybe<T0>> optional(hydra.parsing.Parser<T0> p) {
    return hydra.Parsers.<hydra.util.Maybe<T0>>alt(
      hydra.Parsers.<T0, hydra.util.Maybe<T0>>map(
        (java.util.function.Function<T0, hydra.util.Maybe<T0>>) (hydra.lib.maybes.Pure::apply),
        p),
      hydra.Parsers.<hydra.util.Maybe<T0>>pure((hydra.util.Maybe<T0>) (hydra.util.Maybe.<T0>nothing())));
  }
  ...
  static <T0, T1> hydra.parsing.Parser<hydra.util.ConsList<T0>> sepBy1(hydra.parsing.Parser<T0> p, hydra.parsing.Parser<T1> sep) {
    return hydra.Parsers.<T0, hydra.util.ConsList<T0>>bind(
      p,
      (java.util.function.Function<T0, hydra.parsing.Parser<hydra.util.ConsList<T0>>>) (x -> hydra.Parsers.<hydra.util.ConsList<T0>, hydra.util.ConsList<T0>>bind(
        hydra.Parsers.<T0>many(hydra.Parsers.<T1, T0>bind(
          sep,
          (java.util.function.Function<T1, hydra.parsing.Parser<T0>>) (ignored -> p))),
        (java.util.function.Function<hydra.util.ConsList<T0>, hydra.parsing.Parser<hydra.util.ConsList<T0>>>) (xs -> hydra.Parsers.<hydra.util.ConsList<T0>>pure(hydra.lib.lists.Cons.apply(
          x,
          xs))))));
  }
