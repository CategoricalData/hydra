...
public interface Eithers {
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term> bind(hydra.context.Context cx, T0 g, hydra.core.Term eitherTerm, hydra.core.Term funTerm) {
    return (eitherTerm).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term> visit(hydra.core.Term.Either e) {
        return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>right(hydra.lib.eithers.Either.apply(
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term> mapMaybe(hydra.context.Context cx, T0 g, hydra.core.Term funTerm, hydra.core.Term maybeTerm) {
    return (maybeTerm).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term> visit(hydra.core.Term.Maybe opt) {
        return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>right(hydra.lib.maybes.Maybe.applyLazy(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term> mapSet(hydra.context.Context cx, hydra.graph.Graph g, hydra.core.Term funTerm, hydra.core.Term setTerm) {
    return hydra.lib.eithers.Bind.apply(
      hydra.extract.core.Core.set(
        ...
        g,
        setTerm),
      (java.util.function.Function<java.util.Set<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>>) (elements -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>right(hydra.lib.lists.Foldl.apply(
