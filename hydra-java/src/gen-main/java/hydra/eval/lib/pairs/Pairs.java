...
public interface Pairs {
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term> bimap(hydra.context.Context cx, T0 g, hydra.core.Term firstFun, hydra.core.Term secondFun, hydra.core.Term pairTerm) {
