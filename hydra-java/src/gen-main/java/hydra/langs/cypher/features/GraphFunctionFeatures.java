...
public class GraphFunctionFeatures implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/langs/cypher/features.GraphFunctionFeatures");
  
  public static final hydra.core.Name FIELD_NAME_GRAPH.BY_ELEMENT_ID = new hydra.core.Name("graph.byElementId");
  
  public static final hydra.core.Name FIELD_NAME_GRAPH.BY_NAME = new hydra.core.Name("graph.byName");
  
  public static final hydra.core.Name FIELD_NAME_GRAPH.NAMES = new hydra.core.Name("graph.names");
  
  public static final hydra.core.Name FIELD_NAME_GRAPH.PROPERTIES_BY_NAME = new hydra.core.Name("graph.propertiesByName");
  ...
  public GraphFunctionFeatures withGraph.byElementId(Boolean graph_byElementId) {
    java.util.Objects.requireNonNull((graph_byElementId));
    return new GraphFunctionFeatures(graph_byElementId, graph_byName, graph_names, graph_propertiesByName);
  }
  
  public GraphFunctionFeatures withGraph.byName(Boolean graph_byName) {
    java.util.Objects.requireNonNull((graph_byName));
    return new GraphFunctionFeatures(graph_byElementId, graph_byName, graph_names, graph_propertiesByName);
  }
  
  public GraphFunctionFeatures withGraph.names(Boolean graph_names) {
    java.util.Objects.requireNonNull((graph_names));
    return new GraphFunctionFeatures(graph_byElementId, graph_byName, graph_names, graph_propertiesByName);
  }
  
  public GraphFunctionFeatures withGraph.propertiesByName(Boolean graph_propertiesByName) {
    java.util.Objects.requireNonNull((graph_propertiesByName));
    return new GraphFunctionFeatures(graph_byElementId, graph_byName, graph_names, graph_propertiesByName);
  }
}