...
public abstract class AddOrSubtractOperator implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/langs/cypher/openCypher.AddOrSubtractOperator");
  ...
  public static final class Add extends hydra.langs.cypher.openCypher.AddOrSubtractOperator implements Serializable {
    public Add () {
  ...
  public static final class Subtract extends hydra.langs.cypher.openCypher.AddOrSubtractOperator implements Serializable {
    public Subtract () {
