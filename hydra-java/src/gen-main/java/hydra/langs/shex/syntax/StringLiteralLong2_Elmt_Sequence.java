...
public class StringLiteralLong2_Elmt_Sequence implements Serializable {
  ...
  public StringLiteralLong2_Elmt_Sequence (hydra.util.Opt<hydra.langs.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option> alts, String regex) {
  ...
  public StringLiteralLong2_Elmt_Sequence withAlts(hydra.util.Opt<hydra.langs.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option> alts) {
    java.util.Objects.requireNonNull((alts));
