...
public abstract class Field {
   ...
   * The field type.
   */
  public static final class Kind extends hydra.langs.protobuf.type.Field {
    /**
     * The field type.
     */
    public final hydra.langs.protobuf.type.Kind value;
    
    public Kind (hydra.langs.protobuf.type.Kind value) {
      this.value = value;
    }
   ...
   */
  public static final class Cardinality extends hydra.langs.protobuf.type.Field {
    /**
     * The field cardinality.
     */
    public final hydra.langs.protobuf.type.Cardinality value;
    
    public Cardinality (hydra.langs.protobuf.type.Cardinality value) {
      this.value = value;
    }
   ...
   * The field number.
   */
  public static final class Number_ extends hydra.langs.protobuf.type.Field {
    /**
     * The field number.
     */
   ...
   * The field name.
   */
  public static final class Name extends hydra.langs.protobuf.type.Field {
    /**
     * The field name.
     */
   ...
   */
  public static final class TypeUrl extends hydra.langs.protobuf.type.Field {
    /**
     * The field type URL, without the scheme, for message or enumeration types. Example: `"type.googleapis.com/google.protobuf.Timestamp"`.
     */
    public final String value;
   ...
   */
  public static final class OneofIndex extends hydra.langs.protobuf.type.Field {
    /**
     * The index of the field type in `Type.oneofs`, for message or enumeration types. The first type has index 1; zero means the type is not in the list.
     */
    public final Integer value;
   ...
   */
  public static final class Packed extends hydra.langs.protobuf.type.Field {
    /**
     * Whether to use alternative packed wire representation.
     */
   ...
   */
  public static final class Options extends hydra.langs.protobuf.type.Field {
    /**
     * The protocol buffer options.
     */
    public final java.util.List<hydra.langs.protobuf.type.Option> value;
    
    public Options (java.util.List<hydra.langs.protobuf.type.Option> value) {
      this.value = value;
    }
   ...
   * The field JSON name.
   */
  public static final class JsonName extends hydra.langs.protobuf.type.Field {
    /**
     * The field JSON name.
     */
    public final String value;
   ...
   */
  public static final class DefaultValue extends hydra.langs.protobuf.type.Field {
    /**
     * The string value of the default value of this field. Proto2 syntax only.
     */
    public final String value;
