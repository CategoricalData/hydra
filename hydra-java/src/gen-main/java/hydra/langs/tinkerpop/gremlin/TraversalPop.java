...
public abstract class TraversalPop implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/langs/tinkerpop/gremlin.TraversalPop");
  ...
  public static final class First extends hydra.langs.tinkerpop.gremlin.TraversalPop implements Serializable {
    public First () {
  ...
  public static final class Last extends hydra.langs.tinkerpop.gremlin.TraversalPop implements Serializable {
    public Last () {
  ...
  public static final class All extends hydra.langs.tinkerpop.gremlin.TraversalPop implements Serializable {
    public All () {
  ...
  public static final class Mixed extends hydra.langs.tinkerpop.gremlin.TraversalPop implements Serializable {
    public Mixed () {
