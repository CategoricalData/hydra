...
public abstract class FloatArgument implements Serializable {
  ...
  public static final class Value extends hydra.langs.tinkerpop.gremlin.FloatArgument implements Serializable {
    public final hydra.langs.tinkerpop.gremlin.FloatLiteral value;
    
    public Value (hydra.langs.tinkerpop.gremlin.FloatLiteral value) {
      if (value == null) {
  ...
  public static final class Variable extends hydra.langs.tinkerpop.gremlin.FloatArgument implements Serializable {
