...
public class AnnotationSchema {
  ...
  public AnnotationSchema (String vertexLabel, String edgeLabel, String vertexId, String edgeId, String key, String value, String outVertex, String outVertexLabel, String inVertex, String inVertexLabel, String outEdge, String outEdgeLabel, String inEdge, String inEdgeLabel, String ignore) {
  ...
  public boolean equals(Object other) {
    ...
    return vertexLabel.equals(o.vertexLabel) && edgeLabel.equals(o.edgeLabel) && vertexId.equals(o.vertexId) && edgeId.equals(o.edgeId) && key.equals(o.key) && value.equals(o.value) && outVertex.equals(o.outVertex) && outVertexLabel.equals(o.outVertexLabel) && inVertex.equals(o.inVertex) && inVertexLabel.equals(o.inVertexLabel) && outEdge.equals(o.outEdge) && outEdgeLabel.equals(o.outEdgeLabel) && inEdge.equals(o.inEdge) && inEdgeLabel.equals(o.inEdgeLabel) && ignore.equals(o.ignore);
  }
  
  @Override
  public int hashCode() {
    return 2 * vertexLabel.hashCode() + 3 * edgeLabel.hashCode() + 5 * vertexId.hashCode() + 7 * edgeId.hashCode() + 11 * key.hashCode() + 13 * value.hashCode() + 17 * outVertex.hashCode() + 19 * outVertexLabel.hashCode() + 23 * inVertex.hashCode() + 29 * inVertexLabel.hashCode() + 31 * outEdge.hashCode() + 37 * outEdgeLabel.hashCode() + 41 * inEdge.hashCode() + 43 * inEdgeLabel.hashCode() + 47 * ignore.hashCode();
  }
  
  public AnnotationSchema withVertexLabel(String vertexLabel) {
    return new AnnotationSchema(vertexLabel, edgeLabel, vertexId, edgeId, key, value, outVertex, outVertexLabel, inVertex, inVertexLabel, outEdge, outEdgeLabel, inEdge, inEdgeLabel, ignore);
  }
  ...
  public AnnotationSchema withKey(String key) {
    return new AnnotationSchema(vertexLabel, edgeLabel, vertexId, edgeId, key, value, outVertex, outVertexLabel, inVertex, inVertexLabel, outEdge, outEdgeLabel, inEdge, inEdgeLabel, ignore);
  }
  
  public AnnotationSchema withValue(String value) {
    return new AnnotationSchema(vertexLabel, edgeLabel, vertexId, edgeId, key, value, outVertex, outVertexLabel, inVertex, inVertexLabel, outEdge, outEdgeLabel, inEdge, inEdgeLabel, ignore);
  }
