...
public abstract class IdType {
  public static final hydra.core.Name NAME = new hydra.core.Name("hydra/langs/tinkerpop/typed.IdType");
  ...
  public static final class Vertex extends hydra.langs.tinkerpop.typed.IdType {
    public final hydra.langs.tinkerpop.typed.VertexType value;
    
    public Vertex (hydra.langs.tinkerpop.typed.VertexType value) {
      this.value = value;
    }
  ...
  public static final class Edge extends hydra.langs.tinkerpop.typed.IdType {
    public final hydra.langs.tinkerpop.typed.EdgeType value;
    
    public Edge (hydra.langs.tinkerpop.typed.EdgeType value) {
      this.value = value;
    }
