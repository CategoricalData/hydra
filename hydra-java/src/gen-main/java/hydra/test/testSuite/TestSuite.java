    ...
    return new hydra.testing.TestGroup("All tests", Opt.empty(), java.util.Arrays.asList(
      new hydra.testing.TestGroup("hydra/lib/lists primitives", Opt.empty(), java.util.Arrays.asList(
        new hydra.testing.TestGroup("apply", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.apply"))), new hydra.core.Term.List(java.util.Arrays.asList(
          ...
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("three"))))))),
        new hydra.testing.TestGroup("bind", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.bind"))), new hydra.core.Term.List(java.util.Arrays.asList(
        ...
        new hydra.testing.TestGroup("concat", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.concat"))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.List(java.util.Arrays.asList(
            new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
            new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
            new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(3))))),
        ...
        new hydra.testing.TestGroup("head", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.head"))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
        ...
        new hydra.testing.TestGroup("intercalate", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.intercalate"))), new hydra.core.Term.List(java.util.Arrays.asList(
          ...
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(7))),
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(8)))))))),
        new hydra.testing.TestGroup("intersperse", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.intersperse"))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("and")))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("three")))))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
          ...
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("and")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("three"))))))),
        new hydra.testing.TestGroup("last", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.last"))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
        ...
        new hydra.testing.TestGroup("length", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.length"))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(3))))))), new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(3)))))),
        new hydra.testing.TestGroup("map", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.map"))), new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.toUpper"))))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")))))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("ONE")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("TWO"))))))),
        new hydra.testing.TestGroup("pure", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.pure"))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")))), new hydra.core.Term.List(java.util.Arrays.asList(new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")))))))), java.util.Arrays.asList()),
      new hydra.testing.TestGroup("hydra/lib/strings primitives", Opt.empty(), java.util.Arrays.asList(
        new hydra.testing.TestGroup("cat", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(
          new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.cat"))), new hydra.core.Term.List(java.util.Arrays.asList(
            new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
            new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")),
          ...
          new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.cat"))), new hydra.core.Term.List(java.util.Arrays.asList()))), new hydra.core.Term.Literal(new hydra.core.Literal.String_(""))))),
        new hydra.testing.TestGroup("length", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(
        ...
        new hydra.testing.TestGroup("splitOn", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(
          new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.splitOn"))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("ss")))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("Mississippi")))), new hydra.core.Term.List(java.util.Arrays.asList(
          ...
          new hydra.testing.TestCase(Opt.empty(), new hydra.testing.EvaluationStyle.Eager(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.splitOn"))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("")))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("")))), new hydra.core.Term.List(java.util.Arrays.asList(new hydra.core.Term.Literal(new hydra.core.Literal.String_(""))))))),
        new hydra.testing.TestGroup("toLower", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(
        ...
        new hydra.testing.TestGroup("toUpper", Opt.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(
