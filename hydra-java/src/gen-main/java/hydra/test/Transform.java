...
public interface Transform {
  ...
  static hydra.util.ConsList<hydra.testing.TestCaseWithMetadata> collectTestCases(hydra.testing.TestGroup tg) {
    return hydra.lib.lists.Concat2.apply(
      ...
      hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.testing.TestGroup, hydra.util.ConsList<hydra.testing.TestCaseWithMetadata>>) (sg -> hydra.test.Transform.collectTestCases(sg)),
        (tg).subgroups)));
  }
  ...
  static hydra.core.Term encodeAdjacencyList(hydra.util.ConsList<hydra.util.Pair<Integer, hydra.util.ConsList<Integer>>> pairs) {
    return new hydra.core.Term.List(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.util.Pair<Integer, hydra.util.ConsList<Integer>>, hydra.core.Term>) (p -> new hydra.core.Term.Pair((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) ((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) (new hydra.util.Pair<hydra.core.Term, hydra.core.Term>(hydra.test.Transform.encodeInt(hydra.lib.pairs.First.apply(p)), new hydra.core.Term.List(hydra.lib.lists.Map.apply(
  ...
  static hydra.core.Term encodeEitherListList(hydra.util.Either<hydra.util.ConsList<hydra.util.ConsList<Integer>>, hydra.util.ConsList<Integer>> e) {
    return new hydra.core.Term.Either(hydra.lib.eithers.Bimap.apply(
      (java.util.function.Function<hydra.util.ConsList<hydra.util.ConsList<Integer>>, hydra.core.Term>) (cycles -> hydra.test.Transform.encodeListList(cycles)),
      (java.util.function.Function<hydra.util.ConsList<Integer>, hydra.core.Term>) (sorted -> hydra.test.Transform.encodeIntList(sorted)),
      e));
  }

  static hydra.core.Term encodeListList(hydra.util.ConsList<hydra.util.ConsList<Integer>> lists) {
    return new hydra.core.Term.List(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.util.ConsList<Integer>, hydra.core.Term>) (l -> hydra.test.Transform.encodeIntList(l)),
      lists));
  }
