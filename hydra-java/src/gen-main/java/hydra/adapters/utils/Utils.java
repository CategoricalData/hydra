      ...
      public String visit(hydra.core.Type.Function instance) {
        return hydra.lib.strings.Strings.cat(java.util.Arrays.asList(
          hydra.lib.strings.Strings.cat(java.util.Arrays.asList(
            hydra.lib.strings.Strings.cat(java.util.Arrays.asList(
              "functions from ",
              hydra.adapters.utils.Utils.describeType((hydra.core.Type<M>) (((instance.value)).domain)))),
            " to ")),
          hydra.adapters.utils.Utils.describeType((hydra.core.Type<M>) (((instance.value)).codomain))));
      }
      ...
      public String visit(hydra.core.Type.Map instance) {
        return hydra.lib.strings.Strings.cat(java.util.Arrays.asList(
          hydra.lib.strings.Strings.cat(java.util.Arrays.asList(
            hydra.lib.strings.Strings.cat(java.util.Arrays.asList(
              "maps from ",
              hydra.adapters.utils.Utils.describeType((hydra.core.Type<M>) (((instance.value)).keys)))),
            " to ")),
          hydra.adapters.utils.Utils.describeType((hydra.core.Type<M>) (((instance.value)).values))));
      }
