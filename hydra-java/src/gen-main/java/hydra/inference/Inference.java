...
public interface Inference {
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.TypeSubst> bindConstraints(hydra.context.Context flowCx, hydra.graph.Graph cx, java.util.List<hydra.typing.TypeConstraint> constraints) {
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.Bimap.apply(
        ...
        hydra.unification.Unification.unifyTypeConstraints(
          ...
          (cx).schemaTypes,
          constraints)),
      (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.TypeSubst>>) (s -> hydra.lib.eithers.Bind.apply(
        hydra.checking.Checking.checkTypeSubst(
          flowCx,
          cx,
          s),
        (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.TypeSubst>>) (ignored -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.TypeSubst>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.TypeSubst>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.TypeSubst>right(s)))))));
  }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term> finalizeInferredTerm(hydra.context.Context flowCx, hydra.graph.Graph cx, hydra.core.Term term) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.checking.Checking.checkForUnboundTypeVariables(
        ...
        cx,
        term2),
      (java.util.function.Function<java.lang.Void, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>>) (ignored -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>right(hydra.rewriting.Rewriting.normalizeTypeVariablesInTerm(term2))))));
  }
  
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<T0, hydra.context.Context>> forInferredTerm(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Term term, String desc, java.util.function.Function<hydra.typing.InferenceResult, T0> f) {
    return hydra.lib.eithers.Bind.apply(
      hydra.inference.Inference.inferTypeOfTerm(
        ...
        term,
        desc),
      (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<T0, hydra.context.Context>>>) (rp -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<T0, hydra.context.Context>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<T0, hydra.context.Context>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<T0, hydra.context.Context>>right((hydra.util.Pair<T0, hydra.context.Context>) ((hydra.util.Pair<T0, hydra.context.Context>) (new hydra.util.Pair<T0, hydra.context.Context>((f).apply(rp), (rp).context))))))));
  }
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>> inferGraphTypes(hydra.context.Context fcx0, java.util.List<hydra.core.Binding> bindings0, hydra.graph.Graph g0) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.inference.Inference.inferTypeOfTerm(
        ...
        "graph term"),
      (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>>) (result -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.inference.Inference.finalizeInferredTerm(
            ...
            g0,
            term),
          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>>) (finalized -> (finalized).accept(new hydra.core.Term.PartialVisitor<>() {
            @Override
            public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>> visit(hydra.core.Term.Let l) {
              return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>right((hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>) ((hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>) (new hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>((fromLetTerm).apply((l).value), fcx2))))));
            }
            
            @Override
            public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>> visit(hydra.core.Term.Variable ignored) {
              return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.graph.Graph, java.util.List<hydra.core.Binding>>, hydra.context.Context>>left((hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError("Expected inferred graph as let term")), fcx2)))));
            }
          })));
      }));
  }
  
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferInGraphContext(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Term term) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>> inferMany(hydra.context.Context fcx, hydra.graph.Graph cx, java.util.List<hydra.util.Pair<hydra.core.Term, String>> pairs) {
    hydra.util.Lazy<hydra.core.Term> e = new hydra.util.Lazy<>(() -> hydra.lib.pairs.First.apply(hydra.lib.lists.Head.apply(pairs)));
    hydra.util.Lazy<hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>> dflt = new hydra.util.Lazy<>(() -> ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>>) (() -> {
      hydra.util.Lazy<String> desc = new hydra.util.Lazy<>(() -> hydra.lib.pairs.Second.apply(hydra.lib.lists.Head.apply(pairs)));
      return ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>>) (() -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.inference.Inference.inferTypeOfTerm(
            ...
            e.get(),
            desc.get()),
          (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>>) (result1 -> {
            ...
            return hydra.lib.eithers.Bind.apply(
              hydra.inference.Inference.inferMany(
                ...
                hydra.substitution.Substitution.substInContext(
                  ...
                  cx),
                tl.get()),
              (java.util.function.Function<hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>>) (rp2 -> {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.core.Term, hydra.core.TypeScheme>, hydra.context.Context>> inferTypeOf(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Term term) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.inference.Inference.inferTypeOfTerm(
        ...
        letTerm.get(),
        "infer type of term"),
      (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.core.Term, hydra.core.TypeScheme>, hydra.context.Context>>>) (result -> {
        hydra.context.Context fcx2 = (result).context;
        return hydra.lib.eithers.Bind.apply(
          hydra.inference.Inference.finalizeInferredTerm(
            fcx2,
            cx,
            (result).term),
          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.core.Term, hydra.core.TypeScheme>, hydra.context.Context>>>) (finalized -> hydra.lib.eithers.Bind.apply(
            hydra.extract.core.Core.let(
              fcx2,
              cx,
              finalized),
            (java.util.function.Function<hydra.core.Let, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<hydra.core.Term, hydra.core.TypeScheme>, hydra.context.Context>>>) (letResult -> {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfAnnotatedTerm(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.AnnotatedTerm at) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.inference.Inference.inferTypeOfTerm(
        ...
        term,
        "annotated term"),
      (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (result -> {
        hydra.context.Context fcx2 = (result).context;
        ...
        return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(new hydra.typing.InferenceResult(new hydra.core.Term.Annotated(new hydra.core.AnnotatedTerm(iterm, ann)), itype, isubst, iconstraints, fcx2))));
      }));
  }
  
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfApplication(hydra.context.Context fcx0, hydra.graph.Graph cx, hydra.core.Application app) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.inference.Inference.inferTypeOfTerm(
        ...
        e0,
        "lhs"),
      (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (lhsResult -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.inference.Inference.inferTypeOfTerm(
            ...
            e1,
            "rhs"),
          (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (rhsResult -> {
            ...
            return hydra.lib.eithers.Bind.apply(
              hydra.lib.eithers.Bimap.apply(
                ...
                hydra.unification.Unification.unifyTypes(
                  ...
                  "application lhs")),
              (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (s2 -> hydra.lib.eithers.Bind.apply(
                hydra.checking.Checking.checkTypeSubst(
                  fcx4.get(),
                  cx,
                  s2),
                (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (ignored -> {
                  ...
                  return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(new hydra.typing.InferenceResult(rExpr, rType, rSubst, rConstraints.get(), fcx4.get()))));
                }))));
          }));
      }));
  }
  
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfCaseStatement(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.CaseStatement caseStmt) {
      ...
      (java.util.function.Function<hydra.util.Pair<hydra.core.TypeScheme, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (stRp -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.extract.core.Core.unionType(
            ...
            tname,
            stype),
          (java.util.function.Function<java.util.List<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (sfields -> hydra.lib.eithers.Bind.apply(
            hydra.lib.eithers.MapMaybe.apply(
              (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (t -> hydra.inference.Inference.inferTypeOfTerm(
                fcx2.get(),
                cx,
                t,
                hydra.lib.strings.Cat.apply(java.util.List.of(
                  ...
                  ".<default>")))),
              dflt),
            (java.util.function.Function<hydra.util.Maybe<hydra.typing.InferenceResult>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (dfltRp -> {
                ...
                (java.util.function.Function<hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (caseRp -> {
                  ...
                  hydra.util.Lazy<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>> dfltClassConstraints = new hydra.util.Lazy<>(() -> hydra.lib.maybes.FromMaybe.applyLazy(
                    ...
                    hydra.lib.maybes.Map.apply(
                      ...
                      dfltResult)));
                  hydra.util.Lazy<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>> allElemConstraints = new hydra.util.Lazy<>(() -> hydra.inference.Inference.mergeClassConstraints(
                  ...
                  return hydra.lib.eithers.Bind.apply(
                    hydra.inference.Inference.mapConstraints(
                      fcx5.get(),
                      cx,
                      (java.util.function.Function<hydra.typing.TypeSubst, hydra.typing.InferenceResult>) (subst -> hydra.inference.Inference.yieldWithConstraints(
                        fcx5.get(),
                      ...
                      hydra.lib.lists.Concat.apply(java.util.List.of(
                        dfltConstraints.get(),
                        caseConstraints.get()))),
                    (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (mcResult -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(mcResult)))));
                }));
            }))));
      }));
  }
  
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfCollection(hydra.context.Context fcx, hydra.graph.Graph cx, java.util.function.Function<hydra.core.Type, hydra.core.Type> typCons, java.util.function.Function<java.util.List<hydra.core.Term>, hydra.core.Term> trmCons, String desc, java.util.Set<hydra.core.Name> classNames, java.util.List<hydra.core.Term> els) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(hydra.inference.Inference.yieldWithConstraints(
        fcx2.get(),
        hydra.inference.Inference.buildTypeApplicationTerm(
            ...
            hydra.lib.lists.Map.apply(
              ...
              hydra.lib.math.Range.apply(
                ...
                hydra.lib.math.Add.apply(
                  ...
                  1))))),
        (java.util.function.Function<hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (resultsRp -> {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.inference.Inference.mapConstraints(
              ...
              (java.util.function.Function<hydra.typing.TypeSubst, hydra.typing.InferenceResult>) (subst2 -> {
                ...
                return hydra.inference.Inference.yieldWithConstraints(
                  fcx3.get(),
                  iterm,
                  itype,
                  isubst,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfEither(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.util.Either<hydra.core.Term, hydra.core.Term> e) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (l -> hydra.lib.eithers.Bind.apply(
        hydra.inference.Inference.inferTypeOfTerm(
          fcx,
          cx,
          l,
          "either left value"),
        (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (r1 -> {
          ...
          return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(hydra.inference.Inference.yieldChecked(
            fcx3.get(),
            termWithBothTypes,
            eitherType,
            subst))));
        }))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (r -> hydra.lib.eithers.Bind.apply(
        hydra.inference.Inference.inferTypeOfTerm(
          fcx,
          cx,
          r,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfElimination(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Elimination elm) {
    return (elm).accept(new hydra.core.Elimination.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Elimination.Record p) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Elimination.Union c) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Elimination.Wrap tname) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfFunction(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Function f) {
    return (f).accept(new hydra.core.Function.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Function.Elimination elm) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Function.Lambda l) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Function.Primitive name) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfInjection(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Injection injection) {
            ...
            return hydra.lib.eithers.Bind.apply(
              ...
              (java.util.function.Function<java.util.List<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (sfields -> hydra.lib.eithers.Bind.apply(
                hydra.schemas.Schemas.findFieldType(
                  ...
                  fname,
                  sfields),
                (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (ftyp -> hydra.lib.eithers.Bind.apply(
                  hydra.inference.Inference.mapConstraints(
                    fcx3.get(),
                    cx,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfLambda(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Lambda lambda) {
      ...
      (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (result -> {
        ...
        hydra.util.Lazy<java.util.Set<hydra.core.Name>> vars = new hydra.util.Lazy<>(() -> hydra.lib.sets.Unions.apply(java.util.List.of(
          ...
          hydra.inference.Inference.freeVariablesInContext(hydra.substitution.Substitution.substInContext(
            isubst,
            cx2.get())))));
        return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(new hydra.typing.InferenceResult(rterm, rtype, isubst, iconstraints, fcx3))));
      }));
  }
  
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfLet(hydra.context.Context fcx0, hydra.graph.Graph cx, hydra.core.Let let0) {
    ...
    hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> res = (rewrittenLet.get()).accept(new hydra.core.Term.PartialVisitor<>() {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Let l) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfLetNormalized(hydra.context.Context fcx0, hydra.graph.Graph cx0, hydra.core.Let letTerm) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.inference.Inference.inferTypesOfTemporaryBindings(
        ...
        cx1.get(),
        bins0),
      (java.util.function.Function<hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (irRp -> {
            ...
            (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (ignored -> {
              ...
              return hydra.lib.eithers.Bind.apply(
                hydra.inference.Inference.inferTypeOfTerm(
                  ...
                  body0,
                  "let body"),
                (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (bodyResult -> {
                  ...
                  return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(new hydra.typing.InferenceResult(new hydra.core.Term.Let(new hydra.core.Let(bins1.get(), body1)), tbody, hydra.substitution.Substitution.composeTypeSubstList(java.util.List.of(
                    s1.get(),
                    s2,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfList(hydra.context.Context fcx, hydra.graph.Graph cx, java.util.List<hydra.core.Term> v1) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfMap(hydra.context.Context fcx, hydra.graph.Graph cx, java.util.Map<hydra.core.Term, hydra.core.Term> m) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.eithers.Bind.apply(
        ...
        (java.util.function.Function<hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (kRp -> {
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (vRp -> {
              ...
              hydra.util.Lazy<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>> allMapConstraints = new hydra.util.Lazy<>(() -> hydra.inference.Inference.mergeClassConstraints(
                keyConstraints.get(),
                hydra.inference.Inference.mergeClassConstraints(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfOptional(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.util.Maybe<hydra.core.Term> m) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfPair(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.util.Pair<hydra.core.Term, hydra.core.Term> p) {
    return hydra.lib.eithers.Bind.apply(
      hydra.inference.Inference.inferMany(
        fcx,
        cx,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfPrimitive(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Name name) {
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>left((hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
        "No such primitive: ",
        (name).value))), fcx))))),
      (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (scheme -> {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfProjection(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Projection proj) {
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<java.util.List<hydra.core.FieldType>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (sfields -> hydra.lib.eithers.Bind.apply(
            hydra.schemas.Schemas.findFieldType(
              ...
              fname,
              sfields),
            (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (ftyp -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(hydra.inference.Inference.yield(
              fcx2.get(),
              hydra.inference.Inference.buildTypeApplicationTerm(
                svars,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfRecord(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Record record) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfSet(hydra.context.Context fcx, hydra.graph.Graph cx, java.util.Set<hydra.core.Term> s) {
    return hydra.inference.Inference.inferTypeOfCollection(
      fcx,
      cx,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfTerm(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Term term, String desc) {
    ...
    return (term).accept(new hydra.core.Term.PartialVisitor<>() {
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Annotated a) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Application a) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Either e) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Function f) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.List els) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Literal l) {
        return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(hydra.inference.Inference.inferTypeOfLiteral(
          fcx2.get(),
          (l).value))));
      }
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Map m) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Maybe m) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Pair p) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Record r) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Set s) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.TypeApplication tt) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.TypeLambda ta) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Union i) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Unit ignored) {
        return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(hydra.inference.Inference.inferTypeOfUnit(fcx2.get()))));
      }
      
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Variable name) {
      ...
      @Override
      public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> visit(hydra.core.Term.Wrap w) {
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfTypeLambda(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.TypeLambda ta) {
    return hydra.inference.Inference.inferTypeOfTerm(
      fcx,
      cx,
      (ta).body,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfTypeApplication(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.TypeApplicationTerm tt) {
    return hydra.inference.Inference.inferTypeOfTerm(
      fcx,
      cx,
      (tt).body,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfUnwrap(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Name tname) {
    return hydra.lib.eithers.Bind.apply(
      hydra.schemas.Schemas.requireSchemaType(
        fcx,
        (cx).schemaTypes,
      ...
      (java.util.function.Function<hydra.util.Pair<hydra.core.TypeScheme, hydra.context.Context>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (stRp -> {
        ...
        return hydra.lib.eithers.Bind.apply(
          hydra.extract.core.Core.wrappedType(
            ...
            tname,
            stype),
          (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (wtyp -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(hydra.inference.Inference.yield(
            fcx2.get(),
            hydra.inference.Inference.buildTypeApplicationTerm(
              svars,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfVariable(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.Name name) {
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>left((hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
      ...
      (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (scheme -> {
        ...
        hydra.util.Lazy<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>> constraints = new hydra.util.Lazy<>(() -> hydra.lib.maybes.FromMaybe.applyLazy(
          ...
          (ts.get()).constraints));
        hydra.util.Lazy<hydra.context.Context> fcx2 = new hydra.util.Lazy<>(() -> hydra.lib.pairs.Second.apply(tsResult));
        return (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(new hydra.typing.InferenceResult(hydra.inference.Inference.buildTypeApplicationTerm(
          (ts.get()).variables,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> inferTypeOfWrappedTerm(hydra.context.Context fcx, hydra.graph.Graph cx, hydra.core.WrappedTerm wt) {
        ...
        return ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>>) (() -> {
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.typing.InferenceResult, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>>) (result1 -> {
              ...
              return hydra.lib.eithers.Bind.apply(
                hydra.lib.maybes.Maybe.applyLazy(
                  () -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>right((java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>) ((java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>) (hydra.lib.maps.Empty.<hydra.core.Name, hydra.core.TypeVariableMetadata>apply()))))),
                  (java.util.function.Function<hydra.core.TypeScheme, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>) (ts -> {
                    hydra.util.Pair<hydra.core.TypeScheme, hydra.context.Context> tsResult = hydra.schemas.Schemas.instantiateTypeScheme(
                      fcx2,
                      ts);
                    ...
                    return hydra.lib.eithers.Bind.apply(
                      ...
                      (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>) (unifySubst -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>right(hydra.substitution.Substitution.substInClassConstraints(
                        unifySubst,
                        freshConstraints.get()))))));
                  }),
                  (binding.get()).type),
                (java.util.function.Function<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.Pair<java.util.List<hydra.core.Term>, hydra.util.Pair<java.util.List<hydra.core.Type>, hydra.util.Pair<hydra.typing.TypeSubst, java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>>>>, hydra.context.Context>>>) (originalBindingConstraints -> {
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0> mapConstraints(hydra.context.Context flowCx, hydra.graph.Graph cx, java.util.function.Function<hydra.typing.TypeSubst, T0> f, java.util.List<hydra.typing.TypeConstraint> constraints) {
    return hydra.lib.eithers.Bind.apply(
      hydra.lib.eithers.Bimap.apply(
        (java.util.function.Function<hydra.context.InContext<hydra.error.UnificationError>, hydra.context.InContext<hydra.error.Error_>>) (_ic -> (hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError((((java.util.function.Function<hydra.context.InContext<hydra.error.UnificationError>, hydra.error.UnificationError>) (projected -> projected.object)).apply(_ic)).message)), ((java.util.function.Function<hydra.context.InContext<hydra.error.UnificationError>, hydra.context.Context>) (projected -> projected.context)).apply(_ic)))),
        (java.util.function.Function<hydra.typing.TypeSubst, hydra.typing.TypeSubst>) (_a -> _a),
        hydra.unification.Unification.unifyTypeConstraints(
          ...
          (cx).schemaTypes,
          constraints)),
      (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>) (s -> hydra.lib.eithers.Bind.apply(
        hydra.checking.Checking.checkTypeSubst(
          flowCx,
          cx,
          s),
        (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>) (ignored -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, T0>right((f).apply(s))))))));
  }
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult> yieldDebug(hydra.context.Context fcx, T0 cx, String debugId, hydra.core.Term term, hydra.core.Type typ, hydra.typing.TypeSubst subst) {
    ...
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<java.lang.Void, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>>) (result -> (hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) ((hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>) (hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.typing.InferenceResult>right(new hydra.typing.InferenceResult(rterm, rtyp, subst, (java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>) ((java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>) (hydra.lib.maps.Empty.<hydra.core.Name, hydra.core.TypeVariableMetadata>apply())), fcx))))));
  }
