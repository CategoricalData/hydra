  ...
  static hydra.util.PersistentMap<hydra.core.Name, hydra.core.Type> typesByName() {
    return hydra.util.PersistentMap.ofEntries(
      ...
      hydra.util.PersistentMap.entry(
        ...
        new hydra.core.Type.Annotated(new hydra.core.AnnotatedType(new hydra.core.Type.Record(new hydra.core.RowType(new hydra.core.Name("hydra.error.UntypedLambdaError"), (hydra.util.ConsList<hydra.core.FieldType>) (hydra.util.ConsList.<hydra.core.FieldType>empty()))), hydra.util.PersistentMap.ofEntries(hydra.util.PersistentMap.entry(
          new hydra.core.Name("description"),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("A lambda expression without a type annotation on its parameter"))))))),
      hydra.util.PersistentMap.entry(
      ...
      hydra.util.PersistentMap.entry(
        ...
        new hydra.core.Type.Annotated(new hydra.core.AnnotatedType(new hydra.core.Type.Forall(new hydra.core.ForallType(new hydra.core.Name("t1"), new hydra.core.Type.Forall(new hydra.core.ForallType(new hydra.core.Name("t2"), new hydra.core.Type.Forall(new hydra.core.ForallType(new hydra.core.Name("v1"), new hydra.core.Type.Forall(new hydra.core.ForallType(new hydra.core.Name("v2"), new hydra.core.Type.Record(new hydra.core.RowType(new hydra.core.Name("hydra.util.Bicoder"), hydra.util.ConsList.of(
      ...
      hydra.util.PersistentMap.entry(
        ...
        new hydra.core.Type.Annotated(new hydra.core.AnnotatedType(new hydra.core.Type.Union(new hydra.core.RowType(new hydra.core.Name("hydra.util.CaseConvention"), hydra.util.ConsList.of(
      ...
      hydra.util.PersistentMap.entry(
        ...
        new hydra.core.Type.Annotated(new hydra.core.AnnotatedType(new hydra.core.Type.Forall(new hydra.core.ForallType(new hydra.core.Name("v1"), new hydra.core.Type.Forall(new hydra.core.ForallType(new hydra.core.Name("v2"), new hydra.core.Type.Record(new hydra.core.RowType(new hydra.core.Name("hydra.util.Coder"), hydra.util.ConsList.of(
      ...
      hydra.util.PersistentMap.entry(
        ...
        new hydra.core.Type.Annotated(new hydra.core.AnnotatedType(new hydra.core.Type.Union(new hydra.core.RowType(new hydra.core.Name("hydra.util.Comparison"), hydra.util.ConsList.of(
      ...
      hydra.util.PersistentMap.entry(
        ...
        new hydra.core.Type.Annotated(new hydra.core.AnnotatedType(new hydra.core.Type.Union(new hydra.core.RowType(new hydra.core.Name("hydra.util.Precision"), hydra.util.ConsList.of(
