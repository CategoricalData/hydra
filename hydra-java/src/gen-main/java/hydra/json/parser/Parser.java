...
public interface Parser {
  hydra.parsing.Parser<Boolean> whitespace = hydra.parsers.Parsers.map(
    (java.util.function.Function<java.util.List<Integer>, Boolean>) (ignored -> true),
  ...
  static <T0> hydra.parsing.Parser<T0> token(hydra.parsing.Parser<T0> p) {
    return hydra.parsers.Parsers.<T0, T0>bind(
      (p),
      (java.util.function.Function<T0, hydra.parsing.Parser<T0>>) (x -> hydra.parsers.Parsers.<Boolean, T0>bind(
        (hydra.json.parser.Parser.whitespace),
        (java.util.function.Function<Boolean, hydra.parsing.Parser<T0>>) (ignored -> hydra.parsers.Parsers.<T0>pure((x))))));
  }
  
  hydra.parsing.Parser<hydra.json.model.Value> jsonNull = hydra.parsers.Parsers.map(
    (java.util.function.Function<String, hydra.json.model.Value>) (ignored -> new hydra.json.model.Value.Null(true)),
    hydra.json.parser.Parser.token(hydra.parsers.Parsers.string("null")));
  
  hydra.parsing.Parser<hydra.json.model.Value> jsonBool = hydra.parsers.Parsers.alt(
  ...
  hydra.parsing.Parser<Integer> digit = hydra.parsers.Parsers.satisfy((java.util.function.Function<Integer, Boolean>) (c -> hydra.lib.logic.And.apply(
  ...
  hydra.parsing.Parser<String> digits = hydra.parsers.Parsers.map(
    (hydra.lib.strings.FromList::apply),
    hydra.parsers.Parsers.some((hydra.json.parser.Parser.digit)));
  
  hydra.parsing.Parser<String> jsonIntegerPart = hydra.parsers.Parsers.bind(
  ...
  hydra.parsing.Parser<hydra.util.Maybe<String>> jsonFractionPart = hydra.parsers.Parsers.optional(hydra.parsers.Parsers.bind(
  ...
  hydra.parsing.Parser<hydra.util.Maybe<String>> jsonExponentPart = hydra.parsers.Parsers.optional(hydra.parsers.Parsers.bind(
  ...
  hydra.parsing.Parser<hydra.json.model.Value> jsonNumber = hydra.json.parser.Parser.token(hydra.parsers.Parsers.bind(
    ...
    (java.util.function.Function<String, hydra.parsing.Parser<hydra.json.model.Value>>) (intPart -> hydra.parsers.Parsers.bind(
      ...
      (java.util.function.Function<hydra.util.Maybe<String>, hydra.parsing.Parser<hydra.json.model.Value>>) (fracPart -> hydra.parsers.Parsers.bind(
        ...
        (java.util.function.Function<hydra.util.Maybe<String>, hydra.parsing.Parser<hydra.json.model.Value>>) (expPart -> {
          String numStr = hydra.lib.strings.Cat2.apply(
            hydra.lib.strings.Cat2.apply(
              (intPart),
              hydra.lib.maybes.Maybe.apply(
                "",
          ...
          return hydra.parsers.Parsers.pure(new hydra.json.model.Value.Number_(hydra.lib.maybes.Maybe.apply(
            ...
            hydra.lib.literals.ReadBigfloat.apply((numStr)))));
        })))))));
  
  hydra.parsing.Parser<Integer> jsonEscapeChar = hydra.parsers.Parsers.choice(java.util.List.of(
    hydra.parsers.Parsers.map(
  ...
  hydra.parsing.Parser<Integer> jsonStringChar = hydra.parsers.Parsers.alt(
  ...
  hydra.parsing.Parser<hydra.json.model.Value> jsonString = hydra.json.parser.Parser.token(hydra.parsers.Parsers.bind(
    hydra.parsers.Parsers.char_(34),
  ...
  hydra.parsing.Parser<hydra.json.model.Value> jsonArray = hydra.parsers.Parsers.map(
  ...
  hydra.parsing.Parser<hydra.util.Tuple.Tuple2<String, hydra.json.model.Value>> jsonKeyValue = hydra.parsers.Parsers.bind(
  ...
  hydra.parsing.Parser<hydra.json.model.Value> jsonObject = hydra.parsers.Parsers.map(
  ...
  hydra.parsing.Parser<hydra.json.model.Value> jsonValue = hydra.parsers.Parsers.choice(java.util.List.of(
  ...
  static hydra.parsing.ParseResult<hydra.json.model.Value> parseJson(String input) {
    return (((java.util.function.Function<hydra.parsing.Parser<hydra.json.model.Value>, java.util.function.Function<String, hydra.parsing.ParseResult<hydra.json.model.Value>>>) (wrapped -> ((wrapped)).value)).apply(hydra.parsers.Parsers.bind(
      (hydra.json.parser.Parser.whitespace),
      (java.util.function.Function<Boolean, hydra.parsing.Parser<hydra.json.model.Value>>) (ignored -> hydra.parsers.Parsers.bind(
        (hydra.json.parser.Parser.jsonValue),
        (java.util.function.Function<hydra.json.model.Value, hydra.parsing.Parser<hydra.json.model.Value>>) (v -> hydra.parsers.Parsers.bind(
          (hydra.json.parser.Parser.whitespace),
          (java.util.function.Function<Boolean, hydra.parsing.Parser<hydra.json.model.Value>>) (_2 -> hydra.parsers.Parsers.bind(
            (hydra.parsers.Parsers.eof),
            (java.util.function.Function<Boolean, hydra.parsing.Parser<hydra.json.model.Value>>) (_3 -> hydra.parsers.Parsers.pure((v)))))))))))).apply((input));
  }
}
