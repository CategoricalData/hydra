    ...
    return (value).accept(new hydra.json.model.Value.PartialVisitor<>() {
      ...
      public hydra.ext.org.yaml.model.Node visit(hydra.json.model.Value.Object_ obj) {
        return new hydra.ext.org.yaml.model.Node.Mapping(hydra.lib.maps.FromList.apply(hydra.lib.lists.Map.apply(
          (java.util.function.Function<hydra.util.Pair<String, hydra.json.model.Value>, hydra.util.Pair<hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node>>) (kv -> (hydra.util.Pair<hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node>) ((hydra.util.Pair<hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node>) (new hydra.util.Pair<hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node>(new hydra.ext.org.yaml.model.Node.Scalar(new hydra.ext.org.yaml.model.Scalar.Str(hydra.lib.pairs.First.apply(kv))), hydra.json.yaml.Encode.jsonToYaml(hydra.lib.pairs.Second.apply(kv)))))),
