...
public abstract class Comparison {
  ...
  public static final class LessThan extends Comparison {
    public LessThan () {
  ...
  public static final class EqualTo extends Comparison {
    public EqualTo () {
  ...
  public static final class GreaterThan extends Comparison {
    public GreaterThan () {
