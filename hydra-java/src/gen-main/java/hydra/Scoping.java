...
public interface Scoping {
  ...
  static hydra.core.TypeScheme fTypeToTypeScheme(hydra.core.Type typ) {
    ...
    gatherForall.set((java.util.function.Function<hydra.util.ConsList<hydra.core.Name>, java.util.function.Function<hydra.core.Type, hydra.core.TypeScheme>>) (vars -> (java.util.function.Function<hydra.core.Type, hydra.core.TypeScheme>) (typ2 -> stripAnnotations.get().apply(typ2).accept(new hydra.core.Type.PartialVisitor<>() {
      @Override
