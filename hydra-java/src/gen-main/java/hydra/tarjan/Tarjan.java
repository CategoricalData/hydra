...
public interface Tarjan {
  static <T0> hydra.util.Pair<hydra.util.PersistentMap<Integer, hydra.util.ConsList<Integer>>, java.util.function.Function<Integer, T0>> adjacencyListsToGraph(hydra.util.ConsList<hydra.util.Pair<T0, hydra.util.ConsList<T0>>> edges0) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.util.Pair<Integer, hydra.util.Pair<T0, hydra.util.ConsList<T0>>>>> indexedEdges = new hydra.util.Lazy<>(() -> hydra.tarjan.Tarjan.<T0>adjacencyListsToGraph_indexedEdges(hydra.tarjan.Tarjan.<T0>adjacencyListsToGraph_sortedEdges(edges0)));
    hydra.util.Lazy<hydra.util.PersistentMap<Integer, hydra.util.ConsList<Integer>>> graph = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.lib.lists.Map.apply(
      ...
      indexedEdges.get())));
    return (hydra.util.Pair<hydra.util.PersistentMap<Integer, hydra.util.ConsList<Integer>>, java.util.function.Function<Integer, T0>>) ((hydra.util.Pair<hydra.util.PersistentMap<Integer, hydra.util.ConsList<Integer>>, java.util.function.Function<Integer, T0>>) (new hydra.util.Pair<hydra.util.PersistentMap<Integer, hydra.util.ConsList<Integer>>, java.util.function.Function<Integer, T0>>(graph.get(), (java.util.function.Function<Integer, T0>) (v1 -> hydra.tarjan.Tarjan.<T0>adjacencyListsToGraph_vertexToKey(
  ...
  static hydra.topology.TarjanState initialState() {
    return new hydra.topology.TarjanState(0, (hydra.util.PersistentMap<Integer, Integer>) ((hydra.util.PersistentMap<Integer, Integer>) (hydra.lib.maps.Empty.<Integer, Integer>apply())), (hydra.util.PersistentMap<Integer, Integer>) ((hydra.util.PersistentMap<Integer, Integer>) (hydra.lib.maps.Empty.<Integer, Integer>apply())), (hydra.util.ConsList<Integer>) (hydra.util.ConsList.<Integer>of()), (hydra.util.PersistentSet<Integer>) (hydra.lib.sets.Empty.<Integer>apply()), (hydra.util.ConsList<hydra.util.ConsList<Integer>>) (hydra.util.ConsList.<hydra.util.ConsList<Integer>>of()));
  }
  ...
  static hydra.util.Pair<hydra.util.ConsList<Integer>, hydra.topology.TarjanState> popStackUntil(Integer v, hydra.topology.TarjanState st0) {
    ...
    return ((go.get()).apply((hydra.util.ConsList<Integer>) (hydra.util.ConsList.<Integer>of()))).apply(st0);
  }
  ...
  static hydra.topology.TarjanState strongConnect(hydra.util.PersistentMap<Integer, hydra.util.ConsList<Integer>> graph, Integer v, hydra.topology.TarjanState st) {
    ...
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.equality.Equal.apply(
        ...
        idx_v.get()),
      () -> ((java.util.function.Supplier<hydra.topology.TarjanState>) (() -> {
        hydra.util.Pair<hydra.util.ConsList<Integer>, hydra.topology.TarjanState> compResult = hydra.tarjan.Tarjan.popStackUntil(
          v,
