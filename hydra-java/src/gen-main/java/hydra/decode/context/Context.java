...
public interface Context {
  static hydra.util.Either<hydra.error.DecodingError, hydra.context.Context> context(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>>) (err -> (hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>) ((hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>) (hydra.util.Either.<hydra.error.DecodingError, hydra.context.Context>left(new hydra.error.DecodingError(err))))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.error.DecodingError, hydra.context.Context> otherwise(hydra.core.Term instance) {
          return (hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>) ((hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>) (hydra.util.Either.<hydra.error.DecodingError, hydra.context.Context>left(new hydra.error.DecodingError("expected record of type hydra.context.Context"))));
        }
            ...
            (java.util.function.Function<java.util.List<String>, hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>>) (field_trace -> hydra.lib.eithers.Bind.apply(
              ...
              (java.util.function.Function<java.util.List<String>, hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>>) (field_messages -> hydra.lib.eithers.Bind.apply(
                hydra.extract.helpers.Helpers.requireField(
                  ...
                  fieldMap,
                  cx),
                (java.util.function.Function<java.util.Map<hydra.core.Name, hydra.core.Term>, hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>>) (field_other -> (hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>) ((hydra.util.Either<hydra.error.DecodingError, hydra.context.Context>) (hydra.util.Either.<hydra.error.DecodingError, hydra.context.Context>right(new hydra.context.Context(field_trace, field_messages, field_other))))))))));
        }
      })),
      hydra.lexical.Lexical.stripAndDereferenceTermEither(
        cx,
  ...
  static <T0> hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>> inContext(java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, T0>>> e, hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>>) (err -> (hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>) ((hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>) (hydra.util.Either.<hydra.error.DecodingError, hydra.context.InContext<T0>>left(new hydra.error.DecodingError(err))))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>> otherwise(hydra.core.Term instance) {
          return (hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>) ((hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>) (hydra.util.Either.<hydra.error.DecodingError, hydra.context.InContext<T0>>left(new hydra.error.DecodingError("expected record of type hydra.context.InContext"))));
        }
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<T0, hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>>) (field_object -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                ...
                fieldMap,
                cx),
              (java.util.function.Function<hydra.context.Context, hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>>) (field_context -> (hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>) ((hydra.util.Either<hydra.error.DecodingError, hydra.context.InContext<T0>>) (hydra.util.Either.<hydra.error.DecodingError, hydra.context.InContext<T0>>right((hydra.context.InContext<T0>) (new hydra.context.InContext<T0>(field_object, field_context)))))))));
        }
      })),
      hydra.lexical.Lexical.stripAndDereferenceTermEither(
        cx,
