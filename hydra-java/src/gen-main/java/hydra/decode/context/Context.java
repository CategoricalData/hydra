        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.context.Context> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.helpers.Helpers.requireField(
              "trace",
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<String>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<String>>>) (v2 -> hydra.extract.helpers.Helpers.decodeList(
              ...
              fieldMap,
              cx),
            (java.util.function.Function<hydra.util.ConsList<String>, hydra.util.Either<hydra.errors.DecodingError, hydra.context.Context>>) (field_trace -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "messages",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<String>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<String>>>) (v2 -> hydra.extract.helpers.Helpers.decodeList(
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, String>>>) (cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, String>>) (raw2 -> hydra.lib.eithers.Either.apply(
                ...
                fieldMap,
                cx),
              (java.util.function.Function<hydra.util.ConsList<String>, hydra.util.Either<hydra.errors.DecodingError, hydra.context.Context>>) (field_messages -> hydra.lib.eithers.Bind.apply(
                hydra.extract.helpers.Helpers.requireField(
                  "other",
                  ...
                  fieldMap,
                  cx),
                (java.util.function.Function<hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>, hydra.util.Either<hydra.errors.DecodingError, hydra.context.Context>>) (field_other -> hydra.util.Either.<hydra.errors.DecodingError, hydra.context.Context>right(new hydra.context.Context(field_trace, field_messages, field_other))))))));
        }
      })),
      hydra.lexical.Lexical.stripAndDereferenceTermEither(
        cx,
