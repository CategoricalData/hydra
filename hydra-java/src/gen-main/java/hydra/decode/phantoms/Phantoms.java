        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.phantoms.TBinding<T1>> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.core.Name, hydra.util.Either<hydra.errors.DecodingError, hydra.phantoms.TBinding<T1>>>) (field_name -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "term",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.phantoms.TTerm<T1>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.phantoms.TTerm<T1>>>) (v2 -> hydra.decode.phantoms.Phantoms.<T0, T1>tTerm(
                  a,
                  v1,
                  v2))),
                fieldMap,
