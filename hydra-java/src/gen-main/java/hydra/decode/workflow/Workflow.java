  ...
  static hydra.util.Either<hydra.error.DecodingError, hydra.workflow.HydraSchemaSpec> hydraSchemaSpec(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      ...
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.HydraSchemaSpec>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        @Override
        public hydra.util.Either<hydra.error.DecodingError, hydra.workflow.HydraSchemaSpec> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.helpers.Helpers.requireField(
              "modules",
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, java.util.List<hydra.module.Module>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, java.util.List<hydra.module.Module>>>) (v2 -> hydra.extract.helpers.Helpers.decodeList(
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.module.Module>>>) (p0 -> p1 -> hydra.decode.module.Module.module(
                  p0,
                  p1)),
                v1,
                v2))),
              fieldMap,
              cx),
            (java.util.function.Function<java.util.List<hydra.module.Module>, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.HydraSchemaSpec>>) (field_modules -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "typeName",
  ...
  static hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec> schemaSpec(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      ...
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        @Override
        public hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec> visit(hydra.core.Term.Union inj) {
          hydra.core.Field field = ((inj).value).field;
          hydra.core.Name fname = (field).name;
          hydra.core.Term fterm = (field).term;
          hydra.core.Name tname = ((inj).value).typeName;
          hydra.util.Lazy<java.util.Map<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>> variantMap = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(java.util.List.of(
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>(new hydra.core.Name("hydra"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>) (input -> hydra.lib.eithers.Map.apply(
            ...
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>(new hydra.core.Name("file"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>) (input -> hydra.lib.eithers.Map.apply(
              ...
              hydra.lib.eithers.Either.apply(
                ...
                hydra.lexical.Lexical.stripAndDereferenceTermEither(
                  cx,
                  input))))))),
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>(new hydra.core.Name("provided"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>) (input -> hydra.lib.eithers.Map.apply(
  ...
  static hydra.util.Either<hydra.error.DecodingError, hydra.workflow.TransformWorkflow> transformWorkflow(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      ...
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.TransformWorkflow>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        @Override
        public hydra.util.Either<hydra.error.DecodingError, hydra.workflow.TransformWorkflow> visit(hydra.core.Term.Record record) {
          java.util.Map<hydra.core.Name, hydra.core.Term> fieldMap = hydra.extract.helpers.Helpers.toFieldMap((record).value);
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.helpers.Helpers.requireField(
              "name",
              ...
              fieldMap,
              cx),
            (java.util.function.Function<String, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.TransformWorkflow>>) (field_name -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "schemaSpec",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.SchemaSpec>>>) (p0 -> p1 -> hydra.decode.workflow.Workflow.schemaSpec(
                  p0,
                  p1)),
                fieldMap,
                cx),
              (java.util.function.Function<hydra.workflow.SchemaSpec, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.TransformWorkflow>>) (field_schemaSpec -> hydra.lib.eithers.Bind.apply(
                hydra.extract.helpers.Helpers.requireField(
                  "srcDir",
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, String>>>) (cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, String>>) (raw2 -> hydra.lib.eithers.Either.apply(
                    (java.util.function.Function<String, hydra.util.Either<hydra.error.DecodingError, String>>) (err -> (hydra.util.Either<hydra.error.DecodingError, String>) ((hydra.util.Either<hydra.error.DecodingError, String>) (hydra.util.Either.<hydra.error.DecodingError, String>left(new hydra.error.DecodingError(err))))),
                  ...
                  fieldMap,
                  cx),
                (java.util.function.Function<String, hydra.util.Either<hydra.error.DecodingError, hydra.workflow.TransformWorkflow>>) (field_srcDir -> hydra.lib.eithers.Bind.apply(
                  hydra.extract.helpers.Helpers.requireField(
                    "destDir",
                    (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, String>>>) (cx2 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.error.DecodingError, String>>) (raw2 -> hydra.lib.eithers.Either.apply(
                      (java.util.function.Function<String, hydra.util.Either<hydra.error.DecodingError, String>>) (err -> (hydra.util.Either<hydra.error.DecodingError, String>) ((hydra.util.Either<hydra.error.DecodingError, String>) (hydra.util.Either.<hydra.error.DecodingError, String>left(new hydra.error.DecodingError(err))))),
