...
public interface Parsing {
      ...
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.parsing.ParseResult<T0>>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.parsing.ParseResult<T0>> visit(hydra.core.Term.Union inj) {
          ...
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.errors.DecodingError, hydra.parsing.ParseResult<T0>>left(new hydra.errors.DecodingError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "no such field ",
              (fname).value,
              " in union")))),
            ...
            hydra.lib.maps.Lookup.apply(
              ...
              hydra.decode.parsing.Parsing.<T0>parseResult_variantMap(
                a,
                cx,
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.parsing.ParseError>>>) (p0 -> p1 -> hydra.decode.parsing.Parsing.parseError(
                  p0,
                  p1)))));
        }
      })),
  ...
  static <T0> hydra.util.PersistentMap<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.parsing.ParseResult<T0>>>> parseResult_variantMap(java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, T0>>> a, hydra.graph.Graph cx, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.parsing.ParseError>>> hydra_decode_parsing_parseError2) {
