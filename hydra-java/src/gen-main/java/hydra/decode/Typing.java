        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.typing.FunctionStructure<T0>> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.Core.requireField(
              ...
              fieldMap,
              cx),
            (java.util.function.Function<java.util.List<hydra.core.Name>, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.FunctionStructure<T0>>>) (field_typeParams -> hydra.lib.eithers.Bind.apply(
              hydra.extract.Core.requireField(
                "params",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, java.util.List<hydra.core.Name>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, java.util.List<hydra.core.Name>>>) (v2 -> hydra.extract.Core.decodeList(
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.core.Name>>>) (p0 -> p1 -> hydra.decode.Core.name(
                ...
                fieldMap,
                cx),
              (java.util.function.Function<java.util.List<hydra.core.Name>, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.FunctionStructure<T0>>>) (field_params -> hydra.lib.eithers.Bind.apply(
                hydra.extract.Core.requireField(
                  "bindings",
                  ...
                  fieldMap,
                  cx),
                (java.util.function.Function<java.util.List<hydra.core.Binding>, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.FunctionStructure<T0>>>) (field_bindings -> hydra.lib.eithers.Bind.apply(
                  hydra.extract.Core.requireField(
                    "body",
                  ...
                  (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.FunctionStructure<T0>>>) (field_body -> hydra.lib.eithers.Bind.apply(
                    hydra.extract.Core.requireField(
                      ...
                      fieldMap,
                      cx),
                    (java.util.function.Function<java.util.List<hydra.core.Type>, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.FunctionStructure<T0>>>) (field_domains -> hydra.lib.eithers.Bind.apply(
                      hydra.extract.Core.requireField(
                        "codomain",
              ...
              (java.util.function.Function<hydra.core.Type, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.InferenceResult>>) (field_type -> hydra.lib.eithers.Bind.apply(
                ...
                (java.util.function.Function<hydra.typing.TypeSubst, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.InferenceResult>>) (field_subst -> hydra.lib.eithers.Bind.apply(
                  hydra.extract.Core.requireField(
                    ...
                    fieldMap,
                    cx),
                  (java.util.function.Function<java.util.Map<hydra.core.Name, hydra.core.TypeVariableMetadata>, hydra.util.Either<hydra.errors.DecodingError, hydra.typing.InferenceResult>>) (field_classConstraints -> hydra.lib.eithers.Bind.apply(
                    hydra.extract.Core.requireField(
                      "context",
