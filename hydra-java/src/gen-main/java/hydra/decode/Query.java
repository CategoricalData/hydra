...
public interface Query {
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.ComparisonConstraint> comparisonConstraint(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.ComparisonConstraint>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.ComparisonConstraint>left(new hydra.errors.DecodingError(err))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.ComparisonConstraint>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.ComparisonConstraint> visit(hydra.core.Term.Union inj) {
          ...
          hydra.util.Lazy<hydra.util.PersistentMap<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.ComparisonConstraint>>>> variantMap = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.util.ConsList.of(
          ...
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.ComparisonConstraint>left(new hydra.errors.DecodingError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "no such field ",
              (fname).value,
              " in union")))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Edge> edge(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Edge>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Edge>left(new hydra.errors.DecodingError(err))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.GraphPattern> graphPattern(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.GraphPattern>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.GraphPattern>left(new hydra.errors.DecodingError(err))),
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.GraphPattern> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.core.Name, hydra.util.Either<hydra.errors.DecodingError, hydra.query.GraphPattern>>) (field_graph -> hydra.lib.eithers.Bind.apply(
              hydra.extract.Helpers.requireField(
                "patterns",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.query.Pattern>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.query.Pattern>>>) (v2 -> hydra.extract.Helpers.decodeList(
                ...
                fieldMap,
                cx),
              (java.util.function.Function<hydra.util.ConsList<hydra.query.Pattern>, hydra.util.Either<hydra.errors.DecodingError, hydra.query.GraphPattern>>) (field_patterns -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.GraphPattern>right(new hydra.query.GraphPattern(field_graph, field_patterns))))));
        }
      })),
      hydra.Lexical.stripAndDereferenceTermEither(
        cx,
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node> node(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Node>left(new hydra.errors.DecodingError(err))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node> visit(hydra.core.Term.Union inj) {
          ...
          hydra.core.Name fname = (field).name;
          hydra.core.Term fterm = (field).term;
          hydra.util.Lazy<hydra.util.PersistentMap<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node>>>> variantMap = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.util.ConsList.of(
            ...
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node>>>(new hydra.core.Name("wildcard"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Node>>) (input -> hydra.lib.eithers.Map.apply(
              ...
              hydra.extract.Helpers.decodeUnit(
                ...
                input)))))))));
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Node>left(new hydra.errors.DecodingError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "no such field ",
              (fname).value,
              " in union")))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path> path(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Path>left(new hydra.errors.DecodingError(err))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path> visit(hydra.core.Term.Union inj) {
          ...
          hydra.core.Name fname = (field).name;
          hydra.core.Term fterm = (field).term;
          hydra.util.Lazy<hydra.util.PersistentMap<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path>>>> variantMap = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.util.ConsList.of(
            ...
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path>>>(new hydra.core.Name("inverse"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Path>>) (input -> hydra.lib.eithers.Map.apply(
              ...
              hydra.decode.Query.path(
                ...
                input)))))))));
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Path>left(new hydra.errors.DecodingError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "no such field ",
              (fname).value,
              " in union")))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.PathEquation> pathEquation(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.PathEquation>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.PathEquation>left(new hydra.errors.DecodingError(err))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern> pattern(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Pattern>left(new hydra.errors.DecodingError(err))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern> visit(hydra.core.Term.Union inj) {
          ...
          hydra.core.Name fname = (field).name;
          hydra.core.Term fterm = (field).term;
          hydra.util.Lazy<hydra.util.PersistentMap<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>>> variantMap = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.util.ConsList.of(
            ...
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>>(new hydra.core.Name("graph"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>) (input -> hydra.lib.eithers.Map.apply(
              ...
              hydra.decode.Query.graphPattern(
                ...
                input)))))))));
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Pattern>left(new hydra.errors.DecodingError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "no such field ",
              (fname).value,
              " in union")))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.PatternImplication> patternImplication(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.PatternImplication>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.PatternImplication>left(new hydra.errors.DecodingError(err))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Query> query(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Query>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Query>left(new hydra.errors.DecodingError(err))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Query>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.Query> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.Helpers.requireField(
              "variables",
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.query.Variable>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.query.Variable>>>) (v2 -> hydra.extract.Helpers.decodeList(
              ...
              fieldMap,
              cx),
            (java.util.function.Function<hydra.util.ConsList<hydra.query.Variable>, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Query>>) (field_variables -> hydra.lib.eithers.Bind.apply(
              hydra.extract.Helpers.requireField(
                "patterns",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.query.Pattern>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.query.Pattern>>>) (v2 -> hydra.extract.Helpers.decodeList(
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Pattern>>>) (p0 -> p1 -> hydra.decode.Query.pattern(
                ...
                fieldMap,
                cx),
              (java.util.function.Function<hydra.util.ConsList<hydra.query.Pattern>, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Query>>) (field_patterns -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Query>right(new hydra.query.Query(field_variables, field_patterns))))));
        }
      })),
      hydra.Lexical.stripAndDereferenceTermEither(
        cx,
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Range> range(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Range>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Range>left(new hydra.errors.DecodingError(err))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier> regexQuantifier(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.RegexQuantifier>left(new hydra.errors.DecodingError(err))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier> visit(hydra.core.Term.Union inj) {
          ...
          hydra.core.Name fname = (field).name;
          hydra.core.Term fterm = (field).term;
          hydra.util.Lazy<hydra.util.PersistentMap<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier>>>> variantMap = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.util.ConsList.of(
            ...
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier>>>(new hydra.core.Name("range"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexQuantifier>>) (input -> hydra.lib.eithers.Map.apply(
              ...
              hydra.decode.Query.range(
                ...
                input)))))))));
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.RegexQuantifier>left(new hydra.errors.DecodingError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "no such field ",
              (fname).value,
              " in union")))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexSequence> regexSequence(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.RegexSequence>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.RegexSequence>left(new hydra.errors.DecodingError(err))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step> step(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Step>left(new hydra.errors.DecodingError(err))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step> visit(hydra.core.Term.Union inj) {
          ...
          hydra.core.Name fname = (field).name;
          hydra.core.Term fterm = (field).term;
          hydra.util.Lazy<hydra.util.PersistentMap<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step>>>> variantMap = new hydra.util.Lazy<>(() -> hydra.lib.maps.FromList.apply(hydra.util.ConsList.of(
            ...
            (hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step>>>) ((hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step>>>) (new hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step>>>(new hydra.core.Name("compare"), (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Step>>) (input -> hydra.lib.eithers.Map.apply(
              ...
              hydra.decode.Query.comparisonConstraint(
                ...
                input)))))))));
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Step>left(new hydra.errors.DecodingError(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
              "no such field ",
              (fname).value,
              " in union")))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.TriplePattern> triplePattern(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.TriplePattern>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.TriplePattern>left(new hydra.errors.DecodingError(err))),
  ...
  static hydra.util.Either<hydra.errors.DecodingError, hydra.query.Variable> variable(hydra.graph.Graph cx, hydra.core.Term raw) {
    return hydra.lib.eithers.Either.apply(
      (java.util.function.Function<String, hydra.util.Either<hydra.errors.DecodingError, hydra.query.Variable>>) (err -> hydra.util.Either.<hydra.errors.DecodingError, hydra.query.Variable>left(new hydra.errors.DecodingError(err))),
