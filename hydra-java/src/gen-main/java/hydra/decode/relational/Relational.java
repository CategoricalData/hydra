        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ColumnSchema<T0>> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.helpers.Helpers.requireField(
              "name",
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ColumnName>>>) (p0 -> p1 -> hydra.decode.relational.Relational.columnName(
                p0,
                p1)),
              fieldMap,
              cx),
      ...
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ForeignKey>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ForeignKey> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.helpers.Helpers.requireField(
              "foreignRelation",
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.RelationName>>>) (p0 -> p1 -> hydra.decode.relational.Relational.relationName(
                p0,
                p1)),
              fieldMap,
              cx),
            (java.util.function.Function<hydra.relational.RelationName, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ForeignKey>>) (field_foreignRelation -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "keys",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.PersistentMap<hydra.relational.ColumnName, hydra.relational.ColumnName>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.PersistentMap<hydra.relational.ColumnName, hydra.relational.ColumnName>>>) (v2 -> hydra.extract.helpers.Helpers.decodeMap(
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ColumnName>>>) (p0 -> p1 -> hydra.decode.relational.Relational.columnName(
                    p0,
                    p1)),
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ColumnName>>>) (p0 -> p1 -> hydra.decode.relational.Relational.columnName(
      ...
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.Relation<T0>>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.relational.Relation<T0>> visit(hydra.core.Term.Wrap wrappedTerm) {
          return hydra.lib.eithers.Map.apply(
            ...
            hydra.extract.helpers.Helpers.decodeList(
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.Row<T0>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.Row<T0>>>) (v2 -> hydra.decode.relational.Relational.<T0>row(
                v,
                v1,
                v2))),
              cx,
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.relational.RelationSchema<T0>> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.relational.RelationName, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.RelationSchema<T0>>>) (field_name -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "columns",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.relational.ColumnSchema<T0>>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.relational.ColumnSchema<T0>>>>) (v2 -> hydra.extract.helpers.Helpers.decodeList(
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ColumnSchema<T0>>>>) (v12 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ColumnSchema<T0>>>) (v22 -> hydra.decode.relational.Relational.<T0>columnSchema(
                    t,
                    v12,
                    v22))),
                  v1,
              ...
              (java.util.function.Function<hydra.util.ConsList<hydra.relational.ColumnSchema<T0>>, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.RelationSchema<T0>>>) (field_columns -> hydra.lib.eithers.Bind.apply(
                hydra.extract.helpers.Helpers.requireField(
                  "primaryKeys",
                  (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.relational.PrimaryKey>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.relational.PrimaryKey>>>) (v2 -> hydra.extract.helpers.Helpers.decodeList(
                    (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.PrimaryKey>>>) (p0 -> p1 -> hydra.decode.relational.Relational.primaryKey(
                      p0,
                      p1)),
                    v1,
                    v2))),
                ...
                (java.util.function.Function<hydra.util.ConsList<hydra.relational.PrimaryKey>, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.RelationSchema<T0>>>) (field_primaryKeys -> hydra.lib.eithers.Bind.apply(
                  hydra.extract.helpers.Helpers.requireField(
                    "foreignKeys",
                    (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.relational.ForeignKey>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.relational.ForeignKey>>>) (v2 -> hydra.extract.helpers.Helpers.decodeList(
                      (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ForeignKey>>>) (p0 -> p1 -> hydra.decode.relational.Relational.foreignKey(
                        p0,
                        p1)),
                      v1,
                      v2))),
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.relational.Relationship<T0>> visit(hydra.core.Term.Wrap wrappedTerm) {
          return hydra.lib.eithers.Map.apply(
            ...
            hydra.extract.helpers.Helpers.decodeSet(
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.PersistentMap<hydra.relational.ColumnName, T0>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.PersistentMap<hydra.relational.ColumnName, T0>>>) (v2 -> hydra.extract.helpers.Helpers.decodeMap(
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.relational.ColumnName>>>) (p0 -> p1 -> hydra.decode.relational.Relational.columnName(
                  p0,
                  p1)),
                v,
