        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.Grammar> visit(hydra.core.Term.Wrap wrappedTerm) {
          return hydra.lib.eithers.Map.apply(
            ...
            hydra.extract.helpers.Helpers.decodeList(
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.Production>>>) (p0 -> p1 -> hydra.decode.grammar.Grammar.production(
                p0,
                p1)),
              cx,
              (wrappedTerm).value.body));
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.LabeledPattern> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.helpers.Helpers.requireField(
              "label",
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.Label>>>) (p0 -> p1 -> hydra.decode.grammar.Grammar.label(
                p0,
                p1)),
              fieldMap,
              cx),
            (java.util.function.Function<hydra.grammar.Label, hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.LabeledPattern>>) (field_label -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "pattern",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.Pattern>>>) (p0 -> p1 -> hydra.decode.grammar.Grammar.pattern(
                  p0,
                  p1)),
                fieldMap,
                cx),
      ...
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.Production>>) (stripped -> (stripped).accept(new hydra.core.Term.PartialVisitor<>() {
        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.Production> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            hydra.extract.helpers.Helpers.requireField(
              "symbol",
              (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.grammar.Symbol>>>) (p0 -> p1 -> hydra.decode.grammar.Grammar.symbol(
                p0,
                p1)),
              fieldMap,
              cx),
