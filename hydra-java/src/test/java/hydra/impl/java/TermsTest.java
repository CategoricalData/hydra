...
public class TermsTest {
  ...
  /**
   * A union term chooses one of the variants of a union type, and supplies an appropriate term
   *
   * See {@link hydra.impl.java.TypesTest} for the union type corresponding to this term
   */
  private final Term<String> bayAreaLocation = union("Location", field("latlon", bayAreaLatLon));
