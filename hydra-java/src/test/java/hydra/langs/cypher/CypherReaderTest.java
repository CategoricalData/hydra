...
public class CypherReaderTest {
  ...
  @ValueSource(strings = {
      ...
      QUERY_MATCH_1, QUERY_MATCH_2, QUERY_MATCH_3, QUERY_MATCH_4, QUERY_MATCH_6, QUERY_MATCH_7, QUERY_MATCH_8,
      QUERY_MATCH_9, QUERY_MATCH_10, QUERY_MATCH_11, QUERY_MATCH_12, QUERY_MATCH_13, QUERY_MATCH_14,
      QUERY_OPTIONAL_1, QUERY_OPTIONAL_2, QUERY_OPTIONAL_3, QUERY_OPTIONAL_4, QUERY_OPTIONAL_5, QUERY_OPTIONAL_6,
      QUERY_OPTIONAL_7, QUERY_OPTIONAL_8})
  ...
  /**
   * COLLECT is not explicitly supported in the OpenCypher model or the OpenCypher BNF it is based on.
   * However, the ANTLR-based parser turns it into a function call.
   * This is likely true of other built-in functions as well.
   */
  @Test
  public void tmpTestCollect() {
    String q = "MATCH (a)-[:KNOWS]->(b)\n"
        + "RETURN COLLECT(b.name) AS friends";
    Query query = CypherReader.read(q);
    assertNotNull(query);
  }
