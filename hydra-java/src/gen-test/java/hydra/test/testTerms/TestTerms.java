...
public interface TestTerms {
  static hydra.core.Term latlonRecord(Float lat, Float lon) {
    return new hydra.core.Term.Record(new hydra.core.Record(hydra.test.testTypes.TestTypes.testTypeLatLonName(), hydra.util.ConsList.of(
  ...
  static hydra.core.Term testDataArthur() {
    return new hydra.core.Term.Record(new hydra.core.Record(hydra.test.testTypes.TestTypes.testTypePersonName(), hydra.util.ConsList.of(
