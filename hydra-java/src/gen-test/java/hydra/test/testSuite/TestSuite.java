...
public interface TestSuite {
  hydra.testing.TestGroup allTests = new hydra.testing.TestGroup("All tests", java.util.Optional.empty(), java.util.Arrays.asList(
    new hydra.testing.TestGroup("hydra/lib/lists primitives", java.util.Optional.empty(), java.util.Arrays.asList(
      new hydra.testing.TestGroup("apply", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.apply"))), new hydra.core.Term.List(java.util.Arrays.asList(
        ...
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")),
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("three"))))))),
      new hydra.testing.TestGroup("bind", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.bind"))), new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/math.neg"))))), new hydra.core.Term.List(java.util.Arrays.asList(
        ...
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(4))))))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(-1))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(-2))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(-3))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(-4)))))))),
      new hydra.testing.TestGroup("concat", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.concat"))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
          new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(3))))),
      ...
      new hydra.testing.TestGroup("head", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.head"))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
      ...
      new hydra.testing.TestGroup("intercalate", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.intercalate"))), new hydra.core.Term.List(java.util.Arrays.asList(
        ...
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(7))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(8)))))))),
      new hydra.testing.TestGroup("intersperse", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.intersperse"))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("and")))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")),
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("three")))))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
        ...
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("and")),
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("three"))))))),
      new hydra.testing.TestGroup("last", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.last"))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
      ...
      new hydra.testing.TestGroup("length", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.length"))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
        new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(3))))))), new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(3)))))),
      new hydra.testing.TestGroup("map", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.map"))), new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.toUpper"))))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")))))), new hydra.core.Term.List(java.util.Arrays.asList(
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("ONE")),
        new hydra.core.Term.Literal(new hydra.core.Literal.String_("TWO"))))))),
      new hydra.testing.TestGroup("pure", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/lists.pure"))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")))), new hydra.core.Term.List(java.util.Arrays.asList(new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")))))))), java.util.Arrays.asList()),
    new hydra.testing.TestGroup("hydra/lib/strings primitives", java.util.Optional.empty(), java.util.Arrays.asList(
      new hydra.testing.TestGroup("cat", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(
        new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.cat"))), new hydra.core.Term.List(java.util.Arrays.asList(
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("one")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("two")),
        ...
        new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.cat"))), new hydra.core.Term.List(java.util.Arrays.asList()))), new hydra.core.Term.Literal(new hydra.core.Literal.String_(""))))),
      ...
      new hydra.testing.TestGroup("splitOn", java.util.Optional.empty(), java.util.Arrays.asList(), java.util.Arrays.asList(
        new hydra.testing.TestCase(java.util.Optional.empty(), new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Function(new hydra.core.Function.Primitive(new hydra.core.Name("hydra/lib/strings.splitOn"))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("ss")))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("Mississippi")))), new hydra.core.Term.List(java.util.Arrays.asList(
