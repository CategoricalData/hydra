...
public interface Rewriting {
  static hydra.testing.TestGroup allTests() {
    return new hydra.testing.TestGroup("rewriting", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), hydra.util.ConsList.of(
      new hydra.testing.TestGroup("foldOverTerm", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.TestGroup>) (hydra.util.ConsList.<hydra.testing.TestGroup>empty()), hydra.util.ConsList.of(
        new hydra.testing.TestCaseWithMetadata("collect labels from single node - pre-order", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(new hydra.core.Term.List(hydra.lib.lists.Map.apply(
          ...
          hydra.Rewriting.foldOverTerm(
            ...
            (java.util.function.Function<hydra.util.ConsList<hydra.core.Literal>, java.util.function.Function<hydra.core.Term, hydra.util.ConsList<hydra.core.Literal>>>) (acc -> (java.util.function.Function<hydra.core.Term, hydra.util.ConsList<hydra.core.Literal>>) (term -> hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
              acc,
              (term).accept(new hydra.core.Term.PartialVisitor<>() {
                @Override
                public hydra.util.ConsList<hydra.core.Literal> otherwise(hydra.core.Term instance) {
                  return (hydra.util.ConsList<hydra.core.Literal>) (hydra.util.ConsList.<hydra.core.Literal>empty());
                }

                @Override
                public hydra.util.ConsList<hydra.core.Literal> visit(hydra.core.Term.Pair p) {
                  return hydra.lib.pairs.First.apply((p).value).accept(new hydra.core.Term.PartialVisitor<>() {
                    ...
                    @Override
                    public hydra.util.ConsList<hydra.core.Literal> visit(hydra.core.Term.Literal lit) {
                      return hydra.util.ConsList.of((lit).value);
                    }
                  });
                }
              }))))),
            (hydra.util.ConsList<hydra.core.Literal>) (hydra.util.ConsList.<hydra.core.Literal>empty()),
            new hydra.core.Term.Pair((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) ((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) (new hydra.util.Pair<hydra.core.Term, hydra.core.Term>(new hydra.core.Term.Literal(new hydra.core.Literal.String_("a")), new hydra.core.Term.List((hydra.util.ConsList<hydra.core.Term>) (hydra.util.ConsList.<hydra.core.Term>empty())))))))))), hydra.show.Core.term(new hydra.core.Term.List(hydra.util.ConsList.of(new hydra.core.Term.Literal(new hydra.core.Literal.String_("a"))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("collect labels from tree - pre-order", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(new hydra.core.Term.List(hydra.lib.lists.Map.apply(
          ...
          hydra.Rewriting.foldOverTerm(
            ...
            (hydra.util.ConsList<hydra.core.Literal>) (hydra.util.ConsList.<hydra.core.Literal>empty()),
            new hydra.core.Term.Pair((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) ((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) (new hydra.util.Pair<hydra.core.Term, hydra.core.Term>(new hydra.core.Term.Literal(new hydra.core.Literal.String_("a")), new hydra.core.Term.List(hydra.util.ConsList.of(
              new hydra.core.Term.Pair((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) ((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) (new hydra.util.Pair<hydra.core.Term, hydra.core.Term>(new hydra.core.Term.Literal(new hydra.core.Literal.String_("b")), new hydra.core.Term.List((hydra.util.ConsList<hydra.core.Term>) (hydra.util.ConsList.<hydra.core.Term>empty())))))),
              new hydra.core.Term.Pair((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) ((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) (new hydra.util.Pair<hydra.core.Term, hydra.core.Term>(new hydra.core.Term.Literal(new hydra.core.Literal.String_("c")), new hydra.core.Term.List(hydra.util.ConsList.of(new hydra.core.Term.Pair((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) ((hydra.util.Pair<hydra.core.Term, hydra.core.Term>) (new hydra.util.Pair<hydra.core.Term, hydra.core.Term>(new hydra.core.Term.Literal(new hydra.core.Literal.String_("d")), new hydra.core.Term.List((hydra.util.ConsList<hydra.core.Term>) (hydra.util.ConsList.<hydra.core.Term>empty())))))))))))))))))))))), hydra.show.Core.term(new hydra.core.Term.List(hydra.util.ConsList.of(
        ...
        new hydra.testing.TestCaseWithMetadata("collect list lengths - pre-order", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(new hydra.core.Term.List(hydra.lib.lists.Map.apply(
          ...
          hydra.Rewriting.foldOverTerm(
            new hydra.coders.TraversalOrder.Pre(),
            (java.util.function.Function<hydra.util.ConsList<Integer>, java.util.function.Function<hydra.core.Term, hydra.util.ConsList<Integer>>>) (acc -> (java.util.function.Function<hydra.core.Term, hydra.util.ConsList<Integer>>) (term -> hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
              acc,
              (term).accept(new hydra.core.Term.PartialVisitor<>() {
                @Override
                public hydra.util.ConsList<Integer> otherwise(hydra.core.Term instance) {
                  return (hydra.util.ConsList<Integer>) (hydra.util.ConsList.<Integer>empty());
                }

                @Override
                public hydra.util.ConsList<Integer> visit(hydra.core.Term.List elems) {
                  return hydra.util.ConsList.of(hydra.lib.lists.Length.apply((elems).value));
                }
              }))))),
      ...
      new hydra.testing.TestGroup("rewriteType", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.TestGroup>) (hydra.util.ConsList.<hydra.testing.TestGroup>empty()), hydra.util.ConsList.of(
      ...
      new hydra.testing.TestGroup("rewriteTerm", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.TestGroup>) (hydra.util.ConsList.<hydra.testing.TestGroup>empty()), hydra.util.ConsList.of(
        new hydra.testing.TestCaseWithMetadata("string literal foo replaced with bar", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")))), hydra.show.Core.term(new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("string in variable not changed", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Variable(new hydra.core.Name("x")))), hydra.show.Core.term(new hydra.core.Term.Variable(new hydra.core.Name("x"))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("string in list", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          ...
          new hydra.core.Term.List(hydra.util.ConsList.of(
            new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")),
            new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz")))))), hydra.show.Core.term(new hydra.core.Term.List(hydra.util.ConsList.of(
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        ...
        new hydra.testing.TestCaseWithMetadata("strings in multiple record fields", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("Data"), hydra.util.ConsList.of(
            ...
            new hydra.core.Field(new hydra.core.Name("c"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")))))))), hydra.show.Core.term(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("Data"), hydra.util.ConsList.of(
          new hydra.core.Field(new hydra.core.Name("a"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))),
          new hydra.core.Field(new hydra.core.Name("b"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))),
          new hydra.core.Field(new hydra.core.Name("c"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        ...
        new hydra.testing.TestCaseWithMetadata("string in first case branch", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), hydra.util.ConsList.of(
            new hydra.core.Field(new hydra.core.Name("success"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo"))),
            new hydra.core.Field(new hydra.core.Name("error"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz")))))))))), hydra.show.Core.term(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), hydra.util.ConsList.of(
          new hydra.core.Field(new hydra.core.Name("success"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))),
          new hydra.core.Field(new hydra.core.Name("error"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))))))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("string in second case branch", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          ...
          new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), hydra.util.ConsList.of(
            ...
            new hydra.core.Field(new hydra.core.Name("error"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")))))))))), hydra.show.Core.term(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), hydra.util.ConsList.of(
          new hydra.core.Field(new hydra.core.Name("success"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))),
          new hydra.core.Field(new hydra.core.Name("error"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))))))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("string in default branch", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), hydra.util.Maybe.just(new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo"))), hydra.util.ConsList.of(
            new hydra.core.Field(new hydra.core.Name("success"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))),
            new hydra.core.Field(new hydra.core.Name("error"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz")))))))))), hydra.show.Core.term(new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), hydra.util.Maybe.just(new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))), hydra.util.ConsList.of(
          new hydra.core.Field(new hydra.core.Name("success"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))),
          new hydra.core.Field(new hydra.core.Name("error"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))))))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("string deeply nested in record in list in application", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Variable(new hydra.core.Name("process")), new hydra.core.Term.List(hydra.util.ConsList.of(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("Item"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("value"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")))))))))))), hydra.show.Core.term(new hydra.core.Term.Application(new hydra.core.Application(new hydra.core.Term.Variable(new hydra.core.Name("process")), new hydra.core.Term.List(hydra.util.ConsList.of(new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("Item"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("value"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))))))))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("string in union inject value", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("Result"), new hydra.core.Field(new hydra.core.Name("success"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo"))))))), hydra.show.Core.term(new hydra.core.Term.Union(new hydra.core.Injection(new hydra.core.Name("Result"), new hydra.core.Field(new hydra.core.Name("success"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        ...
        new hydra.testing.TestCaseWithMetadata("string in annotated term body", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Annotated(new hydra.core.AnnotatedTerm(new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")), (hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) ((hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) (hydra.util.PersistentMap.<hydra.core.Name, hydra.core.Term>empty())))))), hydra.show.Core.term(new hydra.core.Term.Annotated(new hydra.core.AnnotatedTerm(new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")), (hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) ((hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) (hydra.util.PersistentMap.<hydra.core.Name, hydra.core.Term>empty()))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        ...
        new hydra.testing.TestCaseWithMetadata("string in second of multiple let bindings", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          ...
          new hydra.core.Term.Let(new hydra.core.Let(hydra.util.ConsList.of(
            ...
            new hydra.core.Binding(new hydra.core.Name("y"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing()))), new hydra.core.Term.Variable(new hydra.core.Name("y")))))), hydra.show.Core.term(new hydra.core.Term.Let(new hydra.core.Let(hydra.util.ConsList.of(
          new hydra.core.Binding(new hydra.core.Name("x"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz")), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing())),
        ...
        new hydra.testing.TestCaseWithMetadata("string in all let bindings and body", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          ...
          new hydra.core.Term.Let(new hydra.core.Let(hydra.util.ConsList.of(
            new hydra.core.Binding(new hydra.core.Name("x"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing())),
            new hydra.core.Binding(new hydra.core.Name("y"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing()))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")))))), hydra.show.Core.term(new hydra.core.Term.Let(new hydra.core.Let(hydra.util.ConsList.of(
          new hydra.core.Binding(new hydra.core.Name("x"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing())),
          new hydra.core.Binding(new hydra.core.Name("y"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing()))), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar"))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        new hydra.testing.TestCaseWithMetadata("string in set", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          ...
          new hydra.core.Term.Set(hydra.util.PersistentSet.of(
            ...
            new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")))))), hydra.show.Core.term(new hydra.core.Term.Set(hydra.util.PersistentSet.of(
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
          new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz"))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())),
        ...
        new hydra.testing.TestCaseWithMetadata("string in case branch within let binding", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Let(new hydra.core.Let(hydra.util.ConsList.of(new hydra.core.Binding(new hydra.core.Name("handler"), new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), hydra.util.ConsList.of(
            new hydra.core.Field(new hydra.core.Name("ok"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo"))),
            new hydra.core.Field(new hydra.core.Name("err"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("baz")))))))), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing()))), new hydra.core.Term.Variable(new hydra.core.Name("handler")))))), hydra.show.Core.term(new hydra.core.Term.Let(new hydra.core.Let(hydra.util.ConsList.of(new hydra.core.Binding(new hydra.core.Name("handler"), new hydra.core.Term.Function(new hydra.core.Function.Elimination(new hydra.core.Elimination.Union(new hydra.core.CaseStatement(new hydra.core.Name("Result"), (hydra.util.Maybe<hydra.core.Term>) (hydra.util.Maybe.<hydra.core.Term>nothing()), hydra.util.ConsList.of(
        ...
        new hydra.testing.TestCaseWithMetadata("string in annotated wrapped record field", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(hydra.Rewriting.rewriteTerm(
          (java.util.function.Function<java.util.function.Function<hydra.core.Term, hydra.core.Term>, java.util.function.Function<hydra.core.Term, hydra.core.Term>>) (recurse -> (java.util.function.Function<hydra.core.Term, hydra.core.Term>) (term -> hydra.lib.logic.IfElse.lazy(
            ...
            () -> new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")),
            () -> (recurse).apply(term)))),
          new hydra.core.Term.Annotated(new hydra.core.AnnotatedTerm(new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(new hydra.core.Name("User"), new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("UserData"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("name"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("foo")))))))), (hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) ((hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) (hydra.util.PersistentMap.<hydra.core.Name, hydra.core.Term>empty())))))), hydra.show.Core.term(new hydra.core.Term.Annotated(new hydra.core.AnnotatedTerm(new hydra.core.Term.Wrap(new hydra.core.WrappedTerm(new hydra.core.Name("User"), new hydra.core.Term.Record(new hydra.core.Record(new hydra.core.Name("UserData"), hydra.util.ConsList.of(new hydra.core.Field(new hydra.core.Name("name"), new hydra.core.Term.Literal(new hydra.core.Literal.String_("bar")))))))), (hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) ((hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>) (hydra.util.PersistentMap.<hydra.core.Name, hydra.core.Term>empty()))))))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())))),
      new hydra.testing.TestGroup("rewriteAndFoldTermWithPath", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.TestGroup>) (hydra.util.ConsList.<hydra.testing.TestGroup>empty()), hydra.util.ConsList.of(
        ...
        new hydra.testing.TestCaseWithMetadata("collect list lengths in let body", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.show.Core.term(new hydra.core.Term.List(hydra.lib.lists.Map.apply(
          ...
          hydra.Rewriting.foldOverTerm(
            ...
            (hydra.util.ConsList<Integer>) (hydra.util.ConsList.<Integer>empty()),
            new hydra.core.Term.Let(new hydra.core.Let(hydra.util.ConsList.of(new hydra.core.Binding(new hydra.core.Name("xs"), new hydra.core.Term.List(hydra.util.ConsList.of(new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(1))))), (hydra.util.Maybe<hydra.core.TypeScheme>) (hydra.util.Maybe.<hydra.core.TypeScheme>nothing()))), new hydra.core.Term.List(hydra.util.ConsList.of(
              new hydra.core.Term.Literal(new hydra.core.Literal.Integer_(new hydra.core.IntegerValue.Int32(2))),
