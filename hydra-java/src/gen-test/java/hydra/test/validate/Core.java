...
public interface Core {
  static hydra.testing.TestGroup allTests() {
    return new hydra.testing.TestGroup("validate.core", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), hydra.util.ConsList.of(
      ...
      hydra.test.validate.Core.variableShadowingTests()), (hydra.util.ConsList<hydra.testing.TestCaseWithMetadata>) (hydra.util.ConsList.<hydra.testing.TestCaseWithMetadata>empty()));
  }
