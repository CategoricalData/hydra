...
public interface Pairs {
  static hydra.testing.TestGroup allTests() {
    return new hydra.testing.TestGroup("hydra.lib.pairs primitives", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), hydra.util.ConsList.of(
      new hydra.testing.TestGroup("bimap", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.TestGroup>) (hydra.util.ConsList.<hydra.testing.TestGroup>empty()), hydra.util.ConsList.of(
        new hydra.testing.TestCaseWithMetadata("transform both elements", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
          "(",
        ...
        new hydra.testing.TestCaseWithMetadata("with zero", new hydra.testing.TestCase.Universal(new hydra.testing.UniversalTestCase(hydra.lib.strings.Cat.apply(hydra.util.ConsList.of(
          "(",
          hydra.lib.literals.ShowInt32.apply(hydra.lib.pairs.First.apply(hydra.lib.pairs.Bimap.apply(
            (java.util.function.Function<Integer, Integer>) (x -> hydra.lib.math.Mul.apply(
              x,
          ...
          ")")))), (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.Tag>) (hydra.util.ConsList.<hydra.testing.Tag>empty())))),
      new hydra.testing.TestGroup("first", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.TestGroup>) (hydra.util.ConsList.<hydra.testing.TestGroup>empty()), hydra.util.ConsList.of(
      ...
      new hydra.testing.TestGroup("second", (hydra.util.Maybe<String>) (hydra.util.Maybe.<String>nothing()), (hydra.util.ConsList<hydra.testing.TestGroup>) (hydra.util.ConsList.<hydra.testing.TestGroup>empty()), hydra.util.ConsList.of(
