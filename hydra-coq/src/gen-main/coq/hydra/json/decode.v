...
Definition parseSpecialFloat : string -> (option) (Q) :=
  fun (s : string) => (((logic.ifElse) (((logic.or) (((equality.equal) (s)) ("NaN"%string))) (((logic.or) (((equality.equal) (s)) ("Infinity"%string))) (((equality.equal) (s)) ("-Infinity"%string))))) ((literals.readFloat64) (s))) (None).
...
| Type__List v_ => (fun (elemType : Type_) => let decodeElem := fun (v : Value) => ((((fromJson) (types)) (tname)) (elemType)) (v) in let arrResult := (expectArray) (value) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (arr : (list) (Value)) => let decoded := ((eithers.mapList) (decodeElem)) (arr) in ((eithers.map) (fun (ts : (list) (Term)) => (Term_List) (ts))) (decoded))) (arrResult)) (v_)
| Type__Set v_ => (fun (elemType : Type_) => let decodeElem := fun (v : Value) => ((((fromJson) (types)) (tname)) (elemType)) (v) in let arrResult := (expectArray) (value) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (arr : (list) (Value)) => let decoded := ((eithers.mapList) (decodeElem)) (arr) in ((eithers.map) (fun (elems : (list) (Term)) => (Term_Set) ((sets.fromList) (elems)))) (decoded))) (arrResult)) (v_)
...
| Type__Record v_ => (fun (rt : (list) (FieldType)) => let objResult := (expectObject) (value) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (obj : (list) ((prod) (string) (Value))) => let decodeField := fun (ft : FieldType) => let ftype := (fun r_ => (fieldType_type) (r_)) (ft) in let fname := (fun r_ => (fieldType_name) (r_)) (ft) in let mval := ((maps.lookup) ((fun w_ => w_) (fname))) (obj) in let defaultVal := (Value_Null) (tt) in let jsonVal := ((maybes.fromMaybe) (defaultVal)) (mval) in let decoded := ((((fromJson) (types)) (tname)) (ftype)) (jsonVal) in ((eithers.map) (fun (v : Term) => (Build_Field) (fname) (v))) (decoded) in let decodedFields := ((eithers.mapList) (decodeField)) (rt) in ((eithers.map) (fun (fs : (list) (Field)) => (Term_Record) ((Build_Record_) (tname) (fs)))) (decodedFields))) (objResult)) (v_)
| Type__Union v_ => (fun (rt : (list) (FieldType)) => let objResult := (expectObject) (value) in let decodeVariant := fun (key : string) => fun (val : (option) (Value)) => fun (ftype : Type_) => let jsonVal := ((maybes.fromMaybe) ((Value_Null) (tt))) (val) in let decoded := ((((fromJson) (types)) (tname)) (ftype)) (jsonVal) in ((eithers.map) (fun (v : Term) => (Term_Union) ((Build_Injection) (tname) ((Build_Field) (key) (v))))) (decoded) in let tryField := fun (key : string) => fun (val : (option) (Value)) => fun (ft : FieldType) => (((logic.ifElse) (((equality.equal) ((fun w_ => w_) ((fun r_ => (fieldType_name) (r_)) (ft)))) (key))) ((Some) ((((decodeVariant) (key)) (val)) ((fun r_ => (fieldType_type) (r_)) (ft))))) (None) in let findAndDecode := (hydra_fix) (fun findAndDecode => fun (key : string) => fun (val : (option) (Value)) => fun (fts : (list) (FieldType)) => (((logic.ifElse) ((lists.null) (fts))) ((inl) ((strings.cat) ((cons) ("unknown variant: "%string) ((cons) (key) (nil)))))) ((((maybes.maybe) ((((findAndDecode) (key)) (val)) ((lists.tail) (fts)))) (fun (r : (sum) (string) (Term)) => r)) ((((tryField) (key)) (val)) ((lists.head) (fts))))) in let decodeSingleKey := fun (obj : (list) ((prod) (string) (Value))) => (((findAndDecode) ((lists.head) ((maps.keys) (obj)))) (((maps.lookup) ((lists.head) ((maps.keys) (obj)))) (obj))) (rt) in let processUnion := fun (obj : (list) ((prod) (string) (Value))) => (((logic.ifElse) (((equality.equal) ((lists.length) ((maps.keys) (obj)))) ((1)%Z))) ((decodeSingleKey) (obj))) ((inl) ("expected single-key object for union"%string)) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (obj : (list) ((prod) (string) (Value))) => (processUnion) (obj))) (objResult)) (v_)
...
| Type__Map v_ => (fun (mt : MapType) => let valType := (fun r_ => (mapType_values) (r_)) (mt) in let keyType := (fun r_ => (mapType_keys) (r_)) (mt) in let arrResult := (expectArray) (value) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (arr : (list) (Value)) => let decodeEntry := fun (entryJson : Value) => let objResult := (expectObject) (entryJson) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (entryObj : (list) ((prod) (string) (Value))) => let valJson := ((maps.lookup) ("@value"%string)) (entryObj) in let keyJson := ((maps.lookup) ("@key"%string)) (entryObj) in (((maybes.maybe) ((inl) ("missing @key in map entry"%string))) (fun (kj : Value) => (((maybes.maybe) ((inl) ("missing @value in map entry"%string))) (fun (vj : Value) => let decodedVal := ((((fromJson) (types)) (tname)) (valType)) (vj) in let decodedKey := ((((fromJson) (types)) (tname)) (keyType)) (kj) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (k : Term) => ((eithers.map) (fun (v : Term) => (pair) (k) (v))) (decodedVal))) (decodedKey))) (valJson))) (keyJson))) (objResult) in let entries := ((eithers.mapList) (decodeEntry)) (arr) in ((eithers.map) (fun (es : (list) ((prod) (Term) (Term))) => (Term_Map) ((maps.fromList) (es)))) (entries))) (arrResult)) (v_)
| Type__Pair v_ => (fun (pt : PairType) => let secondType := (fun r_ => (pairType_second) (r_)) (pt) in let objResult := (expectObject) (value) in let firstType := (fun r_ => (pairType_first) (r_)) (pt) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (obj : (list) ((prod) (string) (Value))) => let secondJson := ((maps.lookup) ("@second"%string)) (obj) in let firstJson := ((maps.lookup) ("@first"%string)) (obj) in (((maybes.maybe) ((inl) ("missing @first in pair"%string))) (fun (fj : Value) => (((maybes.maybe) ((inl) ("missing @second in pair"%string))) (fun (sj : Value) => let decodedSecond := ((((fromJson) (types)) (tname)) (secondType)) (sj) in let decodedFirst := ((((fromJson) (types)) (tname)) (firstType)) (fj) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (f : Term) => ((eithers.map) (fun (s : Term) => (Term_Pair) ((pair) (f) (s)))) (decodedSecond))) (decodedFirst))) (secondJson))) (firstJson))) (objResult)) (v_)
| Type__Either v_ => (fun (et : EitherType) => let rightType := (fun r_ => (eitherType_right) (r_)) (et) in let objResult := (expectObject) (value) in let leftType := (fun r_ => (eitherType_left) (r_)) (et) in (((eithers.either) (fun (err : string) => (inl) (err))) (fun (obj : (list) ((prod) (string) (Value))) => let rightJson := ((maps.lookup) ("@right"%string)) (obj) in let leftJson := ((maps.lookup) ("@left"%string)) (obj) in (((maybes.maybe) ((((maybes.maybe) ((inl) ("expected @left or @right in Either"%string))) (fun (rj : Value) => let decoded := ((((fromJson) (types)) (tname)) (rightType)) (rj) in ((eithers.map) (fun (v : Term) => (Term_Either) ((inr) (v)))) (decoded))) (rightJson))) (fun (lj : Value) => let decoded := ((((fromJson) (types)) (tname)) (leftType)) (lj) in ((eithers.map) (fun (v : Term) => (Term_Either) ((inl) (v)))) (decoded))) (leftJson))) (objResult)) (v_)
