...
Definition termIsValue_bundle :=
  hydra_fix (fun (bundle_ : Term -> bool) =>
    ...
    fun (term_ : Term) => let forList := fun (els : (list) (Term)) => (((lists.foldl) (fun (b : bool) => fun (t : Term) => ((logic.and) (b)) ((termIsValue) (t)))) (true)) (els) in let checkField := fun (f : Field) => (termIsValue) ((fun r_ => (field_term) (r_)) (f)) in let checkFields := fun (fields : (list) (Field)) => (((lists.foldl) (fun (b : bool) => fun (f : Field) => ((logic.and) (b)) ((checkField) (f)))) (true)) (fields) in let functionIsValue := fun (f : Function) => (fun x_ => match x_ with
| Function_Elimination v_ => (fun (e : Elimination) => (fun x_ => match x_ with
| Elimination_Wrap v_ => (fun (_ : Name) => true) (v_)
| Elimination_Record v_ => (fun (_ : Projection) => true) (v_)
| Elimination_Union v_ => (fun (cs : CaseStatement) => ((logic.and) ((checkFields) ((fun r_ => (caseStatement_cases) (r_)) (cs)))) ((((maybes.maybe) (true)) (termIsValue)) ((fun r_ => (caseStatement_default) (r_)) (cs)))) (v_)
end) (e)) (v_)
| Function_Lambda v_ => (fun (l : Lambda) => (termIsValue) ((fun r_ => (lambda_body) (r_)) (l))) (v_)
end) (f) in (fun x_ => match x_ with
...
| Term_Function v_ => (fun (f : Function) => (functionIsValue) (f)) (v_)
...
| Term_Union v_ => (fun (i : Injection) => (checkField) ((fun r_ => (injection_field) (r_)) (i))) (v_)
| Term_Unit _ => true
...
Definition reduceTerm_bundle :=
  hydra_fix (fun (bundle_ : Context_ -> hydra.graph.Graph -> bool -> Term -> (sum) (Error) (Term)) =>
    ...
    fun (cx : Context_) => fun (graph_ : hydra.graph.Graph) => fun (eager : bool) => fun (term_ : Term) => let reduce := fun (eager2 : bool) => (((reduceTerm) (cx)) (graph_)) (eager2) in let reduceArg := fun (eager2 : bool) => fun (arg : Term) => (((logic.ifElse) (eager2)) ((inr) (arg))) (((reduce) (false)) (arg)) in let mapErrorToString := fun (e : Error) => (Error_Other) ((hydra.show.errors.error) (e)) in let doRecurse := fun (eager2 : bool) => fun (term2 : Term) => let isNonLambda := fun (f : Function) => (fun x_ => match x_ with
| Function_Lambda v_ => (fun (_ : Lambda) => false) (v_)
| _ => true
end) (f) in let isNonLambdaTerm := (fun x_ => match x_ with
| Term_Function v_ => (fun (f : Function) => (isNonLambda) (f)) (v_)
| Term_Let v_ => (fun (_ : Let) => false) (v_)
| _ => true
end) (term2) in ((logic.and) (eager2)) (isNonLambdaTerm) in let applyToArguments := (hydra_fix) (fun applyToArguments => fun (fun_ : Term) => fun (args : (list) (Term)) => (((logic.ifElse) ((lists.null) (args))) (fun_)) (((applyToArguments) ((Term_Application) ((Build_Application) (fun_) ((lists.head) (args))))) ((lists.tail) (args)))) in let applyElimination := fun (elm : Elimination) => fun (reducedArg : Term) => (fun x_ => match x_ with
| Elimination_Record v_ => (fun (proj : Projection) => ((eithers.bind) ((((hydra.extract.core.record) ((fun r_ => (projection_typeName) (r_)) (proj))) (graph_)) ((deannotateTerm) (reducedArg)))) (fun (fields : (list) (Field)) => let matchingFields := ((lists.filter) (fun (f : Field) => ((equality.equal) ((fun r_ => (field_name) (r_)) (f))) ((fun r_ => (projection_field) (r_)) (proj)))) (fields) in (((logic.ifElse) ((lists.null) (matchingFields))) ((inl) ((Error_Resolution) ((ResolutionError_NoMatchingField) ((Build_NoMatchingFieldError) ((fun r_ => (projection_field) (r_)) (proj))))))) ((inr) ((fun r_ => (field_term) (r_)) ((lists.head) (matchingFields)))))) (v_)
| Elimination_Union v_ => (fun (cs : CaseStatement) => ((eithers.bind) ((((hydra.extract.core.injection) ((fun r_ => (caseStatement_typeName) (r_)) (cs))) (graph_)) (reducedArg))) (fun (field : Field) => let matchingFields := ((lists.filter) (fun (f : Field) => ((equality.equal) ((fun r_ => (field_name) (r_)) (f))) ((fun r_ => (field_name) (r_)) (field)))) ((fun r_ => (caseStatement_cases) (r_)) (cs)) in (((logic.ifElse) ((lists.null) (matchingFields))) ((((maybes.maybe) ((inl) ((Error_Resolution) ((ResolutionError_NoMatchingField) ((Build_NoMatchingFieldError) ((fun r_ => (field_name) (r_)) (field))))))) (fun (x : Term) => (inr) (x))) ((fun r_ => (caseStatement_default) (r_)) (cs)))) ((inr) ((Term_Application) ((Build_Application) ((fun r_ => (field_term) (r_)) ((lists.head) (matchingFields))) ((fun r_ => (field_term) (r_)) (field))))))) (v_)
| Elimination_Wrap v_ => (fun (name : Name) => (((wrap) (name)) (graph_)) (reducedArg)) (v_)
end) (elm) in let applyIfNullary := (hydra_fix) (fun applyIfNullary => fun (eager2 : bool) => fun (original : Term) => fun (args : (list) (Term)) => let stripped := (deannotateTerm) (original) in let forPrimitive := fun (prim : Primitive) => fun (arity : Z) => fun (args2 : (list) (Term)) => let remainingArgs := ((lists.drop) (arity)) (args2) in let argList := ((lists.take) (arity)) (args2) in ((eithers.bind) (((eithers.mapList) ((reduceArg) (eager2))) (argList))) (fun (reducedArgs : (list) (Term)) => let strippedArgs := ((lists.map) (deannotateTerm)) (reducedArgs) in ((eithers.bind) ((((eithers.bimap) (mapErrorToString)) (fun (x : Term) => x)) (((((fun _ : _ => hydra_unreachable) (prim)) (cx)) (graph_)) (strippedArgs)))) (fun (primResult : Term) => ((eithers.bind) (((reduce) (eager2)) (primResult))) (fun (reducedResult : Term) => (((applyIfNullary) (eager2)) (reducedResult)) (remainingArgs)))) in let forLambda := fun (l : Lambda) => fun (args2 : (list) (Term)) => let remainingArgs := (lists.tail) (args2) in let param := (fun r_ => (lambda_parameter) (r_)) (l) in let body := (fun r_ => (lambda_body) (r_)) (l) in let arg := (lists.head) (args2) in ((eithers.bind) (((reduce) (eager2)) ((deannotateTerm) (arg)))) (fun (reducedArg : Term) => ((eithers.bind) (((reduce) (eager2)) ((((replaceFreeTermVariable) (param)) (reducedArg)) (body)))) (fun (reducedResult : Term) => (((applyIfNullary) (eager2)) (reducedResult)) (remainingArgs))) in let forElimination := fun (elm : Elimination) => fun (args2 : (list) (Term)) => let remainingArgs := (lists.tail) (args2) in let arg := (lists.head) (args2) in ((eithers.bind) (((reduceArg) (eager2)) ((deannotateTerm) (arg)))) (fun (reducedArg : Term) => ((eithers.bind) (((eithers.bind) (((applyElimination) (elm)) (reducedArg))) ((reduce) (eager2)))) (fun (reducedResult : Term) => (((applyIfNullary) (eager2)) (reducedResult)) (remainingArgs))) in (fun x_ => match x_ with
...
| Function_Elimination v_ => (fun (elm : Elimination) => (((logic.ifElse) ((lists.null) (args))) ((inr) (original))) (((forElimination) (elm)) (args))) (v_)
| Function_Lambda v_ => (fun (l : Lambda) => (((logic.ifElse) ((lists.null) (args))) ((inr) (original))) (((forLambda) (l)) (args))) (v_)
end) (v_)
...
| Function_Lambda v_ => (fun (l : Lambda) => (reduceLambda) (l)) (v_)
| _ => noChange
end) (f)) (v_)
| _ => noChange
end) (term_)).
...
| Function_Lambda v_ => (fun (_ : Lambda) => (0)%Z) (v_)
end) (f)) (v_)
...
end) (term2)) in let pad := (hydra_fix) (fun pad => fun (vars : (list) (Name)) => fun (body : Term) => (((logic.ifElse) ((lists.null) (vars))) (body)) ((Term_Function) ((Function_Lambda) ((Build_Lambda) ((lists.head) (vars)) (None) (((pad) ((lists.tail) (vars))) ((Term_Application) ((Build_Application) (body) ((Term_Variable) ((lists.head) (vars)))))))))) in let forCase := fun (f : Field) => ((eithers.bind) (((((((rewrite) (false)) (true)) (nil)) (recurse)) (tx)) ((fun r_ => (field_term) (r_)) (f)))) (fun (r : Term) => (inr) ((Build_Field) ((fun r_ => (field_name) (r_)) (f)) (r))) in let forCaseStatement := fun (cs : CaseStatement) => let tname := (fun r_ => (caseStatement_typeName) (r_)) (cs) in let dflt := (fun r_ => (caseStatement_default) (r_)) (cs) in let cases := (fun r_ => (caseStatement_cases) (r_)) (cs) in ((eithers.bind) (((eithers.mapMaybe) ((((((rewrite) (false)) (false)) (nil)) (recurse)) (tx))) (dflt))) (fun (rdflt : (option) (Term)) => ((eithers.bind) (((eithers.mapList) (forCase)) (cases))) (fun (rcases : (list) (Field)) => (inr) ((Term_Function) ((Function_Elimination) ((Elimination_Union) ((Build_CaseStatement) (tname) (rdflt) (rcases))))))) in let extraVariables := fun (n : Z) => ((lists.map) (fun (i : Z) => ((strings.cat2) ("v"%string)) ((literals.showInt32) (i)))) (((math.range) ((1)%Z)) (n)) in let padn := fun (n : Z) => fun (body : Term) => ((pad) ((extraVariables) (n))) (body) in let forElimination := fun (elm : Elimination) => let checkBase := fun (elm2 : Elimination) => (fun x_ => match x_ with
| Elimination_Union v_ => (fun (cs : CaseStatement) => (forCaseStatement) (cs)) (v_)
| _ => ((recurse) (tx)) (term_)
end) (elm2) in ((eithers.bind) (((eithers.map) (unwind)) ((checkBase) (elm)))) (fun (base : Term) => (inr) ((((logic.ifElse) (((logic.or) (topLevel)) (forced))) (((padn) ((1)%Z)) (base))) (base))) in let forceExpansion := fun (t : Term) => ((eithers.bind) (((((typeOf) (cx)) (tx)) (nil)) (t))) (fun (typCx : (prod) (Type_) (Context_)) => let arity := (typeArity) ((pairs.first) (typCx)) in (inr) (((padn) (arity)) ((unwind) (t)))) in let recurseOrForce := fun (term2 : Term) => (((logic.ifElse) (forced)) ((forceExpansion) (term2))) (((recurse) (tx)) ((unwind) (term2))) in let arityOf := (hydra_fix) (fun arityOf => fun (tx2 : hydra.graph.Graph) => fun (term2 : Term) => let forFunction := fun (tx3 : hydra.graph.Graph) => fun (f : Function) => (fun x_ => match x_ with
| Function_Elimination v_ => (fun (_ : Elimination) => (inr) ((1)%Z)) (v_)
| Function_Lambda v_ => (fun (l : Lambda) => let txl := ((extendGraphForLambda) (tx3)) (l) in ((arityOf) (txl)) ((fun r_ => (lambda_body) (r_)) (l))) (v_)
end) (f) in let dflt := ((eithers.map) (fun (_tc : (prod) (Type_) (Context_)) => (typeArity) ((pairs.first) (_tc)))) (((((typeOf) (cx)) (tx2)) (nil)) (term2)) in (fun x_ => match x_ with
| Term_Annotated v_ => (fun (at_ : AnnotatedTerm) => ((arityOf) (tx2)) ((fun r_ => (annotatedTerm_body) (r_)) (at_))) (v_)
| Term_Function v_ => (fun (f : Function) => ((forFunction) (tx2)) (f)) (v_)
...
| Term_Function v_ => (fun (f : Function) => (fun x_ => match x_ with
| Function_Elimination v_ => (fun (elm : Elimination) => (forElimination) (elm)) (v_)
| Function_Lambda v_ => (fun (l : Lambda) => let txl := ((extendGraphForLambda) (tx)) (l) in ((eithers.map) (unwind)) (((recurse) (txl)) (term_))) (v_)
end) (f)) (v_)
...
| Term_Application v_ => (fun (app : Application) => let rhs := (fun r_ => (application_argument) (r_)) (app) in let lhs := (fun r_ => (application_function) (r_)) (app) in (fun x_ => match x_ with
| Term_Function v_ => (fun (f : Function) => (fun x_ => match x_ with
| Function_Lambda v_ => (fun (l : Lambda) => let v := (fun r_ => (lambda_parameter) (r_)) (l) in let body := (fun r_ => (lambda_body) (r_)) (l) in (((logic.ifElse) (((isFreeVariableInTerm) (v)) (body))) (body)) ((((replaceFreeTermVariable) (v)) (rhs)) (body))) (v_)
| _ => rec
end) (f)) (v_)
| _ => rec
...
| Function_Elimination v_ => (fun (elm : Elimination) => let padElim := (fun x_ => match x_ with
| Elimination_Record v_ => (fun (_ : Projection) => false) (v_)
| Elimination_Union v_ => (fun (_ : CaseStatement) => true) (v_)
| Elimination_Wrap v_ => (fun (_ : Name) => false) (v_)
end) (elm) in let elimTerm := (Term_Function) ((Function_Elimination) ((forElimination) (elm))) in let elimHeadType := (fun x_ => match x_ with
| Elimination_Union v_ => (fun (cs2 : CaseStatement) => (Some) ((Type__Function) ((Build_FunctionType) ((Type__Variable) ((fun r_ => (caseStatement_typeName) (r_)) (cs2))) ((Type__Unit) (tt))))) (v_)
| _ => None
end) (elm) in (((((expand) (padElim)) (args)) ((1)%Z)) (elimHeadType)) (elimTerm)) (v_)
| Function_Lambda v_ => (fun (lm : Lambda) => let tx1 := ((extendGraphForLambda) (tx)) (lm) in let body := (((rewriteWithArgs) (nil)) (tx1)) ((fun r_ => (lambda_body) (r_)) (lm)) in let result := (Term_Function) ((Function_Lambda) ((Build_Lambda) ((fun r_ => (lambda_parameter) (r_)) (lm)) ((fun r_ => (lambda_domain) (r_)) (lm)) (body))) in let arty := ((termArityWithContext) (tx)) (result) in (((((expand) (false)) (args)) (arty)) (None)) (result)) (v_)
end) (fn)) (v_)
...
| Term_Union v_ => (fun (inj : Injection) => (afterRecursion) ((Term_Union) ((Build_Injection) ((fun r_ => (injection_typeName) (r_)) (inj)) ((forField) ((fun r_ => (injection_field) (r_)) (inj)))))) (v_)
