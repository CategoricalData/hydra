...
| TraversalOrder_Pre : unit -> TraversalOrder
| TraversalOrder_Post : unit -> TraversalOrder.

Definition LanguageName : Type :=
  string.
...
Record LanguageConstraints : Type := Build_LanguageConstraints {
  ...
  languageConstraints_types : Type_ -> bool
}.
...
| CoderDirection_Encode : unit -> CoderDirection
| CoderDirection_Decode : unit -> CoderDirection.

Record Coder (v1 : Type) (v2 : Type) : Type := Build_Coder {
  coder_encode : Context_ -> v1 -> (sum) (Error) (v2) ;
  coder_decode : Context_ -> v2 -> (sum) (Error) (v1)
}.
...
Record Bicoder (t1 : Type) (t2 : Type) (v1 : Type) (v2 : Type) : Type := Build_Bicoder {
  bicoder_encode : t1 -> ((((Adapter) (t1)) (t2)) (v1)) (v2) ;
  bicoder_decode : t2 -> ((((Adapter) (t2)) (t1)) (v2)) (v1)
}.

Definition SymmetricAdapter (t : Type) (v : Type) : Type :=
  ((((Adapter) (t)) (t)) (v)) (v).

Definition TypeAdapter : Type :=
  AdapterContext -> Type_ -> (sum) (string) (((SymmetricAdapter) (Type_)) (Term)).
