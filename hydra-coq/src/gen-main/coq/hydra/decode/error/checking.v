...
(* Module dependencies *)
Require Import hydra.graph hydra.core hydra.errors hydra.error.checking hydra.lib.eithers hydra.extract.core hydra.decode.paths hydra.paths hydra.decode.core hydra.decode.variants hydra.variants hydra.decode.typing hydra.typing hydra.lib.maps hydra.lib.maybes hydra.lib.strings.

Definition untypedTermVariableCheckingError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UntypedTermVariableCheckingError) :=
...
Definition untypedLetBindingError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UntypedLetBindingError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition untypedLambdaError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UntypedLambdaError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Record v_ => (fun (record : Record_) => let fieldMap := (toFieldMap) (record) in (inr) (tt)) (v_)
| _ => (inl) ("expected record"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw)).
Definition unsupportedTermVariantError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UnsupportedTermVariantError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition unequalTypesError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UnequalTypesError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition undefinedTermVariableCheckingError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UndefinedTermVariableCheckingError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
| Term_Record v_ => (fun (record : Record_) => let fieldMap := (toFieldMap) (record) in ((eithers.bind) (((((requireField) ("path"%string)) (hydra.decode.paths.subtermPath)) (fieldMap)) (cx))) (fun (field_path : SubtermPath) => ((eithers.bind) (((((requireField) ("name"%string)) (hydra.decode.core.name)) (fieldMap)) (cx))) (fun (field_name : Name) => (inr) ((Build_UndefinedTermVariableCheckingError) (field_path) (field_name))))) (v_)
| _ => (inl) ("expected record"%string)
end) (stripped))) (((stripWithDecodingError) (cx)) (raw)).
Definition unboundTypeVariablesError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (UnboundTypeVariablesError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition typeMismatchError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeMismatchError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition typeArityMismatchError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (TypeArityMismatchError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition otherCheckingError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (OtherCheckingError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition notAFunctionTypeError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (NotAFunctionTypeError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition notAForallTypeError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (NotAForallTypeError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition incorrectUnificationError : hydra.graph.Graph -> Term -> (sum) (DecodingError) (IncorrectUnificationError) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
