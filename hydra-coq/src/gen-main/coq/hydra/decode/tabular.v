...
Definition headerRow : hydra.graph.Graph -> Term -> (sum) (DecodingError) (HeaderRow) :=
...
Definition dataRow (t0 : Type) : (hydra.graph.Graph -> Term -> (sum) (DecodingError) (t0)) -> hydra.graph.Graph -> Term -> (sum) (DecodingError) ((DataRow) (t0)) :=
...
Definition table (t0 : Type) : (hydra.graph.Graph -> Term -> (sum) (DecodingError) (t0)) -> hydra.graph.Graph -> Term -> (sum) (DecodingError) ((Table) (t0)) :=
  fun (v : hydra.graph.Graph -> Term -> (sum) (DecodingError) (t0)) => fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Arguments table {t0}.
Definition columnType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (ColumnType) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
...
Definition tableType : hydra.graph.Graph -> Term -> (sum) (DecodingError) (TableType) :=
  fun (cx : hydra.graph.Graph) => fun (raw : Term) => (((eithers.either) (fun (err : DecodingError) => (inl) (err))) (fun (stripped : Term) => (fun x_ => match x_ with
