...
Definition subtermStep : SubtermStep -> (option) (string) :=
  fun (step : SubtermStep) => let idx := fun i => None in let idxSuff := fun (suffix : string) => fun i => ((maybes.map) (fun (s : string) => ((strings.cat2) (s)) (suffix))) ((idx) (i)) in (fun x_ => match x_ with
