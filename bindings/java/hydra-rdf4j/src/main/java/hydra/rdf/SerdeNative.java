...
import hydra.rdf.syntax.Triple;
...
public interface SerdeNative {
   ...
   */
  static BNode bnode(hydra.rdf.syntax.BlankNode r) {
   ...
   */
  static Literal literal(hydra.rdf.syntax.Literal r) {
   ...
   */
  static Resource resource(hydra.rdf.syntax.Resource r) {
    return r.accept(new hydra.rdf.syntax.Resource.Visitor<Resource>() {
      @Override
      public Resource visit(hydra.rdf.syntax.Resource.Iri instance) {
        return iri(instance.value);
      }

      @Override
      public Resource visit(hydra.rdf.syntax.Resource.Bnode instance) {
   ...
   */
  static Value value(hydra.rdf.syntax.Node r) {
