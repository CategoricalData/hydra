...
The current release is **0.16.0**; see the [CHANGELOG](CHANGELOG.md) for details.
...
| Java | [hydra-java on Maven Central](https://central.sonatype.com/artifact/net.fortytwo.hydra/hydra-java) | `net.fortytwo.hydra:hydra-java:0.16.0` |
