...
**Status**: DONE (locally, pending move to hydra-ext)
...
- Ready to move to `hydra-ext/src/main/haskell/Hydra/Ext/Sources/JavaScript/Syntax.hs` when validated
...
- Ready to move to `hydra-ext/src/main/haskell/Hydra/Ext/Sources/JavaScript/Language.hs` when validated
...
### Haskell DSL Files (local, pending move to hydra-ext)
...
1. **Move and validate syntax model** from `hydra-javascript/src/main/haskell/...` to `hydra-ext/src/main/haskell/Hydra/Ext/Sources/JavaScript/Syntax.hs`
   - Verify it compiles
   - Register in `Hydra.Ext.Sources.All`

2. **Move and validate language constraints** to `hydra-ext/src/main/haskell/Hydra/Ext/Sources/JavaScript/Language.hs`
   - Verify it compiles
   - Register in module

3. **Create the coder** in `hydra-ext/src/main/haskell/Hydra/Ext/Staging/JavaScript/Coder.hs`
...
4. **Create the serializer** in `hydra-ext/src/main/haskell/Hydra/Ext/Staging/JavaScript/Serde.hs`
...
- Move Haskell files to hydra-ext and validate compilation
