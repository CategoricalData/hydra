...
(cl:defvar hydra_encode_topology_tarjan_state (cl:lambda (x) (list :record (make-hydra_core_record "hydra.topology.TarjanState" (cl:list (make-hydra_core_field "counter" ((cl:lambda (x) (list :literal (list :integer (list :int32 x)))) ((cl:lambda (v) (hydra_topology_tarjan_state-counter v)) x))) (make-hydra_core_field "indices" ((cl:lambda (m) (list :map (((hydra_lib_maps_bimap hydra_encode_topology_vertex) (cl:lambda (x) (list :literal (list :integer (list :int32 x))))) m))) ((cl:lambda (v) (hydra_topology_tarjan_state-indices v)) x))) (make-hydra_core_field "lowLinks" ((cl:lambda (m) (list :map (((hydra_lib_maps_bimap hydra_encode_topology_vertex) (cl:lambda (x) (list :literal (list :integer (list :int32 x))))) m))) ((cl:lambda (v) (hydra_topology_tarjan_state-low_links v)) x))) (make-hydra_core_field "stack" ((cl:lambda (xs) (list :list ((hydra_lib_lists_map hydra_encode_topology_vertex) xs))) ((cl:lambda (v) (hydra_topology_tarjan_state-stack v)) x))) (make-hydra_core_field "onStack" ((cl:lambda (s) (list :set ((hydra_lib_sets_map hydra_encode_topology_vertex) s))) ((cl:lambda (v) (hydra_topology_tarjan_state-on_stack v)) x))) (make-hydra_core_field "sccs" ((cl:lambda (xs) (list :list ((hydra_lib_lists_map (cl:lambda (xs) (list :list ((hydra_lib_lists_map hydra_encode_topology_vertex) xs)))) xs))) ((cl:lambda (v) (hydra_topology_tarjan_state-sccs v)) x))))))))
