...
(cl:defvar hydra_annotations_get_debug_id (cl:lambda (cx) (((hydra_lib_maybes_maybe (list :right cl:nil)) (cl:lambda (term) ((hydra_lib_eithers_map hydra_lib_maybes_pure) (((hydra_extract_core_string cx) (make-hydra_graph_graph hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_sets_empty hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_sets_empty)) term)))) ((hydra_annotations_get_attr hydra_constants_key_debug_id) cx))))

(cl:defvar hydra_annotations_debug_if (cl:lambda (cx) (cl:lambda (debug_id) (cl:lambda (message) ((hydra_lib_eithers_bind (hydra_annotations_get_debug_id cx)) (cl:lambda (mid) (if ((hydra_lib_equality_equal mid) debug_id) (list :left (make-hydra_context_in_context (list :other message) cx)) (list :right cl:nil))))))))

(cl:defvar hydra_annotations_get_attr_with_default (cl:lambda (key) (cl:lambda (def_) (cl:lambda (cx) ((hydra_lib_maybes_from_maybe def_) ((hydra_annotations_get_attr key) cx))))))

(cl:defvar hydra_annotations_has_flag (cl:lambda (cx) (cl:lambda (flag) (let ((term (((hydra_annotations_get_attr_with_default flag) (list :literal (list :boolean cl:nil))) cx))) (((hydra_extract_core_boolean cx) (make-hydra_graph_graph hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_sets_empty hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_maps_empty hydra_lib_sets_empty)) term)))))

(cl:defvar hydra_annotations_fail_on_flag (cl:lambda (cx) (cl:lambda (flag) (cl:lambda (msg) ((hydra_lib_eithers_bind ((hydra_annotations_has_flag cx) flag)) (cl:lambda (val) (if val (list :left (make-hydra_context_in_context (list :other msg) cx)) (list :right cl:nil))))))))

(cl:defvar hydra_annotations_get_count (cl:lambda (key) (cl:lambda (cx) (((hydra_lib_maybes_maybe 0) (cl:lambda (term) ((cl:lambda (match_target) ((cl:lambda (match_value) (cond ((equal (car match_target) :literal) ((cl:lambda (lit) ((cl:lambda (match_target) ((cl:lambda (match_value) (cond ((equal (car match_target) :integer) ((cl:lambda (iv) ((cl:lambda (match_target) ((cl:lambda (match_value) (cond ((equal (car match_target) :int32) ((cl:lambda (i) i) match_value)) (t 0))) (cadr match_target))) iv)) match_value)) (t 0))) (cadr match_target))) lit)) match_value)) (t 0))) (cadr match_target))) term))) ((hydra_lib_maps_lookup key) ((cl:lambda (v) (hydra_context_context-other v)) cx))))))

(cl:defvar hydra_annotations_get_description (cl:lambda (cx) (cl:lambda (graph) (cl:lambda (anns) (((hydra_lib_maybes_maybe (list :right cl:nil)) (cl:lambda (term) ((hydra_lib_eithers_map hydra_lib_maybes_pure) (((hydra_extract_core_string cx) graph) term)))) ((hydra_lib_maps_lookup "description") anns))))))

(cl:defvar hydra_annotations_term_annotation_internal (cl:lambda (term) (let ((get_ann (cl:lambda (t_) ((cl:lambda (match_target) ((cl:lambda (match_value) (cond ((equal (car match_target) :annotated) ((cl:lambda (a) a) match_value)) (t cl:nil))) (cadr match_target))) t_)))) ((((hydra_annotations_aggregate_annotations get_ann) (cl:lambda (at) ((cl:lambda (v) (hydra_core_annotated_term-body v)) at))) (cl:lambda (at) ((cl:lambda (v) (hydra_core_annotated_term-annotation v)) at))) term))))
...
(cl:defvar hydra_annotations_get_type (cl:lambda (graph) (cl:lambda (anns) (((hydra_lib_maybes_maybe (list :right cl:nil)) (cl:lambda (dat) ((hydra_lib_eithers_map hydra_lib_maybes_pure) ((hydra_decode_core_type graph) dat)))) ((hydra_lib_maps_lookup hydra_constants_key_type) anns)))))

(cl:defvar hydra_annotations_type_annotation_internal (cl:lambda (typ) (let ((get_ann (cl:lambda (t_) ((cl:lambda (match_target) ((cl:lambda (match_value) (cond ((equal (car match_target) :annotated) ((cl:lambda (a) a) match_value)) (t cl:nil))) (cadr match_target))) t_)))) ((((hydra_annotations_aggregate_annotations get_ann) (cl:lambda (at) ((cl:lambda (v) (hydra_core_annotated_type-body v)) at))) (cl:lambda (at) ((cl:lambda (v) (hydra_core_annotated_type-annotation v)) at))) typ))))
...
(cl:defvar hydra_annotations_get_type_classes (cl:lambda (cx) (cl:lambda (graph) (cl:lambda (term) (let ((decode_class (cl:lambda (term) (let ((by_name (hydra_lib_maps_from_list (cl:list (cl:list "equality" (list :equality cl:nil)) (cl:list "ordering" (list :ordering cl:nil)))))) ((hydra_lib_eithers_bind ((((hydra_extract_core_unit_variant cx) "hydra.classes.TypeClass") graph) term)) (cl:lambda (fn_) (((hydra_lib_maybes_maybe (list :left (make-hydra_context_in_context (list :other ((hydra_lib_strings_cat2 "unexpected: expected type class, got ") (hydra_show_core_term term))) cx))) (cl:lambda (x) (list :right x))) ((hydra_lib_maps_lookup fn_) by_name)))))))) (((hydra_lib_maybes_maybe (list :right hydra_lib_maps_empty)) (cl:lambda (term) (((((hydra_extract_core_map cx) (cl:lambda (t_) (((hydra_lib_eithers_bimap (cl:lambda (de) (make-hydra_context_in_context (list :other ((cl:lambda (v) v) de)) cx))) (cl:lambda (x) x)) ((hydra_decode_core_name graph) t_)))) (((hydra_extract_core_set_of cx) decode_class) graph)) graph) term))) ((hydra_annotations_get_term_annotation hydra_constants_key_classes) term)))))))
...
(cl:defvar hydra_annotations_is_native_type (cl:lambda (el) (let ((is_flagged_as_first_class_type ((hydra_lib_maybes_from_maybe cl:nil) ((hydra_lib_maybes_map (cl:lambda (_) cl:t)) ((hydra_annotations_get_term_annotation hydra_constants_key_first_class_type) ((cl:lambda (v) (hydra_core_binding-term v)) el)))))) (((hydra_lib_maybes_maybe cl:nil) (cl:lambda (ts) ((hydra_lib_logic_and ((hydra_lib_equality_equal ts) (make-hydra_core_type_scheme (cl:list) (list :variable "hydra.core.Type") cl:nil))) (hydra_lib_logic_not is_flagged_as_first_class_type)))) ((cl:lambda (v) (hydra_core_binding-type v)) el)))))
...
(cl:defvar hydra_annotations_normalize_term_annotations (cl:lambda (term) (let ((anns (hydra_annotations_term_annotation_internal term))) (let ((stripped (hydra_rewriting_deannotate_term term))) (if (hydra_lib_maps_null anns) stripped (list :annotated (make-hydra_core_annotated_term stripped anns)))))))

(cl:defvar hydra_annotations_normalize_type_annotations (cl:lambda (typ) (let ((anns (hydra_annotations_type_annotation_internal typ))) (let ((stripped (hydra_rewriting_deannotate_type typ))) (if (hydra_lib_maps_null anns) stripped (list :annotated (make-hydra_core_annotated_type stripped anns)))))))
...
(cl:defvar hydra_annotations_set_term_annotation (cl:lambda (key) (cl:lambda (val) (cl:lambda (term) (let ((term_ (hydra_rewriting_deannotate_term term))) (let ((anns (((hydra_annotations_set_annotation key) val) (hydra_annotations_term_annotation_internal term)))) (if (hydra_lib_maps_null anns) term_ (list :annotated (make-hydra_core_annotated_term term_ anns)))))))))
...
(cl:defvar hydra_annotations_type_element (cl:lambda (name) (cl:lambda (typ) (let ((schema_term (list :variable "hydra.core.Type"))) (let ((data_term (hydra_annotations_normalize_term_annotations (list :annotated (make-hydra_core_annotated_term (hydra_encode_core_type typ) (hydra_lib_maps_from_list (cl:list (cl:list hydra_constants_key_type schema_term)))))))) (make-hydra_core_binding name data_term (make-hydra_core_type_scheme (cl:list) (list :variable "hydra.core.Type") cl:nil)))))))
