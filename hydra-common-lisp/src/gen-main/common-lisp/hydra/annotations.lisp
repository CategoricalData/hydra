...
(cl:defvar hydra_annotations_debug_if (cl:lambda (cx) (cl:lambda (debug_id) (cl:lambda (message) ((hydra_lib_eithers_bind (hydra_annotations_get_debug_id cx)) (cl:lambda (mid) (if ((hydra_lib_equality_equal mid) debug_id) (list :left (make-hydra_context_in_context message cx)) (list :right cl:nil))))))))
...
(cl:defvar hydra_annotations_fail_on_flag (cl:lambda (cx) (cl:lambda (flag) (cl:lambda (msg) ((hydra_lib_eithers_bind ((hydra_annotations_has_flag cx) flag)) (cl:lambda (val) (if val (list :left (make-hydra_context_in_context msg cx)) (list :right cl:nil))))))))
...
(cl:defvar hydra_annotations_get_type_classes (cl:lambda (cx) (cl:lambda (graph) (cl:lambda (term) (let ((decode_class (cl:lambda (term) (let ((by_name (hydra_lib_maps_from_list (cl:list (cl:list "equality" (list :equality cl:nil)) (cl:list "ordering" (list :ordering cl:nil)))))) ((hydra_lib_eithers_bind ((((hydra_extract_core_unit_variant cx) "hydra.classes.TypeClass") graph) term)) (cl:lambda (fn_) (((hydra_lib_maybes_maybe (list :left (make-hydra_context_in_context ((hydra_lib_strings_cat2 "unexpected: expected type class, got ") (hydra_show_core_term term)) cx))) (cl:lambda (x) (list :right x))) ((hydra_lib_maps_lookup fn_) by_name)))))))) (((hydra_lib_maybes_maybe (list :right hydra_lib_maps_empty)) (cl:lambda (term) (((((hydra_extract_core_map cx) (cl:lambda (t_) (((hydra_lib_eithers_bimap (cl:lambda (de) (make-hydra_context_in_context ((cl:lambda (v) v) de) cx))) (cl:lambda (x) x)) ((hydra_decode_core_name graph) t_)))) (((hydra_extract_core_set_of cx) decode_class) graph)) graph) term))) ((hydra_annotations_get_term_annotation hydra_constants_key_classes) term)))))))
