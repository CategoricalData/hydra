...
(cl:defvar hydra_extract_json_opt_array (cl:lambda (fname) (cl:lambda (m) (((hydra_lib_maybes_maybe (list :right cl:nil)) (cl:lambda (a) ((hydra_lib_eithers_map (cl:lambda (x) x)) (hydra_extract_json_expect_array a)))) ((hydra_extract_json_opt fname) m)))))

(cl:defvar hydra_extract_json_opt_string (cl:lambda (fname) (cl:lambda (m) (((hydra_lib_maybes_maybe (list :right cl:nil)) (cl:lambda (s) ((hydra_lib_eithers_map (cl:lambda (x) x)) (hydra_extract_json_expect_string s)))) ((hydra_extract_json_opt fname) m)))))
