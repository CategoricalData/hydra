(ns hydra.core.overlay.clojure.lib.effects)

;; Clojure implementations of hydra.core.lib.effects primitives (#494).
;;
...
(def hydra_overlay_clojure_lib_effects_map_optional
...
;; pure :: x -> effect<x>
(def hydra_overlay_clojure_lib_effects_pure
