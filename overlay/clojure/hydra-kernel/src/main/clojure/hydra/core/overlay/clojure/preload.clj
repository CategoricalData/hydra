(ns hydra.core.overlay.clojure.preload
...
(def ^:private lib-ns-names
  ...
  ["hydra.core.overlay.clojure.lib.chars" "hydra.core.overlay.clojure.lib.effects" "hydra.core.overlay.clojure.lib.eithers"
   "hydra.core.overlay.clojure.lib.equality" "hydra.core.overlay.clojure.lib.files" "hydra.core.overlay.clojure.lib.functions"
   "hydra.core.overlay.clojure.lib.lists" "hydra.core.overlay.clojure.lib.literals" "hydra.core.overlay.clojure.lib.logic"
   "hydra.core.overlay.clojure.lib.maps" "hydra.core.overlay.clojure.lib.math" "hydra.core.overlay.clojure.lib.optionals"
   "hydra.core.overlay.clojure.lib.ordering"
   "hydra.core.overlay.clojure.lib.pairs" "hydra.core.overlay.clojure.lib.sets" "hydra.core.overlay.clojure.lib.strings" "hydra.core.overlay.clojure.lib.system"
   "hydra.core.overlay.clojure.lib.text"])
...
(def ^:private gen-ns-names
  ...
  ["hydra.core.paths" "hydra.core.ast" "hydra.core.classes" "hydra.core.coders"   "hydra.core.model" "hydra.core.error.checking" "hydra.core.error.model" "hydra.core.error.packaging"
   "hydra.core.errors" "hydra.core.graph" "hydra.core.json.model" "hydra.core.packaging"
   "hydra.core.parsing" "hydra.core.query" "hydra.core.relational"
   "hydra.core.tabular" "hydra.core.testing" "hydra.core.topology" "hydra.core.typed" "hydra.core.typing" "hydra.core.util"
   "hydra.core.variants" "hydra.core.adapt" "hydra.core.analysis" "hydra.core.annotations"
   "hydra.core.arity" "hydra.core.checking" "hydra.core.codegen" "hydra.core.constants"
   "hydra.core.decoding" "hydra.core.dependencies" "hydra.core.differentiation" "hydra.core.encoding"
   "hydra.core.environment" "hydra.core.extract.model" "hydra.core.extract.util" "hydra.core.formatting"
   "hydra.core.hoisting" "hydra.core.inference" "hydra.core.languages" "hydra.core.lexical"
   "hydra.core.literals" "hydra.core.names" "hydra.core.parsers"
   "hydra.core.predicates" "hydra.core.reduction" "hydra.core.reflect" "hydra.core.resolution"
   "hydra.core.rewriting" "hydra.core.scoping" "hydra.core.serialization" "hydra.core.strip"
   "hydra.core.print.paths" "hydra.core.print.model" "hydra.core.print.errors" "hydra.core.print.error.model"
   "hydra.core.print.graph" "hydra.core.print.variants" "hydra.core.print.typing" "hydra.core.print.util"
   "hydra.core.sorting" "hydra.core.substitution" "hydra.core.templates" "hydra.core.unification"
   "hydra.core.validate.model" "hydra.core.validate.packaging" "hydra.core.variables"
   "hydra.core.decode.paths" "hydra.core.decode.ast" "hydra.core.decode.classes"
   "hydra.core.decode.coders" "hydra.core.decode.model"
   "hydra.core.decode.errors" "hydra.core.decode.error.checking" "hydra.core.decode.error.model"
   "hydra.core.decode.json.model" "hydra.core.decode.packaging" "hydra.core.decode.parsing"
   "hydra.core.decode.query" "hydra.core.decode.relational"
   "hydra.core.decode.tabular" "hydra.core.decode.testing" "hydra.core.decode.topology"
   "hydra.core.decode.typed" "hydra.core.decode.typing" "hydra.core.decode.util" "hydra.core.decode.variants"
   "hydra.core.encode.paths" "hydra.core.encode.ast" "hydra.core.encode.classes"
   "hydra.core.encode.coders" "hydra.core.encode.model"
   "hydra.core.encode.errors" "hydra.core.encode.error.checking" "hydra.core.encode.error.model"
   "hydra.core.encode.json.model" "hydra.core.encode.packaging" "hydra.core.encode.parsing"
   "hydra.core.encode.query" "hydra.core.encode.relational"
   "hydra.core.encode.tabular" "hydra.core.encode.testing" "hydra.core.encode.topology"
   "hydra.core.encode.typed" "hydra.core.encode.typing" "hydra.core.encode.util" "hydra.core.encode.variants"
   ...
   "hydra.core.test.lib.eithers" "hydra.core.test.lib.equality" "hydra.core.test.lib.lists"
   "hydra.core.test.lib.literals" "hydra.core.test.lib.logic" "hydra.core.test.lib.maps"
   "hydra.core.test.lib.math" "hydra.core.test.lib.optionals" "hydra.core.test.lib.pairs"
   "hydra.core.test.lib.regex" "hydra.core.test.lib.sets" "hydra.core.test.lib.strings"
   "hydra.core.test.hoisting.all" "hydra.core.test.hoisting.cases" "hydra.core.test.hoisting.let"
   "hydra.core.test.annotations" "hydra.core.test.dependencies" "hydra.core.test.differentiation"
   "hydra.core.test.etaExpansion" "hydra.core.test.formatting" "hydra.core.test.generation"
   "hydra.core.test.json.roundtrip" "hydra.core.test.json.writer" "hydra.core.test.json.yaml"
   "hydra.core.test.reduction" "hydra.core.test.rewriting" "hydra.core.test.serialization"
   "hydra.core.test.sorting" "hydra.core.test.strip" "hydra.core.test.variables"
   "hydra.core.test.checking.all" "hydra.core.test.checking.advanced"
   "hydra.core.test.checking.algebraicTypes" "hydra.core.test.checking.collections"
   "hydra.core.test.checking.failures" "hydra.core.test.checking.fundamentals"
   "hydra.core.test.checking.nominalTypes" "hydra.core.test.inference.all"
   "hydra.core.test.inference.algebraicTypes" "hydra.core.test.inference.algorithmW"
   "hydra.core.test.inference.classes" "hydra.core.test.inference.failures"
   "hydra.core.test.inference.fundamentals" "hydra.core.test.inference.kernelExamples"
   "hydra.core.test.inference.nominalTypes" "hydra.core.test.substitution"
   "hydra.core.test.unification" "hydra.core.test.validate.all" "hydra.core.test.validate.model"])
...
(def ^:private gen-main-load-order
  ...
  (delay (topo-sort (vec (remove #(.startsWith ^String % "hydra.core.test.") gen-ns-names)))))
...
(def ^:private gen-test-load-order
  "Generated test namespaces in topological dependency order, computed at load
   ...
   earlier by load-gen-main!. hydra.core.test.testEnv is in the manifest but not
   generated as a Clojure file (empty wrapper), so it is filtered out."
  (delay
    (topo-sort
      (vec (filter (fn [^String n]
                     (and (.startsWith n "hydra.core.test.")
                          (not= n "hydra.core.test.testEnv")))
                   gen-ns-names)))))
