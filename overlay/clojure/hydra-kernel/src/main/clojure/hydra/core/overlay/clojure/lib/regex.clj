(ns hydra.core.overlay.clojure.lib.regex
  (:import [java.util.regex Pattern Matcher])
  (:require [hydra.core.parse.regex :refer :all]
            [hydra.core.print.pcre.regex :refer :all]))
...
;; hydra.core.print.pcre.regex (Clojure regexes are java.util.regex, PCRE-like), before handing the
