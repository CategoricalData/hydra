(ns hydra.core.overlay.clojure.lib.files
  (:require [hydra.core.file :refer :all]
            [hydra.core.time :refer :all])
...
;; Clojure implementations of hydra.core.lib.files primitives (#494).
;;
...
;;                   Clojure target's binary representation (see hydra.core.overlay.clojure.lib.literals).
...
;; Classify a raw st_mode int (from the "unix:*" attribute view) into a hydra.core.file.FileType.
