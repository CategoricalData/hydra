(ns hydra.overlay.clojure.preload
...
(def ^:private lib-ns-names
  ...
  ["hydra.overlay.clojure.lib.chars" "hydra.overlay.clojure.lib.effects" "hydra.overlay.clojure.lib.eithers"
   "hydra.overlay.clojure.lib.equality" "hydra.overlay.clojure.lib.files" "hydra.overlay.clojure.lib.functions"
   ...
   "hydra.overlay.clojure.lib.ordering"
...
(def ^:private gen-ns-names
  ...
  ["hydra.paths" "hydra.ast" "hydra.classes" "hydra.coders"   "hydra.core" "hydra.error.checking" "hydra.error.core" "hydra.error.packaging"
   ...
   "hydra.print.paths" "hydra.print.core" "hydra.print.errors" "hydra.print.error.core"
   "hydra.print.graph" "hydra.print.variants" "hydra.print.typing" "hydra.print.util"
...
(defn coder-load-order
  "Walk the :require closure of `root-ns-names` and return the transitive
   dependency set in topological order, omitting hydra.overlay.clojure.lib.* and hydra.eval.*
   ...
   #473: native primitive impls were relocated hydra.lib.* -> hydra.overlay.clojure.lib.*;
   the generated hydra.lib.* def-modules (PrimitiveDefinition data) are not part of
   the runtime require-closure, so only hydra.overlay.clojure.lib.* is skipped here."
  [root-ns-names]
  (let [skip? (fn [^String n]
                (or (.startsWith n "hydra.overlay.clojure.lib.")
