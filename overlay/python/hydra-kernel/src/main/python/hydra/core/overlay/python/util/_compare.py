...
``hydra.core.lib.ordering.compare`` primitive (via ``hydra.core.overlay.python.lib.ordering``)
...
# class object) to avoid importing hydra.core.model at module load time.
...
def compare(x: Any, y: Any) -> int:
    ...
    from hydra.core.overlay.python.dsl.python import Given, None_, Left, Right
