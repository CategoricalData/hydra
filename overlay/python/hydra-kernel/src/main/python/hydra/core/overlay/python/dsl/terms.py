...
import hydra.core.overlay.python.dsl.literals as lt
...
from hydra.core.overlay.python.dsl.python import FrozenDict, Optional, Given, None_, Left, Right
...
def constant(term: Term) -> Term:
    ...
    """
    return lambda_(hydra.core.constants.ignored_variable, term)
...
def first() -> Term:
    ...
    return primitive(Name("hydra.core.lib.pairs.first"))
...
def second() -> Term:
    ...
    return primitive(Name("hydra.core.lib.pairs.second"))
