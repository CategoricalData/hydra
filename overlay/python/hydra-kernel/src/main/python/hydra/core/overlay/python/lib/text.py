"""Python implementations of hydra.core.lib.text primitives.

UTF-8 codec primitives bridging Hydra strings and raw bytes (binary). These pair with
hydra.core.lib.files.readFile / writeFile, which are byte-oriented. For #494.
"""

from __future__ import annotations
from hydra.core.overlay.python.dsl.python import Either, Left, Right
