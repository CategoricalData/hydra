...
from hydra.core.model import Name, Term, Type
...
def deprecated(typ: Type) -> Type:
    ...
    return set_type_annotation(
        hydra.core.constants.key_deprecated,
...
def exclude(typ: Type) -> Type:
    ...
    return set_type_annotation(
        hydra.core.constants.key_exclude,
        Given(terms.boolean(True)),
        typ
    )
...
def preserve_field_name(typ: Type) -> Type:
    ...
    return set_type_annotation(
        hydra.core.constants.key_preserve_field_name,
        Given(terms.boolean(True)),
        typ
    )
...
def set_max_length(m: int, typ: Type) -> Type:
    ...
    return set_type_annotation(
        hydra.core.constants.key_max_length,
        Given(terms.int32(m)),
        typ
    )
...
def set_min_length(m: int, typ: Type) -> Type:
    ...
    return set_type_annotation(
        hydra.core.constants.key_min_length,
        Given(terms.int32(m)),
        typ
    )
...
# Core annotation functions - delegate to the generated hydra.core.annotations module
...
def set_term_annotation(key: Name, mvalue: Optional[Term], term: Term) -> Term:
    ...
    import hydra.core.annotations as _ann
    ...
    match desc:
        ...
        case Given(s):
            return set_term_annotation(
                hydra.core.constants.key_description,
