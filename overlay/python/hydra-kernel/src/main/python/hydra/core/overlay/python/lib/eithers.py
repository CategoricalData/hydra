"""Python implementations of hydra.core.lib.eithers primitives."""

from __future__ import annotations
from collections.abc import Callable
from typing import TypeVar
from hydra.core.overlay.python.dsl.python import Either, Left, Right, Optional, Given, NONE_, frozenlist
