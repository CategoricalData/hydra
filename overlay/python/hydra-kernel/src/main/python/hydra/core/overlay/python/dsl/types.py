...
import hydra.core.overlay.python.dsl.literal_types as lt
...
def use(b: Binding) -> Type:
    ...
    Example: use(name_binding)  # equivalent to variable("hydra.core.model.Name")
    """
...
def annot(ann, t: Type) -> Type:
    ...
    """
    from hydra.core.overlay.python.dsl.terms import annotation_map_as_term
...
def maybe(t: Typeable) -> Type:
    ...
    """
    return TypeOptional(_as_type(t))
