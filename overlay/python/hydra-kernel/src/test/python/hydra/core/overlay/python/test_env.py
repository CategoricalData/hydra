...
#
# The Python coder filters hydra.core.test.testEnv from emitted output (via
...
import hydra.core.overlay.python.lib.maps

# Test context: an empty InferenceContext value. Eager — no side effects beyond
# the InferenceContext constructor.
test_context = hydra.core.typing.InferenceContext(fresh_type_variable_count=0, trace=())
...
# hydra.core.test.test_graph, which imports this module). Both arguments are
