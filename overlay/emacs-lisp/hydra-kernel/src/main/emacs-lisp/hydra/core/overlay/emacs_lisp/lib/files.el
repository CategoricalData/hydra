...
;; Emacs Lisp implementations of hydra.core.lib.files primitives (#494).
;;
...
;; a (TICKS . HZ) cons, or a plain integer) -> hydra.core.time.Timespec. time-convert
