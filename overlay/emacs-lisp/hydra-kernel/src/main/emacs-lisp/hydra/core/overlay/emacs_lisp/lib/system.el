...
;; Emacs Lisp implementations of hydra.core.lib.system primitives (#498).
;;
...
;; getEnvironment :: effect<Map<EnvironmentVariable, string>>  (alist of (key . value), accepted by hydra.core.lib.maps)
