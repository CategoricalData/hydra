...
(defvar hydra_overlay_emacs_lisp_lib_strings_cons
  (lambda (c)
...
(defvar hydra_overlay_emacs_lisp_lib_strings_drop
  (lambda (n)
...
(defvar hydra_overlay_emacs_lisp_lib_strings_is_infix_of
  (lambda (needle)
...
(defvar hydra_overlay_emacs_lisp_lib_strings_is_prefix_of
  (lambda (prefix)
...
(defvar hydra_overlay_emacs_lisp_lib_strings_is_suffix_of
  (lambda (suffix)
...
;; length :: String -> Int
(defvar hydra_overlay_emacs_lisp_lib_strings_length
  (lambda (s)
...
;; null :: String -> Bool
(defvar hydra_overlay_emacs_lisp_lib_strings_is_empty
  (lambda (s)
    "Check whether a string is empty."
    (= (length s) 0)))

;; replicate :: Int -> String -> String
(defvar hydra_overlay_emacs_lisp_lib_strings_replicate
  (lambda (n)
...
(defvar hydra_overlay_emacs_lisp_lib_strings_split_on
  (lambda (sep)
...
;; words :: String -> [String]
(defvar hydra_overlay_emacs_lisp_lib_strings_words
  (lambda (s)
...
(provide 'hydra.core.lib.strings)
