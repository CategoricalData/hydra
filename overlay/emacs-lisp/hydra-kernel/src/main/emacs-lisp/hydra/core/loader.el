...
(defvar hydra-build-gen-test-dir nil
  "Directory containing hydra-build's generated test modules (hydra.core.test.build.*).")
...
package's generated modules with the same ordering/exclusion rules."
  (let* ((base (or main-dir hydra-gen-main-dir))
         ...
         (remaining (cl-remove-if (lambda (f) (or (member f hydra-gen-main-file-order)
                                                   ...
                                                   ;; (hydra.core.test.testEnv) lives at
...
(dolist (f '("overlay/emacs_lisp/lib/chars.el" "overlay/emacs_lisp/lib/effects.el"
             ...
             "overlay/emacs_lisp/lib/functions.el"
             "overlay/emacs_lisp/lib/hashing.el"
             ...
             "overlay/emacs_lisp/lib/optionals.el" "overlay/emacs_lisp/lib/ordering.el"
             "overlay/emacs_lisp/lib/pairs.el"
