...
(defun tc-term ()
  (make-hydra_graph_term_coder (list :variable "hydra.core.model.Term")
    (lambda (_cx) (lambda (_g) (lambda (t_) (list :right t_))))
    (lambda (_cx) (lambda (t_) (list :right t_)))))
...
(defun tc-comparison ()
  (make-hydra_graph_term_coder (list :variable "hydra.core.util.Comparison")
    (lambda (cx) (lambda (g) (lambda (t_)
    ...
    (lambda (_cx) (lambda (c)
      (let ((variant-name
        ...
        (list :right (list :inject (make-hydra_core_injection "hydra.core.util.Comparison"
