...
(defvar hydra_overlay_emacs_lisp_lib_equality_compare
  (lambda (a)
...
;; gt :: a -> a -> Bool
(defvar hydra_overlay_emacs_lisp_lib_equality_gt
  (lambda (a)
...
;; gte :: a -> a -> Bool
(defvar hydra_overlay_emacs_lisp_lib_equality_gte
  (lambda (a)
...
;; identity :: a -> a
(defvar hydra_overlay_emacs_lisp_lib_equality_identity
  (lambda (x)
    "Return a value unchanged."
    x))

;; lt :: a -> a -> Bool
(defvar hydra_overlay_emacs_lisp_lib_equality_lt
  (lambda (a)
...
;; lte :: a -> a -> Bool
(defvar hydra_overlay_emacs_lisp_lib_equality_lte
  (lambda (a)
...
;; max :: a -> a -> a
(defvar hydra_overlay_emacs_lisp_lib_equality_max
  (lambda (a)
...
;; min :: a -> a -> a
(defvar hydra_overlay_emacs_lisp_lib_equality_min
  (lambda (a)
