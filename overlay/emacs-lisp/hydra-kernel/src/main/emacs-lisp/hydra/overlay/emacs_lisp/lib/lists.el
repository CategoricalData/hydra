...
;; apply :: [a -> b] -> [a] -> [b]
(defvar hydra_overlay_emacs_lisp_lib_lists_apply
  (lambda (fs)
...
;; bind :: [a] -> (a -> [b]) -> [b]
(defvar hydra_overlay_emacs_lisp_lib_lists_bind
  (lambda (xs)
...
;; concat :: [[a]] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_concat
  (lambda (xss)
    "Concatenate a list of lists."
    (apply #'append xss)))

;; concat2 :: [a] -> [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_concat2
  (lambda (xs)
...
;; cons :: a -> [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_cons
  (lambda (x)
...
;; drop :: Int -> [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_drop
  (lambda (n)
...
(defvar hydra_overlay_emacs_lisp_lib_lists_drop_while
  (lambda (pred)
...
;; filter :: (a -> Bool) -> [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_filter
  (lambda (pred)
...
(defvar hydra_overlay_emacs_lisp_lib_lists_find
  (lambda (pred)
...
;; foldl :: (b -> a -> b) -> b -> [a] -> b
(defvar hydra_overlay_emacs_lisp_lib_lists_foldl
  (lambda (f)
...
;; foldr :: (a -> b -> b) -> b -> [a] -> b
(defvar hydra_overlay_emacs_lisp_lib_lists_foldr
  (lambda (f)
...
;; group :: [a] -> [[a]]
(defvar hydra_overlay_emacs_lisp_lib_lists_group
  (lambda (xs)
...
;; intersperse :: a -> [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_intersperse
  (lambda (sep)
...
;; length :: [a] -> Int
(defvar hydra_overlay_emacs_lisp_lib_lists_length
  (lambda (xs)
    "Get the length of a list."
    (length xs)))

;; map :: (a -> b) -> [a] -> [b]
(defvar hydra_overlay_emacs_lisp_lib_lists_map
  (lambda (f)
...
;; null :: [a] -> Bool
(defvar hydra_overlay_emacs_lisp_lib_lists_null
  (lambda (xs)
    "Check if a list is empty."
    (null xs)))

;; partition :: (a -> Bool) -> [a] -> Pair [a] [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_partition
  (lambda (pred)
...
;; reverse :: [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_reverse
  (lambda (xs)
    "Reverse a list."
    (reverse xs)))

;; singleton :: a -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_singleton
  (lambda (x)
    "Create a single-element list."
    (list x)))

;; sort :: [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_sort
  (lambda (xs)
    "Sort a list."
...
(defvar hydra_overlay_emacs_lisp_lib_lists_span
  (lambda (pred)
...
;; take :: Int -> [a] -> [a]
(defvar hydra_overlay_emacs_lisp_lib_lists_take
  (lambda (n)
...
(defvar hydra_overlay_emacs_lisp_lib_lists_transpose
  (lambda (xss)
    "Transpose a list of lists."
    (transpose-helper xss)))

;; uncons :: [a] -> Maybe (a, [a])
(defvar hydra_overlay_emacs_lisp_lib_lists_uncons
  (lambda (xs)
...
;; zip :: [a] -> [b] -> [Pair a b]
(defvar hydra_overlay_emacs_lisp_lib_lists_zip
  (lambda (xs)
...
(defvar hydra_overlay_emacs_lisp_lib_lists_zip_with
  (lambda (f)
