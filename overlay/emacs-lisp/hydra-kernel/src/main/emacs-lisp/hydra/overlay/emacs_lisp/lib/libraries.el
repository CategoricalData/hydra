...
(defun register-eithers ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_eithers_left)    (prim1 (prim-name hydra_lib_eithers_left)    hydra_overlay_emacs_lisp_lib_eithers_left    nil x (tc-either x y)))
      ...
      (cons (prim-name hydra_lib_eithers_right)   (prim1 (prim-name hydra_lib_eithers_right)   hydra_overlay_emacs_lisp_lib_eithers_right   nil y (tc-either x y)))
...
(defun register-lists ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_lists_is_empty)       (prim1 (prim-name hydra_lib_lists_is_empty)       hydra_overlay_emacs_lisp_lib_lists_is_empty       nil (tc-list a) (tc-boolean)))
  ...
  (let (
    ...
    (let ((map-kv (tc-map k v)))
      (list
        ...
        (cons (prim-name hydra_lib_maps_is_empty)           (prim1 (prim-name hydra_lib_maps_is_empty)   hydra_overlay_emacs_lisp_lib_maps_is_empty   nil map-kv (tc-boolean) ord-k))
...
(defun register-optionals ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_optionals_given)      (prim1 (prim-name hydra_lib_optionals_given)      hydra_overlay_emacs_lisp_lib_optionals_given      nil a (tc-optional a)))
  ...
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_pairs_pair)   (prim2 (prim-name hydra_lib_pairs_pair)
                                         hydra_overlay_emacs_lisp_lib_pairs_pair
                                         nil a b (tc-pair a b)))
...
(defun register-sets ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_sets_is_empty)         (prim1 (prim-name hydra_lib_sets_is_empty)     hydra_overlay_emacs_lisp_lib_sets_is_empty     nil (tc-set a) (tc-boolean) ord-a))
...
(defun register-strings ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_strings_is_empty)        (prim1 (prim-name hydra_lib_strings_is_empty)        hydra_overlay_emacs_lisp_lib_strings_is_empty        nil s b))
...
(defun register-literals ()
  (let (
    ...
    (append
      ...
      ;; Read primitives
      (list
        (cons (prim-name hydra_lib_literals_parse_bigint)   (prim1 (prim-name hydra_lib_literals_parse_bigint)   hydra_overlay_emacs_lisp_lib_literals_parse_bigint   nil s (tc-optional bi)))
        ...
        (cons (prim-name hydra_lib_literals_parse_decimal)  (prim1 (prim-name hydra_lib_literals_parse_decimal)  hydra_overlay_emacs_lisp_lib_literals_parse_decimal  nil s (tc-optional dec)))
        (cons (prim-name hydra_lib_literals_parse_float32)  (prim1 (prim-name hydra_lib_literals_parse_float32)  hydra_overlay_emacs_lisp_lib_literals_parse_float32  nil s (tc-optional f32)))
        (cons (prim-name hydra_lib_literals_parse_float64)  (prim1 (prim-name hydra_lib_literals_parse_float64)  hydra_overlay_emacs_lisp_lib_literals_parse_float64  nil s (tc-optional f64)))
        (cons (prim-name hydra_lib_literals_parse_int8)     (prim1 (prim-name hydra_lib_literals_parse_int8)     hydra_overlay_emacs_lisp_lib_literals_parse_int8     nil s (tc-optional i8)))
        (cons (prim-name hydra_lib_literals_parse_int16)    (prim1 (prim-name hydra_lib_literals_parse_int16)    hydra_overlay_emacs_lisp_lib_literals_parse_int16    nil s (tc-optional i16)))
        (cons (prim-name hydra_lib_literals_parse_int32)    (prim1 (prim-name hydra_lib_literals_parse_int32)    hydra_overlay_emacs_lisp_lib_literals_parse_int32    nil s (tc-optional i32)))
        (cons (prim-name hydra_lib_literals_parse_int64)    (prim1 (prim-name hydra_lib_literals_parse_int64)    hydra_overlay_emacs_lisp_lib_literals_parse_int64    nil s (tc-optional i64)))
        ...
        (cons (prim-name hydra_lib_literals_parse_uint8)    (prim1 (prim-name hydra_lib_literals_parse_uint8)    hydra_overlay_emacs_lisp_lib_literals_parse_uint8    nil s (tc-optional u8)))
        (cons (prim-name hydra_lib_literals_parse_uint16)   (prim1 (prim-name hydra_lib_literals_parse_uint16)   hydra_overlay_emacs_lisp_lib_literals_parse_uint16   nil s (tc-optional u16)))
        (cons (prim-name hydra_lib_literals_parse_uint32)   (prim1 (prim-name hydra_lib_literals_parse_uint32)   hydra_overlay_emacs_lisp_lib_literals_parse_uint32   nil s (tc-optional u32)))
        (cons (prim-name hydra_lib_literals_parse_uint64)   (prim1 (prim-name hydra_lib_literals_parse_uint64)   hydra_overlay_emacs_lisp_lib_literals_parse_uint64   nil s (tc-optional u64))))
      ;; Show primitives
      (list
        (cons (prim-name hydra_lib_literals_print_bigint)   (prim1 (prim-name hydra_lib_literals_print_bigint)   hydra_overlay_emacs_lisp_lib_literals_print_bigint   nil bi s))
        ...
        (cons (prim-name hydra_lib_literals_print_decimal)  (prim1 (prim-name hydra_lib_literals_print_decimal)  hydra_overlay_emacs_lisp_lib_literals_print_decimal  nil dec s))
        (cons (prim-name hydra_lib_literals_print_float32)  (prim1 (prim-name hydra_lib_literals_print_float32)  hydra_overlay_emacs_lisp_lib_literals_print_float32  nil f32 s))
        (cons (prim-name hydra_lib_literals_print_float64)  (prim1 (prim-name hydra_lib_literals_print_float64)  hydra_overlay_emacs_lisp_lib_literals_print_float64  nil f64 s))
        (cons (prim-name hydra_lib_literals_print_int8)     (prim1 (prim-name hydra_lib_literals_print_int8)     hydra_overlay_emacs_lisp_lib_literals_print_int8     nil i8 s))
        (cons (prim-name hydra_lib_literals_print_int16)    (prim1 (prim-name hydra_lib_literals_print_int16)    hydra_overlay_emacs_lisp_lib_literals_print_int16    nil i16 s))
        (cons (prim-name hydra_lib_literals_print_int32)    (prim1 (prim-name hydra_lib_literals_print_int32)    hydra_overlay_emacs_lisp_lib_literals_print_int32    nil i32 s))
        (cons (prim-name hydra_lib_literals_print_int64)    (prim1 (prim-name hydra_lib_literals_print_int64)    hydra_overlay_emacs_lisp_lib_literals_print_int64    nil i64 s))
        (cons (prim-name hydra_lib_literals_print_uint8)    (prim1 (prim-name hydra_lib_literals_print_uint8)    hydra_overlay_emacs_lisp_lib_literals_print_uint8    nil u8 s))
        (cons (prim-name hydra_lib_literals_print_uint16)   (prim1 (prim-name hydra_lib_literals_print_uint16)   hydra_overlay_emacs_lisp_lib_literals_print_uint16   nil u16 s))
        (cons (prim-name hydra_lib_literals_print_uint32)   (prim1 (prim-name hydra_lib_literals_print_uint32)   hydra_overlay_emacs_lisp_lib_literals_print_uint32   nil u32 s))
        (cons (prim-name hydra_lib_literals_print_uint64)   (prim1 (prim-name hydra_lib_literals_print_uint64)   hydra_overlay_emacs_lisp_lib_literals_print_uint64   nil u64 s))
  ...
  (let ((a (tc-variable "a"))
    ...
    (delq nil
      (list
        ...
        (unless (member (prim-name hydra_lib_equality_not_equal) already-native)
        ...
        (unless (member (prim-name hydra_lib_functions_const) already-native)
        ...
        (unless (member (prim-name hydra_lib_functions_flip) already-native)
