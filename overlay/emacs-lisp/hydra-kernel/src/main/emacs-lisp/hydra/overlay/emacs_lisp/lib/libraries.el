    ...
    (let ((eff (lambda (c) (tc-effect c))))
      (list
        ...
        (cons (prim-name hydra_lib_effects_foldl)        (prim3 (prim-name hydra_lib_effects_foldl)
                                                   hydra_overlay_emacs_lisp_lib_effects_foldl
  ...
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_eithers_foldl)   (prim3 (prim-name hydra_lib_eithers_foldl)
                                          hydra_overlay_emacs_lisp_lib_eithers_foldl
                                          nil (fun x (fun y (tc-either z x))) x (tc-list y) (tc-either z x)))
      (cons (prim-name hydra_lib_eithers_from_left)  (prim2 (prim-name hydra_lib_eithers_from_left)
                                            hydra_overlay_emacs_lisp_lib_eithers_from_left
                                            nil x (tc-either x y) x))
      (cons (prim-name hydra_lib_eithers_from_right) (prim2 (prim-name hydra_lib_eithers_from_right)
                                            hydra_overlay_emacs_lisp_lib_eithers_from_right
      ...
      (cons (prim-name hydra_lib_eithers_partition_eithers) (prim1 (prim-name hydra_lib_eithers_partition_eithers)
                                                   hydra_overlay_emacs_lisp_lib_eithers_partition_eithers
...
(defun register-equality ()
  (let (
        ...
        (eq-x '(("x" . ("equality")))))
    (list
      (cons (prim-name hydra_lib_equality_compare)  (prim2 (prim-name hydra_lib_equality_compare)  hydra_overlay_emacs_lisp_lib_equality_compare  nil x x (tc-comparison) ord-x))
      ...
      (cons (prim-name hydra_lib_equality_gt)       (prim2 (prim-name hydra_lib_equality_gt)       hydra_overlay_emacs_lisp_lib_equality_gt       nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_equality_gte)      (prim2 (prim-name hydra_lib_equality_gte)      hydra_overlay_emacs_lisp_lib_equality_gte      nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_equality_identity) (prim1 (prim-name hydra_lib_equality_identity) #'identity                 nil x x))
      (cons (prim-name hydra_lib_equality_lt)       (prim2 (prim-name hydra_lib_equality_lt)       hydra_overlay_emacs_lisp_lib_equality_lt       nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_equality_lte)      (prim2 (prim-name hydra_lib_equality_lte)      hydra_overlay_emacs_lisp_lib_equality_lte      nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_equality_max)      (prim2 (prim-name hydra_lib_equality_max)      hydra_overlay_emacs_lisp_lib_equality_max      nil x x x ord-x))
      (cons (prim-name hydra_lib_equality_min)      (prim2 (prim-name hydra_lib_equality_min)      hydra_overlay_emacs_lisp_lib_equality_min      nil x x x ord-x)))))
  ...
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_lists_elem)       (prim2 (prim-name hydra_lib_lists_elem)
                                              hydra_overlay_emacs_lisp_lib_lists_elem
      ...
      (cons (prim-name hydra_lib_lists_intercalate) (prim2 (prim-name hydra_lib_lists_intercalate)
                                               hydra_overlay_emacs_lisp_lib_lists_intercalate
      ...
      (cons (prim-name hydra_lib_lists_maybe_at)    (prim2 (prim-name hydra_lib_lists_maybe_at)    hydra_overlay_emacs_lisp_lib_lists_maybe_at   nil (tc-int32) (tc-list a) (tc-optional a)))
      (cons (prim-name hydra_lib_lists_maybe_head)  (prim1 (prim-name hydra_lib_lists_maybe_head)  hydra_overlay_emacs_lisp_lib_lists_maybe_head nil (tc-list a) (tc-optional a)))
      (cons (prim-name hydra_lib_lists_maybe_init)  (prim1 (prim-name hydra_lib_lists_maybe_init)  hydra_overlay_emacs_lisp_lib_lists_maybe_init nil (tc-list a) (tc-optional (tc-list a))))
      (cons (prim-name hydra_lib_lists_maybe_last)  (prim1 (prim-name hydra_lib_lists_maybe_last)  hydra_overlay_emacs_lisp_lib_lists_maybe_last nil (tc-list a) (tc-optional a)))
      (cons (prim-name hydra_lib_lists_maybe_tail)  (prim1 (prim-name hydra_lib_lists_maybe_tail)  hydra_overlay_emacs_lisp_lib_lists_maybe_tail nil (tc-list a) (tc-optional (tc-list a))))
      (cons (prim-name hydra_lib_lists_nub)        (prim1 (prim-name hydra_lib_lists_nub)        hydra_overlay_emacs_lisp_lib_lists_nub        nil (tc-list a) (tc-list a) '(("a" . ("equality")))))
      ...
      (cons (prim-name hydra_lib_lists_sort_on)     (prim2 (prim-name hydra_lib_lists_sort_on)
                                              hydra_overlay_emacs_lisp_lib_lists_sort_on
...
(defun register-logic ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_logic_if_else) (prim3 (prim-name hydra_lib_logic_if_else)
  ...
  (let (
    ...
    (let ((map-kv (tc-map k v)))
      (list
        ...
        (cons (prim-name hydra_lib_maps_find_with_default) (prim3 (prim-name hydra_lib_maps_find_with_default)
  ...
  (let (
    ...
    (append
      ...
      (list
        ...
        (cons (prim-name hydra_lib_math_max)    (prim2 (prim-name hydra_lib_math_max)    hydra_overlay_emacs_lisp_lib_math_max    nil i32 i32 i32))
        (cons (prim-name hydra_lib_math_maybe_div)  (prim2 (prim-name hydra_lib_math_maybe_div)  hydra_overlay_emacs_lisp_lib_math_maybe_div  nil i32 i32 (tc-optional i32)))
        (cons (prim-name hydra_lib_math_maybe_mod)  (prim2 (prim-name hydra_lib_math_maybe_mod)  hydra_overlay_emacs_lisp_lib_math_maybe_mod  nil i32 i32 (tc-optional i32)))
        (cons (prim-name hydra_lib_math_maybe_pred) (prim1 (prim-name hydra_lib_math_maybe_pred) hydra_overlay_emacs_lisp_lib_math_maybe_pred nil i32 (tc-optional i32)))
        (cons (prim-name hydra_lib_math_maybe_rem)  (prim2 (prim-name hydra_lib_math_maybe_rem)  hydra_overlay_emacs_lisp_lib_math_maybe_rem  nil i32 i32 (tc-optional i32)))
        (cons (prim-name hydra_lib_math_maybe_succ) (prim1 (prim-name hydra_lib_math_maybe_succ) hydra_overlay_emacs_lisp_lib_math_maybe_succ nil i32 (tc-optional i32)))
        (cons (prim-name hydra_lib_math_min)    (prim2 (prim-name hydra_lib_math_min)    hydra_overlay_emacs_lisp_lib_math_min    nil i32 i32 i32)))
      ;; Float64 primitives
      (list
...
(defun register-optionals ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_optionals_cases)    (prim3 (prim-name hydra_lib_optionals_cases)
                                           hydra_overlay_emacs_lisp_lib_optionals_cases
                                           nil (tc-optional a) b (fun a b) b))
      (cons (prim-name hydra_lib_optionals_cat)      (prim1 (prim-name hydra_lib_optionals_cat)      hydra_overlay_emacs_lisp_lib_optionals_cat      nil (tc-list (tc-optional a)) (tc-list a)))
      ...
      (cons (prim-name hydra_lib_optionals_from_optional) (prim2 (prim-name hydra_lib_optionals_from_optional)
                                            hydra_overlay_emacs_lisp_lib_optionals_from_optional
...
(defun register-strings ()
  (let (
        ...
        (b (tc-boolean)))
    (list
      (cons (prim-name hydra_lib_strings_cat)         (prim1 (prim-name hydra_lib_strings_cat)         hydra_overlay_emacs_lisp_lib_strings_cat         nil (tc-list s) s))
      (cons (prim-name hydra_lib_strings_cat2)        (prim2 (prim-name hydra_lib_strings_cat2)
                                               hydra_overlay_emacs_lisp_lib_strings_cat2
                                               nil s s s))
      ...
      (cons (prim-name hydra_lib_strings_intercalate) (prim2 (prim-name hydra_lib_strings_intercalate)
                                               hydra_overlay_emacs_lisp_lib_strings_intercalate
                                               nil s (tc-list s) s))
      ...
      (cons (prim-name hydra_lib_strings_maybe_char_at) (prim2 (prim-name hydra_lib_strings_maybe_char_at) hydra_overlay_emacs_lisp_lib_strings_maybe_char_at nil i s (tc-optional i)))
  ...
  (let (
    ...
    (append
      ...
      (list
        ...
        (cons (prim-name hydra_lib_literals_read_boolean)  (prim1 (prim-name hydra_lib_literals_read_boolean)  hydra_overlay_emacs_lisp_lib_literals_read_boolean  nil s (tc-optional b)))
        ...
        (cons (prim-name hydra_lib_literals_read_string)   (prim1 (prim-name hydra_lib_literals_read_string)   hydra_overlay_emacs_lisp_lib_literals_read_string   nil s (tc-optional s)))
      ...
      (list
        ...
        (cons (prim-name hydra_lib_literals_show_boolean)  (prim1 (prim-name hydra_lib_literals_show_boolean)  hydra_overlay_emacs_lisp_lib_literals_show_boolean  nil b s))
        ...
        (cons (prim-name hydra_lib_literals_show_string)   (prim1 (prim-name hydra_lib_literals_show_string)   hydra_overlay_emacs_lisp_lib_literals_show_string   nil s s))))))
