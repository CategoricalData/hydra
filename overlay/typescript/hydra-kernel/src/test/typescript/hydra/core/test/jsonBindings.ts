...
// (#729: 5 levels up from hydra/core/test/, then into the main tree's hydra/core/ namespace.)
import type { Name, Term, TypeScheme } from "../../../../../main/typescript/hydra/core/model.js";
import * as libMaps from "../../../../../main/typescript/hydra/core/overlay/typescript/lib/maps.js";
import * as libSets from "../../../../../main/typescript/hydra/core/overlay/typescript/lib/sets.js";
...
// union's own reflected schema from the loaded kernel JSON (hydra.core.model,
...
const convert = (j: unknown): unknown => {
  ...
  if (keys.length === 1 && UNION_ARMS.has(keys[0]!)) {
    ...
    // The runtime expects a [Term, Term] tuple so `hydra.core.lib.pairs.first(p)
    // = p[0]` works. (#443)
    if (armName === "pair"
    ...
    // derives this from the kernel's own reflected type schemas (hydra.core.model
  ...
  // hydra.core.model.Type's own `unit`/`void` union-arm field names) would no
...
// nominal types via the graph (e.g. `hydra.core.annotations.setAnnotation`
...
export const TYPE_NAMESPACES: readonly string[] = [
  ...
  "hydra.equality",
  "hydra.core.errors",
  "hydra.core.error.checking",
  "hydra.core.error.model",
  "hydra.core.error.packaging",
  "hydra.core.graph",
  "hydra.core.json.model",
  "hydra.json.parsing",
  "hydra.kv",
  "hydra.module",
  "hydra.core.packaging",
  "hydra.path",
  "hydra.core.testing",
  "hydra.tools",
  "hydra.core.util",
