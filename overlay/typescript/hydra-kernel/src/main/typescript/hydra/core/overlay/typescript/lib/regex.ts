// Hand-written runtime: hydra.core.lib.regex primitives.
//
...
// hydra.core.print.pcre.regex (ECMA-262 RegExp shares the byte-identical minimal-core rendering with
// PCRE), before handing the rendered pattern to the native engine. An ill-formed pattern (rejected
// by hydra.core.parse.regex) is treated as "no match" -- the same portable-failure convention as an empty
// match. See issue #603.
