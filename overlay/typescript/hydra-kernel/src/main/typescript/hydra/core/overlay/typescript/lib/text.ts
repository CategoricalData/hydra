// Hand-written runtime: hydra.core.lib.text primitives.
//
// UTF-8 codec primitives bridging Hydra strings and raw bytes (binary). These pair
// with hydra.core.lib.files.readFile / writeFile and hydra.core.lib.system (ProcessResult
...
// and Hydra.Core.Lib.Text. For #494/#507.
