// Hand-written runtime: hydra.core.lib.hashing primitives.
//
...
// as base64. Pure and total. Pairs with hydra.core.lib.files.readFile to hash file contents.
// Mirrors overlay/python/.../lib/hashing.py and Hydra.Core.Lib.Hashing. For #524.
