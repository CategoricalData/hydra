// Hand-written runtime: hydra.core.lib.files primitives.
//
...
// success is Right(value). Mirrors heads/python/.../lib/files.py and Hydra.Core.Lib.Files,
...
// from literals.ts / system.ts), pairing with hydra.core.lib.text.decodeUtf8. `FileError`,
