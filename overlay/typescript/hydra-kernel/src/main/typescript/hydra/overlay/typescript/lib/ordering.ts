...
//
// Ordered comparison over Hydra values. Like equality, ordering is structural;
// but the kernel test primitives often compare Term-encoded scalars, so we first
