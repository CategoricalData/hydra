(define-library (hydra overlay scheme lib hashing)
  ...
  (begin
    ...
    ;; Scheme (R7RS) implementations of hydra.core.lib.hashing primitives (#524).
    ;;
    ;; SHA-256 over raw bytes (binary). These pair with hydra.core.lib.files.readFile, which is
    ...
    ;;                   hydra.core.lib.literals binary representation. The helpers below convert to/from
