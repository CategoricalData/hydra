(define-library (hydra overlay scheme libraries)
  ...
  (begin
    ...
    (define (register-chars)
      (let ()
        (list
          (cons (prim-name def:hydra_lib_chars_is_alpha_num) (prim1 (prim-name def:hydra_lib_chars_is_alpha_num) hydra_overlay_scheme_lib_chars_is_alpha_num #f (tc-int32) (tc-boolean)))
          (cons (prim-name def:hydra_lib_chars_is_lower)    (prim1 (prim-name def:hydra_lib_chars_is_lower)    hydra_overlay_scheme_lib_chars_is_lower    #f (tc-int32) (tc-boolean)))
          (cons (prim-name def:hydra_lib_chars_is_space)    (prim1 (prim-name def:hydra_lib_chars_is_space)    hydra_overlay_scheme_lib_chars_is_space    #f (tc-int32) (tc-boolean)))
          (cons (prim-name def:hydra_lib_chars_is_upper)    (prim1 (prim-name def:hydra_lib_chars_is_upper)    hydra_overlay_scheme_lib_chars_is_upper    #f (tc-int32) (tc-boolean)))
          (cons (prim-name def:hydra_lib_chars_to_lower)    (prim1 (prim-name def:hydra_lib_chars_to_lower)    hydra_overlay_scheme_lib_chars_to_lower    #f (tc-int32) (tc-int32)))
          (cons (prim-name def:hydra_lib_chars_to_upper)    (prim1 (prim-name def:hydra_lib_chars_to_upper)    hydra_overlay_scheme_lib_chars_to_upper    #f (tc-int32) (tc-int32))))))
    ...
    (define (register-equality)
      (let (
        ...
        (list
          (cons (prim-name def:hydra_lib_equality_equal)    (prim2 (prim-name def:hydra_lib_equality_equal)    hydra_overlay_scheme_lib_equality_equal    #f x x (tc-boolean) eq-x)))))
    ...
    (define (register-ordering)
      (let (
        ...
        (list
          (cons (prim-name def:hydra_lib_ordering_compare)  (prim2 (prim-name def:hydra_lib_ordering_compare)  hydra_overlay_scheme_lib_ordering_compare  #f x x (tc-comparison) ord-x))
          (cons (prim-name def:hydra_lib_ordering_gt)       (prim2 (prim-name def:hydra_lib_ordering_gt)       hydra_overlay_scheme_lib_ordering_gt       #f x x (tc-boolean) ord-x))
          (cons (prim-name def:hydra_lib_ordering_gte)      (prim2 (prim-name def:hydra_lib_ordering_gte)      hydra_overlay_scheme_lib_ordering_gte      #f x x (tc-boolean) ord-x))
          (cons (prim-name def:hydra_lib_ordering_lt)       (prim2 (prim-name def:hydra_lib_ordering_lt)       hydra_overlay_scheme_lib_ordering_lt       #f x x (tc-boolean) ord-x))
          (cons (prim-name def:hydra_lib_ordering_lte)      (prim2 (prim-name def:hydra_lib_ordering_lte)      hydra_overlay_scheme_lib_ordering_lte      #f x x (tc-boolean) ord-x))
          (cons (prim-name def:hydra_lib_ordering_max)      (prim2 (prim-name def:hydra_lib_ordering_max)      hydra_overlay_scheme_lib_ordering_max      #f x x x ord-x))
          (cons (prim-name def:hydra_lib_ordering_min)      (prim2 (prim-name def:hydra_lib_ordering_min)      hydra_overlay_scheme_lib_ordering_min      #f x x x ord-x)))))
      ...
      (let (
        ...
        (let ((eff (lambda (c) (tc-effect c))))
          (list
            ...
            (cons (prim-name def:hydra_lib_files_copy) (prim3 (prim-name def:hydra_lib_files_copy)
      ...
      (let (
        ...
        (let ((eff (lambda (c) (tc-effect c))))
          (list
            ...
            (cons (prim-name def:hydra_lib_system_read_stdin) (prim0 (prim-name def:hydra_lib_system_read_stdin)
                                               (lambda () hydra_overlay_scheme_lib_system_read_stdin)
                                               #f (eff (tc-either serr bin))))
            (cons (prim-name def:hydra_lib_system_write_stderr) (prim1 (prim-name def:hydra_lib_system_write_stderr)
                                               hydra_overlay_scheme_lib_system_write_stderr
                                               #f bin (eff (tc-either serr unit))))
            (cons (prim-name def:hydra_lib_system_write_stdout) (prim1 (prim-name def:hydra_lib_system_write_stdout)
    ...
    (define (register-lists)
      (let (
        ...
        (list
          ...
          (cons (prim-name def:hydra_lib_lists_concat)     (prim1 (prim-name def:hydra_lib_lists_concat)     hydra_overlay_scheme_lib_lists_concat     #f (tc-list (tc-list a)) (tc-list a)))
          ...
          (cons (prim-name def:hydra_lib_lists_group)      (prim1 (prim-name def:hydra_lib_lists_group)      hydra_overlay_scheme_lib_lists_group      #f (tc-list a) (tc-list (tc-list a)) eq-a))
          ...
          (cons (prim-name def:hydra_lib_lists_intersperse) (prim2 (prim-name def:hydra_lib_lists_intersperse)
                                                  ...
                                                  #f a (tc-list a) (tc-list a)))
          (cons (prim-name def:hydra_lib_lists_length)     (prim1 (prim-name def:hydra_lib_lists_length)     hydra_overlay_scheme_lib_lists_length     #f (tc-list a) (tc-int32)))
          ...
          (cons (prim-name def:hydra_lib_lists_at)    (prim2 (prim-name def:hydra_lib_lists_at)    hydra_overlay_scheme_lib_lists_at   #f (tc-int32) (tc-list a) (tc-optional a)))
          (cons (prim-name def:hydra_lib_lists_head)  (prim1 (prim-name def:hydra_lib_lists_head)  hydra_overlay_scheme_lib_lists_head #f (tc-list a) (tc-optional a)))
          (cons (prim-name def:hydra_lib_lists_init)  (prim1 (prim-name def:hydra_lib_lists_init)  hydra_overlay_scheme_lib_lists_init #f (tc-list a) (tc-optional (tc-list a))))
          ...
          (cons (prim-name def:hydra_lib_lists_reverse)    (prim1 (prim-name def:hydra_lib_lists_reverse)    hydra_overlay_scheme_lib_lists_reverse    #f (tc-list a) (tc-list a)))
          (cons (prim-name def:hydra_lib_lists_singleton)  (prim1 (prim-name def:hydra_lib_lists_singleton)  hydra_overlay_scheme_lib_lists_singleton  #f a (tc-list a)))
          (cons (prim-name def:hydra_lib_lists_sort)       (prim1 (prim-name def:hydra_lib_lists_sort)       hydra_overlay_scheme_lib_lists_sort       #f (tc-list a) (tc-list a) ord-a))
          ...
          (cons (prim-name def:hydra_lib_lists_take)       (prim2 (prim-name def:hydra_lib_lists_take)
                                                 ...
                                                 #f (tc-int32) (tc-list a) (tc-list a)))
          (cons (prim-name def:hydra_lib_lists_transpose)  (prim1 (prim-name def:hydra_lib_lists_transpose)  hydra_overlay_scheme_lib_lists_transpose  #f (tc-list (tc-list a)) (tc-list (tc-list a))))
          (cons (prim-name def:hydra_lib_lists_uncons)     (prim1 (prim-name def:hydra_lib_lists_uncons)     hydra_overlay_scheme_lib_lists_uncons     #f (tc-list a) (tc-optional (tc-pair a (tc-list a)))))
    ...
    (define (register-logic)
      (let (
        ...
        (list
          ...
          (cons (prim-name def:hydra_lib_logic_if_else) (lazy-args '(1 2) (prim3 (prim-name def:hydra_lib_logic_if_else)
                                            hydra_overlay_scheme_lib_logic_if_else
                                            #f (tc-boolean) a a a)))
          (cons (prim-name def:hydra_lib_logic_not)    (prim1 (prim-name def:hydra_lib_logic_not)    hydra_overlay_scheme_lib_logic_not #f (tc-boolean) (tc-boolean)))
      ...
      (let (
        ...
        (let ((map-kv (tc-map k v)))
          (list
            ...
            (cons (prim-name def:hydra_lib_maps_elems)          (prim1 (prim-name def:hydra_lib_maps_elems)  hydra_overlay_scheme_lib_maps_elems  #f map-kv (tc-list v) ord-k))
            (cons (prim-name def:hydra_lib_maps_empty)          (prim0 (prim-name def:hydra_lib_maps_empty)  (lambda () hydra_overlay_scheme_lib_maps_empty)  #f map-kv ord-k))
            ...
            (cons (prim-name def:hydra_lib_maps_find_with_default) (lazy-args '(0) (prim3 (prim-name def:hydra_lib_maps_find_with_default)
                                                       hydra_overlay_scheme_lib_maps_find_with_default
                                                       #f v k map-kv v ord-k)))
            (cons (prim-name def:hydra_lib_maps_from_list)       (prim1 (prim-name def:hydra_lib_maps_from_list) hydra_overlay_scheme_lib_maps_from_list #f (tc-list (tc-pair k v)) map-kv ord-k))
            ...
            (cons (prim-name def:hydra_lib_maps_keys)           (prim1 (prim-name def:hydra_lib_maps_keys)   hydra_overlay_scheme_lib_maps_keys   #f map-kv (tc-list k) ord-k))
            ...
            (cons (prim-name def:hydra_lib_maps_singleton)      (prim2 (prim-name def:hydra_lib_maps_singleton)
                                                      ...
                                                      #f k v map-kv ord-k))
            (cons (prim-name def:hydra_lib_maps_size)           (prim1 (prim-name def:hydra_lib_maps_size)   hydra_overlay_scheme_lib_maps_size   #f map-kv (tc-int32) ord-k))
            (cons (prim-name def:hydra_lib_maps_to_list)         (prim1 (prim-name def:hydra_lib_maps_to_list) hydra_overlay_scheme_lib_maps_to_list #f map-kv (tc-list (tc-pair k v)) ord-k))
    ...
    (define (register-math)
      (let (
        ...
        (append
          ...
          (list
            (cons (prim-name def:hydra_lib_math_abs)    (prim1 (prim-name def:hydra_lib_math_abs)    hydra_overlay_scheme_lib_math_abs    #f x x numeric-x))
            (cons (prim-name def:hydra_lib_math_add)    (prim2 (prim-name def:hydra_lib_math_add)    hydra_overlay_scheme_lib_math_add    #f x x x numeric-x))
            (cons (prim-name def:hydra_lib_math_mul)    (prim2 (prim-name def:hydra_lib_math_mul)    hydra_overlay_scheme_lib_math_mul    #f x x x numeric-x))
            (cons (prim-name def:hydra_lib_math_negate) (prim1 (prim-name def:hydra_lib_math_negate) hydra_overlay_scheme_lib_math_negate #f x x numeric-x))
            (cons (prim-name def:hydra_lib_math_signum) (prim1 (prim-name def:hydra_lib_math_signum) hydra_overlay_scheme_lib_math_signum #f x x numeric-x))
            (cons (prim-name def:hydra_lib_math_sub)    (prim2 (prim-name def:hydra_lib_math_sub)    hydra_overlay_scheme_lib_math_sub    #f x x x numeric-x))
            (cons (prim-name def:hydra_lib_math_range)  (prim2 (prim-name def:hydra_lib_math_range)  hydra_overlay_scheme_lib_math_range  #f i32 i32 (tc-list i32))))
          ;; Constraint-polymorphic ('integral') primitives
          (list
            (cons (prim-name def:hydra_lib_math_even)   (prim1 (prim-name def:hydra_lib_math_even)   hydra_overlay_scheme_lib_math_even   #f x b integral-x))
            (cons (prim-name def:hydra_lib_math_odd)    (prim1 (prim-name def:hydra_lib_math_odd)    hydra_overlay_scheme_lib_math_odd    #f x b integral-x))
            (cons (prim-name def:hydra_lib_math_div)  (prim2 (prim-name def:hydra_lib_math_div)  hydra_overlay_scheme_lib_math_div  #f x x (tc-optional x) integral-x))
            (cons (prim-name def:hydra_lib_math_mod)  (prim2 (prim-name def:hydra_lib_math_mod)  hydra_overlay_scheme_lib_math_mod  #f x x (tc-optional x) integral-x))
            (cons (prim-name def:hydra_lib_math_rem)  (prim2 (prim-name def:hydra_lib_math_rem)  hydra_overlay_scheme_lib_math_rem  #f x x (tc-optional x) integral-x)))
          ;; Constraint-polymorphic ('fractional') primitives
          (list
            (cons (prim-name def:hydra_lib_math_divide) (prim2 (prim-name def:hydra_lib_math_divide) hydra_overlay_scheme_lib_math_divide #f x x x fractional-x)))
          (list
            (cons (prim-name def:hydra_lib_math_acos)     (prim1 (prim-name def:hydra_lib_math_acos)     hydra_overlay_scheme_lib_math_acos     #f f64 f64))
            (cons (prim-name def:hydra_lib_math_acosh)    (prim1 (prim-name def:hydra_lib_math_acosh)    hydra_overlay_scheme_lib_math_acosh    #f f64 f64))
            (cons (prim-name def:hydra_lib_math_add_float64) (prim2 (prim-name def:hydra_lib_math_add_float64) hydra_overlay_scheme_lib_math_add_float64 #f f64 f64 f64))
            (cons (prim-name def:hydra_lib_math_asin)     (prim1 (prim-name def:hydra_lib_math_asin)     hydra_overlay_scheme_lib_math_asin     #f f64 f64))
            (cons (prim-name def:hydra_lib_math_asinh)    (prim1 (prim-name def:hydra_lib_math_asinh)    hydra_overlay_scheme_lib_math_asinh    #f f64 f64))
            (cons (prim-name def:hydra_lib_math_atan)     (prim1 (prim-name def:hydra_lib_math_atan)     hydra_overlay_scheme_lib_math_atan     #f f64 f64))
            (cons (prim-name def:hydra_lib_math_atan2)    (prim2 (prim-name def:hydra_lib_math_atan2)    hydra_overlay_scheme_lib_math_atan2    #f f64 f64 f64))
            (cons (prim-name def:hydra_lib_math_atanh)    (prim1 (prim-name def:hydra_lib_math_atanh)    hydra_overlay_scheme_lib_math_atanh    #f f64 f64))
            (cons (prim-name def:hydra_lib_math_ceiling)  (prim1 (prim-name def:hydra_lib_math_ceiling)  hydra_overlay_scheme_lib_math_ceiling  #f f64 f64))
            (cons (prim-name def:hydra_lib_math_cos)      (prim1 (prim-name def:hydra_lib_math_cos)      hydra_overlay_scheme_lib_math_cos      #f f64 f64))
            (cons (prim-name def:hydra_lib_math_cosh)     (prim1 (prim-name def:hydra_lib_math_cosh)     hydra_overlay_scheme_lib_math_cosh     #f f64 f64))
            (cons (prim-name def:hydra_lib_math_e)        (prim0 (prim-name def:hydra_lib_math_e)        (lambda () hydra_overlay_scheme_lib_math_e)        #f f64))
            (cons (prim-name def:hydra_lib_math_exp)      (prim1 (prim-name def:hydra_lib_math_exp)      hydra_overlay_scheme_lib_math_exp      #f f64 f64))
            (cons (prim-name def:hydra_lib_math_floor)    (prim1 (prim-name def:hydra_lib_math_floor)    hydra_overlay_scheme_lib_math_floor    #f f64 f64))
            (cons (prim-name def:hydra_lib_math_log)      (prim1 (prim-name def:hydra_lib_math_log)      hydra_overlay_scheme_lib_math_log      #f f64 f64))
            (cons (prim-name def:hydra_lib_math_log_base)  (prim2 (prim-name def:hydra_lib_math_log_base)  hydra_overlay_scheme_lib_math_log_base #f f64 f64 f64))
            (cons (prim-name def:hydra_lib_math_mul_float64) (prim2 (prim-name def:hydra_lib_math_mul_float64) hydra_overlay_scheme_lib_math_mul_float64 #f f64 f64 f64))
            (cons (prim-name def:hydra_lib_math_negate_float64) (prim1 (prim-name def:hydra_lib_math_negate_float64) hydra_overlay_scheme_lib_math_negate_float64 #f f64 f64))
            (cons (prim-name def:hydra_lib_math_pi)       (prim0 (prim-name def:hydra_lib_math_pi)       (lambda () hydra_overlay_scheme_lib_math_pi)       #f f64))
            (cons (prim-name def:hydra_lib_math_pow)      (prim2 (prim-name def:hydra_lib_math_pow)      hydra_overlay_scheme_lib_math_pow      #f f64 f64 f64))
            (cons (prim-name def:hydra_lib_math_round)    (prim1 (prim-name def:hydra_lib_math_round)    hydra_overlay_scheme_lib_math_round    #f f64 f64))
            (cons (prim-name def:hydra_lib_math_round_float32)  (prim2 (prim-name def:hydra_lib_math_round_float32)  hydra_overlay_scheme_lib_math_round_float32  #f i32 f32 f32))
            (cons (prim-name def:hydra_lib_math_round_float64)  (prim2 (prim-name def:hydra_lib_math_round_float64)  hydra_overlay_scheme_lib_math_round_float64  #f i32 f64 f64))
            (cons (prim-name def:hydra_lib_math_sin)      (prim1 (prim-name def:hydra_lib_math_sin)      hydra_overlay_scheme_lib_math_sin      #f f64 f64))
            (cons (prim-name def:hydra_lib_math_sinh)     (prim1 (prim-name def:hydra_lib_math_sinh)     hydra_overlay_scheme_lib_math_sinh     #f f64 f64))
            (cons (prim-name def:hydra_lib_math_sqrt)     (prim1 (prim-name def:hydra_lib_math_sqrt)     hydra_overlay_scheme_lib_math_sqrt     #f f64 f64))
            (cons (prim-name def:hydra_lib_math_sub_float64) (prim2 (prim-name def:hydra_lib_math_sub_float64) hydra_overlay_scheme_lib_math_sub_float64 #f f64 f64 f64))
            (cons (prim-name def:hydra_lib_math_tan)      (prim1 (prim-name def:hydra_lib_math_tan)      hydra_overlay_scheme_lib_math_tan      #f f64 f64))
            (cons (prim-name def:hydra_lib_math_tanh)     (prim1 (prim-name def:hydra_lib_math_tanh)     hydra_overlay_scheme_lib_math_tanh     #f f64 f64))
            (cons (prim-name def:hydra_lib_math_truncate) (prim1 (prim-name def:hydra_lib_math_truncate) hydra_overlay_scheme_lib_math_truncate #f f64 f64))))))
      ...
      (let (
        ...
        (list
          ...
          (cons (prim-name def:hydra_lib_optionals_with_default) (lazy-args '(0) (prim2 (prim-name def:hydra_lib_optionals_with_default)
                                               ...
                                               #f a (tc-optional a) a)))
          (cons (prim-name def:hydra_lib_optionals_is_given)    (prim1 (prim-name def:hydra_lib_optionals_is_given)    hydra_overlay_scheme_lib_optionals_is_given    #f (tc-optional a) (tc-boolean)))
          (cons (prim-name def:hydra_lib_optionals_is_none) (prim1 (prim-name def:hydra_lib_optionals_is_none) hydra_overlay_scheme_lib_optionals_is_none #f (tc-optional a) (tc-boolean)))
    ...
    (define (register-sets)
      (let (
        ...
        (list
          ...
          (cons (prim-name def:hydra_lib_sets_empty)        (prim0 (prim-name def:hydra_lib_sets_empty)   (lambda () hydra_overlay_scheme_lib_sets_empty)   #f (tc-set a) ord-a))
          (cons (prim-name def:hydra_lib_sets_from_list)     (prim1 (prim-name def:hydra_lib_sets_from_list) hydra_overlay_scheme_lib_sets_from_list #f (tc-list a) (tc-set a) ord-a))
          ...
          (cons (prim-name def:hydra_lib_sets_union)        (prim2 (prim-name def:hydra_lib_sets_union)
                                                  ...
                                                  #f (tc-set a) (tc-set a) (tc-set a) ord-a))
          (cons (prim-name def:hydra_lib_sets_unions)       (prim1 (prim-name def:hydra_lib_sets_unions)   hydra_overlay_scheme_lib_sets_unions   #f (tc-list (tc-set a)) (tc-set a) ord-a)))))
    ...
    (define (register-strings)
      (let (
            ...
            (b (tc-boolean)))
        (list
          (cons (prim-name def:hydra_lib_strings_concat)         (prim1 (prim-name def:hydra_lib_strings_concat)         hydra_overlay_scheme_lib_strings_concat         #f (tc-list s) s))
          (cons (prim-name def:hydra_lib_strings_concat2)        (prim2 (prim-name def:hydra_lib_strings_concat2)
                                                  ...
                                                  #f s s s))
          (cons (prim-name def:hydra_lib_strings_from_list)    (prim1 (prim-name def:hydra_lib_strings_from_list)    hydra_overlay_scheme_lib_strings_from_list    #f (tc-list i) s))
    ...
    (define (register-literals)
      (let (
        ...
        (append
          (list
            (cons (prim-name def:hydra_lib_literals_bigint_to_decimal)    (prim1 (prim-name def:hydra_lib_literals_bigint_to_decimal)    hydra_overlay_scheme_lib_literals_bigint_to_decimal    #f bi dec))
            (cons (prim-name def:hydra_lib_literals_bigint_to_int8)       (prim1 (prim-name def:hydra_lib_literals_bigint_to_int8)       hydra_overlay_scheme_lib_literals_bigint_to_int8       #f bi i8))
            (cons (prim-name def:hydra_lib_literals_bigint_to_int16)      (prim1 (prim-name def:hydra_lib_literals_bigint_to_int16)      hydra_overlay_scheme_lib_literals_bigint_to_int16      #f bi i16))
            (cons (prim-name def:hydra_lib_literals_bigint_to_int32)      (prim1 (prim-name def:hydra_lib_literals_bigint_to_int32)      hydra_overlay_scheme_lib_literals_bigint_to_int32      #f bi i32))
            (cons (prim-name def:hydra_lib_literals_bigint_to_int64)      (prim1 (prim-name def:hydra_lib_literals_bigint_to_int64)      hydra_overlay_scheme_lib_literals_bigint_to_int64      #f bi i64))
            (cons (prim-name def:hydra_lib_literals_bigint_to_uint8)      (prim1 (prim-name def:hydra_lib_literals_bigint_to_uint8)      hydra_overlay_scheme_lib_literals_bigint_to_uint8      #f bi u8))
            (cons (prim-name def:hydra_lib_literals_bigint_to_uint16)     (prim1 (prim-name def:hydra_lib_literals_bigint_to_uint16)     hydra_overlay_scheme_lib_literals_bigint_to_uint16     #f bi u16))
            (cons (prim-name def:hydra_lib_literals_bigint_to_uint32)     (prim1 (prim-name def:hydra_lib_literals_bigint_to_uint32)     hydra_overlay_scheme_lib_literals_bigint_to_uint32     #f bi u32))
            (cons (prim-name def:hydra_lib_literals_bigint_to_uint64)     (prim1 (prim-name def:hydra_lib_literals_bigint_to_uint64)     hydra_overlay_scheme_lib_literals_bigint_to_uint64     #f bi u64))
            (cons (prim-name def:hydra_lib_literals_binary_to_bytes)      (prim1 (prim-name def:hydra_lib_literals_binary_to_bytes)      hydra_overlay_scheme_lib_literals_binary_to_bytes      #f bin (tc-list i32)))
            (cons (prim-name def:hydra_lib_literals_binary_to_base64)     (prim1 (prim-name def:hydra_lib_literals_binary_to_base64)     hydra_overlay_scheme_lib_literals_binary_to_base64     #f bin s))
            (cons (prim-name def:hydra_lib_literals_decimal_to_bigint)    (prim1 (prim-name def:hydra_lib_literals_decimal_to_bigint)    hydra_overlay_scheme_lib_literals_decimal_to_bigint    #f dec bi))
            (cons (prim-name def:hydra_lib_literals_decimal_to_float32)   (prim1 (prim-name def:hydra_lib_literals_decimal_to_float32)   hydra_overlay_scheme_lib_literals_decimal_to_float32   #f dec f32))
            (cons (prim-name def:hydra_lib_literals_decimal_to_float64)   (prim1 (prim-name def:hydra_lib_literals_decimal_to_float64)   hydra_overlay_scheme_lib_literals_decimal_to_float64   #f dec f64))
            (cons (prim-name def:hydra_lib_literals_float32_to_decimal)   (prim1 (prim-name def:hydra_lib_literals_float32_to_decimal)   hydra_overlay_scheme_lib_literals_float32_to_decimal   #f f32 dec))
            (cons (prim-name def:hydra_lib_literals_float32_to_float64)   (prim1 (prim-name def:hydra_lib_literals_float32_to_float64)   hydra_overlay_scheme_lib_literals_float32_to_float64   #f f32 f64))
            (cons (prim-name def:hydra_lib_literals_float64_to_decimal)   (prim1 (prim-name def:hydra_lib_literals_float64_to_decimal)   hydra_overlay_scheme_lib_literals_float64_to_decimal   #f f64 dec))
            (cons (prim-name def:hydra_lib_literals_float64_to_float32)   (prim1 (prim-name def:hydra_lib_literals_float64_to_float32)   hydra_overlay_scheme_lib_literals_float64_to_float32   #f f64 f32))
            (cons (prim-name def:hydra_lib_literals_int8_to_bigint)       (prim1 (prim-name def:hydra_lib_literals_int8_to_bigint)       hydra_overlay_scheme_lib_literals_int8_to_bigint       #f i8 bi))
            (cons (prim-name def:hydra_lib_literals_int16_to_bigint)      (prim1 (prim-name def:hydra_lib_literals_int16_to_bigint)      hydra_overlay_scheme_lib_literals_int16_to_bigint      #f i16 bi))
            (cons (prim-name def:hydra_lib_literals_int32_to_bigint)      (prim1 (prim-name def:hydra_lib_literals_int32_to_bigint)      hydra_overlay_scheme_lib_literals_int32_to_bigint      #f i32 bi))
            (cons (prim-name def:hydra_lib_literals_int64_to_bigint)      (prim1 (prim-name def:hydra_lib_literals_int64_to_bigint)      hydra_overlay_scheme_lib_literals_int64_to_bigint      #f i64 bi))
            (cons (prim-name def:hydra_lib_literals_uint8_to_bigint)      (prim1 (prim-name def:hydra_lib_literals_uint8_to_bigint)      hydra_overlay_scheme_lib_literals_uint8_to_bigint      #f u8 bi))
            (cons (prim-name def:hydra_lib_literals_uint16_to_bigint)     (prim1 (prim-name def:hydra_lib_literals_uint16_to_bigint)     hydra_overlay_scheme_lib_literals_uint16_to_bigint     #f u16 bi))
            (cons (prim-name def:hydra_lib_literals_uint32_to_bigint)     (prim1 (prim-name def:hydra_lib_literals_uint32_to_bigint)     hydra_overlay_scheme_lib_literals_uint32_to_bigint     #f u32 bi))
            (cons (prim-name def:hydra_lib_literals_uint64_to_bigint)     (prim1 (prim-name def:hydra_lib_literals_uint64_to_bigint)     hydra_overlay_scheme_lib_literals_uint64_to_bigint     #f u64 bi))
            (cons (prim-name def:hydra_lib_literals_base64_to_binary)     (prim1 (prim-name def:hydra_lib_literals_base64_to_binary)     hydra_overlay_scheme_lib_literals_base64_to_binary     #f s bin)))
          (list
            (cons (prim-name def:hydra_lib_literals_parse_bigint)   (prim1 (prim-name def:hydra_lib_literals_parse_bigint)   hydra_overlay_scheme_lib_literals_parse_bigint   #f s (tc-optional bi)))
            (cons (prim-name def:hydra_lib_literals_parse_boolean)  (prim1 (prim-name def:hydra_lib_literals_parse_boolean)  hydra_overlay_scheme_lib_literals_parse_boolean  #f s (tc-optional b)))
            (cons (prim-name def:hydra_lib_literals_parse_decimal)  (prim1 (prim-name def:hydra_lib_literals_parse_decimal)  hydra_overlay_scheme_lib_literals_parse_decimal  #f s (tc-optional dec)))
            (cons (prim-name def:hydra_lib_literals_parse_float32)  (prim1 (prim-name def:hydra_lib_literals_parse_float32)  hydra_overlay_scheme_lib_literals_parse_float32  #f s (tc-optional f32)))
            (cons (prim-name def:hydra_lib_literals_parse_float64)  (prim1 (prim-name def:hydra_lib_literals_parse_float64)  hydra_overlay_scheme_lib_literals_parse_float64  #f s (tc-optional f64)))
            (cons (prim-name def:hydra_lib_literals_parse_int8)     (prim1 (prim-name def:hydra_lib_literals_parse_int8)     hydra_overlay_scheme_lib_literals_parse_int8     #f s (tc-optional i8)))
            (cons (prim-name def:hydra_lib_literals_parse_int16)    (prim1 (prim-name def:hydra_lib_literals_parse_int16)    hydra_overlay_scheme_lib_literals_parse_int16    #f s (tc-optional i16)))
            (cons (prim-name def:hydra_lib_literals_parse_int32)    (prim1 (prim-name def:hydra_lib_literals_parse_int32)    hydra_overlay_scheme_lib_literals_parse_int32    #f s (tc-optional i32)))
            (cons (prim-name def:hydra_lib_literals_parse_int64)    (prim1 (prim-name def:hydra_lib_literals_parse_int64)    hydra_overlay_scheme_lib_literals_parse_int64    #f s (tc-optional i64)))
            (cons (prim-name def:hydra_lib_literals_parse_string)   (prim1 (prim-name def:hydra_lib_literals_parse_string)   hydra_overlay_scheme_lib_literals_parse_string   #f s (tc-optional s)))
            (cons (prim-name def:hydra_lib_literals_parse_uint8)    (prim1 (prim-name def:hydra_lib_literals_parse_uint8)    hydra_overlay_scheme_lib_literals_parse_uint8    #f s (tc-optional u8)))
            (cons (prim-name def:hydra_lib_literals_parse_uint16)   (prim1 (prim-name def:hydra_lib_literals_parse_uint16)   hydra_overlay_scheme_lib_literals_parse_uint16   #f s (tc-optional u16)))
            (cons (prim-name def:hydra_lib_literals_parse_uint32)   (prim1 (prim-name def:hydra_lib_literals_parse_uint32)   hydra_overlay_scheme_lib_literals_parse_uint32   #f s (tc-optional u32)))
            (cons (prim-name def:hydra_lib_literals_parse_uint64)   (prim1 (prim-name def:hydra_lib_literals_parse_uint64)   hydra_overlay_scheme_lib_literals_parse_uint64   #f s (tc-optional u64))))
          (list
            (cons (prim-name def:hydra_lib_literals_print_bigint)   (prim1 (prim-name def:hydra_lib_literals_print_bigint)   hydra_overlay_scheme_lib_literals_print_bigint   #f bi s))
            (cons (prim-name def:hydra_lib_literals_print_boolean)  (prim1 (prim-name def:hydra_lib_literals_print_boolean)  hydra_overlay_scheme_lib_literals_print_boolean  #f b s))
            (cons (prim-name def:hydra_lib_literals_print_decimal)  (prim1 (prim-name def:hydra_lib_literals_print_decimal)  hydra_overlay_scheme_lib_literals_print_decimal  #f dec s))
            (cons (prim-name def:hydra_lib_literals_print_float32)  (prim1 (prim-name def:hydra_lib_literals_print_float32)  hydra_overlay_scheme_lib_literals_print_float32  #f f32 s))
            (cons (prim-name def:hydra_lib_literals_print_float64)  (prim1 (prim-name def:hydra_lib_literals_print_float64)  hydra_overlay_scheme_lib_literals_print_float64  #f f64 s))
            (cons (prim-name def:hydra_lib_literals_print_int8)     (prim1 (prim-name def:hydra_lib_literals_print_int8)     hydra_overlay_scheme_lib_literals_print_int8     #f i8 s))
            (cons (prim-name def:hydra_lib_literals_print_int16)    (prim1 (prim-name def:hydra_lib_literals_print_int16)    hydra_overlay_scheme_lib_literals_print_int16    #f i16 s))
            (cons (prim-name def:hydra_lib_literals_print_int32)    (prim1 (prim-name def:hydra_lib_literals_print_int32)    hydra_overlay_scheme_lib_literals_print_int32    #f i32 s))
            (cons (prim-name def:hydra_lib_literals_print_int64)    (prim1 (prim-name def:hydra_lib_literals_print_int64)    hydra_overlay_scheme_lib_literals_print_int64    #f i64 s))
            (cons (prim-name def:hydra_lib_literals_print_uint8)    (prim1 (prim-name def:hydra_lib_literals_print_uint8)    hydra_overlay_scheme_lib_literals_print_uint8    #f u8 s))
            (cons (prim-name def:hydra_lib_literals_print_uint16)   (prim1 (prim-name def:hydra_lib_literals_print_uint16)   hydra_overlay_scheme_lib_literals_print_uint16   #f u16 s))
            (cons (prim-name def:hydra_lib_literals_print_uint32)   (prim1 (prim-name def:hydra_lib_literals_print_uint32)   hydra_overlay_scheme_lib_literals_print_uint32   #f u32 s))
            (cons (prim-name def:hydra_lib_literals_print_uint64)   (prim1 (prim-name def:hydra_lib_literals_print_uint64)   hydra_overlay_scheme_lib_literals_print_uint64   #f u64 s))
            (cons (prim-name def:hydra_lib_literals_print_string)   (prim1 (prim-name def:hydra_lib_literals_print_string)   hydra_overlay_scheme_lib_literals_print_string   #f s s))))))
