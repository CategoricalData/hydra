(define-library (hydra overlay scheme lib files)
  ...
  (begin
    ...
    ;; Scheme (R7RS) implementations of hydra.core.lib.files primitives (#494).
    ;;
    ...
    ;;                   hydra.core.lib.literals binary representation. Helpers below also accept a
    ...
    ;; too, mirroring the polymorphic normalization in hydra.core.lib.literals.
    ...
    ;; note in hydra.core.overlay.scheme.lib.system), so FileStatus is built by eval'ing the constructor
    ...
    ;; rationale in hydra.core.overlay.scheme.lib.system (bootstrap.scm flat-loads into
    ...
    ;; POSIX stat type symbol -> hydra.core.file.FileType union value.
