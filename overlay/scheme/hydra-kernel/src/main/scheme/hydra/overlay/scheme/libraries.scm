    ...
    (define (register-lists)
      (let (
        ...
        (list
          ...
          (cons (prim-name def:hydra_lib_lists_null)       (prim1 (prim-name def:hydra_lib_lists_null)       hydra_overlay_scheme_lib_lists_null       #f (tc-list a) (tc-boolean)))
      ...
      (let (
        ...
        (let ((map-kv (tc-map k v)))
          (list
            ...
            (cons (prim-name def:hydra_lib_maps_null)           (prim1 (prim-name def:hydra_lib_maps_null)   hydra_overlay_scheme_lib_maps_null   #f map-kv (tc-boolean) ord-k))
    ...
    (define (register-sets)
      (let (
        ...
        (list
          ...
          (cons (prim-name def:hydra_lib_sets_null)         (prim1 (prim-name def:hydra_lib_sets_null)     hydra_overlay_scheme_lib_sets_null     #f (tc-set a) (tc-boolean) ord-a))
    ...
    (define (register-literals)
      (let (
        ...
        (append
          ...
          (list
            (cons (prim-name def:hydra_lib_literals_read_bigint)   (prim1 (prim-name def:hydra_lib_literals_read_bigint)   hydra_overlay_scheme_lib_literals_read_bigint   #f s (tc-optional bi)))
            ...
            (cons (prim-name def:hydra_lib_literals_read_decimal)  (prim1 (prim-name def:hydra_lib_literals_read_decimal)  hydra_overlay_scheme_lib_literals_read_decimal  #f s (tc-optional dec)))
            (cons (prim-name def:hydra_lib_literals_read_float32)  (prim1 (prim-name def:hydra_lib_literals_read_float32)  hydra_overlay_scheme_lib_literals_read_float32  #f s (tc-optional f32)))
            (cons (prim-name def:hydra_lib_literals_read_float64)  (prim1 (prim-name def:hydra_lib_literals_read_float64)  hydra_overlay_scheme_lib_literals_read_float64  #f s (tc-optional f64)))
            (cons (prim-name def:hydra_lib_literals_read_int8)     (prim1 (prim-name def:hydra_lib_literals_read_int8)     hydra_overlay_scheme_lib_literals_read_int8     #f s (tc-optional i8)))
            (cons (prim-name def:hydra_lib_literals_read_int16)    (prim1 (prim-name def:hydra_lib_literals_read_int16)    hydra_overlay_scheme_lib_literals_read_int16    #f s (tc-optional i16)))
            (cons (prim-name def:hydra_lib_literals_read_int32)    (prim1 (prim-name def:hydra_lib_literals_read_int32)    hydra_overlay_scheme_lib_literals_read_int32    #f s (tc-optional i32)))
            (cons (prim-name def:hydra_lib_literals_read_int64)    (prim1 (prim-name def:hydra_lib_literals_read_int64)    hydra_overlay_scheme_lib_literals_read_int64    #f s (tc-optional i64)))
            ...
            (cons (prim-name def:hydra_lib_literals_read_uint8)    (prim1 (prim-name def:hydra_lib_literals_read_uint8)    hydra_overlay_scheme_lib_literals_read_uint8    #f s (tc-optional u8)))
            (cons (prim-name def:hydra_lib_literals_read_uint16)   (prim1 (prim-name def:hydra_lib_literals_read_uint16)   hydra_overlay_scheme_lib_literals_read_uint16   #f s (tc-optional u16)))
            (cons (prim-name def:hydra_lib_literals_read_uint32)   (prim1 (prim-name def:hydra_lib_literals_read_uint32)   hydra_overlay_scheme_lib_literals_read_uint32   #f s (tc-optional u32)))
            (cons (prim-name def:hydra_lib_literals_read_uint64)   (prim1 (prim-name def:hydra_lib_literals_read_uint64)   hydra_overlay_scheme_lib_literals_read_uint64   #f s (tc-optional u64))))
          (list
            (cons (prim-name def:hydra_lib_literals_show_bigint)   (prim1 (prim-name def:hydra_lib_literals_show_bigint)   hydra_overlay_scheme_lib_literals_show_bigint   #f bi s))
            ...
            (cons (prim-name def:hydra_lib_literals_show_decimal)  (prim1 (prim-name def:hydra_lib_literals_show_decimal)  hydra_overlay_scheme_lib_literals_show_decimal  #f dec s))
            (cons (prim-name def:hydra_lib_literals_show_float32)  (prim1 (prim-name def:hydra_lib_literals_show_float32)  hydra_overlay_scheme_lib_literals_show_float32  #f f32 s))
            (cons (prim-name def:hydra_lib_literals_show_float64)  (prim1 (prim-name def:hydra_lib_literals_show_float64)  hydra_overlay_scheme_lib_literals_show_float64  #f f64 s))
            (cons (prim-name def:hydra_lib_literals_show_int8)     (prim1 (prim-name def:hydra_lib_literals_show_int8)     hydra_overlay_scheme_lib_literals_show_int8     #f i8 s))
            (cons (prim-name def:hydra_lib_literals_show_int16)    (prim1 (prim-name def:hydra_lib_literals_show_int16)    hydra_overlay_scheme_lib_literals_show_int16    #f i16 s))
            (cons (prim-name def:hydra_lib_literals_show_int32)    (prim1 (prim-name def:hydra_lib_literals_show_int32)    hydra_overlay_scheme_lib_literals_show_int32    #f i32 s))
            (cons (prim-name def:hydra_lib_literals_show_int64)    (prim1 (prim-name def:hydra_lib_literals_show_int64)    hydra_overlay_scheme_lib_literals_show_int64    #f i64 s))
            (cons (prim-name def:hydra_lib_literals_show_uint8)    (prim1 (prim-name def:hydra_lib_literals_show_uint8)    hydra_overlay_scheme_lib_literals_show_uint8    #f u8 s))
            (cons (prim-name def:hydra_lib_literals_show_uint16)   (prim1 (prim-name def:hydra_lib_literals_show_uint16)   hydra_overlay_scheme_lib_literals_show_uint16   #f u16 s))
            (cons (prim-name def:hydra_lib_literals_show_uint32)   (prim1 (prim-name def:hydra_lib_literals_show_uint32)   hydra_overlay_scheme_lib_literals_show_uint32   #f u32 s))
            (cons (prim-name def:hydra_lib_literals_show_uint64)   (prim1 (prim-name def:hydra_lib_literals_show_uint64)   hydra_overlay_scheme_lib_literals_show_uint64   #f u64 s))
