(define-library (hydra overlay scheme lib system)
  ;; The Scheme head is guile-based. Process execution, environment access, and the clock are not part
  ;; of R7RS, so they are taken from guile here (mirroring how hydra.core.overlay.scheme.lib.files takes directory
  ...
  (begin
    ...
    ;; Scheme (guile) implementations of hydra.core.lib.system primitives (#498).
    ;;
