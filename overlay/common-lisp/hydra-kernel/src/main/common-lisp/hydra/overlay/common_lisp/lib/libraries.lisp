...
(dolist (sub '("chars" "effects" "eithers" "equality" "files" "functions" "hashing" "lists" "literals"
               "logic" "maps" "math" "optionals" "ordering" "pairs" "regex" "sets" "strings" "system"
               "text"))
    ...
    (let ((eff (lambda (c) (tc-effect c))))
      (list
        ...
        (cons (prim-name hydra_lib_effects_fold_list)    (prim3 (prim-name hydra_lib_effects_fold_list)
                                                   hydra_overlay_common_lisp_lib_effects_fold_list
  ...
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_eithers_fold_list) (prim3 (prim-name hydra_lib_eithers_fold_list)
                                          hydra_overlay_common_lisp_lib_eithers_fold_list
...
;; ============================================================================
;; Functions (#417: identity moved from hydra.lib.equality)
;; ============================================================================
...
;; ============================================================================
;; Ordering (#417: compare/gt/gte/lt/lte/max/min moved from hydra.lib.equality)
;; ============================================================================
...
(defun register-ordering ()
  (let (
        ...
        (ord-x '(("x" . ("ordering")))))
    (list
      (cons (prim-name hydra_lib_ordering_compare)  (prim2 (prim-name hydra_lib_ordering_compare)  hydra_overlay_common_lisp_lib_ordering_compare  nil x x (tc-comparison) ord-x))
      (cons (prim-name hydra_lib_ordering_gt)       (prim2 (prim-name hydra_lib_ordering_gt)       hydra_overlay_common_lisp_lib_ordering_gt       nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_ordering_gte)      (prim2 (prim-name hydra_lib_ordering_gte)      hydra_overlay_common_lisp_lib_ordering_gte      nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_ordering_lt)       (prim2 (prim-name hydra_lib_ordering_lt)       hydra_overlay_common_lisp_lib_ordering_lt       nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_ordering_lte)      (prim2 (prim-name hydra_lib_ordering_lte)      hydra_overlay_common_lisp_lib_ordering_lte      nil x x (tc-boolean) ord-x))
      (cons (prim-name hydra_lib_ordering_max)      (prim2 (prim-name hydra_lib_ordering_max)      hydra_overlay_common_lisp_lib_ordering_max      nil x x x ord-x))
      (cons (prim-name hydra_lib_ordering_min)      (prim2 (prim-name hydra_lib_ordering_min)      hydra_overlay_common_lisp_lib_ordering_min      nil x x x ord-x)))))
    ...
    (let ((eff (lambda (c) (tc-effect c))))
      (list
        ...
        (cons (prim-name hydra_lib_files_create_symlink)  (prim2 (prim-name hydra_lib_files_create_symlink)
                                                   hydra_overlay_common_lisp_lib_files_create_symlink
        ...
        (cons (prim-name hydra_lib_files_read_symlink)    (prim1 (prim-name hydra_lib_files_read_symlink)
                                                   hydra_overlay_common_lisp_lib_files_read_symlink
  ...
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_lists_member)     (prim2 (prim-name hydra_lib_lists_member)
                                              hydra_overlay_common_lisp_lib_lists_member
      ...
      (cons (prim-name hydra_lib_lists_join)       (prim2 (prim-name hydra_lib_lists_join)
                                               hydra_overlay_common_lisp_lib_lists_join
      ...
      (cons (prim-name hydra_lib_lists_at)         (prim2 (prim-name hydra_lib_lists_at)         hydra_overlay_common_lisp_lib_lists_at         nil (tc-int32) (tc-list a) (tc-optional a)))
      (cons (prim-name hydra_lib_lists_head)       (prim1 (prim-name hydra_lib_lists_head)       hydra_overlay_common_lisp_lib_lists_head       nil (tc-list a) (tc-optional a)))
      (cons (prim-name hydra_lib_lists_init)       (prim1 (prim-name hydra_lib_lists_init)       hydra_overlay_common_lisp_lib_lists_init       nil (tc-list a) (tc-optional (tc-list a))))
      ...
      (cons (prim-name hydra_lib_lists_is_empty)       (prim1 (prim-name hydra_lib_lists_is_empty)       hydra_overlay_common_lisp_lib_lists_is_empty       nil (tc-list a) (tc-boolean)))
      ...
      (cons (prim-name hydra_lib_lists_sort_by)    (prim2 (prim-name hydra_lib_lists_sort_by)
                                              hydra_overlay_common_lisp_lib_lists_sort_by
  ...
  (let (
    ...
    (let ((map-kv (tc-map k v)))
      (list
        ...
        (cons (prim-name hydra_lib_maps_is_empty)           (prim1 (prim-name hydra_lib_maps_is_empty)   hydra_overlay_common_lisp_lib_maps_is_empty   nil map-kv (tc-boolean) ord-k))
...
(defun register-math ()
  (let (
    ...
    (append
      ...
      (list
        (cons (prim-name hydra_lib_math_abs)    (prim1 (prim-name hydra_lib_math_abs)    hydra_overlay_common_lisp_lib_math_abs    nil x x numeric-x))
        (cons (prim-name hydra_lib_math_add)    (prim2 (prim-name hydra_lib_math_add)    hydra_overlay_common_lisp_lib_math_add    nil x x x numeric-x))
        (cons (prim-name hydra_lib_math_mul)    (prim2 (prim-name hydra_lib_math_mul)    hydra_overlay_common_lisp_lib_math_mul    nil x x x numeric-x))
        (cons (prim-name hydra_lib_math_negate) (prim1 (prim-name hydra_lib_math_negate) hydra_overlay_common_lisp_lib_math_negate nil x x numeric-x))
        ...
        (cons (prim-name hydra_lib_math_signum) (prim1 (prim-name hydra_lib_math_signum) hydra_overlay_common_lisp_lib_math_signum nil x x numeric-x))
        (cons (prim-name hydra_lib_math_sub)    (prim2 (prim-name hydra_lib_math_sub)    hydra_overlay_common_lisp_lib_math_sub    nil x x x numeric-x)))
      ;; Constraint-polymorphic ('integral') primitives
      (list
        (cons (prim-name hydra_lib_math_even)   (prim1 (prim-name hydra_lib_math_even)   hydra_overlay_common_lisp_lib_math_even   nil x b integral-x))
        (cons (prim-name hydra_lib_math_odd)    (prim1 (prim-name hydra_lib_math_odd)    hydra_overlay_common_lisp_lib_math_odd    nil x b integral-x))
        (cons (prim-name hydra_lib_math_div)  (prim2 (prim-name hydra_lib_math_div)  hydra_overlay_common_lisp_lib_math_div  nil x x (tc-optional x) integral-x))
        (cons (prim-name hydra_lib_math_mod)  (prim2 (prim-name hydra_lib_math_mod)  hydra_overlay_common_lisp_lib_math_mod  nil x x (tc-optional x) integral-x))
        (cons (prim-name hydra_lib_math_rem)  (prim2 (prim-name hydra_lib_math_rem)  hydra_overlay_common_lisp_lib_math_rem  nil x x (tc-optional x) integral-x)))
      ;; Constraint-polymorphic ('fractional') primitives
      (list
        (cons (prim-name hydra_lib_math_divide) (prim2 (prim-name hydra_lib_math_divide) hydra_overlay_common_lisp_lib_math_divide nil x x x fractional-x)))
      ;; Float64 primitives
      (list
...
(defun register-optionals ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_optionals_givens)   (prim1 (prim-name hydra_lib_optionals_givens)   hydra_overlay_common_lisp_lib_optionals_givens   nil (tc-list (tc-optional a)) (tc-list a)))
      ...
      (cons (prim-name hydra_lib_optionals_with_default) (lazy-args '(0) (prim2 (prim-name hydra_lib_optionals_with_default)
                                            hydra_overlay_common_lisp_lib_optionals_with_default
...
(defun register-sets ()
  (let (
    ...
    (list
      ...
      (cons (prim-name hydra_lib_sets_is_empty)         (prim1 (prim-name hydra_lib_sets_is_empty)     hydra_overlay_common_lisp_lib_sets_is_empty     nil (tc-set a) (tc-boolean) ord-a))
...
(defun register-strings ()
  (let (
        ...
        (b (tc-boolean)))
    (list
      (cons (prim-name hydra_lib_strings_concat)      (prim1 (prim-name hydra_lib_strings_concat)      hydra_overlay_common_lisp_lib_strings_concat      nil (tc-list s) s))
      (cons (prim-name hydra_lib_strings_concat2)     (prim2 (prim-name hydra_lib_strings_concat2)
                                               hydra_overlay_common_lisp_lib_strings_concat2
                                               nil s s s))
      ...
      (cons (prim-name hydra_lib_strings_join)        (prim2 (prim-name hydra_lib_strings_join)
                                               hydra_overlay_common_lisp_lib_strings_join
                                               nil s (tc-list s) s))
      ...
      (cons (prim-name hydra_lib_strings_is_empty)        (prim1 (prim-name hydra_lib_strings_is_empty)        hydra_overlay_common_lisp_lib_strings_is_empty        nil s b))
  ...
  (let (
    ...
    (append
      ...
      (list
        ...
        (cons (prim-name hydra_lib_literals_binary_to_base64)     (prim1 (prim-name hydra_lib_literals_binary_to_base64)     hydra_overlay_common_lisp_lib_literals_binary_to_base64     nil bin s))
        ...
        (cons (prim-name hydra_lib_literals_base64_to_binary)     (prim1 (prim-name hydra_lib_literals_base64_to_binary)     hydra_overlay_common_lisp_lib_literals_base64_to_binary     nil s bin)))
      ;; Read primitives
      (list
        (cons (prim-name hydra_lib_literals_parse_bigint)   (prim1 (prim-name hydra_lib_literals_parse_bigint)   hydra_overlay_common_lisp_lib_literals_parse_bigint   nil s (tc-optional bi)))
        (cons (prim-name hydra_lib_literals_parse_boolean) (prim1 (prim-name hydra_lib_literals_parse_boolean) hydra_overlay_common_lisp_lib_literals_parse_boolean nil s (tc-optional b)))
        (cons (prim-name hydra_lib_literals_parse_decimal)  (prim1 (prim-name hydra_lib_literals_parse_decimal)  hydra_overlay_common_lisp_lib_literals_parse_decimal  nil s (tc-optional dec)))
        (cons (prim-name hydra_lib_literals_parse_float32)  (prim1 (prim-name hydra_lib_literals_parse_float32)  hydra_overlay_common_lisp_lib_literals_parse_float32  nil s (tc-optional f32)))
        (cons (prim-name hydra_lib_literals_parse_float64)  (prim1 (prim-name hydra_lib_literals_parse_float64)  hydra_overlay_common_lisp_lib_literals_parse_float64  nil s (tc-optional f64)))
        (cons (prim-name hydra_lib_literals_parse_int8)     (prim1 (prim-name hydra_lib_literals_parse_int8)     hydra_overlay_common_lisp_lib_literals_parse_int8     nil s (tc-optional i8)))
        (cons (prim-name hydra_lib_literals_parse_int16)    (prim1 (prim-name hydra_lib_literals_parse_int16)    hydra_overlay_common_lisp_lib_literals_parse_int16    nil s (tc-optional i16)))
        (cons (prim-name hydra_lib_literals_parse_int32)    (prim1 (prim-name hydra_lib_literals_parse_int32)    hydra_overlay_common_lisp_lib_literals_parse_int32    nil s (tc-optional i32)))
        (cons (prim-name hydra_lib_literals_parse_int64)    (prim1 (prim-name hydra_lib_literals_parse_int64)    hydra_overlay_common_lisp_lib_literals_parse_int64    nil s (tc-optional i64)))
        (cons (prim-name hydra_lib_literals_parse_string)  (prim1 (prim-name hydra_lib_literals_parse_string)  hydra_overlay_common_lisp_lib_literals_parse_string  nil s (tc-optional s)))
        (cons (prim-name hydra_lib_literals_parse_uint8)    (prim1 (prim-name hydra_lib_literals_parse_uint8)    hydra_overlay_common_lisp_lib_literals_parse_uint8    nil s (tc-optional u8)))
        (cons (prim-name hydra_lib_literals_parse_uint16)   (prim1 (prim-name hydra_lib_literals_parse_uint16)   hydra_overlay_common_lisp_lib_literals_parse_uint16   nil s (tc-optional u16)))
        (cons (prim-name hydra_lib_literals_parse_uint32)   (prim1 (prim-name hydra_lib_literals_parse_uint32)   hydra_overlay_common_lisp_lib_literals_parse_uint32   nil s (tc-optional u32)))
        (cons (prim-name hydra_lib_literals_parse_uint64)   (prim1 (prim-name hydra_lib_literals_parse_uint64)   hydra_overlay_common_lisp_lib_literals_parse_uint64   nil s (tc-optional u64))))
      ;; Show primitives
      (list
        (cons (prim-name hydra_lib_literals_print_bigint)   (prim1 (prim-name hydra_lib_literals_print_bigint)   hydra_overlay_common_lisp_lib_literals_print_bigint   nil bi s))
        (cons (prim-name hydra_lib_literals_print_boolean) (prim1 (prim-name hydra_lib_literals_print_boolean) hydra_overlay_common_lisp_lib_literals_print_boolean nil b s))
        (cons (prim-name hydra_lib_literals_print_decimal)  (prim1 (prim-name hydra_lib_literals_print_decimal)  hydra_overlay_common_lisp_lib_literals_print_decimal  nil dec s))
        (cons (prim-name hydra_lib_literals_print_float32)  (prim1 (prim-name hydra_lib_literals_print_float32)  hydra_overlay_common_lisp_lib_literals_print_float32  nil f32 s))
        (cons (prim-name hydra_lib_literals_print_float64)  (prim1 (prim-name hydra_lib_literals_print_float64)  hydra_overlay_common_lisp_lib_literals_print_float64  nil f64 s))
        (cons (prim-name hydra_lib_literals_print_int8)     (prim1 (prim-name hydra_lib_literals_print_int8)     hydra_overlay_common_lisp_lib_literals_print_int8     nil i8 s))
        (cons (prim-name hydra_lib_literals_print_int16)    (prim1 (prim-name hydra_lib_literals_print_int16)    hydra_overlay_common_lisp_lib_literals_print_int16    nil i16 s))
        (cons (prim-name hydra_lib_literals_print_int32)    (prim1 (prim-name hydra_lib_literals_print_int32)    hydra_overlay_common_lisp_lib_literals_print_int32    nil i32 s))
        (cons (prim-name hydra_lib_literals_print_int64)    (prim1 (prim-name hydra_lib_literals_print_int64)    hydra_overlay_common_lisp_lib_literals_print_int64    nil i64 s))
        (cons (prim-name hydra_lib_literals_print_uint8)    (prim1 (prim-name hydra_lib_literals_print_uint8)    hydra_overlay_common_lisp_lib_literals_print_uint8    nil u8 s))
        (cons (prim-name hydra_lib_literals_print_uint16)   (prim1 (prim-name hydra_lib_literals_print_uint16)   hydra_overlay_common_lisp_lib_literals_print_uint16   nil u16 s))
        (cons (prim-name hydra_lib_literals_print_uint32)   (prim1 (prim-name hydra_lib_literals_print_uint32)   hydra_overlay_common_lisp_lib_literals_print_uint32   nil u32 s))
        (cons (prim-name hydra_lib_literals_print_uint64)   (prim1 (prim-name hydra_lib_literals_print_uint64)   hydra_overlay_common_lisp_lib_literals_print_uint64   nil u64 s))
        (cons (prim-name hydra_lib_literals_print_string)  (prim1 (prim-name hydra_lib_literals_print_string)  hydra_overlay_common_lisp_lib_literals_print_string  nil s s))))))
