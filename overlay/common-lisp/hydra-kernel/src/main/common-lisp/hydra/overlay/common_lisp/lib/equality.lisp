...
(defvar hydra_overlay_common_lisp_lib_equality_compare
  (lambda (a)
    (lambda (b)
...
(defvar hydra_overlay_common_lisp_lib_equality_gt
  (lambda (a)
    (lambda (b)
      (> (generic-compare a b) 0))))
...
(defvar hydra_overlay_common_lisp_lib_equality_gte
  (lambda (a)
    (lambda (b)
      (>= (generic-compare a b) 0))))
...
(defvar hydra_overlay_common_lisp_lib_equality_identity
  (lambda (x) x))

;; lt :: a -> a -> Bool
;; Check if first value is less than second.
(defvar hydra_overlay_common_lisp_lib_equality_lt
  (lambda (a)
    (lambda (b)
      (< (generic-compare a b) 0))))
...
(defvar hydra_overlay_common_lisp_lib_equality_lte
  (lambda (a)
    (lambda (b)
      (<= (generic-compare a b) 0))))
...
(defvar hydra_overlay_common_lisp_lib_equality_max
  (lambda (a)
    (lambda (b)
...
(defvar hydra_overlay_common_lisp_lib_equality_min
  (lambda (a)
    (lambda (b)
      (if (<= (generic-compare a b) 0) a b))))
