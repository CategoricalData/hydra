...
(defvar hydra_lisp_lib_system_execute
  (lambda (command)
...
(defvar hydra_lisp_lib_system_exit
  (lambda (code)
...
(defvar hydra_lisp_lib_system_get_environment
  #+sbcl
  (mapcar (lambda (entry)
...
(defvar hydra_lisp_lib_system_get_working_directory
