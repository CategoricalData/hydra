...
;; Common Lisp implementations of hydra.core.lib.system primitives (#498).
;;
...
(defvar hydra_overlay_common_lisp_lib_system_execute
  (lambda (command)
    (let ((program (hydra_system_command-program command))
      ...
      #-sbcl
      (list :left (list :other "hydra.core.lib.system.execute requires SBCL")))))
...
(defvar hydra_overlay_common_lisp_lib_system_read_stdin
  ...
  #-sbcl (list :left (list :other "hydra.core.lib.system.readStdin requires SBCL")))
  ...
  (lambda (bytes)
    ...
    (handler-case
        (progn
          ...
          (list :right nil))
      (error (e) (list :left (list :other (hydra-system-message e)))))
    #-sbcl (list :left (list :other "hydra.core.lib.system.writeStderr requires SBCL"))))
  ...
  (lambda (bytes)
    ...
    (handler-case
        (progn
          ...
          (list :right nil))
      (error (e) (list :left (list :other (hydra-system-message e)))))
    #-sbcl (list :left (list :other "hydra.core.lib.system.writeStdout requires SBCL"))))
