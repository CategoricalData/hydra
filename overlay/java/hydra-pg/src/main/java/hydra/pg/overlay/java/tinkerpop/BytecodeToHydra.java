...
import hydra.pg.tinkerpop.gremlin.GenericLiteral;
import hydra.pg.tinkerpop.gremlin.GenericLiteralArgument;
import hydra.pg.tinkerpop.gremlin.IntegerLiteral;
import hydra.pg.tinkerpop.gremlin.NumericLiteral;
import hydra.pg.tinkerpop.gremlin.RootTraversal;
import hydra.pg.tinkerpop.gremlin.StringNullableArgument;
import hydra.pg.tinkerpop.gremlin.TraversalMethod;
import hydra.pg.tinkerpop.gremlin.TraversalScope;
import hydra.pg.tinkerpop.gremlin.TraversalScopeArgument;
import hydra.pg.tinkerpop.gremlin.TraversalSource;
import hydra.pg.tinkerpop.gremlin.TraversalSourceSelfMethod;
import hydra.pg.tinkerpop.gremlin.TraversalSourceSpawnMethod;
...
/**
 * Reverse mapping: TinkerPop {@link Bytecode} &rarr; Hydra {@code hydra.pg.tinkerpop.gremlin} model.
 *
...
public final class BytecodeToHydra {
        ...
        switch (i.getOperator()) {
            ...
            case "addV":
                return new TraversalSourceSpawnMethod.AddV(a.length == 0
                        ? hydra.core.overlay.java.util.Optional.none()
                        : hydra.core.overlay.java.util.Optional.given(stringOrNestedRev(a[0])));
            case "addE":
    ...
    private static TraversalMethod stepFrom(Bytecode.Instruction i) {
        ...
        switch (i.getOperator()) {
            ...
            case "fold":
                if (a.length == 0) {
                    return new TraversalMethod.Fold(hydra.core.overlay.java.util.Optional.none());
                }
            ...
            case "pageRank":
                return new TraversalMethod.PageRank(a.length == 0
                        ? hydra.core.overlay.java.util.Optional.none()
                        : hydra.core.overlay.java.util.Optional.given(numArg(a[0])));
            ...
            case "range": {
                ...
                return new TraversalMethod.Range(new hydra.pg.tinkerpop.gremlin.RangeArgs(
                        hasScope ? hydra.core.overlay.java.util.Optional.given(scopeArgRev((Scope) a[0])) : hydra.core.overlay.java.util.Optional.none(),
                        intArg(minO), intArg(maxO)));
            }
            case "sample": {
                boolean hasScope = a.length == 2 && a[0] instanceof Scope;
                return new TraversalMethod.Sample(new hydra.pg.tinkerpop.gremlin.SampleByScope(
                        hasScope ? hydra.core.overlay.java.util.Optional.given(scopeArgRev((Scope) a[0])) : hydra.core.overlay.java.util.Optional.none(),
                        intArg(a[a.length - 1])));
            }
            case "replace": {
                ...
                return new TraversalMethod.Replace(new hydra.pg.tinkerpop.gremlin.ReplaceArgs(
                        hasScope ? hydra.core.overlay.java.util.Optional.given(scopeArgRev((Scope) a[0])) : hydra.core.overlay.java.util.Optional.none(),
                        stringNullableArg1(a[base]), stringNullableArg1(a[base + 1])));
            }
            case "split": {
                boolean hasScope = a.length == 2 && a[0] instanceof Scope;
                return new TraversalMethod.Split(new hydra.pg.tinkerpop.gremlin.SplitArgs(
                        hasScope ? hydra.core.overlay.java.util.Optional.given(scopeArgRev((Scope) a[0])) : hydra.core.overlay.java.util.Optional.none(),
                        stringNullableArg1(a[a.length - 1])));
            }
            case "substring": {
                int idx = 0;
                hydra.core.overlay.java.util.Optional<TraversalScopeArgument> scope = hydra.core.overlay.java.util.Optional.none();
                if (a.length > 0 && a[0] instanceof Scope) { scope = hydra.core.overlay.java.util.Optional.given(scopeArgRev((Scope) a[0])); idx = 1; }
                hydra.pg.tinkerpop.gremlin.IntegerArgument start = intArg(a[idx]);
                hydra.core.overlay.java.util.Optional<hydra.pg.tinkerpop.gremlin.IntegerArgument> end =
                        (idx + 1 < a.length) ? hydra.core.overlay.java.util.Optional.given(intArg(a[idx + 1])) : hydra.core.overlay.java.util.Optional.none();
                return new TraversalMethod.Substring(new hydra.pg.tinkerpop.gremlin.SubstringArgs(scope, start, end));
            }
            case "tail": {
                if (a.length == 0) return new TraversalMethod.Tail(hydra.core.overlay.java.util.Optional.none());
                int idx = 0;
                hydra.core.overlay.java.util.Optional<TraversalScopeArgument> scope = hydra.core.overlay.java.util.Optional.none();
                if (a[0] instanceof Scope) { scope = hydra.core.overlay.java.util.Optional.given(scopeArgRev((Scope) a[0])); idx = 1; }
                hydra.core.overlay.java.util.Optional<hydra.pg.tinkerpop.gremlin.IntegerArgument> n =
                        (idx < a.length) ? hydra.core.overlay.java.util.Optional.given(intArg(a[idx])) : hydra.core.overlay.java.util.Optional.none();
                return new TraversalMethod.Tail(hydra.core.overlay.java.util.Optional.given(new hydra.pg.tinkerpop.gremlin.TailArgs(scope, n)));
            }
            case "repeat": {
                boolean hasLabel = a.length == 2;
                return new TraversalMethod.Repeat(new hydra.pg.tinkerpop.gremlin.RepeatArgs(
                        hasLabel ? hydra.core.overlay.java.util.Optional.given(strArg(a[0])) : hydra.core.overlay.java.util.Optional.none(),
                        nestedRev(a[a.length - 1])));
            }
            case "dateAdd":
                return new TraversalMethod.DateAdd(new hydra.pg.tinkerpop.gremlin.DateAddArgs(dtArgRev(a[0]), intArg(a[1])));
            case "dateDiff":
                if (a.length == 1 && a[0] instanceof Bytecode) {
                    return new TraversalMethod.DateDiff(new hydra.pg.tinkerpop.gremlin.DateDiffArgs.Traversal(nestedRev(a[0])));
                }
                throw notYetMapped("step", "dateDiff(date) reverse");
            case "concat": {
                if (a.length > 0 && a[0] instanceof Bytecode) {
                    return new TraversalMethod.Concat(new hydra.pg.tinkerpop.gremlin.ConcatArgs.Traversal(nestedListRev(a)));
                }
                return new TraversalMethod.Concat(new hydra.pg.tinkerpop.gremlin.ConcatArgs.String_(stringNullableArgs(a)));
            }
            case "toE":
                return new TraversalMethod.ToE(directionAndVarargsRev(a));
            case "toV":
                return new TraversalMethod.ToV(new hydra.pg.tinkerpop.gremlin.TraversalDirectionArgument.Value(
            ...
            case "from":
                if (a[0] instanceof Bytecode) return new TraversalMethod.From(new hydra.pg.tinkerpop.gremlin.FromArgs.Traversal(nestedRev(a[0])));
                if (a[0] instanceof String)   return new TraversalMethod.From(new hydra.pg.tinkerpop.gremlin.FromArgs.String_(strArg(a[0])));
            ...
            case "to":
                if (a.length >= 1 && a[0] instanceof org.apache.tinkerpop.gremlin.structure.Direction)
                    return new TraversalMethod.To(new hydra.pg.tinkerpop.gremlin.ToArgs.Direction(directionAndVarargsRev(a)));
                if (a[0] instanceof Bytecode) return new TraversalMethod.To(new hydra.pg.tinkerpop.gremlin.ToArgs.Traversal(nestedRev(a[0])));
                if (a[0] instanceof String)   return new TraversalMethod.To(new hydra.pg.tinkerpop.gremlin.ToArgs.String_(strArg(a[0])));
            ...
            case "valueMap":
                return new TraversalMethod.ValueMap(new hydra.pg.tinkerpop.gremlin.ValueMapArgs.String_(stringNullableArgs(a)));
            ...
            case "dedup": {
                if (a.length >= 1 && a[0] instanceof Scope) {
                    ...
                    return new TraversalMethod.Dedup(new hydra.pg.tinkerpop.gremlin.DedupArgs.ScopeString(
                            new hydra.pg.tinkerpop.gremlin.ScopeStringArgs(scopeArgRev((Scope) a[0]), strs)));
                }
                return new TraversalMethod.Dedup(new hydra.pg.tinkerpop.gremlin.DedupArgs.String_(stringNullableArgs(a)));
            }

            // barrier ([maxBarrierSize]); sack ([Operator])
            case "barrier":
                if (a.length == 0) return new TraversalMethod.Barrier(hydra.core.overlay.java.util.Optional.none());
                return new TraversalMethod.Barrier(hydra.core.overlay.java.util.Optional.given(
                        new hydra.pg.tinkerpop.gremlin.BarrierArgs.Int(intArg(a[0]))));
            case "sack":
                if (a.length == 0) return new TraversalMethod.Sack(hydra.core.overlay.java.util.Optional.none());
                return new TraversalMethod.Sack(hydra.core.overlay.java.util.Optional.given(biFunctionRev(a[0])));
            ...
            case "emit":
                return new TraversalMethod.Emit(a.length == 0
                        ? hydra.core.overlay.java.util.Optional.none()
                        : hydra.core.overlay.java.util.Optional.given(predicateOrTraversalRev(a[0])));

            // where(predicate | string | traversal)
            case "where":
                if (a.length >= 1 && a[0] instanceof Bytecode) {
                    return new TraversalMethod.Where(new hydra.pg.tinkerpop.gremlin.WhereArgs.Traversal(nestedRev(a[0])));
                }
                if (a.length == 1 && a[0] instanceof org.apache.tinkerpop.gremlin.process.traversal.P) {
                    return new TraversalMethod.Where(new hydra.pg.tinkerpop.gremlin.WhereArgs.Predicate(
                            new hydra.pg.tinkerpop.gremlin.WhereWithPredicateArgs(hydra.core.overlay.java.util.Optional.none(), predFrom(a[0]))));
                }
                if (a.length == 2 && a[0] instanceof String && a[1] instanceof org.apache.tinkerpop.gremlin.process.traversal.P) {
                    return new TraversalMethod.Where(new hydra.pg.tinkerpop.gremlin.WhereArgs.Predicate(
                            new hydra.pg.tinkerpop.gremlin.WhereWithPredicateArgs(hydra.core.overlay.java.util.Optional.given(strArg(a[0])), predFrom(a[1]))));
                }
                if (a.length == 1 && a[0] instanceof String) {
                    return new TraversalMethod.Where(new hydra.pg.tinkerpop.gremlin.WhereArgs.String_(strArg(a[0])));
                }
            ...
            case "asNumber":
                return new TraversalMethod.AsNumber(a.length == 0
                        ? hydra.core.overlay.java.util.Optional.none()
                        : hydra.core.overlay.java.util.Optional.given(new hydra.pg.tinkerpop.gremlin.TraversalGTypeArgument.Value(
            ...
            case "select": {
                if (a.length == 1 && a[0] instanceof org.apache.tinkerpop.gremlin.structure.Column) {
                    return new TraversalMethod.Select(new hydra.pg.tinkerpop.gremlin.SelectArgs.Column(
                            new hydra.pg.tinkerpop.gremlin.TraversalColumnArgument.Value(columnRev((org.apache.tinkerpop.gremlin.structure.Column) a[0]))));
                }
                ...
                if (last instanceof Bytecode) {
                    if (hasPop) return new TraversalMethod.Select(new hydra.pg.tinkerpop.gremlin.SelectArgs.PopTraversal(
                            new hydra.pg.tinkerpop.gremlin.PopAndTraversal(popRev((org.apache.tinkerpop.gremlin.process.traversal.Pop) a[0]), nestedRev(last))));
                    return new TraversalMethod.Select(new hydra.pg.tinkerpop.gremlin.SelectArgs.Traversal(nestedRev(last)));
                }
                if (hasPop) {
                    List<hydra.pg.tinkerpop.gremlin.StringArgument> keys = new ArrayList<>();
                    for (int k = 1; k < a.length; k++) keys.add(strArg(a[k]));
                    return new TraversalMethod.Select(new hydra.pg.tinkerpop.gremlin.SelectArgs.PopStrings(
                            new hydra.pg.tinkerpop.gremlin.SelectByKeys(popRev((org.apache.tinkerpop.gremlin.process.traversal.Pop) a[0]), keys)));
                }
                List<hydra.pg.tinkerpop.gremlin.StringArgument> keys = new ArrayList<>();
                for (Object o : a) keys.add(strArg(o));
                return new TraversalMethod.Select(new hydra.pg.tinkerpop.gremlin.SelectArgs.Strings(keys));
            }

            // choose(function | predicate,true[,false] | traversal)
            case "choose": {
                if (a.length == 1 && a[0] instanceof Bytecode) return new TraversalMethod.Choose(new hydra.pg.tinkerpop.gremlin.ChooseArgs.Traversal(nestedRev(a[0])));
                if (a[0] instanceof org.apache.tinkerpop.gremlin.process.traversal.P) {
                    hydra.core.overlay.java.util.Optional<hydra.pg.tinkerpop.gremlin.NestedTraversal> f =
                            (a.length >= 3) ? hydra.core.overlay.java.util.Optional.given(nestedRev(a[2])) : hydra.core.overlay.java.util.Optional.none();
                    return new TraversalMethod.Choose(new hydra.pg.tinkerpop.gremlin.ChooseArgs.PredicateTraversal(
                            new hydra.pg.tinkerpop.gremlin.PredicateOrTraversalChoice(predFrom(a[0]), nestedRev(a[1]), f)));
                }
            ...
            case "option": {
                if (a.length == 1 && a[0] instanceof Bytecode) return new TraversalMethod.Option(new hydra.pg.tinkerpop.gremlin.OptionArgs.Traversal(nestedRev(a[0])));
                if (a.length == 2 && a[0] instanceof org.apache.tinkerpop.gremlin.process.traversal.P) {
                    return new TraversalMethod.Option(new hydra.pg.tinkerpop.gremlin.OptionArgs.PredicateTraversal(
                            new hydra.pg.tinkerpop.gremlin.PredicateAndTraversal(predFrom(a[0]), nestedRev(a[1]))));
                }
                if (a.length == 2) {
                    return new TraversalMethod.Option(new hydra.pg.tinkerpop.gremlin.OptionArgs.ObjectTraversal(
                            new hydra.pg.tinkerpop.gremlin.ObjectAndTraversal(litArg(a[0]), nestedRev(a[1]))));
                }
            ...
            case "by": {
                if (a.length == 0) return new TraversalMethod.By(new hydra.pg.tinkerpop.gremlin.ByArgs.Other(
                        new hydra.pg.tinkerpop.gremlin.ByOtherArgs.Comparator(hydra.core.overlay.java.util.Optional.none())));
                Object x0 = a[0];
                if (x0 instanceof org.apache.tinkerpop.gremlin.process.traversal.Order)
                    return new TraversalMethod.By(new hydra.pg.tinkerpop.gremlin.ByArgs.Order(
                            new hydra.pg.tinkerpop.gremlin.TraversalOrderArgument.Value(orderRev((org.apache.tinkerpop.gremlin.process.traversal.Order) x0))));
                if (x0 instanceof org.apache.tinkerpop.gremlin.structure.T)
                    return new TraversalMethod.By(new hydra.pg.tinkerpop.gremlin.ByArgs.Token(
                            new hydra.pg.tinkerpop.gremlin.TraversalTokenArgument.Value(tokenRev((org.apache.tinkerpop.gremlin.structure.T) x0))));
                if (x0 instanceof Bytecode)
                    return new TraversalMethod.By(new hydra.pg.tinkerpop.gremlin.ByArgs.Other(new hydra.pg.tinkerpop.gremlin.ByOtherArgs.Traversal(nestedRev(x0))));
                if (x0 instanceof String)
                    return new TraversalMethod.By(new hydra.pg.tinkerpop.gremlin.ByArgs.Other(new hydra.pg.tinkerpop.gremlin.ByOtherArgs.String_(strArg(x0))));
            ...
            case "property": {
                if (a.length >= 1 && a[0] instanceof org.apache.tinkerpop.gremlin.structure.VertexProperty.Cardinality) {
                    ...
                    return new TraversalMethod.Property(new hydra.pg.tinkerpop.gremlin.PropertyArgs.CardinalityObjects(
                            new hydra.pg.tinkerpop.gremlin.CardinalityAndObjects(
                                    new hydra.pg.tinkerpop.gremlin.TraversalCardinalityArgument.Value(cardinalityRev((org.apache.tinkerpop.gremlin.structure.VertexProperty.Cardinality) a[0])),
                                    objs)));
                }
                return new TraversalMethod.Property(new hydra.pg.tinkerpop.gremlin.PropertyArgs.Objects(literalArgs(a)));
            }

            // call(service[, traversal]); map form not reversed
            case "call": {
                hydra.pg.tinkerpop.gremlin.ServiceArguments sargs = (a.length >= 2 && a[1] instanceof Bytecode)
                        ? new hydra.pg.tinkerpop.gremlin.ServiceArguments.Traversal(hydra.core.overlay.java.util.Optional.given(nestedRev(a[1])))
                        : new hydra.pg.tinkerpop.gremlin.ServiceArguments.Traversal(hydra.core.overlay.java.util.Optional.none());
                return new TraversalMethod.Call(new hydra.pg.tinkerpop.gremlin.ServiceCall(strArg(a[0]), sargs));
            }

            // with(key[, value]) — string-key form (WithOptions-key form not reversed)
            case "with": {
                hydra.pg.tinkerpop.gremlin.WithArgsKeys keys = new hydra.pg.tinkerpop.gremlin.WithArgsKeys.String_(strArg(a[0]));
                hydra.core.overlay.java.util.Optional<hydra.pg.tinkerpop.gremlin.WithArgsValues> vals =
                        (a.length >= 2) ? hydra.core.overlay.java.util.Optional.given(new hydra.pg.tinkerpop.gremlin.WithArgsValues.Object_(litArg(a[1]))) : hydra.core.overlay.java.util.Optional.none();
                return new TraversalMethod.With(new hydra.pg.tinkerpop.gremlin.WithArgs(keys, vals));
            }
    ...
    static hydra.pg.tinkerpop.gremlin.FloatLiteral floatLiteral(Object o) {
        if (o instanceof Float)               return new hydra.pg.tinkerpop.gremlin.FloatLiteral.Float_((Float) o);
        if (o instanceof Double)              return new hydra.pg.tinkerpop.gremlin.FloatLiteral.Double_((Double) o);
        if (o instanceof java.math.BigDecimal) return new hydra.pg.tinkerpop.gremlin.FloatLiteral.Big((java.math.BigDecimal) o);
    ...
    static List<StringNullableArgument> stringNullableArgs(Object[] args) {
        ...
        for (Object o : args) {
            hydra.core.overlay.java.util.Optional<String> opt = (o == null)
                    ? hydra.core.overlay.java.util.Optional.none()
                    : hydra.core.overlay.java.util.Optional.given((String) o);
    ...
    static hydra.core.overlay.java.util.Optional<TraversalScopeArgument> scopeOpt(Object[] args) {
        if (args.length == 0) {
            return hydra.core.overlay.java.util.Optional.none();
        }
        Scope s = (Scope) args[0];
        TraversalScope scope = (s == Scope.local) ? new TraversalScope.Local() : new TraversalScope.Global();
        return hydra.core.overlay.java.util.Optional.given(new TraversalScopeArgument.Value(scope));
    }

    /** Reverse of as/cap/project: a flat {@code String[]} → {@code AsArgs(first, rest)}. */
    static hydra.pg.tinkerpop.gremlin.AsArgs asArgs(Object[] args) {
        if (args.length == 0) {
            throw new IllegalArgumentException("as/cap/project expects at least 1 label");
        }
        hydra.pg.tinkerpop.gremlin.StringArgument first =
                new hydra.pg.tinkerpop.gremlin.StringArgument.Value((String) args[0]);
        ...
        return new hydra.pg.tinkerpop.gremlin.AsArgs(first, rest);
    }

    /** Reverse of limit/skip: {@code [Scope,] long} → {@code ScopeAndInteger(scope?, integer)}. */
    static hydra.pg.tinkerpop.gremlin.ScopeAndInteger scopeAndInteger(Object[] args) {
        ...
        hydra.pg.tinkerpop.gremlin.IntegerArgument integer = intArg(countObj);
        hydra.core.overlay.java.util.Optional<TraversalScopeArgument> scope =
                (args.length >= 2 && args[0] instanceof Scope)
                        ? hydra.core.overlay.java.util.Optional.given(scopeArgRev((Scope) args[0]))
                        : hydra.core.overlay.java.util.Optional.none();
        return new hydra.pg.tinkerpop.gremlin.ScopeAndInteger(scope, integer);
    }
    ...
    static hydra.pg.tinkerpop.gremlin.PredicateOrObject predicateOrObjectRev(Object[] a) {
        if (isPredicate(a)) {
            return new hydra.pg.tinkerpop.gremlin.PredicateOrObject.Predicate(Predicates.fromP((org.apache.tinkerpop.gremlin.process.traversal.P<?>) a[0]));
        }
        if (a.length != 1) {
            throw new IllegalArgumentException("is expects 1 argument, got " + a.length);
        }
        return new hydra.pg.tinkerpop.gremlin.PredicateOrObject.Object_(
                new GenericLiteralArgument.Value(literal(a[0])));
    }

    /** Reverse of hasLabel/hasKey: a P → predicate, else string varargs → Strings. */
    static hydra.pg.tinkerpop.gremlin.PredicateOrStrings predicateOrStringsRev(Object[] a) {
        if (isPredicate(a)) {
            return new hydra.pg.tinkerpop.gremlin.PredicateOrStrings.Predicate(Predicates.fromP((org.apache.tinkerpop.gremlin.process.traversal.P<?>) a[0]));
        }
        return new hydra.pg.tinkerpop.gremlin.PredicateOrStrings.Strings(stringNullableArgs(a));
    }

    /** Reverse of hasId/hasValue: a P → predicate, else value varargs → Objects. */
    static hydra.pg.tinkerpop.gremlin.PredicateOrObjects predicateOrObjectsRev(Object[] a) {
        if (isPredicate(a)) {
            return new hydra.pg.tinkerpop.gremlin.PredicateOrObjects.Predicate(Predicates.fromP((org.apache.tinkerpop.gremlin.process.traversal.P<?>) a[0]));
        }
        return new hydra.pg.tinkerpop.gremlin.PredicateOrObjects.Objects(literalArgs(a));
    }
    ...
    private static hydra.pg.tinkerpop.gremlin.StringArgument strArg(Object o) {
        return new hydra.pg.tinkerpop.gremlin.StringArgument.Value((String) o);
    }

    private static hydra.core.overlay.java.util.Optional<hydra.pg.tinkerpop.gremlin.StringArgument> strOpt(Object[] a) {
        return a.length == 0
                ? hydra.core.overlay.java.util.Optional.none()
                : hydra.core.overlay.java.util.Optional.given(strArg(a[0]));
    }
    ...
    private static hydra.pg.tinkerpop.gremlin.IntegerArgument intArg(Object o) {
        return new hydra.pg.tinkerpop.gremlin.IntegerArgument.Value(integerLiteral(o));
    }

    private static hydra.pg.tinkerpop.gremlin.NumericArgument numArg(Object o) {
        return new hydra.pg.tinkerpop.gremlin.NumericArgument.Value(numeric0(o));
    }
    ...
    static hydra.pg.tinkerpop.gremlin.NestedTraversal nestedRev(Object o) {
        ...
        return new hydra.pg.tinkerpop.gremlin.NestedTraversal.Anonymous(
                new hydra.pg.tinkerpop.gremlin.ChainedTraversal(steps));
    }

    private static List<hydra.pg.tinkerpop.gremlin.NestedTraversal> nestedListRev(Object[] a) {
        List<hydra.pg.tinkerpop.gremlin.NestedTraversal> out = new ArrayList<>(a.length);
        for (Object o : a) {
            out.add(nestedRev(o));
        }
        return out;
    ...
    private static hydra.pg.tinkerpop.gremlin.TraversalPredicate predFrom(Object o) {
        return Predicates.fromP((org.apache.tinkerpop.gremlin.process.traversal.P<?>) o);
    }

    private static hydra.pg.tinkerpop.gremlin.PredicateOrTraversal predicateOrTraversalRev(Object o) {
        if (o instanceof Bytecode) {
            return new hydra.pg.tinkerpop.gremlin.PredicateOrTraversal.Traversal(nestedRev(o));
        }
        return new hydra.pg.tinkerpop.gremlin.PredicateOrTraversal.Predicate(predFrom(o));
    }

    private static hydra.pg.tinkerpop.gremlin.StringArgumentOrNestedTraversal stringOrNestedRev(Object o) {
        if (o instanceof Bytecode) {
            return new hydra.pg.tinkerpop.gremlin.StringArgumentOrNestedTraversal.Traversal(nestedRev(o));
        }
        return new hydra.pg.tinkerpop.gremlin.StringArgumentOrNestedTraversal.String_(strArg(o));
    }

    private static hydra.pg.tinkerpop.gremlin.MergeArgs mergeArgsRev(Object[] a) {
        if (a.length >= 1 && a[0] instanceof Bytecode) {
            return new hydra.pg.tinkerpop.gremlin.MergeArgs.Traversal(nestedRev(a[0]));
        }
        throw notYetMapped("step", "merge*(map literal) reverse");
    }

    private static hydra.pg.tinkerpop.gremlin.TraversalBiFunctionArgument biFunctionRev(Object o) {
        return new hydra.pg.tinkerpop.gremlin.TraversalBiFunctionArgument.Value(Operators.fromGremlin(
                (org.apache.tinkerpop.gremlin.process.traversal.Operator) o));
    }

    private static hydra.pg.tinkerpop.gremlin.TraversalDTArgument dtArgRev(Object o) {
        org.apache.tinkerpop.gremlin.process.traversal.DT dt = (org.apache.tinkerpop.gremlin.process.traversal.DT) o;
        hydra.pg.tinkerpop.gremlin.TraversalDT t;
        switch (dt) {
            case second: t = new hydra.pg.tinkerpop.gremlin.TraversalDT.Second(); break;
            case minute: t = new hydra.pg.tinkerpop.gremlin.TraversalDT.Minute(); break;
            case hour:   t = new hydra.pg.tinkerpop.gremlin.TraversalDT.Hour(); break;
            case day:    t = new hydra.pg.tinkerpop.gremlin.TraversalDT.Day(); break;
            default: throw new IllegalArgumentException("Unknown DT: " + dt);
        }
        return new hydra.pg.tinkerpop.gremlin.TraversalDTArgument.Value(t);
    }

    private static hydra.pg.tinkerpop.gremlin.DirectionAndVarargs directionAndVarargsRev(Object[] a) {
        hydra.pg.tinkerpop.gremlin.TraversalDirectionArgument dir = new hydra.pg.tinkerpop.gremlin.TraversalDirectionArgument.Value(
                Directions.fromGremlin((org.apache.tinkerpop.gremlin.structure.Direction) a[0]));
        ...
        return new hydra.pg.tinkerpop.gremlin.DirectionAndVarargs(dir, labels);
    }

    // -- Reverse enum helpers ------------------------------------------------------------------

    private static hydra.pg.tinkerpop.gremlin.TraversalColumn columnRev(org.apache.tinkerpop.gremlin.structure.Column c) {
        return c == org.apache.tinkerpop.gremlin.structure.Column.keys
                ? new hydra.pg.tinkerpop.gremlin.TraversalColumn.Keys()
                : new hydra.pg.tinkerpop.gremlin.TraversalColumn.Values();
    }

    private static hydra.pg.tinkerpop.gremlin.TraversalPopArgument popRev(org.apache.tinkerpop.gremlin.process.traversal.Pop p) {
        hydra.pg.tinkerpop.gremlin.TraversalPop t;
        switch (p) {
            case first: t = new hydra.pg.tinkerpop.gremlin.TraversalPop.First(); break;
            case last:  t = new hydra.pg.tinkerpop.gremlin.TraversalPop.Last(); break;
            case all:   t = new hydra.pg.tinkerpop.gremlin.TraversalPop.All(); break;
            case mixed: t = new hydra.pg.tinkerpop.gremlin.TraversalPop.Mixed(); break;
            default: throw new IllegalArgumentException("Unknown Pop: " + p);
        }
        return new hydra.pg.tinkerpop.gremlin.TraversalPopArgument.Value(t);
    }

    private static hydra.pg.tinkerpop.gremlin.TraversalOrder orderRev(org.apache.tinkerpop.gremlin.process.traversal.Order o) {
        switch (o) {
            case asc:     return new hydra.pg.tinkerpop.gremlin.TraversalOrder.Asc();
            case desc:    return new hydra.pg.tinkerpop.gremlin.TraversalOrder.Desc();
            case shuffle: return new hydra.pg.tinkerpop.gremlin.TraversalOrder.Shuffle();
            default: throw new IllegalArgumentException("Unknown Order: " + o);
        }
    }

    private static hydra.pg.tinkerpop.gremlin.TraversalToken tokenRev(org.apache.tinkerpop.gremlin.structure.T t) {
        switch (t) {
            case id:    return new hydra.pg.tinkerpop.gremlin.TraversalToken.Id();
            case label: return new hydra.pg.tinkerpop.gremlin.TraversalToken.Label();
            case key:   return new hydra.pg.tinkerpop.gremlin.TraversalToken.Key();
            case value: return new hydra.pg.tinkerpop.gremlin.TraversalToken.Value();
            default: throw new IllegalArgumentException("Unknown T: " + t);
        }
    }

    private static hydra.pg.tinkerpop.gremlin.TraversalCardinality cardinalityRev(org.apache.tinkerpop.gremlin.structure.VertexProperty.Cardinality c) {
        ...
        hydra.pg.tinkerpop.gremlin.GenericLiteral none = new hydra.pg.tinkerpop.gremlin.GenericLiteral.Null();
        switch (c) {
            case single: return new hydra.pg.tinkerpop.gremlin.TraversalCardinality.Single(none);
            case set:    return new hydra.pg.tinkerpop.gremlin.TraversalCardinality.Set(none);
            case list:   return new hydra.pg.tinkerpop.gremlin.TraversalCardinality.List(none);
    ...
    private static hydra.pg.tinkerpop.gremlin.HasArgs hasArgsRev(Object[] a) {
        Object k0 = a[0];
        Object[] clauseArgs = java.util.Arrays.copyOfRange(a, 1, a.length);
        if (k0 instanceof org.apache.tinkerpop.gremlin.structure.T) {
            return new hydra.pg.tinkerpop.gremlin.HasArgs.TraversalToken(
                    new hydra.pg.tinkerpop.gremlin.HasArgsWithToken(
                            new hydra.pg.tinkerpop.gremlin.TraversalTokenArgument.Value(tokenRev((org.apache.tinkerpop.gremlin.structure.T) k0)),
                            hasValueClauseRev(clauseArgs)));
        }
        StringNullableArgument key = stringNullableArg1(k0);
        hydra.core.overlay.java.util.Optional<hydra.pg.tinkerpop.gremlin.HasValueClause> clause =
                (clauseArgs.length == 0) ? hydra.core.overlay.java.util.Optional.none()
                        : hydra.core.overlay.java.util.Optional.given(hasValueClauseRev(clauseArgs));
        return new hydra.pg.tinkerpop.gremlin.HasArgs.String_(new hydra.pg.tinkerpop.gremlin.HasArgsWithKey(key, clause));
    }

    private static hydra.pg.tinkerpop.gremlin.HasValueClause hasValueClauseRev(Object[] c) {
        if (c.length == 1) {
            Object o = c[0];
            if (o instanceof org.apache.tinkerpop.gremlin.process.traversal.P) {
                return new hydra.pg.tinkerpop.gremlin.HasValueClause.Predicate(predFrom(o));
            }
            if (o instanceof Bytecode) {
                return new hydra.pg.tinkerpop.gremlin.HasValueClause.Traversal(nestedRev(o));
            }
            return new hydra.pg.tinkerpop.gremlin.HasValueClause.Object_(litArg(o));
        }
        if (c.length == 2) {
            // has(label, key, value) form: here c = [key, value-or-P]
            if (c[1] instanceof org.apache.tinkerpop.gremlin.process.traversal.P) {
                return new hydra.pg.tinkerpop.gremlin.HasValueClause.KeyPredicate(
                        new hydra.pg.tinkerpop.gremlin.StringKeyAndPredicate(stringNullableArg1(c[0]), predFrom(c[1])));
            }
            return new hydra.pg.tinkerpop.gremlin.HasValueClause.KeyObject(
                    new hydra.pg.tinkerpop.gremlin.StringKeyAndObject(stringNullableArg1(c[0]), litArg(c[1])));
        }
