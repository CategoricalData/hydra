...
public class HydraGremlinBridge {
    ...
    public static <V> Graph<V> gremlinToHydra(
        ...
        while (vertexIter.hasNext()) {
            ...
            vertices.put(id, new Vertex<>(label, id, hydra.core.overlay.java.util.PersistentMap.coerce(properties)));
        }
        ...
        while (edgeIter.hasNext()) {
            ...
            edges.put(id, new Edge<>(label, id, outId, inId, hydra.core.overlay.java.util.PersistentMap.coerce(properties)));
        }

        return new Graph<>(hydra.core.overlay.java.util.PersistentMap.coerce(vertices), hydra.core.overlay.java.util.PersistentMap.coerce(edges));
    }
    ...
    public static Object literalToObject(Literal lit) {
        return lit.accept(new Literal.Visitor<Object>() {
            ...
            public Object visit(Literal.Integer_ l) {
                return l.value.accept(new hydra.core.model.IntegerValue.Visitor<Object>() {
                    public Object visit(hydra.core.model.IntegerValue.Bigint x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Int8 x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Int16 x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Int32 x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Int64 x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Uint8 x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Uint16 x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Uint32 x) { return x.value; }
                    public Object visit(hydra.core.model.IntegerValue.Uint64 x) { return x.value; }
                });
            }
            public Object visit(Literal.Float_ l) {
                return l.value.accept(new hydra.core.model.FloatValue.Visitor<Object>() {
                    public Object visit(hydra.core.model.FloatValue.Float32 x) { return x.value; }
                    public Object visit(hydra.core.model.FloatValue.Float64 x) { return x.value; }
                });
            }
