package hydra.pg.overlay.java.gql;

import hydra.pg.overlay.java.tools.AntlrReaderBase;
...
public class GQLReader extends AntlrReaderBase {
   ...
   */
  public static Optional<String> tryQuery(String query) {
    try {
      read(query);
    } catch (GQLSyntaxError e) {
      return Optional.given(e.getMessage());
    }
