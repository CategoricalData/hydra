package hydra.overlay.java.cypher;
...
import hydra.overlay.java.tools.MapperBase;
...
import static hydra.overlay.java.pg.dsl.Queries.apply;
import static hydra.overlay.java.pg.dsl.Queries.query;
...
public class FromCypher extends MapperBase {
     ...
     */
    public static ComparisonOperator from(hydra.cypher.openCypher.ComparisonOperator cypher) {
        return cypher.accept(new hydra.cypher.openCypher.ComparisonOperator.Visitor<ComparisonOperator>() {
            @Override
            public ComparisonOperator visit(hydra.cypher.openCypher.ComparisonOperator.Eq instance) {
                return new ComparisonOperator.Eq();
            }

            @Override
            public ComparisonOperator visit(hydra.cypher.openCypher.ComparisonOperator.Neq instance) {
                return new ComparisonOperator.Neq();
            }

            @Override
            public ComparisonOperator visit(hydra.cypher.openCypher.ComparisonOperator.Lt instance) {
                return new ComparisonOperator.Lt();
            }

            @Override
            public ComparisonOperator visit(hydra.cypher.openCypher.ComparisonOperator.Gt instance) {
                return new ComparisonOperator.Gt();
            }

            @Override
            public ComparisonOperator visit(hydra.cypher.openCypher.ComparisonOperator.Lte instance) {
                return new ComparisonOperator.Lte();
            }

            @Override
            public ComparisonOperator visit(hydra.cypher.openCypher.ComparisonOperator.Gte instance) {
     ...
     * @return the converted property graph Expression
     */
    public static Expression from(hydra.cypher.openCypher.Expression cypher) {
     ...
     */
    public static Query from(hydra.cypher.openCypher.Query cypher) {
        return cypher.accept(new hydra.cypher.openCypher.Query.Visitor<Query>() {
            @Override
            public Query visit(hydra.cypher.openCypher.Query.Regular instance) {
                return from(instance.value);
            }

            @Override
            public Query visit(hydra.cypher.openCypher.Query.Standalone instance) {
                return unsupported();
            }
        });
    }
    ...
    public static Query from(SingleQuery cypher) {
        return cypher.accept(new hydra.cypher.openCypher.SingleQuery.Visitor<Query>() {
            @Override
            public Query visit(hydra.cypher.openCypher.SingleQuery.SinglePart instance) {
                return from(instance.value);
            }

            @Override
            public Query visit(hydra.cypher.openCypher.SingleQuery.MultiPart instance) {
                return unsupported();
            }
        });
    }
     ...
     */
    public static Variable from(hydra.cypher.openCypher.Variable cypher) {
