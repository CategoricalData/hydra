...
public class StringToBinary extends PrimitiveFunction {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.lib.eithers.Map.apply((Function<String, Term>) s -> new Term.Literal(new hydra.core.Literal.Binary(apply(s))), hydra.extract.Core.string(graph, args.get(0)));
    }
