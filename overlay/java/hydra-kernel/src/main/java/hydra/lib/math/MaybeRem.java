 ...
 */
public class MaybeRem extends PrimitiveFunction {
    public Name name() {
        return new Name("hydra.lib.math.maybeRem");
    }
     ...
     * @return a function that takes a divisor and returns a Maybe containing the remainder
     */
     ...
     * @return a Maybe containing the remainder, or empty if divisor is zero
     */
