...
public class Concat2 extends PrimitiveFunction {
    ...
    protected Function<List<Term>, Function<InferenceContext, Function<Graph, Either<Error_, Term>>>> implementation() {
        return args -> cx -> graph -> hydra.lib.eithers.Bind.apply(hydra.extract.Core.list(graph, args.get(0)), l1 -> hydra.lib.eithers.Map.apply(l2 -> Terms.list(Concat2.apply(l1, l2)), hydra.extract.Core.list(graph, args.get(1))));
    }
