...
public class Libraries {
    ...
    private static List<PrimitiveFunction> systemPrimitives() {
        return Arrays.asList(
                new hydra.lib.system.Execute(),
                new hydra.lib.system.Exit(),
                new hydra.lib.system.GetEnvironment(),
                new hydra.lib.system.GetEnvironmentVariable(),
                new hydra.lib.system.GetTime(),
                new hydra.lib.system.GetWorkingDirectory());
    }
    ...
    private static List<PrimitiveFunction> listsPrimitives() {
        return Arrays.asList(
                ...
                new hydra.lib.lists.MaybeAt(),
                new hydra.lib.lists.MaybeHead(),
                new hydra.lib.lists.MaybeInit(),
                new hydra.lib.lists.MaybeLast(),
                new hydra.lib.lists.MaybeTail(),
                new hydra.lib.lists.Nub(),
                new hydra.lib.lists.Null(),
                new hydra.lib.lists.Partition(),
    ...
    private static List<PrimitiveFunction> mathPrimitives() {
        return Arrays.asList(
                ...
                new hydra.lib.math.Max(),
                new hydra.lib.math.MaybeDiv(),
                new hydra.lib.math.MaybeMod(),
                new hydra.lib.math.MaybePred(),
                new hydra.lib.math.MaybeRem(),
                new hydra.lib.math.MaybeSucc(),
                new hydra.lib.math.Min(),
                new hydra.lib.math.Mul(),
                new hydra.lib.math.MulFloat64(),
                new hydra.lib.math.Negate(),
                new hydra.lib.math.NegateFloat64(),
