...
public class BigintToInt8 extends PrimitiveFunction {
     ...
     */
    public Name name() {
        return hydra.core.lib.Literals.bigintToInt8().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply(s -> Terms.int8(apply(s)), hydra.core.extract.Model.bigint(graph, args.get(0)));
    }
