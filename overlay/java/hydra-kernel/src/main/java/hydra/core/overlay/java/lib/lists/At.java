...
public class At extends PrimitiveFunction {
    public Name name() {
        return hydra.core.lib.Lists.at().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Bind.apply(hydra.core.extract.Model.int32(graph, args.get(0)), i -> hydra.core.overlay.java.lib.eithers.Map.apply((Function<List<Term>, Term>) l -> Terms.optional(At.apply(i, l)), hydra.core.extract.Model.list(graph, args.get(1))));
    }
