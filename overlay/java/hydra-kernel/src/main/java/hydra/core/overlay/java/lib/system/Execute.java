...
import hydra.core.system.Command;
import hydra.core.system.ProcessResult;
...
public class Execute extends PrimitiveFunction {
    ...
    public TypeScheme type() {
        return scheme(function(
            variable("hydra.core.system.Command"),
            new Type.Effect(either(
                variable("hydra.core.error.system.SystemError"),
                variable("hydra.core.system.ProcessResult")))));
    }
    ...
    public static Either<SystemError, ProcessResult> apply(Command command) {
        ...
        if (command.environment.isGiven()) {
            ...
            env.clear();
            for (Map.Entry<hydra.core.system.EnvironmentVariable, String> e : command.environment.fromGiven().entrySet()) {
