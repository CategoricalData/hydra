...
public class FoldList extends PrimitiveFunction {
    public static final Name NAME = new Name("hydra.core.lib.eithers.foldList");
                ...
                for (Term item : items) {
                    ...
                    if (result.isLeft()) {
                        return Either.right(new Term.Either(new hydra.core.overlay.java.util.Either.Left<>(
                            ((hydra.core.overlay.java.util.Either.Left<Term, Term>) result).value)));
                    }
                    acc = ((hydra.core.overlay.java.util.Either.Right<Term, Term>) result).value;
                }
                return Either.right(new Term.Either(new hydra.core.overlay.java.util.Either.Right<>(acc)));
            });
    }
     ...
     */
    public static <A, B, Z> hydra.core.overlay.java.util.Either<Z, A> apply(
            Function<A, Function<B, hydra.core.overlay.java.util.Either<Z, A>>> fn,
            A init,
            List<B> items) {
    ...
    public static <A, B, Z> hydra.core.overlay.java.util.Either<Z, A> apply(
            BiFunction<A, B, hydra.core.overlay.java.util.Either<Z, A>> fn,
            A init,
            List<B> items) {
        A acc = init;
        for (B item : items) {
            hydra.core.overlay.java.util.Either<Z, A> result = fn.apply(acc, item);
            if (result.isLeft()) {
                return result;
            }
            acc = ((hydra.core.overlay.java.util.Either.Right<Z, A>) result).value;
        }
        return new hydra.core.overlay.java.util.Either.Right<>(acc);
    }
}
