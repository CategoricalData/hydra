...
public class IsEmpty extends PrimitiveFunction {
     ...
     */
    public Name name() {
        return hydra.lib.Sets.isEmpty().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply(arg -> Terms.boolean_(apply(arg)), hydra.core.extract.Core.set(graph, args.get(0)));
    }
