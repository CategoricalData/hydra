...
import hydra.core.util.Comparison;
...
import static hydra.core.overlay.java.dsl.Literals.uint64;

/**
 * A domain-specific language for constructing Hydra terms in Java.
 * Provides parity with Hydra.Core.Dsl.Terms (Haskell) and hydra.core.dsl.terms (Python).
 */
