...
public class ParseFloat64 extends PrimitiveFunction {
     ...
     * @return the function name "hydra.core.lib.literals.parseFloat64"
     */
    public Name name() {
        return hydra.core.lib.Literals.parseFloat64().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply((Function<String, Term>) s -> Terms.optional(apply(s).map(Terms::float64)), hydra.core.extract.Model.string(graph, args.get(0)));
    }
