 ...
 * (see {@code Hydra.Core.Overlay.Haskell.Lib.Math}) and the structural-dispatch pattern already used by
...
public final class NumericDispatch {
    ...
    public static Term binary(String opName, BinaryOp op, Term x, Term y) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": operands are not the same numeric kind");
    }
    ...
    public static Term unary(String opName, UnaryOp op, Term x) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": operand is not numeric");
    }
    ...
    private static IntegerValue rewrapInteger(String opName, IntegerValue ix, IntegerValue iy, BigInteger r) {
        if (ix.getClass() != iy.getClass()) {
            throw new IllegalStateException("hydra.core.lib.math." + opName + ": integer operands differ in precision");
        }
    ...
    public static <A> A applyNativeBinary(String opName, BinaryOp op, A a, A b) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": operand is not numeric: " + a);
    }
