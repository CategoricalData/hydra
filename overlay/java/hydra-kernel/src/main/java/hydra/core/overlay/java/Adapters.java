package hydra.core.overlay.java;

import hydra.core.coders.Adapter;
...
public class Adapters {
     ...
     */
    public static <T1, T2, T3, V1, V2, V3, E> Adapter<T1, T3, V1, V3, E> compose(
            Adapter<T1, T2, V1, V2, E> adapter1,
            Adapter<T2, T3, V2, V3, E> adapter2) {
     ...
     */
    public static <T1, T2, T3, V1, V2, V3, E> Function<T1, Either<E, Adapter<T1, T3, V1, V3, E>>> compose(
            Function<T1, Either<E, Adapter<T1, T2, V1, V2, E>>> constructor1,
            Function<T2, Either<E, Adapter<T2, T3, V2, V3, E>>> constructor2) {
        return t1 -> {
            Either<E, Adapter<T1, T2, V1, V2, E>> r1 = constructor1.apply(t1);
            if (r1.isLeft()) return Either.left(((Either.Left<E, Adapter<T1, T2, V1, V2, E>>) r1).value);
            Adapter<T1, T2, V1, V2, E> firstMile = ((Either.Right<E, Adapter<T1, T2, V1, V2, E>>) r1).value;
            Either<E, Adapter<T2, T3, V2, V3, E>> r2 = constructor2.apply(firstMile.target);
            if (r2.isLeft()) return Either.left(((Either.Left<E, Adapter<T2, T3, V2, V3, E>>) r2).value);
            Adapter<T2, T3, V2, V3, E> lastMile = ((Either.Right<E, Adapter<T2, T3, V2, V3, E>>) r2).value;
