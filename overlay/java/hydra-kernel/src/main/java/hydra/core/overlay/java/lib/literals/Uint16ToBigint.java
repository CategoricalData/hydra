...
public class Uint16ToBigint extends PrimitiveFunction {
     ...
     */
    public Name name() {
        return hydra.core.lib.Literals.uint16ToBigint().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply(s -> Terms.bigint(apply(s)), hydra.core.extract.Model.uint16(graph, args.get(0)));
    }
