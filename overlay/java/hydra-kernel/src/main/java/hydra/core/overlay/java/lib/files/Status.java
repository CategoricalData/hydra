...
import hydra.core.file.FileStatus;
import hydra.core.file.FileType;
...
public class Status extends PrimitiveFunction {
    ...
    public TypeScheme type() {
        return scheme(function(
            ...
            new hydra.core.model.Type.Effect(either(variable("hydra.core.error.file.FileError"), variable("hydra.core.file.FileStatus")))));
    }
