...
public abstract class PrimitiveFunction {
     ...
     * primitives (e.g. maybes.cases, logic.ifElse) override this. Mirrors Hydra.Core.Dsl.Prims.lazyArgs
     ...
     * Defaults to true; effect primitives (e.g. hydra.core.lib.system.getEnvironment, getTime,
     ...
     */
    public Term term() {
        return hydra.core.overlay.java.dsl.Terms.primitive(name());
    }
