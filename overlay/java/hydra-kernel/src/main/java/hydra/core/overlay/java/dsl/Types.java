...
import hydra.core.model.TypeClassConstraint;
 ...
 * Provides parity with Hydra.Core.Dsl.Types (Haskell) and hydra.core.dsl.types (Python).
 */
public interface Types {
     ...
     * Example: {@code polyConstrained(Map.of("a", Set.of(name("hydra.core.model.Eq"))), function(var("a"), var("a"), boolean_()))}
