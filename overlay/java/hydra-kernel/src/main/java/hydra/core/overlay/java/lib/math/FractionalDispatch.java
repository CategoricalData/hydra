...
public final class FractionalDispatch {
    ...
    public static Term binary(String opName, BinaryOp op, Term x, Term y) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": operands are not the same fractional kind");
    }
    ...
    private static Literal fractionalLiteral(String opName, Term term) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": expected a literal term");
    }
    ...
    private static FloatValue floatBinary(String opName, BinaryOp op, FloatValue fx, FloatValue fy) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": float operands differ in precision");
    }
    ...
    public static <A> A applyNativeBinary(String opName, BinaryOp op, A a, A b) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": operand is not fractional: " + a);
    }
}
