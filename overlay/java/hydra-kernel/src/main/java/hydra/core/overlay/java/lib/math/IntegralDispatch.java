 ...
 * (see {@code Hydra.Core.Overlay.Haskell.Lib.Math}) and {@link NumericDispatch}'s structural-dispatch
 ...
 * explicit guard — see {@code Hydra.Core.Overlay.Haskell.Lib.Math.maybeDivBounded}).
 */
public final class IntegralDispatch {
    ...
    private static Optional<Term> divModRem(IntegerValue ix, IntegerValue iy, DivKind kind) {
        if (ix.getClass() != iy.getClass()) {
            throw new IllegalStateException("hydra.core.lib.math." + kind + ": integer operands differ in precision");
        }
    ...
    private static IntegerValue integralLiteral(String opName, Term term) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": expected an integer literal term");
    }
    ...
    private static <A> Optional<A> applyNative(String opName, A x, A y, DivKind kind) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": operand is not integral: " + x);
    }
    ...
    private static BigInteger toBigIntegerNative(Object x) {
        ...
        throw new IllegalStateException("hydra.core.lib.math.even/odd: operand is not integral: " + x);
    }
    ...
    private static Number narrowToBoxed(String opName, Object like, BigInteger r) {
        ...
        throw new IllegalStateException("hydra.core.lib.math." + opName + ": unexpected integer box: " + like.getClass());
    }
}
