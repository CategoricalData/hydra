...
import static hydra.core.overlay.java.dsl.Types.int64;
 ...
 */
public class ParseInt64 extends PrimitiveFunction {
    /**
     * Returns the unique name identifying this primitive function.
     * @return the function name "hydra.core.lib.literals.parseInt64"
     */
    public Name name() {
        return hydra.core.lib.Literals.parseInt64().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply((Function<String, Term>) s -> Terms.optional(apply(s).map(Terms::int64)), hydra.core.extract.Model.string(graph, args.get(0)));
    }
