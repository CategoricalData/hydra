...
public class BigintToInt16 extends PrimitiveFunction {
     ...
     */
    public Name name() {
        return hydra.core.lib.Literals.bigintToInt16().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply(s -> Terms.int16(apply(s)), hydra.core.extract.Model.bigint(graph, args.get(0)));
    }
