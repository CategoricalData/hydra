...
public class PrintInt16 extends PrimitiveFunction {
     ...
     */
    public Name name() {
        return hydra.lib.Literals.printInt16().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply((Function<Short, Term>) s -> Terms.string(apply(s)), hydra.core.extract.Core.int16(graph, args.get(0)));
    }
