...
public class ParseString extends PrimitiveFunction {
     ...
     * @return the function name "hydra.core.lib.literals.parseString"
     */
    public Name name() {
        return hydra.core.lib.Literals.parseString().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.core.overlay.java.lib.eithers.Map.apply((Function<String, Term>) s -> Terms.optional(apply(s).map(Terms::string)), hydra.core.extract.Model.string(graph, args.get(0)));
    }
