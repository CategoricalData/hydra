...
public class Compare extends PrimitiveFunction {
    ...
    public TypeScheme type() {
        return schemeOrd("x", function(Types.var("x"), Types.var("x"), Types.apply(Types.var("hydra.core.util.Comparison"))));
    }
     ...
     * {@link hydra.core.overlay.java.util.Comparing}.
     */
    ...
    public static <A> Comparison apply(A left, A right) {
        int cmp = hydra.core.overlay.java.util.Comparing.compare(left, right);
        if (cmp < 0) {
