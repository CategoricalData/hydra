...
import static hydra.overlay.java.dsl.Types.uint32;
...
public class ParseUint32 extends PrimitiveFunction {
     ...
     * @return the function name "hydra.lib.literals.parseUint32"
     */
    public Name name() {
        return hydra.lib.Literals.parseUint32().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Map.apply((Function<String, Term>) s -> Terms.optional(apply(s).map(Terms::uint32)), hydra.extract.Core.string(graph, args.get(0)));
    }
