...
import hydra.overlay.java.lib.PrimitiveType;
...
public abstract class EqualityFunction<T> extends PrimitiveFunction {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph ->
            hydra.overlay.java.lib.eithers.Bind.apply(expect.apply(graph, args.get(0)), arg0 ->
                hydra.overlay.java.lib.eithers.Map.apply(arg1 ->
