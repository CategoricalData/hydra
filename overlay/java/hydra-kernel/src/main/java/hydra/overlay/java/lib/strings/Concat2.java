...
public class Concat2 extends PrimitiveFunction {
     ...
     * @return the name "hydra.lib.strings.concat2"
     */
    public Name name() {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Bind.apply(hydra.extract.Core.string(graph, args.get(0)), l -> hydra.overlay.java.lib.eithers.Map.apply(r -> Terms.string(Concat2.apply(l, r)), hydra.extract.Core.string(graph, args.get(1))));
    }
