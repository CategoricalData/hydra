...
public class PrintUint32 extends PrimitiveFunction {
     ...
     * @return the function name "hydra.lib.literals.printUint32"
     */
    public Name name() {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Map.apply((Function<Long, Term>) l -> Terms.string(apply(l)), hydra.extract.Core.uint32(graph, args.get(0)));
    }
