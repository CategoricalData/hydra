...
public class Libraries {
    ...
    private static List<PrimitiveFunction> filesPrimitives() {
        return Arrays.asList(
                ...
                new hydra.overlay.java.lib.files.CreateSymlink(),
                ...
                new hydra.overlay.java.lib.files.ReadSymlink(),
    ...
    private static List<PrimitiveFunction> listsPrimitives() {
        return Arrays.asList(
                ...
                new hydra.overlay.java.lib.lists.IsEmpty(),
    ...
    private static List<PrimitiveFunction> literalsPrimitives() {
        return Arrays.asList(
                ...
                new hydra.overlay.java.lib.literals.BinaryToBase64(),
                ...
                new hydra.overlay.java.lib.literals.ParseBigint(),
                new hydra.overlay.java.lib.literals.ParseDecimal(),
                new hydra.overlay.java.lib.literals.ParseFloat32(),
                new hydra.overlay.java.lib.literals.ParseFloat64(),
                new hydra.overlay.java.lib.literals.ParseInt16(),
                new hydra.overlay.java.lib.literals.ParseInt32(),
                new hydra.overlay.java.lib.literals.ParseInt64(),
                new hydra.overlay.java.lib.literals.ParseInt8(),
                new hydra.overlay.java.lib.literals.ParseUint16(),
                new hydra.overlay.java.lib.literals.ParseUint32(),
                new hydra.overlay.java.lib.literals.ParseUint64(),
                new hydra.overlay.java.lib.literals.ParseUint8(),
                new hydra.overlay.java.lib.literals.PrintBigint(),
                new hydra.overlay.java.lib.literals.PrintDecimal(),
                new hydra.overlay.java.lib.literals.PrintFloat32(),
                new hydra.overlay.java.lib.literals.PrintFloat64(),
                new hydra.overlay.java.lib.literals.PrintInt16(),
                new hydra.overlay.java.lib.literals.PrintInt32(),
                new hydra.overlay.java.lib.literals.PrintInt64(),
                new hydra.overlay.java.lib.literals.PrintInt8(),
                new hydra.overlay.java.lib.literals.PrintUint16(),
                new hydra.overlay.java.lib.literals.PrintUint32(),
                new hydra.overlay.java.lib.literals.PrintUint64(),
                new hydra.overlay.java.lib.literals.PrintUint8(),
                new hydra.overlay.java.lib.literals.Base64ToBinary(),
    ...
    private static List<PrimitiveFunction> mapsPrimitives() {
        return Arrays.asList(
                ...
                new hydra.overlay.java.lib.maps.IsEmpty(),
    ...
    private static List<PrimitiveFunction> setsPrimitives() {
        return Arrays.asList(
                ...
                new hydra.overlay.java.lib.sets.IsEmpty(),
    ...
    private static List<PrimitiveFunction> stringsPrimitives() {
        return Arrays.asList(
                ...
                new hydra.overlay.java.lib.strings.IsEmpty(),
