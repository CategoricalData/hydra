...
public class Bind extends PrimitiveFunction {
     ...
     * @return the name "hydra.lib.optionals.bind"
     */
    public Name name() {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Bind.apply(hydra.extract.Core.optionalTerm(t -> Either.right(t), graph, args.get(0)), arg -> {
                if (arg.isNone()) {
