...
public class PrintInt32 extends PrimitiveFunction {
     ...
     * @return the function name "hydra.lib.literals.printInt32"
     */
    public Name name() {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Map.apply((Function<Integer, Term>) s -> Terms.string(apply(s)), hydra.extract.Core.int32(graph, args.get(0)));
    }
