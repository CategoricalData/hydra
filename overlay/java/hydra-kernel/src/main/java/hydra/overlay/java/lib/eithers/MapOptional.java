...
public class MapOptional extends PrimitiveFunction {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Bind.apply(hydra.extract.Core.optionalTerm(t -> Either.right(t), graph, args.get(1)), maybe -> {
                Term fn = args.get(0);
                if (maybe.isNone()) {
                    return Either.right(new Term.Either(new hydra.overlay.java.util.Either.Right<>(Terms.optional(Optional.none()))));
                }
                ...
                return Either.right(new Term.Either(new hydra.overlay.java.util.Either.Right<>(
                    Terms.optional(Optional.given(((hydra.overlay.java.util.Either.Right<Term, Term>) inner).value)))));
            });
    }
     ...
     */
    public static <A, B, Z> hydra.overlay.java.util.Either<Z, Optional<B>> apply(
            Function<A, hydra.overlay.java.util.Either<Z, B>> fn,
            Optional<A> maybe) {
        if (maybe.isNone()) {
            return new hydra.overlay.java.util.Either.Right<>(Optional.none());
        } else {
            A val = maybe.orElse(null);
            hydra.overlay.java.util.Either<Z, B> result = fn.apply(val);
            if (result.isLeft()) {
                return new hydra.overlay.java.util.Either.Left<>(((hydra.overlay.java.util.Either.Left<Z, B>) result).value);
            }
            return new hydra.overlay.java.util.Either.Right<>(Optional.given(((hydra.overlay.java.util.Either.Right<Z, B>) result).value));
        }
    }
     ...
     */
    public static <A, B, Z> Function<Optional<A>, hydra.overlay.java.util.Either<Z, Optional<B>>> apply(
            Function<A, hydra.overlay.java.util.Either<Z, B>> fn) {
