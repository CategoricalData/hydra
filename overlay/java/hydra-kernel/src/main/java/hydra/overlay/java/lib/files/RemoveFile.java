 ...
 * Remove a file.
 */
public class RemoveFile extends PrimitiveFunction {
    /**
     * Returns the name of this primitive function.
     * @return the name "hydra.lib.files.removeFile"
     */
    public Name name() {
     ...
     * @return the type scheme FilePath -&gt; effect&lt;either&lt;FileError, unit&gt;&gt;
     */
    @Override
     ...
     */
    public static Either<FileError, Void> apply(FilePath path) {
