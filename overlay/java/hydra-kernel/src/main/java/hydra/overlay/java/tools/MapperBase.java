...
public abstract class MapperBase {
    ...
    protected static <C1, C2, T> Optional<T> optional(C1 c1, Function<C1, C2> accessor, Function<C2, T> constructor) {
        ...
        return c2 == null ? Optional.none() : Optional.given(constructor.apply(c2));
    }
     ...
     */
    protected static <C1, C2, T> Optional<T> optional(
            C1 c1, int index, Function<C1, List<C2>> accessor, Function<C2, T> constructor) {
        List<C2> c2 = accessor.apply(c1);
        return null == c2 || index >= c2.size() ? Optional.none() : Optional.given(constructor.apply(c2.get(index)));
    }
    ...
    protected static <C0, P0, P> Function<P0, Optional<P>> matchCase(
            Function<P0, C0> getter,
            P parent) {
        return ctx -> null == getter.apply(ctx) ? Optional.none() : Optional.given(parent);
    }
