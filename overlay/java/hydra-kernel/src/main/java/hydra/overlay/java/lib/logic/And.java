...
public class And extends PrimitiveFunction {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Bind.apply(hydra.extract.Core.boolean_(graph, args.get(0)), b1 -> hydra.overlay.java.lib.eithers.Map.apply(b2 -> Terms.boolean_(And.apply(b1, b2)), hydra.extract.Core.boolean_(graph, args.get(1))));
    }
