...
public class WithDefault extends PrimitiveFunction {
     ...
     * @return the name "hydra.lib.optionals.withDefault"
     */
    public Name name() {
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Bind.apply(Either.right(args.get(0)), defaultTerm ->
            hydra.overlay.java.lib.eithers.Bind.apply(hydra.extract.Core.optionalTerm(t -> Either.right(t), graph, args.get(1)), opt ->
