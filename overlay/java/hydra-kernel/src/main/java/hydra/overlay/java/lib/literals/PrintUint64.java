...
public class PrintUint64 extends PrimitiveFunction {
     ...
     * @return the function name "hydra.lib.literals.printUint64"
     */
    public Name name() {
        return hydra.lib.Literals.printUint64().name;
    }
    ...
    protected Function<List<Term>, Function<Graph, Either<Error_, Term>>> implementation() {
        return args -> graph -> hydra.overlay.java.lib.eithers.Map.apply((Function<BigInteger, Term>) i -> Terms.string(apply(i)), hydra.extract.Core.uint64(graph, args.get(0)));
    }
