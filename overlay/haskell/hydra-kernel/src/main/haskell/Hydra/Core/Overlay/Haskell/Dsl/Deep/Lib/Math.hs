-- | Deep term DSL for the hydra.core.lib.math library.
--
...
-- Hydra.Core.Overlay.Haskell.Lib.Math which works at the Haskell value level (TypedTerm Double, etc.).

module Hydra.Core.Overlay.Haskell.Dsl.Deep.Lib.Math where

import Hydra.Kernel
import qualified Hydra.Core.Overlay.Haskell.Dsl.Meta.Core as Core
import Hydra.Core.Overlay.Haskell.Dsl.Phantoms (encodedName)
