...
module Hydra.Core.Overlay.Haskell.Dsl.Phantoms (
  module Hydra.Core.Overlay.Haskell.Dsl.Phantoms,
  module Hydra.Core.Overlay.Haskell.Dsl.Meta.Literals,
  module Hydra.Core.Overlay.Haskell.AsTerm,
) where

import Hydra.Kernel
import Hydra.Core.Overlay.Haskell.AsTerm
import Hydra.Core.Overlay.Haskell.Dsl.Common
import Hydra.Core.Overlay.Haskell.Dsl.Meta.Literals
import qualified Hydra.Core.Overlay.Haskell.Dsl.Annotations as Ann
...
-- | Get a reference to a decoder function in hydra.core.decode.model for a given type name
...
-- | Get a reference to an encoder function in hydra.core.encode.model for a given type name
...
optCases arg ifNothing ifJust = primitive3 (Name "hydra.core.lib.optionals.match") arg ifNothing (asTerm ifJust)
...
-- Example: primitive (Name "hydra.core.lib.strings.length")
...
-- Example: member = deprecatedSince "0.18" "hydra.core.lib.lists.member" $ define "elem" ...
...
-- Example: toPrimitiveNoDefault "Current UNIX time, in seconds" sig (Name "hydra.core.lib.math.currentUnixTimeSeconds") []
