...
import Hydra.Kernel
import Hydra.Core.Overlay.Haskell.Dsl.Prims as Prims
import qualified Hydra.Core.Overlay.Haskell.Dsl.Terms as Terms
import qualified Hydra.Core.Overlay.Haskell.Dsl.Types as Types

import qualified Hydra.Core.Overlay.Haskell.Lib.Chars as Chars
import qualified Hydra.Core.Overlay.Haskell.Lib.Eithers as Eithers
import qualified Hydra.Core.Overlay.Haskell.Lib.Functions as Functions
import qualified Hydra.Core.Overlay.Haskell.Lib.Hashing as Hashing
...
import qualified Hydra.Core.Overlay.Haskell.Lib.Regex as Regex
...
import qualified Hydra.Core.Overlay.Haskell.Lib.Text as Text
import qualified Hydra.Core.Lib.Chars as DefChars
...
hydraLibFiles = standardLibrary [
    ...
    unsupportedEffectPrimitive DefFiles.createSymlink,
    ...
    unsupportedEffectPrimitive DefFiles.readSymlink,
...
-- hydra.core.lib.equality.equal / hydra.core.lib.ordering.compare (+gt/gte/lt/lte/max/min) are
...
--
-- Kernel-type DSL constructors (Hydra.Core.Dsl.Model / Hydra.Core.Overlay.Haskell.Dsl.Meta.Terms)
-- build hydra.core.model.Term/Literal values via the generic, reflective TermInject/Injection
-- encoding rather than the native Term/Literal ADT constructors directly -- e.g. a
-- decimal literal built via the DSL is
-- TermInject(Injection{"hydra.core.model.Term", Field{"literal",
--   TermInject(Injection{"hydra.core.model.Literal", Field{"decimal", <native TermLiteral
--     (LiteralDecimal sci)>}})}}).
...
-- constructor declaration order -- see Hydra.Core.Model), decimals by numeric value then scale.
--
...
termCompareOrdering x y
  ...
  | otherwise = case (x, y) of
    ...
    -- Hydra.Core.Model mirrors the DSL, and the payload itself was checked above for the
...
hydraLibLiterals = standardLibrary [
  ...
  prim1 DefLiterals.parseBigint       Literals.parseBigint       string (optional bigint),
  prim1 DefLiterals.parseBoolean       Literals.parseBoolean       string (optional boolean),
  prim1 DefLiterals.parseDecimal      Literals.parseDecimal      string (optional decimal),
  prim1 DefLiterals.parseFloat32      Literals.parseFloat32      string (optional float32),
  prim1 DefLiterals.parseFloat64      Literals.parseFloat64      string (optional float64),
  prim1 DefLiterals.parseInt8         Literals.parseInt8         string (optional int8),
  prim1 DefLiterals.parseInt16        Literals.parseInt16        string (optional int16),
  prim1 DefLiterals.parseInt32        Literals.parseInt32        string (optional int32),
  prim1 DefLiterals.parseInt64        Literals.parseInt64        string (optional int64),
  prim1 DefLiterals.parseString        Literals.parseString        string (optional string),
  prim1 DefLiterals.parseUint8        Literals.parseUint8        string (optional uint8),
  prim1 DefLiterals.parseUint16       Literals.parseUint16       string (optional uint16),
  prim1 DefLiterals.parseUint32       Literals.parseUint32       string (optional uint32),
  prim1 DefLiterals.parseUint64       Literals.parseUint64       string (optional uint64),
  prim1 DefLiterals.printBigint       Literals.printBigint       bigint string,
  prim1 DefLiterals.printBoolean       Literals.printBoolean       boolean string,
  prim1 DefLiterals.printDecimal      Literals.printDecimal      decimal string,
  prim1 DefLiterals.printFloat32      Literals.printFloat32      float32 string,
  prim1 DefLiterals.printFloat64      Literals.printFloat64      float64 string,
  prim1 DefLiterals.printInt8         Literals.printInt8         int8 string,
  prim1 DefLiterals.printInt16        Literals.printInt16        int16 string,
  prim1 DefLiterals.printInt32        Literals.printInt32        int32 string,
  prim1 DefLiterals.printInt64        Literals.printInt64        int64 string,
  prim1 DefLiterals.printString        Literals.printString        string string,
  prim1 DefLiterals.printUint8        Literals.printUint8        uint8 string,
  prim1 DefLiterals.printUint16       Literals.printUint16       uint16 string,
  prim1 DefLiterals.printUint32       Literals.printUint32       uint32 string,
  prim1 DefLiterals.printUint64       Literals.printUint64       uint64 string,
...
hydraLibMaps = standardLibrary [
    ...
    prim1     DefMaps.isEmpty         Maps.isEmpty           mapKv boolean,
...
hydraLibSets = standardLibrary [
    ...
    prim1     DefSets.isEmpty      Sets.isEmpty      (set x_) boolean,
...
hydraLibStrings = standardLibrary [
  ...
  prim2 DefStrings.charAt Strings.charAt int32 string (optional int32),
  prim1 DefStrings.isEmpty     Strings.isEmpty     string boolean,
...
-- | Assemble a library from its primitives. The library's module name (e.g. "hydra.core.lib.chars")
...
standardLibrary prims = Library {
  libraryName = ns,
  libraryPrefix = L.drop (L.length ("hydra.core.lib." :: String)) $ unModuleName ns,
