-- | Haskell-specific convenience layer over the generated Hydra.Core.Dsl.Variants module.
-- Adds Haskell enum -> TypedTerm converter functions.

module Hydra.Core.Overlay.Haskell.Dsl.Meta.Variants (
  module Hydra.Core.Dsl.Variants,
  module Hydra.Core.Overlay.Haskell.Dsl.Meta.Variants,
) where

import Hydra.Kernel
import Hydra.Core.Overlay.Haskell.Dsl.Phantoms
import Hydra.Core.Dsl.Variants
