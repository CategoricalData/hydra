-- | Haskell implementations of hydra.core.lib.functions primitives.

module Hydra.Core.Overlay.Haskell.Lib.Functions where
...
absurd :: a -> b
absurd _ = P.error "hydra.core.lib.functions.absurd: void has no inhabitants"
