...
module Hydra.Core.Overlay.Haskell.Dsl.Types where

import Prelude hiding (product)

import Hydra.Core.Model
import Hydra.Core.Overlay.Haskell.AsType
...
-- Example: polyConstrained [("a", [Name "hydra.core.model.Eq"])] (var "a" --> var "a" --> boolean)
