...
module Hydra.Core.Overlay.Haskell.Dsl.Terms where

import Hydra.Core.Constants
import Hydra.Core.Model
import Hydra.Core.Graph
import Hydra.Core.Packaging (PrimitiveDefinition, primitiveDefinitionName)
...
first :: Term
first = primitive $ Name "hydra.core.lib.pairs.first"
...
second :: Term
second = primitive $ Name "hydra.core.lib.pairs.second"
