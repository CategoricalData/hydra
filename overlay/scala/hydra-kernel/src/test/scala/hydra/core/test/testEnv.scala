...
package hydra.core.test.testEnv
...
// at the DSL level.
private var cachedGraph: hydra.core.graph.Graph = null
...
def testGraph[T0, T1](testTypes: Map[hydra.core.model.Name, hydra.core.model.Type])
             (testTerms: Map[hydra.core.model.Name, hydra.core.model.Term]): hydra.core.graph.Graph = {
  if (cachedGraph == null) {
...
lazy val testContext: hydra.core.typing.InferenceContext = hydra.core.typing.InferenceContext(
