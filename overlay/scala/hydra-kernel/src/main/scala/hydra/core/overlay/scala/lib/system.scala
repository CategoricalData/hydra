...
import hydra.core.system.{Command, ProcessResult}

import java.io.{File, IOException}

/**
 * Scala implementations of hydra.core.lib.system primitives (#498).
 *
 ...
 *
 * Wrapped string/int types (hydra.core.file.FilePath, hydra.core.system.EnvironmentVariable, hydra.core.system.StatusCode)
...
object system:
  ...
  def getTime: hydra.core.time.Timespec =
    val now = java.time.Instant.now()
    hydra.core.time.Timespec(now.getEpochSecond, now.getNano.toLong)
