// Package math implements the hydra.lib.math primitives.
//
...
// distinct from Div above: hydra.lib.math.div is integral and total
// (optional<x>), while hydra.lib.math.divide is fractional and total in the
