// Package functions implements the hydra.lib.functions primitives (basic
...
func Absurd(v any) any {
	panic("hydra.lib.functions.absurd: called with a value of the uninhabited void type")
}
