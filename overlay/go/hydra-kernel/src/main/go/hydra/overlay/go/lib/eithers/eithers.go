// Package eithers implements the hydra.lib.eithers primitives over util.Either.
//
...
//
// Named for hydra.lib.eithers.foldList; there is no eithers.foldl primitive, so
