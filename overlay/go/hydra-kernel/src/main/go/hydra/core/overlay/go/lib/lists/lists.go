// Package lists implements the hydra.core.lib.lists primitives.
//
...
// The following were added/split into hydra.core.lib.lists by #417/#566; semantics
// mirror the authoritative Haskell overlay (Hydra.Core.Overlay.Haskell.Lib.Lists).
