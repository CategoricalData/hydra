// Package literals implements the hydra.core.lib.literals primitives: conversions
...
func Base64ToBinary(s any) any {
	...
	if err != nil {
		panic("hydra.core.lib.literals.base64ToBinary: invalid base64: " + err.Error())
	}
	return b
}
...
// hydra.core.lib.literals.parse* surface, on the same all-any Native Contract v1 as
