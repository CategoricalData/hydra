...
def dataGraphToDefinitions(constraints: hydra.coders.LanguageConstraints)(doInfer: Boolean)(doExpand: Boolean)(doHoistCaseStatements: Boolean)(doHoistPolymorphicLetBindings: Boolean)(originalBindings: Seq[hydra.core.Binding])(graph0: hydra.graph.Graph)(namespaces: Seq[hydra.module.Namespace])(cx: hydra.context.Context): Either[scala.Predef.String,
  ...
  def hoistCases(bindings: Seq[hydra.core.Binding]): Seq[hydra.core.Binding] =
    ...
    val hoisted: Seq[hydra.core.Binding] = hydra.hoisting.hoistCaseStatementsInGraph(unshadowed0)
    val term1: hydra.core.Term = hydra.core.Term.let(hydra.core.Let(hoisted, hydra.core.Term.unit))
  ...
  def hoistPoly(bindings: Seq[hydra.core.Binding]): Seq[hydra.core.Binding] =
    {
    val letBefore: hydra.core.Let = hydra.core.Let(bindings, hydra.core.Term.unit)
    val letAfter: hydra.core.Let = hydra.hoisting.hoistPolymorphicLetBindings(isParentBinding)(letBefore)
    (letAfter.bindings)
  }
...
def termAlternatives(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[scala.Predef.String, Seq[hydra.core.Term]] =
  ...
  case hydra.core.Term.typeApplication(v_Term_typeApplication_ta) => {
    val term2: hydra.core.Term = (v_Term_typeApplication_ta.body)
    Right(Seq(term2))
  }
  ...
  case hydra.core.Term.wrap(v_Term_wrap_wt) => {
    val term2: hydra.core.Term = (v_Term_wrap_wt.body)
    Right(Seq(term2))
  }
  case _ => Right(Seq())
...
def typeAlternatives(`type`: hydra.core.Type): Seq[hydra.core.Type] =
  ...
  case hydra.core.Type.annotated(v_Type_annotated_at) => {
    val type2: hydra.core.Type = (v_Type_annotated_at.body)
    Seq(type2)
  }
