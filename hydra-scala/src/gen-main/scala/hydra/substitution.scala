...
def substInContext(subst: hydra.typing.TypeSubst)(cx: hydra.graph.Graph): hydra.graph.Graph =
  ...
  lazy val cx2: hydra.graph.Graph = hydra.graph.Graph(cx.boundTerms, newBoundTypes, (cx.classConstraints),
     (cx.lambdaVariables), (cx.metadata), (cx.primitives), (cx.schemaTypes), (cx.typeVariables))
  hydra.graph.Graph(cx2.boundTerms, (cx2.boundTypes), newClassConstraints, (cx2.lambdaVariables), (cx2.metadata),
     (cx2.primitives), (cx2.schemaTypes), (cx2.typeVariables))
}
