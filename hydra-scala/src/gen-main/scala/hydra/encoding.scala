...
def encoderType(typ: hydra.core.Type): hydra.core.Type =
  {
  val resultType: hydra.core.Type = hydra.encoding.encoderFullResultType(typ)
  val baseType: hydra.core.Type = hydra.core.Type.function(hydra.core.FunctionType(resultType, hydra.core.Type.variable("hydra.core.Term")))
...
def encoderTypeNamed(ename: hydra.core.Name)(typ: hydra.core.Type): hydra.core.Type =
  {
  val resultType: hydra.core.Type = hydra.encoding.encoderFullResultTypeNamed(ename)(typ)
  val baseType: hydra.core.Type = hydra.core.Type.function(hydra.core.FunctionType(resultType, hydra.core.Type.variable("hydra.core.Term")))
  hydra.encoding.prependForallEncoders(baseType)(typ)
}
