...
def encodeBinding(cx: hydra.context.Context)(graph: hydra.graph.Graph)(b: hydra.core.Binding): Either[hydra.context.InContext[hydra.errors.DecodingError], hydra.core.Binding] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.DecodingError], hydra.core.Type, hydra.core.Binding](hydra.lib.eithers.bimap[hydra.errors.DecodingError, hydra.core.Type, hydra.context.InContext[hydra.errors.DecodingError], hydra.core.Type]((_wc_e: hydra.errors.DecodingError) => hydra.context.InContext(_wc_e, cx))((_wc_a: hydra.core.Type) => _wc_a)(hydra.decode.core.`type`(graph)(b.term)))((typ: hydra.core.Type) =>
  Right(hydra.core.Binding(hydra.encoding.encodeBindingName(b.name), hydra.encoding.encodeTypeNamed(b.name)(typ), Some(hydra.encoding.encoderTypeSchemeNamed(b.name)(typ)))))

def encodeBindingName(n: hydra.core.Name): hydra.core.Name =
  hydra.lib.logic.ifElse[hydra.core.Name](hydra.lib.logic.not(hydra.lib.lists.`null`[scala.Predef.String](hydra.lib.lists.tail[scala.Predef.String](hydra.lib.strings.splitOn(".")(n)))))(hydra.lib.strings.intercalate(".")(hydra.lib.lists.concat2[scala.Predef.String](Seq("hydra", "encode"))(hydra.lib.lists.concat2[scala.Predef.String](hydra.lib.lists.tail[scala.Predef.String](hydra.lib.lists.init[scala.Predef.String](hydra.lib.strings.splitOn(".")(n))))(Seq(hydra.formatting.decapitalize(hydra.names.localNameOf(n)))))))(hydra.formatting.decapitalize(hydra.names.localNameOf(n)))
...
def encoderCollectOrdVars(typ: hydra.core.Type): Seq[hydra.core.Name] =
  ...
  case hydra.core.Type.map(v_Type_map_mt) => hydra.lib.lists.concat[hydra.core.Name](Seq(hydra.encoding.encoderCollectTypeVarsFromType(v_Type_map_mt.keys), hydra.encoding.encoderCollectOrdVars(v_Type_map_mt.keys), hydra.encoding.encoderCollectOrdVars(v_Type_map_mt.values)))
  ...
  case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.lists.concat[hydra.core.Name](hydra.lib.lists.map[hydra.core.FieldType, Seq[hydra.core.Name]]((ft: hydra.core.FieldType) => hydra.encoding.encoderCollectOrdVars(ft.`type`))(v_Type_record_rt))
  ...
  case hydra.core.Type.union(v_Type_union_rt) => hydra.lib.lists.concat[hydra.core.Name](hydra.lib.lists.map[hydra.core.FieldType, Seq[hydra.core.Name]]((ft: hydra.core.FieldType) => hydra.encoding.encoderCollectOrdVars(ft.`type`))(v_Type_union_rt))
...
def encoderCollectTypeVarsFromType(typ: hydra.core.Type): Seq[hydra.core.Name] =
  ...
  case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.lists.concat[hydra.core.Name](hydra.lib.lists.map[hydra.core.FieldType, Seq[hydra.core.Name]]((ft: hydra.core.FieldType) => hydra.encoding.encoderCollectTypeVarsFromType(ft.`type`))(v_Type_record_rt))
  case hydra.core.Type.set(v_Type_set_elemType) => hydra.encoding.encoderCollectTypeVarsFromType(v_Type_set_elemType)
  case hydra.core.Type.union(v_Type_union_rt) => hydra.lib.lists.concat[hydra.core.Name](hydra.lib.lists.map[hydra.core.FieldType, Seq[hydra.core.Name]]((ft: hydra.core.FieldType) => hydra.encoding.encoderCollectTypeVarsFromType(ft.`type`))(v_Type_union_rt))
...
def encoderFullResultType(typ: hydra.core.Type): hydra.core.Type =
  ...
  case hydra.core.Type.application(v_Type_application_appType) => hydra.core.Type.application(hydra.core.ApplicationType(hydra.encoding.encoderFullResultType(v_Type_application_appType.function), (v_Type_application_appType.argument)))
  ...
  case hydra.core.Type.literal(_) => hydra.core.Type.variable("hydra.core.Literal")
  ...
  case hydra.core.Type.record(_) => hydra.core.Type.variable("hydra.core.Term")
  ...
  case hydra.core.Type.union(_) => hydra.core.Type.variable("hydra.core.Term")
  ...
  case hydra.core.Type.wrap(_) => hydra.core.Type.variable("hydra.core.Term")
...
def encoderFullResultTypeNamed(ename: hydra.core.Name)(typ: hydra.core.Type): hydra.core.Type =
  ...
  case hydra.core.Type.maybe(v_Type_maybe_elemType) => hydra.core.Type.maybe(hydra.encoding.encoderFullResultType(v_Type_maybe_elemType))
  case hydra.core.Type.pair(v_Type_pair_pt) => hydra.core.Type.pair(hydra.core.PairType(hydra.encoding.encoderFullResultType(v_Type_pair_pt.first), hydra.encoding.encoderFullResultType(v_Type_pair_pt.second)))
  case hydra.core.Type.record(_) => hydra.core.Type.variable(ename)
  case hydra.core.Type.set(v_Type_set_elemType) => hydra.core.Type.set(hydra.encoding.encoderFullResultType(v_Type_set_elemType))
  case hydra.core.Type.union(_) => hydra.core.Type.variable(ename)
  case hydra.core.Type.unit => hydra.core.Type.unit
  case hydra.core.Type.variable(v_Type_variable_name) => hydra.core.Type.variable(v_Type_variable_name)
  case hydra.core.Type.void => hydra.core.Type.void
  case hydra.core.Type.wrap(_) => hydra.core.Type.variable(ename)
  case _ => hydra.core.Type.variable("hydra.core.Term")
...
def encoderTypeScheme(typ: hydra.core.Type): hydra.core.TypeScheme =
  ...
  lazy val constraints: Option[Map[hydra.core.Name, hydra.core.TypeVariableMetadata]] = hydra.lib.logic.ifElse[Option[Map[hydra.core.Name, hydra.core.TypeVariableMetadata]]](hydra.lib.lists.`null`[hydra.core.Name](ordVars))(None)(Some(hydra.lib.maps.fromList[hydra.core.Name, hydra.core.TypeVariableMetadata](hydra.lib.lists.map[hydra.core.Name, Tuple2[hydra.core.Name, hydra.core.TypeVariableMetadata]]((v: hydra.core.Name) =>
...
def prependForallEncoders(baseType: hydra.core.Type)(typ: hydra.core.Type): hydra.core.Type =
  ...
  case hydra.core.Type.forall(v_Type_forall_ft) => hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.variable(v_Type_forall_ft.parameter), hydra.core.Type.variable("hydra.core.Term"))), hydra.encoding.prependForallEncoders(baseType)(v_Type_forall_ft.body)))
  case _ => baseType

def encodeFieldValue(typeName: hydra.core.Name)(fieldName: hydra.core.Name)(fieldType: hydra.core.Type): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("y", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("union", hydra.encoding.encodeInjection(typeName)(fieldName)(hydra.core.Term.application(hydra.core.Application(hydra.encoding.encodeType(fieldType), hydra.core.Term.variable("y"))))))))))
...
def encodeInjection(typeName: hydra.core.Name)(fieldName: hydra.core.Name)(fieldTerm: hydra.core.Term): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.core.Injection", Seq(hydra.core.Field("typeName", hydra.encoding.encodeName(typeName)), hydra.core.Field("field", hydra.core.Term.record(hydra.core.Record("hydra.core.Field", Seq(hydra.core.Field("name", hydra.encoding.encodeName(fieldName)), hydra.core.Field("term", fieldTerm))))))))
...
def encodeListType(elemType: hydra.core.Type): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("xs", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("list", hydra.core.Term.application(hydra.core.Application(hydra.core.Term.application(hydra.core.Application(hydra.core.Term.function(hydra.core.Function.primitive("hydra.lib.lists.map")), hydra.encoding.encodeType(elemType))), hydra.core.Term.variable("xs")))))))))

def encodeLiteralType(v1: hydra.core.LiteralType): hydra.core.Term =
  v1 match
  case hydra.core.LiteralType.binary => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("literal", hydra.core.Term.union(hydra.core.Injection("hydra.core.Literal", hydra.core.Field("binary", hydra.core.Term.variable("x"))))))))))
  case hydra.core.LiteralType.boolean => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("literal", hydra.core.Term.union(hydra.core.Injection("hydra.core.Literal", hydra.core.Field("boolean", hydra.core.Term.variable("x"))))))))))
  case hydra.core.LiteralType.string => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("literal", hydra.core.Term.union(hydra.core.Injection("hydra.core.Literal", hydra.core.Field("string", hydra.core.Term.variable("x"))))))))))
  case hydra.core.LiteralType.integer(v_LiteralType_integer_intType) => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("literal", hydra.core.Term.union(hydra.core.Injection("hydra.core.Literal", hydra.core.Field("integer", hydra.encoding.encodeIntegerValue(v_LiteralType_integer_intType)(hydra.core.Term.variable("x")))))))))))
  case hydra.core.LiteralType.float(v_LiteralType_float_floatType) => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("literal", hydra.core.Term.union(hydra.core.Injection("hydra.core.Literal", hydra.core.Field("float", hydra.encoding.encodeFloatValue(v_LiteralType_float_floatType)(hydra.core.Term.variable("x")))))))))))
...
def encodeEitherType(et: hydra.core.EitherType): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("e", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("either", hydra.core.Term.application(hydra.core.Application(hydra.core.Term.application(hydra.core.Application(hydra.core.Term.application(hydra.core.Application(hydra.core.Term.function(hydra.core.Function.primitive("hydra.lib.eithers.bimap")), hydra.encoding.encodeType(et.left))), hydra.encoding.encodeType(et.right))), hydra.core.Term.variable("e")))))))))

def encodeForallType(ft: hydra.core.ForallType): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda(hydra.encoding.encodeBindingName(ft.parameter), None, hydra.encoding.encodeType(ft.body))))

def encodeMapType(mt: hydra.core.MapType): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("m", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("map", hydra.core.Term.application(hydra.core.Application(hydra.core.Term.application(hydra.core.Application(hydra.core.Term.application(hydra.core.Application(hydra.core.Term.function(hydra.core.Function.primitive("hydra.lib.maps.bimap")), hydra.encoding.encodeType(mt.keys))), hydra.encoding.encodeType(mt.values))), hydra.core.Term.variable("m")))))))))

def encodeOptionalType(elemType: hydra.core.Type): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("opt", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("maybe", hydra.core.Term.application(hydra.core.Application(hydra.core.Term.application(hydra.core.Application(hydra.core.Term.function(hydra.core.Function.primitive("hydra.lib.maybes.map")), hydra.encoding.encodeType(elemType))), hydra.core.Term.variable("opt")))))))))
...
def encodeRecordTypeNamed(ename: hydra.core.Name)(rt: Seq[hydra.core.FieldType]): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("record", hydra.core.Term.record(hydra.core.Record("hydra.core.Record", Seq(hydra.core.Field("typeName", hydra.encoding.encodeName(ename)), hydra.core.Field("fields", hydra.core.Term.list(hydra.lib.lists.map[hydra.core.FieldType, hydra.core.Term]((ft: hydra.core.FieldType) =>
  hydra.core.Term.record(hydra.core.Record("hydra.core.Field", Seq(hydra.core.Field("name", hydra.encoding.encodeName(ft.name)), hydra.core.Field("term", hydra.core.Term.application(hydra.core.Application(hydra.encoding.encodeType(ft.`type`), hydra.core.Term.application(hydra.core.Application(hydra.core.Term.function(hydra.core.Function.elimination(hydra.core.Elimination.record(hydra.core.Projection(ename, (ft.name))))), hydra.core.Term.variable("x"))))))))))(rt))))))))))))

def encodeSetType(elemType: hydra.core.Type): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("s", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("set", hydra.core.Term.application(hydra.core.Application(hydra.core.Term.application(hydra.core.Application(hydra.core.Term.function(hydra.core.Function.primitive("hydra.lib.sets.map")), hydra.encoding.encodeType(elemType))), hydra.core.Term.variable("s")))))))))
...
def encodeType(v1: hydra.core.Type): hydra.core.Term =
  ...
  case hydra.core.Type.function(_) => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.variable("x"))))
  ...
  case hydra.core.Type.unit => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("_", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("unit", hydra.core.Term.unit))))))
  case hydra.core.Type.void => hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("_", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("unit", hydra.core.Term.unit))))))
...
def encodeUnionTypeNamed(ename: hydra.core.Name)(rt: Seq[hydra.core.FieldType]): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.elimination(hydra.core.Elimination.union(hydra.core.CaseStatement(ename, None, hydra.lib.lists.map[hydra.core.FieldType, hydra.core.Field]((ft: hydra.core.FieldType) =>
...
def encodeWrappedTypeNamed(ename: hydra.core.Name)(wt: hydra.core.Type): hydra.core.Term =
  hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda("x", None, hydra.core.Term.union(hydra.core.Injection("hydra.core.Term", hydra.core.Field("wrap", hydra.core.Term.record(hydra.core.Record("hydra.core.WrappedTerm", Seq(hydra.core.Field("typeName", hydra.encoding.encodeName(ename)), hydra.core.Field("body", hydra.core.Term.application(hydra.core.Application(hydra.encoding.encodeType(wt), hydra.core.Term.application(hydra.core.Application(hydra.core.Term.function(hydra.core.Function.elimination(hydra.core.Elimination.wrap(ename))), hydra.core.Term.variable("x")))))))))))))))

def filterTypeBindings(cx: hydra.context.Context)(graph: hydra.graph.Graph)(bindings: Seq[hydra.core.Binding]): Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Binding]] =
  hydra.lib.eithers.map[Seq[Option[hydra.core.Binding]], Seq[hydra.core.Binding], hydra.context.InContext[hydra.errors.Error]](hydra.lib.maybes.cat[hydra.core.Binding])(hydra.lib.eithers.mapList[hydra.core.Binding, Option[hydra.core.Binding], hydra.context.InContext[hydra.errors.Error]]((v1: hydra.core.Binding) => hydra.encoding.isEncodableBinding(cx)(graph)(v1))(hydra.lib.lists.filter[hydra.core.Binding](hydra.annotations.isNativeType)(bindings)))

def isEncodableBinding(cx: hydra.context.Context)(graph: hydra.graph.Graph)(b: hydra.core.Binding): Either[hydra.context.InContext[hydra.errors.Error], Option[hydra.core.Binding]] =
