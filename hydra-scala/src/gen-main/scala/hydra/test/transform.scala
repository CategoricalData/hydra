...
def transformTestCase(tcm: hydra.testing.TestCaseWithMetadata): Option[hydra.testing.TestCaseWithMetadata] =
  ...
  val tc: hydra.testing.TestCase = (tcm.`case`)
  ...
  tc match
    case hydra.testing.TestCase.caseConversion(v_TestCase_caseConversion_ccase) => {
      val fromConv: hydra.util.CaseConvention = (v_TestCase_caseConversion_ccase.fromConvention)
      val toConv: hydra.util.CaseConvention = (v_TestCase_caseConversion_ccase.toConvention)
      val fromStr: scala.Predef.String = (v_TestCase_caseConversion_ccase.fromString)
      val toStr: scala.Predef.String = (v_TestCase_caseConversion_ccase.`toString_`)
    ...
    case hydra.testing.TestCase.evaluation(v_TestCase_evaluation_ecase) => {
      val `input_`: hydra.core.Term = (v_TestCase_evaluation_ecase.input)
      val `output_`: hydra.core.Term = (v_TestCase_evaluation_ecase.output)
    ...
    case hydra.testing.TestCase.topologicalSort(v_TestCase_topologicalSort_tscase) => {
      val adjList: Seq[Tuple2[Int, Seq[Int]]] = (v_TestCase_topologicalSort_tscase.adjacencyList)
      val expected: Either[Seq[Seq[Int]], Seq[Int]] = (v_TestCase_topologicalSort_tscase.expected)
    ...
    case hydra.testing.TestCase.topologicalSortSCC(v_TestCase_topologicalSortSCC_scccase) => {
      val adjList: Seq[Tuple2[Int, Seq[Int]]] = (v_TestCase_topologicalSortSCC_scccase.adjacencyList)
      val expected: Seq[Seq[Int]] = (v_TestCase_topologicalSortSCC_scccase.expected)
