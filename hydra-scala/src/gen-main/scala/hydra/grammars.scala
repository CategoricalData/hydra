...
def grammarToModule(ns: hydra.module.Namespace)(grammar: hydra.grammar.Grammar)(desc: Option[scala.Predef.String]): hydra.module.Module =
  {
  lazy val prodPairs: Seq[Tuple2[scala.Predef.String, hydra.grammar.Pattern]] = hydra.lib.lists.map[hydra.grammar.Production,
     Tuple2[scala.Predef.String, hydra.grammar.Pattern]]((prod: hydra.grammar.Production) => Tuple2(prod.symbol,
     (prod.pattern)))(grammar)
  lazy val capitalizedNames: Seq[scala.Predef.String] = hydra.lib.lists.map[Tuple2[scala.Predef.String,
     hydra.grammar.Pattern], scala.Predef.String]((pair: Tuple2[scala.Predef.String, hydra.grammar.Pattern]) =>
    hydra.formatting.capitalize(hydra.lib.pairs.first[scala.Predef.String, hydra.grammar.Pattern](pair)))(prodPairs)
  lazy val patterns: Seq[hydra.grammar.Pattern] = hydra.lib.lists.map[Tuple2[scala.Predef.String, hydra.grammar.Pattern],
  ...
  lazy val elementPairs: Seq[Tuple2[scala.Predef.String, hydra.core.Type]] = hydra.lib.lists.concat[Tuple2[scala.Predef.String,
  ...
  lazy val typeDefs: Seq[hydra.module.Definition] = hydra.lib.lists.map[Tuple2[scala.Predef.String, hydra.core.Type],
     hydra.module.Definition]((pair: Tuple2[scala.Predef.String, hydra.core.Type]) =>
    {
    lazy val lname: scala.Predef.String = hydra.lib.pairs.first[scala.Predef.String, hydra.core.Type](pair)
    {
      ...
      {
        lazy val typ: hydra.core.Type = hydra.grammars.wrapType(hydra.lib.pairs.second[scala.Predef.String, hydra.core.Type](pair))
...
def makeElements(omitTrivial: Boolean)(ns: hydra.module.Namespace)(lname: scala.Predef.String)(pat: hydra.grammar.Pattern): Seq[Tuple2[scala.Predef.String,
   hydra.core.Type]] =
  {
  lazy val trivial: Seq[Tuple2[scala.Predef.String, hydra.core.Type]] = hydra.lib.logic.ifElse[Seq[Tuple2[scala.Predef.String,
  ...
  def forRecordOrUnion(isRecord: Boolean)(construct: (Seq[hydra.core.FieldType] => hydra.core.Type))(pats: Seq[hydra.grammar.Pattern]): Seq[Tuple2[scala.Predef.String,
    ...
    lazy val fieldPairs: Seq[Tuple2[hydra.core.FieldType, Seq[Tuple2[scala.Predef.String, hydra.core.Type]]]] = hydra.lib.lists.zipWith[scala.Predef.String,
    ...
    lazy val fields: Seq[hydra.core.FieldType] = hydra.lib.lists.map[Tuple2[hydra.core.FieldType, Seq[Tuple2[scala.Predef.String,
    ...
    lazy val els: Seq[Tuple2[scala.Predef.String, hydra.core.Type]] = hydra.lib.lists.concat[Tuple2[scala.Predef.String,
