...
def functionArity(v1: hydra.core.Function): Int =
  ...
  case hydra.core.Function.lambda(v_Function_lambda_arg_) => math.add(1)(hydra.arity.termArity(`v_Function_lambda_arg_`.body))
...
def termArity(v1: hydra.core.Term): Int =
  v1 match
  case hydra.core.Term.application(v_Term_application_arg_) => math.sub(hydra.arity.termArity(`v_Term_application_arg_`.function))(1)
...
def typeArity(v1: hydra.core.Type): Int =
  ...
  case hydra.core.Type.function(v_Type_function_f) => math.add(1)(hydra.arity.typeArity(v_Type_function_f.codomain))
  case _ => 0
...
def uncurryType(t: hydra.core.Type): Seq[hydra.core.Type] =
  ...
  case hydra.core.Type.function(v_Type_function_ft) => lists.cons[hydra.core.Type](v_Type_function_ft.domain)(hydra.arity.uncurryType(v_Type_function_ft.codomain))
  case _ => Seq(t)
