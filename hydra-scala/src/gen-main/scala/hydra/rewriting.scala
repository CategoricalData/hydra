    ...
    val0 match
      case hydra.core.Term.annotated(v_Term_annotated_at) => {
        val val1: hydra.core.Term = (v_Term_annotated_at.body)
        {
          val ann: Map[hydra.core.Name, hydra.core.Term] = (v_Term_annotated_at.annotation)
          {
            ...
            {
              val innerBinding: hydra.core.Binding = hydra.lib.pairs.first[hydra.core.Binding, Seq[hydra.core.Binding]](recursive)
              {
                val deps: Seq[hydra.core.Binding] = hydra.lib.pairs.second[hydra.core.Binding, Seq[hydra.core.Binding]](recursive)
                {
      ...
      case hydra.core.Term.let(v_Term_let_innerLet) => {
        val bindings1: Seq[hydra.core.Binding] = (v_Term_let_innerLet.bindings)
        {
          ...
          {
            val prefix: scala.Predef.String = hydra.lib.strings.cat2(key0)("_")
            {
              def qualify(n: hydra.core.Name): hydra.core.Name = hydra.lib.strings.cat2(prefix)(n)
              {
                ...
                {
                  val subst: Map[hydra.core.Name, hydra.core.Name] = hydra.lib.maps.fromList[hydra.core.Name,
      ...
      case hydra.core.Term.let(v_Term_let_lt) => {
        val bindings: Seq[hydra.core.Binding] = (v_Term_let_lt.bindings)
        {
          val body: hydra.core.Term = (v_Term_let_lt.body)
          {
            ...
            {
              val flattenedBindings: Seq[hydra.core.Binding] = hydra.lib.lists.concat[hydra.core.Binding](hydra.lib.lists.map[hydra.core.Binding,
                 Seq[hydra.core.Binding]]((`arg_`: hydra.core.Binding) => forResult(rewriteBinding(`arg_`)))(bindings))
              {
                ...
                {
                  val newBindings: Seq[hydra.core.Binding] = hydra.lib.pairs.first[Seq[hydra.core.Binding], hydra.core.Term](merged)
                  {
                    val newBody: hydra.core.Term = hydra.lib.pairs.second[Seq[hydra.core.Binding], hydra.core.Term](merged)
...
def freeTypeVariablesInTerm(term0: hydra.core.Term): scala.collection.immutable.Set[hydra.core.Name] =
  ...
  def getAll(vars: scala.collection.immutable.Set[hydra.core.Name])(term: hydra.core.Term): scala.collection.immutable.Set[hydra.core.Name] =
    ...
    val dflt: scala.collection.immutable.Set[hydra.core.Name] = allOf(hydra.lib.lists.map[hydra.core.Term,
    ...
    term match
      case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
        ...
        case hydra.core.Function.lambda(v_Function_lambda_l) => {
          val domt: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.maybes.maybe[scala.collection.immutable.Set[hydra.core.Name],
...
def freeVariablesInTerm(term: hydra.core.Term): scala.collection.immutable.Set[hydra.core.Name] =
  {
  val dfltVars: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.lists.foldl[scala.collection.immutable.Set[hydra.core.Name],
     hydra.core.Term]((s: scala.collection.immutable.Set[hydra.core.Name]) =>
    (t: hydra.core.Term) =>
  ...
  def f[T0](recurse: (T0 => Either[scala.Predef.String, hydra.core.Type]))(typ2: T0): Either[scala.Predef.String, hydra.core.Type] =
    ...
    def afterRecurse(tr: hydra.core.Type): Either[scala.Predef.String, hydra.core.Type] =
      ...
      case hydra.core.Type.variable(v_Type_variable_v) => hydra.lib.maybes.maybe[Either[scala.Predef.String,
         hydra.core.Type], hydra.core.Type](Left(hydra.lib.strings.cat2("No such type in schema: ")(v_Type_variable_v)))((v1: hydra.core.Type) => hydra.rewriting.inlineType(schema)(v1))(hydra.lib.maps.lookup[hydra.core.Name,
...
def normalizeTypeVariablesInTerm(term: hydra.core.Term): hydra.core.Term =
  ...
  def rewriteWithSubst(state: Tuple2[Tuple2[Map[hydra.core.Name, hydra.core.Name], scala.collection.immutable.Set[hydra.core.Name]],
    ...
    {
    val sb: Tuple2[Map[hydra.core.Name, hydra.core.Name], scala.collection.immutable.Set[hydra.core.Name]] = hydra.lib.pairs.first[Tuple2[Map[hydra.core.Name,
       hydra.core.Name], scala.collection.immutable.Set[hydra.core.Name]], Int](state)
    val next: Int = hydra.lib.pairs.second[Tuple2[Map[hydra.core.Name, hydra.core.Name], scala.collection.immutable.Set[hydra.core.Name]], Int](state)
    val subst: Map[hydra.core.Name, hydra.core.Name] = hydra.lib.pairs.first[Map[hydra.core.Name, hydra.core.Name],
       scala.collection.immutable.Set[hydra.core.Name]](sb)
    val boundVars: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.pairs.second[Map[hydra.core.Name,
      ...
      case hydra.core.Term.function(v_Term_function_v1) => v_Term_function_v1 match
        ...
        case hydra.core.Function.lambda(v_Function_lambda_l) => {
          ...
          hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda(v_Function_lambda_l.parameter,
             hydra.lib.maybes.map[hydra.core.Type, hydra.core.Type]((v12: hydra.core.Type) => substType(subst)(v12))(domain),
        ...
        val bindings0: Seq[hydra.core.Binding] = (v_Term_let_lt.bindings)
        {
          val body0: hydra.core.Term = (v_Term_let_lt.body)
          {
            def step(acc: Seq[hydra.core.Binding])(bs: Seq[hydra.core.Binding]): Seq[hydra.core.Binding] =
              ...
              val tl: Seq[hydra.core.Binding] = hydra.lib.lists.tail[hydra.core.Binding](bs)
              ...
              def withType(ts: hydra.core.TypeScheme): Seq[hydra.core.Binding] =
                ...
                val vars: Seq[hydra.core.Name] = (ts.variables)
                val typ: hydra.core.Type = (ts.`type`)
                val k: Int = hydra.lib.lists.length[hydra.core.Name](vars)
                def gen(i: Int)(rem: Int)(acc2: Seq[hydra.core.Name]): Seq[hydra.core.Name] =
                  {
                  val ti: hydra.core.Name = hydra.lib.strings.cat2("t")(hydra.lib.literals.showInt32(hydra.lib.math.add(next)(i)))
                ...
                val newSubst: Map[hydra.core.Name, hydra.core.Name] = hydra.lib.maps.union[hydra.core.Name,
                ...
                val newBound: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.sets.union[hydra.core.Name](boundVars)(hydra.lib.sets.fromList[hydra.core.Name](newVars))
                val newVal: hydra.core.Term = rewriteWithSubst(Tuple2(Tuple2(newSubst, newBound), hydra.lib.math.add(next)(k)))(b.term)
                def renameConstraintKeys[T0](constraintMap: Map[hydra.core.Name, T0]): Map[hydra.core.Name, T0] =
                  ...
                  {
                  val oldName: hydra.core.Name = hydra.lib.pairs.first[hydra.core.Name, T0](p)
                  {
                    val meta: T0 = hydra.lib.pairs.second[hydra.core.Name, T0](p)
                    {
                      val newName: hydra.core.Name = hydra.lib.maybes.fromMaybe[hydra.core.Name](oldName)(hydra.lib.maps.lookup[hydra.core.Name,
                ...
                val newConstraints: Option[Map[hydra.core.Name, hydra.core.TypeVariableMetadata]] = hydra.lib.maybes.map[Map[hydra.core.Name,
                   hydra.core.TypeVariableMetadata], Map[hydra.core.Name, hydra.core.TypeVariableMetadata]](renameConstraintKeys)(oldConstraints)
                val b1: hydra.core.Binding = hydra.core.Binding(b.name, newVal, Some(hydra.core.TypeScheme(newVars, substType(newSubst)(typ), newConstraints)))
                step(hydra.lib.lists.cons[hydra.core.Binding](b1)(acc))(tl)
              }
              hydra.lib.logic.ifElse[Seq[hydra.core.Binding]](hydra.lib.lists.`null`[hydra.core.Binding](bs))(hydra.lib.lists.reverse[hydra.core.Binding](acc))(hydra.lib.maybes.maybe[Seq[hydra.core.Binding],
                 hydra.core.TypeScheme](noType)((ts: hydra.core.TypeScheme) => withType(ts))(b.`type`))
            }
            {
...
def pruneLet(l: hydra.core.Let): hydra.core.Let =
  {
  val bindingMap: Map[hydra.core.Name, hydra.core.Term] = hydra.lib.maps.fromList[hydra.core.Name, hydra.core.Term](hydra.lib.lists.map[hydra.core.Binding,
  ...
  def adj(n: hydra.core.Name): scala.collection.immutable.Set[hydra.core.Name] =
    hydra.lib.sets.intersection[hydra.core.Name](hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.maps.keys[hydra.core.Name,
       hydra.core.Term](bindingMap)))(hydra.rewriting.freeVariablesInTerm(hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.equality.equal[hydra.core.Name](n)(rootName))(l.body)(hydra.lib.maybes.fromJust[hydra.core.Term](hydra.lib.maps.lookup[hydra.core.Name,
  ...
  val prunedBindings: Seq[hydra.core.Binding] = hydra.lib.lists.filter[hydra.core.Binding]((b: hydra.core.Binding) => hydra.lib.sets.member[hydra.core.Name](b.name)(reachable))(l.bindings)
...
def rewriteAndFoldTerm[T0](f: ((T0 => hydra.core.Term => Tuple2[T0, hydra.core.Term]) => T0 => hydra.core.Term => Tuple2[T0,
  ...
  def fsub[T1](recurse: (T1 => hydra.core.Term => Tuple2[T1, hydra.core.Term]))(val0: T1)(term02: hydra.core.Term): Tuple2[T1, hydra.core.Term] =
    ...
    def forMany[T2, T3, T4, T5](rec: (T2 => T3 => Tuple2[T2, T4]))(cons: (Seq[T4] => T5))(`val`: T2)(els: Seq[T3]): Tuple2[T2, T5] =
      {
      val rr: Tuple2[T2, Seq[T4]] = hydra.lib.lists.foldl[Tuple2[T2, Seq[T4]], T3]((r: Tuple2[T2, Seq[T4]]) =>
        (el: T3) =>
        {
        val r2: Tuple2[T2, T4] = rec(hydra.lib.pairs.first[T2, Seq[T4]](r))(el)
    ...
    def forPair(`val`: T1)(kv: Tuple2[hydra.core.Term, hydra.core.Term]): Tuple2[T1, Tuple2[hydra.core.Term, hydra.core.Term]] =
      {
      val rk: Tuple2[T1, hydra.core.Term] = recurse(`val`)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](kv))
      val rv: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.pairs.first[T1, hydra.core.Term](rk))(hydra.lib.pairs.second[hydra.core.Term,
         hydra.core.Term](kv))
    ...
    def forElimination(`val`: T1)(elm: hydra.core.Elimination): Tuple2[T1, hydra.core.Elimination] =
      ...
      val r: Tuple2[T1, hydra.core.Elimination] = elm match
        case hydra.core.Elimination.union(v_Elimination_union_cs) => {
          val rmd: Option[Tuple2[T1, hydra.core.Term]] = hydra.lib.maybes.map[hydra.core.Term, Tuple2[T1,
             hydra.core.Term]]((v1: hydra.core.Term) => recurse(`val`)(v1))(v_Elimination_union_cs.default)
          {
            val val1: T1 = hydra.lib.maybes.maybe[T1, Tuple2[T1, hydra.core.Term]](`val`)(hydra.lib.pairs.first[T1, hydra.core.Term])(rmd)
            {
              val rcases: Tuple2[T1, Seq[hydra.core.Field]] = forFields(val1)(v_Elimination_union_cs.cases)
              Tuple2(hydra.lib.pairs.first[T1, Seq[hydra.core.Field]](rcases), hydra.core.Elimination.union(hydra.core.CaseStatement(v_Elimination_union_cs.typeName,
    ...
    term02 match
      ...
      case hydra.core.Term.application(v_Term_application_a) => {
        ...
        {
          val rrhs: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.pairs.first[T1, hydra.core.Term](rlhs))(v_Term_application_a.argument)
      ...
      case hydra.core.Term.pair(v_Term_pair_p) => {
        val rf: Tuple2[T1, hydra.core.Term] = recurse(val0)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](v_Term_pair_p))
        {
          val rs: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.pairs.first[T1, hydra.core.Term](rf))(hydra.lib.pairs.second[hydra.core.Term,
...
def rewriteAndFoldTermWithPath[T0](f: ((Seq[hydra.accessors.TermAccessor] => T0 => hydra.core.Term => Tuple2[T0,
  ...
  def fsub[T1](recurse: (Seq[hydra.accessors.TermAccessor] => T1 => hydra.core.Term => Tuple2[T1, hydra.core.Term]))(path: Seq[hydra.accessors.TermAccessor])(val0: T1)(term02: hydra.core.Term): Tuple2[T1,
    ...
    def forSingleWithAccessor[T2, T3, T4, T5, T6](rec: (Seq[hydra.accessors.TermAccessor] => T2 => T3 => Tuple2[T4,
       ...
       T6] =
      {
      val r: Tuple2[T4, T5] = rec(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(accessor)))(`val`)(term)
      Tuple2(hydra.lib.pairs.first[T4, T5](r), cons(hydra.lib.pairs.second[T4, T5](r)))
    }
    def forManyWithAccessors[T2, T3, T4, T5](rec: (Seq[hydra.accessors.TermAccessor] => T2 => T3 => Tuple2[T2,
       ...
       T3]]): Tuple2[T2, T5] =
      {
      val rr: Tuple2[T2, Seq[T4]] = hydra.lib.lists.foldl[Tuple2[T2, Seq[T4]], Tuple2[hydra.accessors.TermAccessor, T3]]((r: Tuple2[T2, Seq[T4]]) =>
        (atp: Tuple2[hydra.accessors.TermAccessor, T3]) =>
        {
        val r2: Tuple2[T2, T4] = rec(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.lib.pairs.first[hydra.accessors.TermAccessor,
    ...
    def forFieldWithAccessor(mkAccessor: (hydra.core.Name => hydra.accessors.TermAccessor))(`val`: T1)(field: hydra.core.Field): Tuple2[T1, hydra.core.Field] =
      {
      val r: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(mkAccessor(field.name))))(`val`)(field.term)
      Tuple2(hydra.lib.pairs.first[T1, hydra.core.Term](r), hydra.core.Field(field.name, hydra.lib.pairs.second[T1, hydra.core.Term](r)))
    }
    ...
    def forPairWithAccessors(keyAccessor: hydra.accessors.TermAccessor)(valAccessor: hydra.accessors.TermAccessor)(`val`: T1)(kv: Tuple2[hydra.core.Term,
      ...
      {
      val rk: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(keyAccessor)))(`val`)(hydra.lib.pairs.first[hydra.core.Term,
         hydra.core.Term](kv))
      val rv: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(valAccessor)))(hydra.lib.pairs.first[T1,
    ...
    def forBindingWithAccessor(`val`: T1)(binding: hydra.core.Binding): Tuple2[T1, hydra.core.Binding] =
      {
      val r: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.letBinding(binding.name))))(`val`)(binding.term)
      Tuple2(hydra.lib.pairs.first[T1, hydra.core.Term](r), hydra.core.Binding(binding.name, hydra.lib.pairs.second[T1, hydra.core.Term](r), (binding.`type`)))
    }
    def forElimination(`val`: T1)(elm: hydra.core.Elimination): Tuple2[T1, hydra.core.Elimination] =
      {
      val r: Tuple2[T1, hydra.core.Elimination] = elm match
        case hydra.core.Elimination.union(v_Elimination_union_cs) => {
          val rmd: Option[Tuple2[T1, hydra.core.Term]] = hydra.lib.maybes.map[hydra.core.Term, Tuple2[T1, hydra.core.Term]]((`def`: hydra.core.Term) =>
            recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.unionCasesDefault)))(`val`)(`def`))(v_Elimination_union_cs.default)
          {
            val val1: T1 = hydra.lib.maybes.maybe[T1, Tuple2[T1, hydra.core.Term]](`val`)(hydra.lib.pairs.first[T1, hydra.core.Term])(rmd)
            {
              val rcases: Tuple2[T1, Seq[hydra.core.Term]] = forManyWithAccessors(recurse)((x: Seq[hydra.core.Term]) => x)(val1)(hydra.lib.lists.map[hydra.core.Field,
              ...
              Tuple2(hydra.lib.pairs.first[T1, Seq[hydra.core.Term]](rcases), hydra.core.Elimination.union(hydra.core.CaseStatement(v_Elimination_union_cs.typeName,
                 ...
                 hydra.core.Field]((ft: Tuple2[hydra.core.Name, hydra.core.Term]) =>
                hydra.core.Field(hydra.lib.pairs.first[hydra.core.Name, hydra.core.Term](ft), hydra.lib.pairs.second[hydra.core.Name,
                   hydra.core.Term](ft)))(hydra.lib.lists.zip[hydra.core.Name, hydra.core.Term](hydra.lib.lists.map[hydra.core.Field,
                   hydra.core.Name]((x: hydra.core.Field) => (x.name))(v_Elimination_union_cs.cases))(hydra.lib.pairs.second[T1,
    ...
    def forFunction(`val`: T1)(fun: hydra.core.Function): Tuple2[T1, hydra.core.Function] =
      ...
      case hydra.core.Function.lambda(v_Function_lambda_l) => {
        val rl: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.lambdaBody)))(`val`)(v_Function_lambda_l.body)
        Tuple2(hydra.lib.pairs.first[T1, hydra.core.Term](rl), hydra.core.Function.lambda(hydra.core.Lambda(v_Function_lambda_l.parameter,
           (v_Function_lambda_l.domain), hydra.lib.pairs.second[T1, hydra.core.Term](rl))))
      }
      case _ => Tuple2(`val`, fun)
    ...
    term02 match
      ...
      case hydra.core.Term.application(v_Term_application_a) => {
        val rlhs: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.applicationFunction)))(val0)(v_Term_application_a.function)
        {
          val rrhs: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.applicationArgument)))(hydra.lib.pairs.first[T1,
      ...
      case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
         Tuple2[T1, hydra.core.Term]]((l: hydra.core.Term) =>
        {
        val rl: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.sumTerm)))(val0)(l)
        Tuple2(hydra.lib.pairs.first[T1, hydra.core.Term](rl), hydra.core.Term.either(Left(hydra.lib.pairs.second[T1, hydra.core.Term](rl))))
      })((r: hydra.core.Term) =>
        {
        val rr: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.sumTerm)))(val0)(r)
        Tuple2(hydra.lib.pairs.first[T1, hydra.core.Term](rr), hydra.core.Term.either(Right(hydra.lib.pairs.second[T1, hydra.core.Term](rr))))
      })(v_Term_either_e)
      ...
      case hydra.core.Term.let(v_Term_let_l) => {
        val renv: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.letBody)))(val0)(v_Term_let_l.body)
        {
          val rbindings: Tuple2[T1, Seq[hydra.core.Binding]] = hydra.lib.lists.foldl[Tuple2[T1, Seq[hydra.core.Binding]],
             hydra.core.Binding]((r: Tuple2[T1, Seq[hydra.core.Binding]]) =>
            (binding: hydra.core.Binding) =>
            {
            val rb: Tuple2[T1, hydra.core.Binding] = forBindingWithAccessor(hydra.lib.pairs.first[T1, Seq[hydra.core.Binding]](r))(binding)
      ...
      case hydra.core.Term.list(v_Term_list_els) => {
        val idx: Int = 0
        {
          val rr: Tuple2[Int, Tuple2[T1, Seq[hydra.core.Term]]] = hydra.lib.lists.foldl[Tuple2[Int, Tuple2[T1,
             Seq[hydra.core.Term]]], hydra.core.Term]((r: Tuple2[Int, Tuple2[T1, Seq[hydra.core.Term]]]) =>
            (el: hydra.core.Term) =>
            {
            val r2: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.listElement(hydra.lib.pairs.first[Int,
          ...
          Tuple2(hydra.lib.pairs.first[T1, Seq[hydra.core.Term]](hydra.lib.pairs.second[Int, Tuple2[T1,
             Seq[hydra.core.Term]]](rr)), hydra.core.Term.list(hydra.lib.lists.reverse[hydra.core.Term](hydra.lib.pairs.second[T1,
      ...
      case hydra.core.Term.map(v_Term_map_m) => {
        val idx: Int = 0
        {
          val rr: Tuple2[Int, Tuple2[T1, Seq[Tuple2[hydra.core.Term, hydra.core.Term]]]] = hydra.lib.lists.foldl[Tuple2[Int,
            ...
            {
            val rk: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.mapKey(hydra.lib.pairs.first[Int,
            ...
            {
              val rv: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.mapValue(hydra.lib.pairs.first[Int,
                 Tuple2[T1, Seq[Tuple2[hydra.core.Term, hydra.core.Term]]]](r)))))(hydra.lib.pairs.first[T1,
                 hydra.core.Term](rk))(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](kv))
              Tuple2(hydra.lib.math.add(hydra.lib.pairs.first[Int, Tuple2[T1, Seq[Tuple2[hydra.core.Term,
                 hydra.core.Term]]]](r))(1), Tuple2(hydra.lib.pairs.first[T1, hydra.core.Term](rv), hydra.lib.lists.cons[Tuple2[hydra.core.Term,
                 hydra.core.Term]](Tuple2(hydra.lib.pairs.second[T1, hydra.core.Term](rk), hydra.lib.pairs.second[T1,
                 hydra.core.Term](rv)))(hydra.lib.pairs.second[T1, Seq[Tuple2[hydra.core.Term, hydra.core.Term]]](hydra.lib.pairs.second[Int,
      ...
      case hydra.core.Term.pair(v_Term_pair_p) => {
        val rf: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.productTerm(0))))(val0)(hydra.lib.pairs.first[hydra.core.Term,
           hydra.core.Term](v_Term_pair_p))
        {
          val rs: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.productTerm(1))))(hydra.lib.pairs.first[T1,
      ...
      case hydra.core.Term.record(v_Term_record_r) => {
        val rfields: Tuple2[T1, Seq[hydra.core.Term]] = forManyWithAccessors(recurse)((x: Seq[hydra.core.Term]) => x)(val0)(hydra.lib.lists.map[hydra.core.Field,
           Tuple2[hydra.accessors.TermAccessor, hydra.core.Term]]((f2: hydra.core.Field) =>
        ...
        Tuple2(hydra.lib.pairs.first[T1, Seq[hydra.core.Term]](rfields), hydra.core.Term.record(hydra.core.Record(v_Term_record_r.typeName,
          ...
          hydra.core.Field(hydra.lib.pairs.first[hydra.core.Name, hydra.core.Term](ft), hydra.lib.pairs.second[hydra.core.Name,
             hydra.core.Term](ft)))(hydra.lib.lists.zip[hydra.core.Name, hydra.core.Term](hydra.lib.lists.map[hydra.core.Field,
             hydra.core.Name]((x: hydra.core.Field) => (x.name))(v_Term_record_r.fields))(hydra.lib.pairs.second[T1,
      ...
      case hydra.core.Term.set(v_Term_set_els) => {
        val idx: Int = 0
        {
          val rr: Tuple2[Int, Tuple2[T1, Seq[hydra.core.Term]]] = hydra.lib.lists.foldl[Tuple2[Int, Tuple2[T1,
            ...
            (el: hydra.core.Term) =>
            {
            val r2: Tuple2[T1, hydra.core.Term] = recurse(hydra.lib.lists.concat2[hydra.accessors.TermAccessor](path)(Seq(hydra.accessors.TermAccessor.setElement(hydra.lib.pairs.first[Int,
               Tuple2[T1, Seq[hydra.core.Term]]](r)))))(hydra.lib.pairs.first[T1, Seq[hydra.core.Term]](hydra.lib.pairs.second[Int,
               Tuple2[T1, Seq[hydra.core.Term]]](r)))(el)
            Tuple2(hydra.lib.math.add(hydra.lib.pairs.first[Int, Tuple2[T1, Seq[hydra.core.Term]]](r))(1),
               Tuple2(hydra.lib.pairs.first[T1, hydra.core.Term](r2), hydra.lib.lists.cons[hydra.core.Term](hydra.lib.pairs.second[T1,
          ...
          Tuple2(hydra.lib.pairs.first[T1, Seq[hydra.core.Term]](hydra.lib.pairs.second[Int, Tuple2[T1,
             Seq[hydra.core.Term]]](rr)), hydra.core.Term.set(hydra.lib.sets.fromList[hydra.core.Term](hydra.lib.lists.reverse[hydra.core.Term](hydra.lib.pairs.second[T1,
             Seq[hydra.core.Term]](hydra.lib.pairs.second[Int, Tuple2[T1, Seq[hydra.core.Term]]](rr))))))
        }
      }
  ...
  def fsub(recurse: (hydra.core.Term => hydra.core.Term))(term: hydra.core.Term): hydra.core.Term =
    ...
    def forElimination(elm: hydra.core.Elimination): hydra.core.Elimination =
      ...
      case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.core.Elimination.union(hydra.core.CaseStatement(v_Elimination_union_cs.typeName,
         ...
         hydra.lib.lists.map[hydra.core.Field, hydra.core.Field](forField)(v_Elimination_union_cs.cases)))
...
def rewriteTermM[T0](f: ((hydra.core.Term => Either[T0, hydra.core.Term]) => hydra.core.Term => Either[T0,
  ...
  def fsub[T1](recurse: (hydra.core.Term => Either[T1, hydra.core.Term]))(term: hydra.core.Term): Either[T1, hydra.core.Term] =
    ...
    term match
      case hydra.core.Term.annotated(v_Term_annotated_at) => hydra.lib.eithers.bind[T1, hydra.core.Term,
         hydra.core.Term](recurse(v_Term_annotated_at.body))((ex: hydra.core.Term) =>
        Right(hydra.core.Term.annotated(hydra.core.AnnotatedTerm(ex, (v_Term_annotated_at.annotation)))))
      case hydra.core.Term.application(v_Term_application_app) => hydra.lib.eithers.bind[T1, hydra.core.Term,
         hydra.core.Term](recurse(v_Term_application_app.function))((lhs: hydra.core.Term) =>
      ...
      case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.bind[T1, Either[hydra.core.Term,
         hydra.core.Term], hydra.core.Term](hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
         Either[T1, Either[hydra.core.Term, hydra.core.Term]]]((l: hydra.core.Term) =>
        ...
        hydra.lib.eithers.map[hydra.core.Term, Either[hydra.core.Term, hydra.core.Term], T1]((x: hydra.core.Term) => Right(x))(recurse(r)))(v_Term_either_e))((re: Either[hydra.core.Term,
          ...
          case hydra.core.Elimination.union(v_Elimination_union_cs) => {
            val n: hydra.core.Name = (v_Elimination_union_cs.typeName)
            {
              val `def`: Option[hydra.core.Term] = (v_Elimination_union_cs.default)
              {
                ...
                hydra.lib.eithers.bind[T1, Option[hydra.core.Term], hydra.core.Function](hydra.lib.maybes.maybe[Either[T1,
                  ...
                  hydra.core.Function.elimination(hydra.core.Elimination.union(hydra.core.CaseStatement(n,
                     rdef, rcases))))(hydra.lib.eithers.mapList[hydra.core.Field, hydra.core.Field, T1](forField)(cases)))
              }
            }
          }
      ...
      case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[T1, Seq[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Term,
      ...
      case hydra.core.Term.map(v_Term_map_m) => hydra.lib.eithers.bind[T1, Seq[Tuple2[hydra.core.Term,
         hydra.core.Term]], hydra.core.Term](hydra.lib.eithers.mapList[Tuple2[hydra.core.Term, hydra.core.Term],
         Tuple2[hydra.core.Term, hydra.core.Term], T1](forPair)(hydra.lib.maps.toList[hydra.core.Term,
      ...
      case hydra.core.Term.maybe(v_Term_maybe_m) => hydra.lib.eithers.bind[T1, Option[hydra.core.Term],
         hydra.core.Term](hydra.lib.eithers.mapMaybe[hydra.core.Term, hydra.core.Term, T1](recurse)(v_Term_maybe_m))((rm: Option[hydra.core.Term]) => Right(hydra.core.Term.maybe(rm)))
      case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[T1, hydra.core.Term, hydra.core.Term](recurse(hydra.lib.pairs.first[hydra.core.Term,
      ...
      case hydra.core.Term.record(v_Term_record_r) => {
        val n: hydra.core.Name = (v_Term_record_r.typeName)
        {
          ...
          hydra.lib.eithers.map[Seq[hydra.core.Field], hydra.core.Term, T1]((rfields: Seq[hydra.core.Field]) => hydra.core.Term.record(hydra.core.Record(n,
             rfields)))(hydra.lib.eithers.mapList[hydra.core.Field, hydra.core.Field, T1](forField)(fields))
        }
      }
      case hydra.core.Term.set(v_Term_set_s) => hydra.lib.eithers.bind[T1, Seq[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Term,
         hydra.core.Term, T1](recurse)(hydra.lib.sets.toList[hydra.core.Term](v_Term_set_s)))((rlist: Seq[hydra.core.Term]) =>
        Right(hydra.core.Term.set(hydra.lib.sets.fromList[hydra.core.Term](rlist))))
      case hydra.core.Term.typeApplication(v_Term_typeApplication_tt) => hydra.lib.eithers.bind[T1, hydra.core.Term,
...
def rewriteTermWithContextM[T0, T1](f: ((T0 => hydra.core.Term => Either[T1, hydra.core.Term]) => T0 => hydra.core.Term => Either[T1,
  ...
  def forSubterms[T2, T3](recurse0: (T2 => hydra.core.Term => Either[T3, hydra.core.Term]))(cx: T2)(term: hydra.core.Term): Either[T3, hydra.core.Term] =
    ...
    def forElimination(e: hydra.core.Elimination): Either[T3, hydra.core.Function] =
      ...
      case hydra.core.Elimination.union(v_Elimination_union_cs) => {
        val n: hydra.core.Name = (v_Elimination_union_cs.typeName)
        {
          ...
          {
            val cases: Seq[hydra.core.Field] = (v_Elimination_union_cs.cases)
            hydra.lib.eithers.bind[T3, Option[hydra.core.Term], hydra.core.Function](hydra.lib.maybes.maybe[Either[T3,
               Option[hydra.core.Term]], hydra.core.Term](Right(None))((t: hydra.core.Term) =>
              ...
              hydra.core.Function.elimination(hydra.core.Elimination.union(hydra.core.CaseStatement(n,
                 rdef, rcases))))(hydra.lib.eithers.mapList[hydra.core.Field, hydra.core.Field, T3](forField)(cases)))
          }
        }
      }
      case hydra.core.Elimination.wrap(v_Elimination_wrap_name) => Right(hydra.core.Function.elimination(hydra.core.Elimination.wrap(v_Elimination_wrap_name)))
    ...
    term match
      case hydra.core.Term.annotated(v_Term_annotated_at) => hydra.lib.eithers.bind[T3, hydra.core.Term,
         hydra.core.Term](recurse(v_Term_annotated_at.body))((ex: hydra.core.Term) =>
        Right(hydra.core.Term.annotated(hydra.core.AnnotatedTerm(ex, (v_Term_annotated_at.annotation)))))
      case hydra.core.Term.application(v_Term_application_app) => hydra.lib.eithers.bind[T3, hydra.core.Term,
         hydra.core.Term](recurse(v_Term_application_app.function))((lhs: hydra.core.Term) =>
      ...
      case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.bind[T3, Either[hydra.core.Term,
         hydra.core.Term], hydra.core.Term](hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
         Either[T3, Either[hydra.core.Term, hydra.core.Term]]]((l: hydra.core.Term) =>
        ...
        hydra.lib.eithers.map[hydra.core.Term, Either[hydra.core.Term, hydra.core.Term], T3]((x: hydra.core.Term) => Right(x))(recurse(r)))(v_Term_either_e))((re: Either[hydra.core.Term,
           hydra.core.Term]) => Right(hydra.core.Term.either(re)))
      case hydra.core.Term.function(v_Term_function_fun) => hydra.lib.eithers.bind[T3, hydra.core.Function,
         hydra.core.Term](forFunction(v_Term_function_fun))((rfun: hydra.core.Function) => Right(hydra.core.Term.function(rfun)))
      case hydra.core.Term.let(v_Term_let_lt) => {
        val bindings: Seq[hydra.core.Binding] = (v_Term_let_lt.bindings)
        {
          val body: hydra.core.Term = (v_Term_let_lt.body)
      ...
      case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[T3, Seq[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Term,
      ...
      case hydra.core.Term.map(v_Term_map_m) => hydra.lib.eithers.bind[T3, Seq[Tuple2[hydra.core.Term,
         hydra.core.Term]], hydra.core.Term](hydra.lib.eithers.mapList[Tuple2[hydra.core.Term, hydra.core.Term],
         Tuple2[hydra.core.Term, hydra.core.Term], T3](forPair)(hydra.lib.maps.toList[hydra.core.Term,
         hydra.core.Term](v_Term_map_m)))((pairs: Seq[Tuple2[hydra.core.Term, hydra.core.Term]]) =>
        Right(hydra.core.Term.map(hydra.lib.maps.fromList[hydra.core.Term, hydra.core.Term](pairs))))
      case hydra.core.Term.maybe(v_Term_maybe_m) => hydra.lib.eithers.bind[T3, Option[hydra.core.Term],
         hydra.core.Term](hydra.lib.eithers.mapMaybe[hydra.core.Term, hydra.core.Term, T3](recurse)(v_Term_maybe_m))((rm: Option[hydra.core.Term]) => Right(hydra.core.Term.maybe(rm)))
      case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[T3, hydra.core.Term, hydra.core.Term](recurse(hydra.lib.pairs.first[hydra.core.Term,
      ...
      case hydra.core.Term.record(v_Term_record_r) => {
        val n: hydra.core.Name = (v_Term_record_r.typeName)
        {
          ...
          hydra.lib.eithers.map[Seq[hydra.core.Field], hydra.core.Term, T3]((rfields: Seq[hydra.core.Field]) => hydra.core.Term.record(hydra.core.Record(n,
             rfields)))(hydra.lib.eithers.mapList[hydra.core.Field, hydra.core.Field, T3](forField)(fields))
        }
      }
      case hydra.core.Term.set(v_Term_set_s) => hydra.lib.eithers.bind[T3, Seq[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Term,
         hydra.core.Term, T3](recurse)(hydra.lib.sets.toList[hydra.core.Term](v_Term_set_s)))((rlist: Seq[hydra.core.Term]) =>
        Right(hydra.core.Term.set(hydra.lib.sets.fromList[hydra.core.Term](rlist))))
      case hydra.core.Term.typeApplication(v_Term_typeApplication_tt) => hydra.lib.eithers.bind[T3, hydra.core.Term,
         hydra.core.Term](recurse(v_Term_typeApplication_tt.body))((t: hydra.core.Term) =>
        Right(hydra.core.Term.typeApplication(hydra.core.TypeApplicationTerm(t, (v_Term_typeApplication_tt.`type`)))))
      case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => {
        val v: hydra.core.Name = (v_Term_typeLambda_tl.parameter)
...
def rewriteTypeM[T0](f: ((hydra.core.Type => Either[T0, hydra.core.Type]) => hydra.core.Type => Either[T0,
  ...
  def fsub[T1](recurse: (hydra.core.Type => Either[T1, hydra.core.Type]))(typ: hydra.core.Type): Either[T1, hydra.core.Type] =
    typ match
    case hydra.core.Type.annotated(v_Type_annotated_at) => hydra.lib.eithers.bind[T1, hydra.core.Type,
       hydra.core.Type](recurse(v_Type_annotated_at.body))((t: hydra.core.Type) =>
      Right(hydra.core.Type.annotated(hydra.core.AnnotatedType(t, (v_Type_annotated_at.annotation)))))
    case hydra.core.Type.application(v_Type_application_at) => hydra.lib.eithers.bind[T1, hydra.core.Type,
       hydra.core.Type](recurse(v_Type_application_at.function))((lhs: hydra.core.Type) =>
...
def substituteVariables(subst: Map[hydra.core.Name, hydra.core.Name])(term: hydra.core.Term): hydra.core.Term =
  ...
  def replace(recurse: (hydra.core.Term => hydra.core.Term))(term2: hydra.core.Term): hydra.core.Term =
    ...
    case hydra.core.Term.function(v_Term_function_v1) => v_Term_function_v1 match
      case hydra.core.Function.lambda(v_Function_lambda_l) => hydra.lib.maybes.maybe[hydra.core.Term,
...
def subterms(v1: hydra.core.Term): Seq[hydra.core.Term] =
  ...
  case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
     Seq[hydra.core.Term]]((l: hydra.core.Term) => Seq(l))((r: hydra.core.Term) => Seq(r))(v_Term_either_e)
  case hydra.core.Term.function(v_Term_function_v12) => v_Term_function_v12 match
    case hydra.core.Function.elimination(v_Function_elimination_v13) => v_Function_elimination_v13 match
      case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.lib.lists.concat2[hydra.core.Term](hydra.lib.maybes.maybe[Seq[hydra.core.Term],
         hydra.core.Term](Seq())((t: hydra.core.Term) => Seq(t))(v_Elimination_union_cs.default))(hydra.lib.lists.map[hydra.core.Field,
  ...
  case hydra.core.Term.pair(v_Term_pair_p) => Seq(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](v_Term_pair_p),
     hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](v_Term_pair_p))
...
def toShortNames(original: Seq[hydra.core.Name]): Map[hydra.core.Name, hydra.core.Name] =
  ...
  def addName(acc: Map[scala.Predef.String, scala.collection.immutable.Set[hydra.core.Name]])(name: hydra.core.Name): Map[scala.Predef.String,
    ...
    val group: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.maybes.fromMaybe[scala.collection.immutable.Set[hydra.core.Name]](hydra.lib.sets.empty[hydra.core.Name])(hydra.lib.maps.lookup[scala.Predef.String,
  ...
  def renameGroup[T0](localNames: Tuple2[scala.Predef.String, scala.collection.immutable.Set[T0]]): Seq[Tuple2[T0, hydra.core.Name]] =
    {
    val local: scala.Predef.String = hydra.lib.pairs.first[scala.Predef.String, scala.collection.immutable.Set[T0]](localNames)
    val names: scala.collection.immutable.Set[T0] = hydra.lib.pairs.second[scala.Predef.String, scala.collection.immutable.Set[T0]](localNames)
...
def topologicalSortBindingMap(bindingMap: Map[hydra.core.Name, hydra.core.Term]): Seq[Seq[Tuple2[hydra.core.Name, hydra.core.Term]]] =
  {
  val bindings: Seq[Tuple2[hydra.core.Name, hydra.core.Term]] = hydra.lib.maps.toList[hydra.core.Name, hydra.core.Term](bindingMap)
  val keys: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.lists.map[Tuple2[hydra.core.Name,
  ...
  def depsOf[T0](nameAndTerm: Tuple2[T0, hydra.core.Term]): Tuple2[T0, Seq[hydra.core.Name]] =
    {
    val name: T0 = hydra.lib.pairs.first[T0, hydra.core.Term](nameAndTerm)
    val term: hydra.core.Term = hydra.lib.pairs.second[T0, hydra.core.Term](nameAndTerm)
...
def unshadowVariables(term0: hydra.core.Term): hydra.core.Term =
  ...
  def f(recurse: (Map[hydra.core.Name, hydra.core.Name] => hydra.core.Term => hydra.core.Term))(m: Map[hydra.core.Name,
        ...
        val v: hydra.core.Name = (v_Function_lambda_l.parameter)
        {
          val domain: Option[hydra.core.Type] = (v_Function_lambda_l.domain)
          {
            ...
            hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.maps.member[hydra.core.Name, hydra.core.Name](v)(m))({
              ...
              {
                val m2: Map[hydra.core.Name, hydra.core.Name] = hydra.lib.maps.insert[hydra.core.Name,
            ...
            })(hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda(v, domain, f(recurse)(hydra.lib.maps.insert[hydra.core.Name,
    ...
    case hydra.core.Term.let(v_Term_let_lt) => {
      val m2: Map[hydra.core.Name, hydra.core.Name] = hydra.lib.lists.foldl[Map[hydra.core.Name, hydra.core.Name],
