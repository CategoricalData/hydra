...
def convertCase(from: hydra.util.CaseConvention)(to: hydra.util.CaseConvention)(original: scala.Predef.String): scala.Predef.String =
  ...
  val parts: Seq[scala.Predef.String] = {
    ...
    val byUnderscores: Seq[scala.Predef.String] = hydra.lib.strings.splitOn("_")(original)
    from match
...
def mapFirstLetter(mapping: (scala.Predef.String => scala.Predef.String))(s: scala.Predef.String): scala.Predef.String =
  {
  val list: Seq[Int] = hydra.lib.strings.toList(s)
  val firstLetter: scala.Predef.String = mapping(hydra.lib.strings.fromList(hydra.lib.lists.pure[Int](hydra.lib.lists.head[Int](list))))
...
def nonAlnumToUnderscores(input: scala.Predef.String): scala.Predef.String =
  ...
  def replace(p: Tuple2[Seq[Int], Boolean])(c: Int): Tuple2[Seq[Int], Boolean] =
    {
    val s: Seq[Int] = hydra.lib.pairs.first[Seq[Int], Boolean](p)
    val b: Boolean = hydra.lib.pairs.second[Seq[Int], Boolean](p)
  ...
  val result: Tuple2[Seq[Int], Boolean] = hydra.lib.lists.foldl[Tuple2[Seq[Int], Boolean], Int](replace)(Tuple2(Seq(), false))(hydra.lib.strings.toList(input))
...
def withCharacterAliases(original: scala.Predef.String): scala.Predef.String =
  {
  val aliases: Map[Int, scala.Predef.String] = hydra.lib.maps.fromList[Int, scala.Predef.String](Seq(Tuple2(32,
...
def wrapLine(maxlen: Int)(input: scala.Predef.String): scala.Predef.String =
  ...
  def helper(prev: Seq[Seq[Int]])(rem: Seq[Int]): Seq[Seq[Int]] =
    {
    val trunc: Seq[Int] = hydra.lib.lists.take[Int](maxlen)(rem)
    val spanResult: Tuple2[Seq[Int], Seq[Int]] = hydra.lib.lists.span[Int]((c: Int) =>
    ...
    val prefix: Seq[Int] = hydra.lib.lists.reverse[Int](hydra.lib.pairs.second[Seq[Int], Seq[Int]](spanResult))
    val suffix: Seq[Int] = hydra.lib.lists.reverse[Int](hydra.lib.pairs.first[Seq[Int], Seq[Int]](spanResult))
