...
def betaReduceType(cx: hydra.context.Context)(graph: hydra.graph.Graph)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.error.Error],
  ...
  def reduceApp(app: hydra.core.ApplicationType): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type] =
    ...
    lhs match
      case hydra.core.Type.annotated(v_Type_annotated_at) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
  ...
  def mapExpr[T0](recurse: (T0 => Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type]))(t: T0): Either[hydra.context.InContext[hydra.error.Error],
    ...
    def findApp(r: hydra.core.Type): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type] =
      ...
      case _ => Right(r)
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Type, hydra.core.Type](recurse(t))((r: hydra.core.Type) => findApp(r))
  }
...
def etaExpandTerm(graph: hydra.graph.Graph)(term: hydra.core.Term): hydra.core.Term =
  ...
  def expand(args: Seq[hydra.core.Term])(arity: Int)(t: hydra.core.Term): hydra.core.Term =
    {
    val apps: hydra.core.Term = hydra.lib.lists.foldl[hydra.core.Term, hydra.core.Term]((lhs: hydra.core.Term) =>
      (arg: hydra.core.Term) =>
      hydra.core.Term.application(hydra.core.Application(lhs, arg)))(t)(args)
    val is: Seq[Int] = hydra.lib.logic.ifElse[Seq[Int]](hydra.lib.equality.lte[Int](arity)(hydra.lib.lists.length[hydra.core.Term](args)))(Seq())(hydra.lib.math.range(1)(hydra.lib.math.sub(arity)(hydra.lib.lists.length[hydra.core.Term](args))))
...
def etaExpandTermNew(tx0: hydra.graph.Graph)(term0: hydra.core.Term): hydra.core.Term =
  ...
  def termArityWithContext(tx: hydra.graph.Graph)(term: hydra.core.Term): Int =
    ...
    case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
      ...
      case hydra.core.Function.primitive(v_Function_primitive_name) => hydra.lib.maybes.maybe[Int, hydra.core.TypeScheme](0)(hydra.arity.typeSchemeArity)(hydra.lib.maps.lookup[hydra.core.Name,
         hydra.core.TypeScheme](v_Function_primitive_name)(hydra.lib.maps.fromList[hydra.core.Name, hydra.core.TypeScheme](hydra.lib.lists.map[hydra.graph.Primitive,
    ...
    case hydra.core.Term.variable(v_Term_variable_name) => hydra.lib.maybes.maybe[Int, hydra.core.Type](0)(hydra.arity.typeArity)(hydra.lib.maybes.map[hydra.core.TypeScheme,
       hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Term_variable_name)(tx.boundTypes)))
    case _ => 0
  ...
  def expand(alwaysPad: Boolean)(args: Seq[hydra.core.Term])(arity: Int)(headTyp: Option[hydra.core.Type])(head: hydra.core.Term): hydra.core.Term =
    {
    val applied: hydra.core.Term = hydra.lib.lists.foldl[hydra.core.Term, hydra.core.Term]((lhs: hydra.core.Term) =>
      (arg: hydra.core.Term) =>
      hydra.core.Term.application(hydra.core.Application(lhs, arg)))(head)(args)
    val numArgs: Int = hydra.lib.lists.length[hydra.core.Term](args)
    val needed: Int = hydra.lib.math.sub(arity)(numArgs)
    hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.logic.and(hydra.lib.equality.gt[Int](needed)(0))(hydra.lib.logic.or(alwaysPad)(hydra.lib.equality.gt[Int](numArgs)(0))))({
      val indices: Seq[Int] = hydra.lib.math.range(1)(needed)
      {
        val remainingType: Option[hydra.core.Type] = peelFunctionDomains(headTyp)(numArgs)
        {
          val domains: Seq[Option[hydra.core.Type]] = domainTypes(needed)(remainingType)
          {
            ...
            {
              val fullyAppliedRaw: hydra.core.Term = hydra.lib.lists.foldl[hydra.core.Term, Int]((body: hydra.core.Term) =>
                (i: Int) =>
                {
                val vn: hydra.core.Name = hydra.lib.strings.cat2("v")(hydra.lib.literals.showInt32(i))
                hydra.core.Term.application(hydra.core.Application(body, hydra.core.Term.variable(vn)))
              })(applied)(indices)
              {
                val fullyApplied: hydra.core.Term = hydra.lib.maybes.maybe[hydra.core.Term, hydra.core.Type](fullyAppliedRaw)((ct: hydra.core.Type) =>
                ...
                {
                  val indexedDomains: Seq[Tuple2[Int, Option[hydra.core.Type]]] = hydra.lib.lists.zip[Int, Option[hydra.core.Type]](indices)(domains)
                  hydra.lib.lists.foldl[hydra.core.Term, Tuple2[Int, Option[hydra.core.Type]]]((body: hydra.core.Term) =>
                    ...
                    {
                    val i: Int = hydra.lib.pairs.first[Int, Option[hydra.core.Type]](idPair)
                    {
                      val dom: Option[hydra.core.Type] = hydra.lib.pairs.second[Int, Option[hydra.core.Type]](idPair)
                      {
                        val vn: hydra.core.Name = hydra.lib.strings.cat2("v")(hydra.lib.literals.showInt32(i))
  ...
  def rewriteWithArgs(args: Seq[hydra.core.Term])(tx: hydra.graph.Graph)(term: hydra.core.Term): hydra.core.Term =
    ...
    def termHeadType(tx2: hydra.graph.Graph)(trm2: hydra.core.Term): Option[hydra.core.Type] =
      ...
      case hydra.core.Term.function(v_Term_function_f2) => v_Term_function_f2 match
        case hydra.core.Function.primitive(v_Function_primitive_pn2) => hydra.lib.maybes.map[hydra.core.TypeScheme,
           ...
           hydra.core.TypeScheme](v_Function_primitive_pn2)(hydra.lib.maps.fromList[hydra.core.Name, hydra.core.TypeScheme](hydra.lib.lists.map[hydra.graph.Primitive,
           Tuple2[hydra.core.Name, hydra.core.TypeScheme]]((_gpt_p: hydra.graph.Primitive) => Tuple2(_gpt_p.name,
           (_gpt_p.`type`)))(hydra.lib.maps.elems[hydra.core.Name, hydra.graph.Primitive](tx2.primitives)))))
        case _ => None
      ...
      case hydra.core.Term.variable(v_Term_variable_vn2) => hydra.lib.maybes.map[hydra.core.TypeScheme,
         hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Term_variable_vn2)(tx2.boundTypes))
      case _ => None
    ...
    def forElimination(elm: hydra.core.Elimination): hydra.core.Elimination =
      ...
      case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.core.Elimination.union(hydra.core.CaseStatement(v_Elimination_union_cs.typeName,
         hydra.lib.maybes.map[hydra.core.Term, hydra.core.Term]((t1: hydra.core.Term) => recurse(tx)(t1))(v_Elimination_union_cs.default),
         hydra.lib.lists.map[hydra.core.Field, hydra.core.Field](forCaseBranch)(v_Elimination_union_cs.cases)))
    ...
    term match
      ...
      case hydra.core.Term.function(v_Term_function_fn) => v_Term_function_fn match
        ...
        case hydra.core.Function.primitive(v_Function_primitive_pn) => {
          ...
          {
            val primType: Option[hydra.core.Type] = hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type]((ts: hydra.core.TypeScheme) => (ts.`type`))(hydra.lib.maps.lookup[hydra.core.Name,
               hydra.core.TypeScheme](v_Function_primitive_pn)(hydra.lib.maps.fromList[hydra.core.Name,
               hydra.core.TypeScheme](hydra.lib.lists.map[hydra.graph.Primitive, Tuple2[hydra.core.Name,
               hydra.core.TypeScheme]]((_gpt_p: hydra.graph.Primitive) => Tuple2(_gpt_p.name, (_gpt_p.`type`)))(hydra.lib.maps.elems[hydra.core.Name,
               hydra.graph.Primitive](tx.primitives)))))
      ...
      case hydra.core.Term.let(v_Term_let_lt) => {
        val tx1: hydra.graph.Graph = hydra.schemas.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx)(v_Term_let_lt)
        {
          ...
          {
            val result: hydra.core.Term = hydra.core.Term.let(hydra.core.Let(hydra.lib.lists.map[hydra.core.Binding,
      ...
      case hydra.core.Term.variable(v_Term_variable_vn) => {
        val arty: Int = termArityWithContext(tx)(term)
        {
          val varType: Option[hydra.core.Type] = hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name,
...
def etaExpandTypedTerm(cx: hydra.context.Context)(tx0: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error],
  ...
  def rewrite(topLevel: Boolean)(forced: Boolean)(typeArgs: Seq[hydra.core.Type])(recurse: (hydra.graph.Graph => hydra.core.Term => Either[hydra.context.InContext[hydra.error.Error],
    ...
    def rewriteSpine(term2: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
      term2 match
      case hydra.core.Term.annotated(v_Term_annotated_at) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
      ...
      case hydra.core.Term.application(v_Term_application_a) => {
        val l: Seq[hydra.core.Type] = hydra.lib.logic.ifElse[Seq[hydra.core.Type]](false)(Seq(hydra.core.Type.literal(hydra.core.LiteralType.string)))(Seq())
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](rewriteSpine(v_Term_application_a.function))((lhs: hydra.core.Term) =>
          hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](rewrite(true)(false)(l)(recurse)(tx)(v_Term_application_a.argument))((rhs: hydra.core.Term) =>
          Right(hydra.core.Term.application(hydra.core.Application(lhs, rhs)))))
      }
      case hydra.core.Term.typeApplication(v_Term_typeApplication_tat) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
    ...
    def arityOf(tx2: hydra.graph.Graph)(term2: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error], Int] =
      {
      val dflt: Either[hydra.context.InContext[hydra.error.Error], Int] = hydra.lib.eithers.map[Tuple2[hydra.core.Type,
      ...
      term2 match
        ...
        case hydra.core.Term.variable(v_Term_variable_name) => hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.error.Error],
           Int], hydra.core.Type](hydra.lib.eithers.map[Tuple2[hydra.core.Type, hydra.context.Context],
           Int, hydra.context.InContext[hydra.error.Error]]((_tc: Tuple2[hydra.core.Type, hydra.context.Context]) =>
    ...
    def pad(vars: Seq[hydra.core.Name])(body: hydra.core.Term): hydra.core.Term =
      hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.lists.`null`[hydra.core.Name](vars))(body)(hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda(hydra.lib.lists.head[hydra.core.Name](vars),
    ...
    def forceExpansion(t: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
      ...
      {
      val arity: Int = hydra.arity.typeArity(hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context](typCx))
    ...
    def recurseOrForce(term2: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
      hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]](forced)(forceExpansion(term2))(recurse(tx)(unwind(term2)))
    def forCase(f: hydra.core.Field): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Field] =
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Field](rewrite(false)(true)(Seq())(recurse)(tx)(f.term))((r: hydra.core.Term) => Right(hydra.core.Field(f.name,
         r)))
    def forCaseStatement(cs: hydra.core.CaseStatement): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Option[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapMaybe[hydra.core.Term,
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.core.Field], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Field,
    ...
    def forElimination(elm: hydra.core.Elimination): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](hydra.lib.eithers.map[hydra.core.Term,
    ...
    term match
      case hydra.core.Term.application(v_Term_application_a) => {
        val lhs: hydra.core.Term = (v_Term_application_a.function)
        {
          ...
          hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](rewrite(true)(false)(Seq())(recurse)(tx)(rhs))((rhs2: hydra.core.Term) =>
            hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Int, hydra.core.Term](arityOf(tx)(lhs))((lhsarity: Int) =>
            hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](rewriteSpine(lhs))((lhs2: hydra.core.Term) =>
            {
      ...
      case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
        ...
        case hydra.core.Function.lambda(v_Function_lambda_l) => {
          ...
          hydra.lib.eithers.map[hydra.core.Term, hydra.core.Term, hydra.context.InContext[hydra.error.Error]](unwind)(recurse(txl)(term))
        }
...
def reduceTerm(cx: hydra.context.Context)(graph: hydra.graph.Graph)(eager: Boolean)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error],
  ...
  def reduceArg(eager2: Boolean)(arg: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]](eager2)(Right(arg))(reduce(false)(arg))
  ...
  def applyElimination(elm: hydra.core.Elimination)(reducedArg: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
    elm match
    case hydra.core.Elimination.record(v_Elimination_record_proj) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
      ...
      {
      val matchingFields: Seq[hydra.core.Field] = hydra.lib.lists.filter[hydra.core.Field]((f: hydra.core.Field) =>
        hydra.lib.equality.equal[hydra.core.Name](f.name)(v_Elimination_record_proj.field))(fields)
      hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Field](matchingFields))(Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat(Seq("no such field: ",
    ...
    case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
      ...
      hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Field](matchingFields))(hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.error.Error],
         hydra.core.Term], hydra.core.Term](Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat(Seq("no such field ",
  ...
  def applyIfNullary(eager2: Boolean)(original: hydra.core.Term)(args: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.error.Error],
    ...
    def forElimination(elm: hydra.core.Elimination)(args2: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
      ...
      val remainingArgs: Seq[hydra.core.Term] = hydra.lib.lists.tail[hydra.core.Term](args2)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](reduceArg(eager2)(hydra.rewriting.deannotateTerm(arg)))((reducedArg: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
    ...
    def forLambda(l: hydra.core.Lambda)(args2: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term] =
      ...
      val arg: hydra.core.Term = hydra.lib.lists.head[hydra.core.Term](args2)
      val remainingArgs: Seq[hydra.core.Term] = hydra.lib.lists.tail[hydra.core.Term](args2)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](reduce(eager2)(hydra.rewriting.deannotateTerm(arg)))((reducedArg: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](reduce(eager2)(hydra.rewriting.replaceFreeTermVariable(param)(reducedArg)(body)))((reducedResult: hydra.core.Term) => applyIfNullary(eager2)(reducedResult)(remainingArgs)))
    }
    def forPrimitive(prim: hydra.graph.Primitive)(arity: Int)(args2: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.error.Error],
       hydra.core.Term] =
      {
      val argList: Seq[hydra.core.Term] = hydra.lib.lists.take[hydra.core.Term](arity)(args2)
      val remainingArgs: Seq[hydra.core.Term] = hydra.lib.lists.drop[hydra.core.Term](arity)(args2)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Term,
        ...
        {
        val strippedArgs: Seq[hydra.core.Term] = hydra.lib.lists.map[hydra.core.Term, hydra.core.Term](hydra.rewriting.deannotateTerm)(reducedArgs)
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](hydra.lib.eithers.bimap[hydra.context.InContext[hydra.error.Error],
          ...
          hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](reduce(eager2)(primResult))((reducedResult: hydra.core.Term) => applyIfNullary(eager2)(reducedResult)(remainingArgs)))
      })
    }
    stripped match
      ...
      case hydra.core.Term.function(v_Term_function_v1) => v_Term_function_v1 match
        case hydra.core.Function.elimination(v_Function_elimination_elm) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error],
           hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Term](args))(Right(original))(forElimination(v_Function_elimination_elm)(args))
        case hydra.core.Function.lambda(v_Function_lambda_l) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error],
        ...
        case hydra.core.Function.primitive(v_Function_primitive_name) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
          ...
          hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]](hydra.lib.equality.gt[Int](arity)(hydra.lib.lists.length[hydra.core.Term](args)))(Right(applyToArguments(original)(args)))(forPrimitive(prim)(arity)(args))
        })
      case hydra.core.Term.variable(v_Term_variable_v) => {
        ...
        hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term], hydra.core.Binding](Right(applyToArguments(original)(args)))((binding: hydra.core.Binding) => applyIfNullary(eager2)(binding.term)(args))(mBinding)
      }
      case hydra.core.Term.let(v_Term_let_lt) => {
        val bindings: Seq[hydra.core.Binding] = (v_Term_let_lt.bindings)
        {
          val body: hydra.core.Term = (v_Term_let_lt.body)
          {
            def letExpr(b: hydra.core.Binding): hydra.core.Term = hydra.core.Term.let(hydra.core.Let(Seq(b), hydra.core.Term.variable(b.name)))
            {
              ...
              {
                val expandedBindings: Seq[hydra.core.Binding] = hydra.lib.lists.map[hydra.core.Binding, hydra.core.Binding](expandBinding)(bindings)
                {
                  def substituteBinding(term2: hydra.core.Term)(b: hydra.core.Binding): hydra.core.Term = hydra.rewriting.replaceFreeTermVariable(b.name)(b.term)(term2)
                  {
                      ...
                      hydra.lib.lists.foldl[hydra.core.Term, hydra.core.Binding](substituteBinding)(term2)(bs)
                    {
                      ...
                      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term,
  ...
  def mapping(recurse: (hydra.core.Term => Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]))(mid: hydra.core.Term): Either[hydra.context.InContext[hydra.error.Error],
     hydra.core.Term] =
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Term, hydra.core.Term](hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error],
