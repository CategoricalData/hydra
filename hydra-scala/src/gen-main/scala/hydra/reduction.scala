    ...
    term match
      ...
      case hydra.core.Term.function(v_Term_function_fn) => v_Term_function_fn match
        ...
        case hydra.core.Function.lambda(v_Function_lambda_lm) => {
          val tx1: hydra.graph.Graph = hydra.rewriting.extendGraphForLambda(tx)(v_Function_lambda_lm)
          {
      ...
      case hydra.core.Term.let(v_Term_let_lt) => {
        val tx1: hydra.graph.Graph = hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx)(v_Term_let_lt)
        {
      ...
      case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => {
        val tx1: hydra.graph.Graph = hydra.rewriting.extendGraphForTypeLambda(tx)(v_Term_typeLambda_tl)
        {
...
def etaExpandTypedTerm(cx: hydra.context.Context)(tx0: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  def rewrite(topLevel: Boolean)(forced: Boolean)(typeArgs: Seq[hydra.core.Type])(recurse: (hydra.graph.Graph => hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error],
    ...
    def arityOf(tx2: hydra.graph.Graph)(term2: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Int] =
      {
      val dflt: Either[hydra.context.InContext[hydra.errors.Error], Int] = hydra.lib.eithers.map[Tuple2[hydra.core.Type,
      ...
      def forFunction(tx3: hydra.graph.Graph)(f: hydra.core.Function): Either[hydra.context.InContext[hydra.errors.Error], Int] =
        ...
        case hydra.core.Function.lambda(v_Function_lambda_l) => {
          val txl: hydra.graph.Graph = hydra.rewriting.extendGraphForLambda(tx3)(v_Function_lambda_l)
      ...
      term2 match
        ...
        case hydra.core.Term.let(v_Term_let_l) => {
          val txl: hydra.graph.Graph = hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx2)(v_Term_let_l)
        ...
        case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => {
          val txt: hydra.graph.Graph = hydra.rewriting.extendGraphForTypeLambda(tx2)(v_Term_typeLambda_tl)
    ...
    term match
      ...
      case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
        ...
        case hydra.core.Function.lambda(v_Function_lambda_l) => {
          val txl: hydra.graph.Graph = hydra.rewriting.extendGraphForLambda(tx)(v_Function_lambda_l)
      ...
      case hydra.core.Term.let(v_Term_let_l) => {
        val txlt: hydra.graph.Graph = hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx)(v_Term_let_l)
        recurse(txlt)(term)
      }
      ...
      case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => {
        val txt: hydra.graph.Graph = hydra.rewriting.extendGraphForTypeLambda(tx)(v_Term_typeLambda_tl)
        recurse(txt)(term)
      }
      case _ => recurseOrForce(term)
  }
