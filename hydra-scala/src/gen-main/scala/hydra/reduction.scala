...
def betaReduceType(cx: hydra.context.Context)(graph: hydra.graph.Graph)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
  {
  def reduceApp(app: hydra.core.ApplicationType): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
    ...
    lhs match
      case hydra.core.Type.annotated(v_Type_annotated_at) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Type, hydra.core.Type](reduceApp(hydra.core.ApplicationType(v_Type_annotated_at.body, rhs)))((a: hydra.core.Type) =>
      ...
      case hydra.core.Type.variable(v_Type_variable_name) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Type, hydra.core.Type](hydra.schemas.requireType(cx)(graph)(v_Type_variable_name))((`t_`: hydra.core.Type) =>
        hydra.reduction.betaReduceType(cx)(graph)(hydra.core.Type.application(hydra.core.ApplicationType(`t_`, rhs))))
  }
  def mapExpr[T0](recurse: (T0 => Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type]))(t: T0): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
    {
            ...
            case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
              case hydra.core.Function.lambda(v_Function_lambda_l) => {
                lazy val v: hydra.core.Name = (v_Function_lambda_l.parameter)
                {
                  ...
                  hydra.lib.logic.ifElse[hydra.core.Term](hydra.rewriting.isFreeVariableInTerm(v)(body))(body)(hydra.rewriting.replaceFreeTermVariable(v)(rhs)(body))
                }
              }
              case _ => rec
            case _ => rec
...
def etaReduceTerm(term: hydra.core.Term): hydra.core.Term =
      ...
      case hydra.core.Term.application(v_Term_application_app) => {
        lazy val lhs: hydra.core.Term = (v_Term_application_app.function)
        {
          ...
          hydra.reduction.etaReduceTerm(rhs) match
            case hydra.core.Term.annotated(v_Term_annotated_at) => reduceLambda(hydra.core.Lambda(v, d, hydra.core.Term.application(hydra.core.Application(lhs, (v_Term_annotated_at.body)))))
            case hydra.core.Term.variable(v_Term_variable_v1) => hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.logic.and(hydra.lib.equality.equal[scala.Predef.String](v)(v_Term_variable_v1))(hydra.lib.logic.not(hydra.rewriting.isFreeVariableInTerm(v)(lhs))))(hydra.reduction.etaReduceTerm(lhs))(noChange)
            case _ => noChange
        }
      }
      case _ => noChange
  ...
  term match
    case hydra.core.Term.annotated(v_Term_annotated_at) => hydra.core.Term.annotated(hydra.core.AnnotatedTerm(hydra.reduction.etaReduceTerm(v_Term_annotated_at.body), (v_Term_annotated_at.annotation)))
    case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
...
def etaExpandTerm(graph: hydra.graph.Graph)(term: hydra.core.Term): hydra.core.Term =
  ...
  def expand(args: Seq[hydra.core.Term])(arity: Int)(t: hydra.core.Term): hydra.core.Term =
    ...
    def pad(indices: Seq[Int])(t2: hydra.core.Term): hydra.core.Term =
      hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.lists.`null`[Int](indices))(t2)(hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda(hydra.lib.strings.cat2("v")(hydra.lib.literals.showInt32(hydra.lib.lists.head[Int](indices))), None, pad(hydra.lib.lists.tail[Int](indices))(hydra.core.Term.application(hydra.core.Application(t2, hydra.core.Term.variable(hydra.lib.strings.cat2("v")(hydra.lib.literals.showInt32(hydra.lib.lists.head[Int](indices)))))))))))
    pad(is)(apps)
  }
  def rewrite(args: Seq[hydra.core.Term])(recurse: (hydra.core.Term => hydra.core.Term))(t: hydra.core.Term): hydra.core.Term =
    ...
    lazy val t2: hydra.core.Term = hydra.rewriting.detypeTerm(t)
    t2 match
      case hydra.core.Term.application(v_Term_application_app) => {
        lazy val lhs: hydra.core.Term = (v_Term_application_app.function)
        {
...
def etaExpandTermNew(tx0: hydra.graph.Graph)(term0: hydra.core.Term): hydra.core.Term =
  {
  lazy val primTypes: Map[hydra.core.Name, hydra.core.TypeScheme] = hydra.lib.maps.fromList[hydra.core.Name, hydra.core.TypeScheme](hydra.lib.lists.map[hydra.graph.Primitive, Tuple2[hydra.core.Name, hydra.core.TypeScheme]]((_gpt_p: hydra.graph.Primitive) => Tuple2(_gpt_p.name, (_gpt_p.`type`)))(hydra.lib.maps.elems[hydra.core.Name, hydra.graph.Primitive](tx0.primitives)))
  def termArityWithContext(tx: hydra.graph.Graph)(term: hydra.core.Term): Int =
    ...
    case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
      ...
      case hydra.core.Function.lambda(_) => 0
      case hydra.core.Function.primitive(v_Function_primitive_name) => hydra.lib.maybes.maybe[Int, hydra.core.TypeScheme](0)(hydra.arity.typeSchemeArity)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Function_primitive_name)(primTypes))
    case hydra.core.Term.let(v_Term_let_l) => termArityWithContext(hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx)(v_Term_let_l))(v_Term_let_l.body)
    case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => termArityWithContext(hydra.rewriting.extendGraphForTypeLambda(tx)(v_Term_typeLambda_tl))(v_Term_typeLambda_tl.body)
    case hydra.core.Term.typeApplication(v_Term_typeApplication_tat) => termArityWithContext(tx)(v_Term_typeApplication_tat.body)
    case hydra.core.Term.variable(v_Term_variable_name) => hydra.lib.maybes.maybe[Int, hydra.core.Type](0)(hydra.arity.typeArity)(hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Term_variable_name)(tx.boundTypes)))
    case _ => 0
  def domainTypes(n: Int)(mt: Option[hydra.core.Type]): Seq[Option[hydra.core.Type]] =
    hydra.lib.logic.ifElse[Seq[Option[hydra.core.Type]]](hydra.lib.equality.lte[Int](n)(0))(Seq())(hydra.lib.maybes.maybe[Seq[Option[hydra.core.Type]], hydra.core.Type](hydra.lib.lists.map[Int, Option[hydra.core.Type]]((_x: Int) => None)(hydra.lib.math.range(1)(n)))((typ: hydra.core.Type) =>
    typ match
    ...
    case hydra.core.Type.forall(_) => hydra.lib.lists.map[Int, Option[hydra.core.Type]]((_2: Int) => None)(hydra.lib.math.range(1)(n))
  ...
  def peelFunctionDomains(mtyp: Option[hydra.core.Type])(n: Int): Option[hydra.core.Type] =
    hydra.lib.logic.ifElse[Option[hydra.core.Type]](hydra.lib.equality.lte[Int](n)(0))(mtyp)(hydra.lib.maybes.maybe[Option[hydra.core.Type], hydra.core.Type](None)((typ: hydra.core.Type) =>
    typ match
    ...
    case hydra.core.Type.forall(_) => None
    case _ => None)(mtyp))
            ...
            lazy val codomainType: Option[hydra.core.Type] = peelFunctionDomains(remainingType)(needed)
            {
              ...
              })(applied)(indices)
              {
                lazy val fullyApplied: hydra.core.Term = hydra.lib.maybes.maybe[hydra.core.Term, hydra.core.Type](fullyAppliedRaw)((ct: hydra.core.Type) =>
                  hydra.core.Term.annotated(hydra.core.AnnotatedTerm(fullyAppliedRaw, hydra.lib.maps.singleton[hydra.core.Name, hydra.core.Term]("type")(hydra.encode.core.`type`(ct)))))(codomainType)
                {
  ...
  def rewriteWithArgs(args: Seq[hydra.core.Term])(tx: hydra.graph.Graph)(term: hydra.core.Term): hydra.core.Term =
    ...
    def termHeadType(tx2: hydra.graph.Graph)(trm2: hydra.core.Term): Option[hydra.core.Type] =
      ...
      case hydra.core.Term.function(v_Term_function_f2) => v_Term_function_f2 match
        case hydra.core.Function.primitive(v_Function_primitive_pn2) => hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Function_primitive_pn2)(primTypes))
        case _ => None
      case hydra.core.Term.let(v_Term_let_l2) => termHeadType(hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx2)(v_Term_let_l2))(v_Term_let_l2.body)
      case hydra.core.Term.typeLambda(v_Term_typeLambda_tl2) => termHeadType(hydra.rewriting.extendGraphForTypeLambda(tx2)(v_Term_typeLambda_tl2))(v_Term_typeLambda_tl2.body)
      case hydra.core.Term.typeApplication(v_Term_typeApplication_tat2) => hydra.lib.maybes.bind[hydra.core.Type, hydra.core.Type](termHeadType(tx2)(v_Term_typeApplication_tat2.body))((htyp2: hydra.core.Type) =>
        htyp2 match
        ...
        case _ => Some(htyp2))
      case hydra.core.Term.variable(v_Term_variable_vn2) => hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Term_variable_vn2)(tx2.boundTypes))
      case _ => None
    ...
    def forElimination(elm: hydra.core.Elimination): hydra.core.Elimination =
      ...
      case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.core.Elimination.union(hydra.core.CaseStatement(v_Elimination_union_cs.typeName, hydra.lib.maybes.map[hydra.core.Term, hydra.core.Term]((t1: hydra.core.Term) => recurse(tx)(t1))(v_Elimination_union_cs.default), hydra.lib.lists.map[hydra.core.Field, hydra.core.Field](forCaseBranch)(v_Elimination_union_cs.cases)))
    ...
    def forMap(mp: Map[hydra.core.Term, hydra.core.Term]): Map[hydra.core.Term, hydra.core.Term] =
      ...
      def forPair(pr: Tuple2[hydra.core.Term, hydra.core.Term]): Tuple2[hydra.core.Term, hydra.core.Term] =
        Tuple2(recurse(tx)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](pr)), recurse(tx)(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](pr)))
      hydra.lib.maps.fromList[hydra.core.Term, hydra.core.Term](hydra.lib.lists.map[Tuple2[hydra.core.Term, hydra.core.Term], Tuple2[hydra.core.Term, hydra.core.Term]](forPair)(hydra.lib.maps.toList[hydra.core.Term, hydra.core.Term](mp)))
    }
    term match
      case hydra.core.Term.annotated(v_Term_annotated_at) => afterRecursion(hydra.core.Term.annotated(hydra.core.AnnotatedTerm(recurse(tx)(v_Term_annotated_at.body), (v_Term_annotated_at.annotation))))
      case hydra.core.Term.application(v_Term_application_app) => {
      ...
      case hydra.core.Term.either(v_Term_either_e) => afterRecursion(hydra.core.Term.either(hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term, Either[hydra.core.Term, hydra.core.Term]]((l: hydra.core.Term) => Left(recurse(tx)(l)))((r: hydra.core.Term) => Right(recurse(tx)(r)))(v_Term_either_e)))
      case hydra.core.Term.function(v_Term_function_fn) => v_Term_function_fn match
        case hydra.core.Function.elimination(v_Function_elimination_elm) => {
          lazy val padElim: Boolean = v_Function_elimination_elm match
            case hydra.core.Elimination.record(_) => false
            case hydra.core.Elimination.union(_) => true
            case hydra.core.Elimination.wrap(_) => false
          {
            lazy val elimTerm: hydra.core.Term = hydra.core.Term.function(hydra.core.Function.elimination(forElimination(v_Function_elimination_elm)))
            {
              lazy val elimHeadType: Option[hydra.core.Type] = v_Function_elimination_elm match
                case hydra.core.Elimination.union(v_Elimination_union_cs2) => Some(hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.variable(v_Elimination_union_cs2.typeName), hydra.core.Type.unit)))
                case _ => None
        ...
        case hydra.core.Function.lambda(v_Function_lambda_lm) => {
          lazy val tx1: hydra.graph.Graph = hydra.rewriting.extendGraphForLambda(tx)(v_Function_lambda_lm)
          {
            lazy val body: hydra.core.Term = rewriteWithArgs(Seq())(tx1)(v_Function_lambda_lm.body)
            {
              lazy val result: hydra.core.Term = hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda(v_Function_lambda_lm.parameter, (v_Function_lambda_lm.domain), body)))
              {
        ...
        case hydra.core.Function.primitive(v_Function_primitive_pn) => {
          ...
          {
            lazy val primType: Option[hydra.core.Type] = hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type]((ts: hydra.core.TypeScheme) => (ts.`type`))(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Function_primitive_pn)(primTypes))
            expand(false)(args)(arty)(primType)(term)
          }
        }
      case hydra.core.Term.let(v_Term_let_lt) => {
        lazy val tx1: hydra.graph.Graph = hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx)(v_Term_let_lt)
        {
          def mapBinding(b: hydra.core.Binding): hydra.core.Binding = hydra.core.Binding(b.name, rewriteWithArgs(Seq())(tx1)(b.term), (b.`type`))
          {
            lazy val result: hydra.core.Term = hydra.core.Term.let(hydra.core.Let(hydra.lib.lists.map[hydra.core.Binding, hydra.core.Binding](mapBinding)(v_Term_let_lt.bindings), rewriteWithArgs(Seq())(tx1)(v_Term_let_lt.body)))
            afterRecursion(result)
          }
        }
      }
      case hydra.core.Term.list(v_Term_list_els) => afterRecursion(hydra.core.Term.list(hydra.lib.lists.map[hydra.core.Term, hydra.core.Term]((el: hydra.core.Term) => recurse(tx)(el))(v_Term_list_els)))
      ...
      case hydra.core.Term.maybe(v_Term_maybe_mb) => afterRecursion(hydra.core.Term.maybe(hydra.lib.maybes.map[hydra.core.Term, hydra.core.Term]((v: hydra.core.Term) => recurse(tx)(v))(v_Term_maybe_mb)))
      case hydra.core.Term.pair(v_Term_pair_pr) => afterRecursion(hydra.core.Term.pair(Tuple2(recurse(tx)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](v_Term_pair_pr)), recurse(tx)(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](v_Term_pair_pr)))))
      case hydra.core.Term.record(v_Term_record_rc) => afterRecursion(hydra.core.Term.record(hydra.core.Record(v_Term_record_rc.typeName, hydra.lib.lists.map[hydra.core.Field, hydra.core.Field](forField)(v_Term_record_rc.fields))))
      case hydra.core.Term.set(v_Term_set_st) => afterRecursion(hydra.core.Term.set(hydra.lib.sets.fromList[hydra.core.Term](hydra.lib.lists.map[hydra.core.Term, hydra.core.Term]((el: hydra.core.Term) => recurse(tx)(el))(hydra.lib.sets.toList[hydra.core.Term](v_Term_set_st)))))
      case hydra.core.Term.typeApplication(v_Term_typeApplication_tt) => afterRecursion(hydra.core.Term.typeApplication(hydra.core.TypeApplicationTerm(recurse(tx)(v_Term_typeApplication_tt.body), (v_Term_typeApplication_tt.`type`))))
      case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => {
        lazy val tx1: hydra.graph.Graph = hydra.rewriting.extendGraphForTypeLambda(tx)(v_Term_typeLambda_tl)
        {
          lazy val result: hydra.core.Term = hydra.core.Term.typeLambda(hydra.core.TypeLambda(v_Term_typeLambda_tl.parameter, rewriteWithArgs(Seq())(tx1)(v_Term_typeLambda_tl.body)))
          afterRecursion(result)
        }
      }
      case hydra.core.Term.union(v_Term_union_inj) => afterRecursion(hydra.core.Term.union(hydra.core.Injection(v_Term_union_inj.typeName, forField(v_Term_union_inj.field))))
      case hydra.core.Term.unit => hydra.core.Term.unit
      case hydra.core.Term.variable(v_Term_variable_vn) => {
        lazy val arty: Int = termArityWithContext(tx)(term)
        {
          lazy val varType: Option[hydra.core.Type] = hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Term_variable_vn)(tx.boundTypes))
          expand(false)(args)(arty)(varType)(term)
        }
      }
      case hydra.core.Term.wrap(v_Term_wrap_wt) => afterRecursion(hydra.core.Term.wrap(hydra.core.WrappedTerm(v_Term_wrap_wt.typeName, recurse(tx)(v_Term_wrap_wt.body))))
  }
...
def etaExpansionArity(graph: hydra.graph.Graph)(term: hydra.core.Term): Int =
  ...
  case hydra.core.Term.variable(v_Term_variable_name) => hydra.lib.maybes.maybe[Int, hydra.core.TypeScheme](0)((ts: hydra.core.TypeScheme) => hydra.arity.typeArity(ts.`type`))(hydra.lib.maybes.bind[hydra.core.Binding, hydra.core.TypeScheme](hydra.lexical.lookupElement(graph)(v_Term_variable_name))((b: hydra.core.Binding) => (b.`type`)))
  case _ => 0

def etaExpandTypedTerm(cx: hydra.context.Context)(tx0: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
  {
  def rewrite(topLevel: Boolean)(forced: Boolean)(typeArgs: Seq[hydra.core.Type])(recurse: (hydra.graph.Graph => hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]))(tx: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
    {
    def rewriteSpine(term2: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
      term2 match
      case hydra.core.Term.annotated(v_Term_annotated_at) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](rewriteSpine(v_Term_annotated_at.body))((body: hydra.core.Term) =>
        {
      ...
      case hydra.core.Term.typeApplication(v_Term_typeApplication_tat) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](rewriteSpine(v_Term_typeApplication_tat.body))((body: hydra.core.Term) =>
        {
    ...
    def arityOf(tx2: hydra.graph.Graph)(term2: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Int] =
      {
      lazy val dflt: Either[hydra.context.InContext[hydra.errors.Error], Int] = hydra.lib.eithers.map[Tuple2[hydra.core.Type, hydra.context.Context], Int, hydra.context.InContext[hydra.errors.Error]]((_tc: Tuple2[hydra.core.Type, hydra.context.Context]) =>
      ...
      def forFunction(tx3: hydra.graph.Graph)(f: hydra.core.Function): Either[hydra.context.InContext[hydra.errors.Error], Int] =
        f match
        case hydra.core.Function.elimination(_) => Right(1)
        case hydra.core.Function.lambda(v_Function_lambda_l) => {
          lazy val txl: hydra.graph.Graph = hydra.rewriting.extendGraphForLambda(tx3)(v_Function_lambda_l)
          arityOf(txl)(v_Function_lambda_l.body)
        }
        case hydra.core.Function.primitive(v_Function_primitive_name) => hydra.lib.eithers.map[hydra.core.TypeScheme, Int, hydra.context.InContext[hydra.errors.Error]]((_ts: hydra.core.TypeScheme) => hydra.arity.typeSchemeArity(_ts))(hydra.lexical.requirePrimitiveType(cx)(tx3)(v_Function_primitive_name))
      term2 match
        ...
        case hydra.core.Term.let(v_Term_let_l) => {
          lazy val txl: hydra.graph.Graph = hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx2)(v_Term_let_l)
        ...
        case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => {
          lazy val txt: hydra.graph.Graph = hydra.rewriting.extendGraphForTypeLambda(tx2)(v_Term_typeLambda_tl)
          arityOf(txt)(v_Term_typeLambda_tl.body)
        }
        case hydra.core.Term.variable(v_Term_variable_name) => hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Int], hydra.core.Type](hydra.lib.eithers.map[Tuple2[hydra.core.Type, hydra.context.Context], Int, hydra.context.InContext[hydra.errors.Error]]((_tc: Tuple2[hydra.core.Type, hydra.context.Context]) =>
          hydra.arity.typeArity(hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context](_tc)))(hydra.checking.typeOf(cx)(tx2)(Seq())(hydra.core.Term.variable(v_Term_variable_name))))((t: hydra.core.Type) => Right(hydra.arity.typeArity(t)))(hydra.lib.maybes.map[hydra.core.TypeScheme, hydra.core.Type](hydra.rewriting.typeSchemeToFType)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](v_Term_variable_name)(tx2.boundTypes)))
        case _ => dflt
    }
    ...
    def pad(vars: Seq[hydra.core.Name])(body: hydra.core.Term): hydra.core.Term =
      hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.lists.`null`[hydra.core.Name](vars))(body)(hydra.core.Term.function(hydra.core.Function.lambda(hydra.core.Lambda(hydra.lib.lists.head[hydra.core.Name](vars), None, pad(hydra.lib.lists.tail[hydra.core.Name](vars))(hydra.core.Term.application(hydra.core.Application(body, hydra.core.Term.variable(hydra.lib.lists.head[hydra.core.Name](vars)))))))))
    ...
    def forceExpansion(t: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context], hydra.core.Term](hydra.checking.typeOf(cx)(tx)(Seq())(t))((typCx: Tuple2[hydra.core.Type, hydra.context.Context]) =>
      {
    ...
    def forCase(f: hydra.core.Field): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Field] =
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Field](rewrite(false)(true)(Seq())(recurse)(tx)(f.term))((r: hydra.core.Term) => Right(hydra.core.Field(f.name, r)))
    def forCaseStatement(cs: hydra.core.CaseStatement): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapMaybe[hydra.core.Term, hydra.core.Term, hydra.context.InContext[hydra.errors.Error]]((v1: hydra.core.Term) => rewrite(false)(false)(Seq())(recurse)(tx)(v1))(dflt))((rdflt: Option[hydra.core.Term]) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Field], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Field, hydra.core.Field, hydra.context.InContext[hydra.errors.Error]](forCase)(cases))((rcases: Seq[hydra.core.Field]) =>
    ...
    def forElimination(elm: hydra.core.Elimination): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](hydra.lib.eithers.map[hydra.core.Term, hydra.core.Term, hydra.context.InContext[hydra.errors.Error]](unwind)(checkBase(elm)))((base: hydra.core.Term) =>
    ...
    term match
      ...
      case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
        ...
        case hydra.core.Function.lambda(v_Function_lambda_l) => {
          lazy val txl: hydra.graph.Graph = hydra.rewriting.extendGraphForLambda(tx)(v_Function_lambda_l)
      ...
      case hydra.core.Term.let(v_Term_let_l) => {
        lazy val txlt: hydra.graph.Graph = hydra.rewriting.extendGraphForLet((_x: hydra.graph.Graph) => (_2: hydra.core.Binding) => None)(tx)(v_Term_let_l)
        recurse(txlt)(term)
      }
      ...
      case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => {
        lazy val txt: hydra.graph.Graph = hydra.rewriting.extendGraphForTypeLambda(tx)(v_Term_typeLambda_tl)
        recurse(txt)(term)
      }
      case _ => recurseOrForce(term)
  }
  hydra.rewriting.rewriteTermWithContextM((v1: (hydra.graph.Graph => hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term])) =>
    (v2: hydra.graph.Graph) =>
    (v3: hydra.core.Term) => rewrite(true)(false)(Seq())(v1)(v2)(v3))(tx0)(term0)
}

def reduceTerm(cx: hydra.context.Context)(graph: hydra.graph.Graph)(eager: Boolean)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
  {
  def reduce(eager2: Boolean)(v1: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] = hydra.reduction.reduceTerm(cx)(graph)(eager2)(v1)
  def doRecurse(eager2: Boolean)(term2: hydra.core.Term): Boolean =
    {
    def isNonLambda(f: hydra.core.Function): Boolean =
      f match
      case hydra.core.Function.lambda(_) => false
      case _ => true
    lazy val isNonLambdaTerm: Boolean = term2 match
      ...
      case hydra.core.Term.let(_) => false
      case _ => true
  ...
  def applyToArguments(fun: hydra.core.Term)(args: Seq[hydra.core.Term]): hydra.core.Term =
    hydra.lib.logic.ifElse[hydra.core.Term](hydra.lib.lists.`null`[hydra.core.Term](args))(fun)(applyToArguments(hydra.core.Term.application(hydra.core.Application(fun, hydra.lib.lists.head[hydra.core.Term](args))))(hydra.lib.lists.tail[hydra.core.Term](args)))
  ...
  def applyElimination(elm: hydra.core.Elimination)(reducedArg: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
    elm match
    case hydra.core.Elimination.record(v_Elimination_record_proj) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Field], hydra.core.Term](hydra.extract.core.record(cx)(v_Elimination_record_proj.typeName)(graph)(hydra.rewriting.deannotateTerm(reducedArg)))((fields: Seq[hydra.core.Field]) =>
      {
      ...
      hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Field](matchingFields))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat(Seq("no such field: ", (v_Elimination_record_proj.field), " in ", (v_Elimination_record_proj.typeName), " record"))), cx)))(Right(hydra.lib.lists.head[hydra.core.Field](matchingFields).term))
    })
    case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Field, hydra.core.Term](hydra.extract.core.injection(cx)(v_Elimination_union_cs.typeName)(graph)(reducedArg))((field: hydra.core.Field) =>
      {
      lazy val matchingFields: Seq[hydra.core.Field] = hydra.lib.lists.filter[hydra.core.Field]((f: hydra.core.Field) =>
        hydra.lib.equality.equal[hydra.core.Name](f.name)(field.name))(v_Elimination_union_cs.cases)
      hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Field](matchingFields))(hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term], hydra.core.Term](Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat(Seq("no such field ", (field.name), " in ", (v_Elimination_union_cs.typeName), " case statement"))), cx)))((x: hydra.core.Term) => Right(x))(v_Elimination_union_cs.default))(Right(hydra.core.Term.application(hydra.core.Application(hydra.lib.lists.head[hydra.core.Field](matchingFields).term, (field.term)))))
    })
  ...
  def applyIfNullary(eager2: Boolean)(original: hydra.core.Term)(args: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
    {
    lazy val stripped: hydra.core.Term = hydra.rewriting.deannotateTerm(original)
    def forElimination(elm: hydra.core.Elimination)(args2: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](reduceArg(eager2)(hydra.rewriting.deannotateTerm(arg)))((reducedArg: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](applyElimination(elm)(reducedArg))((v1: hydra.core.Term) => reduce(eager2)(v1)))((reducedResult: hydra.core.Term) => applyIfNullary(eager2)(reducedResult)(remainingArgs)))
    }
    def forLambda(l: hydra.core.Lambda)(args2: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
      ...
      lazy val arg: hydra.core.Term = hydra.lib.lists.head[hydra.core.Term](args2)
      lazy val remainingArgs: Seq[hydra.core.Term] = hydra.lib.lists.tail[hydra.core.Term](args2)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](reduce(eager2)(hydra.rewriting.deannotateTerm(arg)))((reducedArg: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](reduce(eager2)(hydra.rewriting.replaceFreeTermVariable(param)(reducedArg)(body)))((reducedResult: hydra.core.Term) => applyIfNullary(eager2)(reducedResult)(remainingArgs)))
    }
    def forPrimitive(prim: hydra.graph.Primitive)(arity: Int)(args2: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
      {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Term], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.Term, hydra.core.Term, hydra.context.InContext[hydra.errors.Error]]((v1: hydra.core.Term) => reduceArg(eager2)(v1))(argList))((reducedArgs: Seq[hydra.core.Term]) =>
        {
        lazy val strippedArgs: Seq[hydra.core.Term] = hydra.lib.lists.map[hydra.core.Term, hydra.core.Term](hydra.rewriting.deannotateTerm)(reducedArgs)
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](hydra.lib.eithers.bimap[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.context.InContext[hydra.errors.Error], hydra.core.Term](mapErrorToString)((x: hydra.core.Term) => x)(prim.implementation(cx)(graph)(strippedArgs)))((primResult: hydra.core.Term) =>
    ...
    stripped match
      ...
      case hydra.core.Term.function(v_Term_function_v1) => v_Term_function_v1 match
        case hydra.core.Function.elimination(v_Function_elimination_elm) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Term](args))(Right(original))(forElimination(v_Function_elimination_elm)(args))
        case hydra.core.Function.lambda(v_Function_lambda_l) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Term](args))(Right(original))(forLambda(v_Function_lambda_l)(args))
        case hydra.core.Function.primitive(v_Function_primitive_name) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.graph.Primitive, hydra.core.Term](hydra.lexical.requirePrimitive(cx)(graph)(v_Function_primitive_name))((prim: hydra.graph.Primitive) =>
          {
                ...
                lazy val expandedBindings: Seq[hydra.core.Binding] = hydra.lib.lists.map[hydra.core.Binding, hydra.core.Binding](expandBinding)(bindings)
                {
                  def substituteBinding(term2: hydra.core.Term)(b: hydra.core.Binding): hydra.core.Term = hydra.rewriting.replaceFreeTermVariable(b.name)(b.term)(term2)
                  {
                      ...
                      hydra.lib.lists.foldl[hydra.core.Term, hydra.core.Binding](substituteBinding)(term2)(bs)
                    {
                      ...
                      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](reduce(eager2)(expandedBody))((reducedBody: hydra.core.Term) => applyIfNullary(eager2)(reducedBody)(args))
                    }
                  }
                }
              }
  ...
  def mapping(recurse: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]))(mid: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Term](hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](doRecurse(eager)(mid))(recurse(mid))(Right(mid)))((inner: hydra.core.Term) => applyIfNullary(eager)(inner)(Seq()))
  hydra.rewriting.rewriteTermM(mapping)(term)
}

def termIsClosed(term: hydra.core.Term): Boolean =
  hydra.lib.sets.`null`[hydra.core.Name](hydra.rewriting.freeVariablesInTerm(term))
...
def termIsValue(term: hydra.core.Term): Boolean =
  ...
  def functionIsValue(f: hydra.core.Function): Boolean =
    ...
    case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
      case hydra.core.Elimination.wrap(_) => true
      case hydra.core.Elimination.record(_) => true
      case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.lib.logic.and(checkFields(v_Elimination_union_cs.cases))(hydra.lib.maybes.maybe[Boolean, hydra.core.Term](true)(hydra.reduction.termIsValue)(v_Elimination_union_cs.default))
    case hydra.core.Function.lambda(v_Function_lambda_l) => hydra.reduction.termIsValue(v_Function_lambda_l.body)
    case hydra.core.Function.primitive(_) => true
  hydra.rewriting.deannotateTerm(term) match
    case hydra.core.Term.application(_) => false
    case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term, Boolean]((l: hydra.core.Term) => hydra.reduction.termIsValue(l))((r: hydra.core.Term) => hydra.reduction.termIsValue(r))(v_Term_either_e)
    case hydra.core.Term.literal(_) => true
    ...
    case hydra.core.Term.map(v_Term_map_m) => hydra.lib.lists.foldl[Boolean, Tuple2[hydra.core.Term, hydra.core.Term]]((b: Boolean) =>
      ...
      hydra.lib.logic.and(b)(hydra.lib.logic.and(hydra.reduction.termIsValue(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](kv)))(hydra.reduction.termIsValue(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](kv)))))(true)(hydra.lib.maps.toList[hydra.core.Term, hydra.core.Term](v_Term_map_m))
    ...
    case hydra.core.Term.variable(_) => false
    case _ => false
}
