...
def functionStructure[T0](env: (T0 => hydra.core.Term))(x: hydra.typing.FunctionStructure[T0]): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.typing.FunctionStructure", Seq(hydra.core.Field("typeParams",
     hydra.core.Term.list(lists.map[hydra.core.Name, hydra.core.Term](hydra.encode.core.name)(x.typeParams))),
     hydra.core.Field("params", hydra.core.Term.list(lists.map[hydra.core.Name, hydra.core.Term](hydra.encode.core.name)(x.params))),
     hydra.core.Field("bindings", hydra.core.Term.list(lists.map[hydra.core.Binding, hydra.core.Term](hydra.encode.core.binding)(x.bindings))),
     hydra.core.Field("body", hydra.encode.core.term(x.body)), hydra.core.Field("domains", hydra.core.Term.list(lists.map[hydra.core.Type,
     hydra.core.Term](hydra.encode.core.`type`)(x.domains))), hydra.core.Field("codomain", hydra.core.Term.maybe(maybes.map[hydra.core.Type,
...
def inferenceResult(x: hydra.typing.InferenceResult): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.typing.InferenceResult", Seq(hydra.core.Field("term",
     ...
     hydra.encode.typing.typeSubst(x.subst)), hydra.core.Field("classConstraints", hydra.core.Term.map(maps.bimap[hydra.core.Name,
...
def termSubst(x: hydra.typing.TermSubst): hydra.core.Term =
  hydra.core.Term.wrap(hydra.core.WrappedTerm("hydra.typing.TermSubst", hydra.core.Term.map(maps.bimap[hydra.core.Name,
...
def typeSubst(x: hydra.typing.TypeSubst): hydra.core.Term =
  hydra.core.Term.wrap(hydra.core.WrappedTerm("hydra.typing.TypeSubst", hydra.core.Term.map(maps.bimap[hydra.core.Name,
