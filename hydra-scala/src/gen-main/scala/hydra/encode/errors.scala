...
def error(v1: hydra.errors.Error): hydra.core.Term =
  ...
  case hydra.errors.Error.undefinedTerm(v_Error_undefinedTerm_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.Error", hydra.core.Field("undefinedTerm", hydra.encode.error.core.undefinedTermError(v_Error_undefinedTerm_y))))
  case hydra.errors.Error.undefinedType(v_Error_undefinedType_y) => hydra.core.Term.union(hydra.core.Injection("hydra.errors.Error", hydra.core.Field("undefinedType", hydra.encode.error.core.undefinedTypeError(v_Error_undefinedType_y))))
