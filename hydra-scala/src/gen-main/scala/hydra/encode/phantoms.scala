...
def tBinding[T0, T1](a: T0)(x: hydra.phantoms.TBinding[T1]): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.phantoms.TBinding", Seq(hydra.core.Field("name", hydra.encode.core.name(x.name)), hydra.core.Field("term", hydra.encode.phantoms.tTerm(a)(x.term)))))
