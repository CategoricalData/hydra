...
def tarjanState(x: hydra.topology.TarjanState): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.topology.TarjanState", Seq(hydra.core.Field("counter",
     ...
     hydra.core.Term.map(hydra.lib.maps.bimap[Int, hydra.core.Term, Int, hydra.core.Term](hydra.encode.topology.vertex)((x2: Int) =>
  hydra.core.Term.literal(hydra.core.Literal.integer(hydra.core.IntegerValue.int32(x2))))(x.indices))),
     hydra.core.Field("lowLinks", hydra.core.Term.map(hydra.lib.maps.bimap[Int, hydra.core.Term, Int,
     hydra.core.Term](hydra.encode.topology.vertex)((x2: Int) =>
