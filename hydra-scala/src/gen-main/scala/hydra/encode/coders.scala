...
def coderDirection(v1: hydra.coders.CoderDirection): hydra.core.Term =
  v1 match
  case hydra.coders.CoderDirection.encode => hydra.core.Term.union(hydra.core.Injection("hydra.coders.CoderDirection",
     hydra.core.Field("encode", hydra.core.Term.unit)))
  case hydra.coders.CoderDirection.decode => hydra.core.Term.union(hydra.core.Injection("hydra.coders.CoderDirection",
...
def traversalOrder(v1: hydra.coders.TraversalOrder): hydra.core.Term =
  v1 match
  case hydra.coders.TraversalOrder.pre => hydra.core.Term.union(hydra.core.Injection("hydra.coders.TraversalOrder",
     hydra.core.Field("pre", hydra.core.Term.unit)))
  case hydra.coders.TraversalOrder.post => hydra.core.Term.union(hydra.core.Injection("hydra.coders.TraversalOrder",
