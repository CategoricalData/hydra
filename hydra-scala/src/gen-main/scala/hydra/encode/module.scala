...
def module(x: hydra.module.Module): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.module.Module", Seq(hydra.core.Field("namespace", hydra.encode.module.namespace(x.namespace)),
     hydra.core.Field("definitions", hydra.core.Term.list(hydra.lib.lists.map[hydra.module.Definition,
     hydra.core.Term](hydra.encode.module.definition)(x.definitions))), hydra.core.Field("termDependencies",
     hydra.core.Term.list(hydra.lib.lists.map[hydra.module.Namespace, hydra.core.Term](hydra.encode.module.namespace)(x.termDependencies))),
     hydra.core.Field("typeDependencies", hydra.core.Term.list(hydra.lib.lists.map[hydra.module.Namespace,
     hydra.core.Term](hydra.encode.module.namespace)(x.typeDependencies))), hydra.core.Field("description",
