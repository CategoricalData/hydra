...
def dataRow[T0](v: (T0 => hydra.core.Term))(x: hydra.tabular.DataRow[T0]): hydra.core.Term =
  hydra.core.Term.wrap(hydra.core.WrappedTerm("hydra.tabular.DataRow", hydra.core.Term.list(lists.map[Option[T0], hydra.core.Term]((opt: Option[T0]) =>
  hydra.core.Term.maybe(maybes.map[T0, hydra.core.Term](v)(opt)))(x))))

def headerRow(x: hydra.tabular.HeaderRow): hydra.core.Term =
  hydra.core.Term.wrap(hydra.core.WrappedTerm("hydra.tabular.HeaderRow", hydra.core.Term.list(lists.map[scala.Predef.String,
...
def table[T0](v: (T0 => hydra.core.Term))(x: hydra.tabular.Table[T0]): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.tabular.Table", Seq(hydra.core.Field("header", hydra.core.Term.maybe(maybes.map[hydra.tabular.HeaderRow,
     hydra.core.Term](hydra.encode.tabular.headerRow)(x.header))), hydra.core.Field("data", hydra.core.Term.list(lists.map[hydra.tabular.DataRow[T0],
...
def tableType(x: hydra.tabular.TableType): hydra.core.Term =
  hydra.core.Term.record(hydra.core.Record("hydra.tabular.TableType", Seq(hydra.core.Field("name", hydra.encode.relational.relationName(x.name)),
     hydra.core.Field("columns", hydra.core.Term.list(lists.map[hydra.tabular.ColumnType, hydra.core.Term](hydra.encode.tabular.columnType)(x.columns))))))
