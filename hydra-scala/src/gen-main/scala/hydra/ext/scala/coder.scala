...
def constructModule(cx: hydra.context.Context)(g: hydra.graph.Graph)(mod: hydra.module.Module)(defs: Seq[hydra.module.Definition]): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Pkg] =
  {
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Pkg](hydra.lib.eithers.mapList[hydra.module.TypeDefinition, hydra.ext.scala.syntax.Stat, hydra.context.InContext[hydra.errors.Error]]((td: hydra.module.TypeDefinition) => hydra.ext.scala.coder.encodeTypeDefinition(cx)(g)(td))(typeDefs))((typeDeclStats: Seq[hydra.ext.scala.syntax.Stat]) =>
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Pkg](hydra.lib.eithers.mapList[hydra.module.TermDefinition, hydra.ext.scala.syntax.Stat, hydra.context.InContext[hydra.errors.Error]]((td: hydra.module.TermDefinition) => hydra.ext.scala.coder.encodeTermDefinition(cx)(g)(td))(termDefs))((termDeclStats: Seq[hydra.ext.scala.syntax.Stat]) =>
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Pkg](hydra.ext.scala.coder.findImports(cx)(g)(mod))((imports: Seq[hydra.ext.scala.syntax.Stat]) =>
...
def encodeCase(cx: hydra.context.Context)(g: hydra.graph.Graph)(ftypes: Map[hydra.core.Name, hydra.core.Type])(sn: Option[hydra.core.Name])(f: hydra.core.Field): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Case] =
  {
  ...
  lazy val shortTypeName: scala.Predef.String = hydra.lib.lists.last[scala.Predef.String](hydra.lib.strings.splitOn(".")(hydra.lib.maybes.maybe[scala.Predef.String, hydra.core.Name]("x")((n: hydra.core.Name) => n)(sn)))
  ...
  lazy val pat: hydra.ext.scala.syntax.Pat = hydra.ext.scala.syntax.Pat.extract(hydra.ext.scala.syntax.Pat_Extract(hydra.ext.scala.utils.sname(hydra.ext.scala.utils.qualifyUnionFieldName("MATCHED.")(sn)(fname)), patArgs))
  lazy val applied: hydra.core.Term = hydra.ext.scala.coder.applyVar(fterm)(v)
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Case](hydra.ext.scala.coder.encodeTerm(cx)(g)(applied))((body: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.syntax.Case(pat, None, body)))
}

def encodeComplexTermDef(cx: hydra.context.Context)(g: hydra.graph.Graph)(lname: scala.Predef.String)(term: hydra.core.Term)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat] =
  {
  ...
  lazy val zippedParams: Seq[Tuple2[hydra.core.Name, hydra.core.Type]] = hydra.lib.lists.zip[hydra.core.Name, hydra.core.Type](hydra.lib.lists.take[hydra.core.Name](paramCount)(paramNames))(hydra.lib.lists.take[hydra.core.Type](paramCount)(doms))
  ...
  lazy val gWithTypeVars: hydra.graph.Graph = hydra.graph.Graph(g.boundTerms, (g.boundTypes), (g.classConstraints), (g.lambdaVariables), (g.metadata), (g.primitives), (g.schemaTypes), hydra.lib.sets.union[hydra.core.Name](hydra.lib.sets.fromList[hydra.core.Name](freeTypeVars))(g.typeVariables))
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data_Param], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[Tuple2[hydra.core.Name, hydra.core.Type], hydra.ext.scala.syntax.Data_Param, hydra.context.InContext[hydra.errors.Error]]((v1: Tuple2[hydra.core.Name, hydra.core.Type]) =>
    ...
    {
    lazy val gForLets: hydra.graph.Graph = hydra.lib.logic.ifElse[hydra.graph.Graph](hydra.lib.lists.`null`[hydra.core.Binding](letBindings))(gWithTypeVars)(hydra.rewriting.extendGraphForLet(hydra.coderUtils.bindingMetadata)(gWithTypeVars)(hydra.core.Let(letBindings, hydra.core.Term.variable("dummy"))))
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.Binding, hydra.ext.scala.syntax.Stat, hydra.context.InContext[hydra.errors.Error]]((v1: hydra.core.Binding) =>
      ...
      Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`def`(hydra.ext.scala.syntax.Defn_Def(Seq(), hydra.ext.scala.syntax.Data_Name(lname), tparams, hydra.lib.lists.map[hydra.ext.scala.syntax.Data_Param, Seq[hydra.ext.scala.syntax.Data_Param]]((p: hydra.ext.scala.syntax.Data_Param) => Seq(p))(sparams), Some(scod), defBody))))
    })
  })))
}

def encodeFunction(cx: hydra.context.Context)(g: hydra.graph.Graph)(meta: Map[hydra.core.Name, hydra.core.Term])(fun: hydra.core.Function)(arg: Option[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data] =
  fun match
  case hydra.core.Function.lambda(v_Function_lambda_lam) => {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(body))((sbody: hydra.ext.scala.syntax.Data) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type]], hydra.core.Type](hydra.ext.scala.coder.findSdom(cx)(g)(meta))((dom: hydra.core.Type) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(dom))((sdom: hydra.ext.scala.syntax.Type) => Right(Some(sdom))))(mdom))((sdom: Option[hydra.ext.scala.syntax.Type]) => Right(hydra.ext.scala.utils.slambda(v)(sbody)(sdom))))
  }
  ...
  case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
    case hydra.core.Elimination.wrap(v_Elimination_wrap_name) => hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data], hydra.core.Term](hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.findSdom(cx)(g)(meta))((sdom: Option[hydra.ext.scala.syntax.Type]) =>
    ...
    case hydra.core.Elimination.record(v_Elimination_record_proj) => {
      ...
      hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data], hydra.core.Term](hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.lib.eithers.either[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type], Either[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type]]]((_x: hydra.context.InContext[hydra.errors.Error]) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(hydra.core.Type.variable(typeName)))((st: hydra.ext.scala.syntax.Type) => Right(Some(st))))((msdom: Option[hydra.ext.scala.syntax.Type]) =>
        hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type]], hydra.ext.scala.syntax.Type](hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(hydra.core.Type.variable(typeName)))((st: hydra.ext.scala.syntax.Type) => Right(Some(st))))((sdom: hydra.ext.scala.syntax.Type) => Right(Some(sdom)))(msdom))(hydra.ext.scala.coder.findSdom(cx)(g)(meta)))((msdom: Option[hydra.ext.scala.syntax.Type]) =>
        Right(hydra.ext.scala.utils.slambda(pv)(hydra.ext.scala.syntax.Data.ref(hydra.ext.scala.syntax.Data_Ref.select(hydra.ext.scala.syntax.Data_Select(hydra.ext.scala.utils.sname(pv), hydra.ext.scala.syntax.Data_Name(fname)))))(msdom))))((a: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(a))((sa: hydra.ext.scala.syntax.Data) =>
        Right(hydra.ext.scala.syntax.Data.ref(hydra.ext.scala.syntax.Data_Ref.select(hydra.ext.scala.syntax.Data_Select(sa, hydra.ext.scala.syntax.Data_Name(fname)))))))(arg)
    }
    case hydra.core.Elimination.union(v_Elimination_union_cs) => {
      ...
      lazy val ftypes: Map[hydra.core.Name, hydra.core.Type] = hydra.lib.eithers.either[hydra.context.InContext[hydra.errors.Error], Map[hydra.core.Name, hydra.core.Type], Map[hydra.core.Name, hydra.core.Type]]((_x: hydra.context.InContext[hydra.errors.Error]) => hydra.lib.maps.empty[hydra.core.Name, hydra.core.Type])((`x_`: Map[hydra.core.Name, hydra.core.Type]) => `x_`)(hydra.schemas.fieldTypes(cx)(g)(dom))
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Case], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Field, hydra.ext.scala.syntax.Case, hydra.context.InContext[hydra.errors.Error]]((f: hydra.core.Field) => hydra.ext.scala.coder.encodeCase(cx)(g)(ftypes)(sn)(f))(cases))((fieldCases: Seq[hydra.ext.scala.syntax.Case]) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Case], hydra.ext.scala.syntax.Data](hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Case]], hydra.core.Term](Right(fieldCases))((dfltTerm: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, Seq[hydra.ext.scala.syntax.Case]](hydra.ext.scala.coder.encodeTerm(cx)(g)(dfltTerm))((sdflt: hydra.ext.scala.syntax.Data) =>
        Right(hydra.lib.lists.concat2[hydra.ext.scala.syntax.Case](fieldCases)(Seq(hydra.ext.scala.syntax.Case(hydra.ext.scala.syntax.Pat.wildcard, None, sdflt))))))(dflt))((scases: Seq[hydra.ext.scala.syntax.Case]) =>
        hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data], hydra.core.Term](hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.findSdom(cx)(g)(meta))((sdom: Option[hydra.ext.scala.syntax.Type]) =>
        Right(hydra.ext.scala.utils.slambda(v)(hydra.ext.scala.syntax.Data.`match`(hydra.ext.scala.syntax.Data_Match(hydra.ext.scala.utils.sname(v), scases)))(sdom))))((a: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(a))((sa: hydra.ext.scala.syntax.Data) =>
...
def encodeLetBinding(cx: hydra.context.Context)(g: hydra.graph.Graph)(outerTypeVars: scala.collection.immutable.Set[hydra.core.Name])(b: hydra.core.Binding): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat] =
  {
  lazy val bname: scala.Predef.String = hydra.ext.scala.utils.scalaEscapeName(b.name)
  lazy val bterm: hydra.core.Term = (b.term)
  lazy val mts: Option[hydra.core.TypeScheme] = hydra.lib.maybes.maybe[Option[hydra.core.TypeScheme], hydra.core.TypeScheme](hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](b.name)(g.boundTypes))((ts: hydra.core.TypeScheme) => Some(ts))(b.`type`)
  lazy val isFn: Boolean = hydra.lib.maybes.maybe[Boolean, hydra.core.TypeScheme](false)((ts: hydra.core.TypeScheme) =>
    ...
    case hydra.core.Type.forall(v_Type_forall_fa) => hydra.rewriting.deannotateType(v_Type_forall_fa.body) match
      ...
      case _ => false
    case _ => false)(mts)
  hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat], hydra.core.TypeScheme](hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeTerm(cx)(g)(bterm))((srhs: hydra.ext.scala.syntax.Data) =>
    Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`val`(hydra.ext.scala.syntax.Defn_Val(Seq(hydra.ext.scala.syntax.Mod.`lazy`), Seq(hydra.ext.scala.syntax.Pat.`var`(hydra.ext.scala.syntax.Pat_Var(hydra.ext.scala.syntax.Data_Name(bname)))), None, srhs))))))((ts: hydra.core.TypeScheme) =>
    {
    ...
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat]](useDef)(hydra.ext.scala.coder.encodeLocalDef(cx)(g)(outerTypeVars)(bname)(bterm)(ts.`type`))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeTerm(cx)(g)(bterm))((srhs: hydra.ext.scala.syntax.Data) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(ts.`type`))((styp: hydra.ext.scala.syntax.Type) =>
      Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`val`(hydra.ext.scala.syntax.Defn_Val(Seq(hydra.ext.scala.syntax.Mod.`lazy`), Seq(hydra.ext.scala.syntax.Pat.`var`(hydra.ext.scala.syntax.Pat_Var(hydra.ext.scala.syntax.Data_Name(bname)))), Some(styp), srhs)))))))
  })(mts)
}

def encodeLiteral[T0](cx: hydra.context.Context)(g: T0)(av: hydra.core.Literal): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Lit] =
  av match
  case hydra.core.Literal.binary(v_Literal_binary__) => Right(hydra.ext.scala.syntax.Lit.string("<binary>"))
...
def encodeLocalDef(cx: hydra.context.Context)(g: hydra.graph.Graph)(outerTypeVars: scala.collection.immutable.Set[hydra.core.Name])(lname: scala.Predef.String)(term: hydra.core.Term)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat] =
  {
  lazy val freeTypeVars: Seq[hydra.core.Name] = hydra.lib.lists.filter[hydra.core.Name]((v: hydra.core.Name) =>
  ...
  lazy val gWithTypeVars: hydra.graph.Graph = hydra.graph.Graph(g.boundTerms, (g.boundTypes), (g.classConstraints), (g.lambdaVariables), (g.metadata), (g.primitives), (g.schemaTypes), hydra.lib.sets.union[hydra.core.Name](allTypeVars)(g.typeVariables))
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data_Param], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[Tuple2[hydra.core.Name, hydra.core.Type], hydra.ext.scala.syntax.Data_Param, hydra.context.InContext[hydra.errors.Error]]((v1: Tuple2[hydra.core.Name, hydra.core.Type]) =>
    hydra.ext.scala.coder.encodeTypedParam(cx)(gWithTypeVars)(v1))(zippedParams))((sparams: Seq[hydra.ext.scala.syntax.Data_Param]) =>
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeTerm(cx)(gWithTypeVars)(hydra.ext.scala.coder.extractBody(term)))((sbody: hydra.ext.scala.syntax.Data) =>
...
def encodeTerm(cx: hydra.context.Context)(g: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data] =
  {
  ...
  hydra.rewriting.deannotateTerm(term) match
    case hydra.core.Term.typeApplication(v_Term_typeApplication_ta) => {
      ...
      hydra.rewriting.deannotateTerm(substitutedBody) match
        case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
          case hydra.core.Function.primitive(v_Function_primitive_pname) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Type, hydra.ext.scala.syntax.Type, hydra.context.InContext[hydra.errors.Error]]((targ: hydra.core.Type) => hydra.ext.scala.coder.encodeType(cx)(g)(targ))(typeArgs))((stypeArgs: Seq[hydra.ext.scala.syntax.Type]) =>
            {
            lazy val inScopeTypeVarNames: scala.collection.immutable.Set[scala.Predef.String] = hydra.lib.sets.fromList[scala.Predef.String](hydra.lib.lists.map[hydra.core.Name, scala.Predef.String]((n: hydra.core.Name) => hydra.formatting.capitalize(n))(hydra.lib.sets.toList[hydra.core.Name](g.typeVariables)))
      ...
      hydra.rewriting.deannotateAndDetypeTerm(fun) match
        case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
                ...
                hydra.rewriting.deannotateAndDetypeTerm(innerFun) match
                  case hydra.core.Term.function(v_Term_function_innerF) => v_Term_function_innerF match
                    case hydra.core.Function.elimination(v_Function_elimination_innerE) => v_Function_elimination_innerE match
                      ...
                      case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(fun))((sfun: hydra.ext.scala.syntax.Data) =>
                        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(sfun)(Seq(sarg)))))
                    case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(fun))((sfun: hydra.ext.scala.syntax.Data) =>
                      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(sfun)(Seq(sarg)))))
                  case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(fun))((sfun: hydra.ext.scala.syntax.Data) =>
                    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(sfun)(Seq(sarg)))))
          ...
          case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
            case hydra.core.Elimination.record(v_Elimination_record_proj) => {
              lazy val fname: scala.Predef.String = hydra.ext.scala.utils.scalaEscapeName(v_Elimination_record_proj.field)
              hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) =>
                Right(hydra.ext.scala.syntax.Data.ref(hydra.ext.scala.syntax.Data_Ref.select(hydra.ext.scala.syntax.Data_Select(sarg, hydra.ext.scala.syntax.Data_Name(fname))))))
            }
    ...
    case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.scala.syntax.Data, hydra.context.InContext[hydra.errors.Error]]((e: hydra.core.Term) => hydra.ext.scala.coder.encodeTerm(cx)(g)(e))(v_Term_list_els))((sels: Seq[hydra.ext.scala.syntax.Data]) =>
      Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("Seq"))(sels)))
    case hydra.core.Term.literal(v_Term_literal_v) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Lit, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeLiteral(cx)(g)(v_Term_literal_v))((slit: hydra.ext.scala.syntax.Lit) =>
      {
      lazy val litData: hydra.ext.scala.syntax.Data = hydra.ext.scala.syntax.Data.lit(slit)
      v_Term_literal_v match
        case hydra.core.Literal.integer(v_Literal_integer_iv) => v_Literal_integer_iv match
          case hydra.core.IntegerValue.bigint(v_IntegerValue_bigint__) => Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("BigInt"))(Seq(litData)))
          case hydra.core.IntegerValue.uint64(v_IntegerValue_uint64__) => Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("BigInt"))(Seq(litData)))
    ...
    case hydra.core.Term.map(v_Term_map_m) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[Tuple2[hydra.core.Term, hydra.core.Term], hydra.ext.scala.syntax.Data, hydra.context.InContext[hydra.errors.Error]]((kv: Tuple2[hydra.core.Term, hydra.core.Term]) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](kv)))((sk: hydra.ext.scala.syntax.Data) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](kv)))((sv: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sassign(sk)(sv)))))(hydra.lib.maps.toList[hydra.core.Term, hydra.core.Term](v_Term_map_m)))((spairs: Seq[hydra.ext.scala.syntax.Data]) =>
    ...
    case hydra.core.Term.maybe(v_Term_maybe_m) => hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data], hydra.core.Term](Right(hydra.ext.scala.utils.sname("None")))((t: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(t))((s: hydra.ext.scala.syntax.Data) =>
    ...
    case hydra.core.Term.record(v_Term_record_rec) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Field, hydra.ext.scala.syntax.Data, hydra.context.InContext[hydra.errors.Error]]((f: hydra.core.Field) => hydra.ext.scala.coder.encodeTerm(cx)(g)(f.term))(fields))((args: Seq[hydra.ext.scala.syntax.Data]) =>
        Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname(n))(args)))
    }
    case hydra.core.Term.set(v_Term_set_s) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.scala.syntax.Data, hydra.context.InContext[hydra.errors.Error]]((e: hydra.core.Term) => hydra.ext.scala.coder.encodeTerm(cx)(g)(e))(hydra.lib.sets.toList[hydra.core.Term](v_Term_set_s)))((sels: Seq[hydra.ext.scala.syntax.Data]) =>
    ...
    case hydra.core.Term.union(v_Term_union_inj) => {
      ...
      lazy val unionFtypes: Map[hydra.core.Name, hydra.core.Type] = hydra.lib.eithers.either[hydra.context.InContext[hydra.errors.Error], Map[hydra.core.Name, hydra.core.Type], Map[hydra.core.Name, hydra.core.Type]]((_x: hydra.context.InContext[hydra.errors.Error]) => hydra.lib.maps.empty[hydra.core.Name, hydra.core.Type])((`x_`: Map[hydra.core.Name, hydra.core.Type]) => `x_`)(hydra.schemas.fieldTypes(cx)(g)(hydra.core.Type.variable(sn)))
      hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data]](hydra.lib.maybes.maybe[Boolean, hydra.core.Type](hydra.rewriting.deannotateAndDetypeTerm(ft) match
        case hydra.core.Term.unit => true
        ...
        case hydra.core.Type.unit => true
        case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.core.FieldType](v_Type_record_rt))(0)
        case _ => false)(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.Type](fn)(unionFtypes)))(Right(lhs))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(ft))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(lhs)(Seq(sarg)))))
    }
    ...
    case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term, Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data]]((l: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(l))((sl: hydra.ext.scala.syntax.Data) =>
      Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("Left"))(Seq(sl)))))((r: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(r))((sr: hydra.ext.scala.syntax.Data) =>
      Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("Right"))(Seq(sr)))))(v_Term_either_e)
    case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((sf: hydra.ext.scala.syntax.Data) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((ss: hydra.ext.scala.syntax.Data) =>
    ...
    case hydra.core.Term.let(v_Term_let_lt) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Binding, hydra.ext.scala.syntax.Stat, hydra.context.InContext[hydra.errors.Error]]((v1: hydra.core.Binding) =>
        hydra.ext.scala.coder.encodeLetBinding(cx)(gLet)(gLet.typeVariables)(v1))(bindings))((sbindings: Seq[hydra.ext.scala.syntax.Stat]) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(gLet)(body))((sbody: hydra.ext.scala.syntax.Data) =>
...
def encodeTermDefinition(cx: hydra.context.Context)(g: hydra.graph.Graph)(td: hydra.module.TermDefinition): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat] =
  {
  ...
  lazy val isFunctionType: Boolean = hydra.rewriting.deannotateType(`typ_`) match
    ...
    case hydra.core.Type.forall(v_Type_forall_fa) => hydra.rewriting.deannotateType(v_Type_forall_fa.body) match
      ...
      case _ => false
    case _ => false
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat]](isFunctionType)(hydra.ext.scala.coder.encodeComplexTermDef(cx)(g)(lname)(term)(`typ_`))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(`typ_`))((stype: hydra.ext.scala.syntax.Type) =>
    ...
    Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`val`(hydra.ext.scala.syntax.Defn_Val(Seq(hydra.ext.scala.syntax.Mod.`lazy`), Seq(hydra.ext.scala.syntax.Pat.`var`(hydra.ext.scala.syntax.Pat_Var(hydra.ext.scala.syntax.Data_Name(lname)))), Some(stype), rhs)))))))
}
...
def encodeType[T0](cx: hydra.context.Context)(g: T0)(t: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type] =
  ...
  case hydra.core.Type.application(v_Type_application_at) => {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(baseFun))((sfun: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Type](hydra.lib.eithers.mapList[hydra.core.Type, hydra.ext.scala.syntax.Type, hydra.context.InContext[hydra.errors.Error]]((a: hydra.core.Type) => hydra.ext.scala.coder.encodeType(cx)(g)(a))(allArgs))((sargs: Seq[hydra.ext.scala.syntax.Type]) => Right(hydra.ext.scala.utils.stapply(sfun)(sargs))))
  }
  ...
  case hydra.core.Type.either(v_Type_either_et) => {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(lt))((slt: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(rt))((srt: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.function(v_Type_function_ft) => {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(dom))((sdom: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(cod))((scod: hydra.ext.scala.syntax.Type) =>
      Right(hydra.ext.scala.syntax.Type.functionType(hydra.ext.scala.syntax.Type_FunctionType.function(hydra.ext.scala.syntax.Type_Function(Seq(sdom), scod))))))
  }
  case hydra.core.Type.list(v_Type_list_lt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_list_lt))((slt: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.map(v_Type_map_mt) => {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(kt))((skt: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(vt))((svt: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.maybe(v_Type_maybe_ot) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_maybe_ot))((sot: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.pair(v_Type_pair_pt) => {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(ft))((sft: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(st))((sst: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.set(v_Type_set_st) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_set_st))((sst: hydra.ext.scala.syntax.Type) =>
...
def encodeTypeDefinition[T0](cx: hydra.context.Context)(g: T0)(td: hydra.module.TypeDefinition): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat] =
  {
  lazy val name: hydra.core.Name = (td.name)
  ...
  hydra.rewriting.deannotateType(typ) match
    case hydra.core.Type.forall(v_Type_forall_ft) => {
      ...
      lazy val allForallParams: Seq[hydra.core.Name] = hydra.lib.lists.reverse[hydra.core.Name](hydra.lib.pairs.first[Seq[hydra.core.Name], hydra.core.Type](collected))
      lazy val innerBody: hydra.core.Type = hydra.lib.pairs.second[Seq[hydra.core.Name], hydra.core.Type](collected)
      lazy val allTparams: Seq[hydra.ext.scala.syntax.Type_Param] = hydra.lib.lists.map[hydra.core.Name, hydra.ext.scala.syntax.Type_Param]((__v: hydra.core.Name) =>
        {
        lazy val vn: scala.Predef.String = hydra.formatting.capitalize(__v)
        hydra.ext.scala.syntax.Type_Param(Seq(), hydra.ext.scala.syntax.Name.value(vn), Seq(), Seq(), Seq(), Seq())
      })(allForallParams)
      hydra.rewriting.deannotateType(innerBody) match
        case hydra.core.Type.record(v_Type_record_rt2) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data_Param], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Data_Param, hydra.context.InContext[hydra.errors.Error]]((f: hydra.core.FieldType) => hydra.ext.scala.coder.fieldToParam(cx)(g)(f))(v_Type_record_rt2))((params: Seq[hydra.ext.scala.syntax.Data_Param]) =>
          Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`class`(hydra.ext.scala.syntax.Defn_Class(Seq(hydra.ext.scala.syntax.Mod.`case`), tname, allTparams, hydra.ext.scala.syntax.Ctor_Primary(Seq(), hydra.ext.scala.syntax.Name.value(""), Seq(params)), hydra.ext.scala.syntax.Template(Seq(), Seq(), (), Seq()))))))
        case hydra.core.Type.union(v_Type_union_rt2) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Stat, hydra.context.InContext[hydra.errors.Error]]((f: hydra.core.FieldType) =>
          hydra.ext.scala.coder.fieldToEnumCase(cx)(g)(lname)(allTparams)(f))(v_Type_union_rt2))((cases: Seq[hydra.ext.scala.syntax.Stat]) =>
          Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`enum`(hydra.ext.scala.syntax.Defn_Enum(Seq(), tname, allTparams, hydra.ext.scala.syntax.Ctor_Primary(Seq(), hydra.ext.scala.syntax.Name.value(""), Seq()), hydra.ext.scala.syntax.Template(Seq(), Seq(), (), cases))))))
        case hydra.core.Type.wrap(v_Type_wrap_wt2) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_wrap_wt2))((styp: hydra.ext.scala.syntax.Type) =>
        ...
        case _ => {
          def mkAlias[T1](styp: hydra.ext.scala.syntax.Type): Either[T1, hydra.ext.scala.syntax.Stat] =
            Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`type`(hydra.ext.scala.syntax.Defn_Type(Seq(), hydra.ext.scala.syntax.Type_Name(lname), allTparams, styp))))
          hydra.lib.eithers.either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat]]((_x: hydra.context.InContext[hydra.errors.Error]) => mkAlias(hydra.ext.scala.utils.stref("Any")))(mkAlias)(hydra.ext.scala.coder.encodeType(cx)(g)(innerBody))
        }
    }
    case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Data_Param], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Data_Param, hydra.context.InContext[hydra.errors.Error]]((f: hydra.core.FieldType) => hydra.ext.scala.coder.fieldToParam(cx)(g)(f))(v_Type_record_rt))((params: Seq[hydra.ext.scala.syntax.Data_Param]) =>
      Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`class`(hydra.ext.scala.syntax.Defn_Class(Seq(hydra.ext.scala.syntax.Mod.`case`), tname, tparams, hydra.ext.scala.syntax.Ctor_Primary(Seq(), hydra.ext.scala.syntax.Name.value(""), Seq(params)), hydra.ext.scala.syntax.Template(Seq(), Seq(), (), Seq()))))))
    case hydra.core.Type.union(v_Type_union_rt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Stat, hydra.context.InContext[hydra.errors.Error]]((f: hydra.core.FieldType) =>
      hydra.ext.scala.coder.fieldToEnumCase(cx)(g)(lname)(tparams)(f))(v_Type_union_rt))((cases: Seq[hydra.ext.scala.syntax.Stat]) =>
      Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`enum`(hydra.ext.scala.syntax.Defn_Enum(Seq(), tname, tparams, hydra.ext.scala.syntax.Ctor_Primary(Seq(), hydra.ext.scala.syntax.Name.value(""), Seq()), hydra.ext.scala.syntax.Template(Seq(), Seq(), (), cases))))))
    case hydra.core.Type.wrap(v_Type_wrap_wt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_wrap_wt))((styp: hydra.ext.scala.syntax.Type) =>
    ...
    case _ => {
      def mkAlias[T1](styp: hydra.ext.scala.syntax.Type): Either[T1, hydra.ext.scala.syntax.Stat] =
        Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`type`(hydra.ext.scala.syntax.Defn_Type(Seq(), hydra.ext.scala.syntax.Type_Name(lname), tparams, styp))))
      hydra.lib.eithers.either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat]]((_x: hydra.context.InContext[hydra.errors.Error]) => mkAlias(hydra.ext.scala.utils.stref("Any")))(mkAlias)(hydra.ext.scala.coder.encodeType(cx)(g)(typ))
    }
}

def encodeTypedParam[T0](cx: hydra.context.Context)(g: T0)(pair: Tuple2[hydra.core.Name, hydra.core.Type]): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data_Param] =
  {
  lazy val pname: scala.Predef.String = hydra.ext.scala.utils.scalaEscapeName(hydra.names.localNameOf(hydra.lib.pairs.first[hydra.core.Name, hydra.core.Type](pair)))
...
def encodeUntypeApplicationTerm(cx: hydra.context.Context)(g: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data] =
...
def fieldToEnumCase[T0](cx: hydra.context.Context)(g: T0)(parentName: scala.Predef.String)(tparams: Seq[hydra.ext.scala.syntax.Type_Param])(ft: hydra.core.FieldType): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Stat] =
  {
  ...
  lazy val isUnit: Boolean = hydra.rewriting.deannotateType(ftyp) match
    ...
    case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.core.FieldType](v_Type_record_rt))(0)
    case _ => false
  lazy val parentType: hydra.ext.scala.syntax.Type = hydra.lib.logic.ifElse[hydra.ext.scala.syntax.Type](hydra.lib.lists.`null`[hydra.ext.scala.syntax.Type_Param](tparams))(hydra.ext.scala.syntax.Type.ref(hydra.ext.scala.syntax.Type_Ref.name(hydra.ext.scala.syntax.Type_Name(parentName))))(hydra.ext.scala.syntax.Type.apply(hydra.ext.scala.syntax.Type_Apply(hydra.ext.scala.syntax.Type.ref(hydra.ext.scala.syntax.Type_Ref.name(hydra.ext.scala.syntax.Type_Name(parentName))), hydra.lib.lists.map[hydra.ext.scala.syntax.Type_Param, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.typeParamToTypeVar)(tparams))))
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(ftyp))((sftyp: hydra.ext.scala.syntax.Type) =>
    Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.enumCase(hydra.ext.scala.syntax.Defn_EnumCase(Seq(), caseName, Seq(), hydra.ext.scala.syntax.Ctor_Primary(Seq(), hydra.ext.scala.syntax.Name.value(""), Seq(hydra.lib.logic.ifElse[Seq[hydra.ext.scala.syntax.Data_Param]](isUnit)(Seq())(Seq(hydra.ext.scala.syntax.Data_Param(Seq(), hydra.ext.scala.syntax.Name.value("value"), Some(sftyp), None))))), Seq(hydra.ext.scala.syntax.Init(parentType, hydra.ext.scala.syntax.Name.value(""), Seq())))))))
}

def fieldToParam[T0](cx: hydra.context.Context)(g: T0)(ft: hydra.core.FieldType): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Data_Param] =
  {
  lazy val fname: scala.Predef.String = hydra.ext.scala.utils.scalaEscapeName(ft.name)
  lazy val ftyp: hydra.core.Type = (ft.`type`)
...
def findDomain(cx: hydra.context.Context)(g: hydra.graph.Graph)(meta: Map[hydra.core.Name, hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[hydra.core.Type], hydra.core.Type](hydra.lib.eithers.bimap[hydra.errors.DecodingError, Option[hydra.core.Type], hydra.context.InContext[hydra.errors.Error], Option[hydra.core.Type]]((__de: hydra.errors.DecodingError) => hydra.context.InContext(hydra.errors.Error.other(__de), cx))((__a: Option[hydra.core.Type]) => __a)(hydra.annotations.getType(g)(meta)))((r: Option[hydra.core.Type]) =>
  hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type], hydra.core.Type](Left(hydra.context.InContext(hydra.errors.Error.other("expected a typed term"), cx)))((t: hydra.core.Type) =>
  hydra.rewriting.deannotateType(t) match
...
def findImports(cx: hydra.context.Context)(g: hydra.graph.Graph)(mod: hydra.module.Module): Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.scala.syntax.Stat]] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], scala.collection.immutable.Set[hydra.module.Namespace], Seq[hydra.ext.scala.syntax.Stat]](hydra.schemas.moduleDependencyNamespaces(cx)(g)(false)(false)(true)(false)(mod))((elImps: scala.collection.immutable.Set[hydra.module.Namespace]) =>
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], scala.collection.immutable.Set[hydra.module.Namespace], Seq[hydra.ext.scala.syntax.Stat]](hydra.schemas.moduleDependencyNamespaces(cx)(g)(false)(true)(false)(false)(mod))((primImps: scala.collection.immutable.Set[hydra.module.Namespace]) =>
  Right(hydra.lib.lists.concat[hydra.ext.scala.syntax.Stat](Seq(hydra.lib.lists.map[hydra.module.Namespace, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.toElImport)(hydra.lib.sets.toList[hydra.module.Namespace](elImps)), hydra.lib.lists.map[hydra.module.Namespace, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.toPrimImport)(hydra.lib.sets.toList[hydra.module.Namespace](primImps)))))))

def findSdom(cx: hydra.context.Context)(g: hydra.graph.Graph)(meta: Map[hydra.core.Name, hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type]] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[hydra.core.Type], Option[hydra.ext.scala.syntax.Type]](hydra.lib.eithers.bimap[hydra.errors.DecodingError, Option[hydra.core.Type], hydra.context.InContext[hydra.errors.Error], Option[hydra.core.Type]]((__de: hydra.errors.DecodingError) => hydra.context.InContext(hydra.errors.Error.other(__de), cx))((__a: Option[hydra.core.Type]) => __a)(hydra.annotations.getType(g)(meta)))((mtyp: Option[hydra.core.Type]) =>
  hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Option[hydra.ext.scala.syntax.Type]], hydra.core.Type](Right(None))((t: hydra.core.Type) =>
  hydra.rewriting.deannotateType(t) match
  case hydra.core.Type.function(v_Type_function_ft) => {
    lazy val dom: hydra.core.Type = (v_Type_function_ft.domain)
  ...
  case hydra.core.Type.forall(v_Type_forall_fa) => hydra.rewriting.deannotateType(v_Type_forall_fa.body) match
    case hydra.core.Type.function(v_Type_function_ft2) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(dom2))((sdom2: hydra.ext.scala.syntax.Type) => Right(Some(sdom2)))
    }
    case _ => Right(None)
  case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(t))((st: hydra.ext.scala.syntax.Type) => Right(Some(st))))(mtyp))

def moduleToScala(mod: hydra.module.Module)(defs: Seq[hydra.module.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error], Map[scala.Predef.String, scala.Predef.String]] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.scala.syntax.Pkg, Map[scala.Predef.String, scala.Predef.String]](hydra.ext.scala.coder.constructModule(cx)(g)(mod)(defs))((pkg: hydra.ext.scala.syntax.Pkg) =>
  {
    ...
    hydra.rewriting.deannotateAndDetypeTerm(appFun) match
      ...
      case hydra.core.Term.application(v_Term_application_innerApp) => {
        ...
        hydra.rewriting.deannotateAndDetypeTerm(innerFun) match
          case hydra.core.Term.function(v_Term_function_innerF) => v_Term_function_innerF match
            case hydra.core.Function.elimination(v_Function_elimination_innerE) => v_Function_elimination_innerE match
              case hydra.core.Elimination.wrap(v_Elimination_wrap__) => hydra.ext.scala.coder.stripWrapEliminations(hydra.core.Term.application(hydra.core.Application(innerArg, appArg)))
              case _ => t
            case _ => t
          case _ => t
      }
...
def toElImport(ns: hydra.module.Namespace): hydra.ext.scala.syntax.Stat =
  hydra.ext.scala.syntax.Stat.importExport(hydra.ext.scala.syntax.ImportExportStat.`import`(hydra.ext.scala.syntax.Import(Seq(hydra.ext.scala.syntax.Importer(hydra.ext.scala.syntax.Data_Ref.name(hydra.ext.scala.syntax.Data_Name(hydra.lib.strings.intercalate(".")(hydra.lib.strings.splitOn(".")(ns)))), Seq(hydra.ext.scala.syntax.Importee.wildcard))))))

def toPrimImport(ns: hydra.module.Namespace): hydra.ext.scala.syntax.Stat =
  hydra.ext.scala.syntax.Stat.importExport(hydra.ext.scala.syntax.ImportExportStat.`import`(hydra.ext.scala.syntax.Import(Seq(hydra.ext.scala.syntax.Importer(hydra.ext.scala.syntax.Data_Ref.name(hydra.ext.scala.syntax.Data_Name(hydra.lib.strings.intercalate(".")(hydra.lib.strings.splitOn(".")(ns)))), Seq())))))
