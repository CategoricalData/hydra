...
def constructModule[T0](cx: T0)(g: hydra.graph.Graph)(mod: hydra.packaging.Module)(defs: Seq[hydra.packaging.Definition]): Either[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Pkg](hydra.lib.eithers.mapList[hydra.packaging.TypeDefinition,
     hydra.ext.scala.syntax.Stat, hydra.errors.Error]((td: hydra.packaging.TypeDefinition) => hydra.ext.scala.coder.encodeTypeDefinition(cx)(g)(td))(typeDefs))((typeDeclStats: Seq[hydra.ext.scala.syntax.Stat]) =>
    hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Pkg](hydra.lib.eithers.mapList[hydra.packaging.TermDefinition,
       hydra.ext.scala.syntax.Stat, hydra.errors.Error]((td: hydra.packaging.TermDefinition) => hydra.ext.scala.coder.encodeTermDefinition(cx)(g)(td))(termDefs))((termDeclStats: Seq[hydra.ext.scala.syntax.Stat]) =>
    hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Pkg](hydra.ext.scala.coder.findImports(cx)(g)(mod))((imports: Seq[hydra.ext.scala.syntax.Stat]) =>
...
def encodeCase[T0](cx: T0)(g: hydra.graph.Graph)(ftypes: Map[hydra.core.Name, hydra.core.Type])(sn: Option[hydra.core.Name])(f: hydra.core.Field): Either[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Case](hydra.ext.scala.coder.encodeTerm(cx)(g)(applied))((body: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.syntax.Case(pat,
     None, body)))
}
...
def encodeComplexTermDef[T0](cx: T0)(g: hydra.graph.Graph)(lname: scala.Predef.String)(term: hydra.core.Term)(typ: hydra.core.Type): Either[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data_Param], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[Tuple2[hydra.core.Name,
     hydra.core.Type], hydra.ext.scala.syntax.Data_Param, hydra.errors.Error]((v1: Tuple2[hydra.core.Name,
     hydra.core.Type]) =>
    hydra.ext.scala.coder.encodeTypedParam(cx)(gWithTypeVars)(v1))(zippedParams))((sparams: Seq[hydra.ext.scala.syntax.Data_Param]) =>
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeTerm(cx)(gWithTypeVars)(hydra.ext.scala.coder.extractBody(term)))((sbody: hydra.ext.scala.syntax.Data) =>
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(cod))((scod: hydra.ext.scala.syntax.Type) =>
    {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.Binding,
       hydra.ext.scala.syntax.Stat, hydra.errors.Error]((v1: hydra.core.Binding) =>
...
def encodeFunction[T0](cx: T0)(g: hydra.graph.Graph)(meta: Map[hydra.core.Name, hydra.core.Term])(fun: hydra.core.Function)(arg: Option[hydra.core.Term]): Either[hydra.errors.Error,
  ...
  case hydra.core.Function.lambda(v_Function_lambda_lam) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(body))((sbody: hydra.ext.scala.syntax.Data) =>
      hydra.lib.eithers.bind[hydra.errors.Error, Option[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.lib.maybes.maybe[Either[hydra.errors.Error,
         Option[hydra.ext.scala.syntax.Type]], hydra.core.Type](hydra.ext.scala.coder.findSdom(cx)(g)(meta))((dom: hydra.core.Type) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(dom))((sdom: hydra.ext.scala.syntax.Type) => Right(Some(sdom))))(mdom))((sdom: Option[hydra.ext.scala.syntax.Type]) => Right(hydra.ext.scala.utils.slambda(v)(sbody)(sdom))))
  }
  case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
    case hydra.core.Elimination.wrap(v_Elimination_wrap_name) => hydra.lib.maybes.maybe[Either[hydra.errors.Error,
       hydra.ext.scala.syntax.Data], hydra.core.Term](hydra.lib.eithers.bind[hydra.errors.Error, Option[hydra.ext.scala.syntax.Type],
    ...
    case hydra.core.Elimination.record(v_Elimination_record_proj) => {
      ...
      hydra.lib.maybes.maybe[Either[hydra.errors.Error, hydra.ext.scala.syntax.Data], hydra.core.Term](hydra.lib.eithers.bind[hydra.errors.Error,
         Option[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.lib.eithers.either[hydra.errors.Error,
         Option[hydra.ext.scala.syntax.Type], Either[hydra.errors.Error, Option[hydra.ext.scala.syntax.Type]]]((_x: hydra.errors.Error) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(hydra.core.Type.variable(typeName)))((st: hydra.ext.scala.syntax.Type) => Right(Some(st))))((msdom: Option[hydra.ext.scala.syntax.Type]) =>
        hydra.lib.maybes.maybe[Either[hydra.errors.Error, Option[hydra.ext.scala.syntax.Type]], hydra.ext.scala.syntax.Type](hydra.lib.eithers.bind[hydra.errors.Error,
        ...
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(a))((sa: hydra.ext.scala.syntax.Data) =>
    ...
    case hydra.core.Elimination.union(v_Elimination_union_cs) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Case], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Field,
         hydra.ext.scala.syntax.Case, hydra.errors.Error]((f: hydra.core.Field) => hydra.ext.scala.coder.encodeCase(cx)(g)(ftypes)(sn)(f))(cases))((fieldCases: Seq[hydra.ext.scala.syntax.Case]) =>
        hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Case], hydra.ext.scala.syntax.Data](hydra.lib.maybes.maybe[Either[hydra.errors.Error,
           Seq[hydra.ext.scala.syntax.Case]], hydra.core.Term](Right(fieldCases))((dfltTerm: hydra.core.Term) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, Seq[hydra.ext.scala.syntax.Case]](hydra.ext.scala.coder.encodeTerm(cx)(g)(dfltTerm))((sdflt: hydra.ext.scala.syntax.Data) =>
...
def encodeLetBinding[T0](cx: T0)(g: hydra.graph.Graph)(outerTypeVars: scala.collection.immutable.Set[hydra.core.Name])(b: hydra.core.Binding): Either[hydra.errors.Error,
  ...
  lazy val isFn: Boolean = hydra.lib.maybes.maybe[Boolean, hydra.core.TypeScheme](false)((ts: hydra.core.TypeScheme) =>
    ...
    case hydra.core.Type.forall(v_Type_forall_fa) => hydra.strip.deannotateType(v_Type_forall_fa.body) match
      ...
      case _ => false
    case _ => false)(mts)
  hydra.lib.maybes.maybe[Either[hydra.errors.Error, hydra.ext.scala.syntax.Stat], hydra.core.TypeScheme](hydra.lib.eithers.bind[hydra.errors.Error,
    ...
    hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.ext.scala.syntax.Stat]](useDef)(hydra.ext.scala.coder.encodeLocalDef(cx)(g)(outerTypeVars)(bname)(bterm)(ts.`type`))(hydra.lib.eithers.bind[hydra.errors.Error,
       hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeTerm(cx)(g)(bterm))((srhs: hydra.ext.scala.syntax.Data) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(ts.`type`))((styp: hydra.ext.scala.syntax.Type) =>
      Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`val`(hydra.ext.scala.syntax.Defn_Val(Seq(hydra.ext.scala.syntax.Mod.`lazy`),
         Seq(hydra.ext.scala.syntax.Pat.`var`(hydra.ext.scala.syntax.Pat_Var(hydra.ext.scala.syntax.Data_Name(bname)))),
         Some(styp), srhs)))))))
  })(mts)
...
def encodeLiteral[T0, T1](cx: T0)(g: T1)(av: hydra.core.Literal): Either[hydra.errors.Error, hydra.ext.scala.syntax.Lit] =
  av match
...
def encodeLocalDef[T0](cx: T0)(g: hydra.graph.Graph)(outerTypeVars: scala.collection.immutable.Set[hydra.core.Name])(lname: scala.Predef.String)(term: hydra.core.Term)(typ: hydra.core.Type): Either[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data_Param], hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[Tuple2[hydra.core.Name,
    ...
    hydra.ext.scala.coder.encodeTypedParam(cx)(gWithTypeVars)(v1))(zippedParams))((sparams: Seq[hydra.ext.scala.syntax.Data_Param]) =>
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeTerm(cx)(gWithTypeVars)(hydra.ext.scala.coder.extractBody(term)))((sbody: hydra.ext.scala.syntax.Data) =>
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(gWithTypeVars)(cod))((scod: hydra.ext.scala.syntax.Type) =>
    {
    lazy val gForLets: hydra.graph.Graph = hydra.lib.logic.ifElse[hydra.graph.Graph](hydra.lib.lists.`null`[hydra.core.Binding](letBindings))(gWithTypeVars)(hydra.scoping.extendGraphForLet((g2: hydra.graph.Graph) =>
      (b: hydra.core.Binding) =>
      hydra.lib.logic.ifElse[Option[hydra.core.Term]](hydra.predicates.isComplexBinding(g2)(b))(Some(hydra.core.Term.literal(hydra.core.Literal.boolean(true))))(None))(gWithTypeVars)(hydra.core.Let(letBindings,
...
def encodeTerm[T0](cx: T0)(g: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.errors.Error, hydra.ext.scala.syntax.Data] =
  {
  ...
  hydra.strip.deannotateTerm(term) match
    case hydra.core.Term.typeApplication(v_Term_typeApplication_ta) => {
      ...
      hydra.strip.deannotateTerm(substitutedBody) match
        ...
        case hydra.core.Term.variable(v_Term_variable_pname) => hydra.lib.maybes.cases[hydra.graph.Primitive,
           Either[hydra.errors.Error, hydra.ext.scala.syntax.Data]](hydra.lib.maps.lookup[hydra.core.Name,
          ...
          hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Type,
             hydra.ext.scala.syntax.Type, hydra.errors.Error]((targ: hydra.core.Type) => hydra.ext.scala.coder.encodeType(cx)(g)(targ))(typeArgs))((stypeArgs: Seq[hydra.ext.scala.syntax.Type]) =>
          {
          ...
          hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.ext.scala.syntax.Data]](hasForallResidual)(Right(hydra.ext.scala.utils.sprim(v_Term_variable_pname)))(Right(hydra.ext.scala.utils.sapplyTypes(hydra.ext.scala.utils.sprim(v_Term_variable_pname))(stypeArgs)))
        }))
        case _ => hydra.ext.scala.coder.encodeTerm(cx)(g)(substitutedBody)
    }
      ...
      hydra.strip.deannotateAndDetypeTerm(fun) match
        case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
                ...
                hydra.strip.deannotateAndDetypeTerm(innerFun) match
                  case hydra.core.Term.function(v_Term_function_innerF) => v_Term_function_innerF match
                    case hydra.core.Function.elimination(v_Function_elimination_innerE) => v_Function_elimination_innerE match
                      ...
                      case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data,
                         hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(fun))((sfun: hydra.ext.scala.syntax.Data) =>
                        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(sfun)(Seq(sarg)))))
                    case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data,
                       hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(fun))((sfun: hydra.ext.scala.syntax.Data) =>
                      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(sfun)(Seq(sarg)))))
                  case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(fun))((sfun: hydra.ext.scala.syntax.Data) =>
                    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(sfun)(Seq(sarg)))))
              }
              case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(fun))((sfun: hydra.ext.scala.syntax.Data) =>
                hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) => Right(hydra.ext.scala.utils.sapply(sfun)(Seq(sarg)))))
          ...
          case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
            case hydra.core.Elimination.record(v_Elimination_record_proj) => {
              lazy val fname: scala.Predef.String = hydra.ext.scala.utils.scalaEscapeName(v_Elimination_record_proj.field)
              hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(arg))((sarg: hydra.ext.scala.syntax.Data) =>
    ...
    case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data],
       hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.scala.syntax.Data,
       hydra.errors.Error]((e: hydra.core.Term) => hydra.ext.scala.coder.encodeTerm(cx)(g)(e))(v_Term_list_els))((sels: Seq[hydra.ext.scala.syntax.Data]) =>
      Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("Seq"))(sels)))
    case hydra.core.Term.literal(v_Term_literal_v) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Lit,
       hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeLiteral(cx)(g)(v_Term_literal_v))((slit: hydra.ext.scala.syntax.Lit) =>
      {
    ...
    case hydra.core.Term.map(v_Term_map_m) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data],
       hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[Tuple2[hydra.core.Term, hydra.core.Term],
       hydra.ext.scala.syntax.Data, hydra.errors.Error]((kv: Tuple2[hydra.core.Term, hydra.core.Term]) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(hydra.lib.pairs.first[hydra.core.Term,
         hydra.core.Term](kv)))((sk: hydra.ext.scala.syntax.Data) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(hydra.lib.pairs.second[hydra.core.Term,
    ...
    case hydra.core.Term.maybe(v_Term_maybe_m) => hydra.lib.maybes.maybe[Either[hydra.errors.Error, hydra.ext.scala.syntax.Data],
       hydra.core.Term](Right(hydra.ext.scala.utils.sname("None")))((t: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(t))((s: hydra.ext.scala.syntax.Data) =>
    ...
    case hydra.core.Term.record(v_Term_record_rec) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Field,
         hydra.ext.scala.syntax.Data, hydra.errors.Error]((f: hydra.core.Field) => hydra.ext.scala.coder.encodeTerm(cx)(g)(f.term))(fields))((args: Seq[hydra.ext.scala.syntax.Data]) =>
        Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname(n))(args)))
    }
    case hydra.core.Term.set(v_Term_set_s) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data],
       hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.scala.syntax.Data,
       hydra.errors.Error]((e: hydra.core.Term) => hydra.ext.scala.coder.encodeTerm(cx)(g)(e))(hydra.lib.sets.toList[hydra.core.Term](v_Term_set_s)))((sels: Seq[hydra.ext.scala.syntax.Data]) =>
    ...
    case hydra.core.Term.union(v_Term_union_inj) => {
      ...
      hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.ext.scala.syntax.Data]](hydra.lib.maybes.maybe[Boolean,
    ...
    case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
       Either[hydra.errors.Error, hydra.ext.scala.syntax.Data]]((l: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(l))((sl: hydra.ext.scala.syntax.Data) =>
      Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("Left"))(Seq(sl)))))((r: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(g)(r))((sr: hydra.ext.scala.syntax.Data) =>
      Right(hydra.ext.scala.utils.sapply(hydra.ext.scala.utils.sname("Right"))(Seq(sr)))))(v_Term_either_e)
    case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data,
    ...
    case hydra.core.Term.let(v_Term_let_lt) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat], hydra.ext.scala.syntax.Data](hydra.lib.eithers.mapList[hydra.core.Binding,
         hydra.ext.scala.syntax.Stat, hydra.errors.Error]((v1: hydra.core.Binding) =>
        hydra.ext.scala.coder.encodeLetBinding(cx)(gLet)(gLet.typeVariables)(v1))(bindings))((sbindings: Seq[hydra.ext.scala.syntax.Stat]) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Data](hydra.ext.scala.coder.encodeTerm(cx)(gLet)(body))((sbody: hydra.ext.scala.syntax.Data) =>
...
def encodeTermDefinition[T0](cx: T0)(g: hydra.graph.Graph)(td: hydra.packaging.TermDefinition): Either[hydra.errors.Error, hydra.ext.scala.syntax.Stat] =
  {
  ...
  lazy val isFunctionType: Boolean = hydra.strip.deannotateType(`typ_`) match
    ...
    case hydra.core.Type.forall(v_Type_forall_fa) => hydra.strip.deannotateType(v_Type_forall_fa.body) match
      ...
      case _ => false
    case _ => false
  hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.ext.scala.syntax.Stat]](isFunctionType)(hydra.ext.scala.coder.encodeComplexTermDef(cx)(g)(lname)(term)(`typ_`))(hydra.lib.eithers.bind[hydra.errors.Error,
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Data, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeTerm(cx)(g)(term))((rhs: hydra.ext.scala.syntax.Data) =>
    Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`val`(hydra.ext.scala.syntax.Defn_Val(Seq(hydra.ext.scala.syntax.Mod.`lazy`),
       Seq(hydra.ext.scala.syntax.Pat.`var`(hydra.ext.scala.syntax.Pat_Var(hydra.ext.scala.syntax.Data_Name(lname)))),
       Some(stype), rhs)))))))
}

def encodeType[T0, T1](cx: T0)(g: T1)(t: hydra.core.Type): Either[hydra.errors.Error, hydra.ext.scala.syntax.Type] =
  ...
  case hydra.core.Type.application(v_Type_application_at) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(baseFun))((sfun: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Type], hydra.ext.scala.syntax.Type](hydra.lib.eithers.mapList[hydra.core.Type,
         hydra.ext.scala.syntax.Type, hydra.errors.Error]((a: hydra.core.Type) => hydra.ext.scala.coder.encodeType(cx)(g)(a))(allArgs))((sargs: Seq[hydra.ext.scala.syntax.Type]) => Right(hydra.ext.scala.utils.stapply(sfun)(sargs))))
  }
  ...
  case hydra.core.Type.either(v_Type_either_et) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(lt))((slt: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(rt))((srt: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.function(v_Type_function_ft) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(dom))((sdom: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(cod))((scod: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.list(v_Type_list_lt) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type,
     hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_list_lt))((slt: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.map(v_Type_map_mt) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(kt))((skt: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(vt))((svt: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.maybe(v_Type_maybe_ot) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type,
     hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_maybe_ot))((sot: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.pair(v_Type_pair_pt) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(ft))((sft: hydra.ext.scala.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(st))((sst: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.set(v_Type_set_st) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type,
     hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_set_st))((sst: hydra.ext.scala.syntax.Type) =>
  ...
  case hydra.core.Type.forall(v_Type_forall_ft) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Type](hydra.ext.scala.coder.encodeType(cx)(g)(body))((sbody: hydra.ext.scala.syntax.Type) =>
...
def encodeTypeDefinition[T0, T1](cx: T0)(g: T1)(td: hydra.packaging.TypeDefinition): Either[hydra.errors.Error, hydra.ext.scala.syntax.Stat] =
  {
  lazy val name: hydra.core.Name = (td.name)
  ...
  hydra.strip.deannotateType(typ) match
    case hydra.core.Type.forall(v_Type_forall_ft) => {
      ...
      hydra.strip.deannotateType(innerBody) match
        case hydra.core.Type.record(v_Type_record_rt2) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data_Param],
           hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Data_Param,
           hydra.errors.Error]((f: hydra.core.FieldType) => hydra.ext.scala.coder.fieldToParam(cx)(g)(f))(v_Type_record_rt2))((params: Seq[hydra.ext.scala.syntax.Data_Param]) =>
        ...
        case hydra.core.Type.union(v_Type_union_rt2) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat],
           hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Stat,
        ...
        case hydra.core.Type.wrap(v_Type_wrap_wt2) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type,
           hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_wrap_wt2))((styp: hydra.ext.scala.syntax.Type) =>
        ...
        case _ => {
          def mkAlias[T2](styp: hydra.ext.scala.syntax.Type): Either[T2, hydra.ext.scala.syntax.Stat] =
          ...
          hydra.lib.eithers.either[hydra.errors.Error, hydra.ext.scala.syntax.Type, Either[hydra.errors.Error,
             hydra.ext.scala.syntax.Stat]]((_x: hydra.errors.Error) => mkAlias(hydra.ext.scala.utils.stref("Any")))(mkAlias)(hydra.ext.scala.coder.encodeType(cx)(g)(innerBody))
        }
    }
    case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Data_Param],
       hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Data_Param,
       hydra.errors.Error]((f: hydra.core.FieldType) => hydra.ext.scala.coder.fieldToParam(cx)(g)(f))(v_Type_record_rt))((params: Seq[hydra.ext.scala.syntax.Data_Param]) =>
      Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`class`(hydra.ext.scala.syntax.Defn_Class(Seq(hydra.ext.scala.syntax.Mod.`case`),
         tname, tparams, hydra.ext.scala.syntax.Ctor_Primary(Seq(), hydra.ext.scala.syntax.Name.value(""),
         Seq(params)), hydra.ext.scala.syntax.Template(Seq(), Seq(), (), Seq()))))))
    case hydra.core.Type.union(v_Type_union_rt) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat],
       hydra.ext.scala.syntax.Stat](hydra.lib.eithers.mapList[hydra.core.FieldType, hydra.ext.scala.syntax.Stat,
       hydra.errors.Error]((f: hydra.core.FieldType) =>
      ...
      Right(hydra.ext.scala.syntax.Stat.defn(hydra.ext.scala.syntax.Defn.`enum`(hydra.ext.scala.syntax.Defn_Enum(Seq(),
         tname, tparams, hydra.ext.scala.syntax.Ctor_Primary(Seq(), hydra.ext.scala.syntax.Name.value(""),
         Seq()), hydra.ext.scala.syntax.Template(Seq(), Seq(), (), cases))))))
    case hydra.core.Type.wrap(v_Type_wrap_wt) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type,
       hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(v_Type_wrap_wt))((styp: hydra.ext.scala.syntax.Type) =>
    ...
    case _ => {
      ...
      hydra.lib.eithers.either[hydra.errors.Error, hydra.ext.scala.syntax.Type, Either[hydra.errors.Error,
         hydra.ext.scala.syntax.Stat]]((_x: hydra.errors.Error) => mkAlias(hydra.ext.scala.utils.stref("Any")))(mkAlias)(hydra.ext.scala.coder.encodeType(cx)(g)(typ))
    }
}

def encodeTypedParam[T0, T1](cx: T0)(g: T1)(pair: Tuple2[hydra.core.Name, hydra.core.Type]): Either[hydra.errors.Error, hydra.ext.scala.syntax.Data_Param] =
  {
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Data_Param](hydra.ext.scala.coder.encodeType(cx)(g)(pdom))((sdom: hydra.ext.scala.syntax.Type) =>
...
def encodeUntypeApplicationTerm(cx: hydra.context.Context)(g: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.errors.Error,
   hydra.ext.scala.syntax.Data] =
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.typing.InferenceResult, hydra.ext.scala.syntax.Data](hydra.inference.inferInGraphContext(cx)(g)(term))((result: hydra.typing.InferenceResult) => hydra.ext.scala.coder.encodeTerm(cx)(g)(result.term))
...
def fieldToEnumCase[T0, T1](cx: T0)(g: T1)(parentName: scala.Predef.String)(tparams: Seq[hydra.ext.scala.syntax.Type_Param])(ft: hydra.core.FieldType): Either[hydra.errors.Error,
   hydra.ext.scala.syntax.Stat] =
  {
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Stat](hydra.ext.scala.coder.encodeType(cx)(g)(ftyp))((sftyp: hydra.ext.scala.syntax.Type) =>
...
def fieldToParam[T0, T1](cx: T0)(g: T1)(ft: hydra.core.FieldType): Either[hydra.errors.Error, hydra.ext.scala.syntax.Data_Param] =
  {
  lazy val fname: scala.Predef.String = hydra.ext.scala.utils.scalaEscapeName(ft.name)
  lazy val ftyp: hydra.core.Type = (ft.`type`)
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, hydra.ext.scala.syntax.Data_Param](hydra.ext.scala.coder.encodeType(cx)(g)(ftyp))((sftyp: hydra.ext.scala.syntax.Type) =>
...
def findImports[T0](cx: T0)(g: hydra.graph.Graph)(mod: hydra.packaging.Module): Either[hydra.errors.Error, Seq[hydra.ext.scala.syntax.Stat]] =
...
def findSdom[T0](cx: T0)(g: hydra.graph.Graph)(meta: Map[hydra.core.Name, hydra.core.Term]): Either[hydra.errors.Error, Option[hydra.ext.scala.syntax.Type]] =
  hydra.lib.eithers.bind[hydra.errors.Error, Option[hydra.core.Type], Option[hydra.ext.scala.syntax.Type]](hydra.lib.eithers.bimap[hydra.errors.DecodingError,
  ...
  hydra.lib.maybes.maybe[Either[hydra.errors.Error, Option[hydra.ext.scala.syntax.Type]], hydra.core.Type](Right(None))((t: hydra.core.Type) =>
  hydra.strip.deannotateType(t) match
  case hydra.core.Type.function(v_Type_function_ft) => {
    lazy val dom: hydra.core.Type = (v_Type_function_ft.domain)
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(dom))((sdom: hydra.ext.scala.syntax.Type) => Right(Some(sdom)))
  }
  case hydra.core.Type.forall(v_Type_forall_fa) => hydra.strip.deannotateType(v_Type_forall_fa.body) match
    case hydra.core.Type.function(v_Type_function_ft2) => {
      lazy val dom2: hydra.core.Type = (v_Type_function_ft2.domain)
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(dom2))((sdom2: hydra.ext.scala.syntax.Type) => Right(Some(sdom2)))
    }
    case _ => Right(None)
  case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Type, Option[hydra.ext.scala.syntax.Type]](hydra.ext.scala.coder.encodeType(cx)(g)(t))((st: hydra.ext.scala.syntax.Type) => Right(Some(st))))(mtyp))
...
def moduleToScala[T0](mod: hydra.packaging.Module)(defs: Seq[hydra.packaging.Definition])(cx: T0)(g: hydra.graph.Graph): Either[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.scala.syntax.Pkg, Map[scala.Predef.String, scala.Predef.String]](hydra.ext.scala.coder.constructModule(cx)(g)(mod)(defs))((pkg: hydra.ext.scala.syntax.Pkg) =>
  {
