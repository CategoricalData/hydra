...
lazy val scalaLanguage: hydra.coders.Language = {
  ...
  lazy val typeVariants: scala.collection.immutable.Set[hydra.variants.TypeVariant] = hydra.lib.sets.fromList[hydra.variants.TypeVariant](Seq(hydra.variants.TypeVariant.annotated,
     ...
     hydra.variants.TypeVariant.maybe, hydra.variants.TypeVariant.pair, hydra.variants.TypeVariant.record,
     hydra.variants.TypeVariant.set, hydra.variants.TypeVariant.union, hydra.variants.TypeVariant.unit,
  ...
  hydra.coders.Language("hydra.ext.scala", hydra.coders.LanguageConstraints(eliminationVariants, literalVariants,
