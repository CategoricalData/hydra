...
def andExpressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(andExpr: hydra.ext.lisp.syntax.AndExpression): hydra.ast.Expr =
  hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst("and")))(hydra.lib.lists.map[hydra.ext.lisp.syntax.Expression, hydra.ast.Expr]((v1: hydra.ext.lisp.syntax.Expression) => hydra.ext.lisp.serde.expressionToExpr(d)(v1))(andExpr.expressions))))
...
def applicationToExpr(d: hydra.ext.lisp.syntax.Dialect)(app: hydra.ext.lisp.syntax.Application): hydra.ast.Expr =
  ...
  lazy val needsFuncall: Boolean = d match
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => funExpr match
      ...
      case _ => true
    case _ => false
  lazy val allParts: Seq[hydra.ast.Expr] = hydra.lib.logic.ifElse[Seq[hydra.ast.Expr]](needsFuncall)(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst("funcall"), fun))(args))(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(fun))(args))
...
def caseExpressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(caseExpr: hydra.ext.lisp.syntax.CaseExpression): hydra.ast.Expr =
  ...
  lazy val clauseExprs: Seq[hydra.ast.Expr] = hydra.lib.lists.map[hydra.ext.lisp.syntax.CaseClause, hydra.ast.Expr]((c: hydra.ext.lisp.syntax.CaseClause) =>
    hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.lisp.syntax.Expression, hydra.ast.Expr]((v1: hydra.ext.lisp.syntax.Expression) => hydra.ext.lisp.serde.expressionToExpr(d)(v1))(c.keys))), hydra.ext.lisp.serde.expressionToExpr(d)(c.body)))))(clauses)
  ...
  hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("case"), scrutinee), clauseExprs, defaultPart))))
}
...
def condExpressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(condExpr: hydra.ext.lisp.syntax.CondExpression): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => {
      lazy val clauseExprs: Seq[hydra.ast.Expr] = hydra.lib.lists.concat[hydra.ast.Expr](hydra.lib.lists.map[hydra.ext.lisp.syntax.CondClause, Seq[hydra.ast.Expr]]((c: hydra.ext.lisp.syntax.CondClause) =>
      ...
      hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("cond")), clauseExprs, defaultPart))))
    }
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => {
      lazy val clauseExprs: Seq[hydra.ast.Expr] = hydra.lib.lists.map[hydra.ext.lisp.syntax.CondClause, hydra.ast.Expr]((c: hydra.ext.lisp.syntax.CondClause) =>
        hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.ext.lisp.serde.expressionToExpr(d)(c.condition), hydra.ext.lisp.serde.expressionToExpr(d)(c.body)))))(clauses)
      lazy val defaultPart: Seq[hydra.ast.Expr] = hydra.lib.maybes.maybe[Seq[hydra.ast.Expr], hydra.ext.lisp.syntax.Expression](Seq())((e: hydra.ext.lisp.syntax.Expression) =>
...
def doExpressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(doExpr: hydra.ext.lisp.syntax.DoExpression): hydra.ast.Expr =
  ...
  hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst(kw)))(hydra.lib.lists.map[hydra.ext.lisp.syntax.Expression, hydra.ast.Expr]((v1: hydra.ext.lisp.syntax.Expression) => hydra.ext.lisp.serde.expressionToExpr(d)(v1))(doExpr.expressions))))
}
...
def exportDeclarationToExpr(d: hydra.ext.lisp.syntax.Dialect)(edecl: hydra.ext.lisp.syntax.ExportDeclaration): hydra.ast.Expr =
  ...
  d match
    ...
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.newlineSep(hydra.lib.lists.map[hydra.ast.Expr, hydra.ast.Expr]((s: hydra.ast.Expr) =>
      hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("provide"), hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), s))))))(syms))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst(":export")))(hydra.lib.lists.map[hydra.ast.Expr, hydra.ast.Expr]((s: hydra.ast.Expr) =>
...
def expressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(expr: hydra.ext.lisp.syntax.Expression): hydra.ast.Expr =
  ...
  case hydra.ext.lisp.syntax.Expression.begin(v_Expression_begin_e) => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst("begin")))(hydra.lib.lists.map[hydra.ext.lisp.syntax.Expression, hydra.ast.Expr]((v1: hydra.ext.lisp.syntax.Expression) => hydra.ext.lisp.serde.expressionToExpr(d)(v1))(v_Expression_begin_e.expressions))))
  ...
  case hydra.ext.lisp.syntax.Expression.cons(v_Expression_cons_c) => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("cons"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_cons_c.head), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_cons_c.tail))))
  case hydra.ext.lisp.syntax.Expression.dottedPair(v_Expression_dottedPair_p) => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_dottedPair_p.car), hydra.serialization.cst("."), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_dottedPair_p.cdr))))
  ...
  case hydra.ext.lisp.syntax.Expression.quote(v_Expression_quote_q) => hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_quote_q.body)))
  case hydra.ext.lisp.syntax.Expression.quasiquote(v_Expression_quasiquote_q) => hydra.serialization.noSep(Seq(hydra.serialization.cst("`"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_quasiquote_q.body)))
  case hydra.ext.lisp.syntax.Expression.unquote(v_Expression_unquote_u) => d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.noSep(Seq(hydra.serialization.cst("~"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_unquote_u.body)))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.noSep(Seq(hydra.serialization.cst(","), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_unquote_u.body)))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.noSep(Seq(hydra.serialization.cst(","), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_unquote_u.body)))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.noSep(Seq(hydra.serialization.cst(","), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_unquote_u.body)))
  case hydra.ext.lisp.syntax.Expression.splicingUnquote(v_Expression_splicingUnquote_su) => d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.noSep(Seq(hydra.serialization.cst("~@"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_splicingUnquote_su.body)))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.noSep(Seq(hydra.serialization.cst(",@"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_splicingUnquote_su.body)))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.noSep(Seq(hydra.serialization.cst(",@"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_splicingUnquote_su.body)))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.noSep(Seq(hydra.serialization.cst(",@"), hydra.ext.lisp.serde.expressionToExpr(d)(v_Expression_splicingUnquote_su.body)))
...
def fieldAccessToExpr(d: hydra.ext.lisp.syntax.Dialect)(fa: hydra.ext.lisp.syntax.FieldAccess): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.noSep(Seq(hydra.serialization.cst(":"), field)), target)))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.noSep(Seq(rtype, hydra.serialization.cst("-"), field)), target)))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.noSep(Seq(rtype, hydra.serialization.cst("-"), field)), target)))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.noSep(Seq(rtype, hydra.serialization.cst("-"), field)), target)))
}
...
def functionDefinitionToExpr(d: hydra.ext.lisp.syntax.Dialect)(fdef: hydra.ext.lisp.syntax.FunctionDefinition): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("defn"), name), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("defun"), name), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("defun"), name), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("define")), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(name))(params)))), body))))
}
...
def ifExpressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(ifExpr: hydra.ext.lisp.syntax.IfExpression): hydra.ast.Expr =
  ...
  hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("if"), cond, `then`), elsePart))))
}
...
def importDeclarationToExpr(d: hydra.ext.lisp.syntax.Dialect)(idecl: hydra.ext.lisp.syntax.ImportDeclaration): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst(":require"), hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(Seq(hydra.serialization.cst(modName)))))))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("require"), hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.cst(modName))))))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst(":use"), hydra.serialization.cst(hydra.lib.strings.cat2(":")(modName)))))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("import"), hydra.serialization.parens(hydra.serialization.cst(modName)))))
}
...
def keywordToExpr(d: hydra.ext.lisp.syntax.Dialect)(k: hydra.ext.lisp.syntax.Keyword): hydra.ast.Expr =
  ...
  d match
    ...
    case _ => hydra.serialization.cst(hydra.lib.maybes.maybe[scala.Predef.String, scala.Predef.String](hydra.lib.strings.cat2(":")(name))((n: scala.Predef.String) => hydra.lib.strings.cat(Seq(n, "/:", name)))(ns))
}
...
def lambdaToExpr(d: hydra.ext.lisp.syntax.Dialect)(lam: hydra.ext.lisp.syntax.Lambda): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.lib.maybes.maybe[hydra.ast.Expr, hydra.ext.lisp.syntax.Symbol](hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst(kw)), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(params))), body)))))((sym: hydra.ext.lisp.syntax.Symbol) =>
      hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst(kw), hydra.ext.lisp.serde.symbolToExpr(sym)), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(params))), body)))))(mname)
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst(kw)), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst(kw)), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst(kw)), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(params))), body))))
}
...
def letExpressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(letExpr: hydra.ext.lisp.syntax.LetExpression): hydra.ast.Expr =
  ...
  lazy val bindingPairs: Seq[Tuple2[hydra.ast.Expr, hydra.ast.Expr]] = hydra.lib.lists.map[hydra.ext.lisp.syntax.LetBinding, Tuple2[hydra.ast.Expr, hydra.ast.Expr]]((b: hydra.ext.lisp.syntax.LetBinding) =>
    b match
    case hydra.ext.lisp.syntax.LetBinding.simple(v_LetBinding_simple_sb) => Tuple2(hydra.ext.lisp.serde.symbolToExpr(v_LetBinding_simple_sb.name), hydra.ext.lisp.serde.expressionToExpr(d)(v_LetBinding_simple_sb.value))
    case hydra.ext.lisp.syntax.LetBinding.destructuring(v_LetBinding_destructuring__) => Tuple2(hydra.serialization.cst("<destructuring>"), hydra.serialization.cst("<destructuring>")))(bindings)
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => kind match
      case hydra.ext.lisp.syntax.LetKind.recursive => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("let")), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](hydra.lib.lists.map[Tuple2[hydra.ast.Expr, hydra.ast.Expr], Seq[hydra.ast.Expr]]((p: Tuple2[hydra.ast.Expr, hydra.ast.Expr]) =>
      ...
      case hydra.ext.lisp.syntax.LetKind.parallel => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("let")), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](hydra.lib.lists.map[Tuple2[hydra.ast.Expr, hydra.ast.Expr], Seq[hydra.ast.Expr]]((p: Tuple2[hydra.ast.Expr, hydra.ast.Expr]) =>
        Seq(hydra.lib.pairs.first[hydra.ast.Expr, hydra.ast.Expr](p), hydra.lib.pairs.second[hydra.ast.Expr, hydra.ast.Expr](p)))(bindingPairs))))), body))))
      case hydra.ext.lisp.syntax.LetKind.sequential => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("let")), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](hydra.lib.lists.map[Tuple2[hydra.ast.Expr, hydra.ast.Expr], Seq[hydra.ast.Expr]]((p: Tuple2[hydra.ast.Expr, hydra.ast.Expr]) =>
        Seq(hydra.lib.pairs.first[hydra.ast.Expr, hydra.ast.Expr](p), hydra.lib.pairs.second[hydra.ast.Expr, hydra.ast.Expr](p)))(bindingPairs))))), body))))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => {
      ...
      lazy val bindingExprs: Seq[hydra.ast.Expr] = hydra.lib.lists.map[Tuple2[hydra.ast.Expr, hydra.ast.Expr], hydra.ast.Expr]((p: Tuple2[hydra.ast.Expr, hydra.ast.Expr]) =>
        hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.lib.pairs.first[hydra.ast.Expr, hydra.ast.Expr](p), hydra.lib.pairs.second[hydra.ast.Expr, hydra.ast.Expr](p)))))(bindingPairs)
      hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst(kw)), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(bindingExprs))), body))))
    }
    case hydra.ext.lisp.syntax.Dialect.commonLisp => {
      lazy val kw: scala.Predef.String = kind match
        case hydra.ext.lisp.syntax.LetKind.parallel => "let"
...
def listLiteralToExpr(d: hydra.ext.lisp.syntax.Dialect)(ll: hydra.ext.lisp.syntax.ListLiteral): hydra.ast.Expr =
  ...
  hydra.lib.logic.ifElse[hydra.ast.Expr](quoted)(hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.parens(hydra.serialization.spaceSep(elems)))))(hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst(hydra.ext.lisp.serde.listKeyword(d))))(elems))))
}
...
def literalToExpr(d: hydra.ext.lisp.syntax.Dialect)(lit: hydra.ext.lisp.syntax.Literal): hydra.ast.Expr =
  ...
  case hydra.ext.lisp.syntax.Literal.symbol(v_Literal_symbol_s) => hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.ext.lisp.serde.symbolToExpr(v_Literal_symbol_s)))
...
def macroDefinitionToExpr(d: hydra.ext.lisp.syntax.Dialect)(mdef: hydra.ext.lisp.syntax.MacroDefinition): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("defmacro"), name), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("defmacro"), name), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("defmacro"), name), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(params))), body))))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("define-syntax"), name), body))))
}
...
def mapLiteralToExpr(d: hydra.ext.lisp.syntax.Dialect)(ml: hydra.ext.lisp.syntax.MapLiteral): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.brackets(hydra.serialization.curlyBraces)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](hydra.lib.lists.map[hydra.ext.lisp.syntax.MapEntry, Seq[hydra.ast.Expr]]((e: hydra.ext.lisp.syntax.MapEntry) =>
      Seq(hydra.ext.lisp.serde.expressionToExpr(d)(e.key), hydra.ext.lisp.serde.expressionToExpr(d)(e.value)))(entries))))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.lisp.syntax.MapEntry, hydra.ast.Expr]((e: hydra.ext.lisp.syntax.MapEntry) =>
      hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.ext.lisp.serde.expressionToExpr(d)(e.key), hydra.serialization.cst("."), hydra.ext.lisp.serde.expressionToExpr(d)(e.value)))))(entries)))))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.lisp.syntax.MapEntry, hydra.ast.Expr]((e: hydra.ext.lisp.syntax.MapEntry) =>
      hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.ext.lisp.serde.expressionToExpr(d)(e.key), hydra.serialization.cst("."), hydra.ext.lisp.serde.expressionToExpr(d)(e.value)))))(entries)))))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst("list")))(hydra.lib.lists.map[hydra.ext.lisp.syntax.MapEntry, hydra.ast.Expr]((e: hydra.ext.lisp.syntax.MapEntry) =>
      hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("cons"), hydra.ext.lisp.serde.expressionToExpr(d)(e.key), hydra.ext.lisp.serde.expressionToExpr(d)(e.value)))))(entries))))
}
...
def moduleDeclarationToExpr(d: hydra.ext.lisp.syntax.Dialect)(mdecl: hydra.ext.lisp.syntax.ModuleDeclaration): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("ns"), hydra.serialization.cst(name))))
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.newlineSep(Seq(hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("require"), hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.cst("cl-lib")))))), hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("provide"), hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.cst(name))))))))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.newlineSep(Seq(hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("defpackage"), hydra.serialization.cst(hydra.lib.strings.cat2(":")(name))))), hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("in-package"), hydra.serialization.cst(hydra.lib.strings.cat2(":")(name)))))))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("define-library"), hydra.serialization.parens(hydra.serialization.cst(name)))))
}
...
def orExpressionToExpr(d: hydra.ext.lisp.syntax.Dialect)(orExpr: hydra.ext.lisp.syntax.OrExpression): hydra.ast.Expr =
  hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst("or")))(hydra.lib.lists.map[hydra.ext.lisp.syntax.Expression, hydra.ast.Expr]((v1: hydra.ext.lisp.syntax.Expression) => hydra.ext.lisp.serde.expressionToExpr(d)(v1))(orExpr.expressions))))
...
def programToExpr(prog: hydra.ext.lisp.syntax.Program): hydra.ast.Expr =
  ...
  lazy val formPart: Seq[hydra.ast.Expr] = hydra.lib.lists.map[hydra.ext.lisp.syntax.TopLevelFormWithComments, hydra.ast.Expr]((v1: hydra.ext.lisp.syntax.TopLevelFormWithComments) => hydra.ext.lisp.serde.topLevelFormWithCommentsToExpr(d)(v1))(forms)
  lazy val importNames: Seq[scala.Predef.String] = hydra.lib.lists.map[hydra.ext.lisp.syntax.ImportDeclaration, scala.Predef.String]((idecl: hydra.ext.lisp.syntax.ImportDeclaration) => (idecl.module))(imports)
  lazy val exportSyms: Seq[hydra.ast.Expr] = hydra.lib.lists.concat[hydra.ast.Expr](hydra.lib.lists.map[hydra.ext.lisp.syntax.ExportDeclaration, Seq[hydra.ast.Expr]]((edecl: hydra.ext.lisp.syntax.ExportDeclaration) =>
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.lib.maybes.maybe[hydra.ast.Expr, hydra.ext.lisp.syntax.ModuleDeclaration](hydra.serialization.doubleNewlineSep(formPart))((m: hydra.ext.lisp.syntax.ModuleDeclaration) =>
      ...
      lazy val requireClauses: Seq[hydra.ast.Expr] = hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((imp: scala.Predef.String) =>
        hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(Seq(hydra.serialization.cst(imp), hydra.serialization.cst(":refer"), hydra.serialization.cst(":all")))))(importNames)
      lazy val nsForm: hydra.ast.Expr = hydra.lib.logic.ifElse[hydra.ast.Expr](hydra.lib.lists.`null`[hydra.ast.Expr](requireClauses))(hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("ns"), hydra.serialization.cst(nameStr)))))(hydra.serialization.parens(hydra.serialization.newlineSep(Seq(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("ns"), hydra.serialization.cst(nameStr))), hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst("  (:require")))(requireClauses)), hydra.serialization.cst(")")))))
      {
        lazy val varNames: Seq[hydra.ast.Expr] = hydra.lib.lists.concat[hydra.ast.Expr](hydra.lib.lists.map[hydra.ext.lisp.syntax.TopLevelFormWithComments, Seq[hydra.ast.Expr]]((fwc: hydra.ext.lisp.syntax.TopLevelFormWithComments) =>
          {
    ...
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.lib.maybes.maybe[hydra.ast.Expr, hydra.ext.lisp.syntax.ModuleDeclaration](hydra.serialization.doubleNewlineSep(formPart))((m: hydra.ext.lisp.syntax.ModuleDeclaration) =>
      {
      lazy val nameStr: scala.Predef.String = (m.name)
      lazy val requireClLib: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("require"), hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.cst("cl-lib"))))))
      lazy val requireImports: Seq[hydra.ast.Expr] = hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((imp: scala.Predef.String) =>
        hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("require"), hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.cst(imp)))))))(importNames)
      lazy val provideForm: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("provide"), hydra.serialization.noSep(Seq(hydra.serialization.cst("'"), hydra.serialization.cst(nameStr))))))
    ...
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.lib.maybes.maybe[hydra.ast.Expr, hydra.ext.lisp.syntax.ModuleDeclaration](hydra.serialization.doubleNewlineSep(formPart))((m: hydra.ext.lisp.syntax.ModuleDeclaration) =>
      ...
      lazy val useClause: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst(":use"), hydra.serialization.cst(":cl")))(hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((imp: scala.Predef.String) => hydra.serialization.cst(hydra.lib.strings.cat2(":")(imp)))(importNames))))
      lazy val exportClause: Seq[hydra.ast.Expr] = hydra.lib.logic.ifElse[Seq[hydra.ast.Expr]](hydra.lib.lists.`null`[hydra.ast.Expr](exportSyms))(Seq())(Seq(hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst(":export")))(hydra.lib.lists.map[hydra.ast.Expr, hydra.ast.Expr]((s: hydra.ast.Expr) =>
        hydra.serialization.noSep(Seq(hydra.serialization.cst(":"), s)))(exportSyms))))))
      lazy val defpkgForm: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.newlineSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("defpackage"), hydra.serialization.cst(colonName)))), Seq(useClause), exportClause))))
      lazy val inpkgForm: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("in-package"), hydra.serialization.cst(colonName))))
    ...
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.lib.maybes.maybe[hydra.ast.Expr, hydra.ext.lisp.syntax.ModuleDeclaration](hydra.serialization.doubleNewlineSep(formPart))((m: hydra.ext.lisp.syntax.ModuleDeclaration) =>
      ...
      lazy val nameExpr: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((p: scala.Predef.String) => hydra.serialization.cst(p))(nameParts)))
      lazy val domainImportExprs: Seq[hydra.ast.Expr] = hydra.lib.lists.map[hydra.ext.lisp.syntax.ImportDeclaration, hydra.ast.Expr]((idecl: hydra.ext.lisp.syntax.ImportDeclaration) =>
        {
        ...
        hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((p: scala.Predef.String) => hydra.serialization.cst(p))(nsParts)))
      })(imports)
      lazy val schemeBaseExpr: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("scheme"), hydra.serialization.cst("base"))))
      ...
      lazy val exportClauses: Seq[hydra.ast.Expr] = hydra.lib.lists.map[hydra.ext.lisp.syntax.ExportDeclaration, hydra.ast.Expr]((edecl: hydra.ext.lisp.syntax.ExportDeclaration) => hydra.ext.lisp.serde.exportDeclarationToExpr(d)(edecl))(exports)
      ...
      hydra.serialization.parens(hydra.serialization.newlineSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("define-library"), nameExpr))), exportClauses, Seq(importClause), Seq(beginClause)))))
    })(modDecl)
}
...
def recordTypeDefinitionToExpr(d: hydra.ext.lisp.syntax.Dialect)(rdef: hydra.ext.lisp.syntax.RecordTypeDefinition): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => {
      ...
      lazy val fieldNames: Seq[scala.Predef.String] = hydra.lib.lists.map[hydra.ext.lisp.syntax.FieldDefinition, scala.Predef.String]((f: hydra.ext.lisp.syntax.FieldDefinition) => (f.name))(rdef.fields)
      lazy val defrecordForm: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst("defrecord"), name, hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(fields)))))
      lazy val makeAlias: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("defn"), hydra.serialization.cst(hydra.lib.strings.cat2("make-")(nameStr))), Seq(hydra.serialization.brackets(hydra.serialization.squareBrackets)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(fields))), Seq(hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst(hydra.lib.strings.cat2("->")(nameStr))))(hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((fn: scala.Predef.String) => hydra.serialization.cst(fn))(fieldNames)))))))))
      hydra.serialization.newlineSep(Seq(defrecordForm, makeAlias))
    }
    case hydra.ext.lisp.syntax.Dialect.emacsLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("cl-defstruct"), name), fields))))
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("cl:defstruct"), name), fields))))
    case hydra.ext.lisp.syntax.Dialect.scheme => {
      lazy val nameStr: scala.Predef.String = (rdef.name)
      lazy val fieldNames: Seq[scala.Predef.String] = hydra.lib.lists.map[hydra.ext.lisp.syntax.FieldDefinition, scala.Predef.String]((f: hydra.ext.lisp.syntax.FieldDefinition) => (f.name))(rdef.fields)
      lazy val constructor: hydra.ast.Expr = hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat2[hydra.ast.Expr](Seq(hydra.serialization.cst(hydra.lib.strings.cat2("make-")(nameStr))))(hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((fn: scala.Predef.String) => hydra.serialization.cst(fn))(fieldNames))))
      ...
      lazy val accessors: Seq[hydra.ast.Expr] = hydra.lib.lists.map[scala.Predef.String, hydra.ast.Expr]((fn: scala.Predef.String) =>
        hydra.serialization.parens(hydra.serialization.spaceSep(Seq(hydra.serialization.cst(fn), hydra.serialization.cst(hydra.lib.strings.cat(Seq(nameStr, "-", fn)))))))(fieldNames)
      hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.concat[hydra.ast.Expr](Seq(Seq(hydra.serialization.cst("define-record-type"), name, constructor, predicate), accessors))))
    }
}
...
def sExpressionToExpr(sexpr: hydra.ext.lisp.syntax.SExpression): hydra.ast.Expr =
  ...
  case hydra.ext.lisp.syntax.SExpression.list(v_SExpression_list_elems) => hydra.serialization.parens(hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.lisp.syntax.SExpression, hydra.ast.Expr](hydra.ext.lisp.serde.sExpressionToExpr)(v_SExpression_list_elems)))
...
def setLiteralToExpr(d: hydra.ext.lisp.syntax.Dialect)(sl: hydra.ext.lisp.syntax.SetLiteral): hydra.ast.Expr =
  ...
  d match
    case hydra.ext.lisp.syntax.Dialect.clojure => hydra.serialization.noSep(Seq(hydra.serialization.cst("#"), hydra.serialization.brackets(hydra.serialization.curlyBraces)(hydra.serialization.inlineStyle)(hydra.serialization.spaceSep(elems))))
...
def vectorLiteralToExpr(d: hydra.ext.lisp.syntax.Dialect)(vl: hydra.ext.lisp.syntax.VectorLiteral): hydra.ast.Expr =
  ...
  d match
    ...
    case hydra.ext.lisp.syntax.Dialect.commonLisp => hydra.serialization.noSep(Seq(hydra.serialization.cst("#"), hydra.serialization.parens(hydra.serialization.spaceSep(elems))))
    case hydra.ext.lisp.syntax.Dialect.scheme => hydra.serialization.noSep(Seq(hydra.serialization.cst("#"), hydra.serialization.parens(hydra.serialization.spaceSep(elems))))
}
