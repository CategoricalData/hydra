...
def encodeApplication[T0, T1, T2](dialect: hydra.ext.lisp.syntax.Dialect)(cx: T0)(g: T1)(rawFun: hydra.core.Term)(rawArg: hydra.core.Term): Either[T2, hydra.ext.lisp.syntax.Expression] =
  {
  lazy val dFun: hydra.core.Term = hydra.rewriting.deannotateTerm(rawFun)
  lazy val normal: Either[T2, hydra.ext.lisp.syntax.Expression] = hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(rawFun))((fun: hydra.ext.lisp.syntax.Expression) =>
      ...
      lazy val midFun: hydra.core.Term = (v_Term_application_app2.function)
      {
        lazy val midArg: hydra.core.Term = (v_Term_application_app2.argument)
        {
          lazy val dMidFun: hydra.core.Term = hydra.rewriting.deannotateTerm(midFun)
          {
            ...
            hydra.lib.logic.ifElse[Either[T2, hydra.ext.lisp.syntax.Expression]](isLazy2)(hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](enc(midFun))((ePrim: hydra.ext.lisp.syntax.Expression) =>
              ...
              case hydra.core.Term.application(v_Term_application_app3) => {
                lazy val innerFun: hydra.core.Term = (v_Term_application_app3.function)
                {
                  lazy val innerArg: hydra.core.Term = (v_Term_application_app3.argument)
                  {
                    ...
                    hydra.lib.logic.ifElse[Either[T2, hydra.ext.lisp.syntax.Expression]](hydra.ext.lisp.coder.isPrimitiveRef("hydra.lib.logic.ifElse")(dInnerFun))(hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](enc(innerArg))((eC: hydra.ext.lisp.syntax.Expression) =>
                      ...
                      Right(hydra.ext.lisp.syntax.Expression.`if`(hydra.ext.lisp.syntax.IfExpression(eC, eT, Some(eE))))))))(hydra.lib.logic.ifElse[Either[T2, hydra.ext.lisp.syntax.Expression]](hydra.ext.lisp.coder.isPrimitiveRef("hydra.lib.maybes.maybe")(dInnerFun))(hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](enc(innerFun))((eP: hydra.ext.lisp.syntax.Expression) =>
                      ...
                      Right(hydra.ext.lisp.coder.lispApp(hydra.ext.lisp.coder.lispApp(hydra.ext.lisp.coder.lispApp(eP)(Seq(hydra.ext.lisp.coder.wrapInThunk(eDef))))(Seq(eF)))(Seq(eM))))))))(hydra.lib.logic.ifElse[Either[T2, hydra.ext.lisp.syntax.Expression]](hydra.ext.lisp.coder.isPrimitiveRef("hydra.lib.maybes.cases")(dInnerFun))(hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](enc(innerFun))((eP: hydra.ext.lisp.syntax.Expression) =>
...
def encodeElimination[T0, T1, T2](dialect: hydra.ext.lisp.syntax.Dialect)(cx: T0)(g: T1)(elim: hydra.core.Elimination)(marg: Option[hydra.core.Term]): Either[T2, hydra.ext.lisp.syntax.Expression] =
  elim match
  case hydra.core.Elimination.record(v_Elimination_record_proj) => {
    lazy val fname: scala.Predef.String = hydra.formatting.convertCaseCamelToLowerSnake(v_Elimination_record_proj.field)
    {
      ...
      hydra.lib.maybes.cases[hydra.core.Term, Either[T2, hydra.ext.lisp.syntax.Expression]](marg)(Right(hydra.ext.lisp.coder.lispLambdaExpr(Seq("v"))(hydra.ext.lisp.syntax.Expression.fieldAccess(hydra.ext.lisp.syntax.FieldAccess(tname, fname, hydra.ext.lisp.coder.lispVar("v"))))))((arg: hydra.core.Term) =>
  ...
  case hydra.core.Elimination.union(v_Elimination_union_cs) => {
    lazy val tname: scala.Predef.String = hydra.names.localNameOf(v_Elimination_union_cs.typeName)
    {
      lazy val caseFields: Seq[hydra.core.Field] = (v_Elimination_union_cs.cases)
      {
        ...
        hydra.lib.eithers.bind[T2, Seq[hydra.ext.lisp.syntax.CondClause], hydra.ext.lisp.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Field, hydra.ext.lisp.syntax.CondClause, T2]((cf: hydra.core.Field) =>
          {
          lazy val cfname: scala.Predef.String = hydra.formatting.convertCaseCamelToLowerSnake(cf.name)
          {
            ...
            {
              lazy val condExpr: hydra.ext.lisp.syntax.Expression = hydra.ext.lisp.coder.lispApp(hydra.ext.lisp.coder.lispVar(hydra.ext.lisp.coder.dialectEqual(dialect)))(Seq(hydra.ext.lisp.coder.lispApp(hydra.ext.lisp.coder.lispVar(hydra.ext.lisp.coder.dialectCar(dialect)))(Seq(hydra.ext.lisp.coder.lispVar("match_target"))), hydra.ext.lisp.coder.lispKeyword(cfname)))
              hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.CondClause](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(hydra.core.Term.application(hydra.core.Application(cfterm, hydra.core.Term.variable("match_value")))))((bodyExpr: hydra.ext.lisp.syntax.Expression) => Right(hydra.ext.lisp.syntax.CondClause(condExpr, bodyExpr)))
            }
          }
        })(caseFields))((clauses: Seq[hydra.ext.lisp.syntax.CondClause]) =>
          hydra.lib.eithers.bind[T2, Option[hydra.ext.lisp.syntax.Expression], hydra.ext.lisp.syntax.Expression](hydra.lib.maybes.cases[hydra.core.Term, Either[T2, Option[hydra.ext.lisp.syntax.Expression]]](defCase)(Right(None))((dt: hydra.core.Term) =>
  ...
  case hydra.core.Elimination.wrap(v_Elimination_wrap_name) => hydra.lib.maybes.cases[hydra.core.Term, Either[T2, hydra.ext.lisp.syntax.Expression]](marg)(Right(hydra.ext.lisp.coder.lispLambdaExpr(Seq("v"))(hydra.ext.lisp.coder.lispVar("v"))))((arg: hydra.core.Term) => hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(arg))
...
def encodeLetAsLambdaApp[T0, T1, T2](dialect: hydra.ext.lisp.syntax.Dialect)(cx: T0)(g: T1)(bindings: Seq[hydra.core.Binding])(body: hydra.core.Term): Either[T2, hydra.ext.lisp.syntax.Expression] =
...
def encodeLetAsNative[T0, T1, T2](dialect: hydra.ext.lisp.syntax.Dialect)(cx: T0)(g: T1)(bindings: Seq[hydra.core.Binding])(body: hydra.core.Term): Either[T2, hydra.ext.lisp.syntax.Expression] =
  {
  ...
  hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(body))((bodyExpr: hydra.ext.lisp.syntax.Expression) =>
    ...
    lazy val sortedBindings: Seq[hydra.core.Binding] = hydra.lib.logic.ifElse[Seq[hydra.core.Binding]](true)({
      lazy val allNames: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.lists.map[hydra.core.Binding, hydra.core.Name]((b: hydra.core.Binding) => (b.name))(bindings))
      lazy val adjList: Seq[Tuple2[hydra.core.Name, Seq[hydra.core.Name]]] = hydra.lib.lists.map[hydra.core.Binding, Tuple2[hydra.core.Name, Seq[hydra.core.Name]]]((b: hydra.core.Binding) =>
      ...
      lazy val nameToBinding: Map[hydra.core.Name, hydra.core.Binding] = hydra.lib.maps.fromList[hydra.core.Name, hydra.core.Binding](hydra.lib.lists.map[hydra.core.Binding, Tuple2[hydra.core.Name, hydra.core.Binding]]((b: hydra.core.Binding) => Tuple2(b.name, b))(bindings))
      hydra.lib.eithers.either[Seq[Seq[hydra.core.Name]], Seq[hydra.core.Name], Seq[hydra.core.Binding]]((_x: Seq[Seq[hydra.core.Name]]) => bindings)((sorted: Seq[hydra.core.Name]) =>
        ...
        hydra.lib.maybes.fromMaybe[hydra.core.Binding](hydra.lib.lists.head[hydra.core.Binding](bindings))(hydra.lib.maps.lookup[hydra.core.Name, hydra.core.Binding](name)(nameToBinding)))(sorted))(sortResult)
    })(bindings)
    hydra.lib.eithers.bind[T2, Seq[Tuple2[scala.Predef.String, hydra.ext.lisp.syntax.Expression]], hydra.ext.lisp.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Binding, Tuple2[scala.Predef.String, hydra.ext.lisp.syntax.Expression], T2]((b: hydra.core.Binding) =>
      {
      lazy val bname: scala.Predef.String = hydra.formatting.convertCaseCamelOrUnderscoreToLowerSnake(hydra.formatting.sanitizeWithUnderscores(hydra.ext.lisp.language.lispReservedWords)(b.name))
      {
          ...
          hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, Tuple2[scala.Predef.String, hydra.ext.lisp.syntax.Expression]](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(b.term))((bval: hydra.ext.lisp.syntax.Expression) =>
              ...
              case _ => false
            {
              lazy val wrappedVal: hydra.ext.lisp.syntax.Expression = hydra.lib.logic.ifElse[hydra.ext.lisp.syntax.Expression](isClojure)(hydra.lib.logic.ifElse[hydra.ext.lisp.syntax.Expression](isSelfRef)(hydra.lib.logic.ifElse[hydra.ext.lisp.syntax.Expression](isLambda)(bval match
                case hydra.ext.lisp.syntax.Expression.lambda(v_Expression_lambda_lam) => hydra.ext.lisp.syntax.Expression.lambda(hydra.ext.lisp.syntax.Lambda(Some(bname), (v_Expression_lambda_lam.params), (v_Expression_lambda_lam.restParam), (v_Expression_lambda_lam.body)))
      ...
      {
      lazy val allBindingNames: scala.collection.immutable.Set[hydra.core.Name] = hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.lists.map[hydra.core.Binding, hydra.core.Name]((b: hydra.core.Binding) => (b.name))(bindings))
      {
          ...
          hydra.lib.logic.or(acc)(hydra.lib.logic.not(hydra.lib.sets.`null`[hydra.core.Name](hydra.lib.sets.intersection[hydra.core.Name](allBindingNames)(hydra.rewriting.freeVariablesInTerm(b.term))))))(false)(bindings)
        {
            ...
            hydra.lib.logic.or(acc)(hydra.lib.sets.member[hydra.core.Name](b.name)(hydra.rewriting.freeVariablesInTerm(b.term))))(false)(bindings)
          {
            lazy val isRecursive: Boolean = hasSelfRef
            {
              ...
              {
                lazy val lispBindings: Seq[hydra.ext.lisp.syntax.LetBinding] = hydra.lib.lists.map[Tuple2[scala.Predef.String, hydra.ext.lisp.syntax.Expression], hydra.ext.lisp.syntax.LetBinding]((eb: Tuple2[scala.Predef.String, hydra.ext.lisp.syntax.Expression]) =>
                  hydra.ext.lisp.syntax.LetBinding.simple(hydra.ext.lisp.syntax.SimpleBinding(hydra.lib.pairs.first[scala.Predef.String, hydra.ext.lisp.syntax.Expression](eb), hydra.lib.pairs.second[scala.Predef.String, hydra.ext.lisp.syntax.Expression](eb))))(encodedBindings)
...
def encodeLiteral(lit: hydra.core.Literal): hydra.ext.lisp.syntax.Expression =
  ...
  case hydra.core.Literal.float(v_Literal_float_fv) => v_Literal_float_fv match
    case hydra.core.FloatValue.float32(v_FloatValue_float32_f) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.float(hydra.ext.lisp.syntax.FloatLiteral(hydra.lib.literals.float32ToBigfloat(v_FloatValue_float32_f), None)))
    case hydra.core.FloatValue.float64(v_FloatValue_float64_f) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.float(hydra.ext.lisp.syntax.FloatLiteral(hydra.lib.literals.float64ToBigfloat(v_FloatValue_float64_f), None)))
    case hydra.core.FloatValue.bigfloat(v_FloatValue_bigfloat_f) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.float(hydra.ext.lisp.syntax.FloatLiteral(v_FloatValue_bigfloat_f, None)))
  case hydra.core.Literal.integer(v_Literal_integer_iv) => v_Literal_integer_iv match
    case hydra.core.IntegerValue.int8(v_IntegerValue_int8_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.int8ToBigint(v_IntegerValue_int8_i), false)))
    case hydra.core.IntegerValue.int16(v_IntegerValue_int16_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.int16ToBigint(v_IntegerValue_int16_i), false)))
    case hydra.core.IntegerValue.int32(v_IntegerValue_int32_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.int32ToBigint(v_IntegerValue_int32_i), false)))
    case hydra.core.IntegerValue.int64(v_IntegerValue_int64_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.int64ToBigint(v_IntegerValue_int64_i), false)))
    case hydra.core.IntegerValue.uint8(v_IntegerValue_uint8_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.uint8ToBigint(v_IntegerValue_uint8_i), false)))
    case hydra.core.IntegerValue.uint16(v_IntegerValue_uint16_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.uint16ToBigint(v_IntegerValue_uint16_i), false)))
    case hydra.core.IntegerValue.uint32(v_IntegerValue_uint32_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.uint32ToBigint(v_IntegerValue_uint32_i), false)))
    case hydra.core.IntegerValue.uint64(v_IntegerValue_uint64_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.uint64ToBigint(v_IntegerValue_uint64_i), false)))
    case hydra.core.IntegerValue.bigint(v_IntegerValue_bigint_i) => hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(v_IntegerValue_bigint_i, true)))
  case hydra.core.Literal.binary(v_Literal_binary_b) => {
    ...
    hydra.ext.lisp.syntax.Expression.vector(hydra.ext.lisp.syntax.VectorLiteral(hydra.lib.lists.map[Int, hydra.ext.lisp.syntax.Expression]((bv: Int) =>
      hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.integer(hydra.ext.lisp.syntax.IntegerLiteral(hydra.lib.literals.int32ToBigint(bv), false))))(byteValues)))
  }
...
def encodeTerm[T0, T1, T2](dialect: hydra.ext.lisp.syntax.Dialect)(cx: T0)(g: T1)(term: hydra.core.Term): Either[T2, hydra.ext.lisp.syntax.Expression] =
  ...
  case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term, Either[T2, hydra.ext.lisp.syntax.Expression]]((l: hydra.core.Term) =>
  ...
  case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[T2, Seq[hydra.ext.lisp.syntax.Expression], hydra.ext.lisp.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.lisp.syntax.Expression, T2]((v1: hydra.core.Term) => hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(v1))(v_Term_list_els))((sels: Seq[hydra.ext.lisp.syntax.Expression]) => Right(hydra.ext.lisp.coder.lispListExpr(sels)))
  case hydra.core.Term.literal(v_Term_literal_lit) => Right(hydra.ext.lisp.coder.encodeLiteral(v_Term_literal_lit))
  case hydra.core.Term.map(v_Term_map_m) => hydra.lib.eithers.bind[T2, Seq[hydra.ext.lisp.syntax.MapEntry], hydra.ext.lisp.syntax.Expression](hydra.lib.eithers.mapList[Tuple2[hydra.core.Term, hydra.core.Term], hydra.ext.lisp.syntax.MapEntry, T2]((entry: Tuple2[hydra.core.Term, hydra.core.Term]) =>
    hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.MapEntry](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](entry)))((k: hydra.ext.lisp.syntax.Expression) =>
    hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.MapEntry](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](entry)))((v: hydra.ext.lisp.syntax.Expression) => Right(hydra.ext.lisp.syntax.MapEntry(k, v)))))(hydra.lib.maps.toList[hydra.core.Term, hydra.core.Term](v_Term_map_m)))((pairs: Seq[hydra.ext.lisp.syntax.MapEntry]) =>
  ...
  case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((f: hydra.ext.lisp.syntax.Expression) =>
    hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((s: hydra.ext.lisp.syntax.Expression) => Right(hydra.ext.lisp.coder.lispListExpr(Seq(f, s)))))
  case hydra.core.Term.record(v_Term_record_rec) => {
    lazy val rname: hydra.core.Name = (v_Term_record_rec.typeName)
    {
      ...
      hydra.lib.eithers.bind[T2, Seq[hydra.ext.lisp.syntax.Expression], hydra.ext.lisp.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Field, hydra.ext.lisp.syntax.Expression, T2]((f: hydra.core.Field) => hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(f.term))(fields))((sfields: Seq[hydra.ext.lisp.syntax.Expression]) =>
        {
  ...
  case hydra.core.Term.set(v_Term_set_s) => hydra.lib.eithers.bind[T2, Seq[hydra.ext.lisp.syntax.Expression], hydra.ext.lisp.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.lisp.syntax.Expression, T2]((v1: hydra.core.Term) => hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(v1))(hydra.lib.sets.toList[hydra.core.Term](v_Term_set_s)))((sels: Seq[hydra.ext.lisp.syntax.Expression]) =>
          ...
          lazy val fterm: hydra.core.Term = (field.term)
          {
            lazy val dterm: hydra.core.Term = hydra.rewriting.deannotateTerm(fterm)
            {
              lazy val isUnit: Boolean = dterm match
                ...
                case _ => false
              hydra.lib.logic.ifElse[Either[T2, hydra.ext.lisp.syntax.Expression]](isUnit)(Right(hydra.ext.lisp.coder.lispApp(hydra.ext.lisp.coder.lispVar("list"))(Seq(hydra.ext.lisp.coder.lispKeyword(hydra.formatting.convertCaseCamelToLowerSnake(fname)), hydra.ext.lisp.coder.lispNilExpr))))(hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.Expression](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(fterm))((sval: hydra.ext.lisp.syntax.Expression) =>
                Right(hydra.ext.lisp.coder.lispApp(hydra.ext.lisp.coder.lispVar("list"))(Seq(hydra.ext.lisp.coder.lispKeyword(hydra.formatting.convertCaseCamelToLowerSnake(fname)), sval)))))
            }
          }
        }
      }
...
def encodeTermDefinition[T0, T1, T2](dialect: hydra.ext.lisp.syntax.Dialect)(cx: T0)(g: T1)(tdef: hydra.module.TermDefinition): Either[T2, hydra.ext.lisp.syntax.TopLevelFormWithComments] =
  {
  ...
  dterm match
    case hydra.core.Term.function(v_Term_function_fun) => v_Term_function_fun match
      case hydra.core.Function.lambda(v_Function_lambda_lam) => hydra.lib.eithers.bind[T2, hydra.ext.lisp.syntax.Expression, hydra.ext.lisp.syntax.TopLevelFormWithComments](hydra.ext.lisp.coder.encodeTerm(dialect)(cx)(g)(term))((sterm: hydra.ext.lisp.syntax.Expression) =>
...
def encodeType[T0, T1, T2](cx: T0)(g: T1)(t: hydra.core.Type): Either[T2, hydra.ext.lisp.syntax.TypeSpecifier] =
  ...
  typ match
    ...
    case hydra.core.Type.list(v_Type_list_inner) => hydra.lib.eithers.map[hydra.ext.lisp.syntax.TypeSpecifier, hydra.ext.lisp.syntax.TypeSpecifier, T2]((enc: hydra.ext.lisp.syntax.TypeSpecifier) => hydra.ext.lisp.syntax.TypeSpecifier.list(enc))(hydra.ext.lisp.coder.encodeType(cx)(g)(v_Type_list_inner))
    case hydra.core.Type.set(v_Type_set_inner) => hydra.lib.eithers.map[hydra.ext.lisp.syntax.TypeSpecifier, hydra.ext.lisp.syntax.TypeSpecifier, T2]((enc: hydra.ext.lisp.syntax.TypeSpecifier) => hydra.ext.lisp.syntax.TypeSpecifier.set(enc))(hydra.ext.lisp.coder.encodeType(cx)(g)(v_Type_set_inner))
    case hydra.core.Type.map(v_Type_map_mt) => Right(hydra.ext.lisp.syntax.TypeSpecifier.named("Map"))
    case hydra.core.Type.maybe(v_Type_maybe_inner) => hydra.lib.eithers.map[hydra.ext.lisp.syntax.TypeSpecifier, hydra.ext.lisp.syntax.TypeSpecifier, T2]((enc: hydra.ext.lisp.syntax.TypeSpecifier) => hydra.ext.lisp.syntax.TypeSpecifier.maybe(enc))(hydra.ext.lisp.coder.encodeType(cx)(g)(v_Type_maybe_inner))
...
def encodeTypeBody[T0](lname: scala.Predef.String)(origTyp: hydra.core.Type)(typ: hydra.core.Type): Either[T0, hydra.ext.lisp.syntax.TopLevelFormWithComments] =
  ...
  case hydra.core.Type.record(v_Type_record_rt) => {
    lazy val fields: Seq[hydra.ext.lisp.syntax.FieldDefinition] = hydra.lib.lists.map[hydra.core.FieldType, hydra.ext.lisp.syntax.FieldDefinition](hydra.ext.lisp.coder.encodeFieldDef)(v_Type_record_rt)
  ...
  case hydra.core.Type.union(v_Type_union_rt) => {
    lazy val variantNames: Seq[hydra.ext.lisp.syntax.Expression] = hydra.lib.lists.map[hydra.core.FieldType, hydra.ext.lisp.syntax.Expression]((f: hydra.core.FieldType) =>
      hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.keyword(hydra.ext.lisp.syntax.Keyword(hydra.formatting.convertCaseCamelToLowerSnake(f.name), None))))(v_Type_union_rt)
    Right(hydra.ext.lisp.coder.lispTopForm(hydra.ext.lisp.syntax.TopLevelForm.variable(hydra.ext.lisp.syntax.VariableDefinition(hydra.lib.strings.cat2(lname)("-variants"), hydra.ext.lisp.coder.lispListExpr(variantNames), Some(hydra.lib.strings.cat2("Variants of the ")(lname))))))
  }
  case hydra.core.Type.wrap(v_Type_wrap_wt) => Right(hydra.ext.lisp.coder.lispTopForm(hydra.ext.lisp.syntax.TopLevelForm.recordType(hydra.ext.lisp.syntax.RecordTypeDefinition(lname, Seq(hydra.ext.lisp.syntax.FieldDefinition("value", None)), None))))
  case _ => Right(hydra.ext.lisp.syntax.TopLevelFormWithComments(None, Some(hydra.ext.lisp.syntax.Comment(hydra.ext.lisp.syntax.CommentStyle.line, hydra.lib.strings.cat2(hydra.lib.strings.cat2(lname)(" = "))(hydra.show.core.`type`(origTyp)))), hydra.ext.lisp.syntax.TopLevelForm.expression(hydra.ext.lisp.syntax.Expression.literal(hydra.ext.lisp.syntax.Literal.nil))))
...
def lispLambdaExpr(params: Seq[scala.Predef.String])(body: hydra.ext.lisp.syntax.Expression): hydra.ext.lisp.syntax.Expression =
  hydra.ext.lisp.syntax.Expression.lambda(hydra.ext.lisp.syntax.Lambda(None, hydra.lib.lists.map[scala.Predef.String, hydra.ext.lisp.syntax.Symbol]((p: scala.Predef.String) => p)(params), None, Seq(body)))
...
def lispNamedLambdaExpr(name: scala.Predef.String)(params: Seq[scala.Predef.String])(body: hydra.ext.lisp.syntax.Expression): hydra.ext.lisp.syntax.Expression =
  hydra.ext.lisp.syntax.Expression.lambda(hydra.ext.lisp.syntax.Lambda(Some(name), hydra.lib.lists.map[scala.Predef.String, hydra.ext.lisp.syntax.Symbol]((p: scala.Predef.String) => p)(params), None, Seq(body)))
...
def lispTopForm(form: hydra.ext.lisp.syntax.TopLevelForm): hydra.ext.lisp.syntax.TopLevelFormWithComments = hydra.ext.lisp.syntax.TopLevelFormWithComments(None, None, form)
...
def lispTopFormWithComments(mdoc: Option[scala.Predef.String])(form: hydra.ext.lisp.syntax.TopLevelForm): hydra.ext.lisp.syntax.TopLevelFormWithComments =
  hydra.ext.lisp.syntax.TopLevelFormWithComments(hydra.lib.maybes.map[scala.Predef.String, hydra.ext.lisp.syntax.Docstring]((d: scala.Predef.String) => d)(mdoc), None, form)
...
def moduleExports(forms: Seq[hydra.ext.lisp.syntax.TopLevelFormWithComments]): Seq[hydra.ext.lisp.syntax.ExportDeclaration] =
  {
  lazy val symbols: Seq[hydra.ext.lisp.syntax.Symbol] = hydra.lib.lists.concat[hydra.ext.lisp.syntax.Symbol](hydra.lib.lists.map[hydra.ext.lisp.syntax.TopLevelFormWithComments, Seq[hydra.ext.lisp.syntax.Symbol]]((fwc: hydra.ext.lisp.syntax.TopLevelFormWithComments) =>
    {
    ...
    form match
      ...
      case hydra.ext.lisp.syntax.TopLevelForm.recordType(v_TopLevelForm_recordType_rdef) => {
        lazy val rname: scala.Predef.String = (v_TopLevelForm_recordType_rdef.name)
        {
          ...
          {
            lazy val fieldSyms: Seq[hydra.ext.lisp.syntax.Symbol] = hydra.lib.lists.map[hydra.ext.lisp.syntax.FieldDefinition, hydra.ext.lisp.syntax.Symbol]((f: hydra.ext.lisp.syntax.FieldDefinition) =>
              {
              lazy val fn: scala.Predef.String = (f.name)
              hydra.lib.strings.cat(Seq(rname, "-", fn))
            })(fields)
            hydra.lib.lists.concat[hydra.ext.lisp.syntax.Symbol](Seq(Seq(hydra.lib.strings.cat2("make-")(rname), hydra.lib.strings.cat2(rname)("?")), fieldSyms))
          }
        }
      }
      case _ => Seq()
...
def moduleToLisp[T0, T1, T2](dialect: hydra.ext.lisp.syntax.Dialect)(mod: hydra.module.Module)(defs0: Seq[hydra.module.Definition])(cx: T0)(g: T1): Either[T2, hydra.ext.lisp.syntax.Program] =
  {
  ...
  lazy val allTypeDefs: Seq[hydra.module.TypeDefinition] = hydra.lib.pairs.first[Seq[hydra.module.TypeDefinition], Seq[hydra.module.TermDefinition]](partitioned)
  ...
  hydra.lib.eithers.bind[T2, Seq[hydra.ext.lisp.syntax.TopLevelFormWithComments], hydra.ext.lisp.syntax.Program](hydra.lib.eithers.mapList[hydra.module.TypeDefinition, hydra.ext.lisp.syntax.TopLevelFormWithComments, T2]((v1: hydra.module.TypeDefinition) => hydra.ext.lisp.coder.encodeTypeDefinition(cx)(g)(v1))(typeDefs))((typeItems: Seq[hydra.ext.lisp.syntax.TopLevelFormWithComments]) =>
    hydra.lib.eithers.bind[T2, Seq[hydra.ext.lisp.syntax.TopLevelFormWithComments], hydra.ext.lisp.syntax.Program](hydra.lib.eithers.mapList[hydra.module.TermDefinition, hydra.ext.lisp.syntax.TopLevelFormWithComments, T2]((v1: hydra.module.TermDefinition) =>
