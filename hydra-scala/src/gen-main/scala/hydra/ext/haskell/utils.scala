...
def elementReference(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(name: hydra.core.Name): hydra.ext.haskell.syntax.Name =
  ...
  hydra.lib.maybes.cases[hydra.module.Namespace, hydra.ext.haskell.syntax.Name](qname.namespace)(hydra.ext.haskell.utils.simpleName(local))((ns: hydra.module.Namespace) =>
    hydra.lib.maybes.cases[hydra.ext.haskell.syntax.ModuleName, hydra.ext.haskell.syntax.Name](hydra.lib.maps.lookup[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName](ns)(namespacesMap))(hydra.ext.haskell.utils.simpleName(local))((mn: hydra.ext.haskell.syntax.ModuleName) =>
    {
    lazy val aliasStr: scala.Predef.String = mn
    hydra.lib.logic.ifElse[hydra.ext.haskell.syntax.Name](hydra.lib.equality.equal[hydra.module.Namespace](ns)(gname))(hydra.ext.haskell.utils.simpleName(escLocal))(hydra.ext.haskell.utils.rawName(hydra.lib.strings.cat(Seq(aliasStr, ".", hydra.ext.haskell.utils.sanitizeHaskellName(local)))))
  }))
}
...
def namespacesForModule(mod: hydra.module.Module)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error], hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName]] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], scala.collection.immutable.Set[hydra.module.Namespace], hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName]](hydra.schemas.moduleDependencyNamespaces(cx)(g)(true)(true)(true)(true)(mod))((nss: scala.collection.immutable.Set[hydra.module.Namespace]) =>
  {
  lazy val ns: hydra.module.Namespace = (mod.namespace)
  {
    ...
    }
    {
      ...
      {
        def addPair[T0](state: Tuple2[Map[T0, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]])(namePair: Tuple2[T0, hydra.ext.haskell.syntax.ModuleName]): Tuple2[Map[T0, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]] =
          {
          lazy val currentMap: Map[T0, hydra.ext.haskell.syntax.ModuleName] = hydra.lib.pairs.first[Map[T0, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]](state)
          lazy val currentSet: scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName] = hydra.lib.pairs.second[Map[T0, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]](state)
          ...
          hydra.lib.logic.ifElse[Tuple2[Map[T0, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]]](hydra.lib.sets.member[hydra.ext.haskell.syntax.ModuleName](alias)(currentSet))(addPair(state)(Tuple2(name, hydra.lib.strings.cat2(aliasStr)("_"))))(Tuple2(hydra.lib.maps.insert[T0, hydra.ext.haskell.syntax.ModuleName](name)(alias)(currentMap), hydra.lib.sets.insert[hydra.ext.haskell.syntax.ModuleName](alias)(currentSet)))
        }
        {
          lazy val focusPair: Tuple2[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName] = toPair(ns)
          {
            ...
            {
              lazy val nssPairs: Seq[Tuple2[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName]] = hydra.lib.lists.map[hydra.module.Namespace, Tuple2[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName]](toPair)(nssAsList)
              {
                ...
                {
                  lazy val finalState: Tuple2[Map[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]] = hydra.lib.lists.foldl[Tuple2[Map[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]], Tuple2[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName]](addPair)(emptyState)(nssPairs)
                  {
                    lazy val resultMap: Map[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName] = hydra.lib.pairs.first[Map[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName], scala.collection.immutable.Set[hydra.ext.haskell.syntax.ModuleName]](finalState)
...
def toTypeApplication(types: Seq[hydra.ext.haskell.syntax.Type]): hydra.ext.haskell.syntax.Type =
  ...
  def app(l: Seq[hydra.ext.haskell.syntax.Type]): hydra.ext.haskell.syntax.Type =
    hydra.lib.logic.ifElse[hydra.ext.haskell.syntax.Type](hydra.lib.equality.gt[Int](hydra.lib.lists.length[hydra.ext.haskell.syntax.Type](l))(1))(hydra.ext.haskell.syntax.Type.application(hydra.ext.haskell.syntax.ApplicationType(app(hydra.lib.lists.tail[hydra.ext.haskell.syntax.Type](l)), hydra.lib.lists.head[hydra.ext.haskell.syntax.Type](l))))(hydra.lib.lists.head[hydra.ext.haskell.syntax.Type](l))
