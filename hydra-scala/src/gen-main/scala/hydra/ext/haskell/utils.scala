...
def elementReference(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(name: hydra.core.Name): hydra.ext.haskell.syntax.Name =
  {
  lazy val namespacePair: Tuple2[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName] = (namespaces.focus)
  lazy val gname: hydra.packaging.Namespace = hydra.lib.pairs.first[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName](namespacePair)
  lazy val gmod: scala.Predef.String = hydra.lib.pairs.second[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName](namespacePair)
  lazy val namespacesMap: Map[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName] = (namespaces.mapping)
  ...
  hydra.lib.maybes.cases[hydra.packaging.Namespace, hydra.ext.haskell.syntax.Name](qname.namespace)(hydra.ext.haskell.utils.simpleName(local))((ns: hydra.packaging.Namespace) =>
    hydra.lib.maybes.cases[hydra.ext.haskell.syntax.ModuleName, hydra.ext.haskell.syntax.Name](hydra.lib.maps.lookup[hydra.packaging.Namespace,
    ...
    hydra.lib.logic.ifElse[hydra.ext.haskell.syntax.Name](hydra.lib.equality.equal[hydra.packaging.Namespace](ns)(gname))(hydra.ext.haskell.utils.simpleName(escLocal))(hydra.ext.haskell.utils.rawName(hydra.lib.strings.cat(Seq(aliasStr,
  ...
  lazy val ns: hydra.packaging.Namespace = (mod.namespace)
  {
    ...
    }
    {
      def toPair(name: hydra.packaging.Namespace): Tuple2[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName] = Tuple2(name, toModuleName(name))
      {
        ...
        {
          lazy val focusPair: Tuple2[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName] = toPair(ns)
          {
                 ...
                 Tuple2[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName]](toPair)(nssAsList)
              {
                   ...
                   T1], hydra.lib.sets.empty[T2])
                {
                  lazy val finalState: Tuple2[Map[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName],
                     ...
                     Tuple2[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName]](addPair)(emptyState)(nssPairs)
                  {
                    lazy val resultMap: Map[hydra.packaging.Namespace, hydra.ext.haskell.syntax.ModuleName] = hydra.lib.pairs.first[Map[hydra.packaging.Namespace,
...
def recordFieldReference(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(sname: hydra.core.Name)(fname: hydra.core.Name): hydra.ext.haskell.syntax.Name =
  {
...
def unionFieldReference(boundNames: scala.collection.immutable.Set[hydra.core.Name])(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(sname: hydra.core.Name)(fname: hydra.core.Name): hydra.ext.haskell.syntax.Name =
  {
  lazy val fnameStr: scala.Predef.String = fname
  lazy val qname: hydra.packaging.QualifiedName = hydra.names.qualifyName(sname)
  lazy val ns: Option[hydra.packaging.Namespace] = (qname.namespace)
