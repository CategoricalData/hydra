...
def applicationPatternToExpr(appPat: hydra.ext.haskell.ast.ApplicationPattern): hydra.ast.Expr =
  {
  lazy val name: hydra.ext.haskell.ast.Name = (appPat.name)
  lazy val pats: Seq[hydra.ext.haskell.ast.Pattern] = (appPat.args)
  hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern, hydra.ast.Expr](hydra.ext.haskell.serde.patternToExpr)(pats)))
}
...
def assertionToExpr(sert: hydra.ext.haskell.ast.Assertion): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Assertion.tuple(v_Assertion_tuple_serts) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Assertion, hydra.ast.Expr](hydra.ext.haskell.serde.assertionToExpr)(v_Assertion_tuple_serts))

def caseExpressionToExpr(caseExpr: hydra.ext.haskell.ast.CaseExpression): hydra.ast.Expr =
  {
  lazy val cs: hydra.ext.haskell.ast.Expression = (caseExpr.`case`)
  lazy val alts: Seq[hydra.ext.haskell.ast.Alternative] = (caseExpr.alternatives)
  ...
  lazy val rhs: hydra.ast.Expr = hydra.serialization.newlineSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Alternative, hydra.ast.Expr](hydra.ext.haskell.serde.alternativeToExpr)(alts))
...
def classAssertionToExpr(clsAsrt: hydra.ext.haskell.ast.ClassAssertion): hydra.ast.Expr =
  {
  lazy val name: hydra.ext.haskell.ast.Name = (clsAsrt.name)
  lazy val types: Seq[hydra.ext.haskell.ast.Type] = (clsAsrt.types)
  hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(Seq(hydra.serialization.commaSep(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.Type, hydra.ast.Expr](hydra.ext.haskell.serde.typeToExpr)(types)))))
}
...
def constructorToExpr(cons: hydra.ext.haskell.ast.Constructor): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Constructor.ordinary(v_Constructor_ordinary_ord) => {
    lazy val name: hydra.ext.haskell.ast.Name = (v_Constructor_ordinary_ord.name)
    lazy val types: Seq[hydra.ext.haskell.ast.Type] = (v_Constructor_ordinary_ord.fields)
    hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(Seq(hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Type, hydra.ast.Expr](hydra.ext.haskell.serde.typeToExpr)(types)))))
  }
  case hydra.ext.haskell.ast.Constructor.record(v_Constructor_record_rec) => {
    lazy val name: hydra.ext.haskell.ast.Name = (v_Constructor_record_rec.name)
    lazy val fields: Seq[hydra.ext.haskell.ast.FieldWithComments] = (v_Constructor_record_rec.fields)
    hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(Seq(hydra.serialization.curlyBracesList(None)(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.FieldWithComments, hydra.ast.Expr](hydra.ext.haskell.serde.fieldWithCommentsToExpr)(fields)))))
  }

def constructorWithCommentsToExpr(consWithComments: hydra.ext.haskell.ast.ConstructorWithComments): hydra.ast.Expr =
  {
  lazy val body: hydra.ext.haskell.ast.Constructor = (consWithComments.body)
...
def declarationHeadToExpr(hd: hydra.ext.haskell.ast.DeclarationHead): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.DeclarationHead.application(v_DeclarationHead_application_appHead) => {
    lazy val fun: hydra.ext.haskell.ast.DeclarationHead = (v_DeclarationHead_application_appHead.function)
    lazy val op: hydra.ext.haskell.ast.Variable = (v_DeclarationHead_application_appHead.operand)
...
def declarationToExpr(decl: hydra.ext.haskell.ast.Declaration): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Declaration.data(v_Declaration_data_dataDecl) => {
    lazy val kw: hydra.ext.haskell.ast.DataOrNewtype = (v_Declaration_data_dataDecl.keyword)
    lazy val hd: hydra.ext.haskell.ast.DeclarationHead = (v_Declaration_data_dataDecl.head)
    lazy val cons: Seq[hydra.ext.haskell.ast.ConstructorWithComments] = (v_Declaration_data_dataDecl.constructors)
    lazy val deriv: Seq[hydra.ext.haskell.ast.Deriving] = (v_Declaration_data_dataDecl.deriving)
    lazy val derivCat: Seq[hydra.ext.haskell.ast.Name] = hydra.lib.lists.concat[hydra.ext.haskell.ast.Name](hydra.lib.lists.map[hydra.ext.haskell.ast.Deriving, Seq[hydra.ext.haskell.ast.Name]]((x) => x)(deriv))
    lazy val constructors: hydra.ast.Expr = hydra.serialization.orSep(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.ConstructorWithComments, hydra.ast.Expr](hydra.ext.haskell.serde.constructorWithCommentsToExpr)(cons))
    lazy val derivingClause: Seq[hydra.ast.Expr] = hydra.lib.logic.ifElse[Seq[hydra.ast.Expr]](hydra.lib.lists.`null`[hydra.ext.haskell.ast.Name](derivCat))(Seq())(Seq(hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("deriving"))(Seq(hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Name, hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr)(derivCat)))))))
  ...
  case hydra.ext.haskell.ast.Declaration.`type`(v_Declaration_type_typeDecl) => {
    lazy val hd: hydra.ext.haskell.ast.DeclarationHead = (v_Declaration_type_typeDecl.name)
    lazy val typ: hydra.ext.haskell.ast.Type = (v_Declaration_type_typeDecl.`type`)
  ...
  case hydra.ext.haskell.ast.Declaration.typedBinding(v_Declaration_typedBinding_typedBinding) => {
    lazy val typeSig: hydra.ext.haskell.ast.TypeSignature = (v_Declaration_typedBinding_typedBinding.typeSignature)
    lazy val vb: hydra.ext.haskell.ast.ValueBinding = (v_Declaration_typedBinding_typedBinding.valueBinding)
    lazy val name: hydra.ext.haskell.ast.Name = (typeSig.name)
    lazy val htype: hydra.ext.haskell.ast.Type = (typeSig.`type`)
...
def declarationWithCommentsToExpr(declWithComments: hydra.ext.haskell.ast.DeclarationWithComments): hydra.ast.Expr =
  {
  lazy val body: hydra.ext.haskell.ast.Declaration = (declWithComments.body)
...
def expressionToExpr(expr: hydra.ext.haskell.ast.Expression): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Expression.`do`(v_Expression_do_statements) => hydra.serialization.indentBlock(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("do"))(hydra.lib.lists.map[hydra.ext.haskell.ast.Statement, hydra.ast.Expr](hydra.ext.haskell.serde.statementToExpr)(v_Expression_do_statements)))
  ...
  case hydra.ext.haskell.ast.Expression.let(v_Expression_let_letExpr) => {
    lazy val bindings: Seq[hydra.ext.haskell.ast.LocalBinding] = (v_Expression_let_letExpr.bindings)
    lazy val inner: hydra.ext.haskell.ast.Expression = (v_Expression_let_letExpr.inner)
    ...
    hydra.serialization.indentBlock(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst(""))(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("let"))(Seq(hydra.serialization.customIndentBlock("    ")(hydra.lib.lists.map[hydra.ext.haskell.ast.LocalBinding, hydra.ast.Expr](encodeBinding)(bindings))))))(Seq(hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("in"))(Seq(hydra.ext.haskell.serde.expressionToExpr(inner))))))))
  }
  case hydra.ext.haskell.ast.Expression.list(v_Expression_list_exprs) => hydra.serialization.bracketList(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.Expression, hydra.ast.Expr](hydra.ext.haskell.serde.expressionToExpr)(v_Expression_list_exprs))
  ...
  case hydra.ext.haskell.ast.Expression.tuple(v_Expression_tuple_exprs) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Expression, hydra.ast.Expr](hydra.ext.haskell.serde.expressionToExpr)(v_Expression_tuple_exprs))
...
def constructRecordExpressionToExpr(constructRecord: hydra.ext.haskell.ast.ConstructRecordExpression): hydra.ast.Expr =
  {
  lazy val name: hydra.ext.haskell.ast.Name = (constructRecord.name)
  lazy val updates: Seq[hydra.ext.haskell.ast.FieldUpdate] = (constructRecord.fields)
  def fromUpdate(update: hydra.ext.haskell.ast.FieldUpdate): hydra.ast.Expr =
    {
    lazy val fn: hydra.ext.haskell.ast.Name = (update.name)
    lazy val `val`: hydra.ext.haskell.ast.Expression = (update.value)
  ...
  lazy val body: hydra.ast.Expr = hydra.serialization.commaSep(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.FieldUpdate, hydra.ast.Expr](fromUpdate)(updates))
...
def fieldToExpr(field: hydra.ext.haskell.ast.Field): hydra.ast.Expr =
  {
  lazy val name: hydra.ext.haskell.ast.Name = (field.name)
  lazy val typ: hydra.ext.haskell.ast.Type = (field.`type`)
...
def fieldWithCommentsToExpr(fieldWithComments: hydra.ext.haskell.ast.FieldWithComments): hydra.ast.Expr =
  {
  lazy val field: hydra.ext.haskell.ast.Field = (fieldWithComments.field)
...
def ifExpressionToExpr(ifExpr: hydra.ext.haskell.ast.IfExpression): hydra.ast.Expr =
  {
  lazy val eif: hydra.ext.haskell.ast.Expression = (ifExpr.condition)
  lazy val ethen: hydra.ext.haskell.ast.Expression = (ifExpr.`then`)
  lazy val eelse: hydra.ext.haskell.ast.Expression = (ifExpr.`else`)
...
def importToExpr(`import`: hydra.ext.haskell.ast.Import): hydra.ast.Expr =
  ...
  lazy val modName: hydra.ext.haskell.ast.ModuleName = (`import`.module)
  lazy val mod: Option[hydra.ext.haskell.ast.ModuleName] = (`import`.as)
  lazy val mspec: Option[hydra.ext.haskell.ast.SpecImport] = (`import`.spec)
  lazy val name: scala.Predef.String = modName
  def hidingSec(spec: hydra.ext.haskell.ast.SpecImport): hydra.ast.Expr =
    spec match
    case hydra.ext.haskell.ast.SpecImport.hiding(v_SpecImport_hiding_names) => hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("hiding "))(Seq(hydra.serialization.parens(hydra.serialization.commaSep(hydra.serialization.inlineStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.ImportExportSpec, hydra.ast.Expr](hydra.ext.haskell.serde.importExportSpecToExpr)(v_SpecImport_hiding_names))))))
  lazy val parts: Seq[hydra.ast.Expr] = hydra.lib.maybes.cat[hydra.ast.Expr](Seq(Some(hydra.serialization.cst("import")), hydra.lib.logic.ifElse[Option[hydra.ast.Expr]](qual)(Some(hydra.serialization.cst("qualified")))(None), Some(hydra.serialization.cst(name)), hydra.lib.maybes.map[hydra.ext.haskell.ast.ModuleName, hydra.ast.Expr]((m: hydra.ext.haskell.ast.ModuleName) => hydra.serialization.cst(hydra.lib.strings.cat2("as ")(m)))(mod), hydra.lib.maybes.map[hydra.ext.haskell.ast.SpecImport, hydra.ast.Expr](hidingSec)(mspec)))
...
def lambdaExpressionToExpr(lambdaExpr: hydra.ext.haskell.ast.LambdaExpression): hydra.ast.Expr =
  {
  lazy val bindings: Seq[hydra.ext.haskell.ast.Pattern] = (lambdaExpr.bindings)
  lazy val inner: hydra.ext.haskell.ast.Expression = (lambdaExpr.inner)
  lazy val head: hydra.ast.Expr = hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern, hydra.ast.Expr](hydra.ext.haskell.serde.patternToExpr)(bindings))
...
def literalToExpr(lit: hydra.ext.haskell.ast.Literal): hydra.ast.Expr =
  ...
  hydra.serialization.cst(lit match
    case hydra.ext.haskell.ast.Literal.char(v_Literal_char_c) => hydra.lib.literals.showString(hydra.lib.literals.showUint16(v_Literal_char_c))
    case hydra.ext.haskell.ast.Literal.double(v_Literal_double_d) => parensIfNeg(hydra.lib.equality.lt[Double](v_Literal_double_d)(0.0))(hydra.lib.literals.showFloat64(v_Literal_double_d))
    case hydra.ext.haskell.ast.Literal.float(v_Literal_float_f) => parensIfNeg(hydra.lib.equality.lt[Float](v_Literal_float_f)(0.0f))(hydra.lib.literals.showFloat32(v_Literal_float_f))
    case hydra.ext.haskell.ast.Literal.int(v_Literal_int_i) => parensIfNeg(hydra.lib.equality.lt[Int](v_Literal_int_i)(0))(hydra.lib.literals.showInt32(v_Literal_int_i))
    case hydra.ext.haskell.ast.Literal.integer(v_Literal_integer_i) => parensIfNeg(hydra.lib.equality.lt[BigInt](v_Literal_integer_i)(BigInt(0L)))(hydra.lib.literals.showBigint(v_Literal_integer_i))
    case hydra.ext.haskell.ast.Literal.string(v_Literal_string_s) => hydra.lib.literals.showString(v_Literal_string_s))
}
...
def moduleHeadToExpr(moduleHead: hydra.ext.haskell.ast.ModuleHead): hydra.ast.Expr =
  ...
  lazy val modName: hydra.ext.haskell.ast.ModuleName = (moduleHead.name)
...
def moduleToExpr(module: hydra.ext.haskell.ast.Module): hydra.ast.Expr =
  {
  lazy val mh: Option[hydra.ext.haskell.ast.ModuleHead] = (module.head)
  lazy val imports: Seq[hydra.ext.haskell.ast.Import] = (module.imports)
  lazy val decls: Seq[hydra.ext.haskell.ast.DeclarationWithComments] = (module.declarations)
  ...
  lazy val headerLine: Seq[hydra.ast.Expr] = hydra.lib.maybes.maybe[Seq[hydra.ast.Expr], hydra.ext.haskell.ast.ModuleHead](Seq())((h: hydra.ext.haskell.ast.ModuleHead) => Seq(hydra.ext.haskell.serde.moduleHeadToExpr(h)))(mh)
  lazy val declLines: Seq[hydra.ast.Expr] = hydra.lib.lists.map[hydra.ext.haskell.ast.DeclarationWithComments, hydra.ast.Expr](hydra.ext.haskell.serde.declarationWithCommentsToExpr)(decls)
  lazy val importLines: Seq[hydra.ast.Expr] = hydra.lib.logic.ifElse[Seq[hydra.ast.Expr]](hydra.lib.lists.`null`[hydra.ext.haskell.ast.Import](imports))(Seq())(Seq(hydra.serialization.newlineSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Import, hydra.ast.Expr](hydra.ext.haskell.serde.importToExpr)(imports))))
...
def nameToExpr(name: hydra.ext.haskell.ast.Name): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Name.`implicit`(v_Name_implicit_qn) => hydra.lib.strings.cat2("?")(hydra.ext.haskell.serde.writeQualifiedName(v_Name_implicit_qn))
  case hydra.ext.haskell.ast.Name.normal(v_Name_normal_qn) => hydra.ext.haskell.serde.writeQualifiedName(v_Name_normal_qn)
  case hydra.ext.haskell.ast.Name.parens(v_Name_parens_qn) => hydra.lib.strings.cat(Seq("(", hydra.ext.haskell.serde.writeQualifiedName(v_Name_parens_qn), ")")))
...
def patternToExpr(pat: hydra.ext.haskell.ast.Pattern): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Pattern.list(v_Pattern_list_pats) => hydra.serialization.bracketList(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern, hydra.ast.Expr](hydra.ext.haskell.serde.patternToExpr)(v_Pattern_list_pats))
  ...
  case hydra.ext.haskell.ast.Pattern.tuple(v_Pattern_tuple_pats) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern, hydra.ast.Expr](hydra.ext.haskell.serde.patternToExpr)(v_Pattern_tuple_pats))
...
def typeSignatureToExpr(typeSig: hydra.ext.haskell.ast.TypeSignature): hydra.ast.Expr =
  {
  lazy val name: hydra.ext.haskell.ast.Name = (typeSig.name)
  lazy val typ: hydra.ext.haskell.ast.Type = (typeSig.`type`)
...
def typeToExpr(htype: hydra.ext.haskell.ast.Type): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Type.application(v_Type_application_appType) => {
    lazy val lhs: hydra.ext.haskell.ast.Type = (v_Type_application_appType.context)
    lazy val rhs: hydra.ext.haskell.ast.Type = (v_Type_application_appType.argument)
  ...
  case hydra.ext.haskell.ast.Type.ctx(v_Type_ctx_ctxType) => {
    lazy val ctx: hydra.ext.haskell.ast.Assertion = (v_Type_ctx_ctxType.ctx)
    lazy val typ: hydra.ext.haskell.ast.Type = (v_Type_ctx_ctxType.`type`)
  ...
  case hydra.ext.haskell.ast.Type.function(v_Type_function_funType) => {
    lazy val dom: hydra.ext.haskell.ast.Type = (v_Type_function_funType.domain)
    lazy val cod: hydra.ext.haskell.ast.Type = (v_Type_function_funType.codomain)
  ...
  case hydra.ext.haskell.ast.Type.tuple(v_Type_tuple_types) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Type, hydra.ast.Expr](hydra.ext.haskell.serde.typeToExpr)(v_Type_tuple_types))
...
def valueBindingToExpr(vb: hydra.ext.haskell.ast.ValueBinding): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.ValueBinding.simple(v_ValueBinding_simple_simpleVB) => {
    lazy val pat: hydra.ext.haskell.ast.Pattern = (v_ValueBinding_simple_simpleVB.pattern)
    lazy val rhs: hydra.ext.haskell.ast.RightHandSide = (v_ValueBinding_simple_simpleVB.rhs)
    lazy val local: Option[hydra.ext.haskell.ast.LocalBindings] = (v_ValueBinding_simple_simpleVB.localBindings)
    ...
    hydra.lib.maybes.maybe[hydra.ast.Expr, hydra.ext.haskell.ast.LocalBindings](body)((localBindings: hydra.ext.haskell.ast.LocalBindings) =>
      {
      lazy val bindings: Seq[hydra.ext.haskell.ast.LocalBinding] = localBindings
      hydra.serialization.indentBlock(hydra.lib.lists.cons[hydra.ast.Expr](body)(Seq(hydra.serialization.indentBlock(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("where"))(hydra.lib.lists.map[hydra.ext.haskell.ast.LocalBinding, hydra.ast.Expr](hydra.ext.haskell.serde.localBindingToExpr)(bindings))))))
    })(local)
  }
...
def writeQualifiedName(qname: hydra.ext.haskell.ast.QualifiedName): scala.Predef.String =
  {
  lazy val qualifiers: Seq[hydra.ext.haskell.ast.NamePart] = (qname.qualifiers)
  lazy val unqual: hydra.ext.haskell.ast.NamePart = (qname.unqualified)
  def h(namePart: hydra.ext.haskell.ast.NamePart): scala.Predef.String = namePart
  lazy val allParts: Seq[scala.Predef.String] = hydra.lib.lists.concat2[scala.Predef.String](hydra.lib.lists.map[hydra.ext.haskell.ast.NamePart, scala.Predef.String](h)(qualifiers))(Seq(h(unqual)))
