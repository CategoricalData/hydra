...
def applicationPatternToExpr(appPat: hydra.ext.haskell.ast.ApplicationPattern): hydra.ast.Expr =
  ...
  hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern,
...
def assertionToExpr(sert: hydra.ext.haskell.ast.Assertion): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Assertion.tuple(v_Assertion_tuple_serts) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Assertion,
...
def caseExpressionToExpr(caseExpr: hydra.ext.haskell.ast.CaseExpression): hydra.ast.Expr =
  ...
  val rhs: hydra.ast.Expr = hydra.serialization.newlineSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Alternative,
...
def classAssertionToExpr(clsAsrt: hydra.ext.haskell.ast.ClassAssertion): hydra.ast.Expr =
  ...
  hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(Seq(hydra.serialization.commaSep(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.Type,
...
def constructorToExpr(cons: hydra.ext.haskell.ast.Constructor): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Constructor.ordinary(v_Constructor_ordinary_ord) => {
    ...
    hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(Seq(hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Type,
       hydra.ast.Expr](hydra.ext.haskell.serde.typeToExpr)(types)))))
  }
  case hydra.ext.haskell.ast.Constructor.record(v_Constructor_record_rec) => {
    ...
    hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.ext.haskell.serde.nameToExpr(name))(Seq(hydra.serialization.curlyBracesList(None)(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.FieldWithComments,
...
def declarationToExpr(decl: hydra.ext.haskell.ast.Declaration): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Declaration.data(v_Declaration_data_dataDecl) => {
    ...
    val derivCat: Seq[hydra.ext.haskell.ast.Name] = hydra.lib.lists.concat[hydra.ext.haskell.ast.Name](hydra.lib.lists.map[hydra.ext.haskell.ast.Deriving,
       Seq[hydra.ext.haskell.ast.Name]]((x) => x)(deriv))
    val constructors: hydra.ast.Expr = hydra.serialization.orSep(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.ConstructorWithComments,
       hydra.ast.Expr](hydra.ext.haskell.serde.constructorWithCommentsToExpr)(cons))
    val derivingClause: Seq[hydra.ast.Expr] = hydra.lib.logic.ifElse[Seq[hydra.ast.Expr]](hydra.lib.lists.`null`[hydra.ext.haskell.ast.Name](derivCat))(Seq())(Seq(hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("deriving"))(Seq(hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Name,
...
def expressionToExpr(expr: hydra.ext.haskell.ast.Expression): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Expression.`do`(v_Expression_do_statements) => hydra.serialization.indentBlock(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("do"))(hydra.lib.lists.map[hydra.ext.haskell.ast.Statement,
  ...
  case hydra.ext.haskell.ast.Expression.list(v_Expression_list_exprs) => hydra.serialization.bracketList(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.Expression,
  ...
  case hydra.ext.haskell.ast.Expression.tuple(v_Expression_tuple_exprs) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Expression,
...
def constructRecordExpressionToExpr(constructRecord: hydra.ext.haskell.ast.ConstructRecordExpression): hydra.ast.Expr =
  ...
  val body: hydra.ast.Expr = hydra.serialization.commaSep(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.FieldUpdate,
...
def importToExpr(`import`: hydra.ext.haskell.ast.Import): hydra.ast.Expr =
  ...
  def hidingSec(spec: hydra.ext.haskell.ast.SpecImport): hydra.ast.Expr =
    spec match
    case hydra.ext.haskell.ast.SpecImport.hiding(v_SpecImport_hiding_names) => hydra.serialization.spaceSep(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("hiding "))(Seq(hydra.serialization.parens(hydra.serialization.commaSep(hydra.serialization.inlineStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.ImportExportSpec,
  ...
  val parts: Seq[hydra.ast.Expr] = hydra.lib.maybes.cat[hydra.ast.Expr](Seq(Some(hydra.serialization.cst("import")),
     ...
     Some(hydra.serialization.cst(name)), hydra.lib.maybes.map[hydra.ext.haskell.ast.ModuleName, hydra.ast.Expr]((m: hydra.ext.haskell.ast.ModuleName) => hydra.serialization.cst(hydra.lib.strings.cat2("as ")(m)))(mod),
     hydra.lib.maybes.map[hydra.ext.haskell.ast.SpecImport, hydra.ast.Expr](hidingSec)(mspec)))
...
def lambdaExpressionToExpr(lambdaExpr: hydra.ext.haskell.ast.LambdaExpression): hydra.ast.Expr =
  ...
  val head: hydra.ast.Expr = hydra.serialization.spaceSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern,
...
def moduleToExpr(module: hydra.ext.haskell.ast.Module): hydra.ast.Expr =
  ...
  val headerLine: Seq[hydra.ast.Expr] = hydra.lib.maybes.maybe[Seq[hydra.ast.Expr], hydra.ext.haskell.ast.ModuleHead](Seq())((h: hydra.ext.haskell.ast.ModuleHead) => Seq(hydra.ext.haskell.serde.moduleHeadToExpr(h)))(mh)
  val declLines: Seq[hydra.ast.Expr] = hydra.lib.lists.map[hydra.ext.haskell.ast.DeclarationWithComments,
     hydra.ast.Expr](hydra.ext.haskell.serde.declarationWithCommentsToExpr)(decls)
  val importLines: Seq[hydra.ast.Expr] = hydra.lib.logic.ifElse[Seq[hydra.ast.Expr]](hydra.lib.lists.`null`[hydra.ext.haskell.ast.Import](imports))(Seq())(Seq(hydra.serialization.newlineSep(hydra.lib.lists.map[hydra.ext.haskell.ast.Import,
...
def patternToExpr(pat: hydra.ext.haskell.ast.Pattern): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Pattern.list(v_Pattern_list_pats) => hydra.serialization.bracketList(hydra.serialization.halfBlockStyle)(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern,
  ...
  case hydra.ext.haskell.ast.Pattern.tuple(v_Pattern_tuple_pats) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Pattern,
...
def typeToExpr(htype: hydra.ext.haskell.ast.Type): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.Type.tuple(v_Type_tuple_types) => hydra.serialization.parenList(false)(hydra.lib.lists.map[hydra.ext.haskell.ast.Type,
...
def valueBindingToExpr(vb: hydra.ext.haskell.ast.ValueBinding): hydra.ast.Expr =
  ...
  case hydra.ext.haskell.ast.ValueBinding.simple(v_ValueBinding_simple_simpleVB) => {
    ...
    hydra.lib.maybes.maybe[hydra.ast.Expr, hydra.ext.haskell.ast.LocalBindings](body)((localBindings: hydra.ext.haskell.ast.LocalBindings) =>
      ...
      hydra.serialization.indentBlock(hydra.lib.lists.cons[hydra.ast.Expr](body)(Seq(hydra.serialization.indentBlock(hydra.lib.lists.cons[hydra.ast.Expr](hydra.serialization.cst("where"))(hydra.lib.lists.map[hydra.ext.haskell.ast.LocalBinding,
...
def writeQualifiedName(qname: hydra.ext.haskell.ast.QualifiedName): scala.Predef.String =
  ...
  val allParts: Seq[scala.Predef.String] = hydra.lib.lists.concat2[scala.Predef.String](hydra.lib.lists.map[hydra.ext.haskell.ast.NamePart,
