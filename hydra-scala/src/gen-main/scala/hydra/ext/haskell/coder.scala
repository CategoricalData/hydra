...
def adaptTypeToHaskellAndEncode[T0](namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(typ: hydra.core.Type)(cx: hydra.context.Context)(g: T0): Either[hydra.context.InContext[hydra.error.Error],
  ...
  hydra.rewriting.deannotateType(typ) match
    ...
    case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Type, hydra.ext.haskell.ast.Type](hydra.lib.eithers.bimap[scala.Predef.String,
...
def constructModule(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(mod: hydra.module.Module)(defs: Seq[hydra.module.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
  ...
  def createDeclarations(`def`: hydra.module.Definition): Either[hydra.context.InContext[hydra.error.Error],
    ...
    case hydra.module.Definition.term(v_Definition_term_term) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
  ...
  val imports: Seq[hydra.ext.haskell.ast.Import] = hydra.lib.lists.concat2[hydra.ext.haskell.ast.Import](domainImports)(standardImports)
  val domainImports: Seq[hydra.ext.haskell.ast.Import] = {
    def toImport(pair: Tuple2[hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName]): hydra.ext.haskell.ast.Import =
      {
      val namespace: hydra.module.Namespace = hydra.lib.pairs.first[hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName](pair)
      val alias: hydra.ext.haskell.ast.ModuleName = hydra.lib.pairs.second[hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName](pair)
      val name: scala.Predef.String = h(namespace)
      hydra.ext.haskell.ast.Import(true, importName(name), Some(alias), None)
    }
    hydra.lib.lists.map[Tuple2[hydra.module.Namespace, hydra.ext.haskell.ast.ModuleName], hydra.ext.haskell.ast.Import](toImport)(hydra.lib.maps.toList[hydra.module.Namespace,
  ...
  val standardImports: Seq[hydra.ext.haskell.ast.Import] = {
    def toImport(triple: Tuple2[Tuple2[scala.Predef.String, Option[scala.Predef.String]], Seq[scala.Predef.String]]): hydra.ext.haskell.ast.Import =
      ...
      val spec: Option[hydra.ext.haskell.ast.SpecImport] = hydra.lib.logic.ifElse[Option[hydra.ext.haskell.ast.SpecImport]](hydra.lib.lists.`null`[scala.Predef.String](hidden))(None)(Some(hydra.ext.haskell.ast.SpecImport.hiding(hydra.lib.lists.map[scala.Predef.String,
      ...
      hydra.ext.haskell.ast.Import(hydra.lib.maybes.isJust[scala.Predef.String](malias), name, hydra.lib.maybes.map[scala.Predef.String,
    ...
    hydra.lib.lists.map[Tuple2[Tuple2[scala.Predef.String, Option[scala.Predef.String]], Seq[scala.Predef.String]],
       hydra.ext.haskell.ast.Import](toImport)(hydra.lib.lists.concat2[Tuple2[Tuple2[scala.Predef.String,
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[Seq[hydra.ext.haskell.ast.DeclarationWithComments]],
    ...
    {
    val decls: Seq[hydra.ext.haskell.ast.DeclarationWithComments] = hydra.lib.lists.concat[hydra.ext.haskell.ast.DeclarationWithComments](declLists)
...
def encodeCaseExpression(depth: Int)(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(stmt: hydra.core.CaseStatement)(scrutinee: hydra.ext.haskell.ast.Expression)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
  ...
  def toAlt(fieldMap: Map[hydra.core.Name, hydra.core.FieldType])(field: hydra.core.Field): Either[hydra.context.InContext[hydra.error.Error],
    ...
    val hname: hydra.ext.haskell.ast.Name = hydra.ext.haskell.utils.unionFieldReference(hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.maps.keys[hydra.core.Name,
       hydra.core.Term](g.boundTerms)))(namespaces)(dn)(fn)
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.Pattern],
       hydra.ext.haskell.ast.Alternative](hydra.lib.maybes.cases[hydra.core.FieldType, Either[hydra.context.InContext[hydra.error.Error],
       Seq[hydra.ext.haskell.ast.Pattern]]](hydra.lib.maps.lookup[hydra.core.Name, hydra.core.FieldType](fn)(fieldMap))(Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat(Seq("field ",
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.CaseRhs,
         hydra.ext.haskell.ast.Alternative](hydra.lib.eithers.map[hydra.ext.haskell.ast.Expression, hydra.ext.haskell.ast.CaseRhs,
         hydra.context.InContext[hydra.error.Error]]((x: hydra.ext.haskell.ast.Expression) => x)(hydra.ext.haskell.coder.encodeTerm(hydra.lib.math.add(depth)(1))(namespaces)(rhsTerm)(cx)(g)))((rhs: hydra.ext.haskell.ast.CaseRhs) => Right(hydra.ext.haskell.ast.Alternative(lhs,
         rhs, None)))
    })
  }
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.core.FieldType], hydra.ext.haskell.ast.Expression](hydra.schemas.requireUnionType(cx)(g)(dn))((rt: Seq[hydra.core.FieldType]) =>
    {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.Alternative],
       hydra.ext.haskell.ast.Expression](hydra.lib.eithers.mapList[hydra.core.Field, hydra.ext.haskell.ast.Alternative,
       hydra.context.InContext[hydra.error.Error]]((v1: hydra.core.Field) => toAlt(fieldMap)(v1))(fields))((ecases: Seq[hydra.ext.haskell.ast.Alternative]) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.Alternative],
         hydra.ext.haskell.ast.Expression](hydra.lib.maybes.cases[hydra.core.Term, Either[hydra.context.InContext[hydra.error.Error],
         Seq[hydra.ext.haskell.ast.Alternative]]](`def`)(Right(Seq()))((d: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.CaseRhs,
         Seq[hydra.ext.haskell.ast.Alternative]](hydra.lib.eithers.map[hydra.ext.haskell.ast.Expression,
...
def encodeFunction(depth: Int)(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(fun: hydra.core.Function)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
  ...
  case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
    ...
    case hydra.core.Elimination.union(v_Elimination_union_stmt) => hydra.lib.eithers.map[hydra.ext.haskell.ast.Expression,
  ...
  case hydra.core.Function.lambda(v_Function_lambda_lam) => {
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
       hydra.ext.haskell.ast.Expression](hydra.ext.haskell.coder.encodeTerm(depth)(namespaces)(body)(cx)(g))((hbody: hydra.ext.haskell.ast.Expression) =>
...
def encodeLiteral(l: hydra.core.Literal)(cx: hydra.context.Context): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression] =
  ...
  case _ => Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat2("literal value ")(hydra.show.core.literal(l))), cx))
...
def encodeTerm(depth: Int)(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(term: hydra.core.Term)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
  ...
  def nonemptyMap(m: Map[hydra.core.Term, hydra.core.Term]): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression] =
    ...
    def encodePair(pair: Tuple2[hydra.core.Term, hydra.core.Term]): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression] =
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
         hydra.ext.haskell.ast.Expression](encode(k))((hk: hydra.ext.haskell.ast.Expression) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
           hydra.ext.haskell.ast.Expression](encode(v))((hv: hydra.ext.haskell.ast.Expression) => Right(hydra.ext.haskell.ast.Expression.tuple(Seq(hk,
           hv)))))
    }
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
       hydra.ext.haskell.ast.Expression](hydra.lib.eithers.map[Seq[hydra.ext.haskell.ast.Expression],
       hydra.ext.haskell.ast.Expression, hydra.context.InContext[hydra.error.Error]]((x: Seq[hydra.ext.haskell.ast.Expression]) => hydra.ext.haskell.ast.Expression.list(x))(hydra.lib.eithers.mapList[Tuple2[hydra.core.Term,
       hydra.core.Term], hydra.ext.haskell.ast.Expression, hydra.context.InContext[hydra.error.Error]](encodePair)(hydra.lib.maps.toList[hydra.core.Term,
  ...
  def nonemptySet(s: scala.collection.immutable.Set[hydra.core.Term]): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression] =
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
       hydra.ext.haskell.ast.Expression](hydra.ext.haskell.coder.encodeTerm(depth)(namespaces)(hydra.core.Term.list(hydra.lib.sets.toList[hydra.core.Term](s)))(cx)(g))((rhs: hydra.ext.haskell.ast.Expression) => Right(hydra.ext.haskell.utils.hsapp(lhs)(rhs)))
  }
  hydra.rewriting.deannotateTerm(term) match
    case hydra.core.Term.application(v_Term_application_app) => {
      ...
      deannotatedFun match
        case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
          case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
            case hydra.core.Elimination.union(v_Elimination_union_stmt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
            ...
            case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
    ...
    case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
       Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression]]((l: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
         hydra.ext.haskell.ast.Expression](encode(l))((hl: hydra.ext.haskell.ast.Expression) =>
      Right(hydra.ext.haskell.utils.hsapp(hydra.ext.haskell.utils.hsvar("Left"))(hl))))((r: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
         hydra.ext.haskell.ast.Expression](encode(r))((hr: hydra.ext.haskell.ast.Expression) =>
    ...
    case hydra.core.Term.let(v_Term_let_letTerm) => {
      ...
      def encodeBinding(binding: hydra.core.Binding): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.LocalBinding] =
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
           hydra.ext.haskell.ast.LocalBinding](encode(`term_`))((hexpr: hydra.ext.haskell.ast.Expression) =>
          Right(hydra.ext.haskell.ast.LocalBinding.value(hydra.ext.haskell.utils.simpleValueBinding(hname)(hexpr)(None))))
      }
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.LocalBinding],
         hydra.ext.haskell.ast.Expression](hydra.lib.eithers.mapList[hydra.core.Binding, hydra.ext.haskell.ast.LocalBinding,
         hydra.context.InContext[hydra.error.Error]](encodeBinding)(allBindings))((hbindings: Seq[hydra.ext.haskell.ast.LocalBinding]) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
           hydra.ext.haskell.ast.Expression](encode(finalBody))((hinner: hydra.ext.haskell.ast.Expression) =>
        Right(hydra.ext.haskell.ast.Expression.let(hydra.ext.haskell.ast.LetExpression(hbindings, hinner)))))
    }
    case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
       Seq[hydra.ext.haskell.ast.Expression], hydra.ext.haskell.ast.Expression](hydra.lib.eithers.mapList[hydra.core.Term,
    ...
    case hydra.core.Term.map(v_Term_map_m) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error],
       hydra.ext.haskell.ast.Expression]](hydra.lib.maps.`null`[hydra.core.Term, hydra.core.Term](v_Term_map_m))(Right(hydra.ext.haskell.utils.hsvar("M.empty")))(nonemptyMap(v_Term_map_m))
    case hydra.core.Term.maybe(v_Term_maybe_m) => hydra.lib.maybes.cases[hydra.core.Term, Either[hydra.context.InContext[hydra.error.Error],
       hydra.ext.haskell.ast.Expression]](v_Term_maybe_m)(Right(hydra.ext.haskell.utils.hsvar("Nothing")))((t: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
         hydra.ext.haskell.ast.Expression](encode(t))((ht: hydra.ext.haskell.ast.Expression) =>
    ...
    case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
       hydra.ext.haskell.ast.Expression, hydra.ext.haskell.ast.Expression](encode(hydra.lib.pairs.first[hydra.core.Term,
       hydra.core.Term](v_Term_pair_p)))((f: hydra.ext.haskell.ast.Expression) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
         hydra.ext.haskell.ast.Expression](encode(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((s: hydra.ext.haskell.ast.Expression) => Right(hydra.ext.haskell.ast.Expression.tuple(Seq(f,
         s)))))
    case hydra.core.Term.record(v_Term_record_record) => {
      ...
      def toFieldUpdate(field: hydra.core.Field): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.FieldUpdate] =
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
           hydra.ext.haskell.ast.FieldUpdate](encode(ft))((hft: hydra.ext.haskell.ast.Expression) => Right(hydra.ext.haskell.ast.FieldUpdate(fieldRef,
           hft)))
      }
      val typeName: hydra.ext.haskell.ast.Name = hydra.ext.haskell.utils.elementReference(namespaces)(sname)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.FieldUpdate],
    ...
    case hydra.core.Term.set(v_Term_set_s) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error],
       hydra.ext.haskell.ast.Expression]](hydra.lib.sets.`null`[hydra.core.Term](v_Term_set_s))(Right(hydra.ext.haskell.utils.hsvar("S.empty")))(nonemptySet(v_Term_set_s))
    ...
    case hydra.core.Term.union(v_Term_union_injection) => {
      ...
      val fn: hydra.core.Name = (field.name)
      val ft: hydra.core.Term = (field.term)
      val lhs: hydra.ext.haskell.ast.Expression = hydra.ext.haskell.ast.Expression.variable(hydra.ext.haskell.utils.unionFieldReference(hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.maps.keys[hydra.core.Name,
         hydra.core.Term](g.boundTerms)))(namespaces)(sname)(fn))
      val dflt: Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression] = hydra.lib.eithers.map[hydra.ext.haskell.ast.Expression,
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Type, hydra.ext.haskell.ast.Expression](hydra.schemas.requireUnionField(cx)(g)(sname)(fn))((ftyp: hydra.core.Type) =>
    ...
    case hydra.core.Term.wrap(v_Term_wrap_wrapped) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
         hydra.ext.haskell.ast.Expression](encode(`term_`))((rhs: hydra.ext.haskell.ast.Expression) => Right(hydra.ext.haskell.utils.hsapp(lhs)(rhs)))
    }
    case _ => Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat2("unexpected term: ")(hydra.show.core.term(term))), cx))
}
...
def encodeType[T0](namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(typ: hydra.core.Type)(cx: hydra.context.Context)(g: T0): Either[hydra.context.InContext[hydra.error.Error],
  ...
  hydra.rewriting.deannotateType(typ) match
    case hydra.core.Type.application(v_Type_application_app) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.Type](encode(lhs))((hlhs: hydra.ext.haskell.ast.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type,
           hydra.ext.haskell.ast.Type](encode(rhs))((hrhs: hydra.ext.haskell.ast.Type) =>
    ...
    case hydra.core.Type.either(v_Type_either_eitherType) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.Type](encode(`left_`))((hleft: hydra.ext.haskell.ast.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type,
           hydra.ext.haskell.ast.Type](encode(`right_`))((hright: hydra.ext.haskell.ast.Type) =>
    ...
    case hydra.core.Type.function(v_Type_function_funType) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.Type](encode(dom))((hdom: hydra.ext.haskell.ast.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type,
           hydra.ext.haskell.ast.Type](encode(cod))((hcod: hydra.ext.haskell.ast.Type) =>
    ...
    case hydra.core.Type.list(v_Type_list_lt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
    ...
    case hydra.core.Type.literal(v_Type_literal_lt) => v_Type_literal_lt match
      ...
      case hydra.core.LiteralType.integer(v_LiteralType_integer_it) => v_LiteralType_integer_it match
        ...
        case _ => Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat2("unexpected integer type: ")(hydra.show.core.integerType(v_LiteralType_integer_it))),
           cx))
      case hydra.core.LiteralType.string => Right(hydra.ext.haskell.ast.Type.variable(hydra.ext.haskell.utils.rawName("String")))
      case _ => Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat2("unexpected literal type: ")(hydra.show.core.literalType(v_Type_literal_lt))),
         cx))
    case hydra.core.Type.map(v_Type_map_mapType) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.Type](encode(kt))((hkt: hydra.ext.haskell.ast.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type,
           hydra.ext.haskell.ast.Type](encode(vt))((hvt: hydra.ext.haskell.ast.Type) =>
    ...
    case hydra.core.Type.pair(v_Type_pair_pt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.Type](encode(v_Type_pair_pt.second))((s: hydra.ext.haskell.ast.Type) => Right(hydra.ext.haskell.ast.Type.tuple(Seq(f,
         s)))))
    ...
    case _ => Left(hydra.context.InContext(hydra.error.Error.other(hydra.lib.strings.cat2("unexpected type: ")(hydra.show.core.`type`(typ))), cx))
}
...
def encodeTypeWithClassAssertions[T0](namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(explicitClasses: Map[hydra.core.Name,
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.Type](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(typ)(cx)(g))((htyp: hydra.ext.haskell.ast.Type) =>
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type]](hydra.lib.lists.`null`[Tuple2[hydra.core.Name,
       hydra.classes.TypeClass]](assertPairs))(Right(htyp))({
    val encoded: Seq[hydra.ext.haskell.ast.Assertion] = hydra.lib.lists.map[Tuple2[hydra.core.Name, hydra.classes.TypeClass],
       hydra.ext.haskell.ast.Assertion](encodeAssertion)(assertPairs)
    val hassert: hydra.ext.haskell.ast.Assertion = hydra.lib.logic.ifElse[hydra.ext.haskell.ast.Assertion](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.ext.haskell.ast.Assertion](encoded))(1))(hydra.lib.lists.head[hydra.ext.haskell.ast.Assertion](encoded))(hydra.ext.haskell.ast.Assertion.tuple(encoded))
...
def moduleToHaskellModule(mod: hydra.module.Module)(defs: Seq[hydra.module.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
   hydra.ext.haskell.ast.Module] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName],
...
def moduleToHaskell(mod: hydra.module.Module)(defs: Seq[hydra.module.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Module, Map[scala.Predef.String,
...
def nameDecls(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(name: hydra.core.Name)(typ: hydra.core.Type): Seq[hydra.ext.haskell.ast.DeclarationWithComments] =
  ...
  hydra.lib.logic.ifElse[Seq[hydra.ext.haskell.ast.DeclarationWithComments]](hydra.ext.haskell.coder.useCoreImport)(hydra.lib.lists.cons[hydra.ext.haskell.ast.DeclarationWithComments](toDecl("hydra.core.Name")(nameDecl))(hydra.lib.lists.map[Tuple2[scala.Predef.String,
...
def toDataDeclaration(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(`def`: hydra.module.TermDefinition)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
        ...
        case hydra.ext.haskell.ast.Pattern.application(v_Pattern_application_appPat) => {
          ...
          rhsExpr match
            case hydra.ext.haskell.ast.Expression.lambda(v_Expression_lambda_lambda_) => {
              ...
              val newPattern: hydra.ext.haskell.ast.Pattern = hydra.ext.haskell.utils.applicationPattern(`name_`)(hydra.lib.lists.concat2[hydra.ext.haskell.ast.Pattern](args)(vars))
  ...
  def toDecl(comments: Option[scala.Predef.String])(`hname_`: hydra.ext.haskell.ast.Name)(`term_`: hydra.core.Term)(bindings: Option[hydra.ext.haskell.ast.LocalBindings]): Either[hydra.context.InContext[hydra.error.Error],
    ...
    case hydra.core.Term.let(v_Term_let_letTerm) => {
      ...
      val hnames: Seq[hydra.ext.haskell.ast.Name] = hydra.lib.lists.map[hydra.core.Binding, hydra.ext.haskell.ast.Name]((binding: hydra.core.Binding) => hydra.ext.haskell.utils.simpleName(binding.name))(lbindings)
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.Expression],
         hydra.ext.haskell.ast.DeclarationWithComments](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.haskell.ast.Expression,
        ...
        {
        val hbindings: Seq[hydra.ext.haskell.ast.LocalBinding] = hydra.lib.lists.zipWith[hydra.ext.haskell.ast.Name,
           hydra.ext.haskell.ast.Expression, hydra.ext.haskell.ast.LocalBinding](toBinding)(hnames)(hterms)
        val prevBindings: Seq[hydra.ext.haskell.ast.LocalBinding] = hydra.lib.maybes.maybe[Seq[hydra.ext.haskell.ast.LocalBinding],
           hydra.ext.haskell.ast.LocalBindings](Seq())((lb: hydra.ext.haskell.ast.LocalBindings) => lb)(bindings)
        val allBindings: Seq[hydra.ext.haskell.ast.LocalBinding] = hydra.lib.lists.concat2[hydra.ext.haskell.ast.LocalBinding](prevBindings)(hbindings)
    ...
    case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Map[hydra.core.Name, scala.collection.immutable.Set[hydra.classes.TypeClass]],
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type,
           hydra.ext.haskell.ast.DeclarationWithComments](hydra.ext.haskell.coder.encodeTypeWithClassAssertions(namespaces)(combinedClasses)(typ.`type`)(cx)(g))((htype: hydra.ext.haskell.ast.Type) =>
          {
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Option[scala.Predef.String], hydra.ext.haskell.ast.DeclarationWithComments](hydra.annotations.getTermDescription(cx)(g)(term))((comments: Option[scala.Predef.String]) => toDecl(comments)(hname)(term)(None))
}
...
def toTypeDeclarationsFrom(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(elementName: hydra.core.Name)(typ: hydra.core.Type)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
  ...
  def newtypeCons(tname: hydra.core.Name)(`typ_`: hydra.core.Type): Either[hydra.context.InContext[hydra.error.Error],
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.ConstructorWithComments](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(`typ_`)(cx)(g))((htype: hydra.ext.haskell.ast.Type) =>
      {
  ...
  def recordCons(`lname_`: scala.Predef.String)(fields: Seq[hydra.core.FieldType]): Either[hydra.context.InContext[hydra.error.Error],
    ...
    def toField(fieldType: hydra.core.FieldType): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.FieldWithComments] =
      ...
      val `hname_`: hydra.ext.haskell.ast.Name = hydra.ext.haskell.utils.simpleName(hydra.lib.strings.cat2(hydra.formatting.decapitalize(`lname_`))(hydra.formatting.capitalize(fname)))
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type, hydra.ext.haskell.ast.FieldWithComments](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(ftype)(cx)(g))((htype: hydra.ext.haskell.ast.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Option[scala.Predef.String],
           hydra.ext.haskell.ast.FieldWithComments](hydra.annotations.getTypeDescription(cx)(g)(ftype))((comments: Option[scala.Predef.String]) =>
        Right(hydra.ext.haskell.ast.FieldWithComments(hydra.ext.haskell.ast.Field(`hname_`, htype), comments))))
    }
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.FieldWithComments],
       hydra.ext.haskell.ast.ConstructorWithComments](hydra.lib.eithers.mapList[hydra.core.FieldType,
       hydra.ext.haskell.ast.FieldWithComments, hydra.context.InContext[hydra.error.Error]](toField)(fields))((hFields: Seq[hydra.ext.haskell.ast.FieldWithComments]) =>
  ...
  def unionCons(`boundNames_`: scala.collection.immutable.Set[hydra.core.Name])(`lname_`: scala.Predef.String)(fieldType: hydra.core.FieldType): Either[hydra.context.InContext[hydra.error.Error],
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Option[scala.Predef.String], hydra.ext.haskell.ast.ConstructorWithComments](hydra.annotations.getTypeDescription(cx)(g)(ftype))((comments: Option[scala.Predef.String]) =>
      {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.Type],
         hydra.ext.haskell.ast.ConstructorWithComments](hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error],
         Seq[hydra.ext.haskell.ast.Type]]](hydra.lib.equality.equal[hydra.core.Type](hydra.rewriting.deannotateType(ftype))(hydra.core.Type.unit))(Right(Seq()))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Boolean, Seq[hydra.ext.haskell.ast.DeclarationWithComments]](hydra.schemas.isSerializableByName(cx)(g)(elementName))((isSer: Boolean) =>
    {
    val deriv: hydra.ext.haskell.ast.Deriving = hydra.lib.logic.ifElse[Seq[hydra.ext.haskell.ast.Name]](isSer)(hydra.lib.lists.map[scala.Predef.String,
    ...
    val hd: hydra.ext.haskell.ast.DeclarationHead = declHead(hname)(hydra.lib.lists.reverse[hydra.core.Name](vars))
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Declaration,
       Seq[hydra.ext.haskell.ast.DeclarationWithComments]](hydra.rewriting.deannotateType(`t_`) match
      case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
      ...
      case hydra.core.Type.union(v_Type_union_rt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
         Seq[hydra.ext.haskell.ast.ConstructorWithComments], hydra.ext.haskell.ast.Declaration](hydra.lib.eithers.mapList[hydra.core.FieldType,
      ...
      case hydra.core.Type.wrap(v_Type_wrap_wrapped) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
        ...
        Right(hydra.ext.haskell.ast.Declaration.data(hydra.ext.haskell.ast.DataDeclaration(hydra.ext.haskell.ast.DataOrNewtype.newtype,
           Seq(), hd, Seq(cons), Seq(deriv)))))
      case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Type,
         hydra.ext.haskell.ast.Declaration](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(typ)(cx)(g))((htype: hydra.ext.haskell.ast.Type) =>
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Option[scala.Predef.String],
         Seq[hydra.ext.haskell.ast.DeclarationWithComments]](hydra.annotations.getTypeDescription(cx)(g)(typ))((comments: Option[scala.Predef.String]) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], Seq[hydra.ext.haskell.ast.DeclarationWithComments],
         Seq[hydra.ext.haskell.ast.DeclarationWithComments]](hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error],
         Seq[hydra.ext.haskell.ast.DeclarationWithComments]]](hydra.ext.haskell.coder.includeTypeDefinitions)(hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error],
...
def typeDecl(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName])(name: hydra.core.Name)(typ: hydra.core.Type)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.error.Error],
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.ext.haskell.ast.Expression,
     hydra.ext.haskell.ast.DeclarationWithComments](hydra.ext.haskell.coder.encodeTerm(0)(namespaces)(finalTerm)(cx)(g))((expr: hydra.ext.haskell.ast.Expression) =>
    {
