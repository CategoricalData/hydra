    ...
    case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Map[hydra.core.Name, scala.collection.immutable.Set[hydra.classes.TypeClass]],
           ...
           scala.collection.immutable.Set[hydra.classes.TypeClass]](schemeClasses)(explicitClasses)
        {
          ...
          hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
             hydra.ext.haskell.syntax.DeclarationWithComments](hydra.ext.haskell.coder.encodeTypeWithClassAssertions(namespaces)(combinedClasses)(schemeType)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
            {
