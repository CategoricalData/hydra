...
def constructModule(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(mod: hydra.module.Module)(defs: Seq[hydra.module.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  val imports: Seq[hydra.ext.haskell.syntax.Import] = hydra.lib.lists.concat2[hydra.ext.haskell.syntax.Import](domainImports)(standardImports)
  val domainImports: Seq[hydra.ext.haskell.syntax.Import] = {
    def toImport(pair: Tuple2[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName]): hydra.ext.haskell.syntax.Import =
      {
      val namespace: hydra.module.Namespace = hydra.lib.pairs.first[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName](pair)
      val alias: hydra.ext.haskell.syntax.ModuleName = hydra.lib.pairs.second[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName](pair)
  ...
  val standardImports: Seq[hydra.ext.haskell.syntax.Import] = {
    def toImport(triple: Tuple2[Tuple2[scala.Predef.String, Option[scala.Predef.String]], Seq[scala.Predef.String]]): hydra.ext.haskell.syntax.Import =
      {
      val name: scala.Predef.String = hydra.lib.pairs.first[scala.Predef.String, Option[scala.Predef.String]](hydra.lib.pairs.first[Tuple2[scala.Predef.String,
         Option[scala.Predef.String]], Seq[scala.Predef.String]](triple))
      val malias: Option[scala.Predef.String] = hydra.lib.pairs.second[scala.Predef.String, Option[scala.Predef.String]](hydra.lib.pairs.first[Tuple2[scala.Predef.String,
         Option[scala.Predef.String]], Seq[scala.Predef.String]](triple))
      val hidden: Seq[scala.Predef.String] = hydra.lib.pairs.second[Tuple2[scala.Predef.String, Option[scala.Predef.String]], Seq[scala.Predef.String]](triple)
      val spec: Option[hydra.ext.haskell.syntax.SpecImport] = hydra.lib.logic.ifElse[Option[hydra.ext.haskell.syntax.SpecImport]](hydra.lib.lists.`null`[scala.Predef.String](hidden))(None)(Some(hydra.ext.haskell.syntax.SpecImport.hiding(hydra.lib.lists.map[scala.Predef.String,
         hydra.ext.haskell.syntax.ImportExportSpec]((n: scala.Predef.String) =>
        hydra.ext.haskell.syntax.ImportExportSpec(None, hydra.ext.haskell.utils.simpleName(n), None))(hidden))))
      hydra.ext.haskell.syntax.Import(hydra.lib.maybes.isJust[scala.Predef.String](malias), name, hydra.lib.maybes.map[scala.Predef.String,
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[Seq[hydra.ext.haskell.syntax.DeclarationWithComments]],
    ...
    {
    val decls: Seq[hydra.ext.haskell.syntax.DeclarationWithComments] = hydra.lib.lists.concat[hydra.ext.haskell.syntax.DeclarationWithComments](declLists)
...
def encodeCaseExpression(depth: Int)(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(stmt: hydra.core.CaseStatement)(scrutinee: hydra.ext.haskell.syntax.Expression)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  def toAlt(fieldMap: Map[hydra.core.Name, hydra.core.FieldType])(field: hydra.core.Field): Either[hydra.context.InContext[hydra.errors.Error],
     hydra.ext.haskell.syntax.Alternative] =
    {
    val fn: hydra.core.Name = (field.name)
    val `fun_`: hydra.core.Term = (field.term)
    val v0: scala.Predef.String = hydra.lib.strings.cat2("v")(hydra.lib.literals.showInt32(depth))
    ...
    val v1: scala.Predef.String = hydra.lib.logic.ifElse[scala.Predef.String](hydra.rewriting.isFreeVariableInTerm(v0)(rhsTerm))(hydra.constants.ignoredVariable)(v0)
    val hname: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.unionFieldReference(hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.maps.keys[hydra.core.Name,
       hydra.core.Term](g.boundTerms)))(namespaces)(dn)(fn)
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.Pattern],
       hydra.ext.haskell.syntax.Alternative](hydra.lib.maybes.cases[hydra.core.FieldType, Either[hydra.context.InContext[hydra.errors.Error],
       Seq[hydra.ext.haskell.syntax.Pattern]]](hydra.lib.maps.lookup[hydra.core.Name, hydra.core.FieldType](fn)(fieldMap))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat(Seq("field ",
       hydra.lib.literals.showString(fn), " not found in ", hydra.lib.literals.showString(dn)))), cx)))((fieldType: hydra.core.FieldType) =>
      {
      val ft: hydra.core.Type = (fieldType.`type`)
      def noArgs[T0]: Seq[T0] = Seq()
      val singleArg: Seq[hydra.ext.haskell.syntax.Pattern] = Seq(hydra.ext.haskell.syntax.Pattern.name(hydra.ext.haskell.utils.rawName(v1)))
      ...
      {
      val lhs: hydra.ext.haskell.syntax.Pattern = hydra.ext.haskell.utils.applicationPattern(hname)(args)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.CaseRhs,
         hydra.ext.haskell.syntax.Alternative](hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.CaseRhs, hydra.context.InContext[hydra.errors.Error]]((x: hydra.ext.haskell.syntax.Expression) => x)(hydra.ext.haskell.coder.encodeTerm(hydra.lib.math.add(depth)(1))(namespaces)(rhsTerm)(cx)(g)))((rhs: hydra.ext.haskell.syntax.CaseRhs) => Right(hydra.ext.haskell.syntax.Alternative(lhs,
         rhs, None)))
    })
  }
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.FieldType], hydra.ext.haskell.syntax.Expression](hydra.schemas.requireUnionType(cx)(g)(dn))((rt: Seq[hydra.core.FieldType]) =>
    ...
    val fieldMap: Map[hydra.core.Name, hydra.core.FieldType] = hydra.lib.maps.fromList[hydra.core.Name,
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.Alternative],
       hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Field, hydra.ext.haskell.syntax.Alternative,
       hydra.context.InContext[hydra.errors.Error]]((v1: hydra.core.Field) => toAlt(fieldMap)(v1))(fields))((ecases: Seq[hydra.ext.haskell.syntax.Alternative]) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.Alternative],
         hydra.ext.haskell.syntax.Expression](hydra.lib.maybes.cases[hydra.core.Term, Either[hydra.context.InContext[hydra.errors.Error],
         Seq[hydra.ext.haskell.syntax.Alternative]]](`def`)(Right(Seq()))((d: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.CaseRhs,
         Seq[hydra.ext.haskell.syntax.Alternative]](hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.CaseRhs, hydra.context.InContext[hydra.errors.Error]]((x: hydra.ext.haskell.syntax.Expression) => x)(hydra.ext.haskell.coder.encodeTerm(depth)(namespaces)(d)(cx)(g)))((cs: hydra.ext.haskell.syntax.CaseRhs) =>
      {
      val lhs: hydra.ext.haskell.syntax.Pattern = hydra.ext.haskell.syntax.Pattern.name(hydra.ext.haskell.utils.rawName(hydra.constants.ignoredVariable))
      val alt: hydra.ext.haskell.syntax.Alternative = hydra.ext.haskell.syntax.Alternative(lhs, cs, None)
      Right(Seq(alt))
    })))((dcases: Seq[hydra.ext.haskell.syntax.Alternative]) =>
      Right(hydra.ext.haskell.syntax.Expression.`case`(hydra.ext.haskell.syntax.CaseExpression(scrutinee,
         hydra.lib.lists.concat2[hydra.ext.haskell.syntax.Alternative](ecases)(dcases))))))
  })
}
...
def encodeFunction(depth: Int)(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(fun: hydra.core.Function)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
    ...
    case hydra.core.Elimination.union(v_Elimination_union_stmt) => hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
       hydra.ext.haskell.syntax.Expression, hydra.context.InContext[hydra.errors.Error]]((v1: hydra.ext.haskell.syntax.Expression) =>
...
def encodeTerm(depth: Int)(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(term: hydra.core.Term)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  def nonemptyMap(m: Map[hydra.core.Term, hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression] =
    {
    val lhs: hydra.ext.haskell.syntax.Expression = hydra.ext.haskell.utils.hsvar("M.fromList")
    def encodePair(pair: Tuple2[hydra.core.Term, hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression] =
      {
      val k: hydra.core.Term = hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](pair)
      val v: hydra.core.Term = hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](pair)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.Expression](encode(k))((hk: hydra.ext.haskell.syntax.Expression) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
           hydra.ext.haskell.syntax.Expression](encode(v))((hv: hydra.ext.haskell.syntax.Expression) =>
        Right(hydra.ext.haskell.syntax.Expression.tuple(Seq(hk, hv)))))
    }
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
       hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.map[Seq[hydra.ext.haskell.syntax.Expression],
       hydra.ext.haskell.syntax.Expression, hydra.context.InContext[hydra.errors.Error]]((x: Seq[hydra.ext.haskell.syntax.Expression]) => hydra.ext.haskell.syntax.Expression.list(x))(hydra.lib.eithers.mapList[Tuple2[hydra.core.Term,
       hydra.core.Term], hydra.ext.haskell.syntax.Expression, hydra.context.InContext[hydra.errors.Error]](encodePair)(hydra.lib.maps.toList[hydra.core.Term,
       hydra.core.Term](m))))((rhs: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(lhs)(rhs)))
  }
  def nonemptySet(s: scala.collection.immutable.Set[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error],
     hydra.ext.haskell.syntax.Expression] =
    {
    val lhs: hydra.ext.haskell.syntax.Expression = hydra.ext.haskell.utils.hsvar("S.fromList")
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
  ...
  hydra.rewriting.deannotateTerm(term) match
    case hydra.core.Term.application(v_Term_application_app) => {
      ...
      deannotatedFun match
        case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
          case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
            case hydra.core.Elimination.union(v_Elimination_union_stmt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
               hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(arg))((harg: hydra.ext.haskell.syntax.Expression) =>
              hydra.ext.haskell.coder.encodeCaseExpression(depth)(namespaces)(v_Elimination_union_stmt)(harg)(cx)(g))
            case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
               hydra.ext.haskell.syntax.Expression](encode(fun))((hfun: hydra.ext.haskell.syntax.Expression) =>
              hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
                 hydra.ext.haskell.syntax.Expression](encode(arg))((harg: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(hfun)(harg))))
          case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
             hydra.ext.haskell.syntax.Expression](encode(fun))((hfun: hydra.ext.haskell.syntax.Expression) =>
            hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
               hydra.ext.haskell.syntax.Expression](encode(arg))((harg: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(hfun)(harg))))
    ...
    case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
       Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression]]((l: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.Expression](encode(l))((hl: hydra.ext.haskell.syntax.Expression) =>
      Right(hydra.ext.haskell.utils.hsapp(hydra.ext.haskell.utils.hsvar("Left"))(hl))))((r: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.Expression](encode(r))((hr: hydra.ext.haskell.syntax.Expression) =>
    ...
    case hydra.core.Term.let(v_Term_let_letTerm) => {
      ...
      val allBindings: Seq[hydra.core.Binding] = hydra.lib.pairs.first[Seq[hydra.core.Binding], hydra.core.Term](collected)
      val finalBody: hydra.core.Term = hydra.lib.pairs.second[Seq[hydra.core.Binding], hydra.core.Term](collected)
      def encodeBinding(binding: hydra.core.Binding): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.LocalBinding] =
        ...
        val hname: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.simpleName(name)
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
           hydra.ext.haskell.syntax.LocalBinding](encode(`term_`))((hexpr: hydra.ext.haskell.syntax.Expression) =>
          Right(hydra.ext.haskell.syntax.LocalBinding.value(hydra.ext.haskell.utils.simpleValueBinding(hname)(hexpr)(None))))
      }
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.LocalBinding],
         hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Binding, hydra.ext.haskell.syntax.LocalBinding,
         hydra.context.InContext[hydra.errors.Error]](encodeBinding)(allBindings))((hbindings: Seq[hydra.ext.haskell.syntax.LocalBinding]) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
           hydra.ext.haskell.syntax.Expression](encode(finalBody))((hinner: hydra.ext.haskell.syntax.Expression) =>
    ...
    case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
       Seq[hydra.ext.haskell.syntax.Expression], hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Term,
       hydra.ext.haskell.syntax.Expression, hydra.context.InContext[hydra.errors.Error]](encode)(v_Term_list_els))((helems: Seq[hydra.ext.haskell.syntax.Expression]) => Right(hydra.ext.haskell.syntax.Expression.list(helems)))
    ...
    case hydra.core.Term.map(v_Term_map_m) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error],
       hydra.ext.haskell.syntax.Expression]](hydra.lib.maps.`null`[hydra.core.Term, hydra.core.Term](v_Term_map_m))(Right(hydra.ext.haskell.utils.hsvar("M.empty")))(nonemptyMap(v_Term_map_m))
    case hydra.core.Term.maybe(v_Term_maybe_m) => hydra.lib.maybes.cases[hydra.core.Term, Either[hydra.context.InContext[hydra.errors.Error],
       hydra.ext.haskell.syntax.Expression]](v_Term_maybe_m)(Right(hydra.ext.haskell.utils.hsvar("Nothing")))((t: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.Expression](encode(t))((ht: hydra.ext.haskell.syntax.Expression) =>
    ...
    case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
       hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(hydra.lib.pairs.first[hydra.core.Term,
       hydra.core.Term](v_Term_pair_p)))((f: hydra.ext.haskell.syntax.Expression) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.Expression](encode(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((s: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.syntax.Expression.tuple(Seq(f,
         s)))))
    case hydra.core.Term.record(v_Term_record_record) => {
      ...
      def toFieldUpdate(field: hydra.core.Field): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.FieldUpdate] =
        ...
        val fieldRef: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.recordFieldReference(namespaces)(sname)(fn)
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
           hydra.ext.haskell.syntax.FieldUpdate](encode(ft))((hft: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.syntax.FieldUpdate(fieldRef,
           hft)))
      }
      val typeName: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.elementReference(namespaces)(sname)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.FieldUpdate],
         hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Field, hydra.ext.haskell.syntax.FieldUpdate,
         hydra.context.InContext[hydra.errors.Error]](toFieldUpdate)(fields))((updates: Seq[hydra.ext.haskell.syntax.FieldUpdate]) =>
    ...
    case hydra.core.Term.set(v_Term_set_s) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error],
       hydra.ext.haskell.syntax.Expression]](hydra.lib.sets.`null`[hydra.core.Term](v_Term_set_s))(Right(hydra.ext.haskell.utils.hsvar("S.empty")))(nonemptySet(v_Term_set_s))
    ...
    case hydra.core.Term.union(v_Term_union_injection) => {
      ...
      val fn: hydra.core.Name = (field.name)
      val ft: hydra.core.Term = (field.term)
      val lhs: hydra.ext.haskell.syntax.Expression = hydra.ext.haskell.syntax.Expression.variable(hydra.ext.haskell.utils.unionFieldReference(hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.maps.keys[hydra.core.Name,
         hydra.core.Term](g.boundTerms)))(namespaces)(sname)(fn))
      val dflt: Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression] = hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
    ...
    case hydra.core.Term.wrap(v_Term_wrap_wrapped) => {
      ...
      val lhs: hydra.ext.haskell.syntax.Expression = hydra.ext.haskell.syntax.Expression.variable(hydra.ext.haskell.utils.elementReference(namespaces)(tname))
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.Expression](encode(`term_`))((rhs: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(lhs)(rhs)))
    }
...
def encodeType[T0](namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(typ: hydra.core.Type)(cx: hydra.context.Context)(g: T0): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  val unitTuple: hydra.ext.haskell.syntax.Type = hydra.ext.haskell.syntax.Type.tuple(Seq())
  hydra.rewriting.deannotateType(typ) match
    case hydra.core.Type.application(v_Type_application_app) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
         hydra.ext.haskell.syntax.Type](encode(lhs))((hlhs: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
           hydra.ext.haskell.syntax.Type](encode(rhs))((hrhs: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.either(v_Type_either_eitherType) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
         hydra.ext.haskell.syntax.Type](encode(`left_`))((hleft: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
           hydra.ext.haskell.syntax.Type](encode(`right_`))((hright: hydra.ext.haskell.syntax.Type) =>
        Right(hydra.ext.haskell.utils.toTypeApplication(Seq(hydra.ext.haskell.syntax.Type.variable(hydra.ext.haskell.utils.rawName("Either")),
           hleft, hright)))))
    }
    case hydra.core.Type.function(v_Type_function_funType) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
         hydra.ext.haskell.syntax.Type](encode(dom))((hdom: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
           hydra.ext.haskell.syntax.Type](encode(cod))((hcod: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.list(v_Type_list_lt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
       hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(v_Type_list_lt))((hlt: hydra.ext.haskell.syntax.Type) => Right(hydra.ext.haskell.syntax.Type.list(hlt)))
    case hydra.core.Type.literal(v_Type_literal_lt) => v_Type_literal_lt match
      ...
      case hydra.core.LiteralType.integer(v_LiteralType_integer_it) => v_LiteralType_integer_it match
        ...
        case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2("unexpected integer type: ")(hydra.show.core.integerType(v_LiteralType_integer_it))),
           cx))
      case hydra.core.LiteralType.string => Right(hydra.ext.haskell.syntax.Type.variable(hydra.ext.haskell.utils.rawName("String")))
      case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2("unexpected literal type: ")(hydra.show.core.literalType(v_Type_literal_lt))),
         cx))
    case hydra.core.Type.map(v_Type_map_mapType) => {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
         hydra.ext.haskell.syntax.Type](encode(kt))((hkt: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
           hydra.ext.haskell.syntax.Type](encode(vt))((hvt: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.maybe(v_Type_maybe_ot) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
       hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(v_Type_maybe_ot))((hot: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.pair(v_Type_pair_pt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
       hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(v_Type_pair_pt.first))((f: hydra.ext.haskell.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
...
def encodeTypeWithClassAssertions[T0](namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(explicitClasses: Map[hydra.core.Name,
   ...
   hydra.ext.haskell.syntax.Type] =
  {
  val classes: Map[hydra.core.Name, scala.collection.immutable.Set[hydra.classes.TypeClass]] = hydra.lib.maps.union[hydra.core.Name,
  ...
  def encodeAssertion(pair: Tuple2[hydra.core.Name, hydra.classes.TypeClass]): hydra.ext.haskell.syntax.Assertion =
    {
    val name: hydra.core.Name = hydra.lib.pairs.first[hydra.core.Name, hydra.classes.TypeClass](pair)
    val cls: hydra.classes.TypeClass = hydra.lib.pairs.second[hydra.core.Name, hydra.classes.TypeClass](pair)
    val hname: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.rawName(cls match
      case hydra.classes.TypeClass.equality => "Eq"
      case hydra.classes.TypeClass.ordering => "Ord")
    val htype: hydra.ext.haskell.syntax.Type = hydra.ext.haskell.syntax.Type.variable(hydra.ext.haskell.utils.rawName(name))
    hydra.ext.haskell.syntax.Assertion.`class`(hydra.ext.haskell.syntax.ClassAssertion(hname, Seq(htype)))
  }
  val assertPairs: Seq[Tuple2[hydra.core.Name, hydra.classes.TypeClass]] = hydra.lib.lists.concat[Tuple2[hydra.core.Name,
  ...
  def toPairs[T1, T2](mapEntry: Tuple2[T1, scala.collection.immutable.Set[T2]]): Seq[Tuple2[T1, T2]] =
    {
    val name: T1 = hydra.lib.pairs.first[T1, scala.collection.immutable.Set[T2]](mapEntry)
    val clsSet: scala.collection.immutable.Set[T2] = hydra.lib.pairs.second[T1, scala.collection.immutable.Set[T2]](mapEntry)
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(typ)(cx)(g))((htyp: hydra.ext.haskell.syntax.Type) =>
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type]](hydra.lib.lists.`null`[Tuple2[hydra.core.Name,
       hydra.classes.TypeClass]](assertPairs))(Right(htyp))({
    val encoded: Seq[hydra.ext.haskell.syntax.Assertion] = hydra.lib.lists.map[Tuple2[hydra.core.Name,
       hydra.classes.TypeClass], hydra.ext.haskell.syntax.Assertion](encodeAssertion)(assertPairs)
    val hassert: hydra.ext.haskell.syntax.Assertion = hydra.lib.logic.ifElse[hydra.ext.haskell.syntax.Assertion](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.ext.haskell.syntax.Assertion](encoded))(1))(hydra.lib.lists.head[hydra.ext.haskell.syntax.Assertion](encoded))(hydra.ext.haskell.syntax.Assertion.tuple(encoded))
...
def nameDecls(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(name: hydra.core.Name)(typ: hydra.core.Type): Seq[hydra.ext.haskell.syntax.DeclarationWithComments] =
  ...
  def toDecl(n: hydra.core.Name)(pair: Tuple2[scala.Predef.String, scala.Predef.String]): hydra.ext.haskell.syntax.DeclarationWithComments =
    {
    val k: scala.Predef.String = hydra.lib.pairs.first[scala.Predef.String, scala.Predef.String](pair)
    val v: scala.Predef.String = hydra.lib.pairs.second[scala.Predef.String, scala.Predef.String](pair)
    val decl: hydra.ext.haskell.syntax.Declaration = hydra.ext.haskell.syntax.Declaration.valueBinding(hydra.ext.haskell.syntax.ValueBinding.simple(hydra.ext.haskell.syntax.SimpleValueBinding(hydra.ext.haskell.utils.applicationPattern(hydra.ext.haskell.utils.simpleName(k))(Seq()),
       hydra.ext.haskell.syntax.Expression.application(hydra.ext.haskell.syntax.ApplicationExpression(hydra.ext.haskell.syntax.Expression.variable(hydra.ext.haskell.utils.elementReference(namespaces)(n)),
       hydra.ext.haskell.syntax.Expression.literal(hydra.ext.haskell.syntax.Literal.string(v)))), None)))
  ...
  val fieldDecls: Seq[Tuple2[scala.Predef.String, scala.Predef.String]] = hydra.lib.lists.map[hydra.core.FieldType,
  ...
  hydra.lib.logic.ifElse[Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.ext.haskell.coder.useCoreImport)(hydra.lib.lists.cons[hydra.ext.haskell.syntax.DeclarationWithComments](toDecl("hydra.core.Name")(nameDecl))(hydra.lib.lists.map[Tuple2[scala.Predef.String,
     scala.Predef.String], hydra.ext.haskell.syntax.DeclarationWithComments]((v1: Tuple2[scala.Predef.String,
...
def toDataDeclaration(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(`def`: hydra.module.TermDefinition)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  val hname: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.simpleName(hydra.names.localNameOf(name))
  def rewriteValueBinding(vb: hydra.ext.haskell.syntax.ValueBinding): hydra.ext.haskell.syntax.ValueBinding =
    ...
    case hydra.ext.haskell.syntax.ValueBinding.simple(v_ValueBinding_simple_simple) => {
      val `pattern_`: hydra.ext.haskell.syntax.Pattern = (v_ValueBinding_simple_simple.pattern)
      val rhs: hydra.ext.haskell.syntax.RightHandSide = (v_ValueBinding_simple_simple.rhs)
      val bindings: Option[hydra.ext.haskell.syntax.LocalBindings] = (v_ValueBinding_simple_simple.localBindings)
      `pattern_` match
        case hydra.ext.haskell.syntax.Pattern.application(v_Pattern_application_appPat) => {
          val `name_`: hydra.ext.haskell.syntax.Name = (v_Pattern_application_appPat.name)
          val args: Seq[hydra.ext.haskell.syntax.Pattern] = (v_Pattern_application_appPat.args)
          val rhsExpr: hydra.ext.haskell.syntax.Expression = rhs
          rhsExpr match
            case hydra.ext.haskell.syntax.Expression.lambda(v_Expression_lambda_lambda_) => {
              val vars: Seq[hydra.ext.haskell.syntax.Pattern] = (`v_Expression_lambda_lambda_`.bindings)
              val body: hydra.ext.haskell.syntax.Expression = (`v_Expression_lambda_lambda_`.inner)
              val newPattern: hydra.ext.haskell.syntax.Pattern = hydra.ext.haskell.utils.applicationPattern(`name_`)(hydra.lib.lists.concat2[hydra.ext.haskell.syntax.Pattern](args)(vars))
              val newRhs: hydra.ext.haskell.syntax.RightHandSide = body
  ...
  def toDecl(comments: Option[scala.Predef.String])(`hname_`: hydra.ext.haskell.syntax.Name)(`term_`: hydra.core.Term)(bindings: Option[hydra.ext.haskell.syntax.LocalBindings]): Either[hydra.context.InContext[hydra.errors.Error],
    ...
    case hydra.core.Term.let(v_Term_let_letTerm) => {
      ...
      def toBinding(`hname__`: hydra.ext.haskell.syntax.Name)(`hterm_`: hydra.ext.haskell.syntax.Expression): hydra.ext.haskell.syntax.LocalBinding =
        hydra.ext.haskell.syntax.LocalBinding.value(hydra.ext.haskell.utils.simpleValueBinding(`hname__`)(`hterm_`)(None))
      val hnames: Seq[hydra.ext.haskell.syntax.Name] = hydra.lib.lists.map[hydra.core.Binding, hydra.ext.haskell.syntax.Name]((binding: hydra.core.Binding) => hydra.ext.haskell.utils.simpleName(binding.name))(lbindings)
      val terms: Seq[hydra.core.Term] = hydra.lib.lists.map[hydra.core.Binding, hydra.core.Term]((x: hydra.core.Binding) => (x.term))(lbindings)
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.Expression],
         hydra.ext.haskell.syntax.DeclarationWithComments](hydra.lib.eithers.mapList[hydra.core.Term,
         hydra.ext.haskell.syntax.Expression, hydra.context.InContext[hydra.errors.Error]]((t: hydra.core.Term) => hydra.ext.haskell.coder.encodeTerm(0)(namespaces)(t)(cx)(g))(terms))((hterms: Seq[hydra.ext.haskell.syntax.Expression]) =>
        {
        val hbindings: Seq[hydra.ext.haskell.syntax.LocalBinding] = hydra.lib.lists.zipWith[hydra.ext.haskell.syntax.Name,
           hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.LocalBinding](toBinding)(hnames)(hterms)
        val prevBindings: Seq[hydra.ext.haskell.syntax.LocalBinding] = hydra.lib.maybes.maybe[Seq[hydra.ext.haskell.syntax.LocalBinding],
           hydra.ext.haskell.syntax.LocalBindings](Seq())((lb: hydra.ext.haskell.syntax.LocalBindings) => lb)(bindings)
        val allBindings: Seq[hydra.ext.haskell.syntax.LocalBinding] = hydra.lib.lists.concat2[hydra.ext.haskell.syntax.LocalBinding](prevBindings)(hbindings)
        toDecl(comments)(`hname_`)(env)(Some(allBindings))
      })
    }
    case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
       hydra.ext.haskell.syntax.DeclarationWithComments](hydra.ext.haskell.coder.encodeTerm(0)(namespaces)(`term_`)(cx)(g))((hterm: hydra.ext.haskell.syntax.Expression) =>
      {
      val vb: hydra.ext.haskell.syntax.ValueBinding = hydra.ext.haskell.utils.simpleValueBinding(`hname_`)(hterm)(bindings)
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Map[hydra.core.Name, scala.collection.immutable.Set[hydra.classes.TypeClass]],
        ...
        {
        val combinedClasses: Map[hydra.core.Name, scala.collection.immutable.Set[hydra.classes.TypeClass]] = hydra.lib.maps.union[hydra.core.Name,
           scala.collection.immutable.Set[hydra.classes.TypeClass]](schemeClasses)(explicitClasses)
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
           hydra.ext.haskell.syntax.DeclarationWithComments](hydra.ext.haskell.coder.encodeTypeWithClassAssertions(namespaces)(combinedClasses)(typ.`type`)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
          {
          val decl: hydra.ext.haskell.syntax.Declaration = hydra.ext.haskell.syntax.Declaration.typedBinding(hydra.ext.haskell.syntax.TypedBinding(hydra.ext.haskell.syntax.TypeSignature(`hname_`,
...
def toTypeDeclarationsFrom(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(elementName: hydra.core.Name)(typ: hydra.core.Type)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  val hname: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.simpleName(lname)
  def declHead(name: hydra.ext.haskell.syntax.Name)(`vars_`: Seq[hydra.core.Name]): hydra.ext.haskell.syntax.DeclarationHead =
    ...
    val h: hydra.core.Name = hydra.lib.lists.head[hydra.core.Name](`vars_`)
    val rest: Seq[hydra.core.Name] = hydra.lib.lists.tail[hydra.core.Name](`vars_`)
    val hvar: hydra.ext.haskell.syntax.Variable = hydra.ext.haskell.utils.simpleName(h)
  ...
  def newtypeCons(tname: hydra.core.Name)(`typ_`: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error],
     hydra.ext.haskell.syntax.ConstructorWithComments] =
    {
    val hname0: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.simpleName(hydra.ext.haskell.utils.newtypeAccessorName(tname))
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
       hydra.ext.haskell.syntax.ConstructorWithComments](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(`typ_`)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
      {
      val hfield: hydra.ext.haskell.syntax.FieldWithComments = hydra.ext.haskell.syntax.FieldWithComments(hydra.ext.haskell.syntax.Field(hname0, htype), None)
      val constructorName: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.simpleName(hydra.names.localNameOf(tname))
      Right(hydra.ext.haskell.syntax.ConstructorWithComments(hydra.ext.haskell.syntax.Constructor.record(hydra.ext.haskell.syntax.RecordConstructor(constructorName,
         Seq(hfield))), None))
    })
  }
  def recordCons(`lname_`: scala.Predef.String)(fields: Seq[hydra.core.FieldType]): Either[hydra.context.InContext[hydra.errors.Error],
     hydra.ext.haskell.syntax.ConstructorWithComments] =
    {
    def toField(fieldType: hydra.core.FieldType): Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.FieldWithComments] =
      ...
      val `hname_`: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.simpleName(hydra.lib.strings.cat2(hydra.formatting.decapitalize(`lname_`))(hydra.formatting.capitalize(fname)))
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
         hydra.ext.haskell.syntax.FieldWithComments](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(ftype)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[scala.Predef.String],
           hydra.ext.haskell.syntax.FieldWithComments](hydra.annotations.getTypeDescription(cx)(g)(ftype))((comments: Option[scala.Predef.String]) =>
        Right(hydra.ext.haskell.syntax.FieldWithComments(hydra.ext.haskell.syntax.Field(`hname_`, htype), comments))))
    }
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.FieldWithComments],
       hydra.ext.haskell.syntax.ConstructorWithComments](hydra.lib.eithers.mapList[hydra.core.FieldType,
       hydra.ext.haskell.syntax.FieldWithComments, hydra.context.InContext[hydra.errors.Error]](toField)(fields))((hFields: Seq[hydra.ext.haskell.syntax.FieldWithComments]) =>
      Right(hydra.ext.haskell.syntax.ConstructorWithComments(hydra.ext.haskell.syntax.Constructor.record(hydra.ext.haskell.syntax.RecordConstructor(hydra.ext.haskell.utils.simpleName(`lname_`),
         hFields)), None)))
  }
  def unionCons(`boundNames_`: scala.collection.immutable.Set[hydra.core.Name])(`lname_`: scala.Predef.String)(fieldType: hydra.core.FieldType): Either[hydra.context.InContext[hydra.errors.Error],
     hydra.ext.haskell.syntax.ConstructorWithComments] =
    {
    val fname: hydra.core.Name = (fieldType.name)
    val ftype: hydra.core.Type = (fieldType.`type`)
    def deconflict(name: scala.Predef.String): scala.Predef.String =
      {
      val tname: hydra.core.Name = hydra.names.unqualifyName(hydra.module.QualifiedName(Some(hydra.lib.pairs.first[hydra.module.Namespace,
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[scala.Predef.String], hydra.ext.haskell.syntax.ConstructorWithComments](hydra.annotations.getTypeDescription(cx)(g)(ftype))((comments: Option[scala.Predef.String]) =>
      {
      val nm: scala.Predef.String = deconflict(hydra.lib.strings.cat2(hydra.formatting.capitalize(`lname_`))(hydra.formatting.capitalize(fname)))
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Boolean, Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.schemas.isSerializableByName(cx)(g)(elementName))((isSer: Boolean) =>
    {
    val deriv: hydra.ext.haskell.syntax.Deriving = hydra.lib.logic.ifElse[Seq[hydra.ext.haskell.syntax.Name]](isSer)(hydra.lib.lists.map[scala.Predef.String,
    ...
    val vars: Seq[hydra.core.Name] = hydra.lib.pairs.first[Seq[hydra.core.Name], hydra.core.Type](unpackResult)
    val `t_`: hydra.core.Type = hydra.lib.pairs.second[Seq[hydra.core.Name], hydra.core.Type](unpackResult)
    val hd: hydra.ext.haskell.syntax.DeclarationHead = declHead(hname)(hydra.lib.lists.reverse[hydra.core.Name](vars))
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Declaration,
      ...
      case hydra.core.Type.union(v_Type_union_rt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
         Seq[hydra.ext.haskell.syntax.ConstructorWithComments], hydra.ext.haskell.syntax.Declaration](hydra.lib.eithers.mapList[hydra.core.FieldType,
         hydra.ext.haskell.syntax.ConstructorWithComments, hydra.context.InContext[hydra.errors.Error]]((v1: hydra.core.FieldType) =>
      ...
      case hydra.core.Type.wrap(v_Type_wrap_wrapped) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
         hydra.ext.haskell.syntax.ConstructorWithComments, hydra.ext.haskell.syntax.Declaration](newtypeCons(elementName)(v_Type_wrap_wrapped))((cons: hydra.ext.haskell.syntax.ConstructorWithComments) =>
        Right(hydra.ext.haskell.syntax.Declaration.data(hydra.ext.haskell.syntax.DataDeclaration(hydra.ext.haskell.syntax.DataOrNewtype.newtype,
           Seq(), hd, Seq(cons), Seq(deriv)))))
      case _ => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type,
         hydra.ext.haskell.syntax.Declaration](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(typ)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
        Right(hydra.ext.haskell.syntax.Declaration.`type`(hydra.ext.haskell.syntax.TypeDeclaration(hd,
           htype)))))((decl: hydra.ext.haskell.syntax.Declaration) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[scala.Predef.String],
         Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.annotations.getTypeDescription(cx)(g)(typ))((comments: Option[scala.Predef.String]) =>
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.ext.haskell.syntax.DeclarationWithComments],
         Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error],
         Seq[hydra.ext.haskell.syntax.DeclarationWithComments]]](hydra.ext.haskell.coder.includeTypeDefinitions)(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
         hydra.ext.haskell.syntax.DeclarationWithComments, Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.ext.haskell.coder.typeDecl(namespaces)(elementName)(typ)(cx)(g))((`decl_`: hydra.ext.haskell.syntax.DeclarationWithComments) => Right(Seq(`decl_`))))(Right(Seq())))((tdecls: Seq[hydra.ext.haskell.syntax.DeclarationWithComments]) =>
      {
      val mainDecl: hydra.ext.haskell.syntax.DeclarationWithComments = hydra.ext.haskell.syntax.DeclarationWithComments(decl, comments)
      val `nameDecls_`: Seq[hydra.ext.haskell.syntax.DeclarationWithComments] = hydra.ext.haskell.coder.nameDecls(namespaces)(elementName)(typ)
...
def typeDecl(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName])(name: hydra.core.Name)(typ: hydra.core.Type)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Expression,
     hydra.ext.haskell.syntax.DeclarationWithComments](hydra.ext.haskell.coder.encodeTerm(0)(namespaces)(finalTerm)(cx)(g))((expr: hydra.ext.haskell.syntax.Expression) =>
    {
    val rhs: hydra.ext.haskell.syntax.RightHandSide = expr
    val hname: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.simpleName(typeNameLocal(name))
    val pat: hydra.ext.haskell.syntax.Pattern = hydra.ext.haskell.utils.applicationPattern(hname)(Seq())
    val decl: hydra.ext.haskell.syntax.Declaration = hydra.ext.haskell.syntax.Declaration.valueBinding(hydra.ext.haskell.syntax.ValueBinding.simple(hydra.ext.haskell.syntax.SimpleValueBinding(pat,
       rhs, None)))
...
def typeSchemeConstraintsToClassMap[T0](maybeConstraints: Option[Map[T0, hydra.core.TypeVariableMetadata]]): Map[T0,
  ...
  def nameToTypeClass(className: hydra.core.Name): Option[hydra.classes.TypeClass] =
    ...
    val isEq: Boolean = hydra.lib.equality.equal[scala.Predef.String](classNameStr)("equality")
    val isOrd: Boolean = hydra.lib.equality.equal[scala.Predef.String](classNameStr)("ordering")
