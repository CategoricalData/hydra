...
def adaptTypeToHaskellAndEncode[T0, T1](namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(typ: hydra.core.Type)(cx: T0)(g: T1): Either[hydra.errors.Error,
   hydra.ext.haskell.syntax.Type] =
  {
  def enc(t: hydra.core.Type): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Type] = hydra.ext.haskell.coder.encodeType(namespaces)(t)(cx)(g)
  hydra.strip.deannotateType(typ) match
    case hydra.core.Type.variable(v_Type_variable__) => enc(typ)
    case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.core.Type, hydra.ext.haskell.syntax.Type](hydra.adapt.adaptTypeForLanguage(hydra.ext.haskell.language.haskellLanguage)(typ))((adaptedType: hydra.core.Type) => enc(adaptedType))
}
...
def constructModule(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(mod: hydra.packaging.Module)(defs: Seq[hydra.packaging.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.errors.Error,
   hydra.ext.haskell.syntax.Module] =
  {
  def h(namespace: hydra.packaging.Namespace): scala.Predef.String = namespace
  def createDeclarations(`def`: hydra.packaging.Definition): Either[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.DeclarationWithComments]] =
    `def` match
  ...
  lazy val standardImports: Seq[hydra.ext.haskell.syntax.Import] = {
    def toImport(triple: Tuple2[Tuple2[scala.Predef.String, Option[scala.Predef.String]], Seq[scala.Predef.String]]): hydra.ext.haskell.syntax.Import =
      ...
      lazy val spec: Option[hydra.ext.haskell.syntax.SpecImport] = hydra.lib.logic.ifElse[Option[hydra.ext.haskell.syntax.SpecImport]](hydra.lib.lists.`null`[scala.Predef.String](hidden))(None)(Some(hydra.ext.haskell.syntax.SpecImport.hiding(hydra.lib.lists.map[scala.Predef.String,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, Seq[Seq[hydra.ext.haskell.syntax.DeclarationWithComments]],
     ...
     hydra.errors.Error](createDeclarations)(defs))((declLists: Seq[Seq[hydra.ext.haskell.syntax.DeclarationWithComments]]) =>
    {
...
def encodeCaseExpression[T0](depth: Int)(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(stmt: hydra.core.CaseStatement)(scrutinee: hydra.ext.haskell.syntax.Expression)(cx: T0)(g: hydra.graph.Graph): Either[hydra.errors.Error,
  ...
  def toAlt(fieldMap: Map[hydra.core.Name, hydra.core.FieldType])(field: hydra.core.Field): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Alternative] =
    {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Pattern], hydra.ext.haskell.syntax.Alternative](hydra.lib.maybes.cases[hydra.core.FieldType,
       Either[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Pattern]]](hydra.lib.maps.lookup[hydra.core.Name,
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.CaseRhs, hydra.ext.haskell.syntax.Alternative](hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.CaseRhs, hydra.errors.Error]((x: hydra.ext.haskell.syntax.Expression) => x)(hydra.ext.haskell.coder.encodeTerm(hydra.lib.math.add(depth)(1))(namespaces)(rhsTerm)(cx)(g)))((rhs: hydra.ext.haskell.syntax.CaseRhs) => Right(hydra.ext.haskell.syntax.Alternative(lhs,
         rhs, None)))
    })
  }
  hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.core.FieldType], hydra.ext.haskell.syntax.Expression](hydra.resolution.requireUnionType(cx)(g)(dn))((rt: Seq[hydra.core.FieldType]) =>
    {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Alternative], hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Field,
       hydra.ext.haskell.syntax.Alternative, hydra.errors.Error]((v1: hydra.core.Field) => toAlt(fieldMap)(v1))(fields))((ecases: Seq[hydra.ext.haskell.syntax.Alternative]) =>
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Alternative], hydra.ext.haskell.syntax.Expression](hydra.lib.maybes.cases[hydra.core.Term,
         Either[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Alternative]]](`def`)(Right(Seq()))((d: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.CaseRhs, Seq[hydra.ext.haskell.syntax.Alternative]](hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.CaseRhs, hydra.errors.Error]((x: hydra.ext.haskell.syntax.Expression) => x)(hydra.ext.haskell.coder.encodeTerm(depth)(namespaces)(d)(cx)(g)))((cs: hydra.ext.haskell.syntax.CaseRhs) =>
      {
...
def encodeFunction[T0](depth: Int)(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(fun: hydra.core.Function)(cx: T0)(g: hydra.graph.Graph): Either[hydra.errors.Error,
   hydra.ext.haskell.syntax.Expression] =
  fun match
  case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
    ...
    case hydra.core.Elimination.union(v_Elimination_union_stmt) => hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
       hydra.ext.haskell.syntax.Expression, hydra.errors.Error]((v1: hydra.ext.haskell.syntax.Expression) =>
  ...
  case hydra.core.Function.lambda(v_Function_lambda_lam) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](hydra.ext.haskell.coder.encodeTerm(depth)(namespaces)(body)(cx)(g))((hbody: hydra.ext.haskell.syntax.Expression) =>
      Right(hydra.ext.haskell.utils.hslambda(hydra.ext.haskell.utils.elementReference(namespaces)(v))(hbody)))
  }

def encodeLiteral[T0](l: hydra.core.Literal)(cx: T0): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression] =
  l match
...
def encodeTerm[T0](depth: Int)(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(term: hydra.core.Term)(cx: T0)(g: hydra.graph.Graph): Either[hydra.errors.Error,
   hydra.ext.haskell.syntax.Expression] =
  {
  def encode(t: hydra.core.Term): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression] = hydra.ext.haskell.coder.encodeTerm(depth)(namespaces)(t)(cx)(g)
  def nonemptyMap(m: Map[hydra.core.Term, hydra.core.Term]): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression] =
    {
    lazy val lhs: hydra.ext.haskell.syntax.Expression = hydra.ext.haskell.utils.hsvar("M.fromList")
    def encodePair(pair: Tuple2[hydra.core.Term, hydra.core.Term]): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression] =
      {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(k))((hk: hydra.ext.haskell.syntax.Expression) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(v))((hv: hydra.ext.haskell.syntax.Expression) =>
        Right(hydra.ext.haskell.syntax.Expression.tuple(Seq(hk, hv)))))
    }
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.map[Seq[hydra.ext.haskell.syntax.Expression],
       hydra.ext.haskell.syntax.Expression, hydra.errors.Error]((x: Seq[hydra.ext.haskell.syntax.Expression]) => hydra.ext.haskell.syntax.Expression.list(x))(hydra.lib.eithers.mapList[Tuple2[hydra.core.Term,
       hydra.core.Term], hydra.ext.haskell.syntax.Expression, hydra.errors.Error](encodePair)(hydra.lib.maps.toList[hydra.core.Term,
       hydra.core.Term](m))))((rhs: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(lhs)(rhs)))
  }
  def nonemptySet(s: scala.collection.immutable.Set[hydra.core.Term]): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression] =
    {
  ...
  hydra.strip.deannotateTerm(term) match
      ...
      deannotatedFun match
        case hydra.core.Term.function(v_Term_function_f) => v_Term_function_f match
          case hydra.core.Function.elimination(v_Function_elimination_e) => v_Function_elimination_e match
            ...
            case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression,
               hydra.ext.haskell.syntax.Expression](encode(fun))((hfun: hydra.ext.haskell.syntax.Expression) =>
              hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(arg))((harg: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(hfun)(harg))))
          case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(fun))((hfun: hydra.ext.haskell.syntax.Expression) =>
            hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(arg))((harg: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(hfun)(harg))))
        case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(fun))((hfun: hydra.ext.haskell.syntax.Expression) =>
          hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(arg))((harg: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(hfun)(harg))))
    }
    case hydra.core.Term.either(v_Term_either_e) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term,
       Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression]]((l: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(l))((hl: hydra.ext.haskell.syntax.Expression) =>
      Right(hydra.ext.haskell.utils.hsapp(hydra.ext.haskell.utils.hsvar("Left"))(hl))))((r: hydra.core.Term) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(r))((hr: hydra.ext.haskell.syntax.Expression) =>
    ...
    case hydra.core.Term.let(v_Term_let_letTerm) => {
      ...
      def encodeBinding(binding: hydra.core.Binding): Either[hydra.errors.Error, hydra.ext.haskell.syntax.LocalBinding] =
        {
        ...
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.LocalBinding](encode(`term_`))((hexpr: hydra.ext.haskell.syntax.Expression) =>
          Right(hydra.ext.haskell.syntax.LocalBinding.value(hydra.ext.haskell.utils.simpleValueBinding(hname)(hexpr)(None))))
      }
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.LocalBinding], hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Binding,
         hydra.ext.haskell.syntax.LocalBinding, hydra.errors.Error](encodeBinding)(allBindings))((hbindings: Seq[hydra.ext.haskell.syntax.LocalBinding]) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(finalBody))((hinner: hydra.ext.haskell.syntax.Expression) =>
        Right(hydra.ext.haskell.syntax.Expression.let(hydra.ext.haskell.syntax.LetExpression(hbindings, hinner)))))
    }
    case hydra.core.Term.list(v_Term_list_els) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Expression],
       hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Term, hydra.ext.haskell.syntax.Expression,
       hydra.errors.Error](encode)(v_Term_list_els))((helems: Seq[hydra.ext.haskell.syntax.Expression]) => Right(hydra.ext.haskell.syntax.Expression.list(helems)))
    case hydra.core.Term.literal(v_Term_literal_v) => hydra.ext.haskell.coder.encodeLiteral(v_Term_literal_v)(cx)
    case hydra.core.Term.map(v_Term_map_m) => hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression]](hydra.lib.maps.`null`[hydra.core.Term,
       hydra.core.Term](v_Term_map_m))(Right(hydra.ext.haskell.utils.hsvar("M.empty")))(nonemptyMap(v_Term_map_m))
    case hydra.core.Term.maybe(v_Term_maybe_m) => hydra.lib.maybes.cases[hydra.core.Term, Either[hydra.errors.Error,
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(t))((ht: hydra.ext.haskell.syntax.Expression) =>
      Right(hydra.ext.haskell.utils.hsapp(hydra.ext.haskell.utils.hsvar("Just"))(ht))))
    case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression,
       hydra.ext.haskell.syntax.Expression](encode(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((f: hydra.ext.haskell.syntax.Expression) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(hydra.lib.pairs.second[hydra.core.Term,
         hydra.core.Term](v_Term_pair_p)))((s: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.syntax.Expression.tuple(Seq(f,
         s)))))
    case hydra.core.Term.record(v_Term_record_record) => {
      ...
      def toFieldUpdate(field: hydra.core.Field): Either[hydra.errors.Error, hydra.ext.haskell.syntax.FieldUpdate] =
        {
        lazy val fn: hydra.core.Name = (field.name)
        ...
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.FieldUpdate](encode(ft))((hft: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.syntax.FieldUpdate(fieldRef,
           hft)))
      }
      lazy val typeName: hydra.ext.haskell.syntax.Name = hydra.ext.haskell.utils.elementReference(namespaces)(sname)
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.FieldUpdate], hydra.ext.haskell.syntax.Expression](hydra.lib.eithers.mapList[hydra.core.Field,
         hydra.ext.haskell.syntax.FieldUpdate, hydra.errors.Error](toFieldUpdate)(fields))((updates: Seq[hydra.ext.haskell.syntax.FieldUpdate]) =>
    ...
    case hydra.core.Term.set(v_Term_set_s) => hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression]](hydra.lib.sets.`null`[hydra.core.Term](v_Term_set_s))(Right(hydra.ext.haskell.utils.hsvar("S.empty")))(nonemptySet(v_Term_set_s))
    ...
    case hydra.core.Term.union(v_Term_union_injection) => {
      ...
      lazy val fn: hydra.core.Name = (field.name)
      lazy val ft: hydra.core.Term = (field.term)
      lazy val lhs: hydra.ext.haskell.syntax.Expression = hydra.ext.haskell.syntax.Expression.variable(hydra.ext.haskell.utils.unionFieldReference(hydra.lib.sets.union[hydra.core.Name](hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.maps.keys[hydra.core.Name,
         hydra.core.Term](g.boundTerms)))(hydra.lib.sets.fromList[hydra.core.Name](hydra.lib.maps.keys[hydra.core.Name,
         hydra.core.TypeScheme](g.schemaTypes))))(namespaces)(sname)(fn))
      lazy val dflt: Either[hydra.errors.Error, hydra.ext.haskell.syntax.Expression] = hydra.lib.eithers.map[hydra.ext.haskell.syntax.Expression,
         hydra.ext.haskell.syntax.Expression, hydra.errors.Error]((v1: hydra.ext.haskell.syntax.Expression) => hydra.ext.haskell.utils.hsapp(lhs)(v1))(encode(ft))
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.core.Type, hydra.ext.haskell.syntax.Expression](hydra.resolution.requireUnionField(cx)(g)(sname)(fn))((ftyp: hydra.core.Type) =>
    ...
    case hydra.core.Term.wrap(v_Term_wrap_wrapped) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.Expression](encode(`term_`))((rhs: hydra.ext.haskell.syntax.Expression) => Right(hydra.ext.haskell.utils.hsapp(lhs)(rhs)))
    }
...
def encodeType[T0, T1](namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(typ: hydra.core.Type)(cx: T0)(g: T1): Either[hydra.errors.Error,
   hydra.ext.haskell.syntax.Type] =
  {
  def encode(t: hydra.core.Type): Either[hydra.errors.Error, hydra.ext.haskell.syntax.Type] = hydra.ext.haskell.coder.encodeType(namespaces)(t)(cx)(g)
  def ref[T2](name: hydra.core.Name): Either[T2, hydra.ext.haskell.syntax.Type] =
  ...
  hydra.strip.deannotateType(typ) match
    case hydra.core.Type.application(v_Type_application_app) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(lhs))((hlhs: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(rhs))((hrhs: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.either(v_Type_either_eitherType) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(`left_`))((hleft: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(`right_`))((hright: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.function(v_Type_function_funType) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(dom))((hdom: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(cod))((hcod: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.list(v_Type_list_lt) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type,
       hydra.ext.haskell.syntax.Type](encode(v_Type_list_lt))((hlt: hydra.ext.haskell.syntax.Type) => Right(hydra.ext.haskell.syntax.Type.list(hlt)))
    ...
    case hydra.core.Type.map(v_Type_map_mapType) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(kt))((hkt: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(vt))((hvt: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.maybe(v_Type_maybe_ot) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type,
       hydra.ext.haskell.syntax.Type](encode(v_Type_maybe_ot))((hot: hydra.ext.haskell.syntax.Type) =>
    ...
    case hydra.core.Type.pair(v_Type_pair_pt) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type,
       hydra.ext.haskell.syntax.Type](encode(v_Type_pair_pt.first))((f: hydra.ext.haskell.syntax.Type) =>
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](encode(v_Type_pair_pt.second))((s: hydra.ext.haskell.syntax.Type) => Right(hydra.ext.haskell.syntax.Type.tuple(Seq(f,
         s)))))
    case hydra.core.Type.record(v_Type_record__) => ref("placeholder")
    case hydra.core.Type.set(v_Type_set_st) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type,
       hydra.ext.haskell.syntax.Type](encode(v_Type_set_st))((hst: hydra.ext.haskell.syntax.Type) =>
...
def encodeTypeWithClassAssertions[T0, T1](namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(explicitClasses: Map[hydra.core.Name,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Type](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(typ)(cx)(g))((htyp: hydra.ext.haskell.syntax.Type) =>
    hydra.lib.logic.ifElse[Either[hydra.errors.Error, hydra.ext.haskell.syntax.Type]](hydra.lib.lists.`null`[Tuple2[hydra.core.Name,
       hydra.classes.TypeClass]](assertPairs))(Right(htyp))({
    lazy val encoded: Seq[hydra.ext.haskell.syntax.Assertion] = hydra.lib.lists.map[Tuple2[hydra.core.Name,
...
def moduleToHaskell(mod: hydra.packaging.Module)(defs: Seq[hydra.packaging.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Module, Map[scala.Predef.String,
     scala.Predef.String]](hydra.ext.haskell.coder.moduleToHaskellModule(mod)(defs)(cx)(g))((hsmod: hydra.ext.haskell.syntax.Module) =>
  {
...
def moduleToHaskellModule(mod: hydra.packaging.Module)(defs: Seq[hydra.packaging.Definition])(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.errors.Error,
   hydra.ext.haskell.syntax.Module] =
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName],
...
def nameDecls(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(name: hydra.core.Name)(typ: hydra.core.Type): Seq[hydra.ext.haskell.syntax.DeclarationWithComments] =
  ...
  def toDecl(n: hydra.core.Name)(pair: Tuple2[scala.Predef.String, scala.Predef.String]): hydra.ext.haskell.syntax.DeclarationWithComments =
    ...
    lazy val decl: hydra.ext.haskell.syntax.Declaration = hydra.ext.haskell.syntax.Declaration.valueBinding(hydra.ext.haskell.syntax.ValueBinding.simple(hydra.ext.haskell.syntax.SimpleValueBinding(hydra.ext.haskell.utils.applicationPattern(hydra.ext.haskell.utils.simpleName(k))(Seq()),
...
def toDataDeclaration[T0](namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(`def`: hydra.packaging.TermDefinition)(cx: T0)(g: hydra.graph.Graph): Either[hydra.errors.Error,
  ...
  def toDecl(comments: Option[scala.Predef.String])(`hname_`: hydra.ext.haskell.syntax.Name)(`term_`: hydra.core.Term)(bindings: Option[hydra.ext.haskell.syntax.LocalBindings]): Either[hydra.errors.Error,
     hydra.ext.haskell.syntax.DeclarationWithComments] =
    ...
    case hydra.core.Term.let(v_Term_let_letTerm) => {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Expression], hydra.ext.haskell.syntax.DeclarationWithComments](hydra.lib.eithers.mapList[hydra.core.Term,
         hydra.ext.haskell.syntax.Expression, hydra.errors.Error]((t: hydra.core.Term) => hydra.ext.haskell.coder.encodeTerm(0)(namespaces)(t)(cx)(g))(terms))((hterms: Seq[hydra.ext.haskell.syntax.Expression]) =>
        {
        lazy val hbindings: Seq[hydra.ext.haskell.syntax.LocalBinding] = hydra.lib.lists.zipWith[hydra.ext.haskell.syntax.Name,
           hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.LocalBinding](toTermDefinition)(hnames)(hterms)
        lazy val prevBindings: Seq[hydra.ext.haskell.syntax.LocalBinding] = hydra.lib.maybes.maybe[Seq[hydra.ext.haskell.syntax.LocalBinding],
    ...
    case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.DeclarationWithComments](hydra.ext.haskell.coder.encodeTerm(0)(namespaces)(`term_`)(cx)(g))((hterm: hydra.ext.haskell.syntax.Expression) =>
      {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, Map[hydra.core.Name, scala.collection.immutable.Set[hydra.classes.TypeClass]],
           ...
           scala.collection.immutable.Set[hydra.classes.TypeClass]](schemeClasses)(explicitClasses)
        {
          ...
          hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.DeclarationWithComments](hydra.ext.haskell.coder.encodeTypeWithClassAssertions(namespaces)(combinedClasses)(schemeType)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
            {
            lazy val decl: hydra.ext.haskell.syntax.Declaration = hydra.ext.haskell.syntax.Declaration.typedBinding(hydra.ext.haskell.syntax.TypedBinding(hydra.ext.haskell.syntax.TypeSignature(`hname_`,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, Option[scala.Predef.String], hydra.ext.haskell.syntax.DeclarationWithComments](hydra.annotations.getTermDescription(cx)(g)(term))((comments: Option[scala.Predef.String]) => toDecl(comments)(hname)(term)(None))
}

def toTypeDeclarationsFrom(namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(elementName: hydra.core.Name)(typ: hydra.core.Type)(cx: hydra.context.Context)(g: hydra.graph.Graph): Either[hydra.errors.Error,
  ...
  def newtypeCons(tname: hydra.core.Name)(`typ_`: hydra.core.Type): Either[hydra.errors.Error, hydra.ext.haskell.syntax.ConstructorWithComments] =
    {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.ConstructorWithComments](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(`typ_`)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
      {
      lazy val hfield: hydra.ext.haskell.syntax.FieldWithComments = hydra.ext.haskell.syntax.FieldWithComments(hydra.ext.haskell.syntax.Field(hname0,
         htype), None)
  ...
  def recordCons(`lname_`: scala.Predef.String)(fields: Seq[hydra.core.FieldType]): Either[hydra.errors.Error,
    ...
    {
    def toField(fieldType: hydra.core.FieldType): Either[hydra.errors.Error, hydra.ext.haskell.syntax.FieldWithComments] =
      {
      lazy val fname: hydra.core.Name = (fieldType.name)
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.FieldWithComments](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(ftype)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
        hydra.lib.eithers.bind[hydra.errors.Error, Option[scala.Predef.String], hydra.ext.haskell.syntax.FieldWithComments](hydra.annotations.getTypeDescription(cx)(g)(ftype))((comments: Option[scala.Predef.String]) =>
        Right(hydra.ext.haskell.syntax.FieldWithComments(hydra.ext.haskell.syntax.Field(`hname_`, htype), comments))))
    }
    hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.FieldWithComments], hydra.ext.haskell.syntax.ConstructorWithComments](hydra.lib.eithers.mapList[hydra.core.FieldType,
       hydra.ext.haskell.syntax.FieldWithComments, hydra.errors.Error](toField)(fields))((hFields: Seq[hydra.ext.haskell.syntax.FieldWithComments]) =>
  ...
  def unionCons(`boundNames_`: scala.collection.immutable.Set[hydra.core.Name])(`lname_`: scala.Predef.String)(fieldType: hydra.core.FieldType): Either[hydra.errors.Error,
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, Option[scala.Predef.String], hydra.ext.haskell.syntax.ConstructorWithComments](hydra.annotations.getTypeDescription(cx)(g)(ftype))((comments: Option[scala.Predef.String]) =>
      {
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.Type], hydra.ext.haskell.syntax.ConstructorWithComments](hydra.lib.logic.ifElse[Either[hydra.errors.Error,
         Seq[hydra.ext.haskell.syntax.Type]]](hydra.lib.equality.equal[hydra.core.Type](hydra.strip.deannotateType(ftype))(hydra.core.Type.unit))(Right(Seq()))(hydra.lib.eithers.bind[hydra.errors.Error,
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, Boolean, Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.predicates.isSerializableByName(cx)(g)(elementName))((isSer: Boolean) =>
    {
    ...
    hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Declaration, Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.strip.deannotateType(`t_`) match
      case hydra.core.Type.record(v_Type_record_rt) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.ConstructorWithComments,
         hydra.ext.haskell.syntax.Declaration](recordCons(lname)(v_Type_record_rt))((cons: hydra.ext.haskell.syntax.ConstructorWithComments) =>
      ...
      case hydra.core.Type.union(v_Type_union_rt) => hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.ConstructorWithComments],
      ...
      case hydra.core.Type.wrap(v_Type_wrap_wrapped) => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.ConstructorWithComments,
         hydra.ext.haskell.syntax.Declaration](newtypeCons(elementName)(v_Type_wrap_wrapped))((cons: hydra.ext.haskell.syntax.ConstructorWithComments) =>
        Right(hydra.ext.haskell.syntax.Declaration.data(hydra.ext.haskell.syntax.DataDeclaration(hydra.ext.haskell.syntax.DataOrNewtype.newtype,
           Seq(), hd, Seq(cons), Seq(deriv)))))
      case _ => hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.Declaration](hydra.ext.haskell.coder.adaptTypeToHaskellAndEncode(namespaces)(typ)(cx)(g))((htype: hydra.ext.haskell.syntax.Type) =>
      ...
      hydra.lib.eithers.bind[hydra.errors.Error, Option[scala.Predef.String], Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.annotations.getTypeDescription(cx)(g)(typ))((comments: Option[scala.Predef.String]) =>
      hydra.lib.eithers.bind[hydra.errors.Error, Seq[hydra.ext.haskell.syntax.DeclarationWithComments],
         Seq[hydra.ext.haskell.syntax.DeclarationWithComments]](hydra.lib.logic.ifElse[Either[hydra.errors.Error,
         Seq[hydra.ext.haskell.syntax.DeclarationWithComments]]](hydra.ext.haskell.coder.includeTypeDefinitions)(hydra.lib.eithers.bind[hydra.errors.Error,
...
def typeDecl[T0](namespaces: hydra.packaging.Namespaces[hydra.ext.haskell.syntax.ModuleName])(name: hydra.core.Name)(typ: hydra.core.Type)(cx: T0)(g: hydra.graph.Graph): Either[hydra.errors.Error,
   hydra.ext.haskell.syntax.DeclarationWithComments] =
  {
  ...
  hydra.lib.eithers.bind[hydra.errors.Error, hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.DeclarationWithComments](hydra.ext.haskell.coder.encodeTerm(0)(namespaces)(finalTerm)(cx)(g))((expr: hydra.ext.haskell.syntax.Expression) =>
    {
    ...
    lazy val decl: hydra.ext.haskell.syntax.Declaration = hydra.ext.haskell.syntax.Declaration.valueBinding(hydra.ext.haskell.syntax.ValueBinding.simple(hydra.ext.haskell.syntax.SimpleValueBinding(pat,
       rhs, None)))
