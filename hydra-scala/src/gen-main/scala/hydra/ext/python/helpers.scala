...
case class PythonEnvironment(namespaces: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName],
   ...
   graph: hydra.graph.Graph, nullaryBindings: scala.collection.immutable.Set[hydra.core.Name], version: hydra.ext.python.helpers.PythonVersion,
...
case class PyGraph(graph: hydra.graph.Graph, metadata: hydra.ext.python.helpers.PythonModuleMetadata)
