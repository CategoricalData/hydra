...
val pythonLanguage: hydra.coders.Language = {
  ...
  val termVariants: scala.collection.immutable.Set[hydra.variants.TermVariant] = hydra.lib.sets.fromList[hydra.variants.TermVariant](Seq(hydra.variants.TermVariant.annotated,
...
val pythonReservedWords: scala.collection.immutable.Set[scala.Predef.String] = {
  val pythonKeywords: Seq[scala.Predef.String] = Seq("False", "None", "True", "and", "as", "assert", "async",
  ...
  val pythonBuiltInFunctions: Seq[scala.Predef.String] = Seq("range")
  val hydraPythonKeywords: Seq[scala.Predef.String] = Seq("Node", "FrozenDict")
