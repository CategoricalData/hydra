...
def encodeAnnotatedRhs(arhs: hydra.ext.python.syntax.AnnotatedRhs): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.AnnotatedRhs.`yield`(_) => hydra.serialization.cst("yield ...")))
...
def encodeAssignment(a: hydra.ext.python.syntax.Assignment): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.Assignment.aug(_) => hydra.serialization.cst("... += ...")
...
def encodeAtom(atom: hydra.ext.python.syntax.Atom): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.Atom.dictcomp(_) => hydra.serialization.cst("{...}")
  ...
  case hydra.ext.python.syntax.Atom.genexp(_) => hydra.serialization.cst("(...)")
  ...
  case hydra.ext.python.syntax.Atom.listcomp(_) => hydra.serialization.cst("[...]")
  ...
  case hydra.ext.python.syntax.Atom.setcomp(_) => hydra.serialization.cst("{...}")
...
def encodeClosedPattern(cp: hydra.ext.python.syntax.ClosedPattern): hydra.ast.Expr =
  cp match
  case hydra.ext.python.syntax.ClosedPattern.literal(_) => hydra.serialization.cst("...")
  ...
  case hydra.ext.python.syntax.ClosedPattern.group(_) => hydra.serialization.cst("(...)")
  case hydra.ext.python.syntax.ClosedPattern.sequence(_) => hydra.serialization.cst("[...]")
  case hydra.ext.python.syntax.ClosedPattern.mapping(_) => hydra.serialization.cst("{...}")
...
def encodeCompoundStatement(cs: hydra.ext.python.syntax.CompoundStatement): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.CompoundStatement.`if`(_) => hydra.serialization.cst("if ...")
  ...
  case hydra.ext.python.syntax.CompoundStatement.`with`(_) => hydra.serialization.cst("with ...")
  case hydra.ext.python.syntax.CompoundStatement.`for`(_) => hydra.serialization.cst("for ...")
  case hydra.ext.python.syntax.CompoundStatement.`try`(_) => hydra.serialization.cst("try ...")
...
def encodeGroup(g: hydra.ext.python.syntax.Group): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.Group.`yield`(_) => hydra.serialization.cst("(yield ...)")
...
def encodeLambdaStarEtc(lse: hydra.ext.python.syntax.LambdaStarEtc): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.LambdaStarEtc.star(_) => hydra.serialization.cst("*...")
  case hydra.ext.python.syntax.LambdaStarEtc.paramMaybeDefault(_) => hydra.serialization.cst("...")
  case hydra.ext.python.syntax.LambdaStarEtc.kwds(_) => hydra.serialization.cst("**...")
...
def encodeParameters(p: hydra.ext.python.syntax.Parameters): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.Parameters.slashNoDefault(_) => hydra.serialization.cst("...")
  case hydra.ext.python.syntax.Parameters.slashWithDefault(_) => hydra.serialization.cst("...")
...
def encodePattern(p: hydra.ext.python.syntax.Pattern): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.Pattern.as(_) => hydra.serialization.cst("... as ...")
...
def encodePatterns(ps: hydra.ext.python.syntax.Patterns): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.Patterns.sequence(_) => hydra.serialization.cst("...")
...
def encodePrimaryRhs(rhs: hydra.ext.python.syntax.PrimaryRhs): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.PrimaryRhs.genexp(_) => hydra.serialization.cst("[...]")
...
def encodeSimpleStatement(ss: hydra.ext.python.syntax.SimpleStatement): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.SimpleStatement.assert(_) => hydra.serialization.cst("assert ...")
  case hydra.ext.python.syntax.SimpleStatement.global(_) => hydra.serialization.cst("global ...")
  case hydra.ext.python.syntax.SimpleStatement.nonlocal(_) => hydra.serialization.cst("nonlocal ...")
  case hydra.ext.python.syntax.SimpleStatement.del(_) => hydra.serialization.cst("del ...")
...
def encodeSingleTarget(st: hydra.ext.python.syntax.SingleTarget): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.SingleTarget.parens(_) => hydra.serialization.cst("(...)")
  case hydra.ext.python.syntax.SingleTarget.subscriptAttributeTarget(_) => hydra.serialization.cst("...")
...
def encodeSlice(s: hydra.ext.python.syntax.Slice): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.Slice.`slice_`(_) => hydra.serialization.cst(":")
...
def encodeStarAtom(sa: hydra.ext.python.syntax.StarAtom): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.StarAtom.targetWithStarAtom(_) => hydra.serialization.cst("(...)")
  case hydra.ext.python.syntax.StarAtom.starTargetsTupleSeq(_) => hydra.serialization.cst("(...)")
  case hydra.ext.python.syntax.StarAtom.starTargetsListSeq(_) => hydra.serialization.cst("[...]")
...
def encodeSubjectExpression(se: hydra.ext.python.syntax.SubjectExpression): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.SubjectExpression.tuple(_) => hydra.serialization.cst("*...")
...
def encodeTargetWithStarAtom(t: hydra.ext.python.syntax.TargetWithStarAtom): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.TargetWithStarAtom.slices(_) => hydra.serialization.cst("...")
...
def encodeTPrimary(tp: hydra.ext.python.syntax.TPrimary): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.TPrimary.primaryAndSlices(_) => hydra.serialization.cst("...")
  case hydra.ext.python.syntax.TPrimary.primaryAndGenexp(_) => hydra.serialization.cst("...")
  case hydra.ext.python.syntax.TPrimary.primaryAndArguments(_) => hydra.serialization.cst("...")
...
def encodeTypeParameter(tp: hydra.ext.python.syntax.TypeParameter): hydra.ast.Expr =
  ...
  case hydra.ext.python.syntax.TypeParameter.star(_) => hydra.serialization.cst("*...")
  case hydra.ext.python.syntax.TypeParameter.doubleStar(_) => hydra.serialization.cst("**...")
