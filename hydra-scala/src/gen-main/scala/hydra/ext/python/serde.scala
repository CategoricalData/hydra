...
def encodeFunctionDefRaw(fdr: hydra.ext.python.syntax.FunctionDefRaw): hydra.ast.Expr =
  ...
  lazy val tparamPart: Option[hydra.ast.Expr] = hydra.lib.logic.ifElse[Option[hydra.ast.Expr]](hydra.lib.lists.`null`[hydra.ext.python.syntax.TypeParameter](tparams))(None)(Some(hydra.serialization.bracketList(hydra.serialization.inlineStyle)(hydra.lib.lists.map[hydra.ext.python.syntax.TypeParameter,
     hydra.ast.Expr](hydra.ext.python.serde.encodeTypeParameter)(tparams))))
  lazy val paramPart: Option[hydra.ast.Expr] = hydra.lib.maybes.map[hydra.ext.python.syntax.Parameters,
     hydra.ast.Expr](hydra.ext.python.serde.encodeParameters)(params)
...
def encodeImportFrom(`if_`: hydra.ext.python.syntax.ImportFrom): hydra.ast.Expr =
  ...
  lazy val lhs: hydra.ast.Expr = hydra.serialization.noSep(hydra.lib.maybes.cat[hydra.ast.Expr](hydra.lib.lists.concat[Option[hydra.ast.Expr]](Seq(hydra.lib.lists.map[hydra.ext.python.syntax.RelativeImportPrefix,
...
def encodeTypeAlias(ta: hydra.ext.python.syntax.TypeAlias): hydra.ast.Expr =
  ...
  lazy val alias: hydra.ast.Expr = hydra.serialization.noSep(hydra.lib.maybes.cat[hydra.ast.Expr](Seq(Some(hydra.ext.python.serde.encodeName(name)),
