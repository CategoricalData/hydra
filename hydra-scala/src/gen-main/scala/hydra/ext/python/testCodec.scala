...
def emptyPythonModuleMetadata(`ns_`: hydra.module.Namespace): hydra.ext.python.helpers.PythonModuleMetadata =
  hydra.ext.python.helpers.PythonModuleMetadata(hydra.module.Namespaces(Tuple2(`ns_`, hydra.ext.python.names.encodeNamespace(`ns_`)),
     hydra.lib.maps.empty[hydra.module.Namespace, hydra.ext.python.syntax.DottedName]), hydra.lib.sets.empty[hydra.core.Name],
...
def termToPythonWithContext[T0](`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName])(graph0: hydra.graph.Graph)(skipCasts: Boolean)(term: hydra.core.Term)(_g: T0): Either[scala.Predef.String,
   scala.Predef.String] =
  hydra.lib.eithers.bimap[hydra.context.InContext[hydra.error.Error], hydra.ext.python.syntax.Expression,
     scala.Predef.String, scala.Predef.String]((ic: hydra.context.InContext[hydra.error.Error]) => hydra.show.error.error(ic.`object`))((`arg_`: hydra.ext.python.syntax.Expression) =>
  hydra.serialization.printExpr(hydra.ext.python.serde.encodeExpression(`arg_`)))(hydra.ext.python.coder.encodeTermInline(hydra.lexical.emptyContext)(hydra.ext.python.helpers.PythonEnvironment(`namespaces_`,
     Tuple2(Seq(), hydra.lib.maps.empty[hydra.core.Name, hydra.ext.python.syntax.Name]), graph0, hydra.lib.sets.empty[hydra.core.Name],
     hydra.ext.python.utils.targetPythonVersion, skipCasts, hydra.lib.sets.empty[hydra.core.Name]))(skipCasts)(term))
...
def typeToPython(`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName])(typ: hydra.core.Type)(g: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  hydra.serialization.printExpr(hydra.ext.python.serde.encodeExpression(`arg_`)))(hydra.ext.python.coder.encodeType(hydra.ext.python.helpers.PythonEnvironment(`namespaces_`,
     Tuple2(Seq(), hydra.lib.maps.empty[hydra.core.Name, hydra.ext.python.syntax.Name]), g, hydra.lib.sets.empty[hydra.core.Name],
     hydra.ext.python.utils.targetPythonVersion, false, hydra.lib.sets.empty[hydra.core.Name]))(typ))
...
def findPythonImports[T0, T1](`namespaces_`: hydra.module.Namespaces[T0])(`names_`: T1): Seq[scala.Predef.String] =
  ...
  val filtered: Map[hydra.module.Namespace, T0] = hydra.lib.maps.filterWithKey[hydra.module.Namespace, T0]((`ns_`: hydra.module.Namespace) =>
    (_v: T0) =>
...
def namespacesForPythonModule[T0](mod: hydra.module.Module)(`graph_`: hydra.graph.Graph): Either[T0, hydra.module.Namespaces[hydra.ext.python.syntax.DottedName]] =
  ...
  val defs: Seq[hydra.module.Definition] = hydra.lib.maybes.mapMaybe[hydra.core.Binding, hydra.module.Definition]((b: hydra.core.Binding) =>
...
def generatePythonTestGroupHierarchy[T0](g: hydra.graph.Graph)(`namespaces_`: T0)(codec: hydra.testing.TestCodec)(groupPath: Seq[scala.Predef.String])(testGroup: hydra.testing.TestGroup): Either[scala.Predef.String,
  ...
  hydra.lib.eithers.bind[scala.Predef.String, Seq[Seq[scala.Predef.String]], scala.Predef.String](hydra.lib.eithers.mapList[hydra.testing.TestCaseWithMetadata,
    ...
    hydra.lib.eithers.bind[scala.Predef.String, Seq[scala.Predef.String], scala.Predef.String](hydra.lib.eithers.mapList[hydra.testing.TestGroup,
    ...
    hydra.lib.eithers.map[scala.Predef.String, scala.Predef.String, scala.Predef.String]((content: scala.Predef.String) => hydra.lib.strings.cat(Seq(header,
       "\n\n", content)))(hydra.ext.python.testCodec.generatePythonTestGroupHierarchy(g)(`namespaces_`)(codec)(hydra.lib.lists.concat2[scala.Predef.String](groupPath)(Seq(groupName)))(subgroup))
    ...
    val subgroupsStr: scala.Predef.String = hydra.lib.strings.intercalate("\n\n")(subgroupBlocks)
...
def generatePythonTestCase[T0](g: hydra.graph.Graph)(`namespaces_`: T0)(codec: hydra.testing.TestCodec)(groupPath: Seq[scala.Predef.String])(tcm: hydra.testing.TestCaseWithMetadata): Either[scala.Predef.String,
  ...
  tcase match
    case hydra.testing.TestCase.delegatedEvaluation(v_TestCase_delegatedEvaluation_delCase) => {
      ...
      val fullName: scala.Predef.String = hydra.lib.logic.ifElse[scala.Predef.String](hydra.lib.lists.`null`[scala.Predef.String](groupPath))(`name_`)(hydra.lib.strings.intercalate("__")(hydra.lib.lists.concat2[scala.Predef.String](groupPath)(Seq(`name_`))))
...
def generateTestFileWithPythonCodec[T0](codec: hydra.testing.TestCodec)(testModule: hydra.module.Module)(testGroup: hydra.testing.TestGroup)(`namespaces_`: T0)(g: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  val dirParts: Seq[scala.Predef.String] = hydra.lib.lists.init[scala.Predef.String](parts)
  val fileName: scala.Predef.String = hydra.lib.strings.cat(Seq("test_", hydra.lib.lists.last[scala.Predef.String](parts), ".py"))
...
def generatePythonTestFile(testModule: hydra.module.Module)(testGroup: hydra.testing.TestGroup)(g: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  hydra.lib.eithers.bind[scala.Predef.String, hydra.module.Namespaces[hydra.ext.python.syntax.DottedName],
     Tuple2[scala.Predef.String, scala.Predef.String]](hydra.ext.python.testCodec.namespacesForPythonModule(testModule)(g))((`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName]) =>
