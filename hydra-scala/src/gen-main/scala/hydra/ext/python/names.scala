...
def encodeName(isQualified: Boolean)(conv: hydra.util.CaseConvention)(env: hydra.ext.python.helpers.PythonEnvironment)(name: hydra.core.Name): hydra.ext.python.syntax.Name =
  ...
  val focusNs: hydra.module.Namespace = hydra.lib.pairs.first[hydra.module.Namespace, hydra.ext.python.syntax.DottedName](focusPair)
  val boundVars: Map[hydra.core.Name, hydra.ext.python.syntax.Name] = hydra.lib.pairs.second[Seq[hydra.core.Name],
...
def variableReference(conv: hydra.util.CaseConvention)(quoted: Boolean)(env: hydra.ext.python.helpers.PythonEnvironment)(name: hydra.core.Name): hydra.ext.python.syntax.Expression =
  ...
  val sameNamespace: Boolean = hydra.lib.maybes.maybe[Boolean, hydra.module.Namespace](false)((ns: hydra.module.Namespace) =>
