...
def encodeName(isQualified: Boolean)(conv: hydra.util.CaseConvention)(env: hydra.ext.python.environment.PythonEnvironment)(name: hydra.core.Name): hydra.ext.python.syntax.Name =
  ...
  hydra.lib.logic.ifElse[hydra.ext.python.syntax.Name](isQualified)(hydra.lib.maybes.maybe[hydra.ext.python.syntax.Name, hydra.ext.python.syntax.Name](hydra.lib.logic.ifElse[hydra.ext.python.syntax.Name](hydra.lib.equality.equal[Option[hydra.module.Namespace]](mns)(Some(focusNs)))(hydra.lib.logic.ifElse[scala.Predef.String](hydra.ext.python.names.useFutureAnnotations)(pyLocal)(hydra.ext.python.serde.escapePythonString(true)(pyLocal)))(hydra.lib.maybes.maybe[hydra.ext.python.syntax.Name, hydra.module.Namespace](pyLocal)((nsVal: hydra.module.Namespace) =>
    hydra.lib.strings.cat2(pyNs(nsVal))(hydra.lib.strings.cat2(".")(pyLocal)))(mns)))((n: hydra.ext.python.syntax.Name) => n)(hydra.lib.maps.lookup[hydra.core.Name, hydra.ext.python.syntax.Name](name)(boundVars)))(pyLocal)
}
...
def variableReference(conv: hydra.util.CaseConvention)(quoted: Boolean)(env: hydra.ext.python.environment.PythonEnvironment)(name: hydra.core.Name): hydra.ext.python.syntax.Expression =
  ...
  lazy val unquoted: hydra.ext.python.syntax.Expression = hydra.ext.python.syntax.Expression.simple(Seq(Seq(hydra.ext.python.syntax.Inversion.simple(hydra.ext.python.syntax.Comparison(hydra.ext.python.syntax.BitwiseOr(None, hydra.ext.python.syntax.BitwiseXor(None, hydra.ext.python.syntax.BitwiseAnd(None, hydra.ext.python.syntax.ShiftExpression(None, hydra.ext.python.syntax.Sum(None, hydra.ext.python.syntax.Term(None, hydra.ext.python.syntax.Factor.simple(hydra.ext.python.syntax.Power(hydra.ext.python.syntax.AwaitPrimary(false, hydra.ext.python.syntax.Primary.simple(hydra.ext.python.syntax.Atom.name(pyName))), None)))))))), Seq())))))
  lazy val namespaces: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName] = (env.namespaces)
  lazy val focusPair: Tuple2[hydra.module.Namespace, hydra.ext.python.syntax.DottedName] = (namespaces.focus)
  lazy val focusNs: hydra.module.Namespace = hydra.lib.pairs.first[hydra.module.Namespace, hydra.ext.python.syntax.DottedName](focusPair)
  ...
  hydra.lib.logic.ifElse[hydra.ext.python.syntax.Expression](hydra.lib.logic.and(quoted)(sameNamespace))(hydra.ext.python.syntax.Expression.simple(Seq(Seq(hydra.ext.python.syntax.Inversion.simple(hydra.ext.python.syntax.Comparison(hydra.ext.python.syntax.BitwiseOr(None, hydra.ext.python.syntax.BitwiseXor(None, hydra.ext.python.syntax.BitwiseAnd(None, hydra.ext.python.syntax.ShiftExpression(None, hydra.ext.python.syntax.Sum(None, hydra.ext.python.syntax.Term(None, hydra.ext.python.syntax.Factor.simple(hydra.ext.python.syntax.Power(hydra.ext.python.syntax.AwaitPrimary(false, hydra.ext.python.syntax.Primary.simple(hydra.ext.python.syntax.Atom.string(hydra.ext.python.syntax.String(pyName, hydra.ext.python.syntax.QuoteStyle.double)))), None)))))))), Seq()))))))(unquoted)
}
