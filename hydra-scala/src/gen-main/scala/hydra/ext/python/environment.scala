...
case class PythonEnvironment(namespaces: hydra.packaging.Namespaces[hydra.ext.python.syntax.DottedName],
...
case class PythonModuleMetadata(namespaces: hydra.packaging.Namespaces[hydra.ext.python.syntax.DottedName],
