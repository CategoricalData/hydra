...
def pythonTestCodec(`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName]): hydra.testing.TestCodec =
  ...
  (v2: hydra.graph.Graph) =>
  hydra.ext.python.testCodec.typeToPython(`namespaces_`)(v1)(v2), hydra.ext.python.testCodec.formatPythonTestName, hydra.ext.python.testCodec.namespaceToPythonModuleName, hydra.ext.python.testCodec.pythonTestCaseTemplate, hydra.ext.python.testCodec.pythonTestGroupTemplate, hydra.ext.python.testCodec.pythonModuleTemplate, hydra.ext.python.testCodec.pythonImportTemplate, (v1: scala.collection.immutable.Set[hydra.core.Name]) =>
...
def generateTestFileWithPythonCodec[T0](codec: hydra.testing.TestCodec)(testModule: hydra.module.Module)(testGroup: hydra.testing.TestGroup)(`namespaces_`: T0)(g: hydra.graph.Graph): Either[scala.Predef.String, Tuple2[scala.Predef.String, scala.Predef.String]] =
  ...
  {
  lazy val testModuleContent: scala.Predef.String = hydra.ext.python.testCodec.buildPythonTestModule(codec)(testModule)(testGroup)(testBody)(`namespaces_`)
...
def generatePythonTestFile(testModule: hydra.module.Module)(testGroup: hydra.testing.TestGroup)(g: hydra.graph.Graph): Either[scala.Predef.String, Tuple2[scala.Predef.String, scala.Predef.String]] =
  ...
  hydra.lib.eithers.bind[scala.Predef.String, hydra.module.Namespaces[hydra.ext.python.syntax.DottedName], Tuple2[scala.Predef.String, scala.Predef.String]](hydra.ext.python.testCodec.namespacesForPythonModule(testModule)(g))((`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName]) =>
