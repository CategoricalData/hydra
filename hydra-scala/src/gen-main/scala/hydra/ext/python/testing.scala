...
def emptyPythonModuleMetadata(`ns_`: hydra.module.Namespace): hydra.ext.python.environment.PythonModuleMetadata =
  hydra.ext.python.environment.PythonModuleMetadata(hydra.module.Namespaces(Tuple2(`ns_`, hydra.ext.python.names.encodeNamespace(`ns_`)),
...
def termToPythonWithContext[T0](`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName])(graph0: hydra.graph.Graph)(skipCasts: Boolean)(term: hydra.core.Term)(_g: T0): Either[scala.Predef.String,
   scala.Predef.String] =
  hydra.lib.eithers.bimap[hydra.context.InContext[hydra.errors.Error], hydra.ext.python.syntax.Expression,
     scala.Predef.String, scala.Predef.String]((ic: hydra.context.InContext[hydra.errors.Error]) => hydra.show.errors.error(ic.`object`))((`arg_`: hydra.ext.python.syntax.Expression) =>
  hydra.serialization.printExpr(hydra.ext.python.serde.encodeExpression(`arg_`)))(hydra.ext.python.coder.encodeTermInline(hydra.lexical.emptyContext)(hydra.ext.python.environment.PythonEnvironment(`namespaces_`,
...
def typeToPython(`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName])(typ: hydra.core.Type)(g: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  hydra.lib.eithers.bimap[hydra.context.InContext[hydra.errors.Error], hydra.ext.python.syntax.Expression,
     scala.Predef.String, scala.Predef.String]((ic: hydra.context.InContext[hydra.errors.Error]) => hydra.show.errors.error(ic.`object`))((`arg_`: hydra.ext.python.syntax.Expression) =>
  hydra.serialization.printExpr(hydra.ext.python.serde.encodeExpression(`arg_`)))(hydra.ext.python.coder.encodeType(hydra.ext.python.environment.PythonEnvironment(`namespaces_`,
...
def pythonTestCodec(`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName]): hydra.testing.TestCodec =
  ...
  (v2: hydra.graph.Graph) => hydra.ext.python.testing.typeToPython(`namespaces_`)(v1)(v2), hydra.ext.python.testing.formatPythonTestName,
     hydra.ext.python.testing.namespaceToPythonModuleName, hydra.ext.python.testing.pythonTestCaseTemplate,
     hydra.ext.python.testing.pythonTestGroupTemplate, hydra.ext.python.testing.pythonModuleTemplate,
     hydra.ext.python.testing.pythonImportTemplate, (v1: scala.collection.immutable.Set[hydra.core.Name]) =>
...
def generateTestFileWithPythonCodec[T0](codec: hydra.testing.TestCodec)(testModule: hydra.module.Module)(testGroup: hydra.testing.TestGroup)(`namespaces_`: T0)(g: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  {
  val testModuleContent: scala.Predef.String = hydra.ext.python.testing.buildPythonTestModule(codec)(testModule)(testGroup)(testBody)(`namespaces_`)
...
def generatePythonTestFile(testModule: hydra.module.Module)(testGroup: hydra.testing.TestGroup)(g: hydra.graph.Graph): Either[scala.Predef.String,
  ...
  hydra.lib.eithers.bind[scala.Predef.String, hydra.module.Namespaces[hydra.ext.python.syntax.DottedName],
     Tuple2[scala.Predef.String, scala.Predef.String]](hydra.ext.python.testing.namespacesForPythonModule(testModule)(g))((`namespaces_`: hydra.module.Namespaces[hydra.ext.python.syntax.DottedName]) =>
