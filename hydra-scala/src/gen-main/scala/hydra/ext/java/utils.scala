...
def javaExpressionToJavaPrimary(e: hydra.ext.java.syntax.Expression): hydra.ext.java.syntax.Primary =
  {
  val fallback: hydra.ext.java.syntax.Primary = hydra.ext.java.syntax.Primary.noNewArray(hydra.ext.java.syntax.PrimaryNoNewArray.parens(e))
  e match
    case hydra.ext.java.syntax.Expression.assignment(v_Expression_assignment_ae) => v_Expression_assignment_ae match
      case hydra.ext.java.syntax.AssignmentExpression.conditional(v_AssignmentExpression_conditional_ce) => v_AssignmentExpression_conditional_ce match
        case hydra.ext.java.syntax.ConditionalExpression.simple(v_ConditionalExpression_simple_cor) => {
          val cands: Seq[hydra.ext.java.syntax.ConditionalAndExpression] = v_ConditionalExpression_simple_cor
          logic.ifElse[hydra.ext.java.syntax.Primary](equality.equal[Int](lists.length[hydra.ext.java.syntax.ConditionalAndExpression](cands))(1))({
            val iors: Seq[hydra.ext.java.syntax.InclusiveOrExpression] = lists.head[hydra.ext.java.syntax.ConditionalAndExpression](cands)
            logic.ifElse[hydra.ext.java.syntax.Primary](equality.equal[Int](lists.length[hydra.ext.java.syntax.InclusiveOrExpression](iors))(1))({
              val xors: Seq[hydra.ext.java.syntax.ExclusiveOrExpression] = lists.head[hydra.ext.java.syntax.InclusiveOrExpression](iors)
              logic.ifElse[hydra.ext.java.syntax.Primary](equality.equal[Int](lists.length[hydra.ext.java.syntax.ExclusiveOrExpression](xors))(1))({
                val ands: Seq[hydra.ext.java.syntax.AndExpression] = lists.head[hydra.ext.java.syntax.ExclusiveOrExpression](xors)
                logic.ifElse[hydra.ext.java.syntax.Primary](equality.equal[Int](lists.length[hydra.ext.java.syntax.AndExpression](ands))(1))({
                  val eqs: Seq[hydra.ext.java.syntax.EqualityExpression] = lists.head[hydra.ext.java.syntax.AndExpression](ands)
                  logic.ifElse[hydra.ext.java.syntax.Primary](equality.equal[Int](lists.length[hydra.ext.java.syntax.EqualityExpression](eqs))(1))(lists.head[hydra.ext.java.syntax.EqualityExpression](eqs) match
...
def javaClassType(args: Seq[hydra.ext.java.syntax.ReferenceType])(pkg: Option[hydra.ext.java.syntax.PackageName])(id: scala.Predef.String): hydra.ext.java.syntax.ClassType =
  {
  val qual: hydra.ext.java.syntax.ClassTypeQualifier = maybes.cases[hydra.ext.java.syntax.PackageName,
  ...
  val targs: Seq[hydra.ext.java.syntax.TypeArgument] = lists.map[hydra.ext.java.syntax.ReferenceType,
...
val javaBooleanType: hydra.ext.java.syntax.Type = hydra.ext.java.utils.javaPrimitiveTypeToJavaType(hydra.ext.java.syntax.PrimitiveType.boolean)

val javaIntType: hydra.ext.java.syntax.Type = hydra.ext.java.utils.javaPrimitiveTypeToJavaType(hydra.ext.java.syntax.PrimitiveType.numeric(hydra.ext.java.syntax.NumericType.integral(hydra.ext.java.syntax.IntegralType.int)))
...
val javaEmptyStatement: hydra.ext.java.syntax.Statement = hydra.ext.java.syntax.Statement.withoutTrailing(hydra.ext.java.syntax.StatementWithoutTrailingSubstatement.empty)
...
def javaStatementsToBlock(stmts: Seq[hydra.ext.java.syntax.Statement]): hydra.ext.java.syntax.Block =
  lists.map[hydra.ext.java.syntax.Statement, hydra.ext.java.syntax.BlockStatement]((s: hydra.ext.java.syntax.Statement) => hydra.ext.java.syntax.BlockStatement.statement(s))(stmts)
...
def javaMethodBody(mstmts: Option[Seq[hydra.ext.java.syntax.BlockStatement]]): hydra.ext.java.syntax.MethodBody =
  maybes.cases[Seq[hydra.ext.java.syntax.BlockStatement], hydra.ext.java.syntax.MethodBody](mstmts)(hydra.ext.java.syntax.MethodBody.none)((stmts: Seq[hydra.ext.java.syntax.BlockStatement]) => hydra.ext.java.syntax.MethodBody.block(stmts))
...
def javaTypeToJavaTypeArgument(t: hydra.ext.java.syntax.Type): hydra.ext.java.syntax.TypeArgument =
  ...
  case hydra.ext.java.syntax.Type.primitive(v_Type_primitive__) => hydra.ext.java.syntax.TypeArgument.wildcard(hydra.ext.java.syntax.Wildcard(Seq(), None))
...
def variableToJavaIdentifier(name: hydra.core.Name): hydra.ext.java.syntax.Identifier =
  ...
  logic.ifElse[hydra.ext.java.syntax.Identifier](equality.equal[scala.Predef.String](v)("_"))("ignored")(hydra.ext.java.utils.sanitizeJavaName(v))
}
...
def sanitizeJavaName(name: scala.Predef.String): scala.Predef.String =
  logic.ifElse[scala.Predef.String](hydra.ext.java.utils.isEscaped(name))(hydra.ext.java.utils.unescape(name))(logic.ifElse[scala.Predef.String](equality.equal[scala.Predef.String](name)("_"))("ignored")(hydra.formatting.sanitizeWithUnderscores(hydra.ext.java.language.reservedWords)(name)))

def isEscaped(s: scala.Predef.String): Boolean = equality.equal[Int](strings.charAt(0)(s))(36)

def unescape(s: scala.Predef.String): scala.Predef.String = strings.fromList(lists.tail[Int](strings.toList(s)))

def javaPackageDeclaration(ns: hydra.module.Namespace): hydra.ext.java.syntax.PackageDeclaration =
  hydra.ext.java.syntax.PackageDeclaration(Seq(), lists.map[scala.Predef.String, hydra.ext.java.syntax.Identifier]((s: scala.Predef.String) => s)(strings.splitOn(".")(ns)))

val overrideAnnotation: hydra.ext.java.syntax.Annotation = hydra.ext.java.syntax.Annotation.marker(hydra.ext.java.utils.javaTypeName("Override"))
...
def methodInvocation(lhs: Option[Either[hydra.ext.java.syntax.ExpressionName, hydra.ext.java.syntax.Primary]])(methodName: hydra.ext.java.syntax.Identifier)(args: Seq[hydra.ext.java.syntax.Expression]): hydra.ext.java.syntax.MethodInvocation =
  {
  val header: hydra.ext.java.syntax.MethodInvocation_Header = maybes.cases[Either[hydra.ext.java.syntax.ExpressionName,
    ...
    hydra.ext.java.syntax.MethodInvocation_Header.complex(hydra.ext.java.syntax.MethodInvocation_Complex(eithers.either[hydra.ext.java.syntax.ExpressionName,
...
def addExpressions(exprs: Seq[hydra.ext.java.syntax.MultiplicativeExpression]): hydra.ext.java.syntax.AdditiveExpression =
  {
  val first: hydra.ext.java.syntax.AdditiveExpression = hydra.ext.java.syntax.AdditiveExpression.unary(lists.head[hydra.ext.java.syntax.MultiplicativeExpression](exprs))
  val rest: Seq[hydra.ext.java.syntax.MultiplicativeExpression] = lists.tail[hydra.ext.java.syntax.MultiplicativeExpression](exprs)
  lists.foldl[hydra.ext.java.syntax.AdditiveExpression, hydra.ext.java.syntax.MultiplicativeExpression]((ae: hydra.ext.java.syntax.AdditiveExpression) =>
...
def nameToQualifiedJavaName(aliases: hydra.ext.java.helpers.Aliases)(qualify: Boolean)(name: hydra.core.Name)(mlocal: Option[scala.Predef.String]): Tuple2[hydra.ext.java.syntax.TypeIdentifier,
  ...
  val alias: Option[hydra.ext.java.syntax.PackageName] = maybes.cases[hydra.module.Namespace, Option[hydra.ext.java.syntax.PackageName]](`ns_`)(None)((n: hydra.module.Namespace) =>
    Some(maybes.cases[hydra.ext.java.syntax.PackageName, hydra.ext.java.syntax.PackageName](maps.lookup[hydra.module.Namespace,
       hydra.ext.java.syntax.PackageName](n)(aliases.packages))(hydra.ext.java.names.javaPackageName(strings.splitOn(".")(n)))((id: hydra.ext.java.syntax.PackageName) => id)))
  val pkg: hydra.ext.java.syntax.ClassTypeQualifier = logic.ifElse[hydra.ext.java.syntax.ClassTypeQualifier](qualify)(maybes.cases[hydra.ext.java.syntax.PackageName,
  ...
  val jid: hydra.ext.java.syntax.TypeIdentifier = hydra.ext.java.utils.javaTypeIdentifier(maybes.cases[scala.Predef.String,
     scala.Predef.String](mlocal)(hydra.ext.java.utils.sanitizeJavaName(local))((l: scala.Predef.String) =>
    strings.cat2(strings.cat2(hydra.ext.java.utils.sanitizeJavaName(local))("."))(hydra.ext.java.utils.sanitizeJavaName(l))))
  Tuple2(jid, pkg)
}

def nameToJavaClassType(aliases: hydra.ext.java.helpers.Aliases)(qualify: Boolean)(args: Seq[hydra.ext.java.syntax.TypeArgument])(name: hydra.core.Name)(mlocal: Option[scala.Predef.String]): hydra.ext.java.syntax.ClassType =
  {
  val result: Tuple2[hydra.ext.java.syntax.TypeIdentifier, hydra.ext.java.syntax.ClassTypeQualifier] = hydra.ext.java.utils.nameToQualifiedJavaName(aliases)(qualify)(name)(mlocal)
  val id: hydra.ext.java.syntax.TypeIdentifier = pairs.first[hydra.ext.java.syntax.TypeIdentifier, hydra.ext.java.syntax.ClassTypeQualifier](result)
  val pkg: hydra.ext.java.syntax.ClassTypeQualifier = pairs.second[hydra.ext.java.syntax.TypeIdentifier, hydra.ext.java.syntax.ClassTypeQualifier](result)
  hydra.ext.java.syntax.ClassType(Seq(), pkg, id, args)
}

def nameToJavaReferenceType(aliases: hydra.ext.java.helpers.Aliases)(qualify: Boolean)(args: Seq[hydra.ext.java.syntax.TypeArgument])(name: hydra.core.Name)(mlocal: Option[scala.Predef.String]): hydra.ext.java.syntax.ReferenceType =
...
def nameToJavaName(aliases: hydra.ext.java.helpers.Aliases)(name: hydra.core.Name): hydra.ext.java.syntax.Identifier =
  {
  val qn: hydra.module.QualifiedName = hydra.names.qualifyName(name)
  val `ns_`: Option[hydra.module.Namespace] = (qn.namespace)
  val local: scala.Predef.String = (qn.local)
  logic.ifElse[hydra.ext.java.syntax.Identifier](hydra.ext.java.utils.isEscaped(name))(hydra.ext.java.utils.sanitizeJavaName(local))(maybes.cases[hydra.module.Namespace,
     hydra.ext.java.syntax.Identifier](`ns_`)(local)((gname: hydra.module.Namespace) =>
    {
    val parts: Seq[scala.Predef.String] = maybes.cases[hydra.ext.java.syntax.PackageName, Seq[scala.Predef.String]](maps.lookup[hydra.module.Namespace,
       hydra.ext.java.syntax.PackageName](gname)(aliases.packages))(strings.splitOn(".")(gname))((pkgName: hydra.ext.java.syntax.PackageName) =>
      lists.map[hydra.ext.java.syntax.Identifier, scala.Predef.String]((i: hydra.ext.java.syntax.Identifier) => i)(pkgName))
    val allParts: Seq[scala.Predef.String] = lists.concat2[scala.Predef.String](parts)(Seq(hydra.ext.java.utils.sanitizeJavaName(local)))
    strings.intercalate(".")(allParts)
  }))
}

def nameToJavaTypeIdentifier(aliases: hydra.ext.java.helpers.Aliases)(qualify: Boolean)(name: hydra.core.Name): hydra.ext.java.syntax.TypeIdentifier =
  pairs.first[hydra.ext.java.syntax.TypeIdentifier, hydra.ext.java.syntax.ClassTypeQualifier](hydra.ext.java.utils.nameToQualifiedJavaName(aliases)(qualify)(name)(None))

def javaTypeFromTypeName(aliases: hydra.ext.java.helpers.Aliases)(elName: hydra.core.Name): hydra.ext.java.syntax.Type =
...
def javaDoubleCastExpression(rawRt: hydra.ext.java.syntax.ReferenceType)(targetRt: hydra.ext.java.syntax.ReferenceType)(expr: hydra.ext.java.syntax.UnaryExpression): hydra.ext.java.syntax.CastExpression =
  {
  val firstCast: hydra.ext.java.syntax.Expression = hydra.ext.java.utils.javaCastExpressionToJavaExpression(hydra.ext.java.utils.javaCastExpression(rawRt)(expr))
...
val javaBytePrimitiveType: hydra.ext.java.syntax.PrimitiveTypeWithAnnotations = hydra.ext.java.syntax.PrimitiveTypeWithAnnotations(hydra.ext.java.syntax.PrimitiveType.numeric(hydra.ext.java.syntax.NumericType.integral(hydra.ext.java.syntax.IntegralType.byte)),
   Seq())

val visitorTypeVariable: hydra.ext.java.syntax.ReferenceType = hydra.ext.java.utils.javaTypeVariable("r")

def lookupJavaVarName(aliases: hydra.ext.java.helpers.Aliases)(name: hydra.core.Name): hydra.core.Name =
  maybes.cases[hydra.core.Name, hydra.core.Name](maps.lookup[hydra.core.Name, hydra.core.Name](name)(aliases.varRenames))(name)((renamed: hydra.core.Name) => renamed)

def variantClassName(qualify: Boolean)(elName: hydra.core.Name)(fname: hydra.core.Name): hydra.core.Name =
  {
  val qn: hydra.module.QualifiedName = hydra.names.qualifyName(elName)
  val `ns_`: Option[hydra.module.Namespace] = (qn.namespace)
  val local: scala.Predef.String = (qn.local)
  val flocal: scala.Predef.String = hydra.formatting.capitalize(fname)
  val local1: scala.Predef.String = logic.ifElse[scala.Predef.String](qualify)(strings.cat2(strings.cat2(local)("."))(flocal))(logic.ifElse[scala.Predef.String](equality.equal[scala.Predef.String](flocal)(local))(strings.cat2(flocal)("_"))(flocal))
...
def variableDeclarationStatement[T0](aliases: T0)(jtype: hydra.ext.java.syntax.Type)(id: hydra.ext.java.syntax.Identifier)(rhs: hydra.ext.java.syntax.Expression): hydra.ext.java.syntax.BlockStatement =
  {
  val `init_`: hydra.ext.java.syntax.VariableInitializer = hydra.ext.java.syntax.VariableInitializer.expression(rhs)
  val vdec: hydra.ext.java.syntax.VariableDeclarator = hydra.ext.java.utils.javaVariableDeclarator(id)(Some(`init_`))
  hydra.ext.java.syntax.BlockStatement.localVariableDeclaration(hydra.ext.java.syntax.LocalVariableDeclaration(Seq(),
...
val suppressWarningsUncheckedAnnotation: hydra.ext.java.syntax.Annotation = hydra.ext.java.syntax.Annotation.singleElement(hydra.ext.java.syntax.SingleElementAnnotation(hydra.ext.java.utils.javaTypeName("SuppressWarnings"),
...
def methodInvocationStaticWithTypeArgs(self: hydra.ext.java.syntax.Identifier)(methodName: hydra.ext.java.syntax.Identifier)(targs: Seq[hydra.ext.java.syntax.TypeArgument])(args: Seq[hydra.ext.java.syntax.Expression]): hydra.ext.java.syntax.MethodInvocation =
  {
  val header: hydra.ext.java.syntax.MethodInvocation_Header = hydra.ext.java.syntax.MethodInvocation_Header.complex(hydra.ext.java.syntax.MethodInvocation_Complex(hydra.ext.java.syntax.MethodInvocation_Variant.expression(hydra.ext.java.utils.javaIdentifierToJavaExpressionName(self)),
     targs, methodName))
  hydra.ext.java.syntax.MethodInvocation(header, args)
}
...
def javaArrayCreation(primType: hydra.ext.java.syntax.PrimitiveTypeWithAnnotations)(minit: Option[hydra.ext.java.syntax.ArrayInitializer]): hydra.ext.java.syntax.Expression =
  {
  val `init_`: hydra.ext.java.syntax.ArrayInitializer = maybes.cases[hydra.ext.java.syntax.ArrayInitializer,
...
def javaArrayInitializer(exprs: Seq[hydra.ext.java.syntax.Expression]): hydra.ext.java.syntax.ArrayInitializer =
  Seq(lists.map[hydra.ext.java.syntax.Expression, hydra.ext.java.syntax.VariableInitializer]((e: hydra.ext.java.syntax.Expression) => hydra.ext.java.syntax.VariableInitializer.expression(e))(exprs))

def toAssignStmt(fname: hydra.core.Name): hydra.ext.java.syntax.Statement =
  {
  val id: hydra.ext.java.syntax.Identifier = hydra.ext.java.utils.fieldNameToJavaIdentifier(fname)
  val lhs: hydra.ext.java.syntax.LeftHandSide = hydra.ext.java.syntax.LeftHandSide.fieldAccess(hydra.ext.java.syntax.FieldAccess(hydra.ext.java.syntax.FieldAccess_Qualifier.primary(hydra.ext.java.syntax.Primary.noNewArray(hydra.ext.java.syntax.PrimaryNoNewArray.`this`)),
     id))
  val rhs: hydra.ext.java.syntax.Expression = hydra.ext.java.utils.fieldNameToJavaExpression(fname)
...
def importAliasesForModule(mod: hydra.module.Module): hydra.ext.java.helpers.Aliases =
  hydra.ext.java.helpers.Aliases(mod.namespace, maps.empty[hydra.module.Namespace, hydra.ext.java.syntax.PackageName],
     sets.empty[hydra.core.Name], sets.empty[hydra.core.Name], sets.empty[hydra.core.Name], sets.empty[hydra.core.Name],
     sets.empty[hydra.core.Name], maps.empty[hydra.core.Name, hydra.core.Name], sets.empty[hydra.core.Name],
     maps.empty[hydra.core.Name, hydra.core.Name], sets.empty[hydra.core.Name], None, sets.empty[hydra.core.Name])

def javaClassDeclaration(aliases: hydra.ext.java.helpers.Aliases)(tparams: Seq[hydra.ext.java.syntax.TypeParameter])(elName: hydra.core.Name)(mods: Seq[hydra.ext.java.syntax.ClassModifier])(supname: Option[hydra.core.Name])(impls: Seq[hydra.ext.java.syntax.InterfaceType])(bodyDecls: Seq[hydra.ext.java.syntax.ClassBodyDeclarationWithComments]): hydra.ext.java.syntax.ClassDeclaration =
  {
  val `extends_`: Option[hydra.ext.java.syntax.ClassType] = maybes.map[hydra.core.Name, hydra.ext.java.syntax.ClassType]((n: hydra.core.Name) =>
...
def makeConstructor(aliases: hydra.ext.java.helpers.Aliases)(elName: hydra.core.Name)(`private`: Boolean)(params: Seq[hydra.ext.java.syntax.FormalParameter])(stmts: Seq[hydra.ext.java.syntax.BlockStatement]): hydra.ext.java.syntax.ClassBodyDeclaration =
  {
  val nm: hydra.ext.java.syntax.SimpleTypeName = hydra.ext.java.utils.nameToJavaTypeIdentifier(aliases)(false)(elName)
  val cons: hydra.ext.java.syntax.ConstructorDeclarator = hydra.ext.java.syntax.ConstructorDeclarator(Seq(), nm, None, params)
  val mods: Seq[hydra.ext.java.syntax.ConstructorModifier] = Seq(logic.ifElse[hydra.ext.java.syntax.ConstructorModifier](`private`)(hydra.ext.java.syntax.ConstructorModifier.`private`)(hydra.ext.java.syntax.ConstructorModifier.public))
  val body: hydra.ext.java.syntax.ConstructorBody = hydra.ext.java.syntax.ConstructorBody(None, stmts)
...
def toAcceptMethod(`abstract`: Boolean)(vtparams: Seq[hydra.ext.java.syntax.TypeParameter]): hydra.ext.java.syntax.ClassBodyDeclaration =
  {
  val mods: Seq[hydra.ext.java.syntax.MethodModifier] = logic.ifElse[Seq[hydra.ext.java.syntax.MethodModifier]](`abstract`)(Seq(hydra.ext.java.syntax.MethodModifier.public,
     hydra.ext.java.syntax.MethodModifier.`abstract`))(Seq(hydra.ext.java.syntax.MethodModifier.public))
  val tparams: Seq[hydra.ext.java.syntax.TypeParameter] = Seq(hydra.ext.java.utils.javaTypeParameter(hydra.ext.java.names.visitorReturnParameter))
  val anns: Seq[hydra.ext.java.syntax.Annotation] = logic.ifElse[Seq[hydra.ext.java.syntax.Annotation]](`abstract`)(Seq())(Seq(hydra.ext.java.utils.overrideAnnotation))
  ...
  val ref: hydra.ext.java.syntax.Type = hydra.ext.java.utils.javaClassTypeToJavaType(hydra.ext.java.syntax.ClassType(Seq(),
     hydra.ext.java.syntax.ClassTypeQualifier.none, hydra.ext.java.utils.javaTypeIdentifier(hydra.ext.java.names.visitorName),
     lists.concat2[hydra.ext.java.syntax.TypeArgument](typeArgs)(Seq(hydra.ext.java.syntax.TypeArgument.reference(hydra.ext.java.utils.visitorTypeVariable)))))
  val param: hydra.ext.java.syntax.FormalParameter = hydra.ext.java.utils.javaTypeToJavaFormalParameter(ref)("visitor")
  val result: hydra.ext.java.syntax.Result = hydra.ext.java.utils.javaTypeToJavaResult(hydra.ext.java.syntax.Type.reference(hydra.ext.java.utils.visitorTypeVariable))
  val returnExpr: hydra.ext.java.syntax.Expression = hydra.ext.java.utils.javaMethodInvocationToJavaExpression(hydra.ext.java.utils.methodInvocationStatic("visitor")(hydra.ext.java.names.visitMethodName)(Seq(hydra.ext.java.utils.javaThis)))
  val body: Option[Seq[hydra.ext.java.syntax.BlockStatement]] = logic.ifElse[Option[Seq[hydra.ext.java.syntax.BlockStatement]]](`abstract`)(None)(Some(Seq(hydra.ext.java.syntax.BlockStatement.statement(hydra.ext.java.utils.javaReturnStatement(Some(returnExpr))))))
  hydra.ext.java.utils.methodDeclaration(mods)(tparams)(anns)(hydra.ext.java.names.acceptMethodName)(Seq(param))(result)(body)
}

def toJavaArrayType(t: hydra.ext.java.syntax.Type)(cx: hydra.context.Context): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.java.syntax.Type] =
  t match
  case hydra.ext.java.syntax.Type.reference(v_Type_reference_rt) => v_Type_reference_rt match
    ...
    case hydra.ext.java.syntax.ReferenceType.array(v_ReferenceType_array_at) => {
      val oldDims: Seq[Seq[hydra.ext.java.syntax.Annotation]] = (v_ReferenceType_array_at.dims)
      val newDims: hydra.ext.java.syntax.Dims = lists.concat2[Seq[hydra.ext.java.syntax.Annotation]](oldDims)(Seq(Seq()))
      val variant: hydra.ext.java.syntax.ArrayType_Variant = (v_ReferenceType_array_at.variant)
    ...
    case hydra.ext.java.syntax.ReferenceType.variable(v_ReferenceType_variable__) => Left(hydra.context.InContext(hydra.error.Error.other("don't know how to make Java reference type into array type"),
       cx))
  case hydra.ext.java.syntax.Type.primitive(v_Type_primitive__) => Left(hydra.context.InContext(hydra.error.Error.other("don't know how to make Java type into array type"),
     cx))

def javaTypeToJavaReferenceType(t: hydra.ext.java.syntax.Type)(cx: hydra.context.Context): Either[hydra.context.InContext[hydra.error.Error],
  ...
  case hydra.ext.java.syntax.Type.primitive(v_Type_primitive__) => Left(hydra.context.InContext(hydra.error.Error.other("expected a Java reference type"), cx))
...
def javaReferenceTypeToRawType(rt: hydra.ext.java.syntax.ReferenceType): hydra.ext.java.syntax.ReferenceType =
  ...
  case hydra.ext.java.syntax.ReferenceType.classOrInterface(v_ReferenceType_classOrInterface_cit) => v_ReferenceType_classOrInterface_cit match
    case hydra.ext.java.syntax.ClassOrInterfaceType.`class`(v_ClassOrInterfaceType_class_ct) => {
      val anns: Seq[hydra.ext.java.syntax.Annotation] = (v_ClassOrInterfaceType_class_ct.annotations)
      val qual: hydra.ext.java.syntax.ClassTypeQualifier = (v_ClassOrInterfaceType_class_ct.qualifier)
      val id: hydra.ext.java.syntax.TypeIdentifier = (v_ClassOrInterfaceType_class_ct.identifier)
    ...
    case hydra.ext.java.syntax.ClassOrInterfaceType.interface(v_ClassOrInterfaceType_interface_it) => {
      val ct: hydra.ext.java.syntax.ClassType = v_ClassOrInterfaceType_interface_it
...
def addJavaTypeParameter(rt: hydra.ext.java.syntax.ReferenceType)(t: hydra.ext.java.syntax.Type)(cx: hydra.context.Context): Either[hydra.context.InContext[hydra.error.Error],
  ...
  case hydra.ext.java.syntax.Type.reference(v_Type_reference_rt1) => v_Type_reference_rt1 match
    case hydra.ext.java.syntax.ReferenceType.classOrInterface(v_ReferenceType_classOrInterface_cit) => v_ReferenceType_classOrInterface_cit match
      case hydra.ext.java.syntax.ClassOrInterfaceType.`class`(v_ClassOrInterfaceType_class_ct) => {
        ...
        val qual: hydra.ext.java.syntax.ClassTypeQualifier = (v_ClassOrInterfaceType_class_ct.qualifier)
        val id: hydra.ext.java.syntax.TypeIdentifier = (v_ClassOrInterfaceType_class_ct.identifier)
        val args: Seq[hydra.ext.java.syntax.TypeArgument] = (v_ClassOrInterfaceType_class_ct.arguments)
        Right(hydra.ext.java.syntax.Type.reference(hydra.ext.java.syntax.ReferenceType.classOrInterface(hydra.ext.java.syntax.ClassOrInterfaceType.`class`(hydra.ext.java.syntax.ClassType(anns,
           qual, id, lists.concat2[hydra.ext.java.syntax.TypeArgument](args)(Seq(hydra.ext.java.syntax.TypeArgument.reference(rt))))))))
      }
      case hydra.ext.java.syntax.ClassOrInterfaceType.interface(v_ClassOrInterfaceType_interface__) => Left(hydra.context.InContext(hydra.error.Error.other("expected a Java class type"),
         cx))
    ...
    case hydra.ext.java.syntax.ReferenceType.array(v_ReferenceType_array__) => Left(hydra.context.InContext(hydra.error.Error.other("expected a Java class or interface type, or a variable"),
       cx))
  case hydra.ext.java.syntax.Type.primitive(v_Type_primitive__) => Left(hydra.context.InContext(hydra.error.Error.other("expected a reference type"), cx))

def uniqueVarName(aliases: hydra.ext.java.helpers.Aliases)(name: hydra.core.Name): hydra.core.Name =
  logic.ifElse[hydra.core.Name](sets.member[hydra.core.Name](name)(aliases.inScopeJavaVars))(hydra.ext.java.utils.uniqueVarName_go(aliases)(name)(2))(name)

def uniqueVarName_go(aliases: hydra.ext.java.helpers.Aliases)(base: scala.Predef.String)(n: Int): hydra.core.Name =
  {
  val candidate: hydra.core.Name = strings.cat2(base)(literals.showInt32(n))
  logic.ifElse[hydra.core.Name](sets.member[hydra.core.Name](candidate)(aliases.inScopeJavaVars))(hydra.ext.java.utils.uniqueVarName_go(aliases)(base)(math.add(n)(1)))(candidate)
}

def addInScopeVar(name: hydra.core.Name)(aliases: hydra.ext.java.helpers.Aliases): hydra.ext.java.helpers.Aliases =
  hydra.ext.java.helpers.Aliases(aliases.currentNamespace, (aliases.packages), (aliases.branchVars), (aliases.recursiveVars),
     (aliases.inScopeTypeParams), (aliases.polymorphicLocals), sets.insert[hydra.core.Name](name)(aliases.inScopeJavaVars),
     (aliases.varRenames), (aliases.lambdaVars), (aliases.typeVarSubst), (aliases.trustedTypeVars), (aliases.methodCodomain),
     (aliases.thunkedVars))

def addInScopeVars(names: Seq[hydra.core.Name])(aliases: hydra.ext.java.helpers.Aliases): hydra.ext.java.helpers.Aliases =
  lists.foldl[hydra.ext.java.helpers.Aliases, hydra.core.Name]((a: hydra.ext.java.helpers.Aliases) =>
  (n: hydra.core.Name) => hydra.ext.java.utils.addInScopeVar(n)(a))(aliases)(names)

def addVarRename(original: hydra.core.Name)(renamed: hydra.core.Name)(aliases: hydra.ext.java.helpers.Aliases): hydra.ext.java.helpers.Aliases =
  hydra.ext.java.helpers.Aliases(aliases.currentNamespace, (aliases.packages), (aliases.branchVars), (aliases.recursiveVars),
     (aliases.inScopeTypeParams), (aliases.polymorphicLocals), (aliases.inScopeJavaVars), maps.insert[hydra.core.Name,
     hydra.core.Name](original)(renamed)(aliases.varRenames), (aliases.lambdaVars), (aliases.typeVarSubst),
     (aliases.trustedTypeVars), (aliases.methodCodomain), (aliases.thunkedVars))
