      ...
      case hydra.ext.java.syntax.AssignmentExpression.conditional(v_AssignmentExpression_conditional_ce) => v_AssignmentExpression_conditional_ce match
        case hydra.ext.java.syntax.ConditionalExpression.simple(v_ConditionalExpression_simple_cor) => {
          ...
          hydra.lib.logic.ifElse[hydra.ext.java.syntax.Primary](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.ext.java.syntax.ConditionalAndExpression](cands))(1))({
            val iors: Seq[hydra.ext.java.syntax.InclusiveOrExpression] = hydra.lib.lists.head[hydra.ext.java.syntax.ConditionalAndExpression](cands)
            hydra.lib.logic.ifElse[hydra.ext.java.syntax.Primary](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.ext.java.syntax.InclusiveOrExpression](iors))(1))({
              val xors: Seq[hydra.ext.java.syntax.ExclusiveOrExpression] = hydra.lib.lists.head[hydra.ext.java.syntax.InclusiveOrExpression](iors)
              hydra.lib.logic.ifElse[hydra.ext.java.syntax.Primary](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.ext.java.syntax.ExclusiveOrExpression](xors))(1))({
                val ands: Seq[hydra.ext.java.syntax.AndExpression] = hydra.lib.lists.head[hydra.ext.java.syntax.ExclusiveOrExpression](xors)
                hydra.lib.logic.ifElse[hydra.ext.java.syntax.Primary](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.ext.java.syntax.AndExpression](ands))(1))({
                  val eqs: Seq[hydra.ext.java.syntax.EqualityExpression] = hydra.lib.lists.head[hydra.ext.java.syntax.AndExpression](ands)
...
def javaClassType(args: Seq[hydra.ext.java.syntax.ReferenceType])(pkg: Option[hydra.ext.java.syntax.PackageName])(id: scala.Predef.String): hydra.ext.java.syntax.ClassType =
  {
  val qual: hydra.ext.java.syntax.ClassTypeQualifier = hydra.lib.maybes.cases[hydra.ext.java.syntax.PackageName,
  ...
  val targs: Seq[hydra.ext.java.syntax.TypeArgument] = hydra.lib.lists.map[hydra.ext.java.syntax.ReferenceType,
...
def methodInvocation(lhs: Option[Either[hydra.ext.java.syntax.ExpressionName, hydra.ext.java.syntax.Primary]])(methodName: hydra.ext.java.syntax.Identifier)(args: Seq[hydra.ext.java.syntax.Expression]): hydra.ext.java.syntax.MethodInvocation =
  {
  val header: hydra.ext.java.syntax.MethodInvocation_Header = hydra.lib.maybes.cases[Either[hydra.ext.java.syntax.ExpressionName,
...
def addExpressions(exprs: Seq[hydra.ext.java.syntax.MultiplicativeExpression]): hydra.ext.java.syntax.AdditiveExpression =
  {
  val first: hydra.ext.java.syntax.AdditiveExpression = hydra.ext.java.syntax.AdditiveExpression.unary(hydra.lib.lists.head[hydra.ext.java.syntax.MultiplicativeExpression](exprs))
  val rest: Seq[hydra.ext.java.syntax.MultiplicativeExpression] = hydra.lib.lists.tail[hydra.ext.java.syntax.MultiplicativeExpression](exprs)
...
def nameToQualifiedJavaName(aliases: hydra.ext.java.helpers.Aliases)(qualify: Boolean)(name: hydra.core.Name)(mlocal: Option[scala.Predef.String]): Tuple2[hydra.ext.java.syntax.TypeIdentifier,
  ...
  val alias: Option[hydra.ext.java.syntax.PackageName] = hydra.lib.maybes.cases[hydra.module.Namespace,
  ...
  val pkg: hydra.ext.java.syntax.ClassTypeQualifier = hydra.lib.logic.ifElse[hydra.ext.java.syntax.ClassTypeQualifier](qualify)(hydra.lib.maybes.cases[hydra.ext.java.syntax.PackageName,
  ...
  val jid: hydra.ext.java.syntax.TypeIdentifier = hydra.ext.java.utils.javaTypeIdentifier(hydra.lib.maybes.cases[scala.Predef.String,
...
def nameToJavaClassType(aliases: hydra.ext.java.helpers.Aliases)(qualify: Boolean)(args: Seq[hydra.ext.java.syntax.TypeArgument])(name: hydra.core.Name)(mlocal: Option[scala.Predef.String]): hydra.ext.java.syntax.ClassType =
  ...
  val id: hydra.ext.java.syntax.TypeIdentifier = hydra.lib.pairs.first[hydra.ext.java.syntax.TypeIdentifier, hydra.ext.java.syntax.ClassTypeQualifier](result)
  val pkg: hydra.ext.java.syntax.ClassTypeQualifier = hydra.lib.pairs.second[hydra.ext.java.syntax.TypeIdentifier,
...
def nameToJavaName(aliases: hydra.ext.java.helpers.Aliases)(name: hydra.core.Name): hydra.ext.java.syntax.Identifier =
  ...
  hydra.lib.logic.ifElse[hydra.ext.java.syntax.Identifier](hydra.ext.java.utils.isEscaped(name))(hydra.ext.java.utils.sanitizeJavaName(local))(hydra.lib.maybes.cases[hydra.module.Namespace,
    ...
    {
    val parts: Seq[scala.Predef.String] = hydra.lib.maybes.cases[hydra.ext.java.syntax.PackageName, Seq[scala.Predef.String]](hydra.lib.maps.lookup[hydra.module.Namespace,
       hydra.ext.java.syntax.PackageName](gname)(aliases.packages))(hydra.lib.strings.splitOn(".")(gname))((pkgName: hydra.ext.java.syntax.PackageName) =>
      hydra.lib.lists.map[hydra.ext.java.syntax.Identifier, scala.Predef.String]((i: hydra.ext.java.syntax.Identifier) => i)(pkgName))
    val allParts: Seq[scala.Predef.String] = hydra.lib.lists.concat2[scala.Predef.String](parts)(Seq(hydra.ext.java.utils.sanitizeJavaName(local)))
...
def variantClassName(qualify: Boolean)(elName: hydra.core.Name)(fname: hydra.core.Name): hydra.core.Name =
  ...
  val local1: scala.Predef.String = hydra.lib.logic.ifElse[scala.Predef.String](qualify)(hydra.lib.strings.cat2(hydra.lib.strings.cat2(local)("."))(flocal))(hydra.lib.logic.ifElse[scala.Predef.String](hydra.lib.equality.equal[scala.Predef.String](flocal)(local))(hydra.lib.strings.cat2(flocal)("_"))(flocal))
...
def javaArrayCreation(primType: hydra.ext.java.syntax.PrimitiveTypeWithAnnotations)(minit: Option[hydra.ext.java.syntax.ArrayInitializer]): hydra.ext.java.syntax.Expression =
  {
  val `init_`: hydra.ext.java.syntax.ArrayInitializer = hydra.lib.maybes.cases[hydra.ext.java.syntax.ArrayInitializer,
...
def importAliasesForModule(mod: hydra.module.Module): hydra.ext.java.helpers.Aliases =
  hydra.ext.java.helpers.Aliases(mod.namespace, hydra.lib.maps.empty[hydra.module.Namespace, hydra.ext.java.syntax.PackageName],
...
def javaClassDeclaration(aliases: hydra.ext.java.helpers.Aliases)(tparams: Seq[hydra.ext.java.syntax.TypeParameter])(elName: hydra.core.Name)(mods: Seq[hydra.ext.java.syntax.ClassModifier])(supname: Option[hydra.core.Name])(impls: Seq[hydra.ext.java.syntax.InterfaceType])(bodyDecls: Seq[hydra.ext.java.syntax.ClassBodyDeclarationWithComments]): hydra.ext.java.syntax.ClassDeclaration =
  {
  val `extends_`: Option[hydra.ext.java.syntax.ClassType] = hydra.lib.maybes.map[hydra.core.Name, hydra.ext.java.syntax.ClassType]((n: hydra.core.Name) =>
...
def makeConstructor(aliases: hydra.ext.java.helpers.Aliases)(elName: hydra.core.Name)(`private`: Boolean)(params: Seq[hydra.ext.java.syntax.FormalParameter])(stmts: Seq[hydra.ext.java.syntax.BlockStatement]): hydra.ext.java.syntax.ClassBodyDeclaration =
  ...
  val mods: Seq[hydra.ext.java.syntax.ConstructorModifier] = Seq(hydra.lib.logic.ifElse[hydra.ext.java.syntax.ConstructorModifier](`private`)(hydra.ext.java.syntax.ConstructorModifier.`private`)(hydra.ext.java.syntax.ConstructorModifier.public))
...
def toAcceptMethod(`abstract`: Boolean)(vtparams: Seq[hydra.ext.java.syntax.TypeParameter]): hydra.ext.java.syntax.ClassBodyDeclaration =
  {
  val mods: Seq[hydra.ext.java.syntax.MethodModifier] = hydra.lib.logic.ifElse[Seq[hydra.ext.java.syntax.MethodModifier]](`abstract`)(Seq(hydra.ext.java.syntax.MethodModifier.public,
  ...
  val anns: Seq[hydra.ext.java.syntax.Annotation] = hydra.lib.logic.ifElse[Seq[hydra.ext.java.syntax.Annotation]](`abstract`)(Seq())(Seq(hydra.ext.java.utils.overrideAnnotation))
  ...
  val body: Option[Seq[hydra.ext.java.syntax.BlockStatement]] = hydra.lib.logic.ifElse[Option[Seq[hydra.ext.java.syntax.BlockStatement]]](`abstract`)(None)(Some(Seq(hydra.ext.java.syntax.BlockStatement.statement(hydra.ext.java.utils.javaReturnStatement(Some(returnExpr))))))
...
def toJavaArrayType(t: hydra.ext.java.syntax.Type)(cx: hydra.context.Context): Either[hydra.context.InContext[hydra.error.Error], hydra.ext.java.syntax.Type] =
  ...
  case hydra.ext.java.syntax.Type.reference(v_Type_reference_rt) => v_Type_reference_rt match
    ...
    case hydra.ext.java.syntax.ReferenceType.array(v_ReferenceType_array_at) => {
      ...
      val newDims: hydra.ext.java.syntax.Dims = hydra.lib.lists.concat2[Seq[hydra.ext.java.syntax.Annotation]](oldDims)(Seq(Seq()))
...
def uniqueVarName_go(aliases: hydra.ext.java.helpers.Aliases)(base: scala.Predef.String)(n: Int): hydra.core.Name =
  {
  val candidate: hydra.core.Name = hydra.lib.strings.cat2(base)(hydra.lib.literals.showInt32(n))
...
def addInScopeVar(name: hydra.core.Name)(aliases: hydra.ext.java.helpers.Aliases): hydra.ext.java.helpers.Aliases =
  hydra.ext.java.helpers.Aliases(aliases.currentNamespace, (aliases.packages), (aliases.branchVars), (aliases.recursiveVars),
     (aliases.inScopeTypeParams), (aliases.polymorphicLocals), hydra.lib.sets.insert[hydra.core.Name](name)(aliases.inScopeJavaVars),
...
def addInScopeVars(names: Seq[hydra.core.Name])(aliases: hydra.ext.java.helpers.Aliases): hydra.ext.java.helpers.Aliases =
  hydra.lib.lists.foldl[hydra.ext.java.helpers.Aliases, hydra.core.Name]((a: hydra.ext.java.helpers.Aliases) =>
...
def addVarRename(original: hydra.core.Name)(renamed: hydra.core.Name)(aliases: hydra.ext.java.helpers.Aliases): hydra.ext.java.helpers.Aliases =
  hydra.ext.java.helpers.Aliases(aliases.currentNamespace, (aliases.packages), (aliases.branchVars), (aliases.recursiveVars),
     (aliases.inScopeTypeParams), (aliases.polymorphicLocals), (aliases.inScopeJavaVars), hydra.lib.maps.insert[hydra.core.Name,
