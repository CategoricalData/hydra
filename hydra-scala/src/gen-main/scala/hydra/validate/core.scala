...
def validateTypeNode(boundVars: scala.collection.immutable.Set[hydra.core.Name])(typ: hydra.core.Type): Option[hydra.error.core.InvalidTypeError] =
  ...
  case hydra.core.Type.map(v_Type_map_mt) => {
    ...
    hydra.validate.core.firstTypeError(Seq(keyType match
      case hydra.core.Type.function(v_Type_function__) => Some(hydra.error.core.InvalidTypeError.nonComparableMapKeyType(hydra.error.core.NonComparableMapKeyTypeError(Seq(), keyType)))
  ...
  case hydra.core.Type.set(v_Type_set_elemType) => hydra.validate.core.firstTypeError(Seq(v_Type_set_elemType match
    case hydra.core.Type.function(v_Type_function__) => Some(hydra.error.core.InvalidTypeError.nonComparableSetElementType(hydra.error.core.NonComparableSetElementTypeError(Seq(), v_Type_set_elemType)))
