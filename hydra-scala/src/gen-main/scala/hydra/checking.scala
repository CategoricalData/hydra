...
def applyTypeArgumentsToType(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(t: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error],
   hydra.core.Type] =
  ...
  lazy val nonnull: Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] = t match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat(Seq("not a forall type: ",
...
def checkForUnboundTypeVariables(cx: hydra.context.Context)(tx: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error],
   Unit] =
  {
  ...
  def checkRecursive(vars: scala.collection.immutable.Set[hydra.core.Name])(trace: Seq[scala.Predef.String])(lbinding: Option[hydra.core.Binding])(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error],
     Unit] =
    {
    ...
    lazy val dflt: Either[hydra.context.InContext[hydra.errors.Error], Unit] = hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
    ...
    def checkOptional(m: Option[hydra.core.Type]): Either[hydra.context.InContext[hydra.errors.Error], Unit] =
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[Unit], Unit](hydra.lib.eithers.mapMaybe[hydra.core.Type,
    ...
    term match
      ...
      case hydra.core.Term.let(v_Term_let_l) => {
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[Unit], Unit](hydra.lib.eithers.mapList[hydra.core.Binding,
           Unit, hydra.context.InContext[hydra.errors.Error]](forBinding)(v_Term_let_l.bindings))((_x: Seq[Unit]) => recurse(v_Term_let_l.body))
      }
      case hydra.core.Term.typeApplication(v_Term_typeApplication_tt) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
         Unit, Unit](check(v_Term_typeApplication_tt.`type`))((_x: Unit) => recurse(v_Term_typeApplication_tt.body))
      case hydra.core.Term.typeLambda(v_Term_typeLambda_tl) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
      ...
      lazy val vars: Seq[hydra.core.Name] = (schemaType.variables)
      {
        lazy val varslen: Int = hydra.lib.lists.length[hydra.core.Name](vars)
        {
          ...
          hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Unit, hydra.context.Context]]](hydra.lib.equality.equal[Int](varslen)(argslen))(Right(Tuple2((),
             cx2)))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeArityMismatch(hydra.error.checking.TypeArityMismatchError(hydra.core.Type.variable(tname),
...
def checkSameType(cx: hydra.context.Context)(tx: hydra.graph.Graph)(desc: scala.Predef.String)(types: Seq[hydra.core.Type]): Either[hydra.context.InContext[hydra.errors.Error],
   hydra.core.Type] =
...
def checkType(cx: hydra.context.Context)(tx: hydra.graph.Graph)(term: hydra.core.Term)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error],
   Unit] =
  {
  lazy val vars: scala.collection.immutable.Set[hydra.core.Name] = (tx.typeVariables)
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Unit]](hydra.constants.debugInference)(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
     hydra.core.Type, Unit](hydra.lib.eithers.map[Tuple2[hydra.core.Type, hydra.context.Context], hydra.core.Type,
     hydra.context.InContext[hydra.errors.Error]]((_p: Tuple2[hydra.core.Type, hydra.context.Context]) =>
    hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context](_p))(hydra.checking.typeOf(cx)(tx)(Seq())(term)))((t0: hydra.core.Type) =>
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Unit]](hydra.checking.typesEffectivelyEqual(tx)(t0)(typ))(Right(()))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeMismatch(hydra.error.checking.TypeMismatchError(typ,
       t0))), cx)))))(Right(()))
}

def checkTypeSubst(cx: hydra.context.Context)(tx: hydra.graph.Graph)(subst: hydra.typing.TypeSubst): Either[hydra.context.InContext[hydra.errors.Error],
...
def typeOf(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  term match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.unsupportedTermVariant(hydra.error.checking.UnsupportedTermVariantError(hydra.reflect.termVariant(term)))),
       cx1))
}

def typeOfAnnotatedTerm(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(at: hydra.core.AnnotatedTerm): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] = hydra.checking.typeOf(cx)(tx)(typeArgs)(at.body)

def typeOfApplication(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(app: hydra.core.Application): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
  lazy val fun: hydra.core.Term = (app.function)
  lazy val arg: hydra.core.Term = (app.argument)
  def tryType(cx0: hydra.context.Context)(tfun: hydra.core.Type)(targ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error],
     Tuple2[hydra.core.Type, hydra.context.Context]] =
    tfun match
    ...
    case hydra.core.Type.function(v_Type_function_ft) => {
      lazy val dom: hydra.core.Type = (v_Type_function_ft.domain)
      {
        ...
        hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type,
           hydra.context.Context]]](hydra.checking.typesEffectivelyEqual(tx)(dom)(targ))(Right(Tuple2(cod,
           cx0)))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeMismatch(hydra.error.checking.TypeMismatchError(dom,
           targ))), cx0)))
      }
    }
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.notAFunctionType(hydra.error.checking.NotAFunctionTypeError(tfun))),
       cx0))
    ...
    lazy val tfun: hydra.core.Type = hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context](result1)
    {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context],
        ...
        lazy val targ: hydra.core.Type = hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context](result2)
        {
          ...
          hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type,
             hydra.context.Context], Tuple2[hydra.core.Type, hydra.context.Context]](tryType(cx3)(tfun)(targ))((result3: Tuple2[hydra.core.Type,
             hydra.context.Context]) =>
            {
...
def typeOfCaseStatement(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(cs: hydra.core.CaseStatement): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[Tuple2[hydra.core.Type, hydra.context.Context]],
     Tuple2[hydra.core.Type, hydra.context.Context]](hydra.lib.eithers.mapMaybe[hydra.core.Term, Tuple2[hydra.core.Type,
     hydra.context.Context], hydra.context.InContext[hydra.errors.Error]]((e: hydra.core.Term) => hydra.checking.typeOf(cx)(tx)(Seq())(e))(dflt))((dfltResult: Option[Tuple2[hydra.core.Type,
     hydra.context.Context]]) =>
    {
       ...
       hydra.core.Type](hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context])(dfltResult)
    {
      ...
      {
        lazy val foldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
           hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
           Tuple2[Seq[hydra.core.Type], hydra.context.Context]], hydra.core.Term]((acc: Either[hydra.context.InContext[hydra.errors.Error],
           Tuple2[Seq[hydra.core.Type], hydra.context.Context]]) =>
          (term: hydra.core.Term) =>
          hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
          ...
          lazy val tcterms: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], hydra.context.Context](foldR)
          {
            ...
            {
              lazy val fcodsResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
                 hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
                 Tuple2[Seq[hydra.core.Type], hydra.context.Context]], hydra.core.Type]((acc: Either[hydra.context.InContext[hydra.errors.Error],
                 Tuple2[Seq[hydra.core.Type], hydra.context.Context]]) =>
                (t: hydra.core.Type) =>
                hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
                   hydra.context.Context], Tuple2[Seq[hydra.core.Type], hydra.context.Context]](acc)((accR: Tuple2[Seq[hydra.core.Type],
                ...
                hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.FunctionType,
...
def typeOfEither(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(et: Either[hydra.core.Term,
   hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
  lazy val n: Int = hydra.lib.lists.length[hydra.core.Type](typeArgs)
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]]](hydra.lib.equality.equal[Int](n)(2))(hydra.lib.eithers.either[hydra.core.Term,
     hydra.core.Term, Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]]]((leftTerm: hydra.core.Term) =>
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context],
  ...
  }))(et))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeArityMismatch(hydra.error.checking.TypeArityMismatchError(hydra.core.Type.either(hydra.core.EitherType(hydra.core.Type.unit,
     hydra.core.Type.unit)), 2, n, typeArgs))), cx)))
}

def typeOfInjection(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(injection: hydra.core.Injection): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfLambda(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(l: hydra.core.Lambda): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfLet(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(letTerm: hydra.core.Let): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
  ...
  lazy val btypesResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type], Unit],
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Type, Tuple2[Seq[hydra.core.Type],
...
def typeOfList(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(els: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]]](hydra.lib.lists.`null`[hydra.core.Term](els))(hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error],
     ...
     cx)))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeArityMismatch(hydra.error.checking.TypeArityMismatchError(hydra.core.Type.list(hydra.core.Type.unit),
  ...
  lazy val foldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
     ...
     Tuple2[Seq[hydra.core.Type], hydra.context.Context]]) =>
    (term: hydra.core.Term) =>
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type], hydra.context.Context],
...
def typeOfLiteral(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(lit: hydra.core.Literal): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfMap(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(m: Map[hydra.core.Term,
   hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]] =
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]]](hydra.lib.maps.`null`[hydra.core.Term,
     hydra.core.Term](m))(hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type,
     ...
     hydra.lib.lists.at[hydra.core.Type](1)(typeArgs))), cx)))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeArityMismatch(hydra.error.checking.TypeArityMismatchError(hydra.core.Type.map(hydra.core.MapType(hydra.core.Type.unit,
  ...
  {
    lazy val keyFoldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
       hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
       Tuple2[Seq[hydra.core.Type], hydra.context.Context]], Tuple2[hydra.core.Term, hydra.core.Term]]((acc: Either[hydra.context.InContext[hydra.errors.Error],
       Tuple2[Seq[hydra.core.Type], hydra.context.Context]]) =>
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type], hydra.context.Context],
      ...
      lazy val keyTypes: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], hydra.context.Context](keyFoldR)
      {
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Type, Tuple2[hydra.core.Type,
          ...
          {
          lazy val valFoldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
             hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
             Tuple2[Seq[hydra.core.Type], hydra.context.Context]], Tuple2[hydra.core.Term, hydra.core.Term]]((acc: Either[hydra.context.InContext[hydra.errors.Error],
             Tuple2[Seq[hydra.core.Type], hydra.context.Context]]) =>
            (p: Tuple2[hydra.core.Term, hydra.core.Term]) =>
...
def typeOfMaybe(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(mt: Option[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
  lazy val forNothing: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]] = {
    ...
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type,
       ...
       cx)))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeArityMismatch(hydra.error.checking.TypeArityMismatchError(hydra.core.Type.maybe(hydra.core.Type.unit),
       1, n, typeArgs))), cx)))
  }
...
def typeOfPair(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(p: Tuple2[hydra.core.Term,
    ...
    lazy val pairFst: hydra.core.Term = hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](p)
    {
      ...
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context],
        ...
        lazy val firstType: hydra.core.Type = hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context](result1)
        {
          lazy val cx2: hydra.context.Context = hydra.lib.pairs.second[hydra.core.Type, hydra.context.Context](result1)
          hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type,
             hydra.context.Context], Tuple2[hydra.core.Type, hydra.context.Context]](hydra.checking.typeOf(cx2)(tx)(Seq())(pairSnd))((result2: Tuple2[hydra.core.Type,
             hydra.context.Context]) =>
            {
  ...
  })(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeArityMismatch(hydra.error.checking.TypeArityMismatchError(hydra.core.Type.pair(hydra.core.PairType(hydra.core.Type.unit,
     hydra.core.Type.unit)), 2, n, typeArgs))), cx)))
}

def typeOfPrimitive(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(name: hydra.core.Name): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfProjection(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(p: hydra.core.Projection): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfRecord(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(record: hydra.core.Record): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfSet(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(els: scala.collection.immutable.Set[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]]](hydra.lib.sets.`null`[hydra.core.Term](els))(hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error],
     ...
     cx)))(Left(hydra.context.InContext(hydra.errors.Error.checking(hydra.error.checking.CheckingError.typeArityMismatch(hydra.error.checking.TypeArityMismatchError(hydra.core.Type.set(hydra.core.Type.unit),
     1, hydra.lib.lists.length[hydra.core.Type](typeArgs), typeArgs))), cx))))({
  lazy val foldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
     hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
     Tuple2[Seq[hydra.core.Type], hydra.context.Context]], hydra.core.Term]((acc: Either[hydra.context.InContext[hydra.errors.Error],
...
def typeOfTypeLambda(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(tl: hydra.core.TypeLambda): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfUnit(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type]): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Type, Tuple2[hydra.core.Type,
...
def typeOfVariable(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(name: hydra.core.Name): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
