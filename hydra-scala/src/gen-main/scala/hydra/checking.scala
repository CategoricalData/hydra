...
def applyTypeArgumentsToType(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(t: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  val nonnull: Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] = t match
...
def checkForUnboundTypeVariables(cx: hydra.context.Context)(tx: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  def checkRecursive(vars: scala.collection.immutable.Set[hydra.core.Name])(trace: Seq[scala.Predef.String])(lbinding: Option[hydra.core.Binding])(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error],
    ...
    val dflt: Either[hydra.context.InContext[hydra.errors.Error], Unit] = hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
...
def typeOfCaseStatement(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(cs: hydra.core.CaseStatement): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Option[Tuple2[hydra.core.Type, hydra.context.Context]],
       ...
       hydra.core.Type](hydra.lib.pairs.first[hydra.core.Type, hydra.context.Context])(dfltResult)
    {
      ...
      {
        val foldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
          ...
          val tcterms: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], hydra.context.Context](foldR)
          {
            ...
            {
              val fcodsResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
                 hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
...
def typeOfLet(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(letTerm: hydra.core.Let): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  val btypesResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type], Unit]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
     Tuple2[Seq[hydra.core.Type], Unit]], hydra.core.Binding]((acc: Either[hydra.context.InContext[hydra.errors.Error],
...
def typeOfList(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(els: Seq[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  val foldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type], hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
     Tuple2[Seq[hydra.core.Type], hydra.context.Context]], hydra.core.Term]((acc: Either[hydra.context.InContext[hydra.errors.Error],
     Tuple2[Seq[hydra.core.Type], hydra.context.Context]]) =>
    (term: hydra.core.Term) =>
...
def typeOfMap(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(m: Map[hydra.core.Term,
  ...
  {
    val keyFoldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
       hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type], hydra.context.Context],
      ...
      val keyTypes: Seq[hydra.core.Type] = hydra.lib.pairs.first[Seq[hydra.core.Type], hydra.context.Context](keyFoldR)
      {
        ...
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Type, Tuple2[hydra.core.Type,
          ...
          {
          val valFoldResult: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[Seq[hydra.core.Type],
             hydra.context.Context]] = hydra.lib.lists.foldl[Either[hydra.context.InContext[hydra.errors.Error],
             Tuple2[Seq[hydra.core.Type], hydra.context.Context]], Tuple2[hydra.core.Term, hydra.core.Term]]((acc: Either[hydra.context.InContext[hydra.errors.Error],
             Tuple2[Seq[hydra.core.Type], hydra.context.Context]]) =>
            (p: Tuple2[hydra.core.Term, hydra.core.Term]) =>
...
def typeOfMaybe(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(mt: Option[hydra.core.Term]): Either[hydra.context.InContext[hydra.errors.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
  val forNothing: Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]] = {
    val n: Int = hydra.lib.lists.length[hydra.core.Type](typeArgs)
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type,
...
def typeOfPrimitive(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(name: hydra.core.Name): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]],
     hydra.core.TypeScheme](Left(hydra.context.InContext(hydra.errors.Error.undefinedTerm(hydra.error.core.UndefinedTermError(name)),
...
def typeOfVariable(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(name: hydra.core.Name): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Tuple2[hydra.core.Type, hydra.context.Context]],
     hydra.core.TypeScheme](Left(hydra.context.InContext(hydra.errors.Error.undefinedType(hydra.error.core.UndefinedTypeError(name)),
