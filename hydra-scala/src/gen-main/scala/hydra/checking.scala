...
def applyTypeArgumentsToType[T0](cx: hydra.context.Context)(tx: T0)(typeArgs: Seq[hydra.core.Type])(t: hydra.core.Type): Either[hydra.context.InContext[hydra.error.Error],
   hydra.core.Type] =
  {
  val nonnull: Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type] = t match
    ...
    case _ => Left(hydra.context.InContext(hydra.error.Error.checking(hydra.error.CheckingError.notAForallType(hydra.error.NotAForallTypeError(t,
       typeArgs))), cx))
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type]](hydra.lib.lists.`null`[hydra.core.Type](typeArgs))(Right(t))(nonnull)
}
...
def typeOfLiteral[T0](cx: hydra.context.Context)(tx: T0)(typeArgs: Seq[hydra.core.Type])(lit: hydra.core.Literal): Either[hydra.context.InContext[hydra.error.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
...
def typeOfPrimitive(cx: hydra.context.Context)(tx: hydra.graph.Graph)(typeArgs: Seq[hydra.core.Type])(name: hydra.core.Name): Either[hydra.context.InContext[hydra.error.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  {
  val rawTs: Option[hydra.core.TypeScheme] = hydra.lib.maps.lookup[hydra.core.Name, hydra.core.TypeScheme](name)(hydra.lib.maps.fromList[hydra.core.Name,
...
def typeOfUnit[T0](cx: hydra.context.Context)(tx: T0)(typeArgs: Seq[hydra.core.Type]): Either[hydra.context.InContext[hydra.error.Error],
   Tuple2[hydra.core.Type, hydra.context.Context]] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.error.Error], hydra.core.Type, Tuple2[hydra.core.Type,
