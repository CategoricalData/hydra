...
def grammar(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.grammar.Grammar] =
  ...
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[Seq[hydra.grammar.Production],
     hydra.grammar.Grammar, hydra.errors.DecodingError]((b: Seq[hydra.grammar.Production]) => b)(hydra.extract.helpers.decodeList(hydra.decode.grammar.production)(cx)(v_Term_wrap_wrappedTerm.body))
  case _ => Left("expected wrapped type"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def pattern(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.grammar.Pattern] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.grammar.Pattern])] = hydra.lib.maps.fromList[hydra.core.Name,
