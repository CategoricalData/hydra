...
def eliminationVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.variants.EliminationVariant] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.variants.EliminationVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
      ...
      hydra.lib.eithers.map[Unit, hydra.variants.EliminationVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.EliminationVariant.record(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("union", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.EliminationVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.EliminationVariant.union(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
...
def functionVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.variants.FunctionVariant] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.variants.FunctionVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
       ...
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.FunctionVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.FunctionVariant.elimination(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("lambda", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.FunctionVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.FunctionVariant.lambda(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
...
def literalVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.variants.LiteralVariant] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.variants.LiteralVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
       ...
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.LiteralVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.LiteralVariant.binary(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("boolean", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.LiteralVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.LiteralVariant.boolean(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("float", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.LiteralVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.LiteralVariant.float(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("integer", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.LiteralVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.LiteralVariant.integer(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
...
def termVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.variants.TermVariant] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.variants.TermVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
       ...
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.annotated(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("application", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.application(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("either", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.either(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("function", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.function(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("let", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.let(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("list", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.list(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("literal", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.literal(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("map", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.map(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("maybe", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.maybe(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("pair", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.pair(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("record", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.record(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("set", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.set(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("typeApplication", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.typeApplication(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("typeLambda", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.typeLambda(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("union", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.union(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("unit", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.unit(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("variable", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TermVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TermVariant.variable(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("wrap", (input: hydra.core.Term) =>
...
def typeVariant(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.variants.TypeVariant] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.variants.TypeVariant])] = hydra.lib.maps.fromList[hydra.core.Name,
       ...
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.annotated(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("application", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.application(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("either", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.either(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("forall", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.forall(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("function", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.function(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("list", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.list(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("literal", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.literal(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("map", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.map(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("maybe", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.maybe(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("pair", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.pair(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("record", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.record(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("set", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.set(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("union", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.union(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("unit", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.unit(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("variable", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.variable(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("void", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.variants.TypeVariant, hydra.errors.DecodingError]((t: Unit) => hydra.variants.TypeVariant.void(t))(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("wrap", (input: hydra.core.Term) =>
