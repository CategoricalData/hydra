...
def error(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.errors.Error] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.errors.Error])] = hydra.lib.maps.fromList[hydra.core.Name,
      ...
      hydra.lib.eithers.map[hydra.error.core.UndefinedFieldError, hydra.errors.Error, hydra.errors.DecodingError]((t: hydra.error.core.UndefinedFieldError) => hydra.errors.Error.undefinedField(t))(hydra.decode.error.core.undefinedFieldError(cx)(input))),
         Tuple2("undefinedTerm", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[hydra.error.core.UndefinedTermError, hydra.errors.Error, hydra.errors.DecodingError]((t: hydra.error.core.UndefinedTermError) => hydra.errors.Error.undefinedTerm(t))(hydra.decode.error.core.undefinedTermError(cx)(input))),
         Tuple2("undefinedType", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[hydra.error.core.UndefinedTypeError, hydra.errors.Error, hydra.errors.DecodingError]((t: hydra.error.core.UndefinedTypeError) => hydra.errors.Error.undefinedType(t))(hydra.decode.error.core.undefinedTypeError(cx)(input))),
