...
def subtermEdge(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.paths.SubtermEdge] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.paths.SubtermNode, hydra.paths.SubtermEdge](hydra.extract.core.requireField("source")(hydra.decode.paths.subtermNode)(fieldMap)(cx))((field_source: hydra.paths.SubtermNode) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.paths.SubtermPath, hydra.paths.SubtermEdge](hydra.extract.core.requireField("path")(hydra.decode.paths.subtermPath)(fieldMap)(cx))((field_path: hydra.paths.SubtermPath) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.paths.SubtermNode, hydra.paths.SubtermEdge](hydra.extract.core.requireField("target")(hydra.decode.paths.subtermNode)(fieldMap)(cx))((field_target: hydra.paths.SubtermNode) =>
...
def subtermGraph(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.paths.SubtermGraph] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    lazy val fieldMap: Map[hydra.core.Name, hydra.core.Term] = hydra.extract.core.toFieldMap(v_Term_record_record)
    hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.paths.SubtermNode], hydra.paths.SubtermGraph](hydra.extract.core.requireField("nodes")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
      hydra.extract.core.decodeList(hydra.decode.paths.subtermNode)(v1)(v2))(fieldMap)(cx))((field_nodes: Seq[hydra.paths.SubtermNode]) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.paths.SubtermEdge], hydra.paths.SubtermGraph](hydra.extract.core.requireField("edges")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
...
def subtypeEdge(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.paths.SubtypeEdge] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.paths.SubtypeNode, hydra.paths.SubtypeEdge](hydra.extract.core.requireField("source")(hydra.decode.paths.subtypeNode)(fieldMap)(cx))((field_source: hydra.paths.SubtypeNode) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.paths.SubtypePath, hydra.paths.SubtypeEdge](hydra.extract.core.requireField("path")(hydra.decode.paths.subtypePath)(fieldMap)(cx))((field_path: hydra.paths.SubtypePath) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.paths.SubtypeNode, hydra.paths.SubtypeEdge](hydra.extract.core.requireField("target")(hydra.decode.paths.subtypeNode)(fieldMap)(cx))((field_target: hydra.paths.SubtypeNode) =>
...
def subtypeGraph(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.paths.SubtypeGraph] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    lazy val fieldMap: Map[hydra.core.Name, hydra.core.Term] = hydra.extract.core.toFieldMap(v_Term_record_record)
    hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.paths.SubtypeNode], hydra.paths.SubtypeGraph](hydra.extract.core.requireField("nodes")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
      hydra.extract.core.decodeList(hydra.decode.paths.subtypeNode)(v1)(v2))(fieldMap)(cx))((field_nodes: Seq[hydra.paths.SubtypeNode]) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[hydra.paths.SubtypeEdge], hydra.paths.SubtypeGraph](hydra.extract.core.requireField("edges")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
