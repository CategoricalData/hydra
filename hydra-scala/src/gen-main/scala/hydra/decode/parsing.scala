...
def parseResult[T0](a: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError, T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]] =
  hydra.lib.eithers.either[scala.Predef.String, hydra.core.Term, Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]]]((err: scala.Predef.String) => Left(err))((stripped: hydra.core.Term) =>
  stripped match
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]])] = hydra.lib.maps.fromList[hydra.core.Name, (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]]](Seq(Tuple2("success", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[hydra.parsing.ParseSuccess[T0], hydra.parsing.ParseResult[T0], hydra.errors.DecodingError]((t: hydra.parsing.ParseSuccess[T0]) => hydra.parsing.ParseResult.success(t))(hydra.decode.parsing.parseSuccess(a)(cx)(input))), Tuple2("failure", (input: hydra.core.Term) =>
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]], (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]]](Left(hydra.lib.strings.cat(Seq("no such field ", fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]])) => f(fterm))(hydra.lib.maps.lookup[hydra.core.Name, (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.parsing.ParseResult[T0]]](fname)(variantMap))
  }
  case _ => Left("expected union"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))

def parseSuccess[T0](a: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError, T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.parsing.ParseSuccess[T0]] =
