...
def caseConvention(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.util.CaseConvention] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.util.CaseConvention])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.util.CaseConvention]](Seq(Tuple2("camel",
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.util.CaseConvention, hydra.errors.DecodingError]((t: Unit) => hydra.util.CaseConvention.camel)(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("pascal", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.util.CaseConvention, hydra.errors.DecodingError]((t: Unit) => hydra.util.CaseConvention.pascal)(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("lowerSnake", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.util.CaseConvention, hydra.errors.DecodingError]((t: Unit) => hydra.util.CaseConvention.lowerSnake)(hydra.extract.helpers.decodeUnit(cx)(input))),
...
def comparison(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.util.Comparison] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.util.Comparison])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.util.Comparison]](Seq(Tuple2("lessThan",
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.util.Comparison, hydra.errors.DecodingError]((t: Unit) => hydra.util.Comparison.lessThan)(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("equalTo", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.util.Comparison, hydra.errors.DecodingError]((t: Unit) => hydra.util.Comparison.equalTo)(hydra.extract.helpers.decodeUnit(cx)(input))),
...
def precision(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.util.Precision] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.util.Precision])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.util.Precision]](Seq(Tuple2("arbitrary",
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.util.Precision, hydra.errors.DecodingError]((t: Unit) => hydra.util.Precision.arbitrary)(hydra.extract.helpers.decodeUnit(cx)(input))),
