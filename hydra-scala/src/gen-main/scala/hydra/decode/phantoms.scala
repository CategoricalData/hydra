...
def tBinding[T0, T1](a: T0)(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.phantoms.TBinding[T1]] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.core.Name, hydra.phantoms.TBinding[T1]](hydra.extract.helpers.requireField("name")(hydra.decode.core.name)(fieldMap)(cx))((field_name: hydra.core.Name) =>
      ...
      (v2: hydra.core.Term) => hydra.decode.phantoms.tTerm(a)(v1)(v2))(fieldMap)(cx))((field_term: hydra.phantoms.TTerm[T1]) => Right(hydra.phantoms.TBinding(field_name, field_term))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))

def tTerm[T0, T1](a: T0)(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.phantoms.TTerm[T1]] =
  hydra.lib.eithers.either[scala.Predef.String, hydra.core.Term, Either[hydra.errors.DecodingError, hydra.phantoms.TTerm[T1]]]((err: scala.Predef.String) => Left(err))((stripped: hydra.core.Term) =>
  stripped match
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[hydra.core.Term, hydra.phantoms.TTerm[T1], hydra.errors.DecodingError]((b: hydra.core.Term) => b)(hydra.decode.core.term(cx)(v_Term_wrap_wrappedTerm.body))
