...
def value(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.json.model.Value] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    lazy val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.json.model.Value])] = hydra.lib.maps.fromList[hydra.core.Name, (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.json.model.Value]](Seq(Tuple2("array", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Seq[hydra.json.model.Value], hydra.json.model.Value, hydra.errors.DecodingError]((t: Seq[hydra.json.model.Value]) => hydra.json.model.Value.array(t))(hydra.extract.helpers.decodeList(hydra.decode.json.model.value)(cx)(input))), Tuple2("boolean", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Boolean, hydra.json.model.Value, hydra.errors.DecodingError]((t: Boolean) => hydra.json.model.Value.boolean(t))(hydra.lib.eithers.either[scala.Predef.String, hydra.core.Term, Either[hydra.errors.DecodingError, Boolean]]((err: scala.Predef.String) => Left(err))((stripped2: hydra.core.Term) =>
      stripped2 match
      ...
      hydra.lib.eithers.map[Map[scala.Predef.String, hydra.json.model.Value], hydra.json.model.Value, hydra.errors.DecodingError]((t: Map[scala.Predef.String, hydra.json.model.Value]) => hydra.json.model.Value.`object`(t))(hydra.extract.helpers.decodeMap((cx2: hydra.graph.Graph) =>
      ...
      case _ => Left("expected literal"))(hydra.lexical.stripAndDereferenceTermEither(cx2)(raw2)))(hydra.decode.json.model.value)(cx)(input))), Tuple2("string", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[scala.Predef.String, hydra.json.model.Value, hydra.errors.DecodingError]((t: scala.Predef.String) => hydra.json.model.Value.string(t))(hydra.lib.eithers.either[scala.Predef.String, hydra.core.Term, Either[hydra.errors.DecodingError, scala.Predef.String]]((err: scala.Predef.String) => Left(err))((stripped2: hydra.core.Term) =>
      stripped2 match
      case hydra.core.Term.literal(v_Term_literal_v) => v_Term_literal_v match
        case hydra.core.Literal.string(v_Literal_string_s) => Right(v_Literal_string_s)
        case _ => Left("expected string literal")
      case _ => Left("expected literal"))(hydra.lexical.stripAndDereferenceTermEither(cx)(input))))))
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.json.model.Value], (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.json.model.Value]](Left(hydra.lib.strings.cat(Seq("no such field ", fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.json.model.Value])) => f(fterm))(hydra.lib.maps.lookup[hydra.core.Name, (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.json.model.Value]](fname)(variantMap))
  }
