...
def columnType(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.tabular.ColumnType] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.relational.ColumnName, hydra.tabular.ColumnType](hydra.extract.helpers.requireField("name")(hydra.decode.relational.columnName)(fieldMap)(cx))((field_name: hydra.relational.ColumnName) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.core.Type, hydra.tabular.ColumnType](hydra.extract.helpers.requireField("type")(hydra.decode.core.`type`)(fieldMap)(cx))((field_type: hydra.core.Type) => Right(hydra.tabular.ColumnType(field_name, field_type))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))

def dataRow[T0](v: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError, T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.tabular.DataRow[T0]] =
  ...
  stripped match
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[Seq[Option[T0]], hydra.tabular.DataRow[T0], hydra.errors.DecodingError]((b: Seq[Option[T0]]) => b)(hydra.extract.helpers.decodeList((v1: hydra.graph.Graph) =>
...
def headerRow(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.tabular.HeaderRow] =
  ...
  stripped match
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[Seq[scala.Predef.String], hydra.tabular.HeaderRow, hydra.errors.DecodingError]((b: Seq[scala.Predef.String]) => b)(hydra.extract.helpers.decodeList((cx2: hydra.graph.Graph) =>
...
def table[T0](v: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError, T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.tabular.Table[T0]] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, Option[hydra.tabular.HeaderRow], hydra.tabular.Table[T0]](hydra.extract.helpers.requireField("header")((v1: hydra.graph.Graph) =>
      ...
      (v22: hydra.core.Term) => hydra.decode.tabular.dataRow(v)(v12)(v22))(v1)(v2))(fieldMap)(cx))((field_data: Seq[hydra.tabular.DataRow[T0]]) => Right(hydra.tabular.Table(field_header, field_data))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def tableType(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.tabular.TableType] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.relational.RelationName, hydra.tabular.TableType](hydra.extract.helpers.requireField("name")(hydra.decode.relational.relationName)(fieldMap)(cx))((field_name: hydra.relational.RelationName) =>
      ...
      (v2: hydra.core.Term) =>
      hydra.extract.helpers.decodeList(hydra.decode.tabular.columnType)(v1)(v2))(fieldMap)(cx))((field_columns: Seq[hydra.tabular.ColumnType]) => Right(hydra.tabular.TableType(field_name, field_columns))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
