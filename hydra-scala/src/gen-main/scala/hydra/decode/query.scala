...
def comparisonConstraint(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.query.ComparisonConstraint] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.query.ComparisonConstraint])] = hydra.lib.maps.fromList[hydra.core.Name,
...
def node(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.query.Node] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.query.Node])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.query.Node]](Seq(Tuple2("term", (input: hydra.core.Term) =>
...
def path(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.query.Path] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.query.Path])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.query.Path]](Seq(Tuple2("step", (input: hydra.core.Term) =>
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.query.Path], (hydra.core.Term) => Either[hydra.errors.DecodingError,
       hydra.query.Path]](Left(hydra.lib.strings.cat(Seq("no such field ", fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError,
...
def pathEquation(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.query.PathEquation] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.query.Path, hydra.query.PathEquation](hydra.extract.helpers.requireField("left")(hydra.decode.query.path)(fieldMap)(cx))((field_left: hydra.query.Path) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.query.Path, hydra.query.PathEquation](hydra.extract.helpers.requireField("right")(hydra.decode.query.path)(fieldMap)(cx))((field_right: hydra.query.Path) => Right(hydra.query.PathEquation(field_left,
         field_right))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def pattern(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.query.Pattern] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.query.Pattern])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.query.Pattern]](Seq(Tuple2("triple",
       (input: hydra.core.Term) =>
      ...
      hydra.lib.eithers.map[Seq[hydra.query.Pattern], hydra.query.Pattern, hydra.errors.DecodingError]((t: Seq[hydra.query.Pattern]) => hydra.query.Pattern.conjunction(t))(hydra.extract.helpers.decodeList(hydra.decode.query.pattern)(cx)(input))),
         Tuple2("disjunction", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Seq[hydra.query.Pattern], hydra.query.Pattern, hydra.errors.DecodingError]((t: Seq[hydra.query.Pattern]) => hydra.query.Pattern.disjunction(t))(hydra.extract.helpers.decodeList(hydra.decode.query.pattern)(cx)(input))),
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.query.Pattern], (hydra.core.Term) => Either[hydra.errors.DecodingError,
       hydra.query.Pattern]](Left(hydra.lib.strings.cat(Seq("no such field ", fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError,
...
def regexQuantifier(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.query.RegexQuantifier] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.query.RegexQuantifier])] = hydra.lib.maps.fromList[hydra.core.Name,
...
def step(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.query.Step] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.query.Step])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.query.Step]](Seq(Tuple2("edge", (input: hydra.core.Term) =>
    ...
    hydra.lib.maybes.maybe[Either[hydra.errors.DecodingError, hydra.query.Step], (hydra.core.Term) => Either[hydra.errors.DecodingError,
       hydra.query.Step]](Left(hydra.lib.strings.cat(Seq("no such field ", fname, " in union"))))((f: (hydra.core.Term => Either[hydra.errors.DecodingError,
