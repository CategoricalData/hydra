...
def inContext[T0](e: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError, T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, T0, hydra.context.InContext[T0]](hydra.extract.helpers.requireField("object")(e)(fieldMap)(cx))((field_object: T0) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.context.Context, hydra.context.InContext[T0]](hydra.extract.helpers.requireField("context")(hydra.decode.context.context)(fieldMap)(cx))((field_context: hydra.context.Context) => Right(hydra.context.InContext(field_object,
         field_context))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
