...
def context(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.context.Context] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, Seq[scala.Predef.String], hydra.context.Context](hydra.extract.core.requireField("trace")((v1: hydra.graph.Graph) =>
      (v2: hydra.core.Term) =>
