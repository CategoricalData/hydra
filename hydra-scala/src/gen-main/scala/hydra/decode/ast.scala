...
def associativity(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.Associativity] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.ast.Associativity])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.ast.Associativity]](Seq(Tuple2("none",
       (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.ast.Associativity, hydra.errors.DecodingError]((t: Unit) => hydra.ast.Associativity.none)(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("left", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.ast.Associativity, hydra.errors.DecodingError]((t: Unit) => hydra.ast.Associativity.left)(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("right", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.ast.Associativity, hydra.errors.DecodingError]((t: Unit) => hydra.ast.Associativity.right)(hydra.extract.helpers.decodeUnit(cx)(input))),
...
def brackets(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.Brackets] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.Symbol, hydra.ast.Brackets](hydra.extract.helpers.requireField("open")(hydra.decode.ast.symbol)(fieldMap)(cx))((field_open: hydra.ast.Symbol) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.Symbol, hydra.ast.Brackets](hydra.extract.helpers.requireField("close")(hydra.decode.ast.symbol)(fieldMap)(cx))((field_close: hydra.ast.Symbol) => Right(hydra.ast.Brackets(field_open,
         field_close))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def expr(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.Expr] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.ast.Expr])] = hydra.lib.maps.fromList[hydra.core.Name,
...
def indentedExpression(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.IndentedExpression] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.IndentStyle, hydra.ast.IndentedExpression](hydra.extract.helpers.requireField("style")(hydra.decode.ast.indentStyle)(fieldMap)(cx))((field_style: hydra.ast.IndentStyle) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.Expr, hydra.ast.IndentedExpression](hydra.extract.helpers.requireField("expr")(hydra.decode.ast.expr)(fieldMap)(cx))((field_expr: hydra.ast.Expr) => Right(hydra.ast.IndentedExpression(field_style,
         field_expr))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def indentStyle(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.IndentStyle] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.ast.IndentStyle])] = hydra.lib.maps.fromList[hydra.core.Name,
...
def opExpr(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.OpExpr] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.Op, hydra.ast.OpExpr](hydra.extract.helpers.requireField("op")(hydra.decode.ast.op)(fieldMap)(cx))((field_op: hydra.ast.Op) =>
      ...
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.Expr, hydra.ast.OpExpr](hydra.extract.helpers.requireField("rhs")(hydra.decode.ast.expr)(fieldMap)(cx))((field_rhs: hydra.ast.Expr) => Right(hydra.ast.OpExpr(field_op,
         field_lhs, field_rhs)))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def padding(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.Padding] =
  ...
  case hydra.core.Term.record(v_Term_record_record) => {
    ...
    hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.Ws, hydra.ast.Padding](hydra.extract.helpers.requireField("left")(hydra.decode.ast.ws)(fieldMap)(cx))((field_left: hydra.ast.Ws) =>
      hydra.lib.eithers.bind[hydra.errors.DecodingError, hydra.ast.Ws, hydra.ast.Padding](hydra.extract.helpers.requireField("right")(hydra.decode.ast.ws)(fieldMap)(cx))((field_right: hydra.ast.Ws) => Right(hydra.ast.Padding(field_left,
         field_right))))
  }
  case _ => Left("expected record"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def ws(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.ast.Ws] =
  ...
  case hydra.core.Term.union(v_Term_union_inj) => {
    ...
    val fname: hydra.core.Name = (field.name)
    val fterm: hydra.core.Term = (field.term)
    val variantMap: Map[hydra.core.Name, (hydra.core.Term => Either[hydra.errors.DecodingError, hydra.ast.Ws])] = hydra.lib.maps.fromList[hydra.core.Name,
       (hydra.core.Term) => Either[hydra.errors.DecodingError, hydra.ast.Ws]](Seq(Tuple2("none", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.ast.Ws, hydra.errors.DecodingError]((t: Unit) => hydra.ast.Ws.none)(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("space", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.ast.Ws, hydra.errors.DecodingError]((t: Unit) => hydra.ast.Ws.space)(hydra.extract.helpers.decodeUnit(cx)(input))),
         Tuple2("break", (input: hydra.core.Term) =>
      hydra.lib.eithers.map[Unit, hydra.ast.Ws, hydra.errors.DecodingError]((t: Unit) => hydra.ast.Ws.break)(hydra.extract.helpers.decodeUnit(cx)(input))),
