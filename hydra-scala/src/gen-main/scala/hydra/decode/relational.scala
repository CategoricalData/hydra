...
def primaryKey(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError, hydra.relational.PrimaryKey] =
  ...
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[Seq[hydra.relational.ColumnName],
     hydra.relational.PrimaryKey, hydra.errors.DecodingError]((b: Seq[hydra.relational.ColumnName]) => b)(hydra.extract.helpers.decodeList(hydra.decode.relational.columnName)(cx)(v_Term_wrap_wrappedTerm.body))
  case _ => Left("expected wrapped type"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
...
def relation[T0](v: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError, T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[Seq[hydra.relational.Row[T0]],
     hydra.relational.Relation[T0], hydra.errors.DecodingError]((b: Seq[hydra.relational.Row[T0]]) => b)(hydra.extract.helpers.decodeList((v1: hydra.graph.Graph) =>
...
def row[T0](v: (hydra.graph.Graph => hydra.core.Term => Either[hydra.errors.DecodingError, T0]))(cx: hydra.graph.Graph)(raw: hydra.core.Term): Either[hydra.errors.DecodingError,
  ...
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.eithers.map[Seq[T0], hydra.relational.Row[T0],
     hydra.errors.DecodingError]((b: Seq[T0]) => b)(hydra.extract.helpers.decodeList(v)(cx)(v_Term_wrap_wrappedTerm.body))
  case _ => Left("expected wrapped type"))(hydra.lexical.stripAndDereferenceTermEither(cx)(raw))
