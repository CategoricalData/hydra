...
def nameToFilePath(nsConv: hydra.util.CaseConvention)(localConv: hydra.util.CaseConvention)(ext: hydra.packaging.FileExtension)(name: hydra.core.Name): scala.Predef.String =
  ...
  lazy val prefix: scala.Predef.String = hydra.lib.maybes.maybe[scala.Predef.String, hydra.packaging.Namespace]("")((n: hydra.packaging.Namespace) => hydra.lib.strings.cat2(nsToFilePath(n))("/"))(ns)
...
def qname(ns: hydra.packaging.Namespace)(name: scala.Predef.String): hydra.core.Name = hydra.lib.strings.cat(Seq(ns, ".", name))
...
def unqualifyName(qname: hydra.packaging.QualifiedName): hydra.core.Name =
  {
  lazy val prefix: scala.Predef.String = hydra.lib.maybes.maybe[scala.Predef.String, hydra.packaging.Namespace]("")((n: hydra.packaging.Namespace) => hydra.lib.strings.cat2(n)("."))(qname.namespace)
