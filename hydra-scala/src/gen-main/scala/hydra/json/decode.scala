  ...
  stripped match
    ...
    case hydra.core.Type.list(v_Type_list_elemType) => {
      def decodeElem(v: hydra.json.model.Value): Either[scala.Predef.String, hydra.core.Term] = hydra.json.decode.fromJson(types)(tname)(v_Type_list_elemType)(v)
      {
        ...
        hydra.lib.eithers.either[scala.Predef.String, Seq[hydra.json.model.Value], Either[scala.Predef.String,
          ...
          {
          val decoded: Either[scala.Predef.String, Seq[hydra.core.Term]] = hydra.lib.eithers.mapList[hydra.json.model.Value,
    ...
    case hydra.core.Type.maybe(v_Type_maybe_innerType) => {
        ...
        hydra.lib.eithers.map[hydra.core.Term, hydra.core.Term, scala.Predef.String]((v: hydra.core.Term) => hydra.core.Term.maybe(Some(v)))(hydra.json.decode.fromJson(types)(tname)(v_Type_maybe_innerType)(hydra.lib.lists.head[hydra.json.model.Value](arr)))
      {
        def decodeMaybeArray(arr: Seq[hydra.json.model.Value]): Either[scala.Predef.String, hydra.core.Term] =
          {
          val len: Int = hydra.lib.lists.length[hydra.json.model.Value](arr)
    ...
    case hydra.core.Type.record(v_Type_record_rt) => {
      ...
      hydra.lib.eithers.either[scala.Predef.String, Map[scala.Predef.String, hydra.json.model.Value],
        ...
        def decodeField(ft: hydra.core.FieldType): Either[scala.Predef.String, hydra.core.Field] =
          ...
          val mval: Option[hydra.json.model.Value] = hydra.lib.maps.lookup[scala.Predef.String, hydra.json.model.Value](fname)(obj)
          val defaultVal: hydra.json.model.Value = hydra.json.model.Value.`null`
          val jsonVal: hydra.json.model.Value = hydra.lib.maybes.fromMaybe[hydra.json.model.Value](defaultVal)(mval)
        ...
        {
          val decodedFields: Either[scala.Predef.String, Seq[hydra.core.Field]] = hydra.lib.eithers.mapList[hydra.core.FieldType,
    ...
    case hydra.core.Type.union(v_Type_union_rt) => {
      def decodeVariant(key: scala.Predef.String)(`val`: Option[hydra.json.model.Value])(ftype: hydra.core.Type): Either[scala.Predef.String, hydra.core.Term] =
        {
        val jsonVal: hydra.json.model.Value = hydra.lib.maybes.fromMaybe[hydra.json.model.Value](hydra.json.model.Value.`null`)(`val`)
        val decoded: Either[scala.Predef.String, hydra.core.Term] = hydra.json.decode.fromJson(types)(tname)(ftype)(jsonVal)
          ...
          hydra.lib.eithers.either[scala.Predef.String, Seq[hydra.json.model.Value], Either[scala.Predef.String,
            ...
            def decodeEntry(entryJson: hydra.json.model.Value): Either[scala.Predef.String, Tuple2[hydra.core.Term, hydra.core.Term]] =
              ...
              hydra.lib.eithers.either[scala.Predef.String, Map[scala.Predef.String, hydra.json.model.Value],
                 ...
                 hydra.json.model.Value]) =>
                {
                val keyJson: Option[hydra.json.model.Value] = hydra.lib.maps.lookup[scala.Predef.String, hydra.json.model.Value]("@key")(entryObj)
                {
                  val valJson: Option[hydra.json.model.Value] = hydra.lib.maps.lookup[scala.Predef.String, hydra.json.model.Value]("@value")(entryObj)
            ...
            {
              val entries: Either[scala.Predef.String, Seq[Tuple2[hydra.core.Term, hydra.core.Term]]] = hydra.lib.eithers.mapList[hydra.json.model.Value,
      ...
      val firstType: hydra.core.Type = (v_Type_pair_pt.first)
      {
        val secondType: hydra.core.Type = (v_Type_pair_pt.second)
        {
          ...
          hydra.lib.eithers.either[scala.Predef.String, Map[scala.Predef.String, hydra.json.model.Value],
             ...
             hydra.json.model.Value]) =>
            {
            val firstJson: Option[hydra.json.model.Value] = hydra.lib.maps.lookup[scala.Predef.String, hydra.json.model.Value]("@first")(obj)
            {
              val secondJson: Option[hydra.json.model.Value] = hydra.lib.maps.lookup[scala.Predef.String, hydra.json.model.Value]("@second")(obj)
      ...
      val leftType: hydra.core.Type = (v_Type_either_et.left)
      {
        val rightType: hydra.core.Type = (v_Type_either_et.right)
        {
          ...
          hydra.lib.eithers.either[scala.Predef.String, Map[scala.Predef.String, hydra.json.model.Value],
             ...
             hydra.json.model.Value]) =>
            {
            val leftJson: Option[hydra.json.model.Value] = hydra.lib.maps.lookup[scala.Predef.String, hydra.json.model.Value]("@left")(obj)
            {
              val rightJson: Option[hydra.json.model.Value] = hydra.lib.maps.lookup[scala.Predef.String, hydra.json.model.Value]("@right")(obj)
    ...
    case hydra.core.Type.variable(v_Type_variable_name) => {
      val lookedUp: Option[hydra.core.Type] = hydra.lib.maps.lookup[hydra.core.Name, hydra.core.Type](v_Type_variable_name)(types)
...
def decodeFloat(ft: hydra.core.FloatType)(value: hydra.json.model.Value): Either[scala.Predef.String, hydra.core.Term] =
  ...
  case hydra.core.FloatType.float32 => {
    ...
    hydra.lib.eithers.either[scala.Predef.String, scala.Predef.String, Either[scala.Predef.String, hydra.core.Term]]((err: scala.Predef.String) => Left(err))((s: scala.Predef.String) =>
      {
      val parsed: Option[Float] = hydra.lib.literals.readFloat32(s)
...
def decodeInteger(it: hydra.core.IntegerType)(value: hydra.json.model.Value): Either[scala.Predef.String, hydra.core.Term] =
  ...
  case hydra.core.IntegerType.bigint => {
    ...
    hydra.lib.eithers.either[scala.Predef.String, scala.Predef.String, Either[scala.Predef.String, hydra.core.Term]]((err: scala.Predef.String) => Left(err))((s: scala.Predef.String) =>
      {
      val parsed: Option[BigInt] = hydra.lib.literals.readBigint(s)
  ...
  case hydra.core.IntegerType.int64 => {
    ...
    hydra.lib.eithers.either[scala.Predef.String, scala.Predef.String, Either[scala.Predef.String, hydra.core.Term]]((err: scala.Predef.String) => Left(err))((s: scala.Predef.String) =>
      {
      val parsed: Option[Long] = hydra.lib.literals.readInt64(s)
  ...
  case hydra.core.IntegerType.uint32 => {
    ...
    hydra.lib.eithers.either[scala.Predef.String, scala.Predef.String, Either[scala.Predef.String, hydra.core.Term]]((err: scala.Predef.String) => Left(err))((s: scala.Predef.String) =>
      {
      val parsed: Option[Long] = hydra.lib.literals.readUint32(s)
  ...
  case hydra.core.IntegerType.uint64 => {
    ...
    hydra.lib.eithers.either[scala.Predef.String, scala.Predef.String, Either[scala.Predef.String, hydra.core.Term]]((err: scala.Predef.String) => Left(err))((s: scala.Predef.String) =>
      {
      val parsed: Option[BigInt] = hydra.lib.literals.readUint64(s)
