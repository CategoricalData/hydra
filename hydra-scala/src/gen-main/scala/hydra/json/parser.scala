...
val digits: hydra.parsing.Parser[scala.Predef.String] = hydra.parsers.map(hydra.lib.strings.fromList)(hydra.parsers.some(hydra.json.parser.digit))
...
val jsonNumber: hydra.parsing.Parser[hydra.json.model.Value] = hydra.json.parser.token(hydra.parsers.bind(hydra.json.parser.jsonIntegerPart)((intPart: scala.Predef.String) =>
  ...
  {
  val numStr: scala.Predef.String = hydra.lib.strings.cat2(hydra.lib.strings.cat2(intPart)(hydra.lib.maybes.maybe[scala.Predef.String,
