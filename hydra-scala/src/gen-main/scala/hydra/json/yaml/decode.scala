...
def yamlToJson(node: hydra.ext.org.yaml.model.Node): Either[scala.Predef.String, hydra.json.model.Value] =
  ...
  case hydra.ext.org.yaml.model.Node.mapping(v_Node_mapping_m) => {
    ...
    {
      lazy val entries: Either[scala.Predef.String, Seq[Tuple2[scala.Predef.String, hydra.json.model.Value]]] = hydra.lib.eithers.mapList[Tuple2[hydra.ext.org.yaml.model.Node,
  ...
  case hydra.ext.org.yaml.model.Node.sequence(v_Node_sequence_nodes) => {
    lazy val results: Either[scala.Predef.String, Seq[hydra.json.model.Value]] = hydra.lib.eithers.mapList[hydra.ext.org.yaml.model.Node,
