...
def yamlToJson(node: hydra.ext.org.yaml.model.Node): Either[scala.Predef.String, hydra.json.model.Value] =
  ...
  case hydra.ext.org.yaml.model.Node.mapping(v_Node_mapping_m) => {
    def convertEntry(kv: Tuple2[hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node]): Either[scala.Predef.String,
      ...
      {
      val keyNode: hydra.ext.org.yaml.model.Node = hydra.lib.pairs.first[hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node](kv)
      val valNode: hydra.ext.org.yaml.model.Node = hydra.lib.pairs.second[hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node](kv)
      ...
      hydra.lib.eithers.either[scala.Predef.String, scala.Predef.String, Either[scala.Predef.String, Tuple2[scala.Predef.String,
        ...
        hydra.lib.eithers.map[hydra.json.model.Value, Tuple2[scala.Predef.String, hydra.json.model.Value],
           scala.Predef.String]((v: hydra.json.model.Value) => Tuple2(key, v))(valResult)
      })(keyResult)
    }
    {
      val entries: Either[scala.Predef.String, Seq[Tuple2[scala.Predef.String, hydra.json.model.Value]]] = hydra.lib.eithers.mapList[Tuple2[hydra.ext.org.yaml.model.Node,
         hydra.ext.org.yaml.model.Node], Tuple2[scala.Predef.String, hydra.json.model.Value], scala.Predef.String](convertEntry)(hydra.lib.maps.toList[hydra.ext.org.yaml.model.Node,
      ...
      hydra.lib.eithers.map[Seq[Tuple2[scala.Predef.String, hydra.json.model.Value]], hydra.json.model.Value,
         scala.Predef.String]((es: Seq[Tuple2[scala.Predef.String, hydra.json.model.Value]]) =>
  ...
  case hydra.ext.org.yaml.model.Node.sequence(v_Node_sequence_nodes) => {
    val results: Either[scala.Predef.String, Seq[hydra.json.model.Value]] = hydra.lib.eithers.mapList[hydra.ext.org.yaml.model.Node,
