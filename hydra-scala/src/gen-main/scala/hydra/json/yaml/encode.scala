...
def jsonToYaml(value: hydra.json.model.Value): hydra.ext.org.yaml.model.Node =
  value match
  case hydra.json.model.Value.array(v_Value_array_arr) => hydra.ext.org.yaml.model.Node.sequence(hydra.lib.lists.map[hydra.json.model.Value, hydra.ext.org.yaml.model.Node]((v: hydra.json.model.Value) => hydra.json.yaml.encode.jsonToYaml(v))(v_Value_array_arr))
  ...
  case hydra.json.model.Value.`object`(v_Value_object_obj) => hydra.ext.org.yaml.model.Node.mapping(hydra.lib.maps.fromList[hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node](hydra.lib.lists.map[Tuple2[scala.Predef.String, hydra.json.model.Value], Tuple2[hydra.ext.org.yaml.model.Node, hydra.ext.org.yaml.model.Node]]((kv: Tuple2[scala.Predef.String, hydra.json.model.Value]) =>
    Tuple2(hydra.ext.org.yaml.model.Node.scalar(hydra.ext.org.yaml.model.Scalar.str(hydra.lib.pairs.first[scala.Predef.String, hydra.json.model.Value](kv))), hydra.json.yaml.encode.jsonToYaml(hydra.lib.pairs.second[scala.Predef.String, hydra.json.model.Value](kv))))(hydra.lib.maps.toList[scala.Predef.String, hydra.json.model.Value](v_Value_object_obj))))
