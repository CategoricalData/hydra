...
val typesByName: Map[hydra.core.Name, hydra.core.Type] = Map("hydra.coders.AdapterContext" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("graph",
   ...
   hydra.core.FieldType("undefinedTerm", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.core.UndefinedTermError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A reference to an undefined term")))))),
   hydra.core.FieldType("undefinedType", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.core.UndefinedTypeError"),
