...
lazy val typesByName: Map[hydra.core.Name, hydra.core.Type] = Map("hydra.coders.Adapter" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.forall(hydra.core.ForallType("t1",
   ...
   hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.variable("v1"), hydra.core.Type.either(hydra.core.EitherType(hydra.core.Type.variable("hydra.errors.Error"),
   ...
   hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.variable("v2"), hydra.core.Type.either(hydra.core.EitherType(hydra.core.Type.variable("hydra.errors.Error"),
   ...
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Any other error")))))), hydra.core.FieldType("resolution",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.errors.ResolutionError"),
   ...
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The binding name which was duplicated")))))))),
   ...
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The field name which appeared more than once")))))))),
   ...
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The field name which was not found")))))))),
   ...
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The binding name which was not found")))))))),
   ...
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The primitive name which was not found")))))))),
   ...
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Any other error"))))), "hydra.errors.OtherInferenceError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("path",
   ...
   hydra.core.Type.either(hydra.core.EitherType(hydra.core.Type.variable("hydra.errors.Error"), hydra.core.Type.variable("hydra.core.Term"))))))))),
   ...
   hydra.core.Type.either(hydra.core.EitherType(hydra.core.Type.variable("hydra.errors.Error"), hydra.core.Type.variable("a"))))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An encode function from terms to native values")))))),
   hydra.core.FieldType("decode", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.variable("hydra.context.Context"),
   hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.variable("a"), hydra.core.Type.either(hydra.core.EitherType(hydra.core.Type.variable("hydra.errors.Error"),
