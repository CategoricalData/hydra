...
val typesByName: Map[hydra.core.Name, hydra.core.Type] = Map("hydra.coders.AdapterContext" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("graph",
   ...
   "hydra.error.CheckingError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.union(Seq(hydra.core.FieldType("incorrectUnification",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.IncorrectUnificationError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A post-unification consistency check failure")))))),
   hydra.core.FieldType("notAForallType", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.NotAForallTypeError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type that is not a forall type when one was expected")))))),
   hydra.core.FieldType("notAFunctionType", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.NotAFunctionTypeError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type that is not a function type when one was expected")))))),
   hydra.core.FieldType("typeArityMismatch", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.TypeArityMismatchError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type constructor applied to the wrong number of arguments")))))),
   hydra.core.FieldType("typeMismatch", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.TypeMismatchError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type mismatch between expected and actual types")))))),
   hydra.core.FieldType("unboundTypeVariables", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UnboundTypeVariablesError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Type variables that are not bound in scope")))))),
   hydra.core.FieldType("unequalTypes", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UnequalTypesError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Multiple types that should be equal but are not")))))),
   hydra.core.FieldType("unsupportedTermVariant", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UnsupportedTermVariantError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A term variant that the type checker does not support")))))),
   hydra.core.FieldType("untypedLambda", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UntypedLambdaError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A lambda expression without a type annotation on its parameter")))))),
   hydra.core.FieldType("untypedLetBinding", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UntypedLetBindingError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A let binding without a type annotation")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An error that occurred during type checking"))))),
   "hydra.error.DecodingError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.wrap(hydra.core.Type.literal(hydra.core.LiteralType.string)),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An error that occurred during decoding of a term"))))),
   "hydra.error.DuplicateBindingError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("name",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The duplicated binding name")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A duplicate binding name in a let expression"))))),
   "hydra.error.DuplicateFieldError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("name",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The duplicated field name")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A duplicate field name in a record or union type"))))),
   "hydra.error.Error" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.union(Seq(hydra.core.FieldType("checking",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.CheckingError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type checking error")))))),
   hydra.core.FieldType("decoding", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.DecodingError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An error that occurred during decoding of a term")))))),
   hydra.core.FieldType("duplicateBinding", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.DuplicateBindingError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A duplicate binding name error")))))),
   hydra.core.FieldType("duplicateField", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.DuplicateFieldError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A duplicate field name error")))))),
   hydra.core.FieldType("other", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.OtherError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Any other error")))))), hydra.core.FieldType("undefinedField",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UndefinedFieldError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A reference to an undefined field")))))),
   hydra.core.FieldType("undefinedTerm", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UndefinedTermError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A reference to an undefined term")))))),
   hydra.core.FieldType("undefinedType", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UndefinedTypeError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A reference to an undefined type")))))),
   hydra.core.FieldType("unexpectedTermVariant", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UnexpectedTermVariantError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An unexpected term variant")))))),
   hydra.core.FieldType("unexpectedTypeVariant", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UnexpectedTypeVariantError"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An unexpected type variant")))))),
   hydra.core.FieldType("unification", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.error.UnificationError"),
   ...
   "hydra.error.IncorrectUnificationError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("substitution",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.typing.TypeSubst"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The substitution that failed the consistency check")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A post-unification consistency check failure"))))),
   "hydra.error.NotAForallTypeError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("type",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Type"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The actual type encountered")))))),
   hydra.core.FieldType("typeArguments", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.list(hydra.core.Type.variable("hydra.core.Type")),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The type arguments that were being applied")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type that is not a forall type when type arguments are being applied"))))),
   "hydra.error.NotAFunctionTypeError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("type",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Type"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The actual type encountered")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type that is not a function type when one was expected in an application"))))),
   "hydra.error.OtherError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.wrap(hydra.core.Type.literal(hydra.core.LiteralType.string)),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Any other error"))))), "hydra.error.TypeArityMismatchError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("type",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Type"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The type being checked")))))),
   hydra.core.FieldType("expectedArity", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.literal(hydra.core.LiteralType.integer(hydra.core.IntegerType.int32)),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The expected number of type arguments")))))),
   hydra.core.FieldType("actualArity", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.literal(hydra.core.LiteralType.integer(hydra.core.IntegerType.int32)),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The actual number of type arguments provided")))))),
   hydra.core.FieldType("typeArguments", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.list(hydra.core.Type.variable("hydra.core.Type")),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The type arguments that were provided")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type constructor applied to the wrong number of type arguments"))))),
   "hydra.error.TypeMismatchError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("expectedType",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Type"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The expected type")))))),
   hydra.core.FieldType("actualType", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Type"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The actual type encountered")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A type mismatch between expected and actual types"))))),
   "hydra.error.UnboundTypeVariablesError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("variables",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.set(hydra.core.Type.variable("hydra.core.Name")),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The set of unbound type variable names")))))),
   hydra.core.FieldType("type", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Type"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The type containing the unbound variables")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Type variables that appear free in a type but are not bound in scope"))))),
   "hydra.error.UndefinedFieldError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("fieldName",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The name of the undefined field")))))),
   hydra.core.FieldType("typeName", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The name of the type in which the field was expected")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A reference to a field that does not exist in the given type"))))),
   "hydra.error.UndefinedTermError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("name",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The name of the undefined term")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A reference to a term (element, binding, or primitive) that is not defined"))))),
   "hydra.error.UndefinedTypeError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("name",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Name"), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The name of the undefined type")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A reference to a type or type variable that is not defined"))))),
   "hydra.error.UnequalTypesError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("types",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.list(hydra.core.Type.variable("hydra.core.Type")),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The list of types that are not all equal")))))),
   hydra.core.FieldType("description", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.literal(hydra.core.LiteralType.string),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A description of the context in which the types were expected to be equal")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("Multiple types that should all be equal but are not"))))),
   "hydra.error.UnexpectedTermVariantError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("expectedVariant",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.variants.TermVariant"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The expected term variant")))))),
   hydra.core.FieldType("actualTerm", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Term"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The actual term that was encountered")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An unexpected term variant was encountered"))))),
   "hydra.error.UnexpectedTypeVariantError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("expectedVariant",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.variants.TypeVariant"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The expected type variant")))))),
   hydra.core.FieldType("actualType", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Type"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The actual type that was encountered")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An unexpected type variant was encountered"))))),
   "hydra.error.UnificationError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("leftType",
   ...
   "hydra.error.UnsupportedTermVariantError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("termVariant",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.variants.TermVariant"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The unsupported term variant")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A term variant that the type checker does not support"))))),
   "hydra.error.UntypedLambdaError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq()),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A lambda expression without a type annotation on its parameter"))))),
   "hydra.error.UntypedLetBindingError" -> hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.record(Seq(hydra.core.FieldType("binding",
   hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.variable("hydra.core.Binding"),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The untyped binding")))))))),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A let binding without a type annotation"))))),
   ...
   hydra.core.Type.variable("hydra.error.Error"))), hydra.core.Type.variable("hydra.core.Term"))))))))),
   ...
   hydra.core.Type.either(hydra.core.EitherType(hydra.core.Type.application(hydra.core.ApplicationType(hydra.core.Type.variable("hydra.context.InContext"),
   hydra.core.Type.variable("hydra.error.Error"))), hydra.core.Type.variable("a"))))))))), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("An encode function from terms to native values")))))),
   ...
   hydra.core.FieldType("elements", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.list(hydra.core.Type.variable("hydra.core.Binding")),
   Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("The elements defined in this module")))))),
   ...
   hydra.core.Type.variable("hydra.error.Error"))), hydra.core.Type.variable("v2"))))))), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A function which encodes source values as target values in a given context")))))),
   hydra.core.FieldType("decode", hydra.core.Type.annotated(hydra.core.AnnotatedType(hydra.core.Type.function(hydra.core.FunctionType(hydra.core.Type.variable("hydra.context.Context"),
   ...
   hydra.core.Type.variable("hydra.error.Error"))), hydra.core.Type.variable("v1"))))))), Map("description" -> hydra.core.Term.literal(hydra.core.Literal.string("A function which decodes target values as source values in a given context")))))))))))),
