...
def bigfloatValue(cx: hydra.context.Context)(v: hydra.core.FloatValue): Either[hydra.context.InContext[hydra.errors.Error], BigDecimal] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("bigfloat"))(" but found "))(hydra.show.core.float(v))), cx))
...
def bigintValue(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], BigInt] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("bigint"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def binaryLiteral(cx: hydra.context.Context)(v: hydra.core.Literal): Either[hydra.context.InContext[hydra.errors.Error], scala.Predef.String] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("binary"))(" but found "))(hydra.show.core.literal(v))), cx))
...
def booleanLiteral(cx: hydra.context.Context)(v: hydra.core.Literal): Either[hydra.context.InContext[hydra.errors.Error], Boolean] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("boolean"))(" but found "))(hydra.show.core.literal(v))), cx))

def caseField(cx: hydra.context.Context)(name: hydra.core.Name)(n: scala.Predef.String)(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Field] =
  {
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.CaseStatement, hydra.core.Field](hydra.extract.core.cases(cx)(name)(graph)(term))((cs: hydra.core.CaseStatement) =>
    ...
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Field]](hydra.lib.lists.`null`[hydra.core.Field](matching))(Left(hydra.context.InContext(hydra.errors.Error.other("not enough cases"), cx)))(Right(hydra.lib.lists.head[hydra.core.Field](matching)))
  })
}

def cases(cx: hydra.context.Context)(name: hydra.core.Name)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.CaseStatement] =
  ...
  case hydra.core.Term.function(v_Term_function_function) => v_Term_function_function match
    case hydra.core.Function.elimination(v_Function_elimination_elimination) => v_Function_elimination_elimination match
      case hydra.core.Elimination.union(v_Elimination_union_cs) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.CaseStatement]](hydra.lib.equality.equal[scala.Predef.String](v_Elimination_union_cs.typeName)(name))(Right(v_Elimination_union_cs))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")(hydra.lib.strings.cat2("case statement for type ")(name)))(" but found "))(hydra.show.core.term(term))), cx)))
      case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("case statement"))(" but found "))(hydra.show.core.term(term))), cx))
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("case statement"))(" but found "))(hydra.show.core.term(term))), cx))
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("case statement"))(" but found "))(hydra.show.core.term(term))), cx)))

def field[T0](cx: hydra.context.Context)(fname: hydra.core.Name)(mapping: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T0]))(graph: hydra.graph.Graph)(fields: Seq[hydra.core.Field]): Either[hydra.context.InContext[hydra.errors.Error], T0] =
  {
  ...
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], T0]](hydra.lib.lists.`null`[hydra.core.Field](matchingFields))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")(hydra.lib.strings.cat2("field ")(fname)))(" but found "))("no matching field")), cx)))(hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], T0]](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.core.Field](matchingFields))(1))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, T0](hydra.lexical.stripAndDereferenceTerm(cx)(graph)(hydra.lib.lists.head[hydra.core.Field](matchingFields).term))((stripped: hydra.core.Term) => mapping(stripped)))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("single field"))(" but found "))(hydra.lib.strings.cat2("multiple fields named ")(fname))), cx))))
}
...
def float32Value(cx: hydra.context.Context)(v: hydra.core.FloatValue): Either[hydra.context.InContext[hydra.errors.Error], Float] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("float32"))(" but found "))(hydra.show.core.float(v))), cx))
...
def float64Value(cx: hydra.context.Context)(v: hydra.core.FloatValue): Either[hydra.context.InContext[hydra.errors.Error], Double] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("float64"))(" but found "))(hydra.show.core.float(v))), cx))
...
def floatLiteral(cx: hydra.context.Context)(lit: hydra.core.Literal): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.FloatValue] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("floating-point value"))(" but found "))(hydra.show.core.literal(lit))), cx))

def floatValue(cx: hydra.context.Context)(graph: hydra.graph.Graph)(t: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.FloatValue] =
...
def eitherTerm[T0, T1](cx: hydra.context.Context)(leftFun: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T0]))(rightFun: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T1]))(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Either[T0, T1]] =
  ...
  term match
  case hydra.core.Term.either(v_Term_either_et) => hydra.lib.eithers.either[hydra.core.Term, hydra.core.Term, Either[hydra.context.InContext[hydra.errors.Error], Either[T0, T1]]]((l: hydra.core.Term) =>
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("either value"))(" but found "))(hydra.show.core.term(term))), cx)))
...
def eitherType(cx: hydra.context.Context)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.EitherType] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("either type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}
...
def functionType(cx: hydra.context.Context)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.FunctionType] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("function type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}

def injection(cx: hydra.context.Context)(expected: hydra.core.Name)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Field] =
  ...
  term match
  case hydra.core.Term.union(v_Term_union_injection) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Field]](hydra.lib.equality.equal[scala.Predef.String](v_Term_union_injection.typeName)(expected))(Right(v_Term_union_injection.field))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")(hydra.lib.strings.cat2("injection of type ")(expected)))(" but found "))(v_Term_union_injection.typeName)), cx)))
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("injection"))(" but found "))(hydra.show.core.term(term))), cx)))
...
def int16Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], Short] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("int16"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def int32Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], Int] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("int32"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def int64Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], Long] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("int64"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def int8Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], Byte] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("int8"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def integerLiteral(cx: hydra.context.Context)(lit: hydra.core.Literal): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.IntegerValue] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("integer value"))(" but found "))(hydra.show.core.literal(lit))), cx))

def integerValue(cx: hydra.context.Context)(graph: hydra.graph.Graph)(t: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.IntegerValue] =
...
def lambdaBody(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
...
def lambda(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Lambda] =
  ...
  case hydra.core.Term.function(v_Term_function_function) => v_Term_function_function match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("lambda"))(" but found "))(hydra.show.core.term(term))), cx))
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("lambda"))(" but found "))(hydra.show.core.term(term))), cx)))

def letBinding(cx: hydra.context.Context)(n: scala.Predef.String)(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
  {
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Let, hydra.core.Term](hydra.extract.core.let(cx)(graph)(term))((letExpr: hydra.core.Let) =>
    ...
    hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Binding](matchingBindings))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2("no such binding: ")(n)), cx)))(hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.equality.equal[Int](hydra.lib.lists.length[hydra.core.Binding](matchingBindings))(1))(Right(hydra.lib.lists.head[hydra.core.Binding](matchingBindings).term))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2("multiple bindings named ")(n)), cx))))
  })
}
...
def let(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Let] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("let term"))(" but found "))(hydra.show.core.term(term))), cx)))

def list(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Term]] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("list"))(" but found "))(hydra.show.core.term(stripped))), cx)))
...
def listHead(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
  ...
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.lists.`null`[hydra.core.Term](l))(Left(hydra.context.InContext(hydra.errors.Error.other("empty list"), cx)))(Right(hydra.lib.lists.head[hydra.core.Term](l))))

def listOf[T0](cx: hydra.context.Context)(f: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T0]))(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Seq[T0]] =
...
def listType(cx: hydra.context.Context)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("list type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}

def literal(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Literal] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("literal"))(" but found "))(hydra.show.core.term(term))), cx)))

def map[T0, T1](cx: hydra.context.Context)(fk: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T0]))(fv: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T1]))(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Map[T0, T1]] =
  {
  ...
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, Map[T0, T1]](hydra.lexical.stripAndDereferenceTerm(cx)(graph)(term0))((term: hydra.core.Term) =>
    term match
    case hydra.core.Term.map(v_Term_map_m) => hydra.lib.eithers.map[Seq[Tuple2[T0, T1]], Map[T0, T1], hydra.context.InContext[hydra.errors.Error]](hydra.lib.maps.fromList[T0, T1])(hydra.lib.eithers.mapList[Tuple2[hydra.core.Term, hydra.core.Term], Tuple2[T0, T1], hydra.context.InContext[hydra.errors.Error]](pair)(hydra.lib.maps.toList[hydra.core.Term, hydra.core.Term](v_Term_map_m)))
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("map"))(" but found "))(hydra.show.core.term(term))), cx)))
}
...
def mapType(cx: hydra.context.Context)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.MapType] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("map type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}
...
def nArgs[T0](cx: hydra.context.Context)(name: hydra.core.Name)(n: Int)(args: Seq[T0]): Either[hydra.context.InContext[hydra.errors.Error], Unit] =
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Unit]](hydra.lib.equality.equal[Int](hydra.lib.lists.length[T0](args))(n))(Right(()))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")(hydra.lib.strings.cat(Seq(hydra.lib.literals.showInt32(n), " arguments to primitive ", hydra.lib.literals.showString(name)))))(" but found "))(hydra.lib.literals.showInt32(hydra.lib.lists.length[T0](args)))), cx)))

def maybeTerm[T0](cx: hydra.context.Context)(f: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T0]))(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Option[T0]] =
  ...
  term match
  case hydra.core.Term.maybe(v_Term_maybe_mt) => hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error], Option[T0]], hydra.core.Term](Right(None))((t: hydra.core.Term) =>
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("maybe value"))(" but found "))(hydra.show.core.term(term))), cx)))
...
def maybeType(cx: hydra.context.Context)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("maybe type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}

def pair[T0, T1](cx: hydra.context.Context)(kf: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T0]))(vf: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T1]))(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Tuple2[T0, T1]] =
  ...
  term match
  case hydra.core.Term.pair(v_Term_pair_p) => hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], T0, Tuple2[T0, T1]](kf(hydra.lib.pairs.first[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((kVal: T0) =>
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], T1, Tuple2[T0, T1]](vf(hydra.lib.pairs.second[hydra.core.Term, hydra.core.Term](v_Term_pair_p)))((vVal: T1) => Right(Tuple2(kVal, vVal))))
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("pair"))(" but found "))(hydra.show.core.term(term))), cx)))

def record(cx: hydra.context.Context)(expected: hydra.core.Name)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Field]] =
  ...
  hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Field]]](hydra.lib.equality.equal[hydra.core.Name](record.typeName)(expected))(Right(record.fields))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")(hydra.lib.strings.cat2("record of type ")(expected)))(" but found "))(record.typeName)), cx))))
...
def recordType[T0](cx: hydra.context.Context)(ename: T0)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.FieldType]] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("record type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}

def set(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], scala.collection.immutable.Set[hydra.core.Term]] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("set"))(" but found "))(hydra.show.core.term(stripped))), cx)))

def setOf[T0](cx: hydra.context.Context)(f: (hydra.core.Term => Either[hydra.context.InContext[hydra.errors.Error], T0]))(graph: hydra.graph.Graph)(term: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], scala.collection.immutable.Set[T0]] =
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], scala.collection.immutable.Set[hydra.core.Term], scala.collection.immutable.Set[T0]](hydra.extract.core.set(cx)(graph)(term))((els: scala.collection.immutable.Set[hydra.core.Term]) =>
...
def setType(cx: hydra.context.Context)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("set type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}
...
def stringLiteral(cx: hydra.context.Context)(v: hydra.core.Literal): Either[hydra.context.InContext[hydra.errors.Error], scala.Predef.String] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("string"))(" but found "))(hydra.show.core.literal(v))), cx))

def termRecord(cx: hydra.context.Context)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Record] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("record"))(" but found "))(hydra.show.core.term(term))), cx)))
...
def uint16Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], Int] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("uint16"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def uint32Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], Long] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("uint32"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def uint64Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], BigInt] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("uint64"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def uint8Value(cx: hydra.context.Context)(v: hydra.core.IntegerValue): Either[hydra.context.InContext[hydra.errors.Error], Byte] =
  ...
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("uint8"))(" but found "))(hydra.show.core.integer(v))), cx))
...
def unionType[T0](cx: hydra.context.Context)(ename: T0)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.FieldType]] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("union type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}
...
def wrap(cx: hydra.context.Context)(expected: hydra.core.Name)(graph: hydra.graph.Graph)(term0: hydra.core.Term): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term] =
  ...
  term match
  case hydra.core.Term.wrap(v_Term_wrap_wrappedTerm) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](hydra.lib.equality.equal[scala.Predef.String](v_Term_wrap_wrappedTerm.typeName)(expected))(Right(v_Term_wrap_wrappedTerm.body))(Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")(hydra.lib.strings.cat2("wrapper of type ")(expected)))(" but found "))(v_Term_wrap_wrappedTerm.typeName)), cx)))
  case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")(hydra.lib.strings.cat2(hydra.lib.strings.cat2("wrap(")(expected))(")")))(" but found "))(hydra.show.core.term(term))), cx)))
...
def wrappedType[T0](cx: hydra.context.Context)(ename: T0)(typ: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type] =
  ...
  stripped match
    ...
    case _ => Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ")("wrapped type"))(" but found "))(hydra.show.core.`type`(typ))), cx))
}
