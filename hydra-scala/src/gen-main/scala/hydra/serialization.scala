...
def expressionLength(e: hydra.ast.Expr): Int =
  ...
  def blockStyleLength(style: hydra.ast.BlockStyle): Int =
    {
    val mindentLen: Int = hydra.lib.maybes.maybe[Int, scala.Predef.String](0)(hydra.lib.strings.length)(style.indent)
    val nlBeforeLen: Int = hydra.lib.logic.ifElse[Int](style.newlineBeforeContent)(1)(0)
    val nlAfterLen: Int = hydra.lib.logic.ifElse[Int](style.newlineAfterContent)(1)(0)
  ...
  def seqExprLength(se: hydra.ast.SeqExpr): Int =
    ...
    val elementLens: Seq[Int] = hydra.lib.lists.map[hydra.ast.Expr, Int](hydra.serialization.expressionLength)(se.elements)
    val totalElLen: Int = hydra.lib.lists.foldl[Int, Int](hydra.lib.math.add)(0)(elementLens)
    val numSeps: Int = hydra.lib.math.sub(hydra.lib.lists.length[hydra.ast.Expr](se.elements))(1)
...
def parenList(newlines: Boolean)(els: Seq[hydra.ast.Expr]): hydra.ast.Expr =
  {
  val style: hydra.ast.BlockStyle = hydra.lib.logic.ifElse[hydra.ast.BlockStyle](hydra.lib.logic.and(newlines)(hydra.lib.equality.gt[Int](hydra.lib.lists.length[hydra.ast.Expr](els))(1)))(hydra.serialization.halfBlockStyle)(hydra.serialization.inlineStyle)
                      ...
                      case hydra.ast.Expr.op(v_Expr_op_lopExpr) => {
                        val lop: hydra.ast.Op = (v_Expr_op_lopExpr.op)
                        {
                          val lprec: Int = (lop.precedence)
                          {
                            ...
                            {
                              val comparison: hydra.util.Comparison = hydra.lib.equality.compare[Int](prec)(lprec)
                              comparison match
                        ...
                        case hydra.ast.Expr.op(v_Expr_op_ropExpr) => {
                          val rop: hydra.ast.Op = (v_Expr_op_ropExpr.op)
                          {
                            val rprec: Int = (rop.precedence)
                            {
                              ...
                              {
                                val comparison: hydra.util.Comparison = hydra.lib.equality.compare[Int](prec)(rprec)
                                comparison match
  ...
  e match
    ...
    case hydra.ast.Expr.indent(v_Expr_indent_indentExpr) => {
      val style: hydra.ast.IndentStyle = (v_Expr_indent_indentExpr.style)
      {
        ...
        {
          val lns: Seq[scala.Predef.String] = hydra.lib.strings.lines(hydra.serialization.printExpr(expr))
          {
          ...
          val spadding: hydra.ast.Padding = (sop.padding)
          {
            val spadl: hydra.ast.Ws = (spadding.left)
            {
              val spadr: hydra.ast.Ws = (spadding.right)
              {
                ...
                {
                  val separator: scala.Predef.String = hydra.lib.strings.cat2(hydra.lib.strings.cat2(pad(spadl))(ssym))(pad(spadr))
                  {
                    val printedElements: Seq[scala.Predef.String] = hydra.lib.lists.map[hydra.ast.Expr,
                ...
                val body: scala.Predef.String = hydra.serialization.printExpr(e)
                {
                  val doIndent: Option[scala.Predef.String] = (style.indent)
                  {
                    val nlBefore: Boolean = (style.newlineBeforeContent)
                    {
                      ...
                      {
                        val ibody: scala.Predef.String = hydra.lib.maybes.maybe[scala.Predef.String, scala.Predef.String](body)((idt2: scala.Predef.String) => hydra.serialization.customIndent(idt2)(body))(doIndent)
                        {
                          val pre: scala.Predef.String = hydra.lib.logic.ifElse[scala.Predef.String](nlBefore)("\n")("")
                          {
                            val suf: scala.Predef.String = hydra.lib.logic.ifElse[scala.Predef.String](nlAfter)("\n")("")
...
def symbolSep(symb: scala.Predef.String)(style: hydra.ast.BlockStyle)(l: Seq[hydra.ast.Expr]): hydra.ast.Expr =
  {
  val breakCount: Int = hydra.lib.lists.length[Boolean](hydra.lib.lists.filter[Boolean]((`x_`: Boolean) => `x_`)(Seq(style.newlineBeforeContent,
     (style.newlineAfterContent))))
  val break: hydra.ast.Ws = hydra.lib.logic.ifElse[hydra.ast.Ws](hydra.lib.equality.equal[Int](breakCount)(0))(hydra.ast.Ws.space)(hydra.lib.logic.ifElse[hydra.ast.Ws](hydra.lib.equality.equal[Int](breakCount)(1))(hydra.ast.Ws.break)(hydra.ast.Ws.doubleBreak))
