...
def graphToSchema(cx: hydra.context.Context)(graph: hydra.graph.Graph)(els: Seq[hydra.core.Binding]): Either[hydra.context.InContext[hydra.errors.DecodingError],
  ...
  def toPair(el: hydra.core.Binding): Either[hydra.context.InContext[hydra.errors.DecodingError], Tuple2[hydra.core.Name, hydra.core.Type]] =
    ...
    hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.DecodingError], hydra.core.Type, Tuple2[hydra.core.Name,
       hydra.core.Type]](hydra.lib.eithers.bimap[hydra.errors.DecodingError, hydra.core.Type, hydra.context.InContext[hydra.errors.DecodingError],
       hydra.core.Type]((_wc_e: hydra.errors.DecodingError) => hydra.context.InContext(_wc_e, cx))((_wc_a: hydra.core.Type) => _wc_a)(hydra.decode.core.`type`(graph)(el.term)))((t: hydra.core.Type) => Right(Tuple2(name,
       t)))
  }
  hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.DecodingError], Seq[Tuple2[hydra.core.Name,
     ...
     Tuple2[hydra.core.Name, hydra.core.Type], hydra.context.InContext[hydra.errors.DecodingError]](toPair)(els))((pairs: Seq[Tuple2[hydra.core.Name,
     hydra.core.Type]]) =>
    Right(hydra.lib.maps.fromList[hydra.core.Name, hydra.core.Type](pairs)))
}

def instantiateTemplate(cx: hydra.context.Context)(minimal: Boolean)(schema: Map[hydra.core.Name, hydra.core.Type])(tname: hydra.core.Name)(t: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error],
   hydra.core.Term] =
  {
  def inst(tn: hydra.core.Name)(v1: hydra.core.Type): Either[hydra.context.InContext[hydra.errors.Error],
  ...
  t match
    ...
    case hydra.core.Type.map(v_Type_map_mt) => {
      lazy val kt: hydra.core.Type = (v_Type_map_mt.keys)
      {
        ...
        hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]](minimal)(Right(hydra.core.Term.map(hydra.lib.maps.empty[hydra.core.Term,
           hydra.core.Term])))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term,
    ...
    case hydra.core.Type.maybe(v_Type_maybe_ot) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error],
       hydra.core.Term]](minimal)(Right(hydra.core.Term.maybe(None)))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
    ...
    case hydra.core.Type.record(v_Type_record_rt) => {
      def toField(ft: hydra.core.FieldType): Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Field] =
        hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], hydra.core.Term, hydra.core.Field](inst(tname)(ft.`type`))((e: hydra.core.Term) => Right(hydra.core.Field(ft.name,
           e)))
      hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error], Seq[hydra.core.Field], hydra.core.Term](hydra.lib.eithers.mapList[hydra.core.FieldType,
         hydra.core.Field, hydra.context.InContext[hydra.errors.Error]](toField)(v_Type_record_rt))((dfields: Seq[hydra.core.Field]) =>
        Right(hydra.core.Term.record(hydra.core.Record(tname, dfields))))
    }
    case hydra.core.Type.set(v_Type_set_et) => hydra.lib.logic.ifElse[Either[hydra.context.InContext[hydra.errors.Error],
       hydra.core.Term]](minimal)(Right(hydra.core.Term.set(hydra.lib.sets.empty[hydra.core.Term])))(hydra.lib.eithers.bind[hydra.context.InContext[hydra.errors.Error],
    ...
    case hydra.core.Type.variable(v_Type_variable_vname) => hydra.lib.maybes.maybe[Either[hydra.context.InContext[hydra.errors.Error],
       hydra.core.Term], hydra.core.Type](Left(hydra.context.InContext(hydra.errors.Error.other(hydra.lib.strings.cat2("Type variable ")(hydra.lib.strings.cat2(hydra.show.core.term(hydra.core.Term.variable(v_Type_variable_vname)))(" not found in schema"))),
