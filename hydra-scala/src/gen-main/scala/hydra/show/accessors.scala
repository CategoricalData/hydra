...
def termToAccessorGraph(namespaces: Map[hydra.module.Namespace, scala.Predef.String])(term: hydra.core.Term): hydra.accessors.AccessorGraph =
  ...
  def helper(ids: Map[hydra.core.Name, hydra.accessors.AccessorNode])(mroot: Option[hydra.accessors.AccessorNode])(path: Seq[hydra.accessors.TermAccessor])(state: Tuple2[Tuple2[Seq[hydra.accessors.AccessorNode],
    ...
    lazy val nodesEdges: Tuple2[Seq[hydra.accessors.AccessorNode], Seq[hydra.accessors.AccessorEdge]] = hydra.lib.pairs.first[Tuple2[Seq[hydra.accessors.AccessorNode],
       Seq[hydra.accessors.AccessorEdge]], scala.collection.immutable.Set[scala.Predef.String]](state)
    lazy val visited: scala.collection.immutable.Set[scala.Predef.String] = hydra.lib.pairs.second[Tuple2[Seq[hydra.accessors.AccessorNode],
       Seq[hydra.accessors.AccessorEdge]], scala.collection.immutable.Set[scala.Predef.String]](state)
    ...
    currentTerm match
      case hydra.core.Term.let(v_Term_let_letExpr) => {
        ...
        def addBindingName(nodesVisitedIds: Tuple2[Tuple2[Seq[hydra.accessors.AccessorNode], scala.collection.immutable.Set[scala.Predef.String]],
          ...
          {
          lazy val currentNodesVisited: Tuple2[Seq[hydra.accessors.AccessorNode], scala.collection.immutable.Set[scala.Predef.String]] = hydra.lib.pairs.first[Tuple2[Seq[hydra.accessors.AccessorNode],
             scala.collection.immutable.Set[scala.Predef.String]], Map[hydra.core.Name, hydra.accessors.AccessorNode]](nodesVisitedIds)
          lazy val currentIds: Map[hydra.core.Name, hydra.accessors.AccessorNode] = hydra.lib.pairs.second[Tuple2[Seq[hydra.accessors.AccessorNode],
             scala.collection.immutable.Set[scala.Predef.String]], Map[hydra.core.Name, hydra.accessors.AccessorNode]](nodesVisitedIds)
          lazy val currentNodes: Seq[hydra.accessors.AccessorNode] = hydra.lib.pairs.first[Seq[hydra.accessors.AccessorNode],
             scala.collection.immutable.Set[scala.Predef.String]](currentNodesVisited)
          lazy val currentVisited: scala.collection.immutable.Set[scala.Predef.String] = hydra.lib.pairs.second[Seq[hydra.accessors.AccessorNode],
             scala.collection.immutable.Set[scala.Predef.String]](currentNodesVisited)
          ...
          lazy val newIds: Map[hydra.core.Name, hydra.accessors.AccessorNode] = hydra.lib.maps.insert[hydra.core.Name,
             hydra.accessors.AccessorNode](name)(node)(currentIds)
          Tuple2(Tuple2(newNodes, newVisited), newIds)
        }
        lazy val nodesVisitedIds1: Tuple2[Tuple2[Seq[hydra.accessors.AccessorNode], scala.collection.immutable.Set[scala.Predef.String]],
        ...
        lazy val nodes1: Seq[hydra.accessors.AccessorNode] = hydra.lib.pairs.first[Seq[hydra.accessors.AccessorNode],
        ...
        lazy val visited1: scala.collection.immutable.Set[scala.Predef.String] = hydra.lib.pairs.second[Seq[hydra.accessors.AccessorNode],
           scala.collection.immutable.Set[scala.Predef.String]](hydra.lib.pairs.first[Tuple2[Seq[hydra.accessors.AccessorNode],
           scala.collection.immutable.Set[scala.Predef.String]], Map[hydra.core.Name, hydra.accessors.AccessorNode]](nodesVisitedIds1))
        lazy val ids1: Map[hydra.core.Name, hydra.accessors.AccessorNode] = hydra.lib.pairs.second[Tuple2[Seq[hydra.accessors.AccessorNode],
           scala.collection.immutable.Set[scala.Predef.String]], Map[hydra.core.Name, hydra.accessors.AccessorNode]](nodesVisitedIds1)
        ...
        lazy val nodeBindingPairs: Seq[Tuple2[hydra.accessors.AccessorNode, hydra.core.Binding]] = hydra.lib.lists.zip[hydra.accessors.AccessorNode,
           hydra.core.Binding](nodes1)(bindings)
        lazy val stateAfterBindings: Tuple2[Tuple2[Seq[hydra.accessors.AccessorNode], Seq[hydra.accessors.AccessorEdge]],
  ...
  lazy val result: Tuple2[Tuple2[Seq[hydra.accessors.AccessorNode], Seq[hydra.accessors.AccessorEdge]],
  ...
  lazy val finalNodesEdges: Tuple2[Seq[hydra.accessors.AccessorNode], Seq[hydra.accessors.AccessorEdge]] = hydra.lib.pairs.first[Tuple2[Seq[hydra.accessors.AccessorNode],
     Seq[hydra.accessors.AccessorEdge]], scala.collection.immutable.Set[scala.Predef.String]](result)
  lazy val finalNodes: Seq[hydra.accessors.AccessorNode] = hydra.lib.pairs.first[Seq[hydra.accessors.AccessorNode],
     Seq[hydra.accessors.AccessorEdge]](finalNodesEdges)
  lazy val finalEdges: Seq[hydra.accessors.AccessorEdge] = hydra.lib.pairs.second[Seq[hydra.accessors.AccessorNode],
     Seq[hydra.accessors.AccessorEdge]](finalNodesEdges)
