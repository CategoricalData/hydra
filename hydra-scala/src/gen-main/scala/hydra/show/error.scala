...
def decodingError(de: hydra.error.DecodingError): scala.Predef.String = hydra.lib.strings.cat2("decoding error: ")(de)

def duplicateBindingError(e: hydra.error.DuplicateBindingError): scala.Predef.String = hydra.lib.strings.cat2("duplicate binding: ")(e.name)

def duplicateFieldError(e: hydra.error.DuplicateFieldError): scala.Predef.String = hydra.lib.strings.cat2("duplicate field: ")(e.name)
...
def typeMismatchError(e: hydra.error.TypeMismatchError): scala.Predef.String =
  ...
  hydra.lib.strings.cat(Seq("type mismatch: expected ", hydra.show.core.`type`(expected), " but found ", hydra.show.core.`type`(actual)))
}
...
def undefinedTermError(e: hydra.error.UndefinedTermError): scala.Predef.String = hydra.lib.strings.cat2("undefined term: ")(e.name)

def undefinedTypeError(e: hydra.error.UndefinedTypeError): scala.Predef.String = hydra.lib.strings.cat2("undefined type: ")(e.name)
...
def unificationError(e: hydra.error.UnificationError): scala.Predef.String =
  ...
  hydra.lib.strings.cat(Seq("unification error: cannot unify ", hydra.show.core.`type`(lt), " with ", hydra.show.core.`type`(rt), ": ", msg))
}
