...
def error(e: hydra.errors.Error): scala.Predef.String =
  ...
  case hydra.errors.Error.undefinedTerm(v_Error_undefinedTerm_v1) => hydra.show.error.core.undefinedTermError(v_Error_undefinedTerm_v1)
  case hydra.errors.Error.undefinedType(v_Error_undefinedType_v1) => hydra.show.error.core.undefinedTypeError(v_Error_undefinedType_v1)
