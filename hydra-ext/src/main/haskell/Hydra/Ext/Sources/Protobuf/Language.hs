module Hydra.Ext.Sources.Protobuf.Language (module_, protobufLanguage) where
...
definition_ :: String -> TTerm a -> TBinding a
...
protobufLanguage = definition_ "protobufLanguage" $
  ...
  Coders.language
    (Coders.languageName_ $ string "hydra.ext.protobuf")
