...
module_ = Module ns elements
  ...
  where
    elements = [
      toBinding key_proto_field_index,
      toBinding err,
      toBinding unexpectedE,
      toBinding fromEitherString,
      toBinding structuralTypeName,
      toBinding generateStructuralTypeMessage,
      toBinding encodeSimpleTypeForHelper,
      toBinding collectStructuralTypes,
      toBinding collectStructuralTypes_collectFromType,
      toBinding moduleToProtobuf,
      toBinding javaMultipleFilesOptionName,
      toBinding javaPackageOptionName,
      toBinding constructModule,
      toBinding mapAccumResult,
      toBinding encodeDefinition,
      toBinding encodeEnumDefinition,
      toBinding encodeEnumValueName,
      toBinding encodeFieldName,
      toBinding encodeFieldType,
      toBinding encodeRecordType,
      toBinding encodeScalarType,
      toBinding encodeScalarTypeWrapped,
      toBinding encodeTypeName,
      toBinding encodeTypeReference,
      toBinding flattenType,
      toBinding findOptions,
      toBinding isEnumFields,
      toBinding isEnumDefinition,
      toBinding namespaceToFileReference,
      toBinding namespaceToPackageName,
      toBinding readBooleanAnnotation,
      toBinding simplifyType]
