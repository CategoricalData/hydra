...
module Hydra.Ext.Sources.Avro.Testing where
...
ns :: Namespace
ns = Namespace "hydra.ext.avro.testing"
...
module_ :: Module
module_ = Module ns (map toTypeDef elements) [] [Core.ns, AvroSchema.ns, JsonModel.ns] $
