module Hydra.Ext.Sources.Avro.Language where
...
avroLanguageDefinition :: String -> TTerm a -> TBinding a
avroLanguageDefinition = definitionInModule avroLanguageModule
...
avroLanguage = avroLanguageDefinition "avroLanguage" $
  ...
  Coders.language
    (Coders.languageName_ $ string "hydra.ext.avro")
