module Hydra.Ext.Sources.Pegasus.Language where
...
pdlLanguageDefinition :: String -> TTerm a -> TBinding a
pdlLanguageDefinition = definitionInModule pdlLanguageModule
...
pdlLanguage = pdlLanguageDefinition "pdlLanguage" $
  ...
  Coders.language
    (Coders.languageName_ $ string "hydra.ext.pegasus.pdl")
