...
module_ = Module ns elements
  ...
  where
    elements = [
      toBinding lispSymbol,
      toBinding lispKeyword,
      toBinding lispVar,
      toBinding lispApp,
      toBinding lispLambdaExpr,
      toBinding lispNamedLambdaExpr,
      toBinding lispLitExpr,
      toBinding lispListExpr,
      toBinding lispNilExpr,
      toBinding lispTopForm,
      toBinding lispTopFormWithComments,
      toBinding dialectCar,
      toBinding dialectCadr,
      toBinding dialectEqual,
      toBinding dialectConstructorPrefix,
      toBinding qualifiedSnakeName,
      toBinding qualifiedTypeName,
...
-- =============================================================================
-- Type encoding (Hydra type -> Lisp type comment / type specifier)
-- =============================================================================
