...
module_ = Module ns elements
  ...
  where
    elements = [
      ...
      toBinding defnKeyword,
      toBinding defKeyword,
      toBinding defconstKeyword,
      toBinding defrecordKeyword,
      toBinding lambdaKeyword,
      toBinding listKeyword,
      toBinding trueExpr,
      toBinding falseExpr,
      toBinding nilExpr,
      -- Top-level serialization
      toBinding programToExpr,
      toBinding topLevelFormWithCommentsToExpr,
      toBinding topLevelFormToExpr,
      -- Definition serialization
      toBinding functionDefinitionToExpr,
      toBinding variableDefinitionToExpr,
      toBinding constantDefinitionToExpr,
      toBinding recordTypeDefinitionToExpr,
      toBinding macroDefinitionToExpr,
      -- Expression serialization
      toBinding expressionToExpr,
      toBinding applicationToExpr,
      toBinding lambdaToExpr,
      toBinding letExpressionToExpr,
      toBinding ifExpressionToExpr,
      toBinding condExpressionToExpr,
      toBinding caseExpressionToExpr,
      toBinding andExpressionToExpr,
      toBinding orExpressionToExpr,
      toBinding notExpressionToExpr,
      toBinding doExpressionToExpr,
      toBinding variableReferenceToExpr,
      toBinding fieldAccessToExpr,
      -- Literal serialization
      toBinding literalToExpr,
      -- Collection serialization
      toBinding listLiteralToExpr,
      toBinding vectorLiteralToExpr,
      toBinding mapLiteralToExpr,
      toBinding setLiteralToExpr,
      -- Module serialization
      toBinding moduleDeclarationToExpr,
      toBinding importDeclarationToExpr,
      toBinding exportDeclarationToExpr,
      toBinding sExpressionToExpr,
      -- Misc
      toBinding symbolToExpr,
      toBinding keywordToExpr,
      toBinding docstringToExpr,
      toBinding commentToExpr]
