...
module_ = Module ns elements
  ...
  where
    elements = [
      toTermDefinition encodeAnnotatedRhs,
      toTermDefinition encodeAnnotatedStatement,
      toTermDefinition encodeAnnotation,
      toTermDefinition encodeArgs,
      toTermDefinition encodeAssignment,
      toTermDefinition encodeAssignmentExpression,
      toTermDefinition encodeAtom,
      toTermDefinition encodeAttribute,
      toTermDefinition encodeAwaitPrimary,
      toTermDefinition encodeBitwiseAnd,
      toTermDefinition encodeBitwiseOr,
      toTermDefinition encodeBitwiseXor,
      toTermDefinition encodeBlock,
      toTermDefinition encodeCapturePattern,
      toTermDefinition encodeCaseBlock,
      toTermDefinition encodeClassDefinition,
      ...
      toTermDefinition encodeDisjunction,
      toTermDefinition encodeDottedAsName,
      toTermDefinition encodeDottedName,
      toTermDefinition encodeDoubleStarredKvpair,
      toTermDefinition encodeExpression,
      toTermDefinition encodeFactor,
      toTermDefinition encodeFunctionDefRaw,
      toTermDefinition encodeFunctionDefinition,
      toTermDefinition encodeGroup,
      toTermDefinition encodeGuard,
      toTermDefinition encodeImportFrom,
      toTermDefinition encodeImportFromAsName,
      toTermDefinition encodeImportFromTargets,
      toTermDefinition encodeImportName,
      toTermDefinition encodeImportStatement,
      toTermDefinition encodeInversion,
      toTermDefinition encodeKeywordPattern,
      toTermDefinition encodeKeywordPatterns,
      toTermDefinition encodeKvpair,
      toTermDefinition encodeKwarg,
      toTermDefinition encodeKwargOrDoubleStarred,
      toTermDefinition encodeKwargOrStarred,
      toTermDefinition encodeLambda,
      toTermDefinition encodeLambdaParamNoDefault,
      toTermDefinition encodeLambdaParameters,
      toTermDefinition encodeLambdaStarEtc,
      toTermDefinition encodeList,
      toTermDefinition encodeMatchStatement,
      toTermDefinition encodeModule,
      toTermDefinition encodeName,
      toTermDefinition encodeNamedExpression,
      toTermDefinition encodeNameOrAttribute,
      toTermDefinition encodeNumber,
      toTermDefinition encodeOrPattern,
      toTermDefinition encodeParam,
      toTermDefinition encodeParamNoDefault,
      toTermDefinition encodeParamNoDefaultParameters,
      toTermDefinition encodeParameters,
      toTermDefinition encodePattern,
      toTermDefinition encodePatternCaptureTarget,
      toTermDefinition encodePatterns,
      toTermDefinition encodePosArg,
      toTermDefinition encodePositionalPatterns,
      toTermDefinition encodePower,
      toTermDefinition encodePrimary,
      toTermDefinition encodePrimaryRhs,
      toTermDefinition encodePrimaryWithRhs,
      toTermDefinition encodeRaiseExpression,
      toTermDefinition encodeRaiseStatement,
      toTermDefinition encodeRelativeImportPrefix,
      toTermDefinition encodeReturnStatement,
      toTermDefinition encodeSet,
      toTermDefinition encodeShiftExpression,
      toTermDefinition encodeSimpleStatement,
      toTermDefinition encodeSimpleTypeParameter,
      toTermDefinition encodeSingleTarget,
      toTermDefinition encodeSlice,
      toTermDefinition encodeSliceOrStarredExpression,
      toTermDefinition encodeSlices,
