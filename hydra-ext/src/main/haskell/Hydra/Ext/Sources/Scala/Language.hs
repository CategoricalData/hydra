...
scalaLanguageDefinition :: String -> TTerm a -> TBinding a
scalaLanguageDefinition = definitionInModule scalaLanguageModule
...
scalaLanguage = scalaLanguageDefinition "scalaLanguage" $
  ...
  Coders.language
    (Coders.languageName $ string "hydra.ext.scala")
...
scalaReservedWords = scalaLanguageDefinition "scalaReservedWords" $
