...
module_ = Module ns elements
  ...
  where
    elements = [
      ...
      toBinding encodeEnumType,
      toBinding encodeVariantType,
      toBinding encodeWrappedType,
      -- Visitor pattern
      toBinding createVisitorInterface,
      toBinding createPartialVisitorInterface,
      toBinding createUnionBaseClass,
      toBinding createVariantClass,
      toBinding createAcceptImplementation,
      toBinding generateForwardDeclarations,
      toBinding createLessThanOperator,
      -- File generation
      toBinding serializeHeaderFile,
      toBinding bindingNameToFilePath,
      toBinding findIncludes,
      toBinding findTypeDependencies,
      toBinding gatherMetadata,
      toBinding isStdContainerType,
      toBinding isStructType,
      toBinding isTemplateType,
      -- Module entry point
      toBinding generateTypeFile,
      toBinding generateTypeFiles,
      toBinding moduleToCpp]
