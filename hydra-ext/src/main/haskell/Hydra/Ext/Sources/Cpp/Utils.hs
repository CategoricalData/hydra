...
module Hydra.Ext.Sources.Cpp.Utils where
...
-- Phantom type for CppEnvironment, defined in Hydra.Ext.Sources.Cpp.Environment
data CppEnvironment

_CppEnvironment :: Name
_CppEnvironment = Name "hydra.ext.cpp.environment.CppEnvironment"
...
module_ = Module ns elements
  ...
  where
    elements = [
      toBinding constParameter,
      toBinding cppClassDeclaration,
      toBinding cppEnumDeclaration,
      toBinding cppEnumForwardDeclaration,
      toBinding cppPostfixExpressionToCppExpression,
      toBinding cppPrimaryExpressionToCppExpression,
      toBinding cppUnaryExpressionToCppExpression,
      toBinding cppUnaryExpressionToCppLogicalOrExpression,
      toBinding createCastExpr,
      toBinding createCompoundStmt,
      toBinding createConstRefType,
      toBinding createConstType,
      toBinding createConstructorBody,
      toBinding createEnumAccessExpr,
      toBinding createFunctionCallExpr,
      toBinding createHeaderFile,
      toBinding createIdentifierExpr,
      toBinding createLambdaExpr,
      toBinding createLiteralBoolExpr,
      toBinding createLiteralIntExpr,
      toBinding createLiteralStringExpr,
      toBinding createMemberAccessExpr,
      toBinding createQualifiedType,
      toBinding createReferenceType,
      toBinding createReturnStmt,
      toBinding createReturnVoidStmt,
      toBinding createTemplateType,
      toBinding createThisExpr,
      toBinding createThrowStmt,
      toBinding createTypeIdNameCall,
      toBinding createTypeNameExpr,
      toBinding createVariantExpr,
      toBinding emptyFunctionBody,
      toBinding extractPostfixExpression,
      toBinding memberSpecificationProtected,
      toBinding memberSpecificationPublic,
      toBinding stringExpression,
      toBinding toConstType,
      toBinding unnamedParameter]
