...
module_ = Module ns elements
  ...
  where
    elements = [
      toBinding encodeAccessSpecifier,
      toBinding encodeAddOperation,
      toBinding encodeAdditiveExpression,
      toBinding encodeAndExpression,
      toBinding encodeAssignmentExpression,
      toBinding encodeAssignmentOperator,
      toBinding encodeBaseSpecifier,
      toBinding encodeBasicType,
      toBinding encodeBitwiseAndOperation,
      toBinding encodeBitwiseOrOperation,
      toBinding encodeBitwiseXorOperation,
      toBinding encodeBooleanLiteral,
      toBinding encodeCapture,
      toBinding encodeCaptureList,
      toBinding encodeCaseStatement,
      toBinding encodeCaseValue,
      toBinding encodeClassBody,
      toBinding encodeClassDeclaration,
      toBinding encodeClassKey,
      toBinding encodeClassSpecifier,
      toBinding encodeCommaExpression,
      toBinding encodeComment,
      toBinding encodeCompoundStatement,
      toBinding encodeConditionalExpression,
      toBinding encodeConstructorDeclaration,
      toBinding encodeDeclaration,
      toBinding encodeDefineDirective,
      toBinding encodeDestructorDeclaration,
      toBinding encodeDivideOperation,
      toBinding encodeDoStatement,
      toBinding encodeElifDirective,
      toBinding encodeElseDirective,
      toBinding encodeEndifDirective,
      toBinding encodeEqualOperation,
      toBinding encodeEqualityExpression,
      toBinding encodeErrorDirective,
      toBinding encodeExclusiveOrExpression,
      toBinding encodeExplicitAssignment,
      toBinding encodeExpression,
      toBinding encodeForInit,
      toBinding encodeForStatement,
      toBinding encodeFunctionApplication,
      toBinding encodeFunctionBody,
      toBinding encodeFunctionCallOperation,
      toBinding encodeFunctionDeclaration,
      toBinding encodeFunctionIdentifier,
      toBinding encodeFunctionSpecifierPrefix,
      toBinding encodeFunctionSpecifierSuffix,
      toBinding encodeFunctionType,
      toBinding encodeGreaterEqualOperation,
      toBinding encodeGreaterOperation,
      toBinding encodeIfDirective,
      toBinding encodeIfdefDirective,
      toBinding encodeIfndefDirective,
      toBinding encodeIncludeDirective,
      toBinding encodeInclusiveOrExpression,
      toBinding encodeIntegerLiteral,
      toBinding encodeIterationStatement,
      toBinding encodeJumpStatement,
      toBinding encodeLabeledStatement,
      toBinding encodeLambdaExpression,
      toBinding encodeLeftShiftOperation,
      toBinding encodeLessEqualOperation,
      toBinding encodeLessOperation,
      toBinding encodeLineDirective,
      toBinding encodeLiteral,
      toBinding encodeLogicalAndExpression,
      toBinding encodeLogicalAndOperation,
      toBinding encodeLogicalOrExpression,
      toBinding encodeLogicalOrOperation,
      toBinding encodeMap,
      toBinding encodeMapEntry,
      toBinding encodeMemberAccessOperation,
      toBinding encodeMemberDeclaration,
      toBinding encodeMemberSpecification,
      toBinding encodeMemInitializer,
      toBinding encodeModuloOperation,
      toBinding encodeMultiplicativeExpression,
      toBinding encodeMultiplyOperation,
      toBinding encodeNamespaceDeclaration,
      toBinding encodeNotEqualOperation,
      toBinding encodeOptional,
      toBinding encodeOverloadedLambdas,
      toBinding encodeParameter,
      toBinding encodePatternMatch,
      toBinding encodePointerMemberAccessOperation,
      toBinding encodePostfixExpression,
      toBinding encodePragmaDirective,
      toBinding encodePreprocessorDirective,
      toBinding encodePrimaryExpression,
      toBinding encodeProgram,
      toBinding encodeQualifiedIdentifier,
      toBinding encodeQualifiedType,
      toBinding encodeRangeForStatement,
      toBinding encodeRelationalExpression,
      toBinding encodeRightShiftOperation,
      toBinding encodeSelectionStatement,
      toBinding encodeSet,
      toBinding encodeShiftExpression,
      toBinding encodeSizeofExpression,
      toBinding encodeStatement,
      toBinding encodeSubscriptOperation,
      toBinding encodeSubtractOperation,
      toBinding encodeSwitchStatement,
      toBinding encodeTemplateArgument,
      toBinding encodeTemplateDeclaration,
      toBinding encodeTemplateFunctionCallOperation,
      toBinding encodeTemplateType,
      toBinding encodeTernaryExpression,
      toBinding encodeToCppComments,
      toBinding encodeTypeExpression,
      toBinding encodeTypedefDeclaration,
      toBinding encodeUnaryExpression,
      toBinding encodeUnaryOperation,
      toBinding encodeUnaryOperator,
      toBinding encodeUndefDirective,
      toBinding encodeVariableDeclaration,
      toBinding encodeVector,
      toBinding encodeVisitor,
      toBinding encodeWarningDirective,
