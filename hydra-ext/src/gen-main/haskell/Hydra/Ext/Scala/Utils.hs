...
slambda v body sdom = (Meta.DataFunctionData (Meta.Data_FunctionDataFunction (Meta.Data_Function {
...
stapply t args = (Meta.TypeApply (Meta.Type_Apply {
