...
module Hydra.Ext.Java.Environment where
...
_JavaSymbolClass = Core.Name "hydra.ext.java.environment.JavaSymbolClass"
...
_JavaFeatures = Core.Name "hydra.ext.java.environment.JavaFeatures"
...
_Aliases = Core.Name "hydra.ext.java.environment.Aliases"
...
_JavaEnvironment = Core.Name "hydra.ext.java.environment.JavaEnvironment"
