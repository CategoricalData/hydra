...
constParameter name typ = Syntax.Parameter {
...
cppClassDeclaration name baseSpecs mbody = (Syntax.DeclarationClass (Syntax.ClassDeclaration {
...
cppEnumDeclaration name mbody = (Syntax.DeclarationClass (Syntax.ClassDeclaration {
  Syntax.classDeclarationSpecifier = Syntax.ClassSpecifier {
...
cppEnumForwardDeclaration name = (Syntax.DeclarationClass (Syntax.ClassDeclaration {
  Syntax.classDeclarationSpecifier = Syntax.ClassSpecifier {
    Syntax.classSpecifierKey = Syntax.ClassKeyEnumClass,
    Syntax.classSpecifierName = name,
    Syntax.classSpecifierInheritance = []},
...
cppUnaryExpressionToCppExpression ue = (Syntax.ExpressionAssignment (Syntax.AssignmentExpressionConditional (Syntax.ConditionalExpressionLogicalOr (cppUnaryExpressionToCppLogicalOrExpression ue))))
...
cppUnaryExpressionToCppLogicalOrExpression ue = (Syntax.LogicalOrExpressionLogicalAnd (Syntax.LogicalAndExpressionInclusiveOr (Syntax.InclusiveOrExpressionExclusiveOr (Syntax.ExclusiveOrExpressionAnd (Syntax.AndExpressionEquality (Syntax.EqualityExpressionRelational (Syntax.RelationalExpressionShift (Syntax.ShiftExpressionAdditive (Syntax.AdditiveExpressionMultiplicative (Syntax.MultiplicativeExpressionUnary ue))))))))))

-- | Create a cast expression
createCastExpr :: (t0 -> Syntax.Expression -> Syntax.Expression)
createCastExpr targetType expr = (cppPrimaryExpressionToCppExpression (Syntax.PrimaryExpressionParenthesized (cppPrimaryExpressionToCppExpression (Syntax.PrimaryExpressionParenthesized expr))))
...
createEnumAccessExpr enumName valueName = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionMemberAccess (Syntax.MemberAccessOperation {
...
createFunctionCallExpr funcName args = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionFunctionCall (Syntax.FunctionCallOperation {
...
createHeaderFile includes decls = Syntax.Program {
...
createLambdaExpr params body = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionLambda (Syntax.LambdaExpression {
...
createLiteralBoolExpr val = (cppPrimaryExpressionToCppExpression (Syntax.PrimaryExpressionLiteral (Syntax.LiteralBoolean (Syntax.BooleanLiteral val))))

-- | Create an integer literal expression
createLiteralIntExpr :: (Integer -> Syntax.Expression)
createLiteralIntExpr val = (cppPrimaryExpressionToCppExpression (Syntax.PrimaryExpressionLiteral (Syntax.LiteralInteger (Syntax.IntegerLiteralDecimal val))))

-- | Create a string literal expression
createLiteralStringExpr :: (String -> Syntax.Expression)
createLiteralStringExpr val = (cppPrimaryExpressionToCppExpression (Syntax.PrimaryExpressionLiteral (Syntax.LiteralString (Syntax.StringLiteral val))))

-- | Create a member access expression
createMemberAccessExpr :: (Syntax.Expression -> String -> Syntax.Expression)
createMemberAccessExpr objExpr member = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionMemberAccess (Syntax.MemberAccessOperation {
...
createQualifiedType baseType qualifier = (Syntax.TypeExpressionQualified (Syntax.QualifiedType {
...
createTemplateType name args = (Syntax.TypeExpressionTemplate (Syntax.TemplateType {
...
createThisExpr = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "*this")))

-- | Create a throw statement
createThrowStmt :: (String -> Syntax.Expression -> Syntax.Statement)
createThrowStmt exceptionType arg = (Syntax.StatementJump (Syntax.JumpStatementThrow (createFunctionCallExpr exceptionType [
  arg])))

-- | Create a typeid(...).name() call expression
createTypeIdNameCall :: Syntax.Expression
createTypeIdNameCall = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionFunctionCall (Syntax.FunctionCallOperation {
...
createTypeNameExpr typeName = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier typeName)))

-- | Create a variant expression
createVariantExpr :: Syntax.Expression
createVariantExpr = (cppPostfixExpressionToCppExpression (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "variant")))
...
extractPostfixExpression expr = ((\x -> case x of
  Syntax.ExpressionAssignment v0 -> ((\x -> case x of
    Syntax.AssignmentExpressionConditional v1 -> ((\x -> case x of
      Syntax.ConditionalExpressionLogicalOr v2 -> ((\x -> case x of
        Syntax.LogicalOrExpressionLogicalAnd v3 -> ((\x -> case x of
          Syntax.LogicalAndExpressionInclusiveOr v4 -> ((\x -> case x of
            Syntax.InclusiveOrExpressionExclusiveOr v5 -> ((\x -> case x of
              Syntax.ExclusiveOrExpressionAnd v6 -> ((\x -> case x of
                Syntax.AndExpressionEquality v7 -> ((\x -> case x of
                  Syntax.EqualityExpressionRelational v8 -> ((\x -> case x of
                    Syntax.RelationalExpressionShift v9 -> ((\x -> case x of
                      Syntax.ShiftExpressionAdditive v10 -> ((\x -> case x of
                        Syntax.AdditiveExpressionMultiplicative v11 -> ((\x -> case x of
                          Syntax.MultiplicativeExpressionUnary v12 -> ((\x -> case x of
                            Syntax.UnaryExpressionPostfix v13 -> v13
                            _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v12)
                          _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v11)
                        _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v10)
                      _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v9)
                    _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v8)
                  _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v7)
                _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v6)
              _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v5)
            _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v4)
          _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v3)
        _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v2)
      _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v1)
    _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) v0)
  _ -> (Syntax.PostfixExpressionPrimary (Syntax.PrimaryExpressionIdentifier "error"))) expr)
...
stringExpression s = (cppPrimaryExpressionToCppExpression (Syntax.PrimaryExpressionLiteral (Syntax.LiteralString (Syntax.StringLiteral s))))

-- | Add const qualifier to a type
toConstType :: (Syntax.TypeExpression -> Syntax.TypeExpression)
toConstType baseType = (Syntax.TypeExpressionQualified (Syntax.QualifiedType {
  Syntax.qualifiedTypeBaseType = baseType,
  Syntax.qualifiedTypeQualifier = Syntax.TypeQualifierConst}))

-- | Create an unnamed parameter
unnamedParameter :: (String -> Syntax.TypeExpression -> Syntax.Parameter)
unnamedParameter name typ = Syntax.Parameter {
