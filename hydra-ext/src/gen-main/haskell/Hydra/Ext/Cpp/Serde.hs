...
encodeAccessSpecifier a = ((\x -> case x of
  ...
  Syntax.AccessSpecifierNone -> (Serialization.cst "")) a)
...
encodeAdditiveExpression e = ((\x -> case x of
...
encodeAssignmentOperator op = ((\x -> case x of
  ...
  Syntax.AssignmentOperatorBitwiseOrAssign -> (Serialization.cst "|=")) op)
...
encodeBasicType t = ((\x -> case x of
  ...
  Syntax.BasicTypeNamed v0 -> (Serialization.cst v0)) t)
...
encodeCaptureList cl = ((\x -> case x of
  Syntax.CaptureListCaptureByValue -> (Serialization.cst "[=]")
  Syntax.CaptureListCaptures v0 -> (Serialization.bracketList Serialization.inlineStyle (Lists.map encodeCapture v0))) cl)

-- | Convert a case statement to an expression
encodeCaseStatement :: (Syntax.CaseStatement -> Ast.Expr)
encodeCaseStatement stmt = ((\x -> case x of
...
encodeClassBody commas cb = (Serialization.curlyBlock Serialization.fullBlockStyle (Serialization.doubleNewlineSep (Lists.map (encodeMemberSpecification commas) (Syntax.unClassBody cb))))
...
encodeClassKey k = ((\x -> case x of
  ...
  Syntax.ClassKeyStruct -> (Serialization.cst "struct")) k)
...
encodeCompoundStatement cs = (Serialization.curlyBracesList (Just "") Serialization.fullBlockStyle (Lists.map encodeStatement (Syntax.unCompoundStatement cs)))

-- | Convert a conditional expression to an expression
encodeConditionalExpression :: (Syntax.ConditionalExpression -> Ast.Expr)
encodeConditionalExpression c = ((\x -> case x of
  Syntax.ConditionalExpressionLogicalOr v0 -> (encodeLogicalOrExpression v0)
  Syntax.ConditionalExpressionTernary v0 -> (encodeTernaryExpression v0)) c)
...
encodeDeclaration d = ((\x -> case x of
  ...
  Syntax.DeclarationTemplate v0 -> (encodeTemplateDeclaration v0)) d)
...
encodeElifDirective ed = (Serialization.spaceSep [
...
encodeEqualityExpression e = ((\x -> case x of
  ...
  Syntax.EqualityExpressionNotEqual v0 -> (encodeNotEqualOperation v0)) e)

-- | Convert an error directive to an expression
encodeErrorDirective :: (Syntax.ErrorDirective -> Ast.Expr)
encodeErrorDirective ed = (Serialization.spaceSep [
...
encodeExclusiveOrExpression e = ((\x -> case x of
  Syntax.ExclusiveOrExpressionAnd v0 -> (encodeAndExpression v0)
  Syntax.ExclusiveOrExpressionBitwiseXor v0 -> (encodeBitwiseXorOperation v0)) e)
...
encodeFunctionBody b = ((\x -> case x of
  ...
  Syntax.FunctionBodyDefault -> (Serialization.withSemi (Serialization.cst "= default"))) b)
...
encodeFunctionIdentifier f = ((\x -> case x of
  Syntax.FunctionIdentifierSimple v0 -> (Serialization.cst v0)
  Syntax.FunctionIdentifierQualified v0 -> (encodeQualifiedIdentifier v0)) f)
...
encodeFunctionSpecifierPrefix s = ((\x -> case x of
  ...
  Syntax.FunctionSpecifierPrefixExplicit -> (Serialization.cst "explicit")) s)
...
encodeFunctionSpecifierSuffix s = ((\x -> case x of
  ...
  Syntax.FunctionSpecifierSuffixFinal -> (Serialization.cst "final")) s)
...
encodeIfDirective ifd = (Serialization.spaceSep [
...
encodeIfdefDirective id = (Serialization.spaceSep [
...
encodeIfndefDirective ind = (Serialization.spaceSep [
...
encodeIntegerLiteral i = ((\x -> case x of
  ...
  Syntax.IntegerLiteralBinary v0 -> (Serialization.cst (Strings.cat2 "0b" v0))) i)

-- | Convert an iteration statement to an expression
encodeIterationStatement :: (Syntax.IterationStatement -> Ast.Expr)
encodeIterationStatement i = ((\x -> case x of
  ...
  Syntax.IterationStatementRangeFor v0 -> (encodeRangeForStatement v0)) i)

-- | Convert a jump statement to an expression
encodeJumpStatement :: (Syntax.JumpStatement -> Ast.Expr)
encodeJumpStatement j = ((\x -> case x of
...
encodeLogicalOrExpression e = ((\x -> case x of
  Syntax.LogicalOrExpressionLogicalAnd v0 -> (encodeLogicalAndExpression v0)
  Syntax.LogicalOrExpressionLogicalOr v0 -> (encodeLogicalOrOperation v0)) e)
...
encodeMemberDeclaration commas m = ((\x -> case x of
...
encodeMultiplicativeExpression e = ((\x -> case x of
  ...
  Syntax.MultiplicativeExpressionModulo v0 -> (encodeModuloOperation v0)) e)
...
encodeOverloadedLambdas ol = (Serialization.spaceSep [
...
encodeParameter p =  
  let typ = (Syntax.parameterType p) 
      ...
      nameExpr = (Serialization.cst (Logic.ifElse unnamed (Strings.cat [
              "/*",
              name,
              "*/"]) name))
  in (Serialization.spaceSep (Lists.concat [
...
encodePostfixExpression e = ((\x -> case x of
...
encodePreprocessorDirective d = ((\x -> case x of
  ...
  Syntax.PreprocessorDirectiveWarning v0 -> (encodeWarningDirective v0)) d)

-- | Convert a primary expression to an expression
encodePrimaryExpression :: (Syntax.PrimaryExpression -> Ast.Expr)
encodePrimaryExpression e = ((\x -> case x of
  ...
  Syntax.PrimaryExpressionLambda v0 -> (encodeLambdaExpression v0)) e)
...
encodeRelationalExpression e = ((\x -> case x of
  ...
  Syntax.RelationalExpressionGreaterEqual v0 -> (encodeGreaterEqualOperation v0)) e)
...
encodeShiftExpression e = ((\x -> case x of
  ...
  Syntax.ShiftExpressionRightShift v0 -> (encodeRightShiftOperation v0)) e)

-- | Convert a sizeof expression to an expression
encodeSizeofExpression :: (Syntax.SizeofExpression -> Ast.Expr)
encodeSizeofExpression se = (Serialization.spaceSep [
...
encodeStatement s = ((\x -> case x of
  ...
  Syntax.StatementExpression v0 -> (Serialization.withSemi (encodeExpression v0))) s)
...
encodeTemplateArgument a = ((\x -> case x of
  Syntax.TemplateArgumentType v0 -> (encodeTypeExpression v0)
  Syntax.TemplateArgumentValue v0 -> (encodeExpression v0)) a)
...
toCppComments s isMultiline = (Logic.ifElse isMultiline (Strings.cat [
  "/* ",
  s,
  " */"]) (Strings.cat2 "// " s))
...
encodeTypeExpression t = ((\x -> case x of
  ...
  Syntax.TypeExpressionAuto -> (Serialization.cst "auto")) t)
...
encodeUnaryOperator op = ((\x -> case x of
  ...
  Syntax.UnaryOperatorPreDecrement -> (Serialization.cst "--")) op)

-- | Convert an undef directive to an expression
encodeUndefDirective :: (Syntax.UndefDirective -> Ast.Expr)
encodeUndefDirective ud = (Serialization.spaceSep [
