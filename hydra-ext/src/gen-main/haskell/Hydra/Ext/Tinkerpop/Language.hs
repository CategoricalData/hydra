...
tinkerpopLanguage name features extras =  
  let vpFeatures = (Features.vertexPropertyFeaturesDataTypeFeatures (Features.vertexFeaturesProperties (Features.featuresVertex features))) 
      ...
      floatTypes = (Sets.fromList (Maybes.cat [
      ...
      integerTypes = (Sets.fromList (Maybes.cat [
      ...
      termVariants = (Sets.fromList (Maybes.cat [
      ...
      typeVariants = (Sets.fromList (Maybes.cat [
