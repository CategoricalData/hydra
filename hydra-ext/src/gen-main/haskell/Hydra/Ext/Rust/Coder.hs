...
encodeLiteralType lt = ((\x -> case x of
  ...
  Core.LiteralTypeFloat v0 -> ((\x -> case x of
    ...
    Core.FloatTypeFloat64 -> (rustPath "f64")) v0)
  Core.LiteralTypeInteger v0 -> ((\x -> case x of
    ...
    Core.IntegerTypeUint64 -> (rustPath "u64")) v0)
...
encodeLiteral lit = ((\x -> case x of
  ...
  Core.LiteralFloat v0 -> ((\x -> case x of
    ...
    Core.FloatValueBigfloat v1 -> (Syntax.ExpressionLiteral (Syntax.LiteralFloat (Syntax.FloatLiteral {
      ...
      Syntax.floatLiteralSuffix = Nothing})))) v0)
          ...
          in  
            ...
            in (Eithers.bind ((\x -> case x of
              ...
              _ -> (Eithers.bind (encodeType cx g typ) (\styp -> Right (Syntax.ItemTypeAlias (Syntax.TypeAlias {
                ...
                Syntax.typeAliasDoc = Nothing}))))) dtyp) (\item -> Right (Syntax.ItemWithComments {
