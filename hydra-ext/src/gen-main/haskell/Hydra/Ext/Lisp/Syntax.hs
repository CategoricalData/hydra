...
module Hydra.Ext.Lisp.Syntax where
...
_Program = (Core.Name "hydra.ext.lisp.syntax.Program")
...
_TopLevelForm = (Core.Name "hydra.ext.lisp.syntax.TopLevelForm")
...
_TopLevelFormWithComments = (Core.Name "hydra.ext.lisp.syntax.TopLevelFormWithComments")
...
_FunctionDefinition = (Core.Name "hydra.ext.lisp.syntax.FunctionDefinition")
...
_VariableDefinition = (Core.Name "hydra.ext.lisp.syntax.VariableDefinition")
...
_ConstantDefinition = (Core.Name "hydra.ext.lisp.syntax.ConstantDefinition")
...
_RecordTypeDefinition = (Core.Name "hydra.ext.lisp.syntax.RecordTypeDefinition")
...
_FieldDefinition = (Core.Name "hydra.ext.lisp.syntax.FieldDefinition")
...
_MacroDefinition = (Core.Name "hydra.ext.lisp.syntax.MacroDefinition")
...
_Expression = (Core.Name "hydra.ext.lisp.syntax.Expression")
...
_Application = (Core.Name "hydra.ext.lisp.syntax.Application")
...
_Lambda = (Core.Name "hydra.ext.lisp.syntax.Lambda")
...
_VariableReference = (Core.Name "hydra.ext.lisp.syntax.VariableReference")
...
_FieldAccess = (Core.Name "hydra.ext.lisp.syntax.FieldAccess")
...
_TypeAnnotation = (Core.Name "hydra.ext.lisp.syntax.TypeAnnotation")
...
_IfExpression = (Core.Name "hydra.ext.lisp.syntax.IfExpression")
...
_CondExpression = (Core.Name "hydra.ext.lisp.syntax.CondExpression")
...
_CondClause = (Core.Name "hydra.ext.lisp.syntax.CondClause")
...
_CaseExpression = (Core.Name "hydra.ext.lisp.syntax.CaseExpression")
...
_CaseClause = (Core.Name "hydra.ext.lisp.syntax.CaseClause")
...
_AndExpression = (Core.Name "hydra.ext.lisp.syntax.AndExpression")
...
_OrExpression = (Core.Name "hydra.ext.lisp.syntax.OrExpression")
...
_NotExpression = (Core.Name "hydra.ext.lisp.syntax.NotExpression")
...
_DoExpression = (Core.Name "hydra.ext.lisp.syntax.DoExpression")
...
_BeginExpression = (Core.Name "hydra.ext.lisp.syntax.BeginExpression")
...
_QuoteExpression = (Core.Name "hydra.ext.lisp.syntax.QuoteExpression")
...
_QuasiquoteExpression = (Core.Name "hydra.ext.lisp.syntax.QuasiquoteExpression")
...
_UnquoteExpression = (Core.Name "hydra.ext.lisp.syntax.UnquoteExpression")
...
_SplicingUnquoteExpression = (Core.Name "hydra.ext.lisp.syntax.SplicingUnquoteExpression")
...
_LetExpression = (Core.Name "hydra.ext.lisp.syntax.LetExpression")
...
_LetKind = (Core.Name "hydra.ext.lisp.syntax.LetKind")
...
_LetBinding = (Core.Name "hydra.ext.lisp.syntax.LetBinding")
...
_SimpleBinding = (Core.Name "hydra.ext.lisp.syntax.SimpleBinding")
...
_DestructuringBinding = (Core.Name "hydra.ext.lisp.syntax.DestructuringBinding")
...
data DestructuringPattern = 
  ...
  -- | Destructuring with a rest element: [a b & rest]
  DestructuringPatternRest DestructuringPattern
  deriving (Eq, Ord, Read, Show)

_DestructuringPattern = (Core.Name "hydra.ext.lisp.syntax.DestructuringPattern")
...
_Pattern = (Core.Name "hydra.ext.lisp.syntax.Pattern")
...
_ConstructorPattern = (Core.Name "hydra.ext.lisp.syntax.ConstructorPattern")
...
_LiteralPattern = (Core.Name "hydra.ext.lisp.syntax.LiteralPattern")
...
_WildcardPattern = (Core.Name "hydra.ext.lisp.syntax.WildcardPattern")
...
_Literal = (Core.Name "hydra.ext.lisp.syntax.Literal")
...
_IntegerLiteral = (Core.Name "hydra.ext.lisp.syntax.IntegerLiteral")
...
_FloatLiteral = (Core.Name "hydra.ext.lisp.syntax.FloatLiteral")
...
_CharacterLiteral = (Core.Name "hydra.ext.lisp.syntax.CharacterLiteral")
...
_BooleanStyle = (Core.Name "hydra.ext.lisp.syntax.BooleanStyle")
...
_NilStyle = (Core.Name "hydra.ext.lisp.syntax.NilStyle")
...
_Symbol = (Core.Name "hydra.ext.lisp.syntax.Symbol")
...
_Keyword = (Core.Name "hydra.ext.lisp.syntax.Keyword")
...
_QualifiedSymbol = (Core.Name "hydra.ext.lisp.syntax.QualifiedSymbol")
...
_NamespaceName = (Core.Name "hydra.ext.lisp.syntax.NamespaceName")
...
_ListLiteral = (Core.Name "hydra.ext.lisp.syntax.ListLiteral")
...
_VectorLiteral = (Core.Name "hydra.ext.lisp.syntax.VectorLiteral")
...
_MapLiteral = (Core.Name "hydra.ext.lisp.syntax.MapLiteral")
...
_MapEntry = (Core.Name "hydra.ext.lisp.syntax.MapEntry")
...
_SetLiteral = (Core.Name "hydra.ext.lisp.syntax.SetLiteral")
...
_ConsExpression = (Core.Name "hydra.ext.lisp.syntax.ConsExpression")
...
_DottedPair = (Core.Name "hydra.ext.lisp.syntax.DottedPair")
...
_TypeHint = (Core.Name "hydra.ext.lisp.syntax.TypeHint")
...
data TypeSpecifier = 
  ...
  -- | An either/union type
  TypeSpecifierEither TypeSpecifier |
  -- | The unit type
  TypeSpecifierUnit 
  deriving (Eq, Ord, Read, Show)

_TypeSpecifier = (Core.Name "hydra.ext.lisp.syntax.TypeSpecifier")
...
_ModuleDeclaration = (Core.Name "hydra.ext.lisp.syntax.ModuleDeclaration")
...
_ImportDeclaration = (Core.Name "hydra.ext.lisp.syntax.ImportDeclaration")
...
data ImportSpec = 
  ...
  -- | Import with renaming: (import (rename (name) (old new))) in Scheme
  ImportSpecRename [ImportSpec]
  deriving (Eq, Ord, Read, Show)

_ImportSpec = (Core.Name "hydra.ext.lisp.syntax.ImportSpec")
...
_ExportDeclaration = (Core.Name "hydra.ext.lisp.syntax.ExportDeclaration")
...
_Comment = (Core.Name "hydra.ext.lisp.syntax.Comment")
...
_CommentStyle = (Core.Name "hydra.ext.lisp.syntax.CommentStyle")
...
_Docstring = (Core.Name "hydra.ext.lisp.syntax.Docstring")
...
_Dialect = (Core.Name "hydra.ext.lisp.syntax.Dialect")
...
_SExpression = (Core.Name "hydra.ext.lisp.syntax.SExpression")
