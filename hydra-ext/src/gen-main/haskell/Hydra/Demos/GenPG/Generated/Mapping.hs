-- File: src/gen-main/haskell/Hydra/Demos/GenPG/Generated/Mapping.hs

module Hydra.Demos.GenPG.Generated.Mapping where
...
import Hydra.Dsl.Pg.Mappings (LazyGraph, column, edgeNoId, graph, property, vertex)
