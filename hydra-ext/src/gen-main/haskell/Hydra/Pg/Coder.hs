...
constructEdgeCoder :: Context.Context -> Graph.Graph -> Model.VertexLabel -> Mapping.Schema t0 t1 t2 -> Core.Type -> t1 -> t1 -> Model.Direction -> Core.Name -> [Core.FieldType] -> [Util.Adapter Core.FieldType (Model.PropertyType t1) Core.Field (Model.Property t2)] -> Maybe (Core.FieldType, (Mapping.ValueSpec, (Maybe String))) -> Maybe (Core.FieldType, (Mapping.ValueSpec, (Maybe String))) -> Either (Context.InContext Errors.Error) (Util.Adapter Core.Type (Model.ElementTypeTree t1) Core.Term (Model.ElementTree t2))
...
constructVertexCoder :: Context.Context -> Graph.Graph -> Mapping.Schema t0 t1 t2 -> Core.Type -> t1 -> t1 -> Core.Name -> [Core.FieldType] -> [Util.Adapter Core.FieldType (Model.PropertyType t1) Core.Field (Model.Property t2)] -> Either (Context.InContext Errors.Error) (Util.Adapter Core.Type (Model.ElementTypeTree t1) Core.Term (Model.ElementTree t2))
...
edgeIdAdapter :: Context.Context -> t0 -> Mapping.Schema t1 t2 t3 -> t4 -> Core.Name -> Core.Name -> [Core.FieldType] -> Either (Context.InContext Errors.Error) (Maybe (Core.Name, (Util.Adapter Core.Type t4 Core.Term t3)))
...
elementCoder :: Maybe (Model.Direction, Model.VertexLabel) -> Mapping.Schema t0 t1 t2 -> Core.Type -> t1 -> t1 -> Context.Context -> Graph.Graph -> Either (Context.InContext Errors.Error) (Util.Adapter Core.Type (Model.ElementTypeTree t1) Core.Term (Model.ElementTree t2))
...
encodeProperties :: Context.Context -> M.Map Core.Name Core.Term -> [Util.Adapter Core.FieldType t0 Core.Field (Model.Property t1)] -> Either (Context.InContext Errors.Error) (M.Map Model.PropertyKey t1)
...
encodeProperty :: Context.Context -> M.Map Core.Name Core.Term -> Util.Adapter Core.FieldType t0 Core.Field t1 -> Either (Context.InContext Errors.Error) (Maybe t1)
...
findAdjacenEdgeAdapters :: Context.Context -> Graph.Graph -> Mapping.Schema t0 t1 t2 -> t1 -> t1 -> Model.VertexLabel -> Model.Direction -> [Core.FieldType] -> Either (Context.InContext Errors.Error) [(Model.Direction, (Core.FieldType, (Model.EdgeLabel, (Util.Adapter Core.Type (Model.ElementTypeTree t1) Core.Term (Model.ElementTree t2)))))]
...
findIncidentVertexAdapter :: Context.Context -> Graph.Graph -> Mapping.Schema t0 t1 t2 -> t1 -> t1 -> (Core.FieldType, (Mapping.ValueSpec, (Maybe String))) -> Either (Context.InContext Errors.Error) (Core.Name, (Util.Adapter Core.Type (Model.ElementTypeTree t1) Core.Term (Model.ElementTree t2)))
...
propertyAdapter :: Context.Context -> t0 -> Mapping.Schema t1 t2 t3 -> (Core.FieldType, (Mapping.ValueSpec, (Maybe String))) -> Either (Context.InContext Errors.Error) (Util.Adapter Core.FieldType (Model.PropertyType t2) Core.Field (Model.Property t3))
...
selectEdgeId :: Context.Context -> M.Map Core.Name t0 -> (Core.Name, (Util.Adapter t1 t2 t0 t3)) -> Either (Context.InContext Errors.Error) t3
...
selectVertexId :: Context.Context -> M.Map Core.Name t0 -> (Core.Name, (Util.Adapter t1 t2 t0 t3)) -> Either (Context.InContext Errors.Error) t3
...
vertexIdAdapter :: Context.Context -> t0 -> Mapping.Schema t1 t2 t3 -> t4 -> Core.Name -> Core.Name -> [Core.FieldType] -> Either (Context.InContext Errors.Error) (Core.Name, (Util.Adapter Core.Type t4 Core.Term t3))
