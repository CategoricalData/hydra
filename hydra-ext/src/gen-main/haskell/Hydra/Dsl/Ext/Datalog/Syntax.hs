...
-- | DSL functions for hydra.ext.datalog.syntax

module Hydra.Dsl.Ext.Datalog.Syntax where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.Datalog.Syntax as Syntax
...
constant x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unConstant x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
relation x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRelation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
program x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unProgram x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
program_ElmtFact x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
program_ElmtRule x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.datalog.syntax.Program_Elmt"),
  Core.injectionField = Core.Field {
...
fact relation constantList = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
factRelation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
factConstantList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.Fact"),
...
factWithRelation original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.Fact"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Relation"),
...
factWithConstantList original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.Fact"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Relation"),
...
rule atom atomList = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
ruleAtom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
ruleAtomList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.Rule"),
...
ruleWithAtom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.Rule"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Atom"),
...
ruleWithAtomList original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.Rule"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Atom"),
...
atom relation termList = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
atomRelation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
atomTermList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.Atom"),
...
atomWithRelation original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.Atom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Relation"),
...
atomWithTermList original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.Atom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Relation"),
...
atomListSingle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
atomListMultiple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.datalog.syntax.AtomList"),
  Core.injectionField = Core.Field {
...
atomList_Multiple atom atomList = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.AtomList_Multiple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Atom"),
      Core.fieldTerm = (Phantoms.unTTerm atom)},
...
atomList_MultipleAtom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.AtomList_Multiple"),
    Core.projectionField = (Core.Name "Atom")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

atomList_MultipleAtomList :: (Phantoms.TTerm Syntax.AtomList_Multiple -> Phantoms.TTerm Syntax.AtomList)
atomList_MultipleAtomList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.AtomList_Multiple"),
    Core.projectionField = (Core.Name "AtomList")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
atomList_MultipleWithAtom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.AtomList_Multiple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Atom"),
...
atomList_MultipleWithAtomList original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.AtomList_Multiple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Atom"),
...
termConstant x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
termVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.datalog.syntax.Term"),
  Core.injectionField = Core.Field {
...
termListSingle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
termListMultiple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.datalog.syntax.TermList"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "multiple"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
termList_Multiple term termList = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.TermList_Multiple"),
  Core.recordFields = [
    Core.Field {
...
termList_MultipleTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.TermList_Multiple"),
...
termList_MultipleTermList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.TermList_Multiple"),
    Core.projectionField = (Core.Name "TermList")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
termList_MultipleWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.TermList_Multiple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Term"),
...
termList_MultipleWithTermList original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.TermList_Multiple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Term"),
...
constantListSingle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
constantListMultiple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.datalog.syntax.ConstantList"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "multiple"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
constantList_Multiple constant constantList = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
constantList_MultipleConstant x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
constantList_MultipleConstantList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.datalog.syntax.ConstantList_Multiple"),
    Core.projectionField = (Core.Name "ConstantList")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
constantList_MultipleWithConstant original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.ConstantList_Multiple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Constant"),
...
constantList_MultipleWithConstantList original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.datalog.syntax.ConstantList_Multiple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Constant"),
