...
-- | DSL functions for hydra.ext.javaScript.syntax

module Hydra.Dsl.Ext.JavaScript.Syntax where
...
identifier x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.Identifier"),
...
unIdentifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.Identifier")))),
...
literalString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Literal"),
...
literalUndefined = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalBigInt x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalTemplate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Literal"),
  Core.injectionField = Core.Field {
...
stringLiteral value singleQuote = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.StringLiteral"),
  Core.recordFields = [
    Core.Field {
...
stringLiteralValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.StringLiteral"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringLiteralSingleQuote :: (Phantoms.TTerm Syntax.StringLiteral -> Phantoms.TTerm Bool)
stringLiteralSingleQuote x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.StringLiteral"),
...
stringLiteralWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.StringLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
stringLiteralWithSingleQuote original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.StringLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
templateLiteral quasis expressions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateLiteral"),
  Core.recordFields = [
    Core.Field {
...
templateLiteralQuasis x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateLiteral"),
...
templateLiteralExpressions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateLiteral"),
...
templateLiteralWithQuasis original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "quasis"),
...
templateLiteralWithExpressions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "quasis"),
...
templateElement value tail = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
      Core.fieldTerm = (Phantoms.unTTerm value)},
...
templateElementValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateElement"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

templateElementTail :: (Phantoms.TTerm Syntax.TemplateElement -> Phantoms.TTerm Bool)
templateElementTail x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateElement"),
...
templateElementWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
templateElementWithTail original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TemplateElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
numericLiteralInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.NumericLiteral"),
  Core.injectionField = Core.Field {
...
typeAnnotation x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeAnnotation"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unTypeAnnotation :: (Phantoms.TTerm Syntax.TypeAnnotation -> Phantoms.TTerm Syntax.TypeExpression)
unTypeAnnotation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.TypeAnnotation")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeExpressionIdentifier :: (Phantoms.TTerm Syntax.Identifier -> Phantoms.TTerm Syntax.TypeExpression)
typeExpressionIdentifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionParameterized x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionOptional x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionAny = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionVoid = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionNever = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
functionTypeExpression typeParameters parameters returnType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionTypeExpression"),
  Core.recordFields = [
    Core.Field {
...
functionTypeExpressionTypeParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionTypeExpression"),
...
functionTypeExpressionParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionTypeExpression"),
...
functionTypeExpressionReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionTypeExpression"),
...
functionTypeExpressionWithTypeParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionTypeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "typeParameters"),
...
functionTypeExpressionWithParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionTypeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "typeParameters"),
...
functionTypeExpressionWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionTypeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "typeParameters"),
...
arrayTypeExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrayTypeExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unArrayTypeExpression :: (Phantoms.TTerm Syntax.ArrayTypeExpression -> Phantoms.TTerm Syntax.TypeExpression)
unArrayTypeExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.ArrayTypeExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
parameterizedTypeExpression base arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ParameterizedTypeExpression"),
  Core.recordFields = [
    Core.Field {
...
parameterizedTypeExpressionBase x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ParameterizedTypeExpression"),
...
parameterizedTypeExpressionArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ParameterizedTypeExpression"),
...
parameterizedTypeExpressionWithBase original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ParameterizedTypeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "base"),
...
parameterizedTypeExpressionWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ParameterizedTypeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "base"),
...
propertySignature name type_ optional readonly = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
  Core.recordFields = [
    Core.Field {
...
propertySignatureName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

propertySignatureType :: (Phantoms.TTerm Syntax.PropertySignature -> Phantoms.TTerm Syntax.TypeExpression)
propertySignatureType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
...
propertySignatureOptional x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
...
propertySignatureReadonly x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
...
propertySignatureWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
propertySignatureWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
propertySignatureWithOptional original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
propertySignatureWithReadonly original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertySignature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeParameter name constraint default_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeParameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
typeParameterName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeParameter"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeParameterConstraint :: (Phantoms.TTerm Syntax.TypeParameter -> Phantoms.TTerm (Maybe Syntax.TypeExpression))
typeParameterConstraint x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeParameter"),
...
typeParameterDefault x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeParameter"),
...
typeParameterWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeParameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeParameterWithConstraint original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeParameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeParameterWithDefault original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TypeParameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
expressionIdentifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "identifier"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "object"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "function"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionArrow x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionMember x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionThis = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionNew x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionYield x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionSpread x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionParenthesized x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Expression"),
  Core.injectionField = Core.Field {
...
functionExpression id params body async generator = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
...
functionExpressionId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
...
functionExpressionParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
...
functionExpressionBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
...
functionExpressionAsync x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
...
functionExpressionGenerator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
...
functionExpressionWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
functionExpressionWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
functionExpressionWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
functionExpressionWithAsync original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
functionExpressionWithGenerator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
arrowFunctionExpression params body async = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "params"),
      Core.fieldTerm = (Phantoms.unTTerm params)},
...
arrowFunctionExpressionParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionExpression"),
    Core.projectionField = (Core.Name "params")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

arrowFunctionExpressionBody :: (Phantoms.TTerm Syntax.ArrowFunctionExpression -> Phantoms.TTerm Syntax.ArrowFunctionBody)
arrowFunctionExpressionBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionExpression"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
arrowFunctionExpressionAsync x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionExpression"),
    Core.projectionField = (Core.Name "async")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
arrowFunctionExpressionWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "params"),
...
arrowFunctionExpressionWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "params"),
...
arrowFunctionExpressionWithAsync original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "params"),
...
arrowFunctionBodyExpression x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionBody"),
  Core.injectionField = Core.Field {
...
arrowFunctionBodyBlock x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrowFunctionBody"),
  Core.injectionField = Core.Field {
...
callExpression callee arguments optional = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.CallExpression"),
  Core.recordFields = [
    Core.Field {
...
callExpressionCallee x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.CallExpression"),
...
callExpressionArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.CallExpression"),
    Core.projectionField = (Core.Name "arguments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
callExpressionOptional x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.CallExpression"),
    Core.projectionField = (Core.Name "optional")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
callExpressionWithCallee original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.CallExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "callee"),
...
callExpressionWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.CallExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "callee"),
...
callExpressionWithOptional original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.CallExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "callee"),
...
memberExpression object property computed optional = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
memberExpressionObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
...
memberExpressionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
...
memberExpressionComputed x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
...
memberExpressionOptional x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
    Core.projectionField = (Core.Name "optional")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
memberExpressionWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
memberExpressionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
memberExpressionWithComputed original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
memberExpressionWithOptional original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MemberExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
conditionalExpression test consequent alternate = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ConditionalExpression"),
  Core.recordFields = [
    Core.Field {
...
conditionalExpressionTest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ConditionalExpression"),
...
conditionalExpressionConsequent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ConditionalExpression"),
...
conditionalExpressionAlternate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ConditionalExpression"),
...
conditionalExpressionWithTest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ConditionalExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
conditionalExpressionWithConsequent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ConditionalExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
conditionalExpressionWithAlternate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ConditionalExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
binaryExpression operator left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryExpression"),
  Core.recordFields = [
    Core.Field {
...
binaryExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryExpression"),
...
unaryExpression operator argument prefix = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
      Core.fieldTerm = (Phantoms.unTTerm operator)},
...
unaryExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryExpression"),
    Core.projectionField = (Core.Name "operator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

unaryExpressionArgument :: (Phantoms.TTerm Syntax.UnaryExpression -> Phantoms.TTerm Syntax.Expression)
unaryExpressionArgument x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryExpression"),
...
unaryExpressionPrefix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryExpression"),
...
unaryExpressionWithArgument original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
unaryExpressionWithPrefix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
assignmentExpression operator left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
      Core.fieldTerm = (Phantoms.unTTerm operator)},
...
assignmentExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentExpression"),
    Core.projectionField = (Core.Name "operator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

assignmentExpressionLeft :: (Phantoms.TTerm Syntax.AssignmentExpression -> Phantoms.TTerm Syntax.Pattern)
assignmentExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentExpression"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
assignmentExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentExpression"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
assignmentExpressionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
assignmentExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
assignmentExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
spreadElement x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.SpreadElement"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSpreadElement :: (Phantoms.TTerm Syntax.SpreadElement -> Phantoms.TTerm Syntax.Expression)
unSpreadElement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.SpreadElement")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
property key value kind computed shorthand = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
  Core.recordFields = [
    Core.Field {
...
propertyKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
...
propertyKind x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
...
propertyComputed x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
    Core.projectionField = (Core.Name "computed")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyShorthand x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
...
propertyWithKind original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
propertyWithComputed original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
propertyWithShorthand original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.Property"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
propertyKindInit = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertyKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "init"),
    Core.fieldTerm = Core.TermUnit}})))

propertyKindGet :: (Phantoms.TTerm Syntax.PropertyKind)
propertyKindGet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertyKind"),
  Core.injectionField = Core.Field {
...
propertyKindSet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.PropertyKind"),
  Core.injectionField = Core.Field {
...
arrayElementExpression x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrayElement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "expression"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

arrayElementSpread :: (Phantoms.TTerm Syntax.SpreadElement -> Phantoms.TTerm Syntax.ArrayElement)
arrayElementSpread x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrayElement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "spread"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
arrayElementHole = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ArrayElement"),
  Core.injectionField = Core.Field {
...
patternIdentifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "identifier"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

patternObject :: (Phantoms.TTerm Syntax.ObjectPattern -> Phantoms.TTerm Syntax.Pattern)
patternObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "object"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "array"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternAssignment x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "assignment"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternRest x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Pattern"),
  Core.injectionField = Core.Field {
...
objectPattern properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ObjectPattern"),
  Core.recordFields = [
    Core.Field {
...
objectPatternProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ObjectPattern"),
...
objectPatternWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ObjectPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "properties"),
...
objectPatternPropertyProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ObjectPatternProperty"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "property"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

objectPatternPropertyRest :: (Phantoms.TTerm Syntax.RestElement -> Phantoms.TTerm Syntax.ObjectPatternProperty)
objectPatternPropertyRest x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ObjectPatternProperty"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "rest"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
assignmentPattern left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
assignmentPatternLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentPattern"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

assignmentPatternRight :: (Phantoms.TTerm Syntax.AssignmentPattern -> Phantoms.TTerm Syntax.Expression)
assignmentPatternRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentPattern"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
assignmentPatternWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
assignmentPatternWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
restElement x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.RestElement"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unRestElement :: (Phantoms.TTerm Syntax.RestElement -> Phantoms.TTerm Syntax.Pattern)
unRestElement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.RestElement")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
statementExpression x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "expression"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
statementDebugger = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementThrow x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementTry x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementDoWhile x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementForIn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementForOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementVariableDeclaration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementFunctionDeclaration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementClassDeclaration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Statement"),
  Core.injectionField = Core.Field {
...
labeledStatement label body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.LabeledStatement"),
  Core.recordFields = [
    Core.Field {
...
labeledStatementLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.LabeledStatement"),
...
labeledStatementBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.LabeledStatement"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
labeledStatementWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.LabeledStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
variableDeclaration kind declarations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "kind"),
      Core.fieldTerm = (Phantoms.unTTerm kind)},
...
variableDeclarationKind x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclaration"),
    Core.projectionField = (Core.Name "kind")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

variableDeclarationDeclarations :: (Phantoms.TTerm Syntax.VariableDeclaration -> Phantoms.TTerm [Syntax.VariableDeclarator])
variableDeclarationDeclarations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclaration"),
...
variableDeclarationWithKind original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "kind"),
...
variableDeclarationWithDeclarations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "kind"),
...
variableDeclarator id init = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclarator"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
      Core.fieldTerm = (Phantoms.unTTerm id)},
...
variableDeclaratorId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclarator"),
    Core.projectionField = (Core.Name "id")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

variableDeclaratorInit :: (Phantoms.TTerm Syntax.VariableDeclarator -> Phantoms.TTerm (Maybe Syntax.Expression))
variableDeclaratorInit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclarator"),
...
variableDeclaratorWithInit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableDeclarator"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
variableKindVar = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "var"),
    Core.fieldTerm = Core.TermUnit}})))

variableKindLet :: (Phantoms.TTerm Syntax.VariableKind)
variableKindLet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableKind"),
  Core.injectionField = Core.Field {
...
variableKindConst = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.VariableKind"),
  Core.injectionField = Core.Field {
...
ifStatement test consequent alternate = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.IfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
      Core.fieldTerm = (Phantoms.unTTerm test)},
...
ifStatementTest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.IfStatement"),
    Core.projectionField = (Core.Name "test")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

ifStatementConsequent :: (Phantoms.TTerm Syntax.IfStatement -> Phantoms.TTerm Syntax.Statement)
ifStatementConsequent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.IfStatement"),
    Core.projectionField = (Core.Name "consequent")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
ifStatementAlternate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.IfStatement"),
    Core.projectionField = (Core.Name "alternate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
ifStatementWithTest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.IfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
ifStatementWithConsequent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.IfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
ifStatementWithAlternate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.IfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
switchStatement discriminant cases = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchStatement"),
  Core.recordFields = [
    Core.Field {
...
switchStatementDiscriminant x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchStatement"),
...
switchStatementWithDiscriminant original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "discriminant"),
...
switchCase test consequent = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchCase"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
      Core.fieldTerm = (Phantoms.unTTerm test)},
...
switchCaseTest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchCase"),
    Core.projectionField = (Core.Name "test")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

switchCaseConsequent :: (Phantoms.TTerm Syntax.SwitchCase -> Phantoms.TTerm [Syntax.Statement])
switchCaseConsequent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchCase"),
    Core.projectionField = (Core.Name "consequent")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
switchCaseWithTest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchCase"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
switchCaseWithConsequent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.SwitchCase"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
forStatement init test update body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "init"),
      Core.fieldTerm = (Phantoms.unTTerm init)},
...
forStatementInit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForStatement"),
    Core.projectionField = (Core.Name "init")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

forStatementTest :: (Phantoms.TTerm Syntax.ForStatement -> Phantoms.TTerm (Maybe Syntax.Expression))
forStatementTest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForStatement"),
    Core.projectionField = (Core.Name "test")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forStatementUpdate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForStatement"),
...
forStatementWithTest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "init"),
...
forStatementWithUpdate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "init"),
...
forInitVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInit"),
  Core.injectionField = Core.Field {
...
forInStatement left right body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
forInStatementLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInStatement"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

forInStatementRight :: (Phantoms.TTerm Syntax.ForInStatement -> Phantoms.TTerm Syntax.Expression)
forInStatementRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInStatement"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forInStatementBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInStatement"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forInStatementWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
forInStatementWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
forInStatementWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
forInLeftVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInLeft"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

forInLeftPattern :: (Phantoms.TTerm Syntax.Pattern -> Phantoms.TTerm Syntax.ForInLeft)
forInLeftPattern x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForInLeft"),
  Core.injectionField = Core.Field {
...
forOfStatement await left right body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "await"),
...
forOfStatementAwait x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
...
forOfStatementLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forOfStatementRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forOfStatementBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forOfStatementWithAwait original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "await"),
...
forOfStatementWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "await"),
...
forOfStatementWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "await"),
...
forOfStatementWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ForOfStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "await"),
...
whileStatement test body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.WhileStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
      Core.fieldTerm = (Phantoms.unTTerm test)},
...
whileStatementTest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.WhileStatement"),
    Core.projectionField = (Core.Name "test")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
whileStatementWithTest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.WhileStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "test"),
...
doWhileStatement body test = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DoWhileStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
      Core.fieldTerm = (Phantoms.unTTerm body)},
...
doWhileStatementBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DoWhileStatement"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

doWhileStatementTest :: (Phantoms.TTerm Syntax.DoWhileStatement -> Phantoms.TTerm Syntax.Expression)
doWhileStatementTest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DoWhileStatement"),
    Core.projectionField = (Core.Name "test")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
doWhileStatementWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DoWhileStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
doWhileStatementWithTest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DoWhileStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
tryStatement block handler finalizer = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TryStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "block"),
...
tryStatementBlock x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TryStatement"),
...
tryStatementHandler x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TryStatement"),
...
tryStatementFinalizer x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.TryStatement"),
...
tryStatementWithBlock original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TryStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "block"),
...
tryStatementWithHandler original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TryStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "block"),
...
tryStatementWithFinalizer original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.TryStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "block"),
...
catchClause param body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.CatchClause"),
  Core.recordFields = [
    Core.Field {
...
catchClauseParam x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.CatchClause"),
...
catchClauseBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.CatchClause"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
catchClauseWithParam original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.CatchClause"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "param"),
...
catchClauseWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.CatchClause"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "param"),
...
throwStatement x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.ThrowStatement"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unThrowStatement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.ThrowStatement")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclaration id params body async generator = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
      Core.fieldTerm = (Phantoms.unTTerm id)},
...
functionDeclarationId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "id")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

functionDeclarationParams :: (Phantoms.TTerm Syntax.FunctionDeclaration -> Phantoms.TTerm [Syntax.Pattern])
functionDeclarationParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "params")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationAsync x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "async")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationGenerator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "generator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
functionDeclarationWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
functionDeclarationWithAsync original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
functionDeclarationWithGenerator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
classDeclaration id superClass body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
      Core.fieldTerm = (Phantoms.unTTerm id)},
...
classDeclarationId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclaration"),
    Core.projectionField = (Core.Name "id")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

classDeclarationSuperClass :: (Phantoms.TTerm Syntax.ClassDeclaration -> Phantoms.TTerm (Maybe Syntax.Expression))
classDeclarationSuperClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclaration"),
...
classDeclarationWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
classDeclarationWithSuperClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
methodDefinition key value kind computed static = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
      Core.fieldTerm = (Phantoms.unTTerm key)},
...
methodDefinitionKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
    Core.projectionField = (Core.Name "key")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

methodDefinitionValue :: (Phantoms.TTerm Syntax.MethodDefinition -> Phantoms.TTerm Syntax.FunctionExpression)
methodDefinitionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
methodDefinitionKind x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
    Core.projectionField = (Core.Name "kind")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
methodDefinitionComputed x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
    Core.projectionField = (Core.Name "computed")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
methodDefinitionStatic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
...
methodDefinitionWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
methodDefinitionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
methodDefinitionWithKind original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
methodDefinitionWithComputed original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
methodDefinitionWithStatic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
methodKindConstructor = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "constructor"),
    Core.fieldTerm = Core.TermUnit}})))

methodKindMethod :: (Phantoms.TTerm Syntax.MethodKind)
methodKindMethod = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodKind"),
  Core.injectionField = Core.Field {
...
methodKindGet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "get"),
    Core.fieldTerm = Core.TermUnit}})))
...
methodKindSet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.MethodKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "set"),
    Core.fieldTerm = Core.TermUnit}})))
...
program body sourceType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.Program"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
      Core.fieldTerm = (Phantoms.unTTerm body)},
...
programBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Program"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

programSourceType :: (Phantoms.TTerm Syntax.Program -> Phantoms.TTerm Syntax.SourceType)
programSourceType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Program"),
...
programWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.Program"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
programWithSourceType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.Program"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
sourceTypeModule = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.SourceType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "module"),
    Core.fieldTerm = Core.TermUnit}})))

sourceTypeScript :: (Phantoms.TTerm Syntax.SourceType)
sourceTypeScript = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.SourceType"),
  Core.injectionField = Core.Field {
...
moduleItemStatement x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItem"),
  Core.injectionField = Core.Field {
...
moduleItemImport x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItem"),
  Core.injectionField = Core.Field {
...
moduleItemExport x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItem"),
  Core.injectionField = Core.Field {
...
importDeclaration specifiers source = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportDeclaration"),
  Core.recordFields = [
    Core.Field {
...
importDeclarationSpecifiers x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportDeclaration"),
...
importDeclarationSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportDeclaration"),
...
importDeclarationWithSpecifiers original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "specifiers"),
...
importDeclarationWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "specifiers"),
...
importClauseNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportClause"),
  Core.injectionField = Core.Field {
...
importClauseDefault x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportClause"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "default"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
importClauseNamespace x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportClause"),
  Core.injectionField = Core.Field {
...
importSpecifier imported local = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportSpecifier"),
  Core.recordFields = [
    Core.Field {
...
importSpecifierImported x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportSpecifier"),
...
importSpecifierLocal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportSpecifier"),
...
importSpecifierWithImported original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "imported"),
...
importSpecifierWithLocal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "imported"),
...
importDefaultSpecifier x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportDefaultSpecifier"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unImportDefaultSpecifier :: (Phantoms.TTerm Syntax.ImportDefaultSpecifier -> Phantoms.TTerm Syntax.Identifier)
unImportDefaultSpecifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.ImportDefaultSpecifier")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

importNamespaceSpecifier :: (Phantoms.TTerm Syntax.Identifier -> Phantoms.TTerm Syntax.ImportNamespaceSpecifier)
importNamespaceSpecifier x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.javaScript.syntax.ImportNamespaceSpecifier"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unImportNamespaceSpecifier :: (Phantoms.TTerm Syntax.ImportNamespaceSpecifier -> Phantoms.TTerm Syntax.Identifier)
unImportNamespaceSpecifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.javaScript.syntax.ImportNamespaceSpecifier")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

exportDeclarationNamed :: (Phantoms.TTerm Syntax.NamedExport -> Phantoms.TTerm Syntax.ExportDeclaration)
exportDeclarationNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportDeclaration"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "named"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

exportDeclarationDefault :: (Phantoms.TTerm Syntax.Expression -> Phantoms.TTerm Syntax.ExportDeclaration)
exportDeclarationDefault x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportDeclaration"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "default"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
exportDeclarationDeclaration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportDeclaration"),
  Core.injectionField = Core.Field {
...
exportDeclarationAll x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportDeclaration"),
  Core.injectionField = Core.Field {
...
namedExport specifiers source = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.NamedExport"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "specifiers"),
      Core.fieldTerm = (Phantoms.unTTerm specifiers)},
...
namedExportSpecifiers x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.NamedExport"),
    Core.projectionField = (Core.Name "specifiers")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

namedExportSource :: (Phantoms.TTerm Syntax.NamedExport -> Phantoms.TTerm (Maybe Syntax.StringLiteral))
namedExportSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.NamedExport"),
    Core.projectionField = (Core.Name "source")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
namedExportWithSpecifiers original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.NamedExport"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "specifiers"),
...
namedExportWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.NamedExport"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "specifiers"),
...
exportAllDeclaration exported source = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportAllDeclaration"),
  Core.recordFields = [
    Core.Field {
...
exportAllDeclarationExported x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportAllDeclaration"),
...
exportAllDeclarationSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportAllDeclaration"),
    Core.projectionField = (Core.Name "source")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
exportAllDeclarationWithExported original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportAllDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "exported"),
...
exportAllDeclarationWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportAllDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "exported"),
...
exportSpecifier local exported = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "local"),
      Core.fieldTerm = (Phantoms.unTTerm local)},
...
exportSpecifierLocal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportSpecifier"),
    Core.projectionField = (Core.Name "local")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

exportSpecifierExported :: (Phantoms.TTerm Syntax.ExportSpecifier -> Phantoms.TTerm Syntax.Identifier)
exportSpecifierExported x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportSpecifier"),
    Core.projectionField = (Core.Name "exported")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
exportSpecifierWithLocal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "local"),
...
exportSpecifierWithExported original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ExportSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "local"),
...
binaryOperatorAdd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "add"),
    Core.fieldTerm = Core.TermUnit}})))

binaryOperatorSubtract :: (Phantoms.TTerm Syntax.BinaryOperator)
binaryOperatorSubtract = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorExponentiate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorStrictEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorStrictNotEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorLessThan = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorLessThanOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorGreaterThan = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorGreaterThanOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorAnd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorOr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorNullishCoalescing = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorUnsignedRightShift = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorIn = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorInstanceof = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorNegate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorTypeof = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorVoid = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "void"),
    Core.fieldTerm = Core.TermUnit}})))
...
unaryOperatorDelete = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorIncrement = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorDecrement = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "assign"),
    Core.fieldTerm = Core.TermUnit}})))

assignmentOperatorAddAssign :: (Phantoms.TTerm Syntax.AssignmentOperator)
assignmentOperatorAddAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorSubtractAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorExponentiateAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorUnsignedRightShiftAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorAndAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorOrAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorNullishAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
commentLine x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Comment"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "line"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

commentBlock :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.Comment)
commentBlock x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Comment"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "block"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
commentDocumentation x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.Comment"),
  Core.injectionField = Core.Field {
...
documentationComment description tags = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationComment"),
  Core.recordFields = [
    Core.Field {
...
documentationCommentDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationComment"),
...
documentationCommentTags x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationComment"),
...
documentationCommentWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationComment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "description"),
...
documentationCommentWithTags original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationComment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "description"),
...
documentationTag name type_ paramName description = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
documentationTagName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

documentationTagType :: (Phantoms.TTerm Syntax.DocumentationTag -> Phantoms.TTerm (Maybe Syntax.TypeExpression))
documentationTagType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
documentationTagParamName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
...
documentationTagDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
    Core.projectionField = (Core.Name "description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
documentationTagWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
documentationTagWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
documentationTagWithParamName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
documentationTagWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.DocumentationTag"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
moduleItemWithComments body comments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItemWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
      Core.fieldTerm = (Phantoms.unTTerm body)},
...
moduleItemWithCommentsBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItemWithComments"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
moduleItemWithCommentsComments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItemWithComments"),
...
moduleItemWithCommentsWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItemWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
moduleItemWithCommentsWithComments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ModuleItemWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
statementWithComments body comments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.StatementWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
      Core.fieldTerm = (Phantoms.unTTerm body)},
...
statementWithCommentsBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.StatementWithComments"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
statementWithCommentsComments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.StatementWithComments"),
    Core.projectionField = (Core.Name "comments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
statementWithCommentsWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.StatementWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
statementWithCommentsWithComments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.StatementWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
functionDeclarationWithComments body comments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclarationWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
      Core.fieldTerm = (Phantoms.unTTerm body)},
...
functionDeclarationWithCommentsBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclarationWithComments"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationWithCommentsComments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclarationWithComments"),
    Core.projectionField = (Core.Name "comments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationWithCommentsWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclarationWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
functionDeclarationWithCommentsWithComments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.FunctionDeclarationWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
classDeclarationWithComments body comments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclarationWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
      Core.fieldTerm = (Phantoms.unTTerm body)},
...
classDeclarationWithCommentsBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclarationWithComments"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
classDeclarationWithCommentsComments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclarationWithComments"),
    Core.projectionField = (Core.Name "comments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
classDeclarationWithCommentsWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclarationWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
classDeclarationWithCommentsWithComments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.javaScript.syntax.ClassDeclarationWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
