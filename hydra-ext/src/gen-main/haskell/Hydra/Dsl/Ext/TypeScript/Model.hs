...
-- | DSL functions for hydra.ext.typeScript.model

module Hydra.Dsl.Ext.TypeScript.Model where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.TypeScript.Model as Model
...
functionType parameters range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.typeScript.model.FunctionType"),
  Core.recordFields = [
    Core.Field {
...
functionTypeParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.typeScript.model.FunctionType"),
...
functionTypeRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.typeScript.model.FunctionType"),
...
functionTypeWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.typeScript.model.FunctionType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "parameters"),
...
parameter name type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.typeScript.model.Parameter"),
  Core.recordFields = [
    Core.Field {
...
parameterName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.typeScript.model.Parameter"),
...
primitiveTypeBigint = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.PrimitiveType"),
...
primitiveTypeNull = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.PrimitiveType"),
  Core.injectionField = Core.Field {
...
primitiveTypeNumber = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.PrimitiveType"),
  Core.injectionField = Core.Field {
...
primitiveTypeObject = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.PrimitiveType"),
  Core.injectionField = Core.Field {
...
primitiveTypeSymbol = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.PrimitiveType"),
  Core.injectionField = Core.Field {
...
primitiveTypeUndefined = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.PrimitiveType"),
  Core.injectionField = Core.Field {
...
typeArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.Type"),
  Core.injectionField = Core.Field {
...
typeObjectLiteral = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.Type"),
  Core.injectionField = Core.Field {
...
typeUnknown = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.Type"),
  Core.injectionField = Core.Field {
...
typeVoid = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.typeScript.model.Type"),
  Core.injectionField = Core.Field {
