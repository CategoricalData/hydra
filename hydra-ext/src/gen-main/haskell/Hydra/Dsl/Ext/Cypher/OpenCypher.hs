...
-- | DSL functions for hydra.ext.cypher.openCypher

module Hydra.Dsl.Ext.Cypher.OpenCypher where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.Cypher.OpenCypher as OpenCypher
...
queryRegular x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Query"),
...
queryStandalone x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Query"),
  Core.injectionField = Core.Field {
...
regularQuery head rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RegularQuery"),
  Core.recordFields = [
    Core.Field {
...
regularQueryHead x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RegularQuery"),
...
regularQueryRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RegularQuery"),
...
regularQueryWithHead original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RegularQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "head"),
...
regularQueryWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RegularQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "head"),
...
union all query = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Union"),
  Core.recordFields = [
    Core.Field {
...
unionAll x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Union"),
    Core.projectionField = (Core.Name "all")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

unionQuery :: (Phantoms.TTerm OpenCypher.Union -> Phantoms.TTerm OpenCypher.SingleQuery)
unionQuery x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Union"),
...
unionWithAll original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Union"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "all"),
...
unionWithQuery original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Union"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "all"),
...
singleQuerySinglePart x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SingleQuery"),
  Core.injectionField = Core.Field {
...
singleQueryMultiPart x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SingleQuery"),
  Core.injectionField = Core.Field {
...
singlePartQuery reading updating return = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.SinglePartQuery"),
  Core.recordFields = [
    Core.Field {
...
singlePartQueryReading x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SinglePartQuery"),
...
singlePartQueryUpdating x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SinglePartQuery"),
...
singlePartQueryReturn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SinglePartQuery"),
...
singlePartQueryWithReading original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.SinglePartQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "reading"),
...
singlePartQueryWithUpdating original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.SinglePartQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "reading"),
...
singlePartQueryWithReturn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.SinglePartQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "reading"),
...
withClause reading updating with = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.WithClause"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "reading"),
      Core.fieldTerm = (Phantoms.unTTerm reading)},
...
withClauseReading x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.WithClause"),
    Core.projectionField = (Core.Name "reading")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

withClauseUpdating :: (Phantoms.TTerm OpenCypher.WithClause -> Phantoms.TTerm [OpenCypher.UpdatingClause])
withClauseUpdating x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.WithClause"),
    Core.projectionField = (Core.Name "updating")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
withClauseWith x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.WithClause"),
...
withClauseWithReading original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.WithClause"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "reading"),
...
withClauseWithUpdating original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.WithClause"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "reading"),
...
withClauseWithWith original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.WithClause"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "reading"),
...
multiPartQuery with body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiPartQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "with"),
      Core.fieldTerm = (Phantoms.unTTerm with)},
...
multiPartQueryWith x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiPartQuery"),
    Core.projectionField = (Core.Name "with")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

multiPartQueryBody :: (Phantoms.TTerm OpenCypher.MultiPartQuery -> Phantoms.TTerm OpenCypher.SinglePartQuery)
multiPartQueryBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiPartQuery"),
...
multiPartQueryWithWith original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiPartQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "with"),
...
multiPartQueryWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiPartQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "with"),
...
updatingClauseCreate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.UpdatingClause"),
  Core.injectionField = Core.Field {
...
updatingClauseMerge x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.UpdatingClause"),
  Core.injectionField = Core.Field {
...
updatingClauseDelete x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.UpdatingClause"),
  Core.injectionField = Core.Field {
...
updatingClauseSet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.UpdatingClause"),
  Core.injectionField = Core.Field {
...
updatingClauseRemove x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.UpdatingClause"),
  Core.injectionField = Core.Field {
...
readingClauseMatch x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ReadingClause"),
  Core.injectionField = Core.Field {
...
readingClauseUnwind x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ReadingClause"),
  Core.injectionField = Core.Field {
...
readingClauseInQueryCall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ReadingClause"),
  Core.injectionField = Core.Field {
...
match optional pattern where_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Match"),
  Core.recordFields = [
    Core.Field {
...
matchOptional x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Match"),
    Core.projectionField = (Core.Name "optional")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

matchPattern :: (Phantoms.TTerm OpenCypher.Match -> Phantoms.TTerm OpenCypher.Pattern)
matchPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Match"),
...
matchWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Match"),
...
matchWithOptional original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Match"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "optional"),
...
matchWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Match"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "optional"),
...
matchWithWhere original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Match"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "optional"),
...
unwind expression variable = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Unwind"),
  Core.recordFields = [
    Core.Field {
...
unwindExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Unwind"),
...
unwindVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Unwind"),
...
unwindWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Unwind"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
unwindWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Unwind"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
merge patternPart actions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Merge"),
  Core.recordFields = [
    Core.Field {
...
mergePatternPart x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Merge"),
...
mergeActions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Merge"),
...
mergeWithPatternPart original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Merge"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "patternPart"),
...
mergeWithActions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Merge"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "patternPart"),
...
matchOrCreateMatch = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MatchOrCreate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "match"),
    Core.fieldTerm = Core.TermUnit}})))

matchOrCreateCreate :: (Phantoms.TTerm OpenCypher.MatchOrCreate)
matchOrCreateCreate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MatchOrCreate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "create"),
    Core.fieldTerm = Core.TermUnit}})))
...
mergeAction action set = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MergeAction"),
  Core.recordFields = [
    Core.Field {
...
mergeActionAction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MergeAction"),
    Core.projectionField = (Core.Name "action")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

mergeActionSet :: (Phantoms.TTerm OpenCypher.MergeAction -> Phantoms.TTerm OpenCypher.Set)
mergeActionSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MergeAction"),
...
mergeActionWithAction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MergeAction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "action"),
...
mergeActionWithSet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MergeAction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "action"),
...
create x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Create"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unCreate :: (Phantoms.TTerm OpenCypher.Create -> Phantoms.TTerm OpenCypher.Pattern)
unCreate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Create")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

set :: (Phantoms.TTerm [OpenCypher.SetItem] -> Phantoms.TTerm OpenCypher.Set)
set x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Set"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Set")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

setItemProperty :: (Phantoms.TTerm OpenCypher.PropertyEquals -> Phantoms.TTerm OpenCypher.SetItem)
setItemProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SetItem"),
  Core.injectionField = Core.Field {
...
setItemVariableEqual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SetItem"),
  Core.injectionField = Core.Field {
...
setItemVariablePlusEqual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SetItem"),
  Core.injectionField = Core.Field {
...
setItemVariableLabels x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SetItem"),
  Core.injectionField = Core.Field {
...
propertyEquals lhs rhs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyEquals"),
  Core.recordFields = [
    Core.Field {
...
propertyEqualsLhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyEquals"),
...
propertyEqualsRhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyEquals"),
...
propertyEqualsWithLhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
propertyEqualsWithRhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
variableEquals lhs rhs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
      Core.fieldTerm = (Phantoms.unTTerm lhs)},
...
variableEqualsLhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableEquals"),
    Core.projectionField = (Core.Name "lhs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

variableEqualsRhs :: (Phantoms.TTerm OpenCypher.VariableEquals -> Phantoms.TTerm OpenCypher.Expression)
variableEqualsRhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableEquals"),
    Core.projectionField = (Core.Name "rhs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
variableEqualsWithLhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
variableEqualsWithRhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
variablePlusEquals lhs rhs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariablePlusEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
      Core.fieldTerm = (Phantoms.unTTerm lhs)},
...
variablePlusEqualsLhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariablePlusEquals"),
    Core.projectionField = (Core.Name "lhs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

variablePlusEqualsRhs :: (Phantoms.TTerm OpenCypher.VariablePlusEquals -> Phantoms.TTerm OpenCypher.Expression)
variablePlusEqualsRhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariablePlusEquals"),
    Core.projectionField = (Core.Name "rhs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
variablePlusEqualsWithLhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariablePlusEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
variablePlusEqualsWithRhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariablePlusEquals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
variableAndNodeLabels variable labels = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableAndNodeLabels"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
      Core.fieldTerm = (Phantoms.unTTerm variable)},
...
variableAndNodeLabelsVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableAndNodeLabels"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

variableAndNodeLabelsLabels :: (Phantoms.TTerm OpenCypher.VariableAndNodeLabels -> Phantoms.TTerm OpenCypher.NodeLabels)
variableAndNodeLabelsLabels x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableAndNodeLabels"),
...
variableAndNodeLabelsWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableAndNodeLabels"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
variableAndNodeLabelsWithLabels original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.VariableAndNodeLabels"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
delete detach expressions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Delete"),
  Core.recordFields = [
    Core.Field {
...
deleteDetach x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Delete"),
...
deleteExpressions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Delete"),
...
deleteWithDetach original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Delete"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "detach"),
...
deleteWithExpressions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Delete"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "detach"),
...
remove x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Remove"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unRemove :: (Phantoms.TTerm OpenCypher.Remove -> Phantoms.TTerm [OpenCypher.RemoveItem])
unRemove x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Remove")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

removeItemVariableLabels :: (Phantoms.TTerm OpenCypher.VariableAndNodeLabels -> Phantoms.TTerm OpenCypher.RemoveItem)
removeItemVariableLabels x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RemoveItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variableLabels"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

removeItemProperty :: (Phantoms.TTerm OpenCypher.PropertyExpression -> Phantoms.TTerm OpenCypher.RemoveItem)
removeItemProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RemoveItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "property"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inQueryCall call yieldItems = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.InQueryCall"),
  Core.recordFields = [
    Core.Field {
...
inQueryCallCall x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.InQueryCall"),
...
inQueryCallYieldItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.InQueryCall"),
...
inQueryCallWithCall original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.InQueryCall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "call"),
...
inQueryCallWithYieldItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.InQueryCall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "call"),
...
procedureInvocationExplicit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProcedureInvocation"),
  Core.injectionField = Core.Field {
...
procedureInvocationImplicit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProcedureInvocation"),
  Core.injectionField = Core.Field {
...
starOrYieldItemsStar = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StarOrYieldItems"),
  Core.injectionField = Core.Field {
...
starOrYieldItemsItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StarOrYieldItems"),
  Core.injectionField = Core.Field {
...
standaloneCall call yieldItems = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StandaloneCall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "call"),
      Core.fieldTerm = (Phantoms.unTTerm call)},
...
standaloneCallCall x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StandaloneCall"),
    Core.projectionField = (Core.Name "call")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

standaloneCallYieldItems :: (Phantoms.TTerm OpenCypher.StandaloneCall -> Phantoms.TTerm (Maybe OpenCypher.StarOrYieldItems))
standaloneCallYieldItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StandaloneCall"),
    Core.projectionField = (Core.Name "yieldItems")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
standaloneCallWithCall original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StandaloneCall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "call"),
...
standaloneCallWithYieldItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StandaloneCall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "call"),
...
yieldItems items where_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItems"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "items"),
...
yieldItemsItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItems"),
...
yieldItemsWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItems"),
    Core.projectionField = (Core.Name "where")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
yieldItemsWithItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItems"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "items"),
...
yieldItemsWithWhere original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItems"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "items"),
...
yieldItem field variable = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItem"),
  Core.recordFields = [
    Core.Field {
...
yieldItemField x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItem"),
...
yieldItemVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItem"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
yieldItemWithField original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "field"),
...
yieldItemWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.YieldItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "field"),
...
with projection where_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.With"),
  Core.recordFields = [
    Core.Field {
...
withProjection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.With"),
    Core.projectionField = (Core.Name "projection")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

withWhere :: (Phantoms.TTerm OpenCypher.With -> Phantoms.TTerm (Maybe OpenCypher.Where))
withWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.With"),
    Core.projectionField = (Core.Name "where")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
withWithProjection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.With"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projection"),
...
withWithWhere original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.With"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projection"),
...
return x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Return"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unReturn :: (Phantoms.TTerm OpenCypher.Return -> Phantoms.TTerm OpenCypher.ProjectionBody)
unReturn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Return")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
projectionBody distinct projectionItems order skip limit = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
  Core.recordFields = [
    Core.Field {
...
projectionBodyDistinct x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
...
projectionBodyProjectionItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
...
projectionBodyOrder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
...
projectionBodySkip x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
...
projectionBodyLimit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
...
projectionBodyWithDistinct original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "distinct"),
...
projectionBodyWithProjectionItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "distinct"),
...
projectionBodyWithOrder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "distinct"),
...
projectionBodyWithSkip original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "distinct"),
...
projectionBodyWithLimit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "distinct"),
...
projectionItems star explicit = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItems"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "star"),
...
projectionItemsStar x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItems"),
...
projectionItemsExplicit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItems"),
...
projectionItemsWithStar original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItems"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "star"),
...
projectionItemsWithExplicit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItems"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "star"),
...
projectionItem expression variable = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
      Core.fieldTerm = (Phantoms.unTTerm expression)},
...
projectionItemExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItem"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

projectionItemVariable :: (Phantoms.TTerm OpenCypher.ProjectionItem -> Phantoms.TTerm (Maybe OpenCypher.Variable))
projectionItemVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItem"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
projectionItemWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
projectionItemWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProjectionItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
order x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Order"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unOrder :: (Phantoms.TTerm OpenCypher.Order -> Phantoms.TTerm [OpenCypher.SortItem])
unOrder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Order")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

skip :: (Phantoms.TTerm OpenCypher.Expression -> Phantoms.TTerm OpenCypher.Skip)
skip x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Skip"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSkip :: (Phantoms.TTerm OpenCypher.Skip -> Phantoms.TTerm OpenCypher.Expression)
unSkip x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Skip")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

limit :: (Phantoms.TTerm OpenCypher.Expression -> Phantoms.TTerm OpenCypher.Limit)
limit x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Limit"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unLimit :: (Phantoms.TTerm OpenCypher.Limit -> Phantoms.TTerm OpenCypher.Expression)
unLimit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Limit")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

sortOrderAscending :: (Phantoms.TTerm OpenCypher.SortOrder)
sortOrderAscending = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SortOrder"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "ascending"),
    Core.fieldTerm = Core.TermUnit}})))

sortOrderDescending :: (Phantoms.TTerm OpenCypher.SortOrder)
sortOrderDescending = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SortOrder"),
  Core.injectionField = Core.Field {
...
sortItem expression order = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.SortItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
      Core.fieldTerm = (Phantoms.unTTerm expression)},
...
sortItemExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SortItem"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

sortItemOrder :: (Phantoms.TTerm OpenCypher.SortItem -> Phantoms.TTerm (Maybe OpenCypher.SortOrder))
sortItemOrder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.SortItem"),
    Core.projectionField = (Core.Name "order")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
sortItemWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.SortItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
sortItemWithOrder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.SortItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
where_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Where"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unWhere :: (Phantoms.TTerm OpenCypher.Where -> Phantoms.TTerm OpenCypher.Expression)
unWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Where")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pattern :: (Phantoms.TTerm [OpenCypher.PatternPart] -> Phantoms.TTerm OpenCypher.Pattern)
pattern x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Pattern"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unPattern :: (Phantoms.TTerm OpenCypher.Pattern -> Phantoms.TTerm [OpenCypher.PatternPart])
unPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Pattern")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
patternPart variable pattern = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternPart"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
      Core.fieldTerm = (Phantoms.unTTerm variable)},
...
patternPartVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternPart"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

patternPartPattern :: (Phantoms.TTerm OpenCypher.PatternPart -> Phantoms.TTerm OpenCypher.AnonymousPatternPart)
patternPartPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternPart"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
patternPartWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternPart"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
patternPartWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternPart"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
anonymousPatternPart x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.AnonymousPatternPart"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unAnonymousPatternPart :: (Phantoms.TTerm OpenCypher.AnonymousPatternPart -> Phantoms.TTerm OpenCypher.PatternElement)
unAnonymousPatternPart x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.AnonymousPatternPart")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nodePatternChain nodePattern chain = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePatternChain"),
  Core.recordFields = [
    Core.Field {
...
nodePatternChainNodePattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePatternChain"),
...
nodePatternChainChain x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePatternChain"),
...
nodePatternChainWithNodePattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePatternChain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nodePattern"),
...
nodePatternChainWithChain original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePatternChain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nodePattern"),
...
patternElementChained x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternElement"),
  Core.injectionField = Core.Field {
...
patternElementParenthesized x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternElement"),
  Core.injectionField = Core.Field {
...
relationshipsPattern nodePattern chain = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipsPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nodePattern"),
      Core.fieldTerm = (Phantoms.unTTerm nodePattern)},
...
relationshipsPatternNodePattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipsPattern"),
    Core.projectionField = (Core.Name "nodePattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

relationshipsPatternChain :: (Phantoms.TTerm OpenCypher.RelationshipsPattern -> Phantoms.TTerm [OpenCypher.PatternElementChain])
relationshipsPatternChain x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipsPattern"),
    Core.projectionField = (Core.Name "chain")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
relationshipsPatternWithNodePattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipsPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nodePattern"),
...
relationshipsPatternWithChain original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipsPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nodePattern"),
...
nodePattern variable labels properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
      Core.fieldTerm = (Phantoms.unTTerm variable)},
...
nodePatternVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePattern"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

nodePatternLabels :: (Phantoms.TTerm OpenCypher.NodePattern -> Phantoms.TTerm (Maybe OpenCypher.NodeLabels))
nodePatternLabels x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePattern"),
    Core.projectionField = (Core.Name "labels")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nodePatternProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePattern"),
...
nodePatternWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
nodePatternWithLabels original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
nodePatternWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
patternElementChain relationship node = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternElementChain"),
  Core.recordFields = [
    Core.Field {
...
patternElementChainRelationship x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternElementChain"),
...
patternElementChainNode x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternElementChain"),
...
patternElementChainWithRelationship original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternElementChain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "relationship"),
...
patternElementChainWithNode original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternElementChain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "relationship"),
...
relationshipPattern leftArrow detail rightArrow = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipPattern"),
  Core.recordFields = [
    Core.Field {
...
relationshipPatternLeftArrow x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipPattern"),
...
relationshipPatternDetail x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipPattern"),
...
relationshipPatternRightArrow x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipPattern"),
...
relationshipPatternWithLeftArrow original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "leftArrow"),
...
relationshipPatternWithDetail original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "leftArrow"),
...
relationshipPatternWithRightArrow original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "leftArrow"),
...
relationshipDetail variable types range properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
      Core.fieldTerm = (Phantoms.unTTerm variable)},
...
relationshipDetailVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

relationshipDetailTypes :: (Phantoms.TTerm OpenCypher.RelationshipDetail -> Phantoms.TTerm (Maybe OpenCypher.RelationshipTypes))
relationshipDetailTypes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
...
relationshipDetailRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
...
relationshipDetailProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
    Core.projectionField = (Core.Name "properties")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
relationshipDetailWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
relationshipDetailWithTypes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
relationshipDetailWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
relationshipDetailWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipDetail"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
propertiesMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Properties"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "map"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

propertiesParameter :: (Phantoms.TTerm OpenCypher.Parameter -> Phantoms.TTerm OpenCypher.Properties)
propertiesParameter x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Properties"),
  Core.injectionField = Core.Field {
...
relationshipTypes x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelationshipTypes"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unRelationshipTypes :: (Phantoms.TTerm OpenCypher.RelationshipTypes -> Phantoms.TTerm [OpenCypher.RelTypeName])
unRelationshipTypes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.RelationshipTypes")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

nodeLabels :: (Phantoms.TTerm [OpenCypher.NodeLabel] -> Phantoms.TTerm OpenCypher.NodeLabels)
nodeLabels x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodeLabels"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unNodeLabels :: (Phantoms.TTerm OpenCypher.NodeLabels -> Phantoms.TTerm [OpenCypher.NodeLabel])
unNodeLabels x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.NodeLabels")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

nodeLabel :: (Phantoms.TTerm String -> Phantoms.TTerm OpenCypher.NodeLabel)
nodeLabel x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.NodeLabel"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unNodeLabel :: (Phantoms.TTerm OpenCypher.NodeLabel -> Phantoms.TTerm String)
unNodeLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.NodeLabel")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangeLiteral :: (Phantoms.TTerm (Maybe Integer) -> Phantoms.TTerm (Maybe Integer) -> Phantoms.TTerm OpenCypher.RangeLiteral)
rangeLiteral start end = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeLiteral"),
  Core.recordFields = [
    Core.Field {
...
rangeLiteralStart x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeLiteral"),
    Core.projectionField = (Core.Name "start")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangeLiteralEnd :: (Phantoms.TTerm OpenCypher.RangeLiteral -> Phantoms.TTerm (Maybe Integer))
rangeLiteralEnd x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeLiteral"),
...
rangeLiteralWithStart original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "start"),
...
rangeLiteralWithEnd original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "start"),
...
relTypeName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.RelTypeName"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unRelTypeName :: (Phantoms.TTerm OpenCypher.RelTypeName -> Phantoms.TTerm String)
unRelTypeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.RelTypeName")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyExpression atom lookups = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyExpression"),
  Core.recordFields = [
    Core.Field {
...
propertyExpressionAtom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyExpression"),
...
propertyExpressionLookups x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyExpression"),
...
propertyExpressionWithAtom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "atom"),
...
propertyExpressionWithLookups original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "atom"),
...
expression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Expression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unExpression :: (Phantoms.TTerm OpenCypher.Expression -> Phantoms.TTerm OpenCypher.OrExpression)
unExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Expression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

orExpression :: (Phantoms.TTerm [OpenCypher.XorExpression] -> Phantoms.TTerm OpenCypher.OrExpression)
orExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.OrExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unOrExpression :: (Phantoms.TTerm OpenCypher.OrExpression -> Phantoms.TTerm [OpenCypher.XorExpression])
unOrExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.OrExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

xorExpression :: (Phantoms.TTerm [OpenCypher.AndExpression] -> Phantoms.TTerm OpenCypher.XorExpression)
xorExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.XorExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unXorExpression :: (Phantoms.TTerm OpenCypher.XorExpression -> Phantoms.TTerm [OpenCypher.AndExpression])
unXorExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.XorExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
andExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.AndExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unAndExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.AndExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

notExpression :: (Phantoms.TTerm Bool -> Phantoms.TTerm OpenCypher.ComparisonExpression -> Phantoms.TTerm OpenCypher.NotExpression)
notExpression not expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NotExpression"),
  Core.recordFields = [
    Core.Field {
...
notExpressionNot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NotExpression"),
...
notExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NotExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
notExpressionWithNot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NotExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "not"),
...
notExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NotExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "not"),
...
comparisonExpression left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonExpression"),
  Core.recordFields = [
    Core.Field {
...
comparisonExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonExpression"),
...
comparisonExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonExpression"),
...
comparisonExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
comparisonExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
comparisonOperatorEq = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "eq"),
    Core.fieldTerm = Core.TermUnit}})))

comparisonOperatorNeq :: (Phantoms.TTerm OpenCypher.ComparisonOperator)
comparisonOperatorNeq = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorLt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorGt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorLte = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorGte = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
partialComparisonExpression operator right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PartialComparisonExpression"),
  Core.recordFields = [
    Core.Field {
...
partialComparisonExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PartialComparisonExpression"),
...
partialComparisonExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PartialComparisonExpression"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
partialComparisonExpressionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PartialComparisonExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
partialComparisonExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PartialComparisonExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
stringListNullPredicateExpression left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
stringListNullPredicateExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateExpression"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringListNullPredicateExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateExpression"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringListNullPredicateExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
stringListNullPredicateExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
stringListNullPredicateRightHandSideString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateRightHandSide"),
  Core.injectionField = Core.Field {
...
stringListNullPredicateRightHandSideList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateRightHandSide"),
  Core.injectionField = Core.Field {
...
stringListNullPredicateRightHandSideNull x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringListNullPredicateRightHandSide"),
  Core.injectionField = Core.Field {
...
stringPredicateExpression operator expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
      Core.fieldTerm = (Phantoms.unTTerm operator)},
...
stringPredicateExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateExpression"),
    Core.projectionField = (Core.Name "operator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringPredicateExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringPredicateExpressionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
stringPredicateExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
stringPredicateOperatorStartsWith = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "startsWith"),
    Core.fieldTerm = Core.TermUnit}})))

stringPredicateOperatorEndsWith :: (Phantoms.TTerm OpenCypher.StringPredicateOperator)
stringPredicateOperatorEndsWith = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateOperator"),
  Core.injectionField = Core.Field {
...
stringPredicateOperatorContains = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringPredicateOperator"),
  Core.injectionField = Core.Field {
...
listPredicateExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListPredicateExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unListPredicateExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.ListPredicateExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

nullPredicateExpression :: (Phantoms.TTerm Bool -> Phantoms.TTerm OpenCypher.NullPredicateExpression)
nullPredicateExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.NullPredicateExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unNullPredicateExpression :: (Phantoms.TTerm OpenCypher.NullPredicateExpression -> Phantoms.TTerm Bool)
unNullPredicateExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.NullPredicateExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
addOrSubtractExpression left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
addOrSubtractExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractExpression"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
addOrSubtractExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractExpression"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
addOrSubtractExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
addOrSubtractExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
addOrSubtractRightHandSide operator expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractRightHandSide"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
      Core.fieldTerm = (Phantoms.unTTerm operator)},
...
addOrSubtractRightHandSideOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractRightHandSide"),
    Core.projectionField = (Core.Name "operator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
addOrSubtractRightHandSideExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractRightHandSide"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
addOrSubtractRightHandSideWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractRightHandSide"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
addOrSubtractRightHandSideWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractRightHandSide"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
addOrSubtractOperatorAdd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "add"),
    Core.fieldTerm = Core.TermUnit}})))

addOrSubtractOperatorSubtract :: (Phantoms.TTerm OpenCypher.AddOrSubtractOperator)
addOrSubtractOperatorSubtract = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.AddOrSubtractOperator"),
  Core.injectionField = Core.Field {
...
multiplyDivideModuloExpression left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
multiplyDivideModuloExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloExpression"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiplyDivideModuloExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloExpression"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiplyDivideModuloExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
multiplyDivideModuloExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
multiplyDivideModuloRightHandSide operator expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloRightHandSide"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
      Core.fieldTerm = (Phantoms.unTTerm operator)},
...
multiplyDivideModuloRightHandSideOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloRightHandSide"),
    Core.projectionField = (Core.Name "operator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiplyDivideModuloRightHandSideExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloRightHandSide"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiplyDivideModuloRightHandSideWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloRightHandSide"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
multiplyDivideModuloRightHandSideWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloRightHandSide"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
multiplyDivideModuloOperatorMultiply = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloOperator"),
  Core.injectionField = Core.Field {
...
multiplyDivideModuloOperatorDivide = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloOperator"),
  Core.injectionField = Core.Field {
...
multiplyDivideModuloOperatorModulo = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.MultiplyDivideModuloOperator"),
  Core.injectionField = Core.Field {
...
powerOfExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.PowerOfExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unPowerOfExpression :: (Phantoms.TTerm OpenCypher.PowerOfExpression -> Phantoms.TTerm [OpenCypher.UnaryAddOrSubtractExpression])
unPowerOfExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.PowerOfExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unaryAddOrSubtractExpression operator expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.UnaryAddOrSubtractExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
      Core.fieldTerm = (Phantoms.unTTerm operator)},
...
unaryAddOrSubtractExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.UnaryAddOrSubtractExpression"),
    Core.projectionField = (Core.Name "operator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unaryAddOrSubtractExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.UnaryAddOrSubtractExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unaryAddOrSubtractExpressionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.UnaryAddOrSubtractExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
unaryAddOrSubtractExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.UnaryAddOrSubtractExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
listOperatorExpressionOrPropertyLookupList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListOperatorExpressionOrPropertyLookup"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "list"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
listOperatorExpressionOrPropertyLookupProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListOperatorExpressionOrPropertyLookup"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "property"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
nonArithmeticOperatorExpression atom listsAndLookups labels = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "atom"),
      Core.fieldTerm = (Phantoms.unTTerm atom)},
...
nonArithmeticOperatorExpressionAtom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression"),
    Core.projectionField = (Core.Name "atom")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nonArithmeticOperatorExpressionListsAndLookups x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression"),
...
nonArithmeticOperatorExpressionLabels x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression"),
    Core.projectionField = (Core.Name "labels")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nonArithmeticOperatorExpressionWithAtom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "atom"),
...
nonArithmeticOperatorExpressionWithListsAndLookups original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "atom"),
...
nonArithmeticOperatorExpressionWithLabels original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.NonArithmeticOperatorExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "atom"),
...
rangeExpression start end = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "start"),
      Core.fieldTerm = (Phantoms.unTTerm start)},
...
rangeExpressionStart x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeExpression"),
    Core.projectionField = (Core.Name "start")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangeExpressionEnd :: (Phantoms.TTerm OpenCypher.RangeExpression -> Phantoms.TTerm (Maybe OpenCypher.Expression))
rangeExpressionEnd x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeExpression"),
    Core.projectionField = (Core.Name "end")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rangeExpressionWithStart original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "start"),
...
rangeExpressionWithEnd original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.RangeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "start"),
...
listOperatorExpressionSingle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListOperatorExpression"),
  Core.injectionField = Core.Field {
...
listOperatorExpressionRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListOperatorExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "range"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
propertyLookup x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyLookup"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unPropertyLookup :: (Phantoms.TTerm OpenCypher.PropertyLookup -> Phantoms.TTerm OpenCypher.PropertyKeyName)
unPropertyLookup x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.PropertyLookup")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

atomLiteral :: (Phantoms.TTerm OpenCypher.Literal -> Phantoms.TTerm OpenCypher.Atom)
atomLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

atomParameter :: (Phantoms.TTerm OpenCypher.Parameter -> Phantoms.TTerm OpenCypher.Atom)
atomParameter x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "parameter"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
atomCase x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomCountStar = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomListComprehension x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomPatternComprehension x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomQuantifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomPatternPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomParenthesized x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "parenthesized"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
atomFunctionInvocation x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomExistentialSubquery x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
...
atomVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Atom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
caseExpression expression alternatives else_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
      Core.fieldTerm = (Phantoms.unTTerm expression)},
...
caseExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

caseExpressionAlternatives :: (Phantoms.TTerm OpenCypher.CaseExpression -> Phantoms.TTerm [OpenCypher.CaseAlternative])
caseExpressionAlternatives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseExpression"),
...
caseExpressionElse x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseExpression"),
...
caseExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
caseExpressionWithAlternatives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
caseExpressionWithElse original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
caseAlternative condition result = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseAlternative"),
  Core.recordFields = [
    Core.Field {
...
caseAlternativeCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseAlternative"),
...
caseAlternativeResult x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseAlternative"),
...
caseAlternativeWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseAlternative"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
caseAlternativeWithResult original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.CaseAlternative"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
listComprehension left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
listComprehensionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListComprehension"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

listComprehensionRight :: (Phantoms.TTerm OpenCypher.ListComprehension -> Phantoms.TTerm (Maybe OpenCypher.Expression))
listComprehensionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListComprehension"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
listComprehensionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
listComprehensionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
patternComprehension variable pattern where_ right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
      Core.fieldTerm = (Phantoms.unTTerm variable)},
...
patternComprehensionVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
patternComprehensionPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
patternComprehensionWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
    Core.projectionField = (Core.Name "where")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
patternComprehensionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
patternComprehensionWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
patternComprehensionWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
patternComprehensionWithWhere original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
patternComprehensionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternComprehension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
quantifier operator expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Quantifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
      Core.fieldTerm = (Phantoms.unTTerm operator)},
...
quantifierOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Quantifier"),
    Core.projectionField = (Core.Name "operator")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

quantifierExpression :: (Phantoms.TTerm OpenCypher.Quantifier -> Phantoms.TTerm OpenCypher.FilterExpression)
quantifierExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Quantifier"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
quantifierWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Quantifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
quantifierWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.Quantifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
quantifierOperatorAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.QuantifierOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "all"),
    Core.fieldTerm = Core.TermUnit}})))

quantifierOperatorAny :: (Phantoms.TTerm OpenCypher.QuantifierOperator)
quantifierOperatorAny = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.QuantifierOperator"),
  Core.injectionField = Core.Field {
...
quantifierOperatorNone = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.QuantifierOperator"),
  Core.injectionField = Core.Field {
...
quantifierOperatorSingle = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.QuantifierOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "single"),
    Core.fieldTerm = Core.TermUnit}})))
...
filterExpression idInColl where_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.FilterExpression"),
  Core.recordFields = [
    Core.Field {
...
filterExpressionIdInColl x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.FilterExpression"),
...
filterExpressionWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.FilterExpression"),
    Core.projectionField = (Core.Name "where")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
filterExpressionWithIdInColl original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.FilterExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "idInColl"),
...
filterExpressionWithWhere original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.FilterExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "idInColl"),
...
patternPredicate x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternPredicate"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unPatternPredicate :: (Phantoms.TTerm OpenCypher.PatternPredicate -> Phantoms.TTerm OpenCypher.RelationshipsPattern)
unPatternPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.PatternPredicate")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

parenthesizedExpression :: (Phantoms.TTerm OpenCypher.Expression -> Phantoms.TTerm OpenCypher.ParenthesizedExpression)
parenthesizedExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.ParenthesizedExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unParenthesizedExpression :: (Phantoms.TTerm OpenCypher.ParenthesizedExpression -> Phantoms.TTerm OpenCypher.Expression)
unParenthesizedExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.ParenthesizedExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

idInColl :: (Phantoms.TTerm OpenCypher.Variable -> Phantoms.TTerm OpenCypher.Expression -> Phantoms.TTerm OpenCypher.IdInColl)
idInColl variable expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.IdInColl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
      Core.fieldTerm = (Phantoms.unTTerm variable)},
...
idInCollVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.IdInColl"),
    Core.projectionField = (Core.Name "variable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

idInCollExpression :: (Phantoms.TTerm OpenCypher.IdInColl -> Phantoms.TTerm OpenCypher.Expression)
idInCollExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.IdInColl"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
idInCollWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.IdInColl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
idInCollWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.IdInColl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
functionInvocation name distinct arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.FunctionInvocation"),
  Core.recordFields = [
    Core.Field {
...
functionInvocationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.FunctionInvocation"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

functionInvocationDistinct :: (Phantoms.TTerm OpenCypher.FunctionInvocation -> Phantoms.TTerm Bool)
functionInvocationDistinct x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.FunctionInvocation"),
    Core.projectionField = (Core.Name "distinct")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionInvocationArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.FunctionInvocation"),
...
functionInvocationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.FunctionInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
functionInvocationWithDistinct original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.FunctionInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
functionInvocationWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.FunctionInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
qualifiedName namespace local = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.QualifiedName"),
  Core.recordFields = [
    Core.Field {
...
qualifiedNameNamespace x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.QualifiedName"),
    Core.projectionField = (Core.Name "namespace")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

qualifiedNameLocal :: (Phantoms.TTerm OpenCypher.QualifiedName -> Phantoms.TTerm String)
qualifiedNameLocal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.QualifiedName"),
...
qualifiedNameWithLocal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.QualifiedName"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "namespace"),
...
patternWhere pattern where_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternWhere"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
      Core.fieldTerm = (Phantoms.unTTerm pattern)},
...
patternWherePattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternWhere"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

patternWhereWhere :: (Phantoms.TTerm OpenCypher.PatternWhere -> Phantoms.TTerm (Maybe OpenCypher.Where))
patternWhereWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternWhere"),
    Core.projectionField = (Core.Name "where")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
patternWhereWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternWhere"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
patternWhereWithWhere original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.PatternWhere"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
existentialSubqueryRegular x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ExistentialSubquery"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regular"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

existentialSubqueryPattern :: (Phantoms.TTerm OpenCypher.PatternWhere -> Phantoms.TTerm OpenCypher.ExistentialSubquery)
existentialSubqueryPattern x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ExistentialSubquery"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "pattern"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
explicitProcedureInvocation name arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ExplicitProcedureInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
explicitProcedureInvocationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ExplicitProcedureInvocation"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
explicitProcedureInvocationArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.ExplicitProcedureInvocation"),
    Core.projectionField = (Core.Name "arguments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
explicitProcedureInvocationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ExplicitProcedureInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
explicitProcedureInvocationWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.ExplicitProcedureInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implicitProcedureInvocation x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.ImplicitProcedureInvocation"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unImplicitProcedureInvocation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.ImplicitProcedureInvocation")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

procedureResultField :: (Phantoms.TTerm String -> Phantoms.TTerm OpenCypher.ProcedureResultField)
procedureResultField x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.ProcedureResultField"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unProcedureResultField :: (Phantoms.TTerm OpenCypher.ProcedureResultField -> Phantoms.TTerm String)
unProcedureResultField x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.ProcedureResultField")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
variable x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.Variable"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.Variable")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
literalBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Literal"),
  Core.injectionField = Core.Field {
...
literalNumber x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Literal"),
  Core.injectionField = Core.Field {
...
literalList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Literal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "list"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
literalMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Literal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "map"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
numberLiteralDouble x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NumberLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "double"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

numberLiteralInteger :: (Phantoms.TTerm Integer -> Phantoms.TTerm OpenCypher.NumberLiteral)
numberLiteralInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.NumberLiteral"),
  Core.injectionField = Core.Field {
...
stringLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.StringLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unStringLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.StringLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

listLiteral :: (Phantoms.TTerm [OpenCypher.Expression] -> Phantoms.TTerm OpenCypher.ListLiteral)
listLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.ListLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unListLiteral :: (Phantoms.TTerm OpenCypher.ListLiteral -> Phantoms.TTerm [OpenCypher.Expression])
unListLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.ListLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

mapLiteral :: (Phantoms.TTerm [OpenCypher.KeyValuePair] -> Phantoms.TTerm OpenCypher.MapLiteral)
mapLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.MapLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unMapLiteral :: (Phantoms.TTerm OpenCypher.MapLiteral -> Phantoms.TTerm [OpenCypher.KeyValuePair])
unMapLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.MapLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
keyValuePair key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.KeyValuePair"),
  Core.recordFields = [
    Core.Field {
...
keyValuePairKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.KeyValuePair"),
...
keyValuePairValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.KeyValuePair"),
...
keyValuePairWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.KeyValuePair"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
keyValuePairWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cypher.openCypher.KeyValuePair"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
propertyKeyName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cypher.openCypher.PropertyKeyName"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unPropertyKeyName :: (Phantoms.TTerm OpenCypher.PropertyKeyName -> Phantoms.TTerm String)
unPropertyKeyName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cypher.openCypher.PropertyKeyName")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

parameterSymbolic :: (Phantoms.TTerm String -> Phantoms.TTerm OpenCypher.Parameter)
parameterSymbolic x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Parameter"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "symbolic"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

parameterInteger :: (Phantoms.TTerm Integer -> Phantoms.TTerm OpenCypher.Parameter)
parameterInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cypher.openCypher.Parameter"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "integer"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
