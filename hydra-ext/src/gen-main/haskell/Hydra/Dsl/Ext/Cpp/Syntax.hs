...
-- | DSL functions for hydra.ext.cpp.syntax

module Hydra.Dsl.Ext.Cpp.Syntax where
...
accessSpecifierPublic = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AccessSpecifier"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "public"),
    Core.fieldTerm = Core.TermUnit}})))

accessSpecifierProtected :: (Phantoms.TTerm Syntax.AccessSpecifier)
accessSpecifierProtected = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AccessSpecifier"),
  Core.injectionField = Core.Field {
...
accessSpecifierPrivate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AccessSpecifier"),
  Core.injectionField = Core.Field {
...
accessSpecifierNone = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AccessSpecifier"),
  Core.injectionField = Core.Field {
...
program preprocessorDirectives includes declarations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Program"),
  Core.recordFields = [
    Core.Field {
...
programPreprocessorDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Program"),
...
programIncludes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Program"),
...
programDeclarations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Program"),
...
programWithPreprocessorDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Program"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "preprocessorDirectives"),
...
programWithIncludes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Program"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "preprocessorDirectives"),
...
programWithDeclarations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Program"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "preprocessorDirectives"),
...
includeDirective name isSystem = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IncludeDirective"),
  Core.recordFields = [
    Core.Field {
...
includeDirectiveName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IncludeDirective"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

includeDirectiveIsSystem :: (Phantoms.TTerm Syntax.IncludeDirective -> Phantoms.TTerm Bool)
includeDirectiveIsSystem x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IncludeDirective"),
...
includeDirectiveWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IncludeDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
includeDirectiveWithIsSystem original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IncludeDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
declarationPreprocessor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Declaration"),
  Core.injectionField = Core.Field {
...
declarationClass x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Declaration"),
  Core.injectionField = Core.Field {
...
declarationFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Declaration"),
  Core.injectionField = Core.Field {
...
declarationVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Declaration"),
  Core.injectionField = Core.Field {
...
declarationTypedef x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Declaration"),
  Core.injectionField = Core.Field {
...
declarationNamespace x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Declaration"),
  Core.injectionField = Core.Field {
...
declarationTemplate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Declaration"),
  Core.injectionField = Core.Field {
...
namespaceDeclaration name declarations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.NamespaceDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
namespaceDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.NamespaceDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

namespaceDeclarationDeclarations :: (Phantoms.TTerm Syntax.NamespaceDeclaration -> Phantoms.TTerm [Syntax.Declaration])
namespaceDeclarationDeclarations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.NamespaceDeclaration"),
    Core.projectionField = (Core.Name "declarations")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
namespaceDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.NamespaceDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
namespaceDeclarationWithDeclarations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.NamespaceDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typedefDeclaration name type_ isUsing = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TypedefDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
typedefDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypedefDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typedefDeclarationType :: (Phantoms.TTerm Syntax.TypedefDeclaration -> Phantoms.TTerm Syntax.TypeExpression)
typedefDeclarationType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypedefDeclaration"),
...
typedefDeclarationIsUsing x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypedefDeclaration"),
...
typedefDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TypedefDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typedefDeclarationWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TypedefDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typedefDeclarationWithIsUsing original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TypedefDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
classDeclaration specifier body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassDeclaration"),
  Core.recordFields = [
    Core.Field {
...
classDeclarationSpecifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassDeclaration"),
...
classDeclarationBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassDeclaration"),
...
classDeclarationWithSpecifier original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "specifier"),
...
classDeclarationWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "specifier"),
...
templateDeclaration inline parameters declaration = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateDeclaration"),
  Core.recordFields = [
    Core.Field {
...
templateDeclarationInline x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateDeclaration"),
...
templateDeclarationParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateDeclaration"),
...
templateDeclarationDeclaration x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateDeclaration"),
...
templateDeclarationWithInline original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inline"),
...
templateDeclarationWithParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inline"),
...
templateDeclarationWithDeclaration original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inline"),
...
preprocessorDirectiveInclude x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectivePragma x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveDefine x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveUndef x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveIfdef x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveIfndef x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveIf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveElif x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveElse x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveEndif x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveLine x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveError x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
preprocessorDirectiveWarning x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PreprocessorDirective"),
  Core.injectionField = Core.Field {
...
pragmaDirective content = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PragmaDirective"),
  Core.recordFields = [
    Core.Field {
...
pragmaDirectiveContent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PragmaDirective"),
...
pragmaDirectiveWithContent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PragmaDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "content"),
...
defineDirective name parameters replacement = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DefineDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
defineDirectiveName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DefineDirective"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

defineDirectiveParameters :: (Phantoms.TTerm Syntax.DefineDirective -> Phantoms.TTerm (Maybe [String]))
defineDirectiveParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DefineDirective"),
    Core.projectionField = (Core.Name "parameters")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
defineDirectiveReplacement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DefineDirective"),
...
defineDirectiveWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DefineDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
defineDirectiveWithParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DefineDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
defineDirectiveWithReplacement original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DefineDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
undefDirective name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.UndefDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)}]})))
...
undefDirectiveName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UndefDirective"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

undefDirectiveWithName :: (Phantoms.TTerm Syntax.UndefDirective -> Phantoms.TTerm String -> Phantoms.TTerm Syntax.UndefDirective)
undefDirectiveWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.UndefDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
ifdefDirective identifier = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IfdefDirective"),
  Core.recordFields = [
    Core.Field {
...
ifdefDirectiveIdentifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IfdefDirective"),
...
ifdefDirectiveWithIdentifier original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IfdefDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "identifier"),
...
ifndefDirective identifier = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IfndefDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "identifier"),
      Core.fieldTerm = (Phantoms.unTTerm identifier)}]})))
...
ifndefDirectiveIdentifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IfndefDirective"),
    Core.projectionField = (Core.Name "identifier")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
ifndefDirectiveWithIdentifier original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IfndefDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "identifier"),
...
ifDirective condition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IfDirective"),
  Core.recordFields = [
    Core.Field {
...
ifDirectiveCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IfDirective"),
...
ifDirectiveWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.IfDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
elifDirective condition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ElifDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
      Core.fieldTerm = (Phantoms.unTTerm condition)}]})))
...
elifDirectiveCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ElifDirective"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

elifDirectiveWithCondition :: (Phantoms.TTerm Syntax.ElifDirective -> Phantoms.TTerm String -> Phantoms.TTerm Syntax.ElifDirective)
elifDirectiveWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ElifDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
lineDirective lineNumber filename = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LineDirective"),
  Core.recordFields = [
    Core.Field {
...
lineDirectiveLineNumber x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LineDirective"),
...
lineDirectiveFilename x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LineDirective"),
...
lineDirectiveWithLineNumber original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LineDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lineNumber"),
...
lineDirectiveWithFilename original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LineDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lineNumber"),
...
errorDirective message = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ErrorDirective"),
  Core.recordFields = [
    Core.Field {
...
errorDirectiveMessage x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ErrorDirective"),
...
errorDirectiveWithMessage original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ErrorDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "message"),
...
warningDirective message = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.WarningDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "message"),
      Core.fieldTerm = (Phantoms.unTTerm message)}]})))
...
warningDirectiveMessage x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.WarningDirective"),
    Core.projectionField = (Core.Name "message")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
warningDirectiveWithMessage original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.WarningDirective"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "message"),
...
classSpecifier key name inheritance = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassSpecifier"),
  Core.recordFields = [
    Core.Field {
...
classSpecifierKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassSpecifier"),
    Core.projectionField = (Core.Name "key")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

classSpecifierName :: (Phantoms.TTerm Syntax.ClassSpecifier -> Phantoms.TTerm String)
classSpecifierName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassSpecifier"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
classSpecifierInheritance x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassSpecifier"),
...
classSpecifierWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
classSpecifierWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
classSpecifierWithInheritance original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
classKeyClass = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "class"),
    Core.fieldTerm = Core.TermUnit}})))

classKeyEnum :: (Phantoms.TTerm Syntax.ClassKey)
classKeyEnum = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassKey"),
  Core.injectionField = Core.Field {
...
classKeyEnumClass = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassKey"),
  Core.injectionField = Core.Field {
...
classKeyStruct = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassKey"),
  Core.injectionField = Core.Field {
...
baseSpecifier access name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BaseSpecifier"),
  Core.recordFields = [
    Core.Field {
...
baseSpecifierAccess x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BaseSpecifier"),
    Core.projectionField = (Core.Name "access")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

baseSpecifierName :: (Phantoms.TTerm Syntax.BaseSpecifier -> Phantoms.TTerm String)
baseSpecifierName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BaseSpecifier"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
baseSpecifierWithAccess original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BaseSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "access"),
...
baseSpecifierWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BaseSpecifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "access"),
...
classBody x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.ClassBody"),
...
unClassBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.ClassBody")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

memberSpecificationAccessLabel :: (Phantoms.TTerm Syntax.AccessSpecifier -> Phantoms.TTerm Syntax.MemberSpecification)
memberSpecificationAccessLabel x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberSpecification"),
  Core.injectionField = Core.Field {
...
memberSpecificationMember x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberSpecification"),
  Core.injectionField = Core.Field {
...
memberDeclarationFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberDeclaration"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "function"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

memberDeclarationVariable :: (Phantoms.TTerm Syntax.VariableDeclaration -> Phantoms.TTerm Syntax.MemberDeclaration)
memberDeclarationVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberDeclaration"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
memberDeclarationConstructor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberDeclaration"),
  Core.injectionField = Core.Field {
...
memberDeclarationDestructor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberDeclaration"),
  Core.injectionField = Core.Field {
...
memberDeclarationNestedClass x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberDeclaration"),
  Core.injectionField = Core.Field {
...
memberDeclarationTemplate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberDeclaration"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "template"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
constructorDeclaration name parameters initializers body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ConstructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
constructorDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ConstructorDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

constructorDeclarationParameters :: (Phantoms.TTerm Syntax.ConstructorDeclaration -> Phantoms.TTerm [Syntax.Parameter])
constructorDeclarationParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ConstructorDeclaration"),
    Core.projectionField = (Core.Name "parameters")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
constructorDeclarationInitializers x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ConstructorDeclaration"),
...
constructorDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ConstructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
constructorDeclarationWithParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ConstructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
constructorDeclarationWithInitializers original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ConstructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
memInitializer name arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MemInitializer"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
memInitializerName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemInitializer"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

memInitializerArguments :: (Phantoms.TTerm Syntax.MemInitializer -> Phantoms.TTerm [Syntax.Expression])
memInitializerArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemInitializer"),
...
memInitializerWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MemInitializer"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
memInitializerWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MemInitializer"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
destructorDeclaration prefixSpecifiers name suffixSpecifiers body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
  Core.recordFields = [
    Core.Field {
...
destructorDeclarationPrefixSpecifiers x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
...
destructorDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
destructorDeclarationSuffixSpecifiers x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
...
destructorDeclarationBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
destructorDeclarationWithPrefixSpecifiers original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
destructorDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
destructorDeclarationWithSuffixSpecifiers original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
destructorDeclarationWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DestructorDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
functionDeclaration prefixSpecifiers returnType name parameters suffixSpecifiers body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
      Core.fieldTerm = (Phantoms.unTTerm prefixSpecifiers)},
...
functionDeclarationPrefixSpecifiers x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "prefixSpecifiers")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

functionDeclarationReturnType :: (Phantoms.TTerm Syntax.FunctionDeclaration -> Phantoms.TTerm Syntax.TypeExpression)
functionDeclarationReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
...
functionDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "parameters")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationSuffixSpecifiers x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "suffixSpecifiers")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionDeclarationWithPrefixSpecifiers original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
functionDeclarationWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
functionDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
functionDeclarationWithParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
functionDeclarationWithSuffixSpecifiers original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
functionDeclarationWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefixSpecifiers"),
...
functionSpecifierPrefixInline = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierPrefix"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "inline"),
    Core.fieldTerm = Core.TermUnit}})))

functionSpecifierPrefixVirtual :: (Phantoms.TTerm Syntax.FunctionSpecifierPrefix)
functionSpecifierPrefixVirtual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierPrefix"),
  Core.injectionField = Core.Field {
...
functionSpecifierPrefixStatic = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierPrefix"),
  Core.injectionField = Core.Field {
...
functionSpecifierPrefixExplicit = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierPrefix"),
  Core.injectionField = Core.Field {
...
functionSpecifierSuffixConst = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierSuffix"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "const"),
    Core.fieldTerm = Core.TermUnit}})))

functionSpecifierSuffixNoexcept :: (Phantoms.TTerm Syntax.FunctionSpecifierSuffix)
functionSpecifierSuffixNoexcept = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierSuffix"),
  Core.injectionField = Core.Field {
...
functionSpecifierSuffixOverride = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierSuffix"),
  Core.injectionField = Core.Field {
...
functionSpecifierSuffixFinal = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionSpecifierSuffix"),
  Core.injectionField = Core.Field {
...
parameter type_ name unnamed defaultValue = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
parameterType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

parameterName :: (Phantoms.TTerm Syntax.Parameter -> Phantoms.TTerm String)
parameterName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
parameterUnnamed x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
...
parameterDefaultValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
...
parameterWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
parameterWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
parameterWithUnnamed original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
parameterWithDefaultValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
functionBodyCompound x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionBody"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "compound"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

functionBodyDeclaration :: (Phantoms.TTerm Syntax.FunctionBody)
functionBodyDeclaration = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionBody"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "declaration"),
    Core.fieldTerm = Core.TermUnit}})))
...
functionBodyPure = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionBody"),
  Core.injectionField = Core.Field {
...
functionBodyDefault = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionBody"),
  Core.injectionField = Core.Field {
...
variableDeclaration type_ name initializer isAuto = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
variableDeclarationType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

variableDeclarationName :: (Phantoms.TTerm Syntax.VariableDeclaration -> Phantoms.TTerm String)
variableDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
variableDeclarationInitializer x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
...
variableDeclarationIsAuto x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
...
variableDeclarationWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
variableDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
variableDeclarationWithInitializer original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
variableDeclarationWithIsAuto original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariableDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
variantDeclaration types name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariantDeclaration"),
  Core.recordFields = [
    Core.Field {
...
variantDeclarationTypes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.VariantDeclaration"),
...
variantDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.VariantDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
variantDeclarationWithTypes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariantDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "types"),
...
variantDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.VariantDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "types"),
...
productDeclaration name fields = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ProductDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
productDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ProductDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

productDeclarationFields :: (Phantoms.TTerm Syntax.ProductDeclaration -> Phantoms.TTerm [Syntax.VariableDeclaration])
productDeclarationFields x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ProductDeclaration"),
...
productDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ProductDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
productDeclarationWithFields original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ProductDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
containerDeclarationList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ContainerDeclaration"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "list"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

containerDeclarationMap :: (Phantoms.TTerm Syntax.MapDeclaration -> Phantoms.TTerm Syntax.ContainerDeclaration)
containerDeclarationMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ContainerDeclaration"),
  Core.injectionField = Core.Field {
...
containerDeclarationSet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ContainerDeclaration"),
  Core.injectionField = Core.Field {
...
containerDeclarationOptional x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ContainerDeclaration"),
  Core.injectionField = Core.Field {
...
listDeclaration elementType name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ListDeclaration"),
  Core.recordFields = [
    Core.Field {
...
listDeclarationElementType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ListDeclaration"),
...
listDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ListDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
listDeclarationWithElementType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ListDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
listDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ListDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
mapDeclaration keyType valueType name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MapDeclaration"),
  Core.recordFields = [
    Core.Field {
...
mapDeclarationKeyType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MapDeclaration"),
...
mapDeclarationValueType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MapDeclaration"),
...
mapDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MapDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
mapDeclarationWithKeyType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MapDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keyType"),
...
mapDeclarationWithValueType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MapDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keyType"),
...
mapDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MapDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keyType"),
...
setDeclaration elementType name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SetDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
      Core.fieldTerm = (Phantoms.unTTerm elementType)},
...
setDeclarationElementType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SetDeclaration"),
    Core.projectionField = (Core.Name "elementType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

setDeclarationName :: (Phantoms.TTerm Syntax.SetDeclaration -> Phantoms.TTerm String)
setDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SetDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
setDeclarationWithElementType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SetDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
setDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SetDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
optionalDeclaration valueType name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.OptionalDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "valueType"),
      Core.fieldTerm = (Phantoms.unTTerm valueType)},
...
optionalDeclarationValueType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.OptionalDeclaration"),
    Core.projectionField = (Core.Name "valueType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

optionalDeclarationName :: (Phantoms.TTerm Syntax.OptionalDeclaration -> Phantoms.TTerm String)
optionalDeclarationName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.OptionalDeclaration"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
optionalDeclarationWithValueType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.OptionalDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "valueType"),
...
optionalDeclarationWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.OptionalDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "valueType"),
...
expressionAssignment x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionComma x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Expression"),
  Core.injectionField = Core.Field {
...
commaExpression left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.CommaExpression"),
  Core.recordFields = [
    Core.Field {
...
commaExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CommaExpression"),
...
commaExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CommaExpression"),
...
commaExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.CommaExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
commaExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.CommaExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
assignmentExpressionConditional x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentExpression"),
  Core.injectionField = Core.Field {
...
explicitAssignment left op right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ExplicitAssignment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
explicitAssignmentLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ExplicitAssignment"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

explicitAssignmentOp :: (Phantoms.TTerm Syntax.ExplicitAssignment -> Phantoms.TTerm Syntax.AssignmentOperator)
explicitAssignmentOp x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ExplicitAssignment"),
...
explicitAssignmentRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ExplicitAssignment"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
explicitAssignmentWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ExplicitAssignment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
explicitAssignmentWithOp original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ExplicitAssignment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
explicitAssignmentWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ExplicitAssignment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
assignmentOperatorAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "assign"),
    Core.fieldTerm = Core.TermUnit}})))

assignmentOperatorPlusAssign :: (Phantoms.TTerm Syntax.AssignmentOperator)
assignmentOperatorPlusAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorMinusAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorMultiplyAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorDivideAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorModuloAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorLeftShiftAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorRightShiftAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorBitwiseAndAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorBitwiseXorAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
assignmentOperatorBitwiseOrAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AssignmentOperator"),
  Core.injectionField = Core.Field {
...
conditionalExpressionLogicalOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ConditionalExpression"),
  Core.injectionField = Core.Field {
...
conditionalExpressionTernary x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ConditionalExpression"),
  Core.injectionField = Core.Field {
...
ternaryExpression condition trueExpr falseExpr = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TernaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
      Core.fieldTerm = (Phantoms.unTTerm condition)},
...
ternaryExpressionCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TernaryExpression"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

ternaryExpressionTrueExpr :: (Phantoms.TTerm Syntax.TernaryExpression -> Phantoms.TTerm Syntax.Expression)
ternaryExpressionTrueExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TernaryExpression"),
...
ternaryExpressionFalseExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TernaryExpression"),
...
ternaryExpressionWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TernaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ternaryExpressionWithTrueExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TernaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ternaryExpressionWithFalseExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TernaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
logicalOrExpressionLogicalAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalOrExpression"),
  Core.injectionField = Core.Field {
...
logicalOrExpressionLogicalOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalOrExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "logicalOr"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
logicalOrOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalOrOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
logicalOrOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalOrOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

logicalOrOperationRight :: (Phantoms.TTerm Syntax.LogicalOrOperation -> Phantoms.TTerm Syntax.LogicalAndExpression)
logicalOrOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalOrOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
logicalOrOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalOrOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
logicalOrOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalOrOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
logicalAndExpressionInclusiveOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalAndExpression"),
  Core.injectionField = Core.Field {
...
logicalAndExpressionLogicalAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalAndExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "logicalAnd"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
logicalAndOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalAndOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
logicalAndOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalAndOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

logicalAndOperationRight :: (Phantoms.TTerm Syntax.LogicalAndOperation -> Phantoms.TTerm Syntax.InclusiveOrExpression)
logicalAndOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalAndOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
logicalAndOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalAndOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
logicalAndOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LogicalAndOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
inclusiveOrExpressionExclusiveOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.InclusiveOrExpression"),
  Core.injectionField = Core.Field {
...
inclusiveOrExpressionBitwiseOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.InclusiveOrExpression"),
  Core.injectionField = Core.Field {
...
bitwiseOrOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseOrOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
bitwiseOrOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseOrOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

bitwiseOrOperationRight :: (Phantoms.TTerm Syntax.BitwiseOrOperation -> Phantoms.TTerm Syntax.ExclusiveOrExpression)
bitwiseOrOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseOrOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
bitwiseOrOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseOrOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
bitwiseOrOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseOrOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
exclusiveOrExpressionAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ExclusiveOrExpression"),
  Core.injectionField = Core.Field {
...
exclusiveOrExpressionBitwiseXor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ExclusiveOrExpression"),
  Core.injectionField = Core.Field {
...
bitwiseXorOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseXorOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
bitwiseXorOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseXorOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

bitwiseXorOperationRight :: (Phantoms.TTerm Syntax.BitwiseXorOperation -> Phantoms.TTerm Syntax.AndExpression)
bitwiseXorOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseXorOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
bitwiseXorOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseXorOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
bitwiseXorOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseXorOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
andExpressionEquality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AndExpression"),
  Core.injectionField = Core.Field {
...
andExpressionBitwiseAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AndExpression"),
  Core.injectionField = Core.Field {
...
bitwiseAndOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseAndOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
bitwiseAndOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseAndOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

bitwiseAndOperationRight :: (Phantoms.TTerm Syntax.BitwiseAndOperation -> Phantoms.TTerm Syntax.EqualityExpression)
bitwiseAndOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseAndOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
bitwiseAndOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseAndOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
bitwiseAndOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.BitwiseAndOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
equalityExpressionRelational x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.EqualityExpression"),
  Core.injectionField = Core.Field {
...
equalOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.EqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
equalOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.EqualOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

equalOperationRight :: (Phantoms.TTerm Syntax.EqualOperation -> Phantoms.TTerm Syntax.RelationalExpression)
equalOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.EqualOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
equalOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.EqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
equalOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.EqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
notEqualOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.NotEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
notEqualOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.NotEqualOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

notEqualOperationRight :: (Phantoms.TTerm Syntax.NotEqualOperation -> Phantoms.TTerm Syntax.RelationalExpression)
notEqualOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.NotEqualOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
notEqualOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.NotEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
notEqualOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.NotEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
relationalExpressionShift x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RelationalExpression"),
  Core.injectionField = Core.Field {
...
relationalExpressionLess x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RelationalExpression"),
  Core.injectionField = Core.Field {
...
relationalExpressionGreater x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RelationalExpression"),
  Core.injectionField = Core.Field {
...
relationalExpressionLessEqual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RelationalExpression"),
  Core.injectionField = Core.Field {
...
relationalExpressionGreaterEqual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RelationalExpression"),
  Core.injectionField = Core.Field {
...
lessOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LessOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
lessOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LessOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

lessOperationRight :: (Phantoms.TTerm Syntax.LessOperation -> Phantoms.TTerm Syntax.ShiftExpression)
lessOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LessOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
lessOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LessOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
lessOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LessOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
greaterOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
greaterOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

greaterOperationRight :: (Phantoms.TTerm Syntax.GreaterOperation -> Phantoms.TTerm Syntax.ShiftExpression)
greaterOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
greaterOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
greaterOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
lessEqualOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LessEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
lessEqualOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LessEqualOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

lessEqualOperationRight :: (Phantoms.TTerm Syntax.LessEqualOperation -> Phantoms.TTerm Syntax.ShiftExpression)
lessEqualOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LessEqualOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
lessEqualOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LessEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
lessEqualOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LessEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
greaterEqualOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
greaterEqualOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterEqualOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

greaterEqualOperationRight :: (Phantoms.TTerm Syntax.GreaterEqualOperation -> Phantoms.TTerm Syntax.ShiftExpression)
greaterEqualOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterEqualOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
greaterEqualOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
greaterEqualOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.GreaterEqualOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
shiftExpressionAdditive x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ShiftExpression"),
  Core.injectionField = Core.Field {
...
shiftExpressionLeftShift x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ShiftExpression"),
  Core.injectionField = Core.Field {
...
shiftExpressionRightShift x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ShiftExpression"),
  Core.injectionField = Core.Field {
...
leftShiftOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LeftShiftOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
leftShiftOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LeftShiftOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

leftShiftOperationRight :: (Phantoms.TTerm Syntax.LeftShiftOperation -> Phantoms.TTerm Syntax.AdditiveExpression)
leftShiftOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LeftShiftOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
leftShiftOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LeftShiftOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
leftShiftOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LeftShiftOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
rightShiftOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RightShiftOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
rightShiftOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RightShiftOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rightShiftOperationRight :: (Phantoms.TTerm Syntax.RightShiftOperation -> Phantoms.TTerm Syntax.AdditiveExpression)
rightShiftOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RightShiftOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rightShiftOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RightShiftOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
rightShiftOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RightShiftOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
additiveExpressionMultiplicative x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AdditiveExpression"),
  Core.injectionField = Core.Field {
...
additiveExpressionAdd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AdditiveExpression"),
  Core.injectionField = Core.Field {
...
additiveExpressionSubtract x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AdditiveExpression"),
  Core.injectionField = Core.Field {
...
addOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.AddOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
addOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AddOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

addOperationRight :: (Phantoms.TTerm Syntax.AddOperation -> Phantoms.TTerm Syntax.MultiplicativeExpression)
addOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.AddOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
addOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.AddOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
addOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.AddOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
subtractOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SubtractOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
subtractOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SubtractOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

subtractOperationRight :: (Phantoms.TTerm Syntax.SubtractOperation -> Phantoms.TTerm Syntax.MultiplicativeExpression)
subtractOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SubtractOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
subtractOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SubtractOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
subtractOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SubtractOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
multiplicativeExpressionUnary x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplicativeExpression"),
  Core.injectionField = Core.Field {
...
multiplicativeExpressionMultiply x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplicativeExpression"),
  Core.injectionField = Core.Field {
...
multiplicativeExpressionModulo x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplicativeExpression"),
  Core.injectionField = Core.Field {
...
multiplyOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplyOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
multiplyOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplyOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

multiplyOperationRight :: (Phantoms.TTerm Syntax.MultiplyOperation -> Phantoms.TTerm Syntax.UnaryExpression)
multiplyOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplyOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiplyOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplyOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
multiplyOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MultiplyOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
divideOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DivideOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
divideOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DivideOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

divideOperationRight :: (Phantoms.TTerm Syntax.DivideOperation -> Phantoms.TTerm Syntax.UnaryExpression)
divideOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DivideOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
divideOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DivideOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
divideOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DivideOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
moduloOperation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ModuloOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
moduloOperationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ModuloOperation"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

moduloOperationRight :: (Phantoms.TTerm Syntax.ModuloOperation -> Phantoms.TTerm Syntax.UnaryExpression)
moduloOperationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ModuloOperation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
moduloOperationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ModuloOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
moduloOperationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ModuloOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
unaryExpressionPostfix x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryExpression"),
  Core.injectionField = Core.Field {
...
unaryExpressionUnaryOp x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryExpression"),
  Core.injectionField = Core.Field {
...
unaryExpressionSizeof x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryExpression"),
  Core.injectionField = Core.Field {
...
unaryOperation operator operand = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperation"),
  Core.recordFields = [
    Core.Field {
...
unaryOperationOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperation"),
...
unaryOperationWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
unaryOperatorPlus = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "plus"),
    Core.fieldTerm = Core.TermUnit}})))

unaryOperatorMinus :: (Phantoms.TTerm Syntax.UnaryOperator)
unaryOperatorMinus = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorLogicalNot = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorBitwiseNot = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorDereference = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorAddressOf = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorPreIncrement = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
unaryOperatorPreDecrement = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.UnaryOperator"),
  Core.injectionField = Core.Field {
...
sizeofExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.SizeofExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSizeofExpression :: (Phantoms.TTerm Syntax.SizeofExpression -> Phantoms.TTerm Syntax.TypeExpression)
unSizeofExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.SizeofExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
postfixExpressionPrimary x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PostfixExpression"),
  Core.injectionField = Core.Field {
...
postfixExpressionSubscript x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PostfixExpression"),
  Core.injectionField = Core.Field {
...
postfixExpressionFunctionCall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PostfixExpression"),
  Core.injectionField = Core.Field {
...
postfixExpressionTemplateFunctionCall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PostfixExpression"),
  Core.injectionField = Core.Field {
...
postfixExpressionMemberAccess x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PostfixExpression"),
  Core.injectionField = Core.Field {
...
postfixExpressionPointerMemberAccess x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PostfixExpression"),
  Core.injectionField = Core.Field {
...
subscriptOperation array index = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SubscriptOperation"),
  Core.recordFields = [
    Core.Field {
...
subscriptOperationArray x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SubscriptOperation"),
...
subscriptOperationIndex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SubscriptOperation"),
...
subscriptOperationWithArray original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SubscriptOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "array"),
...
subscriptOperationWithIndex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SubscriptOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "array"),
...
functionCallOperation function arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionCallOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
functionCallOperationFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionCallOperation"),
...
functionCallOperationArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionCallOperation"),
    Core.projectionField = (Core.Name "arguments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionCallOperationWithFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionCallOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
functionCallOperationWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionCallOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
memberAccessOperation object member = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberAccessOperation"),
  Core.recordFields = [
    Core.Field {
...
memberAccessOperationObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberAccessOperation"),
...
memberAccessOperationMember x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberAccessOperation"),
...
memberAccessOperationWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberAccessOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
memberAccessOperationWithMember original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MemberAccessOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
pointerMemberAccessOperation pointer member = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PointerMemberAccessOperation"),
  Core.recordFields = [
    Core.Field {
...
pointerMemberAccessOperationPointer x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PointerMemberAccessOperation"),
...
pointerMemberAccessOperationMember x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PointerMemberAccessOperation"),
    Core.projectionField = (Core.Name "member")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pointerMemberAccessOperationWithPointer original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PointerMemberAccessOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pointer"),
...
pointerMemberAccessOperationWithMember original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PointerMemberAccessOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pointer"),
...
templateFunctionCallOperation function templateArguments arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateFunctionCallOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
      Core.fieldTerm = (Phantoms.unTTerm function)},
...
templateFunctionCallOperationFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateFunctionCallOperation"),
    Core.projectionField = (Core.Name "function")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
templateFunctionCallOperationTemplateArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateFunctionCallOperation"),
...
templateFunctionCallOperationArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateFunctionCallOperation"),
    Core.projectionField = (Core.Name "arguments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
templateFunctionCallOperationWithFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateFunctionCallOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
templateFunctionCallOperationWithTemplateArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateFunctionCallOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
templateFunctionCallOperationWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateFunctionCallOperation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
primaryExpressionIdentifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PrimaryExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "identifier"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

primaryExpressionLiteral :: (Phantoms.TTerm Syntax.Literal -> Phantoms.TTerm Syntax.PrimaryExpression)
primaryExpressionLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PrimaryExpression"),
  Core.injectionField = Core.Field {
...
primaryExpressionParenthesized x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PrimaryExpression"),
  Core.injectionField = Core.Field {
...
primaryExpressionLambda x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PrimaryExpression"),
  Core.injectionField = Core.Field {
...
lambdaExpression captures parameters returnType body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LambdaExpression"),
  Core.recordFields = [
    Core.Field {
...
lambdaExpressionCaptures x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LambdaExpression"),
...
lambdaExpressionReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LambdaExpression"),
    Core.projectionField = (Core.Name "returnType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
lambdaExpressionWithCaptures original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LambdaExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "captures"),
...
lambdaExpressionWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LambdaExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "captures"),
...
captureListCaptureByValue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CaptureList"),
  Core.injectionField = Core.Field {
...
captureListCaptures x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CaptureList"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "captures"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
capture name byReference = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Capture"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
captureName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Capture"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

captureByReference :: (Phantoms.TTerm Syntax.Capture -> Phantoms.TTerm Bool)
captureByReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Capture"),
...
captureWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Capture"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
captureWithByReference original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Capture"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
patternMatch visitor variant = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PatternMatch"),
  Core.recordFields = [
    Core.Field {
...
patternMatchVisitor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PatternMatch"),
...
patternMatchVariant x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.PatternMatch"),
...
patternMatchWithVisitor original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PatternMatch"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "visitor"),
...
patternMatchWithVariant original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.PatternMatch"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "visitor"),
...
visitorLambda x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Visitor"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "lambda"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

visitorOverloaded :: (Phantoms.TTerm Syntax.OverloadedLambdas -> Phantoms.TTerm Syntax.Visitor)
visitorOverloaded x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Visitor"),
  Core.injectionField = Core.Field {
...
overloadedLambdas x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.OverloadedLambdas"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unOverloadedLambdas :: (Phantoms.TTerm Syntax.OverloadedLambdas -> Phantoms.TTerm [Syntax.LambdaExpression])
unOverloadedLambdas x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.OverloadedLambdas")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionApplication function arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionApplication"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
      Core.fieldTerm = (Phantoms.unTTerm function)},
...
functionApplicationFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionApplication"),
    Core.projectionField = (Core.Name "function")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

functionApplicationArguments :: (Phantoms.TTerm Syntax.FunctionApplication -> Phantoms.TTerm [Syntax.Expression])
functionApplicationArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionApplication"),
    Core.projectionField = (Core.Name "arguments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionApplicationWithFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionApplication"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
functionApplicationWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionApplication"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
functionIdentifierSimple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionIdentifier"),
  Core.injectionField = Core.Field {
...
functionIdentifierQualified x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionIdentifier"),
  Core.injectionField = Core.Field {
...
qualifiedIdentifier namespace name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedIdentifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "namespace"),
...
qualifiedIdentifierNamespace x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedIdentifier"),
...
qualifiedIdentifierName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedIdentifier"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
qualifiedIdentifierWithNamespace original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedIdentifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "namespace"),
...
qualifiedIdentifierWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedIdentifier"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "namespace"),
...
statementLabeled x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementSelection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementIteration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementJump x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementExpression x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Statement"),
  Core.injectionField = Core.Field {
...
labeledStatement label statement = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LabeledStatement"),
  Core.recordFields = [
    Core.Field {
...
labeledStatementLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.LabeledStatement"),
...
labeledStatementWithLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.LabeledStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
compoundStatement x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.CompoundStatement"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unCompoundStatement :: (Phantoms.TTerm Syntax.CompoundStatement -> Phantoms.TTerm [Syntax.Statement])
unCompoundStatement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.CompoundStatement")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
selectionStatement condition thenBranch elseBranch = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SelectionStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
      Core.fieldTerm = (Phantoms.unTTerm condition)},
...
selectionStatementCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SelectionStatement"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

selectionStatementThenBranch :: (Phantoms.TTerm Syntax.SelectionStatement -> Phantoms.TTerm Syntax.Statement)
selectionStatementThenBranch x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SelectionStatement"),
...
selectionStatementElseBranch x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SelectionStatement"),
...
selectionStatementWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SelectionStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
selectionStatementWithThenBranch original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SelectionStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
selectionStatementWithElseBranch original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SelectionStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
switchStatement value cases = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SwitchStatement"),
  Core.recordFields = [
    Core.Field {
...
switchStatementValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SwitchStatement"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

switchStatementCases :: (Phantoms.TTerm Syntax.SwitchStatement -> Phantoms.TTerm [Syntax.CaseStatement])
switchStatementCases x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.SwitchStatement"),
...
switchStatementWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SwitchStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
switchStatementWithCases original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.SwitchStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
caseStatementCase x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CaseStatement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "case"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

caseStatementDefault :: (Phantoms.TTerm Syntax.Statement -> Phantoms.TTerm Syntax.CaseStatement)
caseStatementDefault x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CaseStatement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "default"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
caseValue value statement = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.CaseValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
      Core.fieldTerm = (Phantoms.unTTerm value)},
...
caseValueValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CaseValue"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

caseValueStatement :: (Phantoms.TTerm Syntax.CaseValue -> Phantoms.TTerm Syntax.Statement)
caseValueStatement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.CaseValue"),
    Core.projectionField = (Core.Name "statement")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
caseValueWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.CaseValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
caseValueWithStatement original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.CaseValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
iterationStatementWhile x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IterationStatement"),
  Core.injectionField = Core.Field {
...
iterationStatementDo x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IterationStatement"),
  Core.injectionField = Core.Field {
...
iterationStatementFor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IterationStatement"),
  Core.injectionField = Core.Field {
...
iterationStatementRangeFor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IterationStatement"),
  Core.injectionField = Core.Field {
...
whileStatement condition body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.WhileStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
      Core.fieldTerm = (Phantoms.unTTerm condition)},
...
whileStatementCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.WhileStatement"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
doStatement body condition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DoStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
      Core.fieldTerm = (Phantoms.unTTerm body)},
...
doStatementBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DoStatement"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

doStatementCondition :: (Phantoms.TTerm Syntax.DoStatement -> Phantoms.TTerm Syntax.Expression)
doStatementCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.DoStatement"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
doStatementWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.DoStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
forStatement init condition increment body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ForStatement"),
  Core.recordFields = [
    Core.Field {
...
forStatementInit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ForStatement"),
...
forStatementCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ForStatement"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forStatementIncrement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ForStatement"),
...
forStatementWithInit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "init"),
...
forStatementWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "init"),
...
forStatementWithIncrement original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.ForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "init"),
...
forInitExpression x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ForInit"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "expression"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

forInitDeclaration :: (Phantoms.TTerm Syntax.VariableDeclaration -> Phantoms.TTerm Syntax.ForInit)
forInitDeclaration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ForInit"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "declaration"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
forInitEmpty = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.ForInit"),
  Core.injectionField = Core.Field {
...
rangeForStatement type_ variable range body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
rangeForStatementType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangeForStatementVariable :: (Phantoms.TTerm Syntax.RangeForStatement -> Phantoms.TTerm String)
rangeForStatementVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
...
rangeForStatementRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
...
rangeForStatementBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rangeForStatementWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
rangeForStatementWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
rangeForStatementWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
rangeForStatementWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.RangeForStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
jumpStatementBreak = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.JumpStatement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "break"),
    Core.fieldTerm = Core.TermUnit}})))

jumpStatementContinue :: (Phantoms.TTerm Syntax.JumpStatement)
jumpStatementContinue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.JumpStatement"),
  Core.injectionField = Core.Field {
...
jumpStatementReturnValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.JumpStatement"),
  Core.injectionField = Core.Field {
...
jumpStatementReturnVoid = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.JumpStatement"),
  Core.injectionField = Core.Field {
...
jumpStatementThrow x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.JumpStatement"),
  Core.injectionField = Core.Field {
...
expressionStatement x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.ExpressionStatement"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unExpressionStatement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.ExpressionStatement")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeExpressionBasic :: (Phantoms.TTerm Syntax.BasicType -> Phantoms.TTerm Syntax.TypeExpression)
typeExpressionBasic x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
typeExpressionQualified x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "qualified"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeExpressionTemplate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "template"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeExpressionFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "function"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeExpressionAuto = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeExpression"),
  Core.injectionField = Core.Field {
...
basicTypeVoid = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "void"),
    Core.fieldTerm = Core.TermUnit}})))

basicTypeBool :: (Phantoms.TTerm Syntax.BasicType)
basicTypeBool = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
...
basicTypeChar = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
...
basicTypeInt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
...
basicTypeFloat = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
...
basicTypeDouble = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
...
basicTypeString = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
...
basicTypeAuto = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "auto"),
    Core.fieldTerm = Core.TermUnit}})))
...
basicTypeNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BasicType"),
  Core.injectionField = Core.Field {
...
qualifiedType baseType qualifier = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedType"),
  Core.recordFields = [
    Core.Field {
...
qualifiedTypeBaseType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedType"),
...
qualifiedTypeQualifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedType"),
...
qualifiedTypeWithBaseType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "baseType"),
...
qualifiedTypeWithQualifier original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.QualifiedType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "baseType"),
...
typeQualifierConst = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeQualifier"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "const"),
    Core.fieldTerm = Core.TermUnit}})))

typeQualifierLvalueRef :: (Phantoms.TTerm Syntax.TypeQualifier)
typeQualifierLvalueRef = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeQualifier"),
  Core.injectionField = Core.Field {
...
typeQualifierRvalueRef = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeQualifier"),
  Core.injectionField = Core.Field {
...
typeQualifierPointer = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TypeQualifier"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "pointer"),
    Core.fieldTerm = Core.TermUnit}})))
...
templateType name arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
templateTypeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateType"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

templateTypeArguments :: (Phantoms.TTerm Syntax.TemplateType -> Phantoms.TTerm [Syntax.TemplateArgument])
templateTypeArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateType"),
    Core.projectionField = (Core.Name "arguments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
templateTypeWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
templateTypeWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
templateArgumentType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

templateArgumentValue :: (Phantoms.TTerm Syntax.Expression -> Phantoms.TTerm Syntax.TemplateArgument)
templateArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.TemplateArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
functionType returnType parameters = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "returnType"),
      Core.fieldTerm = (Phantoms.unTTerm returnType)},
...
functionTypeReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionType"),
    Core.projectionField = (Core.Name "returnType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

functionTypeParameters :: (Phantoms.TTerm Syntax.FunctionType -> Phantoms.TTerm [Syntax.Parameter])
functionTypeParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionType"),
    Core.projectionField = (Core.Name "parameters")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionTypeWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "returnType"),
...
functionTypeWithParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.FunctionType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "returnType"),
...
literalInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Literal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "integer"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

literalFloating :: (Phantoms.TTerm Syntax.FloatingLiteral -> Phantoms.TTerm Syntax.Literal)
literalFloating x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Literal"),
  Core.injectionField = Core.Field {
...
integerLiteralDecimal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IntegerLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "decimal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

integerLiteralHexadecimal :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.IntegerLiteral)
integerLiteralHexadecimal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IntegerLiteral"),
  Core.injectionField = Core.Field {
...
integerLiteralOctal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IntegerLiteral"),
  Core.injectionField = Core.Field {
...
integerLiteralBinary x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.IntegerLiteral"),
  Core.injectionField = Core.Field {
...
floatingLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.FloatingLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unFloatingLiteral :: (Phantoms.TTerm Syntax.FloatingLiteral -> Phantoms.TTerm Double)
unFloatingLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.FloatingLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

characterLiteral :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.CharacterLiteral)
characterLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.CharacterLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unCharacterLiteral :: (Phantoms.TTerm Syntax.CharacterLiteral -> Phantoms.TTerm String)
unCharacterLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.CharacterLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.StringLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unStringLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.StringLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

booleanLiteral :: (Phantoms.TTerm Bool -> Phantoms.TTerm Syntax.BooleanLiteral)
booleanLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.cpp.syntax.BooleanLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unBooleanLiteral :: (Phantoms.TTerm Syntax.BooleanLiteral -> Phantoms.TTerm Bool)
unBooleanLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.cpp.syntax.BooleanLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

vector :: (Phantoms.TTerm Syntax.TypeExpression -> Phantoms.TTerm [Syntax.Expression] -> Phantoms.TTerm Syntax.Vector)
vector elementType elements = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Vector"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
      Core.fieldTerm = (Phantoms.unTTerm elementType)},
...
vectorElementType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Vector"),
    Core.projectionField = (Core.Name "elementType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

vectorElements :: (Phantoms.TTerm Syntax.Vector -> Phantoms.TTerm [Syntax.Expression])
vectorElements x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Vector"),
...
vectorWithElementType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Vector"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
vectorWithElements original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Vector"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
map keyType valueType entries = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Map"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keyType"),
      Core.fieldTerm = (Phantoms.unTTerm keyType)},
...
mapKeyType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Map"),
    Core.projectionField = (Core.Name "keyType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

mapValueType :: (Phantoms.TTerm Syntax.Map -> Phantoms.TTerm Syntax.TypeExpression)
mapValueType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Map"),
    Core.projectionField = (Core.Name "valueType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
mapEntries x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Map"),
...
mapWithKeyType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Map"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keyType"),
...
mapWithValueType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Map"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keyType"),
...
mapWithEntries original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Map"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keyType"),
...
mapEntry key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MapEntry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
      Core.fieldTerm = (Phantoms.unTTerm key)},
...
mapEntryKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MapEntry"),
    Core.projectionField = (Core.Name "key")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

mapEntryValue :: (Phantoms.TTerm Syntax.MapEntry -> Phantoms.TTerm Syntax.Expression)
mapEntryValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.MapEntry"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
mapEntryWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MapEntry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
mapEntryWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.MapEntry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
set elementType elements = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Set"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
      Core.fieldTerm = (Phantoms.unTTerm elementType)},
...
setElementType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Set"),
    Core.projectionField = (Core.Name "elementType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

setElements :: (Phantoms.TTerm Syntax.Set -> Phantoms.TTerm [Syntax.Expression])
setElements x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Set"),
    Core.projectionField = (Core.Name "elements")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
setWithElementType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Set"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
setWithElements original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Set"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "elementType"),
...
optional valueType value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Optional"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "valueType"),
      Core.fieldTerm = (Phantoms.unTTerm valueType)},
...
optionalValueType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Optional"),
    Core.projectionField = (Core.Name "valueType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

optionalValue :: (Phantoms.TTerm Syntax.Optional -> Phantoms.TTerm (Maybe Syntax.Expression))
optionalValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Optional"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
optionalWithValueType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Optional"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "valueType"),
...
optionalWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Optional"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "valueType"),
...
comment text isMultiline = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Comment"),
  Core.recordFields = [
    Core.Field {
...
commentText x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Comment"),
    Core.projectionField = (Core.Name "text")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

commentIsMultiline :: (Phantoms.TTerm Syntax.Comment -> Phantoms.TTerm Bool)
commentIsMultiline x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.cpp.syntax.Comment"),
...
commentWithText original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Comment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "text"),
...
commentWithIsMultiline original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.cpp.syntax.Comment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "text"),
...
binaryOperatorPlus = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "plus"),
    Core.fieldTerm = Core.TermUnit}})))

binaryOperatorMinus :: (Phantoms.TTerm Syntax.BinaryOperator)
binaryOperatorMinus = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "minus"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorMultiply = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "multiply"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorDivide = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "divide"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorModulo = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "modulo"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorBitwiseAnd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "bitwiseAnd"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorBitwiseOr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "bitwiseOr"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorBitwiseXor = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "bitwiseXor"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorLogicalAnd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "logicalAnd"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorLogicalOr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "logicalOr"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "equal"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorNotEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "notEqual"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorLess = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "less"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorGreater = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "greater"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorLessEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "lessEqual"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorGreaterEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "greaterEqual"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorLeftShift = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "leftShift"),
    Core.fieldTerm = Core.TermUnit}})))
...
binaryOperatorRightShift = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.cpp.syntax.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "rightShift"),
    Core.fieldTerm = Core.TermUnit}})))
