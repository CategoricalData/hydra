...
-- | DSL functions for hydra.ext.com.microsoft.kusto.kql

module Hydra.Dsl.Ext.Com.Microsoft.Kusto.Kql where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.Com.Microsoft.Kusto.Kql as Kql
...
betweenExpression not expression lowerBound upperBound = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
betweenExpressionNot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
betweenExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BetweenExpression"),
...
betweenExpressionLowerBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BetweenExpression"),
...
betweenExpressionUpperBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BetweenExpression"),
...
betweenExpressionWithNot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BetweenExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "not"),
...
betweenExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BetweenExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "not"),
...
betweenExpressionWithLowerBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BetweenExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "not"),
...
betweenExpressionWithUpperBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BetweenExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "not"),
...
binaryExpression left operator right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryExpression"),
  Core.recordFields = [
    Core.Field {
...
binaryExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryExpression"),
...
binaryExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryExpression"),
...
binaryExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryExpression"),
...
binaryExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
binaryExpressionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
binaryExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
binaryOperatorCaseInsensitiveEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "caseInsensitiveEqual"),
    Core.fieldTerm = Core.TermUnit}})))

binaryOperatorContains :: (Phantoms.TTerm Kql.BinaryOperator)
binaryOperatorContains = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorEndsWith = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorGreaterOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorHas = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorHasPrefix = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorHasSuffix = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorLessOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorMatchesRegex = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorStartsWith = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorTimes = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BinaryOperator"),
  Core.injectionField = Core.Field {
...
builtInFunctionAgo = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "ago"),
    Core.fieldTerm = Core.TermUnit}})))

builtInFunctionBin :: (Phantoms.TTerm Kql.BuiltInFunction)
builtInFunctionBin = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionCount = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionDcount = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionEndofday = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionExtract = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionFormat_datetime = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionMaterialize = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionNow = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionRange = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionStartofday = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionStrcat = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
builtInFunctionTodynamic = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.BuiltInFunction"),
  Core.injectionField = Core.Field {
...
columnAlias column alias = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
columnAliasColumn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
columnAliasAlias x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAlias"),
...
columnAliasWithColumn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAlias"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
columnAliasWithAlias original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAlias"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
columnAssignment column expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAssignment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
      Core.fieldTerm = (Phantoms.unTTerm column)},
...
columnAssignmentColumn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAssignment"),
    Core.projectionField = (Core.Name "column")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

columnAssignmentExpression :: (Phantoms.TTerm Kql.ColumnAssignment -> Phantoms.TTerm Kql.Expression)
columnAssignmentExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAssignment"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
columnAssignmentWithColumn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAssignment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
columnAssignmentWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ColumnAssignment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
columnsAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Columns"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "all"),
    Core.fieldTerm = Core.TermUnit}})))

columnsSingle :: (Phantoms.TTerm Kql.ColumnName -> Phantoms.TTerm Kql.Columns)
columnsSingle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Columns"),
  Core.injectionField = Core.Field {
...
commandCount = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "count"),
    Core.fieldTerm = Core.TermUnit}})))

commandDistinct :: (Phantoms.TTerm [Kql.ColumnName] -> Phantoms.TTerm Kql.Command)
commandDistinct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandExtend x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandJoin x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandLimit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandMvexpand x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandOrderBy x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandParse x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandPrint x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandProject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandProjectAway x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandProjectRename x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandRender x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandSearch x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandSortBy x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandSummarize x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandTake x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandTop x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
commandWhere x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Command"),
  Core.injectionField = Core.Field {
...
datetime x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDatetime x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
duration value unit = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
durationValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
durationUnit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Duration"),
...
durationWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Duration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
durationWithUnit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Duration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
durationUnitSecond = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
durationUnitMinute = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.DurationUnit"),
  Core.injectionField = Core.Field {
...
durationUnitHour = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.DurationUnit"),
  Core.injectionField = Core.Field {
...
expressionAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "and"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

expressionAny :: (Phantoms.TTerm Kql.Expression)
expressionAny = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
...
expressionBetween x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
...
expressionBraces x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
...
expressionColumn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "column"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionDataset x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
...
expressionOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
...
expressionParentheses x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
...
expressionProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Expression"),
  Core.injectionField = Core.Field {
...
functionBuiltIn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Function"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "builtIn"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

functionCustom :: (Phantoms.TTerm Kql.FunctionName -> Phantoms.TTerm Kql.Function)
functionCustom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Function"),
  Core.injectionField = Core.Field {
...
functionExpression function arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
functionExpressionFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
functionExpressionArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.FunctionExpression"),
...
functionExpressionWithFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
functionExpressionWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.FunctionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
functionName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unFunctionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
indexExpression expression index = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.IndexExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
      Core.fieldTerm = (Phantoms.unTTerm expression)},
...
indexExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.IndexExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

indexExpressionIndex :: (Phantoms.TTerm Kql.IndexExpression -> Phantoms.TTerm String)
indexExpressionIndex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.IndexExpression"),
...
indexExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.IndexExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
indexExpressionWithIndex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.IndexExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
joinCommand kind expression on = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
joinCommandKind x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
joinCommandExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinCommand"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
joinCommandOn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinCommand"),
...
joinCommandWithKind original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "kind"),
...
joinCommandWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "kind"),
...
joinCommandWithOn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "kind"),
...
joinKindLeftouter = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
joinKindLeftsemi = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
joinKindLeftanti = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
joinKindFullouter = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
joinKindInner = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
joinKindInnerunique = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
joinKindRightouter = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
joinKindRightsemi = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
joinKindRightanti = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.JoinKind"),
  Core.injectionField = Core.Field {
...
keyValuePair key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.KeyValuePair"),
  Core.recordFields = [
    Core.Field {
...
keyValuePairKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.KeyValuePair"),
...
letBinding name expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letBindingName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letBindingExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.LetBinding"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letBindingWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.LetBinding"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
letBindingWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.LetBinding"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
letExpression bindings expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.LetExpression"),
  Core.recordFields = [
    Core.Field {
...
letExpressionBindings x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.LetExpression"),
...
letExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.LetExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.LetExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bindings"),
...
literalDuration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
literalDatetime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Literal"),
  Core.injectionField = Core.Field {
...
literalLong x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Literal"),
  Core.injectionField = Core.Field {
...
orderAscending = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Order"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "ascending"),
    Core.fieldTerm = Core.TermUnit}})))

orderDescending :: (Phantoms.TTerm Kql.Order)
orderDescending = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Order"),
  Core.injectionField = Core.Field {
...
parameter key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
      Core.fieldTerm = (Phantoms.unTTerm key)},
...
parameterKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Parameter"),
    Core.projectionField = (Core.Name "key")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

parameterValue :: (Phantoms.TTerm Kql.Parameter -> Phantoms.TTerm Kql.Literal)
parameterValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Parameter"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
parameterWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
parameterWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Parameter"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
parseCommand column pairs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ParseCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
      Core.fieldTerm = (Phantoms.unTTerm column)},
...
parseCommandColumn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ParseCommand"),
    Core.projectionField = (Core.Name "column")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

parseCommandPairs :: (Phantoms.TTerm Kql.ParseCommand -> Phantoms.TTerm [Kql.KeyValuePair])
parseCommandPairs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ParseCommand"),
...
parseCommandWithColumn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ParseCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
parseCommandWithPairs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.ParseCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
pipelineExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unPipelineExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
printCommand column expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PrintCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
      Core.fieldTerm = (Phantoms.unTTerm column)},
...
printCommandColumn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PrintCommand"),
    Core.projectionField = (Core.Name "column")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

printCommandExpression :: (Phantoms.TTerm Kql.PrintCommand -> Phantoms.TTerm Kql.Expression)
printCommandExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PrintCommand"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
printCommandWithColumn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PrintCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
printCommandWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PrintCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
projection expression alias = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
projectionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
projectionAlias x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Projection"),
    Core.projectionField = (Core.Name "alias")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
projectionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Projection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
projectionWithAlias original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.Projection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
propertyExpression expression property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PropertyExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
      Core.fieldTerm = (Phantoms.unTTerm expression)},
...
propertyExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PropertyExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

propertyExpressionProperty :: (Phantoms.TTerm Kql.PropertyExpression -> Phantoms.TTerm String)
propertyExpressionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PropertyExpression"),
...
propertyExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PropertyExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
propertyExpressionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.PropertyExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
query x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unQuery x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
searchCommand datasets pattern = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SearchCommand"),
  Core.recordFields = [
    Core.Field {
...
searchCommandDatasets x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SearchCommand"),
...
searchCommandPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SearchCommand"),
...
searchCommandWithDatasets original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SearchCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "datasets"),
...
searchCommandWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SearchCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "datasets"),
...
summarizeCommand columns by = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
summarizeCommandColumns x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
summarizeCommandBy x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SummarizeCommand"),
...
summarizeCommandWithColumns original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SummarizeCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
summarizeCommandWithBy original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SummarizeCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
topCommand count sort = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
topCommandCount x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
topCommandSort x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.TopCommand"),
...
topCommandWithCount original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.TopCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "count"),
...
topCommandWithSort original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.TopCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "count"),
...
sortBy column order = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SortBy"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
      Core.fieldTerm = (Phantoms.unTTerm column)},
...
sortByColumn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SortBy"),
    Core.projectionField = (Core.Name "column")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

sortByOrder :: (Phantoms.TTerm Kql.SortBy -> Phantoms.TTerm (Maybe Kql.Order))
sortByOrder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SortBy"),
...
sortByWithColumn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SortBy"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
sortByWithOrder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.SortBy"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "column"),
...
tabularExpressionCommand x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
tabularExpressionPipeline x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.TabularExpression"),
  Core.injectionField = Core.Field {
...
tabularExpressionLet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.TabularExpression"),
  Core.injectionField = Core.Field {
...
tabularExpressionTable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.TabularExpression"),
  Core.injectionField = Core.Field {
...
unaryExpression operator expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
unaryExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
unaryExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnaryExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unaryExpressionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
unaryExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
unaryOperatorNot = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnaryOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "not"),
    Core.fieldTerm = Core.TermUnit}})))
...
unionCommand parameters kind withSource isFuzzy tables = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
unionCommandParameters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
unionCommandKind x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
    Core.projectionField = (Core.Name "kind")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionCommandWithSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
...
unionCommandIsFuzzy x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
...
unionCommandTables x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
...
unionCommandWithParameters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "parameters"),
...
unionCommandWithKind original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "parameters"),
...
unionCommandWithWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "parameters"),
...
unionCommandWithIsFuzzy original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "parameters"),
...
unionCommandWithTables original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionCommand"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "parameters"),
...
unionKindInner = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "inner"),
    Core.fieldTerm = Core.TermUnit}})))

unionKindOuter :: (Phantoms.TTerm Kql.UnionKind)
unionKindOuter = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.com.microsoft.kusto.kql.UnionKind"),
  Core.injectionField = Core.Field {
