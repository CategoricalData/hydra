...
definitionEnum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
definitionMessage x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.Definition"),
  Core.injectionField = Core.Field {
...
enumDefinition name values options = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
enumDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
enumDefinitionValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumDefinition"),
...
enumDefinitionOptions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumDefinition"),
...
enumDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefinitionWithValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefinitionWithOptions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumValue name number options = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
enumValueNumber x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumValue"),
...
enumValueOptions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumValue"),
    Core.projectionField = (Core.Name "options")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumValueWithNumber original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumValueWithOptions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.EnumValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumValueName_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unEnumValueName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
field name jsonName type_ number options = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
fieldJsonName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.Field"),
...
fieldNumber x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.Field"),
    Core.projectionField = (Core.Name "number")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldOptions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.Field"),
    Core.projectionField = (Core.Name "options")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldWithJsonName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldWithNumber original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldWithOptions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldName_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
fieldTypeMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
fieldTypeOneof x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.FieldType"),
  Core.injectionField = Core.Field {
...
fieldTypeRepeated x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.FieldType"),
  Core.injectionField = Core.Field {
...
fieldTypeSimple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.FieldType"),
  Core.injectionField = Core.Field {
...
fileReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unFileReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
mapType keys values = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
mapTypeKeys x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
mapTypeValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.MapType"),
    Core.projectionField = (Core.Name "values")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
mapTypeWithKeys original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.MapType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keys"),
...
mapTypeWithValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.MapType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keys"),
...
messageDefinition name fields options = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
messageDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
messageDefinitionFields x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.MessageDefinition"),
...
messageDefinitionOptions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.MessageDefinition"),
    Core.projectionField = (Core.Name "options")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
messageDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.MessageDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
messageDefinitionWithFields original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.MessageDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
messageDefinitionWithOptions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.MessageDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
option name value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
optionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
optionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.Option"),
...
optionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
optionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
protoFile package imports types options = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
protoFilePackage x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
protoFileImports x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ProtoFile"),
...
protoFileTypes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ProtoFile"),
...
protoFileOptions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ProtoFile"),
    Core.projectionField = (Core.Name "options")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
protoFileWithPackage original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.ProtoFile"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "package"),
...
protoFileWithImports original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.ProtoFile"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "package"),
...
protoFileWithTypes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.ProtoFile"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "package"),
...
protoFileWithOptions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.protobuf.proto3.ProtoFile"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "package"),
...
scalarTypeBool = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
scalarTypeBytes = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeDouble = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeFixed32 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeFixed64 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeFloat = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeInt32 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeInt64 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeSfixed32 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeSfixed64 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeSint32 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeSint64 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeString = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeUint32 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
scalarTypeUint64 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.ScalarType"),
  Core.injectionField = Core.Field {
...
simpleTypeReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
simpleTypeScalar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.protobuf.proto3.SimpleType"),
  Core.injectionField = Core.Field {
...
typeName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTypeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
typeReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTypeReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
