...
-- | DSL functions for hydra.ext.io.shex.syntax

module Hydra.Dsl.Ext.Io.Shex.Syntax where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.Io.Shex.Syntax as Syntax
...
shexDoc listOfDirective sequence prefixDecl = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc"),
  Core.recordFields = [
    Core.Field {
...
shexDocListOfDirective x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc"),
...
shexDocSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc"),
...
shexDocPrefixDecl x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc"),
...
shexDocWithListOfDirective original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfDirective"),
...
shexDocWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfDirective"),
...
shexDocWithPrefixDecl original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfDirective"),
...
shexDoc_Sequence_Option alts listOfStatement = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
...
shexDoc_Sequence_OptionAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option"),
...
shexDoc_Sequence_OptionListOfStatement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option"),
...
shexDoc_Sequence_OptionWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
shexDoc_Sequence_OptionWithListOfStatement original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
shexDoc_Sequence_Option_AltsNotStartAction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option_Alts"),
...
shexDoc_Sequence_Option_AltsStartActions x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option_Alts"),
  Core.injectionField = Core.Field {
...
directiveBaseDecl x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Directive"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "BaseDecl"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

directivePrefixDecl :: (Phantoms.TTerm Syntax.PrefixDecl -> Phantoms.TTerm Syntax.Directive)
directivePrefixDecl x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Directive"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PrefixDecl"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
baseDecl x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.BaseDecl"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unBaseDecl :: (Phantoms.TTerm Syntax.BaseDecl -> Phantoms.TTerm Syntax.IriRef)
unBaseDecl x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.BaseDecl")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

prefixDecl :: (Phantoms.TTerm Syntax.PnameNs -> Phantoms.TTerm Syntax.IriRef -> Phantoms.TTerm Syntax.PrefixDecl)
prefixDecl pnameNs iriRef = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PrefixDecl"),
  Core.recordFields = [
    Core.Field {
...
prefixDeclPnameNs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PrefixDecl"),
    Core.projectionField = (Core.Name "PnameNs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

prefixDeclIriRef :: (Phantoms.TTerm Syntax.PrefixDecl -> Phantoms.TTerm Syntax.IriRef)
prefixDeclIriRef x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PrefixDecl"),
...
prefixDeclWithPnameNs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PrefixDecl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
...
prefixDeclWithIriRef original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PrefixDecl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
...
notStartActionStart x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction"),
  Core.injectionField = Core.Field {
...
notStartActionShapeExprDecl x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction"),
  Core.injectionField = Core.Field {
...
notStartAction_ShapeExprDecl shapeExprLabel alts = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction_ShapeExprDecl"),
  Core.recordFields = [
    Core.Field {
...
notStartAction_ShapeExprDeclShapeExprLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction_ShapeExprDecl"),
...
notStartAction_ShapeExprDeclAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction_ShapeExprDecl"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
notStartAction_ShapeExprDeclWithShapeExprLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction_ShapeExprDecl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeExprLabel"),
...
notStartAction_ShapeExprDeclWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction_ShapeExprDecl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeExprLabel"),
...
notStartAction_ShapeExprDecl_AltsShapeExpression x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction_ShapeExprDecl_Alts"),
  Core.injectionField = Core.Field {
...
notStartAction_ShapeExprDecl_AltsEXTERNAL = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NotStartAction_ShapeExprDecl_Alts"),
  Core.injectionField = Core.Field {
...
startActions x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.StartActions"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unStartActions :: (Phantoms.TTerm Syntax.StartActions -> Phantoms.TTerm [Syntax.CodeDecl])
unStartActions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.StartActions")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

statementDirective :: (Phantoms.TTerm Syntax.Directive -> Phantoms.TTerm Syntax.Statement)
statementDirective x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Statement"),
  Core.injectionField = Core.Field {
...
statementNotStartAction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Statement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "NotStartAction"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
shapeExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unShapeExpression :: (Phantoms.TTerm Syntax.ShapeExpression -> Phantoms.TTerm Syntax.ShapeOr)
unShapeExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.ShapeExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

inlineShapeExpression :: (Phantoms.TTerm Syntax.InlineShapeOr -> Phantoms.TTerm Syntax.InlineShapeExpression)
inlineShapeExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unInlineShapeExpression :: (Phantoms.TTerm Syntax.InlineShapeExpression -> Phantoms.TTerm Syntax.InlineShapeOr)
unInlineShapeExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.InlineShapeExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

shapeOr :: (Phantoms.TTerm Syntax.ShapeAnd -> Phantoms.TTerm [Syntax.ShapeAnd] -> Phantoms.TTerm Syntax.ShapeOr)
shapeOr shapeAnd listOfSequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOr"),
  Core.recordFields = [
    Core.Field {
...
shapeOrShapeAnd x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOr"),
...
shapeOrListOfSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOr"),
...
shapeOrWithShapeAnd original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeAnd"),
...
shapeOrWithListOfSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeAnd"),
...
inlineShapeOr shapeAnd listOfSequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeAnd"),
      Core.fieldTerm = (Phantoms.unTTerm shapeAnd)},
...
inlineShapeOrShapeAnd x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOr"),
    Core.projectionField = (Core.Name "ShapeAnd")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

inlineShapeOrListOfSequence :: (Phantoms.TTerm Syntax.InlineShapeOr -> Phantoms.TTerm [Syntax.InlineShapeAnd])
inlineShapeOrListOfSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOr"),
    Core.projectionField = (Core.Name "listOfSequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineShapeOrWithShapeAnd original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeAnd"),
...
inlineShapeOrWithListOfSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeAnd"),
...
shapeAnd shapeNot listOfSequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAnd"),
  Core.recordFields = [
    Core.Field {
...
shapeAndShapeNot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAnd"),
...
shapeAndListOfSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAnd"),
    Core.projectionField = (Core.Name "listOfSequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
shapeAndWithShapeNot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAnd"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeNot"),
...
shapeAndWithListOfSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAnd"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ShapeNot"),
...
inlineShapeAnd inlineShapeNot listOfSequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAnd"),
  Core.recordFields = [
    Core.Field {
...
inlineShapeAndInlineShapeNot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAnd"),
...
inlineShapeAndListOfSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAnd"),
    Core.projectionField = (Core.Name "listOfSequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineShapeAndWithInlineShapeNot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAnd"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InlineShapeNot"),
...
inlineShapeAndWithListOfSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAnd"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InlineShapeNot"),
...
shapeNot nOT shapeAtom = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeNot"),
  Core.recordFields = [
    Core.Field {
...
shapeNotNOT x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeNot"),
    Core.projectionField = (Core.Name "NOT")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

shapeNotShapeAtom :: (Phantoms.TTerm Syntax.ShapeNot -> Phantoms.TTerm Syntax.ShapeAtom)
shapeNotShapeAtom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeNot"),
...
shapeNotWithNOT original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeNot"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
shapeNotWithShapeAtom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeNot"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
inlineShapeNot nOT inlineShapeAtom = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeNot"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
      Core.fieldTerm = (Phantoms.unTTerm nOT)},
...
inlineShapeNotNOT x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeNot"),
    Core.projectionField = (Core.Name "NOT")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

inlineShapeNotInlineShapeAtom :: (Phantoms.TTerm Syntax.InlineShapeNot -> Phantoms.TTerm Syntax.InlineShapeAtom)
inlineShapeNotInlineShapeAtom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeNot"),
...
inlineShapeNotWithNOT original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeNot"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
inlineShapeNotWithInlineShapeAtom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeNot"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
shapeAtomSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

shapeAtomShapeOrRef :: (Phantoms.TTerm Syntax.ShapeOrRef -> Phantoms.TTerm Syntax.ShapeAtom)
shapeAtomShapeOrRef x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom"),
  Core.injectionField = Core.Field {
...
shapeAtomSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom"),
  Core.injectionField = Core.Field {
...
shapeAtomPeriod = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom"),
  Core.injectionField = Core.Field {
...
shapeAtom_Sequence nodeConstraint shapeOrRef = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom_Sequence"),
  Core.recordFields = [
    Core.Field {
...
shapeAtom_SequenceNodeConstraint x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom_Sequence"),
...
shapeAtom_SequenceShapeOrRef x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom_Sequence"),
...
shapeAtom_SequenceWithNodeConstraint original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NodeConstraint"),
...
shapeAtom_SequenceWithShapeOrRef original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeAtom_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NodeConstraint"),
...
inlineShapeAtomSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

inlineShapeAtomSequence2 :: (Phantoms.TTerm Syntax.InlineShapeAtom_Sequence2 -> Phantoms.TTerm Syntax.InlineShapeAtom)
inlineShapeAtomSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inlineShapeAtomSequence3 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom"),
  Core.injectionField = Core.Field {
...
inlineShapeAtomPeriod = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Period"),
    Core.fieldTerm = Core.TermUnit}})))
...
inlineShapeAtom_Sequence nodeConstraint inlineShapeOrRef = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NodeConstraint"),
      Core.fieldTerm = (Phantoms.unTTerm nodeConstraint)},
...
inlineShapeAtom_SequenceNodeConstraint x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence"),
    Core.projectionField = (Core.Name "NodeConstraint")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineShapeAtom_SequenceInlineShapeOrRef x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence"),
...
inlineShapeAtom_SequenceWithNodeConstraint original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NodeConstraint"),
...
inlineShapeAtom_SequenceWithInlineShapeOrRef original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NodeConstraint"),
...
inlineShapeAtom_Sequence2 inlineShapeOrRef nodeConstraint = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InlineShapeOrRef"),
      Core.fieldTerm = (Phantoms.unTTerm inlineShapeOrRef)},
...
inlineShapeAtom_Sequence2InlineShapeOrRef x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence2"),
    Core.projectionField = (Core.Name "InlineShapeOrRef")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineShapeAtom_Sequence2NodeConstraint x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence2"),
    Core.projectionField = (Core.Name "NodeConstraint")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineShapeAtom_Sequence2WithInlineShapeOrRef original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InlineShapeOrRef"),
...
inlineShapeAtom_Sequence2WithNodeConstraint original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InlineShapeOrRef"),
...
shapeOrRefShapeDefinition x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOrRef"),
  Core.injectionField = Core.Field {
...
shapeOrRefAtpNameLn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOrRef"),
  Core.injectionField = Core.Field {
...
shapeOrRefAtpNameNs x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOrRef"),
  Core.injectionField = Core.Field {
...
shapeOrRefSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeOrRef"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inlineShapeOrRefInlineShapeDefinition x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOrRef"),
  Core.injectionField = Core.Field {
...
inlineShapeOrRefAtpNameLn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOrRef"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "AtpNameLn"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inlineShapeOrRefAtpNameNs x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOrRef"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "AtpNameNs"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inlineShapeOrRefSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeOrRef"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
nodeConstraintSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

nodeConstraintSequence2 :: (Phantoms.TTerm Syntax.NodeConstraint_Sequence2 -> Phantoms.TTerm Syntax.NodeConstraint)
nodeConstraintSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
nodeConstraintSequence3 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence3"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
nodeConstraintSequence4 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint"),
  Core.injectionField = Core.Field {
...
nodeConstraintSequence5 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint"),
  Core.injectionField = Core.Field {
...
nodeConstraintListOfXsFacet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint"),
  Core.injectionField = Core.Field {
...
nodeConstraint_Sequence2 nonLiteralKind listOfStringFacet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence2"),
  Core.recordFields = [
    Core.Field {
...
nodeConstraint_Sequence2NonLiteralKind x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence2"),
...
nodeConstraint_Sequence2ListOfStringFacet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence2"),
...
nodeConstraint_Sequence2WithNonLiteralKind original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NonLiteralKind"),
...
nodeConstraint_Sequence2WithListOfStringFacet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NonLiteralKind"),
...
nodeConstraint_Sequence3 datatype listOfXsFacet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence3"),
  Core.recordFields = [
    Core.Field {
...
nodeConstraint_Sequence3Datatype x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence3"),
...
nodeConstraint_Sequence3ListOfXsFacet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence3"),
...
nodeConstraint_Sequence3WithDatatype original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Datatype"),
...
nodeConstraint_Sequence3WithListOfXsFacet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Datatype"),
...
nodeConstraint_Sequence4 valueSet listOfXsFacet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence4"),
  Core.recordFields = [
    Core.Field {
...
nodeConstraint_Sequence4ValueSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence4"),
...
nodeConstraint_Sequence4ListOfXsFacet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence4"),
    Core.projectionField = (Core.Name "listOfXsFacet")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nodeConstraint_Sequence4WithValueSet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence4"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ValueSet"),
...
nodeConstraint_Sequence4WithListOfXsFacet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence4"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ValueSet"),
...
nodeConstraint_Sequence5 valueSet listOfXsFacet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence5"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ValueSet"),
      Core.fieldTerm = (Phantoms.unTTerm valueSet)},
...
nodeConstraint_Sequence5ValueSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence5"),
    Core.projectionField = (Core.Name "ValueSet")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

nodeConstraint_Sequence5ListOfXsFacet :: (Phantoms.TTerm Syntax.NodeConstraint_Sequence5 -> Phantoms.TTerm [Syntax.XsFacet])
nodeConstraint_Sequence5ListOfXsFacet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence5"),
    Core.projectionField = (Core.Name "listOfXsFacet")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nodeConstraint_Sequence5WithValueSet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence5"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ValueSet"),
...
nodeConstraint_Sequence5WithListOfXsFacet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NodeConstraint_Sequence5"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ValueSet"),
...
nonLiteralKindIRI = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NonLiteralKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "IRI"),
    Core.fieldTerm = Core.TermUnit}})))

nonLiteralKindBNODE :: (Phantoms.TTerm Syntax.NonLiteralKind)
nonLiteralKindBNODE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NonLiteralKind"),
  Core.injectionField = Core.Field {
...
nonLiteralKindNONLITERAL = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NonLiteralKind"),
  Core.injectionField = Core.Field {
...
xsFacetStringFacet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.XsFacet"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "StringFacet"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

xsFacetNumericFacet :: (Phantoms.TTerm Syntax.NumericFacet -> Phantoms.TTerm Syntax.XsFacet)
xsFacetNumericFacet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.XsFacet"),
  Core.injectionField = Core.Field {
...
stringFacetSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringFacet"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

stringFacetRegexp :: (Phantoms.TTerm Syntax.Regexp -> Phantoms.TTerm Syntax.StringFacet)
stringFacetRegexp x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringFacet"),
  Core.injectionField = Core.Field {
...
stringFacet_Sequence stringLength integer = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringFacet_Sequence"),
  Core.recordFields = [
    Core.Field {
...
stringFacet_SequenceStringLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringFacet_Sequence"),
...
stringFacet_SequenceInteger x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringFacet_Sequence"),
...
stringFacet_SequenceWithStringLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringFacet_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "StringLength"),
...
stringFacet_SequenceWithInteger original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringFacet_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "StringLength"),
...
stringLengthLENGTH = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLength"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "LENGTH"),
    Core.fieldTerm = Core.TermUnit}})))

stringLengthMINLENGTH :: (Phantoms.TTerm Syntax.StringLength)
stringLengthMINLENGTH = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLength"),
  Core.injectionField = Core.Field {
...
stringLengthMAXLENGTH = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLength"),
  Core.injectionField = Core.Field {
...
numericFacetSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

numericFacetSequence2 :: (Phantoms.TTerm Syntax.NumericFacet_Sequence2 -> Phantoms.TTerm Syntax.NumericFacet)
numericFacetSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
numericFacet_Sequence numericRange numericLiteral = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence"),
  Core.recordFields = [
    Core.Field {
...
numericFacet_SequenceNumericRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence"),
...
numericFacet_SequenceNumericLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence"),
...
numericFacet_SequenceWithNumericRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NumericRange"),
...
numericFacet_SequenceWithNumericLiteral original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NumericRange"),
...
numericFacet_Sequence2 numericLength integer = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence2"),
  Core.recordFields = [
    Core.Field {
...
numericFacet_Sequence2NumericLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence2"),
...
numericFacet_Sequence2Integer x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence2"),
    Core.projectionField = (Core.Name "Integer")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
numericFacet_Sequence2WithNumericLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NumericLength"),
...
numericFacet_Sequence2WithInteger original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericFacet_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NumericLength"),
...
numericRangeMININCLUSIVE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericRange"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "MININCLUSIVE"),
    Core.fieldTerm = Core.TermUnit}})))

numericRangeMINEXCLUSIVE :: (Phantoms.TTerm Syntax.NumericRange)
numericRangeMINEXCLUSIVE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericRange"),
  Core.injectionField = Core.Field {
...
numericRangeMAXINCLUSIVE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericRange"),
  Core.injectionField = Core.Field {
...
numericRangeMAXEXCLUSIVE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericRange"),
  Core.injectionField = Core.Field {
...
numericLengthTOTALDIGITS = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericLength"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "TOTALDIGITS"),
    Core.fieldTerm = Core.TermUnit}})))

numericLengthFRACTIONDIGITS :: (Phantoms.TTerm Syntax.NumericLength)
numericLengthFRACTIONDIGITS = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericLength"),
  Core.injectionField = Core.Field {
...
shapeDefinition listOfAlts tripleExpression listOfAnnotation semanticActions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
  Core.recordFields = [
    Core.Field {
...
shapeDefinitionListOfAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
...
shapeDefinitionTripleExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
...
shapeDefinitionListOfAnnotation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
...
shapeDefinitionSemanticActions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
...
shapeDefinitionWithListOfAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
shapeDefinitionWithTripleExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
shapeDefinitionWithListOfAnnotation original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
shapeDefinitionWithSemanticActions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
shapeDefinition_ListOfAlts_ElmtIncludeSet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
...
shapeDefinition_ListOfAlts_ElmtExtraPropertySet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
...
shapeDefinition_ListOfAlts_ElmtCLOSED = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeDefinition_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
...
inlineShapeDefinition listOfAlts tripleExpression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
      Core.fieldTerm = (Phantoms.unTTerm listOfAlts)},
...
inlineShapeDefinitionListOfAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition"),
    Core.projectionField = (Core.Name "listOfAlts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineShapeDefinitionTripleExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition"),
    Core.projectionField = (Core.Name "TripleExpression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineShapeDefinitionWithListOfAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
inlineShapeDefinitionWithTripleExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
inlineShapeDefinition_ListOfAlts_ElmtIncludeSet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "IncludeSet"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inlineShapeDefinition_ListOfAlts_ElmtExtraPropertySet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "ExtraPropertySet"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inlineShapeDefinition_ListOfAlts_ElmtCLOSED = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InlineShapeDefinition_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "CLOSED"),
    Core.fieldTerm = Core.TermUnit}})))
...
extraPropertySet x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.ExtraPropertySet"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unExtraPropertySet :: (Phantoms.TTerm Syntax.ExtraPropertySet -> Phantoms.TTerm [Syntax.Predicate])
unExtraPropertySet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.ExtraPropertySet")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

tripleExpression :: (Phantoms.TTerm Syntax.OneOfTripleExpr -> Phantoms.TTerm Syntax.TripleExpression)
tripleExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleExpression"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unTripleExpression :: (Phantoms.TTerm Syntax.TripleExpression -> Phantoms.TTerm Syntax.OneOfTripleExpr)
unTripleExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.TripleExpression")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

oneOfTripleExprGroupTripleExpr :: (Phantoms.TTerm Syntax.GroupTripleExpr -> Phantoms.TTerm Syntax.OneOfTripleExpr)
oneOfTripleExprGroupTripleExpr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.OneOfTripleExpr"),
  Core.injectionField = Core.Field {
...
oneOfTripleExprMultiElementOneOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.OneOfTripleExpr"),
  Core.injectionField = Core.Field {
...
multiElementOneOf groupTripleExpr listOfSequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementOneOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "GroupTripleExpr"),
...
multiElementOneOfGroupTripleExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementOneOf"),
...
multiElementOneOfListOfSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementOneOf"),
    Core.projectionField = (Core.Name "listOfSequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiElementOneOfWithGroupTripleExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementOneOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "GroupTripleExpr"),
...
multiElementOneOfWithListOfSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementOneOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "GroupTripleExpr"),
...
innerTripleExprMultiElementGroup x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InnerTripleExpr"),
  Core.injectionField = Core.Field {
...
innerTripleExprMultiElementOneOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.InnerTripleExpr"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "MultiElementOneOf"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
groupTripleExprSingleElementGroup x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.GroupTripleExpr"),
  Core.injectionField = Core.Field {
...
groupTripleExprMultiElementGroup x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.GroupTripleExpr"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "MultiElementGroup"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
singleElementGroup unaryTripleExpr semi = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.SingleElementGroup"),
  Core.recordFields = [
    Core.Field {
...
singleElementGroupUnaryTripleExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.SingleElementGroup"),
...
singleElementGroupSemi x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.SingleElementGroup"),
...
singleElementGroupWithUnaryTripleExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.SingleElementGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnaryTripleExpr"),
...
singleElementGroupWithSemi original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.SingleElementGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnaryTripleExpr"),
...
multiElementGroup unaryTripleExpr listOfSequence semi = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnaryTripleExpr"),
      Core.fieldTerm = (Phantoms.unTTerm unaryTripleExpr)},
...
multiElementGroupUnaryTripleExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementGroup"),
    Core.projectionField = (Core.Name "UnaryTripleExpr")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

multiElementGroupListOfSequence :: (Phantoms.TTerm Syntax.MultiElementGroup -> Phantoms.TTerm [Syntax.UnaryTripleExpr])
multiElementGroupListOfSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementGroup"),
    Core.projectionField = (Core.Name "listOfSequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiElementGroupSemi x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementGroup"),
    Core.projectionField = (Core.Name "Semi")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiElementGroupWithUnaryTripleExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnaryTripleExpr"),
...
multiElementGroupWithListOfSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnaryTripleExpr"),
...
multiElementGroupWithSemi original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.MultiElementGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnaryTripleExpr"),
...
unaryTripleExprSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

unaryTripleExprInclude :: (Phantoms.TTerm Syntax.Include -> Phantoms.TTerm Syntax.UnaryTripleExpr)
unaryTripleExprInclude x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr"),
  Core.injectionField = Core.Field {
...
unaryTripleExpr_Sequence sequence alts = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Sequence"),
      Core.fieldTerm = (Phantoms.unTTerm sequence)},
...
unaryTripleExpr_SequenceSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unaryTripleExpr_SequenceAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unaryTripleExpr_SequenceWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Sequence"),
...
unaryTripleExpr_SequenceWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Sequence"),
...
unaryTripleExpr_Sequence_AltsTripleConstraint x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence_Alts"),
  Core.injectionField = Core.Field {
...
unaryTripleExpr_Sequence_AltsBracketedTripleExpr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence_Alts"),
  Core.injectionField = Core.Field {
...
bracketedTripleExpr innerTripleExpr cardinality listOfAnnotation semanticActions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
  Core.recordFields = [
    Core.Field {
...
bracketedTripleExprInnerTripleExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
...
bracketedTripleExprCardinality x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
...
bracketedTripleExprListOfAnnotation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
    Core.projectionField = (Core.Name "listOfAnnotation")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
bracketedTripleExprSemanticActions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
    Core.projectionField = (Core.Name "SemanticActions")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
bracketedTripleExprWithInnerTripleExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InnerTripleExpr"),
...
bracketedTripleExprWithCardinality original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InnerTripleExpr"),
...
bracketedTripleExprWithListOfAnnotation original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InnerTripleExpr"),
...
bracketedTripleExprWithSemanticActions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BracketedTripleExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "InnerTripleExpr"),
...
tripleConstraint senseFlags predicate inlineShapeExpression cardinality listOfAnnotation semanticActions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
  Core.recordFields = [
    Core.Field {
...
tripleConstraintSenseFlags x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
...
tripleConstraintPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
...
tripleConstraintInlineShapeExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
...
tripleConstraintCardinality x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
    Core.projectionField = (Core.Name "Cardinality")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tripleConstraintListOfAnnotation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
    Core.projectionField = (Core.Name "listOfAnnotation")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tripleConstraintSemanticActions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
    Core.projectionField = (Core.Name "SemanticActions")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tripleConstraintWithSenseFlags original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "SenseFlags"),
...
tripleConstraintWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "SenseFlags"),
...
tripleConstraintWithInlineShapeExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "SenseFlags"),
...
tripleConstraintWithCardinality original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "SenseFlags"),
...
tripleConstraintWithListOfAnnotation original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "SenseFlags"),
...
tripleConstraintWithSemanticActions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "SenseFlags"),
...
cardinalityAst = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Cardinality"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Ast"),
    Core.fieldTerm = Core.TermUnit}})))

cardinalityPlus :: (Phantoms.TTerm Syntax.Cardinality)
cardinalityPlus = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Cardinality"),
  Core.injectionField = Core.Field {
...
cardinalityQuest = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Cardinality"),
  Core.injectionField = Core.Field {
...
cardinalityRepeatRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Cardinality"),
  Core.injectionField = Core.Field {
...
senseFlags x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.SenseFlags"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSenseFlags :: (Phantoms.TTerm Syntax.SenseFlags -> Phantoms.TTerm ())
unSenseFlags x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.SenseFlags")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

valueSet :: (Phantoms.TTerm [Syntax.ValueSetValue] -> Phantoms.TTerm Syntax.ValueSet)
valueSet x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.ValueSet"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unValueSet :: (Phantoms.TTerm Syntax.ValueSet -> Phantoms.TTerm [Syntax.ValueSetValue])
unValueSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.ValueSet")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

valueSetValueIriRange :: (Phantoms.TTerm Syntax.IriRange -> Phantoms.TTerm Syntax.ValueSetValue)
valueSetValueIriRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ValueSetValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "IriRange"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

valueSetValueLiteral :: (Phantoms.TTerm Syntax.Literal -> Phantoms.TTerm Syntax.ValueSetValue)
valueSetValueLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ValueSetValue"),
  Core.injectionField = Core.Field {
...
iriRangeSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRange"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

iriRangeSequence2 :: (Phantoms.TTerm [Syntax.Exclusion] -> Phantoms.TTerm Syntax.IriRange)
iriRangeSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRange"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
iriRange_Sequence iri sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRange_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Iri"),
...
iriRange_SequenceIri x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRange_Sequence"),
...
iriRange_SequenceSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRange_Sequence"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
iriRange_SequenceWithIri original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRange_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Iri"),
...
iriRange_SequenceWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRange_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Iri"),
...
exclusion x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Exclusion"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unExclusion :: (Phantoms.TTerm Syntax.Exclusion -> Phantoms.TTerm Syntax.Iri)
unExclusion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Exclusion")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

include :: (Phantoms.TTerm Syntax.TripleExprLabel -> Phantoms.TTerm Syntax.Include)
include x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Include"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unInclude :: (Phantoms.TTerm Syntax.Include -> Phantoms.TTerm Syntax.TripleExprLabel)
unInclude x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Include")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

annotation :: (Phantoms.TTerm Syntax.Predicate -> Phantoms.TTerm Syntax.Annotation_Alts -> Phantoms.TTerm Syntax.Annotation)
annotation predicate alts = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Annotation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Predicate"),
      Core.fieldTerm = (Phantoms.unTTerm predicate)},
...
annotationPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Annotation"),
    Core.projectionField = (Core.Name "Predicate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

annotationAlts :: (Phantoms.TTerm Syntax.Annotation -> Phantoms.TTerm Syntax.Annotation_Alts)
annotationAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Annotation"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
annotationWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Annotation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Predicate"),
...
annotationWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Annotation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Predicate"),
...
annotation_AltsIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Annotation_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Iri"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

annotation_AltsLiteral :: (Phantoms.TTerm Syntax.Literal -> Phantoms.TTerm Syntax.Annotation_Alts)
annotation_AltsLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Annotation_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
semanticActions x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.SemanticActions"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSemanticActions :: (Phantoms.TTerm Syntax.SemanticActions -> Phantoms.TTerm [Syntax.CodeDecl])
unSemanticActions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.SemanticActions")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

codeDecl :: (Phantoms.TTerm Syntax.Iri -> Phantoms.TTerm Syntax.CodeDecl_Alts -> Phantoms.TTerm Syntax.CodeDecl)
codeDecl iri alts = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.CodeDecl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Iri"),
      Core.fieldTerm = (Phantoms.unTTerm iri)},
...
codeDeclIri x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.CodeDecl"),
    Core.projectionField = (Core.Name "Iri")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

codeDeclAlts :: (Phantoms.TTerm Syntax.CodeDecl -> Phantoms.TTerm Syntax.CodeDecl_Alts)
codeDeclAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.CodeDecl"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
codeDeclWithIri original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.CodeDecl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Iri"),
...
codeDeclWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.CodeDecl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Iri"),
...
codeDecl_AltsCode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.CodeDecl_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Code"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

codeDecl_AltsPercnt :: (Phantoms.TTerm Syntax.CodeDecl_Alts)
codeDecl_AltsPercnt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.CodeDecl_Alts"),
  Core.injectionField = Core.Field {
...
literalRdfLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalNumericLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Literal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "NumericLiteral"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
literalBooleanLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Literal"),
  Core.injectionField = Core.Field {
...
predicateIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Predicate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Iri"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

predicateRdfType :: (Phantoms.TTerm Syntax.RdfType -> Phantoms.TTerm Syntax.Predicate)
predicateRdfType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Predicate"),
  Core.injectionField = Core.Field {
...
datatype x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Datatype"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unDatatype :: (Phantoms.TTerm Syntax.Datatype -> Phantoms.TTerm Syntax.Iri)
unDatatype x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Datatype")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

shapeExprLabelIri :: (Phantoms.TTerm Syntax.Iri -> Phantoms.TTerm Syntax.ShapeExprLabel)
shapeExprLabelIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeExprLabel"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Iri"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

shapeExprLabelBlankNode :: (Phantoms.TTerm Syntax.BlankNode -> Phantoms.TTerm Syntax.ShapeExprLabel)
shapeExprLabelBlankNode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.ShapeExprLabel"),
  Core.injectionField = Core.Field {
...
tripleExprLabelIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleExprLabel"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Iri"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

tripleExprLabelBlankNode :: (Phantoms.TTerm Syntax.BlankNode -> Phantoms.TTerm Syntax.TripleExprLabel)
tripleExprLabelBlankNode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.TripleExprLabel"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "BlankNode"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
numericLiteralInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Integer"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

numericLiteralDecimal :: (Phantoms.TTerm Syntax.Decimal -> Phantoms.TTerm Syntax.NumericLiteral)
numericLiteralDecimal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericLiteral"),
  Core.injectionField = Core.Field {
...
numericLiteralDouble x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.NumericLiteral"),
  Core.injectionField = Core.Field {
...
rdfLiteral string alts = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfLiteral"),
  Core.recordFields = [
    Core.Field {
...
rdfLiteralString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfLiteral"),
...
rdfLiteralAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfLiteral"),
    Core.projectionField = (Core.Name "Alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rdfLiteralWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "String"),
...
rdfLiteralWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "String"),
...
rdfLiteral_Alts_OptionLangTag x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfLiteral_Alts_Option"),
  Core.injectionField = Core.Field {
...
rdfLiteral_Alts_OptionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfLiteral_Alts_Option"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
booleanLiteralTrue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BooleanLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "True"),
    Core.fieldTerm = Core.TermUnit}})))

booleanLiteralFalse :: (Phantoms.TTerm Syntax.BooleanLiteral)
booleanLiteralFalse = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BooleanLiteral"),
  Core.injectionField = Core.Field {
...
stringStringLiteral1 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.String"),
  Core.injectionField = Core.Field {
...
stringStringLiteralLong1 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.String"),
  Core.injectionField = Core.Field {
...
stringStringLiteral2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.String"),
  Core.injectionField = Core.Field {
...
stringStringLiteralLong2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.String"),
  Core.injectionField = Core.Field {
...
iriIriRef x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Iri"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "IriRef"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

iriPrefixedName :: (Phantoms.TTerm Syntax.PrefixedName -> Phantoms.TTerm Syntax.Iri)
iriPrefixedName x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Iri"),
  Core.injectionField = Core.Field {
...
prefixedNamePnameLn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PrefixedName"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnameLn"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

prefixedNamePnameNs :: (Phantoms.TTerm Syntax.PnameNs -> Phantoms.TTerm Syntax.PrefixedName)
prefixedNamePnameNs x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PrefixedName"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnameNs"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
blankNode x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNode"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unBlankNode :: (Phantoms.TTerm Syntax.BlankNode -> Phantoms.TTerm Syntax.BlankNodeLabel)
unBlankNode x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.BlankNode")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

includeSet :: (Phantoms.TTerm [Syntax.ShapeExprLabel] -> Phantoms.TTerm Syntax.IncludeSet)
includeSet x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.IncludeSet"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unIncludeSet :: (Phantoms.TTerm Syntax.IncludeSet -> Phantoms.TTerm [Syntax.ShapeExprLabel])
unIncludeSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.IncludeSet")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

code :: (Phantoms.TTerm [Syntax.Code_Elmt] -> Phantoms.TTerm Syntax.Code)
code x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Code"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unCode :: (Phantoms.TTerm Syntax.Code -> Phantoms.TTerm [Syntax.Code_Elmt])
unCode x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Code")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

code_ElmtRegex :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.Code_Elmt)
code_ElmtRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Code_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

code_ElmtSequence :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.Code_Elmt)
code_ElmtSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Code_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
code_ElmtUchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Code_Elmt"),
  Core.injectionField = Core.Field {
...
repeatRange integer sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.RepeatRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Integer"),
      Core.fieldTerm = (Phantoms.unTTerm integer)},
...
repeatRangeInteger x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RepeatRange"),
    Core.projectionField = (Core.Name "Integer")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
repeatRangeSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RepeatRange"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
repeatRangeWithInteger original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.RepeatRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Integer"),
...
repeatRangeWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.RepeatRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Integer"),
...
repeatRange_Sequence_Option_Option_OptionInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RepeatRange_Sequence_Option_Option_Option"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Integer"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

repeatRange_Sequence_Option_Option_OptionAst :: (Phantoms.TTerm Syntax.RepeatRange_Sequence_Option_Option_Option)
repeatRange_Sequence_Option_Option_OptionAst = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.RepeatRange_Sequence_Option_Option_Option"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Ast"),
    Core.fieldTerm = Core.TermUnit}})))
...
rdfType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.RdfType"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unRdfType :: (Phantoms.TTerm Syntax.RdfType -> Phantoms.TTerm ())
unRdfType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.RdfType")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

iriRef :: (Phantoms.TTerm [Syntax.IriRef_Elmt] -> Phantoms.TTerm Syntax.IriRef)
iriRef x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRef"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unIriRef :: (Phantoms.TTerm Syntax.IriRef -> Phantoms.TTerm [Syntax.IriRef_Elmt])
unIriRef x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.IriRef")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

iriRef_ElmtRegex :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.IriRef_Elmt)
iriRef_ElmtRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRef_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

iriRef_ElmtUchar :: (Phantoms.TTerm Syntax.Uchar -> Phantoms.TTerm Syntax.IriRef_Elmt)
iriRef_ElmtUchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.IriRef_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Uchar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
pnameNs x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnameNs"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unPnameNs :: (Phantoms.TTerm Syntax.PnameNs -> Phantoms.TTerm (Maybe Syntax.PnPrefix))
unPnameNs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.PnameNs")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pnameLn :: (Phantoms.TTerm Syntax.PnameNs -> Phantoms.TTerm Syntax.PnLocal -> Phantoms.TTerm Syntax.PnameLn)
pnameLn pnameNs pnLocal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnameLn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
      Core.fieldTerm = (Phantoms.unTTerm pnameNs)},
...
pnameLnPnameNs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnameLn"),
    Core.projectionField = (Core.Name "PnameNs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pnameLnPnLocal :: (Phantoms.TTerm Syntax.PnameLn -> Phantoms.TTerm Syntax.PnLocal)
pnameLnPnLocal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnameLn"),
...
pnameLnWithPnameNs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnameLn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
...
pnameLnWithPnLocal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnameLn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
...
atpNameNs x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.AtpNameNs"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unAtpNameNs :: (Phantoms.TTerm Syntax.AtpNameNs -> Phantoms.TTerm (Maybe Syntax.PnPrefix))
unAtpNameNs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.AtpNameNs")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

atpNameLn :: (Phantoms.TTerm Syntax.PnameNs -> Phantoms.TTerm Syntax.PnLocal -> Phantoms.TTerm Syntax.AtpNameLn)
atpNameLn pnameNs pnLocal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.AtpNameLn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
      Core.fieldTerm = (Phantoms.unTTerm pnameNs)},
...
atpNameLnPnameNs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.AtpNameLn"),
    Core.projectionField = (Core.Name "PnameNs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

atpNameLnPnLocal :: (Phantoms.TTerm Syntax.AtpNameLn -> Phantoms.TTerm Syntax.PnLocal)
atpNameLnPnLocal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.AtpNameLn"),
    Core.projectionField = (Core.Name "PnLocal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
atpNameLnWithPnameNs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.AtpNameLn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
...
atpNameLnWithPnLocal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.AtpNameLn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnameNs"),
...
regexp listOfAlts listOfRegex = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
      Core.fieldTerm = (Phantoms.unTTerm listOfAlts)},
...
regexpListOfAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp"),
    Core.projectionField = (Core.Name "listOfAlts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

regexpListOfRegex :: (Phantoms.TTerm Syntax.Regexp -> Phantoms.TTerm [String])
regexpListOfRegex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp"),
...
regexpWithListOfAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
regexpWithListOfRegex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
regexp_ListOfAlts_ElmtRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

regexp_ListOfAlts_ElmtSequence :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.Regexp_ListOfAlts_Elmt)
regexp_ListOfAlts_ElmtSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
regexp_ListOfAlts_ElmtUchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Regexp_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Uchar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
blankNodeLabel alts listOfAlts pnChars = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
      Core.fieldTerm = (Phantoms.unTTerm alts)},
...
blankNodeLabelAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
blankNodeLabelListOfAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel"),
    Core.projectionField = (Core.Name "ListOfAlts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
blankNodeLabelPnChars x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel"),
...
blankNodeLabelWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
blankNodeLabelWithListOfAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
blankNodeLabelWithPnChars original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
blankNodeLabel_AltsPnCharsU x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel_Alts"),
  Core.injectionField = Core.Field {
...
blankNodeLabel_AltsRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
blankNodeLabel_ListOfAlts_Option_ElmtPnChars x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnChars"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

blankNodeLabel_ListOfAlts_Option_ElmtPeriod :: (Phantoms.TTerm Syntax.BlankNodeLabel_ListOfAlts_Option_Elmt)
blankNodeLabel_ListOfAlts_Option_ElmtPeriod = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Period"),
    Core.fieldTerm = Core.TermUnit}})))
...
langTag x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.LangTag"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unLangTag :: (Phantoms.TTerm Syntax.LangTag -> Phantoms.TTerm String)
unLangTag x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.LangTag")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

integer :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.Integer_)
integer x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Integer"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unInteger :: (Phantoms.TTerm Syntax.Integer_ -> Phantoms.TTerm String)
unInteger x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Integer")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

decimal :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.Decimal)
decimal x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Decimal"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unDecimal :: (Phantoms.TTerm Syntax.Decimal -> Phantoms.TTerm String)
unDecimal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Decimal")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

double :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.Double_)
double x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Double"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unDouble :: (Phantoms.TTerm Syntax.Double_ -> Phantoms.TTerm String)
unDouble x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Double")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringLiteral1 :: (Phantoms.TTerm [Syntax.StringLiteral1_Elmt] -> Phantoms.TTerm Syntax.StringLiteral1)
stringLiteral1 x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral1"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unStringLiteral1 :: (Phantoms.TTerm Syntax.StringLiteral1 -> Phantoms.TTerm [Syntax.StringLiteral1_Elmt])
unStringLiteral1 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.StringLiteral1")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringLiteral1_ElmtRegex :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.StringLiteral1_Elmt)
stringLiteral1_ElmtRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral1_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

stringLiteral1_ElmtEchar :: (Phantoms.TTerm Syntax.Echar -> Phantoms.TTerm Syntax.StringLiteral1_Elmt)
stringLiteral1_ElmtEchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral1_Elmt"),
  Core.injectionField = Core.Field {
...
stringLiteral1_ElmtUchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral1_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Uchar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteral2 x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral2"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unStringLiteral2 :: (Phantoms.TTerm Syntax.StringLiteral2 -> Phantoms.TTerm [Syntax.StringLiteral2_Elmt])
unStringLiteral2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.StringLiteral2")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringLiteral2_ElmtRegex :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.StringLiteral2_Elmt)
stringLiteral2_ElmtRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral2_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

stringLiteral2_ElmtEchar :: (Phantoms.TTerm Syntax.Echar -> Phantoms.TTerm Syntax.StringLiteral2_Elmt)
stringLiteral2_ElmtEchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral2_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Echar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteral2_ElmtUchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteral2_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Uchar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteralLong1 x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unStringLiteralLong1 :: (Phantoms.TTerm Syntax.StringLiteralLong1 -> Phantoms.TTerm [Syntax.StringLiteralLong1_Elmt])
unStringLiteralLong1 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringLiteralLong1_ElmtSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

stringLiteralLong1_ElmtEchar :: (Phantoms.TTerm Syntax.Echar -> Phantoms.TTerm Syntax.StringLiteralLong1_Elmt)
stringLiteralLong1_ElmtEchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Echar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteralLong1_ElmtUchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Uchar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteralLong1_Elmt_Sequence alts regex = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alts"),
      Core.fieldTerm = (Phantoms.unTTerm alts)},
...
stringLiteralLong1_Elmt_SequenceAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence"),
    Core.projectionField = (Core.Name "Alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringLiteralLong1_Elmt_SequenceRegex :: (Phantoms.TTerm Syntax.StringLiteralLong1_Elmt_Sequence -> Phantoms.TTerm String)
stringLiteralLong1_Elmt_SequenceRegex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence"),
...
stringLiteralLong1_Elmt_SequenceWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alts"),
...
stringLiteralLong1_Elmt_SequenceWithRegex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alts"),
...
stringLiteralLong1_Elmt_Sequence_Alts_OptionApos = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option"),
  Core.injectionField = Core.Field {
...
stringLiteralLong1_Elmt_Sequence_Alts_OptionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteralLong1_Elmt_Sequence_Alts_Option_Sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option_Sequence"),
  Core.recordFields = []})))

stringLiteralLong2 :: (Phantoms.TTerm [Syntax.StringLiteralLong2_Elmt] -> Phantoms.TTerm Syntax.StringLiteralLong2)
stringLiteralLong2 x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unStringLiteralLong2 :: (Phantoms.TTerm Syntax.StringLiteralLong2 -> Phantoms.TTerm [Syntax.StringLiteralLong2_Elmt])
unStringLiteralLong2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringLiteralLong2_ElmtSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

stringLiteralLong2_ElmtEchar :: (Phantoms.TTerm Syntax.Echar -> Phantoms.TTerm Syntax.StringLiteralLong2_Elmt)
stringLiteralLong2_ElmtEchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Echar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteralLong2_ElmtUchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Uchar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteralLong2_Elmt_Sequence alts regex = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alts"),
      Core.fieldTerm = (Phantoms.unTTerm alts)},
...
stringLiteralLong2_Elmt_SequenceAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence"),
    Core.projectionField = (Core.Name "Alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringLiteralLong2_Elmt_SequenceRegex :: (Phantoms.TTerm Syntax.StringLiteralLong2_Elmt_Sequence -> Phantoms.TTerm String)
stringLiteralLong2_Elmt_SequenceRegex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence"),
    Core.projectionField = (Core.Name "regex")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringLiteralLong2_Elmt_SequenceWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alts"),
...
stringLiteralLong2_Elmt_SequenceWithRegex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alts"),
...
stringLiteralLong2_Elmt_Sequence_Alts_OptionQuot = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option"),
  Core.injectionField = Core.Field {
...
stringLiteralLong2_Elmt_Sequence_Alts_OptionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringLiteralLong2_Elmt_Sequence_Alts_Option_Sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.StringLiteralLong2_Elmt_Sequence_Alts_Option_Sequence"),
  Core.recordFields = []})))

ucharSequence :: (Phantoms.TTerm Syntax.Uchar_Sequence -> Phantoms.TTerm Syntax.Uchar)
ucharSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

ucharSequence2 :: (Phantoms.TTerm Syntax.Uchar_Sequence2 -> Phantoms.TTerm Syntax.Uchar)
ucharSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
uchar_Sequence hex hex2 hex3 hex4 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
  Core.recordFields = [
    Core.Field {
...
uchar_SequenceHex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
    Core.projectionField = (Core.Name "Hex")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

uchar_SequenceHex2 :: (Phantoms.TTerm Syntax.Uchar_Sequence -> Phantoms.TTerm Syntax.Hex)
uchar_SequenceHex2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
...
uchar_SequenceHex3 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
...
uchar_SequenceHex4 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
...
uchar_SequenceWithHex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_SequenceWithHex2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_SequenceWithHex3 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_SequenceWithHex4 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2 hex hex2 hex3 hex4 hex5 hex6 hex7 hex8 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
      Core.fieldTerm = (Phantoms.unTTerm hex)},
...
uchar_Sequence2Hex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
    Core.projectionField = (Core.Name "Hex")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

uchar_Sequence2Hex2 :: (Phantoms.TTerm Syntax.Uchar_Sequence2 -> Phantoms.TTerm Syntax.Hex)
uchar_Sequence2Hex2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
    Core.projectionField = (Core.Name "Hex2")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
uchar_Sequence2Hex3 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
    Core.projectionField = (Core.Name "Hex3")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
uchar_Sequence2Hex4 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
    Core.projectionField = (Core.Name "Hex4")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
uchar_Sequence2Hex5 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
...
uchar_Sequence2Hex6 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
...
uchar_Sequence2Hex7 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
...
uchar_Sequence2Hex8 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
...
uchar_Sequence2WithHex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2WithHex2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2WithHex3 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2WithHex4 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2WithHex5 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2WithHex6 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2WithHex7 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
uchar_Sequence2WithHex8 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Uchar_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
echar x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Echar"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unEchar :: (Phantoms.TTerm Syntax.Echar -> Phantoms.TTerm String)
unEchar x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Echar")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pnCharsBaseRegex :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.PnCharsBase)
pnCharsBaseRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnCharsBase"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

pnCharsBaseRegex2 :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.PnCharsBase)
pnCharsBaseRegex2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnCharsBase"),
  Core.injectionField = Core.Field {
...
pnCharsUPnCharsBase x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnCharsU"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnCharsBase"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

pnCharsULowbar :: (Phantoms.TTerm Syntax.PnCharsU)
pnCharsULowbar = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnCharsU"),
  Core.injectionField = Core.Field {
...
pnCharsPnCharsU x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnChars"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnCharsU"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

pnCharsMinus :: (Phantoms.TTerm Syntax.PnChars)
pnCharsMinus = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnChars"),
  Core.injectionField = Core.Field {
...
pnCharsRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnChars"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
pnPrefix pnCharsBase sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnCharsBase"),
...
pnPrefixPnCharsBase x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix"),
...
pnPrefixSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pnPrefixWithPnCharsBase original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnCharsBase"),
...
pnPrefixWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "PnCharsBase"),
...
pnPrefix_Sequence_Option alts pnChars = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
      Core.fieldTerm = (Phantoms.unTTerm alts)},
...
pnPrefix_Sequence_OptionAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pnPrefix_Sequence_OptionPnChars :: (Phantoms.TTerm Syntax.PnPrefix_Sequence_Option -> Phantoms.TTerm Syntax.PnChars)
pnPrefix_Sequence_OptionPnChars x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option"),
    Core.projectionField = (Core.Name "PnChars")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pnPrefix_Sequence_OptionWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
pnPrefix_Sequence_OptionWithPnChars original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
pnPrefix_Sequence_Option_AltsPnChars x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnChars"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

pnPrefix_Sequence_Option_AltsPeriod :: (Phantoms.TTerm Syntax.PnPrefix_Sequence_Option_Alts)
pnPrefix_Sequence_Option_AltsPeriod = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Period"),
    Core.fieldTerm = Core.TermUnit}})))
...
pnLocal alts sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
      Core.fieldTerm = (Phantoms.unTTerm alts)},
...
pnLocalAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pnLocalSequence :: (Phantoms.TTerm Syntax.PnLocal -> Phantoms.TTerm (Maybe Syntax.PnLocal_Sequence_Option))
pnLocalSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pnLocalWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
pnLocalWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alts"),
...
pnLocal_AltsPnCharsU x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnCharsU"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

pnLocal_AltsColon :: (Phantoms.TTerm Syntax.PnLocal_Alts)
pnLocal_AltsColon = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Alts"),
  Core.injectionField = Core.Field {
...
pnLocal_AltsRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "regex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
pnLocal_AltsPlx x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Alts"),
  Core.injectionField = Core.Field {
...
pnLocal_Sequence_Option listOfAlts alts = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
      Core.fieldTerm = (Phantoms.unTTerm listOfAlts)},
...
pnLocal_Sequence_OptionListOfAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option"),
    Core.projectionField = (Core.Name "listOfAlts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pnLocal_Sequence_OptionAlts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option"),
    Core.projectionField = (Core.Name "alts")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pnLocal_Sequence_OptionWithListOfAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
pnLocal_Sequence_OptionWithAlts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "listOfAlts"),
...
pnLocal_Sequence_Option_ListOfAlts_ElmtPnChars x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnChars"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

pnLocal_Sequence_Option_ListOfAlts_ElmtPeriod :: (Phantoms.TTerm Syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt)
pnLocal_Sequence_Option_ListOfAlts_ElmtPeriod = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Period"),
    Core.fieldTerm = Core.TermUnit}})))
...
pnLocal_Sequence_Option_ListOfAlts_ElmtColon = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Colon"),
    Core.fieldTerm = Core.TermUnit}})))
...
pnLocal_Sequence_Option_ListOfAlts_ElmtPlx x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option_ListOfAlts_Elmt"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Plx"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
pnLocal_Sequence_Option_AltsPnChars x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "PnChars"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

pnLocal_Sequence_Option_AltsColon :: (Phantoms.TTerm Syntax.PnLocal_Sequence_Option_Alts)
pnLocal_Sequence_Option_AltsColon = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Colon"),
    Core.fieldTerm = Core.TermUnit}})))
...
pnLocal_Sequence_Option_AltsPlx x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocal_Sequence_Option_Alts"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Plx"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
plxPercent x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Plx"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Percent"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

plxPnLocalEsc :: (Phantoms.TTerm Syntax.PnLocalEsc -> Phantoms.TTerm Syntax.Plx)
plxPnLocalEsc x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Plx"),
  Core.injectionField = Core.Field {
...
percent hex hex2 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Percent"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
      Core.fieldTerm = (Phantoms.unTTerm hex)},
...
percentHex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Percent"),
    Core.projectionField = (Core.Name "Hex")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

percentHex2 :: (Phantoms.TTerm Syntax.Percent -> Phantoms.TTerm Syntax.Hex)
percentHex2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.io.shex.syntax.Percent"),
    Core.projectionField = (Core.Name "Hex2")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
percentWithHex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Percent"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
percentWithHex2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.io.shex.syntax.Percent"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Hex"),
...
hex x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.Hex"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unHex :: (Phantoms.TTerm Syntax.Hex -> Phantoms.TTerm String)
unHex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.Hex")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pnLocalEsc :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.PnLocalEsc)
pnLocalEsc x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.io.shex.syntax.PnLocalEsc"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unPnLocalEsc :: (Phantoms.TTerm Syntax.PnLocalEsc -> Phantoms.TTerm String)
unPnLocalEsc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.io.shex.syntax.PnLocalEsc")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
