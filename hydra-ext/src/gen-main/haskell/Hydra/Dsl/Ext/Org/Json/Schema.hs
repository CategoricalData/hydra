...
document id definitions root = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
documentId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
documentDefinitions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.json.schema.Document"),
...
documentRoot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.json.schema.Document"),
...
documentWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.json.schema.Document"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
documentWithDefinitions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.json.schema.Document"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
documentWithRoot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.json.schema.Document"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
keyword x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unKeyword x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
schema x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unSchema x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
restrictionType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
restrictionString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
restrictionNumber x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
restrictionArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
restrictionObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
restrictionMultiple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
restrictionReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
restrictionTitle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
restrictionDescription x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Restriction"),
  Core.injectionField = Core.Field {
...
typeSingle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
typeMultiple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Type"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "multiple"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeNameString = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
typeNameInteger = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.TypeName"),
  Core.injectionField = Core.Field {
...
typeNameNumber = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.TypeName"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "number"),
    Core.fieldTerm = Core.TermUnit}})))
...
typeNameBoolean = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.TypeName"),
  Core.injectionField = Core.Field {
...
typeNameNull = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.TypeName"),
  Core.injectionField = Core.Field {
...
typeNameArray = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.TypeName"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "array"),
    Core.fieldTerm = Core.TermUnit}})))
...
typeNameObject = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.TypeName"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "object"),
    Core.fieldTerm = Core.TermUnit}})))
...
stringRestrictionMinLength x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
stringRestrictionMaxLength x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.StringRestriction"),
  Core.injectionField = Core.Field {
...
stringRestrictionPattern x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.StringRestriction"),
  Core.injectionField = Core.Field {
...
regularExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRegularExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
numericRestrictionMinimum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
numericRestrictionMaximum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.NumericRestriction"),
  Core.injectionField = Core.Field {
...
numericRestrictionMultipleOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.NumericRestriction"),
  Core.injectionField = Core.Field {
...
limit value exclusive = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
limitValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
limitExclusive x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.json.schema.Limit"),
...
limitWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.json.schema.Limit"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
limitWithExclusive original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.json.schema.Limit"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
arrayRestrictionItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
arrayRestrictionAdditionalItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ArrayRestriction"),
  Core.injectionField = Core.Field {
...
arrayRestrictionMinItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ArrayRestriction"),
  Core.injectionField = Core.Field {
...
arrayRestrictionMaxItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ArrayRestriction"),
  Core.injectionField = Core.Field {
...
arrayRestrictionUniqueItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ArrayRestriction"),
  Core.injectionField = Core.Field {
...
itemsSameItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
itemsVarItems x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.Items"),
  Core.injectionField = Core.Field {
...
additionalItemsAny x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
additionalItemsSchema x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.AdditionalItems"),
  Core.injectionField = Core.Field {
...
objectRestrictionProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
objectRestrictionAdditionalProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ObjectRestriction"),
  Core.injectionField = Core.Field {
...
objectRestrictionRequired x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ObjectRestriction"),
  Core.injectionField = Core.Field {
...
objectRestrictionMinProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ObjectRestriction"),
  Core.injectionField = Core.Field {
...
objectRestrictionMaxProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ObjectRestriction"),
  Core.injectionField = Core.Field {
...
objectRestrictionDependencies x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ObjectRestriction"),
  Core.injectionField = Core.Field {
...
objectRestrictionPatternProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.ObjectRestriction"),
  Core.injectionField = Core.Field {
...
schemaOrArraySchema x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
schemaOrArrayArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.SchemaOrArray"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "array"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
multipleRestrictionAllOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
multipleRestrictionAnyOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.MultipleRestriction"),
  Core.injectionField = Core.Field {
...
multipleRestrictionOneOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.MultipleRestriction"),
  Core.injectionField = Core.Field {
...
multipleRestrictionNot x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.MultipleRestriction"),
  Core.injectionField = Core.Field {
...
multipleRestrictionEnum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.json.schema.MultipleRestriction"),
  Core.injectionField = Core.Field {
...
schemaReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unSchemaReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
