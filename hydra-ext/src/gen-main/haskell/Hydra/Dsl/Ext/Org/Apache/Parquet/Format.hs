...
-- | DSL functions for hydra.ext.org.apache.parquet.format

module Hydra.Dsl.Ext.Org.Apache.Parquet.Format where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.Org.Apache.Parquet.Format as Format
...
typeBoolean = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Type"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "boolean"),
    Core.fieldTerm = Core.TermUnit}})))

typeInt32 :: (Phantoms.TTerm Format.Type)
typeInt32 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Type"),
  Core.injectionField = Core.Field {
...
typeInt64 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Type"),
  Core.injectionField = Core.Field {
...
typeFloat = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Type"),
  Core.injectionField = Core.Field {
...
typeDouble = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Type"),
  Core.injectionField = Core.Field {
...
typeByteArray = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Type"),
  Core.injectionField = Core.Field {
...
typeFixedLenByteArray = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Type"),
  Core.injectionField = Core.Field {
...
fieldRepetitionTypeRequired = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FieldRepetitionType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "required"),
    Core.fieldTerm = Core.TermUnit}})))

fieldRepetitionTypeOptional :: (Phantoms.TTerm Format.FieldRepetitionType)
fieldRepetitionTypeOptional = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FieldRepetitionType"),
  Core.injectionField = Core.Field {
...
fieldRepetitionTypeRepeated = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FieldRepetitionType"),
  Core.injectionField = Core.Field {
...
statistics nullCount distinctCount maxValue minValue = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
  Core.recordFields = [
    Core.Field {
...
statisticsNullCount x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
...
statisticsDistinctCount x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
...
statisticsMaxValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
...
statisticsMinValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
...
statisticsWithNullCount original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullCount"),
...
statisticsWithDistinctCount original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullCount"),
...
statisticsWithMaxValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullCount"),
...
statisticsWithMinValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Statistics"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullCount"),
...
decimalType scale precision = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DecimalType"),
  Core.recordFields = [
    Core.Field {
...
decimalTypeScale x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DecimalType"),
...
timeUnitMillis = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeUnit"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "millis"),
    Core.fieldTerm = Core.TermUnit}})))

timeUnitMicros :: (Phantoms.TTerm Format.TimeUnit)
timeUnitMicros = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeUnit"),
  Core.injectionField = Core.Field {
...
timeUnitNanos = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeUnit"),
  Core.injectionField = Core.Field {
...
timestampType isAdjustedToUtc unit = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimestampType"),
  Core.recordFields = [
    Core.Field {
...
timestampTypeIsAdjustedToUtc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimestampType"),
...
timestampTypeUnit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimestampType"),
...
timestampTypeWithIsAdjustedToUtc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimestampType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "isAdjustedToUtc"),
...
timestampTypeWithUnit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimestampType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "isAdjustedToUtc"),
...
timeType isAdjustedToUtc unit = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "isAdjustedToUtc"),
      Core.fieldTerm = (Phantoms.unTTerm isAdjustedToUtc)},
...
timeTypeIsAdjustedToUtc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeType"),
    Core.projectionField = (Core.Name "isAdjustedToUtc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

timeTypeUnit :: (Phantoms.TTerm Format.TimeType -> Phantoms.TTerm Format.TimeUnit)
timeTypeUnit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeType"),
    Core.projectionField = (Core.Name "unit")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
timeTypeWithIsAdjustedToUtc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "isAdjustedToUtc"),
...
timeTypeWithUnit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.TimeType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "isAdjustedToUtc"),
...
intType bitWidth isSigned = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.IntType"),
  Core.recordFields = [
    Core.Field {
...
intTypeBitWidth x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.IntType"),
    Core.projectionField = (Core.Name "bitWidth")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

intTypeIsSigned :: (Phantoms.TTerm Format.IntType -> Phantoms.TTerm Bool)
intTypeIsSigned x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.IntType"),
...
intTypeWithBitWidth original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.IntType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bitWidth"),
...
intTypeWithIsSigned original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.IntType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bitWidth"),
...
logicalTypeString = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = Core.TermUnit}})))

logicalTypeMap :: (Phantoms.TTerm Format.LogicalType)
logicalTypeMap = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeList = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeEnum = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeDecimal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeDate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeTime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeTimestamp x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeUnknown = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeJson = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeBson = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
logicalTypeUuid = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.LogicalType"),
  Core.injectionField = Core.Field {
...
schemaElement type_ typeLength repetitionType name numChildren fieldId logicalType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
...
schemaElementType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

schemaElementTypeLength :: (Phantoms.TTerm Format.SchemaElement -> Phantoms.TTerm (Maybe Int))
schemaElementTypeLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
...
schemaElementRepetitionType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
...
schemaElementName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
...
schemaElementNumChildren x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
...
schemaElementFieldId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
...
schemaElementLogicalType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
...
schemaElementWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
schemaElementWithTypeLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
schemaElementWithRepetitionType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
schemaElementWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
schemaElementWithNumChildren original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
schemaElementWithFieldId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
schemaElementWithLogicalType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SchemaElement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
encodingPlain = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "plain"),
    Core.fieldTerm = Core.TermUnit}})))

encodingRle :: (Phantoms.TTerm Format.Encoding)
encodingRle = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
...
encodingBitPacked = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
...
encodingDeltaBinaryPacked = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
...
encodingDeltaLengthByteArray = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
...
encodingDeltaByteArray = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
...
encodingRleDictionary = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
...
encodingByteStreamSplit = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.Encoding"),
  Core.injectionField = Core.Field {
...
compressionCodecUncompressed = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.CompressionCodec"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "uncompressed"),
    Core.fieldTerm = Core.TermUnit}})))

compressionCodecSnappy :: (Phantoms.TTerm Format.CompressionCodec)
compressionCodecSnappy = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.CompressionCodec"),
  Core.injectionField = Core.Field {
...
compressionCodecGzip = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.CompressionCodec"),
  Core.injectionField = Core.Field {
...
compressionCodecLzo = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.CompressionCodec"),
  Core.injectionField = Core.Field {
...
compressionCodecBrotli = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.CompressionCodec"),
  Core.injectionField = Core.Field {
...
compressionCodecZstd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.CompressionCodec"),
  Core.injectionField = Core.Field {
...
compressionCodecLz4Raw = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.CompressionCodec"),
  Core.injectionField = Core.Field {
...
pageTypeDataPage = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "dataPage"),
    Core.fieldTerm = Core.TermUnit}})))

pageTypeIndexPage :: (Phantoms.TTerm Format.PageType)
pageTypeIndexPage = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageType"),
  Core.injectionField = Core.Field {
...
pageTypeDictionaryPage = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageType"),
  Core.injectionField = Core.Field {
...
pageTypeDataPageV2 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageType"),
  Core.injectionField = Core.Field {
...
boundaryOrderUnordered = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BoundaryOrder"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "unordered"),
    Core.fieldTerm = Core.TermUnit}})))

boundaryOrderAscending :: (Phantoms.TTerm Format.BoundaryOrder)
boundaryOrderAscending = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BoundaryOrder"),
  Core.injectionField = Core.Field {
...
boundaryOrderDescending = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BoundaryOrder"),
  Core.injectionField = Core.Field {
...
dataPageHeader numValues encoding definitionLevelEncoding repetitionLevelEncoding statistics = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
  Core.recordFields = [
    Core.Field {
...
dataPageHeaderNumValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
...
dataPageHeaderEncoding x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
...
dataPageHeaderDefinitionLevelEncoding x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
...
dataPageHeaderRepetitionLevelEncoding x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
...
dataPageHeaderStatistics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
...
dataPageHeaderWithNumValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderWithEncoding original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderWithDefinitionLevelEncoding original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderWithRepetitionLevelEncoding original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderWithStatistics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
indexPageHeader = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.IndexPageHeader"),
  Core.recordFields = []})))
...
dictionaryPageHeader numValues encoding isSorted = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DictionaryPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
      Core.fieldTerm = (Phantoms.unTTerm numValues)},
...
dictionaryPageHeaderNumValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DictionaryPageHeader"),
    Core.projectionField = (Core.Name "numValues")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

dictionaryPageHeaderEncoding :: (Phantoms.TTerm Format.DictionaryPageHeader -> Phantoms.TTerm Format.Encoding)
dictionaryPageHeaderEncoding x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DictionaryPageHeader"),
    Core.projectionField = (Core.Name "encoding")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dictionaryPageHeaderIsSorted x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DictionaryPageHeader"),
...
dictionaryPageHeaderWithNumValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DictionaryPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dictionaryPageHeaderWithEncoding original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DictionaryPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dictionaryPageHeaderWithIsSorted original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DictionaryPageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2 numValues numNulls numRows encoding definitionLevelsByteLength repetitionLevelsByteLength isCompressed statistics = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
      Core.fieldTerm = (Phantoms.unTTerm numValues)},
...
dataPageHeaderV2NumValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
    Core.projectionField = (Core.Name "numValues")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

dataPageHeaderV2NumNulls :: (Phantoms.TTerm Format.DataPageHeaderV2 -> Phantoms.TTerm Int)
dataPageHeaderV2NumNulls x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
...
dataPageHeaderV2NumRows x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
...
dataPageHeaderV2Encoding x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
    Core.projectionField = (Core.Name "encoding")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPageHeaderV2DefinitionLevelsByteLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
...
dataPageHeaderV2RepetitionLevelsByteLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
...
dataPageHeaderV2IsCompressed x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
...
dataPageHeaderV2Statistics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
    Core.projectionField = (Core.Name "statistics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPageHeaderV2WithNumValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2WithNumNulls original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2WithNumRows original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2WithEncoding original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2WithDefinitionLevelsByteLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2WithRepetitionLevelsByteLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2WithIsCompressed original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
dataPageHeaderV2WithStatistics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.DataPageHeaderV2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numValues"),
...
bloomFilterAlgorithmBlock = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterAlgorithm"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "block"),
    Core.fieldTerm = Core.TermUnit}})))

bloomFilterHashXxhash :: (Phantoms.TTerm Format.BloomFilterHash)
bloomFilterHashXxhash = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHash"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "xxhash"),
    Core.fieldTerm = Core.TermUnit}})))

bloomFilterCompressionUncompressed :: (Phantoms.TTerm Format.BloomFilterCompression)
bloomFilterCompressionUncompressed = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterCompression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "uncompressed"),
    Core.fieldTerm = Core.TermUnit}})))
...
bloomFilterHeader numBytes algorithm hash compression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
  Core.recordFields = [
    Core.Field {
...
bloomFilterHeaderNumBytes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
...
bloomFilterHeaderAlgorithm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
...
bloomFilterHeaderHash x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
...
bloomFilterHeaderCompression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
...
bloomFilterHeaderWithNumBytes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numBytes"),
...
bloomFilterHeaderWithAlgorithm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numBytes"),
...
bloomFilterHeaderWithHash original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numBytes"),
...
bloomFilterHeaderWithCompression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.BloomFilterHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "numBytes"),
...
pageHeader type_ uncompressedPageSize compressedPageSize crc dataPageHeader indexPageHeader dictionaryPageHeader dataPageHeaderV2 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
pageHeaderType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pageHeaderUncompressedPageSize :: (Phantoms.TTerm Format.PageHeader -> Phantoms.TTerm Int)
pageHeaderUncompressedPageSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
...
pageHeaderCompressedPageSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
...
pageHeaderCrc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
...
pageHeaderDataPageHeader x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
...
pageHeaderIndexPageHeader x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
...
pageHeaderDictionaryPageHeader x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
...
pageHeaderDataPageHeaderV2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
...
pageHeaderWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
pageHeaderWithUncompressedPageSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
pageHeaderWithCompressedPageSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
pageHeaderWithCrc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
pageHeaderWithDataPageHeader original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
pageHeaderWithIndexPageHeader original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
pageHeaderWithDictionaryPageHeader original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
pageHeaderWithDataPageHeaderV2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageHeader"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
keyValue key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.KeyValue"),
  Core.recordFields = [
    Core.Field {
...
keyValueKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.KeyValue"),
    Core.projectionField = (Core.Name "key")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

keyValueValue :: (Phantoms.TTerm Format.KeyValue -> Phantoms.TTerm (Maybe String))
keyValueValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.KeyValue"),
...
keyValueWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.KeyValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
keyValueWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.KeyValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
sortingColumn columnIdx descending nullsFirst = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SortingColumn"),
  Core.recordFields = [
    Core.Field {
...
sortingColumnColumnIdx x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SortingColumn"),
    Core.projectionField = (Core.Name "columnIdx")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

sortingColumnDescending :: (Phantoms.TTerm Format.SortingColumn -> Phantoms.TTerm Bool)
sortingColumnDescending x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SortingColumn"),
...
sortingColumnNullsFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SortingColumn"),
...
sortingColumnWithColumnIdx original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SortingColumn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columnIdx"),
...
sortingColumnWithDescending original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SortingColumn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columnIdx"),
...
sortingColumnWithNullsFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.SortingColumn"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columnIdx"),
...
pageEncodingStats pageType encoding count = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageEncodingStats"),
  Core.recordFields = [
    Core.Field {
...
pageEncodingStatsPageType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageEncodingStats"),
...
pageEncodingStatsEncoding x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageEncodingStats"),
    Core.projectionField = (Core.Name "encoding")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pageEncodingStatsCount x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageEncodingStats"),
...
pageEncodingStatsWithPageType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageEncodingStats"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pageType"),
...
pageEncodingStatsWithEncoding original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageEncodingStats"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pageType"),
...
pageEncodingStatsWithCount original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageEncodingStats"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pageType"),
...
columnMetaData type_ encodings pathInSchema codec numValues totalUncompressedSize totalCompressedSize keyValueMetadata dataPageOffset indexPageOffset dictionaryPageOffset statistics encodingStats bloomFilterOffset = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
columnMetaDataType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

columnMetaDataEncodings :: (Phantoms.TTerm Format.ColumnMetaData -> Phantoms.TTerm [Format.Encoding])
columnMetaDataEncodings x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataPathInSchema x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataCodec x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataNumValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
    Core.projectionField = (Core.Name "numValues")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
columnMetaDataTotalUncompressedSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataTotalCompressedSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataKeyValueMetadata x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataDataPageOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataIndexPageOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataDictionaryPageOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataStatistics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
    Core.projectionField = (Core.Name "statistics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
columnMetaDataEncodingStats x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataBloomFilterOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
...
columnMetaDataWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithEncodings original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithPathInSchema original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithCodec original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithNumValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithTotalUncompressedSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithTotalCompressedSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithKeyValueMetadata original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithDataPageOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithIndexPageOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithDictionaryPageOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithStatistics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithEncodingStats original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
columnMetaDataWithBloomFilterOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
encryptionWithFooterKey = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionWithFooterKey"),
  Core.recordFields = []})))
...
encryptionWithColumnKey pathInSchema keyMetadata = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionWithColumnKey"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathInSchema"),
      Core.fieldTerm = (Phantoms.unTTerm pathInSchema)},
...
encryptionWithColumnKeyPathInSchema x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionWithColumnKey"),
    Core.projectionField = (Core.Name "pathInSchema")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

encryptionWithColumnKeyKeyMetadata :: (Phantoms.TTerm Format.EncryptionWithColumnKey -> Phantoms.TTerm (Maybe B.ByteString))
encryptionWithColumnKeyKeyMetadata x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionWithColumnKey"),
...
encryptionWithColumnKeyWithPathInSchema original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionWithColumnKey"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathInSchema"),
...
encryptionWithColumnKeyWithKeyMetadata original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionWithColumnKey"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathInSchema"),
...
columnCryptoMetaDataEncryptionWithFooterKey x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnCryptoMetaData"),
  Core.injectionField = Core.Field {
...
columnCryptoMetaDataEncryptionWithColumnKey x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnCryptoMetaData"),
  Core.injectionField = Core.Field {
...
columnChunk filePath fileOffset metaData offsetIndexOffset offsetIndexLength columnIndexOffset columnIndexLength cryptoMetadata encryptedColumnMetadata = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
...
columnChunkFilePath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
    Core.projectionField = (Core.Name "filePath")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

columnChunkFileOffset :: (Phantoms.TTerm Format.ColumnChunk -> Phantoms.TTerm I.Int64)
columnChunkFileOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkMetaData x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkOffsetIndexOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkOffsetIndexLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkColumnIndexOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkColumnIndexLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkCryptoMetadata x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkEncryptedColumnMetadata x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
...
columnChunkWithFilePath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithFileOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithMetaData original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithOffsetIndexOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithOffsetIndexLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithColumnIndexOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithColumnIndexLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithCryptoMetadata original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
columnChunkWithEncryptedColumnMetadata original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnChunk"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "filePath"),
...
rowGroup columns totalByteSize numRows sortingColumns fileOffset totalCompressedSize ordinal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
...
rowGroupColumns x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
    Core.projectionField = (Core.Name "columns")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rowGroupTotalByteSize :: (Phantoms.TTerm Format.RowGroup -> Phantoms.TTerm I.Int64)
rowGroupTotalByteSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
...
rowGroupNumRows x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
    Core.projectionField = (Core.Name "numRows")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rowGroupSortingColumns x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
...
rowGroupFileOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
    Core.projectionField = (Core.Name "fileOffset")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rowGroupTotalCompressedSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
    Core.projectionField = (Core.Name "totalCompressedSize")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rowGroupOrdinal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
...
rowGroupWithColumns original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
rowGroupWithTotalByteSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
rowGroupWithNumRows original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
rowGroupWithSortingColumns original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
rowGroupWithFileOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
rowGroupWithTotalCompressedSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
rowGroupWithOrdinal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.RowGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
columnOrderTypeOrder = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnOrder"),
  Core.injectionField = Core.Field {
...
pageLocation offset compressedPageSize firstRowIndex = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageLocation"),
  Core.recordFields = [
    Core.Field {
...
pageLocationOffset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageLocation"),
...
pageLocationCompressedPageSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageLocation"),
    Core.projectionField = (Core.Name "compressedPageSize")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pageLocationFirstRowIndex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageLocation"),
...
pageLocationWithOffset original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageLocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "offset"),
...
pageLocationWithCompressedPageSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageLocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "offset"),
...
pageLocationWithFirstRowIndex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.PageLocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "offset"),
...
offsetIndex pageLocations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.OffsetIndex"),
  Core.recordFields = [
    Core.Field {
...
offsetIndexPageLocations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.OffsetIndex"),
...
offsetIndexWithPageLocations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.OffsetIndex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pageLocations"),
...
columnIndex nullPages minValues maxValues boundaryOrder nullCounts = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
  Core.recordFields = [
    Core.Field {
...
columnIndexNullPages x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
...
columnIndexMinValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
...
columnIndexMaxValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
...
columnIndexBoundaryOrder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
...
columnIndexNullCounts x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
...
columnIndexWithNullPages original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullPages"),
...
columnIndexWithMinValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullPages"),
...
columnIndexWithMaxValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullPages"),
...
columnIndexWithBoundaryOrder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullPages"),
...
columnIndexWithNullCounts original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.ColumnIndex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "nullPages"),
...
aesGcmV1 aadPrefix aadFileUnique supplyAadPrefix = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmV1"),
  Core.recordFields = [
    Core.Field {
...
aesGcmV1AadPrefix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmV1"),
...
aesGcmV1AadFileUnique x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmV1"),
...
aesGcmV1SupplyAadPrefix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmV1"),
...
aesGcmV1WithAadPrefix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmV1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "aadPrefix"),
...
aesGcmV1WithAadFileUnique original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmV1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "aadPrefix"),
...
aesGcmV1WithSupplyAadPrefix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmV1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "aadPrefix"),
...
aesGcmCtrV1 aadPrefix aadFileUnique supplyAadPrefix = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmCtrV1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "aadPrefix"),
      Core.fieldTerm = (Phantoms.unTTerm aadPrefix)},
...
aesGcmCtrV1AadPrefix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmCtrV1"),
    Core.projectionField = (Core.Name "aadPrefix")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

aesGcmCtrV1AadFileUnique :: (Phantoms.TTerm Format.AesGcmCtrV1 -> Phantoms.TTerm (Maybe B.ByteString))
aesGcmCtrV1AadFileUnique x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmCtrV1"),
    Core.projectionField = (Core.Name "aadFileUnique")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
aesGcmCtrV1SupplyAadPrefix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmCtrV1"),
    Core.projectionField = (Core.Name "supplyAadPrefix")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
aesGcmCtrV1WithAadPrefix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmCtrV1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "aadPrefix"),
...
aesGcmCtrV1WithAadFileUnique original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmCtrV1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "aadPrefix"),
...
aesGcmCtrV1WithSupplyAadPrefix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.AesGcmCtrV1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "aadPrefix"),
...
encryptionAlgorithmAesGcmV1 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionAlgorithm"),
  Core.injectionField = Core.Field {
...
encryptionAlgorithmAesGcmCtrV1 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.EncryptionAlgorithm"),
  Core.injectionField = Core.Field {
...
fileMetaData version schema numRows rowGroups keyValueMetadata createdBy columnOrders encryptionAlgorithm footerSigningKeyMetadata = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
...
fileMetaDataVersion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
...
fileMetaDataSchema x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
...
fileMetaDataNumRows x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
    Core.projectionField = (Core.Name "numRows")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fileMetaDataRowGroups x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
...
fileMetaDataKeyValueMetadata x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
    Core.projectionField = (Core.Name "keyValueMetadata")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fileMetaDataCreatedBy x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
...
fileMetaDataColumnOrders x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
...
fileMetaDataEncryptionAlgorithm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
...
fileMetaDataFooterSigningKeyMetadata x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
...
fileMetaDataWithVersion original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithSchema original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithNumRows original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithRowGroups original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithKeyValueMetadata original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithCreatedBy original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithColumnOrders original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithEncryptionAlgorithm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileMetaDataWithFooterSigningKeyMetadata original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "version"),
...
fileCryptoMetaData encryptionAlgorithm keyMetadata = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileCryptoMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "encryptionAlgorithm"),
      Core.fieldTerm = (Phantoms.unTTerm encryptionAlgorithm)},
...
fileCryptoMetaDataEncryptionAlgorithm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileCryptoMetaData"),
    Core.projectionField = (Core.Name "encryptionAlgorithm")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fileCryptoMetaDataKeyMetadata :: (Phantoms.TTerm Format.FileCryptoMetaData -> Phantoms.TTerm (Maybe B.ByteString))
fileCryptoMetaDataKeyMetadata x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileCryptoMetaData"),
    Core.projectionField = (Core.Name "keyMetadata")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fileCryptoMetaDataWithEncryptionAlgorithm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileCryptoMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "encryptionAlgorithm"),
...
fileCryptoMetaDataWithKeyMetadata original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.parquet.format.FileCryptoMetaData"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "encryptionAlgorithm"),
