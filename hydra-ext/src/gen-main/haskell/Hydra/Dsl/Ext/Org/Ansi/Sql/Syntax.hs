...
approximateNumericLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unApproximateNumericLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
binaryStringLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unBinaryStringLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
characterStringLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unCharacterStringLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
columnName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unColumnName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dateString x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDateString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
domainName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDomainName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
exactNumericLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unExactNumericLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
leftBracketOrTrigraph x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unLeftBracketOrTrigraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
rightBracketOrTrigraph x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRightBracketOrTrigraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
nationalCharacterStringLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNationalCharacterStringLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
pathResolvedUserDefinedTypeName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unPathResolvedUserDefinedTypeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
tableName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTableName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
timeString x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTimeString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
timestampLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTimestampLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
unicodeCharacterStringLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unUnicodeCharacterStringLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
unsignedInteger x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unUnsignedInteger x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
approximateNumericTypeFloat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
approximateNumericTypeReal = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ApproximateNumericType"),
  Core.injectionField = Core.Field {
...
approximateNumericTypeDouble = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ApproximateNumericType"),
  Core.injectionField = Core.Field {
...
arrayElement x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unArrayElement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
arrayElementList first rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
arrayElementListFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
arrayElementListRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayElementList"),
...
arrayElementListWithFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayElementList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
arrayElementListWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayElementList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
arrayElementReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unArrayElementReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
arrayType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unArrayType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
arrayValueConstructorEnumeration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
arrayValueConstructorQuery x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayValueConstructor"),
  Core.injectionField = Core.Field {
...
arrayValueConstructorByQuery x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unArrayValueConstructorByQuery x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
arrayValueConstructorByEnumeration leftBracketOrTrigraph arrayElementList rightBracketOrTrigraph = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
arrayValueConstructorByEnumerationLeftBracketOrTrigraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
arrayValueConstructorByEnumerationArrayElementList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayValueConstructorByEnumeration"),
...
arrayValueConstructorByEnumerationRightBracketOrTrigraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayValueConstructorByEnumeration"),
...
arrayValueConstructorByEnumerationWithLeftBracketOrTrigraph original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayValueConstructorByEnumeration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "LeftBracketOrTrigraph"),
...
arrayValueConstructorByEnumerationWithArrayElementList original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayValueConstructorByEnumeration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "LeftBracketOrTrigraph"),
...
arrayValueConstructorByEnumerationWithRightBracketOrTrigraph original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ArrayValueConstructorByEnumeration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "LeftBracketOrTrigraph"),
...
arrayValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unArrayValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
asSubqueryClause x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unAsSubqueryClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
attributeOrMethodReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unAttributeOrMethodReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
binaryLargeObjectStringTypeBinary x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
binaryLargeObjectStringTypeBlob x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BinaryLargeObjectStringType"),
  Core.injectionField = Core.Field {
...
booleanFactor nOT booleanTest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
booleanFactorNOT x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
booleanFactorBooleanTest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanFactor"),
...
booleanFactorWithNOT original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanFactor"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
booleanFactorWithBooleanTest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanFactor"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
booleanLiteralUNKNOWN = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanLiteral"),
  Core.injectionField = Core.Field {
...
booleanPredicand x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unBooleanPredicand x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
booleanPrimaryPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
booleanPrimaryPredicand x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanPrimary"),
  Core.injectionField = Core.Field {
...
booleanTermFactor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
booleanTermAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTerm"),
  Core.injectionField = Core.Field {
...
booleanTerm_And lhs rhs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
booleanTerm_AndLhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
booleanTerm_AndRhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTerm_And"),
...
booleanTerm_AndWithLhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTerm_And"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
booleanTerm_AndWithRhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTerm_And"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
booleanTest booleanPrimary sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
booleanTestBooleanPrimary x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
booleanTestSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTest"),
...
booleanTestWithBooleanPrimary original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTest"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "BooleanPrimary"),
...
booleanTestWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTest"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "BooleanPrimary"),
...
booleanTest_Sequence_Option nOT truthValue = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
booleanTest_Sequence_OptionNOT x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
booleanTest_Sequence_OptionTruthValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTest_Sequence_Option"),
...
booleanTest_Sequence_OptionWithNOT original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTest_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
booleanTest_Sequence_OptionWithTruthValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanTest_Sequence_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "NOT"),
...
booleanType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unBooleanType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
booleanValueExpressionTerm x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
booleanValueExpressionOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanValueExpression"),
  Core.injectionField = Core.Field {
...
booleanValueExpression_Or lhs rhs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
booleanValueExpression_OrLhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
booleanValueExpression_OrRhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanValueExpression_Or"),
    Core.projectionField = (Core.Name "rhs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
booleanValueExpression_OrWithLhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanValueExpression_Or"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
booleanValueExpression_OrWithRhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.BooleanValueExpression_Or"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
caseExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unCaseExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
castSpecification x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unCastSpecification x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
characterSetSpecification x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unCharacterSetSpecification x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
characterStringTypeCharacter x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
characterStringTypeChar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CharacterStringType"),
  Core.injectionField = Core.Field {
...
characterStringTypeCharacterVarying x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CharacterStringType"),
  Core.injectionField = Core.Field {
...
characterStringTypeCharVarying x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CharacterStringType"),
  Core.injectionField = Core.Field {
...
characterStringTypeVarchar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CharacterStringType"),
  Core.injectionField = Core.Field {
...
characterStringTypeCharacterLargeObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CharacterStringType"),
  Core.injectionField = Core.Field {
...
characterStringTypeCharLargeObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CharacterStringType"),
  Core.injectionField = Core.Field {
...
characterStringTypeClob x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CharacterStringType"),
  Core.injectionField = Core.Field {
...
collateClause x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unCollateClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
collectionTypeArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
collectionTypeMultiset x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CollectionType"),
  Core.injectionField = Core.Field {
...
collectionValueConstructorArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
collectionValueConstructorMultiset x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CollectionValueConstructor"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "multiset"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
collectionValueExpressionArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
collectionValueExpressionMultiset x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CollectionValueExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "multiset"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
columnConstraintDefinition x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unColumnConstraintDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
columnDefinition name typeOrDomain refScope defaultOrIdentityOrGeneration constraints collate = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
columnDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
columnDefinitionTypeOrDomain x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
...
columnDefinitionRefScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
...
columnDefinitionDefaultOrIdentityOrGeneration x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
...
columnDefinitionConstraints x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
...
columnDefinitionCollate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
...
columnDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
columnDefinitionWithTypeOrDomain original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
columnDefinitionWithRefScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
columnDefinitionWithDefaultOrIdentityOrGeneration original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
columnDefinitionWithConstraints original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
columnDefinitionWithCollate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
columnDefinition_TypeOrDomain_OptionDataType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
columnDefinition_TypeOrDomain_OptionDomainName x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition_TypeOrDomain_Option"),
  Core.injectionField = Core.Field {
...
columnDefinition_DefaultOrIdentityOrGeneration_OptionDefaultClause x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
columnDefinition_DefaultOrIdentityOrGeneration_OptionIdentityColumnSpecification x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition_DefaultOrIdentityOrGeneration_Option"),
  Core.injectionField = Core.Field {
...
columnDefinition_DefaultOrIdentityOrGeneration_OptionGenerationClause x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnDefinition_DefaultOrIdentityOrGeneration_Option"),
  Core.injectionField = Core.Field {
...
columnNameList first rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
columnNameListFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
columnNameListRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnNameList"),
    Core.projectionField = (Core.Name "rest")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
columnNameListWithFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnNameList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
columnNameListWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ColumnNameList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
columnOptions x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unColumnOptions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
columnReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unColumnReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
commonValueExpressionNumeric x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
commonValueExpressionString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CommonValueExpression"),
  Core.injectionField = Core.Field {
...
commonValueExpressionDatetime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CommonValueExpression"),
  Core.injectionField = Core.Field {
...
commonValueExpressionInterval x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CommonValueExpression"),
  Core.injectionField = Core.Field {
...
commonValueExpressionUserDefined x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CommonValueExpression"),
  Core.injectionField = Core.Field {
...
commonValueExpressionReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CommonValueExpression"),
  Core.injectionField = Core.Field {
...
commonValueExpressionCollection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.CommonValueExpression"),
  Core.injectionField = Core.Field {
...
contextuallyTypedRowValueExpressionSpecialCase x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
contextuallyTypedRowValueExpressionConstructor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueExpression"),
  Core.injectionField = Core.Field {
...
contextuallyTypedRowValueConstructor x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unContextuallyTypedRowValueConstructor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
contextuallyTypedRowValueExpressionList first rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
contextuallyTypedRowValueExpressionListFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
contextuallyTypedRowValueExpressionListRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueExpressionList"),
    Core.projectionField = (Core.Name "rest")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
contextuallyTypedRowValueExpressionListWithFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueExpressionList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
contextuallyTypedRowValueExpressionListWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueExpressionList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
contextuallyTypedTableValueConstructor x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unContextuallyTypedTableValueConstructor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataTypePredefined x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
dataTypeRow x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.DataType"),
  Core.injectionField = Core.Field {
...
dataTypeNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.DataType"),
  Core.injectionField = Core.Field {
...
dataTypeReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.DataType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "reference"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
dataTypeCollection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.DataType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "collection"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
dateLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDateLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
datetimeLiteralDate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
datetimeLiteralTime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.DatetimeLiteral"),
  Core.injectionField = Core.Field {
...
datetimeLiteralTimestamp x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.DatetimeLiteral"),
  Core.injectionField = Core.Field {
...
datetimeType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDatetimeType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
datetimeValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDatetimeValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
defaultClause x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDefaultClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
exactNumericTypeNumeric x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
exactNumericTypeDecimal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType"),
  Core.injectionField = Core.Field {
...
exactNumericTypeDec x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType"),
  Core.injectionField = Core.Field {
...
exactNumericTypeSmallint = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType"),
  Core.injectionField = Core.Field {
...
exactNumericTypeInteger = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType"),
  Core.injectionField = Core.Field {
...
exactNumericTypeInt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType"),
  Core.injectionField = Core.Field {
...
exactNumericTypeBigint = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType"),
  Core.injectionField = Core.Field {
...
exactNumericType_Numeric_Option precision sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
exactNumericType_Numeric_OptionPrecision x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
exactNumericType_Numeric_OptionSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Numeric_Option"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
exactNumericType_Numeric_OptionWithPrecision original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Numeric_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Precision"),
...
exactNumericType_Numeric_OptionWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Numeric_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Precision"),
...
exactNumericType_Decimal_Option precision sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
exactNumericType_Decimal_OptionPrecision x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
exactNumericType_Decimal_OptionSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Decimal_Option"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
exactNumericType_Decimal_OptionWithPrecision original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Decimal_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Precision"),
...
exactNumericType_Decimal_OptionWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Decimal_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Precision"),
...
exactNumericType_Dec_Option precision sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
exactNumericType_Dec_OptionPrecision x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
exactNumericType_Dec_OptionSequence x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Dec_Option"),
    Core.projectionField = (Core.Name "Sequence")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
exactNumericType_Dec_OptionWithPrecision original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Dec_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Precision"),
...
exactNumericType_Dec_OptionWithSequence original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ExactNumericType_Dec_Option"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Precision"),
...
fieldReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unFieldReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
fromConstructor columns override values = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
fromConstructorColumns x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
fromConstructorOverride x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.FromConstructor"),
...
fromConstructorValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.FromConstructor"),
...
fromConstructorWithColumns original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.FromConstructor"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
fromConstructorWithOverride original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.FromConstructor"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
fromConstructorWithValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.FromConstructor"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "columns"),
...
fromDefault x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unFromDefault x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
fromSubquery x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unFromSubquery x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
generalLiteralString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
generalLiteralNationalString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.GeneralLiteral"),
  Core.injectionField = Core.Field {
...
generalLiteralUnicode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.GeneralLiteral"),
  Core.injectionField = Core.Field {
...
generalLiteralBinary x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.GeneralLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "binary"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
generalLiteralDateTime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.GeneralLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "dateTime"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
generalLiteralInterval x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.GeneralLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "interval"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
generalLiteralBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.GeneralLiteral"),
  Core.injectionField = Core.Field {
...
generalValueSpecification x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unGeneralValueSpecification x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
generationClause x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unGenerationClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
globalOrLocalGlobal = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
globalOrLocalLocal = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.GlobalOrLocal"),
  Core.injectionField = Core.Field {
...
identityColumnSpecification x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unIdentityColumnSpecification x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
insertColumnList x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unInsertColumnList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
insertColumnsAndSourceSubquery x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
insertColumnsAndSourceConstructor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.InsertColumnsAndSource"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "constructor"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
insertColumnsAndSourceDefault x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.InsertColumnsAndSource"),
  Core.injectionField = Core.Field {
...
insertStatement target columnsAndSource = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
insertStatementTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
insertStatementColumnsAndSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.InsertStatement"),
...
insertStatementWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.InsertStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
insertStatementWithColumnsAndSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.InsertStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
insertionTarget x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unInsertionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
intervalLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unIntervalLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
intervalType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unIntervalType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
intervalValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unIntervalValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
largeObjectLength x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unLargeObjectLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
length x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
likeClause x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unLikeClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
methodInvocation x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unMethodInvocation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
multisetElementReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unMultisetElementReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
multisetType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unMultisetType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
multisetValueConstructor x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unMultisetValueConstructor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
multisetValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unMultisetValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
nationalCharacterStringType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNationalCharacterStringType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
newSpecification x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNewSpecification x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
nextValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNextValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
numericTypeExact x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
numericTypeApproximate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NumericType"),
  Core.injectionField = Core.Field {
...
numericValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNumericValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
overrideClauseOVERRIDINGspUSERspVALUE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
overrideClauseOVERRIDINGspSYSTEMspVALUE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.OverrideClause"),
  Core.injectionField = Core.Field {
...
parenthesizedValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unParenthesizedValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
precision x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unPrecision x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
predefinedTypeString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
predefinedTypeNationalString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "nationalString"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
predefinedTypeBlob x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "blob"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
predefinedTypeNumeric x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "numeric"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
predefinedTypeBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "boolean"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
predefinedTypeDatetime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "datetime"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
predefinedTypeInterval x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "interval"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
predefinedType_String type_ characters collate = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
predefinedType_StringType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
predefinedType_StringCharacters x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_String"),
...
predefinedType_StringCollate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_String"),
    Core.projectionField = (Core.Name "collate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
predefinedType_StringWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_String"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
predefinedType_StringWithCharacters original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_String"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
predefinedType_StringWithCollate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_String"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
predefinedType_NationalString type_ collate = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
predefinedType_NationalStringType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
predefinedType_NationalStringCollate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_NationalString"),
    Core.projectionField = (Core.Name "collate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
predefinedType_NationalStringWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_NationalString"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
predefinedType_NationalStringWithCollate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.PredefinedType_NationalString"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
predicate x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
queryExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unQueryExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
referenceScopeCheck x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unReferenceScopeCheck x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
referenceType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unReferenceType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
rowType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRowType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
rowValueSpecialCase x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRowValueSpecialCase x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
nonparenthesizedValueExpressionPrimaryUnsigned x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
nonparenthesizedValueExpressionPrimaryColumn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimarySetFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryWindowFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryScalarSubquery x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryCases x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryCast x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryField x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimarySubtype x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryMethod x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryStaticMethod x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryNew x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryAttributeOrMethod x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "reference"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
nonparenthesizedValueExpressionPrimaryCollection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "collection"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
nonparenthesizedValueExpressionPrimaryArrayElement x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryMultisetElement x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryRoutine x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
nonparenthesizedValueExpressionPrimaryNext x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.NonparenthesizedValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
referenceResolution x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unReferenceResolution x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
referenceValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unReferenceValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
rowValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRowValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
routineInvocation x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRoutineInvocation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
scalarSubquery x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unScalarSubquery x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
scale x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unScale x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
selfReferencingColumnSpecification x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unSelfReferencingColumnSpecification x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
setFunctionSpecification x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unSetFunctionSpecification x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
staticMethodInvocation x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unStaticMethodInvocation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
stringValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unStringValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
subquery x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unSubquery x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
subtableClause x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unSubtableClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
subtypeTreatment x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unSubtypeTreatment x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
tableCommitActionPreserve = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
tableCommitActionDelete = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableCommitAction"),
  Core.injectionField = Core.Field {
...
tableConstraintDefinition x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTableConstraintDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
tableContentsSourceList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
tableContentsSourceSubtable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableContentsSource"),
  Core.injectionField = Core.Field {
...
tableContentsSourceSubquery x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableContentsSource"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "subquery"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
tableContentsSource_Subtable type_ subtable elements = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
tableContentsSource_SubtableType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
tableContentsSource_SubtableSubtable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableContentsSource_Subtable"),
...
tableContentsSource_SubtableElements x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableContentsSource_Subtable"),
...
tableContentsSource_SubtableWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableContentsSource_Subtable"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
tableContentsSource_SubtableWithSubtable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableContentsSource_Subtable"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
tableContentsSource_SubtableWithElements original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableContentsSource_Subtable"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
tableDefinition scope name source commitActions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
tableDefinitionScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
tableDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableDefinition"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tableDefinitionSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableDefinition"),
...
tableDefinitionCommitActions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableDefinition"),
...
tableDefinitionWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
tableDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
tableDefinitionWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
tableDefinitionWithCommitActions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
tableElementColumn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
tableElementTableConstraint x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableElement"),
  Core.injectionField = Core.Field {
...
tableElementLike x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableElement"),
  Core.injectionField = Core.Field {
...
tableElementSelfReferencingColumn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableElement"),
  Core.injectionField = Core.Field {
...
tableElementColumOptions x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableElement"),
  Core.injectionField = Core.Field {
...
tableElementList first rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
tableElementListFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
tableElementListRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableElementList"),
    Core.projectionField = (Core.Name "rest")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tableElementListWithFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableElementList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
tableElementListWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TableElementList"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
tableScope x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTableScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
timeLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unTimeLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
truthValueTRUE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
truthValueFALSE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TruthValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "FALSE"),
    Core.fieldTerm = Core.TermUnit}})))
...
truthValueUNKNOWN = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.TruthValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "UNKNOWN"),
    Core.fieldTerm = Core.TermUnit}})))
...
unsignedLiteralNumeric x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
unsignedLiteralGeneral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.UnsignedLiteral"),
  Core.injectionField = Core.Field {
...
unsignedNumericLiteralExact x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
unsignedNumericLiteralApproximate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.UnsignedNumericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "approximate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
unsignedValueSpecificationLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
unsignedValueSpecificationGeneral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.UnsignedValueSpecification"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "general"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
userDefinedTypeValueExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unUserDefinedTypeValueExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
valueExpressionCommon x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
valueExpressionBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ValueExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "boolean"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
valueExpressionRow x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ValueExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "row"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
valueExpressionPrimaryParens x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
valueExpressionPrimaryNoparens x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.ansi.sql.syntax.ValueExpressionPrimary"),
  Core.injectionField = Core.Field {
...
windowFunction x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unWindowFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
