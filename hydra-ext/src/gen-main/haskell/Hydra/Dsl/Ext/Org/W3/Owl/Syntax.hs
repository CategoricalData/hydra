...
ontology directImports annotations axioms = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
ontologyDirectImports x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
ontologyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Ontology"),
...
ontologyAxioms x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Ontology"),
...
ontologyWithDirectImports original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Ontology"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "directImports"),
...
ontologyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Ontology"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "directImports"),
...
ontologyWithAxioms original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Ontology"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "directImports"),
...
declaration annotations entity = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
declarationAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
declarationEntity x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Declaration"),
...
declarationWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Declaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
declarationWithEntity original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Declaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
entityAnnotationProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
entityClass x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Entity"),
  Core.injectionField = Core.Field {
...
entityDataProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Entity"),
  Core.injectionField = Core.Field {
...
entityDatatype x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Entity"),
  Core.injectionField = Core.Field {
...
entityNamedIndividual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Entity"),
  Core.injectionField = Core.Field {
...
entityObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Entity"),
  Core.injectionField = Core.Field {
...
annotationSubjectIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
annotationSubjectAnonymousIndividual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationSubject"),
  Core.injectionField = Core.Field {
...
annotationValueAnonymousIndividual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
annotationValueIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "iri"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
annotationValueLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationValue"),
  Core.injectionField = Core.Field {
...
annotation annotations property value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
annotationAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
annotationProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Annotation"),
...
annotationValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Annotation"),
...
annotationWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Annotation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Annotation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Annotation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationAxiomAnnotationAssertion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
annotationAxiomAnnotationPropertyDomain x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAxiom"),
  Core.injectionField = Core.Field {
...
annotationAxiomAnnotationPropertyRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAxiom"),
  Core.injectionField = Core.Field {
...
annotationAxiomSubAnnotationPropertyOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAxiom"),
  Core.injectionField = Core.Field {
...
annotationAssertion annotations property subject value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
annotationAssertionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
annotationAssertionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAssertion"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
annotationAssertionSubject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAssertion"),
...
annotationAssertionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAssertion"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
annotationAssertionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationAssertionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationAssertionWithSubject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationAssertionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subAnnotationPropertyOf annotations subProperty superProperty = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
subAnnotationPropertyOfAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
subAnnotationPropertyOfSubProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubAnnotationPropertyOf"),
...
subAnnotationPropertyOfSuperProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubAnnotationPropertyOf"),
...
subAnnotationPropertyOfWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubAnnotationPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subAnnotationPropertyOfWithSubProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubAnnotationPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subAnnotationPropertyOfWithSuperProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubAnnotationPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationPropertyDomain annotations property iri = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
annotationPropertyDomainAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
annotationPropertyDomainProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyDomain"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
annotationPropertyDomainIri x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyDomain"),
...
annotationPropertyDomainWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationPropertyDomainWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationPropertyDomainWithIri original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationPropertyRange annotations property iri = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
annotationPropertyRangeAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
annotationPropertyRangeProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyRange"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
annotationPropertyRangeIri x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyRange"),
    Core.projectionField = (Core.Name "iri")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
annotationPropertyRangeWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationPropertyRangeWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
annotationPropertyRangeWithIri original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AnnotationPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
class_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
datatypeXmlSchema x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
datatypeOther x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Datatype"),
  Core.injectionField = Core.Field {
...
objectProperty x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unObjectProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataProperty x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDataProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
annotationProperty_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unAnnotationProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
individualNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
individualAnonymous x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Individual"),
  Core.injectionField = Core.Field {
...
namedIndividual x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNamedIndividual x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
anonymousIndividual x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unAnonymousIndividual x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
objectPropertyExpressionObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
objectPropertyExpressionInverseObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyExpression"),
  Core.injectionField = Core.Field {
...
inverseObjectProperty x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unInverseObjectProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataPropertyExpression x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDataPropertyExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataRangeDataComplementOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
dataRangeDataIntersectionOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataRange"),
  Core.injectionField = Core.Field {
...
dataRangeDataOneOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataRange"),
  Core.injectionField = Core.Field {
...
dataRangeDataUnionOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataRange"),
  Core.injectionField = Core.Field {
...
dataRangeDatatype x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataRange"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "datatype"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
dataRangeDatatypeRestriction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataRange"),
  Core.injectionField = Core.Field {
...
dataIntersectionOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDataIntersectionOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataUnionOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDataUnionOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataComplementOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDataComplementOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataOneOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDataOneOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
datatypeRestriction datatype constraints = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
datatypeRestrictionDatatype x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
datatypeRestrictionConstraints x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeRestriction"),
...
datatypeRestrictionWithDatatype original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeRestriction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "datatype"),
...
datatypeRestrictionWithConstraints original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeRestriction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "datatype"),
...
datatypeRestriction_Constraint constrainingFacet restrictionValue = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
datatypeRestriction_ConstraintConstrainingFacet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
datatypeRestriction_ConstraintRestrictionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeRestriction_Constraint"),
...
datatypeRestriction_ConstraintWithConstrainingFacet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeRestriction_Constraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constrainingFacet"),
...
datatypeRestriction_ConstraintWithRestrictionValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeRestriction_Constraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constrainingFacet"),
...
datatypeRestriction_ConstrainingFacetXmlSchema x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
datatypeRestriction_ConstrainingFacetOther x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeRestriction_ConstrainingFacet"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "other"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
classExpressionClass x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
classExpressionDataSomeValuesFrom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionDataAllValuesFrom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionDataHasValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionDataMinCardinality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionDataMaxCardinality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionDataExactCardinality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectAllValuesFrom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectExactCardinality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectHasSelf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectHasValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectIntersectionOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectMaxCardinality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectMinCardinality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectOneOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectSomeValuesFrom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
classExpressionObjectUnionOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassExpression"),
  Core.injectionField = Core.Field {
...
objectIntersectionOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unObjectIntersectionOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
objectUnionOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unObjectUnionOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
objectComplementOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unObjectComplementOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
objectOneOf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unObjectOneOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
objectSomeValuesFrom property class_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectSomeValuesFromProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectSomeValuesFromClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectSomeValuesFrom"),
...
objectSomeValuesFromWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectSomeValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
objectSomeValuesFromWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectSomeValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
objectAllValuesFrom property class_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectAllValuesFromProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectAllValuesFromClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectAllValuesFrom"),
    Core.projectionField = (Core.Name "class")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectAllValuesFromWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectAllValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
objectAllValuesFromWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectAllValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
objectHasValue property individual = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectHasValueProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectHasValueIndividual x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectHasValue"),
...
objectHasValueWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectHasValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
objectHasValueWithIndividual original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectHasValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
objectHasSelf x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unObjectHasSelf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
objectMinCardinality bound property class_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectMinCardinalityBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectMinCardinalityProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMinCardinality"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectMinCardinalityClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMinCardinality"),
    Core.projectionField = (Core.Name "class")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectMinCardinalityWithBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMinCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectMinCardinalityWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMinCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectMinCardinalityWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMinCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectMaxCardinality bound property class_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectMaxCardinalityBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectMaxCardinalityProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMaxCardinality"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectMaxCardinalityClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMaxCardinality"),
    Core.projectionField = (Core.Name "class")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectMaxCardinalityWithBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMaxCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectMaxCardinalityWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMaxCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectMaxCardinalityWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectMaxCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectExactCardinality bound property class_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectExactCardinalityBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectExactCardinalityProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectExactCardinality"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectExactCardinalityClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectExactCardinality"),
    Core.projectionField = (Core.Name "class")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectExactCardinalityWithBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectExactCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectExactCardinalityWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectExactCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
objectExactCardinalityWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectExactCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataSomeValuesFrom property range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataSomeValuesFromProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataSomeValuesFromRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataSomeValuesFrom"),
...
dataSomeValuesFromWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataSomeValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
dataSomeValuesFromWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataSomeValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
dataAllValuesFrom property range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataAllValuesFromProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataAllValuesFromRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataAllValuesFrom"),
    Core.projectionField = (Core.Name "range")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataAllValuesFromWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataAllValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
dataAllValuesFromWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataAllValuesFrom"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
dataHasValue property value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataHasValueProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataHasValueValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataHasValue"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataHasValueWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataHasValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
dataHasValueWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataHasValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "property"),
...
dataMinCardinality bound property range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataMinCardinalityBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataMinCardinalityProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMinCardinality"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataMinCardinalityRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMinCardinality"),
    Core.projectionField = (Core.Name "range")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataMinCardinalityWithBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMinCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataMinCardinalityWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMinCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataMinCardinalityWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMinCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataMaxCardinality bound property range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataMaxCardinalityBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataMaxCardinalityProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMaxCardinality"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataMaxCardinalityRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMaxCardinality"),
    Core.projectionField = (Core.Name "range")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataMaxCardinalityWithBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMaxCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataMaxCardinalityWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMaxCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataMaxCardinalityWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataMaxCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataExactCardinality bound property range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataExactCardinalityBound x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataExactCardinalityProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataExactCardinality"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataExactCardinalityRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataExactCardinality"),
    Core.projectionField = (Core.Name "range")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataExactCardinalityWithBound original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataExactCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataExactCardinalityWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataExactCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
dataExactCardinalityWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataExactCardinality"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bound"),
...
axiomAnnotationAxiom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
axiomAssertion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Axiom"),
  Core.injectionField = Core.Field {
...
axiomClassAxiom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Axiom"),
  Core.injectionField = Core.Field {
...
axiomDataPropertyAxiom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Axiom"),
  Core.injectionField = Core.Field {
...
axiomDatatypeDefinition x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Axiom"),
  Core.injectionField = Core.Field {
...
axiomDeclaration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Axiom"),
  Core.injectionField = Core.Field {
...
axiomHasKey x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Axiom"),
  Core.injectionField = Core.Field {
...
axiomObjectPropertyAxiom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Axiom"),
  Core.injectionField = Core.Field {
...
classAxiomDisjointClasses x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
classAxiomDisjointUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAxiom"),
  Core.injectionField = Core.Field {
...
classAxiomEquivalentClasses x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAxiom"),
  Core.injectionField = Core.Field {
...
classAxiomSubClassOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAxiom"),
  Core.injectionField = Core.Field {
...
subClassOf annotations subClass superClass = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
subClassOfAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
subClassOfSubClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubClassOf"),
...
subClassOfSuperClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubClassOf"),
...
subClassOfWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubClassOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subClassOfWithSubClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubClassOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subClassOfWithSuperClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubClassOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
equivalentClasses annotations classes = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
equivalentClassesAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
equivalentClassesClasses x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentClasses"),
...
equivalentClassesWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentClasses"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
equivalentClassesWithClasses original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentClasses"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointClasses annotations classes = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
disjointClassesAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
disjointClassesClasses x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointClasses"),
    Core.projectionField = (Core.Name "classes")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
disjointClassesWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointClasses"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointClassesWithClasses original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointClasses"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointUnion annotations class_ classes = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
disjointUnionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
disjointUnionClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointUnion"),
    Core.projectionField = (Core.Name "class")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
disjointUnionClasses x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointUnion"),
    Core.projectionField = (Core.Name "classes")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
disjointUnionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointUnion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointUnionWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointUnion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointUnionWithClasses original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointUnion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyAxiomAsymmetricObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
objectPropertyAxiomDisjointObjectProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomEquivalentObjectProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomFunctionalObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomInverseFunctionalObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomInverseObjectProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomIrreflexiveObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomObjectPropertyDomain x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomObjectPropertyRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomReflexiveObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomSubObjectPropertyOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomSymmetricObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
objectPropertyAxiomTransitiveObjectProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAxiom"),
  Core.injectionField = Core.Field {
...
subObjectPropertyOf annotations subProperty superProperty = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
subObjectPropertyOfAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
subObjectPropertyOfSubProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubObjectPropertyOf"),
    Core.projectionField = (Core.Name "subProperty")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
subObjectPropertyOfSuperProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubObjectPropertyOf"),
    Core.projectionField = (Core.Name "superProperty")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
subObjectPropertyOfWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubObjectPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subObjectPropertyOfWithSubProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubObjectPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subObjectPropertyOfWithSuperProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubObjectPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
equivalentObjectProperties annotations properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
equivalentObjectPropertiesAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
equivalentObjectPropertiesProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentObjectProperties"),
...
equivalentObjectPropertiesWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentObjectProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
equivalentObjectPropertiesWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentObjectProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointObjectProperties annotations properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
disjointObjectPropertiesAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
disjointObjectPropertiesProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointObjectProperties"),
    Core.projectionField = (Core.Name "properties")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
disjointObjectPropertiesWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointObjectProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointObjectPropertiesWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointObjectProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyDomain annotations property domain = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectPropertyDomainAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectPropertyDomainProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyDomain"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectPropertyDomainDomain x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyDomain"),
...
objectPropertyDomainWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyDomainWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyDomainWithDomain original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyRange annotations property range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectPropertyRangeAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectPropertyRangeProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyRange"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectPropertyRangeRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyRange"),
    Core.projectionField = (Core.Name "range")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectPropertyRangeWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyRangeWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyRangeWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
inverseObjectProperties annotations property1 property2 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
inverseObjectPropertiesAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
inverseObjectPropertiesProperty1 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseObjectProperties"),
...
inverseObjectPropertiesProperty2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseObjectProperties"),
...
inverseObjectPropertiesWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseObjectProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
inverseObjectPropertiesWithProperty1 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseObjectProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
inverseObjectPropertiesWithProperty2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseObjectProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
functionalObjectProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
functionalObjectPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
functionalObjectPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.FunctionalObjectProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionalObjectPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.FunctionalObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
functionalObjectPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.FunctionalObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
inverseFunctionalObjectProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
inverseFunctionalObjectPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
inverseFunctionalObjectPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseFunctionalObjectProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inverseFunctionalObjectPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseFunctionalObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
inverseFunctionalObjectPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.InverseFunctionalObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
reflexiveObjectProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
reflexiveObjectPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
reflexiveObjectPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ReflexiveObjectProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
reflexiveObjectPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ReflexiveObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
reflexiveObjectPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ReflexiveObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
irreflexiveObjectProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
irreflexiveObjectPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
irreflexiveObjectPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.IrreflexiveObjectProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
irreflexiveObjectPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.IrreflexiveObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
irreflexiveObjectPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.IrreflexiveObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
symmetricObjectProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
symmetricObjectPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
symmetricObjectPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SymmetricObjectProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
symmetricObjectPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SymmetricObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
symmetricObjectPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SymmetricObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
asymmetricObjectProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
asymmetricObjectPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
asymmetricObjectPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AsymmetricObjectProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
asymmetricObjectPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AsymmetricObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
asymmetricObjectPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.AsymmetricObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
transitiveObjectProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
transitiveObjectPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
transitiveObjectPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.TransitiveObjectProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
transitiveObjectPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.TransitiveObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
transitiveObjectPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.TransitiveObjectProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyAxiomDataPropertyAxiom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
dataPropertyAxiomDataPropertyRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAxiom"),
  Core.injectionField = Core.Field {
...
dataPropertyAxiomDisjointDataProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAxiom"),
  Core.injectionField = Core.Field {
...
dataPropertyAxiomEquivalentDataProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAxiom"),
  Core.injectionField = Core.Field {
...
dataPropertyAxiomFunctionalDataProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAxiom"),
  Core.injectionField = Core.Field {
...
dataPropertyAxiomSubDataPropertyOf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAxiom"),
  Core.injectionField = Core.Field {
...
subDataPropertyOf annotations subProperty superProperty = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
subDataPropertyOfAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
subDataPropertyOfSubProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubDataPropertyOf"),
    Core.projectionField = (Core.Name "subProperty")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
subDataPropertyOfSuperProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubDataPropertyOf"),
    Core.projectionField = (Core.Name "superProperty")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
subDataPropertyOfWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubDataPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subDataPropertyOfWithSubProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubDataPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
subDataPropertyOfWithSuperProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SubDataPropertyOf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
equivalentDataProperties annotations properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
equivalentDataPropertiesAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
equivalentDataPropertiesProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentDataProperties"),
    Core.projectionField = (Core.Name "properties")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
equivalentDataPropertiesWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentDataProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
equivalentDataPropertiesWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.EquivalentDataProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointDataProperties annotations properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
disjointDataPropertiesAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
disjointDataPropertiesProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointDataProperties"),
    Core.projectionField = (Core.Name "properties")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
disjointDataPropertiesWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointDataProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
disjointDataPropertiesWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DisjointDataProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyDomain annotations property domain = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataPropertyDomainAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataPropertyDomainProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyDomain"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPropertyDomainDomain x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyDomain"),
    Core.projectionField = (Core.Name "domain")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPropertyDomainWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyDomainWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyDomainWithDomain original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyDomain"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyRange annotations property range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataPropertyRangeAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataPropertyRangeProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyRange"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPropertyRangeRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyRange"),
    Core.projectionField = (Core.Name "range")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPropertyRangeWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyRangeWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyRangeWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
functionalDataProperty annotations property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
functionalDataPropertyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
functionalDataPropertyProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.FunctionalDataProperty"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
functionalDataPropertyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.FunctionalDataProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
functionalDataPropertyWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.FunctionalDataProperty"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
datatypeDefinition annotations datatype range = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
datatypeDefinitionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
datatypeDefinitionDatatype x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeDefinition"),
    Core.projectionField = (Core.Name "datatype")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
datatypeDefinitionRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeDefinition"),
    Core.projectionField = (Core.Name "range")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
datatypeDefinitionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
datatypeDefinitionWithDatatype original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
datatypeDefinitionWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DatatypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
hasKey annotations class_ objectProperties dataProperties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
hasKeyAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
hasKeyClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.HasKey"),
    Core.projectionField = (Core.Name "class")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
hasKeyObjectProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.HasKey"),
...
hasKeyDataProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.HasKey"),
...
hasKeyWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.HasKey"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
hasKeyWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.HasKey"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
hasKeyWithObjectProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.HasKey"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
hasKeyWithDataProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.HasKey"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
assertionClassAssertion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
assertionDataPropertyAssertion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Assertion"),
  Core.injectionField = Core.Field {
...
assertionDifferentIndividuals x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Assertion"),
  Core.injectionField = Core.Field {
...
assertionObjectPropertyAssertion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Assertion"),
  Core.injectionField = Core.Field {
...
assertionNegativeDataPropertyAssertion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Assertion"),
  Core.injectionField = Core.Field {
...
assertionNegativeObjectPropertyAssertion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Assertion"),
  Core.injectionField = Core.Field {
...
assertionSameIndividual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.Assertion"),
  Core.injectionField = Core.Field {
...
sameIndividual annotations individuals = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
sameIndividualAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
sameIndividualIndividuals x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SameIndividual"),
...
sameIndividualWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SameIndividual"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
sameIndividualWithIndividuals original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.SameIndividual"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
differentIndividuals annotations individuals = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
differentIndividualsAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
differentIndividualsIndividuals x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DifferentIndividuals"),
    Core.projectionField = (Core.Name "individuals")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
differentIndividualsWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DifferentIndividuals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
differentIndividualsWithIndividuals original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DifferentIndividuals"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
classAssertion annotations class_ individual = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
classAssertionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
classAssertionClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAssertion"),
    Core.projectionField = (Core.Name "class")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
classAssertionIndividual x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAssertion"),
    Core.projectionField = (Core.Name "individual")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
classAssertionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
classAssertionWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
classAssertionWithIndividual original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ClassAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyAssertion annotations property source target = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
objectPropertyAssertionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
objectPropertyAssertionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAssertion"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectPropertyAssertionSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAssertion"),
...
objectPropertyAssertionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAssertion"),
...
objectPropertyAssertionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyAssertionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyAssertionWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
objectPropertyAssertionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.ObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeObjectPropertyAssertion annotations property source target = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
negativeObjectPropertyAssertionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
negativeObjectPropertyAssertionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeObjectPropertyAssertion"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
negativeObjectPropertyAssertionSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeObjectPropertyAssertion"),
    Core.projectionField = (Core.Name "source")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
negativeObjectPropertyAssertionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeObjectPropertyAssertion"),
    Core.projectionField = (Core.Name "target")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
negativeObjectPropertyAssertionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeObjectPropertyAssertionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeObjectPropertyAssertionWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeObjectPropertyAssertionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeObjectPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyAssertion annotations property source target = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
dataPropertyAssertionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
dataPropertyAssertionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAssertion"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPropertyAssertionSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAssertion"),
    Core.projectionField = (Core.Name "source")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPropertyAssertionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAssertion"),
    Core.projectionField = (Core.Name "target")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
dataPropertyAssertionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyAssertionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyAssertionWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
dataPropertyAssertionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.DataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeDataPropertyAssertion annotations property source target = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
negativeDataPropertyAssertionAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
negativeDataPropertyAssertionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeDataPropertyAssertion"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
negativeDataPropertyAssertionSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeDataPropertyAssertion"),
    Core.projectionField = (Core.Name "source")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
negativeDataPropertyAssertionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeDataPropertyAssertion"),
    Core.projectionField = (Core.Name "target")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
negativeDataPropertyAssertionWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeDataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeDataPropertyAssertionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeDataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeDataPropertyAssertionWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeDataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
...
negativeDataPropertyAssertionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.owl.syntax.NegativeDataPropertyAssertion"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annotations"),
