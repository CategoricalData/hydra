...
-- | DSL functions for hydra.ext.org.w3.shacl.model

module Hydra.Dsl.Ext.Org.W3.Shacl.Model where
...
closed isClosed ignoredProperties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
closedIsClosed x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
closedIgnoredProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Closed"),
...
closedWithIsClosed original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Closed"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "isClosed"),
...
closedWithIgnoredProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Closed"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "isClosed"),
...
commonConstraintAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
commonConstraintClosed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintClass x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintDatatype x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintDisjoint x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintEquals x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintHasValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintIn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintLanguageIn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintNodeKind x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintNode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintNot x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintMaxExclusive x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintMaxInclusive x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintMaxLength x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintMinExclusive x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintMinInclusive x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintMinLength x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintPattern x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonConstraintXone x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonConstraint"),
  Core.injectionField = Core.Field {
...
commonProperties constraints deactivated message severity targetClass targetNode targetObjectsOf targetSubjectsOf = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
...
commonPropertiesConstraints x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesDeactivated x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesMessage x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesSeverity x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesTargetClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesTargetNode x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesTargetObjectsOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesTargetSubjectsOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
...
commonPropertiesWithConstraints original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
commonPropertiesWithDeactivated original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
commonPropertiesWithMessage original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
commonPropertiesWithSeverity original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
commonPropertiesWithTargetClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
commonPropertiesWithTargetNode original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
commonPropertiesWithTargetObjectsOf original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
commonPropertiesWithTargetSubjectsOf original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.CommonProperties"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "constraints"),
...
definition iri target = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Definition"),
  Core.recordFields = [
    Core.Field {
...
definitionIri x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Definition"),
    Core.projectionField = (Core.Name "iri")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

definitionTarget :: (Phantoms.TTerm (Model.Definition a) -> Phantoms.TTerm a)
definitionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Definition"),
...
definitionWithIri original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Definition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "iri"),
...
definitionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Definition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "iri"),
...
nodeKindBlankNode = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
nodeKindIri = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeKind"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "iri"),
    Core.fieldTerm = Core.TermUnit}})))
...
nodeKindLiteral = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeKind"),
  Core.injectionField = Core.Field {
...
nodeKindBlankNodeOrIri = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeKind"),
  Core.injectionField = Core.Field {
...
nodeKindBlankNodeOrLiteral = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeKind"),
  Core.injectionField = Core.Field {
...
nodeKindIriOrLiteral = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeKind"),
  Core.injectionField = Core.Field {
...
nodeShape common = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeShape"),
  Core.recordFields = [
    Core.Field {
...
nodeShapeCommon x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeShape"),
...
nodeShapeWithCommon original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.NodeShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
pattern regex flags = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
patternRegex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
patternFlags x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Pattern"),
...
patternWithRegex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Pattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "regex"),
...
patternWithFlags original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Pattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "regex"),
...
propertyShape common constraints defaultValue description name order path = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
      Core.fieldTerm = (Phantoms.unTTerm common)},
...
propertyShapeCommon x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
propertyShapeConstraints x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
    Core.projectionField = (Core.Name "constraints")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyShapeDefaultValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
...
propertyShapeDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
...
propertyShapeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
...
propertyShapeOrder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
...
propertyShapePath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
...
propertyShapeWithCommon original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
propertyShapeWithConstraints original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
propertyShapeWithDefaultValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
propertyShapeWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
propertyShapeWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
propertyShapeWithOrder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
propertyShapeWithPath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "common"),
...
propertyShapeConstraintLessThan x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
propertyShapeConstraintLessThanOrEquals x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShapeConstraint"),
  Core.injectionField = Core.Field {
...
propertyShapeConstraintMaxCount x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShapeConstraint"),
  Core.injectionField = Core.Field {
...
propertyShapeConstraintMinCount x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShapeConstraint"),
  Core.injectionField = Core.Field {
...
propertyShapeConstraintUniqueLang x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShapeConstraint"),
  Core.injectionField = Core.Field {
...
propertyShapeConstraintQualifiedValueShape x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.PropertyShapeConstraint"),
  Core.injectionField = Core.Field {
...
qualifiedValueShape qualifiedValueShape qualifiedMaxCount qualifiedMinCount qualifiedValueShapesDisjoint = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
qualifiedValueShapeQualifiedValueShape x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
qualifiedValueShapeQualifiedMaxCount x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.QualifiedValueShape"),
...
qualifiedValueShapeQualifiedMinCount x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.QualifiedValueShape"),
...
qualifiedValueShapeQualifiedValueShapesDisjoint x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.QualifiedValueShape"),
...
qualifiedValueShapeWithQualifiedValueShape original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.QualifiedValueShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualifiedValueShape"),
...
qualifiedValueShapeWithQualifiedMaxCount original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.QualifiedValueShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualifiedValueShape"),
...
qualifiedValueShapeWithQualifiedMinCount original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.QualifiedValueShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualifiedValueShape"),
...
qualifiedValueShapeWithQualifiedValueShapesDisjoint original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.QualifiedValueShape"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualifiedValueShape"),
...
referenceNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
referenceAnonymous x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Reference"),
  Core.injectionField = Core.Field {
...
referenceDefinition x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Reference"),
  Core.injectionField = Core.Field {
...
severityInfo = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
severityWarning = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Severity"),
  Core.injectionField = Core.Field {
...
severityViolation = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Severity"),
  Core.injectionField = Core.Field {
...
shapeNode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Shape"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "node"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

shapeProperty :: (Phantoms.TTerm Model.PropertyShape -> Phantoms.TTerm Model.Shape)
shapeProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.Shape"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "property"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
shapesGraph x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.w3.shacl.model.ShapesGraph"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unShapesGraph :: (Phantoms.TTerm Model.ShapesGraph -> Phantoms.TTerm (S.Set (Model.Definition Model.Shape)))
unShapesGraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.w3.shacl.model.ShapesGraph")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
