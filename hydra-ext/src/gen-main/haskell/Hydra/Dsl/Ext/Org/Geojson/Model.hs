...
boundingBox x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unBoundingBox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
coordinateRange min max = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
coordinateRangeMin x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
coordinateRangeMax x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.CoordinateRange"),
...
coordinateRangeWithMin original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.CoordinateRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "min"),
...
coordinateRangeWithMax original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.CoordinateRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "min"),
...
feature geometry properties id bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
featureGeometry x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
featureProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Feature"),
...
featureId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Feature"),
...
featureBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Feature"),
...
featureWithGeometry original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Feature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "geometry"),
...
featureWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Feature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "geometry"),
...
featureWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Feature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "geometry"),
...
featureWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Feature"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "geometry"),
...
featureCollection features bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
featureCollectionFeatures x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
featureCollectionBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.FeatureCollection"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
featureCollectionWithFeatures original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.FeatureCollection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "features"),
...
featureCollectionWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.FeatureCollection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "features"),
...
geometryCollection geometries bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
geometryCollectionGeometries x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
geometryCollectionBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.GeometryCollection"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
geometryCollectionWithGeometries original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.GeometryCollection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "geometries"),
...
geometryCollectionWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.GeometryCollection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "geometries"),
...
geometryPoint x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
geometryMultiPoint x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Geometry"),
  Core.injectionField = Core.Field {
...
geometryLineString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Geometry"),
  Core.injectionField = Core.Field {
...
geometryMultiLineString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Geometry"),
  Core.injectionField = Core.Field {
...
geometryPolygon x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Geometry"),
  Core.injectionField = Core.Field {
...
geometryMultiPolygon x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Geometry"),
  Core.injectionField = Core.Field {
...
geometryGeometryCollection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Geometry"),
  Core.injectionField = Core.Field {
...
idNumber x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
idString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Id"),
  Core.injectionField = Core.Field {
...
lineString coordinates bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
lineStringCoordinates x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
lineStringBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.LineString"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
lineStringWithCoordinates original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.LineString"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
lineStringWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.LineString"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
multiLineString coordinates bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
multiLineStringCoordinates x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
multiLineStringBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiLineString"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiLineStringWithCoordinates original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiLineString"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
multiLineStringWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiLineString"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
multiPoint coordinates bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
multiPointCoordinates x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
multiPointBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiPoint"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiPointWithCoordinates original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiPoint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
multiPointWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiPoint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
multiPolygon coordinates bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
multiPolygonCoordinates x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
multiPolygonBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiPolygon"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
multiPolygonWithCoordinates original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiPolygon"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
multiPolygonWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.MultiPolygon"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
objectGeometry x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
objectFeature x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Object"),
  Core.injectionField = Core.Field {
...
objectFeatureCollection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Object"),
  Core.injectionField = Core.Field {
...
point coordinates bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
pointCoordinates x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
pointBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Point"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pointWithCoordinates original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Point"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
pointWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Point"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
polygon coordinates bbox = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
polygonCoordinates x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
polygonBbox x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Polygon"),
    Core.projectionField = (Core.Name "bbox")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
polygonWithCoordinates original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Polygon"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
polygonWithBbox original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Polygon"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "coordinates"),
...
position latitude longitude altitude = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
positionLatitude x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
positionLongitude x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Position"),
...
positionAltitude x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.geojson.model.Position"),
...
positionWithLatitude original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Position"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "latitude"),
...
positionWithLongitude original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Position"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "latitude"),
...
positionWithAltitude original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.geojson.model.Position"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "latitude"),
