...
rdfsClass x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRdfsClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
dataset x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unDataset x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
description subject graph = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
descriptionSubject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
descriptionGraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Description"),
...
descriptionWithSubject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Description"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
descriptionWithGraph original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Description"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
graph x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unGraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
iriOrLiteralIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
iriOrLiteralLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.IriOrLiteral"),
  Core.injectionField = Core.Field {
...
langStrings x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unLangStrings x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
languageTag x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unLanguageTag x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
literal lexicalForm datatypeIri languageTag = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
literalLexicalForm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
literalDatatypeIri x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Literal"),
...
literalLanguageTag x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Literal"),
...
literalWithLexicalForm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Literal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lexicalForm"),
...
literalWithDatatypeIri original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Literal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lexicalForm"),
...
literalWithLanguageTag original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Literal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lexicalForm"),
...
nodeIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
nodeBnode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Node"),
  Core.injectionField = Core.Field {
...
nodeLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Node"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
property domain range subPropertyOf = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
propertyDomain x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
propertyRange x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Property"),
...
propertySubPropertyOf x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Property"),
...
propertyWithDomain original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Property"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "domain"),
...
propertyWithRange original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Property"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "domain"),
...
propertyWithSubPropertyOf original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Property"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "domain"),
...
quad subject predicate object graph = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
quadSubject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
quadPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Quad"),
...
quadObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Quad"),
...
quadGraph x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Quad"),
    Core.projectionField = (Core.Name "graph")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
quadWithSubject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Quad"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
quadWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Quad"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
quadWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Quad"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
quadWithGraph original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Quad"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
resourceIri x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
resourceBnode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Resource"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "bnode"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
triple subject predicate object = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
tripleSubject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
triplePredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Triple"),
    Core.projectionField = (Core.Name "predicate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tripleObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Triple"),
    Core.projectionField = (Core.Name "object")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tripleWithSubject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Triple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
tripleWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Triple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
...
tripleWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.w3.rdf.syntax.Triple"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "subject"),
