...
-- | DSL functions for hydra.ext.org.apache.avro.schema

module Hydra.Dsl.Ext.Org.Apache.Avro.Schema where
...
array items = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Array"),
  Core.recordFields = [
    Core.Field {
...
arrayItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Array"),
...
arrayWithItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Array"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "items"),
...
enum symbols default_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Enum"),
  Core.recordFields = [
    Core.Field {
...
enumSymbols x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Enum"),
    Core.projectionField = (Core.Name "symbols")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

enumDefault :: (Phantoms.TTerm Schema.Enum -> Phantoms.TTerm (Maybe String))
enumDefault x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Enum"),
...
enumWithSymbols original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Enum"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "symbols"),
...
enumWithDefault original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Enum"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "symbols"),
...
field name doc type_ default_ order aliases annotations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
  Core.recordFields = [
    Core.Field {
...
fieldName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fieldDoc :: (Phantoms.TTerm Schema.Field -> Phantoms.TTerm (Maybe String))
fieldDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
...
fieldDefault x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
    Core.projectionField = (Core.Name "default")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldOrder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
...
fieldAliases x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
...
fieldAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
...
fieldWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldWithDefault original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldWithOrder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldWithAliases original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fixed size = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Fixed"),
  Core.recordFields = [
    Core.Field {
...
fixedSize x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Fixed"),
...
fixedWithSize original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Fixed"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "size"),
...
map values = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Map"),
  Core.recordFields = [
    Core.Field {
...
mapValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Map"),
...
mapWithValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Map"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "values"),
...
named name namespace aliases doc type_ annotations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
namedName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

namedNamespace :: (Phantoms.TTerm Schema.Named -> Phantoms.TTerm (Maybe String))
namedNamespace x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
...
namedAliases x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
    Core.projectionField = (Core.Name "aliases")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
namedDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
namedType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
namedAnnotations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
    Core.projectionField = (Core.Name "annotations")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
namedWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
namedWithNamespace original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
namedWithAliases original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
namedWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
namedWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
namedWithAnnotations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Named"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
namedTypeEnum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.NamedType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "enum"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

namedTypeFixed :: (Phantoms.TTerm Schema.Fixed -> Phantoms.TTerm Schema.NamedType)
namedTypeFixed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.NamedType"),
  Core.injectionField = Core.Field {
...
namedTypeRecord x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.NamedType"),
  Core.injectionField = Core.Field {
...
orderAscending = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Order"),
  Core.injectionField = Core.Field {
...
orderIgnore = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Order"),
  Core.injectionField = Core.Field {
...
primitiveNull = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "null"),
    Core.fieldTerm = Core.TermUnit}})))

primitiveBoolean :: (Phantoms.TTerm Schema.Primitive)
primitiveBoolean = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
...
primitiveInt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
...
primitiveLong = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
...
primitiveFloat = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
...
primitiveDouble = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
...
primitiveBytes = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
...
primitiveString = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Primitive"),
  Core.injectionField = Core.Field {
...
record fields = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Record"),
  Core.recordFields = [
    Core.Field {
...
recordFields x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Record"),
...
schemaArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Schema"),
  Core.injectionField = Core.Field {
...
schemaReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Schema"),
  Core.injectionField = Core.Field {
...
union x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.avro.schema.Union"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unUnion :: (Phantoms.TTerm Schema.Union -> Phantoms.TTerm [Schema.Schema])
unUnion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.avro.schema.Union")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
