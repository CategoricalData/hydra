...
-- | DSL functions for hydra.ext.org.apache.tinkerpop.gremlin

module Hydra.Dsl.Ext.Org.Apache.Tinkerpop.Gremlin where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.Org.Apache.Tinkerpop.Gremlin as Gremlin
...
queryList x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.QueryList"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unQueryList :: (Phantoms.TTerm Gremlin.QueryList -> Phantoms.TTerm [Gremlin.Query])
unQueryList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.QueryList")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

queryTraversalSource :: (Phantoms.TTerm Gremlin.TraversalSourceQuery -> Phantoms.TTerm Gremlin.Query)
queryTraversalSource x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Query"),
...
queryRootTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Query"),
  Core.injectionField = Core.Field {
...
queryToString = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Query"),
  Core.injectionField = Core.Field {
...
queryEmpty = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Query"),
  Core.injectionField = Core.Field {
...
traversalSourceQuery source transactionPart = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceQuery"),
  Core.recordFields = [
    Core.Field {
...
traversalSourceQuerySource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceQuery"),
...
traversalSourceQueryTransactionPart x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceQuery"),
...
traversalSourceQueryWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "source"),
...
traversalSourceQueryWithTransactionPart original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "source"),
...
rootTraversalQuery root terminalMethod = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversalQuery"),
  Core.recordFields = [
    Core.Field {
...
rootTraversalQueryRoot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversalQuery"),
...
rootTraversalQueryTerminalMethod x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversalQuery"),
...
rootTraversalQueryWithRoot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversalQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "root"),
...
rootTraversalQueryWithTerminalMethod original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversalQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "root"),
...
traversalSource x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSource"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unTraversalSource :: (Phantoms.TTerm Gremlin.TraversalSource -> Phantoms.TTerm [Gremlin.TraversalSourceSelfMethod])
unTraversalSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSource")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

transactionPartBegin :: (Phantoms.TTerm Gremlin.TransactionPart)
transactionPartBegin = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TransactionPart"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "begin"),
    Core.fieldTerm = Core.TermUnit}})))

transactionPartCommit :: (Phantoms.TTerm Gremlin.TransactionPart)
transactionPartCommit = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TransactionPart"),
  Core.injectionField = Core.Field {
...
transactionPartRollback = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TransactionPart"),
  Core.injectionField = Core.Field {
...
rootTraversal source spawnMethod chained = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "source"),
      Core.fieldTerm = (Phantoms.unTTerm source)},
...
rootTraversalSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversal"),
    Core.projectionField = (Core.Name "source")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rootTraversalSpawnMethod :: (Phantoms.TTerm Gremlin.RootTraversal -> Phantoms.TTerm Gremlin.TraversalSourceSpawnMethod)
rootTraversalSpawnMethod x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversal"),
...
rootTraversalChained x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversal"),
...
rootTraversalWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "source"),
...
rootTraversalWithSpawnMethod original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "source"),
...
rootTraversalWithChained original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RootTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "source"),
...
traversalSourceSelfMethodWithBulk x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSelfMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "withBulk"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalSourceSelfMethodWithPath :: (Phantoms.TTerm Gremlin.TraversalSourceSelfMethod)
traversalSourceSelfMethodWithPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSelfMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSelfMethodWithSack x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSelfMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSelfMethodWithSideEffect x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSelfMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSelfMethodWithStrategies x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSelfMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSelfMethodWithoutStrategies x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSelfMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSelfMethodWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSelfMethod"),
  Core.injectionField = Core.Field {
...
genericLiteralArgumentAndOptionalTraversalBiFunctionArgument literal biFunction = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument"),
  Core.recordFields = [
    Core.Field {
...
genericLiteralArgumentAndOptionalTraversalBiFunctionArgumentLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument"),
...
genericLiteralArgumentAndOptionalTraversalBiFunctionArgumentBiFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument"),
...
genericLiteralArgumentAndOptionalTraversalBiFunctionArgumentWithLiteral original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "literal"),
...
genericLiteralArgumentAndOptionalTraversalBiFunctionArgumentWithBiFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndOptionalTraversalBiFunctionArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "literal"),
...
stringArgumentAndGenericLiteralArgument string literal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
...
stringArgumentAndGenericLiteralArgumentString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndGenericLiteralArgument"),
...
stringArgumentAndGenericLiteralArgumentLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndGenericLiteralArgument"),
    Core.projectionField = (Core.Name "literal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringArgumentAndGenericLiteralArgumentWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
stringArgumentAndGenericLiteralArgumentWithLiteral original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
stringArgumentAndOptionalGenericLiteralArgument string literal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
      Core.fieldTerm = (Phantoms.unTTerm string)},
...
stringArgumentAndOptionalGenericLiteralArgumentString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalGenericLiteralArgument"),
    Core.projectionField = (Core.Name "string")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringArgumentAndOptionalGenericLiteralArgumentLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalGenericLiteralArgument"),
    Core.projectionField = (Core.Name "literal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringArgumentAndOptionalGenericLiteralArgumentWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
stringArgumentAndOptionalGenericLiteralArgumentWithLiteral original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
traversalSourceSpawnMethodAddE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodAddV x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodV x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodMergeV x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodMergeE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodInject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodIo x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodCall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
traversalSourceSpawnMethodUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSourceSpawnMethod"),
  Core.injectionField = Core.Field {
...
genericLiteralMapNullableArgumentOrNestedTraversalMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal"),
  Core.injectionField = Core.Field {
...
genericLiteralMapNullableArgumentOrNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgumentOrNestedTraversal"),
  Core.injectionField = Core.Field {
...
serviceCall service arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ServiceCall"),
  Core.recordFields = [
    Core.Field {
...
serviceCallService x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ServiceCall"),
...
serviceCallArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ServiceCall"),
...
serviceCallWithService original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ServiceCall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "service"),
...
serviceCallWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ServiceCall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "service"),
...
serviceArgumentsMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ServiceArguments"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "map"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

serviceArgumentsTraversal :: (Phantoms.TTerm (Maybe Gremlin.NestedTraversal) -> Phantoms.TTerm Gremlin.ServiceArguments)
serviceArgumentsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ServiceArguments"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
chainedTraversal first rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChainedTraversal"),
  Core.recordFields = [
    Core.Field {
...
chainedTraversalFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChainedTraversal"),
...
chainedTraversalRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChainedTraversal"),
...
chainedTraversalWithFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChainedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
chainedTraversalWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChainedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
chainedTraversalElementMethod x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChainedTraversalElement"),
  Core.injectionField = Core.Field {
...
chainedTraversalElementSelf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChainedTraversalElement"),
  Core.injectionField = Core.Field {
...
nestedTraversalRoot x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "root"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

nestedTraversalChained :: (Phantoms.TTerm Gremlin.ChainedTraversal -> Phantoms.TTerm Gremlin.NestedTraversal)
nestedTraversalChained x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "chained"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
nestedTraversalAnonymous x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversal"),
  Core.injectionField = Core.Field {
...
terminatedTraversal root terminal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TerminatedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "root"),
      Core.fieldTerm = (Phantoms.unTTerm root)},
...
terminatedTraversalRoot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TerminatedTraversal"),
    Core.projectionField = (Core.Name "root")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

terminatedTraversalTerminal :: (Phantoms.TTerm Gremlin.TerminatedTraversal -> Phantoms.TTerm Gremlin.TraversalTerminalMethod)
terminatedTraversalTerminal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TerminatedTraversal"),
...
terminatedTraversalWithRoot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TerminatedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "root"),
...
terminatedTraversalWithTerminal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TerminatedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "root"),
...
traversalMethodV x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "v"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalMethodE :: (Phantoms.TTerm [Gremlin.GenericLiteralArgument] -> Phantoms.TTerm Gremlin.TraversalMethod)
traversalMethodE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "e"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodAddE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "addE"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodAddV x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "addV"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodMergeE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "mergeE"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodMergeV x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "mergeV"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodAggregate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodAll x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodAny x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodAs x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodBarrier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodBoth x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodBothE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodBothV = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodBranch x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodBy x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodCap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodChoose x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodCoalesce x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodCoin x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodConjoin x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodConnectedComponent = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodConstant x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodCount x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodCyclicPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodDedup x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodDifference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodDisjunct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodDrop = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodElementMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodEmit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodFilter x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodFlatMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodFold x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodFrom x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodGroup x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodGroupCount x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodHas x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodHasId x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodHasKey x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodHasLabel x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodHasNot x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodHasValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodId = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodIdentity = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodIn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodInE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodIntersect x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodInV = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodIndex = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodInject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "inject"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodIs x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodKey = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodLabel = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodLimit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodLocal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodLoops x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "map"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodMatch x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodMath x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodMax x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodMean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodMin x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodNone x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodNot x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOption x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOptional x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOrder x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOtherV = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOut x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOutE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodOutV = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodPageRank x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodPeerPressure = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodProfile x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodProject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodProperties x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodPropertyMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodRead = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodRepeat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSack x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSample x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSelect x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodCombine x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodProduct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodMerge x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodShortestPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSideEffect x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSimplePath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSkip x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodStore x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSubgraph x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodTail x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodFail x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodTimes x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodTo x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodToE x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodToV x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodTree x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodUnfold = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "union"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodUntil x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodValue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodValueMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodValues x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodWhere x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "with"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodWrite = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodElement x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodCall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "call"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMethodConcat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodAsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodFormat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodToUpper x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodToLower x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodLength x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodTrim x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodLTrim x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodRTrim x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodReverse = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodReplace x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSplit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodSubstring x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodAsDate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodDateAdd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
traversalMethodDateDiff x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMethod"),
  Core.injectionField = Core.Field {
...
stringArgumentOrNestedTraversalString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentOrNestedTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringArgumentOrNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentOrNestedTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
optionalTraversalScopeArgumentAndStringArgument scope string = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndStringArgument"),
  Core.recordFields = [
    Core.Field {
...
optionalTraversalScopeArgumentAndStringArgumentScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndStringArgument"),
...
optionalTraversalScopeArgumentAndStringArgumentString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndStringArgument"),
    Core.projectionField = (Core.Name "string")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
optionalTraversalScopeArgumentAndStringArgumentWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndStringArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
optionalTraversalScopeArgumentAndStringArgumentWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndStringArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
stringArgumentAndOptionalStringLiteralVarargs first rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalStringLiteralVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
      Core.fieldTerm = (Phantoms.unTTerm first)},
...
stringArgumentAndOptionalStringLiteralVarargsFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalStringLiteralVarargs"),
    Core.projectionField = (Core.Name "first")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringArgumentAndOptionalStringLiteralVarargsRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalStringLiteralVarargs"),
    Core.projectionField = (Core.Name "rest")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringArgumentAndOptionalStringLiteralVarargsWithFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalStringLiteralVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
stringArgumentAndOptionalStringLiteralVarargsWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalStringLiteralVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
traversalSackMethodArgumentOrIntegerArgumentConsumer x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSackMethodArgumentOrIntegerArgument"),
  Core.injectionField = Core.Field {
...
traversalSackMethodArgumentOrIntegerArgumentInt x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSackMethodArgumentOrIntegerArgument"),
  Core.injectionField = Core.Field {
...
byArgsOrder x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ByArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "order"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

byArgsToken :: (Phantoms.TTerm Gremlin.TraversalTokenArgument -> Phantoms.TTerm Gremlin.ByArgs)
byArgsToken x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ByArgs"),
  Core.injectionField = Core.Field {
...
byArgsOther x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ByArgs"),
  Core.injectionField = Core.Field {
...
byOtherArgsComparator x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ByOtherArgs"),
  Core.injectionField = Core.Field {
...
byOtherArgsOther x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ByOtherArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "other"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalFunctionArgumentOrStringArgumentOrNestedTraversalFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunctionArgumentOrStringArgumentOrNestedTraversal"),
  Core.injectionField = Core.Field {
...
traversalFunctionArgumentOrStringArgumentOrNestedTraversalString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunctionArgumentOrStringArgumentOrNestedTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalFunctionArgumentOrStringArgumentOrNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunctionArgumentOrStringArgumentOrNestedTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
chooseArgsFunction x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChooseArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "function"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

chooseArgsPredicateTraversal :: (Phantoms.TTerm Gremlin.PredicateTraversalArgument -> Phantoms.TTerm Gremlin.ChooseArgs)
chooseArgsPredicateTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChooseArgs"),
  Core.injectionField = Core.Field {
...
chooseArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ChooseArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
predicateTraversalArgument predicate traversal1 traversal2 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateTraversalArgument"),
  Core.recordFields = [
    Core.Field {
...
predicateTraversalArgumentPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateTraversalArgument"),
...
predicateTraversalArgumentTraversal1 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateTraversalArgument"),
...
predicateTraversalArgumentTraversal2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateTraversalArgument"),
...
predicateTraversalArgumentWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateTraversalArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "predicate"),
...
predicateTraversalArgumentWithTraversal1 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateTraversalArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "predicate"),
...
predicateTraversalArgumentWithTraversal2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateTraversalArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "predicate"),
...
nestedTraversalArgument traversal1 traversal2 traversal3 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversalArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "traversal1"),
      Core.fieldTerm = (Phantoms.unTTerm traversal1)},
...
nestedTraversalArgumentTraversal1 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversalArgument"),
    Core.projectionField = (Core.Name "traversal1")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nestedTraversalArgumentTraversal2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversalArgument"),
    Core.projectionField = (Core.Name "traversal2")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nestedTraversalArgumentTraversal3 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversalArgument"),
...
nestedTraversalArgumentWithTraversal1 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversalArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "traversal1"),
...
nestedTraversalArgumentWithTraversal2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversalArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "traversal1"),
...
nestedTraversalArgumentWithTraversal3 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversalArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "traversal1"),
...
dedupArgsScopeString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DedupArgs"),
  Core.injectionField = Core.Field {
...
dedupArgsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DedupArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
scopeStringArgument scope strings = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ScopeStringArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
      Core.fieldTerm = (Phantoms.unTTerm scope)},
...
scopeStringArgumentScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ScopeStringArgument"),
    Core.projectionField = (Core.Name "scope")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

scopeStringArgumentStrings :: (Phantoms.TTerm Gremlin.ScopeStringArgument -> Phantoms.TTerm [Gremlin.StringNullableArgument])
scopeStringArgumentStrings x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ScopeStringArgument"),
...
scopeStringArgumentWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ScopeStringArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
scopeStringArgumentWithStrings original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ScopeStringArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
predicateOrTraversalPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateOrTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

predicateOrTraversalTraversal :: (Phantoms.TTerm Gremlin.NestedTraversal -> Phantoms.TTerm Gremlin.PredicateOrTraversal)
predicateOrTraversalTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PredicateOrTraversal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralArgumentAndTraversalBiFunctionArgument literal biFunction = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalBiFunctionArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "literal"),
      Core.fieldTerm = (Phantoms.unTTerm literal)},
...
genericLiteralArgumentAndTraversalBiFunctionArgumentLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalBiFunctionArgument"),
    Core.projectionField = (Core.Name "literal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
genericLiteralArgumentAndTraversalBiFunctionArgumentBiFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalBiFunctionArgument"),
    Core.projectionField = (Core.Name "biFunction")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
genericLiteralArgumentAndTraversalBiFunctionArgumentWithLiteral original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalBiFunctionArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "literal"),
...
genericLiteralArgumentAndTraversalBiFunctionArgumentWithBiFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalBiFunctionArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "literal"),
...
fromArgsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.FromArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

fromArgsVertex :: (Phantoms.TTerm Gremlin.StructureVertexArgument -> Phantoms.TTerm Gremlin.FromArgs)
fromArgsVertex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.FromArgs"),
  Core.injectionField = Core.Field {
...
fromArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.FromArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
hasArgsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

hasArgsTraversalToken :: (Phantoms.TTerm Gremlin.HasTraversalTokenArgs -> Phantoms.TTerm Gremlin.HasArgs)
hasArgsTraversalToken x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasArgs"),
  Core.injectionField = Core.Field {
...
hasStringArgumentAndOptionalStringLiteralVarargs string rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
      Core.fieldTerm = (Phantoms.unTTerm string)},
...
hasStringArgumentAndOptionalStringLiteralVarargsString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargs"),
    Core.projectionField = (Core.Name "string")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
hasStringArgumentAndOptionalStringLiteralVarargsRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargs"),
    Core.projectionField = (Core.Name "rest")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
hasStringArgumentAndOptionalStringLiteralVarargsWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
hasStringArgumentAndOptionalStringLiteralVarargsWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
hasStringArgumentAndOptionalStringLiteralVarargsRestObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest"),
  Core.injectionField = Core.Field {
...
hasStringArgumentAndOptionalStringLiteralVarargsRestPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
hasStringArgumentAndOptionalStringLiteralVarargsRestStringObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest"),
  Core.injectionField = Core.Field {
...
hasStringArgumentAndOptionalStringLiteralVarargsRestStringPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest"),
  Core.injectionField = Core.Field {
...
hasStringArgumentAndOptionalStringLiteralVarargsRestTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasStringArgumentAndOptionalStringLiteralVarargsRest"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringNullableArgumentAndGenericLiteralArgument string literal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
      Core.fieldTerm = (Phantoms.unTTerm string)},
...
stringNullableArgumentAndGenericLiteralArgumentString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument"),
    Core.projectionField = (Core.Name "string")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringNullableArgumentAndGenericLiteralArgumentLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument"),
    Core.projectionField = (Core.Name "literal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringNullableArgumentAndGenericLiteralArgumentWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
stringNullableArgumentAndGenericLiteralArgumentWithLiteral original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndGenericLiteralArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
stringNullableArgumentAndTraversalPredicate string predicate = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
      Core.fieldTerm = (Phantoms.unTTerm string)},
...
stringNullableArgumentAndTraversalPredicateString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate"),
    Core.projectionField = (Core.Name "string")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringNullableArgumentAndTraversalPredicatePredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate"),
    Core.projectionField = (Core.Name "predicate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringNullableArgumentAndTraversalPredicateWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
stringNullableArgumentAndTraversalPredicateWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgumentAndTraversalPredicate"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
hasTraversalTokenArgs traversalToken rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "traversalToken"),
...
hasTraversalTokenArgsTraversalToken x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgs"),
...
hasTraversalTokenArgsRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgs"),
    Core.projectionField = (Core.Name "rest")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
hasTraversalTokenArgsWithTraversalToken original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "traversalToken"),
...
hasTraversalTokenArgsWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "traversalToken"),
...
hasTraversalTokenArgsRestLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgsRest"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
hasTraversalTokenArgsRestPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgsRest"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
hasTraversalTokenArgsRestTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.HasTraversalTokenArgsRest"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralArgumentAndTraversalPredicateLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalPredicate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralArgumentAndTraversalPredicatePredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndTraversalPredicate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateOrStringLiteralVarargsPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateOrStringLiteralVarargs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateOrStringLiteralVarargsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateOrStringLiteralVarargs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateOrGenericLiteralArgumentPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateOrGenericLiteralArgumentLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateOrGenericLiteralArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
optionArgsPredicateTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicateTraversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
optionArgsMergeMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionArgs"),
  Core.injectionField = Core.Field {
...
optionArgsMergeTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionArgs"),
  Core.injectionField = Core.Field {
...
optionArgsObjectTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionArgs"),
  Core.injectionField = Core.Field {
...
optionArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateAndNestedTraversal predicate traversal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "predicate"),
      Core.fieldTerm = (Phantoms.unTTerm predicate)},
...
traversalPredicateAndNestedTraversalPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal"),
    Core.projectionField = (Core.Name "predicate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traversalPredicateAndNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal"),
...
traversalPredicateAndNestedTraversalWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "predicate"),
...
traversalPredicateAndNestedTraversalWithTraversal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicateAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "predicate"),
...
traversalMergeArgumentAndGenericLiteralMapNullableArgument merge map cardinality = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "merge"),
...
traversalMergeArgumentAndGenericLiteralMapNullableArgumentMerge x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument"),
...
traversalMergeArgumentAndGenericLiteralMapNullableArgumentMap x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument"),
...
traversalMergeArgumentAndGenericLiteralMapNullableArgumentCardinality x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument"),
...
traversalMergeArgumentAndGenericLiteralMapNullableArgumentWithMerge original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "merge"),
...
traversalMergeArgumentAndGenericLiteralMapNullableArgumentWithMap original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "merge"),
...
traversalMergeArgumentAndGenericLiteralMapNullableArgumentWithCardinality original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndGenericLiteralMapNullableArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "merge"),
...
traversalMergeArgumentAndNestedTraversal merge traversal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "merge"),
      Core.fieldTerm = (Phantoms.unTTerm merge)},
...
traversalMergeArgumentAndNestedTraversalMerge x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal"),
    Core.projectionField = (Core.Name "merge")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traversalMergeArgumentAndNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal"),
    Core.projectionField = (Core.Name "traversal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traversalMergeArgumentAndNestedTraversalWithMerge original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "merge"),
...
traversalMergeArgumentAndNestedTraversalWithTraversal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "merge"),
...
genericLiteralArgumentAndNestedTraversal object traversal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
genericLiteralArgumentAndNestedTraversalObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal"),
...
genericLiteralArgumentAndNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal"),
    Core.projectionField = (Core.Name "traversal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
genericLiteralArgumentAndNestedTraversalWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
genericLiteralArgumentAndNestedTraversalWithTraversal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
propertyArgsCardinalityObjects x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PropertyArgs"),
  Core.injectionField = Core.Field {
...
propertyArgsObjects x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PropertyArgs"),
  Core.injectionField = Core.Field {
...
propertyArgsObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PropertyArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "object"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
propertyArgsCardinalityObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PropertyArgs"),
  Core.injectionField = Core.Field {
...
traversalCardinalityArgumentAndObjects cardinality objects = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinalityArgumentAndObjects"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "cardinality"),
      Core.fieldTerm = (Phantoms.unTTerm cardinality)},
...
traversalCardinalityArgumentAndObjectsCardinality x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinalityArgumentAndObjects"),
    Core.projectionField = (Core.Name "cardinality")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traversalCardinalityArgumentAndObjectsObjects x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinalityArgumentAndObjects"),
...
traversalCardinalityArgumentAndObjectsWithCardinality original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinalityArgumentAndObjects"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "cardinality"),
...
traversalCardinalityArgumentAndObjectsWithObjects original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinalityArgumentAndObjects"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "cardinality"),
...
genericLiteralMapNullableArgumentAndTraversalCardinalityArgument cardinality object = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "cardinality"),
      Core.fieldTerm = (Phantoms.unTTerm cardinality)},
...
genericLiteralMapNullableArgumentAndTraversalCardinalityArgumentCardinality x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument"),
    Core.projectionField = (Core.Name "cardinality")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
genericLiteralMapNullableArgumentAndTraversalCardinalityArgumentObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument"),
    Core.projectionField = (Core.Name "object")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
genericLiteralMapNullableArgumentAndTraversalCardinalityArgumentWithCardinality original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "cardinality"),
...
genericLiteralMapNullableArgumentAndTraversalCardinalityArgumentWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgumentAndTraversalCardinalityArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "cardinality"),
...
rangeArgs scope min max = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
      Core.fieldTerm = (Phantoms.unTTerm scope)},
...
rangeArgsScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgs"),
    Core.projectionField = (Core.Name "scope")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangeArgsMin :: (Phantoms.TTerm Gremlin.RangeArgs -> Phantoms.TTerm Gremlin.IntegerArgument)
rangeArgsMin x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgs"),
...
rangeArgsMax x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgs"),
...
rangeArgsWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
rangeArgsWithMin original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
rangeArgsWithMax original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
optionalStringArgumentAndNestedTraversal string traversal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalStringArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
      Core.fieldTerm = (Phantoms.unTTerm string)},
...
optionalStringArgumentAndNestedTraversalString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalStringArgumentAndNestedTraversal"),
    Core.projectionField = (Core.Name "string")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
optionalStringArgumentAndNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalStringArgumentAndNestedTraversal"),
    Core.projectionField = (Core.Name "traversal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
optionalStringArgumentAndNestedTraversalWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalStringArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
optionalStringArgumentAndNestedTraversalWithTraversal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalStringArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "string"),
...
optionalTraversalScopeArgumentAndIntegerArgument scope long = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndIntegerArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
      Core.fieldTerm = (Phantoms.unTTerm scope)},
...
optionalTraversalScopeArgumentAndIntegerArgumentScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndIntegerArgument"),
    Core.projectionField = (Core.Name "scope")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
optionalTraversalScopeArgumentAndIntegerArgumentLong x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndIntegerArgument"),
...
optionalTraversalScopeArgumentAndIntegerArgumentWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndIntegerArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
optionalTraversalScopeArgumentAndIntegerArgumentWithLong original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.OptionalTraversalScopeArgumentAndIntegerArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
selectArgsColumn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SelectArgs"),
  Core.injectionField = Core.Field {
...
selectArgsPopStrings x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SelectArgs"),
  Core.injectionField = Core.Field {
...
selectArgsPopTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SelectArgs"),
  Core.injectionField = Core.Field {
...
selectArgsStrings x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SelectArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "strings"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
selectArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SelectArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
popStringsArgument pop string = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PopStringsArgument"),
  Core.recordFields = [
    Core.Field {
...
popStringsArgumentPop x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PopStringsArgument"),
...
popStringsArgumentString x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PopStringsArgument"),
    Core.projectionField = (Core.Name "string")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
popStringsArgumentWithPop original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PopStringsArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pop"),
...
popStringsArgumentWithString original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PopStringsArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pop"),
...
traversalPopArgumentAndNestedTraversal pop traversal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPopArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pop"),
      Core.fieldTerm = (Phantoms.unTTerm pop)},
...
traversalPopArgumentAndNestedTraversalPop x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPopArgumentAndNestedTraversal"),
    Core.projectionField = (Core.Name "pop")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traversalPopArgumentAndNestedTraversalTraversal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPopArgumentAndNestedTraversal"),
    Core.projectionField = (Core.Name "traversal")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traversalPopArgumentAndNestedTraversalWithPop original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPopArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pop"),
...
traversalPopArgumentAndNestedTraversalWithTraversal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPopArgumentAndNestedTraversal"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pop"),
...
tailArgs scope integer = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TailArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
      Core.fieldTerm = (Phantoms.unTTerm scope)},
...
tailArgsScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TailArgs"),
    Core.projectionField = (Core.Name "scope")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

tailArgsInteger :: (Phantoms.TTerm Gremlin.TailArgs -> Phantoms.TTerm (Maybe Gremlin.IntegerArgument))
tailArgsInteger x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TailArgs"),
...
tailArgsWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TailArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
tailArgsWithInteger original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TailArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
toArgsDirection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ToArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "direction"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

toArgsString :: (Phantoms.TTerm Gremlin.StringArgument -> Phantoms.TTerm Gremlin.ToArgs)
toArgsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ToArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
toArgsVertex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ToArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "vertex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
toArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ToArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
directionAndVarargs direction varargs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DirectionAndVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
directionAndVarargsDirection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DirectionAndVarargs"),
...
directionAndVarargsVarargs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DirectionAndVarargs"),
...
directionAndVarargsWithDirection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DirectionAndVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
directionAndVarargsWithVarargs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DirectionAndVarargs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
valueMapArgsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ValueMapArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

valueMapArgsBoolean :: (Phantoms.TTerm Gremlin.ValueMapBooleanArgs -> Phantoms.TTerm Gremlin.ValueMapArgs)
valueMapArgsBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ValueMapArgs"),
  Core.injectionField = Core.Field {
...
valueMapBooleanArgs value keys = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ValueMapBooleanArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
valueMapBooleanArgsValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ValueMapBooleanArgs"),
...
valueMapBooleanArgsKeys x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ValueMapBooleanArgs"),
...
valueMapBooleanArgsWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ValueMapBooleanArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
valueMapBooleanArgsWithKeys original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ValueMapBooleanArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
whereArgsPredicate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "predicate"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

whereArgsString :: (Phantoms.TTerm Gremlin.StringArgument -> Phantoms.TTerm Gremlin.WhereArgs)
whereArgsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
whereArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
whereWithPredicateArgs leftArg predicate = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereWithPredicateArgs"),
  Core.recordFields = [
    Core.Field {
...
whereWithPredicateArgsLeftArg x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereWithPredicateArgs"),
...
whereWithPredicateArgsPredicate x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereWithPredicateArgs"),
    Core.projectionField = (Core.Name "predicate")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
whereWithPredicateArgsWithLeftArg original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereWithPredicateArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "leftArg"),
...
whereWithPredicateArgsWithPredicate original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WhereWithPredicateArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "leftArg"),
...
withArgs keys values = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keys"),
      Core.fieldTerm = (Phantoms.unTTerm keys)},
...
withArgsKeys x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgs"),
    Core.projectionField = (Core.Name "keys")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

withArgsValues :: (Phantoms.TTerm Gremlin.WithArgs -> Phantoms.TTerm (Maybe Gremlin.WithArgsValues))
withArgsValues x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgs"),
...
withArgsWithKeys original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keys"),
...
withArgsWithValues original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "keys"),
...
withArgsKeysWithOption x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgsKeys"),
  Core.injectionField = Core.Field {
...
withArgsKeysString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgsKeys"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
withArgsValuesWithOptions x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgsValues"),
  Core.injectionField = Core.Field {
...
withArgsValuesIo x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "io"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
withArgsValuesObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithArgsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "object"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
concatArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ConcatArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

concatArgsString :: (Phantoms.TTerm [Gremlin.StringNullableArgument] -> Phantoms.TTerm Gremlin.ConcatArgs)
concatArgsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ConcatArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
replaceArgs scope from to = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ReplaceArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
      Core.fieldTerm = (Phantoms.unTTerm scope)},
...
replaceArgsScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ReplaceArgs"),
    Core.projectionField = (Core.Name "scope")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

replaceArgsFrom :: (Phantoms.TTerm Gremlin.ReplaceArgs -> Phantoms.TTerm Gremlin.StringNullableArgument)
replaceArgsFrom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ReplaceArgs"),
...
replaceArgsTo x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ReplaceArgs"),
...
replaceArgsWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ReplaceArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
replaceArgsWithFrom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ReplaceArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
replaceArgsWithTo original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ReplaceArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
splitArgs scope delimiter = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SplitArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
      Core.fieldTerm = (Phantoms.unTTerm scope)},
...
splitArgsScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SplitArgs"),
    Core.projectionField = (Core.Name "scope")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

splitArgsDelimiter :: (Phantoms.TTerm Gremlin.SplitArgs -> Phantoms.TTerm Gremlin.StringNullableArgument)
splitArgsDelimiter x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SplitArgs"),
...
splitArgsWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SplitArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
splitArgsWithDelimiter original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SplitArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
substringArgs scope start end = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
      Core.fieldTerm = (Phantoms.unTTerm scope)},
...
substringArgsScope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs"),
    Core.projectionField = (Core.Name "scope")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

substringArgsStart :: (Phantoms.TTerm Gremlin.SubstringArgs -> Phantoms.TTerm Gremlin.IntegerArgument)
substringArgsStart x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs"),
...
substringArgsEnd x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs"),
...
substringArgsWithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
substringArgsWithStart original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
substringArgsWithEnd original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scope"),
...
dateAddArgs unit duration = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateAddArgs"),
  Core.recordFields = [
    Core.Field {
...
dateAddArgsUnit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateAddArgs"),
...
dateAddArgsDuration x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateAddArgs"),
...
dateAddArgsWithUnit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateAddArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "unit"),
...
dateAddArgsWithDuration original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateAddArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "unit"),
...
dateDiffArgsTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateDiffArgs"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

dateDiffArgsDate :: (Phantoms.TTerm Gremlin.DateArgument -> Phantoms.TTerm Gremlin.DateDiffArgs)
dateDiffArgsDate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateDiffArgs"),
  Core.injectionField = Core.Field {
...
structureVertex new id label = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertex"),
  Core.recordFields = [
    Core.Field {
...
structureVertexNew x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertex"),
...
structureVertexId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertex"),
...
structureVertexLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertex"),
...
structureVertexWithNew original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "new"),
...
structureVertexWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "new"),
...
structureVertexWithLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "new"),
...
traversalStrategy new class_ configurations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalStrategy"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "new"),
      Core.fieldTerm = (Phantoms.unTTerm new)},
...
traversalStrategyNew x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalStrategy"),
    Core.projectionField = (Core.Name "new")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

traversalStrategyClass :: (Phantoms.TTerm Gremlin.TraversalStrategy -> Phantoms.TTerm Gremlin.Identifier)
traversalStrategyClass x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalStrategy"),
...
traversalStrategyConfigurations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalStrategy"),
...
traversalStrategyWithNew original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalStrategy"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "new"),
...
traversalStrategyWithClass original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalStrategy"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "new"),
...
traversalStrategyWithConfigurations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalStrategy"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "new"),
...
configuration key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Configuration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
configurationKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Configuration"),
...
configurationValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Configuration"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
configurationWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Configuration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
configurationWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Configuration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
keywordOrIdentifierKeyword x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.KeywordOrIdentifier"),
  Core.injectionField = Core.Field {
...
keywordOrIdentifierIdentifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.KeywordOrIdentifier"),
  Core.injectionField = Core.Field {
...
traversalScopeLocal = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalScope"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "local"),
    Core.fieldTerm = Core.TermUnit}})))

traversalScopeGlobal :: (Phantoms.TTerm Gremlin.TraversalScope)
traversalScopeGlobal = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalScope"),
  Core.injectionField = Core.Field {
...
traversalTokenId = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalToken"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "id"),
    Core.fieldTerm = Core.TermUnit}})))

traversalTokenLabel :: (Phantoms.TTerm Gremlin.TraversalToken)
traversalTokenLabel = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalToken"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "label"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalTokenKey = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalToken"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "key"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalTokenValue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalToken"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalMergeOnCreate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMerge"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "onCreate"),
    Core.fieldTerm = Core.TermUnit}})))

traversalMergeOnMatch :: (Phantoms.TTerm Gremlin.TraversalMerge)
traversalMergeOnMatch = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMerge"),
  Core.injectionField = Core.Field {
...
traversalMergeOutV = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMerge"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "outV"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalMergeInV = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMerge"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "inV"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalOrderIncr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOrder"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "incr"),
    Core.fieldTerm = Core.TermUnit}})))

traversalOrderDecr :: (Phantoms.TTerm Gremlin.TraversalOrder)
traversalOrderDecr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOrder"),
  Core.injectionField = Core.Field {
...
traversalOrderAsc = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOrder"),
  Core.injectionField = Core.Field {
...
traversalOrderDesc = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOrder"),
  Core.injectionField = Core.Field {
...
traversalOrderShuffle = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOrder"),
  Core.injectionField = Core.Field {
...
traversalDirectionIn = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDirection"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "in"),
    Core.fieldTerm = Core.TermUnit}})))

traversalDirectionOut :: (Phantoms.TTerm Gremlin.TraversalDirection)
traversalDirectionOut = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDirection"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "out"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalDirectionBoth = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDirection"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "both"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalCardinalitySingle x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinality"),
  Core.injectionField = Core.Field {
...
traversalCardinalitySet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinality"),
  Core.injectionField = Core.Field {
...
traversalCardinalityList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinality"),
  Core.injectionField = Core.Field {
...
traversalColumnKeys = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalColumn"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "keys"),
    Core.fieldTerm = Core.TermUnit}})))

traversalColumnValues :: (Phantoms.TTerm Gremlin.TraversalColumn)
traversalColumnValues = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalColumn"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "values"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalPopFirst = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPop"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "first"),
    Core.fieldTerm = Core.TermUnit}})))

traversalPopLast :: (Phantoms.TTerm Gremlin.TraversalPop)
traversalPopLast = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPop"),
  Core.injectionField = Core.Field {
...
traversalPopAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPop"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "all"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalPopMixed = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPop"),
  Core.injectionField = Core.Field {
...
traversalOperatorAddAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "addAll"),
    Core.fieldTerm = Core.TermUnit}})))

traversalOperatorAnd :: (Phantoms.TTerm Gremlin.TraversalOperator)
traversalOperatorAnd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "and"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalOperatorAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
...
traversalOperatorDiv = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
...
traversalOperatorMax = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "max"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalOperatorMin = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "min"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalOperatorMinus = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
...
traversalOperatorMult = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
...
traversalOperatorOr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "or"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalOperatorSum = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sum"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalOperatorSumLong = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOperator"),
  Core.injectionField = Core.Field {
...
traversalPickAny = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPick"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "any"),
    Core.fieldTerm = Core.TermUnit}})))

traversalPickNone :: (Phantoms.TTerm Gremlin.TraversalPick)
traversalPickNone = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPick"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "none"),
    Core.fieldTerm = Core.TermUnit}})))
...
traversalDTSecond = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDT"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "second"),
    Core.fieldTerm = Core.TermUnit}})))

traversalDTMinute :: (Phantoms.TTerm Gremlin.TraversalDT)
traversalDTMinute = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDT"),
  Core.injectionField = Core.Field {
...
traversalDTHour = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDT"),
  Core.injectionField = Core.Field {
...
traversalDTDay = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDT"),
  Core.injectionField = Core.Field {
...
traversalPredicateEq x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateNeq x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateLt x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateLte x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateGt x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateGte x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateInside x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateOutside x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateBetween x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateWithin x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateWithout x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateNot x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "not"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateStartingWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateNotStartingWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateEndingWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateNotEndingWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateContaining x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateNotContaining x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateNotRegex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
traversalPredicateAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "and"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "or"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPredicateNegate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPredicate"),
  Core.injectionField = Core.Field {
...
twoTraversalPredicates left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TwoTraversalPredicates"),
  Core.recordFields = [
    Core.Field {
...
twoTraversalPredicatesLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TwoTraversalPredicates"),
...
twoTraversalPredicatesRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TwoTraversalPredicates"),
...
twoTraversalPredicatesWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TwoTraversalPredicates"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
twoTraversalPredicatesWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TwoTraversalPredicates"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
traversalTerminalMethodExplain = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "explain"),
    Core.fieldTerm = Core.TermUnit}})))

traversalTerminalMethodIterate :: (Phantoms.TTerm Gremlin.TraversalTerminalMethod)
traversalTerminalMethodIterate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
...
traversalTerminalMethodHasNext = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
...
traversalTerminalMethodTryNext = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
...
traversalTerminalMethodNext x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
...
traversalTerminalMethodToList = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
...
traversalTerminalMethodToSet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
...
traversalTerminalMethodToBulkSet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTerminalMethod"),
  Core.injectionField = Core.Field {
...
traversalSelfMethodDiscard = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSelfMethod"),
  Core.injectionField = Core.Field {
...
traversalFunctionToken x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunction"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "token"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalFunctionColumn :: (Phantoms.TTerm Gremlin.TraversalColumn -> Phantoms.TTerm Gremlin.TraversalFunction)
traversalFunctionColumn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunction"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "column"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
rangeArgument min max = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "min"),
      Core.fieldTerm = (Phantoms.unTTerm min)},
...
rangeArgumentMin x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgument"),
    Core.projectionField = (Core.Name "min")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangeArgumentMax :: (Phantoms.TTerm Gremlin.RangeArgument -> Phantoms.TTerm Gremlin.GenericLiteralArgument)
rangeArgumentMax x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgument"),
    Core.projectionField = (Core.Name "max")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rangeArgumentWithMin original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "min"),
...
rangeArgumentWithMax original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.RangeArgument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "min"),
...
withOptionKeysShortestPath x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionKeys"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "shortestPath"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
withOptionKeysConnectedComponent x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionKeys"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "connectedComponent"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
withOptionKeysPageRank x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionKeys"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "pageRank"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
withOptionKeysPeerPressure x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionKeys"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "peerPressure"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
withOptionKeysIo x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionKeys"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "io"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
withOptionKeysWithOptionsTokens = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionKeys"),
  Core.injectionField = Core.Field {
...
withOptionKeysWithOptionsIndexer = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionKeys"),
  Core.injectionField = Core.Field {
...
connectedComponentConstantsComponent = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ConnectedComponentConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "component"),
    Core.fieldTerm = Core.TermUnit}})))

connectedComponentConstantsEdges :: (Phantoms.TTerm Gremlin.ConnectedComponentConstants)
connectedComponentConstantsEdges = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ConnectedComponentConstants"),
  Core.injectionField = Core.Field {
...
connectedComponentConstantsPropertyName = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ConnectedComponentConstants"),
  Core.injectionField = Core.Field {
...
pageRankConstantsEdges = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PageRankConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "edges"),
    Core.fieldTerm = Core.TermUnit}})))

pageRankConstantsTimes :: (Phantoms.TTerm Gremlin.PageRankConstants)
pageRankConstantsTimes = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PageRankConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "times"),
    Core.fieldTerm = Core.TermUnit}})))
...
pageRankConstantsPropertyName = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PageRankConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "propertyName"),
    Core.fieldTerm = Core.TermUnit}})))
...
peerPressureConstantsEdges = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PeerPressureConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "edges"),
    Core.fieldTerm = Core.TermUnit}})))

peerPressureConstantsTimes :: (Phantoms.TTerm Gremlin.PeerPressureConstants)
peerPressureConstantsTimes = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PeerPressureConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "times"),
    Core.fieldTerm = Core.TermUnit}})))
...
peerPressureConstantsPropertyName = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.PeerPressureConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "propertyName"),
    Core.fieldTerm = Core.TermUnit}})))
...
shortestPathConstantsTarget = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ShortestPathConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "target"),
    Core.fieldTerm = Core.TermUnit}})))

shortestPathConstantsEdges :: (Phantoms.TTerm Gremlin.ShortestPathConstants)
shortestPathConstantsEdges = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ShortestPathConstants"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "edges"),
    Core.fieldTerm = Core.TermUnit}})))
...
shortestPathConstantsDistance = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ShortestPathConstants"),
  Core.injectionField = Core.Field {
...
shortestPathConstantsMaxDistance = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ShortestPathConstants"),
  Core.injectionField = Core.Field {
...
shortestPathConstantsIncludeEdges = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.ShortestPathConstants"),
  Core.injectionField = Core.Field {
...
withOptionsValuesTokens = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "tokens"),
    Core.fieldTerm = Core.TermUnit}})))

withOptionsValuesNone :: (Phantoms.TTerm Gremlin.WithOptionsValues)
withOptionsValuesNone = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "none"),
    Core.fieldTerm = Core.TermUnit}})))
...
withOptionsValuesIds = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
...
withOptionsValuesLabels = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
...
withOptionsValuesKeys = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "keys"),
    Core.fieldTerm = Core.TermUnit}})))
...
withOptionsValuesValues = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "values"),
    Core.fieldTerm = Core.TermUnit}})))
...
withOptionsValuesAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "all"),
    Core.fieldTerm = Core.TermUnit}})))
...
withOptionsValuesList = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "list"),
    Core.fieldTerm = Core.TermUnit}})))
...
withOptionsValuesMap = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.WithOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "map"),
    Core.fieldTerm = Core.TermUnit}})))
...
ioOptionsKeysReader = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IoOptionsKeys"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "reader"),
    Core.fieldTerm = Core.TermUnit}})))

ioOptionsKeysWriter :: (Phantoms.TTerm Gremlin.IoOptionsKeys)
ioOptionsKeysWriter = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IoOptionsKeys"),
  Core.injectionField = Core.Field {
...
ioOptionsValuesGryo = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IoOptionsValues"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "gryo"),
    Core.fieldTerm = Core.TermUnit}})))

ioOptionsValuesGraphson :: (Phantoms.TTerm Gremlin.IoOptionsValues)
ioOptionsValuesGraphson = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IoOptionsValues"),
  Core.injectionField = Core.Field {
...
ioOptionsValuesGraphml = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IoOptionsValues"),
  Core.injectionField = Core.Field {
...
booleanArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.BooleanArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

booleanArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.BooleanArgument)
booleanArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.BooleanArgument"),
  Core.injectionField = Core.Field {
...
integerArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

integerArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.IntegerArgument)
integerArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
floatArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.FloatArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

floatArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.FloatArgument)
floatArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.FloatArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

stringArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.StringArgument)
stringArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stringNullableArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

stringNullableArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.StringNullableArgument)
stringNullableArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
dateArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

dateArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.DateArgument)
dateArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

genericLiteralArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.GenericLiteralArgument)
genericLiteralArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralListArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralListArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

genericLiteralListArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.GenericLiteralListArgument)
genericLiteralListArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralListArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralMapArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

genericLiteralMapArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.GenericLiteralMapArgument)
genericLiteralMapArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralMapNullableArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralMapNullableArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMapNullableArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
structureVertexArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertexArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

structureVertexArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.StructureVertexArgument)
structureVertexArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StructureVertexArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalCardinalityArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinalityArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalCardinalityArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalCardinalityArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalColumnArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalColumnArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalColumnArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalColumnArgument)
traversalColumnArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalColumnArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalDirectionArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDirectionArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalDirectionArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalDirectionArgument)
traversalDirectionArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDirectionArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalMergeArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalMergeArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalMergeArgument)
traversalMergeArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalMergeArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalOrderArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOrderArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalOrderArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalOrderArgument)
traversalOrderArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalOrderArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalPopArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPopArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalPopArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalPopArgument)
traversalPopArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalPopArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalSackMethodArgumentValue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSackMethodArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = Core.TermUnit}})))

traversalSackMethodArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalSackMethodArgument)
traversalSackMethodArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalSackMethodArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalScopeArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalScopeArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalScopeArgument)
traversalScopeArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalTokenArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTokenArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalTokenArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalTokenArgument)
traversalTokenArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalTokenArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalComparatorArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalComparatorArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalComparatorArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalComparatorArgument)
traversalComparatorArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalComparatorArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalFunctionArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunctionArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalFunctionArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalFunctionArgument)
traversalFunctionArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunctionArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalBiFunctionArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalBiFunctionArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalBiFunctionArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalBiFunctionArgument)
traversalBiFunctionArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalBiFunctionArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traversalDTArgumentValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDTArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traversalDTArgumentVariable :: (Phantoms.TTerm Gremlin.Identifier -> Phantoms.TTerm Gremlin.TraversalDTArgument)
traversalDTArgumentVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.TraversalDTArgument"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralList x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralList"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unGenericLiteralList :: (Phantoms.TTerm Gremlin.GenericLiteralList -> Phantoms.TTerm [Gremlin.GenericLiteral])
unGenericLiteralList x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralList")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

genericLiteralRangeInteger :: (Phantoms.TTerm Gremlin.IntegerRange -> Phantoms.TTerm Gremlin.GenericLiteralRange)
genericLiteralRangeInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralRange"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "integer"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

genericLiteralRangeString :: (Phantoms.TTerm Gremlin.StringRange -> Phantoms.TTerm Gremlin.GenericLiteralRange)
genericLiteralRangeString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralRange"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
integerRange left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
integerRangeLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerRange"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

integerRangeRight :: (Phantoms.TTerm Gremlin.IntegerRange -> Phantoms.TTerm Gremlin.IntegerLiteral)
integerRangeRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerRange"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
integerRangeWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
integerRangeWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
stringRange left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
      Core.fieldTerm = (Phantoms.unTTerm left)},
...
stringRangeLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringRange"),
    Core.projectionField = (Core.Name "left")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringRangeRight :: (Phantoms.TTerm Gremlin.StringRange -> Phantoms.TTerm String)
stringRangeRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringRange"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
stringRangeWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
stringRangeWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.StringRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
genericLiteralSet x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralSet"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unGenericLiteralSet :: (Phantoms.TTerm Gremlin.GenericLiteralSet -> Phantoms.TTerm [Gremlin.GenericLiteral])
unGenericLiteralSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralSet")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

genericLiteralCollection :: (Phantoms.TTerm [Gremlin.GenericLiteral] -> Phantoms.TTerm Gremlin.GenericLiteralCollection)
genericLiteralCollection x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralCollection"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unGenericLiteralCollection :: (Phantoms.TTerm Gremlin.GenericLiteralCollection -> Phantoms.TTerm [Gremlin.GenericLiteral])
unGenericLiteralCollection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralCollection")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

genericLiteralNumeric :: (Phantoms.TTerm Gremlin.NumericLiteral -> Phantoms.TTerm Gremlin.GenericLiteral)
genericLiteralNumeric x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "numeric"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

genericLiteralBoolean :: (Phantoms.TTerm Bool -> Phantoms.TTerm Gremlin.GenericLiteral)
genericLiteralBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "boolean"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralDate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "date"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralNull = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralNan = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralInf = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralTraversalToken x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversalToken"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericLiteralTraversalCardinality x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralTraversalDirection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralTraversalMerge x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralTraversalPick x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralTraversalDT x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralStructureVertex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralGenericLiteralSet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralGenericLiteralCollection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralGenericLiteralRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralNestedTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralTerminatedTraversal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralGenericLiteralMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteral"),
  Core.injectionField = Core.Field {
...
genericLiteralMap x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMap"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unGenericLiteralMap :: (Phantoms.TTerm Gremlin.GenericLiteralMap -> Phantoms.TTerm [Gremlin.MapEntry])
unGenericLiteralMap x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralMap")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

mapEntryKey :: (Phantoms.TTerm Gremlin.MapKey -> Phantoms.TTerm Gremlin.MapEntry)
mapEntryKey x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapEntry"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "key"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

mapEntryValue :: (Phantoms.TTerm Gremlin.GenericLiteral -> Phantoms.TTerm Gremlin.MapEntry)
mapEntryValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapEntry"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
mapKeyString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

mapKeyNumeric :: (Phantoms.TTerm Gremlin.NumericLiteral -> Phantoms.TTerm Gremlin.MapKey)
mapKeyNumeric x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "numeric"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
mapKeyTraversalToken x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversalToken"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
mapKeyTraversalDirection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "traversalDirection"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
mapKeySet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "set"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
mapKeyCollection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
...
mapKeyMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "map"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
mapKeyKeyword x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "keyword"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
mapKeyIdentifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.MapKey"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "identifier"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
integerLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unIntegerLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.IntegerLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

floatLiteral :: (Phantoms.TTerm Double -> Phantoms.TTerm Gremlin.FloatLiteral)
floatLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.FloatLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unFloatLiteral :: (Phantoms.TTerm Gremlin.FloatLiteral -> Phantoms.TTerm Double)
unFloatLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.FloatLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
numericLiteralInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NumericLiteral"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "integer"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

numericLiteralFloat :: (Phantoms.TTerm Gremlin.FloatLiteral -> Phantoms.TTerm Gremlin.NumericLiteral)
numericLiteralFloat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.NumericLiteral"),
  Core.injectionField = Core.Field {
...
dateLiteral x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateLiteral"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unDateLiteral x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.DateLiteral")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

keywordEdges :: (Phantoms.TTerm Gremlin.Keyword)
keywordEdges = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Keyword"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "edges"),
    Core.fieldTerm = Core.TermUnit}})))

keywordKeys :: (Phantoms.TTerm Gremlin.Keyword)
keywordKeys = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Keyword"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "keys"),
    Core.fieldTerm = Core.TermUnit}})))
...
keywordNew = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Keyword"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "new"),
    Core.fieldTerm = Core.TermUnit}})))
...
keywordValues = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Keyword"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "values"),
    Core.fieldTerm = Core.TermUnit}})))
...
identifier x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Identifier"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unIdentifier x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.apache.tinkerpop.gremlin.Identifier")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
