...
-- | DSL functions for hydra.ext.org.stacspec.items

module Hydra.Dsl.Ext.Org.Stacspec.Items where
...
asset href title description type_ roles = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
  Core.recordFields = [
    Core.Field {
...
assetHref x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
    Core.projectionField = (Core.Name "href")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

assetTitle :: (Phantoms.TTerm Items.Asset -> Phantoms.TTerm (Maybe String))
assetTitle x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
...
assetDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
...
assetType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
...
assetRoles x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
...
assetWithHref original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
assetWithTitle original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
assetWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
assetWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
assetWithRoles original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Asset"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
item feature stacVersion stacExtensions links assets collection = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
  Core.recordFields = [
    Core.Field {
...
itemFeature x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
    Core.projectionField = (Core.Name "feature")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

itemStacVersion :: (Phantoms.TTerm Items.Item -> Phantoms.TTerm Items.StacVersion)
itemStacVersion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
...
itemStacExtensions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
...
itemLinks x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
...
itemAssets x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
...
itemCollection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
...
itemWithFeature original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "feature"),
...
itemWithStacVersion original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "feature"),
...
itemWithStacExtensions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "feature"),
...
itemWithLinks original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "feature"),
...
itemWithAssets original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "feature"),
...
itemWithCollection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Item"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "feature"),
...
link href rel type_ title = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
      Core.fieldTerm = (Phantoms.unTTerm href)},
...
linkHref x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
    Core.projectionField = (Core.Name "href")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

linkRel :: (Phantoms.TTerm Items.Link -> Phantoms.TTerm Items.RelationType)
linkRel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
...
linkType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
linkTitle x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
    Core.projectionField = (Core.Name "title")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
linkWithHref original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
linkWithRel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
linkWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
linkWithTitle original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.stacspec.items.Link"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "href"),
...
mediaType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.stacspec.items.MediaType"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unMediaType :: (Phantoms.TTerm Items.MediaType -> Phantoms.TTerm String)
unMediaType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.stacspec.items.MediaType")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

relationTypeIana :: (Phantoms.TTerm Linkrelations.LinkRelationType -> Phantoms.TTerm Items.RelationType)
relationTypeIana x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.RelationType"),
...
relationTypeStac x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.RelationType"),
  Core.injectionField = Core.Field {
...
relationTypeOther x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.RelationType"),
  Core.injectionField = Core.Field {
...
roleThumbnail = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Role"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "thumbnail"),
    Core.fieldTerm = Core.TermUnit}})))

roleOverview :: (Phantoms.TTerm Items.Role)
roleOverview = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Role"),
  Core.injectionField = Core.Field {
...
roleData = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Role"),
  Core.injectionField = Core.Field {
...
roleMetadata = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Role"),
  Core.injectionField = Core.Field {
...
roleOther x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.Role"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "other"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
stacRelationTypeSelf = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.StacRelationType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "self"),
    Core.fieldTerm = Core.TermUnit}})))

stacRelationTypeRoot :: (Phantoms.TTerm Items.StacRelationType)
stacRelationTypeRoot = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.StacRelationType"),
  Core.injectionField = Core.Field {
...
stacRelationTypeParent = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.StacRelationType"),
  Core.injectionField = Core.Field {
...
stacRelationTypeCollection = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.StacRelationType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "collection"),
    Core.fieldTerm = Core.TermUnit}})))
...
stacRelationTypeDerivedFrom = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.stacspec.items.StacRelationType"),
  Core.injectionField = Core.Field {
...
stacVersion x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.stacspec.items.StacVersion"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unStacVersion :: (Phantoms.TTerm Items.StacVersion -> Phantoms.TTerm String)
unStacVersion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.stacspec.items.StacVersion")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

uri :: (Phantoms.TTerm String -> Phantoms.TTerm Items.Uri)
uri x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.stacspec.items.Uri"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unUri :: (Phantoms.TTerm Items.Uri -> Phantoms.TTerm String)
unUri x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.stacspec.items.Uri")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

url :: (Phantoms.TTerm String -> Phantoms.TTerm Items.Url)
url x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.stacspec.items.Url"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unUrl :: (Phantoms.TTerm Items.Url -> Phantoms.TTerm String)
unUrl x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.stacspec.items.Url")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
