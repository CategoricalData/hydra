...
-- | DSL functions for hydra.ext.org.graphql.syntax

module Hydra.Dsl.Ext.Org.Graphql.Syntax where
...
name x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Name"),
...
unName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.Name")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

intValue :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.IntValue)
intValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.IntValue"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unIntValue :: (Phantoms.TTerm Syntax.IntValue -> Phantoms.TTerm String)
unIntValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.IntValue")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

floatValue :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.FloatValue)
floatValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FloatValue"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unFloatValue :: (Phantoms.TTerm Syntax.FloatValue -> Phantoms.TTerm String)
unFloatValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.FloatValue")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

stringValue :: (Phantoms.TTerm String -> Phantoms.TTerm Syntax.StringValue)
stringValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.StringValue"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unStringValue :: (Phantoms.TTerm Syntax.StringValue -> Phantoms.TTerm String)
unStringValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.StringValue")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

document :: (Phantoms.TTerm [Syntax.Definition] -> Phantoms.TTerm Syntax.Document)
document x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Document"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unDocument :: (Phantoms.TTerm Syntax.Document -> Phantoms.TTerm [Syntax.Definition])
unDocument x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.Document")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

definitionExecutable :: (Phantoms.TTerm Syntax.ExecutableDefinition -> Phantoms.TTerm Syntax.Definition)
definitionExecutable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Definition"),
...
definitionTypeSystem x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Definition"),
  Core.injectionField = Core.Field {
...
executableDocument x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDocument"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unExecutableDocument :: (Phantoms.TTerm Syntax.ExecutableDocument -> Phantoms.TTerm [Syntax.ExecutableDefinition])
unExecutableDocument x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDocument")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

executableDefinitionOperation :: (Phantoms.TTerm Syntax.OperationDefinition -> Phantoms.TTerm Syntax.ExecutableDefinition)
executableDefinitionOperation x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDefinition"),
  Core.injectionField = Core.Field {
...
executableDefinitionFragment x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDefinition"),
  Core.injectionField = Core.Field {
...
operationDefinitionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition"),
  Core.injectionField = Core.Field {
...
operationDefinitionSelectionSet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition"),
  Core.injectionField = Core.Field {
...
operationDefinition_Sequence operationType name variablesDefinition directives selectionSet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
...
operationDefinition_SequenceOperationType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
...
operationDefinition_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
...
operationDefinition_SequenceVariablesDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
...
operationDefinition_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
...
operationDefinition_SequenceSelectionSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
...
operationDefinition_SequenceWithOperationType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
...
operationDefinition_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
...
operationDefinition_SequenceWithVariablesDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
...
operationDefinition_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
...
operationDefinition_SequenceWithSelectionSet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
...
operationTypeQuery = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Query"),
    Core.fieldTerm = Core.TermUnit}})))

operationTypeMutation :: (Phantoms.TTerm Syntax.OperationType)
operationTypeMutation = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationType"),
  Core.injectionField = Core.Field {
...
operationTypeSubscription = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.OperationType"),
  Core.injectionField = Core.Field {
...
selectionSet x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SelectionSet"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSelectionSet :: (Phantoms.TTerm Syntax.SelectionSet -> Phantoms.TTerm [Syntax.Selection])
unSelectionSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.SelectionSet")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

selectionField :: (Phantoms.TTerm Syntax.Field -> Phantoms.TTerm Syntax.Selection)
selectionField x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Selection"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Field"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

selectionFragmentSpread :: (Phantoms.TTerm Syntax.FragmentSpread -> Phantoms.TTerm Syntax.Selection)
selectionFragmentSpread x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Selection"),
  Core.injectionField = Core.Field {
...
selectionInlineFragment x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Selection"),
  Core.injectionField = Core.Field {
...
field alias name arguments directives selectionSet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
  Core.recordFields = [
    Core.Field {
...
fieldAlias x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
    Core.projectionField = (Core.Name "Alias")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fieldName :: (Phantoms.TTerm Syntax.Field -> Phantoms.TTerm Syntax.Name)
fieldName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
...
fieldDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldSelectionSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
    Core.projectionField = (Core.Name "SelectionSet")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldWithAlias original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alias"),
...
fieldWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alias"),
...
fieldWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alias"),
...
fieldWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alias"),
...
fieldWithSelectionSet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Field"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Alias"),
...
aliasName x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Alias"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Name"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

aliasColon :: (Phantoms.TTerm Syntax.Alias)
aliasColon = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Alias"),
  Core.injectionField = Core.Field {
...
arguments x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Arguments"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unArguments :: (Phantoms.TTerm Syntax.Arguments -> Phantoms.TTerm [Syntax.Argument])
unArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.Arguments")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

argument :: (Phantoms.TTerm Syntax.Name -> Phantoms.TTerm Syntax.Value -> Phantoms.TTerm Syntax.Argument)
argument name value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Argument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
argumentName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Argument"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

argumentValue :: (Phantoms.TTerm Syntax.Argument -> Phantoms.TTerm Syntax.Value)
argumentValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Argument"),
...
argumentWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Argument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
argumentWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Argument"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
fragmentSpread fragmentName directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentSpread"),
  Core.recordFields = [
    Core.Field {
...
fragmentSpreadFragmentName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentSpread"),
...
fragmentSpreadDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentSpread"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fragmentSpreadWithFragmentName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentSpread"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "FragmentName"),
...
fragmentSpreadWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentSpread"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "FragmentName"),
...
inlineFragment typeCondition directives selectionSet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InlineFragment"),
  Core.recordFields = [
    Core.Field {
...
inlineFragmentTypeCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InlineFragment"),
...
inlineFragmentDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InlineFragment"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineFragmentSelectionSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InlineFragment"),
    Core.projectionField = (Core.Name "SelectionSet")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inlineFragmentWithTypeCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InlineFragment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "TypeCondition"),
...
inlineFragmentWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InlineFragment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "TypeCondition"),
...
inlineFragmentWithSelectionSet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InlineFragment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "TypeCondition"),
...
fragmentDefinition fragmentName typeCondition directives selectionSet = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "FragmentName"),
      Core.fieldTerm = (Phantoms.unTTerm fragmentName)},
...
fragmentDefinitionFragmentName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
    Core.projectionField = (Core.Name "FragmentName")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fragmentDefinitionTypeCondition :: (Phantoms.TTerm Syntax.FragmentDefinition -> Phantoms.TTerm Syntax.TypeCondition)
fragmentDefinitionTypeCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
    Core.projectionField = (Core.Name "TypeCondition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fragmentDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fragmentDefinitionSelectionSet x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
    Core.projectionField = (Core.Name "SelectionSet")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fragmentDefinitionWithFragmentName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "FragmentName"),
...
fragmentDefinitionWithTypeCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "FragmentName"),
...
fragmentDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "FragmentName"),
...
fragmentDefinitionWithSelectionSet original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "FragmentName"),
...
fragmentName x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FragmentName"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unFragmentName :: (Phantoms.TTerm Syntax.FragmentName -> Phantoms.TTerm Syntax.Name)
unFragmentName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.FragmentName")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeConditionOn :: (Phantoms.TTerm Syntax.TypeCondition)
typeConditionOn = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeCondition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "On"),
    Core.fieldTerm = Core.TermUnit}})))

typeConditionNamedType :: (Phantoms.TTerm Syntax.NamedType -> Phantoms.TTerm Syntax.TypeCondition)
typeConditionNamedType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeCondition"),
  Core.injectionField = Core.Field {
...
valueVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "Variable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

valueInt :: (Phantoms.TTerm Syntax.IntValue -> Phantoms.TTerm Syntax.Value)
valueInt x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueFloat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueNull x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueEnum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Value"),
  Core.injectionField = Core.Field {
...
booleanValueTrue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.BooleanValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "True"),
    Core.fieldTerm = Core.TermUnit}})))

booleanValueFalse :: (Phantoms.TTerm Syntax.BooleanValue)
booleanValueFalse = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.BooleanValue"),
  Core.injectionField = Core.Field {
...
nullValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.NullValue"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unNullValue :: (Phantoms.TTerm Syntax.NullValue -> Phantoms.TTerm ())
unNullValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.NullValue")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

enumValue :: (Phantoms.TTerm Syntax.Name -> Phantoms.TTerm Syntax.EnumValue)
enumValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValue"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unEnumValue :: (Phantoms.TTerm Syntax.EnumValue -> Phantoms.TTerm Syntax.Name)
unEnumValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.EnumValue")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

listValueSequence :: (Phantoms.TTerm Syntax.ListValue_Sequence -> Phantoms.TTerm Syntax.ListValue)
listValueSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ListValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

listValueSequence2 :: (Phantoms.TTerm [Syntax.Value] -> Phantoms.TTerm Syntax.ListValue)
listValueSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ListValue"),
  Core.injectionField = Core.Field {
...
listValue_Sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ListValue_Sequence"),
  Core.recordFields = []})))

objectValueSequence :: (Phantoms.TTerm Syntax.ObjectValue_Sequence -> Phantoms.TTerm Syntax.ObjectValue)
objectValueSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

objectValueSequence2 :: (Phantoms.TTerm [Syntax.ObjectField] -> Phantoms.TTerm Syntax.ObjectValue)
objectValueSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
objectValue_Sequence = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectValue_Sequence"),
  Core.recordFields = []})))

objectField :: (Phantoms.TTerm Syntax.Name -> Phantoms.TTerm Syntax.Value -> Phantoms.TTerm Syntax.ObjectField)
objectField name value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
objectFieldName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectField"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

objectFieldValue :: (Phantoms.TTerm Syntax.ObjectField -> Phantoms.TTerm Syntax.Value)
objectFieldValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectField"),
    Core.projectionField = (Core.Name "Value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectFieldWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectFieldWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
variablesDefinition variable type_ defaultValue directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Variable"),
...
variablesDefinitionVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
...
variablesDefinitionType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
...
variablesDefinitionDefaultValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
...
variablesDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
variablesDefinitionWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Variable"),
...
variablesDefinitionWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Variable"),
...
variablesDefinitionWithDefaultValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Variable"),
...
variablesDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.VariablesDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Variable"),
...
variable x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Variable"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.Variable")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
defaultValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DefaultValue"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unDefaultValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.DefaultValue")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeNamed :: (Phantoms.TTerm Syntax.NamedType -> Phantoms.TTerm Syntax.Type)
typeNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Type"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "named"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

typeList :: (Phantoms.TTerm Syntax.ListType -> Phantoms.TTerm Syntax.Type)
typeList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Type"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "list"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeNonNull x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Type"),
  Core.injectionField = Core.Field {
...
namedType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.NamedType"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unNamedType :: (Phantoms.TTerm Syntax.NamedType -> Phantoms.TTerm Syntax.Name)
unNamedType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.NamedType")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

listType :: (Phantoms.TTerm Syntax.Type -> Phantoms.TTerm Syntax.ListType)
listType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ListType"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unListType :: (Phantoms.TTerm Syntax.ListType -> Phantoms.TTerm Syntax.Type)
unListType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.ListType")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

nonNullTypeNamed :: (Phantoms.TTerm Syntax.NamedType -> Phantoms.TTerm Syntax.NonNullType)
nonNullTypeNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.NonNullType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "named"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

nonNullTypeList :: (Phantoms.TTerm Syntax.ListType -> Phantoms.TTerm Syntax.NonNullType)
nonNullTypeList x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.NonNullType"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "list"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
directives x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Directives"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unDirectives :: (Phantoms.TTerm Syntax.Directives -> Phantoms.TTerm [Syntax.Directive])
unDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.Directives")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

directive :: (Phantoms.TTerm Syntax.Name -> Phantoms.TTerm (Maybe Syntax.Arguments) -> Phantoms.TTerm Syntax.Directive)
directive name arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Directive"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
directiveName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Directive"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

directiveArguments :: (Phantoms.TTerm Syntax.Directive -> Phantoms.TTerm (Maybe Syntax.Arguments))
directiveArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Directive"),
    Core.projectionField = (Core.Name "Arguments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
directiveWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Directive"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
directiveWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Directive"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
typeSystemDocment x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDocment"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unTypeSystemDocment :: (Phantoms.TTerm Syntax.TypeSystemDocment -> Phantoms.TTerm [Syntax.TypeSystemDefinition])
unTypeSystemDocment x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDocment")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeSystemDefinitionSchema :: (Phantoms.TTerm Syntax.SchemaDefinition -> Phantoms.TTerm Syntax.TypeSystemDefinition)
typeSystemDefinitionSchema x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDefinition"),
  Core.injectionField = Core.Field {
...
typeSystemDefinitionType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDefinition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeSystemDefinitionDirective x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDefinition"),
  Core.injectionField = Core.Field {
...
typeSystemExtensionDocument x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemExtensionDocument"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unTypeSystemExtensionDocument x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemExtensionDocument")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeSystemDefinitionOrExtensionDefinition x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDefinitionOrExtension"),
  Core.injectionField = Core.Field {
...
typeSystemDefinitionOrExtensionExtension x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDefinitionOrExtension"),
  Core.injectionField = Core.Field {
...
typeSystemExtensionSchema x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "schema"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

typeSystemExtensionType :: (Phantoms.TTerm Syntax.TypeExtension -> Phantoms.TTerm Syntax.TypeSystemExtension)
typeSystemExtensionType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
schemaDefinition description directives rootOperationTypeDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaDefinition"),
  Core.recordFields = [
    Core.Field {
...
schemaDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaDefinition"),
...
schemaDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
schemaDefinitionRootOperationTypeDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaDefinition"),
...
schemaDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
schemaDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
schemaDefinitionWithRootOperationTypeDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
schemaExtensionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

schemaExtensionSequence2 :: (Phantoms.TTerm Syntax.Directives -> Phantoms.TTerm Syntax.SchemaExtension)
schemaExtensionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
schemaExtension_Sequence directives rootOperationTypeDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Directives"),
      Core.fieldTerm = (Phantoms.unTTerm directives)},
...
schemaExtension_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaExtension_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
schemaExtension_SequenceRootOperationTypeDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaExtension_Sequence"),
    Core.projectionField = (Core.Name "RootOperationTypeDefinition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
schemaExtension_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Directives"),
...
schemaExtension_SequenceWithRootOperationTypeDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.SchemaExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Directives"),
...
rootOperationTypeDefinition operationType namedType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.RootOperationTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
      Core.fieldTerm = (Phantoms.unTTerm operationType)},
...
rootOperationTypeDefinitionOperationType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.RootOperationTypeDefinition"),
    Core.projectionField = (Core.Name "OperationType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rootOperationTypeDefinitionNamedType :: (Phantoms.TTerm Syntax.RootOperationTypeDefinition -> Phantoms.TTerm Syntax.NamedType)
rootOperationTypeDefinitionNamedType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.RootOperationTypeDefinition"),
...
rootOperationTypeDefinitionWithOperationType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.RootOperationTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
...
rootOperationTypeDefinitionWithNamedType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.RootOperationTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "OperationType"),
...
description x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.Description"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unDescription :: (Phantoms.TTerm Syntax.Description -> Phantoms.TTerm Syntax.StringValue)
unDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.Description")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeDefinitionScalar :: (Phantoms.TTerm Syntax.ScalarTypeDefinition -> Phantoms.TTerm Syntax.TypeDefinition)
typeDefinitionScalar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeDefinition"),
  Core.injectionField = Core.Field {
...
typeDefinitionObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeDefinition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "object"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeDefinitionInterface x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeDefinition"),
  Core.injectionField = Core.Field {
...
typeDefinitionUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeDefinition"),
  Core.injectionField = Core.Field {
...
typeDefinitionEnum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeDefinition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "enum"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeDefinitionInputObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeDefinition"),
  Core.injectionField = Core.Field {
...
typeExtensionScalar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "scalar"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

typeExtensionObject :: (Phantoms.TTerm Syntax.ObjectTypeExtension -> Phantoms.TTerm Syntax.TypeExtension)
typeExtensionObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "object"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeExtensionInterface x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "interface"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeExtensionUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "union"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeExtensionEnum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "enum"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeExtensionInputObject x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "inputObject"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
scalarTypeDefinition description name directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
scalarTypeDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

scalarTypeDefinitionName :: (Phantoms.TTerm Syntax.ScalarTypeDefinition -> Phantoms.TTerm Syntax.Name)
scalarTypeDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeDefinition"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
scalarTypeDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
scalarTypeDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
scalarTypeDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
scalarTypeDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
scalarTypeExtension name directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeExtension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
scalarTypeExtensionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeExtension"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

scalarTypeExtensionDirectives :: (Phantoms.TTerm Syntax.ScalarTypeExtension -> Phantoms.TTerm Syntax.Directives)
scalarTypeExtensionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeExtension"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
scalarTypeExtensionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeExtension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
scalarTypeExtensionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ScalarTypeExtension"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeDefinition description name implementsInterfaces directives fieldsDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
objectTypeDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

objectTypeDefinitionName :: (Phantoms.TTerm Syntax.ObjectTypeDefinition -> Phantoms.TTerm Syntax.Name)
objectTypeDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeDefinitionImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
...
objectTypeDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeDefinitionFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
...
objectTypeDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
objectTypeDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
objectTypeDefinitionWithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
objectTypeDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
objectTypeDefinitionWithFieldsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
objectTypeExtensionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
objectTypeExtensionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
objectTypeExtensionSequence3 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension"),
  Core.injectionField = Core.Field {
...
objectTypeExtension_Sequence name implementsInterfaces directives fieldsDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
objectTypeExtension_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_SequenceImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_SequenceFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "FieldsDefinition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_SequenceWithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_SequenceWithFieldsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_Sequence2 name implementsInterfaces directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
objectTypeExtension_Sequence2Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_Sequence2ImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_Sequence2Directives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_Sequence2WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_Sequence2WithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_Sequence2WithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_Sequence3 name implementsInterfaces = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
objectTypeExtension_Sequence3Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence3"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_Sequence3ImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence3"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
objectTypeExtension_Sequence3WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
objectTypeExtension_Sequence3WithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ObjectTypeExtension_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
implementsInterfacesSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
implementsInterfacesSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
implementsInterfaces_Sequence implementsInterfaces namedType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ImplementsInterfaces"),
      Core.fieldTerm = (Phantoms.unTTerm implementsInterfaces)},
...
implementsInterfaces_SequenceImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implementsInterfaces_SequenceNamedType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence"),
    Core.projectionField = (Core.Name "NamedType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implementsInterfaces_SequenceWithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ImplementsInterfaces"),
...
implementsInterfaces_SequenceWithNamedType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ImplementsInterfaces"),
...
implementsInterfaces_Sequence2 amp namedType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence2"),
  Core.recordFields = [
    Core.Field {
...
implementsInterfaces_Sequence2Amp x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence2"),
...
implementsInterfaces_Sequence2NamedType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence2"),
    Core.projectionField = (Core.Name "NamedType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implementsInterfaces_Sequence2WithAmp original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Amp"),
...
implementsInterfaces_Sequence2WithNamedType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ImplementsInterfaces_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Amp"),
...
fieldsDefinition x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldsDefinition"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unFieldsDefinition :: (Phantoms.TTerm Syntax.FieldsDefinition -> Phantoms.TTerm [Syntax.FieldDefinition])
unFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.FieldsDefinition")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldDefinition description name argumentsDefinition type_ directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
fieldDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fieldDefinitionName :: (Phantoms.TTerm Syntax.FieldDefinition -> Phantoms.TTerm Syntax.Name)
fieldDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldDefinitionArgumentsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
...
fieldDefinitionType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
    Core.projectionField = (Core.Name "Type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
fieldDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
fieldDefinitionWithArgumentsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
fieldDefinitionWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
fieldDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.FieldDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
argumentsDefinition x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ArgumentsDefinition"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unArgumentsDefinition :: (Phantoms.TTerm Syntax.ArgumentsDefinition -> Phantoms.TTerm [Syntax.InputValueDefinition])
unArgumentsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.ArgumentsDefinition")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputValueDefinition description name type_ defaultValue directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
inputValueDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

inputValueDefinitionName :: (Phantoms.TTerm Syntax.InputValueDefinition -> Phantoms.TTerm Syntax.Name)
inputValueDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputValueDefinitionType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
    Core.projectionField = (Core.Name "Type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputValueDefinitionDefaultValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
    Core.projectionField = (Core.Name "DefaultValue")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputValueDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputValueDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputValueDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputValueDefinitionWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputValueDefinitionWithDefaultValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputValueDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinitionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
interfaceTypeDefinitionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
interfaceTypeDefinition_Sequence description name implementsInterfaces directives fieldsDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
interfaceTypeDefinition_SequenceDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

interfaceTypeDefinition_SequenceName :: (Phantoms.TTerm Syntax.InterfaceTypeDefinition_Sequence -> Phantoms.TTerm Syntax.Name)
interfaceTypeDefinition_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeDefinition_SequenceImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeDefinition_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeDefinition_SequenceFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "FieldsDefinition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeDefinition_SequenceWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_SequenceWithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_SequenceWithFieldsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_Sequence2 description name implementsInterfaces directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
interfaceTypeDefinition_Sequence2Description x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

interfaceTypeDefinition_Sequence2Name :: (Phantoms.TTerm Syntax.InterfaceTypeDefinition_Sequence2 -> Phantoms.TTerm Syntax.Name)
interfaceTypeDefinition_Sequence2Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeDefinition_Sequence2ImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeDefinition_Sequence2Directives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeDefinition_Sequence2WithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_Sequence2WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_Sequence2WithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeDefinition_Sequence2WithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
interfaceTypeExtensionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
interfaceTypeExtensionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
interfaceTypeExtensionSequence3 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence3"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
interfaceTypeExtension_Sequence name implementsInterfaces directives fieldsDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
interfaceTypeExtension_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_SequenceImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_SequenceFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "FieldsDefinition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_SequenceWithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_SequenceWithFieldsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_Sequence2 name implementsInterfaces directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
interfaceTypeExtension_Sequence2Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_Sequence2ImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_Sequence2Directives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_Sequence2WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_Sequence2WithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_Sequence2WithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_Sequence3 name implementsInterfaces = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
interfaceTypeExtension_Sequence3Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence3"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_Sequence3ImplementsInterfaces x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence3"),
    Core.projectionField = (Core.Name "ImplementsInterfaces")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
interfaceTypeExtension_Sequence3WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
interfaceTypeExtension_Sequence3WithImplementsInterfaces original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InterfaceTypeExtension_Sequence3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
unionTypeDefinition description name directives unionMemberTypes = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
unionTypeDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

unionTypeDefinitionName :: (Phantoms.TTerm Syntax.UnionTypeDefinition -> Phantoms.TTerm Syntax.Name)
unionTypeDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionTypeDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionTypeDefinitionUnionMemberTypes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
...
unionTypeDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
unionTypeDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
unionTypeDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
unionTypeDefinitionWithUnionMemberTypes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
unionMemberTypesSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

unionMemberTypesSequence2 :: (Phantoms.TTerm Syntax.UnionMemberTypes_Sequence2 -> Phantoms.TTerm Syntax.UnionMemberTypes)
unionMemberTypesSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
unionMemberTypes_Sequence unionMemberTypes namedType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnionMemberTypes"),
      Core.fieldTerm = (Phantoms.unTTerm unionMemberTypes)},
...
unionMemberTypes_SequenceUnionMemberTypes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence"),
    Core.projectionField = (Core.Name "UnionMemberTypes")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

unionMemberTypes_SequenceNamedType :: (Phantoms.TTerm Syntax.UnionMemberTypes_Sequence -> Phantoms.TTerm Syntax.NamedType)
unionMemberTypes_SequenceNamedType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence"),
    Core.projectionField = (Core.Name "NamedType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionMemberTypes_SequenceWithUnionMemberTypes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnionMemberTypes"),
...
unionMemberTypes_SequenceWithNamedType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "UnionMemberTypes"),
...
unionMemberTypes_Sequence2 or namedType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence2"),
  Core.recordFields = [
    Core.Field {
...
unionMemberTypes_Sequence2Or x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence2"),
...
unionMemberTypes_Sequence2NamedType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence2"),
    Core.projectionField = (Core.Name "NamedType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionMemberTypes_Sequence2WithOr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Or"),
...
unionMemberTypes_Sequence2WithNamedType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionMemberTypes_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Or"),
...
unionTypeExtensionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

unionTypeExtensionSequence2 :: (Phantoms.TTerm Syntax.UnionTypeExtension_Sequence2 -> Phantoms.TTerm Syntax.UnionTypeExtension)
unionTypeExtensionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
unionTypeExtension_Sequence name directives unionMemberTypes = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
unionTypeExtension_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionTypeExtension_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionTypeExtension_SequenceUnionMemberTypes x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "UnionMemberTypes")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionTypeExtension_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
unionTypeExtension_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
unionTypeExtension_SequenceWithUnionMemberTypes original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
unionTypeExtension_Sequence2 name directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
unionTypeExtension_Sequence2Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionTypeExtension_Sequence2Directives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionTypeExtension_Sequence2WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
unionTypeExtension_Sequence2WithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.UnionTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
enumTypeDefinition description name directives enumValuesDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
enumTypeDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

enumTypeDefinitionName :: (Phantoms.TTerm Syntax.EnumTypeDefinition -> Phantoms.TTerm Syntax.Name)
enumTypeDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumTypeDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumTypeDefinitionEnumValuesDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
...
enumTypeDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
enumTypeDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
enumTypeDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
enumTypeDefinitionWithEnumValuesDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
enumValuesDefinition x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValuesDefinition"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unEnumValuesDefinition :: (Phantoms.TTerm Syntax.EnumValuesDefinition -> Phantoms.TTerm [Syntax.EnumValueDefinition])
unEnumValuesDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.EnumValuesDefinition")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumValueDefinition description enumValue directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
enumValueDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValueDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

enumValueDefinitionEnumValue :: (Phantoms.TTerm Syntax.EnumValueDefinition -> Phantoms.TTerm Syntax.EnumValue)
enumValueDefinitionEnumValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValueDefinition"),
...
enumValueDefinitionDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValueDefinition"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumValueDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
enumValueDefinitionWithEnumValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
enumValueDefinitionWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumValueDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
enumTypeExtensionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

enumTypeExtensionSequence2 :: (Phantoms.TTerm Syntax.EnumTypeExtension_Sequence2 -> Phantoms.TTerm Syntax.EnumTypeExtension)
enumTypeExtensionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
enumTypeExtension_Sequence name directives enumValuesDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
enumTypeExtension_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumTypeExtension_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumTypeExtension_SequenceEnumValuesDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "EnumValuesDefinition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumTypeExtension_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
enumTypeExtension_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
enumTypeExtension_SequenceWithEnumValuesDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
enumTypeExtension_Sequence2 name directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
enumTypeExtension_Sequence2Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

enumTypeExtension_Sequence2Directives :: (Phantoms.TTerm Syntax.EnumTypeExtension_Sequence2 -> Phantoms.TTerm Syntax.Directives)
enumTypeExtension_Sequence2Directives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumTypeExtension_Sequence2WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
enumTypeExtension_Sequence2WithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.EnumTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
inputObjectTypeDefinitionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inputObjectTypeDefinitionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inputObjectTypeDefinition_Sequence description name directives inputFieldsDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
inputObjectTypeDefinition_SequenceDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeDefinition_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeDefinition_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeDefinition_SequenceInputFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
...
inputObjectTypeDefinition_SequenceWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputObjectTypeDefinition_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputObjectTypeDefinition_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputObjectTypeDefinition_SequenceWithInputFieldsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputObjectTypeDefinition_Sequence2 description name directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
inputObjectTypeDefinition_Sequence2Description x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence2"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeDefinition_Sequence2Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence2"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeDefinition_Sequence2Directives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence2"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeDefinition_Sequence2WithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputObjectTypeDefinition_Sequence2WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputObjectTypeDefinition_Sequence2WithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeDefinition_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
inputFieldsDefinition x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputFieldsDefinition"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unInputFieldsDefinition :: (Phantoms.TTerm Syntax.InputFieldsDefinition -> Phantoms.TTerm [Syntax.InputValueDefinition])
unInputFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.org.graphql.syntax.InputFieldsDefinition")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeExtensionSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inputObjectTypeExtensionSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
inputObjectTypeExtension_Sequence name directives inputFieldsDefinition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
inputObjectTypeExtension_SequenceName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeExtension_SequenceDirectives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeExtension_SequenceInputFieldsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence"),
    Core.projectionField = (Core.Name "InputFieldsDefinition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeExtension_SequenceWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
inputObjectTypeExtension_SequenceWithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
inputObjectTypeExtension_SequenceWithInputFieldsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
inputObjectTypeExtension_Sequence2 name directives = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
inputObjectTypeExtension_Sequence2Name x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeExtension_Sequence2Directives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence2"),
    Core.projectionField = (Core.Name "Directives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
inputObjectTypeExtension_Sequence2WithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
inputObjectTypeExtension_Sequence2WithDirectives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.InputObjectTypeExtension_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Name"),
...
directiveDefinition description name argumentsDefinition repeatable directiveLocations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
      Core.fieldTerm = (Phantoms.unTTerm description)},
...
directiveDefinitionDescription x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
    Core.projectionField = (Core.Name "Description")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

directiveDefinitionName :: (Phantoms.TTerm Syntax.DirectiveDefinition -> Phantoms.TTerm Syntax.Name)
directiveDefinitionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
    Core.projectionField = (Core.Name "Name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
directiveDefinitionArgumentsDefinition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
    Core.projectionField = (Core.Name "ArgumentsDefinition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
directiveDefinitionRepeatable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
...
directiveDefinitionDirectiveLocations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
...
directiveDefinitionWithDescription original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
directiveDefinitionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
directiveDefinitionWithArgumentsDefinition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
directiveDefinitionWithRepeatable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
directiveDefinitionWithDirectiveLocations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveDefinition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Description"),
...
directiveLocationsSequence x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

directiveLocationsSequence2 :: (Phantoms.TTerm Syntax.DirectiveLocations_Sequence2 -> Phantoms.TTerm Syntax.DirectiveLocations)
directiveLocationsSequence2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "sequence2"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
directiveLocations_Sequence directiveLocations directiveLocation = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "DirectiveLocations"),
      Core.fieldTerm = (Phantoms.unTTerm directiveLocations)},
...
directiveLocations_SequenceDirectiveLocations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence"),
    Core.projectionField = (Core.Name "DirectiveLocations")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
directiveLocations_SequenceDirectiveLocation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence"),
...
directiveLocations_SequenceWithDirectiveLocations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "DirectiveLocations"),
...
directiveLocations_SequenceWithDirectiveLocation original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "DirectiveLocations"),
...
directiveLocations_Sequence2 or directiveLocation = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Or"),
      Core.fieldTerm = (Phantoms.unTTerm or)},
...
directiveLocations_Sequence2Or x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence2"),
    Core.projectionField = (Core.Name "Or")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
directiveLocations_Sequence2DirectiveLocation x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence2"),
    Core.projectionField = (Core.Name "DirectiveLocation")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
directiveLocations_Sequence2WithOr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Or"),
...
directiveLocations_Sequence2WithDirectiveLocation original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocations_Sequence2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "Or"),
...
directiveLocationExecutable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "executable"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

directiveLocationTypeSystem :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation -> Phantoms.TTerm Syntax.DirectiveLocation)
directiveLocationTypeSystem x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.DirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "typeSystem"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
executableDirectiveLocationQUERY = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "QUERY"),
    Core.fieldTerm = Core.TermUnit}})))

executableDirectiveLocationMUTATION :: (Phantoms.TTerm Syntax.ExecutableDirectiveLocation)
executableDirectiveLocationMUTATION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "MUTATION"),
    Core.fieldTerm = Core.TermUnit}})))
...
executableDirectiveLocationSUBSCRIPTION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "SUBSCRIPTION"),
    Core.fieldTerm = Core.TermUnit}})))
...
executableDirectiveLocationFIELD = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "FIELD"),
    Core.fieldTerm = Core.TermUnit}})))

executableDirectiveLocationFRAGMENTlowbarDEFINITION :: (Phantoms.TTerm Syntax.ExecutableDirectiveLocation)
executableDirectiveLocationFRAGMENTlowbarDEFINITION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "FRAGMENTlowbarDEFINITION"),
    Core.fieldTerm = Core.TermUnit}})))

executableDirectiveLocationFRAGMENTlowbarSPREAD :: (Phantoms.TTerm Syntax.ExecutableDirectiveLocation)
executableDirectiveLocationFRAGMENTlowbarSPREAD = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "FRAGMENTlowbarSPREAD"),
    Core.fieldTerm = Core.TermUnit}})))

executableDirectiveLocationINLINElowbarFRAGMENT :: (Phantoms.TTerm Syntax.ExecutableDirectiveLocation)
executableDirectiveLocationINLINElowbarFRAGMENT = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "INLINElowbarFRAGMENT"),
    Core.fieldTerm = Core.TermUnit}})))

executableDirectiveLocationVARIABLElowbarDEFINITION :: (Phantoms.TTerm Syntax.ExecutableDirectiveLocation)
executableDirectiveLocationVARIABLElowbarDEFINITION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.ExecutableDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "VARIABLElowbarDEFINITION"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationSCHEMA :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationSCHEMA = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "SCHEMA"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationSCALAR :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationSCALAR = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "SCALAR"),
    Core.fieldTerm = Core.TermUnit}})))
...
typeSystemDirectiveLocationOBJECT = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "OBJECT"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationFIELDlowbarDEFINITION :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationFIELDlowbarDEFINITION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "FIELDlowbarDEFINITION"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationARGUMENTlowbarDEFINITION :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationARGUMENTlowbarDEFINITION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "ARGUMENTlowbarDEFINITION"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationINTERFACE :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationINTERFACE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "INTERFACE"),
    Core.fieldTerm = Core.TermUnit}})))
...
typeSystemDirectiveLocationUNION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "UNION"),
    Core.fieldTerm = Core.TermUnit}})))
...
typeSystemDirectiveLocationENUM = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "ENUM"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationENUMlowbarVALUE :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationENUMlowbarVALUE = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "ENUMlowbarVALUE"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationINPUTlowbarOBJECT :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationINPUTlowbarOBJECT = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "INPUTlowbarOBJECT"),
    Core.fieldTerm = Core.TermUnit}})))

typeSystemDirectiveLocationINPUTlowbarFIELDlowbarDEFINITION :: (Phantoms.TTerm Syntax.TypeSystemDirectiveLocation)
typeSystemDirectiveLocationINPUTlowbarFIELDlowbarDEFINITION = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.org.graphql.syntax.TypeSystemDirectiveLocation"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "INPUTlowbarFIELDlowbarDEFINITION"),
    Core.fieldTerm = Core.TermUnit}})))
