...
annotatedApplication annot terms = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
annotatedApplicationAnnot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
annotatedApplicationTerms x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.AnnotatedApplication"),
...
annotatedApplicationWithAnnot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.AnnotatedApplication"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annot"),
...
annotatedApplicationWithTerms original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.AnnotatedApplication"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "annot"),
...
applicationNormal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
applicationAnnotated x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Application"),
  Core.injectionField = Core.Field {
...
argIdent x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
argNatural x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Arg"),
  Core.injectionField = Core.Field {
...
argTerm x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Arg"),
  Core.injectionField = Core.Field {
...
binderName x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
binderType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Binder"),
  Core.injectionField = Core.Field {
...
binderTerm x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Binder"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "term"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
binderImplicit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Binder"),
  Core.injectionField = Core.Field {
...
binderGeneralizing x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Binder"),
  Core.injectionField = Core.Field {
...
binderPattern x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Binder"),
  Core.injectionField = Core.Field {
...
caseItem term as in_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
caseItemTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
caseItemAs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CaseItem"),
...
caseItemIn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CaseItem"),
...
caseItemWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CaseItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
caseItemWithAs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CaseItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
caseItemWithIn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CaseItem"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
cofix body qual = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
cofixBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
cofixQual x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Cofix"),
...
cofixWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Cofix"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
cofixWithQual original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Cofix"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "body"),
...
cofixBody_ ident binders type_ term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
cofixBodyIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
cofixBodyBinders x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixBody"),
...
cofixBodyType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixBody"),
...
cofixBodyTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixBody"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
cofixBodyWithIdent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
cofixBodyWithBinders original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
cofixBodyWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
cofixBodyWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixBody"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
cofixQualIn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
cofixQualWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixQual"),
  Core.injectionField = Core.Field {
...
cofixWith with for = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
cofixWithWith x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
cofixWithFor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixWith"),
...
cofixWithWithWith original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixWith"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "with"),
...
cofixWithWithFor original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.CofixWith"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "with"),
...
equation pattern term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
equationPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
equationTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Equation"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
equationWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Equation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
equationWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Equation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
existentialVariable ident variant = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
existentialVariableIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
existentialVariableVariant x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ExistentialVariable"),
...
existentialVariableWithIdent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ExistentialVariable"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
existentialVariableWithVariant original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ExistentialVariable"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
existentialVariableVariantPlaceholder = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
existentialVariableVariantInside1 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ExistentialVariableVariant"),
  Core.injectionField = Core.Field {
...
existentialVariableVariantInside2 = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ExistentialVariableVariant"),
  Core.injectionField = Core.Field {
...
existentialVariableVariantOutside x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ExistentialVariableVariant"),
  Core.injectionField = Core.Field {
...
fieldIdent x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unFieldIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
fixDecl x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
fixQual x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "qual"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
fixAnnotStruct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
fixAnnotWf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot"),
  Core.injectionField = Core.Field {
...
fixAnnotMeasure x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot"),
  Core.injectionField = Core.Field {
...
fixAnnot_Measure term ident term2 = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
fixAnnot_MeasureTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
fixAnnot_MeasureIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Measure"),
    Core.projectionField = (Core.Name "ident")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fixAnnot_MeasureTerm2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Measure"),
...
fixAnnot_MeasureWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Measure"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
fixAnnot_MeasureWithIdent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Measure"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
fixAnnot_MeasureWithTerm2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Measure"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
fixAnnot_Wf term ident = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
fixAnnot_WfTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
fixAnnot_WfIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Wf"),
    Core.projectionField = (Core.Name "ident")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fixAnnot_WfWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Wf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
fixAnnot_WfWithIdent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixAnnot_Wf"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
fix_Decl ident binders annot type_ term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
fix_DeclIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
fix_DeclBinders x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
    Core.projectionField = (Core.Name "binders")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fix_DeclAnnot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
    Core.projectionField = (Core.Name "annot")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fix_DeclType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fix_DeclTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fix_DeclWithIdent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
fix_DeclWithBinders original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
fix_DeclWithAnnot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
fix_DeclWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
fix_DeclWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Decl"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
fix_QualIn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
fix_QualWith x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fix_Qual"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "with"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
fixWith decls for = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
fixWithDecls x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
fixWithFor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixWith"),
    Core.projectionField = (Core.Name "for")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fixWithWithDecls original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixWith"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "decls"),
...
fixWithWithFor original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.FixWith"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "decls"),
...
forall_ binders type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
forallBinders x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
forallType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Forall"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forallWithBinders original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Forall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "binders"),
...
forallWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Forall"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "binders"),
...
forallOrFunForall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
forallOrFunFun x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ForallOrFun"),
  Core.injectionField = Core.Field {
...
fun binders body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
funBinders x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
funBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fun"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
funWithBinders original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fun"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "binders"),
...
funWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Fun"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "binders"),
...
generalizingBinderExplicit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
generalizingBinderImplicitMaximallyInserted x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.GeneralizingBinder"),
  Core.injectionField = Core.Field {
...
generalizingBinderImplicitNonMaximallyInserted x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.GeneralizingBinder"),
  Core.injectionField = Core.Field {
...
ident x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
identArg ident term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
identArgIdent x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
identArgTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.IdentArg"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
identArgWithIdent original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.IdentArg"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
identArgWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.IdentArg"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ident"),
...
if_ condition returnAs then_ else_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
ifCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
ifReturnAs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.If"),
...
ifThen x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.If"),
...
ifElse x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.If"),
...
ifWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.If"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ifWithReturnAs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.If"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ifWithThen original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.If"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ifWithElse original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.If"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
implicitBindersMaximallyInserted x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
implicitBindersNonMaximallyInserted x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ImplicitBinders"),
  Core.injectionField = Core.Field {
...
let_ bindings in_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letBindings x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letIn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Let"),
    Core.projectionField = (Core.Name "in")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letWithBindings original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Let"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bindings"),
...
letWithIn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Let"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bindings"),
...
letBinder name type_ term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letBinderName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letBinderType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetBinder"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letBinderTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetBinder"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letBinderWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetBinder"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
letBinderWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetBinder"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
letBinderWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetBinder"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
letBindingsNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
letBindingsDestructuring x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetBindings"),
  Core.injectionField = Core.Field {
...
letNamed binder binders = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letNamedBinder x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letNamedBinders x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetNamed"),
    Core.projectionField = (Core.Name "binders")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letNamedWithBinder original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetNamed"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "binder"),
...
letNamedWithBinders original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetNamed"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "binder"),
...
letDestructuringVariant1 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
letDestructuringVariant2 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring"),
  Core.injectionField = Core.Field {
...
letDestructuringVariant3 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring"),
  Core.injectionField = Core.Field {
...
letDestructuring_Variant1 names returnAs term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letDestructuring_Variant1Names x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letDestructuring_Variant1ReturnAs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant1"),
    Core.projectionField = (Core.Name "returnAs")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letDestructuring_Variant1Term x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant1"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letDestructuring_Variant1WithNames original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "names"),
...
letDestructuring_Variant1WithReturnAs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "names"),
...
letDestructuring_Variant1WithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "names"),
...
letDestructuring_Variant2 pattern term return = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letDestructuring_Variant2Pattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letDestructuring_Variant2Term x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant2"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letDestructuring_Variant2Return x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant2"),
...
letDestructuring_Variant2WithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
letDestructuring_Variant2WithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
letDestructuring_Variant2WithReturn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant2"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
letDestructuring_Variant3 pattern1 pattern2 term return = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letDestructuring_Variant3Pattern1 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letDestructuring_Variant3Pattern2 x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant3"),
...
letDestructuring_Variant3Term x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant3"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letDestructuring_Variant3Return x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant3"),
    Core.projectionField = (Core.Name "return")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letDestructuring_Variant3WithPattern1 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern1"),
...
letDestructuring_Variant3WithPattern2 original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern1"),
...
letDestructuring_Variant3WithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern1"),
...
letDestructuring_Variant3WithReturn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.LetDestructuring_Variant3"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern1"),
...
match caseItems return pipe equations = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
matchCaseItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
matchReturn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Match"),
    Core.projectionField = (Core.Name "return")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
matchPipe x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Match"),
...
matchEquations x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Match"),
...
matchWithCaseItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Match"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "caseItems"),
...
matchWithReturn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Match"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "caseItems"),
...
matchWithPipe original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Match"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "caseItems"),
...
matchWithEquations original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Match"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "caseItems"),
...
natural x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNatural x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
naturalArg natural term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
naturalArgNatural x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
naturalArgTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.NaturalArg"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
naturalArgWithNatural original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.NaturalArg"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "natural"),
...
naturalArgWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.NaturalArg"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "natural"),
...
normalApplication lhs rhs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
normalApplicationLhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
normalApplicationRhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.NormalApplication"),
...
normalApplicationWithLhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.NormalApplication"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
normalApplicationWithRhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.NormalApplication"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
number x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unNumber x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
oneTermExplicit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
oneTermTerm1 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.OneTerm"),
  Core.injectionField = Core.Field {
...
openBindersType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
openBindersBinders x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.OpenBinders"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "binders"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternPattern x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
patternTerm x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "term"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
pattern0Qualid x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
pattern0QualIdAndPattern x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern0"),
  Core.injectionField = Core.Field {
...
pattern0Placeholder = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern0"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "placeholder"),
    Core.fieldTerm = Core.TermUnit}})))
...
pattern0Parens x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern0"),
  Core.injectionField = Core.Field {
...
pattern0Number x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern0"),
  Core.injectionField = Core.Field {
...
pattern0String x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern0"),
  Core.injectionField = Core.Field {
...
pattern1 pattern scope = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
pattern1Pattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
pattern1Scope x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern1"),
...
pattern1WithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
pattern1WithScope original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern1"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
pattern10As x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
pattern10Patterns x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10"),
  Core.injectionField = Core.Field {
...
pattern10Qualiid x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10"),
  Core.injectionField = Core.Field {
...
pattern10_As pattern as = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
pattern10_AsPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
pattern10_AsAs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_As"),
    Core.projectionField = (Core.Name "as")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pattern10_AsWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_As"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
pattern10_AsWithAs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_As"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
pattern10_Patterns pattern patterns = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
pattern10_PatternsPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
pattern10_PatternsPatterns x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_Patterns"),
...
pattern10_PatternsWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_Patterns"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
pattern10_PatternsWithPatterns original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_Patterns"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
pattern10_Qualid qualid patterns = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
pattern10_QualidQualid x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
pattern10_QualidPatterns x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_Qualid"),
    Core.projectionField = (Core.Name "patterns")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
pattern10_QualidWithQualid original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_Qualid"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualid"),
...
pattern10_QualidWithPatterns original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Pattern10_Qualid"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualid"),
...
primitiveNotationsNumber x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
primitiveNotationsString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.PrimitiveNotations"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "string"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
qualid id fieldIds = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
qualidId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
qualidFieldIds x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Qualid"),
...
qualidWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Qualid"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
qualidWithFieldIds original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Qualid"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
qualidAndPattern qualid pattern = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
qualidAndPatternQualid x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
qualidAndPatternPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.QualidAndPattern"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
qualidAndPatternWithQualid original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.QualidAndPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualid"),
...
qualidAndPatternWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.QualidAndPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualid"),
...
qualidAnnotated qualid univAnnot = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
qualidAnnotatedQualid x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
qualidAnnotatedUnivAnnot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.QualidAnnotated"),
...
qualidAnnotatedWithQualid original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.QualidAnnotated"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualid"),
...
qualidAnnotatedWithUnivAnnot original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.QualidAnnotated"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "qualid"),
...
returnAs as return = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
returnAsAs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
returnAsReturn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ReturnAs"),
    Core.projectionField = (Core.Name "return")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
returnAsWithAs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ReturnAs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "as"),
...
returnAsWithReturn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.ReturnAs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "as"),
...
scopeKey x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unScopeKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
sortSet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
sortProp = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Sort"),
  Core.injectionField = Core.Field {
...
sortSProp = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Sort"),
  Core.injectionField = Core.Field {
...
sortType = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Sort"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = Core.TermUnit}})))
...
sortTypeWithAnyUniverse = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Sort"),
  Core.injectionField = Core.Field {
...
sortTypeWithUniverse x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Sort"),
  Core.injectionField = Core.Field {
...
termForallOrFun x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
termLet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term"),
  Core.injectionField = Core.Field {
...
termIf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term"),
  Core.injectionField = Core.Field {
...
termFix x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term"),
  Core.injectionField = Core.Field {
...
termCofix x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term"),
  Core.injectionField = Core.Field {
...
termTerm100 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term"),
  Core.injectionField = Core.Field {
...
term0QualidAnnotated x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
term0Sort x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
...
term0PrimitiveNotations x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
...
term0Evar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
...
term0Match x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
...
term0Record = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
...
term0Generalizing = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "generalizing"),
    Core.fieldTerm = Core.TermUnit}})))
...
term0Ltac = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
...
term0Parens x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term0"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "parens"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
term1Projection = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
term1Scope = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term1"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "scope"),
    Core.fieldTerm = Core.TermUnit}})))
...
term1Term0 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term1"),
  Core.injectionField = Core.Field {
...
term10Application x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
term10OneTerm x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term10"),
  Core.injectionField = Core.Field {
...
term100Cast x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
term100Term10 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Term100"),
  Core.injectionField = Core.Field {
...
type_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
typeCast term type_ operator = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
typeCastTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
typeCastType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeCast"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeCastOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeCast"),
...
typeCastWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeCast"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
typeCastWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeCast"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
typeCastWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeCast"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "term"),
...
typeCastOperatorNormal = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
typeCastOperatorVmCompute = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeCastOperator"),
  Core.injectionField = Core.Field {
...
typeCastOperatorNativeCompute = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeCastOperator"),
  Core.injectionField = Core.Field {
...
typeBinders names type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
typeBindersNames x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
typeBindersType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeBinders"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeBindersWithNames original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeBinders"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "names"),
...
typeBindersWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeBinders"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "names"),
...
typeclassConstraint name generalizing term = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
typeclassConstraintName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
typeclassConstraintGeneralizing x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeclassConstraint"),
...
typeclassConstraintTerm x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeclassConstraint"),
    Core.projectionField = (Core.Name "term")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeclassConstraintWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeclassConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeclassConstraintWithGeneralizing original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeclassConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeclassConstraintWithTerm original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.TypeclassConstraint"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
univAnnot x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unUnivAnnot x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
universeMax x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
universeExpr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Universe"),
  Core.injectionField = Core.Field {
...
universe_Expr name number = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
universe_ExprName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
universe_ExprNumber x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Universe_Expr"),
...
universe_ExprWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Universe_Expr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
universe_ExprWithNumber original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.Universe_Expr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
universeLevelSet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
universeLevelProp = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.UniverseLevel"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "prop"),
    Core.fieldTerm = Core.TermUnit}})))
...
universeLevelType = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.UniverseLevel"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = Core.TermUnit}})))
...
universeLevelIgnored = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.UniverseLevel"),
  Core.injectionField = Core.Field {
...
universeLevelQualid x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.UniverseLevel"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "qualid"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
universeNameQualid x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
universeNameSet = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.UniverseName"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "set"),
    Core.fieldTerm = Core.TermUnit}})))
...
universeNameProp = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.fr.inria.coq.syntax.UniverseName"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "prop"),
    Core.fieldTerm = Core.TermUnit}})))
