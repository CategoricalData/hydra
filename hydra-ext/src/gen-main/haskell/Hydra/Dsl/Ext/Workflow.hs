...
-- | DSL functions for hydra.ext.workflow

module Hydra.Dsl.Ext.Workflow where
...
hydraSchemaSpec modules typeName = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
hydraSchemaSpecModules x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.workflow.HydraSchemaSpec"),
...
hydraSchemaSpecTypeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.workflow.HydraSchemaSpec"),
...
hydraSchemaSpecWithModules original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.workflow.HydraSchemaSpec"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "modules"),
...
hydraSchemaSpecWithTypeName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.workflow.HydraSchemaSpec"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "modules"),
...
schemaSpecHydra x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
schemaSpecFile x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.workflow.SchemaSpec"),
  Core.injectionField = Core.Field {
...
schemaSpecProvided = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.workflow.SchemaSpec"),
  Core.injectionField = Core.Field {
...
transformWorkflow name schemaSpec srcDir destDir = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
transformWorkflowName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
transformWorkflowSchemaSpec x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.workflow.TransformWorkflow"),
...
transformWorkflowSrcDir x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.workflow.TransformWorkflow"),
...
transformWorkflowDestDir x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.workflow.TransformWorkflow"),
...
transformWorkflowWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.workflow.TransformWorkflow"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
transformWorkflowWithSchemaSpec original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.workflow.TransformWorkflow"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
transformWorkflowWithSrcDir original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.workflow.TransformWorkflow"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
transformWorkflowWithDestDir original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.workflow.TransformWorkflow"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
