...
-- | DSL functions for hydra.ext.rust.syntax

module Hydra.Dsl.Ext.Rust.Syntax where
...
crate items = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Crate"),
  Core.recordFields = [
    Core.Field {
...
crateItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.Crate"),
...
crateWithItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Crate"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "items"),
...
itemUse x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "use"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

itemStruct :: (Phantoms.TTerm Syntax.StructDef -> Phantoms.TTerm Syntax.Item)
itemStruct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemEnum x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemFn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemTypeAlias x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemImpl x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemTrait x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemMod x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemConst x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemStatic x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemMacro x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Item"),
  Core.injectionField = Core.Field {
...
itemWithComments doc visibility item = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ItemWithComments"),
  Core.recordFields = [
    Core.Field {
...
itemWithCommentsDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ItemWithComments"),
...
itemWithCommentsVisibility x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ItemWithComments"),
...
itemWithCommentsItem x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ItemWithComments"),
...
itemWithCommentsWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ItemWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "doc"),
...
itemWithCommentsWithVisibility original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ItemWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "doc"),
...
itemWithCommentsWithItem original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ItemWithComments"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "doc"),
...
useDeclaration public tree = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseDeclaration"),
  Core.recordFields = [
    Core.Field {
...
useDeclarationPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseDeclaration"),
...
useDeclarationTree x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseDeclaration"),
...
useDeclarationWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "public"),
...
useDeclarationWithTree original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseDeclaration"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "public"),
...
useTreePath x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseTree"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "path"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

useTreeRename :: (Phantoms.TTerm Syntax.UseRename -> Phantoms.TTerm Syntax.UseTree)
useTreeRename x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseTree"),
  Core.injectionField = Core.Field {
...
useTreeGlob x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseTree"),
  Core.injectionField = Core.Field {
...
useTreeGroup x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseTree"),
  Core.injectionField = Core.Field {
...
usePath segments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UsePath"),
  Core.recordFields = [
    Core.Field {
...
usePathSegments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UsePath"),
...
usePathWithSegments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UsePath"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "segments"),
...
useRename path alias = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseRename"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
useRenamePath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseRename"),
    Core.projectionField = (Core.Name "path")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

useRenameAlias :: (Phantoms.TTerm Syntax.UseRename -> Phantoms.TTerm String)
useRenameAlias x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseRename"),
...
useRenameWithPath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseRename"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
useRenameWithAlias original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseRename"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
useGroup prefix trees = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseGroup"),
  Core.recordFields = [
    Core.Field {
...
useGroupPrefix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseGroup"),
    Core.projectionField = (Core.Name "prefix")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

useGroupTrees :: (Phantoms.TTerm Syntax.UseGroup -> Phantoms.TTerm [Syntax.UseTree])
useGroupTrees x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UseGroup"),
...
useGroupWithPrefix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefix"),
...
useGroupWithTrees original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UseGroup"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "prefix"),
...
structDef name generics whereClause body derives public doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
...
structDefName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

structDefGenerics :: (Phantoms.TTerm Syntax.StructDef -> Phantoms.TTerm [Syntax.GenericParam])
structDefGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
...
structDefWhereClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
...
structDefBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
...
structDefDerives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
...
structDefPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
structDefDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
structDefWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structDefWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structDefWithWhereClause original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structDefWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structDefWithDerives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structDefWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structDefWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structBodyNamed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructBody"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "named"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

structBodyTuple :: (Phantoms.TTerm [Syntax.TupleField] -> Phantoms.TTerm Syntax.StructBody)
structBodyTuple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructBody"),
  Core.injectionField = Core.Field {
...
structBodyUnit = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructBody"),
  Core.injectionField = Core.Field {
...
structField name type_ public doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
structFieldName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

structFieldType :: (Phantoms.TTerm Syntax.StructField -> Phantoms.TTerm Syntax.Type)
structFieldType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
...
structFieldPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
structFieldDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
structFieldWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structFieldWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
structFieldWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
tupleField type_ public = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
tupleFieldType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TupleField"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

tupleFieldPublic :: (Phantoms.TTerm Syntax.TupleField -> Phantoms.TTerm Bool)
tupleFieldPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TupleField"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
tupleFieldWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
tupleFieldWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleField"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
enumDef name generics whereClause variants derives public doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
enumDefName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

enumDefGenerics :: (Phantoms.TTerm Syntax.EnumDef -> Phantoms.TTerm [Syntax.GenericParam])
enumDefGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
    Core.projectionField = (Core.Name "generics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumDefWhereClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
    Core.projectionField = (Core.Name "whereClause")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumDefVariants x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
...
enumDefDerives x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
    Core.projectionField = (Core.Name "derives")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumDefPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumDefDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumDefWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefWithWhereClause original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefWithVariants original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefWithDerives original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumDefWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumVariant name body doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariant"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
enumVariantName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariant"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

enumVariantBody :: (Phantoms.TTerm Syntax.EnumVariant -> Phantoms.TTerm Syntax.EnumVariantBody)
enumVariantBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariant"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumVariantDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariant"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
enumVariantWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariant"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumVariantWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariant"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumVariantWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariant"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
enumVariantBodyUnit = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariantBody"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "unit"),
    Core.fieldTerm = Core.TermUnit}})))

enumVariantBodyTuple :: (Phantoms.TTerm [Syntax.Type] -> Phantoms.TTerm Syntax.EnumVariantBody)
enumVariantBodyTuple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariantBody"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "tuple"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
enumVariantBodyStruct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.EnumVariantBody"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "struct"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
fnDef name generics whereClause params returnType body public async const unsafe doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
fnDefName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fnDefGenerics :: (Phantoms.TTerm Syntax.FnDef -> Phantoms.TTerm [Syntax.GenericParam])
fnDefGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
    Core.projectionField = (Core.Name "generics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fnDefWhereClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
    Core.projectionField = (Core.Name "whereClause")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fnDefParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
...
fnDefReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
...
fnDefBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fnDefPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fnDefAsync x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
...
fnDefConst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
...
fnDefUnsafe x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
...
fnDefDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fnDefWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithWhereClause original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithAsync original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithConst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithUnsafe original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnDefWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fnParam pattern type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnParam"),
  Core.recordFields = [
    Core.Field {
...
fnParamPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnParam"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fnParamType :: (Phantoms.TTerm Syntax.FnParam -> Phantoms.TTerm Syntax.Type)
fnParamType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnParam"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fnParamWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
fnParamWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
selfParamOwned = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.SelfParam"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "owned"),
    Core.fieldTerm = Core.TermUnit}})))

selfParamRef :: (Phantoms.TTerm Syntax.SelfParam)
selfParamRef = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.SelfParam"),
  Core.injectionField = Core.Field {
...
selfParamRefMut = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.SelfParam"),
  Core.injectionField = Core.Field {
...
methodParamSelf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.MethodParam"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "self"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

methodParamRegular :: (Phantoms.TTerm Syntax.FnParam -> Phantoms.TTerm Syntax.MethodParam)
methodParamRegular x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.MethodParam"),
  Core.injectionField = Core.Field {
...
typeAlias name generics type_ public doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
typeAliasName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeAliasGenerics :: (Phantoms.TTerm Syntax.TypeAlias -> Phantoms.TTerm [Syntax.GenericParam])
typeAliasGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
    Core.projectionField = (Core.Name "generics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeAliasType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeAliasPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeAliasDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeAliasWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeAliasWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeAliasWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeAliasWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAlias"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
constDef name type_ value public doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
constDefName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

constDefType :: (Phantoms.TTerm Syntax.ConstDef -> Phantoms.TTerm Syntax.Type)
constDefType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
constDefValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
...
constDefPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
constDefDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
constDefWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
constDefWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
constDefWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
constDefWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
constDefWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ConstDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
staticDef name type_ value mutable public doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
staticDefName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

staticDefType :: (Phantoms.TTerm Syntax.StaticDef -> Phantoms.TTerm Syntax.Type)
staticDefType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
staticDefValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
staticDefMutable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
...
staticDefPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
staticDefDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
staticDefWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
staticDefWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
staticDefWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
staticDefWithMutable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
staticDefWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
staticDefWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StaticDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
modDef name body public doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
modDefName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

modDefBody :: (Phantoms.TTerm Syntax.ModDef -> Phantoms.TTerm (Maybe [Syntax.Item]))
modDefBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
modDefPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
modDefDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
modDefWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
modDefWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
modDefWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
modDefWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ModDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implBlock generics whereClause trait negative selfType items = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "generics"),
      Core.fieldTerm = (Phantoms.unTTerm generics)},
...
implBlockGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
    Core.projectionField = (Core.Name "generics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

implBlockWhereClause :: (Phantoms.TTerm Syntax.ImplBlock -> Phantoms.TTerm (Maybe Syntax.WhereClause))
implBlockWhereClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
    Core.projectionField = (Core.Name "whereClause")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implBlockTrait x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
...
implBlockNegative x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
...
implBlockSelfType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
...
implBlockItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
    Core.projectionField = (Core.Name "items")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implBlockWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "generics"),
...
implBlockWithWhereClause original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "generics"),
...
implBlockWithTrait original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "generics"),
...
implBlockWithNegative original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "generics"),
...
implBlockWithSelfType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "generics"),
...
implBlockWithItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplBlock"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "generics"),
...
implItemMethod x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "method"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

implItemType :: (Phantoms.TTerm Syntax.TypeAlias -> Phantoms.TTerm Syntax.ImplItem)
implItemType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
implItemConst x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "const"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
implMethod name generics whereClause params returnType body public default_ doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
implMethodName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

implMethodGenerics :: (Phantoms.TTerm Syntax.ImplMethod -> Phantoms.TTerm [Syntax.GenericParam])
implMethodGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "generics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implMethodWhereClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "whereClause")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implMethodParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "params")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implMethodReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "returnType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implMethodBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implMethodPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implMethodDefault x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
...
implMethodDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
implMethodWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithWhereClause original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithDefault original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
implMethodWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ImplMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDef name generics whereClause superTraits items public unsafe doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
traitDefName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

traitDefGenerics :: (Phantoms.TTerm Syntax.TraitDef -> Phantoms.TTerm [Syntax.GenericParam])
traitDefGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
    Core.projectionField = (Core.Name "generics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitDefWhereClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
    Core.projectionField = (Core.Name "whereClause")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitDefSuperTraits x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
...
traitDefItems x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
    Core.projectionField = (Core.Name "items")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitDefPublic x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
    Core.projectionField = (Core.Name "public")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitDefUnsafe x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
    Core.projectionField = (Core.Name "unsafe")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitDefDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitDefWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDefWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDefWithWhereClause original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDefWithSuperTraits original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDefWithItems original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDefWithPublic original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDefWithUnsafe original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitDefWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitDef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitItemMethod x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "method"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

traitItemType :: (Phantoms.TTerm Syntax.TraitType -> Phantoms.TTerm Syntax.TraitItem)
traitItemType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traitItemConst x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitItem"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "const"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
traitMethod name generics whereClause params returnType defaultBody doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
traitMethodName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

traitMethodGenerics :: (Phantoms.TTerm Syntax.TraitMethod -> Phantoms.TTerm [Syntax.GenericParam])
traitMethodGenerics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
    Core.projectionField = (Core.Name "generics")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitMethodWhereClause x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
    Core.projectionField = (Core.Name "whereClause")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitMethodParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
    Core.projectionField = (Core.Name "params")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitMethodReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
    Core.projectionField = (Core.Name "returnType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitMethodDefaultBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
...
traitMethodDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitMethodWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitMethodWithGenerics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitMethodWithWhereClause original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitMethodWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitMethodWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitMethodWithDefaultBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitMethodWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitMethod"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitType name bounds default_ doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
traitTypeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

traitTypeBounds :: (Phantoms.TTerm Syntax.TraitType -> Phantoms.TTerm [Syntax.TypeParamBound])
traitTypeBounds x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
...
traitTypeDefault x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
    Core.projectionField = (Core.Name "default")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitTypeDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitTypeWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitTypeWithBounds original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitTypeWithDefault original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitTypeWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitConst name type_ default_ doc = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
traitConstName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

traitConstType :: (Phantoms.TTerm Syntax.TraitConst -> Phantoms.TTerm Syntax.Type)
traitConstType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitConstDefault x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
    Core.projectionField = (Core.Name "default")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitConstDoc x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
    Core.projectionField = (Core.Name "doc")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
traitConstWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitConstWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitConstWithDefault original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
traitConstWithDoc original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TraitConst"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
genericParam name bounds = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.GenericParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
genericParamName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericParam"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

genericParamBounds :: (Phantoms.TTerm Syntax.GenericParam -> Phantoms.TTerm [Syntax.TypeParamBound])
genericParamBounds x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericParam"),
    Core.projectionField = (Core.Name "bounds")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
genericParamWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.GenericParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
genericParamWithBounds original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.GenericParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeParamBoundTrait x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeParamBound"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "trait"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

typeParamBoundLifetime :: (Phantoms.TTerm Syntax.Lifetime -> Phantoms.TTerm Syntax.TypeParamBound)
typeParamBoundLifetime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeParamBound"),
  Core.injectionField = Core.Field {
...
lifetime name = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Lifetime"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)}]})))
...
lifetimeName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.Lifetime"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

lifetimeWithName :: (Phantoms.TTerm Syntax.Lifetime -> Phantoms.TTerm String -> Phantoms.TTerm Syntax.Lifetime)
lifetimeWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Lifetime"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
whereClause predicates = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WhereClause"),
  Core.recordFields = [
    Core.Field {
...
whereClausePredicates x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.WhereClause"),
...
whereClauseWithPredicates original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WhereClause"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "predicates"),
...
wherePredicate type_ bounds = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WherePredicate"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
wherePredicateType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.WherePredicate"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

wherePredicateBounds :: (Phantoms.TTerm Syntax.WherePredicate -> Phantoms.TTerm [Syntax.TypeParamBound])
wherePredicateBounds x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.WherePredicate"),
    Core.projectionField = (Core.Name "bounds")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
wherePredicateWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WherePredicate"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
wherePredicateWithBounds original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WherePredicate"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
typePath x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "path"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
typeSlice x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typeArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typeFnPointer x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typeImplTrait x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typeDynTrait x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typeInferred = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typeUnit = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "unit"),
    Core.fieldTerm = Core.TermUnit}})))
...
typeNever = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typeRawPointer x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Type"),
  Core.injectionField = Core.Field {
...
typePath_ global segments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypePath"),
  Core.recordFields = [
    Core.Field {
...
typePathGlobal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypePath"),
    Core.projectionField = (Core.Name "global")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typePathSegments :: (Phantoms.TTerm Syntax.TypePath -> Phantoms.TTerm [Syntax.PathSegment])
typePathSegments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypePath"),
    Core.projectionField = (Core.Name "segments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typePathWithGlobal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypePath"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "global"),
...
typePathWithSegments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypePath"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "global"),
...
pathSegment name arguments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.PathSegment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
pathSegmentName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.PathSegment"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

pathSegmentArguments :: (Phantoms.TTerm Syntax.PathSegment -> Phantoms.TTerm Syntax.GenericArguments)
pathSegmentArguments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.PathSegment"),
...
pathSegmentWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.PathSegment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
pathSegmentWithArguments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.PathSegment"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
genericArgumentsNone = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericArguments"),
  Core.injectionField = Core.Field {
...
genericArgumentsAngleBracketed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericArguments"),
  Core.injectionField = Core.Field {
...
genericArgumentsParenthesized x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericArguments"),
  Core.injectionField = Core.Field {
...
angleBracketedArgs args = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.AngleBracketedArgs"),
  Core.recordFields = [
    Core.Field {
...
angleBracketedArgsArgs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.AngleBracketedArgs"),
...
angleBracketedArgsWithArgs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.AngleBracketedArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "args"),
...
genericArgType x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericArg"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "type"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

genericArgLifetime :: (Phantoms.TTerm Syntax.Lifetime -> Phantoms.TTerm Syntax.GenericArg)
genericArgLifetime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericArg"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "lifetime"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericArgConst x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericArg"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "const"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
genericArgBinding x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.GenericArg"),
  Core.injectionField = Core.Field {
...
typeBinding name type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeBinding"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
typeBindingName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeBinding"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeBindingType :: (Phantoms.TTerm Syntax.TypeBinding -> Phantoms.TTerm Syntax.Type)
typeBindingType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeBinding"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeBindingWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeBinding"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
typeBindingWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeBinding"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
parenthesizedArgs inputs output = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ParenthesizedArgs"),
  Core.recordFields = [
    Core.Field {
...
parenthesizedArgsInputs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ParenthesizedArgs"),
...
parenthesizedArgsOutput x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ParenthesizedArgs"),
...
parenthesizedArgsWithInputs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ParenthesizedArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inputs"),
...
parenthesizedArgsWithOutput original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ParenthesizedArgs"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inputs"),
...
referenceType lifetime mutable type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ReferenceType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lifetime"),
...
referenceTypeLifetime x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ReferenceType"),
    Core.projectionField = (Core.Name "lifetime")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

referenceTypeMutable :: (Phantoms.TTerm Syntax.ReferenceType -> Phantoms.TTerm Bool)
referenceTypeMutable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ReferenceType"),
    Core.projectionField = (Core.Name "mutable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
referenceTypeType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ReferenceType"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
referenceTypeWithLifetime original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ReferenceType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lifetime"),
...
referenceTypeWithMutable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ReferenceType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lifetime"),
...
referenceTypeWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ReferenceType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lifetime"),
...
arrayType element length = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayType"),
  Core.recordFields = [
    Core.Field {
...
arrayTypeElement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayType"),
...
fnPointerType params returnType = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnPointerType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "params"),
      Core.fieldTerm = (Phantoms.unTTerm params)},
...
fnPointerTypeParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnPointerType"),
    Core.projectionField = (Core.Name "params")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fnPointerTypeReturnType :: (Phantoms.TTerm Syntax.FnPointerType -> Phantoms.TTerm Syntax.Type)
fnPointerTypeReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FnPointerType"),
    Core.projectionField = (Core.Name "returnType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fnPointerTypeWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnPointerType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "params"),
...
fnPointerTypeWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FnPointerType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "params"),
...
rawPointerType mutable type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RawPointerType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
      Core.fieldTerm = (Phantoms.unTTerm mutable)},
...
rawPointerTypeMutable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RawPointerType"),
    Core.projectionField = (Core.Name "mutable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rawPointerTypeType :: (Phantoms.TTerm Syntax.RawPointerType -> Phantoms.TTerm Syntax.Type)
rawPointerTypeType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RawPointerType"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rawPointerTypeWithMutable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RawPointerType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
...
rawPointerTypeWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RawPointerType"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
...
expressionLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

expressionPath :: (Phantoms.TTerm Syntax.ExprPath -> Phantoms.TTerm Syntax.Expression)
expressionPath x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "path"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionBlock x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionCall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionMethodCall x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionFieldAccess x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionTupleIndex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionClosure x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionIf x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionMatch x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionLoop x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionWhile x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionFor x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "reference"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionDereference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionStruct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "struct"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionTuple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "tuple"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionArray x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "array"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionIndex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionReturn x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionBreak x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionContinue = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionTry x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionCast x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionTypeAscription x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionAwait x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionAssign x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionCompoundAssign x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
expressionMacro x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "macro"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
expressionParen x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Expression"),
  Core.injectionField = Core.Field {
...
exprPath global segments = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ExprPath"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "global"),
      Core.fieldTerm = (Phantoms.unTTerm global)},
...
exprPathGlobal x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ExprPath"),
    Core.projectionField = (Core.Name "global")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

exprPathSegments :: (Phantoms.TTerm Syntax.ExprPath -> Phantoms.TTerm [Syntax.PathSegment])
exprPathSegments x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ExprPath"),
    Core.projectionField = (Core.Name "segments")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
exprPathWithGlobal original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ExprPath"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "global"),
...
exprPathWithSegments original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ExprPath"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "global"),
...
callExpr function args = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CallExpr"),
  Core.recordFields = [
    Core.Field {
...
callExprFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.CallExpr"),
    Core.projectionField = (Core.Name "function")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

callExprArgs :: (Phantoms.TTerm Syntax.CallExpr -> Phantoms.TTerm [Syntax.Expression])
callExprArgs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.CallExpr"),
    Core.projectionField = (Core.Name "args")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
callExprWithArgs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CallExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
methodCallExpr receiver method turbofish args = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
  Core.recordFields = [
    Core.Field {
...
methodCallExprReceiver x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
    Core.projectionField = (Core.Name "receiver")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

methodCallExprMethod :: (Phantoms.TTerm Syntax.MethodCallExpr -> Phantoms.TTerm String)
methodCallExprMethod x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
...
methodCallExprTurbofish x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
...
methodCallExprArgs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
    Core.projectionField = (Core.Name "args")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
methodCallExprWithReceiver original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "receiver"),
...
methodCallExprWithMethod original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "receiver"),
...
methodCallExprWithTurbofish original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "receiver"),
...
methodCallExprWithArgs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MethodCallExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "receiver"),
...
fieldAccessExpr object field = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldAccessExpr"),
  Core.recordFields = [
    Core.Field {
...
fieldAccessExprObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FieldAccessExpr"),
    Core.projectionField = (Core.Name "object")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fieldAccessExprField :: (Phantoms.TTerm Syntax.FieldAccessExpr -> Phantoms.TTerm String)
fieldAccessExprField x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FieldAccessExpr"),
...
fieldAccessExprWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldAccessExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
fieldAccessExprWithField original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldAccessExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
tupleIndexExpr tuple index = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleIndexExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "tuple"),
...
tupleIndexExprTuple x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TupleIndexExpr"),
    Core.projectionField = (Core.Name "tuple")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

tupleIndexExprIndex :: (Phantoms.TTerm Syntax.TupleIndexExpr -> Phantoms.TTerm Int)
tupleIndexExprIndex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TupleIndexExpr"),
...
tupleIndexExprWithTuple original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleIndexExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "tuple"),
...
tupleIndexExprWithIndex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleIndexExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "tuple"),
...
closureExpr move params returnType body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
  Core.recordFields = [
    Core.Field {
...
closureExprMove x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
...
closureExprParams x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
    Core.projectionField = (Core.Name "params")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
closureExprReturnType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
    Core.projectionField = (Core.Name "returnType")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
closureExprBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
closureExprWithMove original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "move"),
...
closureExprWithParams original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "move"),
...
closureExprWithReturnType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "move"),
...
closureExprWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "move"),
...
closureParam pattern type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
      Core.fieldTerm = (Phantoms.unTTerm pattern)},
...
closureParamPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureParam"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

closureParamType :: (Phantoms.TTerm Syntax.ClosureParam -> Phantoms.TTerm (Maybe Syntax.Type))
closureParamType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureParam"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
closureParamWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
closureParamWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ClosureParam"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
ifExpr condition thenBlock elseBranch = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IfExpr"),
  Core.recordFields = [
    Core.Field {
...
ifExprCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IfExpr"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

ifExprThenBlock :: (Phantoms.TTerm Syntax.IfExpr -> Phantoms.TTerm Syntax.Block)
ifExprThenBlock x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IfExpr"),
...
ifExprElseBranch x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IfExpr"),
...
ifExprWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IfExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ifExprWithThenBlock original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IfExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ifExprWithElseBranch original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IfExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
ifConditionBool x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.IfCondition"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "bool"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

ifConditionLet :: (Phantoms.TTerm Syntax.LetCondition -> Phantoms.TTerm Syntax.IfCondition)
ifConditionLet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.IfCondition"),
  Core.injectionField = Core.Field {
...
matchExpr scrutinee arms = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MatchExpr"),
  Core.recordFields = [
    Core.Field {
...
matchExprScrutinee x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MatchExpr"),
    Core.projectionField = (Core.Name "scrutinee")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

matchExprArms :: (Phantoms.TTerm Syntax.MatchExpr -> Phantoms.TTerm [Syntax.MatchArm])
matchExprArms x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MatchExpr"),
...
matchExprWithScrutinee original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MatchExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scrutinee"),
...
matchExprWithArms original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MatchExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "scrutinee"),
...
matchArm pattern guard body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MatchArm"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
      Core.fieldTerm = (Phantoms.unTTerm pattern)},
...
matchArmPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MatchArm"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

matchArmGuard :: (Phantoms.TTerm Syntax.MatchArm -> Phantoms.TTerm (Maybe Syntax.Expression))
matchArmGuard x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MatchArm"),
...
matchArmBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MatchArm"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
matchArmWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MatchArm"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
matchArmWithGuard original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MatchArm"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
matchArmWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MatchArm"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
loopExpr label body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LoopExpr"),
  Core.recordFields = [
    Core.Field {
...
loopExprLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LoopExpr"),
    Core.projectionField = (Core.Name "label")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

loopExprBody :: (Phantoms.TTerm Syntax.LoopExpr -> Phantoms.TTerm Syntax.Block)
loopExprBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LoopExpr"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
loopExprWithLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LoopExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
loopExprWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LoopExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
whileExpr label condition body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WhileExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
      Core.fieldTerm = (Phantoms.unTTerm label)},
...
whileExprLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.WhileExpr"),
    Core.projectionField = (Core.Name "label")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

whileExprCondition :: (Phantoms.TTerm Syntax.WhileExpr -> Phantoms.TTerm Syntax.IfCondition)
whileExprCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.WhileExpr"),
    Core.projectionField = (Core.Name "condition")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
whileExprBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.WhileExpr"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
whileExprWithLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WhileExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
whileExprWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WhileExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
whileExprWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.WhileExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
forExpr label pattern iter body = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
      Core.fieldTerm = (Phantoms.unTTerm label)},
...
forExprLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
    Core.projectionField = (Core.Name "label")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

forExprPattern :: (Phantoms.TTerm Syntax.ForExpr -> Phantoms.TTerm Syntax.Pattern)
forExprPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forExprIter x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
...
forExprBody x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
    Core.projectionField = (Core.Name "body")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
forExprWithLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
forExprWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
forExprWithIter original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
forExprWithBody original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ForExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "label"),
...
binaryExpr left op right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryExpr"),
  Core.recordFields = [
    Core.Field {
...
binaryExprLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryExpr"),
...
binaryOpAdd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "add"),
    Core.fieldTerm = Core.TermUnit}})))

binaryOpSub :: (Phantoms.TTerm Syntax.BinaryOp)
binaryOpSub = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpMul = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpDiv = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpRem = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpBitAnd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpBitOr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpBitXor = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpShl = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpShr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpEq = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpNe = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpLt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpLe = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpGt = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
binaryOpGe = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.BinaryOp"),
  Core.injectionField = Core.Field {
...
unaryExpr op operand = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UnaryExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "op"),
      Core.fieldTerm = (Phantoms.unTTerm op)},
...
unaryExprOp x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UnaryExpr"),
    Core.projectionField = (Core.Name "op")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

unaryExprOperand :: (Phantoms.TTerm Syntax.UnaryExpr -> Phantoms.TTerm Syntax.Expression)
unaryExprOperand x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.UnaryExpr"),
...
unaryExprWithOp original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UnaryExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "op"),
...
unaryExprWithOperand original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.UnaryExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "op"),
...
unaryOpNeg = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.UnaryOp"),
  Core.injectionField = Core.Field {
...
refExpr mutable expr = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RefExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
      Core.fieldTerm = (Phantoms.unTTerm mutable)},
...
refExprMutable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RefExpr"),
    Core.projectionField = (Core.Name "mutable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

refExprExpr :: (Phantoms.TTerm Syntax.RefExpr -> Phantoms.TTerm Syntax.Expression)
refExprExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RefExpr"),
...
refExprWithMutable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RefExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
...
refExprWithExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RefExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
...
structExpr path fields rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
      Core.fieldTerm = (Phantoms.unTTerm path)},
...
structExprPath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructExpr"),
    Core.projectionField = (Core.Name "path")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

structExprFields :: (Phantoms.TTerm Syntax.StructExpr -> Phantoms.TTerm [Syntax.FieldValue])
structExprFields x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructExpr"),
...
structExprRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructExpr"),
...
structExprWithPath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
structExprWithFields original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
structExprWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
fieldValue name value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
fieldValueName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FieldValue"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fieldValueValue :: (Phantoms.TTerm Syntax.FieldValue -> Phantoms.TTerm (Maybe Syntax.Expression))
fieldValueValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FieldValue"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldValueWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldValueWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
arrayExprElements x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayExpr"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "elements"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

arrayExprRepeat :: (Phantoms.TTerm Syntax.ArrayRepeat -> Phantoms.TTerm Syntax.ArrayExpr)
arrayExprRepeat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayExpr"),
  Core.injectionField = Core.Field {
...
indexExpr object index = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IndexExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
      Core.fieldTerm = (Phantoms.unTTerm object)},
...
indexExprObject x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IndexExpr"),
    Core.projectionField = (Core.Name "object")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
indexExprWithObject original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IndexExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "object"),
...
rangeExpr from to inclusive = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangeExpr"),
  Core.recordFields = [
    Core.Field {
...
rangeExprFrom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RangeExpr"),
    Core.projectionField = (Core.Name "from")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangeExprTo :: (Phantoms.TTerm Syntax.RangeExpr -> Phantoms.TTerm (Maybe Syntax.Expression))
rangeExprTo x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RangeExpr"),
...
rangeExprInclusive x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RangeExpr"),
...
rangeExprWithFrom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangeExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "from"),
...
rangeExprWithTo original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangeExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "from"),
...
rangeExprWithInclusive original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangeExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "from"),
...
castExpr expr type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CastExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expr"),
      Core.fieldTerm = (Phantoms.unTTerm expr)},
...
castExprExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.CastExpr"),
    Core.projectionField = (Core.Name "expr")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

castExprType :: (Phantoms.TTerm Syntax.CastExpr -> Phantoms.TTerm Syntax.Type)
castExprType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.CastExpr"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
castExprWithExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CastExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expr"),
...
castExprWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CastExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expr"),
...
typeAscriptionExpr expr type_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAscriptionExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expr"),
      Core.fieldTerm = (Phantoms.unTTerm expr)},
...
typeAscriptionExprExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAscriptionExpr"),
    Core.projectionField = (Core.Name "expr")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

typeAscriptionExprType :: (Phantoms.TTerm Syntax.TypeAscriptionExpr -> Phantoms.TTerm Syntax.Type)
typeAscriptionExprType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAscriptionExpr"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
typeAscriptionExprWithExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAscriptionExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expr"),
...
typeAscriptionExprWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TypeAscriptionExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expr"),
...
assignExpr target value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.AssignExpr"),
  Core.recordFields = [
    Core.Field {
...
assignExprTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.AssignExpr"),
    Core.projectionField = (Core.Name "target")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

assignExprValue :: (Phantoms.TTerm Syntax.AssignExpr -> Phantoms.TTerm Syntax.Expression)
assignExprValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.AssignExpr"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
assignExprWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.AssignExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
assignExprWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.AssignExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
compoundAssignExpr target op value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
      Core.fieldTerm = (Phantoms.unTTerm target)},
...
compoundAssignExprTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignExpr"),
    Core.projectionField = (Core.Name "target")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

compoundAssignExprOp :: (Phantoms.TTerm Syntax.CompoundAssignExpr -> Phantoms.TTerm Syntax.CompoundAssignOp)
compoundAssignExprOp x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignExpr"),
    Core.projectionField = (Core.Name "op")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
compoundAssignExprValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignExpr"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
compoundAssignExprWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
compoundAssignExprWithOp original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
compoundAssignExprWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignExpr"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
compoundAssignOpAddAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "addAssign"),
    Core.fieldTerm = Core.TermUnit}})))

compoundAssignOpSubAssign :: (Phantoms.TTerm Syntax.CompoundAssignOp)
compoundAssignOpSubAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpMulAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpDivAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpRemAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpBitAndAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpBitOrAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpBitXorAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpShlAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
compoundAssignOpShrAssign = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.CompoundAssignOp"),
  Core.injectionField = Core.Field {
...
macroInvocation path delimiter tokens = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MacroInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
      Core.fieldTerm = (Phantoms.unTTerm path)},
...
macroInvocationPath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MacroInvocation"),
    Core.projectionField = (Core.Name "path")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

macroInvocationDelimiter :: (Phantoms.TTerm Syntax.MacroInvocation -> Phantoms.TTerm Syntax.MacroDelimiter)
macroInvocationDelimiter x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MacroInvocation"),
...
macroInvocationTokens x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.MacroInvocation"),
...
macroInvocationWithPath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MacroInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
macroInvocationWithDelimiter original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MacroInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
macroInvocationWithTokens original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.MacroInvocation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
macroDelimiterParen = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.MacroDelimiter"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "paren"),
    Core.fieldTerm = Core.TermUnit}})))

macroDelimiterBracket :: (Phantoms.TTerm Syntax.MacroDelimiter)
macroDelimiterBracket = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.MacroDelimiter"),
  Core.injectionField = Core.Field {
...
macroDelimiterBrace = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.MacroDelimiter"),
  Core.injectionField = Core.Field {
...
statementLet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Statement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "let"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
statementItem x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Statement"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "item"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
statementEmpty = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Statement"),
  Core.injectionField = Core.Field {
...
letStatement pattern mutable type_ init = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
      Core.fieldTerm = (Phantoms.unTTerm pattern)},
...
letStatementPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

letStatementMutable :: (Phantoms.TTerm Syntax.LetStatement -> Phantoms.TTerm Bool)
letStatementMutable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
    Core.projectionField = (Core.Name "mutable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letStatementType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letStatementInit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
...
letStatementWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
letStatementWithMutable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
letStatementWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
letStatementWithInit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetStatement"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
block statements expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Block"),
  Core.recordFields = [
    Core.Field {
...
blockStatements x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.Block"),
...
blockExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.Block"),
...
blockWithStatements original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Block"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "statements"),
...
blockWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Block"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "statements"),
...
patternWildcard = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "wildcard"),
    Core.fieldTerm = Core.TermUnit}})))

patternIdentifier :: (Phantoms.TTerm Syntax.IdentifierPattern -> Phantoms.TTerm Syntax.Pattern)
patternIdentifier x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
...
patternLiteral x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "literal"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternReference x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "reference"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternStruct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "struct"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternTupleStruct x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
...
patternTuple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "tuple"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternSlice x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "slice"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternPath x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "path"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternRange x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "range"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
patternRest = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "rest"),
    Core.fieldTerm = Core.TermUnit}})))
...
patternParen x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Pattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "paren"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
identifierPattern name mutable atPattern = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IdentifierPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
identifierPatternName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IdentifierPattern"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

identifierPatternMutable :: (Phantoms.TTerm Syntax.IdentifierPattern -> Phantoms.TTerm Bool)
identifierPatternMutable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IdentifierPattern"),
    Core.projectionField = (Core.Name "mutable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
identifierPatternAtPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IdentifierPattern"),
...
identifierPatternWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IdentifierPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
identifierPatternWithMutable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IdentifierPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
identifierPatternWithAtPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IdentifierPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
refPattern mutable pattern = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RefPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
      Core.fieldTerm = (Phantoms.unTTerm mutable)},
...
refPatternMutable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RefPattern"),
    Core.projectionField = (Core.Name "mutable")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

refPatternPattern :: (Phantoms.TTerm Syntax.RefPattern -> Phantoms.TTerm Syntax.Pattern)
refPatternPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RefPattern"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
refPatternWithMutable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RefPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
...
refPatternWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RefPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "mutable"),
...
structPattern path fields rest = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
      Core.fieldTerm = (Phantoms.unTTerm path)},
...
structPatternPath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructPattern"),
    Core.projectionField = (Core.Name "path")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

structPatternFields :: (Phantoms.TTerm Syntax.StructPattern -> Phantoms.TTerm [Syntax.FieldPattern])
structPatternFields x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructPattern"),
    Core.projectionField = (Core.Name "fields")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
structPatternRest x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.StructPattern"),
    Core.projectionField = (Core.Name "rest")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
structPatternWithPath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
structPatternWithFields original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
structPatternWithRest original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.StructPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
fieldPattern name pattern = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
      Core.fieldTerm = (Phantoms.unTTerm name)},
...
fieldPatternName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FieldPattern"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

fieldPatternPattern :: (Phantoms.TTerm Syntax.FieldPattern -> Phantoms.TTerm (Maybe Syntax.Pattern))
fieldPatternPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FieldPattern"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
fieldPatternWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
fieldPatternWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FieldPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
tupleStructPattern path elements = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleStructPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
      Core.fieldTerm = (Phantoms.unTTerm path)},
...
tupleStructPatternPath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TupleStructPattern"),
    Core.projectionField = (Core.Name "path")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

tupleStructPatternElements :: (Phantoms.TTerm Syntax.TupleStructPattern -> Phantoms.TTerm [Syntax.Pattern])
tupleStructPatternElements x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.TupleStructPattern"),
...
tupleStructPatternWithPath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleStructPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
tupleStructPatternWithElements original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.TupleStructPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "path"),
...
rangePattern from to inclusive = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "from"),
      Core.fieldTerm = (Phantoms.unTTerm from)},
...
rangePatternFrom x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RangePattern"),
    Core.projectionField = (Core.Name "from")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

rangePatternTo :: (Phantoms.TTerm Syntax.RangePattern -> Phantoms.TTerm (Maybe Syntax.Pattern))
rangePatternTo x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RangePattern"),
    Core.projectionField = (Core.Name "to")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rangePatternInclusive x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.RangePattern"),
    Core.projectionField = (Core.Name "inclusive")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
rangePatternWithFrom original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "from"),
...
rangePatternWithTo original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "from"),
...
rangePatternWithInclusive original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.RangePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "from"),
...
literalInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Literal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "integer"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

literalFloat :: (Phantoms.TTerm Syntax.FloatLiteral -> Phantoms.TTerm Syntax.Literal)
literalFloat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalRawString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalByteString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalChar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalByte x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Literal"),
  Core.injectionField = Core.Field {
...
literalBool x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Literal"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "bool"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
integerLiteral value suffix = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IntegerLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
      Core.fieldTerm = (Phantoms.unTTerm value)},
...
integerLiteralValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IntegerLiteral"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

integerLiteralSuffix :: (Phantoms.TTerm Syntax.IntegerLiteral -> Phantoms.TTerm (Maybe String))
integerLiteralSuffix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.IntegerLiteral"),
...
integerLiteralWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IntegerLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
integerLiteralWithSuffix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.IntegerLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
floatLiteral value suffix = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FloatLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
      Core.fieldTerm = (Phantoms.unTTerm value)},
...
floatLiteralValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FloatLiteral"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

floatLiteralSuffix :: (Phantoms.TTerm Syntax.FloatLiteral -> Phantoms.TTerm (Maybe String))
floatLiteralSuffix x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.FloatLiteral"),
    Core.projectionField = (Core.Name "suffix")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
floatLiteralWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FloatLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
floatLiteralWithSuffix original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.FloatLiteral"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
attribute inner path tokens = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Attribute"),
  Core.recordFields = [
    Core.Field {
...
attributeInner x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.Attribute"),
    Core.projectionField = (Core.Name "inner")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

attributePath :: (Phantoms.TTerm Syntax.Attribute -> Phantoms.TTerm [String])
attributePath x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.Attribute"),
    Core.projectionField = (Core.Name "path")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
attributeTokens x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.Attribute"),
    Core.projectionField = (Core.Name "tokens")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
attributeWithInner original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Attribute"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inner"),
...
attributeWithPath original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Attribute"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inner"),
...
attributeWithTokens original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.Attribute"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "inner"),
...
visibilityPublic = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Visibility"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "public"),
    Core.fieldTerm = Core.TermUnit}})))

visibilityCrate :: (Phantoms.TTerm Syntax.Visibility)
visibilityCrate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Visibility"),
  Core.injectionField = Core.Field {
...
visibilityRestricted x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Visibility"),
  Core.injectionField = Core.Field {
...
visibilityPrivate = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.rust.syntax.Visibility"),
  Core.injectionField = Core.Field {
...
letCondition pattern expr = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
      Core.fieldTerm = (Phantoms.unTTerm pattern)},
...
letConditionPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LetCondition"),
    Core.projectionField = (Core.Name "pattern")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

letConditionExpr :: (Phantoms.TTerm Syntax.LetCondition -> Phantoms.TTerm Syntax.Expression)
letConditionExpr x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.LetCondition"),
    Core.projectionField = (Core.Name "expr")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
letConditionWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
letConditionWithExpr original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.LetCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pattern"),
...
arrayRepeat element length = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayRepeat"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "element"),
      Core.fieldTerm = (Phantoms.unTTerm element)},
...
arrayRepeatElement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayRepeat"),
    Core.projectionField = (Core.Name "element")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

arrayRepeatLength :: (Phantoms.TTerm Syntax.ArrayRepeat -> Phantoms.TTerm Syntax.Expression)
arrayRepeatLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayRepeat"),
    Core.projectionField = (Core.Name "length")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
arrayRepeatWithElement original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayRepeat"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "element"),
...
arrayRepeatWithLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.rust.syntax.ArrayRepeat"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "element"),
