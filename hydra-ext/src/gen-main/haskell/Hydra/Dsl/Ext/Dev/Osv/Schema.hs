...
-- | DSL functions for hydra.ext.dev.osv.schema

module Hydra.Dsl.Ext.Dev.Osv.Schema where

import qualified Hydra.Core as Core
import qualified Hydra.Ext.Dev.Osv.Schema as Schema
...
credited name contact = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Credited"),
  Core.recordFields = [
    Core.Field {
...
creditedName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Credited"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

creditedContact :: (Phantoms.TTerm Schema.Credited -> Phantoms.TTerm (Maybe [Schema.Url]))
creditedContact x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Credited"),
...
creditedWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Credited"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
creditedWithContact original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Credited"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
ecosystem x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.Ecosystem"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unEcosystem :: (Phantoms.TTerm Schema.Ecosystem -> Phantoms.TTerm String)
unEcosystem x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.Ecosystem")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
entry schemaVersion id modified published withdrawn aliases related summary details severity affected references credits = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
...
entrySchemaVersion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
    Core.projectionField = (Core.Name "schemaVersion")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

entryId :: (Phantoms.TTerm Schema.Entry -> Phantoms.TTerm Schema.Id)
entryId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryModified x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryPublished x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryWithdrawn x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryAliases x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryRelated x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entrySummary x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryDetails x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entrySeverity x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryAffected x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryReferences x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryCredits x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
...
entryWithSchemaVersion original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithModified original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithPublished original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithWithdrawn original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithAliases original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithRelated original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithSummary original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithDetails original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithSeverity original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithAffected original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithReferences original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
entryWithCredits original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Entry"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "schemaVersion"),
...
eventIntroduced x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Event"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "introduced"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))

eventFixed :: (Phantoms.TTerm Schema.Version -> Phantoms.TTerm Schema.Event)
eventFixed x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Event"),
  Core.injectionField = Core.Field {
...
eventLastAffected x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Event"),
  Core.injectionField = Core.Field {
...
eventLimit x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Event"),
  Core.injectionField = Core.Field {
...
id x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.Id"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unId :: (Phantoms.TTerm Schema.Id -> Phantoms.TTerm String)
unId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.Id")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

markdown :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.Markdown)
markdown x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.Markdown"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unMarkdown :: (Phantoms.TTerm Schema.Markdown -> Phantoms.TTerm String)
unMarkdown x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.Markdown")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

osvVersion :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.OsvVersion)
osvVersion x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.OsvVersion"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unOsvVersion :: (Phantoms.TTerm Schema.OsvVersion -> Phantoms.TTerm String)
unOsvVersion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.OsvVersion")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
package ecosystem name purl = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Package"),
  Core.recordFields = [
    Core.Field {
...
packageEcosystem x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Package"),
    Core.projectionField = (Core.Name "ecosystem")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

packageName :: (Phantoms.TTerm Schema.Package -> Phantoms.TTerm String)
packageName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Package"),
    Core.projectionField = (Core.Name "name")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
packagePurl x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Package"),
...
packageWithEcosystem original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Package"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ecosystem"),
...
packageWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Package"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ecosystem"),
...
packageWithPurl original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Package"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "ecosystem"),
...
packageVersions package ranges versions = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.PackageVersions"),
  Core.recordFields = [
    Core.Field {
...
packageVersionsPackage x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.PackageVersions"),
...
packageVersionsRanges x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.PackageVersions"),
...
packageVersionsVersions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.PackageVersions"),
...
packageVersionsWithPackage original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.PackageVersions"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "package"),
...
packageVersionsWithRanges original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.PackageVersions"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "package"),
...
packageVersionsWithVersions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.PackageVersions"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "package"),
...
reference type_ url = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Reference"),
  Core.recordFields = [
    Core.Field {
...
referenceType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Reference"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

referenceUrl :: (Phantoms.TTerm Schema.Reference -> Phantoms.TTerm Schema.Url)
referenceUrl x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Reference"),
...
referenceWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Reference"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
referenceWithUrl original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Reference"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
referenceType_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.ReferenceType"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))
...
unReferenceType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.ReferenceType")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

severity :: (Phantoms.TTerm Schema.SeverityType -> Phantoms.TTerm Schema.SeverityScore -> Phantoms.TTerm Schema.Severity)
severity type_ score = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Severity"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
severityType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Severity"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

severityScore :: (Phantoms.TTerm Schema.Severity -> Phantoms.TTerm Schema.SeverityScore)
severityScore x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.Severity"),
...
severityWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Severity"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
severityWithScore original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.Severity"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
severityScore_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.SeverityScore"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSeverityScore :: (Phantoms.TTerm Schema.SeverityScore -> Phantoms.TTerm String)
unSeverityScore x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.SeverityScore")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

severityType_ :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.SeverityType)
severityType_ x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.SeverityType"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unSeverityType :: (Phantoms.TTerm Schema.SeverityType -> Phantoms.TTerm String)
unSeverityType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.SeverityType")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

timestamp :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.Timestamp)
timestamp x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.Timestamp"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unTimestamp :: (Phantoms.TTerm Schema.Timestamp -> Phantoms.TTerm String)
unTimestamp x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.Timestamp")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

url :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.Url)
url x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.Url"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unUrl :: (Phantoms.TTerm Schema.Url -> Phantoms.TTerm String)
unUrl x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.Url")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

version :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.Version)
version x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.Version"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unVersion :: (Phantoms.TTerm Schema.Version -> Phantoms.TTerm String)
unVersion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.Version")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

versionOrStar :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.VersionOrStar)
versionOrStar x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionOrStar"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unVersionOrStar :: (Phantoms.TTerm Schema.VersionOrStar -> Phantoms.TTerm String)
unVersionOrStar x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.VersionOrStar")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

versionOrZero :: (Phantoms.TTerm String -> Phantoms.TTerm Schema.VersionOrZero)
versionOrZero x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionOrZero"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unVersionOrZero :: (Phantoms.TTerm Schema.VersionOrZero -> Phantoms.TTerm String)
unVersionOrZero x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.VersionOrZero")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
versionRange type_ repo events = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
      Core.fieldTerm = (Phantoms.unTTerm type_)},
...
versionRangeType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionRange"),
    Core.projectionField = (Core.Name "type")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))

versionRangeRepo :: (Phantoms.TTerm Schema.VersionRange -> Phantoms.TTerm (Maybe Schema.Url))
versionRangeRepo x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionRange"),
...
versionRangeEvents x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionRange"),
...
versionRangeWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
versionRangeWithRepo original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
versionRangeWithEvents original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionRange"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
versionType x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
  Core.wrappedTermTypeName = (Core.Name "hydra.ext.dev.osv.schema.VersionType"),
  Core.wrappedTermBody = (Phantoms.unTTerm x)})))

unVersionType :: (Phantoms.TTerm Schema.VersionType -> Phantoms.TTerm String)
unVersionType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationWrap (Core.Name "hydra.ext.dev.osv.schema.VersionType")))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
