...
bigDecimalValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unBigDecimalValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
compositeTypedValue type_ fields = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
compositeTypedValueType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
compositeTypedValueFields x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.graphson.syntax.CompositeTypedValue"),
...
compositeTypedValueWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.CompositeTypedValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
compositeTypedValueWithFields original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.CompositeTypedValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
doubleValueFinite x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
doubleValueInfinity = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.DoubleValue"),
  Core.injectionField = Core.Field {
...
doubleValueNegativeInfinity = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.DoubleValue"),
  Core.injectionField = Core.Field {
...
doubleValueNotANumber = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.DoubleValue"),
  Core.injectionField = Core.Field {
...
edgeLabel x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
floatValueFinite x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
floatValueInfinity = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.FloatValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "infinity"),
    Core.fieldTerm = Core.TermUnit}})))
...
floatValueNegativeInfinity = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.FloatValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "negativeInfinity"),
    Core.fieldTerm = Core.TermUnit}})))
...
floatValueNotANumber = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.FloatValue"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "notANumber"),
    Core.fieldTerm = Core.TermUnit}})))
...
map x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unMap x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
adjacentEdge id vertexId properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
adjacentEdgeVertexId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.graphson.syntax.AdjacentEdge"),
...
adjacentEdgeWithVertexId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.AdjacentEdge"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
primitiveTypedValue type_ value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
primitiveTypedValueType x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
primitiveTypedValueValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.graphson.syntax.PrimitiveTypedValue"),
...
primitiveTypedValueWithType original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.PrimitiveTypedValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
primitiveTypedValueWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.PrimitiveTypedValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "type"),
...
valueBigDecimal x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
valueBigInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueBinary x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueByte x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueChar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueComposite x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueDateTime x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueDouble x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueDuration x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueLong x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueMap x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueNull = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valuePrimitive x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueSet x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueShort x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valueUuid x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Value"),
  Core.injectionField = Core.Field {
...
valuePair first second = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
valuePairFirst x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
valuePairSecond x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.graphson.syntax.ValuePair"),
...
valuePairWithFirst original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.ValuePair"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
valuePairWithSecond original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.ValuePair"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "first"),
...
vertex id label inEdges outEdges properties = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
vertexInEdges x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Vertex"),
...
vertexOutEdges x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.graphson.syntax.Vertex"),
...
vertexWithInEdges original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.Vertex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
vertexWithOutEdges original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.Vertex"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
vertexPropertyValue id value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
vertexPropertyValueId x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
vertexPropertyValueValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.graphson.syntax.VertexPropertyValue"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
vertexPropertyValueWithId original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.VertexPropertyValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
...
vertexPropertyValueWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.graphson.syntax.VertexPropertyValue"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "id"),
