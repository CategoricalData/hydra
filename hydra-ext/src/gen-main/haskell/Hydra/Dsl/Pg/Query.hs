...
aggregationQueryCount = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
applicationQuery x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unApplicationQuery x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
associativeExpression operator operands = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
associativeExpressionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
associativeExpressionOperands x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.AssociativeExpression"),
...
associativeExpressionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.AssociativeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
associativeExpressionWithOperands original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.AssociativeExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
binaryBooleanOperatorAnd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
binaryBooleanOperatorOr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.BinaryBooleanOperator"),
  Core.injectionField = Core.Field {
...
binaryBooleanOperatorXor = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.BinaryBooleanOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
binaryOperatorComparison x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binaryOperatorPower = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.BinaryOperator"),
  Core.injectionField = Core.Field {
...
binding key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
bindingKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
bindingValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.Binding"),
...
bindingWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.Binding"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
bindingWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.Binding"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
edgeProjectionPattern direction label properties vertex = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
edgeProjectionPatternDirection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
edgeProjectionPatternLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.EdgeProjectionPattern"),
...
edgeProjectionPatternProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.EdgeProjectionPattern"),
...
edgeProjectionPatternVertex x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.EdgeProjectionPattern"),
...
edgeProjectionPatternWithDirection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.EdgeProjectionPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
edgeProjectionPatternWithLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.EdgeProjectionPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
edgeProjectionPatternWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.EdgeProjectionPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
edgeProjectionPatternWithVertex original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.EdgeProjectionPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
expressionAssociative x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
expressionVertex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.Expression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "vertex"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
letQuery bindings environment = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
letQueryBindings x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
letQueryEnvironment x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.LetQuery"),
...
letQueryWithBindings original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.LetQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bindings"),
...
letQueryWithEnvironment original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.LetQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "bindings"),
...
matchQuery optional pattern where_ = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
matchQueryOptional x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
matchQueryPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.MatchQuery"),
...
matchQueryWhere x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.MatchQuery"),
...
matchQueryWithOptional original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.MatchQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "optional"),
...
matchQueryWithPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.MatchQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "optional"),
...
matchQueryWithWhere original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.MatchQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "optional"),
...
projection value as = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
projectionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
projectionAs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.Projection"),
...
projectionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.Projection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
projectionWithAs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.Projection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "value"),
...
projections all explicit = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
projectionsAll x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
projectionsExplicit x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.Projections"),
...
projectionsWithAll original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.Projections"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "all"),
...
projectionsWithExplicit original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.Projections"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "all"),
...
propertyPattern key value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
propertyPatternKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
propertyPatternValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.PropertyPattern"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyPatternWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.PropertyPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
propertyPatternWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.PropertyPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "key"),
...
propertyProjection base key = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
propertyProjectionBase x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
propertyProjectionKey x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.PropertyProjection"),
    Core.projectionField = (Core.Name "key")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyProjectionWithBase original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.PropertyProjection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "base"),
...
propertyProjectionWithKey original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.PropertyProjection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "base"),
...
propertyValue x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unPropertyValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
propertyValuePatternVariable x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
propertyValuePatternValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.PropertyValuePattern"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
queryApplication x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
queryAggregate x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.Query"),
  Core.injectionField = Core.Field {
...
queryLetQuery x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.Query"),
  Core.injectionField = Core.Field {
...
queryMatch x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.Query"),
  Core.injectionField = Core.Field {
...
querySelect x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.Query"),
  Core.injectionField = Core.Field {
...
queryValue x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "hydra.pg.query.Query"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "value"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
selectQuery distinct projection = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
selectQueryDistinct x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
selectQueryProjection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.SelectQuery"),
...
selectQueryWithDistinct original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.SelectQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "distinct"),
...
selectQueryWithProjection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.SelectQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "distinct"),
...
unaryExpression operator operand = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
unaryExpressionOperand x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.UnaryExpression"),
...
unaryExpressionWithOperand original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.UnaryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "operator"),
...
vertexPattern variable label properties edges = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
vertexPatternVariable x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
vertexPatternLabel x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.VertexPattern"),
    Core.projectionField = (Core.Name "label")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
vertexPatternProperties x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.VertexPattern"),
    Core.projectionField = (Core.Name "properties")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
vertexPatternEdges x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "hydra.pg.query.VertexPattern"),
...
vertexPatternWithVariable original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.VertexPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
vertexPatternWithLabel original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.VertexPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
vertexPatternWithProperties original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.VertexPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
...
vertexPatternWithEdges original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "hydra.pg.query.VertexPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "variable"),
