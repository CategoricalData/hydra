...
pathQuery projection restrictorExt pathPattern groupBy orderBy = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
pathQueryProjection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
pathQueryRestrictorExt x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
...
pathQueryPathPattern x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
...
pathQueryGroupBy x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
...
pathQueryOrderBy x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
...
pathQueryWithProjection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projection"),
...
pathQueryWithRestrictorExt original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projection"),
...
pathQueryWithPathPattern original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projection"),
...
pathQueryWithGroupBy original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projection"),
...
pathQueryWithOrderBy original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathQuery"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projection"),
...
projection partProj groupProj pathProj = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
projectionPartProj x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
projectionGroupProj x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Projection"),
...
projectionPathProj x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Projection"),
...
projectionWithPartProj original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Projection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "partProj"),
...
projectionWithGroupProj original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Projection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "partProj"),
...
projectionWithPathProj original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Projection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "partProj"),
...
partProjAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
partProjLimited x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PartProj"),
  Core.injectionField = Core.Field {
...
groupProjAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
groupProjLimited x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.GroupProj"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "limited"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
pathProjAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
pathProjLimited x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathProj"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "limited"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
restrictorExtWalk = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
restrictorExtTrail = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.RestrictorExt"),
  Core.injectionField = Core.Field {
...
restrictorExtSimple = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.RestrictorExt"),
  Core.injectionField = Core.Field {
...
restrictorExtAcyclic = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.RestrictorExt"),
  Core.injectionField = Core.Field {
...
restrictorExtShortest = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.RestrictorExt"),
  Core.injectionField = Core.Field {
...
orderBy x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unOrderBy x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
groupBy x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unGroupBy x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
orderByOptionPartition = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
orderByOptionGroup = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.OrderByOption"),
  Core.injectionField = Core.Field {
...
orderByOptionPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.OrderByOption"),
  Core.injectionField = Core.Field {
...
orderByOptionPartitionGroup = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.OrderByOption"),
  Core.injectionField = Core.Field {
...
orderByOptionPartitionPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.OrderByOption"),
  Core.injectionField = Core.Field {
...
orderByOptionGroupPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.OrderByOption"),
  Core.injectionField = Core.Field {
...
orderByOptionPartitionGroupPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.OrderByOption"),
  Core.injectionField = Core.Field {
...
groupByOptionSource = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
groupByOptionTarget = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.GroupByOption"),
  Core.injectionField = Core.Field {
...
groupByOptionLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.GroupByOption"),
  Core.injectionField = Core.Field {
...
groupByOptionSourceTarget = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.GroupByOption"),
  Core.injectionField = Core.Field {
...
groupByOptionSourceLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.GroupByOption"),
  Core.injectionField = Core.Field {
...
groupByOptionTargetLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.GroupByOption"),
  Core.injectionField = Core.Field {
...
groupByOptionSourceTargetLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.GroupByOption"),
  Core.injectionField = Core.Field {
...
pathPattern pathName startNode edge endNode condition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
pathPatternPathName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
pathPatternStartNode x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
...
pathPatternEdge x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
...
pathPatternEndNode x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
...
pathPatternCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
...
pathPatternWithPathName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathName"),
...
pathPatternWithStartNode original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathName"),
...
pathPatternWithEdge original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathName"),
...
pathPatternWithEndNode original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathName"),
...
pathPatternWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.PathPattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathName"),
...
nodePattern variable = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
edgePattern direction rpq = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
edgePatternDirection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
edgePatternRpq x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.EdgePattern"),
...
edgePatternWithDirection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.EdgePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
edgePatternWithRpq original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.EdgePattern"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "direction"),
...
edgeDirectionOutgoing = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
edgeDirectionIncoming = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.EdgeDirection"),
  Core.injectionField = Core.Field {
...
edgeDirectionUndirected = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.EdgeDirection"),
  Core.injectionField = Core.Field {
...
rpqParenthesis x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
rpqLabel x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
rpqNegated x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
rpqReverse x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
rpqOptional x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
rpqPlus x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
rpqStar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
rpqConcatenation x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
rpqAlternation x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Rpq"),
  Core.injectionField = Core.Field {
...
plus expression restrictor = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
plusExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
plusRestrictor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Plus"),
...
plusWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Plus"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
plusWithRestrictor original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Plus"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
star expression restrictor = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
starExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
starRestrictor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Star"),
    Core.projectionField = (Core.Name "restrictor")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
starWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Star"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
starWithRestrictor original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Star"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "expression"),
...
concatenation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
concatenationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
concatenationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Concatenation"),
...
concatenationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Concatenation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
concatenationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Concatenation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
alternation left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
alternationLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
alternationRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Alternation"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
alternationWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Alternation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
alternationWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Alternation"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
rpqRestrictor x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unRpqRestrictor x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
complexConditionSimple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
complexConditionCompound x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.ComplexCondition"),
  Core.injectionField = Core.Field {
...
compoundComplexCondition lhs operator rhs = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
compoundComplexConditionLhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
compoundComplexConditionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompoundComplexCondition"),
...
compoundComplexConditionRhs x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompoundComplexCondition"),
...
compoundComplexConditionWithLhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompoundComplexCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
compoundComplexConditionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompoundComplexCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
compoundComplexConditionWithRhs original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompoundComplexCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "lhs"),
...
condition function compareSym value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
conditionFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
conditionCompareSym x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Condition"),
...
conditionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Condition"),
...
conditionWithFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Condition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
conditionWithCompareSym original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Condition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
conditionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Condition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "function"),
...
compareSymEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
compareSymNotEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompareSym"),
  Core.injectionField = Core.Field {
...
compareSymLessThan = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompareSym"),
  Core.injectionField = Core.Field {
...
compareSymGreaterThan = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompareSym"),
  Core.injectionField = Core.Field {
...
compareSymLessThanOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompareSym"),
  Core.injectionField = Core.Field {
...
compareSymGreaterThanOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.CompareSym"),
  Core.injectionField = Core.Field {
...
functionSimple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
functionNested x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Function"),
  Core.injectionField = Core.Field {
...
functionComplex x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.Function"),
  Core.injectionField = Core.Field {
...
simpleFunction name argument = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
simpleFunctionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
simpleFunctionArgument x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.SimpleFunction"),
...
simpleFunctionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.SimpleFunction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
simpleFunctionWithArgument original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.SimpleFunction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
nestedFunction name innerFunction = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
nestedFunctionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
nestedFunctionInnerFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.NestedFunction"),
...
nestedFunctionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.NestedFunction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
nestedFunctionWithInnerFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.NestedFunction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
complexFunction name innerFunction additionalArg = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
complexFunctionName x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
complexFunctionInnerFunction x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.ComplexFunction"),
    Core.projectionField = (Core.Name "innerFunction")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
complexFunctionAdditionalArg x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.ComplexFunction"),
...
complexFunctionWithName original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.ComplexFunction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
complexFunctionWithInnerFunction original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.ComplexFunction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
complexFunctionWithAdditionalArg original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.ComplexFunction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "name"),
...
boolOpAnd = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
boolOpOr = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.syntax.BoolOp"),
  Core.injectionField = Core.Field {
