...
queryExpression pathExpression resultProjection = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
queryExpressionPathExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
queryExpressionResultProjection x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.QueryExpression"),
...
queryExpressionWithPathExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.QueryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathExpression"),
...
queryExpressionWithResultProjection original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.QueryExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "pathExpression"),
...
pathExpressionBase x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
pathExpressionSelection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathExpression"),
  Core.injectionField = Core.Field {
...
pathExpressionJoin x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathExpression"),
  Core.injectionField = Core.Field {
...
pathExpressionUnion x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathExpression"),
  Core.injectionField = Core.Field {
...
pathExpressionRecursive x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathExpression"),
  Core.injectionField = Core.Field {
...
pathExpressionGroupBy x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathExpression"),
  Core.injectionField = Core.Field {
...
pathExpressionOrderBy x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathExpression"),
  Core.injectionField = Core.Field {
...
pathExpressionProjection x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathExpression"),
  Core.injectionField = Core.Field {
...
baseExpressionPaths0 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
baseExpressionPaths1 x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.BaseExpression"),
  Core.injectionField = Core.Field {
...
baseExpressionPathsStar x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.BaseExpression"),
  Core.injectionField = Core.Field {
...
graphReference x = (Phantoms.TTerm (Core.TermWrap (Core.WrappedTerm {
...
unGraphReference x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
...
selectionExpression condition expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
selectionExpressionCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
selectionExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SelectionExpression"),
...
selectionExpressionWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SelectionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
selectionExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SelectionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
selectionConditionSimple x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
selectionConditionAnd x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SelectionCondition"),
  Core.injectionField = Core.Field {
...
selectionConditionOr x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SelectionCondition"),
  Core.injectionField = Core.Field {
...
selectionConditionNot x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SelectionCondition"),
  Core.injectionField = Core.Field {
...
simpleConditionLabelEquals x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
simpleConditionPropertyEquals x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SimpleCondition"),
  Core.injectionField = Core.Field {
...
simpleConditionPropertyComparison x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SimpleCondition"),
  Core.injectionField = Core.Field {
...
simpleConditionLengthEquals x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SimpleCondition"),
  Core.injectionField = Core.Field {
...
labelCondition target value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
labelConditionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
labelConditionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.LabelCondition"),
...
labelConditionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.LabelCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
labelConditionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.LabelCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
propertyCondition target property value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
propertyConditionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
propertyConditionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyCondition"),
...
propertyConditionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyCondition"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyConditionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
propertyConditionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
propertyConditionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
propertyComparisonCondition target property operator value = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
propertyComparisonConditionTarget x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
propertyComparisonConditionProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyComparisonCondition"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyComparisonConditionOperator x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyComparisonCondition"),
...
propertyComparisonConditionValue x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyComparisonCondition"),
    Core.projectionField = (Core.Name "value")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
propertyComparisonConditionWithTarget original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyComparisonCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
propertyComparisonConditionWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyComparisonCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
propertyComparisonConditionWithOperator original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyComparisonCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
propertyComparisonConditionWithValue original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyComparisonCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "target"),
...
comparisonOperatorEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
comparisonOperatorNotEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorLessThan = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorLessThanOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorGreaterThan = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
comparisonOperatorGreaterThanOrEqual = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ComparisonOperator"),
  Core.injectionField = Core.Field {
...
literalValueString x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
literalValueInteger x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.LiteralValue"),
  Core.injectionField = Core.Field {
...
literalValueFloat x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.LiteralValue"),
  Core.injectionField = Core.Field {
...
literalValueBoolean x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.LiteralValue"),
  Core.injectionField = Core.Field {
...
lengthCondition length = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
lengthConditionLength x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
lengthConditionWithLength original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.LengthCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "length"),
...
pathElementNode x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
pathElementEdge x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathElement"),
  Core.injectionField = Core.Field {
...
pathElementFirst = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathElement"),
  Core.injectionField = Core.Field {
...
pathElementLast = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathElement"),
  Core.injectionField = Core.Field {
...
andCondition left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
andConditionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
andConditionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.AndCondition"),
...
andConditionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.AndCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
andConditionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.AndCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
orCondition left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
orConditionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
orConditionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrCondition"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
orConditionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
orConditionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
notCondition condition = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
notConditionCondition x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
notConditionWithCondition original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.NotCondition"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "condition"),
...
joinExpression left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
joinExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
joinExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.JoinExpression"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
joinExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.JoinExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
joinExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.JoinExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
unionExpression left right = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
unionExpressionLeft x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
unionExpressionRight x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.UnionExpression"),
    Core.projectionField = (Core.Name "right")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
unionExpressionWithLeft original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.UnionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
unionExpressionWithRight original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.UnionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "left"),
...
recursiveExpression semantics expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
recursiveExpressionSemantics x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
recursiveExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.RecursiveExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
recursiveExpressionWithSemantics original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.RecursiveExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "semantics"),
...
recursiveExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.RecursiveExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "semantics"),
...
pathSemanticsWalk = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
pathSemanticsTrail = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathSemantics"),
  Core.injectionField = Core.Field {
...
pathSemanticsAcyclic = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathSemantics"),
  Core.injectionField = Core.Field {
...
pathSemanticsSimple = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathSemantics"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "simple"),
    Core.fieldTerm = Core.TermUnit}})))
...
pathSemanticsShortest = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathSemantics"),
  Core.injectionField = Core.Field {
...
solutionSpaceExpressionGroupBy x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
solutionSpaceExpressionOrderBy x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.SolutionSpaceExpression"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "orderBy"),
    Core.fieldTerm = (Phantoms.unTTerm x)}})))
...
groupByExpression criterion expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
groupByExpressionCriterion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
groupByExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
groupByExpressionWithCriterion original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "criterion"),
...
groupByExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "criterion"),
...
groupByCriterionNone = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
groupByCriterionSource = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByCriterion"),
  Core.injectionField = Core.Field {
...
groupByCriterionTarget = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByCriterion"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "target"),
    Core.fieldTerm = Core.TermUnit}})))
...
groupByCriterionLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByCriterion"),
  Core.injectionField = Core.Field {
    Core.fieldName = (Core.Name "length"),
    Core.fieldTerm = Core.TermUnit}})))
...
groupByCriterionSourceTarget = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByCriterion"),
  Core.injectionField = Core.Field {
...
groupByCriterionSourceLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByCriterion"),
  Core.injectionField = Core.Field {
...
groupByCriterionTargetLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByCriterion"),
  Core.injectionField = Core.Field {
...
groupByCriterionSourceTargetLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.GroupByCriterion"),
  Core.injectionField = Core.Field {
...
orderByExpression criterion expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
orderByExpressionCriterion x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
orderByExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
orderByExpressionWithCriterion original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "criterion"),
...
orderByExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "criterion"),
...
orderByCriterionPartition = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
orderByCriterionGroup = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByCriterion"),
  Core.injectionField = Core.Field {
...
orderByCriterionPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByCriterion"),
  Core.injectionField = Core.Field {
...
orderByCriterionPartitionGroup = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByCriterion"),
  Core.injectionField = Core.Field {
...
orderByCriterionPartitionPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByCriterion"),
  Core.injectionField = Core.Field {
...
orderByCriterionGroupPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByCriterion"),
  Core.injectionField = Core.Field {
...
orderByCriterionPartitionGroupPath = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.OrderByCriterion"),
  Core.injectionField = Core.Field {
...
projectionExpression partitions groups paths expression = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
projectionExpressionPartitions x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
projectionExpressionGroups x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionExpression"),
...
projectionExpressionPaths x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionExpression"),
...
projectionExpressionExpression x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionExpression"),
    Core.projectionField = (Core.Name "expression")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
projectionExpressionWithPartitions original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "partitions"),
...
projectionExpressionWithGroups original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "partitions"),
...
projectionExpressionWithPaths original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "partitions"),
...
projectionExpressionWithExpression original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionExpression"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "partitions"),
...
projectionSpecAll = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
projectionSpecLimited x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ProjectionSpec"),
  Core.injectionField = Core.Field {
...
resultProjection projections = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
resultProjectionProjections x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
resultProjectionWithProjections original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.ResultProjection"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "projections"),
...
propertyExtraction alias source = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
propertyExtractionAlias x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
propertyExtractionSource x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyExtraction"),
...
propertyExtractionWithAlias original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyExtraction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alias"),
...
propertyExtractionWithSource original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertyExtraction"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "alias"),
...
propertySourceNodeProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
propertySourceEdgeProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertySource"),
  Core.injectionField = Core.Field {
...
propertySourcePathProperty x = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PropertySource"),
  Core.injectionField = Core.Field {
...
nodePropertyRef element property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
nodePropertyRefElement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
nodePropertyRefProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.NodePropertyRef"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
nodePropertyRefWithElement original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.NodePropertyRef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "element"),
...
nodePropertyRefWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.NodePropertyRef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "element"),
...
edgePropertyRef element property = (Phantoms.TTerm (Core.TermRecord (Core.Record {
...
edgePropertyRefElement x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
...
edgePropertyRefProperty x = (Phantoms.TTerm (Core.TermApplication (Core.Application {
  Core.applicationFunction = (Core.TermFunction (Core.FunctionElimination (Core.EliminationRecord (Core.Projection {
    Core.projectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.EdgePropertyRef"),
    Core.projectionField = (Core.Name "property")})))),
  Core.applicationArgument = (Phantoms.unTTerm x)})))
...
edgePropertyRefWithElement original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.EdgePropertyRef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "element"),
...
edgePropertyRefWithProperty original newVal = (Phantoms.TTerm (Core.TermRecord (Core.Record {
  Core.recordTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.EdgePropertyRef"),
  Core.recordFields = [
    Core.Field {
      Core.fieldName = (Core.Name "element"),
...
pathPropertyRefLength = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
...
pathPropertyRefStartNode = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathPropertyRef"),
  Core.injectionField = Core.Field {
...
pathPropertyRefEndNode = (Phantoms.TTerm (Core.TermUnion (Core.Injection {
  Core.injectionTypeName = (Core.Name "com.gdblab.pathAlgebra.expressions.PathPropertyRef"),
  Core.injectionField = Core.Field {
