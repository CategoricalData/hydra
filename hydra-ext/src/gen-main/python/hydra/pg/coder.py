...
def encode_property(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, hydra.core.Term], adapter: hydra.coders.Adapter[hydra.core.FieldType, T0, hydra.core.Field, T1]):
    ...
    return hydra.lib.maybes.maybe((lambda : hydra.lib.logic.if_else(is_maybe(), (lambda : Right(Nothing())), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2("expected field not found in record: ", fname().value)))), cx))))), (lambda value: hydra.lib.logic.if_else(is_maybe(), (lambda : _hoist_fname_body_1(value, hydra.strip.deannotate_term(value))), (lambda : encode_value(value)))), hydra.lib.maps.lookup(fname(), fields))

def encode_properties(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, hydra.core.Term], adapters: frozenlist[hydra.coders.Adapter[hydra.core.FieldType, T0, hydra.core.Field, hydra.pg.model.Property[T1]]]) -> Either[hydra.context.InContext[hydra.errors.Error], FrozenDict[hydra.pg.model.PropertyKey, T1]]:
...
def select_edge_id(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, T0], ad: tuple[hydra.core.Name, hydra.coders.Adapter[T1, T2, T0, T3]]) -> Either[hydra.context.InContext[hydra.errors.Error], T3]:
...
def select_vertex_id(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, T0], ad: tuple[hydra.core.Name, hydra.coders.Adapter[T1, T2, T0, T3]]) -> Either[hydra.context.InContext[hydra.errors.Error], T3]:
...
def construct_edge_coder(cx: hydra.context.Context, g: hydra.graph.Graph, parent_label: hydra.pg.model.VertexLabel, schema: hydra.pg.mapping.Schema[T0, T1, T2], source: hydra.core.Type, vid_type: T1, eid_type: T1, dir: hydra.pg.model.Direction, name: hydra.core.Name, fields: frozenlist[hydra.core.FieldType], prop_adapters: frozenlist[hydra.coders.Adapter[hydra.core.FieldType, hydra.pg.model.PropertyType[T1], hydra.core.Field, hydra.pg.model.Property[T2]]], m_out_spec: Maybe[tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]], m_in_spec: Maybe[tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.coders.Adapter[hydra.core.Type, hydra.pg.model.ElementTypeTree[T1], hydra.core.Term, hydra.pg.model.ElementTree[T2]]]:
...
def construct_vertex_coder(cx: hydra.context.Context, g: hydra.graph.Graph, schema: hydra.pg.mapping.Schema[T0, T1, T2], source: hydra.core.Type, vid_type: T1, eid_type: T1, name: hydra.core.Name, fields: frozenlist[hydra.core.FieldType], prop_adapters: frozenlist[hydra.coders.Adapter[hydra.core.FieldType, hydra.pg.model.PropertyType[T1], hydra.core.Field, hydra.pg.model.Property[T2]]]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.coders.Adapter[hydra.core.Type, hydra.pg.model.ElementTypeTree[T1], hydra.core.Term, hydra.pg.model.ElementTree[T2]]]:
...
def find_adjacen_edge_adapters(cx: hydra.context.Context, g: hydra.graph.Graph, schema: hydra.pg.mapping.Schema[T0, T1, T2], vid_type: T1, eid_type: T1, parent_label: hydra.pg.model.VertexLabel, dir: hydra.pg.model.Direction, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[tuple[hydra.pg.model.Direction, tuple[hydra.core.FieldType, tuple[hydra.pg.model.EdgeLabel, hydra.coders.Adapter[hydra.core.Type, hydra.pg.model.ElementTypeTree[T1], hydra.core.Term, hydra.pg.model.ElementTree[hydra.context.InContext[hydra.errors.Error]]]]]]]]:
