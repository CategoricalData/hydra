...
def select_edge_id(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, T0], ad: tuple[hydra.core.Name, hydra.util.Adapter[T1, T2, T0, T3]]) -> Either[hydra.context.InContext[hydra.error.Error], T3]:
    ...
    return hydra.lib.maybes.maybe((lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2("no ", fname().value), " in record")))), cx))), (lambda t: adapter().coder.encode(cx, t)), hydra.lib.maps.lookup(fname(), fields))
...
def find_single_field_with_annotation_key(cx: hydra.context.Context, tname: hydra.core.Name, key: hydra.core.Name, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.error.Error], Maybe[hydra.core.FieldType]]:
    ...
    return hydra.lib.logic.if_else(hydra.lib.equality.gt(hydra.lib.lists.length(matches()), 1), (lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("Multiple fields marked as '", key.value), "' in record type "), tname.value)))), cx))), (lambda : Right(hydra.lib.lists.safe_head(matches()))))
...
def projection_adapter(cx: T0, g: T1, idtype: T2, coder: hydra.util.Coder[hydra.core.Term, T3], spec: tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, T4]], key: str) -> Either[T5, tuple[hydra.core.Name, hydra.util.Adapter[hydra.core.Type, T2, hydra.core.Term, T3]]]:
    ...
    return hydra.lib.eithers.bind(hydra.pg.terms_to_elements.parse_value_spec(cx, g, values()), (lambda traversal: Right((field().name, hydra.util.Adapter(True, field().type, idtype, hydra.util.Coder((lambda cx_, typ: hydra.lib.eithers.bind(traverse_to_single_term(cx_, hydra.lib.strings.cat2(key, "-projection"), (lambda v1: traversal(cx_, v1)), typ), (lambda t: coder.encode(cx_, t)))), (lambda cx_, _: Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2("edge '", key), "' decoding is not yet supported")))), cx_)))))))))
...
def property_adapter(cx: hydra.context.Context, g: T0, schema: hydra.pg.mapping.Schema[T1, T2, T3], spec: tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]) -> Either[hydra.context.InContext[hydra.error.Error], hydra.util.Adapter[hydra.core.FieldType, hydra.pg.model.PropertyType[T2], hydra.core.Field, hydra.pg.model.Property[T3]]]:
    ...
    return hydra.lib.eithers.bind(schema.property_types.encode(cx, tfield().type), (lambda pt: hydra.lib.eithers.bind(hydra.pg.terms_to_elements.parse_value_spec(cx, g, values()), (lambda traversal: Right(hydra.util.Adapter(True, tfield(), hydra.pg.model.PropertyType(key(), pt, True), hydra.util.Coder((lambda cx_, dfield: hydra.lib.eithers.bind(traverse_to_single_term(cx_, "property traversal", (lambda v1: traversal(cx_, v1)), dfield.term), (lambda result: hydra.lib.eithers.bind(schema.property_values.encode(cx_, result), (lambda value: Right(hydra.pg.model.Property(key(), value))))))), (lambda cx_, _: Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError("property decoding is not yet supported"))), cx_))))))))))
