...
def encode_property(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, hydra.core.Term], adapter: hydra.util.Adapter[hydra.core.FieldType, T0, hydra.core.Field, T1]) -> Either[hydra.context.InContext[hydra.errors.Error], Maybe[hydra.core.Term]]:
    ...
    return hydra.lib.maybes.maybe((lambda : hydra.lib.logic.if_else(is_maybe(), (lambda : Right(Nothing())), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2("expected field not found in record: ", fname().value)))), cx))))), (lambda value: hydra.lib.logic.if_else(is_maybe(), (lambda : _hoist_fname_body_1(value, hydra.rewriting.deannotate_term(value))), (lambda : encode_value(value)))), hydra.lib.maps.lookup(fname(), fields))
