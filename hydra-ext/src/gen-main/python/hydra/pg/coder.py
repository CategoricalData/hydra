...
def encode_property(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, hydra.core.Term], adapter: hydra.util.Adapter[hydra.core.FieldType, T0, hydra.core.Field, T1]):
    ...
    def ftyp() -> hydra.core.Type:
        return hydra.rewriting.deannotate_type(adapter.source.type)
    @lru_cache(1)
    def is_maybe() -> bool:
        match ftyp():
    ...
    return hydra.lib.maybes.maybe((lambda : hydra.lib.logic.if_else(is_maybe(), (lambda : Right(Nothing())), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2("expected field not found in record: ", fname().value)))), cx))))), (lambda value: hydra.lib.logic.if_else(is_maybe(), (lambda : _hoist_body_1(value, hydra.rewriting.deannotate_term(value))), (lambda : encode_value(value)))), hydra.lib.maps.lookup(fname(), fields))

def encode_properties(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, hydra.core.Term], adapters: frozenlist[hydra.util.Adapter[hydra.core.FieldType, T0, hydra.core.Field, hydra.pg.model.Property[T1]]]) -> Either[hydra.context.InContext[hydra.errors.Error], FrozenDict[hydra.pg.model.PropertyKey, T1]]:
...
def select_edge_id(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, T0], ad: tuple[hydra.core.Name, hydra.util.Adapter[T1, T2, T0, T3]]) -> Either[hydra.context.InContext[hydra.errors.Error], T3]:
    ...
    @lru_cache(1)
    def adapter() -> hydra.util.Adapter[T1, T2, T0, T3]:
        return hydra.lib.pairs.second(ad)
    return hydra.lib.maybes.maybe((lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2("no ", fname().value), " in record")))), cx))), (lambda t: adapter().coder.encode(cx, t)), hydra.lib.maps.lookup(fname(), fields))

def select_vertex_id(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, T0], ad: tuple[hydra.core.Name, hydra.util.Adapter[T1, T2, T0, T3]]) -> Either[hydra.context.InContext[hydra.errors.Error], T3]:
...
def edge_coder(g: T0, dir: hydra.pg.model.Direction, schema: hydra.pg.mapping.Schema[T1, T2, T3], source: T4, eid_type: T5, tname: hydra.core.Name, label: hydra.pg.model.EdgeLabel, out_label: hydra.pg.model.VertexLabel, in_label: hydra.pg.model.VertexLabel, m_id_adapter: Maybe[tuple[hydra.core.Name, hydra.util.Adapter[T6, T7, hydra.core.Term, T3]]], out_adapter: Maybe[tuple[hydra.core.Name, hydra.util.Adapter[T8, T9, hydra.core.Term, T3]]], in_adapter: Maybe[tuple[hydra.core.Name, hydra.util.Adapter[T10, T11, hydra.core.Term, T3]]], prop_adapters: frozenlist[hydra.util.Adapter[hydra.core.FieldType, hydra.pg.model.PropertyType[T5], hydra.core.Field, hydra.pg.model.Property[T3]]], vertex_adapters: frozenlist[tuple[hydra.core.Name, hydra.util.Adapter[T12, T13, hydra.core.Term, hydra.pg.model.ElementTree[T3]]]]) -> hydra.util.Adapter[T4, hydra.pg.model.ElementTypeTree[T5], hydra.core.Term, hydra.pg.model.ElementTree[T3]]:
    ...
    return hydra.util.Adapter(True, source, element_type_tree_edge(et(), ()), hydra.util.Coder((lambda cx, term: (deannot := hydra.rewriting.deannotate_term(term), unwrapped := (_hoist_unwrapped_1 := (lambda v1: (lambda mt: hydra.lib.maybes.from_maybe((lambda : deannot), mt))(v1.value) if isinstance(v1, hydra.core.TermMaybe) else deannot), _hoist_unwrapped_1(deannot))[1], rec := (_hoist_rec_1 := (lambda v1: (lambda r: r)(v1.value) if isinstance(v1, hydra.core.TermRecord) else hydra.dsl.python.unsupported("no matching case in inline union elimination")), _hoist_rec_1(unwrapped))[1], hydra.lib.eithers.bind(check_record_name(cx, tname, rec.type_name), (lambda _chk: (fieldsm := hydra.schemas.field_map(rec.fields), hydra.lib.eithers.bind(hydra.lib.maybes.maybe((lambda : Right(schema.default_edge_id)), (lambda v1: select_edge_id(cx, fieldsm, v1)), m_id_adapter), (lambda edge_id: hydra.lib.eithers.bind(encode_properties(cx, fieldsm, prop_adapters), (lambda props: (get_vertex_id := (lambda dir_check, adapter: hydra.lib.maybes.maybe((lambda : Right(schema.default_vertex_id)), (lambda v1: select_vertex_id(cx, fieldsm, v1)), hydra.lib.logic.if_else(hydra.lib.equality.equal(dir, dir_check), (lambda : Nothing()), (lambda : adapter)))), hydra.lib.eithers.bind(get_vertex_id(hydra.pg.model.Direction.OUT, out_adapter), (lambda out_id: hydra.lib.eithers.bind(get_vertex_id(hydra.pg.model.Direction.IN, in_adapter), (lambda in_id: hydra.lib.eithers.bind(hydra.lib.eithers.map((lambda xs: hydra.lib.maybes.cat(xs)), hydra.lib.eithers.map_list((lambda va: (fname := hydra.lib.pairs.first(va), ad := hydra.lib.pairs.second(va), hydra.lib.maybes.maybe((lambda : Right(Nothing())), (lambda fterm: hydra.lib.eithers.map((lambda x: Just(x)), ad.coder.encode(cx, fterm))), hydra.lib.maps.lookup(fname, fieldsm)))[2]), vertex_adapters)), (lambda deps: Right(element_tree_edge(hydra.pg.model.Edge(label, edge_id, out_id, in_id, props), deps)))))))))[1])))))[1])))[3]), (lambda cx, _: Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("edge decoding is not yet supported"))), cx)))))

def find_single_field_with_annotation_key(cx: hydra.context.Context, tname: hydra.core.Name, key: hydra.core.Name, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], Maybe[hydra.core.FieldType]]:
    ...
    return hydra.lib.logic.if_else(hydra.lib.equality.gt(hydra.lib.lists.length(matches()), 1), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("Multiple fields marked as '", key.value), "' in record type "), tname.value)))), cx))), (lambda : Right(hydra.lib.lists.safe_head(matches()))))

def find_id_projection_spec(cx: hydra.context.Context, required: bool, tname: hydra.core.Name, id_key: hydra.core.Name, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], Maybe[tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]]]:
    r"""Find an id projection spec for a field."""

    return hydra.lib.eithers.bind(find_single_field_with_annotation_key(cx, tname, id_key, fields), (lambda mid: hydra.lib.maybes.maybe((lambda : hydra.lib.logic.if_else(required, (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2("no ", id_key.value), " field")))), cx))), (lambda : Right(Nothing())))), (lambda mi: hydra.lib.eithers.map((lambda spec: Just((mi, (spec, hydra.lib.maybes.map((lambda s: hydra.lib.strings.to_upper(s)), Nothing()))))), hydra.lib.maybes.maybe((lambda : Right(cast(hydra.pg.mapping.ValueSpec, hydra.pg.mapping.ValueSpecValue()))), (lambda v1: hydra.pg.terms_to_elements.decode_value_spec(cx, hydra.graph.Graph(hydra.lib.maps.empty(), hydra.lib.maps.empty(), hydra.lib.maps.empty(), hydra.lib.sets.empty(), hydra.lib.maps.empty(), hydra.lib.maps.empty(), hydra.lib.maps.empty(), hydra.lib.sets.empty()), v1)), hydra.annotations.get_type_annotation(id_key, mi.type)))), mid)))

def traverse_to_single_term(cx: hydra.context.Context, desc: str, traversal: Callable[[T0], Either[hydra.context.InContext[hydra.errors.Error], frozenlist[T1]]], term: T0) -> Either[hydra.context.InContext[hydra.errors.Error], T1]:
    r"""Traverse to a single term, failing if zero or multiple terms are found."""

    return hydra.lib.eithers.bind(traversal(term), (lambda terms: hydra.lib.logic.if_else(hydra.lib.lists.null(terms), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(desc, " did not resolve to a term")))), cx))), (lambda : hydra.lib.logic.if_else(hydra.lib.equality.equal(hydra.lib.lists.length(terms), 1), (lambda : Right(hydra.lib.lists.head(terms))), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(desc, " resolved to multiple terms")))), cx))))))))
...
def projection_adapter(cx: T0, g: T1, idtype: T2, coder: hydra.util.Coder[hydra.core.Term, T3], spec: tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, T4]], key: str) -> Either[T5, tuple[hydra.core.Name, hydra.util.Adapter[hydra.core.Type, T2, hydra.core.Term, T3]]]:
    ...
    return hydra.lib.eithers.bind(hydra.pg.terms_to_elements.parse_value_spec(cx, g, values()), (lambda traversal: Right((field().name, hydra.util.Adapter(True, field().type, idtype, hydra.util.Coder((lambda cx_, typ: hydra.lib.eithers.bind(traverse_to_single_term(cx_, hydra.lib.strings.cat2(key, "-projection"), (lambda v1: traversal(cx_, v1)), typ), (lambda t: coder.encode(cx_, t)))), (lambda cx_, _: Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2("edge '", key), "' decoding is not yet supported")))), cx_)))))))))

def edge_id_adapter(cx: hydra.context.Context, g: T0, schema: hydra.pg.mapping.Schema[T1, T2, T3], eid_type: T4, name: hydra.core.Name, id_key: hydra.core.Name, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], Maybe[tuple[hydra.core.Name, hydra.util.Adapter[hydra.core.Type, T4, hydra.core.Term, T3]]]]:
...
def extract_string(cx: hydra.context.Context, g: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], str]:
    r"""Extract a string from a term."""

    return hydra.extract.core.string(cx, g, t)

def find_label_string(cx: hydra.context.Context, g: hydra.graph.Graph, source: hydra.core.Type, tname: hydra.core.Name, label_key: hydra.core.Name) -> Either[hydra.context.InContext[hydra.errors.Error], str]:
...
def vertex_coder(g: T0, schema: hydra.pg.mapping.Schema[T1, T2, T3], source: T4, vid_type: T5, tname: T6, vlabel: hydra.pg.model.VertexLabel, id_adapter: tuple[hydra.core.Name, hydra.util.Adapter[T7, T8, hydra.core.Term, T3]], prop_adapters: frozenlist[hydra.util.Adapter[hydra.core.FieldType, hydra.pg.model.PropertyType[T5], hydra.core.Field, hydra.pg.model.Property[T3]]], edge_adapters: frozenlist[tuple[hydra.pg.model.Direction, tuple[hydra.core.FieldType, tuple[hydra.pg.model.EdgeLabel, hydra.util.Adapter[T9, hydra.pg.model.ElementTypeTree[T5], hydra.core.Term, hydra.pg.model.ElementTree[T3]]]]]]):
    ...
    return hydra.util.Adapter(True, source, target(), hydra.util.Coder((lambda cx, term: (deannot := hydra.rewriting.deannotate_term(term), unwrapped := (_hoist_unwrapped_1 := (lambda v1: (lambda mt: hydra.lib.maybes.from_maybe((lambda : deannot), mt))(v1.value) if isinstance(v1, hydra.core.TermMaybe) else deannot), _hoist_unwrapped_1(deannot))[1], rec := (_hoist_rec_1 := (lambda v1: (lambda r: r)(v1.value) if isinstance(v1, hydra.core.TermRecord) else hydra.dsl.python.unsupported("no matching case in inline union elimination")), _hoist_rec_1(unwrapped))[1], fmap := hydra.schemas.field_map(rec.fields), hydra.lib.eithers.bind(select_vertex_id(cx, fmap, id_adapter), (lambda vid: hydra.lib.eithers.bind(encode_properties(cx, fmap, prop_adapters), (lambda props: hydra.lib.eithers.bind(hydra.lib.eithers.map((lambda xs: hydra.lib.lists.concat(xs)), hydra.lib.eithers.map_list((lambda ea: (ea_dir := hydra.lib.pairs.first(ea), ea_field := hydra.lib.pairs.first(hydra.lib.pairs.second(ea)), ea_label := hydra.lib.pairs.first(hydra.lib.pairs.second(hydra.lib.pairs.second(ea))), ea_adapter := hydra.lib.pairs.second(hydra.lib.pairs.second(hydra.lib.pairs.second(ea))), _hoist_body_1 := (lambda tree, v1: (lambda vtx: (otherid := vtx.id, edgeid := schema.default_edge_id, out_id := (_hoist_out_id_1 := (lambda v12: (lambda _: vid)(v12) if v12 else (lambda _: otherid)(v12) if v12 else hydra.dsl.python.unsupported("no matching case in inline union elimination")), _hoist_out_id_1(ea_dir))[1], in_id := (_hoist_in_id_1 := (lambda v12: (lambda _: otherid)(v12) if v12 else (lambda _: vid)(v12) if v12 else hydra.dsl.python.unsupported("no matching case in inline union elimination")), _hoist_in_id_1(ea_dir))[1], edge := cast(hydra.pg.model.Element, hydra.pg.model.ElementEdge(hydra.pg.model.Edge(ea_label, edgeid, out_id, in_id, hydra.lib.maps.empty()))), (hydra.pg.model.ElementTree(edge, (tree,)),))[5])(v1.value) if isinstance(v1, hydra.pg.model.ElementVertex) else (lambda edg: (fixed_edge := (_hoist_fixed_edge_1 := (lambda v12: (lambda _: hydra.pg.model.Edge(edg.label, edg.id, vid, edg.in_, edg.properties))(v12) if v12 else (lambda _: hydra.pg.model.Edge(edg.label, edg.id, edg.out, vid, edg.properties))(v12) if v12 else hydra.dsl.python.unsupported("no matching case in inline union elimination")), _hoist_fixed_edge_1(ea_dir))[1], (hydra.pg.model.ElementTree(cast(hydra.pg.model.Element, hydra.pg.model.ElementEdge(fixed_edge)), tree.dependencies),))[1])(v1.value) if isinstance(v1, hydra.pg.model.ElementEdge) else hydra.dsl.python.unsupported("no matching case in inline union elimination")), hydra.lib.maybes.maybe((lambda : Right(())), (lambda fterm: hydra.lib.eithers.map((lambda tree: _hoist_body_1(tree, tree.self)), ea_adapter.coder.encode(cx, fterm))), hydra.lib.maps.lookup(ea_field.name, fmap)))[5]), edge_adapters)), (lambda deps: Right(element_tree_vertex(hydra.pg.model.Vertex(vlabel, vid, props), deps)))))))))[4]), (lambda cx, _: Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("vertex decoding is not yet supported"))), cx)))))

def vertex_id_adapter(cx: hydra.context.Context, g: T0, schema: hydra.pg.mapping.Schema[T1, T2, T3], vid_type: T4, name: hydra.core.Name, id_key: hydra.core.Name, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], tuple[hydra.core.Name, hydra.util.Adapter[hydra.core.Type, T4, hydra.core.Term, T3]]]:
...
def find_projection_spec(cx: hydra.context.Context, g: hydra.graph.Graph, tname: hydra.core.Name, key: hydra.core.Name, alias_key: hydra.core.Name, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], Maybe[tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]]]:
...
def find_property_specs(cx: hydra.context.Context, g: hydra.graph.Graph, schema: hydra.pg.mapping.Schema[T0, T1, T2], kind: hydra.pg.model.ElementKind, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]]]:
...
def property_adapter(cx: hydra.context.Context, g: T0, schema: hydra.pg.mapping.Schema[T1, T2, T3], spec: tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.util.Adapter[hydra.core.FieldType, hydra.pg.model.PropertyType[T2], hydra.core.Field, hydra.pg.model.Property[T3]]]:
...
def element_coder(mparent: Maybe[tuple[hydra.pg.model.Direction, hydra.pg.model.VertexLabel]], schema: hydra.pg.mapping.Schema[T0, T1, T2], source: hydra.core.Type, vid_type: T1, eid_type: T1, cx: hydra.context.Context, g: hydra.graph.Graph):
    ...
    while True:
        ...
        match hydra.rewriting.deannotate_type(source):
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("Expected ", "record type"), ", found: "), "other type")))), cx))

def find_adjacen_edge_adapters(cx: hydra.context.Context, g: hydra.graph.Graph, schema: hydra.pg.mapping.Schema[T0, T1, T2], vid_type: T1, eid_type: T1, parent_label: hydra.pg.model.VertexLabel, dir: hydra.pg.model.Direction, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[tuple[hydra.pg.model.Direction, tuple[hydra.core.FieldType, tuple[hydra.pg.model.EdgeLabel, hydra.util.Adapter[hydra.core.Type, hydra.pg.model.ElementTypeTree[T1], hydra.core.Term, hydra.pg.model.ElementTree[hydra.context.InContext[hydra.errors.Error]]]]]]]]:
...
def find_incident_vertex_adapter(cx: hydra.context.Context, g: hydra.graph.Graph, schema: hydra.pg.mapping.Schema[T0, T1, T2], vid_type: T1, eid_type: T1, spec: tuple[hydra.core.FieldType, tuple[hydra.pg.mapping.ValueSpec, Maybe[str]]]) -> Either[hydra.context.InContext[hydra.errors.Error], tuple[hydra.core.Name, hydra.util.Adapter[hydra.core.Type, hydra.pg.model.ElementTypeTree[T1], hydra.core.Term, hydra.pg.model.ElementTree[T2]]]]:
