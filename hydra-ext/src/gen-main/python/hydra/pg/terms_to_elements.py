    ...
    def _hoist_hydra_pg_terms_to_elements_eval_step_1(cx, step, v1):
        match v1:
            ...
            case hydra.core.TermRecord(value=rec):
                return hydra.lib.maybes.maybe((lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2("No such field ", step), " in record")))), cx))), (lambda t: Right((t,))), hydra.lib.maps.lookup(hydra.core.Name(step), hydra.schemas.field_map(rec.fields)))
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2("Can't traverse through term for step ", step)))), cx))
...
def eval_path(cx: hydra.context.Context, path: frozenlist[str], term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], frozenlist[hydra.core.Term]]:
...
def apply_pattern(cx: hydra.context.Context, first_lit: str, pairs: frozenlist[tuple[frozenlist[str], str]], term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], frozenlist[hydra.core.Term]]:
...
def decode_edge_label(cx: hydra.context.Context, g: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.pg.model.EdgeLabel]:
...
def decode_property_key(cx: hydra.context.Context, g: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.pg.model.PropertyKey]:
...
def read_injection(cx: hydra.context.Context, g: hydra.graph.Graph, cases: frozenlist[tuple[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], T0]]]], encoded: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], T0]:
    r"""Read an injection (union value) from a term."""
    
    return hydra.lib.eithers.bind(hydra.extract.core.map(cx, (lambda k: hydra.lib.eithers.map((lambda _n: hydra.core.Name(_n)), hydra.extract.core.string(cx, g, k))), (lambda _v: Right(_v)), g, encoded), (lambda mp: (entries := hydra.lib.maps.to_list(mp), hydra.lib.logic.if_else(hydra.lib.lists.null(entries), (lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError("empty injection"))), cx))), (lambda : (f := hydra.lib.lists.head(entries), key := hydra.lib.pairs.first(f), val := hydra.lib.pairs.second(f), matching := hydra.lib.lists.filter((lambda c: hydra.lib.equality.equal(hydra.lib.pairs.first(c), key)), cases), hydra.lib.logic.if_else(hydra.lib.lists.null(matching), (lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2("unexpected field: ", key.value)))), cx))), (lambda : hydra.lib.pairs.second(hydra.lib.lists.head(matching))(val))))[4])))[1]))
...
def read_field(cx: hydra.context.Context, fields: FrozenDict[hydra.core.Name, T0], fname: hydra.core.Name, fun: Callable[[T0], Either[hydra.context.InContext[hydra.error.Error], T1]]) -> Either[hydra.context.InContext[hydra.error.Error], T0]:
    r"""Read a field from a map of fields by name."""
    
    return hydra.lib.maybes.maybe((lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2("no such field: ", fname.value)))), cx))), fun, hydra.lib.maps.lookup(fname, fields))

def read_record(cx: hydra.context.Context, g: hydra.graph.Graph, cons: Callable[[FrozenDict[hydra.core.Name, hydra.core.Term]], Either[hydra.context.InContext[hydra.error.Error], T0]], term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], T0]:
...
def decode_property_spec(cx: hydra.context.Context, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.pg.mapping.PropertySpec]:
...
def expect_list(cx: hydra.context.Context, g: hydra.graph.Graph, f: Callable[[hydra.context.Context, hydra.graph.Graph, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], T0]], term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], frozenlist[T0]]:
...
def decode_edge_spec(cx: hydra.context.Context, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.pg.mapping.EdgeSpec]:
...
def decode_vertex_label(cx: hydra.context.Context, g: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.pg.model.VertexLabel]:
...
def decode_vertex_spec(cx: hydra.context.Context, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.pg.mapping.VertexSpec]:
...
def decode_element_spec(cx: hydra.context.Context, g: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.pg.mapping.ElementSpec]:
...
def parse_pattern(cx: T0, _g: T1, pat: str) -> Either[T2, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[hydra.core.Term]]]]:
...
def parse_value_spec(cx: T0, g: T1, spec: hydra.pg.mapping.ValueSpec) -> Either[T2, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[hydra.core.Term]]]]:
...
def parse_edge_id_pattern(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.ValueSpec) -> Either[T5, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[T4]]]]:
...
def parse_property_spec(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.PropertySpec) -> Either[T5, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[tuple[hydra.pg.model.PropertyKey, T4]]]]]:
...
def parse_vertex_id_pattern(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.ValueSpec) -> Either[T5, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[T4]]]]:
...
def require_unique(cx: hydra.context.Context, context: str, fun: Callable[[T0], Either[hydra.context.InContext[hydra.error.Error], frozenlist[T1]]], term: T0) -> Either[hydra.context.InContext[hydra.error.Error], T1]:
    r"""Require exactly one result from a list-producing function."""
    
    return hydra.lib.eithers.bind(fun(term), (lambda results: hydra.lib.logic.if_else(hydra.lib.lists.null(results), (lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2("No value found: ", context)))), cx))), (lambda : hydra.lib.logic.if_else(hydra.lib.equality.equal(hydra.lib.lists.length(results), 1), (lambda : Right(hydra.lib.lists.head(results))), (lambda : Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2("Multiple values found: ", context)))), cx))))))))

def parse_edge_spec(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.EdgeSpec) -> Either[T5, tuple[hydra.pg.model.Label, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[hydra.pg.model.Element[T4]]]]]]:
...
def parse_vertex_spec(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.VertexSpec) -> Either[T5, tuple[hydra.pg.model.Label, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[hydra.pg.model.Element[T4]]]]]]:
...
def parse_element_spec(cx: T0, g: T1, schema: hydra.pg.mapping.Schema[T2, T3, T4], spec: hydra.pg.mapping.ElementSpec) -> Either[T5, tuple[hydra.pg.model.Label, Callable[[hydra.context.Context, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], frozenlist[hydra.pg.model.Element[T4]]]]]]:
...
def term_to_elements_adapter(cx: hydra.context.Context, g: hydra.graph.Graph, schema: hydra.pg.mapping.Schema[T0, T1, T2], typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.Error], hydra.util.Adapter[hydra.core.Type, frozenlist[hydra.pg.model.Label], hydra.core.Term, frozenlist[hydra.pg.model.Element[T2]]]]:
