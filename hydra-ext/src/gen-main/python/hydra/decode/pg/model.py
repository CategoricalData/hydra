    ...
    def _hoist_hydra_decode_pg_model_edge_label_3(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.pg.model.EdgeLabel(b)), hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped2: _hoist_hydra_decode_pg_model_edge_label_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, wrapped_term.body)))
...
def property_key(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    def _hoist_hydra_decode_pg_model_property_key_3(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.pg.model.PropertyKey(b)), hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped2: _hoist_hydra_decode_pg_model_property_key_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, wrapped_term.body)))
...
def adjacent_edge(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def edge(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def property_type(t: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def vertex_label(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    def _hoist_hydra_decode_pg_model_vertex_label_3(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.pg.model.VertexLabel(b)), hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped2: _hoist_hydra_decode_pg_model_vertex_label_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, wrapped_term.body)))
...
def edge_type(t: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def vertex(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def element(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_pg_model_element_1(cx, v, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.pg.model.Element[T0]]]]:
...
def element_tree(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def vertex_type(t: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def element_type(t: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_pg_model_element_type_1(cx, t, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.pg.model.ElementType[T0]]]]:
...
def element_type_tree(t: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def graph(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def graph_schema(t: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def lazy_graph(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def property(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
...
def vertex_with_adjacent_edges(v: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
