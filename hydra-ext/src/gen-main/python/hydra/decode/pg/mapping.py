                ...
                def variant_map():
                    ...
                    def _hoist_variant_map_2(v12):
                        match v12:
                            ...
                            case _:
                                return Left(hydra.error.DecodingError("expected literal"))
                    return hydra.lib.maps.from_list(((hydra.core.Name("value"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.pg.mapping.ValueSpec, hydra.pg.mapping.ValueSpecValue())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("pattern"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.pg.mapping.ValueSpec, hydra.pg.mapping.ValueSpecPattern(t))), hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped2: _hoist_variant_map_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, input)))))))
