...
Create.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Create")

class Set(Node["frozenlist[SetItem]"]):
    ...

Set.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Set")
...
Remove.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Remove")
...
Return.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Return")
...
Order.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Order")

class Skip(Node["Expression"]):
    ...

Skip.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Skip")

class Limit(Node["Expression"]):
    ...

Limit.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Limit")
...
Where.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Where")

class Pattern(Node["frozenlist[PatternPart]"]):
    ...

Pattern.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Pattern")
...
AnonymousPatternPart.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.AnonymousPatternPart")
...
RelationshipTypes.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.RelationshipTypes")

class NodeLabels(Node["frozenlist[NodeLabel]"]):
    ...

NodeLabels.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.NodeLabels")

class NodeLabel(Node[str]):
    ...

NodeLabel.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.NodeLabel")
...
RelTypeName.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.RelTypeName")
...
Expression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Expression")

class OrExpression(Node["frozenlist[XorExpression]"]):
    ...

OrExpression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.OrExpression")

class XorExpression(Node["frozenlist[AndExpression]"]):
    ...

XorExpression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.XorExpression")

class AndExpression(Node["frozenlist[NotExpression]"]):
    ...

AndExpression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.AndExpression")
...
ListPredicateExpression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.ListPredicateExpression")

class NullPredicateExpression(Node[bool]):
    ...

NullPredicateExpression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.NullPredicateExpression")
...
PowerOfExpression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.PowerOfExpression")
...
PropertyLookup.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.PropertyLookup")
...
PatternPredicate.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.PatternPredicate")

class ParenthesizedExpression(Node["Expression"]):
    ...

ParenthesizedExpression.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.ParenthesizedExpression")
...
ImplicitProcedureInvocation.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.ImplicitProcedureInvocation")

class ProcedureResultField(Node[str]):
    ...

ProcedureResultField.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.ProcedureResultField")

class Variable(Node[str]):
    ...

Variable.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.Variable")
...
StringLiteral.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.StringLiteral")

class ListLiteral(Node["frozenlist[Expression]"]):
    ...

ListLiteral.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.ListLiteral")

class MapLiteral(Node["frozenlist[KeyValuePair]"]):
    ...

MapLiteral.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.MapLiteral")
...
PropertyKeyName.TYPE_ = hydra.core.Name("hydra.ext.cypher.openCypher.PropertyKeyName")
