...
public interface Coder {
  ...
  static <T0, T1, T2> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>> constructEdgeCoder(hydra.context.Context cx, hydra.graph.Graph g, hydra.pg.model.VertexLabel parentLabel, hydra.pg.mapping.Schema<T0, T1, T2> schema, hydra.core.Type source, T1 vidType, T1 eidType, hydra.pg.model.Direction dir, hydra.core.Name name, hydra.util.ConsList<hydra.core.FieldType> fields, hydra.util.ConsList<hydra.compute.Adapter<hydra.core.FieldType, hydra.pg.model.PropertyType<T1>, hydra.core.Field, hydra.pg.model.Property<T2>>> propAdapters, hydra.util.Maybe<hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.mapping.ValueSpec, hydra.util.Maybe<String>>>> mOutSpec, hydra.util.Maybe<hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.mapping.ValueSpec, hydra.util.Maybe<String>>>> mInSpec) {
        ...
        return hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<hydra.util.Pair<hydra.core.Name, hydra.util.Adapter<hydra.core.Type, T1, hydra.core.Term, T2>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>) (idAdapter -> hydra.lib.eithers.Bind.apply(
            hydra.pg.coder.Coder.<T0, T1, T2>findAdjacenEdgeAdapters(
              ...
              fields),
            (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>) (outEdgeAdapters -> hydra.lib.eithers.Bind.apply(
              hydra.pg.coder.Coder.<T0, T1, T2>findAdjacenEdgeAdapters(
                cx,
                g,
                schema,
  ...
  static <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> hydra.compute.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>> edgeCoder(T0 g, hydra.pg.model.Direction dir, hydra.pg.mapping.Schema<T1, T2, T3> schema, T4 source, T5 eidType, hydra.core.Name tname, hydra.pg.model.EdgeLabel label, hydra.pg.model.VertexLabel outLabel, hydra.pg.model.VertexLabel inLabel, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<T6, T7, hydra.core.Term, T3>>> mIdAdapter, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<T8, T9, hydra.core.Term, T3>>> outAdapter, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<T10, T11, hydra.core.Term, T3>>> inAdapter, hydra.util.ConsList<hydra.compute.Adapter<hydra.core.FieldType, hydra.pg.model.PropertyType<T5>, hydra.core.Field, hydra.pg.model.Property<T3>>> propAdapters, hydra.util.ConsList<hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<T12, T13, hydra.core.Term, hydra.pg.model.ElementTree<T3>>>> vertexAdapters) {
    return (hydra.compute.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.compute.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.compute.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.compute.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) (new hydra.compute.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>(true, source, hydra.pg.coder.Coder.<T5>elementTypeTreeEdge(
      hydra.pg.coder.Coder.<T3, T5>edgeCoder_et(
        ...
        outLabel,
        propAdapters),
      (hydra.util.ConsList<hydra.pg.model.ElementTypeTree<T5>>) (hydra.util.ConsList.<hydra.pg.model.ElementTypeTree<T5>>of())), (hydra.compute.Coder<hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.compute.Coder<hydra.core.Term, hydra.pg.model.ElementTree<T3>>) (new hydra.compute.Coder<hydra.core.Term, hydra.pg.model.ElementTree<T3>>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>>) (cx -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (term -> {
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<T3, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (edgeId -> hydra.lib.eithers.Bind.apply(
              hydra.pg.coder.Coder.encodeProperties(
                ...
                fieldsm,
                propAdapters),
              (java.util.function.Function<hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T3>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (props -> hydra.lib.eithers.Bind.apply(
                  ...
                  (java.util.function.Function<T3, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (inId -> hydra.lib.eithers.Bind.apply(
                    hydra.lib.eithers.Map.apply(
                      ...
                      hydra.lib.eithers.MapList.apply(
                        ...
                        vertexAdapters)),
                    (java.util.function.Function<hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (deps -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>right(hydra.pg.coder.Coder.<T3>elementTreeEdge(
  ...
  static <T3, T5> hydra.pg.model.EdgeType<T5> edgeCoder_et(T5 eidType, hydra.pg.model.VertexLabel inLabel, hydra.pg.model.EdgeLabel label, hydra.pg.model.VertexLabel outLabel, hydra.util.ConsList<hydra.compute.Adapter<hydra.core.FieldType, hydra.pg.model.PropertyType<T5>, hydra.core.Field, hydra.pg.model.Property<T3>>> propAdapters) {
            ...
            (java.util.function.Function<hydra.util.Maybe<hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.mapping.ValueSpec, hydra.util.Maybe<String>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>) (mInSpec -> {
              ...
              return hydra.lib.eithers.Bind.apply(
                hydra.pg.coder.Coder.<T0, T1, T2>findPropertySpecs(
                  ...
                  kind.get(),
                  fields),
                (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.mapping.ValueSpec, hydra.util.Maybe<String>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>) (propSpecs -> hydra.lib.eithers.Bind.apply(
                  hydra.lib.eithers.MapList.apply(
  ...
  static <T0, T1> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Maybe<T1>> encodeProperty(hydra.context.Context cx, hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term> fields, hydra.compute.Adapter<hydra.core.FieldType, T0, hydra.core.Field, T1> adapter) {
  ...
  static <T0, T1, T2> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>>>> findAdjacenEdgeAdapters(hydra.context.Context cx, hydra.graph.Graph g, hydra.pg.mapping.Schema<T0, T1, T2> schema, T1 vidType, T1 eidType, hydra.pg.model.VertexLabel parentLabel, hydra.pg.model.Direction dir, hydra.util.ConsList<hydra.core.FieldType> fields) {
    return hydra.lib.eithers.Map.apply(
      (java.util.function.Function<hydra.util.ConsList<hydra.util.Maybe<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>>>>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<hydra.core.Type, hydra.pg.model.ElementTypeTree<T1>, hydra.core.Term, hydra.pg.model.ElementTree<T2>>>>>>>) (xs -> hydra.lib.maybes.Cat.apply(xs)),
      hydra.lib.eithers.MapList.apply(
  ...
  static <T0, T1, T2, T3> hydra.util.ConsList<hydra.pg.model.PropertyType<T1>> propertyTypes(hydra.util.ConsList<hydra.compute.Adapter<T0, hydra.pg.model.PropertyType<T1>, T2, T3>> propAdapters) {
  ...
  static <T0, T1, T2, T3> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T3> selectEdgeId(hydra.context.Context cx, hydra.util.PersistentMap<hydra.core.Name, T0> fields, hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<T1, T2, T0, T3>> ad) {
  ...
  static <T0, T1, T2, T3> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T3> selectVertexId(hydra.context.Context cx, hydra.util.PersistentMap<hydra.core.Name, T0> fields, hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<T1, T2, T0, T3>> ad) {
    hydra.util.Lazy<hydra.core.Name> fname = new hydra.util.Lazy<>(() -> hydra.lib.pairs.First.apply(ad));
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, T3>left((hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
        hydra.lib.strings.Cat2.apply(
  ...
  static <T0, T1> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T1> traverseToSingleTerm(hydra.context.Context cx, String desc, java.util.function.Function<T0, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T1>>> traversal, T0 term) {
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<hydra.util.ConsList<T1>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T1>>) (terms -> hydra.lib.logic.IfElse.lazy(
  ...
  static <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> hydra.compute.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>> vertexCoder(T0 g, hydra.pg.mapping.Schema<T1, T2, T3> schema, T4 source, T5 vidType, T6 tname, hydra.pg.model.VertexLabel vlabel, hydra.util.Pair<hydra.core.Name, hydra.compute.Adapter<T7, T8, hydra.core.Term, T3>> idAdapter, hydra.util.ConsList<hydra.compute.Adapter<hydra.core.FieldType, hydra.pg.model.PropertyType<T5>, hydra.core.Field, hydra.pg.model.Property<T3>>> propAdapters, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<T9, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>>>>> edgeAdapters) {
        ...
        (java.util.function.Function<T3, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (vid -> hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T3>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (props -> hydra.lib.eithers.Bind.apply(
            hydra.lib.eithers.Map.apply(
              ...
              hydra.lib.eithers.MapList.apply(
                (java.util.function.Function<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<T9, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>>>) (ea -> {
                  ...
                  return hydra.lib.maybes.Maybe.applyLazy(
                    () -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>>right((hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>) (hydra.util.ConsList.<hydra.pg.model.ElementTree<T3>>of())),
                    (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>>>) (fterm -> hydra.lib.eithers.Map.apply(
                ...
                edgeAdapters)),
            (java.util.function.Function<hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (deps -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>right(hydra.pg.coder.Coder.<T3>elementTreeVertex(
  ...
  static <T3, T5> hydra.pg.model.VertexType<T5> vertexCoder_vtype(hydra.util.ConsList<hydra.compute.Adapter<hydra.core.FieldType, hydra.pg.model.PropertyType<T5>, hydra.core.Field, hydra.pg.model.Property<T3>>> propAdapters, T5 vidType, hydra.pg.model.VertexLabel vlabel) {
  ...
  static <T3, T5, T9> hydra.util.ConsList<hydra.pg.model.ElementTypeTree<T5>> vertexCoder_depTypes(hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<T9, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>>>>> edgeAdapters) {
    return hydra.lib.lists.Map.apply(
  ...
  static <T3, T5, T9> hydra.pg.model.ElementTypeTree<T5> vertexCoder_target(hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.compute.Adapter<T9, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>>>>> edgeAdapters, hydra.util.ConsList<hydra.compute.Adapter<hydra.core.FieldType, hydra.pg.model.PropertyType<T5>, hydra.core.Field, hydra.pg.model.Property<T3>>> propAdapters, T5 vidType, hydra.pg.model.VertexLabel vlabel) {
