  ...
  static <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> hydra.util.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>> edgeCoder(T0 g, hydra.pg.model.Direction dir, hydra.pg.mapping.Schema<T1, T2, T3> schema, T4 source, T5 eidType, hydra.core.Name tname, hydra.pg.model.EdgeLabel label, hydra.pg.model.VertexLabel outLabel, hydra.pg.model.VertexLabel inLabel, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.util.Adapter<T6, T7, hydra.core.Term, T3>>> mIdAdapter, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.util.Adapter<T8, T9, hydra.core.Term, T3>>> outAdapter, hydra.util.Maybe<hydra.util.Pair<hydra.core.Name, hydra.util.Adapter<T10, T11, hydra.core.Term, T3>>> inAdapter, hydra.util.ConsList<hydra.util.Adapter<hydra.core.FieldType, hydra.pg.model.PropertyType<T5>, hydra.core.Field, hydra.pg.model.Property<T3>>> propAdapters, hydra.util.ConsList<hydra.util.Pair<hydra.core.Name, hydra.util.Adapter<T12, T13, hydra.core.Term, hydra.pg.model.ElementTree<T3>>>> vertexAdapters) {
    return (hydra.util.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.util.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.util.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.util.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>) (new hydra.util.Adapter<T4, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>(true, source, hydra.pg.coder.Coder.<T5>elementTypeTreeEdge(
      hydra.pg.coder.Coder.<T3, T5>edgeCoder_et(
        ...
        outLabel,
        propAdapters),
      (hydra.util.ConsList<hydra.pg.model.ElementTypeTree<T5>>) (hydra.util.ConsList.<hydra.pg.model.ElementTypeTree<T5>>empty())), (hydra.util.Coder<hydra.core.Term, hydra.pg.model.ElementTree<T3>>) ((hydra.util.Coder<hydra.core.Term, hydra.pg.model.ElementTree<T3>>) (new hydra.util.Coder<hydra.core.Term, hydra.pg.model.ElementTree<T3>>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>>) (cx -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (term -> {
        ...
        (java.util.function.Function<T3, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (vid -> hydra.lib.eithers.Bind.apply(
          ...
          (java.util.function.Function<hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T3>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.model.ElementTree<T3>>>) (props -> hydra.lib.eithers.Bind.apply(
            hydra.lib.eithers.Map.apply(
              ...
              hydra.lib.eithers.MapList.apply(
                (java.util.function.Function<hydra.util.Pair<hydra.pg.model.Direction, hydra.util.Pair<hydra.core.FieldType, hydra.util.Pair<hydra.pg.model.EdgeLabel, hydra.util.Adapter<T9, hydra.pg.model.ElementTypeTree<T5>, hydra.core.Term, hydra.pg.model.ElementTree<T3>>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>>>) (ea -> {
                  ...
                  return hydra.lib.maybes.Maybe.applyLazy(
                    () -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>>right((hydra.util.ConsList<hydra.pg.model.ElementTree<T3>>) (hydra.util.ConsList.<hydra.pg.model.ElementTree<T3>>empty())),
