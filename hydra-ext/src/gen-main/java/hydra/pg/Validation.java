...
public interface Validation {
  ...
  static <T0, T1> hydra.util.Maybe<String> validateEdge(java.util.function.Function<T0, java.util.function.Function<T1, hydra.util.Maybe<String>>> checkValue, java.util.function.Function<T1, String> showValue, hydra.util.Maybe<java.util.function.Function<T1, hydra.util.Maybe<hydra.pg.model.VertexLabel>>> labelForVertexId, hydra.pg.model.EdgeType<T0> typ, hydra.pg.model.Edge<T1> el) {
    ...
    hydra.util.Lazy<hydra.util.Maybe<String>> checkId = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Map.apply(
      (java.util.function.Function<String, String>) (arg_ -> (failWith).apply(hydra.pg.Validation.prepend(
        "Invalid id",
        arg_))),
    ...
    hydra.util.Lazy<hydra.util.Maybe<String>> checkIn = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Maybe.applyLazy(
      ...
      (java.util.function.Function<java.util.function.Function<T1, hydra.util.Maybe<hydra.pg.model.VertexLabel>>, hydra.util.Maybe<String>>) (f -> hydra.lib.maybes.Maybe.applyLazy(
        () -> hydra.util.Maybe.just((failWith).apply(hydra.pg.Validation.prepend(
        ...
        (java.util.function.Function<hydra.pg.model.VertexLabel, hydra.util.Maybe<String>>) (label -> hydra.pg.Validation.<String>verify(
          ...
          (failWith).apply(hydra.pg.Validation.prepend(
            "Wrong in-vertex label",
            hydra.pg.Validation.vertexLabelMismatch(
    ...
    hydra.util.Lazy<hydra.util.Maybe<String>> checkLabel = new hydra.util.Lazy<>(() -> hydra.pg.Validation.<String>verify(
      hydra.lib.equality.Equal.apply(
        actual.get().value,
        expected.get().value),
      (failWith).apply(hydra.pg.Validation.prepend(
        "Wrong label",
        hydra.pg.Validation.edgeLabelMismatch(
          expected.get(),
          actual.get())))));
    ...
    hydra.util.Lazy<hydra.util.Maybe<String>> checkProperties = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Map.apply(
      (java.util.function.Function<String, String>) (arg_ -> (failWith).apply(hydra.pg.Validation.prepend(
        "Invalid property",
        arg_))),
      hydra.pg.Validation.<T0, T1>validateProperties(
        checkValue,
        ((java.util.function.Function<hydra.pg.model.EdgeType<T0>, hydra.util.ConsList<hydra.pg.model.PropertyType<T0>>>) (projected -> projected.properties)).apply(typ),
        ((java.util.function.Function<hydra.pg.model.Edge<T1>, hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T1>>) (projected -> projected.properties)).apply(el))));
    return hydra.pg.Validation.<String>checkAll(hydra.util.ConsList.of(
      checkLabel.get(),
      checkId.get(),
      checkProperties.get(),
      checkOut.get(),
      ...
      public hydra.util.Maybe<String> visit(hydra.pg.model.ElementType.Vertex<T0> vt) {
        return ((java.util.function.Function<hydra.pg.model.Element, hydra.util.Maybe<String>>) (v12 -> ((java.util.function.Function<hydra.pg.model.Element<T1>, hydra.util.Maybe<String>>) ((java.util.function.Function<hydra.pg.model.Element<T1>, hydra.util.Maybe<String>>) (u -> (u).accept(new hydra.pg.model.Element.PartialVisitor<>() {
          ...
          public hydra.util.Maybe<String> visit(hydra.pg.model.Element.Edge<T1> e) {
            return hydra.util.Maybe.just(hydra.pg.Validation.prepend(
          ...
          public hydra.util.Maybe<String> visit(hydra.pg.model.Element.Vertex<T1> vertex) {
            return hydra.pg.Validation.<T0, T1>validateVertex(
              checkValue,
              showValue,
              (vt).value,
              (vertex).value);
      ...
      public hydra.util.Maybe<String> visit(hydra.pg.model.ElementType.Edge<T0> et) {
        return ((java.util.function.Function<hydra.pg.model.Element, hydra.util.Maybe<String>>) (v12 -> ((java.util.function.Function<hydra.pg.model.Element<T1>, hydra.util.Maybe<String>>) ((java.util.function.Function<hydra.pg.model.Element<T1>, hydra.util.Maybe<String>>) (u -> (u).accept(new hydra.pg.model.Element.PartialVisitor<>() {
          ...
          public hydra.util.Maybe<String> visit(hydra.pg.model.Element.Edge<T1> edge) {
            return hydra.pg.Validation.<T0, T1>validateEdge(
              checkValue,
              showValue,
              labelForVertexId,
              (et).value,
  ...
  static <T0, T1> hydra.util.Maybe<String> validateGraph(java.util.function.Function<T0, java.util.function.Function<T1, hydra.util.Maybe<String>>> checkValue, java.util.function.Function<T1, String> showValue, hydra.pg.model.GraphSchema<T0> schema, hydra.pg.model.Graph<T1> graph) {
    hydra.util.Lazy<hydra.util.Maybe<String>> checkEdges = new hydra.util.Lazy<>(() -> hydra.pg.Validation.<String>checkAll(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.pg.model.Edge<T1>, hydra.util.Maybe<String>>) (v1 -> hydra.pg.Validation.<T0, T1>validateGraph_checkEdge(
        checkValue,
        graph,
        (java.util.function.Function<String, java.util.function.Function<String, String>>) (p0 -> p1 -> hydra.pg.Validation.prepend(
          p0,
          p1)),
        schema,
        showValue,
        v1)),
      hydra.lib.maps.Elems.apply(((java.util.function.Function<hydra.pg.model.Graph<T1>, hydra.util.PersistentMap<T1, hydra.pg.model.Edge<T1>>>) (projected -> projected.edges)).apply(graph)))));
    hydra.util.Lazy<hydra.util.Maybe<String>> checkVertices = new hydra.util.Lazy<>(() -> hydra.pg.Validation.<String>checkAll(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.pg.model.Vertex<T1>, hydra.util.Maybe<String>>) (v1 -> hydra.pg.Validation.<T0, T1>validateGraph_checkVertex(
        checkValue,
        (java.util.function.Function<String, java.util.function.Function<String, String>>) (p0 -> p1 -> hydra.pg.Validation.prepend(
          p0,
          p1)),
        ...
        showValue,
        v1)),
      hydra.lib.maps.Elems.apply(((java.util.function.Function<hydra.pg.model.Graph<T1>, hydra.util.PersistentMap<T1, hydra.pg.model.Vertex<T1>>>) (projected -> projected.vertices)).apply(graph)))));
    return hydra.pg.Validation.<String>checkAll(hydra.util.ConsList.of(
      checkVertices.get(),
      checkEdges.get()));
  }

  static <T0, T1> hydra.util.Maybe<String> validateGraph_checkEdge(java.util.function.Function<T0, java.util.function.Function<T1, hydra.util.Maybe<String>>> checkValue, hydra.pg.model.Graph<T1> graph, java.util.function.Function<String, java.util.function.Function<String, String>> hydra_pg_validation_prepend, hydra.pg.model.GraphSchema<T0> schema, java.util.function.Function<T1, String> showValue, hydra.pg.model.Edge<T1> el) {
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> hydra.util.Maybe.just(hydra.pg.Validation.<T1>edgeError(
        showValue,
        el,
        (hydra_pg_validation_prepend).apply("Unexpected label").apply(((java.util.function.Function<hydra.pg.model.Edge<T1>, hydra.pg.model.EdgeLabel>) (projected -> projected.label)).apply(el).value))),
      (java.util.function.Function<hydra.pg.model.EdgeType<T0>, hydra.util.Maybe<String>>) (t -> hydra.pg.Validation.<T0, T1>validateEdge(
        checkValue,
        showValue,
        hydra.pg.Validation.<T1>validateGraph_labelForVertexId(graph),
        t,
        el)),
  ...
  static <T0, T1> hydra.util.Maybe<String> validateGraph_checkVertex(java.util.function.Function<T0, java.util.function.Function<T1, hydra.util.Maybe<String>>> checkValue, java.util.function.Function<String, java.util.function.Function<String, String>> hydra_pg_validation_prepend, hydra.pg.model.GraphSchema<T0> schema, java.util.function.Function<T1, String> showValue, hydra.pg.model.Vertex<T1> el) {
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> hydra.util.Maybe.just(hydra.pg.Validation.<T1>vertexError(
        showValue,
        el,
        (hydra_pg_validation_prepend).apply("Unexpected label").apply(((java.util.function.Function<hydra.pg.model.Vertex<T1>, hydra.pg.model.VertexLabel>) (projected -> projected.label)).apply(el).value))),
  ...
  static <T1> hydra.util.Maybe<java.util.function.Function<T1, hydra.util.Maybe<hydra.pg.model.VertexLabel>>> validateGraph_labelForVertexId(hydra.pg.model.Graph<T1> graph) {
    return hydra.util.Maybe.just((java.util.function.Function<T1, hydra.util.Maybe<hydra.pg.model.VertexLabel>>) (i -> hydra.lib.maybes.Map.apply(
      ...
      hydra.lib.maps.Lookup.apply(
        i,
        ((java.util.function.Function<hydra.pg.model.Graph<T1>, hydra.util.PersistentMap<T1, hydra.pg.model.Vertex<T1>>>) (projected -> projected.vertices)).apply(graph)))));
  }

  static <T0, T1> hydra.util.Maybe<String> validateProperties(java.util.function.Function<T0, java.util.function.Function<T1, hydra.util.Maybe<String>>> checkValue, hydra.util.ConsList<hydra.pg.model.PropertyType<T0>> types, hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T1> props) {
    hydra.util.Lazy<hydra.util.Maybe<String>> checkTypes = new hydra.util.Lazy<>(() -> hydra.pg.Validation.<String>checkAll(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.pg.model.PropertyType<T0>, hydra.util.Maybe<String>>) (v1 -> hydra.pg.Validation.<T1, T0>validateProperties_checkType(
        (java.util.function.Function<String, java.util.function.Function<String, String>>) (p0 -> p1 -> hydra.pg.Validation.prepend(
          p0,
          p1)),
        props,
        v1)),
      types)));
    hydra.util.Lazy<hydra.util.Maybe<String>> checkValues = new hydra.util.Lazy<>(() -> hydra.pg.Validation.<String>checkAll(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.util.Pair<hydra.pg.model.PropertyKey, T1>, hydra.util.Maybe<String>>) (v1 -> hydra.pg.Validation.<T0, T1>validateProperties_checkPair(
        checkValue,
        (java.util.function.Function<String, java.util.function.Function<String, String>>) (p0 -> p1 -> hydra.pg.Validation.prepend(
          p0,
          p1)),
  ...
  static <T0, T1> hydra.util.Maybe<String> validateProperties_checkPair(java.util.function.Function<T0, java.util.function.Function<T1, hydra.util.Maybe<String>>> checkValue, java.util.function.Function<String, java.util.function.Function<String, String>> hydra_pg_validation_prepend, hydra.util.ConsList<hydra.pg.model.PropertyType<T0>> types, hydra.util.Pair<hydra.pg.model.PropertyKey, T1> pair) {
    hydra.util.Lazy<hydra.pg.model.PropertyKey> key = new hydra.util.Lazy<>(() -> hydra.lib.pairs.First.apply(pair));
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> hydra.util.Maybe.just((hydra_pg_validation_prepend).apply("Unexpected key").apply(key.get().value)),
      (java.util.function.Function<T0, hydra.util.Maybe<String>>) (typ -> hydra.lib.maybes.Map.apply(
        (java.util.function.Function<String, String>) (v1 -> (hydra_pg_validation_prepend).apply("Invalid value").apply(v1)),
  ...
  static <T1, T2> hydra.util.Maybe<String> validateProperties_checkType(java.util.function.Function<String, java.util.function.Function<String, String>> hydra_pg_validation_prepend, hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T1> props, hydra.pg.model.PropertyType<T2> t) {
    return hydra.lib.logic.IfElse.lazy(
      ((java.util.function.Function<hydra.pg.model.PropertyType<T2>, Boolean>) (projected -> projected.required)).apply(t),
      () -> hydra.lib.maybes.Maybe.applyLazy(
        () -> hydra.util.Maybe.just((hydra_pg_validation_prepend).apply("Missing value for ").apply(((java.util.function.Function<hydra.pg.model.PropertyType<T2>, hydra.pg.model.PropertyKey>) (projected -> projected.key)).apply(t).value)),
  ...
  static <T0> hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T0> validateProperties_m(hydra.util.ConsList<hydra.pg.model.PropertyType<T0>> types) {
  ...
  static <T0, T1> hydra.util.Maybe<String> validateVertex(java.util.function.Function<T0, java.util.function.Function<T1, hydra.util.Maybe<String>>> checkValue, java.util.function.Function<T1, String> showValue, hydra.pg.model.VertexType<T0> typ, hydra.pg.model.Vertex<T1> el) {
    ...
    java.util.function.Function<String, String> failWith = (java.util.function.Function<String, String>) (v1 -> hydra.pg.Validation.<T1>vertexError(
      showValue,
      el,
      v1));
    hydra.util.Lazy<hydra.util.Maybe<String>> checkId = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Map.apply(
    ...
    hydra.util.Lazy<hydra.util.Maybe<String>> checkProperties = new hydra.util.Lazy<>(() -> hydra.lib.maybes.Map.apply(
      ...
      hydra.pg.Validation.<T0, T1>validateProperties(
        checkValue,
        ((java.util.function.Function<hydra.pg.model.VertexType<T0>, hydra.util.ConsList<hydra.pg.model.PropertyType<T0>>>) (projected -> projected.properties)).apply(typ),
        ((java.util.function.Function<hydra.pg.model.Vertex<T1>, hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T1>>) (projected -> projected.properties)).apply(el))));
    return hydra.pg.Validation.<String>checkAll(hydra.util.ConsList.of(
      checkLabel.get(),
      checkId.get(),
      checkProperties.get()));
