...
public interface Construct {
  static <T0, T1> hydra.util.Either<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>> adjacentEdgeToGraphson(java.util.function.Function<T0, hydra.util.Either<T1, hydra.pg.graphson.syntax.Value>> encodeValue, hydra.pg.model.AdjacentEdge<T0> edge) {
    ...
    return hydra.lib.eithers.Bind.apply(
      (encodeValue).apply(hydra.pg.graphson.Construct.<T0>adjacentEdgeToGraphson_edgeId(edge)),
      (java.util.function.Function<hydra.pg.graphson.syntax.Value, hydra.util.Either<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (gid -> hydra.lib.eithers.Bind.apply(
        (encodeValue).apply(hydra.pg.graphson.Construct.<T0>adjacentEdgeToGraphson_vertexId(edge)),
        (java.util.function.Function<hydra.pg.graphson.syntax.Value, hydra.util.Either<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (gv -> hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.util.Pair<hydra.pg.model.PropertyKey, T0>, hydra.util.Either<T1, hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.Value>>>) (v1 -> hydra.pg.graphson.Construct.edgePropertyToGraphson(
              encodeValue,
              v1)),
            hydra.lib.maps.ToList.apply(hydra.pg.graphson.Construct.<T0>adjacentEdgeToGraphson_props(edge))),
  ...
  static <T0, T1> hydra.util.PersistentMap<T0, hydra.util.ConsList<T1>> aggregateMap(hydra.util.ConsList<hydra.util.Pair<T0, T1>> pairs) {
    return hydra.lib.lists.Foldl.apply(
      (java.util.function.Function<hydra.util.PersistentMap<T0, hydra.util.ConsList<T1>>, java.util.function.Function<hydra.util.Pair<T0, T1>, hydra.util.PersistentMap<T0, hydra.util.ConsList<T1>>>>) (m -> (java.util.function.Function<hydra.util.Pair<T0, T1>, hydra.util.PersistentMap<T0, hydra.util.ConsList<T1>>>) (p -> {
        hydra.util.Lazy<T0> k = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Construct.<T0, T1>aggregateMap_k(p));
        hydra.util.Lazy<T1> v = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Construct.<T0, T1>aggregateMap_v(p));
        return hydra.lib.maps.Insert.apply(
          ...
          hydra.lib.maybes.Maybe.applyLazy(
            ...
            (java.util.function.Function<hydra.util.ConsList<T1>, hydra.util.ConsList<T1>>) (vs -> hydra.lib.lists.Cons.apply(
              v.get(),
              vs)),
            hydra.pg.graphson.Construct.<T0, T1>aggregateMap_existing(
              k.get(),
              m)),
          m);
      })),
  ...
  static hydra.coders.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value> graphsonVertexToJsonCoder() {
    return new hydra.coders.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.json.model.Value>>>) (_cx -> (java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.json.model.Value>>) (v -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.json.model.Value>right(hydra.pg.graphson.Coder.vertexToJson(v)))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.pg.graphson.syntax.Vertex>>>) (_cx -> (java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.pg.graphson.syntax.Vertex>>) (ignored -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.pg.graphson.syntax.Vertex>left((hydra.context.InContext<hydra.errors.Error_>) (new hydra.context.InContext<hydra.errors.Error_>(new hydra.errors.Error_.Other(new hydra.errors.OtherError("decoding GraphSON JSON is currently unsupported")), _cx))))));
  }
  ...
  static <T0, T1> hydra.util.Either<T1, hydra.pg.graphson.syntax.Vertex> pgVertexWithAdjacentEdgesToGraphsonVertex(java.util.function.Function<T0, hydra.util.Either<T1, hydra.pg.graphson.syntax.Value>> encodeValue, hydra.pg.model.VertexWithAdjacentEdges<T0> vae) {
    hydra.util.Lazy<hydra.pg.model.Vertex<T0>> vertex = new hydra.util.Lazy<>(() -> hydra.pg.graphson.Construct.<T0>pgVertexWithAdjacentEdgesToGraphsonVertex_vertex(vae));
    ...
    return hydra.lib.eithers.Bind.apply(
      (encodeValue).apply(hydra.pg.graphson.Construct.<T0>pgVertexWithAdjacentEdgesToGraphsonVertex_vertexId(vertex.get())),
      (java.util.function.Function<hydra.pg.graphson.syntax.Value, hydra.util.Either<T1, hydra.pg.graphson.syntax.Vertex>>) (gid -> hydra.lib.eithers.Bind.apply(
        hydra.lib.eithers.MapList.apply(
          (java.util.function.Function<hydra.util.Pair<hydra.pg.model.PropertyKey, T0>, hydra.util.Either<T1, hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.VertexPropertyValue>>>) (v1 -> hydra.pg.graphson.Construct.<T0, T1>vertexPropertyToGraphson(
            encodeValue,
            v1)),
          hydra.lib.maps.ToList.apply(hydra.pg.graphson.Construct.<T0>pgVertexWithAdjacentEdgesToGraphsonVertex_props(vertex.get()))),
        (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.VertexPropertyValue>>, hydra.util.Either<T1, hydra.pg.graphson.syntax.Vertex>>) (propPairs -> hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.pg.model.AdjacentEdge<T0>, hydra.util.Either<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (v1 -> hydra.pg.graphson.Construct.<T0, T1>adjacentEdgeToGraphson(
              encodeValue,
              v1)),
            hydra.pg.graphson.Construct.<T0>pgVertexWithAdjacentEdgesToGraphsonVertex_ins(vae)),
          (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>, hydra.util.Either<T1, hydra.pg.graphson.syntax.Vertex>>) (inPairs -> hydra.lib.eithers.Bind.apply(
            hydra.lib.eithers.MapList.apply(
              (java.util.function.Function<hydra.pg.model.AdjacentEdge<T0>, hydra.util.Either<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (v1 -> hydra.pg.graphson.Construct.<T0, T1>adjacentEdgeToGraphson(
                encodeValue,
                v1)),
              hydra.pg.graphson.Construct.<T0>pgVertexWithAdjacentEdgesToGraphsonVertex_outs(vae)),
            (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>, hydra.util.Either<T1, hydra.pg.graphson.syntax.Vertex>>) (outPairs -> hydra.util.Either.<T1, hydra.pg.graphson.syntax.Vertex>right(new hydra.pg.graphson.syntax.Vertex(gid, hydra.util.Maybe.just(new hydra.pg.graphson.syntax.VertexLabel(label.get().value)), hydra.pg.graphson.Construct.aggregateMap(inPairs), hydra.pg.graphson.Construct.aggregateMap(outPairs), hydra.pg.graphson.Construct.aggregateMap(propPairs)))))))))));
  }
  ...
  static <T0, T1> hydra.util.Either<T1, hydra.json.model.Value> pgVertexWithAdjacentEdgesToJson(java.util.function.Function<T0, hydra.util.Either<T1, hydra.pg.graphson.syntax.Value>> encodeValue, hydra.pg.model.VertexWithAdjacentEdges<T0> vertex) {
    return hydra.lib.eithers.Bind.apply(
      hydra.pg.graphson.Construct.<T0, T1>pgVertexWithAdjacentEdgesToGraphsonVertex(
        encodeValue,
        vertex),
      (java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<T1, hydra.json.model.Value>>) (gVertex -> hydra.util.Either.<T1, hydra.json.model.Value>right(hydra.pg.graphson.Coder.vertexToJson(gVertex))));
  }
