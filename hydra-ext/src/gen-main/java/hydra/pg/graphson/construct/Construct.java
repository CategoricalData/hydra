...
public interface Construct {
  ...
  static <T0, T1> hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>> adjacentEdgeToGraphson(java.util.function.Function<T0, hydra.compute.Flow<T1, hydra.pg.graphson.syntax.Value>> encodeValue, hydra.pg.model.AdjacentEdge<T0> edge) {
    ...
    return hydra.lib.flows.Bind.apply(
      ...
      (java.util.function.Function<hydra.pg.graphson.syntax.Value, hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (gid -> hydra.lib.flows.Bind.apply(
        (encodeValue).apply(hydra.pg.graphson.construct.Construct.<T0>adjacentEdgeToGraphson_vertexId(edge)),
        (java.util.function.Function<hydra.pg.graphson.syntax.Value, hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (gv -> hydra.lib.flows.Bind.apply(
          hydra.lib.flows.MapList.apply(
            (java.util.function.Function<hydra.util.Pair<hydra.pg.model.PropertyKey, T0>, hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.Value>>>) (v1 -> hydra.pg.graphson.construct.Construct.edgePropertyToGraphson(
              encodeValue,
              v1)),
            hydra.lib.maps.ToList.apply(hydra.pg.graphson.construct.Construct.<T0>adjacentEdgeToGraphson_props(edge))),
          (java.util.function.Function<java.util.List<hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.Value>>, hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (propPairs -> hydra.lib.flows.Pure.apply((hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>) ((hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>) (new hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>(new hydra.pg.graphson.syntax.EdgeLabel((label.get()).value), new hydra.pg.graphson.syntax.AdjacentEdge(gid, gv, hydra.lib.maps.FromList.apply(propPairs))))))))))));
  }
  ...
  static <T0, T1, T2> hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, T2>> edgePropertyToGraphson(java.util.function.Function<T0, hydra.compute.Flow<T1, T2>> encodeValue, hydra.util.Pair<hydra.pg.model.PropertyKey, T0> prop) {
  ...
  static <T0, T1> hydra.compute.Flow<T1, hydra.pg.graphson.syntax.Vertex> pgVertexWithAdjacentEdgesToGraphsonVertex(java.util.function.Function<T0, hydra.compute.Flow<T1, hydra.pg.graphson.syntax.Value>> encodeValue, hydra.pg.model.VertexWithAdjacentEdges<T0> vae) {
    ...
    return hydra.lib.flows.Bind.apply(
      ...
      (java.util.function.Function<hydra.pg.graphson.syntax.Value, hydra.compute.Flow<T1, hydra.pg.graphson.syntax.Vertex>>) (gid -> hydra.lib.flows.Bind.apply(
        hydra.lib.flows.MapList.apply(
          (java.util.function.Function<hydra.util.Pair<hydra.pg.model.PropertyKey, T0>, hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.VertexPropertyValue>>>) (v1 -> hydra.pg.graphson.construct.Construct.<T0, T1>vertexPropertyToGraphson(
            encodeValue,
            v1)),
        ...
        (java.util.function.Function<java.util.List<hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.VertexPropertyValue>>, hydra.compute.Flow<T1, hydra.pg.graphson.syntax.Vertex>>) (propPairs -> hydra.lib.flows.Bind.apply(
          hydra.lib.flows.MapList.apply(
            (java.util.function.Function<hydra.pg.model.AdjacentEdge<T0>, hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (v1 -> hydra.pg.graphson.construct.Construct.<T0, T1>adjacentEdgeToGraphson(
              encodeValue,
              v1)),
            hydra.pg.graphson.construct.Construct.<T0>pgVertexWithAdjacentEdgesToGraphsonVertex_ins(vae)),
          (java.util.function.Function<java.util.List<hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>, hydra.compute.Flow<T1, hydra.pg.graphson.syntax.Vertex>>) (inPairs -> hydra.lib.flows.Bind.apply(
            hydra.lib.flows.MapList.apply(
              (java.util.function.Function<hydra.pg.model.AdjacentEdge<T0>, hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge>>>) (v1 -> hydra.pg.graphson.construct.Construct.<T0, T1>adjacentEdgeToGraphson(
                encodeValue,
                v1)),
  ...
  static <T0, T1> hydra.compute.Flow<T1, hydra.util.Pair<hydra.pg.graphson.syntax.PropertyKey, hydra.pg.graphson.syntax.VertexPropertyValue>> vertexPropertyToGraphson(java.util.function.Function<T0, hydra.compute.Flow<T1, hydra.pg.graphson.syntax.Value>> encodeValue, hydra.util.Pair<hydra.pg.model.PropertyKey, T0> prop) {
    return hydra.lib.flows.Map.apply(
