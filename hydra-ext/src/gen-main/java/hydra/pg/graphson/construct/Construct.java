...
public interface Construct {
  ...
  static hydra.util.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value> graphsonVertexToJsonCoder() {
    return new hydra.util.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.json.model.Value>>>) (_cx -> (java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.json.model.Value>>) (v -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.json.model.Value>right(hydra.pg.graphson.coder.Coder.vertexToJson(v)))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.pg.graphson.syntax.Vertex>>>) (_cx -> (java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.context.InContext<hydra.errors.Error_>, hydra.pg.graphson.syntax.Vertex>>) (ignored -> hydra.util.Either.<hydra.context.InContext<hydra.errors.Error_>, hydra.pg.graphson.syntax.Vertex>left((hydra.context.InContext<hydra.errors.Error_>) (new hydra.context.InContext<hydra.errors.Error_>(new hydra.errors.Error_.Other(new hydra.errors.OtherError("decoding GraphSON JSON is currently unsupported")), _cx))))));
  }
  ...
  static <T0, T1> hydra.util.Either<T1, hydra.json.model.Value> pgVertexWithAdjacentEdgesToJson(java.util.function.Function<T0, hydra.util.Either<T1, hydra.pg.graphson.syntax.Value>> encodeValue, hydra.pg.model.VertexWithAdjacentEdges<T0> vertex) {
    return hydra.lib.eithers.Bind.apply(
      hydra.pg.graphson.construct.Construct.<T0, T1>pgVertexWithAdjacentEdgesToGraphsonVertex(
        encodeValue,
        vertex),
      (java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<T1, hydra.json.model.Value>>) (gVertex -> hydra.util.Either.<T1, hydra.json.model.Value>right(hydra.pg.graphson.coder.Coder.vertexToJson(gVertex))));
  }
