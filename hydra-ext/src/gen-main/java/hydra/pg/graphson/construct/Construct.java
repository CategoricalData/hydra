...
public interface Construct {
  ...
  static hydra.compute.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value> graphsonVertexToJsonCoder() {
    return new hydra.compute.Coder<hydra.pg.graphson.syntax.Vertex, hydra.json.model.Value>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.json.model.Value>>>) (_cx -> (java.util.function.Function<hydra.pg.graphson.syntax.Vertex, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.json.model.Value>>) (v -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.json.model.Value>right(hydra.pg.graphson.coder.Coder.vertexToJson(v)))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.pg.graphson.syntax.Vertex>>>) (_cx -> (java.util.function.Function<hydra.json.model.Value, hydra.util.Either<hydra.context.InContext<hydra.error.OtherError>, hydra.pg.graphson.syntax.Vertex>>) (ignored -> hydra.util.Either.<hydra.context.InContext<hydra.error.OtherError>, hydra.pg.graphson.syntax.Vertex>left((hydra.context.InContext<hydra.error.OtherError>) (new hydra.context.InContext<hydra.error.OtherError>(new hydra.error.OtherError("decoding GraphSON JSON is currently unsupported"), _cx))))));
  }
