...
public interface Mappings {
    ...
    return hydra.lib.lists.Concat.apply(hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.pg.model.EdgeType<T1>, hydra.util.ConsList<hydra.ext.org.w3.shacl.model.CommonConstraint>>) (et -> {
        ...
        return hydra.lib.logic.IfElse.lazy(
          matchesVertex.get(),
          () -> hydra.util.ConsList.of(edgeShape.get()),
          () -> (hydra.util.ConsList<hydra.ext.org.w3.shacl.model.CommonConstraint>) (hydra.util.ConsList.<hydra.ext.org.w3.shacl.model.CommonConstraint>empty()));
      }),
      edgeTypes));
  }
  ...
  static <T0> hydra.ext.org.w3.rdf.syntax.Graph encodeLazyGraph(hydra.pg.rdf.environment.PgRdfEnvironment<T0> env, hydra.pg.model.LazyGraph<T0> lg) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.rdf.syntax.Description>> edgeDescs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.rdf.syntax.Description>> vertexDescs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.pg.model.Vertex<T0>, hydra.ext.org.w3.rdf.syntax.Description>) (v1 -> hydra.pg.rdf.Mappings.<T0>encodeVertex(
        env,
        v1)),
      ((java.util.function.Function<hydra.pg.model.LazyGraph<T0>, hydra.util.ConsList<hydra.pg.model.Vertex<T0>>>) (projected -> projected.vertices)).apply(lg)));
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.rdf.syntax.Description>> allDescs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Concat.apply(hydra.util.ConsList.of(
      vertexDescs.get(),
      edgeDescs.get())));
  ...
  static <T0> hydra.ext.org.w3.rdf.syntax.Description encodeVertex(hydra.pg.rdf.environment.PgRdfEnvironment<T0> env, hydra.pg.model.Vertex<T0> vertex) {
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.rdf.syntax.Triple>> propTriples = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.rdf.syntax.Triple>> allTriples = new hydra.util.Lazy<>(() -> hydra.lib.lists.Cons.apply(
      typeTriple,
      propTriples.get()));
  ...
  static <T0> hydra.util.PersistentMap<hydra.pg.model.PropertyKey, T0> encodeVertex_vprops(hydra.pg.model.Vertex<T0> vertex) {
  ...
  static <T0> hydra.ext.org.w3.shacl.model.ShapesGraph graphSchemaToShapesGraph(java.util.function.Function<T0, hydra.ext.org.w3.rdf.syntax.Iri> encodeType, java.util.function.Function<hydra.pg.model.VertexLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeVertexLabel, java.util.function.Function<hydra.pg.model.EdgeLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeEdgeLabel, java.util.function.Function<hydra.pg.model.PropertyKey, hydra.ext.org.w3.rdf.syntax.Iri> encodeKey, hydra.pg.model.GraphSchema<T0> schema) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.Shape>>> defs = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      (java.util.function.Function<hydra.pg.model.VertexType<T0>, hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.Shape>>) (vt -> {
        ...
        hydra.util.Lazy<hydra.ext.org.w3.shacl.model.NodeShape> baseNode = new hydra.util.Lazy<>(() -> baseShape.get().accept(new hydra.ext.org.w3.shacl.model.Shape.PartialVisitor<>() {
          ...
          public hydra.ext.org.w3.shacl.model.NodeShape visit(hydra.ext.org.w3.shacl.model.Shape.Property ignored) {
            return new hydra.ext.org.w3.shacl.model.NodeShape(new hydra.ext.org.w3.shacl.model.CommonProperties((hydra.util.PersistentSet<hydra.ext.org.w3.shacl.model.CommonConstraint>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.shacl.model.CommonConstraint>apply()), (hydra.util.Maybe<Boolean>) (hydra.util.Maybe.<Boolean>nothing()), hydra.ext.rdf.Utils.emptyLangStrings(), new hydra.ext.org.w3.shacl.model.Severity.Violation(), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.RdfsClass>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.RdfsClass>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.IriOrLiteral>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.IriOrLiteral>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.Property>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Property>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.Property>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Property>apply())));
          }
        }));
        hydra.ext.org.w3.shacl.model.CommonProperties baseCommon = baseNode.get().common;
        hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.shacl.model.CommonConstraint>> edgeShapes = new hydra.util.Lazy<>(() -> hydra.pg.rdf.Mappings.edgeTypesToPropertyShapes(
          encodeVertexLabel,
          encodeEdgeLabel,
        ...
        hydra.util.Lazy<hydra.util.PersistentSet<hydra.ext.org.w3.shacl.model.CommonConstraint>> mergedConstraints = new hydra.util.Lazy<>(() -> hydra.lib.sets.Union.apply(
  ...
  static <T0> hydra.util.ConsList<hydra.pg.model.EdgeType<T0>> graphSchemaToShapesGraph_edgeTypes(hydra.pg.model.GraphSchema<T0> schema) {
    return hydra.lib.maps.Elems.apply(((java.util.function.Function<hydra.pg.model.GraphSchema<T0>, hydra.util.PersistentMap<hydra.pg.model.EdgeLabel, hydra.pg.model.EdgeType<T0>>>) (projected -> projected.edges)).apply(schema));
  }

  static <T0> hydra.util.ConsList<hydra.pg.model.VertexType<T0>> graphSchemaToShapesGraph_vertexTypes(hydra.pg.model.GraphSchema<T0> schema) {
    return hydra.lib.maps.Elems.apply(((java.util.function.Function<hydra.pg.model.GraphSchema<T0>, hydra.util.PersistentMap<hydra.pg.model.VertexLabel, hydra.pg.model.VertexType<T0>>>) (projected -> projected.vertices)).apply(schema));
  }
  ...
  static <T0> hydra.ext.org.w3.shacl.model.PropertyShape propertyTypeToPropertyShape(java.util.function.Function<T0, hydra.ext.org.w3.rdf.syntax.Iri> encodeType, java.util.function.Function<hydra.pg.model.PropertyKey, hydra.ext.org.w3.rdf.syntax.Iri> encodeKey, hydra.pg.model.PropertyType<T0> pt) {
    ...
    hydra.util.Lazy<hydra.util.PersistentSet<hydra.ext.org.w3.shacl.model.CommonConstraint>> constraints = new hydra.util.Lazy<>(() -> hydra.lib.sets.Singleton.apply(new hydra.ext.org.w3.shacl.model.CommonConstraint.Datatype(dtIri.get())));
    ...
    hydra.util.Lazy<hydra.util.PersistentSet<hydra.ext.org.w3.shacl.model.PropertyShapeConstraint>> propConstraints = new hydra.util.Lazy<>(() -> hydra.lib.logic.IfElse.lazy(
      required_.get(),
      ...
      () -> (hydra.util.PersistentSet<hydra.ext.org.w3.shacl.model.PropertyShapeConstraint>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.shacl.model.PropertyShapeConstraint>apply())));
    return new hydra.ext.org.w3.shacl.model.PropertyShape(new hydra.ext.org.w3.shacl.model.CommonProperties(constraints.get(), (hydra.util.Maybe<Boolean>) (hydra.util.Maybe.<Boolean>nothing()), hydra.ext.rdf.Utils.emptyLangStrings(), new hydra.ext.org.w3.shacl.model.Severity.Violation(), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.RdfsClass>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.RdfsClass>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.IriOrLiteral>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.IriOrLiteral>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.Property>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Property>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.Property>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Property>apply())), propConstraints.get(), (hydra.util.Maybe<hydra.ext.org.w3.rdf.syntax.Node>) (hydra.util.Maybe.<hydra.ext.org.w3.rdf.syntax.Node>nothing()), hydra.ext.rdf.Utils.emptyLangStrings(), hydra.ext.rdf.Utils.emptyLangStrings(), (hydra.util.Maybe<java.math.BigInteger>) (hydra.util.Maybe.<java.math.BigInteger>nothing()), path);
  }
  ...
  static <T0> hydra.ext.org.w3.shacl.model.Definition<hydra.ext.org.w3.shacl.model.Shape> vertexTypeToNodeShape(java.util.function.Function<T0, hydra.ext.org.w3.rdf.syntax.Iri> encodeType, java.util.function.Function<hydra.pg.model.VertexLabel, hydra.ext.org.w3.rdf.syntax.Iri> encodeLabel, java.util.function.Function<hydra.pg.model.PropertyKey, hydra.ext.org.w3.rdf.syntax.Iri> encodeKey, hydra.pg.model.VertexType<T0> vt) {
    hydra.util.Lazy<hydra.util.ConsList<hydra.ext.org.w3.shacl.model.CommonConstraint>> propShapes = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
    ...
    hydra.util.Lazy<hydra.ext.org.w3.shacl.model.CommonProperties> common = new hydra.util.Lazy<>(() -> new hydra.ext.org.w3.shacl.model.CommonProperties(hydra.lib.sets.FromList.apply(propShapes.get()), (hydra.util.Maybe<Boolean>) (hydra.util.Maybe.<Boolean>nothing()), hydra.ext.rdf.Utils.emptyLangStrings(), new hydra.ext.org.w3.shacl.model.Severity.Violation(), hydra.lib.sets.Singleton.apply(new hydra.ext.org.w3.rdf.syntax.RdfsClass(null)), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.IriOrLiteral>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.IriOrLiteral>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.Property>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Property>apply()), (hydra.util.PersistentSet<hydra.ext.org.w3.rdf.syntax.Property>) (hydra.lib.sets.Empty.<hydra.ext.org.w3.rdf.syntax.Property>apply())));
  ...
  static <T0> hydra.util.ConsList<hydra.pg.model.PropertyType<T0>> vertexTypeToNodeShape_propTypes(hydra.pg.model.VertexType<T0> vt) {
    return ((java.util.function.Function<hydra.pg.model.VertexType<T0>, hydra.util.ConsList<hydra.pg.model.PropertyType<T0>>>) (projected -> projected.properties)).apply(vt);
  }
}
