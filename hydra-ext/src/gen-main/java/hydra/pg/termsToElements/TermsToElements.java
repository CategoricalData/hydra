...
public interface TermsToElements {
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>> applyPattern(hydra.context.Context cx, String firstLit, hydra.util.ConsList<hydra.util.Pair<hydra.util.ConsList<String>, String>> pairs, hydra.core.Term term) {
    return hydra.lib.logic.IfElse.lazy(
      hydra.lib.lists.Null.apply(pairs),
      () -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>right(hydra.util.ConsList.of(new hydra.core.Term.Literal(new hydra.core.Literal.String_(firstLit)))),
      () -> hydra.lib.eithers.Bind.apply(
        hydra.lib.eithers.MapList.apply(
          (java.util.function.Function<hydra.util.Pair<hydra.util.ConsList<String>, String>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.util.ConsList<String>, String>>>) (pp -> hydra.lib.eithers.Map.apply(
            ...
            hydra.pg.termsToElements.TermsToElements.evalPath(
              ...
              term))),
          pairs),
        (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.util.ConsList<String>, String>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>) (evaluated -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>right(hydra.lib.lists.Map.apply(
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.EdgeSpec> decodeEdgeSpec(hydra.context.Context cx, hydra.graph.Graph g, hydra.core.Term term) {
    return hydra.pg.termsToElements.TermsToElements.readRecord(
      cx,
      g,
      (java.util.function.Function<hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.EdgeSpec>>) (fields -> hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.pg.mapping.ValueSpec, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.EdgeSpec>>) (_c -> hydra.lib.eithers.Bind.apply(
              ...
              (java.util.function.Function<hydra.pg.mapping.ValueSpec, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.EdgeSpec>>) (_d -> hydra.lib.eithers.Map.apply(
                ...
                hydra.pg.termsToElements.TermsToElements.readField(
                  ...
                  (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.mapping.PropertySpec>>>) (v1 -> hydra.pg.termsToElements.TermsToElements.expectList(
                    cx,
                    g,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.PropertySpec> decodePropertySpec(hydra.context.Context cx, hydra.graph.Graph g, hydra.core.Term term) {
    return hydra.pg.termsToElements.TermsToElements.readRecord(
      cx,
      g,
      (java.util.function.Function<hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.PropertySpec>>) (fields -> hydra.lib.eithers.Bind.apply(
        hydra.pg.termsToElements.TermsToElements.readField(
          cx,
          fields,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.VertexSpec> decodeVertexSpec(hydra.context.Context cx, hydra.graph.Graph g, hydra.core.Term term) {
    return hydra.pg.termsToElements.TermsToElements.readRecord(
      cx,
      g,
      (java.util.function.Function<hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.VertexSpec>>) (fields -> hydra.lib.eithers.Bind.apply(
        hydra.pg.termsToElements.TermsToElements.readField(
          cx,
          fields,
          new hydra.core.Name("label"),
    ...
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> hydra.lib.eithers.Bind.apply(
        hydra.pg.termsToElements.TermsToElements.evalStep(
          ...
          term),
        (java.util.function.Function<hydra.util.ConsList<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>) (results -> hydra.lib.eithers.Map.apply(
          ...
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>) (v1 -> hydra.pg.termsToElements.TermsToElements.evalPath(
              cx,
  ...
  static hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>> evalStep(hydra.context.Context cx, String step, hydra.core.Term term) {
    return hydra.lib.logic.IfElse.lazy(
      ...
      () -> (hydra.rewriting.Rewriting.deannotateTerm(term)).accept(new hydra.core.Term.PartialVisitor<>() {
        @Override
        public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>> otherwise(hydra.core.Term instance) {
          return hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>left((hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
        ...
        public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>> visit(hydra.core.Term.List terms) {
          return hydra.lib.eithers.Map.apply(
            (java.util.function.Function<hydra.util.ConsList<hydra.util.ConsList<hydra.core.Term>>, hydra.util.ConsList<hydra.core.Term>>) (xs -> hydra.lib.lists.Concat.apply(xs)),
            hydra.lib.eithers.MapList.apply(
              (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>) (v1 -> hydra.pg.termsToElements.TermsToElements.evalStep(
                cx,
                step,
                v1)),
              (terms).value));
        ...
        public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>> visit(hydra.core.Term.Maybe mt) {
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>right((hydra.util.ConsList<hydra.core.Term>) (hydra.util.ConsList.<hydra.core.Term>of())),
            (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>) (t -> hydra.pg.termsToElements.TermsToElements.evalStep(
              cx,
              step,
              t)),
            (mt).value);
        ...
        public hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>> visit(hydra.core.Term.Record rec) {
          return hydra.lib.maybes.Maybe.applyLazy(
            () -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>left((hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError(hydra.lib.strings.Cat2.apply(
              hydra.lib.strings.Cat2.apply(
                "No such field ",
                step),
              " in record"))), cx))),
            (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>) (t -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>right(hydra.util.ConsList.of(t))),
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T0>> expectList(hydra.context.Context cx, hydra.graph.Graph g, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>>> f, hydra.core.Term term) {
    return hydra.lib.eithers.Bind.apply(
      hydra.extract.core.Core.list(
        ...
        g,
        term),
      (java.util.function.Function<hydra.util.ConsList<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T0>>>) (elems -> hydra.lib.eithers.MapList.apply(
  ...
  static <T0, T1, T2, T3, T4, T5> hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>> parseEdgeIdPattern(T0 cx, T1 g, hydra.pg.mapping.Schema<T2, T3, T4> schema, hydra.pg.mapping.ValueSpec spec) {
    return hydra.lib.eithers.Bind.apply(
      hydra.pg.termsToElements.TermsToElements.<T0, T1, T5>parseValueSpec(
        ...
        g,
        spec),
      (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>>, hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>>>) (fun -> hydra.util.Either.<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>>right((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>) (cx_ -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (term -> hydra.lib.eithers.Bind.apply(
        ((fun).apply(cx_)).apply(term),
        (java.util.function.Function<hydra.util.ConsList<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (terms -> hydra.lib.eithers.MapList.apply(
          (((java.util.function.Function<hydra.compute.Coder<hydra.core.Term, T4>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T4>>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.core.Term, T4>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T4>>>>) (projected -> projected.encode))).apply(((java.util.function.Function<hydra.pg.mapping.Schema<T2, T3, T4>, hydra.compute.Coder<hydra.core.Term, T4>>) ((java.util.function.Function<hydra.pg.mapping.Schema<T2, T3, T4>, hydra.compute.Coder<hydra.core.Term, T4>>) ((java.util.function.Function<hydra.pg.mapping.Schema<T2, T3, T4>, hydra.compute.Coder<hydra.core.Term, T4>>) (projected -> projected.edgeIds)))).apply(schema))).apply(cx_),
          terms))))))));
  }
  ...
  static <T0, T1, T2, T3, T4, T5> hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>> parseEdgeSpec(T0 cx, T1 g, hydra.pg.mapping.Schema<T2, T3, T4> schema, hydra.pg.mapping.EdgeSpec spec) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.pg.termsToElements.TermsToElements.<T0, T1, T2, T3, T4, T5>parseEdgeIdPattern(
        ...
        schema,
        id),
      (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>, hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>>) (getId -> hydra.lib.eithers.Bind.apply(
        hydra.pg.termsToElements.TermsToElements.<T0, T1, T2, T3, T4, T5>parseVertexIdPattern(
          cx,
          g,
          schema,
          outV),
        (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>, hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>>) (getOut -> hydra.lib.eithers.Bind.apply(
          hydra.pg.termsToElements.TermsToElements.<T0, T1, T2, T3, T4, T5>parseVertexIdPattern(
            cx,
            g,
            schema,
            inV),
          (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>, hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>>) (getIn -> hydra.lib.eithers.Bind.apply(
            hydra.lib.eithers.MapList.apply(
              (java.util.function.Function<hydra.pg.mapping.PropertySpec, hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>>>) (v1 -> hydra.pg.termsToElements.TermsToElements.<T0, T1, T2, T3, T4, T5>parsePropertySpec(
                cx,
                g,
                schema,
                v1)),
              props),
            (java.util.function.Function<hydra.util.ConsList<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>>, hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>>) (getProps -> hydra.util.Either.<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>right((hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>) ((hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>) (new hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>(new hydra.pg.model.Label.Edge(label), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>) (cx_ -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>) (term -> hydra.lib.eithers.Bind.apply(
              hydra.pg.termsToElements.TermsToElements.requireUnique(
                cx_,
                "edge id",
                (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (v1 -> ((getId).apply(cx_)).apply(v1)),
                term),
              (java.util.function.Function<T4, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>) (tid -> hydra.lib.eithers.Bind.apply(
                hydra.pg.termsToElements.TermsToElements.requireUnique(
                  cx_,
                  "vertex id",
                  (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (v1 -> ((getOut).apply(cx_)).apply(v1)),
                  term),
                (java.util.function.Function<T4, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>) (tout -> hydra.lib.eithers.Bind.apply(
                  hydra.pg.termsToElements.TermsToElements.requireUnique(
                    cx_,
                    "edge id",
                    (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (v1 -> ((getIn).apply(cx_)).apply(v1)),
                    term),
                  (java.util.function.Function<T4, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>) (tin -> hydra.lib.eithers.Bind.apply(
                    hydra.lib.eithers.Map.apply(
                      ...
                      hydra.lib.eithers.MapList.apply(
                        (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>) (gf -> hydra.pg.termsToElements.TermsToElements.requireUnique(
                          cx_,
                          "property key",
                          (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>) (v1 -> ((gf).apply(cx_)).apply(v1)),
                          term)),
                        getProps)),
  ...
  static <T0, T1, T2, T3, T4, T5> hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>> parseElementSpec(T0 cx, T1 g, hydra.pg.mapping.Schema<T2, T3, T4> schema, hydra.pg.mapping.ElementSpec spec) {
    return (spec).accept(new hydra.pg.mapping.ElementSpec.PartialVisitor<>() {
      @Override
      public hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>> visit(hydra.pg.mapping.ElementSpec.Vertex vspec) {
  ...
  static <T0, T1, T2> hydra.util.Either<T2, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>>> parsePattern(T0 cx, T1 _g, String pat) {
    ...
    hydra.util.Lazy<hydra.util.ConsList<hydra.util.Pair<hydra.util.ConsList<String>, String>>> parsed = new hydra.util.Lazy<>(() -> hydra.lib.lists.Map.apply(
      ...
      rest.get()));
    return hydra.util.Either.<T2, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>>>right((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>>) (cx_ -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>) (term -> hydra.pg.termsToElements.TermsToElements.applyPattern(
      cx_,
      firstLit.get(),
      parsed.get(),
      term))));
  ...
  static <T0, T1, T2, T3, T4, T5> hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>> parsePropertySpec(T0 cx, T1 g, hydra.pg.mapping.Schema<T2, T3, T4> schema, hydra.pg.mapping.PropertySpec spec) {
    ...
    return hydra.lib.eithers.Bind.apply(
      hydra.pg.termsToElements.TermsToElements.<T0, T1, T5>parseValueSpec(
        ...
        g,
        value),
      (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>>, hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>>>) (fun -> hydra.util.Either.<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>>right((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>) (cx_ -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>) (term -> hydra.lib.eithers.Bind.apply(
        ((fun).apply(cx_)).apply(term),
        (java.util.function.Function<hydra.util.ConsList<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>) (results -> hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            ...
            results),
          (java.util.function.Function<hydra.util.ConsList<T4>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>) (values -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>right(hydra.lib.lists.Map.apply(
  ...
  static <T0, T1, T2, T3, T4, T5> hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>> parseVertexIdPattern(T0 cx, T1 g, hydra.pg.mapping.Schema<T2, T3, T4> schema, hydra.pg.mapping.ValueSpec spec) {
    return hydra.lib.eithers.Bind.apply(
      ...
      (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.core.Term>>>>, hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>>>) (fun -> hydra.util.Either.<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>>right((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>) (cx_ -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (term -> hydra.lib.eithers.Bind.apply(
        ((fun).apply(cx_)).apply(term),
        (java.util.function.Function<hydra.util.ConsList<hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (terms -> hydra.lib.eithers.MapList.apply(
          (((java.util.function.Function<hydra.compute.Coder<hydra.core.Term, T4>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T4>>>>) ((java.util.function.Function<hydra.compute.Coder<hydra.core.Term, T4>, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T4>>>>) (projected -> projected.encode))).apply(((java.util.function.Function<hydra.pg.mapping.Schema<T2, T3, T4>, hydra.compute.Coder<hydra.core.Term, T4>>) ((java.util.function.Function<hydra.pg.mapping.Schema<T2, T3, T4>, hydra.compute.Coder<hydra.core.Term, T4>>) ((java.util.function.Function<hydra.pg.mapping.Schema<T2, T3, T4>, hydra.compute.Coder<hydra.core.Term, T4>>) (projected -> projected.vertexIds)))).apply(schema))).apply(cx_),
          terms))))))));
  }
      ...
      (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>>, hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>>) (getId -> hydra.lib.eithers.Bind.apply(
        hydra.lib.eithers.MapList.apply(
          (java.util.function.Function<hydra.pg.mapping.PropertySpec, hydra.util.Either<T5, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>>>) (v1 -> hydra.pg.termsToElements.TermsToElements.<T0, T1, T2, T3, T4, T5>parsePropertySpec(
            ...
            v1)),
          props),
        (java.util.function.Function<hydra.util.ConsList<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.PropertyKey, T4>>>>>>, hydra.util.Either<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>>) (getProps -> hydra.util.Either.<T5, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>>right((hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>) ((hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>) (new hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>>(new hydra.pg.model.Label.Vertex(label), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>>) (cx_ -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T4>>>>) (term -> hydra.lib.eithers.Bind.apply(
          hydra.pg.termsToElements.TermsToElements.requireUnique(
            cx_,
            "vertex id",
            (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T4>>>) (v1 -> ((getId).apply(cx_)).apply(v1)),
  ...
  static <T0> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0> readInjection(hydra.context.Context cx, hydra.graph.Graph g, hydra.util.ConsList<hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>>> cases, hydra.core.Term encoded) {
    return hydra.lib.eithers.Bind.apply(
      hydra.extract.core.Core.map(
        ...
        g,
        encoded),
      (java.util.function.Function<hydra.util.PersistentMap<hydra.core.Name, hydra.core.Term>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>) (mp -> {
        ...
        return hydra.lib.logic.IfElse.lazy(
          ...
          () -> ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>) (() -> {
            ...
            return ((java.util.function.Supplier<hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>) (() -> {
              hydra.util.Lazy<hydra.util.ConsList<hydra.util.Pair<hydra.core.Name, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T0>>>>> matching = new hydra.util.Lazy<>(() -> hydra.pg.termsToElements.TermsToElements.<T0>readInjection_matching(
                cases,
                key.get()));
              return hydra.lib.logic.IfElse.lazy(
  ...
  static <T0, T1> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T1> requireUnique(hydra.context.Context cx, String context, java.util.function.Function<T0, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<T1>>> fun, T0 term) {
    return hydra.lib.eithers.Bind.apply(
      (fun).apply(term),
      (java.util.function.Function<hydra.util.ConsList<T1>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, T1>>) (results -> hydra.lib.logic.IfElse.lazy(
  ...
  static <T0, T1, T2> hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>> termToElementsAdapter(hydra.context.Context cx, hydra.graph.Graph g, hydra.pg.mapping.Schema<T0, T1, T2> schema, hydra.core.Type typ) {
    hydra.core.Name key_elements = new hydra.core.Name("elements");
    return hydra.lib.maybes.Maybe.applyLazy(
      () -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>right((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) (new hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>(false, typ, (hydra.util.ConsList<hydra.pg.model.Label>) (hydra.util.ConsList.<hydra.pg.model.Label>of()), (hydra.compute.Coder<hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Coder<hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) (new hydra.compute.Coder<hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>) (_cx -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>) (_t -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>right((hydra.util.ConsList<hydra.pg.model.Element<T2>>) (hydra.util.ConsList.<hydra.pg.model.Element<T2>>of())))), (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.util.ConsList<hydra.pg.model.Element<T2>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>>>) (cx_ -> (java.util.function.Function<hydra.util.ConsList<hydra.pg.model.Element<T2>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>>) (_els -> hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.core.Term>left((hydra.context.InContext<hydra.error.Error_>) (new hydra.context.InContext<hydra.error.Error_>(new hydra.error.Error_.Other(new hydra.error.OtherError("no corresponding element type")), cx_)))))))))))))),
      (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>) (term -> hydra.lib.eithers.Bind.apply(
        hydra.pg.termsToElements.TermsToElements.expectList(
          ...
          (java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.pg.mapping.ElementSpec>>>>) (p0 -> p1 -> p2 -> hydra.pg.termsToElements.TermsToElements.decodeElementSpec(
            ...
            p2)),
          term),
        (java.util.function.Function<hydra.util.ConsList<hydra.pg.mapping.ElementSpec>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>) (specTerms -> hydra.lib.eithers.Bind.apply(
          hydra.lib.eithers.MapList.apply(
            (java.util.function.Function<hydra.pg.mapping.ElementSpec, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>>>>) (v1 -> hydra.pg.termsToElements.TermsToElements.parseElementSpec(
              cx,
              g,
              schema,
              v1)),
            specTerms),
          (java.util.function.Function<hydra.util.ConsList<hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>) (specs -> {
            hydra.util.Lazy<hydra.util.ConsList<hydra.pg.model.Label>> labels = new hydra.util.Lazy<>(() -> hydra.lib.lists.Nub.apply(hydra.lib.lists.Map.apply(
              (java.util.function.Function<hydra.util.Pair<hydra.pg.model.Label, java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>>, hydra.pg.model.Label>) (_p -> hydra.lib.pairs.First.apply(_p)),
              specs)));
            return hydra.util.Either.<hydra.context.InContext<hydra.error.Error_>, hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>right((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) (new hydra.compute.Adapter<hydra.core.Type, hydra.util.ConsList<hydra.pg.model.Label>, hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>(false, typ, labels.get(), (hydra.compute.Coder<hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) ((hydra.compute.Coder<hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>) (new hydra.compute.Coder<hydra.core.Term, hydra.util.ConsList<hydra.pg.model.Element<T2>>>((java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>) (cx_ -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>) (t -> hydra.lib.eithers.Map.apply(
              ...
              hydra.lib.eithers.MapList.apply(
                (java.util.function.Function<java.util.function.Function<hydra.context.Context, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>>, hydra.util.Either<hydra.context.InContext<hydra.error.Error_>, hydra.util.ConsList<hydra.pg.model.Element<T2>>>>) (e -> ((e).apply(cx_)).apply(t)),
