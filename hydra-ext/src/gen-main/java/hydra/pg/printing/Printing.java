  ...
  static <T0> String printLazyGraph(java.util.function.Function<T0, String> printValue, hydra.pg.model.LazyGraph<T0> lg) {
    return hydra.lib.strings.Cat.apply(java.util.List.of(
      ...
      hydra.lib.strings.Cat.apply(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.pg.model.Vertex<T0>, String>) (v -> hydra.lib.strings.Cat.apply(java.util.List.of(
          "\n\t",
      ...
      "\nedges:",
      hydra.lib.strings.Cat.apply(hydra.lib.lists.Map.apply(
        (java.util.function.Function<hydra.pg.model.Edge<T0>, String>) (e -> hydra.lib.strings.Cat.apply(java.util.List.of(
          "\n\t",
