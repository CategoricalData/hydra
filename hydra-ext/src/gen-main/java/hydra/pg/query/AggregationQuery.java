...
public abstract class AggregationQuery implements Serializable, Comparable<AggregationQuery> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.pg.query.AggregationQuery");
