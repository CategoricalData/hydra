...
public abstract class TimeUnit implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.TimeUnit");
  ...
  public static final class Millis extends hydra.ext.parquet.format.TimeUnit implements Serializable {
    public Millis () {
  ...
  public static final class Micros extends hydra.ext.parquet.format.TimeUnit implements Serializable {
    public Micros () {
  ...
  public static final class Nanos extends hydra.ext.parquet.format.TimeUnit implements Serializable {
    public Nanos () {
