...
public class DictionaryPageHeader implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.DictionaryPageHeader");
  ...
  public DictionaryPageHeader (Integer numValues, hydra.ext.parquet.format.Encoding encoding, hydra.util.Opt<Boolean> isSorted) {
