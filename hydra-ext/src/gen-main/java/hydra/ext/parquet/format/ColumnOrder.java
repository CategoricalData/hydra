...
public abstract class ColumnOrder implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.ColumnOrder");
   ...
   */
  public static final class TypeOrder extends hydra.ext.parquet.format.ColumnOrder implements Serializable {
    public TypeOrder () {
