...
public abstract class BoundaryOrder implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.BoundaryOrder");
  ...
  public static final class Unordered extends hydra.ext.parquet.format.BoundaryOrder implements Serializable {
    public Unordered () {
  ...
  public static final class Ascending extends hydra.ext.parquet.format.BoundaryOrder implements Serializable {
    public Ascending () {
  ...
  public static final class Descending extends hydra.ext.parquet.format.BoundaryOrder implements Serializable {
    public Descending () {
