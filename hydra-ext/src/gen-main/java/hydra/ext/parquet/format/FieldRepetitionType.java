...
public abstract class FieldRepetitionType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.FieldRepetitionType");
   ...
   */
  public static final class Required extends hydra.ext.parquet.format.FieldRepetitionType implements Serializable {
    public Required () {
   ...
   */
  public static final class Optional extends hydra.ext.parquet.format.FieldRepetitionType implements Serializable {
    public Optional () {
   ...
   */
  public static final class Repeated extends hydra.ext.parquet.format.FieldRepetitionType implements Serializable {
    public Repeated () {
