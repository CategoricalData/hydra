...
public abstract class PageType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.PageType");
  ...
  public static final class DataPage extends hydra.ext.parquet.format.PageType implements Serializable {
    public DataPage () {
  ...
  public static final class IndexPage extends hydra.ext.parquet.format.PageType implements Serializable {
    public IndexPage () {
  ...
  public static final class DictionaryPage extends hydra.ext.parquet.format.PageType implements Serializable {
  ...
  public static final class DataPageV2 extends hydra.ext.parquet.format.PageType implements Serializable {
    public DataPageV2 () {
