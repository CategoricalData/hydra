...
public class RowGroup implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.RowGroup");
   ...
   */
  public final java.util.List<hydra.ext.parquet.format.ColumnChunk> columns;
   ...
   */
  public final hydra.util.Opt<java.util.List<hydra.ext.parquet.format.SortingColumn>> sortingColumns;
  ...
  public RowGroup (java.util.List<hydra.ext.parquet.format.ColumnChunk> columns, Long totalByteSize, Long numRows, hydra.util.Opt<java.util.List<hydra.ext.parquet.format.SortingColumn>> sortingColumns, hydra.util.Opt<Long> fileOffset, hydra.util.Opt<Long> totalCompressedSize, hydra.util.Opt<Short> ordinal) {
  ...
  public RowGroup withColumns(java.util.List<hydra.ext.parquet.format.ColumnChunk> columns) {
    java.util.Objects.requireNonNull((columns));
  ...
  public RowGroup withSortingColumns(hydra.util.Opt<java.util.List<hydra.ext.parquet.format.SortingColumn>> sortingColumns) {
    java.util.Objects.requireNonNull((sortingColumns));
    return new RowGroup(columns, totalByteSize, numRows, sortingColumns, fileOffset, totalCompressedSize, ordinal);
  }
