...
public abstract class EncryptionAlgorithm implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.EncryptionAlgorithm");
  ...
  public static final class AesGcmV1 extends hydra.ext.parquet.format.EncryptionAlgorithm implements Serializable {
    public final hydra.ext.parquet.format.AesGcmV1 value;
    
    public AesGcmV1 (hydra.ext.parquet.format.AesGcmV1 value) {
  ...
  public static final class AesGcmCtrV1 extends hydra.ext.parquet.format.EncryptionAlgorithm implements Serializable {
    public final hydra.ext.parquet.format.AesGcmCtrV1 value;
    
    public AesGcmCtrV1 (hydra.ext.parquet.format.AesGcmCtrV1 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
