...
public class ColumnMetaData implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/parquet/format.ColumnMetaData");
   ...
   */
  public final hydra.util.Opt<java.util.List<hydra.ext.parquet.format.PageEncodingStats>> encodingStats;
  ...
  public ColumnMetaData (hydra.ext.parquet.format.Type type, java.util.List<hydra.ext.parquet.format.Encoding> encodings, java.util.List<String> pathInSchema, hydra.ext.parquet.format.CompressionCodec codec, Long numValues, Long totalUncompressedSize, Long totalCompressedSize, hydra.util.Opt<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata, Long dataPageOffset, hydra.util.Opt<Long> indexPageOffset, hydra.util.Opt<Long> dictionaryPageOffset, hydra.util.Opt<hydra.ext.parquet.format.Statistics> statistics, hydra.util.Opt<java.util.List<hydra.ext.parquet.format.PageEncodingStats>> encodingStats, hydra.util.Opt<Long> bloomFilterOffset) {
  ...
  public ColumnMetaData withKeyValueMetadata(hydra.util.Opt<java.util.List<hydra.ext.parquet.format.KeyValue>> keyValueMetadata) {
    java.util.Objects.requireNonNull((keyValueMetadata));
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
  ...
  public ColumnMetaData withStatistics(hydra.util.Opt<hydra.ext.parquet.format.Statistics> statistics) {
    java.util.Objects.requireNonNull((statistics));
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
  
  public ColumnMetaData withEncodingStats(hydra.util.Opt<java.util.List<hydra.ext.parquet.format.PageEncodingStats>> encodingStats) {
    java.util.Objects.requireNonNull((encodingStats));
    return new ColumnMetaData(type, encodings, pathInSchema, codec, numValues, totalUncompressedSize, totalCompressedSize, keyValueMetadata, dataPageOffset, indexPageOffset, dictionaryPageOffset, statistics, encodingStats, bloomFilterOffset);
  }
