...
public class UnaryTripleExpr_Sequence implements Serializable {
  ...
  public final hydra.util.Opt<hydra.ext.io.shex.syntax.TripleExprLabel> sequence;
  
  public final hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence_Alts alts;
  
  public UnaryTripleExpr_Sequence (hydra.util.Opt<hydra.ext.io.shex.syntax.TripleExprLabel> sequence, hydra.ext.io.shex.syntax.UnaryTripleExpr_Sequence_Alts alts) {
  ...
  public UnaryTripleExpr_Sequence withSequence(hydra.util.Opt<hydra.ext.io.shex.syntax.TripleExprLabel> sequence) {
    java.util.Objects.requireNonNull((sequence));
