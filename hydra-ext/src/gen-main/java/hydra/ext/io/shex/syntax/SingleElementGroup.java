...
public class SingleElementGroup implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/io/shex/syntax.SingleElementGroup");
  ...
  public SingleElementGroup (hydra.ext.io.shex.syntax.UnaryTripleExpr unaryTripleExpr, hydra.util.Opt<java.lang.Void> semi) {
