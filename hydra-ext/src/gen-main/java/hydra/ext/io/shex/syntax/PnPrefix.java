...
public class PnPrefix implements Serializable {
  ...
  public final hydra.util.Opt<hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option> sequence;
  
  public PnPrefix (hydra.ext.io.shex.syntax.PnCharsBase pnCharsBase, hydra.util.Opt<hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option> sequence) {
  ...
  public PnPrefix withSequence(hydra.util.Opt<hydra.ext.io.shex.syntax.PnPrefix_Sequence_Option> sequence) {
    java.util.Objects.requireNonNull((sequence));
    return new PnPrefix(pnCharsBase, sequence);
  }
}