...
public class ShapeNot implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/io/shex/syntax.ShapeNot");
  ...
  public ShapeNot (hydra.util.Opt<java.lang.Void> nOT, hydra.ext.io.shex.syntax.ShapeAtom shapeAtom) {
