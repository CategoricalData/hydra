...
public class InlineShapeAtom_Sequence implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.io.shex.syntax.InlineShapeAtom_Sequence");
  ...
  public final hydra.util.Opt<hydra.ext.io.shex.syntax.InlineShapeOrRef> inlineShapeOrRef;
  
  public InlineShapeAtom_Sequence (hydra.ext.io.shex.syntax.NodeConstraint nodeConstraint, hydra.util.Opt<hydra.ext.io.shex.syntax.InlineShapeOrRef> inlineShapeOrRef) {
  ...
  public InlineShapeAtom_Sequence withInlineShapeOrRef(hydra.util.Opt<hydra.ext.io.shex.syntax.InlineShapeOrRef> inlineShapeOrRef) {
    java.util.Objects.requireNonNull((inlineShapeOrRef));
    return new InlineShapeAtom_Sequence(nodeConstraint, inlineShapeOrRef);
  }
}