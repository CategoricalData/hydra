...
public abstract class XsFacet implements Serializable, Comparable<XsFacet> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.io.shex.syntax.XsFacet");

  public static final hydra.core.Name STRING_FACET = new hydra.core.Name("StringFacet");

  public static final hydra.core.Name NUMERIC_FACET = new hydra.core.Name("NumericFacet");
  ...
  public static final class StringFacet extends hydra.ext.io.shex.syntax.XsFacet implements Serializable {
    ...
    public int compareTo(XsFacet other) {
