...
public class ShapeDefinition implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/io/shex/syntax.ShapeDefinition");
  ...
  public final hydra.util.Opt<hydra.ext.io.shex.syntax.TripleExpression> tripleExpression;
  ...
  public ShapeDefinition (java.util.List<hydra.ext.io.shex.syntax.ShapeDefinition_ListOfAlts_Elmt> listOfAlts, hydra.util.Opt<hydra.ext.io.shex.syntax.TripleExpression> tripleExpression, java.util.List<hydra.ext.io.shex.syntax.Annotation> listOfAnnotation, hydra.ext.io.shex.syntax.SemanticActions semanticActions) {
  ...
  public ShapeDefinition withTripleExpression(hydra.util.Opt<hydra.ext.io.shex.syntax.TripleExpression> tripleExpression) {
    java.util.Objects.requireNonNull((tripleExpression));
    return new ShapeDefinition(listOfAlts, tripleExpression, listOfAnnotation, semanticActions);
  }
