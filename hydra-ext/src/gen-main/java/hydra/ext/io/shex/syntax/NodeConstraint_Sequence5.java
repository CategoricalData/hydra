...
public class NodeConstraint_Sequence5 implements Serializable, Comparable<NodeConstraint_Sequence5> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.io.shex.syntax.NodeConstraint_Sequence5");
  ...
  public int compareTo(NodeConstraint_Sequence5 other) {
    int cmp = 0;
    cmp = ((Comparable) ValueSet).compareTo(other.ValueSet);
    if (cmp != 0) {
      return cmp;
    }
