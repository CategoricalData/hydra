...
public class ShexDoc implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/io/shex/syntax.ShexDoc");
  ...
  public final hydra.util.Opt<hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option> sequence;
  
  public final hydra.ext.io.shex.syntax.PrefixDecl prefixDecl;
  
  public ShexDoc (java.util.List<hydra.ext.io.shex.syntax.Directive> listOfDirective, hydra.util.Opt<hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option> sequence, hydra.ext.io.shex.syntax.PrefixDecl prefixDecl) {
  ...
  public ShexDoc withSequence(hydra.util.Opt<hydra.ext.io.shex.syntax.ShexDoc_Sequence_Option> sequence) {
    java.util.Objects.requireNonNull((sequence));
    return new ShexDoc(listOfDirective, sequence, prefixDecl);
  }
