...
public class StringLiteralLong1_Elmt_Sequence implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence");
  ...
  public final hydra.util.Opt<hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option> alts;
  
  public final String regex;
  
  public StringLiteralLong1_Elmt_Sequence (hydra.util.Opt<hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option> alts, String regex) {
  ...
  public StringLiteralLong1_Elmt_Sequence withAlts(hydra.util.Opt<hydra.ext.io.shex.syntax.StringLiteralLong1_Elmt_Sequence_Alts_Option> alts) {
    java.util.Objects.requireNonNull((alts));
