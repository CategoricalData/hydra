...
public abstract class ColumnDefinition_DefaultOrIdentityOrGeneration_Option implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.ColumnDefinition.DefaultOrIdentityOrGeneration.Option");
  ...
  public static final class DefaultClause extends hydra.ext.sql.ansi.ColumnDefinition_DefaultOrIdentityOrGeneration_Option implements Serializable {
  ...
  public static final class IdentityColumnSpecification extends hydra.ext.sql.ansi.ColumnDefinition_DefaultOrIdentityOrGeneration_Option implements Serializable {
  ...
  public static final class GenerationClause extends hydra.ext.sql.ansi.ColumnDefinition_DefaultOrIdentityOrGeneration_Option implements Serializable {
