...
public abstract class ColumnDefinition_TypeOrDomain_Option implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.ColumnDefinition.TypeOrDomain.Option");
  ...
  public static final class DataType extends hydra.ext.sql.ansi.ColumnDefinition_TypeOrDomain_Option implements Serializable {
    public final hydra.ext.sql.ansi.DataType value;
    
    public DataType (hydra.ext.sql.ansi.DataType value) {
  ...
  public static final class DomainName extends hydra.ext.sql.ansi.ColumnDefinition_TypeOrDomain_Option implements Serializable {
    public final hydra.ext.sql.ansi.DomainName value;
    
    public DomainName (hydra.ext.sql.ansi.DomainName value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
