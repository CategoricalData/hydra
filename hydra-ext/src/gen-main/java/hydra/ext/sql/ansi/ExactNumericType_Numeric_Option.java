...
public class ExactNumericType_Numeric_Option implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.ExactNumericType.Numeric.Option");
  ...
  public ExactNumericType_Numeric_Option (hydra.ext.sql.ansi.Precision precision, hydra.util.Opt<hydra.ext.sql.ansi.Scale> sequence) {
  ...
  public ExactNumericType_Numeric_Option withSequence(hydra.util.Opt<hydra.ext.sql.ansi.Scale> sequence) {
    java.util.Objects.requireNonNull((sequence));
    return new ExactNumericType_Numeric_Option(precision, sequence);
  }
}