...
public abstract class BooleanLiteral implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.BooleanLiteral");
  ...
  public static final class TRUE extends hydra.ext.sql.ansi.BooleanLiteral implements Serializable {
    public TRUE () {
  ...
  public static final class FALSE extends hydra.ext.sql.ansi.BooleanLiteral implements Serializable {
    public FALSE () {
  ...
  public static final class UNKNOWN extends hydra.ext.sql.ansi.BooleanLiteral implements Serializable {
    public UNKNOWN () {
