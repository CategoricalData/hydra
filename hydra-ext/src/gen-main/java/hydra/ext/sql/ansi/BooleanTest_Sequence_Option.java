...
public class BooleanTest_Sequence_Option implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.BooleanTest.Sequence.Option");
  ...
  public BooleanTest_Sequence_Option (hydra.util.Opt<java.lang.Void> nOT, hydra.ext.sql.ansi.TruthValue truthValue) {
