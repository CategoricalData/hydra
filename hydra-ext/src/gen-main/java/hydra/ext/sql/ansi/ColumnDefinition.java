...
public class ColumnDefinition implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.ColumnDefinition");
  ...
  public final hydra.util.Opt<hydra.ext.sql.ansi.ColumnDefinition_TypeOrDomain_Option> typeOrDomain;
  
  public final hydra.util.Opt<hydra.ext.sql.ansi.ReferenceScopeCheck> refScope;
  
  public final hydra.util.Opt<hydra.ext.sql.ansi.ColumnDefinition_DefaultOrIdentityOrGeneration_Option> defaultOrIdentityOrGeneration;
  
  public final java.util.List<hydra.ext.sql.ansi.ColumnConstraintDefinition> constraints;
  
  public final hydra.util.Opt<hydra.ext.sql.ansi.CollateClause> collate;
  
  public ColumnDefinition (hydra.ext.sql.ansi.ColumnName name, hydra.util.Opt<hydra.ext.sql.ansi.ColumnDefinition_TypeOrDomain_Option> typeOrDomain, hydra.util.Opt<hydra.ext.sql.ansi.ReferenceScopeCheck> refScope, hydra.util.Opt<hydra.ext.sql.ansi.ColumnDefinition_DefaultOrIdentityOrGeneration_Option> defaultOrIdentityOrGeneration, java.util.List<hydra.ext.sql.ansi.ColumnConstraintDefinition> constraints, hydra.util.Opt<hydra.ext.sql.ansi.CollateClause> collate) {
  ...
  public ColumnDefinition withTypeOrDomain(hydra.util.Opt<hydra.ext.sql.ansi.ColumnDefinition_TypeOrDomain_Option> typeOrDomain) {
    java.util.Objects.requireNonNull((typeOrDomain));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
  
  public ColumnDefinition withRefScope(hydra.util.Opt<hydra.ext.sql.ansi.ReferenceScopeCheck> refScope) {
    java.util.Objects.requireNonNull((refScope));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
  
  public ColumnDefinition withDefaultOrIdentityOrGeneration(hydra.util.Opt<hydra.ext.sql.ansi.ColumnDefinition_DefaultOrIdentityOrGeneration_Option> defaultOrIdentityOrGeneration) {
    java.util.Objects.requireNonNull((defaultOrIdentityOrGeneration));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
  ...
  public ColumnDefinition withCollate(hydra.util.Opt<hydra.ext.sql.ansi.CollateClause> collate) {
    java.util.Objects.requireNonNull((collate));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
}