...
public abstract class CollectionType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.CollectionType");
  ...
  public static final class Array extends hydra.ext.sql.ansi.CollectionType implements Serializable {
  ...
  public static final class Multiset extends hydra.ext.sql.ansi.CollectionType implements Serializable {
