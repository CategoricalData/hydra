...
public abstract class BooleanTerm implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.BooleanTerm");
  ...
  public static final class Factor extends hydra.ext.sql.ansi.BooleanTerm implements Serializable {
  ...
  public static final class And extends hydra.ext.sql.ansi.BooleanTerm implements Serializable {
