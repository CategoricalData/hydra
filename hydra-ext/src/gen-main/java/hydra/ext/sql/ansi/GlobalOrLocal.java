...
public abstract class GlobalOrLocal implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.GlobalOrLocal");
  ...
  public static final class Global extends hydra.ext.sql.ansi.GlobalOrLocal implements Serializable {
    public Global () {
  ...
  public static final class Local extends hydra.ext.sql.ansi.GlobalOrLocal implements Serializable {
    public Local () {
