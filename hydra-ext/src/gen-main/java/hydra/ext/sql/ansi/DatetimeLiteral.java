...
public abstract class DatetimeLiteral implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.DatetimeLiteral");
  ...
  public static final class Date extends hydra.ext.sql.ansi.DatetimeLiteral implements Serializable {
  ...
  public static final class Time extends hydra.ext.sql.ansi.DatetimeLiteral implements Serializable {
  ...
  public static final class Timestamp extends hydra.ext.sql.ansi.DatetimeLiteral implements Serializable {
