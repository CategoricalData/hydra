...
public abstract class TruthValue implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.TruthValue");
  ...
  public static final class TRUE extends hydra.ext.sql.ansi.TruthValue implements Serializable {
    public TRUE () {
  ...
  public static final class FALSE extends hydra.ext.sql.ansi.TruthValue implements Serializable {
    public FALSE () {
  ...
  public static final class UNKNOWN extends hydra.ext.sql.ansi.TruthValue implements Serializable {
    public UNKNOWN () {
