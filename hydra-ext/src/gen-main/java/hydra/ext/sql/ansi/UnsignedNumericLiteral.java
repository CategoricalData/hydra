...
public abstract class UnsignedNumericLiteral implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/sql/ansi.UnsignedNumericLiteral");
  ...
  public static final class Exact extends hydra.ext.sql.ansi.UnsignedNumericLiteral implements Serializable {
  ...
  public static final class Approximate extends hydra.ext.sql.ansi.UnsignedNumericLiteral implements Serializable {
