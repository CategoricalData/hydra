...
public class SearchCommand implements Serializable {
  ...
  public final java.util.List<hydra.ext.com.microsoft.kusto.kql.TableName> datasets;
  
  public final hydra.ext.com.microsoft.kusto.kql.Expression pattern;
  
  public SearchCommand (java.util.List<hydra.ext.com.microsoft.kusto.kql.TableName> datasets, hydra.ext.com.microsoft.kusto.kql.Expression pattern) {
  ...
  public SearchCommand withDatasets(java.util.List<hydra.ext.com.microsoft.kusto.kql.TableName> datasets) {
    java.util.Objects.requireNonNull((datasets));
    return new SearchCommand(datasets, pattern);
  }
  
  public SearchCommand withPattern(hydra.ext.com.microsoft.kusto.kql.Expression pattern) {
    java.util.Objects.requireNonNull((pattern));
    return new SearchCommand(datasets, pattern);
  }
}