...
public abstract class UnionKind implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.com.microsoft.kusto.kql.UnionKind");
  ...
  public static final class Inner extends hydra.ext.com.microsoft.kusto.kql.UnionKind implements Serializable {
    public Inner () {
  ...
  public static final class Outer extends hydra.ext.com.microsoft.kusto.kql.UnionKind implements Serializable {
    public Outer () {
