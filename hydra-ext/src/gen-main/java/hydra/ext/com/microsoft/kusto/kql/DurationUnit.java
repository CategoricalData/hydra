...
public abstract class DurationUnit implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/com/microsoft/kusto/kql.DurationUnit");
  ...
  public static final class Second extends hydra.ext.com.microsoft.kusto.kql.DurationUnit implements Serializable {
    public Second () {
  ...
  public static final class Minute extends hydra.ext.com.microsoft.kusto.kql.DurationUnit implements Serializable {
    public Minute () {
  ...
  public static final class Hour extends hydra.ext.com.microsoft.kusto.kql.DurationUnit implements Serializable {
    public Hour () {
