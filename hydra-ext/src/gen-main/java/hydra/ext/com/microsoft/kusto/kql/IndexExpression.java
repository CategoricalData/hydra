...
public class IndexExpression implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/com/microsoft/kusto/kql.IndexExpression");
  ...
  public IndexExpression (hydra.ext.com.microsoft.kusto.kql.Expression expression, String index) {
  ...
  public IndexExpression withExpression(hydra.ext.com.microsoft.kusto.kql.Expression expression) {
    java.util.Objects.requireNonNull((expression));
