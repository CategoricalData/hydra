...
public class UnaryExpression implements Serializable {
  ...
  public final hydra.ext.com.microsoft.kusto.kql.UnaryOperator operator;
  
  public final hydra.ext.com.microsoft.kusto.kql.Expression expression;
  
  public UnaryExpression (hydra.ext.com.microsoft.kusto.kql.UnaryOperator operator, hydra.ext.com.microsoft.kusto.kql.Expression expression) {
  ...
  public UnaryExpression withOperator(hydra.ext.com.microsoft.kusto.kql.UnaryOperator operator) {
    java.util.Objects.requireNonNull((operator));
    return new UnaryExpression(operator, expression);
  }
  
  public UnaryExpression withExpression(hydra.ext.com.microsoft.kusto.kql.Expression expression) {
    java.util.Objects.requireNonNull((expression));
    return new UnaryExpression(operator, expression);
  }
}