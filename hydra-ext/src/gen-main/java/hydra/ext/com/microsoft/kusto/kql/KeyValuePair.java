...
public class KeyValuePair implements Serializable {
  ...
  public KeyValuePair (String key, hydra.ext.com.microsoft.kusto.kql.Expression value) {
  ...
  public KeyValuePair withValue(hydra.ext.com.microsoft.kusto.kql.Expression value) {
    java.util.Objects.requireNonNull((value));
    return new KeyValuePair(key, value);
  }
}