...
public abstract class Columns implements Serializable {
  ...
  public static final class All extends hydra.ext.com.microsoft.kusto.kql.Columns implements Serializable {
    public All () {
  ...
  public static final class Single extends hydra.ext.com.microsoft.kusto.kql.Columns implements Serializable {
    public final hydra.ext.com.microsoft.kusto.kql.ColumnName value;
    
    public Single (hydra.ext.com.microsoft.kusto.kql.ColumnName value) {
