...
public abstract class Literal implements Serializable {
  ...
  public static final class Duration extends hydra.ext.com.microsoft.kusto.kql.Literal implements Serializable {
    public final hydra.ext.com.microsoft.kusto.kql.Duration value;
    
    public Duration (hydra.ext.com.microsoft.kusto.kql.Duration value) {
  ...
  public static final class Datetime extends hydra.ext.com.microsoft.kusto.kql.Literal implements Serializable {
    public final hydra.ext.com.microsoft.kusto.kql.Datetime value;
    
    public Datetime (hydra.ext.com.microsoft.kusto.kql.Datetime value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class String_ extends hydra.ext.com.microsoft.kusto.kql.Literal implements Serializable {
  ...
  public static final class Int extends hydra.ext.com.microsoft.kusto.kql.Literal implements Serializable {
  ...
  public static final class Long_ extends hydra.ext.com.microsoft.kusto.kql.Literal implements Serializable {
  ...
  public static final class Double_ extends hydra.ext.com.microsoft.kusto.kql.Literal implements Serializable {
  ...
  public static final class Boolean_ extends hydra.ext.com.microsoft.kusto.kql.Literal implements Serializable {
