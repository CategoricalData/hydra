...
public class MapValue implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.com.microsoft.azure.dtld.MapValue");
  ...
  public MapValue (String name, hydra.ext.com.microsoft.azure.dtld.Schema schema, hydra.util.Opt<hydra.ext.com.microsoft.azure.dtld.Dtmi> id, hydra.util.Opt<String> comment, hydra.util.Opt<String> description, hydra.util.Opt<String> displayName) {
  ...
  public MapValue withName(String name) {
    java.util.Objects.requireNonNull((name));
    return new MapValue(name, schema, id, comment, description, displayName);
  }
  
  public MapValue withSchema(hydra.ext.com.microsoft.azure.dtld.Schema schema) {
    java.util.Objects.requireNonNull((schema));
    return new MapValue(name, schema, id, comment, description, displayName);
  }
  
  public MapValue withId(hydra.util.Opt<hydra.ext.com.microsoft.azure.dtld.Dtmi> id) {
    java.util.Objects.requireNonNull((id));
    return new MapValue(name, schema, id, comment, description, displayName);
  }
  
  public MapValue withComment(hydra.util.Opt<String> comment) {
    java.util.Objects.requireNonNull((comment));
    return new MapValue(name, schema, id, comment, description, displayName);
  }
  
  public MapValue withDescription(hydra.util.Opt<String> description) {
    java.util.Objects.requireNonNull((description));
    return new MapValue(name, schema, id, comment, description, displayName);
  }
  
  public MapValue withDisplayName(hydra.util.Opt<String> displayName) {
    java.util.Objects.requireNonNull((displayName));
    return new MapValue(name, schema, id, comment, description, displayName);
  }
}