...
public class Parameter implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/com/microsoft/kusto/kql.Parameter");
  ...
  public Parameter (String key, hydra.ext.com.microsoft.kusto.kql.Literal value) {
  ...
  public Parameter withValue(hydra.ext.com.microsoft.kusto.kql.Literal value) {
    java.util.Objects.requireNonNull((value));
    return new Parameter(key, value);
  }
}