...
public abstract class TermList implements Serializable, Comparable<TermList> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.datalog.syntax.TermList");
  ...
  public static final class Single extends hydra.ext.datalog.syntax.TermList implements Serializable {
  ...
  public static final class Multiple extends hydra.ext.datalog.syntax.TermList implements Serializable {
