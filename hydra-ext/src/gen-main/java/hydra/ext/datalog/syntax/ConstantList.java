...
public abstract class ConstantList implements Serializable, Comparable<ConstantList> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.datalog.syntax.ConstantList");
  ...
  public static final class Single extends hydra.ext.datalog.syntax.ConstantList implements Serializable {
    ...
    public int compareTo(ConstantList other) {
