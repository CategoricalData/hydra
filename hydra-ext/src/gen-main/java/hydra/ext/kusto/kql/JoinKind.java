...
public abstract class JoinKind implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.JoinKind");
  ...
  public static final class Leftouter extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Leftouter () {
  ...
  public static final class Leftsemi extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Leftsemi () {
  ...
  public static final class Leftanti extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Leftanti () {
  ...
  public static final class Fullouter extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Fullouter () {
  ...
  public static final class Inner extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Inner () {
  ...
  public static final class Innerunique extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Innerunique () {
  ...
  public static final class Rightouter extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Rightouter () {
  ...
  public static final class Rightsemi extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Rightsemi () {
  ...
  public static final class Rightanti extends hydra.ext.kusto.kql.JoinKind implements Serializable {
    public Rightanti () {
