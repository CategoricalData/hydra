...
public class UnionCommand implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.UnionCommand");
  ...
  public final java.util.List<hydra.ext.kusto.kql.Parameter> parameters;
  
  public final hydra.util.Opt<hydra.ext.kusto.kql.UnionKind> kind;
  
  public final hydra.util.Opt<hydra.ext.kusto.kql.ColumnName> withSource;
  
  public final hydra.util.Opt<Boolean> isFuzzy;
  
  public final java.util.List<hydra.ext.kusto.kql.TableName> tables;
  
  public UnionCommand (java.util.List<hydra.ext.kusto.kql.Parameter> parameters, hydra.util.Opt<hydra.ext.kusto.kql.UnionKind> kind, hydra.util.Opt<hydra.ext.kusto.kql.ColumnName> withSource, hydra.util.Opt<Boolean> isFuzzy, java.util.List<hydra.ext.kusto.kql.TableName> tables) {
  ...
  public UnionCommand withParameters(java.util.List<hydra.ext.kusto.kql.Parameter> parameters) {
    java.util.Objects.requireNonNull((parameters));
    return new UnionCommand(parameters, kind, withSource, isFuzzy, tables);
  }
  
  public UnionCommand withKind(hydra.util.Opt<hydra.ext.kusto.kql.UnionKind> kind) {
    java.util.Objects.requireNonNull((kind));
    return new UnionCommand(parameters, kind, withSource, isFuzzy, tables);
  }
  
  public UnionCommand withWithSource(hydra.util.Opt<hydra.ext.kusto.kql.ColumnName> withSource) {
    java.util.Objects.requireNonNull((withSource));
    return new UnionCommand(parameters, kind, withSource, isFuzzy, tables);
  }
  ...
  public UnionCommand withTables(java.util.List<hydra.ext.kusto.kql.TableName> tables) {
    java.util.Objects.requireNonNull((tables));
    return new UnionCommand(parameters, kind, withSource, isFuzzy, tables);
  }
}
