...
public abstract class BuiltInFunction implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.BuiltInFunction");
  ...
  public static final class Ago extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Ago () {
  ...
  public static final class Bin extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Bin () {
  ...
  public static final class Count extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Count () {
  ...
  public static final class Dcount extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Dcount () {
  ...
  public static final class Endofday extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Endofday () {
  ...
  public static final class Extract extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Extract () {
  ...
  public static final class Format_datetime extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
  ...
  public static final class Materialize extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Materialize () {
  ...
  public static final class Now extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Now () {
  ...
  public static final class Range extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Range () {
  ...
  public static final class Startofday extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Startofday () {
  ...
  public static final class Strcat extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Strcat () {
  ...
  public static final class Todynamic extends hydra.ext.kusto.kql.BuiltInFunction implements Serializable {
    public Todynamic () {
