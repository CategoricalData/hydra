...
public class ParseCommand implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.ParseCommand");
  ...
  public final java.util.List<hydra.ext.kusto.kql.KeyValuePair> pairs;
  
  public ParseCommand (hydra.ext.kusto.kql.ColumnName column, java.util.List<hydra.ext.kusto.kql.KeyValuePair> pairs) {
  ...
  public ParseCommand withColumn(hydra.ext.kusto.kql.ColumnName column) {
    java.util.Objects.requireNonNull((column));
    return new ParseCommand(column, pairs);
  }
  
  public ParseCommand withPairs(java.util.List<hydra.ext.kusto.kql.KeyValuePair> pairs) {
    java.util.Objects.requireNonNull((pairs));
    return new ParseCommand(column, pairs);
  }
}
