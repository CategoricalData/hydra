...
public class BetweenExpression implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.BetweenExpression");
  ...
  public final hydra.ext.kusto.kql.Expression lowerBound;
  
  public final hydra.ext.kusto.kql.Expression upperBound;
  
  public BetweenExpression (Boolean not, hydra.ext.kusto.kql.Expression expression, hydra.ext.kusto.kql.Expression lowerBound, hydra.ext.kusto.kql.Expression upperBound) {
  ...
  public BetweenExpression withExpression(hydra.ext.kusto.kql.Expression expression) {
    java.util.Objects.requireNonNull((expression));
    return new BetweenExpression(not, expression, lowerBound, upperBound);
  }
  
  public BetweenExpression withLowerBound(hydra.ext.kusto.kql.Expression lowerBound) {
    java.util.Objects.requireNonNull((lowerBound));
    return new BetweenExpression(not, expression, lowerBound, upperBound);
  }
  
  public BetweenExpression withUpperBound(hydra.ext.kusto.kql.Expression upperBound) {
    java.util.Objects.requireNonNull((upperBound));
    return new BetweenExpression(not, expression, lowerBound, upperBound);
  }
}
