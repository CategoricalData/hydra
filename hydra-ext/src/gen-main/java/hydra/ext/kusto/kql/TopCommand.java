...
public class TopCommand implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.TopCommand");
  ...
  public final java.util.List<hydra.ext.kusto.kql.SortBy> sort;
  
  public TopCommand (Integer count, java.util.List<hydra.ext.kusto.kql.SortBy> sort) {
  ...
  public TopCommand withSort(java.util.List<hydra.ext.kusto.kql.SortBy> sort) {
    java.util.Objects.requireNonNull((sort));
    return new TopCommand(count, sort);
  }
}