...
public abstract class BinaryOperator implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.BinaryOperator");
  ...
  public static final class CaseInsensitiveEqual extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
  ...
  public static final class Contains extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Contains () {
  ...
  public static final class Divide extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Divide () {
  ...
  public static final class EndsWith extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public EndsWith () {
  ...
  public static final class Equal extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Equal () {
  ...
  public static final class Greater extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Greater () {
  ...
  public static final class GreaterOrEqual extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
  ...
  public static final class Has extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Has () {
  ...
  public static final class HasPrefix extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public HasPrefix () {
  ...
  public static final class HasSuffix extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public HasSuffix () {
  ...
  public static final class Less extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Less () {
  ...
  public static final class LessOrEqual extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public LessOrEqual () {
  ...
  public static final class MatchesRegex extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public MatchesRegex () {
  ...
  public static final class Minus extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Minus () {
  ...
  public static final class NotEqual extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public NotEqual () {
  ...
  public static final class Plus extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Plus () {
  ...
  public static final class StartsWith extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public StartsWith () {
  ...
  public static final class Times extends hydra.ext.kusto.kql.BinaryOperator implements Serializable {
    public Times () {
