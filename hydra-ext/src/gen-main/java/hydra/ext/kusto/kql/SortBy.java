...
public class SortBy implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.SortBy");
  ...
  public final hydra.ext.kusto.kql.ColumnName column;
  
  public final hydra.util.Opt<hydra.ext.kusto.kql.Order> order;
  
  public SortBy (hydra.ext.kusto.kql.ColumnName column, hydra.util.Opt<hydra.ext.kusto.kql.Order> order) {
  ...
  public SortBy withColumn(hydra.ext.kusto.kql.ColumnName column) {
    java.util.Objects.requireNonNull((column));
    return new SortBy(column, order);
  }
  
  public SortBy withOrder(hydra.util.Opt<hydra.ext.kusto.kql.Order> order) {
    java.util.Objects.requireNonNull((order));
    return new SortBy(column, order);
  }
}
