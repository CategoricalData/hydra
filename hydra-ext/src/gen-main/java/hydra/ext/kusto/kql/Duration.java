...
public class Duration implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.Duration");
  ...
  public final hydra.ext.kusto.kql.DurationUnit unit;
  
  public Duration (Integer value, hydra.ext.kusto.kql.DurationUnit unit) {
  ...
  public Duration withUnit(hydra.ext.kusto.kql.DurationUnit unit) {
    java.util.Objects.requireNonNull((unit));
    return new Duration(value, unit);
  }
}