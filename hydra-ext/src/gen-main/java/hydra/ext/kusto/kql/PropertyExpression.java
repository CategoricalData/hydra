...
public class PropertyExpression implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/kusto/kql.PropertyExpression");
  ...
  public PropertyExpression (hydra.ext.kusto.kql.Expression expression, String property) {
  ...
  public PropertyExpression withExpression(hydra.ext.kusto.kql.Expression expression) {
    java.util.Objects.requireNonNull((expression));
