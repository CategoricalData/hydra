...
public abstract class NodeConstraint implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.NodeConstraint");
  ...
  public static final class Sequence extends hydra.ext.shex.syntax.NodeConstraint implements Serializable {
  ...
  public static final class Sequence2 extends hydra.ext.shex.syntax.NodeConstraint implements Serializable {
    public final hydra.ext.shex.syntax.NodeConstraint_Sequence2 value;
    
    public Sequence2 (hydra.ext.shex.syntax.NodeConstraint_Sequence2 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Sequence3 extends hydra.ext.shex.syntax.NodeConstraint implements Serializable {
    public final hydra.ext.shex.syntax.NodeConstraint_Sequence3 value;
    
    public Sequence3 (hydra.ext.shex.syntax.NodeConstraint_Sequence3 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Sequence4 extends hydra.ext.shex.syntax.NodeConstraint implements Serializable {
    public final hydra.ext.shex.syntax.NodeConstraint_Sequence4 value;
    
    public Sequence4 (hydra.ext.shex.syntax.NodeConstraint_Sequence4 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Sequence5 extends hydra.ext.shex.syntax.NodeConstraint implements Serializable {
    public final hydra.ext.shex.syntax.NodeConstraint_Sequence5 value;
    
    public Sequence5 (hydra.ext.shex.syntax.NodeConstraint_Sequence5 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class ListOfXsFacet extends hydra.ext.shex.syntax.NodeConstraint implements Serializable {
    public final java.util.List<hydra.ext.shex.syntax.XsFacet> value;
    
    public ListOfXsFacet (java.util.List<hydra.ext.shex.syntax.XsFacet> value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
