...
public abstract class PnLocal_Sequence_Option_Alts implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.PnLocal.Sequence.Option.Alts");
  ...
  public static final class PnChars extends hydra.ext.shex.syntax.PnLocal_Sequence_Option_Alts implements Serializable {
  ...
  public static final class Colon extends hydra.ext.shex.syntax.PnLocal_Sequence_Option_Alts implements Serializable {
    public Colon () {
  ...
  public static final class Plx extends hydra.ext.shex.syntax.PnLocal_Sequence_Option_Alts implements Serializable {
