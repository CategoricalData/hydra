...
public class NodeConstraint_Sequence5 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.NodeConstraint.Sequence5");
  ...
  public NodeConstraint_Sequence5 (hydra.ext.shex.syntax.ValueSet valueSet, java.util.List<hydra.ext.shex.syntax.XsFacet> listOfXsFacet) {
  ...
  public NodeConstraint_Sequence5 withValueSet(hydra.ext.shex.syntax.ValueSet valueSet) {
    java.util.Objects.requireNonNull((valueSet));
    return new NodeConstraint_Sequence5(valueSet, listOfXsFacet);
  }
  
  public NodeConstraint_Sequence5 withListOfXsFacet(java.util.List<hydra.ext.shex.syntax.XsFacet> listOfXsFacet) {
    java.util.Objects.requireNonNull((listOfXsFacet));
    return new NodeConstraint_Sequence5(valueSet, listOfXsFacet);
  }
}