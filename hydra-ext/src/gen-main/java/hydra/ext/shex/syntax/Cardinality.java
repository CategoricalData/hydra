...
public abstract class Cardinality implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.Cardinality");
  ...
  public static final class Ast extends hydra.ext.shex.syntax.Cardinality implements Serializable {
    public Ast () {
  ...
  public static final class Plus extends hydra.ext.shex.syntax.Cardinality implements Serializable {
    public Plus () {
  ...
  public static final class Quest extends hydra.ext.shex.syntax.Cardinality implements Serializable {
    public Quest () {
  ...
  public static final class RepeatRange extends hydra.ext.shex.syntax.Cardinality implements Serializable {
    public final hydra.ext.shex.syntax.RepeatRange value;
    
    public RepeatRange (hydra.ext.shex.syntax.RepeatRange value) {
