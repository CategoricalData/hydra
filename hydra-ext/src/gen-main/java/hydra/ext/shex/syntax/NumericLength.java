...
public abstract class NumericLength implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.NumericLength");
  ...
  public static final class TOTALDIGITS extends hydra.ext.shex.syntax.NumericLength implements Serializable {
    public TOTALDIGITS () {
  ...
  public static final class FRACTIONDIGITS extends hydra.ext.shex.syntax.NumericLength implements Serializable {
