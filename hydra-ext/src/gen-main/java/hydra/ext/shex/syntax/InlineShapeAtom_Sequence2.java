...
public class InlineShapeAtom_Sequence2 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.InlineShapeAtom.Sequence2");
  ...
  public final hydra.util.Opt<hydra.ext.shex.syntax.NodeConstraint> nodeConstraint;
  
  public InlineShapeAtom_Sequence2 (hydra.ext.shex.syntax.InlineShapeOrRef inlineShapeOrRef, hydra.util.Opt<hydra.ext.shex.syntax.NodeConstraint> nodeConstraint) {
  ...
  public InlineShapeAtom_Sequence2 withNodeConstraint(hydra.util.Opt<hydra.ext.shex.syntax.NodeConstraint> nodeConstraint) {
    java.util.Objects.requireNonNull((nodeConstraint));
    return new InlineShapeAtom_Sequence2(inlineShapeOrRef, nodeConstraint);
  }
}
