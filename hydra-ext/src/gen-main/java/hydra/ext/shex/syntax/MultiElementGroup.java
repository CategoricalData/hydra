...
public class MultiElementGroup implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.MultiElementGroup");
  ...
  public MultiElementGroup (hydra.ext.shex.syntax.UnaryTripleExpr unaryTripleExpr, java.util.List<hydra.ext.shex.syntax.UnaryTripleExpr> listOfSequence, hydra.util.Opt<java.lang.Void> semi) {
