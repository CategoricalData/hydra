...
public class InlineShapeNot implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.InlineShapeNot");
  ...
  public InlineShapeNot (hydra.util.Opt<java.lang.Void> nOT, hydra.ext.shex.syntax.InlineShapeAtom inlineShapeAtom) {
