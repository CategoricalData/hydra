...
public class TripleConstraint implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.TripleConstraint");
  ...
  public final hydra.util.Opt<hydra.ext.shex.syntax.SenseFlags> senseFlags;
  ...
  public final hydra.util.Opt<hydra.ext.shex.syntax.Cardinality> cardinality;
  ...
  public TripleConstraint (hydra.util.Opt<hydra.ext.shex.syntax.SenseFlags> senseFlags, hydra.ext.shex.syntax.Predicate predicate, hydra.ext.shex.syntax.InlineShapeExpression inlineShapeExpression, hydra.util.Opt<hydra.ext.shex.syntax.Cardinality> cardinality, java.util.List<hydra.ext.shex.syntax.Annotation> listOfAnnotation, hydra.ext.shex.syntax.SemanticActions semanticActions) {
  ...
  public TripleConstraint withSenseFlags(hydra.util.Opt<hydra.ext.shex.syntax.SenseFlags> senseFlags) {
    java.util.Objects.requireNonNull((senseFlags));
  ...
  public TripleConstraint withCardinality(hydra.util.Opt<hydra.ext.shex.syntax.Cardinality> cardinality) {
    java.util.Objects.requireNonNull((cardinality));
    return new TripleConstraint(senseFlags, predicate, inlineShapeExpression, cardinality, listOfAnnotation, semanticActions);
  }
