...
public class UnaryTripleExpr_Sequence implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.UnaryTripleExpr.Sequence");
  ...
  public final hydra.util.Opt<hydra.ext.shex.syntax.TripleExprLabel> sequence;
  
  public final hydra.ext.shex.syntax.UnaryTripleExpr_Sequence_Alts alts;
  
  public UnaryTripleExpr_Sequence (hydra.util.Opt<hydra.ext.shex.syntax.TripleExprLabel> sequence, hydra.ext.shex.syntax.UnaryTripleExpr_Sequence_Alts alts) {
  ...
  public UnaryTripleExpr_Sequence withSequence(hydra.util.Opt<hydra.ext.shex.syntax.TripleExprLabel> sequence) {
    java.util.Objects.requireNonNull((sequence));
