...
public abstract class PrefixedName implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.PrefixedName");
  ...
  public static final class PnameLn extends hydra.ext.shex.syntax.PrefixedName implements Serializable {
    public final hydra.ext.shex.syntax.PnameLn value;
    
    public PnameLn (hydra.ext.shex.syntax.PnameLn value) {
  ...
  public static final class PnameNs extends hydra.ext.shex.syntax.PrefixedName implements Serializable {
    public final hydra.ext.shex.syntax.PnameNs value;
    
    public PnameNs (hydra.ext.shex.syntax.PnameNs value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
