...
public abstract class RdfLiteral_Alts_Option implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.RdfLiteral.Alts.Option");
  ...
  public static final class LangTag extends hydra.ext.shex.syntax.RdfLiteral_Alts_Option implements Serializable {
    public final hydra.ext.shex.syntax.LangTag value;
    
    public LangTag (hydra.ext.shex.syntax.LangTag value) {
  ...
  public static final class Sequence extends hydra.ext.shex.syntax.RdfLiteral_Alts_Option implements Serializable {
