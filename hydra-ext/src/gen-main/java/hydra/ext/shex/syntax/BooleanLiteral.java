...
public abstract class BooleanLiteral implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.BooleanLiteral");
  ...
  public static final class True extends hydra.ext.shex.syntax.BooleanLiteral implements Serializable {
    public True () {
  ...
  public static final class False extends hydra.ext.shex.syntax.BooleanLiteral implements Serializable {
    public False () {
