...
public abstract class Annotation_Alts implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.Annotation.Alts");
  ...
  public static final class Iri extends hydra.ext.shex.syntax.Annotation_Alts implements Serializable {
  ...
  public static final class Literal extends hydra.ext.shex.syntax.Annotation_Alts implements Serializable {
