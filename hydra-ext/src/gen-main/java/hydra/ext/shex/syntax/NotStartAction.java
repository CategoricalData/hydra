...
public abstract class NotStartAction implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.NotStartAction");
  ...
  public static final class Start extends hydra.ext.shex.syntax.NotStartAction implements Serializable {
  ...
  public static final class ShapeExprDecl extends hydra.ext.shex.syntax.NotStartAction implements Serializable {
