...
public abstract class NonLiteralKind implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.NonLiteralKind");
  ...
  public static final class IRI extends hydra.ext.shex.syntax.NonLiteralKind implements Serializable {
    public IRI () {
  ...
  public static final class BNODE extends hydra.ext.shex.syntax.NonLiteralKind implements Serializable {
    public BNODE () {
  ...
  public static final class NONLITERAL extends hydra.ext.shex.syntax.NonLiteralKind implements Serializable {
    public NONLITERAL () {
