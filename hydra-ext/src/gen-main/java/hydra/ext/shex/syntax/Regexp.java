...
public class Regexp implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.Regexp");
  ...
  public final java.util.List<hydra.ext.shex.syntax.Regexp_ListOfAlts_Elmt> listOfAlts;
  
  public final java.util.List<String> listOfRegex;
  
  public Regexp (java.util.List<hydra.ext.shex.syntax.Regexp_ListOfAlts_Elmt> listOfAlts, java.util.List<String> listOfRegex) {
  ...
  public Regexp withListOfAlts(java.util.List<hydra.ext.shex.syntax.Regexp_ListOfAlts_Elmt> listOfAlts) {
    java.util.Objects.requireNonNull((listOfAlts));
