...
public class NodeConstraint_Sequence4 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.NodeConstraint.Sequence4");
  ...
  public final hydra.ext.shex.syntax.ValueSet valueSet;
  
  public final java.util.List<hydra.ext.shex.syntax.XsFacet> listOfXsFacet;
  
  public NodeConstraint_Sequence4 (hydra.ext.shex.syntax.ValueSet valueSet, java.util.List<hydra.ext.shex.syntax.XsFacet> listOfXsFacet) {
  ...
  public NodeConstraint_Sequence4 withValueSet(hydra.ext.shex.syntax.ValueSet valueSet) {
    java.util.Objects.requireNonNull((valueSet));
    return new NodeConstraint_Sequence4(valueSet, listOfXsFacet);
  }
  
  public NodeConstraint_Sequence4 withListOfXsFacet(java.util.List<hydra.ext.shex.syntax.XsFacet> listOfXsFacet) {
    java.util.Objects.requireNonNull((listOfXsFacet));
    return new NodeConstraint_Sequence4(valueSet, listOfXsFacet);
  }
}