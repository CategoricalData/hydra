...
public abstract class PnChars implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.PnChars");
  ...
  public static final class PnCharsU extends hydra.ext.shex.syntax.PnChars implements Serializable {
  ...
  public static final class Minus extends hydra.ext.shex.syntax.PnChars implements Serializable {
    public Minus () {
  ...
  public static final class Regex extends hydra.ext.shex.syntax.PnChars implements Serializable {
