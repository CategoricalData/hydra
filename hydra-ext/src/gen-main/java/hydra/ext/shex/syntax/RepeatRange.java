...
public class RepeatRange implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.RepeatRange");
  ...
  public final hydra.util.Opt<hydra.util.Opt<hydra.util.Opt<hydra.ext.shex.syntax.RepeatRange_Sequence_Option_Option_Option>>> sequence;
  
  public RepeatRange (hydra.ext.shex.syntax.Integer_ integer, hydra.util.Opt<hydra.util.Opt<hydra.util.Opt<hydra.ext.shex.syntax.RepeatRange_Sequence_Option_Option_Option>>> sequence) {
  ...
  public RepeatRange withSequence(hydra.util.Opt<hydra.util.Opt<hydra.util.Opt<hydra.ext.shex.syntax.RepeatRange_Sequence_Option_Option_Option>>> sequence) {
    java.util.Objects.requireNonNull((sequence));
    return new RepeatRange(integer, sequence);
  }
}