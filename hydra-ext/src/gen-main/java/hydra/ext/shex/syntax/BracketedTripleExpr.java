...
public class BracketedTripleExpr implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.BracketedTripleExpr");
  ...
  public BracketedTripleExpr (hydra.ext.shex.syntax.InnerTripleExpr innerTripleExpr, hydra.util.Opt<hydra.ext.shex.syntax.Cardinality> cardinality, java.util.List<hydra.ext.shex.syntax.Annotation> listOfAnnotation, hydra.ext.shex.syntax.SemanticActions semanticActions) {
  ...
  public BracketedTripleExpr withCardinality(hydra.util.Opt<hydra.ext.shex.syntax.Cardinality> cardinality) {
    java.util.Objects.requireNonNull((cardinality));
    return new BracketedTripleExpr(innerTripleExpr, cardinality, listOfAnnotation, semanticActions);
  }
