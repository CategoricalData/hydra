...
public abstract class OneOfTripleExpr implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.OneOfTripleExpr");
  ...
  public static final class GroupTripleExpr extends hydra.ext.shex.syntax.OneOfTripleExpr implements Serializable {
    public final hydra.ext.shex.syntax.GroupTripleExpr value;
    
    public GroupTripleExpr (hydra.ext.shex.syntax.GroupTripleExpr value) {
  ...
  public static final class MultiElementOneOf extends hydra.ext.shex.syntax.OneOfTripleExpr implements Serializable {
