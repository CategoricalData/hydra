...
public abstract class String_ implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.String");
  ...
  public static final class StringLiteral1 extends hydra.ext.shex.syntax.String_ implements Serializable {
    public final hydra.ext.shex.syntax.StringLiteral1 value;
    
    public StringLiteral1 (hydra.ext.shex.syntax.StringLiteral1 value) {
  ...
  public static final class StringLiteralLong1 extends hydra.ext.shex.syntax.String_ implements Serializable {
    public final hydra.ext.shex.syntax.StringLiteralLong1 value;
    
    public StringLiteralLong1 (hydra.ext.shex.syntax.StringLiteralLong1 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class StringLiteral2 extends hydra.ext.shex.syntax.String_ implements Serializable {
    public final hydra.ext.shex.syntax.StringLiteral2 value;
    
    public StringLiteral2 (hydra.ext.shex.syntax.StringLiteral2 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class StringLiteralLong2 extends hydra.ext.shex.syntax.String_ implements Serializable {
    public final hydra.ext.shex.syntax.StringLiteralLong2 value;
    
    public StringLiteralLong2 (hydra.ext.shex.syntax.StringLiteralLong2 value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
