...
public abstract class PnPrefix_Sequence_Option_Alts implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.PnPrefix.Sequence.Option.Alts");
  ...
  public static final class PnChars extends hydra.ext.shex.syntax.PnPrefix_Sequence_Option_Alts implements Serializable {
  ...
  public static final class Period extends hydra.ext.shex.syntax.PnPrefix_Sequence_Option_Alts implements Serializable {
    public Period () {
