...
public abstract class StringLiteralLong1_Elmt implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.StringLiteralLong1.Elmt");
  ...
  public static final class Sequence extends hydra.ext.shex.syntax.StringLiteralLong1_Elmt implements Serializable {
    public final hydra.ext.shex.syntax.StringLiteralLong1_Elmt_Sequence value;
    
    public Sequence (hydra.ext.shex.syntax.StringLiteralLong1_Elmt_Sequence value) {
  ...
  public static final class Echar extends hydra.ext.shex.syntax.StringLiteralLong1_Elmt implements Serializable {
  ...
  public static final class Uchar extends hydra.ext.shex.syntax.StringLiteralLong1_Elmt implements Serializable {
