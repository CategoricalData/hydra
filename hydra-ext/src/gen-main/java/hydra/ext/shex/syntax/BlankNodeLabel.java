...
public class BlankNodeLabel implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.BlankNodeLabel");
  ...
  public final hydra.util.Opt<java.util.List<hydra.ext.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt>> listOfAlts;
  
  public final hydra.ext.shex.syntax.PnChars pnChars;
  
  public BlankNodeLabel (hydra.ext.shex.syntax.BlankNodeLabel_Alts alts, hydra.util.Opt<java.util.List<hydra.ext.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt>> listOfAlts, hydra.ext.shex.syntax.PnChars pnChars) {
  ...
  public BlankNodeLabel withListOfAlts(hydra.util.Opt<java.util.List<hydra.ext.shex.syntax.BlankNodeLabel_ListOfAlts_Option_Elmt>> listOfAlts) {
    java.util.Objects.requireNonNull((listOfAlts));
    return new BlankNodeLabel(alts, listOfAlts, pnChars);
  }
