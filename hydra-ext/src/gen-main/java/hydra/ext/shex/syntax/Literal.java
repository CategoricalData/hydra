...
public abstract class Literal implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.Literal");
  ...
  public static final class RdfLiteral extends hydra.ext.shex.syntax.Literal implements Serializable {
  ...
  public static final class NumericLiteral extends hydra.ext.shex.syntax.Literal implements Serializable {
  ...
  public static final class BooleanLiteral extends hydra.ext.shex.syntax.Literal implements Serializable {
