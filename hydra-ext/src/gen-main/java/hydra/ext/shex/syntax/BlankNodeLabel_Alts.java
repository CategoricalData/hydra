...
public abstract class BlankNodeLabel_Alts implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.BlankNodeLabel.Alts");
  ...
  public static final class PnCharsU extends hydra.ext.shex.syntax.BlankNodeLabel_Alts implements Serializable {
  ...
  public static final class Regex extends hydra.ext.shex.syntax.BlankNodeLabel_Alts implements Serializable {
