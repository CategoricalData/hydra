...
public abstract class Directive implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.Directive");
  ...
  public static final class BaseDecl extends hydra.ext.shex.syntax.Directive implements Serializable {
  ...
  public static final class PrefixDecl extends hydra.ext.shex.syntax.Directive implements Serializable {
