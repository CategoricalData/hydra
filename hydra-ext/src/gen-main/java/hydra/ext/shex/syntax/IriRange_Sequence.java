...
public class IriRange_Sequence implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.IriRange.Sequence");
  ...
  public final hydra.util.Opt<java.util.List<hydra.ext.shex.syntax.Exclusion>> sequence;
  
  public IriRange_Sequence (hydra.ext.shex.syntax.Iri iri, hydra.util.Opt<java.util.List<hydra.ext.shex.syntax.Exclusion>> sequence) {
  ...
  public IriRange_Sequence withSequence(hydra.util.Opt<java.util.List<hydra.ext.shex.syntax.Exclusion>> sequence) {
    java.util.Objects.requireNonNull((sequence));
    return new IriRange_Sequence(iri, sequence);
  }
}