...
public abstract class Code_Elmt implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/shex/syntax.Code.Elmt");
  ...
  public static final class Regex extends hydra.ext.shex.syntax.Code_Elmt implements Serializable {
  ...
  public static final class Sequence extends hydra.ext.shex.syntax.Code_Elmt implements Serializable {
    public final String value;
  ...
  public static final class Uchar extends hydra.ext.shex.syntax.Code_Elmt implements Serializable {
