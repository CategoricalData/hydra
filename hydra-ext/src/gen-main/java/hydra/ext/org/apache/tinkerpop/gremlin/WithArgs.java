...
public class WithArgs implements Serializable {
  ...
  public final hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.WithArgsValues> values;
  
  public WithArgs (hydra.ext.org.apache.tinkerpop.gremlin.WithArgsKeys keys, hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.WithArgsValues> values) {
  ...
  public WithArgs withValues(hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.WithArgsValues> values) {
    java.util.Objects.requireNonNull((values));
    return new WithArgs(keys, values);
  }
}