...
public class DataPageHeaderV2 implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/parquet/format.DataPageHeaderV2");
  ...
  public DataPageHeaderV2 (Integer numValues, Integer numNulls, Integer numRows, hydra.ext.org.apache.parquet.format.Encoding encoding, Integer definitionLevelsByteLength, Integer repetitionLevelsByteLength, hydra.util.Opt<Boolean> isCompressed, hydra.util.Opt<hydra.ext.org.apache.parquet.format.Statistics> statistics) {
  ...
  public DataPageHeaderV2 withEncoding(hydra.ext.org.apache.parquet.format.Encoding encoding) {
    java.util.Objects.requireNonNull((encoding));
    return new DataPageHeaderV2(numValues, numNulls, numRows, encoding, definitionLevelsByteLength, repetitionLevelsByteLength, isCompressed, statistics);
  }
  ...
  public DataPageHeaderV2 withStatistics(hydra.util.Opt<hydra.ext.org.apache.parquet.format.Statistics> statistics) {
    java.util.Objects.requireNonNull((statistics));
    return new DataPageHeaderV2(numValues, numNulls, numRows, encoding, definitionLevelsByteLength, repetitionLevelsByteLength, isCompressed, statistics);
  }
}