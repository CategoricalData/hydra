...
public class FileCryptoMetaData implements Serializable {
   ...
   */
  public final hydra.ext.org.apache.parquet.format.EncryptionAlgorithm encryptionAlgorithm;
  ...
  public FileCryptoMetaData (hydra.ext.org.apache.parquet.format.EncryptionAlgorithm encryptionAlgorithm, hydra.util.Opt<String> keyMetadata) {
  ...
  public FileCryptoMetaData withEncryptionAlgorithm(hydra.ext.org.apache.parquet.format.EncryptionAlgorithm encryptionAlgorithm) {
    java.util.Objects.requireNonNull((encryptionAlgorithm));
