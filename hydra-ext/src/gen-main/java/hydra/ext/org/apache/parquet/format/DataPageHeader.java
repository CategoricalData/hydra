...
public class DataPageHeader implements Serializable {
   ...
   */
  public final hydra.ext.org.apache.parquet.format.Encoding definitionLevelEncoding;
  
  /**
   * Encoding used for repetition levels
   */
  public final hydra.ext.org.apache.parquet.format.Encoding repetitionLevelEncoding;
  ...
  public DataPageHeader (Integer numValues, hydra.ext.org.apache.parquet.format.Encoding encoding, hydra.ext.org.apache.parquet.format.Encoding definitionLevelEncoding, hydra.ext.org.apache.parquet.format.Encoding repetitionLevelEncoding, hydra.util.Opt<hydra.ext.org.apache.parquet.format.Statistics> statistics) {
  ...
  public DataPageHeader withEncoding(hydra.ext.org.apache.parquet.format.Encoding encoding) {
    java.util.Objects.requireNonNull((encoding));
    return new DataPageHeader(numValues, encoding, definitionLevelEncoding, repetitionLevelEncoding, statistics);
  }
  
  public DataPageHeader withDefinitionLevelEncoding(hydra.ext.org.apache.parquet.format.Encoding definitionLevelEncoding) {
    java.util.Objects.requireNonNull((definitionLevelEncoding));
    return new DataPageHeader(numValues, encoding, definitionLevelEncoding, repetitionLevelEncoding, statistics);
  }
  
  public DataPageHeader withRepetitionLevelEncoding(hydra.ext.org.apache.parquet.format.Encoding repetitionLevelEncoding) {
    java.util.Objects.requireNonNull((repetitionLevelEncoding));
    return new DataPageHeader(numValues, encoding, definitionLevelEncoding, repetitionLevelEncoding, statistics);
  }
  
  public DataPageHeader withStatistics(hydra.util.Opt<hydra.ext.org.apache.parquet.format.Statistics> statistics) {
    java.util.Objects.requireNonNull((statistics));
    return new DataPageHeader(numValues, encoding, definitionLevelEncoding, repetitionLevelEncoding, statistics);
  }
}