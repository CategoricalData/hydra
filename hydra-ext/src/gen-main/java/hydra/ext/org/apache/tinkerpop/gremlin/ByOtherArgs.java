...
public abstract class ByOtherArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.apache.tinkerpop.gremlin.ByOtherArgs");
  ...
  public static final class Comparator extends hydra.ext.org.apache.tinkerpop.gremlin.ByOtherArgs implements Serializable {
    public final hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalComparatorArgument> value;
    
    public Comparator (hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalComparatorArgument> value) {
  ...
  public static final class Other extends hydra.ext.org.apache.tinkerpop.gremlin.ByOtherArgs implements Serializable {
    public final hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunctionArgumentOrStringArgumentOrNestedTraversal> value;
    
    public Other (hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalFunctionArgumentOrStringArgumentOrNestedTraversal> value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
