...
public class TimestampType implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/parquet/format.TimestampType");
  ...
  public final hydra.ext.org.apache.parquet.format.TimeUnit unit;
  
  public TimestampType (Boolean isAdjustedToUtc, hydra.ext.org.apache.parquet.format.TimeUnit unit) {
  ...
  public TimestampType withUnit(hydra.ext.org.apache.parquet.format.TimeUnit unit) {
    java.util.Objects.requireNonNull((unit));
    return new TimestampType(isAdjustedToUtc, unit);
  }
}