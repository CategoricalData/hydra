...
public abstract class ColumnCryptoMetaData implements Serializable {
  ...
  public static final class EncryptionWithFooterKey extends hydra.ext.org.apache.parquet.format.ColumnCryptoMetaData implements Serializable {
    public final hydra.ext.org.apache.parquet.format.EncryptionWithFooterKey value;
    
    public EncryptionWithFooterKey (hydra.ext.org.apache.parquet.format.EncryptionWithFooterKey value) {
  ...
  public static final class EncryptionWithColumnKey extends hydra.ext.org.apache.parquet.format.ColumnCryptoMetaData implements Serializable {
    public final hydra.ext.org.apache.parquet.format.EncryptionWithColumnKey value;
    
    public EncryptionWithColumnKey (hydra.ext.org.apache.parquet.format.EncryptionWithColumnKey value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
