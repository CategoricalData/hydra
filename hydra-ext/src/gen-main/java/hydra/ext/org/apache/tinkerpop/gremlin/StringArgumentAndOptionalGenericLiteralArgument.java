...
public class StringArgumentAndOptionalGenericLiteralArgument implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentAndOptionalGenericLiteralArgument");
  ...
  public final hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgument> literal;
  
  public StringArgumentAndOptionalGenericLiteralArgument (hydra.ext.org.apache.tinkerpop.gremlin.StringArgument string, hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgument> literal) {
  ...
  public StringArgumentAndOptionalGenericLiteralArgument withLiteral(hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.GenericLiteralArgument> literal) {
    java.util.Objects.requireNonNull((literal));
    return new StringArgumentAndOptionalGenericLiteralArgument(string, literal);
  }
}