...
public abstract class StringArgumentOrNestedTraversal implements Serializable, Comparable<StringArgumentOrNestedTraversal> {
  public static final hydra.core.Name TYPE_ = new hydra.core.Name("hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentOrNestedTraversal");
  ...
  public static final class String_ extends hydra.ext.org.apache.tinkerpop.gremlin.StringArgumentOrNestedTraversal implements Serializable {
    ...
    public int compareTo(StringArgumentOrNestedTraversal other) {
