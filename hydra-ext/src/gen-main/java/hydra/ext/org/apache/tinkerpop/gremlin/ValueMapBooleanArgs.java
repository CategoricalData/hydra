...
public class ValueMapBooleanArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/gremlin.ValueMapBooleanArgs");
  ...
  public final hydra.util.Opt<java.util.List<hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument>> keys;
  
  public ValueMapBooleanArgs (hydra.ext.org.apache.tinkerpop.gremlin.BooleanArgument value, hydra.util.Opt<java.util.List<hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument>> keys) {
  ...
  public ValueMapBooleanArgs withKeys(hydra.util.Opt<java.util.List<hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument>> keys) {
    java.util.Objects.requireNonNull((keys));
    return new ValueMapBooleanArgs(value, keys);
  }
}