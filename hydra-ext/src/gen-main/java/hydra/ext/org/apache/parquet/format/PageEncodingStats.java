...
public class PageEncodingStats implements Serializable {
   ...
   */
  public final hydra.ext.org.apache.parquet.format.PageType pageType;
  ...
  public PageEncodingStats (hydra.ext.org.apache.parquet.format.PageType pageType, hydra.ext.org.apache.parquet.format.Encoding encoding, Integer count) {
  ...
  public PageEncodingStats withPageType(hydra.ext.org.apache.parquet.format.PageType pageType) {
    java.util.Objects.requireNonNull((pageType));
    return new PageEncodingStats(pageType, encoding, count);
  }
  
  public PageEncodingStats withEncoding(hydra.ext.org.apache.parquet.format.Encoding encoding) {
    java.util.Objects.requireNonNull((encoding));
    return new PageEncodingStats(pageType, encoding, count);
  }
