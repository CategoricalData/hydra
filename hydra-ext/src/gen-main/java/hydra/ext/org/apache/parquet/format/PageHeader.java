...
public class PageHeader implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/parquet/format.PageHeader");
   ...
   */
  public final hydra.ext.org.apache.parquet.format.PageType type;
  ...
  public final hydra.util.Opt<hydra.ext.org.apache.parquet.format.DataPageHeader> dataPageHeader;
  
  public final hydra.util.Opt<hydra.ext.org.apache.parquet.format.IndexPageHeader> indexPageHeader;
  
  public final hydra.util.Opt<hydra.ext.org.apache.parquet.format.DictionaryPageHeader> dictionaryPageHeader;
  
  public final hydra.util.Opt<hydra.ext.org.apache.parquet.format.DataPageHeaderV2> dataPageHeaderV2;
  
  public PageHeader (hydra.ext.org.apache.parquet.format.PageType type, Integer uncompressedPageSize, Integer compressedPageSize, hydra.util.Opt<Integer> crc, hydra.util.Opt<hydra.ext.org.apache.parquet.format.DataPageHeader> dataPageHeader, hydra.util.Opt<hydra.ext.org.apache.parquet.format.IndexPageHeader> indexPageHeader, hydra.util.Opt<hydra.ext.org.apache.parquet.format.DictionaryPageHeader> dictionaryPageHeader, hydra.util.Opt<hydra.ext.org.apache.parquet.format.DataPageHeaderV2> dataPageHeaderV2) {
  ...
  public PageHeader withType(hydra.ext.org.apache.parquet.format.PageType type) {
    java.util.Objects.requireNonNull((type));
  ...
  public PageHeader withDataPageHeader(hydra.util.Opt<hydra.ext.org.apache.parquet.format.DataPageHeader> dataPageHeader) {
    java.util.Objects.requireNonNull((dataPageHeader));
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
  
  public PageHeader withIndexPageHeader(hydra.util.Opt<hydra.ext.org.apache.parquet.format.IndexPageHeader> indexPageHeader) {
    java.util.Objects.requireNonNull((indexPageHeader));
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
  
  public PageHeader withDictionaryPageHeader(hydra.util.Opt<hydra.ext.org.apache.parquet.format.DictionaryPageHeader> dictionaryPageHeader) {
    java.util.Objects.requireNonNull((dictionaryPageHeader));
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
  
  public PageHeader withDataPageHeaderV2(hydra.util.Opt<hydra.ext.org.apache.parquet.format.DataPageHeaderV2> dataPageHeaderV2) {
    java.util.Objects.requireNonNull((dataPageHeaderV2));
    return new PageHeader(type, uncompressedPageSize, compressedPageSize, crc, dataPageHeader, indexPageHeader, dictionaryPageHeader, dataPageHeaderV2);
  }
}