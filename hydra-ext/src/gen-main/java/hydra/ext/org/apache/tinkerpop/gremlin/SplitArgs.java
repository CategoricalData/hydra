...
public class SplitArgs implements Serializable {
  ...
  public SplitArgs (hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.ext.org.apache.tinkerpop.gremlin.StringNullableArgument delimiter) {
  ...
  public SplitArgs withScope(hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    java.util.Objects.requireNonNull((scope));
