...
public class ColumnIndex implements Serializable {
   ...
   */
  public final hydra.ext.org.apache.parquet.format.BoundaryOrder boundaryOrder;
  ...
  public ColumnIndex (java.util.List<Boolean> nullPages, java.util.List<String> minValues, java.util.List<String> maxValues, hydra.ext.org.apache.parquet.format.BoundaryOrder boundaryOrder, hydra.util.Opt<java.util.List<Long>> nullCounts) {
  ...
  public ColumnIndex withBoundaryOrder(hydra.ext.org.apache.parquet.format.BoundaryOrder boundaryOrder) {
    java.util.Objects.requireNonNull((boundaryOrder));
    return new ColumnIndex(nullPages, minValues, maxValues, boundaryOrder, nullCounts);
  }
