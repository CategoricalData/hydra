...
public class OptionalStringArgumentAndNestedTraversal implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/tinkerpop/gremlin.OptionalStringArgumentAndNestedTraversal");
  
  public static final hydra.core.Name FIELD_NAME_STRING = new hydra.core.Name("string");
  
  public static final hydra.core.Name FIELD_NAME_TRAVERSAL = new hydra.core.Name("traversal");
  
  public final hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.StringArgument> string;
  
  public final hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversal traversal;
  
  public OptionalStringArgumentAndNestedTraversal (hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.StringArgument> string, hydra.ext.org.apache.tinkerpop.gremlin.NestedTraversal traversal) {
  ...
  public OptionalStringArgumentAndNestedTraversal withString(hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.StringArgument> string) {
    java.util.Objects.requireNonNull((string));
