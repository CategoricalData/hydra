...
public class SubstringArgs implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.apache.tinkerpop.gremlin.SubstringArgs");
  ...
  public final hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.IntegerArgument> end;
  
  public SubstringArgs (hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument> scope, hydra.ext.org.apache.tinkerpop.gremlin.IntegerArgument start, hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.IntegerArgument> end) {
  ...
  public SubstringArgs withScope(hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.TraversalScopeArgument> scope) {
    java.util.Objects.requireNonNull((scope));
  ...
  public SubstringArgs withEnd(hydra.util.Opt<hydra.ext.org.apache.tinkerpop.gremlin.IntegerArgument> end) {
    java.util.Objects.requireNonNull((end));
    return new SubstringArgs(scope, start, end);
  }
}