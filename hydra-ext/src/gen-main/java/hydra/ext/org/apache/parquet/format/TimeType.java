...
public class TimeType implements Serializable {
  ...
  public TimeType (Boolean isAdjustedToUtc, hydra.ext.org.apache.parquet.format.TimeUnit unit) {
  ...
  public TimeType withUnit(hydra.ext.org.apache.parquet.format.TimeUnit unit) {
    java.util.Objects.requireNonNull((unit));
    return new TimeType(isAdjustedToUtc, unit);
  }
}