...
public class OffsetIndex implements Serializable {
   ...
   */
  public final java.util.List<hydra.ext.org.apache.parquet.format.PageLocation> pageLocations;
  
  public OffsetIndex (java.util.List<hydra.ext.org.apache.parquet.format.PageLocation> pageLocations) {
