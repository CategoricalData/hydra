...
public abstract class CompressionCodec implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/parquet/format.CompressionCodec");
  ...
  public static final class Uncompressed extends hydra.ext.org.apache.parquet.format.CompressionCodec implements Serializable {
    public Uncompressed () {
  ...
  public static final class Snappy extends hydra.ext.org.apache.parquet.format.CompressionCodec implements Serializable {
    public Snappy () {
  ...
  public static final class Gzip extends hydra.ext.org.apache.parquet.format.CompressionCodec implements Serializable {
    public Gzip () {
  ...
  public static final class Lzo extends hydra.ext.org.apache.parquet.format.CompressionCodec implements Serializable {
    public Lzo () {
   ...
   * Added in 2.4
   */
  public static final class Brotli extends hydra.ext.org.apache.parquet.format.CompressionCodec implements Serializable {
    public Brotli () {
   ...
   * Added in 2.4
   */
  public static final class Zstd extends hydra.ext.org.apache.parquet.format.CompressionCodec implements Serializable {
    public Zstd () {
   ...
   * Added in 2.9
   */
  public static final class Lz4Raw extends hydra.ext.org.apache.parquet.format.CompressionCodec implements Serializable {
    public Lz4Raw () {
