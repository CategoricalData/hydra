...
public abstract class ConnectedComponentConstants implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.apache.tinkerpop.gremlin.ConnectedComponentConstants");
  ...
  public static final class Component extends hydra.ext.org.apache.tinkerpop.gremlin.ConnectedComponentConstants implements Serializable {
    public Component () {
  ...
  public static final class Edges extends hydra.ext.org.apache.tinkerpop.gremlin.ConnectedComponentConstants implements Serializable {
    public Edges () {
  ...
  public static final class PropertyName extends hydra.ext.org.apache.tinkerpop.gremlin.ConnectedComponentConstants implements Serializable {
    public PropertyName () {
