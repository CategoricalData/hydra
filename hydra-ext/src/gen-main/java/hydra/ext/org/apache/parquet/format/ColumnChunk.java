...
public class ColumnChunk implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/org/apache/parquet/format.ColumnChunk");
   ...
   */
  public final hydra.util.Opt<hydra.ext.org.apache.parquet.format.ColumnMetaData> metaData;
   ...
   */
  public final hydra.util.Opt<hydra.ext.org.apache.parquet.format.ColumnCryptoMetaData> cryptoMetadata;
  ...
  public ColumnChunk (hydra.util.Opt<String> filePath, Long fileOffset, hydra.util.Opt<hydra.ext.org.apache.parquet.format.ColumnMetaData> metaData, hydra.util.Opt<Long> offsetIndexOffset, hydra.util.Opt<Integer> offsetIndexLength, hydra.util.Opt<Long> columnIndexOffset, hydra.util.Opt<Integer> columnIndexLength, hydra.util.Opt<hydra.ext.org.apache.parquet.format.ColumnCryptoMetaData> cryptoMetadata, hydra.util.Opt<String> encryptedColumnMetadata) {
  ...
  public ColumnChunk withMetaData(hydra.util.Opt<hydra.ext.org.apache.parquet.format.ColumnMetaData> metaData) {
    java.util.Objects.requireNonNull((metaData));
    return new ColumnChunk(filePath, fileOffset, metaData, offsetIndexOffset, offsetIndexLength, columnIndexOffset, columnIndexLength, cryptoMetadata, encryptedColumnMetadata);
  }
  ...
  public ColumnChunk withCryptoMetadata(hydra.util.Opt<hydra.ext.org.apache.parquet.format.ColumnCryptoMetaData> cryptoMetadata) {
    java.util.Objects.requireNonNull((cryptoMetadata));
    return new ColumnChunk(filePath, fileOffset, metaData, offsetIndexOffset, offsetIndexLength, columnIndexOffset, columnIndexLength, cryptoMetadata, encryptedColumnMetadata);
  }
