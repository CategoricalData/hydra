...
public class BooleanFactor implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.ansi.sql.syntax.BooleanFactor");
  ...
  public final hydra.ext.org.ansi.sql.syntax.BooleanTest booleanTest;
  
  public BooleanFactor (hydra.util.Opt<java.lang.Void> nOT, hydra.ext.org.ansi.sql.syntax.BooleanTest booleanTest) {
  ...
  public BooleanFactor withBooleanTest(hydra.ext.org.ansi.sql.syntax.BooleanTest booleanTest) {
    java.util.Objects.requireNonNull((booleanTest));
    return new BooleanFactor(nOT, booleanTest);
  }
}