...
public class BooleanTest_Sequence_Option implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra.ext.org.ansi.sql.syntax.BooleanTest_Sequence_Option");
  ...
  public final hydra.ext.org.ansi.sql.syntax.TruthValue truthValue;
  
  public BooleanTest_Sequence_Option (hydra.util.Opt<java.lang.Void> nOT, hydra.ext.org.ansi.sql.syntax.TruthValue truthValue) {
  ...
  public BooleanTest_Sequence_Option withTruthValue(hydra.ext.org.ansi.sql.syntax.TruthValue truthValue) {
    java.util.Objects.requireNonNull((truthValue));
    return new BooleanTest_Sequence_Option(nOT, truthValue);
  }
}