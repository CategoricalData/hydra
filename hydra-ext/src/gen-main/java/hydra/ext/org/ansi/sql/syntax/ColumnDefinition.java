...
public class ColumnDefinition implements Serializable {
  ...
  public final hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ColumnDefinition_TypeOrDomain_Option> typeOrDomain;
  
  public final hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ReferenceScopeCheck> refScope;
  
  public final hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ColumnDefinition_DefaultOrIdentityOrGeneration_Option> defaultOrIdentityOrGeneration;
  
  public final java.util.List<hydra.ext.org.ansi.sql.syntax.ColumnConstraintDefinition> constraints;
  
  public final hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.CollateClause> collate;
  
  public ColumnDefinition (hydra.ext.org.ansi.sql.syntax.ColumnName name, hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ColumnDefinition_TypeOrDomain_Option> typeOrDomain, hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ReferenceScopeCheck> refScope, hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ColumnDefinition_DefaultOrIdentityOrGeneration_Option> defaultOrIdentityOrGeneration, java.util.List<hydra.ext.org.ansi.sql.syntax.ColumnConstraintDefinition> constraints, hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.CollateClause> collate) {
  ...
  public ColumnDefinition withTypeOrDomain(hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ColumnDefinition_TypeOrDomain_Option> typeOrDomain) {
    java.util.Objects.requireNonNull((typeOrDomain));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
  
  public ColumnDefinition withRefScope(hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ReferenceScopeCheck> refScope) {
    java.util.Objects.requireNonNull((refScope));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
  
  public ColumnDefinition withDefaultOrIdentityOrGeneration(hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.ColumnDefinition_DefaultOrIdentityOrGeneration_Option> defaultOrIdentityOrGeneration) {
    java.util.Objects.requireNonNull((defaultOrIdentityOrGeneration));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
  
  public ColumnDefinition withConstraints(java.util.List<hydra.ext.org.ansi.sql.syntax.ColumnConstraintDefinition> constraints) {
    java.util.Objects.requireNonNull((constraints));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
  
  public ColumnDefinition withCollate(hydra.util.Opt<hydra.ext.org.ansi.sql.syntax.CollateClause> collate) {
    java.util.Objects.requireNonNull((collate));
    return new ColumnDefinition(name, typeOrDomain, refScope, defaultOrIdentityOrGeneration, constraints, collate);
  }
}