...
public abstract class ContextuallyTypedRowValueExpression implements Serializable {
  ...
  public static final class SpecialCase extends hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueExpression implements Serializable {
    public final hydra.ext.org.ansi.sql.syntax.RowValueSpecialCase value;
    
    public SpecialCase (hydra.ext.org.ansi.sql.syntax.RowValueSpecialCase value) {
  ...
  public static final class Constructor extends hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueExpression implements Serializable {
    public final hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueConstructor value;
    
    public Constructor (hydra.ext.org.ansi.sql.syntax.ContextuallyTypedRowValueConstructor value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
