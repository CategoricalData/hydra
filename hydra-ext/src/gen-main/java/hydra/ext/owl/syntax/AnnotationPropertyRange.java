...
public class AnnotationPropertyRange implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.AnnotationPropertyRange");
  ...
  public AnnotationPropertyRange (java.util.List<hydra.ext.owl.syntax.Annotation> annotations, hydra.ext.owl.syntax.AnnotationProperty property, hydra.ext.rdf.syntax.Iri iri) {
  ...
  public AnnotationPropertyRange withAnnotations(java.util.List<hydra.ext.owl.syntax.Annotation> annotations) {
    java.util.Objects.requireNonNull((annotations));
    return new AnnotationPropertyRange(annotations, property, iri);
  }
  
  public AnnotationPropertyRange withProperty(hydra.ext.owl.syntax.AnnotationProperty property) {
    java.util.Objects.requireNonNull((property));
    return new AnnotationPropertyRange(annotations, property, iri);
  }
