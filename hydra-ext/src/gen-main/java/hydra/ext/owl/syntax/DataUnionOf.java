...
public class DataUnionOf implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.DataUnionOf");
  
  public static final hydra.core.Name FIELD_NAME_VALUE = new hydra.core.Name("value");
  
  public final java.util.List<hydra.ext.owl.syntax.DataRange> value;
  
  public DataUnionOf (java.util.List<hydra.ext.owl.syntax.DataRange> value) {
