...
public class SameIndividual implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.SameIndividual");
  ...
  public SameIndividual (java.util.List<hydra.ext.owl.syntax.Annotation> annotations, java.util.List<hydra.ext.owl.syntax.Individual> individuals) {
  ...
  public SameIndividual withAnnotations(java.util.List<hydra.ext.owl.syntax.Annotation> annotations) {
    java.util.Objects.requireNonNull((annotations));
    return new SameIndividual(annotations, individuals);
  }
  
  public SameIndividual withIndividuals(java.util.List<hydra.ext.owl.syntax.Individual> individuals) {
    java.util.Objects.requireNonNull((individuals));
    return new SameIndividual(annotations, individuals);
  }
}