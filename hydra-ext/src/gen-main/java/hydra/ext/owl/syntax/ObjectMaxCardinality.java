...
public class ObjectMaxCardinality implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.ObjectMaxCardinality");
  ...
  public ObjectMaxCardinality (java.math.BigInteger bound, hydra.ext.owl.syntax.ObjectPropertyExpression property, java.util.List<hydra.ext.owl.syntax.ClassExpression> class_) {
  ...
  public ObjectMaxCardinality withProperty(hydra.ext.owl.syntax.ObjectPropertyExpression property) {
    java.util.Objects.requireNonNull((property));
    return new ObjectMaxCardinality(bound, property, class_);
  }
  
  public ObjectMaxCardinality withClass(java.util.List<hydra.ext.owl.syntax.ClassExpression> class_) {
    java.util.Objects.requireNonNull((class_));
    return new ObjectMaxCardinality(bound, property, class_);
  }
}
