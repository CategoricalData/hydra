...
public abstract class AnnotationSubject implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.AnnotationSubject");
  ...
  public static final class Iri extends hydra.ext.owl.syntax.AnnotationSubject implements Serializable {
  ...
  public static final class AnonymousIndividual extends hydra.ext.owl.syntax.AnnotationSubject implements Serializable {
