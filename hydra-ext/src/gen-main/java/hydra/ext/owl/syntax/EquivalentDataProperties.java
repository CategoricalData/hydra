...
public class EquivalentDataProperties implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.EquivalentDataProperties");
  ...
  public EquivalentDataProperties (java.util.List<hydra.ext.owl.syntax.Annotation> annotations, java.util.List<hydra.ext.owl.syntax.DataPropertyExpression> properties) {
  ...
  public EquivalentDataProperties withAnnotations(java.util.List<hydra.ext.owl.syntax.Annotation> annotations) {
    java.util.Objects.requireNonNull((annotations));
    return new EquivalentDataProperties(annotations, properties);
  }
  
  public EquivalentDataProperties withProperties(java.util.List<hydra.ext.owl.syntax.DataPropertyExpression> properties) {
    java.util.Objects.requireNonNull((properties));
    return new EquivalentDataProperties(annotations, properties);
  }
}