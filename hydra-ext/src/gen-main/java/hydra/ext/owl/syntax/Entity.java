...
public abstract class Entity implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.Entity");
  ...
  public static final class AnnotationProperty extends hydra.ext.owl.syntax.Entity implements Serializable {
    public final hydra.ext.owl.syntax.AnnotationProperty value;
    
    public AnnotationProperty (hydra.ext.owl.syntax.AnnotationProperty value) {
  ...
  public static final class Class_ extends hydra.ext.owl.syntax.Entity implements Serializable {
  ...
  public static final class DataProperty extends hydra.ext.owl.syntax.Entity implements Serializable {
    public final hydra.ext.owl.syntax.DataProperty value;
    
    public DataProperty (hydra.ext.owl.syntax.DataProperty value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class Datatype extends hydra.ext.owl.syntax.Entity implements Serializable {
  ...
  public static final class NamedIndividual extends hydra.ext.owl.syntax.Entity implements Serializable {
    public final hydra.ext.owl.syntax.NamedIndividual value;
    
    public NamedIndividual (hydra.ext.owl.syntax.NamedIndividual value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
  ...
  public static final class ObjectProperty extends hydra.ext.owl.syntax.Entity implements Serializable {
    public final hydra.ext.owl.syntax.ObjectProperty value;
    
    public ObjectProperty (hydra.ext.owl.syntax.ObjectProperty value) {
      java.util.Objects.requireNonNull((value));
      this.value = value;
    }
