...
public class DataMinCardinality implements Serializable {
  public static final hydra.core.Name TYPE_NAME = new hydra.core.Name("hydra/ext/owl/syntax.DataMinCardinality");
  ...
  public DataMinCardinality (java.math.BigInteger bound, hydra.ext.owl.syntax.DataPropertyExpression property, java.util.List<hydra.ext.owl.syntax.DataRange> range) {
  ...
  public DataMinCardinality withProperty(hydra.ext.owl.syntax.DataPropertyExpression property) {
    java.util.Objects.requireNonNull((property));
    return new DataMinCardinality(bound, property, range);
  }
  
  public DataMinCardinality withRange(java.util.List<hydra.ext.owl.syntax.DataRange> range) {
    java.util.Objects.requireNonNull((range));
    return new DataMinCardinality(bound, property, range);
  }
}