        ...
        public hydra.util.Either<hydra.errors.DecodingError, hydra.pg.mapping.EdgeSpec> visit(hydra.core.Term.Record record) {
          ...
          return hydra.lib.eithers.Bind.apply(
            ...
            (java.util.function.Function<hydra.pg.model.EdgeLabel, hydra.util.Either<hydra.errors.DecodingError, hydra.pg.mapping.EdgeSpec>>) (field_label -> hydra.lib.eithers.Bind.apply(
              hydra.extract.helpers.Helpers.requireField(
                "id",
                (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.pg.mapping.ValueSpec>>>) (p0 -> p1 -> hydra.decode.pg.mapping.Mapping.valueSpec(
                  p0,
                  p1)),
                fieldMap,
                cx),
              (java.util.function.Function<hydra.pg.mapping.ValueSpec, hydra.util.Either<hydra.errors.DecodingError, hydra.pg.mapping.EdgeSpec>>) (field_id -> hydra.lib.eithers.Bind.apply(
                ...
                (java.util.function.Function<hydra.pg.mapping.ValueSpec, hydra.util.Either<hydra.errors.DecodingError, hydra.pg.mapping.EdgeSpec>>) (field_out -> hydra.lib.eithers.Bind.apply(
                  ...
                  (java.util.function.Function<hydra.pg.mapping.ValueSpec, hydra.util.Either<hydra.errors.DecodingError, hydra.pg.mapping.EdgeSpec>>) (field_in -> hydra.lib.eithers.Bind.apply(
                    hydra.extract.helpers.Helpers.requireField(
                      "properties",
                      (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.pg.mapping.PropertySpec>>>>) (v1 -> (java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.util.ConsList<hydra.pg.mapping.PropertySpec>>>) (v2 -> hydra.extract.helpers.Helpers.decodeList(
                        (java.util.function.Function<hydra.graph.Graph, java.util.function.Function<hydra.core.Term, hydra.util.Either<hydra.errors.DecodingError, hydra.pg.mapping.PropertySpec>>>) (p0 -> p1 -> hydra.decode.pg.mapping.Mapping.propertySpec(
                          p0,
                          p1)),
                        v1,
                        v2))),
