-- | Generate Java kernel type source modules.
--
...
--   hydra/sources/core/Core.java with a Module object as data
--
...
main = do
  ...
  putStrLn "=== Generate Java kernel type sources ==="
  putStrLn ""
  ...
  writeJava "../hydra-java/src/gen-main/java" (kernelTypesModules ++ sourcesModules) sourcesModules
