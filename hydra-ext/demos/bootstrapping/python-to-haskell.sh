...
echo "=========================================="
echo "Python to Haskell bootstrapping demo"
echo "=========================================="
echo ""
...
echo "Step 3: Mapping JSON to Haskell (via Python host)..."
STEP_START=$(date +%s)
"$SCRIPT_DIR/python-bootstrap.sh" --target haskell --output "$OUTPUT_BASE" --include-tests $EXTRA_FLAGS 2>&1
STEP_END=$(date +%s)
