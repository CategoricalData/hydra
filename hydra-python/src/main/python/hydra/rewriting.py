    ...
    def fsub(recurse: Callable[[hydra.core.Term], hydra.core.Term], term: hydra.core.Term) -> hydra.core.Term:
        ...
        def for_elimination(elm: hydra.core.Elimination) -> hydra.core.Elimination:
            match elm:
                ...
                case hydra.core.EliminationUnion(value=cs):
                    return cast(hydra.core.Elimination, hydra.core.EliminationUnion(hydra.core.CaseStatement(cs.type_name, hydra.lib.optionals.map(recurse, cs.default), hydra.lib.lists.map(for_field, cs.cases))))
        ...
        match term:
            ...
            case hydra.core.TermOptional(value=m2):
                return cast(hydra.core.Term, hydra.core.TermOptional(hydra.lib.optionals.map(recurse, m2)))
    ...
    def replace(recurse: Callable[[hydra.core.Term], hydra.core.Term], term2: hydra.core.Term) -> hydra.core.Term:
        match term2:
            case hydra.core.TermVariable(value=n):
                return cast(hydra.core.Term, hydra.core.TermVariable(hydra.lib.optionals.from_maybe(n, hydra.lib.maps.lookup(n, subst))))
            
            case hydra.core.TermFunction(value=v1):
                match v1:
                    case hydra.core.FunctionLambda(value=l):
                        return hydra.lib.optionals.maybe(recurse(term2), (lambda _: term2), hydra.lib.maps.lookup(l.parameter, subst))
...
def flatten_let_terms(term: hydra.core.Term) -> hydra.core.Term:
    ...
    def rewrite_binding(binding: hydra.core.Binding) -> Tuple[hydra.core.Binding, frozenlist[hydra.core.Binding]]:
        ...
        match val0:
            ...
            case hydra.core.TermLet(value=inner_let):
                ...
                subst = hydra.lib.maps.from_list(hydra.lib.lists.map(to_subst_pair, bindings1))
    ...
    def flatten[T0](recurse: Callable[[T0], hydra.core.Term], term2: T0) -> hydra.core.Term:
        ...
        match rewritten:
            ...
            case _:
                return rewritten
    return rewrite_term(flatten, term)
...
def subterms(v1: hydra.core.Term) -> frozenlist[hydra.core.Term]:
    ...
    match v1:
        ...
        case hydra.core.TermFunction(value=v12):
            match v12:
                case hydra.core.FunctionElimination(value=v13):
                    match v13:
                        case hydra.core.EliminationUnion(value=cs):
                            return hydra.lib.lists.concat2(hydra.lib.optionals.maybe((), (lambda t: (t,)), cs.default), hydra.lib.lists.map((lambda v14: v14.term), cs.cases))
        ...
        case hydra.core.TermOptional(value=m2):
            return hydra.lib.optionals.maybe((), (lambda t: (t,)), m2)
...
def free_variables_in_type(typ: hydra.core.Type) -> frozenset[hydra.core.Name]:
    ...
    dflt_vars = hydra.lib.lists.foldl((lambda s, t: hydra.lib.sets.union(s, free_variables_in_type(t))), hydra.lib.sets.empty(), subtypes(typ))
    match typ:
        case hydra.core.TypeForall(value=lt):
...
def free_type_variables_in_term(term0: hydra.core.Term) -> frozenset[hydra.core.Name]:
    ...
    def all_of[T0](sets: frozenlist[frozenset[T0]]) -> frozenset[T0]:
        return hydra.lib.lists.foldl(hydra.lib.sets.union, hydra.lib.sets.empty(), sets)
        ...
        match term:
            case hydra.core.TermFunction(value=f):
                match f:
                    case hydra.core.FunctionElimination(value=e):
                        match e:
                            case hydra.core.EliminationProduct(value=tp):
                                return hydra.lib.optionals.maybe(hydra.lib.sets.empty(), (lambda typs: all_of(hydra.lib.lists.map((lambda v1: try_type(vars, v1)), typs))), tp.domain)
                            
                            case _:
                                return dflt
                    
                    case hydra.core.FunctionLambda(value=l):
                        domt = hydra.lib.optionals.maybe(hydra.lib.sets.empty(), (lambda v1: try_type(vars, v1)), l.domain)
            ...
            case hydra.core.TermLet(value=l):
                def for_binding(b: hydra.core.Binding) -> frozenset[hydra.core.Name]:
                    ...
                    return hydra.lib.sets.union(get_all(new_vars, b.term), hydra.lib.optionals.maybe(hydra.lib.sets.empty(), (lambda ts: try_type(new_vars, ts.type)), b.type))
...
def free_variables_in_term(term: hydra.core.Term) -> frozenset[hydra.core.Name]:
    ...
    dflt_vars = hydra.lib.lists.foldl((lambda s, t: hydra.lib.sets.union(s, free_variables_in_term(t))), hydra.lib.sets.empty(), subterms(term))
    match term:
        case hydra.core.TermFunction(value=v1):
            match v1:
                case hydra.core.FunctionLambda(value=l):
...
def free_variables_in_type_ordered(typ: hydra.core.Type) -> frozenlist[hydra.core.Name]:
    ...
    def collect_vars(bound_vars: frozenset[hydra.core.Name], t: hydra.core.Type) -> frozenlist[hydra.core.Name]:
        match t:
            case hydra.core.TypeVariable(value=v):
                return hydra.lib.logic.if_else(hydra.lib.sets.member(v, bound_vars), (), (v,))
...
def free_variables_in_type_simple(typ: hydra.core.Type) -> frozenset[hydra.core.Name]:
    ...
    def helper(types: frozenset[hydra.core.Name], typ2: hydra.core.Type) -> frozenset[hydra.core.Name]:
        match typ2:
            ...
            case _:
                return types
    return fold_over_type(cast(hydra.coders.TraversalOrder, hydra.coders.TraversalOrderPre(None)), helper, hydra.lib.sets.empty(), typ)
...
def inline_type[T0](schema: FrozenDict[hydra.core.Name, hydra.core.Type], typ: hydra.core.Type) -> hydra.compute.Flow[T0, hydra.core.Type]:
    def f[T1](recurse: Callable[[T1], hydra.compute.Flow[T0, hydra.core.Type]], typ2: T1) -> hydra.compute.Flow[T0, hydra.core.Type]:
        def after_recurse(tr: hydra.core.Type) -> hydra.compute.Flow[T0, hydra.core.Type]:
            match tr:
                case hydra.core.TypeVariable(value=v):
                    return hydra.lib.optionals.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("No such type in schema: ", v.value)), (lambda v1: inline_type(schema, v1)), hydra.lib.maps.lookup(v, schema))
                
                case _:
                    return hydra.lib.flows.pure(tr)
        return hydra.lib.flows.bind(recurse(typ2), (lambda tr: after_recurse(tr)))
    return rewrite_type_m(f, typ)
...
def normalize_type_variables_in_term(term: hydra.core.Term) -> hydra.core.Term:
    ...
    def replace_name[T0](subst: FrozenDict[T0, T0], v: T0) -> T0:
        return hydra.lib.optionals.from_maybe(v, hydra.lib.maps.lookup(v, subst))
            ...
            match term2:
                case hydra.core.TermFunction(value=v1):
                    match v1:
                        ...
                        case hydra.core.FunctionLambda(value=l):
                            domain = l.domain
                            return cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionLambda(hydra.core.Lambda(l.parameter, hydra.lib.optionals.map((lambda v12: subst_type(subst, v12)), domain), rewrite_with_subst(((subst, bound_vars), next), l.body))))))
                ...
                case hydra.core.TermLet(value=lt):
                    ...
                    def step(acc: frozenlist[hydra.core.Binding], bs: frozenlist[hydra.core.Binding]) -> frozenlist[hydra.core.Binding]:
                        ...
                        def with_type(ts: hydra.core.TypeScheme) -> frozenlist[hydra.core.Binding]:
                            ...
                            new_vars = gen(0, k, ())
                            new_subst = hydra.lib.maps.union(hydra.lib.maps.from_list(hydra.lib.lists.zip(vars, new_vars)), subst)
                            ...
                            b1 = hydra.core.Binding(b.name, new_val, Just(hydra.core.TypeScheme(new_vars, subst_type(new_subst, typ))))
                            return step(hydra.lib.lists.cons(b1, acc), tl)
                        return hydra.lib.logic.if_else(hydra.lib.lists.null(bs), hydra.lib.lists.reverse(acc), hydra.lib.optionals.maybe(no_type(), (lambda ts: with_type(ts)), b.type))
...
def remove_type_annotations(typ: hydra.core.Type) -> hydra.core.Type:
    ...
    def remove[T0](recurse: Callable[[T0], hydra.core.Type], typ2: T0) -> hydra.core.Type:
        ...
        match rewritten:
            ...
            case _:
                return rewritten
    return rewrite_type(remove, typ)
...
def remove_types_from_term(term: hydra.core.Term) -> hydra.core.Term:
    ...
    def strip[T0](recurse: Callable[[T0], hydra.core.Term], term2: T0) -> hydra.core.Term:
        ...
        match rewritten:
            case hydra.core.TermFunction(value=f):
                match f:
                    case hydra.core.FunctionElimination(value=e):
                        match e:
                            case hydra.core.EliminationProduct(value=tp):
                                return cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationProduct(hydra.core.TupleProjection(tp.index, tp.arity, Nothing())))))))
            ...
            case _:
                return rewritten
    return rewrite_term(strip, term)
    ...
    def rewrite(recurse: Callable[[hydra.core.Type], hydra.core.Type], typ: hydra.core.Type) -> hydra.core.Type:
        ...
        match typ:
            ...
            case hydra.core.TypeVariable(value=v):
                ...
                return hydra.lib.optionals.maybe(dflt, (lambda ts: for_type_scheme(ts)), hydra.lib.maps.lookup(v, types))
  ...
  hydra.core.Term], Tuple[T0, hydra.core.Term]], term0: T0, v1: hydra.core.Term) -> Tuple[T0, hydra.core.Term]:
    def fsub[T1](recurse: Callable[[T1, hydra.core.Term], Tuple[T1, hydra.core.Term]], val0: T1, term02: hydra.core.Term) -> Tuple[T1, hydra.core.Term]:
        ...
        def for_many[T2, T3, T4, T5](rec: Callable[[T2, T3], Tuple[T2, T4]], cons: Callable[[frozenlist[T4]], T5], val: T2, els: frozenlist[T3]) -> Tuple[T2, T5]:
            rr = hydra.lib.lists.foldl((lambda r, el: (r2 := rec(r[0], el), (r2[0], hydra.lib.lists.cons(r2[1], r[1])))[1]), (val, ()), els)
        ...
        def for_elimination(val: T1, elm: hydra.core.Elimination) -> Tuple[T1, hydra.core.Elimination]:
            def r() -> Tuple[T1, hydra.core.Elimination]:
                match elm:
                    case hydra.core.EliminationUnion(value=cs):
                        rmd = hydra.lib.optionals.map((lambda v1: recurse(val, v1)), cs.default)
                        val1 = hydra.lib.optionals.maybe(val, (lambda v1: v1[0]), rmd)
                        rcases = for_fields(val1, cs.cases)
                        return (rcases[0], cast(hydra.core.Elimination, hydra.core.EliminationUnion(hydra.core.CaseStatement(cs.type_name, hydra.lib.optionals.map((lambda v1: v1[1]), rmd), rcases[1]))))
        ...
        match term02:
            ...
            case hydra.core.TermOptional(value=mt):
                return hydra.lib.optionals.maybe(dflt, (lambda t: for_single(recurse, (lambda t1: cast(hydra.core.Term, hydra.core.TermOptional(Just(t1)))), val0, t)), mt)
  ...
  hydra.core.Term], hydra.compute.Flow[T1, Tuple[T0, hydra.core.Term]]], term0: T0, v1: hydra.core.Term) -> hydra.compute.Flow[T1, Tuple[T0, hydra.core.Term]]:
    def fsub[T2, T3](recurse: Callable[[T2, hydra.core.Term], hydra.compute.Flow[T3, Tuple[T2, hydra.core.Term]]], val0: T2, term02: hydra.core.Term) -> hydra.compute.Flow[T3, Tuple[T2, hydra.core.Term]]:
        ...
        def for_many[T4, T5, T6, T7, T8](rec: Callable[[T4, T5], hydra.compute.Flow[T6, Tuple[T4, T7]]], cons: Callable[[frozenlist[T7]], T8], val: T4, els: frozenlist[T5]) -> hydra.compute.Flow[T6, Tuple[T4, T8]]:
            return hydra.lib.flows.bind(hydra.lib.flows.foldl((lambda r, el: hydra.lib.flows.bind(rec(r[0], el), (lambda r2: hydra.lib.flows.pure((r2[0], hydra.lib.lists.cons(r2[1], r[1])))))), (val, ()), els), (lambda rr: hydra.lib.flows.pure((rr[0], cons(hydra.lib.lists.reverse(rr[1]))))))
        ...
        def for_elimination(val: T2, elm: hydra.core.Elimination) -> hydra.compute.Flow[T3, Tuple[T2, hydra.core.Elimination]]:
            def rw(elm2: hydra.core.Elimination) -> hydra.compute.Flow[T3, Tuple[T2, hydra.core.Elimination]]:
                match elm2:
                    case hydra.core.EliminationUnion(value=cs):
                        return hydra.lib.flows.bind(hydra.lib.optionals.maybe(hydra.lib.flows.pure(Nothing()), (lambda def_: hydra.lib.flows.map(hydra.lib.optionals.pure, recurse(val, def_))), cs.default), (lambda rmd: (val1 := hydra.lib.optionals.maybe(val, (lambda v1: v1[0]), rmd), hydra.lib.flows.bind(for_fields(val1, cs.cases), (lambda rcases: hydra.lib.flows.pure((rcases[0], cast(hydra.core.Elimination, hydra.core.EliminationUnion(hydra.core.CaseStatement(cs.type_name, hydra.lib.optionals.map((lambda v1: v1[1]), rmd), rcases[1]))))))))[1]))
        ...
        dflt = hydra.lib.flows.pure((val0, term02))
        match term02:
            case hydra.core.TermAnnotated(value=at):
                return for_single(recurse, (lambda t: cast(hydra.core.Term, hydra.core.TermAnnotated(hydra.core.AnnotatedTerm(t, at.annotation)))), val0, at.body)
                ...
                def for_elm(e: hydra.core.Elimination) -> hydra.compute.Flow[T1, hydra.core.Function]:
                    match e:
                        ...
                        case hydra.core.EliminationUnion(value=cs):
                            ...
                            def_ = cs.default
                            cases = cs.cases
                            return hydra.lib.flows.bind(hydra.lib.optionals.maybe(hydra.lib.flows.pure(Nothing()), (lambda t: hydra.lib.flows.map(hydra.lib.optionals.pure, recurse(t))), def_), (lambda rdef: hydra.lib.flows.map((lambda rcases: cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationUnion(hydra.core.CaseStatement(n, rdef, rcases)))))), hydra.lib.flows.map_list(for_field, cases))))
...
def simplify_term(term: hydra.core.Term) -> hydra.core.Term:
    ...
    return rewrite_term(simplify, term)
    ...
    def replace(recurse: Callable[[hydra.core.Type], hydra.core.Type], typ2: hydra.core.Type) -> hydra.core.Type:
        match typ2:
            case hydra.core.TypeVariable(value=n):
                return cast(hydra.core.Type, hydra.core.TypeVariable(hydra.lib.optionals.from_maybe(n, hydra.lib.maps.lookup(n, subst))))
...
def subterms_with_accessors(v1: hydra.core.Term) -> frozenlist[Tuple[hydra.accessors.TermAccessor, hydra.core.Term]]:
    ...
    match v1:
        ...
        case hydra.core.TermFunction(value=v12):
            match v12:
                case hydra.core.FunctionElimination(value=v13):
                    match v13:
                        case hydra.core.EliminationUnion(value=cs):
                            return hydra.lib.lists.concat2(hydra.lib.optionals.maybe((), (lambda t: ((cast(hydra.accessors.TermAccessor, hydra.accessors.TermAccessorUnionCasesDefault(None)), t),)), cs.default), hydra.lib.lists.map((lambda f: (cast(hydra.accessors.TermAccessor, hydra.accessors.TermAccessorUnionCasesBranch(f.name)), f.term)), cs.cases))
        ...
        case hydra.core.TermOptional(value=m2):
            return hydra.lib.optionals.maybe((), (lambda t: ((cast(hydra.accessors.TermAccessor, hydra.accessors.TermAccessorOptionalTerm(None)), t),)), m2)
...
def term_dependency_names(binds: bool, with_prims: bool, with_noms: bool, term0: hydra.core.Term) -> frozenset[hydra.core.Name]:
    ...
    def add_names(names: frozenset[hydra.core.Name], term: hydra.core.Term) -> frozenset[hydra.core.Name]:
        ...
        match term:
            ...
            case _:
                return names
    return fold_over_term(cast(hydra.coders.TraversalOrder, hydra.coders.TraversalOrderPre(None)), add_names, hydra.lib.sets.empty(), term0)
...
def to_short_names(original: frozenlist[hydra.core.Name]) -> FrozenDict[hydra.core.Name, hydra.core.Name]:
    ...
    def add_name(acc: FrozenDict[str, frozenset[hydra.core.Name]], name: hydra.core.Name) -> FrozenDict[str, frozenset[hydra.core.Name]]:
        ...
        group = hydra.lib.optionals.from_maybe(hydra.lib.sets.empty(), hydra.lib.maps.lookup(local, acc))
    ...
    def rename_group[T0](local_names: Tuple[str, frozenset[T0]]) -> frozenlist[Tuple[T0, hydra.core.Name]]:
        ...
        return hydra.lib.lists.zip_with(rename, hydra.lib.sets.to_list(names), range_from(1))
    return hydra.lib.maps.from_list(hydra.lib.lists.concat(hydra.lib.lists.map(rename_group, hydra.lib.maps.to_list(groups))))
...
def topological_sort_binding_map(binding_map: FrozenDict[hydra.core.Name, hydra.core.Term]) -> frozenlist[frozenlist[Tuple[hydra.core.Name, hydra.core.Term]]]:
    ...
    def deps_of[T0](name_and_term: Tuple[T0, hydra.core.Term]) -> Tuple[T0, frozenlist[hydra.core.Name]]:
        ...
        return (name, hydra.lib.logic.if_else(has_type_annotation(term), (), hydra.lib.sets.to_list(hydra.lib.sets.intersection(keys, free_variables_in_term(term)))))
    def to_pair(name: hydra.core.Name) -> Tuple[hydra.core.Name, hydra.core.Term]:
        return (name, hydra.lib.optionals.from_maybe(cast(hydra.core.Term, hydra.core.TermLiteral(cast(hydra.core.Literal, hydra.core.LiteralString("Impossible!")))), hydra.lib.maps.lookup(name, binding_map)))
    return hydra.lib.lists.map((lambda v1: hydra.lib.lists.map(to_pair, v1)), hydra.sorting.topological_sort_components(hydra.lib.lists.map(deps_of, bindings)))
...
def type_names_in_type(typ0: hydra.core.Type) -> frozenset[hydra.core.Name]:
    def add_names(names: frozenset[hydra.core.Name], typ: hydra.core.Type) -> frozenset[hydra.core.Name]:
        match typ:
            ...
            case _:
                return names
    return fold_over_type(cast(hydra.coders.TraversalOrder, hydra.coders.TraversalOrderPre(None)), add_names, hydra.lib.sets.empty(), typ0)
            ...
            case hydra.core.TermFunction(value=f):
                match f:
                    case hydra.core.FunctionLambda(value=l):
                        ...
                        domain = l.domain
                        body = l.body
                        return (m, hydra.lib.optionals.maybe(cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionLambda(hydra.core.Lambda(v, domain, rewrite(recurse, hydra.lib.maps.insert(v, 1, m), body)[1]))))), (lambda i: (i2 := hydra.lib.math.add(i, 1), v2 := hydra.core.Name(hydra.lib.strings.cat2(v.value, hydra.lib.literals.show_int32(i2))), m2 := hydra.lib.maps.insert(v, i2, m), cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionLambda(hydra.core.Lambda(v2, domain, rewrite(recurse, m2, body)[1]))))))[3]), hydra.lib.maps.lookup(v, m)))
                    
                    case _:
                        return dflt
            
            case hydra.core.TermVariable(value=v):
                return (m, cast(hydra.core.Term, hydra.core.TermVariable(hydra.lib.optionals.maybe(v, (lambda i: hydra.lib.logic.if_else(hydra.lib.equality.equal(i, 1), v, hydra.core.Name(hydra.lib.strings.cat2(v.value, hydra.lib.literals.show_int32(i))))), hydra.lib.maps.lookup(v, m)))))
            
            case _:
                return dflt
    return rewrite_and_fold_term(rewrite, hydra.lib.maps.empty(), term)[1]
