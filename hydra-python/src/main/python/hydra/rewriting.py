...
def deannotate_type_recursive(typ: hydra.core.Type) -> hydra.core.Type:
    ...
    def strip(recurse: Callable[[T0], hydra.core.Type], typ2: T0) -> hydra.core.Type:
        ...
        match rewritten:
            ...
            case _:
                return rewritten
    return rewrite_type(cast(Callable[[Callable[[hydra.core.Type], hydra.core.Type], hydra.core.Type], hydra.core.Type], (lambda x1: (lambda x2: strip(x1, x2)))), typ)
...
def flatten_let_terms(term: hydra.core.Term) -> hydra.core.Term:
    ...
    def flatten(recurse: Callable[[T0], hydra.core.Term], term2: T0) -> hydra.core.Term:
        ...
        match rewritten:
            ...
            case _:
                return rewritten
    return rewrite_term(cast(Callable[[Callable[[hydra.core.Term], hydra.core.Term], hydra.core.Term], hydra.core.Term], (lambda x1: (lambda x2: flatten(x1, x2)))), term)
...
def free_type_variables_in_term(term0: hydra.core.Term) -> frozenset[hydra.core.Name]:
    ...
    def all_of(sets: frozenlist[frozenset[T0]]) -> frozenset[T0]:
        return hydra.lib.lists.foldl(cast(Callable[[frozenset[T0], frozenset[T0]], frozenset[T0]], (lambda x1: (lambda x2: hydra.lib.sets.union(x1, x2)))), cast(frozenset[T0], hydra.lib.sets.empty()), sets)
...
def inline_type(schema: FrozenDict[hydra.core.Name, hydra.core.Type], typ: hydra.core.Type) -> hydra.compute.Flow[T0, hydra.core.Type]:
    ...
    return rewrite_type_m(cast(Callable[[
      Callable[[hydra.core.Type], hydra.compute.Flow[T0, hydra.core.Type]],
      hydra.core.Type], hydra.compute.Flow[T0, hydra.core.Type]], (lambda x1: (lambda x2: f(x1, x2)))), typ)
                ...
                case hydra.core.TermLet(value=lt):
                    ...
                    def step(acc: frozenlist[hydra.core.Binding], bs: frozenlist[hydra.core.Binding]) -> frozenlist[hydra.core.Binding]:
                        ...
                        def with_type(ts: hydra.core.TypeScheme) -> frozenlist[hydra.core.Binding]:
                            ...
                            def b1() -> hydra.core.Binding:
                                return hydra.core.Binding(b().name, new_val(), cast(Maybe[hydra.core.TypeScheme], Just(hydra.core.TypeScheme(new_vars(), subst_type(new_subst(), typ)))))
                            return step(hydra.lib.lists.cons(b1(), acc), tl())
...
def remove_type_annotations(typ: hydra.core.Type) -> hydra.core.Type:
    ...
    def remove(recurse: Callable[[T0], hydra.core.Type], typ2: T0) -> hydra.core.Type:
        ...
        match rewritten:
            ...
            case _:
                return rewritten
    return rewrite_type(cast(Callable[[Callable[[hydra.core.Type], hydra.core.Type], hydra.core.Type], hydra.core.Type], (lambda x1: (lambda x2: remove(x1, x2)))), typ)
...
def remove_types_from_term(term: hydra.core.Term) -> hydra.core.Term:
    ...
    def strip(recurse: Callable[[T0], hydra.core.Term], term2: T0) -> hydra.core.Term:
        ...
        match rewritten:
            ...
            case _:
                return rewritten
    return rewrite_term(cast(Callable[[Callable[[hydra.core.Term], hydra.core.Term], hydra.core.Term], hydra.core.Term], (lambda x1: (lambda x2: strip(x1, x2)))), term)
...
def simplify_term(term: hydra.core.Term) -> hydra.core.Term:
    ...
    return rewrite_term(cast(Callable[[Callable[[hydra.core.Term], hydra.core.Term], hydra.core.Term], hydra.core.Term], (lambda x1: (lambda x2: simplify(x1, x2)))), term)
...
def to_short_names(original: frozenlist[hydra.core.Name]) -> FrozenDict[hydra.core.Name, hydra.core.Name]:
    ...
    def rename_group(local_names: tuple[str, frozenset[T0]]) -> frozenlist[tuple[T0, hydra.core.Name]]:
        ...
        return hydra.lib.lists.zip_with(cast(Callable[[T0, int], tuple[T0, hydra.core.Name]], (lambda x1: (lambda x2: rename(x1, x2)))), hydra.lib.sets.to_list(names()), range_from(1))
