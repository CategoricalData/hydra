        ...
        match term:
            case hydra.core.TermLet(value=l):
                def for_binding(b: hydra.core.Binding) -> hydra.core.Type:
                    bname = b.name
                    bterm = b.term
                    return hydra.lib.maybes.maybe(hydra.core.Binding(bname, bind_unbound_type_variables(cx, bterm), cast(Maybe[hydra.core.TypeScheme], Nothing())), (lambda ts: (bvars := (lambda : hydra.lib.sets.from_list(ts.variables)), unbound_in_type := hydra.rewriting.free_variables_in_type(ts.type), unbound_in_term := hydra.rewriting.free_type_variables_in_term(bterm), unbound := (lambda : hydra.lib.sets.to_list(hydra.lib.sets.difference(hydra.lib.sets.union(unbound_in_type, unbound_in_term), hydra.lib.sets.union(svars(), bvars())))), ts2 := (lambda : hydra.core.TypeScheme(hydra.lib.lists.concat2(ts.variables, unbound()), ts.type, ts.constraints)), bterm2 := (lambda : hydra.lib.lists.foldl((lambda t, v: cast(hydra.core.Term, hydra.core.TermTypeLambda(hydra.core.TypeLambda(v, t)))), bterm, unbound())), hydra.core.Binding(bname, bterm2(), cast(Maybe[hydra.core.TypeScheme], Just(ts2()))))[6]), b.type)
...
def extend_context(pairs: frozenlist[tuple[hydra.core.Name, hydra.core.TypeScheme]], cx: hydra.typing.InferenceContext) -> hydra.core.Type:
    ...
    return hydra.typing.InferenceContext(cx.schema_types, cx.primitive_types, hydra.lib.maps.union(cast(FrozenDict[hydra.core.Name, hydra.core.TypeScheme], hydra.lib.maps.from_list(pairs)), cx.data_types), cx.class_constraints, cx.debug)
...
def merge_class_constraints(m1: FrozenDict[T0, hydra.core.TypeVariableMetadata], m2: FrozenDict[T0, hydra.core.TypeVariableMetadata]) -> FrozenDict[T0, hydra.core.TypeVariableMetadata]:
    return hydra.lib.lists.foldl((lambda acc, pair: (k := (lambda : hydra.lib.pairs.first(pair)), v := (lambda : hydra.lib.pairs.second(pair)), hydra.lib.maybes.maybe(hydra.lib.maps.insert(k(), v(), acc), (lambda existing: (merged := (lambda : hydra.core.TypeVariableMetadata(hydra.lib.sets.union(existing.classes, v().classes))), hydra.lib.maps.insert(k(), merged(), acc))[1]), hydra.lib.maps.lookup(k(), acc)))[2]), m1, hydra.lib.maps.to_list(m2))
...
def yield_checked(term: hydra.core.Term, typ: hydra.core.Type, subst: hydra.typing.TypeSubst) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    return hydra.lib.flows.pure(hydra.typing.InferenceResult(iterm, itype, subst, cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty())))
...
def yield_(term: hydra.core.Term, typ: hydra.core.Type, subst: hydra.typing.TypeSubst) -> hydra.core.Type:
    ...
    return hydra.typing.InferenceResult(hydra.substitution.subst_types_in_term(subst, term), hydra.substitution.subst_in_type(subst, typ), subst, cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty()))
...
def yield_checked_with_constraints(term: hydra.core.Term, typ: hydra.core.Type, subst: hydra.typing.TypeSubst, constraints: FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    iterm = hydra.substitution.subst_types_in_term(subst, term)
    itype = hydra.substitution.subst_in_type(subst, typ)
    iconstraints = hydra.substitution.subst_in_class_constraints(subst, constraints)
...
def infer_type_of_primitive(cx: hydra.typing.InferenceContext, name: hydra.core.Name) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("No such primitive: ", name.value)), (lambda scheme: hydra.lib.flows.bind(hydra.schemas.instantiate_type_scheme(scheme), (lambda ts: (constraints := (lambda : hydra.lib.maybes.from_maybe(cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty()), ts.constraints)), yield_checked_with_constraints(build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionPrimitive(name))))), ts.type, hydra.substitution.id_type_subst(), constraints()))[1]))), hydra.lib.maps.lookup(name, cx.primitive_types))
...
def generalize(cx: hydra.typing.InferenceContext, typ: hydra.core.Type) -> hydra.core.Type:
    ...
    def relevant_constraints() -> FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]:
        return cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.from_list(hydra.lib.maybes.cat(hydra.lib.lists.map((lambda v: hydra.lib.maybes.map((lambda meta: cast(tuple[hydra.core.Name, hydra.core.TypeVariableMetadata], (v, meta))), hydra.lib.maps.lookup(v, all_constraints))), vars()))))
    def constraints_maybe() -> Maybe[FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]:
        return hydra.lib.logic.if_else(hydra.lib.maps.null(relevant_constraints()), (lambda : cast(Maybe[FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]], Nothing())), (lambda : cast(Maybe[FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]], Just(relevant_constraints()))))
...
def infer_type_of_literal(_: T0, lit: hydra.core.Literal) -> hydra.compute.Flow[T1, hydra.typing.InferenceResult]:
    return hydra.lib.flows.pure(hydra.typing.InferenceResult(cast(hydra.core.Term, hydra.core.TermLiteral(lit)), cast(hydra.core.Type, hydra.core.TypeLiteral(hydra.reflect.literal_type(lit))), hydra.substitution.id_type_subst(), cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty())))

def infer_type_of_unit() -> hydra.core.Type:
    r"""The trivial inference rule for the unit term."""
    
    return hydra.typing.InferenceResult(cast(hydra.core.Term, hydra.core.TermUnit()), cast(hydra.core.Type, hydra.core.TypeUnit()), hydra.substitution.id_type_subst(), cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty()))
...
def infer_type_of_variable(cx: hydra.typing.InferenceContext, name: hydra.core.Name) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("Variable not bound to type: ", name.value)), (lambda scheme: hydra.lib.flows.bind(hydra.schemas.instantiate_type_scheme(scheme), (lambda ts: (constraints := (lambda : hydra.lib.maybes.from_maybe(cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty()), ts.constraints)), hydra.lib.flows.pure(hydra.typing.InferenceResult(build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermVariable(name))), ts.type, hydra.substitution.id_type_subst(), constraints())))[1]))), hydra.lib.maps.lookup(name, cx.data_types))
...
def infer_type_of_collection(cx: hydra.typing.InferenceContext, typ_cons: Callable[[hydra.core.Type], hydra.core.Type], trm_cons: Callable[[frozenlist[hydra.core.Term]], hydra.core.Term], desc: str, els: frozenlist[hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.flows.bind(cast(hydra.compute.Flow[T0, hydra.core.Name], hydra.schemas.fresh_name()), (lambda var: hydra.lib.logic.if_else(hydra.lib.lists.null(els), (lambda : hydra.lib.flows.pure(yield_(build_type_application_term((var,), trm_cons(cast(frozenlist[hydra.core.Term], ()))), typ_cons(cast(hydra.core.Type, hydra.core.TypeVariable(var))), hydra.substitution.id_type_subst()))), (lambda : hydra.lib.flows.bind(infer_many(cx, hydra.lib.lists.zip(els, hydra.lib.lists.map((lambda i: hydra.lib.strings.cat(("#", hydra.lib.literals.show_int32(i)))), hydra.lib.math.range_(1, hydra.lib.math.add(hydra.lib.lists.length(els), 1))))), (lambda results: (terms := (lambda : hydra.lib.pairs.first(results)), types := (lambda : hydra.lib.pairs.first(hydra.lib.pairs.second(results))), subst1 := (lambda : hydra.lib.pairs.second(hydra.lib.pairs.second(results))), constraints := (lambda : hydra.lib.lists.map((lambda t: hydra.typing.TypeConstraint(cast(hydra.core.Type, hydra.core.TypeVariable(var)), t, desc)), types())), map_constraints(cx, (lambda subst2: (iterm := (lambda : trm_cons(terms())), itype := typ_cons(cast(hydra.core.Type, hydra.core.TypeVariable(var))), isubst := (lambda : hydra.substitution.compose_type_subst(subst1(), subst2)), yield_(iterm(), itype, isubst()))[3]), constraints()))[4]))))))
...
def infer_type_of_either(cx: hydra.typing.InferenceContext, e: Either[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.eithers.either((lambda l: hydra.lib.flows.bind(infer_type_of_term(cx, l, "either left value"), (lambda r1: (iterm := r1.term, left_type := r1.type, subst := r1.subst, hydra.lib.flows.bind(cast(hydra.compute.Flow[T0, hydra.core.Type], fresh_variable_type()), (lambda right_type: (either_term := (lambda : cast(hydra.core.Term, hydra.core.TermEither(cast(Either[hydra.core.Term, hydra.core.Term], Left(iterm))))), term_with_left_type := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(either_term(), left_type)))), term_with_both_types := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(term_with_left_type(), right_type)))), either_type := cast(hydra.core.Type, hydra.core.TypeEither(hydra.core.EitherType(left_type, right_type))), yield_checked(term_with_both_types(), either_type, subst))[4])))[3]))), (lambda r: hydra.lib.flows.bind(infer_type_of_term(cx, r, "either right value"), (lambda r1: (iterm := r1.term, right_type := r1.type, subst := r1.subst, hydra.lib.flows.bind(cast(hydra.compute.Flow[T0, hydra.core.Type], fresh_variable_type()), (lambda left_type: (either_term := (lambda : cast(hydra.core.Term, hydra.core.TermEither(cast(Either[hydra.core.Term, hydra.core.Term], Right(iterm))))), term_with_left_type := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(either_term(), left_type)))), term_with_both_types := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(term_with_left_type(), right_type)))), either_type := cast(hydra.core.Type, hydra.core.TypeEither(hydra.core.EitherType(left_type, right_type))), yield_checked(term_with_both_types(), either_type, subst))[4])))[3]))), e)
...
def infer_type_of_let(cx: hydra.typing.InferenceContext, let0: hydra.core.Let) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    def binding_map() -> FrozenDict[hydra.core.Name, hydra.core.Binding]:
        return cast(FrozenDict[hydra.core.Name, hydra.core.Binding], hydra.lib.maps.from_list(hydra.lib.lists.zip(names(), bindings0)))
    ...
    def restore_let(iterm: hydra.core.Term) -> hydra.core.Type:
        ...
        def result() -> tuple[frozenlist[hydra.core.Binding], hydra.core.Term]:
            return helper(hydra.lib.lists.length(groups()), cast(frozenlist[hydra.core.Binding], ()), iterm)
        ...
        def binding_map2() -> FrozenDict[hydra.core.Name, hydra.core.Binding]:
            return cast(FrozenDict[hydra.core.Name, hydra.core.Binding], hydra.lib.maps.from_list(hydra.lib.lists.map((lambda b: cast(tuple[hydra.core.Name, hydra.core.Binding], (b.name, b))), binding_list())))
...
def infer_type_of_let_normalized(cx0: hydra.typing.InferenceContext, let_term: hydra.core.Let) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    return hydra.lib.flows.bind(hydra.schemas.fresh_names(hydra.lib.lists.length(bins0)), (lambda bvars: (tbins0 := (lambda : hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), bvars)), cx1 := (lambda : extend_context(hydra.lib.lists.zip(bnames(), hydra.lib.lists.map((lambda t: hydra.core.TypeScheme(cast(frozenlist[hydra.core.Name], ()), t, cast(Maybe[FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]], Nothing()))), tbins0())), cx0)), hydra.lib.flows.bind(infer_types_of_temporary_bindings(cx1(), bins0), (lambda inferred_result: (bterms1 := (lambda : hydra.lib.pairs.first(inferred_result)), tbins1 := (lambda : hydra.lib.pairs.first(hydra.lib.pairs.second(inferred_result))), subst_and_constraints := (lambda : hydra.lib.pairs.second(hydra.lib.pairs.second(inferred_result))), s1 := (lambda : hydra.lib.pairs.first(subst_and_constraints())), inferred_constraints := (lambda : hydra.lib.pairs.second(subst_and_constraints())), hydra.lib.flows.bind(hydra.unification.unify_type_lists(cx0.schema_types, hydra.lib.lists.map((lambda v1: hydra.substitution.subst_in_type(s1(), v1)), tbins0()), tbins1(), "temporary type bindings"), (lambda s2: hydra.lib.flows.bind(hydra.checking.check_type_subst(cx0, s2), (lambda _: (g2base := (lambda : hydra.substitution.subst_in_context(hydra.substitution.compose_type_subst(s1(), s2), cx0)), constraints_with_s2 := (lambda : hydra.substitution.subst_in_class_constraints(s2, inferred_constraints())), composed_subst := (lambda : hydra.substitution.compose_type_subst(s1(), s2)), original_binding_constraints := (lambda : hydra.lib.lists.foldl((lambda acc, b: hydra.lib.maybes.maybe(acc, (lambda ts: hydra.lib.maybes.maybe(acc, (lambda c: merge_class_constraints(acc, c)), ts.constraints)), b.type)), cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty()), bins0)), original_constraints_subst := (lambda : hydra.substitution.subst_in_class_constraints(composed_subst(), original_binding_constraints())), all_inferred_constraints := (lambda : merge_class_constraints(constraints_with_s2(), original_constraints_subst())), merged_constraints := (lambda : merge_class_constraints(g2base().class_constraints, all_inferred_constraints())), g2 := (lambda : hydra.typing.InferenceContext(g2base().schema_types, g2base().primitive_types, g2base().data_types, merged_constraints(), g2base().debug)), bterms1_subst := (lambda : hydra.lib.lists.map((lambda v1: hydra.substitution.subst_types_in_term(s2, v1)), bterms1())), tsbins1 := (lambda : hydra.lib.lists.zip(bnames(), hydra.lib.lists.map((lambda t: generalize(g2(), hydra.substitution.subst_in_type(s2, t))), tbins1()))), hydra.lib.flows.bind(infer_type_of_term(extend_context(tsbins1(), g2()), body0, "let body"), (lambda body_result: (body1 := body_result.term, tbody := body_result.type, sbody := body_result.subst, st1 := (lambda : hydra.typing.TermSubst(cast(FrozenDict[hydra.core.Name, hydra.core.Term], hydra.lib.maps.from_list(hydra.lib.lists.map((lambda pair: (name := (lambda : hydra.lib.pairs.first(pair)), ts := (lambda : hydra.lib.pairs.second(pair)), cast(tuple[hydra.core.Name, hydra.core.Term], (name(), build_type_application_term(ts().variables, cast(hydra.core.Term, hydra.core.TermVariable(name()))))))[2]), tsbins1()))))), create_binding := (lambda binding_pair: (name_ts_pair := (lambda : hydra.lib.pairs.first(binding_pair)), term := (lambda : hydra.lib.pairs.second(binding_pair)), name := (lambda : hydra.lib.pairs.first(name_ts_pair())), ts := (lambda : hydra.lib.pairs.second(name_ts_pair())), type_lambda_term := (lambda : hydra.lib.lists.foldl((lambda b, v: cast(hydra.core.Term, hydra.core.TermTypeLambda(hydra.core.TypeLambda(v, b)))), hydra.substitution.substitute_in_term(st1(), term()), hydra.lib.lists.reverse(ts().variables))), final_ts := (lambda : hydra.substitution.subst_in_type_scheme(sbody, ts())), hydra.core.Binding(name(), hydra.substitution.subst_types_in_term(hydra.substitution.compose_type_subst(sbody, s2), type_lambda_term()), cast(Maybe[hydra.core.TypeScheme], Just(final_ts()))))[6]), bins1 := (lambda : hydra.lib.lists.map(create_binding, hydra.lib.lists.zip(tsbins1(), bterms1_subst()))), body_constraints := hydra.substitution.subst_in_class_constraints(sbody, body_result.class_constraints), binding_constraints_subst := (lambda : hydra.substitution.subst_in_class_constraints(sbody, constraints_with_s2())), all_constraints := (lambda : merge_class_constraints(binding_constraints_subst(), body_constraints)), ret := (lambda : hydra.typing.InferenceResult(cast(hydra.core.Term, hydra.core.TermLet(hydra.core.Let(bins1(), body1))), tbody, hydra.substitution.compose_type_subst_list((s1(), s2, sbody)), all_constraints())), hydra.lib.flows.pure(ret()))[10])))[10])))))[5])))[2]))
...
def infer_type_of_map(cx: hydra.typing.InferenceContext, m: FrozenDict[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.flows.bind(cast(hydra.compute.Flow[T0, hydra.core.Name], hydra.schemas.fresh_name()), (lambda kvar: hydra.lib.flows.bind(cast(hydra.compute.Flow[T0, hydra.core.Name], hydra.schemas.fresh_name()), (lambda vvar: hydra.lib.logic.if_else(hydra.lib.maps.null(m), (lambda : hydra.lib.flows.pure(yield_(build_type_application_term((kvar, vvar), cast(hydra.core.Term, hydra.core.TermMap(cast(FrozenDict[hydra.core.Term, hydra.core.Term], hydra.lib.maps.empty())))), cast(hydra.core.Type, hydra.core.TypeMap(hydra.core.MapType(cast(hydra.core.Type, hydra.core.TypeVariable(kvar)), cast(hydra.core.Type, hydra.core.TypeVariable(vvar))))), hydra.substitution.id_type_subst()))), (lambda : hydra.lib.flows.bind(infer_many(cx, hydra.lib.lists.map((lambda k: cast(tuple[hydra.core.Term, str], (k, "map key"))), hydra.lib.maps.keys(m))), (lambda kresults: (kterms := (lambda : hydra.lib.pairs.first(kresults)), ktypes := (lambda : hydra.lib.pairs.first(hydra.lib.pairs.second(kresults))), ksubst := (lambda : hydra.lib.pairs.second(hydra.lib.pairs.second(kresults))), hydra.lib.flows.bind(infer_many(cx, hydra.lib.lists.map((lambda v: cast(tuple[hydra.core.Term, str], (v, "map value"))), hydra.lib.maps.elems(m))), (lambda vresults: (vterms := (lambda : hydra.lib.pairs.first(vresults)), vtypes := (lambda : hydra.lib.pairs.first(hydra.lib.pairs.second(vresults))), vsubst := (lambda : hydra.lib.pairs.second(hydra.lib.pairs.second(vresults))), kcons := (lambda : hydra.lib.lists.map((lambda t: hydra.typing.TypeConstraint(cast(hydra.core.Type, hydra.core.TypeVariable(kvar)), t, "map key")), ktypes())), vcons := (lambda : hydra.lib.lists.map((lambda t: hydra.typing.TypeConstraint(cast(hydra.core.Type, hydra.core.TypeVariable(vvar)), t, "map value")), vtypes())), map_constraints(cx, (lambda subst: yield_(cast(hydra.core.Term, hydra.core.TermMap(cast(FrozenDict[hydra.core.Term, hydra.core.Term], hydra.lib.maps.from_list(hydra.lib.lists.zip(kterms(), vterms()))))), cast(hydra.core.Type, hydra.core.TypeMap(hydra.core.MapType(cast(hydra.core.Type, hydra.core.TypeVariable(kvar)), cast(hydra.core.Type, hydra.core.TypeVariable(vvar))))), hydra.substitution.compose_type_subst_list((ksubst(), vsubst(), subst)))), hydra.lib.lists.concat((kcons(), vcons()))))[5])))[3]))))))))
...
def infer_type_of_optional(cx: hydra.typing.InferenceContext, m: Maybe[hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    return infer_type_of_collection(cx, (lambda x: cast(hydra.core.Type, hydra.core.TypeMaybe(x))), trm_cons, "optional element", hydra.lib.maybes.maybe(cast(frozenlist[hydra.core.Term], ()), cast(Callable[[hydra.core.Term], frozenlist[hydra.core.Term]], (lambda x1: hydra.lib.lists.singleton(x1))), m))
...
def infer_type_of_pair(cx: hydra.typing.InferenceContext, p: tuple[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.flows.map((lambda results: (iterms := (lambda : hydra.lib.pairs.first(results)), itypes := (lambda : hydra.lib.pairs.first(hydra.lib.pairs.second(results))), isubst := (lambda : hydra.lib.pairs.second(hydra.lib.pairs.second(results))), ifst := (lambda : hydra.lib.lists.head(iterms())), isnd := (lambda : hydra.lib.lists.head(hydra.lib.lists.tail(iterms()))), ty_fst := (lambda : hydra.lib.lists.head(itypes())), ty_snd := (lambda : hydra.lib.lists.head(hydra.lib.lists.tail(itypes()))), pair_term := (lambda : cast(hydra.core.Term, hydra.core.TermPair(cast(tuple[hydra.core.Term, hydra.core.Term], (ifst(), isnd()))))), term_with_types := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(pair_term(), ty_fst()))), ty_snd())))), yield_(term_with_types(), cast(hydra.core.Type, hydra.core.TypePair(hydra.core.PairType(ty_fst(), ty_snd()))), isubst()))[9]), infer_many(cx, (cast(tuple[hydra.core.Term, str], (hydra.lib.pairs.first(p), "pair first element")), cast(tuple[hydra.core.Term, str], (hydra.lib.pairs.second(p), "pair second element")))))
...
def infer_types_of_temporary_bindings(cx: hydra.typing.InferenceContext, bins: frozenlist[hydra.core.Binding]) -> hydra.compute.Flow[T0, tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]]]]:
    def dflt() -> hydra.compute.Flow[T0, tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]]]]:
        ...
        return hydra.lib.flows.bind(infer_type_of_term(cx, v(), hydra.lib.strings.cat(("temporary let binding '", k().value, "'"))), (lambda result1: (j := result1.term, u_prime := result1.type, u := result1.subst, c1_inferred := result1.class_constraints, hydra.lib.flows.bind(hydra.lib.maybes.maybe(hydra.lib.flows.pure(cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty())), (lambda ts: hydra.lib.flows.bind(hydra.schemas.instantiate_type_scheme(ts), (lambda instantiated_ts: (fresh_constraints := (lambda : hydra.lib.maybes.from_maybe(cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty()), instantiated_ts.constraints)), hydra.lib.flows.bind(hydra.unification.unify_types(cx.schema_types, instantiated_ts.type, u_prime, "original binding type"), (lambda unify_subst: hydra.lib.flows.pure(hydra.substitution.subst_in_class_constraints(unify_subst, fresh_constraints())))))[1]))), binding().type), (lambda original_binding_constraints: (c1 := (lambda : merge_class_constraints(c1_inferred, original_binding_constraints)), hydra.lib.flows.bind(infer_types_of_temporary_bindings(hydra.substitution.subst_in_context(u, cx), tl()), (lambda result2: (h := (lambda : hydra.lib.pairs.first(result2)), r_prime := (lambda : hydra.lib.pairs.first(hydra.lib.pairs.second(result2))), rest_pair := (lambda : hydra.lib.pairs.second(hydra.lib.pairs.second(result2))), r := (lambda : hydra.lib.pairs.first(rest_pair())), c2 := (lambda : hydra.lib.pairs.second(rest_pair())), c1_subst := (lambda : hydra.substitution.subst_in_class_constraints(r(), c1())), merged_constraints := (lambda : merge_class_constraints(c1_subst(), c2())), hydra.lib.flows.pure(cast(tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]]], (hydra.lib.lists.cons(hydra.substitution.subst_types_in_term(r(), j), h()), cast(tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]], (hydra.lib.lists.cons(hydra.substitution.subst_in_type(r(), u_prime), r_prime()), cast(tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]], (hydra.substitution.compose_type_subst(u, r()), merged_constraints()))))))))[7])))[1])))[4]))
    return hydra.lib.logic.if_else(hydra.lib.lists.null(bins), (lambda : hydra.lib.flows.pure(cast(tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]]], (cast(frozenlist[hydra.core.Term], ()), cast(tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]], (cast(frozenlist[hydra.core.Type], ()), cast(tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]], (hydra.substitution.id_type_subst(), cast(FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata], hydra.lib.maps.empty()))))))))), (lambda : dflt()))
...
def infer_type_of(cx: hydra.typing.InferenceContext, term: hydra.core.Term) -> hydra.compute.Flow[T0, tuple[hydra.core.Term, hydra.core.TypeScheme]]:
    def let_term() -> hydra.core.Type:
        return cast(hydra.core.Term, hydra.core.TermLet(hydra.core.Let((hydra.core.Binding(hydra.core.Name("ignoredVariableName"), term, cast(Maybe[hydra.core.TypeScheme], Nothing())),), cast(hydra.core.Term, hydra.core.TermLiteral(cast(hydra.core.Literal, hydra.core.LiteralString("ignoredBody")))))))
