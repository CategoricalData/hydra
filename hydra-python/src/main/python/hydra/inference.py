...
def infer_type_of_optional[T0](cx: hydra.typing.InferenceContext, m: Maybe[hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    return infer_type_of_collection(cx, (lambda x: cast(hydra.core.Type, hydra.core.TypeOptional(x))), trm_cons, "optional element", hydra.lib.maybes.maybe(cast(frozenlist[hydra.core.Term], ()), cast(Callable[[hydra.core.Term], frozenlist[hydra.core.Term]], hydra.lib.lists.singleton), m))
