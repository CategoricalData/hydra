...
def infer_type_of_primitive(cx: hydra.typing.InferenceContext, name: hydra.core.Name) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("No such primitive: ", name.value)), (lambda scheme: hydra.lib.flows.bind(hydra.schemas.instantiate_type_scheme(scheme), (lambda ts: (constraints := (lambda : hydra.lib.maybes.from_maybe(hydra.lib.maps.empty(), ts.constraints)), yield_checked_with_constraints(build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionPrimitive(name))))), ts.type, hydra.substitution.id_type_subst(), constraints()))[1]))), hydra.lib.maps.lookup(name, cx.primitive_types))
...
def infer_type_of_either(cx: hydra.typing.InferenceContext, e: Either[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.eithers.either((lambda l: hydra.lib.flows.bind(infer_type_of_term(cx, l, "either left value"), (lambda r1: (iterm := r1.term, left_type := r1.type, subst := r1.subst, hydra.lib.flows.bind(fresh_variable_type(), (lambda right_type: (either_term := (lambda : cast(hydra.core.Term, hydra.core.TermEither(Left(iterm)))), term_with_left_type := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(either_term(), left_type)))), term_with_both_types := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(term_with_left_type(), right_type)))), either_type := cast(hydra.core.Type, hydra.core.TypeEither(hydra.core.EitherType(left_type, right_type))), yield_checked(term_with_both_types(), either_type, subst))[4])))[3]))), (lambda r: hydra.lib.flows.bind(infer_type_of_term(cx, r, "either right value"), (lambda r1: (iterm := r1.term, right_type := r1.type, subst := r1.subst, hydra.lib.flows.bind(fresh_variable_type(), (lambda left_type: (either_term := (lambda : cast(hydra.core.Term, hydra.core.TermEither(Right(iterm)))), term_with_left_type := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(either_term(), left_type)))), term_with_both_types := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(term_with_left_type(), right_type)))), either_type := cast(hydra.core.Type, hydra.core.TypeEither(hydra.core.EitherType(left_type, right_type))), yield_checked(term_with_both_types(), either_type, subst))[4])))[3]))), e)
...
def infer_type_of_pair(cx: hydra.typing.InferenceContext, p: tuple[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    return hydra.lib.flows.map((lambda results: (iterms := (lambda : hydra.lib.pairs.first(results)), itypes := (lambda : hydra.lib.pairs.first(hydra.lib.pairs.second(results))), isubst := (lambda : hydra.lib.pairs.second(hydra.lib.pairs.second(results))), ifst := (lambda : hydra.lib.lists.head(iterms())), isnd := (lambda : hydra.lib.lists.head(hydra.lib.lists.tail(iterms()))), ty_fst := (lambda : hydra.lib.lists.head(itypes())), ty_snd := (lambda : hydra.lib.lists.head(hydra.lib.lists.tail(itypes()))), pair_term := (lambda : cast(hydra.core.Term, hydra.core.TermPair((ifst(), isnd())))), term_with_types := (lambda : cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(pair_term(), ty_fst()))), ty_snd())))), yield_(term_with_types(), cast(hydra.core.Type, hydra.core.TypePair(hydra.core.PairType(ty_fst(), ty_snd()))), isubst()))[9]), infer_many(cx, ((hydra.lib.pairs.first(p), "pair first element"), (hydra.lib.pairs.second(p), "pair second element"))))
