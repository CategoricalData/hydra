...
def empty_inference_context() -> hydra.typing.InferenceContext:
    ...
    return hydra.typing.InferenceContext(cast(FrozenDict[hydra.core.Name, hydra.core.TypeScheme], FrozenDict({})), cast(FrozenDict[hydra.core.Name, hydra.core.TypeScheme], FrozenDict({})), cast(FrozenDict[hydra.core.Name, hydra.core.TypeScheme], FrozenDict({})), False)
...
def infer_types_of_temporary_bindings(cx: hydra.typing.InferenceContext, bins: frozenlist[hydra.core.Binding]) -> hydra.compute.Flow[T0, tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], hydra.typing.TypeSubst]]]:
    def dflt() -> hydra.compute.Flow[T0, tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], hydra.typing.TypeSubst]]]:
