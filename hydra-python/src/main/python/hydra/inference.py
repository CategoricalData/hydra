...
def infer_type_of_maybe[T0](cx: hydra.typing.InferenceContext, m: Maybe[hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    def match_term() -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
        match term:
            ...
            case hydra.core.TermMaybe(value=m2):
                return infer_type_of_maybe(cx, m2)
