...
def language_adapter(lang: hydra.coders.Language, typ: hydra.core.Type) -> hydra.compute.Flow[hydra.graph.Graph, hydra.compute.Adapter[T0, T1, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    def get_pair(typ2: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, tuple[hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term], hydra.coders.AdapterContext]]:
        return hydra.lib.flows.bind(hydra.adapt.terms.term_adapter(typ2), (lambda ad: hydra.lib.flows.bind(cast(hydra.compute.Flow[hydra.coders.AdapterContext, hydra.coders.AdapterContext], hydra.monads.get_state()), (lambda cx: hydra.lib.flows.pure(cast(tuple[hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term], hydra.coders.AdapterContext], (ad, cx)))))))
    return hydra.lib.flows.bind(cast(hydra.compute.Flow[hydra.graph.Graph, hydra.graph.Graph], hydra.monads.get_state()), (lambda g: (cx0 := (lambda : hydra.coders.AdapterContext(g, lang, cast(FrozenDict[hydra.core.Name, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]], hydra.lib.maps.empty()))), hydra.lib.flows.bind(hydra.monads.with_state(cx0(), get_pair(typ)), (lambda result: (adapter := (lambda : hydra.lib.pairs.first(result)), cx := (lambda : hydra.lib.pairs.second(result)), encode := (lambda term: hydra.monads.with_state(cx(), adapter().coder.encode(term))), decode := (lambda term: hydra.monads.with_state(cx(), adapter().coder.decode(term))), hydra.lib.flows.pure(cast(hydra.compute.Adapter[T0, T1, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term], hydra.compute.Adapter(adapter().is_lossy, adapter().source, adapter().target, cast(hydra.compute.Coder[T0, T1, hydra.core.Term, hydra.core.Term], hydra.compute.Coder(cast(Callable[[hydra.core.Term], hydra.compute.Flow[T0, hydra.core.Term]], (lambda x1: encode(x1))), cast(Callable[[hydra.core.Term], hydra.compute.Flow[T1, hydra.core.Term]], (lambda x1: decode(x1)))))))))[4])))[1]))
