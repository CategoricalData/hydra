...
def pass_unit(_: T0) -> hydra.compute.Flow[T1, hydra.compute.Adapter[T2, T3, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    return hydra.lib.flows.pure(cast(hydra.compute.Adapter[T2, T3, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term], hydra.compute.Adapter(False, cast(hydra.core.Type, hydra.core.TypeUnit()), cast(hydra.core.Type, hydra.core.TypeUnit()), cast(hydra.compute.Coder[T2, T3, hydra.core.Term, hydra.core.Term], hydra.compute.Coder((lambda _2: hydra.lib.flows.pure(cast(hydra.core.Term, hydra.core.TermUnit()))), (lambda _2: hydra.lib.flows.pure(cast(hydra.core.Term, hydra.core.TermUnit()))))))))

def union_type_to_record_type(rt: hydra.core.RowType) -> hydra.core.Type:
    r"""Convert a union row type to a record row type."""
    
    def make_optional(f: hydra.core.FieldType) -> hydra.core.Type:
        fn = f.name
        ft = f.type
...
def for_type_reference(name: hydra.core.Name) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def encdec(name2: hydra.core.Name, dir: hydra.coders.CoderDirection, term: hydra.core.Term) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]:
        return hydra.lib.flows.bind(cast(hydra.compute.Flow[hydra.coders.AdapterContext, hydra.coders.AdapterContext], hydra.monads.get_state()), (lambda cx: (adapters := cx.adapters, hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("no adapter for reference type ", name2.value)), (lambda ad: hydra.adapt.utils.encode_decode(dir, ad.coder, term)), hydra.lib.maps.lookup(name2, adapters)))[1]))
    def for_type(cx: hydra.coders.AdapterContext, adapters: FrozenDict[hydra.core.Name, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]], t: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
        return hydra.lib.flows.bind(term_adapter(t), (lambda actual: (final_adapters := (lambda : hydra.lib.maps.insert(name, actual, adapters)), final_cx := (lambda : hydra.coders.AdapterContext(cx.graph, cx.language, final_adapters())), hydra.lib.flows.bind(hydra.monads.put_state(final_cx()), (lambda ignored2: hydra.lib.flows.pure(actual))))[2]))
    ...
    def flow() -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
        ...
        def placeholder() -> hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]:
            return cast(hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term], hydra.compute.Adapter(lossy, cast(hydra.core.Type, hydra.core.TypeVariable(name)), cast(hydra.core.Type, hydra.core.TypeVariable(name)), hydra.adapt.utils.bidirectional((lambda v1, v2: encdec(name, v1, v2)))))
        return hydra.lib.flows.bind(cast(hydra.compute.Flow[hydra.coders.AdapterContext, hydra.coders.AdapterContext], hydra.monads.get_state()), (lambda cx: (adapters := cx.adapters, hydra.lib.maybes.maybe(for_missing_adapter(cx, lossy, adapters, placeholder()), cast(Callable[[
          hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]], hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]], (lambda x1: hydra.lib.flows.pure(x1))), hydra.lib.maps.lookup(name, adapters)))[1]))
...
def function_to_union(t: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def read_from_string(term: hydra.core.Term) -> hydra.compute.Flow[hydra.graph.Graph, hydra.core.Term]:
        return hydra.lib.flows.bind(hydra.extract.core.string(term), (lambda s: hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("failed to parse term: ", s)), cast(Callable[[hydra.core.Term], hydra.compute.Flow[hydra.graph.Graph, hydra.core.Term]], (lambda x1: hydra.lib.flows.pure(x1))), hydra.show.core.read_term(s))))
    def decode(ad: hydra.compute.Adapter[T0, hydra.coders.AdapterContext, T1, T2, hydra.core.Term, T3], term: T3) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]:
        ...
        return hydra.lib.flows.bind(ad.coder.decode(term), (lambda inj_term: hydra.lib.flows.bind(with_graph_context(hydra.extract.core.injection(function_proxy_name, inj_term)), (lambda field: (fname := field.name, fterm := field.term, hydra.lib.maybes.from_maybe(not_found(fname), hydra.lib.maps.lookup(fname, cast(FrozenDict[hydra.core.Name, hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]], hydra.lib.maps.from_list((cast(tuple[hydra.core.Name, hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]], (hydra.core.Name("wrap"), for_wrapped(fterm))), cast(tuple[hydra.core.Name, hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]], (hydra.core.Name("record"), for_projection(fterm))), cast(tuple[hydra.core.Name, hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]], (hydra.core.Name("union"), for_cases(fterm))), cast(tuple[hydra.core.Name, hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]], (hydra.core.Name("lambda"), for_lambda(fterm))), cast(tuple[hydra.core.Name, hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]], (hydra.core.Name("primitive"), for_primitive(fterm))), cast(tuple[hydra.core.Name, hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]], (hydra.core.Name("variable"), for_variable(fterm)))))))))[2]))))
    match t:
...
def pass_function(t: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def to_case_ads(dom: hydra.core.Type, cod: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, FrozenDict[hydra.core.Name, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.FieldType, hydra.core.FieldType, hydra.core.Field, hydra.core.Field]]]:
        match hydra.rewriting.deannotate_type(dom):
            case hydra.core.TypeUnion(value=rt):
                return hydra.lib.flows.bind(hydra.lib.flows.map_list((lambda f: hydra.lib.flows.bind(field_adapter(hydra.core.FieldType(f.name, cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(f.type, cod))))), (lambda ad: hydra.lib.flows.pure(cast(tuple[hydra.core.Name, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.FieldType, hydra.core.FieldType, hydra.core.Field, hydra.core.Field]], (f.name, ad)))))), rt.fields), (lambda pairs: hydra.lib.flows.pure(cast(FrozenDict[hydra.core.Name, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.FieldType, hydra.core.FieldType, hydra.core.Field, hydra.core.Field]], hydra.lib.maps.from_list(pairs)))))
        ...
        match hydra.rewriting.deannotate_type(dom):
            case hydra.core.TypeMaybe(value=ot):
                return hydra.lib.flows.map(cast(Callable[[
                  hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]], Maybe[hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]], (lambda x1: hydra.lib.maybes.pure(x1))), term_adapter(cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(ot, cod)))))
    ...
    def get_coder(case_ads: FrozenDict[T0, hydra.compute.Adapter[T1, T2, T3, T4, T5, T5]], fname: T0) -> hydra.compute.Coder[T1, T2, T5, T5]:
        return hydra.lib.maybes.maybe(cast(hydra.compute.Coder[T1, T2, T5, T5], hydra.adapt.utils.id_coder()), (lambda v1: v1.coder), hydra.lib.maps.lookup(fname, case_ads))
    ...
    def for_function_type(ft: hydra.core.FunctionType) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
        dom = ft.domain
        cod = ft.codomain
        return hydra.lib.flows.bind(term_adapter(dom), (lambda dom_ad: hydra.lib.flows.bind(term_adapter(cod), (lambda cod_ad: hydra.lib.flows.bind(to_case_ads(dom, cod), (lambda case_ads: hydra.lib.flows.bind(to_option_ad(dom, cod), (lambda option_ad: (lossy := (lambda : hydra.lib.logic.or_(cod_ad.is_lossy, hydra.lib.lists.foldl(hydra.lib.logic.or_, False, hydra.lib.lists.map((lambda pair: hydra.lib.pairs.second(pair).is_lossy), hydra.lib.maps.to_list(case_ads))))), target := (lambda : cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(dom_ad.target, cod_ad.target)))), hydra.lib.flows.pure(cast(hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term], hydra.compute.Adapter(lossy(), t, target(), hydra.adapt.utils.bidirectional((lambda v1, v2: encdec(cod_ad, case_ads, v1, v2)))))))[2]))))))))
    match t:
        case hydra.core.TypeFunction(value=ft):
    ...
    def encdec(kad: hydra.compute.Adapter[T0, T0, T1, T2, hydra.core.Term, hydra.core.Term], vad: hydra.compute.Adapter[T0, T0, T3, T4, hydra.core.Term, hydra.core.Term], dir: hydra.coders.CoderDirection, term: hydra.core.Term) -> hydra.compute.Flow[T0, hydra.core.Term]:
        match term:
            case hydra.core.TermMap(value=m):
                return hydra.lib.flows.bind(hydra.lib.flows.map_list((lambda pair: (k := (lambda : hydra.lib.pairs.first(pair)), v := (lambda : hydra.lib.pairs.second(pair)), hydra.lib.flows.bind(hydra.adapt.utils.encode_decode(dir, kad.coder, k()), (lambda new_k: hydra.lib.flows.bind(hydra.adapt.utils.encode_decode(dir, vad.coder, v()), (lambda new_v: hydra.lib.flows.pure(cast(tuple[hydra.core.Term, hydra.core.Term], (new_k, new_v))))))))[2]), hydra.lib.maps.to_list(m)), (lambda new_pairs: hydra.lib.flows.pure(cast(hydra.core.Term, hydra.core.TermMap(cast(FrozenDict[hydra.core.Term, hydra.core.Term], hydra.lib.maps.from_list(new_pairs)))))))
...
def pass_optional(t: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def map_term(coder: hydra.compute.Coder[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Term, hydra.core.Term], dir: hydra.coders.CoderDirection, term: hydra.core.Term) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.core.Term]:
        return hydra.lib.flows.bind(with_graph_context(hydra.extract.core.maybe_term(cast(Callable[[hydra.core.Term], hydra.compute.Flow[hydra.graph.Graph, hydra.core.Term]], (lambda x1: hydra.lib.flows.pure(x1))), term)), (lambda opt: hydra.lib.flows.bind(hydra.lib.flows.map_maybe((lambda v1: hydra.adapt.utils.encode_decode(dir, coder, v1)), opt), (lambda new_opt: hydra.lib.flows.pure(cast(hydra.core.Term, hydra.core.TermMaybe(new_opt)))))))
    match t:
        case hydra.core.TypeMaybe(value=ot):
    ...
    match t:
        case hydra.core.TypeUnion(value=rt):
            ...
            def get_adapter(adapters_map: FrozenDict[hydra.core.Name, T0], f: hydra.core.Field) -> hydra.compute.Flow[T1, T0]:
                return hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("no such field: ", f.name.value)), cast(Callable[[T0], hydra.compute.Flow[T1, T0]], (lambda x1: hydra.lib.flows.pure(x1))), hydra.lib.maps.lookup(f.name, adapters_map))
            return hydra.lib.flows.bind(hydra.lib.flows.map_list((lambda f: hydra.lib.flows.bind(field_adapter(f), (lambda ad: hydra.lib.flows.pure(cast(tuple[hydra.core.Name, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.FieldType, hydra.core.FieldType, hydra.core.Field, hydra.core.Field]], (f.name, ad)))))), sfields), (lambda adapters: (adapters_map := (lambda : cast(FrozenDict[hydra.core.Name, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.FieldType, hydra.core.FieldType, hydra.core.Field, hydra.core.Field]], hydra.lib.maps.from_list(adapters))), lossy := (lambda : hydra.lib.lists.foldl(hydra.lib.logic.or_, False, hydra.lib.lists.map((lambda pair: hydra.lib.pairs.second(pair).is_lossy), adapters))), sfields_ := (lambda : hydra.lib.lists.map((lambda pair: hydra.lib.pairs.second(pair).target), adapters)), hydra.lib.flows.pure(cast(hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term], hydra.compute.Adapter(lossy(), t, cast(hydra.core.Type, hydra.core.TypeUnion(hydra.core.RowType(tname, sfields_()))), hydra.adapt.utils.bidirectional((lambda dir, term: hydra.lib.flows.pure(term)))))))[3]))
...
def term_adapter(typ: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def constraints(cx: hydra.coders.AdapterContext) -> hydra.core.Type:
    ...
    def pass_(t: hydra.core.Type) -> frozenlist[Callable[[hydra.core.Type], hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]]]:
        match hydra.reflect.type_variant(hydra.rewriting.deannotate_type(t)):
            ...
            case hydra.variants.TypeVariant.UNIT:
                return (cast(Callable[[hydra.core.Type], hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]], (lambda x1: pass_unit(x1))),)
    ...
    def try_substitution(t: hydra.core.Type) -> frozenlist[Callable[[hydra.core.Type], hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]]]:
        match hydra.reflect.type_variant(t):
            ...
            case hydra.variants.TypeVariant.UNIT:
                return (cast(Callable[[hydra.core.Type], hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]], (lambda x1: unit_to_record(x1))),)
...
def union_to_record(t: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def from_record_fields(term: hydra.core.Term, term_: T0, t_: hydra.core.Type, fields: frozenlist[hydra.core.Field]) -> hydra.compute.Flow[T1, hydra.core.Field]:
        def matches() -> frozenlist[hydra.core.Field]:
            return hydra.lib.maybes.map_maybe(for_field, fields)
    ...
    match t:
        case hydra.core.TypeUnion(value=rt):
            ...
            def to_record_field(term: hydra.core.Term, fn: hydra.core.Name, f: hydra.core.FieldType) -> hydra.core.Type:
                fn_ = f.name
                return hydra.core.Field(fn_, cast(hydra.core.Term, hydra.core.TermMaybe(hydra.lib.logic.if_else(hydra.lib.equality.equal(fn_, fn), (lambda : cast(Maybe[hydra.core.Term], Just(term))), (lambda : cast(Maybe[hydra.core.Term], Nothing()))))))
