...
def pass_function(t: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def for_function_type(ft: hydra.core.FunctionType) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
        dom = ft.domain
        cod = ft.codomain
        return hydra.lib.flows.bind(term_adapter(dom), (lambda dom_ad: hydra.lib.flows.bind(term_adapter(cod), (lambda cod_ad: hydra.lib.flows.bind(to_case_ads(dom, cod), (lambda case_ads: hydra.lib.flows.bind(to_option_ad(dom, cod), (lambda option_ad: (lossy := (lambda : hydra.lib.logic.or_(cod_ad.is_lossy, hydra.lib.lists.foldl(hydra.lib.logic.or_, False, hydra.lib.lists.map((lambda pair: hydra.lib.pairs.second(pair).is_lossy), hydra.lib.maps.to_list(case_ads))))), target := (lambda : cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(dom_ad.target, cod_ad.target)))), hydra.lib.flows.pure(hydra.compute.Adapter(lossy(), t, target(), hydra.adapt.utils.bidirectional((lambda v1, v2: encdec(cod_ad, case_ads, v1, v2))))))[2]))))))))
    match t:
        case hydra.core.TypeFunction(value=ft):
...
def pass_union(t: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    match t:
        case hydra.core.TypeUnion(value=rt):
            ...
            return hydra.lib.flows.bind(hydra.lib.flows.map_list((lambda f: hydra.lib.flows.bind(field_adapter(f), (lambda ad: hydra.lib.flows.pure((f.name, ad))))), sfields), (lambda adapters: (adapters_map := (lambda : hydra.lib.maps.from_list(adapters)), lossy := (lambda : hydra.lib.lists.foldl(hydra.lib.logic.or_, False, hydra.lib.lists.map((lambda pair: hydra.lib.pairs.second(pair).is_lossy), adapters))), sfields_ := (lambda : hydra.lib.lists.map((lambda pair: hydra.lib.pairs.second(pair).target), adapters)), hydra.lib.flows.pure(hydra.compute.Adapter(lossy(), t, cast(hydra.core.Type, hydra.core.TypeUnion(hydra.core.RowType(tname, sfields_()))), hydra.adapt.utils.bidirectional((lambda dir, term: hydra.lib.flows.pure(term))))))[3]))
...
def term_adapter(typ: hydra.core.Type) -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
    ...
    def dflt() -> hydra.compute.Flow[hydra.coders.AdapterContext, hydra.compute.Adapter[hydra.coders.AdapterContext, hydra.coders.AdapterContext, hydra.core.Type, hydra.core.Type, hydra.core.Term, hydra.core.Term]]:
        match typ:
            ...
            case _:
                return hydra.lib.flows.bind(hydra.monads.get_state(), (lambda cx: hydra.adapt.utils.choose_adapter((lambda v1: alts(cx, v1)), (lambda v1: supported(cx, v1)), hydra.show.core.type, hydra.show.core.type, typ)))
    match typ:
