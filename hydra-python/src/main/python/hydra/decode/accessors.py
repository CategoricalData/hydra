...
def accessor_path(cx: hydra.graph.Graph, raw: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.accessors.AccessorPath]:
    def _hoist_hydra_decode_accessors_accessor_path_1(cx: hydra.graph.Graph, v1: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.accessors.AccessorPath]:
        match v1:
            ...
            case _:
                return cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorPath], Left(hydra.util.DecodingError("expected wrapped type hydra.accessors.AccessorPath")))
    return hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorPath], Left(hydra.util.DecodingError(err)))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_path_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def accessor_edge(cx: hydra.graph.Graph, raw: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.accessors.AccessorEdge]:
    def _hoist_hydra_decode_accessors_accessor_edge_1(cx: hydra.graph.Graph, v1: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.accessors.AccessorEdge]:
        match v1:
            case hydra.core.TermRecord(value=record):
                field_map = hydra.extract.helpers.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.helpers.require_field("source", accessor_node, field_map, cx), (lambda field_source: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("path", accessor_path, field_map, cx), (lambda field_path: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("target", accessor_node, field_map, cx), (lambda field_target: cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorEdge], Right(hydra.accessors.AccessorEdge(field_source, field_path, field_target)))))))))
            
            case _:
                return cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorEdge], Left(hydra.util.DecodingError("expected record of type hydra.accessors.AccessorEdge")))
    return hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorEdge], Left(hydra.util.DecodingError(err)))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_edge_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def accessor_graph(cx: hydra.graph.Graph, raw: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.accessors.AccessorGraph]:
    def _hoist_hydra_decode_accessors_accessor_graph_1(cx: hydra.graph.Graph, v1: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.accessors.AccessorGraph]:
        match v1:
            case hydra.core.TermRecord(value=record):
                field_map = hydra.extract.helpers.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.helpers.require_field("nodes", (lambda v1, v2: hydra.extract.helpers.decode_list(accessor_node, v1, v2)), field_map, cx), (lambda field_nodes: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("edges", (lambda v1, v2: hydra.extract.helpers.decode_list(accessor_edge, v1, v2)), field_map, cx), (lambda field_edges: cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorGraph], Right(hydra.accessors.AccessorGraph(field_nodes, field_edges)))))))
            
            case _:
                return cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorGraph], Left(hydra.util.DecodingError("expected record of type hydra.accessors.AccessorGraph")))
    return hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, hydra.accessors.AccessorGraph], Left(hydra.util.DecodingError(err)))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_graph_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
