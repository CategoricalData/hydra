...
def type_subst(cx: hydra.graph.Graph, raw: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.typing.TypeSubst]:
    def _hoist_hydra_decode_typing_type_subst_1(cx: hydra.graph.Graph, v1: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.typing.TypeSubst]:
        match v1:
            ...
            case _:
                return cast(Either[hydra.util.DecodingError, hydra.typing.TypeSubst], Left(hydra.util.DecodingError("expected wrapped type hydra.typing.TypeSubst")))
    return hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, hydra.typing.TypeSubst], Left(hydra.util.DecodingError(err)))), (lambda stripped: _hoist_hydra_decode_typing_type_subst_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def inference_result(cx: hydra.graph.Graph, raw: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.typing.InferenceResult]:
    def _hoist_hydra_decode_typing_inference_result_1(cx: hydra.graph.Graph, v1: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.typing.InferenceResult]:
        match v1:
            case hydra.core.TermRecord(value=record):
                field_map = hydra.extract.helpers.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.helpers.require_field("term", hydra.decode.core.term, field_map, cx), (lambda field_term: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("type", hydra.decode.core.type, field_map, cx), (lambda field_type: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("subst", type_subst, field_map, cx), (lambda field_subst: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("classConstraints", (lambda v1, v2: hydra.extract.helpers.decode_map(hydra.decode.core.name, hydra.decode.core.type_variable_metadata, v1, v2)), field_map, cx), (lambda field_class_constraints: cast(Either[hydra.util.DecodingError, hydra.typing.InferenceResult], Right(hydra.typing.InferenceResult(field_term, field_type, field_subst, field_class_constraints)))))))))))
            
            case _:
                return cast(Either[hydra.util.DecodingError, hydra.typing.InferenceResult], Left(hydra.util.DecodingError("expected record of type hydra.typing.InferenceResult")))
    return hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, hydra.typing.InferenceResult], Left(hydra.util.DecodingError(err)))), (lambda stripped: _hoist_hydra_decode_typing_inference_result_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def term_subst(cx: hydra.graph.Graph, raw: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.typing.TermSubst]:
    def _hoist_hydra_decode_typing_term_subst_1(cx: hydra.graph.Graph, v1: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.typing.TermSubst]:
        match v1:
            ...
            case _:
                return cast(Either[hydra.util.DecodingError, hydra.typing.TermSubst], Left(hydra.util.DecodingError("expected wrapped type hydra.typing.TermSubst")))
    return hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, hydra.typing.TermSubst], Left(hydra.util.DecodingError(err)))), (lambda stripped: _hoist_hydra_decode_typing_term_subst_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
    ...
    def _hoist_hydra_decode_typing_type_constraint_1(cx: hydra.graph.Graph, v1: hydra.core.Term) -> Either[hydra.util.DecodingError, hydra.typing.TypeConstraint]:
        match v1:
            case hydra.core.TermRecord(value=record):
                ...
                return hydra.lib.eithers.bind(hydra.extract.helpers.require_field("left", hydra.decode.core.type, field_map, cx), (lambda field_left: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("right", hydra.decode.core.type, field_map, cx), (lambda field_right: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("comment", (lambda cx2, raw2: hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, str], Left(hydra.util.DecodingError(err)))), (lambda stripped2: _hoist_body_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx2, raw2))), field_map, cx), (lambda field_comment: cast(Either[hydra.util.DecodingError, hydra.typing.TypeConstraint], Right(hydra.typing.TypeConstraint(field_left, field_right, field_comment)))))))))
            
            case _:
                return cast(Either[hydra.util.DecodingError, hydra.typing.TypeConstraint], Left(hydra.util.DecodingError("expected record of type hydra.typing.TypeConstraint")))
    return hydra.lib.eithers.either((lambda err: cast(Either[hydra.util.DecodingError, hydra.typing.TypeConstraint], Left(hydra.util.DecodingError(err)))), (lambda stripped: _hoist_hydra_decode_typing_type_constraint_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
