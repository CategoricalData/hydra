...
def literal_type(v1: hydra.core.Term) -> hydra.compute.Flow[hydra.graph.Graph, hydra.core.LiteralType]:
    return hydra.lexical.match_union(hydra.core.Name("hydra.core.LiteralType"), (hydra.lexical.match_unit_field(hydra.core.Name("binary"), hydra.core.LiteralTypeBinary(None)), hydra.lexical.match_unit_field(hydra.core.Name("boolean"), hydra.core.LiteralTypeBoolean(None)), (hydra.core.Name("float"), (lambda ft: hydra.lib.flows.map((lambda x: hydra.core.LiteralTypeFloat(x)), float_type(ft)))), (hydra.core.Name("integer"), (lambda it: hydra.lib.flows.map((lambda x: hydra.core.LiteralTypeInteger(x)), integer_type(it)))), hydra.lexical.match_unit_field(hydra.core.Name("string"), hydra.core.LiteralTypeString(None))), v1)
...
def type(dat: hydra.core.Term) -> hydra.compute.Flow[hydra.graph.Graph, hydra.core.Type]:
    match dat:
        case hydra.core.TermAnnotated(value=annotated_term):
            return hydra.lib.flows.map((lambda t: hydra.core.TypeAnnotated(hydra.core.AnnotatedType(t, annotated_term.annotation))), type(annotated_term.body))
        
        case _:
            return hydra.lexical.match_union(hydra.core.Name("hydra.core.Type"), ((hydra.core.Name("application"), (lambda at: hydra.lib.flows.map((lambda x: hydra.core.TypeApplication(x)), application_type(at)))), (hydra.core.Name("forall"), (lambda ft: hydra.lib.flows.map((lambda x: hydra.core.TypeForall(x)), forall_type(ft)))), (hydra.core.Name("function"), (lambda ft: hydra.lib.flows.map((lambda x: hydra.core.TypeFunction(x)), function_type(ft)))), (hydra.core.Name("list"), (lambda et: hydra.lib.flows.map((lambda x: hydra.core.TypeList(x)), type(et)))), (hydra.core.Name("literal"), (lambda lt: hydra.lib.flows.map((lambda x: hydra.core.TypeLiteral(x)), literal_type(lt)))), (hydra.core.Name("map"), (lambda mt: hydra.lib.flows.map((lambda x: hydra.core.TypeMap(x)), map_type(mt)))), (hydra.core.Name("optional"), (lambda et: hydra.lib.flows.map((lambda x: hydra.core.TypeOptional(x)), type(et)))), (hydra.core.Name("product"), (lambda types: hydra.lib.flows.map((lambda x: hydra.core.TypeProduct(x)), hydra.extract.core.list_of(type, types)))), (hydra.core.Name("record"), (lambda rt: hydra.lib.flows.map((lambda x: hydra.core.TypeRecord(x)), row_type(rt)))), (hydra.core.Name("set"), (lambda et: hydra.lib.flows.map((lambda x: hydra.core.TypeSet(x)), type(et)))), (hydra.core.Name("sum"), (lambda types: hydra.lib.flows.map((lambda x: hydra.core.TypeSum(x)), hydra.extract.core.list_of(type, types)))), (hydra.core.Name("union"), (lambda rt: hydra.lib.flows.map((lambda x: hydra.core.TypeUnion(x)), row_type(rt)))), (hydra.core.Name("unit"), (lambda _: hydra.lib.flows.pure(hydra.core.TypeUnit(None)))), (hydra.core.Name("variable"), (lambda n: hydra.lib.flows.map((lambda x: hydra.core.TypeVariable(x)), name(n)))), (hydra.core.Name("wrap"), (lambda wt: hydra.lib.flows.map((lambda x: hydra.core.TypeWrap(x)), wrapped_type(wt))))), dat)
