...
def join_types[T0](left: hydra.core.Type, right: hydra.core.Type, comment: str) -> hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]]:
    ...
    def assert_equal[T1, T2]() -> hydra.compute.Flow[T1, frozenlist[T2]]:
        return hydra.lib.logic.if_else(hydra.lib.equality.equal(sleft, sright), hydra.lib.flows.pure(cast(frozenlist[T2], ())), cast(hydra.compute.Flow[T1, frozenlist[T2]], cannot_unify))
    def join_list[T1](lefts: frozenlist[hydra.core.Type], rights: frozenlist[hydra.core.Type]) -> hydra.compute.Flow[T1, frozenlist[hydra.typing.TypeConstraint]]:
        return hydra.lib.logic.if_else(hydra.lib.equality.equal(hydra.lib.lists.length(lefts), hydra.lib.lists.length(rights)), hydra.lib.flows.pure(hydra.lib.lists.zip_with(join_one, lefts, rights)), cast(hydra.compute.Flow[T1, frozenlist[hydra.typing.TypeConstraint]], cannot_unify))
    ...
    match sleft:
        ...
        case hydra.core.TypeEither(value=l2):
            match sright:
                case hydra.core.TypeEither(value=r):
                    return hydra.lib.flows.pure((join_one(l2.left, r.left), join_one(l2.right, r.right)))
        ...
        case hydra.core.TypeFunction(value=l3):
            match sright:
                case hydra.core.TypeFunction(value=r):
                    return hydra.lib.flows.pure((join_one(l3.domain, r.domain), join_one(l3.codomain, r.codomain)))
        ...
        case hydra.core.TypeList(value=l4):
            match sright:
                case hydra.core.TypeList(value=r):
                    return hydra.lib.flows.pure((join_one(l4, r),))
                
                case _:
                    return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify)
        
        case hydra.core.TypeLiteral():
            return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], assert_equal)
        
        case hydra.core.TypeMap(value=l5):
            match sright:
                case hydra.core.TypeMap(value=r):
                    return hydra.lib.flows.pure((join_one(l5.keys, r.keys), join_one(l5.values, r.values)))
        ...
        case hydra.core.TypeMaybe(value=l6):
            match sright:
                case hydra.core.TypeMaybe(value=r):
                    return hydra.lib.flows.pure((join_one(l6, r),))
        ...
        case hydra.core.TypePair(value=l7):
            match sright:
                case hydra.core.TypePair(value=r):
                    return hydra.lib.flows.pure((join_one(l7.first, r.first), join_one(l7.second, r.second)))
                
                case _:
                    return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify)
        
        case hydra.core.TypeProduct(value=l8):
            match sright:
                case hydra.core.TypeProduct(value=r):
                    return join_list(l8, r)
                
                case _:
                    return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify)
        
        case hydra.core.TypeRecord(value=l9):
            match sright:
                case hydra.core.TypeRecord(value=r):
                    return join_row_types(l9, r)
                
                case _:
                    return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify)
        
        case hydra.core.TypeSet(value=l10):
            match sright:
                case hydra.core.TypeSet(value=r):
                    return hydra.lib.flows.pure((join_one(l10, r),))
                
                case _:
                    return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify)
        
        case hydra.core.TypeSum(value=l11):
            match sright:
                case hydra.core.TypeSum(value=r):
                    return join_list(l11, r)
                
                case _:
                    return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify)
        
        case hydra.core.TypeUnion(value=l12):
            match sright:
                case hydra.core.TypeUnion(value=r):
                    return join_row_types(l12, r)
        ...
        case hydra.core.TypeUnit():
            match sright:
                case hydra.core.TypeUnit():
                    return hydra.lib.flows.pure(cast(frozenlist[hydra.typing.TypeConstraint], ()))
                
                case _:
                    return cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify)
        
        case hydra.core.TypeWrap(value=l13):
            match sright:
                case hydra.core.TypeWrap(value=r):
                    return hydra.lib.logic.if_else(hydra.lib.equality.equal(l13.type_name.value, r.type_name.value), hydra.lib.flows.pure((join_one(l13.body, r.body),)), cast(hydra.compute.Flow[T0, frozenlist[hydra.typing.TypeConstraint]], cannot_unify))
