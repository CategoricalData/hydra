...
def bimap(key_fun: hydra.core.Term, val_fun: hydra.core.Term, map_term: hydra.core.Term) -> hydra.compute.Flow[T0, hydra.core.Term]:
    match map_term:
        case hydra.core.TermMap(value=m):
            ...
            return hydra.lib.flows.pure(cast(hydra.core.Term, hydra.core.TermMap(hydra.lib.maps.from_list(hydra.lib.lists.map((lambda p: (k := (lambda : hydra.lib.pairs.first(p)), v := (lambda : hydra.lib.pairs.second(p)), (cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(key_fun, k()))), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(val_fun, v())))))[2]), pairs())))))
...
def map(val_fun: hydra.core.Term, map_term: hydra.core.Term) -> hydra.compute.Flow[T0, hydra.core.Term]:
    match map_term:
        case hydra.core.TermMap(value=m):
            def pairs() -> frozenlist[tuple[hydra.core.Term, hydra.core.Term]]:
                return hydra.lib.maps.to_list(m)
            return hydra.lib.flows.pure(cast(hydra.core.Term, hydra.core.TermMap(hydra.lib.maps.from_list(hydra.lib.lists.map((lambda p: (k := (lambda : hydra.lib.pairs.first(p)), v := (lambda : hydra.lib.pairs.second(p)), (k(), cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(val_fun, v())))))[2]), pairs())))))
...
def map_keys(key_fun: hydra.core.Term, map_term: hydra.core.Term) -> hydra.compute.Flow[T0, hydra.core.Term]:
    match map_term:
        case hydra.core.TermMap(value=m):
            def pairs() -> frozenlist[tuple[hydra.core.Term, hydra.core.Term]]:
                return hydra.lib.maps.to_list(m)
            return hydra.lib.flows.pure(cast(hydra.core.Term, hydra.core.TermMap(hydra.lib.maps.from_list(hydra.lib.lists.map((lambda p: (k := (lambda : hydra.lib.pairs.first(p)), v := (lambda : hydra.lib.pairs.second(p)), (cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(key_fun, k()))), v()))[2]), pairs())))))
