...
test_element_arthur = hydra.core.Binding(hydra.core.Name("firstName"), test_data_arthur, cast(Maybe[hydra.core.TypeScheme], Just(hydra.core.TypeScheme(cast(frozenlist[hydra.core.Name], ()), cast(hydra.core.Type, hydra.core.TypeVariable(hydra.test.test_types.test_type_person_name))))))
