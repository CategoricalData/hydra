...
def convert_case(from_: hydra.gen.mantle.CaseConvention, to: hydra.gen.mantle.CaseConvention, original: str) -> str:
    ...
    def parts() -> frozenlist[str]:
        ...
        match from_:
            case hydra.gen.mantle.CaseConvention.CAMEL:
                return by_caps()
            
            case hydra.gen.mantle.CaseConvention.PASCAL:
                return by_caps()
            
            case hydra.gen.mantle.CaseConvention.LOWER_SNAKE:
                return by_underscores
            
            case hydra.gen.mantle.CaseConvention.UPPER_SNAKE:
                return by_underscores
    match to:
        case hydra.gen.mantle.CaseConvention.CAMEL:
...
def convert_case_camel_to_lower_snake(v1: str) -> str:
    ...
    return convert_case(hydra.gen.mantle.CaseConvention.CAMEL, hydra.gen.mantle.CaseConvention.LOWER_SNAKE, v1)

def convert_case_camel_to_upper_snake(v1: str) -> str:
    """Convert a string from camel case to upper snake case."""
    return convert_case(hydra.gen.mantle.CaseConvention.CAMEL, hydra.gen.mantle.CaseConvention.UPPER_SNAKE, v1)

def convert_case_pascal_to_upper_snake(v1: str) -> str:
    """Convert a string from pascal case to upper snake case."""
    return convert_case(hydra.gen.mantle.CaseConvention.PASCAL, hydra.gen.mantle.CaseConvention.UPPER_SNAKE, v1)
