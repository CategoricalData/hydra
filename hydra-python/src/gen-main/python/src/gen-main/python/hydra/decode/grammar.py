...
def grammar(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_grammar_grammar_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.util.DecodingError("expected wrapped type hydra.grammar.Grammar"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.util.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_grammar_grammar_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
