...
def hydra_schema_spec(x: hydra.workflow.HydraSchemaSpec) -> hydra.core.Term:
    return cast(hydra.core.Term, hydra.core.TermRecord(hydra.core.Record(hydra.core.Name("hydra.workflow.HydraSchemaSpec"), (hydra.core.Field(hydra.core.Name("modules"), cast(hydra.core.Term, hydra.core.TermList(hydra.lib.lists.map((lambda x1: hydra.encode.module.module(x1)), x.modules)))), hydra.core.Field(hydra.core.Name("typeName"), hydra.encode.core.name(x.type_name))))))

def schema_spec(v1: hydra.workflow.SchemaSpec) -> hydra.core.Term:
    match v1:
...
def transform_workflow(x: hydra.workflow.TransformWorkflow) -> hydra.core.Term:
