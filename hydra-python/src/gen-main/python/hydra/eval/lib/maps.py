...
def alter(cx: hydra.context.Context, g: T0, fun_term: hydra.core.Term, key_term: hydra.core.Term, map_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
    ...
    match map_term:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "map value"), " but found "), hydra.show.core.term(map_term))))), cx))

def bimap(cx: hydra.context.Context, g: T0, key_fun: hydra.core.Term, val_fun: hydra.core.Term, map_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
...
def filter(cx: hydra.context.Context, g: T0, val_pred: hydra.core.Term, map_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
...
def filter_with_key(cx: hydra.context.Context, g: T0, pred: hydra.core.Term, map_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
...
def map(cx: hydra.context.Context, g: T0, val_fun: hydra.core.Term, map_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
...
def map_keys(cx: hydra.context.Context, g: T0, key_fun: hydra.core.Term, map_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
