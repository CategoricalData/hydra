...
def map(cx: hydra.context.Context, g: hydra.graph.Graph, fun: hydra.core.Term, set_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
