...
def apply(cx: hydra.context.Context, g: T0, fun_opt_term: hydra.core.Term, arg_opt_term: hydra.core.Term):
    def _hoist_hydra_eval_lib_maybes_apply_1(arg_opt_term, cx, mf, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "optional value"), " but found "), hydra.show.core.term(arg_opt_term))))), cx))
    match fun_opt_term:
        case hydra.core.TermMaybe(value=mf):
            return _hoist_hydra_eval_lib_maybes_apply_1(arg_opt_term, cx, mf, arg_opt_term)
        
        case _:
            return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "optional function"), " but found "), hydra.show.core.term(fun_opt_term))))), cx))

def bind(cx: hydra.context.Context, g: T0, opt_term: hydra.core.Term, fun_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
    ...
    match opt_term:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "optional value"), " but found "), hydra.show.core.term(opt_term))))), cx))

def cases(cx: hydra.context.Context, g: T0, opt_term: hydra.core.Term, default_term: hydra.core.Term, fun_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
...
def map(cx: hydra.context.Context, g: T0, fun_term: hydra.core.Term, opt_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
...
def map_maybe(cx: hydra.context.Context, g: hydra.graph.Graph, fun_term: hydra.core.Term, list_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
...
def maybe(cx: hydra.context.Context, g: T0, default_term: hydra.core.Term, fun_term: hydra.core.Term, opt_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
