...
def convert_case(from_: hydra.mantle.CaseConvention, to: hydra.mantle.CaseConvention, original: str) -> str:
    ...
    def parts() -> T247:
        ...
        def by_caps() -> T239:
            def split_on_uppercase(acc: T202, c: T203) -> T224:
...
def convert_case_camel_to_upper_snake(v3: str) -> str:
...
def convert_case_pascal_to_upper_snake(v3: str) -> str:
