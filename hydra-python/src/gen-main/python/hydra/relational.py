...
ColumnName.TYPE_ = hydra.core.Name("hydra.relational.ColumnName")
...
PrimaryKey.TYPE_ = hydra.core.Name("hydra.relational.PrimaryKey")

class Relation(Node["frozenlist[Row[V]]"], Generic[V]):
    r"""A set of distinct n-tuples; a table."""

Relation.TYPE_ = hydra.core.Name("hydra.relational.Relation")

class RelationName(Node[str]):
    r"""A unique relation (table) name."""

RelationName.TYPE_ = hydra.core.Name("hydra.relational.RelationName")
...
class RelationSchema(Generic[T]):
    ...
    PRIMARY_KEYS = hydra.core.Name("primaryKeys")
    FOREIGN_KEYS = hydra.core.Name("foreignKeys")
...
Relationship.TYPE_ = hydra.core.Name("hydra.relational.Relationship")

class Row(Node["frozenlist[V]"], Generic[V]):
    r"""An n-tuple which is an element of a given relation."""

Row.TYPE_ = hydra.core.Name("hydra.relational.Row")
