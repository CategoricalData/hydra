...
SchemaSpecHydra = Annotated[NewType('SchemaSpecHydra', HydraSchemaSpec), 'A native Hydra schema']

SchemaSpecFile = Annotated[NewType('SchemaSpecFile', str), 'A schema provided as a file, available at the given file path']

SchemaSpecProvided = Literal['provided']

SchemaSpec = Annotated[SchemaSpecHydra | SchemaSpecFile | SchemaSpecProvided, 'The specification of a schema at the source end of a workflow']
