...
class ErrorChecking(Node["hydra.errors.checking.CheckingError"]):
    r"""A type checking error"""

class ErrorDecoding(Node["DecodingError"]):
    r"""An error that occurred during decoding of a term"""

class ErrorDuplicateBinding(Node["hydra.errors.core.DuplicateBindingError"]):
    r"""A duplicate binding name error"""

class ErrorDuplicateField(Node["hydra.errors.core.DuplicateFieldError"]):
    r"""A duplicate field name error"""

class ErrorOther(Node["OtherError"]):
    r"""Any other error"""

class ErrorUndefinedField(Node["hydra.errors.core.UndefinedFieldError"]):
    r"""A reference to an undefined field"""

class ErrorUndefinedTerm(Node["hydra.errors.core.UndefinedTermError"]):
    r"""A reference to an undefined term"""

class ErrorUndefinedType(Node["hydra.errors.core.UndefinedTypeError"]):
    r"""A reference to an undefined type"""

class ErrorUnexpectedTermVariant(Node["hydra.errors.core.UnexpectedTermVariantError"]):
    r"""An unexpected term variant"""

class ErrorUnexpectedTypeVariant(Node["hydra.errors.core.UnexpectedTypeVariantError"]):
