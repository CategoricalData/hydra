...
def join_types(cx: hydra.context.Context, left: hydra.core.Type, right: hydra.core.Type, comment: str):
    ...
    @lru_cache(1)
    def cannot_unify() -> Either[hydra.context.InContext[hydra.error.UnificationError], T0]:
        return Left(hydra.context.InContext(hydra.error.UnificationError(sleft(), sright(), hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("cannot unify ", hydra.show.core.type(sleft())), " with "), hydra.show.core.type(sright()))), cx))
    @lru_cache(1)
    def assert_equal() -> Either[hydra.context.InContext[hydra.error.UnificationError], frozenlist[T0]]:
...
def unify_type_constraints(cx: hydra.context.Context, schema_types: FrozenDict[hydra.core.Name, T0], constraints: frozenlist[hydra.typing.TypeConstraint]) -> Either[hydra.context.InContext[hydra.error.UnificationError], hydra.typing.TypeSubst]:
    ...
    def with_constraint(c: hydra.typing.TypeConstraint, rest: frozenlist[hydra.typing.TypeConstraint]):
        ...
        def try_binding(v: hydra.core.Name, t: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.UnificationError], hydra.typing.TypeSubst]:
            return hydra.lib.logic.if_else(variable_occurs_in_type(v, t), (lambda : Left(hydra.context.InContext(hydra.error.UnificationError(sleft(), sright(), hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("Variable ", v.value), " appears free in type "), hydra.show.core.type(t)), " ("), comment), ")")), cx))), (lambda : bind(v, t)))
        @lru_cache(1)
        def no_vars() -> Either[hydra.context.InContext[hydra.error.UnificationError], hydra.typing.TypeSubst]:
            def with_constraints(constraints2: frozenlist[hydra.typing.TypeConstraint]) -> Either[hydra.context.InContext[hydra.error.UnificationError], hydra.typing.TypeSubst]:
        ...
        @lru_cache(1)
        def dflt() -> Either[hydra.context.InContext[hydra.error.UnificationError], hydra.typing.TypeSubst]:
            match sright():
...
def unify_type_lists(cx: hydra.context.Context, schema_types: FrozenDict[hydra.core.Name, T0], l: frozenlist[hydra.core.Type], r: frozenlist[hydra.core.Type], comment: str) -> Either[hydra.context.InContext[hydra.error.UnificationError], hydra.typing.TypeSubst]:
...
def unify_types(cx: hydra.context.Context, schema_types: FrozenDict[hydra.core.Name, T0], l: hydra.core.Type, r: hydra.core.Type, comment: str) -> Either[hydra.context.InContext[hydra.error.UnificationError], hydra.typing.TypeSubst]:
