...
def schema_spec(v1: hydra.workflow.SchemaSpec) -> hydra.core.Type:
    match v1:
        ...
        case hydra.workflow.SchemaSpecFile(value=y2):
            return cast(hydra.core.Term, hydra.core.TermUnion(hydra.core.Injection(hydra.core.Name("hydra.workflow.SchemaSpec"), hydra.core.Field(hydra.core.Name("file"), (lambda x: cast(hydra.core.Term, hydra.core.TermLiteral(cast(hydra.core.Literal, hydra.core.LiteralString(x)))))(y2)))))
