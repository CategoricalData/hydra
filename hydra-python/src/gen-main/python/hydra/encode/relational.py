...
def foreign_key(x: hydra.relational.ForeignKey) -> hydra.core.Type:
    return cast(hydra.core.Term, hydra.core.TermRecord(hydra.core.Record(hydra.core.Name("hydra.relational.ForeignKey"), (hydra.core.Field(hydra.core.Name("foreignRelation"), relation_name(x.foreign_relation)), hydra.core.Field(hydra.core.Name("keys"), cast(hydra.core.Term, hydra.core.TermMap(hydra.lib.maps.bimap(column_name, column_name, x.keys))))))))

def primary_key(x: hydra.relational.PrimaryKey) -> hydra.core.Type:
    return cast(hydra.core.Term, hydra.core.TermWrap(hydra.core.WrappedTerm(hydra.core.Name("hydra.relational.PrimaryKey"), cast(hydra.core.Term, hydra.core.TermList(hydra.lib.lists.map(column_name, x.value))))))
...
def relation_schema(t: Callable[[T0], hydra.core.Term], x: hydra.relational.RelationSchema[T0]) -> hydra.core.Type:
    return cast(hydra.core.Term, hydra.core.TermRecord(hydra.core.Record(hydra.core.Name("hydra.relational.RelationSchema"), (hydra.core.Field(hydra.core.Name("name"), relation_name(x.name)), hydra.core.Field(hydra.core.Name("columns"), cast(hydra.core.Term, hydra.core.TermList(hydra.lib.lists.map((lambda v1: column_schema(t, v1)), x.columns)))), hydra.core.Field(hydra.core.Name("primaryKeys"), cast(hydra.core.Term, hydra.core.TermList(hydra.lib.lists.map(primary_key, x.primary_keys)))), hydra.core.Field(hydra.core.Name("foreignKeys"), cast(hydra.core.Term, hydra.core.TermList(hydra.lib.lists.map(foreign_key, x.foreign_keys))))))))

def relationship(v: Callable[[T0], hydra.core.Term], x: hydra.relational.Relationship[T0]) -> hydra.core.Type:
    return cast(hydra.core.Term, hydra.core.TermWrap(hydra.core.WrappedTerm(hydra.core.Name("hydra.relational.Relationship"), cast(hydra.core.Term, hydra.core.TermSet(hydra.lib.sets.map((lambda m: cast(hydra.core.Term, hydra.core.TermMap(hydra.lib.maps.bimap(column_name, v, m)))), x.value))))))
