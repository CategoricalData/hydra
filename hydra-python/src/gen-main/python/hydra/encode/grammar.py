...
def pattern(v1: hydra.grammar.Pattern) -> hydra.core.Type:
    match v1:
        case hydra.grammar.PatternAlternatives(value=y):
            return cast(hydra.core.Term, hydra.core.TermUnion(hydra.core.Injection(hydra.core.Name("hydra.grammar.Pattern"), hydra.core.Field(hydra.core.Name("alternatives"), (lambda xs: cast(hydra.core.Term, hydra.core.TermList(hydra.lib.lists.map(pattern, xs))))(y)))))
        ...
        case hydra.grammar.PatternSequence(value=y10):
            return cast(hydra.core.Term, hydra.core.TermUnion(hydra.core.Injection(hydra.core.Name("hydra.grammar.Pattern"), hydra.core.Field(hydra.core.Name("sequence"), (lambda xs: cast(hydra.core.Term, hydra.core.TermList(hydra.lib.lists.map(pattern, xs))))(y10)))))
