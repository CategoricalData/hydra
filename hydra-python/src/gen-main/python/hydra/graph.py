...
Comparison = Annotated[ComparisonLessThan | ComparisonEqualTo | ComparisonGreaterThan, 'An equality judgement: less than, equal to, or greater than']
...
TypeClass = Annotated[TypeClassEquality | TypeClassOrdering, 'Any of a small number of built-in type classes']