...
def bigfloat_value(cx: hydra.context.Context, v: hydra.core.FloatValue) -> Either[hydra.context.InContext[hydra.errors.Error], Decimal]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "bigfloat"), " but found "), hydra.show.core.float(v))))), cx))

def float_literal(cx: hydra.context.Context, lit: hydra.core.Literal) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.FloatValue]:
    ...
    match lit:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "floating-point value"), " but found "), hydra.show.core.literal(lit))))), cx))
...
def literal(cx: hydra.context.Context, graph: hydra.graph.Graph, term0: hydra.core.Term):
    def _hoist_hydra_extract_core_literal_1(cx, term, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "literal"), " but found "), hydra.show.core.term(term))))), cx))
...
def bigfloat(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], Decimal]:
...
def bigint_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "bigint"), " but found "), hydra.show.core.integer(v))))), cx))

def integer_literal(cx: hydra.context.Context, lit: hydra.core.Literal) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.IntegerValue]:
    ...
    match lit:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "integer value"), " but found "), hydra.show.core.literal(lit))))), cx))

def bigint(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
...
def binary_literal(cx: hydra.context.Context, v: hydra.core.Literal) -> Either[hydra.context.InContext[hydra.errors.Error], bytes]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "binary"), " but found "), hydra.show.core.literal(v))))), cx))

def binary(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], bytes]:
    r"""Extract a binary data value from a term."""

    return hydra.lib.eithers.bind(literal(cx, graph, t), (lambda l: binary_literal(cx, l)))

def boolean_literal(cx: hydra.context.Context, v: hydra.core.Literal) -> Either[hydra.context.InContext[hydra.errors.Error], bool]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "boolean"), " but found "), hydra.show.core.literal(v))))), cx))

def boolean(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], bool]:
    ...
    def _hoist_hydra_extract_core_cases_1(cx, name, term, v1):
        match v1:
            case hydra.core.EliminationUnion(value=cs):
                return hydra.lib.logic.if_else(hydra.lib.equality.equal(cs.type_name.value, name.value), (lambda : Right(cs)), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", hydra.lib.strings.cat2("case statement for type ", name.value)), " but found "), hydra.show.core.term(term))))), cx))))

            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "case statement"), " but found "), hydra.show.core.term(term))))), cx))
...
def case_field(cx: hydra.context.Context, name: hydra.core.Name, n: str, graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Field]:
...
def either_term(cx: hydra.context.Context, left_fun: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T0]], right_fun: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T1]], graph: hydra.graph.Graph, term0: hydra.core.Term):
    def _hoist_hydra_extract_core_either_term_1(cx, left_fun, right_fun, term, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "either value"), " but found "), hydra.show.core.term(term))))), cx))
...
def either_type(cx: hydra.context.Context, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.EitherType]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "either type"), " but found "), hydra.show.core.type(typ))))), cx))

def field(cx: hydra.context.Context, fname: hydra.core.Name, mapping: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T0]], graph: hydra.graph.Graph, fields: frozenlist[hydra.core.Field]) -> Either[hydra.context.InContext[hydra.errors.Error], T0]:
    ...
    return hydra.lib.logic.if_else(hydra.lib.lists.null(matching_fields()), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", hydra.lib.strings.cat2("field ", fname.value)), " but found "), "no matching field")))), cx))), (lambda : hydra.lib.logic.if_else(hydra.lib.equality.equal(hydra.lib.lists.length(matching_fields()), 1), (lambda : hydra.lib.eithers.bind(hydra.lexical.strip_and_dereference_term(cx, graph, hydra.lib.lists.head(matching_fields()).term), (lambda stripped: mapping(stripped)))), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "single field"), " but found "), hydra.lib.strings.cat2("multiple fields named ", fname.value))))), cx))))))

def float32_value(cx: hydra.context.Context, v: hydra.core.FloatValue) -> Either[hydra.context.InContext[hydra.errors.Error], float]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "float32"), " but found "), hydra.show.core.float(v))))), cx))
...
def float64_value(cx: hydra.context.Context, v: hydra.core.FloatValue) -> Either[hydra.context.InContext[hydra.errors.Error], float]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "float64"), " but found "), hydra.show.core.float(v))))), cx))

def float64(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], float]:
...
def float_value(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.FloatValue]:
    r"""Extract a float value from a term."""

    return hydra.lib.eithers.bind(literal(cx, graph, t), (lambda l: float_literal(cx, l)))

def function_type(cx: hydra.context.Context, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.FunctionType]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "function type"), " but found "), hydra.show.core.type(typ))))), cx))
    ...
    def _hoist_hydra_extract_core_injection_1(cx, expected, term, v1):
        match v1:
            case hydra.core.TermUnion(value=injection):
                return hydra.lib.logic.if_else(hydra.lib.equality.equal(injection.type_name.value, expected.value), (lambda : Right(injection.field)), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", hydra.lib.strings.cat2("injection of type ", expected.value)), " but found "), injection.type_name.value)))), cx))))

            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "injection"), " but found "), hydra.show.core.term(term))))), cx))
...
def int16_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "int16"), " but found "), hydra.show.core.integer(v))))), cx))

def int16(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
...
def int32_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "int32"), " but found "), hydra.show.core.integer(v))))), cx))
...
def int64_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "int64"), " but found "), hydra.show.core.integer(v))))), cx))

def int64(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
...
def int8_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "int8"), " but found "), hydra.show.core.integer(v))))), cx))

def int8(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
...
def integer_value(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.IntegerValue]:
...
def lambda_(cx: hydra.context.Context, graph: hydra.graph.Graph, term0: hydra.core.Term):
    def _hoist_hydra_extract_core_lambda_1(cx, term, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "lambda"), " but found "), hydra.show.core.term(term))))), cx))
...
def lambda_body(cx: hydra.context.Context, graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]:
...
def let(cx: hydra.context.Context, graph: hydra.graph.Graph, term0: hydra.core.Term):
    def _hoist_hydra_extract_core_let_1(cx, term, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "let term"), " but found "), hydra.show.core.term(term))))), cx))
...
def let_binding(cx: hydra.context.Context, n: str, graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]:
    r"""Extract a binding with the given name from a let term."""

    name = hydra.core.Name(n)
    return hydra.lib.eithers.bind(let(cx, graph, term), (lambda let_expr: (matching_bindings := hydra.lib.lists.filter((lambda b: hydra.lib.equality.equal(b.name.value, name.value)), let_expr.bindings), hydra.lib.logic.if_else(hydra.lib.lists.null(matching_bindings), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2("no such binding: ", n)))), cx))), (lambda : hydra.lib.logic.if_else(hydra.lib.equality.equal(hydra.lib.lists.length(matching_bindings), 1), (lambda : Right(hydra.lib.lists.head(matching_bindings).term)), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2("multiple bindings named ", n)))), cx)))))))[1]))
...
def list(cx: hydra.context.Context, graph: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_core_list_1(cx, stripped, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "list"), " but found "), hydra.show.core.term(stripped))))), cx))
...
def list_head(cx: hydra.context.Context, graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Term]:
    r"""Extract the first element of a list term."""

    return hydra.lib.eithers.bind(list(cx, graph, term), (lambda l: hydra.lib.logic.if_else(hydra.lib.lists.null(l), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("empty list"))), cx))), (lambda : Right(hydra.lib.lists.head(l))))))

def list_of(cx: hydra.context.Context, f: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T0]], graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[T0]]:
...
def list_type(cx: hydra.context.Context, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "list type"), " but found "), hydra.show.core.type(typ))))), cx))

def map(cx: hydra.context.Context, fk: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T0]], fv: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T1]], graph: hydra.graph.Graph, term0: hydra.core.Term):
    r"""Extract a map of key-value pairs from a term, mapping functions over each key and value."""

    def pair(kv_pair: tuple[hydra.core.Term, hydra.core.Term]) -> Either[hydra.context.InContext[hydra.errors.Error], tuple[T0, T1]]:
        @lru_cache(1)
...
def map_type(cx: hydra.context.Context, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.MapType]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "map type"), " but found "), hydra.show.core.type(typ))))), cx))

def maybe_term(cx: hydra.context.Context, f: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T0]], graph: hydra.graph.Graph, term0: hydra.core.Term):
    def _hoist_hydra_extract_core_maybe_term_1(cx, f, term, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "maybe value"), " but found "), hydra.show.core.term(term))))), cx))
...
def maybe_type(cx: hydra.context.Context, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "maybe type"), " but found "), hydra.show.core.type(typ))))), cx))

def n_args(cx: hydra.context.Context, name: hydra.core.Name, n: int, args: frozenlist[T0]) -> Either[hydra.context.InContext[hydra.errors.Error], None]:
    r"""Ensure a function has the expected number of arguments."""

    return hydra.lib.logic.if_else(hydra.lib.equality.equal(hydra.lib.lists.length(args), n), (lambda : Right(None)), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", hydra.lib.strings.cat((hydra.lib.literals.show_int32(n), " arguments to primitive ", hydra.lib.literals.show_string(name.value)))), " but found "), hydra.lib.literals.show_int32(hydra.lib.lists.length(args)))))), cx))))

def pair(cx: hydra.context.Context, kf: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T0]], vf: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T1]], graph: hydra.graph.Graph, term0: hydra.core.Term):
    def _hoist_hydra_extract_core_pair_1(cx, kf, term, vf, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "pair"), " but found "), hydra.show.core.term(term))))), cx))
...
def term_record(cx: hydra.context.Context, graph: hydra.graph.Graph, term0: hydra.core.Term):
    def _hoist_hydra_extract_core_term_record_1(cx, term, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "record"), " but found "), hydra.show.core.term(term))))), cx))
...
def record(cx: hydra.context.Context, expected: hydra.core.Name, graph: hydra.graph.Graph, term0: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[hydra.core.Field]]:
    r"""Extract a record's fields from a term."""

    return hydra.lib.eithers.bind(term_record(cx, graph, term0), (lambda record: hydra.lib.logic.if_else(hydra.lib.equality.equal(record.type_name, expected), (lambda : Right(record.fields)), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", hydra.lib.strings.cat2("record of type ", expected.value)), " but found "), record.type_name.value)))), cx))))))

def record_type(cx: hydra.context.Context, ename: T0, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[hydra.core.FieldType]]:
...
def set(cx: hydra.context.Context, graph: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_core_set_1(cx, stripped, v1):
        match v1:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "set"), " but found "), hydra.show.core.term(stripped))))), cx))
...
def set_of(cx: hydra.context.Context, f: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.errors.Error], T0]], graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], frozenset[T0]]:
...
def set_type(cx: hydra.context.Context, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "set type"), " but found "), hydra.show.core.type(typ))))), cx))

def string_literal(cx: hydra.context.Context, v: hydra.core.Literal) -> Either[hydra.context.InContext[hydra.errors.Error], str]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "string"), " but found "), hydra.show.core.literal(v))))), cx))

def string(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], str]:
...
def uint16_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "uint16"), " but found "), hydra.show.core.integer(v))))), cx))
...
def uint32_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "uint32"), " but found "), hydra.show.core.integer(v))))), cx))

def uint32(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
...
def uint64_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "uint64"), " but found "), hydra.show.core.integer(v))))), cx))

def uint64(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
...
def uint8_value(cx: hydra.context.Context, v: hydra.core.IntegerValue) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
    ...
    match v:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "uint8"), " but found "), hydra.show.core.integer(v))))), cx))

def uint8(cx: hydra.context.Context, graph: hydra.graph.Graph, t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], int]:
...
def union_type(cx: hydra.context.Context, ename: T0, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[hydra.core.FieldType]]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "union type"), " but found "), hydra.show.core.type(typ))))), cx))

def unit(cx: hydra.context.Context, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], None]:
    ...
    match term:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "unit"), " but found "), hydra.show.core.term(term))))), cx))

def unit_variant(cx: hydra.context.Context, tname: hydra.core.Name, graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Name]:
    ...
    def _hoist_hydra_extract_core_wrap_1(cx, expected, term, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.logic.if_else(hydra.lib.equality.equal(wrapped_term.type_name.value, expected.value), (lambda : Right(wrapped_term.body)), (lambda : Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", hydra.lib.strings.cat2("wrapper of type ", expected.value)), " but found "), wrapped_term.type_name.value)))), cx))))

            case _:
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", hydra.lib.strings.cat2(hydra.lib.strings.cat2("wrap(", expected.value), ")")), " but found "), hydra.show.core.term(term))))), cx))
...
def wrapped_type(cx: hydra.context.Context, ename: T0, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.core.Type]:
    ...
    match stripped():
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("expected ", "wrapped type"), " but found "), hydra.show.core.type(typ))))), cx))
