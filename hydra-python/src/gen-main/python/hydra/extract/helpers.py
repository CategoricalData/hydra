...
def decode_either(left_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], right_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T1]], g: hydra.graph.Graph, term: hydra.core.Term):
...
def decode_list(elem_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
...
def decode_map(key_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], val_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T1]], g: hydra.graph.Graph, term: hydra.core.Term):
...
def decode_maybe(elem_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
...
def decode_pair(first_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], second_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T1]], g: hydra.graph.Graph, term: hydra.core.Term):
...
def decode_set(elem_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
...
def decode_wrapped(body_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.error.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
...
def require_field(field_name: str, decoder: Callable[[T0, T1], Either[hydra.error.DecodingError, T2]], field_map: FrozenDict[hydra.core.Name, T1], g: T0) -> Either[hydra.error.DecodingError, T2]:
    ...
    return hydra.lib.maybes.maybe(Left(hydra.error.DecodingError(hydra.lib.strings.cat(("missing field ", field_name, " in record")))), (lambda field_term: decoder(g, field_term)), hydra.lib.maps.lookup(hydra.core.Name(field_name), field_map))
