...
def decode_either(left_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], right_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T1]], g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_either_1(g, left_decoder, right_decoder, v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_either_1(g, left_decoder, right_decoder, stripped)))
...
def decode_list(elem_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_list_1(elem_decoder, g, v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_list_1(elem_decoder, g, stripped)))
...
def decode_map(key_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], val_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T1]], g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_map_1(g, key_decoder, val_decoder, v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_map_1(g, key_decoder, val_decoder, stripped)))
...
def decode_maybe(elem_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_maybe_1(elem_decoder, g, v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_maybe_1(elem_decoder, g, stripped)))
...
def decode_pair(first_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], second_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T1]], g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_pair_1(first_decoder, g, second_decoder, v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_pair_1(first_decoder, g, second_decoder, stripped)))
...
def decode_set(elem_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_set_1(elem_decoder, g, v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_set_1(elem_decoder, g, stripped)))

def decode_unit(g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_unit_1(v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_unit_1(stripped)))
...
def decode_wrapped(body_decoder: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], g: hydra.graph.Graph, term: hydra.core.Term):
    def _hoist_hydra_extract_helpers_decode_wrapped_1(body_decoder, g, v1):
        match v1:
    ...
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x: hydra.errors.DecodingError(x)), (lambda x: x), hydra.lexical.strip_and_dereference_term_either(g, term)), (lambda stripped: _hoist_hydra_extract_helpers_decode_wrapped_1(body_decoder, g, stripped)))
