...
def bind_constraints(cx: hydra.graph.Graph, f: Callable[[hydra.typing.TypeSubst], hydra.compute.Flow[T0, T1]], constraints: frozenlist[hydra.typing.TypeConstraint]) -> hydra.compute.Flow[T0, T1]:
    r"""Bind type constraints and continue with substitution."""
...
def finalize_inferred_term(cx: hydra.graph.Graph, term: hydra.core.Term) -> hydra.compute.Flow[T0, hydra.core.Term]:
...
def map_constraints(cx: hydra.graph.Graph, f: Callable[[hydra.typing.TypeSubst], T0], constraints: frozenlist[hydra.typing.TypeConstraint]) -> hydra.compute.Flow[T1, T0]:
...
def infer_type_of_projection(cx: hydra.graph.Graph, proj: hydra.core.Projection) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a record projection."""
    
    tname = proj.type_name
    fname = proj.field
    return hydra.lib.flows.bind(hydra.schemas.require_schema_type(cx.schema_types, tname), (lambda schema_type: (svars := schema_type.variables, stype := schema_type.type, hydra.lib.flows.bind(hydra.extract.core.record_type(tname, stype), (lambda sfields: hydra.lib.flows.bind(hydra.schemas.find_field_type(fname, sfields), (lambda ftyp: hydra.lib.flows.pure(yield_(build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationRecord(hydra.core.Projection(tname, fname)))))))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), ftyp))), hydra.substitution.id_type_subst())))))))[2]))

def infer_type_of_unwrap(cx: hydra.graph.Graph, tname: hydra.core.Name) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of an unwrap operation."""
    
    return hydra.lib.flows.bind(hydra.schemas.require_schema_type(cx.schema_types, tname), (lambda schema_type: (svars := schema_type.variables, stype := schema_type.type, hydra.lib.flows.bind(hydra.extract.core.wrapped_type(tname, stype), (lambda wtyp: hydra.lib.flows.pure(yield_(build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationWrap(tname))))))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), wtyp))), hydra.substitution.id_type_subst())))))[2]))
...
def infer_type_of_primitive(cx: hydra.graph.Graph, name: hydra.core.Name) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a primitive function. Class constraints from the primitive's type scheme are propagated to the inference result."""
    
    return hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("No such primitive: ", name.value)), (lambda scheme: hydra.lib.flows.bind(hydra.schemas.instantiate_type_scheme(scheme), (lambda ts: (constraints := hydra.lib.maybes.from_maybe(hydra.lib.maps.empty(), ts.constraints), yield_checked_with_constraints(build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionPrimitive(name))))), ts.type, hydra.substitution.id_type_subst(), constraints))[1]))), hydra.lib.maybes.map((lambda v1: v1.type), hydra.lib.maps.lookup(name, cx.primitives)))
...
@lru_cache(1)
def infer_type_of_unit() -> hydra.typing.InferenceResult:
...
def infer_type_of_variable(cx: hydra.graph.Graph, name: hydra.core.Name) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a variable."""
    
    return hydra.lib.maybes.maybe(hydra.lib.flows.fail(hydra.lib.strings.cat2("Variable not bound to type: ", name.value)), (lambda scheme: hydra.lib.flows.bind(hydra.schemas.instantiate_type_scheme(scheme), (lambda ts: (constraints := hydra.lib.maybes.from_maybe(hydra.lib.maps.empty(), ts.constraints), hydra.lib.flows.pure(hydra.typing.InferenceResult(build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermVariable(name))), ts.type, hydra.substitution.id_type_subst(), constraints)))[1]))), hydra.lib.maps.lookup(name, cx.bound_types))

def infer_many(cx: hydra.graph.Graph, pairs: frozenlist[tuple[hydra.core.Term, str]]) -> hydra.compute.Flow[T0, tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], hydra.typing.TypeSubst]]]:
    r"""Infer types for multiple terms."""
...
def infer_type_of_annotated_term(cx: hydra.graph.Graph, at: hydra.core.AnnotatedTerm) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of an annotated term."""
...
def infer_type_of_application(cx: hydra.graph.Graph, app: hydra.core.Application) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a function application."""
...
def infer_type_of_case_statement(cx: hydra.graph.Graph, case_stmt: hydra.core.CaseStatement) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a case statement."""
...
def infer_type_of_either(cx: hydra.graph.Graph, e: Either[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of an either value."""
...
def infer_type_of_elimination(cx: hydra.graph.Graph, elm: hydra.core.Elimination) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of an elimination."""
...
def infer_type_of_function(cx: hydra.graph.Graph, f: hydra.core.Function) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a function."""
...
def infer_type_of_injection(cx: hydra.graph.Graph, injection: hydra.core.Injection) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a union injection."""
    
    tname = injection.type_name
    field = injection.field
    fname = field.name
    term = field.term
    return hydra.lib.flows.bind(infer_type_of_term(cx, term, "injected term"), (lambda result: hydra.lib.flows.bind(hydra.schemas.require_schema_type(cx.schema_types, tname), (lambda schema_type: (svars := schema_type.variables, stype := schema_type.type, iterm := result.term, ityp := result.type, isubst := result.subst, hydra.lib.flows.bind(hydra.extract.core.union_type(tname, stype), (lambda sfields: hydra.lib.flows.bind(hydra.schemas.find_field_type(fname, sfields), (lambda ftyp: map_constraints(cx, (lambda subst: yield_(build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermUnion(hydra.core.Injection(tname, hydra.core.Field(fname, iterm))))), hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), hydra.substitution.compose_type_subst(isubst, subst))), (hydra.typing.TypeConstraint(ftyp, ityp, "schema type of injected field"),)))))))[5]))))

def infer_type_of_lambda(cx: hydra.graph.Graph, lambda_: hydra.core.Lambda) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a lambda function."""
...
def infer_type_of_let(cx: hydra.graph.Graph, let0: hydra.core.Let) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Normalize a let term before inferring its type."""
    ...
    def rewrite_result(result: hydra.typing.InferenceResult) -> hydra.typing.InferenceResult:
        ...
        itype = result.type
        isubst = result.subst
        iconstraints = result.class_constraints
    ...
    return hydra.lib.flows.map((lambda x1: rewrite_result(x1)), res())

def infer_type_of_let_normalized(cx0: hydra.graph.Graph, let_term: hydra.core.Let) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a let (letrec) term which is already in a normal form."""
...
def infer_type_of_map(cx: hydra.graph.Graph, m: FrozenDict[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a map."""
...
def infer_type_of_optional(cx: hydra.graph.Graph, m: Maybe[hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of an optional."""
    ...
    return infer_type_of_collection(cx, (lambda x: cast(hydra.core.Type, hydra.core.TypeMaybe(x))), (lambda x1: trm_cons(x1)), "optional element", hydra.lib.maybes.maybe((), (lambda x1: hydra.lib.lists.singleton(x1)), m))

def infer_type_of_pair(cx: hydra.graph.Graph, p: tuple[hydra.core.Term, hydra.core.Term]) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a pair."""
...
def infer_type_of_record(cx: hydra.graph.Graph, record: hydra.core.Record) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a record."""
...
def infer_type_of_term(cx: hydra.graph.Graph, term: hydra.core.Term, desc: str) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a given term."""
...
def infer_type_of_type_application(cx: hydra.graph.Graph, tt: hydra.core.TypeApplicationTerm) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a type application; just pass through to the inner term."""
    
    return infer_type_of_term(cx, tt.body, "type application term")

def infer_type_of_type_lambda(cx: hydra.graph.Graph, ta: hydra.core.TypeLambda) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a type abstraction; just pass through to the lambda body."""
    
    return infer_type_of_term(cx, ta.body, "type abstraction")

def infer_type_of_wrapped_term(cx: hydra.graph.Graph, wt: hydra.core.WrappedTerm) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a wrapped term."""
...
def infer_types_of_temporary_bindings(cx: hydra.graph.Graph, bins: frozenlist[hydra.core.Binding]) -> hydra.compute.Flow[T0, tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]]]]:
    r"""Infer types for temporary let bindings. Returns a 4-tuple of (terms, types, substitution, accumulated constraints)."""
...
def for_inferred_term(cx: hydra.graph.Graph, term: hydra.core.Term, desc: str, f: Callable[[hydra.typing.InferenceResult], T0]) -> hydra.compute.Flow[T1, T0]:
    r"""Infer a term's type and map over the result."""
    
    return hydra.lib.flows.map(f, infer_type_of_term(cx, term, desc))

def infer_graph_types(bindings0: frozenlist[hydra.core.Binding], g0: hydra.graph.Graph) -> hydra.compute.Flow[T0, tuple[hydra.graph.Graph, frozenlist[hydra.core.Binding]]]:
    ...
    def from_let_term(l: hydra.core.Let) -> tuple[hydra.graph.Graph, frozenlist[hydra.core.Binding]]:
        ...
        return (g(), bindings)
    def for_final(finalized: hydra.core.Term) -> hydra.compute.Flow[T1, tuple[hydra.graph.Graph, frozenlist[hydra.core.Binding]]]:
        match finalized:
            case hydra.core.TermLet(value=l):
            ...
            case _:
                raise TypeError("Unsupported Term")
    return hydra.monads.with_trace("graph inference", hydra.lib.flows.bind(infer_type_of_term(g0, cast(hydra.core.Term, hydra.core.TermLet(let0())), "graph term"), (lambda result: (term := result.term, ts := result.type, hydra.lib.flows.bind(finalize_inferred_term(g0, term), (lambda finalized: for_final(finalized))))[2])))

def infer_in_graph_context(cx: hydra.graph.Graph, term: hydra.core.Term) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    r"""Infer the type of a term in a given inference context."""
    
    return infer_type_of_term(cx, term, "single term")

def infer_type_of(cx: hydra.graph.Graph, term: hydra.core.Term) -> hydra.compute.Flow[T0, tuple[hydra.core.Term, hydra.core.TypeScheme]]:
...
def yield_with_constraints(term: hydra.core.Term, typ: hydra.core.Type, subst: hydra.typing.TypeSubst, constraints: FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]) -> hydra.typing.InferenceResult:
