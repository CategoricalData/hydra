...
def bind_constraints(flow_cx: hydra.context.Context, cx: hydra.graph.Graph, constraints: frozenlist[hydra.typing.TypeConstraint]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.TypeSubst]:
    r"""Unify type constraints and check the substitution."""
    
    return hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda _ic: hydra.context.InContext(hydra.error.OtherError(_ic.object.message), _ic.context)), (lambda _a: _a), hydra.unification.unify_type_constraints(flow_cx, cx.schema_types, constraints)), (lambda s: hydra.lib.eithers.bind(hydra.checking.check_type_subst(flow_cx, cx, s), (lambda _: Right(s)))))
...
def finalize_inferred_term(flow_cx: hydra.context.Context, cx: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
    ...
    return hydra.lib.eithers.bind(hydra.checking.check_for_unbound_type_variables(flow_cx, cx, term2()), (lambda _: Right(hydra.rewriting.normalize_type_variables_in_term(term2()))))
...
def fresh_variable_type(cx: hydra.context.Context) -> tuple[hydra.core.Type, hydra.context.Context]:
    ...
    def result() -> tuple[hydra.core.Name, hydra.context.Context]:
        return hydra.schemas.fresh_name(cx)
    @lru_cache(1)
...
def map_constraints(flow_cx: hydra.context.Context, cx: hydra.graph.Graph, f: Callable[[hydra.typing.TypeSubst], T0], constraints: frozenlist[hydra.typing.TypeConstraint]) -> Either[hydra.context.InContext[hydra.error.OtherError], T0]:
...
def infer_type_of_projection(fcx: hydra.context.Context, cx: hydra.graph.Graph, proj: hydra.core.Projection) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a record projection (Either version)."""
    
    tname = proj.type_name
    fname = proj.field
    return hydra.lib.eithers.bind(hydra.schemas.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.type, hydra.lib.eithers.bind(hydra.extract.core.record_type(fcx2, tname, stype), (lambda sfields: hydra.lib.eithers.bind(hydra.schemas.find_field_type(fcx2, fname, sfields), (lambda ftyp: Right(yield_(fcx2, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationRecord(hydra.core.Projection(tname, fname)))))))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), ftyp))), hydra.substitution.id_type_subst())))))))[4]))

def infer_type_of_unwrap(fcx: hydra.context.Context, cx: hydra.graph.Graph, tname: hydra.core.Name) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of an unwrap operation (Either version)."""
    
    return hydra.lib.eithers.bind(hydra.schemas.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.type, hydra.lib.eithers.bind(hydra.extract.core.wrapped_type(fcx2, tname, stype), (lambda wtyp: Right(yield_(fcx2, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationWrap(tname))))))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), wtyp))), hydra.substitution.id_type_subst())))))[4]))
...
def free_variables_in_context(cx: hydra.graph.Graph) -> frozenset[hydra.core.Name]:
    ...
    return hydra.lib.lists.foldl((lambda x1, x2: hydra.lib.sets.union(x1, x2)), hydra.lib.sets.empty(), hydra.lib.lists.map((lambda x1: hydra.rewriting.free_variables_in_type_scheme_simple(x1)), hydra.lib.maps.elems(cx.bound_types)))
...
def infer_type_of_primitive(fcx: hydra.context.Context, cx: hydra.graph.Graph, name: hydra.core.Name) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a primitive function (Either version)."""
    
    return hydra.lib.maybes.maybe(Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat2("No such primitive: ", name.value)), fcx)), (lambda scheme: (ts_result := hydra.schemas.instantiate_type_scheme(fcx, scheme), ts := hydra.lib.pairs.first(ts_result), fcx2 := hydra.lib.pairs.second(ts_result), constraints := hydra.lib.maybes.from_maybe(hydra.lib.maps.empty(), ts.constraints), Right(yield_checked_with_constraints(fcx2, build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionPrimitive(name))))), ts.type, hydra.substitution.id_type_subst(), constraints)))[4]), hydra.lib.maybes.map((lambda v1: v1.type), hydra.lib.maps.lookup(name, cx.primitives)))
...
def infer_type_of_variable(fcx: hydra.context.Context, cx: hydra.graph.Graph, name: hydra.core.Name) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a variable (Either version)."""
    
    return hydra.lib.maybes.maybe(Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat2("Variable not bound to type: ", name.value)), fcx)), (lambda scheme: (ts_result := hydra.schemas.instantiate_type_scheme(fcx, scheme), ts := hydra.lib.pairs.first(ts_result), fcx2 := hydra.lib.pairs.second(ts_result), constraints := hydra.lib.maybes.from_maybe(hydra.lib.maps.empty(), ts.constraints), Right(hydra.typing.InferenceResult(build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermVariable(name))), ts.type, hydra.substitution.id_type_subst(), constraints, fcx2)))[4]), hydra.lib.maps.lookup(name, cx.bound_types))

def infer_many(fcx: hydra.context.Context, cx: hydra.graph.Graph, pairs: frozenlist[tuple[hydra.core.Term, str]]) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], hydra.typing.TypeSubst]], hydra.context.Context]]:
    r"""Infer types for multiple terms (Either version)."""
    
    @lru_cache(1)
    def dflt() -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], hydra.typing.TypeSubst]], hydra.context.Context]]:
        @lru_cache(1)
        ...
        return hydra.lib.eithers.bind(infer_type_of_term(fcx, cx, e(), desc()), (lambda result1: (fcx2 := result1.context, e1 := result1.term, t1 := result1.type, s1 := result1.subst, hydra.lib.eithers.bind(infer_many(fcx2, hydra.substitution.subst_in_context(s1, cx), tl()), (lambda rp2: (result2 := hydra.lib.pairs.first(rp2), fcx3 := hydra.lib.pairs.second(rp2), e2 := hydra.lib.pairs.first(result2), t2 := hydra.lib.pairs.first(hydra.lib.pairs.second(result2)), s2 := hydra.lib.pairs.second(hydra.lib.pairs.second(result2)), Right(((hydra.lib.lists.cons(hydra.substitution.subst_types_in_term(s2, e1), e2), (hydra.lib.lists.cons(hydra.substitution.subst_in_type(s2, t1), t2), hydra.substitution.compose_type_subst(s1, s2))), fcx3)))[5])))[4]))
    return hydra.lib.logic.if_else(hydra.lib.lists.null(pairs), (lambda : Right((((), ((), hydra.substitution.id_type_subst())), fcx))), (lambda : dflt()))

def infer_type_of_annotated_term(fcx: hydra.context.Context, cx: hydra.graph.Graph, at: hydra.core.AnnotatedTerm) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
...
def infer_type_of_application(fcx0: hydra.context.Context, cx: hydra.graph.Graph, app: hydra.core.Application) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
...
def infer_type_of_case_statement(fcx: hydra.context.Context, cx: hydra.graph.Graph, case_stmt: hydra.core.CaseStatement) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    ...
    return hydra.lib.eithers.bind(hydra.schemas.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.type, hydra.lib.eithers.bind(hydra.extract.core.union_type(fcx2, tname, stype), (lambda sfields: hydra.lib.eithers.bind(hydra.lib.eithers.map_maybe((lambda t: infer_type_of_term(fcx2, cx, t, hydra.lib.strings.cat(("case ", tname.value, ".<default>")))), dflt), (lambda dflt_rp: (dflt_result := dflt_rp, fcx3 := hydra.lib.maybes.from_maybe(fcx2, hydra.lib.maybes.map((lambda v1: v1.context), dflt_rp)), hydra.lib.eithers.bind(infer_many(fcx3, cx, hydra.lib.lists.map((lambda f: (f.term, hydra.lib.strings.cat(("case ", tname.value, ".", f.name.value)))), cases)), (lambda case_rp: (case_results := hydra.lib.pairs.first(case_rp), fcx4 := hydra.lib.pairs.second(case_rp), iterms := hydra.lib.pairs.first(case_results), itypes := hydra.lib.pairs.first(hydra.lib.pairs.second(case_results)), isubst := hydra.lib.pairs.second(hydra.lib.pairs.second(case_results)), codv_result := hydra.schemas.fresh_name(fcx4), codv := hydra.lib.pairs.first(codv_result), fcx5 := hydra.lib.pairs.second(codv_result), cod := cast(hydra.core.Type, hydra.core.TypeVariable(codv)), case_map := hydra.lib.maps.from_list(hydra.lib.lists.map((lambda ft: (ft.name, ft.type)), sfields)), dflt_constraints := hydra.monads.maybe_to_list(hydra.lib.maybes.map((lambda r: hydra.typing.TypeConstraint(cod, hydra.substitution.subst_in_type(isubst, r.type), "match default")), dflt_result)), case_constraints := hydra.lib.maybes.cat(hydra.lib.lists.zip_with((lambda fname, itype: hydra.lib.maybes.map((lambda ftype: hydra.typing.TypeConstraint(itype, cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(ftype, cod))), "case type")), hydra.lib.maps.lookup(fname, case_map))), fnames(), itypes)), hydra.lib.eithers.bind(map_constraints(fcx5, cx, (lambda subst: yield_(fcx5, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationUnion(hydra.core.CaseStatement(tname, hydra.lib.maybes.map((lambda v1: v1.term), dflt_result), hydra.lib.lists.zip_with((lambda n, t: hydra.core.Field(n, t)), fnames(), iterms))))))))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), cod))), hydra.substitution.compose_type_subst_list(hydra.lib.lists.concat((hydra.monads.maybe_to_list(hydra.lib.maybes.map((lambda v1: v1.subst), dflt_result)), (isubst, subst)))))), hydra.lib.lists.concat((dflt_constraints, case_constraints))), (lambda mc_result: Right(mc_result))))[12])))[2])))))[4]))

def infer_type_of_collection(fcx: hydra.context.Context, cx: hydra.graph.Graph, typ_cons: Callable[[hydra.core.Type], hydra.core.Type], trm_cons: Callable[[frozenlist[hydra.core.Term]], hydra.core.Term], desc: str, els: frozenlist[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a collection (Either version)."""
    
    @lru_cache(1)
    def var_result() -> tuple[hydra.core.Name, hydra.context.Context]:
        return hydra.schemas.fresh_name(fcx)
    @lru_cache(1)
    ...
    return hydra.lib.logic.if_else(hydra.lib.lists.null(els), (lambda : Right(yield_(fcx2(), build_type_application_term((var(),), trm_cons(())), typ_cons(cast(hydra.core.Type, hydra.core.TypeVariable(var()))), hydra.substitution.id_type_subst()))), (lambda : hydra.lib.eithers.bind(infer_many(fcx2(), cx, hydra.lib.lists.zip(els, hydra.lib.lists.map((lambda i: hydra.lib.strings.cat(("#", hydra.lib.literals.show_int32(i)))), hydra.lib.math.range_(1, hydra.lib.math.add(hydra.lib.lists.length(els), 1))))), (lambda results_rp: (results := hydra.lib.pairs.first(results_rp), fcx3 := hydra.lib.pairs.second(results_rp), terms := hydra.lib.pairs.first(results), types := hydra.lib.pairs.first(hydra.lib.pairs.second(results)), subst1 := hydra.lib.pairs.second(hydra.lib.pairs.second(results)), constraints := hydra.lib.lists.map((lambda t: hydra.typing.TypeConstraint(cast(hydra.core.Type, hydra.core.TypeVariable(var())), t, desc)), types), hydra.lib.eithers.bind(map_constraints(fcx3, cx, (lambda subst2: (iterm := trm_cons(terms), itype := typ_cons(cast(hydra.core.Type, hydra.core.TypeVariable(var()))), isubst := hydra.substitution.compose_type_subst(subst1, subst2), yield_(fcx3, iterm, itype, isubst))[3]), constraints), (lambda mc_result: Right(mc_result))))[6]))))

def infer_type_of_either(fcx: hydra.context.Context, cx: hydra.graph.Graph, e: Either[hydra.core.Term, hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
...
def infer_type_of_elimination(fcx: hydra.context.Context, cx: hydra.graph.Graph, elm: hydra.core.Elimination) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
...
def infer_type_of_function(fcx: hydra.context.Context, cx: hydra.graph.Graph, f: hydra.core.Function) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
...
def infer_type_of_injection(fcx: hydra.context.Context, cx: hydra.graph.Graph, injection: hydra.core.Injection) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    ...
    fname = field.name
    term = field.term
    return hydra.lib.eithers.bind(infer_type_of_term(fcx, cx, term, "injected term"), (lambda result: (fcx2 := result.context, hydra.lib.eithers.bind(hydra.schemas.require_schema_type(fcx2, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx3 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.type, iterm := result.term, ityp := result.type, isubst := result.subst, hydra.lib.eithers.bind(hydra.extract.core.union_type(fcx3, tname, stype), (lambda sfields: hydra.lib.eithers.bind(hydra.schemas.find_field_type(fcx3, fname, sfields), (lambda ftyp: hydra.lib.eithers.bind(map_constraints(fcx3, cx, (lambda subst: yield_(fcx3, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermUnion(hydra.core.Injection(tname, hydra.core.Field(fname, iterm))))), hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), hydra.substitution.compose_type_subst(isubst, subst))), (hydra.typing.TypeConstraint(ftyp, ityp, "schema type of injected field"),)), (lambda mc_result: Right(mc_result))))))))[7])))[1]))

def infer_type_of_lambda(fcx: hydra.context.Context, cx: hydra.graph.Graph, lambda_: hydra.core.Lambda) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
...
def infer_type_of_let(fcx0: hydra.context.Context, cx: hydra.graph.Graph, let0: hydra.core.Let) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    ...
    @lru_cache(1)
    def res() -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
        match rewritten_let():
            case hydra.core.TermLet(value=l):
...
def infer_type_of_let_normalized(fcx0: hydra.context.Context, cx0: hydra.graph.Graph, let_term: hydra.core.Let) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    ...
    def bvars_result() -> tuple[frozenlist[hydra.core.Name], hydra.context.Context]:
        return hydra.schemas.fresh_names(hydra.lib.lists.length(bins0), fcx())
    @lru_cache(1)
...
def infer_type_of_map(fcx: hydra.context.Context, cx: hydra.graph.Graph, m: FrozenDict[hydra.core.Term, hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    ...
    def vvar_result() -> tuple[hydra.core.Name, hydra.context.Context]:
        return hydra.schemas.fresh_name(fcx2())
    @lru_cache(1)
    ...
    return hydra.lib.logic.if_else(hydra.lib.maps.null(m), (lambda : Right(yield_(fcx3(), build_type_application_term((kvar(), vvar()), cast(hydra.core.Term, hydra.core.TermMap(hydra.lib.maps.empty()))), cast(hydra.core.Type, hydra.core.TypeMap(hydra.core.MapType(cast(hydra.core.Type, hydra.core.TypeVariable(kvar())), cast(hydra.core.Type, hydra.core.TypeVariable(vvar()))))), hydra.substitution.id_type_subst()))), (lambda : hydra.lib.eithers.bind(infer_many(fcx3(), cx, hydra.lib.lists.map((lambda k: (k, "map key")), hydra.lib.maps.keys(m))), (lambda k_rp: (k_results := hydra.lib.pairs.first(k_rp), fcx4 := hydra.lib.pairs.second(k_rp), kterms := hydra.lib.pairs.first(k_results), ktypes := hydra.lib.pairs.first(hydra.lib.pairs.second(k_results)), ksubst := hydra.lib.pairs.second(hydra.lib.pairs.second(k_results)), hydra.lib.eithers.bind(infer_many(fcx4, cx, hydra.lib.lists.map((lambda v: (v, "map value")), hydra.lib.maps.elems(m))), (lambda v_rp: (v_results := hydra.lib.pairs.first(v_rp), fcx5 := hydra.lib.pairs.second(v_rp), vterms := hydra.lib.pairs.first(v_results), vtypes := hydra.lib.pairs.first(hydra.lib.pairs.second(v_results)), vsubst := hydra.lib.pairs.second(hydra.lib.pairs.second(v_results)), kcons := hydra.lib.lists.map((lambda t: hydra.typing.TypeConstraint(cast(hydra.core.Type, hydra.core.TypeVariable(kvar())), t, "map key")), ktypes), vcons := hydra.lib.lists.map((lambda t: hydra.typing.TypeConstraint(cast(hydra.core.Type, hydra.core.TypeVariable(vvar())), t, "map value")), vtypes), hydra.lib.eithers.bind(map_constraints(fcx5, cx, (lambda subst: yield_(fcx5, cast(hydra.core.Term, hydra.core.TermMap(hydra.lib.maps.from_list(hydra.lib.lists.zip(kterms, vterms)))), cast(hydra.core.Type, hydra.core.TypeMap(hydra.core.MapType(cast(hydra.core.Type, hydra.core.TypeVariable(kvar())), cast(hydra.core.Type, hydra.core.TypeVariable(vvar()))))), hydra.substitution.compose_type_subst_list((ksubst, vsubst, subst)))), hydra.lib.lists.concat((kcons, vcons))), (lambda mc_result: Right(mc_result))))[7])))[5]))))

def infer_type_of_optional(fcx: hydra.context.Context, cx: hydra.graph.Graph, m: Maybe[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of an optional (Either version)."""
    ...
    return infer_type_of_collection(fcx, cx, (lambda x: cast(hydra.core.Type, hydra.core.TypeMaybe(x))), (lambda x1: trm_cons(x1)), "optional element", hydra.lib.maybes.maybe((), (lambda x1: hydra.lib.lists.singleton(x1)), m))

def infer_type_of_pair(fcx: hydra.context.Context, cx: hydra.graph.Graph, p: tuple[hydra.core.Term, hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a pair (Either version)."""
    
    return hydra.lib.eithers.bind(infer_many(fcx, cx, ((hydra.lib.pairs.first(p), "pair first element"), (hydra.lib.pairs.second(p), "pair second element"))), (lambda rp: (results := hydra.lib.pairs.first(rp), fcx2 := hydra.lib.pairs.second(rp), iterms := hydra.lib.pairs.first(results), itypes := hydra.lib.pairs.first(hydra.lib.pairs.second(results)), isubst := hydra.lib.pairs.second(hydra.lib.pairs.second(results)), ifst := hydra.lib.lists.head(iterms), isnd := hydra.lib.lists.head(hydra.lib.lists.tail(iterms)), ty_fst := hydra.lib.lists.head(itypes), ty_snd := hydra.lib.lists.head(hydra.lib.lists.tail(itypes)), pair_term := cast(hydra.core.Term, hydra.core.TermPair((ifst, isnd))), term_with_types := cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(cast(hydra.core.Term, hydra.core.TermTypeApplication(hydra.core.TypeApplicationTerm(pair_term, ty_fst))), ty_snd))), Right(yield_(fcx2, term_with_types, cast(hydra.core.Type, hydra.core.TypePair(hydra.core.PairType(ty_fst, ty_snd))), isubst)))[11]))

def infer_type_of_record(fcx: hydra.context.Context, cx: hydra.graph.Graph, record: hydra.core.Record) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    ...
    return hydra.lib.eithers.bind(hydra.schemas.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), hydra.lib.eithers.bind(infer_many(fcx2, cx, hydra.lib.lists.map((lambda f: (f.term, hydra.lib.strings.cat2("field ", f.name.value))), fields)), (lambda rp: (results := hydra.lib.pairs.first(rp), fcx3 := hydra.lib.pairs.second(rp), svars := schema_type.variables, stype := schema_type.type, iterms := hydra.lib.pairs.first(results), itypes := hydra.lib.pairs.first(hydra.lib.pairs.second(results)), isubst := hydra.lib.pairs.second(hydra.lib.pairs.second(results)), ityp := cast(hydra.core.Type, hydra.core.TypeRecord(hydra.core.RowType(tname, hydra.lib.lists.zip_with((lambda n, t: hydra.core.FieldType(n, t)), fnames(), itypes)))), hydra.lib.eithers.bind(map_constraints(fcx3, cx, (lambda subst: yield_(fcx3, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermRecord(hydra.core.Record(tname, hydra.lib.lists.zip_with((lambda n, t: hydra.core.Field(n, t)), fnames(), iterms))))), hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), hydra.substitution.compose_type_subst(isubst, subst))), (hydra.typing.TypeConstraint(stype, ityp, "schema type of record"),)), (lambda mc_result: Right(mc_result))))[8])))[2]))

def infer_type_of_set(fcx: hydra.context.Context, cx: hydra.graph.Graph, s: frozenset[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a set (Either version)."""
    
    return infer_type_of_collection(fcx, cx, (lambda x: cast(hydra.core.Type, hydra.core.TypeSet(x))), (lambda terms: cast(hydra.core.Term, hydra.core.TermSet(hydra.lib.sets.from_list(terms)))), "set element", hydra.lib.sets.to_list(s))

def infer_type_of_term(fcx: hydra.context.Context, cx: hydra.graph.Graph, term: hydra.core.Term, desc: str) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
...
def infer_type_of_type_application(fcx: hydra.context.Context, cx: hydra.graph.Graph, tt: hydra.core.TypeApplicationTerm) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a type application (Either version)."""
    
    return infer_type_of_term(fcx, cx, tt.body, "type application term")

def infer_type_of_type_lambda(fcx: hydra.context.Context, cx: hydra.graph.Graph, ta: hydra.core.TypeLambda) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a type abstraction (Either version)."""
    
    return infer_type_of_term(fcx, cx, ta.body, "type abstraction")

def infer_type_of_wrapped_term(fcx: hydra.context.Context, cx: hydra.graph.Graph, wt: hydra.core.WrappedTerm) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a wrapped term (Either version)."""
    
    tname = wt.type_name
    term = wt.body
    return hydra.lib.eithers.bind(hydra.schemas.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), hydra.lib.eithers.bind(infer_type_of_term(fcx2, cx, term, "wrapped term"), (lambda result: (fcx3 := result.context, svars := schema_type.variables, stype := schema_type.type, iterm := result.term, itype := result.type, isubst := result.subst, ityp := cast(hydra.core.Type, hydra.core.TypeWrap(hydra.core.WrappedType(tname, itype))), hydra.lib.eithers.bind(map_constraints(fcx3, cx, (lambda subst: yield_(fcx3, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermWrap(hydra.core.WrappedTerm(tname, iterm)))), hydra.schemas.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), hydra.substitution.compose_type_subst(isubst, subst))), (hydra.typing.TypeConstraint(stype, ityp, "schema type of wrapper"),)), (lambda mc_result: Right(mc_result))))[7])))[2]))

def infer_types_of_temporary_bindings(fcx: hydra.context.Context, cx: hydra.graph.Graph, bins: frozenlist[hydra.core.Binding]) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]]], hydra.context.Context]]:
    r"""Infer types for temporary let bindings (Either version)."""
    
    @lru_cache(1)
    def dflt() -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[tuple[frozenlist[hydra.core.Term], tuple[frozenlist[hydra.core.Type], tuple[hydra.typing.TypeSubst, FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]]]], hydra.context.Context]]:
        @lru_cache(1)
        ...
        return hydra.lib.eithers.bind(infer_type_of_term(fcx, cx, v, hydra.lib.strings.cat(("temporary let binding '", k.value, "'"))), (lambda result1: (fcx2 := result1.context, j := result1.term, u_prime := result1.type, u := result1.subst, c1_inferred := result1.class_constraints, hydra.lib.eithers.bind(hydra.lib.maybes.maybe(Right(hydra.lib.maps.empty()), (lambda ts: (ts_result := hydra.schemas.instantiate_type_scheme(fcx2, ts), instantiated_ts := hydra.lib.pairs.first(ts_result), fresh_constraints := hydra.lib.maybes.from_maybe(hydra.lib.maps.empty(), instantiated_ts.constraints), hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda _ic: hydra.context.InContext(hydra.error.OtherError(_ic.object.message), _ic.context)), (lambda _a: _a), hydra.unification.unify_types(fcx2, cx.schema_types, instantiated_ts.type, u_prime, "original binding type")), (lambda unify_subst: Right(hydra.substitution.subst_in_class_constraints(unify_subst, fresh_constraints)))))[3]), binding().type), (lambda original_binding_constraints: (c1 := merge_class_constraints(c1_inferred, original_binding_constraints), hydra.lib.eithers.bind(infer_types_of_temporary_bindings(fcx2, hydra.substitution.subst_in_context(u, cx), tl()), (lambda rp2: (result2 := hydra.lib.pairs.first(rp2), fcx3 := hydra.lib.pairs.second(rp2), h := hydra.lib.pairs.first(result2), r_prime := hydra.lib.pairs.first(hydra.lib.pairs.second(result2)), rest_pair := hydra.lib.pairs.second(hydra.lib.pairs.second(result2)), r := hydra.lib.pairs.first(rest_pair), c2 := hydra.lib.pairs.second(rest_pair), c1_subst := hydra.substitution.subst_in_class_constraints(r, c1), merged_constraints := merge_class_constraints(c1_subst, c2), Right(((hydra.lib.lists.cons(hydra.substitution.subst_types_in_term(r, j), h), (hydra.lib.lists.cons(hydra.substitution.subst_in_type(r, u_prime), r_prime), (hydra.substitution.compose_type_subst(u, r), merged_constraints))), fcx3)))[9])))[1])))[5]))
    return hydra.lib.logic.if_else(hydra.lib.lists.null(bins), (lambda : Right((((), ((), (hydra.substitution.id_type_subst(), hydra.lib.maps.empty()))), fcx))), (lambda : dflt()))

def for_inferred_term(fcx: hydra.context.Context, cx: hydra.graph.Graph, term: hydra.core.Term, desc: str, f: Callable[[hydra.typing.InferenceResult], T0]) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[T0, hydra.context.Context]]:
...
def infer_graph_types(fcx0: hydra.context.Context, bindings0: frozenlist[hydra.core.Binding], g0: hydra.graph.Graph):
    ...
    def from_let_term(l: hydra.core.Let) -> tuple[hydra.graph.Graph, frozenlist[hydra.core.Binding]]:
        ...
        return (g(), bindings)
    return hydra.lib.eithers.bind(infer_type_of_term(fcx(), g0, cast(hydra.core.Term, hydra.core.TermLet(let0())), "graph term"), (lambda result: (fcx2 := result.context, term := result.term, _hoist_body_1 := (lambda v1: (lambda l: Right((from_let_term(l), fcx2)))(v1.value) if isinstance(v1, hydra.core.TermLet) else (lambda _: Left(hydra.context.InContext(hydra.error.OtherError("Expected inferred graph as let term"), fcx2)))(v1.value) if isinstance(v1, hydra.core.TermVariable) else hydra.dsl.python.unsupported("no matching case in inline union elimination")), hydra.lib.eithers.bind(finalize_inferred_term(fcx2, g0, term), (lambda finalized: _hoist_body_1(finalized))))[3]))

def infer_in_graph_context(fcx: hydra.context.Context, cx: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
    r"""Infer the type of a term in a given inference context."""
    
    return infer_type_of_term(fcx, cx, term, "single term")

def infer_type_of(fcx: hydra.context.Context, cx: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[tuple[hydra.core.Term, hydra.core.TypeScheme], hydra.context.Context]]:
...
def yield_debug(fcx: hydra.context.Context, cx: T0, debug_id: str, term: hydra.core.Term, typ: hydra.core.Type, subst: hydra.typing.TypeSubst) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.typing.InferenceResult]:
