...
def finalize_inferred_term(flow_cx: T0, cx: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.errors.Error, hydra.core.Term]:
...
def map_constraints(flow_cx: T0, cx: hydra.graph.Graph, f: Callable[[hydra.typing.TypeSubst], T1], constraints: frozenlist[hydra.typing.TypeConstraint]) -> Either[hydra.errors.Error, T1]:
...
def infer_type_of_projection(fcx: hydra.context.Context, cx: hydra.graph.Graph, proj: hydra.core.Projection) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    r"""Infer the type of a record projection (Either version)."""

    tname = proj.type_name
    fname = proj.field
    return hydra.lib.eithers.bind(hydra.resolution.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.type, hydra.lib.eithers.bind(hydra.extract.core.record_type(tname, stype), (lambda sfields: hydra.lib.eithers.bind(hydra.resolution.find_field_type(fcx2, fname, sfields), (lambda ftyp: Right(yield_(fcx2, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationRecord(hydra.core.Projection(tname, fname)))))))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.resolution.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), ftyp))), hydra.substitution.id_type_subst())))))))[4]))

def infer_type_of_unwrap(fcx: hydra.context.Context, cx: hydra.graph.Graph, tname: hydra.core.Name) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    r"""Infer the type of an unwrap operation (Either version)."""

    return hydra.lib.eithers.bind(hydra.resolution.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.type, hydra.lib.eithers.bind(hydra.extract.core.wrapped_type(tname, stype), (lambda wtyp: Right(yield_(fcx2, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermFunction(cast(hydra.core.Function, hydra.core.FunctionElimination(cast(hydra.core.Elimination, hydra.core.EliminationWrap(tname))))))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.resolution.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), wtyp))), hydra.substitution.id_type_subst())))))[4]))
...
def infer_type_of_annotated_term(fcx: hydra.context.Context, cx: hydra.graph.Graph, at: hydra.core.AnnotatedTerm) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_application(fcx0: hydra.context.Context, cx: hydra.graph.Graph, app: hydra.core.Application) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_either(fcx: hydra.context.Context, cx: hydra.graph.Graph, e: Either[hydra.core.Term, hydra.core.Term]) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_elimination(fcx: hydra.context.Context, cx: hydra.graph.Graph, elm: hydra.core.Elimination) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_function(fcx: hydra.context.Context, cx: hydra.graph.Graph, f: hydra.core.Function) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_injection(fcx: hydra.context.Context, cx: hydra.graph.Graph, injection: hydra.core.Injection) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_let(fcx0: hydra.context.Context, cx: hydra.graph.Graph, let0: hydra.core.Let) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    ...
    @lru_cache(1)
    def res() -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
        match rewritten_let():
            case hydra.core.TermLet(value=l):
...
def infer_type_of_let_normalized(fcx0: hydra.context.Context, cx0: hydra.graph.Graph, let_term: hydra.core.Let) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_map(fcx: hydra.context.Context, cx: hydra.graph.Graph, m: FrozenDict[hydra.core.Term, hydra.core.Term]) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_optional(fcx: hydra.context.Context, cx: hydra.graph.Graph, m: Maybe[hydra.core.Term]) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_set(fcx: hydra.context.Context, cx: hydra.graph.Graph, s: frozenset[hydra.core.Term]) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_term(fcx: hydra.context.Context, cx: hydra.graph.Graph, term: hydra.core.Term, desc: str) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_type_application(fcx: hydra.context.Context, cx: hydra.graph.Graph, tt: hydra.core.TypeApplicationTerm) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    r"""Infer the type of a type application (Either version)."""

    return infer_type_of_term(fcx, cx, tt.body, "type application term")

def infer_type_of_type_lambda(fcx: hydra.context.Context, cx: hydra.graph.Graph, ta: hydra.core.TypeLambda) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    r"""Infer the type of a type abstraction (Either version)."""

    return infer_type_of_term(fcx, cx, ta.body, "type abstraction")

def infer_type_of_wrapped_term(fcx: hydra.context.Context, cx: hydra.graph.Graph, wt: hydra.core.WrappedTerm) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
...
def infer_type_of_primitive(fcx: hydra.context.Context, cx: hydra.graph.Graph, name: hydra.core.Name) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    ...
    return hydra.lib.maybes.maybe((lambda : Left(cast(hydra.errors.Error, hydra.errors.ErrorResolution(cast(hydra.errors.ResolutionError, hydra.errors.ResolutionErrorNoSuchPrimitive(hydra.errors.NoSuchPrimitiveError(name))))))), (lambda scheme: (ts_result := hydra.resolution.instantiate_type_scheme(fcx, scheme), ts := hydra.lib.pairs.first(ts_result), fcx2 := hydra.lib.pairs.second(ts_result), constraints := hydra.lib.maybes.from_maybe((lambda : hydra.lib.maps.empty()), ts.constraints), Right(yield_checked_with_constraints(fcx2, build_type_application_term(ts.variables, cast(hydra.core.Term, hydra.core.TermVariable(name))), ts.type, hydra.substitution.id_type_subst(), constraints)))[4]), hydra.lib.maybes.map((lambda v1: v1.type), hydra.lib.maps.lookup(name, cx.primitives)))
...
def yield_debug(fcx: hydra.context.Context, cx: T0, debug_id: str, term: hydra.core.Term, typ: hydra.core.Type, subst: hydra.typing.TypeSubst) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
