...
@lru_cache(1)
def empty_inference_context() -> hydra.typing.InferenceContext:
...
def free_variables_in_context(cx: hydra.typing.InferenceContext) -> frozenset[hydra.core.Name]:
    ...
    return hydra.lib.lists.foldl((lambda x1, x2: hydra.lib.sets.union(x1, x2)), hydra.lib.sets.empty(), hydra.lib.lists.map((lambda x1: hydra.rewriting.free_variables_in_type_scheme_simple(x1)), hydra.lib.maps.elems(cx.data_types)))
...
def infer_type_of_application(cx: hydra.typing.InferenceContext, app: hydra.core.Application) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    @lru_cache(1)
    def e0() -> hydra.core.Term:
        return app.function
    @lru_cache(1)
    def e1() -> hydra.core.Term:
        return app.argument
...
def infer_type_of_let(cx: hydra.typing.InferenceContext, let0: hydra.core.Let) -> hydra.compute.Flow[T0, hydra.typing.InferenceResult]:
    ...
    def rewrite_result(result: hydra.typing.InferenceResult) -> hydra.typing.InferenceResult:
        ...
        def itype() -> hydra.core.Type:
            return result.type
        @lru_cache(1)
        def isubst() -> hydra.typing.TypeSubst:
            return result.subst
        @lru_cache(1)
        def iconstraints() -> FrozenDict[hydra.core.Name, hydra.core.TypeVariableMetadata]:
...
def infer_graph_types(g0: hydra.graph.Graph) -> hydra.compute.Flow[T0, hydra.graph.Graph]:
    ...
    def to_let_term(g: hydra.graph.Graph) -> hydra.core.Term:
        ...
        return cast(hydra.core.Term, hydra.core.TermLet(hydra.core.Let(hydra.lib.lists.map((lambda x1: to_binding(x1)), g.elements), g.body)))
...
def infer_type_of(cx: hydra.typing.InferenceContext, term: hydra.core.Term) -> hydra.compute.Flow[T0, tuple[hydra.core.Term, hydra.core.TypeScheme]]:
    r"""Infer the type of a term and return a type scheme."""
...
def initial_type_context(g: hydra.graph.Graph) -> hydra.compute.Flow[T0, hydra.typing.TypeContext]:
    r"""Create an initial type context from a graph."""
