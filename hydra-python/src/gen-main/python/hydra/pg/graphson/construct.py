...
def edge_property_to_graphson(encode_value: Callable[[T0], Either[T1, T2]], prop: tuple[hydra.pg.model.PropertyKey, T0]) -> Either[T1, tuple[hydra.pg.graphson.syntax.PropertyKey, T2]]:
...
def adjacent_edge_to_graphson(encode_value: Callable[[T0], Either[T1, hydra.pg.graphson.syntax.Value]], edge: hydra.pg.model.AdjacentEdge[T0]) -> Either[T1, tuple[hydra.pg.graphson.syntax.EdgeLabel, hydra.pg.graphson.syntax.AdjacentEdge]]:
...
def pg_vertex_with_adjacent_edges_to_graphson_vertex(encode_value: Callable[[T0], Either[T1, hydra.pg.graphson.syntax.Value]], vae: hydra.pg.model.VertexWithAdjacentEdges[T0]) -> Either[T1, hydra.pg.graphson.syntax.Vertex]:
...
def pg_vertex_with_adjacent_edges_to_json(encode_value: Callable[[T0], Either[T1, hydra.pg.graphson.syntax.Value]], vertex: hydra.pg.model.VertexWithAdjacentEdges[T0]) -> Either[T1, hydra.json.model.Value]:
