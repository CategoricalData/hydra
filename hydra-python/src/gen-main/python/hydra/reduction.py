...
def eta_expand_term_new(tx0: hydra.graph.Graph, term0: hydra.core.Term) -> hydra.core.Term:
    ...
    def domain_types(n: int, mt: Maybe[hydra.core.Type]):
        ...
        return hydra.lib.logic.if_else(hydra.lib.equality.lte(n, 0), (lambda : ()), (lambda : hydra.lib.maybes.maybe(hydra.lib.lists.map((lambda _: Nothing()), hydra.lib.math.range_(1, n)), (lambda typ: _hoist_domain_types_1(n, typ)), mt)))
    def peel_function_domains(mtyp: Maybe[hydra.core.Type], n: int):
        def _hoist_peel_function_domains_1(n, v1):
            match v1:
                ...
                case _:
                    return Nothing()
        return hydra.lib.logic.if_else(hydra.lib.equality.lte(n, 0), (lambda : mtyp), (lambda : hydra.lib.maybes.maybe(Nothing(), (lambda typ: _hoist_peel_function_domains_1(n, typ)), mtyp)))
...
def eta_expand_typed_term(cx: hydra.context.Context, tx0: hydra.graph.Graph, term0: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
    ...
    def rewrite(top_level: bool, forced: bool, type_args: frozenlist[hydra.core.Type], recurse: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]], tx: hydra.graph.Graph, term: hydra.core.Term):
        def rewrite_spine(term2: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
            match term2:
                case hydra.core.TermAnnotated(value=at):
        ...
        def arity_of(tx2: hydra.graph.Graph, term2: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], int]:
            while True:
                @lru_cache(1)
                def dflt() -> Either[hydra.context.InContext[hydra.error.OtherError], int]:
                ...
                def for_function(tx3: hydra.graph.Graph, f: hydra.core.Function) -> Either[hydra.context.InContext[hydra.error.OtherError], int]:
                    match f:
                        case hydra.core.FunctionElimination():
                            return Right(1)
                ...
                match term2:
                    ...
                    case hydra.core.TermLet(value=l):
                        return (txl := hydra.schemas.extend_graph_for_let((lambda _, _2: Nothing()), tx2, l), arity_of(txl, l.body))[1]
        ...
        def force_expansion(t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
        ...
        def recurse_or_force(term2: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
            return hydra.lib.logic.if_else(forced, (lambda : force_expansion(term2)), (lambda : recurse(tx, unwind(term2))))
        def for_case(f: hydra.core.Field) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Field]:
            return hydra.lib.eithers.bind(rewrite(False, True, (), recurse, tx, f.term), (lambda r: Right(hydra.core.Field(f.name, r))))
        def for_case_statement(cs: hydra.core.CaseStatement) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
            tname = cs.type_name
            dflt = cs.default
            cases = cs.cases
        ...
        def for_elimination(elm: hydra.core.Elimination) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
            def check_base(elm2: hydra.core.Elimination) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
                match elm2:
                    case hydra.core.EliminationUnion(value=cs):
...
def reduce_term(cx: hydra.context.Context, graph: hydra.graph.Graph, eager: bool, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
    r"""A term evaluation function which is alternatively lazy or eager."""
    
    def reduce(eager2: bool, v1: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
    ...
    def reduce_arg(eager2: bool, arg: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
    ...
    def map_error_to_other_error(ic: hydra.context.InContext[hydra.error.Error]):
        def _hoist_map_error_to_other_error_1(v1):
            match v1:
                case hydra.error.ErrorDecoding(value=_de):
                    return _de.value
                
                case hydra.error.ErrorOther(value=_oe):
                    return _oe.value
                
                case hydra.error.ErrorUnification(value=_ue):
                    return _ue.message
                
                case _:
                    raise AssertionError("Unreachable: all variants handled")
        return hydra.context.InContext(hydra.error.OtherError(_hoist_map_error_to_other_error_1(ic.object)), ic.context)
    def apply_elimination(elm: hydra.core.Elimination, reduced_arg: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
        match elm:
            case hydra.core.EliminationRecord(value=proj):
                return hydra.lib.eithers.bind(hydra.extract.core.record(cx, proj.type_name, graph, hydra.rewriting.deannotate_term(reduced_arg)), (lambda fields: (matching_fields := hydra.lib.lists.filter((lambda f: hydra.lib.equality.equal(f.name, proj.field)), fields), hydra.lib.logic.if_else(hydra.lib.lists.null(matching_fields), (lambda : Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("no such field: ", proj.field.value, " in ", proj.type_name.value, " record"))), cx))), (lambda : Right(hydra.lib.lists.head(matching_fields).term))))[1]))
            
            case hydra.core.EliminationUnion(value=cs):
                return hydra.lib.eithers.bind(hydra.extract.core.injection(cx, cs.type_name, graph, reduced_arg), (lambda field: (matching_fields := hydra.lib.lists.filter((lambda f: hydra.lib.equality.equal(f.name, field.name)), cs.cases), hydra.lib.logic.if_else(hydra.lib.lists.null(matching_fields), (lambda : hydra.lib.maybes.maybe(Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("no such field ", field.name.value, " in ", cs.type_name.value, " case statement"))), cx)), (lambda x: Right(x)), cs.default)), (lambda : Right(cast(hydra.core.Term, hydra.core.TermApplication(hydra.core.Application(hydra.lib.lists.head(matching_fields).term, field.term)))))))[1]))
    ...
    def apply_if_nullary(eager2: bool, original: hydra.core.Term, args: frozenlist[hydra.core.Term]):
        ...
        def for_elimination(elm: hydra.core.Elimination, args2: frozenlist[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
            @lru_cache(1)
        ...
        def for_lambda(l: hydra.core.Lambda, args2: frozenlist[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
            param = l.parameter
            body = l.body
            @lru_cache(1)
            def arg() -> hydra.core.Term:
        ...
        def for_primitive(prim: hydra.graph.Primitive, arity: int, args2: frozenlist[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
            @lru_cache(1)
            ...
            return hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda v1: reduce_arg(eager2, v1)), arg_list()), (lambda reduced_args: (stripped_args := hydra.lib.lists.map((lambda x1: hydra.rewriting.deannotate_term(x1)), reduced_args), hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda x1: map_error_to_other_error(x1)), (lambda x: x), prim.implementation(cx, graph, stripped_args)), (lambda prim_result: hydra.lib.eithers.bind(reduce(eager2, prim_result), (lambda reduced_result: apply_if_nullary(eager2, reduced_result, remaining_args()))))))[1]))
        def _hoist_body_1(v1):
            match v1:
                case hydra.core.FunctionElimination(value=elm):
        ...
        match stripped():
            ...
            case hydra.core.TermVariable(value=v):
                ...
                return hydra.lib.maybes.maybe(Right(apply_to_arguments(original, args)), (lambda binding: apply_if_nullary(eager2, binding.term, args)), m_binding())
    ...
    def mapping(recurse: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]], mid: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Term]:
