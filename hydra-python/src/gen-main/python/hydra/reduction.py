...
def beta_reduce_type(cx: hydra.context.Context, graph: hydra.graph.Graph, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type]:
    r"""Eagerly beta-reduce a type by substituting type arguments into type lambdas."""
    
    def reduce_app(app: hydra.core.ApplicationType) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type]:
        lhs = app.function
        rhs = app.argument
        match lhs:
    ...
    def map_expr(recurse: Callable[[T0], Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type]], t: T0) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Type]:
...
def eta_expand_typed_term(cx: hydra.context.Context, tx0: hydra.graph.Graph, term0: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
    ...
    def rewrite(top_level: bool, forced: bool, type_args: frozenlist[hydra.core.Type], recurse: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]], tx: hydra.graph.Graph, term: hydra.core.Term):
        def rewrite_spine(term2: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
            match term2:
                case hydra.core.TermAnnotated(value=at):
        ...
        def arity_of(tx2: hydra.graph.Graph, term2: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], int]:
            while True:
                @lru_cache(1)
                def dflt() -> Either[hydra.context.InContext[hydra.error.Error], int]:
                ...
                def for_function(tx3: hydra.graph.Graph, f: hydra.core.Function) -> Either[hydra.context.InContext[hydra.error.Error], int]:
                    match f:
                        case hydra.core.FunctionElimination():
                            return Right(1)
        ...
        def force_expansion(t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
        ...
        def recurse_or_force(term2: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
            return hydra.lib.logic.if_else(forced, (lambda : force_expansion(term2)), (lambda : recurse(tx, unwind(term2))))
        def for_case(f: hydra.core.Field) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Field]:
            return hydra.lib.eithers.bind(rewrite(False, True, (), recurse, tx, f.term), (lambda r: Right(hydra.core.Field(f.name, r))))
        def for_case_statement(cs: hydra.core.CaseStatement) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
            tname = cs.type_name
            dflt = cs.default
            cases = cs.cases
        ...
        def for_elimination(elm: hydra.core.Elimination) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
            def check_base(elm2: hydra.core.Elimination) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
                match elm2:
                    case hydra.core.EliminationUnion(value=cs):
...
def reduce_term(cx: hydra.context.Context, graph: hydra.graph.Graph, eager: bool, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
    r"""A term evaluation function which is alternatively lazy or eager."""
    
    def reduce(eager2: bool, v1: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
    ...
    def reduce_arg(eager2: bool, arg: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
    ...
    def apply_if_nullary(eager2: bool, original: hydra.core.Term, args: frozenlist[hydra.core.Term]):
        ...
        def for_elimination(elm: hydra.core.Elimination, args2: frozenlist[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
            @lru_cache(1)
        ...
        def for_lambda(l: hydra.core.Lambda, args2: frozenlist[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
            param = l.parameter
            body = l.body
            @lru_cache(1)
            def arg() -> hydra.core.Term:
        ...
        def for_primitive(prim: hydra.graph.Primitive, arity: int, args2: frozenlist[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
            @lru_cache(1)
    ...
    def mapping(recurse: Callable[[hydra.core.Term], Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]], mid: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
