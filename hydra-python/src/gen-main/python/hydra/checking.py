...
def apply_type_arguments_to_type(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], t: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Type]:
    r"""Apply type arguments to a type, substituting forall-bound variables."""
    
    @lru_cache(1)
    def nonnull() -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Type]:
        match t:
...
def check_for_unbound_type_variables(cx: hydra.context.Context, tx: hydra.graph.Graph, term0: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], None]:
    ...
    def check_recursive(vars: frozenset[hydra.core.Name], trace: frozenlist[str], lbinding: Maybe[hydra.core.Binding], term: hydra.core.Term):
        def recurse(v1: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], None]:
            return check_recursive(vars, trace, lbinding, v1)
        @lru_cache(1)
        def dflt() -> Either[hydra.context.InContext[hydra.error.OtherError], None]:
        ...
        def check(typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.OtherError], None]:
            @lru_cache(1)
            ...
            return hydra.lib.logic.if_else(hydra.lib.sets.null(badvars()), (lambda : Right(None)), (lambda : Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("unbound type variables: {", hydra.lib.strings.intercalate(", ", hydra.lib.lists.map((lambda v1: v1.value), hydra.lib.sets.to_list(badvars())))), "} in type "), hydra.show.core.type(typ)), " at path: "), hydra.lib.strings.intercalate(" >> ", hydra.lib.lists.reverse(trace))), hydra.lib.maybes.maybe("none", (lambda binding: hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(". bound term = ", hydra.show.core.term(binding.term)), ". bound type = "), hydra.lib.maybes.maybe("none", (lambda x1: hydra.show.core.type_scheme(x1)), binding.type))), lbinding))), cx))))
        def check_optional(m: Maybe[hydra.core.Type]) -> Either[hydra.context.InContext[hydra.error.OtherError], None]:
        ...
        match term:
            ...
            case hydra.core.TermLet(value=l):
                def for_binding(b: hydra.core.Binding) -> Either[hydra.context.InContext[hydra.error.OtherError], None]:
                    bterm = b.term
                    @lru_cache(1)
...
def check_nominal_application(cx: hydra.context.Context, tx: hydra.graph.Graph, tname: hydra.core.Name, type_args: frozenlist[hydra.core.Type]) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[None, hydra.context.Context]]:
    r"""Check that a nominal type is applied to the correct number of type arguments (Either version)."""
    
    return hydra.lib.eithers.bind(hydra.schemas.require_schema_type(cx, tx.schema_types, tname), (lambda result: (schema_type := hydra.lib.pairs.first(result), cx2 := hydra.lib.pairs.second(result), vars := schema_type.variables, varslen := hydra.lib.lists.length(vars), argslen := hydra.lib.lists.length(type_args), hydra.lib.logic.if_else(hydra.lib.equality.equal(varslen, argslen), (lambda : Right((None, cx2))), (lambda : Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2(hydra.lib.strings.cat2("nominal type ", tname.value), " applied to the wrong number of type arguments: "), "(expected "), hydra.lib.literals.show_int32(varslen)), " arguments, got "), hydra.lib.literals.show_int32(argslen)), "): "), hydra.formatting.show_list((lambda x1: hydra.show.core.type(x1)), type_args))), cx2)))))[5]))
...
def check_same_type(cx: hydra.context.Context, tx: hydra.graph.Graph, desc: str, types: frozenlist[hydra.core.Type]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Type]:
    r"""Ensure all types in a list are equal and return the common type."""
    
    return hydra.lib.logic.if_else(types_all_effectively_equal(tx, types), (lambda : Right(hydra.lib.lists.head(types))), (lambda : Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("unequal types ", hydra.formatting.show_list((lambda x1: hydra.show.core.type(x1)), types), " in ", desc))), cx))))
...
def type_of_injection(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], injection: hydra.core.Injection) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_literal(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], lit: hydra.core.Literal) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_primitive(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], name: hydra.core.Name) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
    ...
    return hydra.lib.maybes.maybe(Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("no such primitive: ", name.value))), cx)), (lambda ts_raw: (inst_result := hydra.schemas.instantiate_type_scheme(cx, ts_raw), ts := hydra.lib.pairs.first(inst_result), cx2 := hydra.lib.pairs.second(inst_result), t := hydra.rewriting.type_scheme_to_f_type(ts), hydra.lib.eithers.bind(apply_type_arguments_to_type(cx2, tx, type_args, t), (lambda applied: Right((applied, cx2)))))[4]), raw_ts())

def type_of_projection(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], p: hydra.core.Projection) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_unit(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type]) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_unwrap(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], tname: hydra.core.Name) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_variable(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], name: hydra.core.Name) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], term: hydra.core.Term):
    ...
    match term:
        ...
        case _:
            return Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("unsupported term variant in typeOf: ", hydra.show.meta.term_variant(hydra.reflect.term_variant(term))))), cx1()))

def type_of_annotated_term(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], at: hydra.core.AnnotatedTerm) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
    r"""Reconstruct the type of an annotated term (Either/Context version)."""
    
    return type_of(cx, tx, type_args, at.body)

def type_of_application(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], app: hydra.core.Application) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
    r"""Reconstruct the type of an application term (Either/Context version)."""
    
    fun = app.function
    arg = app.argument
    def try_type(cx0: hydra.context.Context, tfun: hydra.core.Type, targ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
        while True:
            match tfun:
                case hydra.core.TypeForall(value=ft):
                    cx0 = cx0
                ...
                case hydra.core.TypeFunction(value=ft2):
                    return (dom := ft2.domain, (cod := ft2.codomain, hydra.lib.logic.if_else(types_effectively_equal(tx, dom, targ), (lambda : Right((cod, cx0))), (lambda : Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("in application, expected ", hydra.show.core.type(dom), " but found ", hydra.show.core.type(targ)))), cx0)))))[1])[1]
                ...
                case _:
                    return Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("left hand side of application (", hydra.show.core.term(fun), ") is not function-typed (", hydra.show.core.type(tfun), ")", ". types: ", hydra.lib.strings.intercalate(", ", hydra.lib.lists.map((lambda p: hydra.lib.strings.cat((hydra.lib.pairs.first(p).value, ": ", hydra.show.core.type(hydra.rewriting.type_scheme_to_f_type(hydra.lib.pairs.second(p)))))), hydra.lib.maps.to_list(tx.bound_types)))))), cx0))
...
def type_of_case_statement(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], cs: hydra.core.CaseStatement) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_let(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], let_term: hydra.core.Let) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
    ...
    def binding_type(b: hydra.core.Binding) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.core.Type]:
        return hydra.lib.maybes.maybe(Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("untyped let binding: ", hydra.show.core.binding(b)))), cx)), (lambda ts: Right(hydra.rewriting.type_scheme_to_f_type(ts))), b.type)
    @lru_cache(1)
    def btypes_result() -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[frozenlist[hydra.core.Type], None]]:
...
def type_of_pair(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], p: tuple[hydra.core.Term, hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
    r"""Reconstruct the type of a pair (Either/Context version)."""
    
    @lru_cache(1)
    def n() -> int:
        return hydra.lib.lists.length(type_args)
    return hydra.lib.logic.if_else(hydra.lib.equality.equal(n(), 2), (lambda : (pair_fst := hydra.lib.pairs.first(p), (pair_snd := hydra.lib.pairs.second(p), hydra.lib.eithers.bind(type_of(cx, tx, (), pair_fst), (lambda result1: (first_type := hydra.lib.pairs.first(result1), cx2 := hydra.lib.pairs.second(result1), hydra.lib.eithers.bind(type_of(cx2, tx, (), pair_snd), (lambda result2: (second_type := hydra.lib.pairs.first(result2), cx3 := hydra.lib.pairs.second(result2), Right((cast(hydra.core.Type, hydra.core.TypePair(hydra.core.PairType(first_type, second_type))), cx3)))[2])))[2])))[1])[1]), (lambda : Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat2("pair type requires 2 type arguments, got ", hydra.lib.literals.show_int32(n()))), cx))))

def type_of_record(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], record: hydra.core.Record) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
    r"""Reconstruct the type of a record (Either/Context version)."""
    
    tname = record.type_name
    fields = record.fields
    @lru_cache(1)
    def fold_result() -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[frozenlist[hydra.core.Type], hydra.context.Context]]:
...
def type_of_set(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], els: frozenset[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
    r"""Reconstruct the type of a set (Either/Context version)."""
    
    return hydra.lib.logic.if_else(hydra.lib.sets.null(els), (lambda : hydra.lib.logic.if_else(hydra.lib.equality.equal(hydra.lib.lists.length(type_args), 1), (lambda : Right((cast(hydra.core.Type, hydra.core.TypeSet(hydra.lib.lists.head(type_args))), cx))), (lambda : Left(hydra.context.InContext(hydra.error.OtherError("set type applied to more or less than one argument"), cx))))), (lambda : (fold_result := hydra.lib.lists.foldl((lambda acc, term: hydra.lib.eithers.bind(acc, (lambda acc_r: (types := hydra.lib.pairs.first(acc_r), cx_a := hydra.lib.pairs.second(acc_r), hydra.lib.eithers.bind(type_of(cx_a, tx, (), term), (lambda t_result: (t := hydra.lib.pairs.first(t_result), cx_b := hydra.lib.pairs.second(t_result), Right((hydra.lib.lists.concat2(types, hydra.lib.lists.pure(t)), cx_b)))[2])))[2]))), Right(((), cx)), hydra.lib.sets.to_list(els)), hydra.lib.eithers.bind(fold_result, (lambda fold_r: (eltypes := hydra.lib.pairs.first(fold_r), cx2 := hydra.lib.pairs.second(fold_r), hydra.lib.eithers.bind(check_same_type(cx2, tx, "set elements", eltypes), (lambda unified_type: Right((cast(hydra.core.Type, hydra.core.TypeSet(unified_type)), cx2)))))[2])))[1]))

def type_of_type_application(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], tyapp: hydra.core.TypeApplicationTerm) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_type_lambda(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], tl: hydra.core.TypeLambda) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def type_of_wrapped_term(cx: hydra.context.Context, tx: hydra.graph.Graph, type_args: frozenlist[hydra.core.Type], wt: hydra.core.WrappedTerm) -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.core.Type, hydra.context.Context]]:
...
def check_type(cx: hydra.context.Context, tx: hydra.graph.Graph, term: hydra.core.Term, typ: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.OtherError], None]:
    r"""Check that a term has the expected type."""
    
    vars = tx.type_variables
    return hydra.lib.logic.if_else(hydra.constants.debug_inference, (lambda : hydra.lib.eithers.bind(hydra.lib.eithers.map((lambda _p: hydra.lib.pairs.first(_p)), type_of(cx, tx, (), term)), (lambda t0: hydra.lib.logic.if_else(types_effectively_equal(tx, t0, typ), (lambda : Right(None)), (lambda : Left(hydra.context.InContext(hydra.error.OtherError(hydra.lib.strings.cat(("type checking failed: expected ", hydra.show.core.type(typ), " but found ", hydra.show.core.type(t0)))), cx))))))), (lambda : Right(None)))
