...
TCase = Annotated[hydra.core.Name, 'An association of a field name (as in a case statement) with a phantom type']
...
TField = Annotated[hydra.core.Field, 'An association with a term-level field with a phantom type']
