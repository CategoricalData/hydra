...
ValueObject = Annotated[NewType('ValueObject', dict[str, Value]), 'A JSON object as a set of key/value pairs']

ValueString = Annotated[NewType('ValueString', str), 'A string value']

Value = Annotated[ValueArray | ValueBoolean | ValueNull | ValueNumber | ValueObject | ValueString, 'A JSON value']