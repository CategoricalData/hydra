    ...
    def _hoist_hydra_decode_context_in_context_1(cx, e, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                ...
                def field_map() -> FrozenDict[hydra.core.Name, hydra.core.Term]:
                    return hydra.extract.core.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.core.require_field("object", e, field_map(), cx), (lambda field_object: hydra.lib.eithers.bind(hydra.extract.core.require_field("context", (lambda x1, x2: context(x1, x2)), field_map(), cx), (lambda field_context: Right(hydra.context.InContext(field_object, field_context))))))
