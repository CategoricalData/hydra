...
def term_definition(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_term_definition_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def type_definition(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_packaging_type_definition_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_type_definition_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def definition(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_definition_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
    ...
    def _hoist_hydra_decode_packaging_file_extension_3(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.packaging.FileExtension(b)), hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped2: _hoist_hydra_decode_packaging_file_extension_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, wrapped_term.body)))

            case _:
                return Left(hydra.errors.DecodingError("expected wrapped type"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_file_extension_3(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def namespace(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    def _hoist_hydra_decode_packaging_namespace_3(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.packaging.Namespace(b)), hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped2: _hoist_hydra_decode_packaging_namespace_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, wrapped_term.body)))

            case _:
                return Left(hydra.errors.DecodingError("expected wrapped type"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_namespace_3(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def module(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_packaging_module_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_module_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def namespaces(n: Callable[[hydra.graph.Graph, hydra.core.Term], Either[hydra.errors.DecodingError, T0]], cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_packaging_namespaces_1(cx, n, v1):
        match v1:
            ...
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_namespaces_1(cx, n, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def package_name(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    def _hoist_hydra_decode_packaging_package_name_3(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.packaging.PackageName(b)), hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped2: _hoist_hydra_decode_packaging_package_name_2(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, wrapped_term.body)))

            case _:
                return Left(hydra.errors.DecodingError("expected wrapped type"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_package_name_3(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def package(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_packaging_package_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_package_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def qualified_name(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_packaging_qualified_name_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_packaging_qualified_name_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
