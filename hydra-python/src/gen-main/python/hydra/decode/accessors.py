...
def accessor_node(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_accessors_accessor_node_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected record of type hydra.accessors.AccessorNode"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_node_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))

def term_accessor(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_accessors_term_accessor_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.accessors.TermAccessor"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_term_accessor_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))

def accessor_path(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_accessors_accessor_path_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected wrapped type hydra.accessors.AccessorPath"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_path_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))

def accessor_edge(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_accessors_accessor_edge_1(cx, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                @lru_cache(1)
                def field_map() -> FrozenDict[hydra.core.Name, hydra.core.Term]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected record of type hydra.accessors.AccessorEdge"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_edge_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))

def accessor_graph(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_accessors_accessor_graph_1(cx, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                @lru_cache(1)
                def field_map() -> FrozenDict[hydra.core.Name, hydra.core.Term]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected record of type hydra.accessors.AccessorGraph"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_graph_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
