...
def accessor_node(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_node_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def term_accessor(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_term_accessor_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def accessor_path(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_path_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def accessor_edge(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_accessors_accessor_edge_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_edge_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
...
def accessor_graph(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_accessors_accessor_graph_1(cx, v1):
        match v1:
            ...
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_accessors_accessor_graph_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
