    ...
    def _hoist_hydra_decode_util_case_convention_1(cx, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.util.CaseConvention]]]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.util.CaseConvention"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_util_case_convention_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
    ...
    def _hoist_hydra_decode_util_comparison_1(cx, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.util.Comparison]]]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.util.Comparison"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_util_comparison_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
        ...
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                def variant_map():
                    ...
                    return hydra.lib.maps.from_list(((hydra.core.Name("arbitrary"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.util.Precision, hydra.util.PrecisionArbitrary())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("bits"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.util.Precision, hydra.util.PrecisionBits(t))), hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped2: _hoist_variant_map_3(stripped2)), hydra.lexical.strip_and_dereference_term_either(cx, input)))))))
                return hydra.lib.maybes.maybe(Left(hydra.error.DecodingError(hydra.lib.strings.cat(("no such field ", fname.value, " in union type ", tname.value)))), (lambda f: f(fterm)), hydra.lib.maps.lookup(fname, variant_map()))
            
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.util.Precision"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_util_precision_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
