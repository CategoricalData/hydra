    ...
    def _hoist_hydra_decode_variants_elimination_variant_1(cx, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.variants.EliminationVariant]]]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.variants.EliminationVariant"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_variants_elimination_variant_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
    ...
    def _hoist_hydra_decode_variants_function_variant_1(cx, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.variants.FunctionVariant]]]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.variants.FunctionVariant"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_variants_function_variant_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
    ...
    def _hoist_hydra_decode_variants_literal_variant_1(cx, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.variants.LiteralVariant]]]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.variants.LiteralVariant"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_variants_literal_variant_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
    ...
    def _hoist_hydra_decode_variants_term_variant_1(cx, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.variants.TermVariant]]]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.variants.TermVariant"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_variants_term_variant_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
    ...
    def _hoist_hydra_decode_variants_type_variant_1(cx, v1):
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                fterm = field.term
                @lru_cache(1)
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.error.DecodingError, hydra.variants.TypeVariant]]]:
            ...
            case _:
                return Left(hydra.error.DecodingError("expected union of type hydra.variants.TypeVariant"))
    return hydra.lib.eithers.either((lambda err: Left(hydra.error.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_variants_type_variant_1(cx, stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
