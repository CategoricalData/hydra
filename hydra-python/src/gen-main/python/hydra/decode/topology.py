...
def vertex(cx: hydra.graph.Graph, raw: hydra.core.Term):
    ...
    return hydra.lib.eithers.either((lambda err: Left(hydra.errors.DecodingError(err))), (lambda stripped: _hoist_hydra_decode_topology_vertex_3(stripped)), hydra.lexical.strip_and_dereference_term_either(cx, raw))
