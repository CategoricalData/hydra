    ...
    def _hoist_hydra_decode_paths_subterm_path_1(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.paths.SubtermPath(b)), hydra.extract.helpers.decode_list((lambda x1, x2: subterm_step(x1, x2)), cx, wrapped_term.body))
    ...
    def _hoist_hydra_decode_paths_subterm_edge_1(cx, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                ...
                def field_map() -> FrozenDict[hydra.core.Name, hydra.core.Term]:
                    return hydra.extract.helpers.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.helpers.require_field("source", (lambda x1, x2: subterm_node(x1, x2)), field_map(), cx), (lambda field_source: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("path", (lambda x1, x2: subterm_path(x1, x2)), field_map(), cx), (lambda field_path: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("target", (lambda x1, x2: subterm_node(x1, x2)), field_map(), cx), (lambda field_target: Right(hydra.paths.SubtermEdge(field_source, field_path, field_target))))))))
        ...
        match v1:
            case hydra.core.TermUnion(value=inj):
                ...
                def variant_map() -> FrozenDict[hydra.core.Name, Callable[[hydra.core.Term], Either[hydra.errors.DecodingError, hydra.paths.SubtypeStep]]]:
                    return hydra.lib.maps.from_list(((hydra.core.Name("annotatedBody"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepAnnotatedBody())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("applicationFunction"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepApplicationFunction())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("applicationArgument"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepApplicationArgument())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("eitherLeft"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepEitherLeft())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("eitherRight"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepEitherRight())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("forallBody"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepForallBody())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("functionDomain"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepFunctionDomain())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("functionCodomain"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepFunctionCodomain())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("listElement"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepListElement())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("mapKeys"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepMapKeys())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("mapValues"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepMapValues())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("maybeElement"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepMaybeElement())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("pairFirst"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepPairFirst())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("pairSecond"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepPairSecond())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("recordField"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepRecordField(t))), hydra.decode.core.name(cx, input)))), (hydra.core.Name("setElement"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepSetElement())), hydra.extract.helpers.decode_unit(cx, input)))), (hydra.core.Name("unionField"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepUnionField(t))), hydra.decode.core.name(cx, input)))), (hydra.core.Name("wrappedType"), (lambda input: hydra.lib.eithers.map((lambda t: cast(hydra.paths.SubtypeStep, hydra.paths.SubtypeStepWrappedType())), hydra.extract.helpers.decode_unit(cx, input))))))
                return hydra.lib.maybes.maybe((lambda : Left(hydra.errors.DecodingError(hydra.lib.strings.cat(("no such field ", fname.value, " in union"))))), (lambda f: f(fterm)), hydra.lib.maps.lookup(fname, variant_map()))
...
def subtype_path(cx: hydra.graph.Graph, raw: hydra.core.Term):
    def _hoist_hydra_decode_paths_subtype_path_1(cx, v1):
        match v1:
            case hydra.core.TermWrap(value=wrapped_term):
                return hydra.lib.eithers.map((lambda b: hydra.paths.SubtypePath(b)), hydra.extract.helpers.decode_list((lambda x1, x2: subtype_step(x1, x2)), cx, wrapped_term.body))
    ...
    def _hoist_hydra_decode_paths_subtype_edge_1(cx, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                ...
                def field_map() -> FrozenDict[hydra.core.Name, hydra.core.Term]:
                    return hydra.extract.helpers.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.helpers.require_field("source", (lambda x1, x2: subtype_node(x1, x2)), field_map(), cx), (lambda field_source: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("path", (lambda x1, x2: subtype_path(x1, x2)), field_map(), cx), (lambda field_path: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("target", (lambda x1, x2: subtype_node(x1, x2)), field_map(), cx), (lambda field_target: Right(hydra.paths.SubtypeEdge(field_source, field_path, field_target))))))))
    ...
    def _hoist_hydra_decode_paths_subtype_graph_1(cx, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                ...
                def field_map() -> FrozenDict[hydra.core.Name, hydra.core.Term]:
                    return hydra.extract.helpers.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.helpers.require_field("nodes", (lambda v12, v2: hydra.extract.helpers.decode_list((lambda x1, x2: subtype_node(x1, x2)), v12, v2)), field_map(), cx), (lambda field_nodes: hydra.lib.eithers.bind(hydra.extract.helpers.require_field("edges", (lambda v12, v2: hydra.extract.helpers.decode_list((lambda x1, x2: subtype_edge(x1, x2)), v12, v2)), field_map(), cx), (lambda field_edges: Right(hydra.paths.SubtypeGraph(field_nodes, field_edges))))))
