...
class Program:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Program")
...
class TopLevelForm(metaclass=_TopLevelFormMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.TopLevelForm")
...
class TopLevelFormWithComments:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.TopLevelFormWithComments")
...
class FunctionDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.FunctionDefinition")
...
class VariableDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.VariableDefinition")
    NAME = hydra.core.Name("name")
...
class ConstantDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ConstantDefinition")
    NAME = hydra.core.Name("name")
    VALUE = hydra.core.Name("value")
    DOC = hydra.core.Name("doc")
...
class RecordTypeDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.RecordTypeDefinition")
    NAME = hydra.core.Name("name")
...
class FieldDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.FieldDefinition")
    NAME = hydra.core.Name("name")
...
class MacroDefinition:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.MacroDefinition")
    NAME = hydra.core.Name("name")
    PARAMS = hydra.core.Name("params")
    REST_PARAM = hydra.core.Name("restParam")
    BODY = hydra.core.Name("body")
...
class Expression(metaclass=_ExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Expression")
...
class Application:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Application")
    FUNCTION = hydra.core.Name("function")
...
class Lambda:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Lambda")
    NAME = hydra.core.Name("name")
    PARAMS = hydra.core.Name("params")
    REST_PARAM = hydra.core.Name("restParam")
    BODY = hydra.core.Name("body")
...
class VariableReference:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.VariableReference")
    NAME = hydra.core.Name("name")
...
class FieldAccess:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.FieldAccess")
    RECORD_TYPE = hydra.core.Name("recordType")
...
class TypeAnnotation:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.TypeAnnotation")
    EXPRESSION = hydra.core.Name("expression")
...
class IfExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.IfExpression")
...
class CondExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.CondExpression")
...
class CondClause:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.CondClause")
    CONDITION = hydra.core.Name("condition")
    BODY = hydra.core.Name("body")
...
class CaseExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.CaseExpression")
...
class CaseClause:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.CaseClause")
...
class AndExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.AndExpression")
...
class OrExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.OrExpression")
    EXPRESSIONS = hydra.core.Name("expressions")
...
class NotExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.NotExpression")
    EXPRESSION = hydra.core.Name("expression")
...
class DoExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.DoExpression")
    EXPRESSIONS = hydra.core.Name("expressions")
...
class BeginExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.BeginExpression")
    EXPRESSIONS = hydra.core.Name("expressions")
...
class QuoteExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.QuoteExpression")
    BODY = hydra.core.Name("body")
...
class QuasiquoteExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.QuasiquoteExpression")
    BODY = hydra.core.Name("body")
...
class UnquoteExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.UnquoteExpression")
    BODY = hydra.core.Name("body")
...
class SplicingUnquoteExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.SplicingUnquoteExpression")
    BODY = hydra.core.Name("body")
...
class LetExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.LetExpression")
...
LetKind.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.LetKind")
...
class LetBinding(metaclass=_LetBindingMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.LetBinding")
...
class SimpleBinding:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.SimpleBinding")
    NAME = hydra.core.Name("name")
    VALUE = hydra.core.Name("value")
...
class DestructuringBinding:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.DestructuringBinding")
...
class DestructuringPattern(metaclass=_DestructuringPatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.DestructuringPattern")
    SEQUENTIAL = hydra.core.Name("sequential")
...
class Pattern(metaclass=_PatternMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Pattern")
...
class ConstructorPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ConstructorPattern")
    CONSTRUCTOR = hydra.core.Name("constructor")
    ARGUMENTS = hydra.core.Name("arguments")
...
class LiteralPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.LiteralPattern")
    VALUE = hydra.core.Name("value")
...
class WildcardPattern:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.WildcardPattern")
...
class Literal(metaclass=_LiteralMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Literal")
...
class IntegerLiteral:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.IntegerLiteral")
    VALUE = hydra.core.Name("value")
...
class FloatLiteral:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.FloatLiteral")
    VALUE = hydra.core.Name("value")
...
class CharacterLiteral:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.CharacterLiteral")
    VALUE = hydra.core.Name("value")
...
BooleanStyle.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.BooleanStyle")
...
NilStyle.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.NilStyle")

class Symbol(Node[str]):
    r"""A Lisp symbol (identifier)."""

Symbol.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Symbol")
...
class Keyword:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Keyword")
    NAME = hydra.core.Name("name")
...
class QualifiedSymbol:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.QualifiedSymbol")
    NAMESPACE = hydra.core.Name("namespace")
    NAME = hydra.core.Name("name")
...
NamespaceName.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.NamespaceName")
...
class ListLiteral:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ListLiteral")
...
class VectorLiteral:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.VectorLiteral")
    ELEMENTS = hydra.core.Name("elements")
...
class MapLiteral:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.MapLiteral")
...
class MapEntry:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.MapEntry")
...
class SetLiteral:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.SetLiteral")
    ELEMENTS = hydra.core.Name("elements")
...
class ConsExpression:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ConsExpression")
...
class DottedPair:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.DottedPair")
...
class TypeHint:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.TypeHint")
    NAME = hydra.core.Name("name")
    TYPE = hydra.core.Name("type")
...
class TypeSpecifier(metaclass=_TypeSpecifierMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.TypeSpecifier")
...
class ModuleDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ModuleDeclaration")
    NAME = hydra.core.Name("name")
    DOC = hydra.core.Name("doc")
...
class ImportDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ImportDeclaration")
    MODULE = hydra.core.Name("module")
...
class ImportSpec(metaclass=_ImportSpecMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ImportSpec")
...
class ExportDeclaration:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.ExportDeclaration")
...
class Comment:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Comment")
...
CommentStyle.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.CommentStyle")

class Docstring(Node[str]):
    r"""A documentation string."""

Docstring.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Docstring")
...
Dialect.TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.Dialect")
...
class SExpression(metaclass=_SExpressionMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.lisp.syntax.SExpression")
