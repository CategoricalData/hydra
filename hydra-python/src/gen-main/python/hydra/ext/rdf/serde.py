...
def write_iri(iri: hydra.ext.org.w3.rdf.syntax.Iri) -> hydra.ast.Expr:
...
def write_blank_node(bnode: hydra.ext.org.w3.rdf.syntax.BlankNode) -> hydra.ast.Expr:
...
def write_language_tag(lang: hydra.ext.org.w3.rdf.syntax.LanguageTag) -> hydra.ast.Expr:
...
def write_literal(lit: hydra.ext.org.w3.rdf.syntax.Literal) -> hydra.ast.Expr:
...
def write_node(n: hydra.ext.org.w3.rdf.syntax.Node_) -> hydra.ast.Expr:
    ...
    match n:
        ...
        case hydra.ext.org.w3.rdf.syntax.NodeLiteral(value=lit):
            return write_literal(lit)

        case _:
            raise AssertionError("Unreachable: all variants handled")

def write_resource(r: hydra.ext.org.w3.rdf.syntax.Resource) -> hydra.ast.Expr:
    r"""Convert a resource to an expression."""

    match r:
        case hydra.ext.org.w3.rdf.syntax.ResourceIri(value=iri):
            return write_iri(iri)

        case hydra.ext.org.w3.rdf.syntax.ResourceBnode(value=bnode):
            return write_blank_node(bnode)

        case _:
            raise AssertionError("Unreachable: all variants handled")

def write_triple(t: hydra.ext.org.w3.rdf.syntax.Triple) -> hydra.ast.Expr:
...
def write_graph(g: hydra.ext.org.w3.rdf.syntax.Graph) -> hydra.ast.Expr:
...
def rdf_graph_to_ntriples(g: hydra.ext.org.w3.rdf.syntax.Graph) -> str:
