...
def generate_test_file_with_python_codec(test_module: hydra.module.Module, test_group: hydra.testing.TestGroup) -> Either[T0, tuple[str, str]]:
...
def generate_python_test_file(test_module: hydra.module.Module, test_group: hydra.testing.TestGroup, _g: T0) -> Either[T1, tuple[str, str]]:
