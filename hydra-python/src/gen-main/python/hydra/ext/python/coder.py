...
def python_binding_metadata(tc: hydra.graph.Graph, b: hydra.core.Binding) -> Maybe[hydra.core.Term]:
    ...
    return hydra.lib.logic.if_else(hydra.lib.logic.and_(hydra.coder_utils.is_complex_binding(tc, b), hydra.lib.logic.not_(hydra.coder_utils.is_trivial_term(b.term))), (lambda : hydra.coder_utils.binding_metadata(tc, b)), (lambda : Nothing()))
...
def analyze_python_function_inline(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, term: hydra.core.Term) -> Either[T0, hydra.typing.FunctionStructure[hydra.ext.python.helpers.PythonEnvironment]]:
    r"""Analyze a function term without recording binding metadata (for inline lambdas)."""
    
    return hydra.coder_utils.analyze_function_term_inline(cx, (lambda x1: python_environment_get_graph(x1)), (lambda x1, x2: python_environment_set_graph(x1, x2)), env, term)
...
def encode_variable(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, name: hydra.core.Name, args: frozenlist[hydra.ext.python.syntax.Expression]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Expression]:
...
def encode_type(env: hydra.ext.python.helpers.PythonEnvironment, typ: hydra.core.Type) -> Either[T0, hydra.ext.python.syntax.Expression]:
    ...
    match hydra.rewriting.deannotate_type(typ):
        ...
        case hydra.core.TypeRecord(value=rt):
            return Right(hydra.ext.python.names.type_variable_reference(env, rt.type_name))
        ...
        case hydra.core.TypeUnion(value=rt2):
            return Right(hydra.ext.python.names.type_variable_reference(env, rt2.type_name))
        ...
        case hydra.core.TypeWrap(value=wt):
            return Right(hydra.ext.python.names.type_variable_reference(env, wt.type_name))
...
def encode_application(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, app: hydra.core.Application) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Expression]:
...
def encode_application_inner(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, fun: hydra.core.Term, hargs: frozenlist[hydra.ext.python.syntax.Expression], rargs: frozenlist[hydra.ext.python.syntax.Expression]):
    ...
    @lru_cache(1)
    def default_case() -> Either[hydra.context.InContext[hydra.error.OtherError], tuple[hydra.ext.python.syntax.Expression, frozenlist[hydra.ext.python.syntax.Expression]]]:
...
def encode_term_inline(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, no_cast: bool, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Expression]:
    r"""Encode a term to a Python expression (inline form)."""
    
    def encode(t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Expression]:
    ...
    match hydra.rewriting.deannotate_and_detype_term(term):
        ...
        case hydra.core.TermMaybe(value=mt):
            return hydra.lib.maybes.maybe(Right(hydra.ext.python.utils.function_call(hydra.ext.python.utils.py_name_to_py_primary(hydra.ext.python.syntax.Name("Nothing")), ())), (lambda t1: hydra.lib.eithers.bind(encode(t1), (lambda pyexp: with_cast(hydra.ext.python.utils.function_call(hydra.ext.python.utils.py_name_to_py_primary(hydra.ext.python.syntax.Name("Just")), (pyexp,)))))), mt)
...
def encode_binding_as(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, binding: hydra.core.Binding) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Statement]:
...
def encode_term_multiline(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, term: hydra.core.Term):
    ...
    @lru_cache(1)
    def dflt_logic() -> Either[hydra.context.InContext[hydra.error.OtherError], frozenlist[hydra.ext.python.syntax.Statement]]:
...
def encode_field_type(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, field_type: hydra.core.FieldType) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Statement]:
...
def encode_record_type(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, name: hydra.core.Name, row_type: hydra.core.RowType, comment: Maybe[str]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Statement]:
    r"""Encode a record type as a Python dataclass."""
    
    tfields = row_type.fields
    return hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda v1: encode_field_type(cx, env, v1)), tfields), (lambda py_fields: (const_stmts := encode_name_constants(env, name, tfields), body := hydra.ext.python.utils.indented_block(comment, (py_fields, const_stmts)), bound_vars := env.bound_type_variables, tparam_list := hydra.lib.pairs.first(bound_vars), m_generic_arg := generic_arg(tparam_list), args := hydra.lib.maybes.maybe(Nothing(), (lambda a: Just(hydra.ext.python.utils.py_expressions_to_py_args((a,)))), m_generic_arg), decs := Just(hydra.ext.python.syntax.Decorators((dataclass_decorator(),))), py_name := hydra.ext.python.names.encode_name(False, hydra.util.CaseConvention.PASCAL, env, name), no_type_params := (), Right(hydra.ext.python.utils.py_class_definition_to_py_statement(hydra.ext.python.syntax.ClassDefinition(decs, py_name, no_type_params, args, body))))[9]))
...
def encode_enum_value_assignment(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, field_type: hydra.core.FieldType) -> Either[hydra.context.InContext[hydra.error.OtherError], frozenlist[hydra.ext.python.syntax.Statement]]:
...
def encode_union_field(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, union_name: hydra.core.Name, field_type: hydra.core.FieldType) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Statement]:
...
def encode_type_assignment_inner(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, name: hydra.core.Name, typ: hydra.core.Type, comment: Maybe[str]) -> Either[hydra.context.InContext[hydra.error.OtherError], frozenlist[hydra.ext.python.syntax.Statement]]:
...
def encode_type_assignment(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, name: hydra.core.Name, typ: hydra.core.Type, comment: Maybe[str]) -> Either[hydra.context.InContext[hydra.error.OtherError], frozenlist[frozenlist[hydra.ext.python.syntax.Statement]]]:
...
def encode_definition(cx: hydra.context.Context, env: hydra.ext.python.helpers.PythonEnvironment, def_: hydra.module.Definition) -> Either[hydra.context.InContext[hydra.error.OtherError], frozenlist[frozenlist[hydra.ext.python.syntax.Statement]]]:
...
def encode_python_module(cx: hydra.context.Context, g: hydra.graph.Graph, mod: hydra.module.Module, defs0: frozenlist[hydra.module.Definition]) -> Either[hydra.context.InContext[hydra.error.OtherError], hydra.ext.python.syntax.Module]:
...
def module_to_python(mod: hydra.module.Module, defs: frozenlist[hydra.module.Definition], cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.error.OtherError], FrozenDict[str, str]]:
