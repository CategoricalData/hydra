...
def encode_name(is_qualified: bool, conv: hydra.util.CaseConvention, env: hydra.ext.python.environment.PythonEnvironment, name: hydra.core.Name) -> hydra.ext.python.syntax.Name:
...
def encode_enum_value(v1: hydra.ext.python.environment.PythonEnvironment, v2: hydra.core.Name) -> hydra.ext.python.syntax.Name:
...
def encode_field_name(env: hydra.ext.python.environment.PythonEnvironment, fname: hydra.core.Name) -> hydra.ext.python.syntax.Name:
...
def encode_name_qualified(env: hydra.ext.python.environment.PythonEnvironment, name: hydra.core.Name) -> hydra.ext.python.syntax.Name:
...
def variable_reference(conv: hydra.util.CaseConvention, quoted: bool, env: hydra.ext.python.environment.PythonEnvironment, name: hydra.core.Name) -> hydra.ext.python.syntax.Expression:
...
def term_variable_reference(v1: hydra.ext.python.environment.PythonEnvironment, v2: hydra.core.Name) -> hydra.ext.python.syntax.Expression:
...
def type_variable_reference(v1: hydra.ext.python.environment.PythonEnvironment, v2: hydra.core.Name) -> hydra.ext.python.syntax.Expression:
    r"""Reference a type variable as a Python expression."""

    return variable_reference(hydra.util.CaseConvention.PASCAL, False, v1, v2)

def variant_name(is_qualified: bool, env: hydra.ext.python.environment.PythonEnvironment, tname: hydra.core.Name, fname: hydra.core.Name) -> hydra.ext.python.syntax.Name:
