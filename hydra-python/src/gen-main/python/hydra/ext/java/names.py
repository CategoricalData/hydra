...
hydra_core_package_name = Just(java_package_name(("hydra", "core")))

# The hydra.util package name.
hydra_util_package_name = Just(java_package_name(("hydra", "util")))

instance_name = "instance"

# The java.lang package name.
java_lang_package_name = Just(java_package_name(("java", "lang")))

# The java.util.function package name.
java_util_function_package_name = Just(java_package_name(("java", "util", "function")))

# The java.util package name.
java_util_package_name = Just(java_package_name(("java", "util")))
