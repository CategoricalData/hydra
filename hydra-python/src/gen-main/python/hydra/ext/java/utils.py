...
def add_in_scope_var(name: hydra.core.Name, aliases: hydra.ext.java.environment.Aliases) -> hydra.ext.java.environment.Aliases:
    return hydra.ext.java.environment.Aliases(aliases.current_namespace, aliases.packages, aliases.branch_vars, aliases.recursive_vars, aliases.in_scope_type_params, aliases.polymorphic_locals, hydra.lib.sets.insert(name, aliases.in_scope_java_vars), aliases.var_renames, aliases.lambda_vars, aliases.type_var_subst, aliases.trusted_type_vars, aliases.method_codomain, aliases.thunked_vars)

def add_in_scope_vars(names: frozenlist[hydra.core.Name], aliases: hydra.ext.java.environment.Aliases) -> hydra.ext.java.environment.Aliases:
...
def add_java_type_parameter(rt: hydra.ext.java.syntax.ReferenceType, t: hydra.ext.java.syntax.Type, cx: hydra.context.Context):
    def _hoist_hydra_ext_java_utils_add_java_type_parameter_1(cx, rt, v1):
        match v1:
            ...
            case hydra.ext.java.syntax.ClassOrInterfaceTypeInterface():
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("expected a Java class type"))), cx))
    ...
    def _hoist_hydra_ext_java_utils_add_java_type_parameter_2(cx, rt, v1):
        match v1:
            ...
            case hydra.ext.java.syntax.ReferenceTypeArray():
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("expected a Java class or interface type, or a variable"))), cx))
    ...
    match t:
        ...
        case hydra.ext.java.syntax.TypePrimitive():
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("expected a reference type"))), cx))

        case _:
            raise AssertionError("Unreachable: all variants handled")

def add_var_rename(original: hydra.core.Name, renamed: hydra.core.Name, aliases: hydra.ext.java.environment.Aliases) -> hydra.ext.java.environment.Aliases:
    return hydra.ext.java.environment.Aliases(aliases.current_namespace, aliases.packages, aliases.branch_vars, aliases.recursive_vars, aliases.in_scope_type_params, aliases.polymorphic_locals, aliases.in_scope_java_vars, hydra.lib.maps.insert(original, renamed, aliases.var_renames), aliases.lambda_vars, aliases.type_var_subst, aliases.trusted_type_vars, aliases.method_codomain, aliases.thunked_vars)
...
def java_literal_to_java_primary(lit: hydra.ext.java.syntax.Literal) -> hydra.ext.java.syntax.Primary:
    return cast(hydra.ext.java.syntax.Primary, hydra.ext.java.syntax.PrimaryNoNewArray(cast(hydra.ext.java.syntax.PrimaryNoNewArrayExpression, hydra.ext.java.syntax.PrimaryNoNewArrayExpressionLiteral(lit))))
...
def name_to_java_class_type(aliases: hydra.ext.java.environment.Aliases, qualify: bool, args: frozenlist[hydra.ext.java.syntax.TypeArgument], name: hydra.core.Name, mlocal: Maybe[str]) -> hydra.ext.java.syntax.ClassType:
    @lru_cache(1)
...
def java_expression_to_java_primary(e: hydra.ext.java.syntax.Expression):
    ...
    def fallback() -> hydra.ext.java.syntax.Primary:
        return cast(hydra.ext.java.syntax.Primary, hydra.ext.java.syntax.PrimaryNoNewArray(cast(hydra.ext.java.syntax.PrimaryNoNewArrayExpression, hydra.ext.java.syntax.PrimaryNoNewArrayExpressionParens(e))))
...
def java_method_invocation_to_java_postfix_expression(mi: hydra.ext.java.syntax.MethodInvocation) -> hydra.ext.java.syntax.PostfixExpression:
    return cast(hydra.ext.java.syntax.PostfixExpression, hydra.ext.java.syntax.PostfixExpressionPrimary(cast(hydra.ext.java.syntax.Primary, hydra.ext.java.syntax.PrimaryNoNewArray(cast(hydra.ext.java.syntax.PrimaryNoNewArrayExpression, hydra.ext.java.syntax.PrimaryNoNewArrayExpressionMethodInvocation(mi))))))

def java_method_invocation_to_java_primary(mi: hydra.ext.java.syntax.MethodInvocation) -> hydra.ext.java.syntax.Primary:
    return cast(hydra.ext.java.syntax.Primary, hydra.ext.java.syntax.PrimaryNoNewArray(cast(hydra.ext.java.syntax.PrimaryNoNewArrayExpression, hydra.ext.java.syntax.PrimaryNoNewArrayExpressionMethodInvocation(mi))))
...
def java_relational_expression_to_java_unary_expression(re: hydra.ext.java.syntax.RelationalExpression) -> hydra.ext.java.syntax.UnaryExpression:
    return cast(hydra.ext.java.syntax.UnaryExpression, hydra.ext.java.syntax.UnaryExpressionOther(cast(hydra.ext.java.syntax.UnaryExpressionNotPlusMinus, hydra.ext.java.syntax.UnaryExpressionNotPlusMinusPostfix(cast(hydra.ext.java.syntax.PostfixExpression, hydra.ext.java.syntax.PostfixExpressionPrimary(cast(hydra.ext.java.syntax.Primary, hydra.ext.java.syntax.PrimaryNoNewArray(cast(hydra.ext.java.syntax.PrimaryNoNewArrayExpression, hydra.ext.java.syntax.PrimaryNoNewArrayExpressionParens(cast(hydra.ext.java.syntax.Expression, hydra.ext.java.syntax.ExpressionAssignment(cast(hydra.ext.java.syntax.AssignmentExpression, hydra.ext.java.syntax.AssignmentExpressionConditional(cast(hydra.ext.java.syntax.ConditionalExpression, hydra.ext.java.syntax.ConditionalExpressionSimple(hydra.ext.java.syntax.ConditionalOrExpression((hydra.ext.java.syntax.ConditionalAndExpression((hydra.ext.java.syntax.InclusiveOrExpression((hydra.ext.java.syntax.ExclusiveOrExpression((hydra.ext.java.syntax.AndExpression((cast(hydra.ext.java.syntax.EqualityExpression, hydra.ext.java.syntax.EqualityExpressionUnary(re)),)),)),)),)),))))))))))))))))))
...
def name_to_java_type_identifier(aliases: hydra.ext.java.environment.Aliases, qualify: bool, name: hydra.core.Name) -> hydra.ext.java.syntax.TypeIdentifier:
    return hydra.lib.pairs.first(name_to_qualified_java_name(aliases, qualify, name, Nothing()))

def java_type_from_type_name(aliases: hydra.ext.java.environment.Aliases, el_name: hydra.core.Name) -> hydra.ext.java.syntax.Type:
...
def java_type_to_java_reference_type(t: hydra.ext.java.syntax.Type, cx: hydra.context.Context) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.java.syntax.ReferenceType]:
    match t:
        case hydra.ext.java.syntax.TypeReference(value=rt):
            return Right(rt)

        case hydra.ext.java.syntax.TypePrimitive():
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("expected a Java reference type"))), cx))
...
def lookup_java_var_name(aliases: hydra.ext.java.environment.Aliases, name: hydra.core.Name) -> hydra.core.Name:
    return hydra.lib.maybes.cases(hydra.lib.maps.lookup(name, aliases.var_renames), (lambda : name), (lambda renamed: renamed))

def make_constructor(aliases: hydra.ext.java.environment.Aliases, el_name: hydra.core.Name, private: bool, params: frozenlist[hydra.ext.java.syntax.FormalParameter], stmts: frozenlist[hydra.ext.java.syntax.BlockStatement]) -> hydra.ext.java.syntax.ClassBodyDeclaration:
    @lru_cache(1)
...
def name_to_java_reference_type(aliases: hydra.ext.java.environment.Aliases, qualify: bool, args: frozenlist[hydra.ext.java.syntax.TypeArgument], name: hydra.core.Name, mlocal: Maybe[str]) -> hydra.ext.java.syntax.ReferenceType:
...
def to_java_array_type(t: hydra.ext.java.syntax.Type, cx: hydra.context.Context):
    def _hoist_hydra_ext_java_utils_to_java_array_type_1(cx, v1):
        match v1:
            ...
            case hydra.ext.java.syntax.ReferenceTypeVariable():
                return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("don't know how to make Java reference type into array type"))), cx))
    ...
    match t:
        ...
        case hydra.ext.java.syntax.TypePrimitive():
            return Left(hydra.context.InContext(cast(hydra.errors.Error, hydra.errors.ErrorOther(hydra.errors.OtherError("don't know how to make Java type into array type"))), cx))
...
def unique_var_name_go(aliases: hydra.ext.java.environment.Aliases, base: str, n: int) -> hydra.core.Name:
    @lru_cache(1)
...
def unique_var_name(aliases: hydra.ext.java.environment.Aliases, name: hydra.core.Name) -> hydra.core.Name:
