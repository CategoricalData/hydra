...
r"""Environment types for Java code generation."""
...
class JavaSymbolClass(metaclass=_JavaSymbolClassMeta):
    ...
    TYPE_ = hydra.core.Name("hydra.ext.java.environment.JavaSymbolClass")
...
class JavaFeatures:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.java.environment.JavaFeatures")
...
class Aliases:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.java.environment.Aliases")
...
class JavaEnvironment:
    ...
    TYPE_ = hydra.core.Name("hydra.ext.java.environment.JavaEnvironment")
