...
def decode_record(rt: hydra.core.RowType, coders: frozenlist[tuple[hydra.core.FieldType, hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]], cx: hydra.context.Context, n: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
    r"""Decode a JSON value to a record term."""
    
    def decode_object_body(m: FrozenDict[str, hydra.json.model.Value]) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
        def decode_field(coder: tuple[hydra.core.FieldType, hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Field]:
            @lru_cache(1)
    ...
    match n:
        ...
        case _:
            return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected object, found: ", show_value(n)))))), cx))

def encode_record(coders: frozenlist[tuple[hydra.core.FieldType, hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]], cx: hydra.context.Context, graph: hydra.graph.Graph, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.json.model.Value]:
    r"""Encode a record term to JSON."""
    
    @lru_cache(1)
    def stripped() -> hydra.core.Term:
        return hydra.rewriting.deannotate_term(term)
    def match_maybe_term(fvalue: hydra.core.Term, coder_: hydra.compute.Coder[hydra.core.Term, T0], fname: hydra.core.Name, dflt: Either[hydra.context.InContext[hydra.error.Error], Maybe[tuple[str, T0]]]) -> Either[hydra.context.InContext[hydra.error.Error], Maybe[tuple[str, T0]]]:
        match fvalue:
    ...
    def match_type_for_maybe(ft: hydra.core.FieldType, for_maybe: Callable[[hydra.core.Type], T0], dflt: T0) -> T0:
        match ft.type:
            ...
            case _:
                return dflt
    def encode_field(coder_and_field: tuple[tuple[hydra.core.FieldType, hydra.compute.Coder[hydra.core.Term, T0]], hydra.core.Field]) -> Either[hydra.context.InContext[hydra.error.Error], Maybe[tuple[str, T0]]]:
        @lru_cache(1)
        ...
        fname = field().name
        fvalue = field().term
        def for_maybe(ot: T1) -> Either[hydra.context.InContext[hydra.error.Error], Maybe[tuple[str, T0]]]:
            @lru_cache(1)
            def dflt() -> Either[hydra.context.InContext[hydra.error.Error], Maybe[tuple[str, T0]]]:
...
def literal_json_coder(lt: hydra.core.LiteralType) -> Either[T0, hydra.compute.Coder[hydra.core.Literal, hydra.json.model.Value]]:
    ...
    def decode_bool(cx: hydra.context.Context, s: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Literal]:
        match s:
            case hydra.json.model.ValueBoolean(value=b):
                return Right(cast(hydra.core.Literal, hydra.core.LiteralBoolean(b)))
            
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected boolean, found: ", show_value(s)))))), cx))
    def decode_float(cx: hydra.context.Context, s: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Literal]:
        match s:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected number, found: ", show_value(s)))))), cx))
    def decode_integer(cx: hydra.context.Context, s: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Literal]:
        match s:
            case hydra.json.model.ValueNumber(value=f):
                @lru_cache(1)
                def bi() -> int:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected number, found: ", show_value(s)))))), cx))
    def decode_string(cx: hydra.context.Context, s: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Literal]:
        match s:
            case hydra.json.model.ValueString(value=s_):
                return Right(cast(hydra.core.Literal, hydra.core.LiteralString(s_)))
            
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected string, found: ", show_value(s)))))), cx))
    @lru_cache(1)
...
def unit_coder() -> hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]:
    ...
    def encode_unit(cx: hydra.context.Context, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.json.model.Value]:
        match hydra.rewriting.deannotate_term(term):
            case hydra.core.TermUnit():
                return Right(cast(hydra.json.model.Value, hydra.json.model.ValueNull()))
            
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected unit, found: ", hydra.show.core.term(term)))))), cx))
    def decode_unit(cx: hydra.context.Context, n: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
        match n:
            case hydra.json.model.ValueNull():
                return Right(cast(hydra.core.Term, hydra.core.TermUnit()))
            
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected null, found: ", show_value(n)))))), cx))
    return hydra.compute.Coder((lambda x1, x2: encode_unit(x1, x2)), (lambda x1, x2: decode_unit(x1, x2)))

def record_coder(rt: hydra.core.RowType, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.error.Error], hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]:
    r"""Create a JSON coder for record types."""
    
    fields = rt.fields
    def get_coder(f: hydra.core.FieldType) -> Either[hydra.context.InContext[hydra.error.Error], tuple[hydra.core.FieldType, hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]]:
...
def term_coder(typ: hydra.core.Type, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.error.Error], hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]:
    r"""Create a JSON coder for term types."""
    
    @lru_cache(1)
    def stripped() -> hydra.core.Type:
        return hydra.rewriting.deannotate_type(typ)
    def encode_literal(ac: hydra.compute.Coder[hydra.core.Literal, T0], cx2: hydra.context.Context, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], T0]:
        match term:
            case hydra.core.TermLiteral(value=av):
                return ac.encode(cx2, av)
            
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected literal term, found: ", hydra.show.core.term(term)))))), cx2))
    def encode_list(lc: hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value], cx2: hydra.context.Context, term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.json.model.Value]:
        match term:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected list term, found: ", hydra.show.core.term(term)))))), cx2))
    def decode_list(lc: hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value], cx2: hydra.context.Context, n: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
        match n:
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected sequence, found: ", show_value(n)))))), cx2))
    ...
    def match_term_literal(v: hydra.core.Term) -> str:
        match hydra.rewriting.deannotate_term(v):
            ...
            case _:
                return hydra.show.core.term(v)
    def encode_maybe(maybe_element_coder: hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value], cx2: hydra.context.Context, maybe_term: hydra.core.Term) -> Either[hydra.context.InContext[hydra.error.Error], hydra.json.model.Value]:
        @lru_cache(1)
        ...
        match stripped_maybe_term():
            ...
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("expected optional term, found: ", hydra.show.core.term(maybe_term)))))), cx2))
    def decode_maybe(maybe_element_coder: hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value], cx2: hydra.context.Context, json_val: hydra.json.model.Value) -> Either[hydra.context.InContext[hydra.error.Error], hydra.core.Term]:
        match json_val:
            case hydra.json.model.ValueNull():
    ...
    def result():
        match stripped():
            ...
            case hydra.core.TypeVariable(value=name):
                return Right(hydra.compute.Coder((lambda _cx, term: Right(cast(hydra.json.model.Value, hydra.json.model.ValueString(hydra.lib.strings.cat(("variable '", name.value, "' for: ", hydra.show.core.term(term))))))), (lambda cx2, _term: Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("type variable ", name.value, " does not support decoding"))))), cx2)))))
            
            case _:
                return Left(hydra.context.InContext(cast(hydra.error.Error, hydra.error.ErrorOther(hydra.error.OtherError(hydra.lib.strings.cat(("unsupported type in JSON: ", hydra.show.core.type(typ)))))), cx))
    return result()

def json_coder(typ: hydra.core.Type, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.error.Error], hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]:
    r"""Create a JSON coder for a given type."""
    
    def mk_term_coder(t: hydra.core.Type) -> Either[hydra.context.InContext[hydra.error.Error], hydra.compute.Coder[hydra.core.Term, hydra.json.model.Value]]:
