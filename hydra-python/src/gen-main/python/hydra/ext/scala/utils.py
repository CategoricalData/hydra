...
def sapply(fun: hydra.ext.scala.meta.Data, args: frozenlist[hydra.ext.scala.meta.Data]) -> hydra.ext.scala.meta.Data:
    r"""Apply a Scala data expression to a list of arguments."""

    return cast(hydra.ext.scala.meta.Data, hydra.ext.scala.meta.DataApply(hydra.ext.scala.meta.Data_Apply(fun, args)))

def sname(s: str) -> hydra.ext.scala.meta.Data:
    r"""Create a Scala name reference."""

    return cast(hydra.ext.scala.meta.Data, hydra.ext.scala.meta.DataRef(cast(hydra.ext.scala.meta.Data_Ref, hydra.ext.scala.meta.Data_RefName(hydra.ext.scala.meta.Data_Name(hydra.ext.scala.meta.PredefString(s))))))

def type_to_string(t: hydra.ext.scala.meta.Type):
    def _hoist_hydra_ext_scala_utils_type_to_string_1(v1):
        match v1:
            case hydra.ext.scala.meta.Type_RefName(value=tn):
                return tn.value
    ...
    def _hoist_hydra_ext_scala_utils_type_to_string_2(v1):
        match v1:
            case hydra.ext.scala.meta.Type_FunctionTypeFunction(value=fn):
                @lru_cache(1)
...
def sapply_types(fun: hydra.ext.scala.meta.Data, type_args: frozenlist[hydra.ext.scala.meta.Type]):
    r"""Apply explicit type parameters to a Scala expression (e.g. f[A, B])."""

    def type_to_str(t: hydra.ext.scala.meta.Type) -> str:
...
def sassign(lhs: hydra.ext.scala.meta.Data, rhs: hydra.ext.scala.meta.Data) -> hydra.ext.scala.meta.Data:
    r"""Create a Scala assignment expression."""

    return cast(hydra.ext.scala.meta.Data, hydra.ext.scala.meta.DataAssign(hydra.ext.scala.meta.Data_Assign(lhs, rhs)))

def slambda(v: str, body: hydra.ext.scala.meta.Data, sdom: Maybe[hydra.ext.scala.meta.Type]) -> hydra.ext.scala.meta.Data:
    r"""Create a Scala lambda (function) expression."""

    return cast(hydra.ext.scala.meta.Data, hydra.ext.scala.meta.DataFunctionData(cast(hydra.ext.scala.meta.Data_FunctionData, hydra.ext.scala.meta.Data_FunctionDataFunction(hydra.ext.scala.meta.Data_Function((hydra.ext.scala.meta.Data_Param((), cast(hydra.ext.scala.meta.Name, hydra.ext.scala.meta.NameValue(v)), sdom, Nothing()),), body)))))

def sprim(name: hydra.core.Name) -> hydra.ext.scala.meta.Data:
...
def stapply(t: hydra.ext.scala.meta.Type, args: frozenlist[hydra.ext.scala.meta.Type]) -> hydra.ext.scala.meta.Type:
    r"""Apply a Scala type to a list of type arguments."""

    return cast(hydra.ext.scala.meta.Type, hydra.ext.scala.meta.TypeApply(hydra.ext.scala.meta.Type_Apply(t, args)))

def stapply1(t1: hydra.ext.scala.meta.Type, t2: hydra.ext.scala.meta.Type) -> hydra.ext.scala.meta.Type:
    r"""Apply a Scala type to one type argument."""

    return stapply(t1, (t2,))

def stapply2(t1: hydra.ext.scala.meta.Type, t2: hydra.ext.scala.meta.Type, t3: hydra.ext.scala.meta.Type) -> hydra.ext.scala.meta.Type:
    r"""Apply a Scala type to two type arguments."""

    return stapply(t1, (t2, t3))

def stparam(name: hydra.core.Name) -> hydra.ext.scala.meta.Type_Param:
    ...
    return hydra.ext.scala.meta.Type_Param((), cast(hydra.ext.scala.meta.Name, hydra.ext.scala.meta.NameValue(v())), (), (), (), ())

def stref(s: str) -> hydra.ext.scala.meta.Type:
    r"""Create a Scala type reference by name."""

    return cast(hydra.ext.scala.meta.Type, hydra.ext.scala.meta.TypeRef(cast(hydra.ext.scala.meta.Type_Ref, hydra.ext.scala.meta.Type_RefName(hydra.ext.scala.meta.Type_Name(s)))))

def svar(name: hydra.core.Name) -> hydra.ext.scala.meta.Pat:
    r"""Create a Scala pattern variable."""

    v = name.value
    return cast(hydra.ext.scala.meta.Pat, hydra.ext.scala.meta.PatVar(hydra.ext.scala.meta.Pat_Var(hydra.ext.scala.meta.Data_Name(hydra.ext.scala.meta.PredefString(v)))))
