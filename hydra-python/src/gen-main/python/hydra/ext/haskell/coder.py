...
def encode_type(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], typ: hydra.core.Type):
    ...
    def _hoist_body_4(v1):
        match v1:
            ...
            case hydra.core.TypeEither(value=either_type):
                left = either_type.left
                right = either_type.right
...
def encode_literal(l: hydra.core.Literal):
    def _hoist_hydra_ext_haskell_coder_encode_literal_1(v1):
        match v1:
            ...
            case hydra.core.FloatValueFloat64(value=f):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralDouble(f))))
            
            case hydra.core.FloatValueBigfloat(value=f):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralDouble(hydra.lib.literals.bigfloat_to_float64(f)))))
    ...
    def _hoist_hydra_ext_haskell_coder_encode_literal_2(v1):
        match v1:
            ...
            case hydra.core.IntegerValueInt8(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInteger(hydra.lib.literals.int8_to_bigint(i)))))
            
            case hydra.core.IntegerValueInt16(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInteger(hydra.lib.literals.int16_to_bigint(i)))))
            
            case hydra.core.IntegerValueInt32(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInt(i))))
            
            case hydra.core.IntegerValueInt64(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInteger(hydra.lib.literals.int64_to_bigint(i)))))
            
            case hydra.core.IntegerValueUint8(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInteger(hydra.lib.literals.uint8_to_bigint(i)))))
            
            case hydra.core.IntegerValueUint16(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInteger(hydra.lib.literals.uint16_to_bigint(i)))))
            
            case hydra.core.IntegerValueUint32(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInteger(hydra.lib.literals.uint32_to_bigint(i)))))
            
            case hydra.core.IntegerValueUint64(value=i):
                return hydra.lib.flows.pure(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.ast.Literal, hydra.ext.haskell.ast.LiteralInteger(hydra.lib.literals.uint64_to_bigint(i)))))
...
def encode_function(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], fun: hydra.core.Function):
    def _hoist_hydra_ext_haskell_coder_encode_function_1(namespaces, v1):
        match v1:
...
def encode_term(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], term: hydra.core.Term):
    ...
    match hydra.rewriting.deannotate_term(term):
        ...
        case hydra.core.TermUnion(value=injection):
            ...
            fn = field.name
            ft = field.term
            return hydra.lib.flows.bind(hydra.monads.get_state(), (lambda g_ufr2: (lhs := cast(hydra.ext.haskell.ast.Expression, hydra.ext.haskell.ast.ExpressionVariable(hydra.ext.haskell.utils.union_field_reference(hydra.lib.sets.from_list(hydra.lib.maps.keys(g_ufr2.bound_terms)), namespaces, sname, fn))), dflt := hydra.lib.flows.map((lambda v1: hydra.ext.haskell.utils.hsapp(lhs, v1)), encode(ft)), _hoist_body_1 := (lambda v1: (lambda _: hydra.lib.flows.pure(lhs))(v1.value) if isinstance(v1, hydra.core.TypeUnit) else dflt), hydra.lib.flows.bind(hydra.schemas.require_union_field(sname, fn), (lambda ftyp: _hoist_body_1(hydra.rewriting.deannotate_type(ftyp)))))[3]))
    ...
    def to_decl(comments: Maybe[str], hname_: hydra.ext.haskell.ast.Name, term_: hydra.core.Term, bindings: Maybe[hydra.ext.haskell.ast.LocalBindings]) -> hydra.compute.Flow[hydra.graph.Graph, hydra.ext.haskell.ast.DeclarationWithComments]:
        match hydra.rewriting.deannotate_term(term_):
            case hydra.core.TermLet(value=let_term):
                ...
                return hydra.lib.flows.bind(hydra.lib.flows.map_list((lambda v1: encode_term(namespaces, v1)), terms()), (lambda hterms: (hbindings := hydra.lib.lists.zip_with((lambda x1, x2: to_binding(x1, x2)), hnames(), hterms), prev_bindings := hydra.lib.maybes.maybe((), (lambda lb: lb.value), bindings), all_bindings := hydra.lib.lists.concat2(prev_bindings, hbindings), to_decl(comments, hname_, env, Just(hydra.ext.haskell.ast.LocalBindings(all_bindings))))[3]))
...
def to_type_declarations_from(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], element_name: hydra.core.Name, typ: hydra.core.Type):
    ...
    def union_cons(bound_names_: frozenset[hydra.core.Name], lname_: str, field_type: hydra.core.FieldType) -> hydra.compute.Flow[hydra.graph.Graph, hydra.ext.haskell.ast.ConstructorWithComments]:
        fname = field_type.name
        ftype = field_type.type
    ...
    return hydra.monads.with_trace(hydra.lib.strings.cat2("type definition ", element_name.value), hydra.lib.flows.bind(hydra.monads.get_state(), (lambda g: hydra.lib.flows.bind(hydra.schemas.is_serializable_by_name(element_name), (lambda is_ser: (deriv := hydra.ext.haskell.ast.Deriving(hydra.lib.logic.if_else(is_ser, (lambda : hydra.lib.lists.map((lambda x1: hydra.ext.haskell.utils.raw_name(x1)), ("Eq", "Ord", "Read", "Show"))), (lambda : ()))), unpack_result := hydra.ext.haskell.utils.unpack_forall_type(typ), vars := hydra.lib.pairs.first(unpack_result), t_ := hydra.lib.pairs.second(unpack_result), hd := decl_head(hname(), hydra.lib.lists.reverse(vars)), _hoist_body_1 := (lambda v1: (lambda rt: hydra.lib.flows.bind(record_cons(lname(), rt.fields), (lambda cons: hydra.lib.flows.pure(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationData(hydra.ext.haskell.ast.DataDeclaration(hydra.ext.haskell.ast.DataOrNewtype.DATA, (), hd, (cons,), (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeRecord) else (lambda rt: hydra.lib.flows.bind(hydra.lib.flows.map_list((lambda v12: union_cons(hydra.lib.sets.from_list(hydra.lib.maps.keys(g.bound_terms)), lname(), v12)), rt.fields), (lambda cons: hydra.lib.flows.pure(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationData(hydra.ext.haskell.ast.DataDeclaration(hydra.ext.haskell.ast.DataOrNewtype.DATA, (), hd, cons, (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeUnion) else (lambda wrapped: (wt := wrapped.body, hydra.lib.flows.bind(newtype_cons(element_name, wt), (lambda cons: hydra.lib.flows.pure(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationData(hydra.ext.haskell.ast.DataDeclaration(hydra.ext.haskell.ast.DataOrNewtype.NEWTYPE, (), hd, (cons,), (deriv,))))))))[1])(v1.value) if isinstance(v1, hydra.core.TypeWrap) else hydra.lib.flows.bind(adapt_type_to_haskell_and_encode(namespaces, typ), (lambda htype: hydra.lib.flows.pure(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationType(hydra.ext.haskell.ast.TypeDeclaration(hd, htype))))))), hydra.lib.flows.bind(_hoist_body_1(hydra.rewriting.deannotate_type(t_)), (lambda decl: hydra.lib.flows.bind(hydra.annotations.get_type_description(typ), (lambda comments: hydra.lib.flows.bind(hydra.lib.logic.if_else(include_type_definitions, (lambda : hydra.lib.flows.bind(type_decl(namespaces, element_name, typ), (lambda decl_: hydra.lib.flows.pure((decl_,))))), (lambda : hydra.lib.flows.pure(()))), (lambda tdecls: (main_decl := hydra.ext.haskell.ast.DeclarationWithComments(decl, comments), name_decls_ := name_decls(namespaces, element_name, typ), hydra.lib.flows.pure(hydra.lib.lists.concat(((main_decl,), name_decls_, tdecls))))[2])))))))[6])))))
