...
def encode_type(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], typ: hydra.core.Type, cx: hydra.context.Context, g: T0):
    ...
    def encode(t: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Type]:
...
def adapt_type_to_haskell_and_encode(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], typ: hydra.core.Type, cx: hydra.context.Context, g: T0) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Type]:
    r"""Adapt a Hydra type to Haskell's type system and encode it."""

    def enc(t: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Type]:
        return encode_type(namespaces, t, cx, g)
    match hydra.rewriting.deannotate_type(typ):
...
def encode_term(depth: int, namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], term: hydra.core.Term, cx: hydra.context.Context, g: hydra.graph.Graph):
    ...
    def encode(t: hydra.core.Term) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Expression]:
        return encode_term(depth, namespaces, t, cx, g)
    def nonempty_map(m: FrozenDict[hydra.core.Term, hydra.core.Term]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Expression]:
        @lru_cache(1)
        def lhs() -> hydra.ext.haskell.ast.Expression:
            return hydra.ext.haskell.utils.hsvar("M.fromList")
        def encode_pair(pair: tuple[hydra.core.Term, hydra.core.Term]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Expression]:
            @lru_cache(1)
    ...
    def nonempty_set(s: frozenset[hydra.core.Term]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Expression]:
        @lru_cache(1)
        def lhs() -> hydra.ext.haskell.ast.Expression:
    ...
    match hydra.rewriting.deannotate_term(term):
        ...
        case hydra.core.TermLet(value=let_term):
            ...
            def encode_binding(binding: hydra.core.Binding) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.LocalBinding]:
                name = binding.name
                term_ = binding.term
                @lru_cache(1)
                def hname() -> hydra.ext.haskell.ast.Name:
        ...
        case hydra.core.TermRecord(value=record):
            ...
            def to_field_update(field: hydra.core.Field) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.FieldUpdate]:
                fn = field.name
                ft = field.term
                @lru_cache(1)
        ...
        case hydra.core.TermUnion(value=injection):
            ...
            @lru_cache(1)
            def dflt() -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Expression]:
...
def to_data_declaration(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], def_: hydra.module.TermDefinition, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.DeclarationWithComments]:
    ...
    def rewrite_value_binding(vb: hydra.ext.haskell.ast.ValueBinding):
        match vb:
            ...
            case _:
                raise AssertionError("Unreachable: all variants handled")
    def to_decl(comments: Maybe[str], hname_: hydra.ext.haskell.ast.Name, term_: hydra.core.Term, bindings: Maybe[hydra.ext.haskell.ast.LocalBindings]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.DeclarationWithComments]:
...
def type_decl(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], name: hydra.core.Name, typ: hydra.core.Type, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.DeclarationWithComments]:
...
def to_type_declarations_from(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], element_name: hydra.core.Name, typ: hydra.core.Type, cx: hydra.context.Context, g: hydra.graph.Graph):
    ...
    def newtype_cons(tname: hydra.core.Name, typ_: hydra.core.Type) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.ConstructorWithComments]:
        @lru_cache(1)
    ...
    def record_cons(lname_: str, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.ConstructorWithComments]:
        def to_field(field_type: hydra.core.FieldType) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.FieldWithComments]:
            fname = field_type.name
    ...
    def union_cons(bound_names_: frozenset[hydra.core.Name], lname_: str, field_type: hydra.core.FieldType) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.ConstructorWithComments]:
        fname = field_type.name
        ftype = field_type.type
    ...
    return hydra.lib.eithers.bind(hydra.schemas.is_serializable_by_name(cx, g, element_name), (lambda is_ser: (deriv := hydra.ext.haskell.ast.Deriving(hydra.lib.logic.if_else(is_ser, (lambda : hydra.lib.lists.map((lambda x1: hydra.ext.haskell.utils.raw_name(x1)), ("Eq", "Ord", "Read", "Show"))), (lambda : ()))), unpack_result := hydra.ext.haskell.utils.unpack_forall_type(typ), vars := hydra.lib.pairs.first(unpack_result), t_ := hydra.lib.pairs.second(unpack_result), hd := decl_head(hname(), hydra.lib.lists.reverse(vars)), _hoist_deriv_body_1 := (lambda v1: (lambda rt: hydra.lib.eithers.bind(record_cons(lname(), rt), (lambda cons: Right(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationData(hydra.ext.haskell.ast.DataDeclaration(hydra.ext.haskell.ast.DataOrNewtype.DATA, (), hd, (cons,), (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeRecord) else (lambda rt: hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda v12: union_cons(hydra.lib.sets.from_list(hydra.lib.maps.keys(g.bound_terms)), lname(), v12)), rt), (lambda cons: Right(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationData(hydra.ext.haskell.ast.DataDeclaration(hydra.ext.haskell.ast.DataOrNewtype.DATA, (), hd, cons, (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeUnion) else (lambda wrapped: hydra.lib.eithers.bind(newtype_cons(element_name, wrapped), (lambda cons: Right(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationData(hydra.ext.haskell.ast.DataDeclaration(hydra.ext.haskell.ast.DataOrNewtype.NEWTYPE, (), hd, (cons,), (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeWrap) else hydra.lib.eithers.bind(adapt_type_to_haskell_and_encode(namespaces, typ, cx, g), (lambda htype: Right(cast(hydra.ext.haskell.ast.Declaration, hydra.ext.haskell.ast.DeclarationType(hydra.ext.haskell.ast.TypeDeclaration(hd, htype))))))), hydra.lib.eithers.bind(_hoist_deriv_body_1(hydra.rewriting.deannotate_type(t_)), (lambda decl: hydra.lib.eithers.bind(hydra.annotations.get_type_description(cx, g, typ), (lambda comments: hydra.lib.eithers.bind(hydra.lib.logic.if_else(include_type_definitions, (lambda : hydra.lib.eithers.bind(type_decl(namespaces, element_name, typ, cx, g), (lambda decl_: Right((decl_,))))), (lambda : Right(()))), (lambda tdecls: (main_decl := hydra.ext.haskell.ast.DeclarationWithComments(decl, comments), name_decls_ := name_decls(namespaces, element_name, typ), Right(hydra.lib.lists.concat(((main_decl,), name_decls_, tdecls))))[2])))))))[6]))

def construct_module(namespaces: hydra.module.Namespaces[hydra.ext.haskell.ast.ModuleName], mod: hydra.module.Module, defs: frozenlist[hydra.module.Definition], cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Module]:
    r"""Construct a Haskell module from a Hydra module and its definitions."""

    def h(namespace: hydra.module.Namespace) -> str:
        return namespace.value
    def create_declarations(def_: hydra.module.Definition) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[hydra.ext.haskell.ast.DeclarationWithComments]]:
        match def_:
...
def module_to_haskell_module(mod: hydra.module.Module, defs: frozenlist[hydra.module.Definition], cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.ast.Module]:
