...
def encode_type(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], typ: hydra.core.Type, cx: hydra.context.Context, g: T0):
    ...
    def unit_tuple() -> hydra.ext.haskell.syntax.Type:
        return cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeTuple(()))
    def _hoist_encode_body_1(v1):
        match v1:
            case hydra.core.FloatType.FLOAT32:
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Float"))))

            case hydra.core.FloatType.FLOAT64:
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Double"))))
    ...
    def _hoist_encode_body_2(it, v1):
        match v1:
            case hydra.core.IntegerType.BIGINT:
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Integer"))))

            case hydra.core.IntegerType.INT8:
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("I.Int8"))))

            case hydra.core.IntegerType.INT16:
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("I.Int16"))))

            case hydra.core.IntegerType.INT32:
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Int"))))
    ...
    def _hoist_encode_body_3(lt, v1):
        match v1:
            case hydra.core.LiteralTypeBinary():
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("B.ByteString"))))

            case hydra.core.LiteralTypeBoolean():
                return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Bool"))))
    ...
    match hydra.rewriting.deannotate_type(typ):
        ...
        case hydra.core.TypeEither(value=either_type):
            ...
            return hydra.lib.eithers.bind(encode(left_), (lambda hleft: hydra.lib.eithers.bind(encode(right_), (lambda hright: Right(hydra.ext.haskell.utils.to_type_application((cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Either"))), hleft, hright)))))))

        case hydra.core.TypeFunction(value=fun_type):
            dom = fun_type.domain
            cod = fun_type.codomain
            return hydra.lib.eithers.bind(encode(dom), (lambda hdom: hydra.lib.eithers.bind(encode(cod), (lambda hcod: Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeFunction(hydra.ext.haskell.syntax.FunctionType(hdom, hcod))))))))
        ...
        case hydra.core.TypeList(value=lt):
            return hydra.lib.eithers.bind(encode(lt), (lambda hlt: Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeList(hlt)))))
        ...
        case hydra.core.TypeMap(value=map_type):
            kt = map_type.keys
            vt = map_type.values
            return hydra.lib.eithers.bind(encode(kt), (lambda hkt: hydra.lib.eithers.bind(encode(vt), (lambda hvt: Right(hydra.ext.haskell.utils.to_type_application((cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("M.Map"))), hkt, hvt)))))))

        case hydra.core.TypeMaybe(value=ot):
            return hydra.lib.eithers.bind(encode(ot), (lambda hot: Right(hydra.ext.haskell.utils.to_type_application((cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Maybe"))), hot)))))

        case hydra.core.TypePair(value=pt):
            return hydra.lib.eithers.bind(encode(pt.first), (lambda f: hydra.lib.eithers.bind(encode(pt.second), (lambda s: Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeTuple((f, s))))))))

        case hydra.core.TypeRecord():
            return ref(hydra.core.Name("placeholder"))

        case hydra.core.TypeSet(value=st):
            return hydra.lib.eithers.bind(encode(st), (lambda hst: Right(hydra.ext.haskell.utils.to_type_application((cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("S.Set"))), hst)))))
        ...
        case hydra.core.TypeVoid():
            return Right(cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name("Void"))))
...
def adapt_type_to_haskell_and_encode(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], typ: hydra.core.Type, cx: hydra.context.Context, g: T0) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type]:
    ...
    def _hoist_hydra_ext_haskell_coder_encode_literal_1(v1):
        match v1:
            case hydra.core.FloatValueFloat32(value=f):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralFloat(f))))

            case hydra.core.FloatValueFloat64(value=f):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralDouble(f))))

            case hydra.core.FloatValueBigfloat(value=f):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralDouble(hydra.lib.literals.bigfloat_to_float64(f)))))
    ...
    def _hoist_hydra_ext_haskell_coder_encode_literal_2(v1):
        match v1:
            case hydra.core.IntegerValueBigint(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(i))))

            case hydra.core.IntegerValueInt8(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(hydra.lib.literals.int8_to_bigint(i)))))

            case hydra.core.IntegerValueInt16(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(hydra.lib.literals.int16_to_bigint(i)))))

            case hydra.core.IntegerValueInt32(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInt(i))))

            case hydra.core.IntegerValueInt64(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(hydra.lib.literals.int64_to_bigint(i)))))

            case hydra.core.IntegerValueUint8(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(hydra.lib.literals.uint8_to_bigint(i)))))

            case hydra.core.IntegerValueUint16(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(hydra.lib.literals.uint16_to_bigint(i)))))

            case hydra.core.IntegerValueUint32(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(hydra.lib.literals.uint32_to_bigint(i)))))

            case hydra.core.IntegerValueUint64(value=i):
                return Right(hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralInteger(hydra.lib.literals.uint64_to_bigint(i)))))

            case _:
                raise AssertionError("Unreachable: all variants handled")
    match l:
        case hydra.core.LiteralBinary(value=bs):
            return Right(hydra.ext.haskell.utils.hsapp(hydra.ext.haskell.utils.hsvar("Literals.stringToBinary"), hydra.ext.haskell.utils.hslit(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralString(hydra.lib.literals.binary_to_string(bs))))))
...
def encode_function(depth: int, namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], fun: hydra.core.Function, cx: hydra.context.Context, g: hydra.graph.Graph):
    def _hoist_hydra_ext_haskell_coder_encode_function_1(cx, depth, g, namespaces, v1):
        match v1:
            case hydra.core.EliminationWrap(value=name):
                return Right(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionVariable(hydra.ext.haskell.utils.element_reference(namespaces, hydra.names.qname(hydra.lib.maybes.from_just(hydra.names.namespace_of(name)), hydra.ext.haskell.utils.newtype_accessor_name(name))))))

            case hydra.core.EliminationRecord(value=proj):
                dn = proj.type_name
                fname = proj.field
                return Right(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionVariable(hydra.ext.haskell.utils.record_field_reference(namespaces, dn, fname))))
...
def encode_term(depth: int, namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], term: hydra.core.Term, cx: hydra.context.Context, g: hydra.graph.Graph):
    ...
    match hydra.rewriting.deannotate_term(term):
        ...
        case hydra.core.TermLet(value=let_term):
            def collect_bindings(lt: hydra.core.Let):
                ...
                def _hoist_body_body_1(v1):
                    match v1:
                        ...
                        case _:
                            return (bs, body)
                return _hoist_body_body_1(hydra.rewriting.deannotate_term(body))
            @lru_cache(1)
            ...
            def encode_binding(binding: hydra.core.Binding) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.LocalBinding]:
                ...
                return hydra.lib.eithers.bind(encode(term_), (lambda hexpr: Right(cast(hydra.ext.haskell.syntax.LocalBinding, hydra.ext.haskell.syntax.LocalBindingValue(hydra.ext.haskell.utils.simple_value_binding(hname(), hexpr, Nothing()))))))
            return hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda x1: encode_binding(x1)), all_bindings()), (lambda hbindings: hydra.lib.eithers.bind(encode(final_body()), (lambda hinner: Right(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionLet(hydra.ext.haskell.syntax.LetExpression(hbindings, hinner))))))))

        case hydra.core.TermList(value=els):
            return hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda x1: encode(x1)), els), (lambda helems: Right(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionList(helems)))))
        ...
        case hydra.core.TermPair(value=p):
            return hydra.lib.eithers.bind(encode(hydra.lib.pairs.first(p)), (lambda f: hydra.lib.eithers.bind(encode(hydra.lib.pairs.second(p)), (lambda s: Right(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionTuple((f, s))))))))
        ...
        case hydra.core.TermRecord(value=record):
            ...
            def to_field_update(field: hydra.core.Field) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.FieldUpdate]:
                ...
                ft = field.term
                @lru_cache(1)
                def field_ref() -> hydra.ext.haskell.syntax.Name:
                    return hydra.ext.haskell.utils.record_field_reference(namespaces, sname, fn)
                return hydra.lib.eithers.bind(encode(ft), (lambda hft: Right(hydra.ext.haskell.syntax.FieldUpdate(field_ref(), hft))))
            @lru_cache(1)
            def type_name() -> hydra.ext.haskell.syntax.Name:
                return hydra.ext.haskell.utils.element_reference(namespaces, sname)
            return hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda x1: to_field_update(x1)), fields), (lambda updates: Right(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionConstructRecord(hydra.ext.haskell.syntax.ConstructRecordExpression(type_name(), updates))))))
        ...
        case hydra.core.TermUnion(value=injection):
            ...
            def _hoist_sname_body_1(v1):
                match v1:
                    ...
                    case _:
                        return dflt()
            return hydra.lib.eithers.bind(hydra.schemas.require_union_field(cx, g, sname, fn), (lambda ftyp: _hoist_sname_body_1(hydra.rewriting.deannotate_type(ftyp))))

        case hydra.core.TermUnit():
            return Right(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionTuple(())))
        ...
        case hydra.core.TermWrap(value=wrapped):
            ...
            @lru_cache(1)
            def lhs() -> hydra.ext.haskell.syntax.Expression:
                return cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionVariable(hydra.ext.haskell.utils.element_reference(namespaces, tname)))
...
def encode_type_with_class_assertions(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], explicit_classes: FrozenDict[hydra.core.Name, frozenset[hydra.classes.TypeClass]], typ: hydra.core.Type, cx: hydra.context.Context, g: T0) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Type]:
    ...
    def encode_assertion(pair: tuple[hydra.core.Name, hydra.classes.TypeClass]) -> hydra.ext.haskell.syntax.Assertion:
        @lru_cache(1)
        ...
        @lru_cache(1)
        def htype() -> hydra.ext.haskell.syntax.Type:
            return cast(hydra.ext.haskell.syntax.Type, hydra.ext.haskell.syntax.TypeVariable(hydra.ext.haskell.utils.raw_name(name().value)))
        return cast(hydra.ext.haskell.syntax.Assertion, hydra.ext.haskell.syntax.AssertionClass(hydra.ext.haskell.syntax.ClassAssertion(hname(), (htype(),))))
    @lru_cache(1)
...
def to_data_declaration(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], def_: hydra.module.TermDefinition, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.DeclarationWithComments]:
    ...
    def rewrite_value_binding(vb: hydra.ext.haskell.syntax.ValueBinding):
        match vb:
            case hydra.ext.haskell.syntax.ValueBindingSimple(value=simple):
                pattern_ = simple.pattern
                rhs = simple.rhs
                bindings = simple.local_bindings
                def _hoist_pattern_body_1(v1):
                    match v1:
                        case hydra.ext.haskell.syntax.PatternApplication(value=app_pat):
                            name_ = app_pat.name
                            args = app_pat.args
                            rhs_expr = rhs.value
                            def _hoist_name_body_1(v12):
                                match v12:
                                    case hydra.ext.haskell.syntax.ExpressionLambda(value=lambda_):
                                        vars = lambda_.bindings
                                        body = lambda_.inner
                                        @lru_cache(1)
                                        def new_pattern() -> hydra.ext.haskell.syntax.Pattern:
                                            return hydra.ext.haskell.utils.application_pattern(name_, hydra.lib.lists.concat2(args, vars))
                                        new_rhs = hydra.ext.haskell.syntax.RightHandSide(body)
                                        return rewrite_value_binding(cast(hydra.ext.haskell.syntax.ValueBinding, hydra.ext.haskell.syntax.ValueBindingSimple(hydra.ext.haskell.syntax.SimpleValueBinding(new_pattern(), new_rhs, bindings))))
    ...
    def to_decl(comments: Maybe[str], hname_: hydra.ext.haskell.syntax.Name, term_: hydra.core.Term, bindings: Maybe[hydra.ext.haskell.syntax.LocalBindings]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.DeclarationWithComments]:
        match hydra.rewriting.deannotate_term(term_):
            case hydra.core.TermLet(value=let_term):
                ...
                env = let_term.body
                def to_term_definition(hname_: hydra.ext.haskell.syntax.Name, hterm_: hydra.ext.haskell.syntax.Expression) -> hydra.ext.haskell.syntax.LocalBinding:
                    return cast(hydra.ext.haskell.syntax.LocalBinding, hydra.ext.haskell.syntax.LocalBindingValue(hydra.ext.haskell.utils.simple_value_binding(hname_, hterm_, Nothing())))
                @lru_cache(1)
                def hnames() -> frozenlist[hydra.ext.haskell.syntax.Name]:
                ...
                return hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda t: encode_term(0, namespaces, t, cx, g)), terms()), (lambda hterms: (hbindings := hydra.lib.lists.zip_with((lambda x1, x2: to_term_definition(x1, x2)), hnames(), hterms), prev_bindings := hydra.lib.maybes.maybe((lambda : ()), (lambda lb: lb.value), bindings), all_bindings := hydra.lib.lists.concat2(prev_bindings, hbindings), to_decl(comments, hname_, env, Just(hydra.ext.haskell.syntax.LocalBindings(all_bindings))))[3]))

            case _:
                return hydra.lib.eithers.bind(encode_term(0, namespaces, term_, cx, g), (lambda hterm: (vb := hydra.ext.haskell.utils.simple_value_binding(hname_, hterm, bindings), scheme_constraints := hydra.lib.maybes.maybe((lambda : Nothing()), (lambda ts: ts.constraints), typ), scheme_classes := type_scheme_constraints_to_class_map(scheme_constraints), hydra.lib.eithers.bind(hydra.annotations.get_type_classes(cx, g, hydra.rewriting.remove_types_from_term(term)), (lambda explicit_classes: (combined_classes := hydra.lib.maps.union(scheme_classes, explicit_classes), scheme_type := hydra.lib.maybes.maybe((lambda : cast(hydra.core.Type, hydra.core.TypeUnit())), (lambda ts: ts.type), typ), hydra.lib.eithers.bind(encode_type_with_class_assertions(namespaces, combined_classes, scheme_type, cx, g), (lambda htype: (decl := cast(hydra.ext.haskell.syntax.Declaration, hydra.ext.haskell.syntax.DeclarationTypedBinding(hydra.ext.haskell.syntax.TypedBinding(hydra.ext.haskell.syntax.TypeSignature(hname_, htype), rewrite_value_binding(vb)))), Right(hydra.ext.haskell.syntax.DeclarationWithComments(decl, comments)))[1])))[2])))[3]))
...
def name_decls(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], name: hydra.core.Name, typ: hydra.core.Type) -> frozenlist[hydra.ext.haskell.syntax.DeclarationWithComments]:
    r"""Generate Haskell declarations for type and field name constants."""

    nm = name.value
    def to_decl(n: hydra.core.Name, pair: tuple[str, str]) -> hydra.ext.haskell.syntax.DeclarationWithComments:
        @lru_cache(1)
        def k() -> str:
            return hydra.lib.pairs.first(pair)
        @lru_cache(1)
        def v() -> str:
            return hydra.lib.pairs.second(pair)
        @lru_cache(1)
        def decl() -> hydra.ext.haskell.syntax.Declaration:
            return cast(hydra.ext.haskell.syntax.Declaration, hydra.ext.haskell.syntax.DeclarationValueBinding(cast(hydra.ext.haskell.syntax.ValueBinding, hydra.ext.haskell.syntax.ValueBindingSimple(hydra.ext.haskell.syntax.SimpleValueBinding(hydra.ext.haskell.utils.application_pattern(hydra.ext.haskell.utils.simple_name(k()), ()), hydra.ext.haskell.syntax.RightHandSide(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionApplication(hydra.ext.haskell.syntax.ApplicationExpression(cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionVariable(hydra.ext.haskell.utils.element_reference(namespaces, n))), cast(hydra.ext.haskell.syntax.Expression, hydra.ext.haskell.syntax.ExpressionLiteral(cast(hydra.ext.haskell.syntax.Literal, hydra.ext.haskell.syntax.LiteralString(v())))))))), Nothing())))))
        return hydra.ext.haskell.syntax.DeclarationWithComments(decl(), Nothing())
    @lru_cache(1)
...
def type_decl(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], name: hydra.core.Name, typ: hydra.core.Type, cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.DeclarationWithComments]:
    ...
    return hydra.lib.eithers.bind(encode_term(0, namespaces, final_term(), cx, g), (lambda expr: (rhs := hydra.ext.haskell.syntax.RightHandSide(expr), hname := hydra.ext.haskell.utils.simple_name(type_name_local(name)), pat := hydra.ext.haskell.utils.application_pattern(hname, ()), decl := cast(hydra.ext.haskell.syntax.Declaration, hydra.ext.haskell.syntax.DeclarationValueBinding(cast(hydra.ext.haskell.syntax.ValueBinding, hydra.ext.haskell.syntax.ValueBindingSimple(hydra.ext.haskell.syntax.SimpleValueBinding(pat, rhs, Nothing()))))), Right(hydra.ext.haskell.syntax.DeclarationWithComments(decl, Nothing())))[4]))

def to_type_declarations_from(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], element_name: hydra.core.Name, typ: hydra.core.Type, cx: hydra.context.Context, g: hydra.graph.Graph):
    ...
    def record_cons(lname_: str, fields: frozenlist[hydra.core.FieldType]) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.ConstructorWithComments]:
        def to_field(field_type: hydra.core.FieldType) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.FieldWithComments]:
            ...
            @lru_cache(1)
            def hname_() -> hydra.ext.haskell.syntax.Name:
    ...
    return hydra.lib.eithers.bind(hydra.schemas.is_serializable_by_name(cx, g, element_name), (lambda is_ser: (deriv := hydra.ext.haskell.syntax.Deriving(hydra.lib.logic.if_else(is_ser, (lambda : hydra.lib.lists.map((lambda x1: hydra.ext.haskell.utils.raw_name(x1)), ("Eq", "Ord", "Read", "Show"))), (lambda : ()))), unpack_result := hydra.ext.haskell.utils.unpack_forall_type(typ), vars := hydra.lib.pairs.first(unpack_result), t_ := hydra.lib.pairs.second(unpack_result), hd := decl_head(hname(), hydra.lib.lists.reverse(vars)), _hoist_deriv_body_1 := (lambda v1: (lambda rt: hydra.lib.eithers.bind(record_cons(lname(), rt), (lambda cons: Right(cast(hydra.ext.haskell.syntax.Declaration, hydra.ext.haskell.syntax.DeclarationData(hydra.ext.haskell.syntax.DataDeclaration(hydra.ext.haskell.syntax.DataOrNewtype.DATA, (), hd, (cons,), (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeRecord) else (lambda rt: hydra.lib.eithers.bind(hydra.lib.eithers.map_list((lambda v12: union_cons(hydra.lib.sets.union(hydra.lib.sets.from_list(hydra.lib.maps.keys(g.bound_terms)), hydra.lib.sets.from_list(hydra.lib.maps.keys(g.schema_types))), lname(), v12)), rt), (lambda cons: Right(cast(hydra.ext.haskell.syntax.Declaration, hydra.ext.haskell.syntax.DeclarationData(hydra.ext.haskell.syntax.DataDeclaration(hydra.ext.haskell.syntax.DataOrNewtype.DATA, (), hd, cons, (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeUnion) else (lambda wrapped: hydra.lib.eithers.bind(newtype_cons(element_name, wrapped), (lambda cons: Right(cast(hydra.ext.haskell.syntax.Declaration, hydra.ext.haskell.syntax.DeclarationData(hydra.ext.haskell.syntax.DataDeclaration(hydra.ext.haskell.syntax.DataOrNewtype.NEWTYPE, (), hd, (cons,), (deriv,))))))))(v1.value) if isinstance(v1, hydra.core.TypeWrap) else hydra.lib.eithers.bind(adapt_type_to_haskell_and_encode(namespaces, typ, cx, g), (lambda htype: Right(cast(hydra.ext.haskell.syntax.Declaration, hydra.ext.haskell.syntax.DeclarationType(hydra.ext.haskell.syntax.TypeDeclaration(hd, htype))))))), hydra.lib.eithers.bind(_hoist_deriv_body_1(hydra.rewriting.deannotate_type(t_)), (lambda decl: hydra.lib.eithers.bind(hydra.annotations.get_type_description(cx, g, typ), (lambda comments: hydra.lib.eithers.bind(hydra.lib.logic.if_else(include_type_definitions, (lambda : hydra.lib.eithers.bind(type_decl(namespaces, element_name, typ, cx, g), (lambda decl_: Right((decl_,))))), (lambda : Right(()))), (lambda tdecls: (main_decl := hydra.ext.haskell.syntax.DeclarationWithComments(decl, comments), name_decls_ := name_decls(namespaces, element_name, typ), Right(hydra.lib.lists.concat(((main_decl,), name_decls_, tdecls))))[2])))))))[6]))

def construct_module(namespaces: hydra.module.Namespaces[hydra.ext.haskell.syntax.ModuleName], mod: hydra.module.Module, defs: frozenlist[hydra.module.Definition], cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Module]:
    r"""Construct a Haskell module from a Hydra module and its definitions."""

    def h(namespace: hydra.module.Namespace) -> str:
        return namespace.value
    def create_declarations(def_: hydra.module.Definition) -> Either[hydra.context.InContext[hydra.errors.Error], frozenlist[hydra.ext.haskell.syntax.DeclarationWithComments]]:
        match def_:
            ...
            case _:
                raise AssertionError("Unreachable: all variants handled")
    def import_name(name: str) -> hydra.ext.haskell.syntax.ModuleName:
        return hydra.ext.haskell.syntax.ModuleName(hydra.lib.strings.intercalate(".", hydra.lib.lists.map(hydra.formatting.capitalize, hydra.lib.strings.split_on(".", name))))
    @lru_cache(1)
    def imports() -> frozenlist[hydra.ext.haskell.syntax.Import]:
        return hydra.lib.lists.concat2(domain_imports(), standard_imports())
    @lru_cache(1)
    def domain_imports() -> frozenlist[hydra.ext.haskell.syntax.Import]:
        def to_import(pair: tuple[hydra.module.Namespace, hydra.ext.haskell.syntax.ModuleName]) -> hydra.ext.haskell.syntax.Import:
            @lru_cache(1)
            def namespace() -> hydra.module.Namespace:
                return hydra.lib.pairs.first(pair)
            @lru_cache(1)
            def alias() -> hydra.ext.haskell.syntax.ModuleName:
                return hydra.lib.pairs.second(pair)
            @lru_cache(1)
            def name() -> str:
                return h(namespace())
...
def module_to_haskell_module(mod: hydra.module.Module, defs: frozenlist[hydra.module.Definition], cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], hydra.ext.haskell.syntax.Module]:
...
def module_to_haskell(mod: hydra.module.Module, defs: frozenlist[hydra.module.Definition], cx: hydra.context.Context, g: hydra.graph.Graph) -> Either[hydra.context.InContext[hydra.errors.Error], FrozenDict[str, str]]:
