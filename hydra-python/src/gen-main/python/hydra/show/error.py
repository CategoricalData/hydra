...
def incorrect_unification_error(e: hydra.error.IncorrectUnificationError) -> str:
...
def not_a_forall_type_error(e: hydra.error.NotAForallTypeError) -> str:
...
def not_a_function_type_error(e: hydra.error.NotAFunctionTypeError) -> str:
    r"""Show a not-a-function-type error as a string."""

    typ = e.type
    return hydra.lib.strings.cat2("not a function type: ", hydra.show.core.type(typ))

def type_arity_mismatch_error(e: hydra.error.TypeArityMismatchError) -> str:
...
def type_mismatch_error(e: hydra.error.TypeMismatchError) -> str:
...
def unbound_type_variables_error(e: hydra.error.UnboundTypeVariablesError) -> str:
...
def unequal_types_error(e: hydra.error.UnequalTypesError) -> str:
...
def unsupported_term_variant_error(e: hydra.error.UnsupportedTermVariantError) -> str:
...
def untyped_let_binding_error(e: hydra.error.UntypedLetBindingError) -> str:
...
def checking_error(ce: hydra.error.CheckingError) -> str:
    r"""Show a checking error as a string."""

    match ce:
        case hydra.error.CheckingErrorIncorrectUnification(value=v1):
            return incorrect_unification_error(v1)

        case hydra.error.CheckingErrorNotAForallType(value=v12):
            return not_a_forall_type_error(v12)

        case hydra.error.CheckingErrorNotAFunctionType(value=v13):
            return not_a_function_type_error(v13)

        case hydra.error.CheckingErrorTypeArityMismatch(value=v14):
            return type_arity_mismatch_error(v14)

        case hydra.error.CheckingErrorTypeMismatch(value=v15):
            return type_mismatch_error(v15)

        case hydra.error.CheckingErrorUnboundTypeVariables(value=v16):
            return unbound_type_variables_error(v16)

        case hydra.error.CheckingErrorUnequalTypes(value=v17):
            return unequal_types_error(v17)

        case hydra.error.CheckingErrorUnsupportedTermVariant(value=v18):
            return unsupported_term_variant_error(v18)

        case hydra.error.CheckingErrorUntypedLambda(value=v19):
            return untyped_lambda_error(v19)

        case hydra.error.CheckingErrorUntypedLetBinding(value=v110):
...
def duplicate_binding_error(e: hydra.error.DuplicateBindingError) -> str:
    r"""Show a duplicate binding error as a string."""

    return hydra.lib.strings.cat2("duplicate binding: ", e.name.value)

def duplicate_field_error(e: hydra.error.DuplicateFieldError) -> str:
...
def undefined_field_error(e: hydra.error.UndefinedFieldError) -> str:
...
def undefined_term_error(e: hydra.error.UndefinedTermError) -> str:
    r"""Show an undefined term error as a string."""

    return hydra.lib.strings.cat2("undefined term: ", e.name.value)

def undefined_type_error(e: hydra.error.UndefinedTypeError) -> str:
    r"""Show an undefined type error as a string."""

    return hydra.lib.strings.cat2("undefined type: ", e.name.value)

def unexpected_term_variant_error(e: hydra.error.UnexpectedTermVariantError) -> str:
...
def unexpected_type_variant_error(e: hydra.error.UnexpectedTypeVariantError) -> str:
