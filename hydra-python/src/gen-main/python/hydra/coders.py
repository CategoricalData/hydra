...
CoderDirection = Annotated[
    CoderDirectionEncode | CoderDirectionDecode,
...
class LanguageConstraints:
    ...
    elimination_variants: Annotated[
        set[hydra.mantle.EliminationVariant], "All supported elimination variants"
    ]

    literal_variants: Annotated[
        set[hydra.mantle.LiteralVariant], "All supported literal variants"
    ]

    float_types: Annotated[set[hydra.core.FloatType], "All supported float types"]

    function_variants: Annotated[
        set[hydra.mantle.FunctionVariant], "All supported function variants"
    ]

    integer_types: Annotated[set[hydra.core.IntegerType], "All supported integer types"]

    term_variants: Annotated[
        set[hydra.mantle.TermVariant], "All supported term variants"
    ]

    type_variants: Annotated[
        set[hydra.mantle.TypeVariant], "All supported type variants"
    ]

    types: Annotated[
        Callable[[hydra.core.Type], bool],
...
TraversalOrder = Annotated[
    TraversalOrderPre | TraversalOrderPost,
